...
fun NotPickedUpScreen(
    viewModel: NotPickedUpViewModel,
    onNavigateBack: () -> Unit
) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Not Picked Up Calls") },
                navigationIcon = {
            ...
            when {
                ...
                uiState.calls.isEmpty() -> {
                    Column(
                        ...
                        Text(
                            text = "Great job! All your calls were picked up.",
    ...
    ListItem(
        ...
        supportingContent = {
            Column {
                ...
                Text(
                    text = "${call.attempts} attempts • Last: ${formatDateTime(call.lastAttempt)}",
