...
public final class C3426y extends AbstractC3404c {
    private static final long serialVersionUID = 1300372329181994526L;

    /* renamed from: a */
    public final transient LocalDate f18106a;
    ...
    public final C3485o mo7812l(TemporalField temporalField) {
        ...
        int i10 = AbstractC3425x.f18105a[chronoField.ordinal()];
        if (i10 == 1 || i10 == 2 || i10 == 3) {
            return this.f18106a.mo7812l(temporalField);
        }
        if (i10 != 4) {
            return C3424w.f18104d.mo7891A(chronoField);
        }
        C3485o c3485o = ChronoField.YEAR.f18248b;
        return C3485o.m8013f(1L, m7934X() <= 0 ? (-c3485o.f18284a) + 1912 : c3485o.f18287d - 1911);
    }

    @Override // j$.time.temporal.TemporalAccessor
    public final long getLong(TemporalField temporalField) {
        if (temporalField instanceof ChronoField) {
            int i10 = AbstractC3425x.f18105a[((ChronoField) temporalField).ordinal()];
            if (i10 == 4) {
                int iM7934X = m7934X();
                if (iM7934X < 1) {
                    iM7934X = 1 - iM7934X;
            ...
            if (i10 == 5) {
                return ((m7934X() * 12) + this.f18106a.getMonthValue()) - 1;
            }
            if (i10 == 6) {
                return m7934X();
            }
            if (i10 != 7) {
                return this.f18106a.getLong(temporalField);
            }
            return m7934X() < 1 ? 0 : 1;
        }
    ...
    /* renamed from: X */
    public final int m7934X() {
        return this.f18106a.getYear() - 1911;
    }
    ...
    */
    public final j$.time.chrono.C3426y mo7819a(long r8, j$.time.temporal.TemporalField r10) {
        /*
            r7 = this;
            ...
            return r7
        L10:
            int[] r1 = j$.time.chrono.AbstractC3425x.f18105a
            int r2 = r0.ordinal()
            r2 = r1[r2]
            r3 = 7
            r4 = 6
            ...
            goto L63
        L25:
            j$.time.chrono.w r10 = j$.time.chrono.C3424w.f18104d
            ...
            r2 = 12
            long r0 = r0 * r2
            j$.time.LocalDate r10 = r7.f18106a
            ...
            j$.time.chrono.y r8 = r7.b0(r8)
            return r8
        L4d:
            j$.time.chrono.w r2 = j$.time.chrono.C3424w.f18104d
            ...
            if (r0 == r3) goto L6e
        L63:
            j$.time.LocalDate r0 = r7.f18106a
            j$.time.LocalDate r8 = r0.mo7819a(r8, r10)
            j$.time.chrono.y r8 = r7.b0(r8)
            return r8
        L6e:
            j$.time.LocalDate r8 = r7.f18106a
            int r9 = r7.m7934X()
            int r9 = 1912 - r9
        ...
        La3:
            ...
            j$.time.chrono.y r8 = (j$.time.chrono.C3426y) r8
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.time.chrono.C3426y.mo7819a(long, j$.time.temporal.TemporalField):j$.time.chrono.y");
    }

    @Override // j$.time.chrono.AbstractC3404c, j$.time.chrono.ChronoLocalDate, j$.time.temporal.Temporal
    /* renamed from: e */
    public final Temporal mo7835j(LocalDate localDate) {
        return (C3426y) super.mo7835j(localDate);
    }

    @Override // j$.time.chrono.ChronoLocalDate
    /* renamed from: j */
    public final ChronoLocalDate mo7835j(TemporalAdjuster temporalAdjuster) {
        return (C3426y) super.mo7835j(temporalAdjuster);
    }

    @Override // j$.time.chrono.ChronoLocalDate
    /* renamed from: S */
    public final ChronoLocalDate mo7830S(InterfaceC3482l interfaceC3482l) {
        return (C3426y) super.mo7830S(interfaceC3482l);
    }

    @Override // j$.time.chrono.AbstractC3404c
    /* renamed from: Q */
    public final ChronoLocalDate mo7918Q(long j6) {
        return b0(this.f18106a.h0(j6));
    }

    @Override // j$.time.chrono.AbstractC3404c
    /* renamed from: K */
    public final ChronoLocalDate mo7917K(long j6) {
        return b0(this.f18106a.plusMonths(j6));
    }

    @Override // j$.time.chrono.AbstractC3404c
    /* renamed from: I */
    public final ChronoLocalDate mo7916I(long j6) {
        return b0(this.f18106a.plusDays(j6));
    }

    @Override // j$.time.chrono.AbstractC3404c, j$.time.chrono.ChronoLocalDate, j$.time.temporal.Temporal
    /* renamed from: b */
    public final ChronoLocalDate mo7820b(long j6, TemporalUnit temporalUnit) {
        return (C3426y) super.mo7820b(j6, temporalUnit);
    }
    ...
    public final ChronoLocalDate mo7821c(long j6, TemporalUnit temporalUnit) {
        return (C3426y) super.mo7821c(j6, temporalUnit);
    }
    ...
    public final C3426y b0(LocalDate localDate) {
        return localDate.equals(this.f18106a) ? this : new C3426y(localDate);
    }

    @Override // j$.time.chrono.ChronoLocalDate
    public final long toEpochDay() {
        return this.f18106a.toEpochDay();
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C3426y) {
            return this.f18106a.equals(((C3426y) obj).f18106a);
        }
        return false;
    }
