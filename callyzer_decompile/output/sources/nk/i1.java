...
public class i1 extends AbstractC4103w {
    ...
    public final Object mo8851b(C6564a c6564a) throws IOException {
        ...
        try {
            int iO0 = c6564a.o0();
            if (iO0 <= 65535 && iO0 >= -32768) {
                return Short.valueOf((short) iO0);
            }
            StringBuilder sbM4567n = AbstractC1452a.m4567n(iO0, "Lossy conversion from ", " to short; at path ");
