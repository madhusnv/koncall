...
public final class CryptoServicesRegistrar {
    ...
    public static class ThreadLocalSecureRandomProvider implements SecureRandomProvider {
    ...
    static {
        CryptoServicesConstraints cryptoServicesConstraints = new CryptoServicesConstraints() { // from class: org.bouncycastle.crypto.CryptoServicesRegistrar.1
    ...
    private static void checkPermission(final Permission permission) {
        ...
        if (securityManager != null) {
            AccessController.doPrivileged(new PrivilegedAction<Object>() { // from class: org.bouncycastle.crypto.CryptoServicesRegistrar.3
    ...
    public static <T> T getSizedProperty(Property property, int i10) {
        ...
        if (property.type.isAssignableFrom(DHParameters.class)) {
            while (i11 != objArrLookupProperty.length) {
                ?? r42 = (T) ((DHParameters) objArrLookupProperty[i11]);
                if (r42.getP().bitLength() == i10) {
                    return r42;
                }
                i11++;
            }
            ...
            while (i11 != objArrLookupProperty.length) {
                ?? r43 = (T) ((DSAParameters) objArrLookupProperty[i11]);
                if (r43.getP().bitLength() == i10) {
                    return r43;
                }
                i11++;
            }
    ...
    public static void setSecureRandom(final SecureRandom secureRandom) {
        ...
        if (secureRandom == null) {
            ...
            defaultSecureRandomProvider.set(new SecureRandomProvider() { // from class: org.bouncycastle.crypto.CryptoServicesRegistrar.2
                @Override // org.bouncycastle.crypto.SecureRandomProvider
                public SecureRandom get() {
                    return secureRandom;
                }
    ...
    public static void setServicesConstraints(CryptoServicesConstraints cryptoServicesConstraints) {
        ...
        } else if (Properties.isOverrideSet("org.bouncycastle.constraints.allow_override")) {
            servicesConstraints.set(cryptoServicesConstraints);
        } else {
