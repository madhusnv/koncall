...
public class SkeinParameters implements CipherParameters {
    ...
    public static class Builder {
        ...
        public Builder set(int i10, byte[] bArr) {
            if (bArr == null) {
            ...
            this.parameters.put(Integers.valueOf(i10), bArr);
            return this;
        }
        ...
        public Builder setPersonalisation(Date date, String str, String str2) throws IOException {
            try {
                ...
                throw new IllegalStateException(AbstractC4801l.m9733g("Byte I/O failed: ", e2));
            }
        }
        ...
        public Builder setPersonalisation(Date date, Locale locale, String str, String str2) throws IOException {
            try {
                ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
                OutputStreamWriter outputStreamWriter = new OutputStreamWriter(byteArrayOutputStream, "UTF-8");
