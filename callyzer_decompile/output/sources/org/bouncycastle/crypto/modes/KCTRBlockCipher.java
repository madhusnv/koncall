...
public class KCTRBlockCipher extends StreamBlockCipher {
    ...
    public KCTRBlockCipher(BlockCipher blockCipher) {
        ...
        this.f44607iv = new byte[blockCipher.getBlockSize()];
    ...
    public void init(boolean z6, CipherParameters cipherParameters) {
        ...
        byte[] bArr = this.f44607iv;
        int length = bArr.length - iv2.length;
        Arrays.fill(bArr, (byte) 0);
        System.arraycopy(iv2, 0, this.f44607iv, length, iv2.length);
    ...
    public void reset() {
        if (this.initialised) {
            this.engine.processBlock(this.f44607iv, 0, this.ofbV, 0);
        }
        this.engine.reset();
        this.byteCount = 0;
    }
