...
public class OldCTSBlockCipher extends DefaultBufferedBlockCipher {
    ...
    public int doFinal(byte[] bArr, int i10) {
        ...
        int i11 = ((DefaultBufferedBlockCipher) this).bufOff - blockSize;
        ...
        if (((DefaultBufferedBlockCipher) this).forEncryption) {
            ...
            if (blockCipher instanceof CBCBlockCipher) {
                ((CBCBlockCipher) blockCipher).getUnderlyingCipher().processBlock(((DefaultBufferedBlockCipher) this).buf, blockSize, bArr, i10);
            } else {
