...
public class Tables8kKGCMMultiplier_256 implements KGCMMultiplier {
    ...
    /* renamed from: T */
    private long[][] f27735T;

    @Override // org.bouncycastle.crypto.modes.kgcm.KGCMMultiplier
    public void init(long[] jArr) {
        long[][] jArr2 = this.f27735T;
        if (jArr2 == null) {
            this.f27735T = (long[][]) Array.newInstance((Class<?>) Long.TYPE, 256, 4);
        } else if (KGCMUtil_256.equal(jArr, jArr2[1])) {
            return;
        }
        KGCMUtil_256.copy(jArr, this.f27735T[1]);
        for (int i10 = 2; i10 < 256; i10 += 2) {
            long[][] jArr3 = this.f27735T;
            KGCMUtil_256.multiplyX(jArr3[i10 >> 1], jArr3[i10]);
            long[][] jArr4 = this.f27735T;
    ...
    public void multiplyH(long[] jArr) {
        ...
        KGCMUtil_256.copy(this.f27735T[((int) (jArr[3] >>> 56)) & 255], jArr2);
        for (int i10 = 30; i10 >= 0; i10--) {
            KGCMUtil_256.multiplyX8(jArr2, jArr2);
            KGCMUtil_256.add(this.f27735T[((int) (jArr[i10 >>> 3] >>> ((i10 & 7) << 3))) & 255], jArr2, jArr2);
        }
