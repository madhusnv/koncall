...
public class PublicKeyFactory {
    ...
    public static class DHPublicNumberConverter extends SubjectPublicKeyInfoConverter {
        ...
        public AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo subjectPublicKeyInfo, Object obj) {
            ...
            BigInteger p4 = domainParameters.getP();
            ...
            return new DHPublicKeyParameters(y10, new DHParameters(p4, g10, q10, j6, validationParams != null ? new DHValidationParameters(validationParams.getSeed(), validationParams.getPgenCounter().intValue()) : null));
        }
    }
    ...
    public static class ECConverter extends SubjectPublicKeyInfoConverter {
        ...
        public AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo subjectPublicKeyInfo, Object obj) {
            ...
            if (bytes[0] == 4 && bytes[1] == bytes.length - 2 && (((b10 = bytes[2]) == 2 || b10 == 3) && new X9IntegerConverter().getByteLength(eCDomainParameters.getCurve()) >= bytes.length - 3)) {
                try {
    ...
    public static class GOST3410_2012Converter extends SubjectPublicKeyInfoConverter {
        ...
        public AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo subjectPublicKeyInfo, Object obj) {
            ...
            try {
                ...
                int i10 = algorithm2.equals((ASN1Primitive) RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512) ? 64 : 32;
                int i11 = i10 * 2;
