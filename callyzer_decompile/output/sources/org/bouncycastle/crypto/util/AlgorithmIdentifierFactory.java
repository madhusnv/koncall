...
public class AlgorithmIdentifierFactory {
    static final ASN1ObjectIdentifier IDEA_CBC = AbstractC4801l.m9746t("1.3.6.1.4.1.188.7.1.1.2");
    static final ASN1ObjectIdentifier CAST5_CBC = AbstractC4801l.m9746t("1.2.840.113533.7.66.10");
    ...
    public static AlgorithmIdentifier generateEncryptionAlgID(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i10, SecureRandom secureRandom) {
        ...
        if (aSN1ObjectIdentifier.equals((ASN1Primitive) CAST5_CBC)) {
            ...
            return new AlgorithmIdentifier(aSN1ObjectIdentifier, new CAST5CBCParameters(bArr5, i10));
        }
