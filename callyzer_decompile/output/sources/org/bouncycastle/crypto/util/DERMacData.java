...
public final class DERMacData {
    ...
    public static /* synthetic */ class C55591 {
    ...
    public static final class Builder {
        ...
        public DERMacData build() {
            int i10 = C55591.$SwitchMap$org$bouncycastle$crypto$util$DERMacData$Type[this.type.ordinal()];
            C55591 c55591 = null;
            if (i10 == 1 || i10 == 2) {
                return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.ephemDataU), DerUtil.toByteArray(this.ephemDataV), this.text), c55591);
            }
            if (i10 == 3 || i10 == 4) {
                return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.ephemDataV), DerUtil.toByteArray(this.ephemDataU), this.text), c55591);
            }
    ...
    public /* synthetic */ DERMacData(byte[] bArr, C55591 c55591) {
        this(bArr);
    }
}
