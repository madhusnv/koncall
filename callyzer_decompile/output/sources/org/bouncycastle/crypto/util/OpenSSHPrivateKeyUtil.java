    ...
    public static byte[] encodePrivateKey(AsymmetricKeyParameter asymmetricKeyParameter) throws IOException {
        ...
        if (asymmetricKeyParameter instanceof DSAPrivateKeyParameters) {
            ...
            try {
                ...
                throw new IllegalStateException(AbstractC0030c.m117h(e2, new StringBuilder("unable to encode DSAPrivateKeyParameters ")));
            }
        }
    ...
    public static AsymmetricKeyParameter parsePrivateKeyBlob(byte[] bArr) {
        ...
        if (bArr[0] == 48) {
            ...
            if ("ssh-ed25519".equals(string)) {
                ...
                if (byName == null) {
                    throw new IllegalStateException("OID not found for: ".concat(string));
                }
                X9ECParameters byOID = NISTNamedCurves.getByOID(byName);
                if (byOID == null) {
                    throw new IllegalStateException(AbstractC4801l.m9734h("Curve not found for: ", byName));
                }
                sSHBuffer2.readBlock();
