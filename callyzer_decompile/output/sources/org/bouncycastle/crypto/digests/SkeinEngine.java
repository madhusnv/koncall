...
public class SkeinEngine implements Memoable {
    ...
    public static class Configuration {
        ...
        public Configuration(long j6) {
            ...
            bArr[4] = 1;
            bArr[5] = 0;
            Pack.longToLittleEndian(j6, bArr, 8);
        }
    ...
    public class UBI {
        ...
        public void update(byte[] bArr, int i10, int i11, long[] jArr) {
            ...
            while (i11 > i12) {
                ...
                int iMin = Math.min(i11 - i12, this.currentBlock.length - this.currentOffset);
                System.arraycopy(bArr, i10 + i12, this.currentBlock, this.currentOffset, iMin);
                i12 += iMin;
    ...
    public SkeinEngine(int i10, int i11) {
        ...
        if (i11 % 8 != 0) {
            throw new IllegalArgumentException(AbstractC4801l.m9730d(i11, "Output size must be a multiple of 8 bits. :"));
        }
    ...
    private void output(long j6, byte[] bArr, int i10, int i11) {
        byte[] bArr2 = new byte[8];
        Pack.longToLittleEndian(j6, bArr2, 0);
        ...
        for (int i13 = 0; i13 < i12; i13++) {
            ...
            if (iMin == 8) {
                Pack.longToLittleEndian(jArr[i13], bArr, i14 + i10);
            } else {
                Pack.longToLittleEndian(jArr[i13], bArr2, 0);
    ...
    public int doFinal(byte[] bArr, int i10) {
        ...
        for (int i13 = 0; i13 < i12; i13++) {
            ...
            output(i13, bArr, i10 + i14, Math.min(blockSize, this.outputSizeBytes - i14));
        }
        reset();
