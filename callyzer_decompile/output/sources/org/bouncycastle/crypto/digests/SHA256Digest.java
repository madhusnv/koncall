...
public class SHA256Digest extends GeneralDigest implements SavableDigest {
    ...
    private void copyIn(SHA256Digest sHA256Digest) {
        ...
        int[] iArr = sHA256Digest.f27619X;
        System.arraycopy(iArr, 0, this.f27619X, 0, iArr.length);
    ...
    public byte[] getEncodedState() {
        ...
        for (int i11 = 0; i11 != this.xOff; i11++) {
            Pack.intToBigEndian(this.f27619X[i11], bArr, (i11 * 4) + 52);
        }
    ...
    public void processBlock() {
        for (int i10 = 16; i10 <= 63; i10++) {
            int[] iArr = this.f27619X;
            int iTheta1 = Theta1(iArr[i10 - 2]);
            int[] iArr2 = this.f27619X;
            iArr[i10] = iTheta1 + iArr2[i10 - 7] + Theta0(iArr2[i10 - 15]) + this.f27619X[i10 - 16];
        }
        int iSum0 = this.H1;
        int iSum02 = this.H2;
        int iSum03 = this.H3;
        ...
        for (int i16 = 0; i16 < 8; i16++) {
            ...
            int[] iArr3 = f27618K;
            int i17 = iSum1 + iArr3[i15] + this.f27619X[i15] + i14;
            int i18 = iSum04 + i17;
            int iSum05 = Sum0(iSum0) + Maj(iSum0, iSum02, iSum03) + i17;
            int i19 = i15 + 1;
            int iSum12 = Sum1(i18) + Ch(i18, i11, i12) + iArr3[i19] + this.f27619X[i19] + i13;
            int i20 = iSum03 + iSum12;
            int iSum06 = Sum0(iSum05) + Maj(iSum05, iSum0, iSum02) + iSum12;
            int i21 = i15 + 2;
            int iSum13 = Sum1(i20) + Ch(i20, i18, i11) + iArr3[i21] + this.f27619X[i21] + i12;
            int i22 = iSum02 + iSum13;
            int iSum07 = Sum0(iSum06) + Maj(iSum06, iSum05, iSum0) + iSum13;
            int i23 = i15 + 3;
            int iSum14 = Sum1(i22) + Ch(i22, i20, i18) + iArr3[i23] + this.f27619X[i23] + i11;
            int i24 = iSum0 + iSum14;
            int iSum08 = Sum0(iSum07) + Maj(iSum07, iSum06, iSum05) + iSum14;
            int i25 = i15 + 4;
            int iSum15 = Sum1(i24) + Ch(i24, i22, i20) + iArr3[i25] + this.f27619X[i25] + i18;
            i14 = iSum05 + iSum15;
            iSum04 = Sum0(iSum08) + Maj(iSum08, iSum07, iSum06) + iSum15;
            int i26 = i15 + 5;
            int iSum16 = Sum1(i14) + Ch(i14, i24, i22) + iArr3[i26] + this.f27619X[i26] + i20;
            i13 = iSum06 + iSum16;
            iSum03 = Sum0(iSum04) + Maj(iSum04, iSum08, iSum07) + iSum16;
            int i27 = i15 + 6;
            int iSum17 = Sum1(i13) + Ch(i13, i14, i24) + iArr3[i27] + this.f27619X[i27] + i22;
            i12 = iSum07 + iSum17;
            iSum02 = Sum0(iSum03) + Maj(iSum03, iSum04, iSum08) + iSum17;
            int i28 = i15 + 7;
            int iSum18 = Sum1(i12) + Ch(i12, i13, i14) + iArr3[i28] + this.f27619X[i28] + i24;
            i11 = iSum08 + iSum18;
    ...
    public void processWord(byte[] bArr, int i10) {
        this.f27619X[this.xOff] = Pack.bigEndianToInt(bArr, i10);
        int i11 = this.xOff + 1;
        this.xOff = i11;
        if (i11 == 16) {
            processBlock();
    ...
    public SHA256Digest(byte[] bArr) {
        ...
        for (int i10 = 0; i10 != this.xOff; i10++) {
            this.f27619X[i10] = Pack.bigEndianToInt(bArr, (i10 * 4) + 52);
        }
    }
