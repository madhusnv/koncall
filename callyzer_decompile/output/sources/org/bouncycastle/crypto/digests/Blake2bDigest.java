...
public class Blake2bDigest implements ExtendedDigest {
    ...
    private long f44507f0;

    /* renamed from: f1, reason: collision with root package name */
    private long f44508f1;
    private int fanout;
    ...
    private long f44509t0;

    /* renamed from: t1, reason: collision with root package name */
    private long f44510t1;
    ...
    /* renamed from: G */
    private void m11184G(long j6, long j10, int i10, int i11, int i12, int i13) {
        long[] jArr = this.internalState;
        long j11 = jArr[i10] + jArr[i11] + j6;
        jArr[i10] = j11;
        jArr[i13] = Longs.rotateRight(jArr[i13] ^ j11, 32);
        long[] jArr2 = this.internalState;
        long j12 = jArr2[i12] + jArr2[i13];
        jArr2[i12] = j12;
        jArr2[i11] = Longs.rotateRight(j12 ^ jArr2[i11], 24);
        long[] jArr3 = this.internalState;
        long j13 = jArr3[i10] + jArr3[i11] + j10;
        jArr3[i10] = j13;
        jArr3[i13] = Longs.rotateRight(jArr3[i13] ^ j13, 16);
        long[] jArr4 = this.internalState;
        long j14 = jArr4[i12] + jArr4[i13];
        jArr4[i12] = j14;
        jArr4[i11] = Longs.rotateRight(j14 ^ jArr4[i11], 63);
    }

    private void compress(byte[] bArr, int i10) {
        initializeInternalState();
        long[] jArr = new long[16];
        Pack.littleEndianToLong(bArr, i10, jArr);
        int i11 = 0;
        for (int i12 = 0; i12 < ROUNDS; i12++) {
            byte[][] bArr2 = blake2b_sigma;
            byte[] bArr3 = bArr2[i12];
            m11184G(jArr[bArr3[0]], jArr[bArr3[1]], 0, 4, 8, 12);
            byte[] bArr4 = bArr2[i12];
            m11184G(jArr[bArr4[2]], jArr[bArr4[3]], 1, 5, 9, 13);
            byte[] bArr5 = bArr2[i12];
            m11184G(jArr[bArr5[4]], jArr[bArr5[5]], 2, 6, 10, 14);
            byte[] bArr6 = bArr2[i12];
            m11184G(jArr[bArr6[6]], jArr[bArr6[7]], 3, 7, 11, 15);
            byte[] bArr7 = bArr2[i12];
            m11184G(jArr[bArr7[8]], jArr[bArr7[9]], 0, 5, 10, 15);
            byte[] bArr8 = bArr2[i12];
            m11184G(jArr[bArr8[10]], jArr[bArr8[11]], 1, 6, 11, 12);
            byte[] bArr9 = bArr2[i12];
            m11184G(jArr[bArr9[12]], jArr[bArr9[13]], 2, 7, 8, 13);
            byte[] bArr10 = bArr2[i12];
            m11184G(jArr[bArr10[14]], jArr[bArr10[15]], 3, 4, 9, 14);
        }
        while (true) {
            ...
            long j6 = jArr2[i11];
            long[] jArr3 = this.internalState;
            jArr2[i11] = (j6 ^ jArr3[i11]) ^ jArr3[i11 + 8];
            i11++;
        }
    }
    ...
    private void init() {
        if (this.chainValue == null) {
            ...
            byte[] bArr = this.salt;
            if (bArr != null) {
                jArr[4] = j6 ^ Pack.littleEndianToLong(bArr, 0);
            ...
            if (bArr2 != null) {
                jArr4[6] = Pack.littleEndianToLong(bArr2, 0) ^ j10;
    ...
    private void initializeInternalState() {
        ...
        long[] jArr3 = this.internalState;
        jArr3[12] = this.f44509t0 ^ jArr2[4];
        jArr3[13] = this.f44510t1 ^ jArr2[5];
        jArr3[14] = this.f44507f0 ^ jArr2[6];
        jArr3[15] = this.f44508f1 ^ jArr2[7];
    }
    ...
    public int doFinal(byte[] bArr, int i10) {
        ...
        int i13 = i12 >>> 3;
        int i14 = i12 & 7;
        Pack.longToLittleEndian(this.chainValue, 0, i13, bArr, i10);
        if (i14 > 0) {
            byte[] bArr2 = new byte[8];
            Pack.longToLittleEndian(this.chainValue[i13], bArr2, 0);
            System.arraycopy(bArr2, 0, bArr, (i10 + this.digestLength) - i14, i14);
        }
    ...
    public void update(byte[] bArr, int i10, int i11) {
        ...
        i11 = i14 - i16;
        System.arraycopy(bArr, i16, this.buffer, 0, i11);
        this.bufferPos += i11;
    }

    public Blake2bDigest(int i10, CryptoServicePurpose cryptoServicePurpose) {
    ...
    public Blake2bDigest(Blake2bDigest blake2bDigest) {
        ...
        this.f44509t0 = blake2bDigest.f44509t0;
        this.f44510t1 = blake2bDigest.f44510t1;
        this.f44507f0 = blake2bDigest.f44507f0;
    ...
    public Blake2bDigest(byte[] bArr, int i10, byte[] bArr2, byte[] bArr3, CryptoServicePurpose cryptoServicePurpose) {
        this.digestLength = 64;
        this.keyLength = 0;
        this.salt = null;
        this.personalization = null;
