...
public class DualECSP800DRBG implements SP80090DRBG {
    ...
    static {
        ...
        nistPoints = new DualECPoints[]{new DualECPoints(128, fp.createPoint(bigInteger, bigInteger2), fp.createPoint(bigInteger3, bigInteger4), 1), new DualECPoints(BERTags.PRIVATE, fp.createPoint(bigInteger5, bigInteger6), fp.createPoint(bigInteger7, bigInteger8), 1), new DualECPoints(256, fp.createPoint(bigInteger9, bigInteger10), fp.createPoint(bigInteger11, bigInteger12), 1)};
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z6) {
        ...
        if (i10 < bArr.length) {
            ...
            if (length5 > i13) {
                System.arraycopy(byteArray2, byteArray2.length - i13, bArr, i10, length4);
            } else {
                System.arraycopy(byteArray2, 0, bArr, (i13 - byteArray2.length) + i10, length4);
            }
            this._reseedCounter++;
        }
    ...
    */
    public DualECSP800DRBG(org.bouncycastle.crypto.prng.drbg.DualECPoints[] r2, org.bouncycastle.crypto.Digest r3, int r4, org.bouncycastle.crypto.prng.EntropySource r5, byte[] r6, byte[] r7) {
        ...
        L92:
            java.lang.IllegalArgumentException r2 = new java.lang.IllegalArgumentException
            java.lang.String r3 = "EntropySource must provide between "
            java.lang.String r5 = " and 4096 bits"
            java.lang.String r3 = org.bouncycastle.jcajce.provider.digest.AbstractC5601a.m11232c(r4, r3, r5)
            r2.<init>(r3)
            throw r2
        La0:
            java.lang.IllegalArgumentException r2 = new java.lang.IllegalArgumentException
