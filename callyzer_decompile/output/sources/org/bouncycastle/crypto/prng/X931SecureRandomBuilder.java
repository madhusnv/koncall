...
public class X931SecureRandomBuilder {
    ...
    public X931SecureRandom build(BlockCipher blockCipher, KeyParameter keyParameter, boolean z6) {
        ...
        return new X931SecureRandom(this.random, new X931RNG(blockCipher, this.dateTimeVector, this.entropySourceProvider.get(blockCipher.getBlockSize() * 8)), z6);
    }
    ...
    public X931SecureRandomBuilder(SecureRandom secureRandom, boolean z6) {
