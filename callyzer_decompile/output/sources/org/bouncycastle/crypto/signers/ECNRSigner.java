...
public class ECNRSigner implements DSAExt {
    ...
    private BigInteger extractT(ECPublicKeyParameters eCPublicKeyParameters, BigInteger bigInteger, BigInteger bigInteger2) {
        BigInteger n6 = eCPublicKeyParameters.getParameters().getN();
        if (bigInteger.compareTo(ECConstants.ONE) < 0 || bigInteger.compareTo(n6) >= 0 || bigInteger2.compareTo(ECConstants.ZERO) < 0 || bigInteger2.compareTo(n6) >= 0) {
            return null;
        }
        ...
        return bigInteger.subtract(eCPointNormalize.getAffineXCoord().toBigInteger()).mod(n6);
    }
    ...
    public void init(boolean z6, CipherParameters cipherParameters) {
        ...
        CryptoServicesRegistrar.checkConstraints(Utils.getDefaultProperties("ECNR", this.key, z6));
    }
    ...
    public boolean verifySignature(byte[] bArr, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        return bigIntegerExtractT != null && bigIntegerExtractT.equals(bigInteger3.mod(n6));
    }
}
