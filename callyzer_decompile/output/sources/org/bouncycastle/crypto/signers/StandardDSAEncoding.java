...
public class StandardDSAEncoding implements DSAEncoding {
    ...
    public BigInteger decodeValue(BigInteger bigInteger, ASN1Sequence aSN1Sequence, int i10) {
        return checkValue(bigInteger, ((ASN1Integer) aSN1Sequence.getObjectAt(i10)).getValue());
    }
