...
public class CamelliaEngine implements BlockCipher {
    ...
    private int[] f44550kw = new int[8];

    /* renamed from: ke, reason: collision with root package name */
    private int[] f44549ke = new int[12];
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i10) {
        ...
        int i12 = iArr3[i11 & 255];
        int[] iArr4 = SBOX3_3033;
        int i13 = i12 ^ iArr4[(i11 >>> 8) & 255];
        int[] iArr5 = SBOX2_0222;
        int i14 = i13 ^ iArr5[(i11 >>> 16) & 255];
        int[] iArr6 = SBOX1_1110;
        int i15 = iArr6[(i11 >>> 24) & 255] ^ i14;
        int i16 = iArr[1] ^ iArr2[i10 + 1];
        int i17 = (iArr5[(i16 >>> 24) & 255] ^ ((iArr6[i16 & 255] ^ iArr3[(i16 >>> 8) & 255]) ^ iArr4[(i16 >>> 16) & 255])) ^ i15;
        iArr[2] = iArr[2] ^ i17;
        int iRightRotate = (rightRotate(i15, 8) ^ i17) ^ iArr[3];
        iArr[3] = iRightRotate;
        int i18 = iArr[2] ^ iArr2[i10 + 2];
        int i19 = iArr6[(i18 >>> 24) & 255] ^ ((iArr3[i18 & 255] ^ iArr4[(i18 >>> 8) & 255]) ^ iArr5[(i18 >>> 16) & 255]);
        int i20 = iArr2[i10 + 3] ^ iRightRotate;
        int i21 = (iArr5[(i20 >>> 24) & 255] ^ ((iArr6[i20 & 255] ^ iArr3[(i20 >>> 8) & 255]) ^ iArr4[(i20 >>> 16) & 255])) ^ i19;
        iArr[0] = iArr[0] ^ i21;
        iArr[1] = (i21 ^ rightRotate(i19, 8)) ^ iArr[1];
    }
    ...
    private int processBlock192or256(byte[] bArr, int i10, byte[] bArr2, int i11) {
        ...
        camelliaF2(iArr, this.subkey, 28);
        camelliaF2(iArr, this.subkey, 32);
        camelliaFLs(iArr, this.f44549ke, 8);
    ...
    private void setKey(boolean z6, byte[] bArr) {
        ...
        if (this._keySize == 16) {
            ...
            if (z6) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f44549ke, 4);
                ...
                roldq(15, iArr2, 0, this.f44549ke, 0);
                ...
                roldq(17, iArr2, 0, this.f44550kw, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            ...
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f44549ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f44549ke, 4);
            ...
            roldq(17, iArr2, 0, this.f44550kw, 0);
            return;
        }
        for (int i12 = 0; i12 < 4; i12++) {
        ...
        if (z6) {
            ...
            roldq(15, iArr, 0, this.f44549ke, 4);
            roldq(17, iArr, 0, this.subkey, 32);
            roldqo32(34, iArr, 0, this.subkey, 44);
            roldq(15, iArr, 4, this.subkey, 4);
            roldq(15, iArr, 4, this.f44549ke, 0);
            ...
            roldqo32(51, iArr3, 0, this.f44550kw, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        ...
        roldqo32(51, iArr3, 0, this.f44550kw, 0);
    }
