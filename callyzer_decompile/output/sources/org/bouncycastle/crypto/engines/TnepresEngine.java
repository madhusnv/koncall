...
public final class TnepresEngine extends SerpentEngineBase {
    ...
    public void decryptBlock(byte[] bArr, int i10, byte[] bArr2, int i11) {
        int[] iArr = {iBigEndianToInt, this.wKey[129] ^ Pack.bigEndianToInt(bArr, i10 + 8), this.wKey[130] ^ Pack.bigEndianToInt(bArr, i10 + 4), this.wKey[131] ^ Pack.bigEndianToInt(bArr, i10)};
        int iBigEndianToInt = this.wKey[128] ^ Pack.bigEndianToInt(bArr, i10 + 12);
        ib7(iArr, iBigEndianToInt, iArr[1], iArr[2], iArr[3]);
        int i12 = iArr[0];
        int[] iArr2 = this.wKey;
        ...
        inverseLT(iArr);
        ib0(iArr, iArr[0], iArr[1], iArr[2], iArr[3]);
        Pack.intToBigEndian(iArr[3] ^ this.wKey[3], bArr2, i11);
        Pack.intToBigEndian(iArr[2] ^ this.wKey[2], bArr2, i11 + 4);
        Pack.intToBigEndian(iArr[1] ^ this.wKey[1], bArr2, i11 + 8);
        Pack.intToBigEndian(this.wKey[0] ^ iArr[0], bArr2, i11 + 12);
    }

    @Override // org.bouncycastle.crypto.engines.SerpentEngineBase
    public void encryptBlock(byte[] bArr, int i10, byte[] bArr2, int i11) {
        int[] iArr = {iBigEndianToInt, Pack.bigEndianToInt(bArr, i10 + 8), Pack.bigEndianToInt(bArr, i10 + 4), Pack.bigEndianToInt(bArr, i10)};
        int iBigEndianToInt = Pack.bigEndianToInt(bArr, i10 + 12);
        int[] iArr2 = this.wKey;
        sb0(iArr, iArr2[0] ^ iBigEndianToInt, iArr[1] ^ iArr2[1], iArr[2] ^ iArr2[2], iArr2[3] ^ iArr[3]);
        LT(iArr);
        int[] iArr3 = this.wKey;
        sb1(iArr, iArr[0] ^ iArr3[4], iArr[1] ^ iArr3[5], iArr[2] ^ iArr3[6], iArr3[7] ^ iArr[3]);
        LT(iArr);
        int[] iArr4 = this.wKey;
        sb2(iArr, iArr[0] ^ iArr4[8], iArr[1] ^ iArr4[9], iArr[2] ^ iArr4[10], iArr4[11] ^ iArr[3]);
        LT(iArr);
        int[] iArr5 = this.wKey;
        sb3(iArr, iArr[0] ^ iArr5[12], iArr[1] ^ iArr5[13], iArr[2] ^ iArr5[14], iArr5[15] ^ iArr[3]);
        LT(iArr);
        int[] iArr6 = this.wKey;
        sb4(iArr, iArr[0] ^ iArr6[16], iArr[1] ^ iArr6[17], iArr[2] ^ iArr6[18], iArr6[19] ^ iArr[3]);
        LT(iArr);
        int[] iArr7 = this.wKey;
        sb5(iArr, iArr[0] ^ iArr7[20], iArr[1] ^ iArr7[21], iArr[2] ^ iArr7[22], iArr7[23] ^ iArr[3]);
        LT(iArr);
        int[] iArr8 = this.wKey;
        sb6(iArr, iArr[0] ^ iArr8[24], iArr[1] ^ iArr8[25], iArr[2] ^ iArr8[26], iArr8[27] ^ iArr[3]);
        LT(iArr);
        int[] iArr9 = this.wKey;
        sb7(iArr, iArr[0] ^ iArr9[28], iArr[1] ^ iArr9[29], iArr[2] ^ iArr9[30], iArr9[31] ^ iArr[3]);
        LT(iArr);
        int[] iArr10 = this.wKey;
        sb0(iArr, iArr[0] ^ iArr10[32], iArr[1] ^ iArr10[33], iArr[2] ^ iArr10[34], iArr10[35] ^ iArr[3]);
        LT(iArr);
        int[] iArr11 = this.wKey;
        sb1(iArr, iArr[0] ^ iArr11[36], iArr[1] ^ iArr11[37], iArr[2] ^ iArr11[38], iArr11[39] ^ iArr[3]);
        LT(iArr);
        int[] iArr12 = this.wKey;
        sb2(iArr, iArr[0] ^ iArr12[40], iArr[1] ^ iArr12[41], iArr[2] ^ iArr12[42], iArr12[43] ^ iArr[3]);
        LT(iArr);
        int[] iArr13 = this.wKey;
        sb3(iArr, iArr[0] ^ iArr13[44], iArr[1] ^ iArr13[45], iArr[2] ^ iArr13[46], iArr13[47] ^ iArr[3]);
        LT(iArr);
        int[] iArr14 = this.wKey;
        sb4(iArr, iArr[0] ^ iArr14[48], iArr[1] ^ iArr14[49], iArr[2] ^ iArr14[50], iArr14[51] ^ iArr[3]);
        LT(iArr);
        int[] iArr15 = this.wKey;
        sb5(iArr, iArr[0] ^ iArr15[52], iArr[1] ^ iArr15[53], iArr[2] ^ iArr15[54], iArr15[55] ^ iArr[3]);
        LT(iArr);
        int[] iArr16 = this.wKey;
        sb6(iArr, iArr[0] ^ iArr16[56], iArr[1] ^ iArr16[57], iArr[2] ^ iArr16[58], iArr16[59] ^ iArr[3]);
        LT(iArr);
        int[] iArr17 = this.wKey;
        sb7(iArr, iArr[0] ^ iArr17[60], iArr[1] ^ iArr17[61], iArr[2] ^ iArr17[62], iArr17[63] ^ iArr[3]);
        LT(iArr);
        int[] iArr18 = this.wKey;
        sb0(iArr, iArr[0] ^ iArr18[64], iArr[1] ^ iArr18[65], iArr[2] ^ iArr18[66], iArr18[67] ^ iArr[3]);
        LT(iArr);
        int[] iArr19 = this.wKey;
        sb1(iArr, iArr[0] ^ iArr19[68], iArr[1] ^ iArr19[69], iArr[2] ^ iArr19[70], iArr19[71] ^ iArr[3]);
        LT(iArr);
        int[] iArr20 = this.wKey;
        sb2(iArr, iArr[0] ^ iArr20[72], iArr[1] ^ iArr20[73], iArr[2] ^ iArr20[74], iArr20[75] ^ iArr[3]);
        LT(iArr);
        int[] iArr21 = this.wKey;
        sb3(iArr, iArr[0] ^ iArr21[76], iArr[1] ^ iArr21[77], iArr[2] ^ iArr21[78], iArr21[79] ^ iArr[3]);
        LT(iArr);
        int[] iArr22 = this.wKey;
        sb4(iArr, iArr[0] ^ iArr22[80], iArr[1] ^ iArr22[81], iArr[2] ^ iArr22[82], iArr22[83] ^ iArr[3]);
        LT(iArr);
        int[] iArr23 = this.wKey;
        sb5(iArr, iArr[0] ^ iArr23[84], iArr[1] ^ iArr23[85], iArr[2] ^ iArr23[86], iArr23[87] ^ iArr[3]);
        LT(iArr);
        int[] iArr24 = this.wKey;
        sb6(iArr, iArr[0] ^ iArr24[88], iArr[1] ^ iArr24[89], iArr[2] ^ iArr24[90], iArr24[91] ^ iArr[3]);
        LT(iArr);
        int[] iArr25 = this.wKey;
        sb7(iArr, iArr[0] ^ iArr25[92], iArr[1] ^ iArr25[93], iArr[2] ^ iArr25[94], iArr25[95] ^ iArr[3]);
        LT(iArr);
        int[] iArr26 = this.wKey;
        sb0(iArr, iArr[0] ^ iArr26[96], iArr[1] ^ iArr26[97], iArr[2] ^ iArr26[98], iArr26[99] ^ iArr[3]);
        LT(iArr);
        int[] iArr27 = this.wKey;
        sb1(iArr, iArr[0] ^ iArr27[100], iArr[1] ^ iArr27[101], iArr[2] ^ iArr27[102], iArr27[103] ^ iArr[3]);
        LT(iArr);
        int[] iArr28 = this.wKey;
        sb2(iArr, iArr[0] ^ iArr28[104], iArr[1] ^ iArr28[105], iArr[2] ^ iArr28[106], iArr28[107] ^ iArr[3]);
        LT(iArr);
        int[] iArr29 = this.wKey;
        sb3(iArr, iArr[0] ^ iArr29[108], iArr[1] ^ iArr29[109], iArr[2] ^ iArr29[110], iArr29[111] ^ iArr[3]);
        LT(iArr);
        int[] iArr30 = this.wKey;
        sb4(iArr, iArr[0] ^ iArr30[112], iArr[1] ^ iArr30[113], iArr[2] ^ iArr30[114], iArr30[115] ^ iArr[3]);
        LT(iArr);
        int[] iArr31 = this.wKey;
        sb5(iArr, iArr[0] ^ iArr31[116], iArr[1] ^ iArr31[117], iArr[2] ^ iArr31[118], iArr31[119] ^ iArr[3]);
        LT(iArr);
        int[] iArr32 = this.wKey;
        sb6(iArr, iArr[0] ^ iArr32[120], iArr[1] ^ iArr32[121], iArr[2] ^ iArr32[122], iArr32[123] ^ iArr[3]);
        LT(iArr);
        int[] iArr33 = this.wKey;
        sb7(iArr, iArr[0] ^ iArr33[124], iArr[1] ^ iArr33[125], iArr[2] ^ iArr33[126], iArr33[127] ^ iArr[3]);
        Pack.intToBigEndian(this.wKey[131] ^ iArr[3], bArr2, i11);
        Pack.intToBigEndian(this.wKey[130] ^ iArr[2], bArr2, i11 + 4);
        Pack.intToBigEndian(this.wKey[129] ^ iArr[1], bArr2, i11 + 8);
        Pack.intToBigEndian(this.wKey[128] ^ iArr[0], bArr2, i11 + 12);
    }
    ...
    public int[] makeWorkingKey(byte[] bArr) {
        ...
        int i10 = 0;
        while (length > 0) {
            iArr[i10] = Pack.bigEndianToInt(bArr, length);
            length -= 4;
            i10++;
        }
        if (length != 0) {
        ...
        int i11 = i10 + 1;
        iArr[i10] = Pack.bigEndianToInt(bArr, 0);
        if (i11 < 8) {
            iArr[i11] = 1;
        }
