...
public final class SerpentEngine extends SerpentEngineBase {
    ...
    public void decryptBlock(byte[] bArr, int i10, byte[] bArr2, int i11) {
        int iLittleEndianToInt = this.wKey[131] ^ Pack.littleEndianToInt(bArr, i10 + 12);
        int[] iArr = {this.wKey[128] ^ Pack.littleEndianToInt(bArr, i10), this.wKey[129] ^ Pack.littleEndianToInt(bArr, i10 + 4), this.wKey[130] ^ Pack.littleEndianToInt(bArr, i10 + 8), iLittleEndianToInt};
        ib7(iArr, iArr[0], iArr[1], iArr[2], iLittleEndianToInt);
        int i12 = iArr[0];
        int[] iArr2 = this.wKey;
        iArr[0] = i12 ^ iArr2[124];
        ...
        inverseLT(iArr);
        ib0(iArr, iArr[0], iArr[1], iArr[2], iArr[3]);
        Pack.intToLittleEndian(iArr[0] ^ this.wKey[0], bArr2, i11);
        Pack.intToLittleEndian(iArr[1] ^ this.wKey[1], bArr2, i11 + 4);
        Pack.intToLittleEndian(iArr[2] ^ this.wKey[2], bArr2, i11 + 8);
        Pack.intToLittleEndian(this.wKey[3] ^ iArr[3], bArr2, i11 + 12);
    }

    @Override // org.bouncycastle.crypto.engines.SerpentEngineBase
    public void encryptBlock(byte[] bArr, int i10, byte[] bArr2, int i11) {
        int[] iArr = {Pack.littleEndianToInt(bArr, i10), Pack.littleEndianToInt(bArr, i10 + 4), Pack.littleEndianToInt(bArr, i10 + 8), Pack.littleEndianToInt(bArr, i10 + 12)};
        int[] iArr2 = this.wKey;
        sb0(iArr, iArr2[0] ^ iArr[0], iArr2[1] ^ iArr[1], iArr2[2] ^ iArr[2], iArr2[3] ^ iArr[3]);
        LT(iArr);
        int[] iArr3 = this.wKey;
        sb1(iArr, iArr3[4] ^ iArr[0], iArr3[5] ^ iArr[1], iArr3[6] ^ iArr[2], iArr[3] ^ iArr3[7]);
        LT(iArr);
        int[] iArr4 = this.wKey;
        sb2(iArr, iArr4[8] ^ iArr[0], iArr4[9] ^ iArr[1], iArr4[10] ^ iArr[2], iArr[3] ^ iArr4[11]);
        LT(iArr);
        int[] iArr5 = this.wKey;
        sb3(iArr, iArr5[12] ^ iArr[0], iArr5[13] ^ iArr[1], iArr5[14] ^ iArr[2], iArr[3] ^ iArr5[15]);
        LT(iArr);
        int[] iArr6 = this.wKey;
        sb4(iArr, iArr6[16] ^ iArr[0], iArr6[17] ^ iArr[1], iArr6[18] ^ iArr[2], iArr[3] ^ iArr6[19]);
        LT(iArr);
        int[] iArr7 = this.wKey;
        sb5(iArr, iArr7[20] ^ iArr[0], iArr7[21] ^ iArr[1], iArr7[22] ^ iArr[2], iArr[3] ^ iArr7[23]);
        LT(iArr);
        int[] iArr8 = this.wKey;
        sb6(iArr, iArr8[24] ^ iArr[0], iArr8[25] ^ iArr[1], iArr8[26] ^ iArr[2], iArr[3] ^ iArr8[27]);
        LT(iArr);
        int[] iArr9 = this.wKey;
        sb7(iArr, iArr9[28] ^ iArr[0], iArr9[29] ^ iArr[1], iArr9[30] ^ iArr[2], iArr[3] ^ iArr9[31]);
        LT(iArr);
        int[] iArr10 = this.wKey;
        sb0(iArr, iArr10[32] ^ iArr[0], iArr10[33] ^ iArr[1], iArr10[34] ^ iArr[2], iArr[3] ^ iArr10[35]);
        LT(iArr);
        int[] iArr11 = this.wKey;
        sb1(iArr, iArr11[36] ^ iArr[0], iArr11[37] ^ iArr[1], iArr11[38] ^ iArr[2], iArr[3] ^ iArr11[39]);
        LT(iArr);
        int[] iArr12 = this.wKey;
        sb2(iArr, iArr12[40] ^ iArr[0], iArr12[41] ^ iArr[1], iArr12[42] ^ iArr[2], iArr[3] ^ iArr12[43]);
        LT(iArr);
        int[] iArr13 = this.wKey;
        sb3(iArr, iArr13[44] ^ iArr[0], iArr13[45] ^ iArr[1], iArr13[46] ^ iArr[2], iArr[3] ^ iArr13[47]);
        LT(iArr);
        int[] iArr14 = this.wKey;
        sb4(iArr, iArr14[48] ^ iArr[0], iArr14[49] ^ iArr[1], iArr14[50] ^ iArr[2], iArr[3] ^ iArr14[51]);
        LT(iArr);
        int[] iArr15 = this.wKey;
        sb5(iArr, iArr15[52] ^ iArr[0], iArr15[53] ^ iArr[1], iArr15[54] ^ iArr[2], iArr[3] ^ iArr15[55]);
        LT(iArr);
        int[] iArr16 = this.wKey;
        sb6(iArr, iArr16[56] ^ iArr[0], iArr16[57] ^ iArr[1], iArr16[58] ^ iArr[2], iArr[3] ^ iArr16[59]);
        LT(iArr);
        int[] iArr17 = this.wKey;
        sb7(iArr, iArr17[60] ^ iArr[0], iArr17[61] ^ iArr[1], iArr17[62] ^ iArr[2], iArr[3] ^ iArr17[63]);
        LT(iArr);
        int[] iArr18 = this.wKey;
        sb0(iArr, iArr18[64] ^ iArr[0], iArr18[65] ^ iArr[1], iArr18[66] ^ iArr[2], iArr[3] ^ iArr18[67]);
        LT(iArr);
        int[] iArr19 = this.wKey;
        sb1(iArr, iArr19[68] ^ iArr[0], iArr19[69] ^ iArr[1], iArr19[70] ^ iArr[2], iArr[3] ^ iArr19[71]);
        LT(iArr);
        int[] iArr20 = this.wKey;
        sb2(iArr, iArr20[72] ^ iArr[0], iArr20[73] ^ iArr[1], iArr20[74] ^ iArr[2], iArr[3] ^ iArr20[75]);
        LT(iArr);
        int[] iArr21 = this.wKey;
        sb3(iArr, iArr21[76] ^ iArr[0], iArr21[77] ^ iArr[1], iArr21[78] ^ iArr[2], iArr[3] ^ iArr21[79]);
        LT(iArr);
        int[] iArr22 = this.wKey;
        sb4(iArr, iArr22[80] ^ iArr[0], iArr22[81] ^ iArr[1], iArr22[82] ^ iArr[2], iArr[3] ^ iArr22[83]);
        LT(iArr);
        int[] iArr23 = this.wKey;
        sb5(iArr, iArr23[84] ^ iArr[0], iArr23[85] ^ iArr[1], iArr23[86] ^ iArr[2], iArr[3] ^ iArr23[87]);
        LT(iArr);
        int[] iArr24 = this.wKey;
        sb6(iArr, iArr24[88] ^ iArr[0], iArr24[89] ^ iArr[1], iArr24[90] ^ iArr[2], iArr[3] ^ iArr24[91]);
        LT(iArr);
        int[] iArr25 = this.wKey;
        sb7(iArr, iArr25[92] ^ iArr[0], iArr25[93] ^ iArr[1], iArr25[94] ^ iArr[2], iArr[3] ^ iArr25[95]);
        LT(iArr);
        int[] iArr26 = this.wKey;
        sb0(iArr, iArr26[96] ^ iArr[0], iArr26[97] ^ iArr[1], iArr26[98] ^ iArr[2], iArr[3] ^ iArr26[99]);
        LT(iArr);
        int[] iArr27 = this.wKey;
        sb1(iArr, iArr27[100] ^ iArr[0], iArr27[101] ^ iArr[1], iArr27[102] ^ iArr[2], iArr[3] ^ iArr27[103]);
        LT(iArr);
        int[] iArr28 = this.wKey;
        sb2(iArr, iArr28[104] ^ iArr[0], iArr28[105] ^ iArr[1], iArr28[106] ^ iArr[2], iArr[3] ^ iArr28[107]);
        LT(iArr);
        int[] iArr29 = this.wKey;
        sb3(iArr, iArr29[108] ^ iArr[0], iArr29[109] ^ iArr[1], iArr29[110] ^ iArr[2], iArr[3] ^ iArr29[111]);
        LT(iArr);
        int[] iArr30 = this.wKey;
        sb4(iArr, iArr30[112] ^ iArr[0], iArr30[113] ^ iArr[1], iArr30[114] ^ iArr[2], iArr[3] ^ iArr30[115]);
        LT(iArr);
        int[] iArr31 = this.wKey;
        sb5(iArr, iArr31[116] ^ iArr[0], iArr31[117] ^ iArr[1], iArr31[118] ^ iArr[2], iArr[3] ^ iArr31[119]);
        LT(iArr);
        int[] iArr32 = this.wKey;
        sb6(iArr, iArr32[120] ^ iArr[0], iArr32[121] ^ iArr[1], iArr32[122] ^ iArr[2], iArr[3] ^ iArr32[123]);
        LT(iArr);
        int[] iArr33 = this.wKey;
        sb7(iArr, iArr33[124] ^ iArr[0], iArr33[125] ^ iArr[1], iArr33[126] ^ iArr[2], iArr[3] ^ iArr33[127]);
        Pack.intToLittleEndian(this.wKey[128] ^ iArr[0], bArr2, i11);
        Pack.intToLittleEndian(this.wKey[129] ^ iArr[1], bArr2, i11 + 4);
        Pack.intToLittleEndian(this.wKey[130] ^ iArr[2], bArr2, i11 + 8);
        Pack.intToLittleEndian(this.wKey[131] ^ iArr[3], bArr2, i11 + 12);
    }
    ...
    public int[] makeWorkingKey(byte[] bArr) {
        ...
        for (int i14 = 8; i14 < 16; i14++) {
            int i15 = i14 - 8;
            iArr[i14] = SerpentEngineBase.rotateLeft(((-1640531527) ^ (((iArr[i15] ^ iArr[i14 - 5]) ^ iArr[i14 - 3]) ^ iArr[i14 - 1])) ^ i15, 11);
        }
        System.arraycopy(iArr, 8, iArr2, 0, 8);
        for (int i16 = 8; i16 < 132; i16++) {
            iArr2[i16] = SerpentEngineBase.rotateLeft(((((iArr2[i16 - 8] ^ iArr2[i16 - 5]) ^ iArr2[i16 - 3]) ^ iArr2[i16 - 1]) ^ (-1640531527)) ^ i16, 11);
        }
        int[] iArr3 = new int[4];
