...
public class Shacal2Engine implements BlockCipher {
    ...
    private void byteBlockToInts(byte[] bArr, int[] iArr, int i10, int i11) {
        while (i11 < 8) {
            ...
            int i13 = i10 + 3;
            int i14 = ((bArr[i10 + 2] & 255) << 8) | i12;
            i10 += 4;
            iArr[i11] = i14 | (bArr[i13] & 255);
            i11++;
        }
    }
    ...
    private void decryptBlock(byte[] bArr, int i10, byte[] bArr2, int i11) {
        ...
        for (int i12 = 63; i12 > -1; i12--) {
            ...
            int i20 = iArr[7];
            iArr[6] = i20;
            iArr[7] = (((i17 - f27670K[i12]) - this.workingKey[i12]) - ((((i18 >>> 6) | (i18 << (-6))) ^ ((i18 >>> 11) | (i18 << (-11)))) ^ ((i18 >>> 25) | (i18 << (-25))))) - ((i18 & i19) ^ ((~i18) & i20));
        }
    ...
    private void encryptBlock(byte[] bArr, int i10, byte[] bArr2, int i11) {
        ...
        for (int i12 = 0; i12 < 64; i12++) {
            ...
            int i15 = ~i13;
            int i16 = iArr[6];
            int i17 = ((((i13 >>> 6) | (i13 << (-6))) ^ ((i13 >>> 11) | (i13 << (-11)))) ^ ((i13 >>> 25) | (i13 << (-25)))) + ((i13 & i14) ^ (i15 & i16)) + iArr[7] + f27670K[i12] + this.workingKey[i12];
            iArr[7] = i16;
            iArr[6] = i14;
            iArr[5] = i13;
            iArr[4] = iArr[3] + i17;
