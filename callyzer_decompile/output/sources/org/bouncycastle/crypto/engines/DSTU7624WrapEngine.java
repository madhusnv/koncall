...
public class DSTU7624WrapEngine implements Wrapper {
    ...
    public DSTU7624WrapEngine(int i10) {
        ...
        this.f27641B = new byte[dSTU7624Engine.getBlockSize() / 2];
    ...
    public byte[] wrap(byte[] bArr, int i10, int i11) {
        ...
        System.arraycopy(bArr, i10, bArr2, 0, i11);
        System.arraycopy(bArr2, 0, this.f27641B, 0, this.engine.getBlockSize() / 2);
        this.Btemp.clear();
        ...
        int i14 = 0;
        while (i14 < i13) {
            System.arraycopy(this.f27641B, 0, bArr2, 0, this.engine.getBlockSize() / 2);
            ...
            System.arraycopy(bArr2, this.engine.getBlockSize() / 2, this.f27641B, 0, this.engine.getBlockSize() / 2);
            for (int i16 = 2; i16 < blockSize; i16++) {
