...
public class DESEngine extends DESBase implements BlockCipher {
    ...
    private static final int[] bigbyte = {8388608, 4194304, 2097152, 1048576, 524288, 262144, 131072, 65536, 32768, 16384, 8192, 4096, NewHope.SENDB_BYTES, 1024, 512, 256, 128, 64, 32, 16, 8, 4, 2, 1};
    ...
    public void desFunc(int[] iArr, byte[] bArr, int i10, byte[] bArr2, int i11) {
        ...
        int i12 = ((iBigEndianToInt >>> 4) ^ iBigEndianToInt2) & 252645135;
        int i13 = iBigEndianToInt2 ^ i12;
        int i14 = iBigEndianToInt ^ (i12 << 4);
        int i15 = ((i14 >>> 16) ^ i13) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH;
        int i16 = i13 ^ i15;
        int i17 = i14 ^ (i15 << 16);
        ...
        int i52 = i49 ^ i51;
        int i53 = i50 ^ (i51 << 2);
        int i54 = ((i52 >>> 16) ^ i53) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH;
        int i55 = i53 ^ i54;
        int i56 = i52 ^ (i54 << 16);
        int i57 = ((i56 >>> 4) ^ i55) & 252645135;
        Pack.intToBigEndian(i56 ^ (i57 << 4), bArr2, i11);
        Pack.intToBigEndian(i55 ^ i57, bArr2, i11 + 4);
    }

    @Override // org.bouncycastle.crypto.engines.DESBase
    public int[] generateWorkingKey(boolean z6, byte[] bArr) {
        int i10;
        int[] iArr = new int[32];
    ...
    public void init(boolean z6, CipherParameters cipherParameters) {
        if (!(cipherParameters instanceof KeyParameter)) {
            throw new IllegalArgumentException(AbstractC4801l.m9736j("invalid parameter passed to DES init - ", cipherParameters));
        }
        ...
        this.workingKey = generateWorkingKey(z6, keyParameter.getKey());
