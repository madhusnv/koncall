...
public class ARIAEngine implements BlockCipher {
    ...
    /* renamed from: C */
    private static final byte[][] f27636C = {Hex.decodeStrict("517cc1b727220a94fe13abe8fa9a6ee0"), Hex.decodeStrict("6db14acc9e21c820ff28b1d5ef5de2b0"), Hex.decodeStrict("db92371d2126e9700324977504e8c90e")};
    ...
    /* renamed from: A */
    public static void m11203A(byte[] bArr) {
        byte b10 = bArr[0];
        byte b11 = bArr[1];
        byte b12 = bArr[2];
        byte b13 = bArr[3];
    ...
    public static byte[][] keySchedule(boolean z6, byte[] bArr) {
        ...
        int i12 = i11 * 2;
        int i13 = i12 + 12;
        byte[][] bArr12 = (byte[][]) Array.newInstance((Class<?>) Byte.TYPE, i12 + 13, 16);
    ...
    public static void keyScheduleRound(byte[] bArr, byte[] bArr2, byte[] bArr3, int i10) {
        int i11 = i10 >>> 3;
        int i12 = i10 & 7;
        int i13 = 8 - i12;
    ...
    public void init(boolean z6, CipherParameters cipherParameters) {
        if (!(cipherParameters instanceof KeyParameter)) {
            throw new IllegalArgumentException(AbstractC4801l.m9736j("invalid parameter passed to ARIA init - ", cipherParameters));
        }
        this.forEncryption = z6;
        this.roundKeys = keySchedule(z6, ((KeyParameter) cipherParameters).getKey());
    ...
    public int processBlock(byte[] bArr, int i10, byte[] bArr2, int i11) {
        ...
        FO(bArr3, this.roundKeys[i12]);
        xor(bArr3, this.roundKeys[i12 + 1]);
        SL2(bArr3);
        xor(bArr3, this.roundKeys[i12 + 2]);
