...
public class Zuc256CoreEngine extends Zuc128CoreEngine {
    private byte[] theD;
    private static final byte[] EK_d = {34, 47, 36, 42, 109, 64, 64, 64, 64, 64, 64, 64, 64, 82, 16, 48};
    private static final byte[] EK_d32 = {34, 47, 37, 42, 109, 64, 64, 64, 64, 64, 64, 64, 64, 82, 16, 48};
    private static final byte[] EK_d64 = {35, 47, 36, 42, 109, 64, 64, 64, 64, 64, 64, 64, 64, 82, 16, 48};
    private static final byte[] EK_d128 = {35, 47, 37, 42, 109, 64, 64, 64, 64, 64, 64, 64, 64, 82, 16, 48};
    ...
    public Zuc256CoreEngine(int i10) {
        if (i10 == 32) {
            this.theD = EK_d32;
        } else if (i10 == 64) {
            this.theD = EK_d64;
            ...
            if (i10 != 128) {
                throw new IllegalArgumentException(AbstractC4801l.m9730d(i10, "Unsupported length: "));
            }
            this.theD = EK_d128;
        }
    }
