...
public class JPAKEParticipant {
    ...
    /* renamed from: b */
    private BigInteger f27548b;
    private final Digest digest;

    /* renamed from: g */
    private final BigInteger f27549g;
    ...
    /* renamed from: p */
    private final BigInteger f27550p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* renamed from: q */
    private final BigInteger f27551q;
    private final SecureRandom random;
    private int state;

    /* renamed from: x1, reason: collision with root package name */
    private BigInteger f44497x1;

    /* renamed from: x2, reason: collision with root package name */
    private BigInteger f44498x2;
    ...
    private BigInteger calculateS() {
        try {
            return JPAKEUtil.calculateS(this.f27551q, this.password);
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        this.password = null;
        BigInteger bigIntegerCalculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f27550p, this.f27551q, this.gx4, this.f44498x2, bigIntegerCalculateS, this.f27548b);
        this.f44497x1 = null;
        this.f44498x2 = null;
        this.f27548b = null;
        this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        ...
        this.f44497x1 = JPAKEUtil.generateX1(this.f27551q, this.random);
        this.f44498x2 = JPAKEUtil.generateX2(this.f27551q, this.random);
        this.gx1 = JPAKEUtil.calculateGx(this.f27550p, this.f27549g, this.f44497x1);
        this.gx2 = JPAKEUtil.calculateGx(this.f27550p, this.f27549g, this.f44498x2);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f27550p, this.f27551q, this.f27549g, this.gx1, this.f44497x1, this.participantId, this.digest, this.random);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f27550p, this.f27551q, this.f27549g, this.gx2, this.f44498x2, this.participantId, this.digest, this.random);
        this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        BigInteger bigIntegerCalculateGA = JPAKEUtil.calculateGA(this.f27550p, this.gx1, this.gx3, this.gx4);
        BigInteger bigIntegerCalculateX2s = JPAKEUtil.calculateX2s(this.f27551q, this.f44498x2, calculateS());
        BigInteger bigIntegerCalculateA = JPAKEUtil.calculateA(this.f27550p, this.f27551q, bigIntegerCalculateGA, bigIntegerCalculateX2s);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f27550p, this.f27551q, bigIntegerCalculateGA, bigIntegerCalculateA, bigIntegerCalculateX2s, this.participantId, this.digest, this.random);
        this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f27550p, this.f27551q, this.f27549g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
        JPAKEUtil.validateZeroKnowledgeProof(this.f27550p, this.f27551q, this.f27549g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
        this.state = 20;
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        BigInteger bigIntegerCalculateGA = JPAKEUtil.calculateGA(this.f27550p, this.gx3, this.gx1, this.gx2);
        this.f27548b = jPAKERound2Payload.getA();
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f27550p, this.f27551q, bigIntegerCalculateGA, this.f27548b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
        this.state = 40;
    }
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        this.f27550p = jPAKEPrimeOrderGroup.getP();
        this.f27551q = jPAKEPrimeOrderGroup.getQ();
        this.f27549g = jPAKEPrimeOrderGroup.getG();
        this.digest = digest;
