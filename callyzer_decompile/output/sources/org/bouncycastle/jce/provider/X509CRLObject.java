...
public class X509CRLObject extends X509CRL {
    ...
    /* renamed from: c */
    private CertificateList f27831c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws SignatureException, InvalidKeyException, CRLException {
        if (!this.f27831c.getSignatureAlgorithm().equals(this.f27831c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z6) {
        ...
        if (getVersion() != 2 || (extensions = this.f27831c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f27831c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f27831c.equals(x509CRLObject.f27831c);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f27831c.getEncoded(ASN1Encoding.DER);
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f27831c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f27831c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f27831c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f27831c.getNextUpdate() != null) {
            return this.f27831c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f27831c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f27831c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f27831c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e2) {
            throw new CRLException(e2.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f27831c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f27831c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        Enumeration revokedCertificateEnumeration = this.f27831c.getRevokedCertificateEnumeration();
        X500Name issuer2 = this.f27831c.getIssuer();
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Can't find top splitter block for handler:B:43:0x0180
