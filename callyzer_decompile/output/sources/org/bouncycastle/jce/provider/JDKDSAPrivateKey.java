...
public class JDKDSAPrivateKey implements DSAPrivateKey, PKCS12BagAttributeCarrier {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        this.f27826x = (BigInteger) objectInputStream.readObject();
    ...
    private void writeObject(ObjectOutputStream objectOutputStream) throws IOException {
        objectOutputStream.writeObject(this.f27826x);
    ...
    public JDKDSAPrivateKey(DSAPrivateKey dSAPrivateKey) {
        this.f27826x = dSAPrivateKey.getX();
        this.dsaSpec = dSAPrivateKey.getParams();
    }

    public JDKDSAPrivateKey(DSAPrivateKeySpec dSAPrivateKeySpec) {
        this.f27826x = dSAPrivateKeySpec.getX();
    ...
    public JDKDSAPrivateKey(PrivateKeyInfo privateKeyInfo) {
        ...
        this.f27826x = ASN1Integer.getInstance(privateKeyInfo.parsePrivateKey()).getValue();
    ...
    public JDKDSAPrivateKey(DSAPrivateKeyParameters dSAPrivateKeyParameters) {
        this.f27826x = dSAPrivateKeyParameters.getX();
