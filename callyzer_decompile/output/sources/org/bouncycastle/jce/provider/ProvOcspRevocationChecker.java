...
class ProvOcspRevocationChecker implements PKIXCertRevocationChecker {
    ...
    private Certificate extractCert() throws CertPathValidatorException {
        try {
            ...
            throw new CertPathValidatorException(AbstractC0030c.m117h(e2, new StringBuilder("cannot process signing cert: ")), e2, this.parameters.getCertPath(), this.parameters.getIndex());
        }
    }
    ...
    public static URI getOcspResponderURI(X509Certificate x509Certificate) {
        ...
        for (int i10 = 0; i10 != accessDescriptions.length; i10++) {
            AccessDescription accessDescription = accessDescriptions[i10];
    ...
    private static String getSignatureName(AlgorithmIdentifier algorithmIdentifier) {
        ...
        if (parameters != null && !DERNull.INSTANCE.equals(parameters) && algorithmIdentifier.getAlgorithm().equals((ASN1Primitive) PKCSObjectIdentifiers.id_RSASSA_PSS)) {
            return AbstractC1452a.m4564k(new StringBuilder(), getDigestName(RSASSAPSSparams.getInstance(parameters).getHashAlgorithm().getAlgorithm()), "WITHRSAANDMGF1");
        }
        Map map = oids;
    ...
    public static boolean validatedOcspResponse(BasicOCSPResponse basicOCSPResponse, PKIXCertRevocationCheckerParameters pKIXCertRevocationCheckerParameters, byte[] bArr, X509Certificate x509Certificate, JcaJceHelper jcaJceHelper) {
        try {
            ...
            throw new CertPathValidatorException(AbstractC4801l.m9731e(e2, new StringBuilder("OCSP response failure: ")), e2, pKIXCertRevocationCheckerParameters.getCertPath(), pKIXCertRevocationCheckerParameters.getIndex());
        } catch (CertPathValidatorException e10) {
            throw e10;
        } catch (GeneralSecurityException e11) {
            throw new CertPathValidatorException("OCSP response failure: " + e11.getMessage(), e11, pKIXCertRevocationCheckerParameters.getCertPath(), pKIXCertRevocationCheckerParameters.getIndex());
        }
    }
    ...
    public void check(java.security.cert.Certificate certificate) {
        ...
        if (ocspResponses.get(x509Certificate) != null || uri == null) {
            ...
            for (int i10 = 0; i10 != ocspExtensions.size(); i10++) {
                java.security.cert.Extension extension = ocspExtensions.get(i10);
            ...
            try {
                ...
                throw new CertPathValidatorException("unable to encode OCSP response", e10, this.parameters.getCertPath(), this.parameters.getIndex());
            }
        }
        ...
        if (responseBytes.getResponseType().equals((ASN1Primitive) OCSPObjectIdentifiers.id_pkix_ocsp_basic)) {
            try {
                ...
                if (!z6 && !validatedOcspResponse(basicOCSPResponse, this.parameters, bArr, this.parent.getOcspResponderCert(), this.helper)) {
                    return;
                }
                ...
                throw new CertPathValidatorException("unable to process OCSP response", e12, this.parameters.getCertPath(), this.parameters.getIndex());
            }
        }
    }
    ...
    private CertID createCertID(AlgorithmIdentifier algorithmIdentifier, Certificate certificate, ASN1Integer aSN1Integer) throws CertPathValidatorException {
        try {
            ...
            throw new CertPathValidatorException(AbstractC0030c.m120k("problem creating ID: ", e2), e2);
        }
    }
