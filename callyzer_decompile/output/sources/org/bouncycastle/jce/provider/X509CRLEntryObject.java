...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    private X500Name loadCertificateIssuer(boolean z6, X500Name x500Name) {
        if (!z6) {
            return null;
        }
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f27830c.equals(((X509CRLEntryObject) obj).f27830c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f27830c.getEncoded(ASN1Encoding.DER);
    ...
    public byte[] getExtensionValue(String str) {
        ...
        try {
            ...
            throw new RuntimeException(AbstractC4801l.m9732f(e2, new StringBuilder("error encoding ")));
        }
    }
    ...
    public Date getRevocationDate() {
        return this.f27830c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f27830c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f27830c.getExtensions() != null;
    }
    ...
    public X509CRLEntryObject(TBSCertList.CRLEntry cRLEntry, boolean z6, X500Name x500Name) {
        this.f27830c = cRLEntry;
        this.certificateIssuer = loadCertificateIssuer(z6, x500Name);
    }
}
