...
public class PKCS10CertificationRequest extends CertificationRequest {
    ...
    private static RSASSAPSSparams creatPSSParams(AlgorithmIdentifier algorithmIdentifier, int i10) {
        return new RSASSAPSSparams(algorithmIdentifier, new AlgorithmIdentifier(PKCSObjectIdentifiers.id_mgf1, algorithmIdentifier), new ASN1Integer(i10), new ASN1Integer(1L));
    }
    ...
    private void setSignatureParameters(Signature signature, ASN1Encodable aSN1Encodable) throws NoSuchAlgorithmException, SignatureException, IOException, InvalidAlgorithmParameterException {
    ...
    public PublicKey getPublicKey(String str) throws InvalidKeySpecException, NoSuchAlgorithmException, InvalidKeyException {
    ...
    public boolean verify(PublicKey publicKey, String str) throws NoSuchAlgorithmException, SignatureException, IOException, InvalidKeyException, InvalidAlgorithmParameterException {
        try {
        ...
        try {
            ...
            throw new SignatureException(AbstractC0030c.m120k("exception encoding TBS cert request - ", e10));
        }
    }
    ...
    */
    public PKCS10CertificationRequest(java.lang.String r5, org.bouncycastle.asn1.x509.X509Name r6, java.security.PublicKey r7, org.bouncycastle.asn1.ASN1Set r8, java.security.PrivateKey r9, java.lang.String r10) throws java.security.SignatureException, java.security.InvalidKeyException {
        /*
            r4 = this;
            r4.<init>()
        ...
        L53:
            ...
            org.bouncycastle.asn1.ASN1Primitive r7 = org.bouncycastle.asn1.ASN1Primitive.fromByteArray(r7)     // Catch: java.io.IOException -> L9a
            org.bouncycastle.asn1.ASN1Sequence r7 = (org.bouncycastle.asn1.ASN1Sequence) r7     // Catch: java.io.IOException -> L9a
            ...
            org.bouncycastle.asn1.x509.SubjectPublicKeyInfo r7 = org.bouncycastle.asn1.x509.SubjectPublicKeyInfo.getInstance(r7)     // Catch: java.io.IOException -> L9a
            r0.<init>(r6, r7, r8)     // Catch: java.io.IOException -> L9a
            r4.reqInfo = r0     // Catch: java.io.IOException -> L9a
            if (r10 != 0) goto L6f
        ...
        L8d:
            ...
            java.lang.String r5 = a2.AbstractC0030c.m120k(r7, r5)
            r6.<init>(r5)
            throw r6
        L9a:
            java.lang.IllegalArgumentException r5 = new java.lang.IllegalArgumentException
