...
public class NetscapeCertRequest extends ASN1Object {
    ...
    private ASN1Primitive getKeySpec() throws InvalidKeySpecException, IOException {
    ...
    public void sign(PrivateKey privateKey) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, NoSuchProviderException {
    ...
    public NetscapeCertRequest(ASN1Sequence aSN1Sequence) {
        try {
            ...
            this.pubkey = KeyFactory.getInstance(algorithm.getAlgorithm().getId(), "BC").generatePublic(x509EncodedKeySpec);
        } catch (Exception e2) {
            throw new IllegalArgumentException(e2.toString());
        }
    }

    public void sign(PrivateKey privateKey, SecureRandom secureRandom) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, NoSuchProviderException {
        Signature signature = Signature.getInstance(this.sigAlg.getAlgorithm().getId(), "BC");
