...
public class Base64 {
    ...
    public static int decode(byte[] bArr, int i10, int i11, OutputStream outputStream) {
        try {
            ...
            throw new DecoderException(AbstractC0030c.m117h(e2, new StringBuilder("unable to decode base64 data: ")), e2);
        }
    }
    ...
    public static byte[] encode(byte[] bArr, int i10, int i11) {
        ...
        try {
            ...
            throw new EncoderException(AbstractC0030c.m117h(e2, new StringBuilder("exception encoding base64 string: ")), e2);
        }
    }
    ...
    public static byte[] decode(String str) {
        ...
        try {
            ...
            throw new DecoderException(AbstractC0030c.m117h(e2, new StringBuilder("unable to decode base64 string: ")), e2);
        }
    }
