...
public class Base32 {
    ...
    public static int decode(byte[] bArr, int i10, int i11, OutputStream outputStream) {
        try {
            ...
            throw new DecoderException(AbstractC0030c.m117h(e2, new StringBuilder("unable to decode base32 data: ")), e2);
        }
    }
    ...
    public static byte[] encode(byte[] bArr, int i10, int i11) {
        ...
        try {
            ...
            throw new EncoderException(AbstractC0030c.m117h(e2, new StringBuilder("exception encoding base32 string: ")), e2);
        }
    }
    ...
    public static byte[] decode(String str) {
        ...
        try {
            ...
            throw new DecoderException(AbstractC0030c.m117h(e2, new StringBuilder("unable to decode base32 string: ")), e2);
        }
    }
