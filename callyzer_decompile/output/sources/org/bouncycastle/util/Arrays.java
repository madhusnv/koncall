...
public final class Arrays {
    ...
    public static void reverseInPlace(byte[] bArr, int i10, int i11) {
        int i12 = (i11 + i10) - 1;
        while (i10 < i12) {
            byte b10 = bArr[i10];
            bArr[i10] = bArr[i12];
    ...
    public static short[] prepend(short[] sArr, short s5) {
        if (sArr == null) {
            return new short[]{s5};
        }
    ...
    public static short[] append(short[] sArr, short s5) {
        if (sArr == null) {
            return new short[]{s5};
        }
        int length = sArr.length;
    ...
    public static void fill(char[] cArr, int i10, int i11, char c2) {
        java.util.Arrays.fill(cArr, i10, i11, c2);
    }
    ...
    public static int hashCode(long[] jArr) {
        ...
        while (true) {
            ...
            long j6 = jArr[length];
            i10 = (((i10 * 257) ^ ((int) j6)) * 257) ^ ((int) (j6 >>> 32));
        }
    }
    ...
    public static void fill(long[] jArr, int i10, int i11, long j6) {
        java.util.Arrays.fill(jArr, i10, i11, j6);
    }
    ...
    public static int hashCode(long[] jArr, int i10, int i11) {
        ...
        while (true) {
            ...
            long j6 = jArr[i10 + i11];
            i12 = (((i12 * 257) ^ ((int) j6)) * 257) ^ ((int) (j6 >>> 32));
        }
    }
    ...
    public static int hashCode(int[][] iArr) {
        ...
        for (int i10 = 0; i10 != iArr.length; i10++) {
            iHashCode = (iHashCode * 257) + hashCode(iArr[i10]);
        }
        return iHashCode;
    }
    ...
    public static void fill(short[] sArr, int i10, int i11, short s5) {
        java.util.Arrays.fill(sArr, i10, i11, s5);
    }

    public static int hashCode(short[][] sArr) {
        int iHashCode = 0;
        for (int i10 = 0; i10 != sArr.length; i10++) {
            iHashCode = (iHashCode * 257) + hashCode(sArr[i10]);
        }
        return iHashCode;
    }

    public static void fill(short[] sArr, short s5) {
        java.util.Arrays.fill(sArr, s5);
    }
    ...
    public static void fill(boolean[] zArr, int i10, int i11, boolean z6) {
        java.util.Arrays.fill(zArr, i10, i11, z6);
    }

    public static void fill(boolean[] zArr, boolean z6) {
        java.util.Arrays.fill(zArr, z6);
    }
}
