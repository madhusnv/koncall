...
public abstract class AsymmetricHybridCipher extends CipherSpiExt {
    ...
    public final int doFinal(byte[] bArr, int i10, int i11, byte[] bArr2, int i12) throws ShortBufferException {
    ...
    public final int update(byte[] bArr, int i10, int i11, byte[] bArr2, int i12) throws ShortBufferException {
        ...
        byte[] bArrUpdate = update(bArr, i10, i11);
        System.arraycopy(bArrUpdate, 0, bArr2, i12, bArrUpdate.length);
