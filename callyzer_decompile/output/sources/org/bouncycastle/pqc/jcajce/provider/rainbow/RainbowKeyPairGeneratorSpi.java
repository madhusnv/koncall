...
public class RainbowKeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    static {
        ...
        parameters = map;
        map.put(RainbowParameterSpec.rainbowIIIclassic.getName(), RainbowParameters.rainbowIIIclassic);
    ...
    public KeyPair generateKeyPair() {
        if (!this.initialised) {
            RainbowParameters rainbowParameters = this.rainbowParameters;
            if (rainbowParameters != null) {
                this.param = new RainbowKeyGenerationParameters(this.random, rainbowParameters);
            } else {
