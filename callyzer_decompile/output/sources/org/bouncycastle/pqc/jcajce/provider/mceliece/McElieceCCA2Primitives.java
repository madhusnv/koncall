...
public final class McElieceCCA2Primitives {
    ...
    public static GF2Vector[] decryptionPrimitive(BCMcElieceCCA2PrivateKey bCMcElieceCCA2PrivateKey, GF2Vector gF2Vector) {
        ...
        Permutation p4 = bCMcElieceCCA2PrivateKey.getP();
        ...
        GF2Vector gF2Vector2 = (GF2Vector) gF2Vector.multiply(p4.computeInverse());
        GF2Vector gF2VectorSyndromeDecode = GoppaCode.syndromeDecode((GF2Vector) h10.rightMultiply(gF2Vector2), field, goppaPoly, qInv);
        GF2Vector gF2Vector3 = (GF2Vector) ((GF2Vector) gF2Vector2.add(gF2VectorSyndromeDecode)).multiply(p4);
        return new GF2Vector[]{gF2Vector3.extractRightVector(k), (GF2Vector) gF2VectorSyndromeDecode.multiply(p4)};
    }
    ...
    public static GF2Vector[] decryptionPrimitive(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters, GF2Vector gF2Vector) {
        ...
        Permutation p4 = mcElieceCCA2PrivateKeyParameters.getP();
