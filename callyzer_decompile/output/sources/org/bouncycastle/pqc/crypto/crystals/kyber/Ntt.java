...
class Ntt {
    ...
    public static void baseMult(Poly poly, int i10, short s5, short s10, short s11, short s12, short s13) {
        poly.setCoeffIndex(i10, (short) (factorQMulMont(factorQMulMont(s10, s12), s13) + factorQMulMont(s5, s11)));
        poly.setCoeffIndex(i10 + 1, (short) (factorQMulMont(s5, s12) + factorQMulMont(s10, s11)));
    }

    public static short factorQMulMont(short s5, short s10) {
        return Reduce.montgomeryReduce(s5 * s10);
    }
    ...
    public static short[] invNtt(short[] sArr) {
        ...
        for (int i11 = 2; i11 <= 128; i11 <<= 1) {
            ...
            while (i12 < 256) {
                int i13 = i10 + 1;
                short s5 = nttZetasInv[i10];
                int i14 = i12;
                while (i14 < i12 + i11) {
                    short s10 = sArr2[i14];
                    int i15 = i14 + i11;
                    sArr2[i14] = Reduce.barretReduce((short) (sArr2[i15] + s10));
                    short s11 = (short) (s10 - sArr2[i15]);
                    sArr2[i15] = s11;
                    sArr2[i15] = factorQMulMont(s5, s11);
                    i14++;
                }
                i12 = i14 + i11;
                i10 = i13;
        ...
        for (int i16 = 0; i16 < 256; i16++) {
            sArr2[i16] = factorQMulMont(sArr2[i16], nttZetasInv[127]);
        }
        return sArr2;
    }
    ...
    public static short[] ntt(short[] sArr) {
        ...
        for (int i11 = 128; i11 >= 2; i11 >>= 1) {
            ...
            while (i12 < 256) {
                int i13 = i10 + 1;
                short s5 = nttZetas[i10];
                int i14 = i12;
                while (i14 < i12 + i11) {
                    int i15 = i14 + i11;
                    short sFactorQMulMont = factorQMulMont(s5, sArr2[i15]);
                    sArr2[i15] = (short) (sArr2[i14] - sFactorQMulMont);
                    sArr2[i14] = (short) (sArr2[i14] + sFactorQMulMont);
                    i14++;
                }
                i12 = i14 + i11;
                i10 = i13;
