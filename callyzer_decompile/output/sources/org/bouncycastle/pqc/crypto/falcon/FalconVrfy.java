...
class FalconVrfy {
    ...
    /* renamed from: Q */
    final int f28022Q = 12289;
    final int Q0I = 12287;

    /* renamed from: R */
    final int f28023R = 4091;
    final int R2 = 10952;
    ...
    public boolean complete_private(byte[] bArr, int i10, byte[] bArr2, int i11, byte[] bArr3, int i12, byte[] bArr4, int i13, int i14, short[] sArr, int i15) {
        int i16 = 1 << i14;
        int i17 = i15 + i16;
        for (int i18 = 0; i18 < i16; i18++) {
            sArr[i15 + i18] = (short) mq_conv_small(bArr3[i12 + i18]);
            sArr[i17 + i18] = (short) mq_conv_small(bArr4[i13 + i18]);
        }
        mq_NTT(sArr, i15, i14);
        mq_NTT(sArr, i17, i14);
        mq_poly_tomonty(sArr, i15, i14);
        mq_poly_montymul_ntt(sArr, i15, sArr, i17, i14);
        for (int i19 = 0; i19 < i16; i19++) {
            sArr[i17 + i19] = (short) mq_conv_small(bArr2[i11 + i19]);
        }
        mq_NTT(sArr, i17, i14);
        boolean z6 = true;
        for (int i20 = 0; i20 < i16; i20++) {
            short s5 = sArr[i17 + i20];
            z6 &= s5 != 0;
            int i21 = i15 + i20;
            sArr[i21] = (short) mq_div_12289(sArr[i21], s5);
        }
        mq_iNTT(sArr, i15, i14);
        for (int i22 = 0; i22 < i16; i22++) {
            int i23 = sArr[i15 + i22] & HPKE.aead_EXPORT_ONLY;
            int i24 = i23 - ((~(-((i23 - 6144) >>> 31))) & 12289);
            z6 &= i24 >= -127 && i24 <= 127;
            bArr[i10 + i22] = (byte) i24;
        }
        return z6;
    }

    public int compute_public(short[] sArr, int i10, byte[] bArr, int i11, byte[] bArr2, int i12, int i13, short[] sArr2, int i14) {
        int i15 = 1 << i13;
        for (int i16 = 0; i16 < i15; i16++) {
            sArr2[i14 + i16] = (short) mq_conv_small(bArr[i11 + i16]);
            sArr[i10 + i16] = (short) mq_conv_small(bArr2[i12 + i16]);
        }
        mq_NTT(sArr, i10, i13);
        mq_NTT(sArr2, i14, i13);
        for (int i17 = 0; i17 < i15; i17++) {
            short s5 = sArr2[i14 + i17];
            if (s5 == 0) {
                return 0;
            }
            int i18 = i10 + i17;
            sArr[i18] = (short) mq_div_12289(sArr[i18], s5);
        }
        mq_iNTT(sArr, i10, i13);
        return 1;
    }

    public int count_nttzero(short[] sArr, int i10, int i11, short[] sArr2, int i12) {
        int i13 = 1 << i11;
        for (int i14 = 0; i14 < i13; i14++) {
            short s5 = sArr[i10 + i14];
            sArr2[i12 + i14] = (short) (s5 + ((-(s5 >>> 31)) & 12289));
        }
        mq_NTT(sArr2, i12, i11);
        int i15 = 0;
        for (int i16 = 0; i16 < i13; i16++) {
            i15 += ((sArr2[i12 + i16] & HPKE.aead_EXPORT_ONLY) - 1) >>> 31;
        }
        return i15;
    }

    public int is_invertible(short[] sArr, int i10, int i11, short[] sArr2, int i12) {
        int i13 = 1 << i11;
        for (int i14 = 0; i14 < i13; i14++) {
            short s5 = sArr[i10 + i14];
            sArr2[i12 + i14] = (short) (s5 + ((-(s5 >>> 31)) & 12289));
        ...
        int i15 = 0;
        for (int i16 = 0; i16 < i13; i16++) {
            i15 |= (sArr2[i12 + i16] & HPKE.aead_EXPORT_ONLY) - 1;
        }
        return 1 - (i15 >>> 31);
    }

    public void mq_NTT(short[] sArr, int i10, int i11) {
        int i12 = 1;
        int i13 = 1 << i11;
        int i14 = i13;
        while (i12 < i13) {
            ...
            int i17 = 0;
            while (i16 < i12) {
                short s5 = this.GMb[i12 + i16];
                int i18 = i17 + i15;
                for (int i19 = i17; i19 < i18; i19++) {
                    int i20 = i10 + i19;
                    int i21 = sArr[i20] & HPKE.aead_EXPORT_ONLY;
                    int i22 = i20 + i15;
                    int iMq_montymul = mq_montymul(sArr[i22], s5);
                    sArr[i20] = (short) mq_add(i21, iMq_montymul);
                    sArr[i22] = (short) mq_sub(i21, iMq_montymul);
                }
                i16++;
                i17 += i14;
            }
    ...
    public int mq_add(int i10, int i11) {
        int i12 = (i10 + i11) - 12289;
        return i12 + ((-(i12 >>> 31)) & 12289);
    }

    public int mq_conv_small(int i10) {
        return i10 + ((-(i10 >>> 31)) & 12289);
    }

    public int mq_div_12289(int i10, int i11) {
        int iMq_montymul = mq_montymul(i11, 10952);
        int iMq_montysqr = mq_montysqr(iMq_montymul);
        int iMq_montymul2 = mq_montymul(iMq_montysqr, iMq_montymul);
        int iMq_montysqr2 = mq_montysqr(mq_montysqr(mq_montysqr(mq_montysqr(mq_montysqr(mq_montymul(iMq_montymul2, iMq_montysqr))))));
        int iMq_montymul3 = mq_montymul(iMq_montysqr2, iMq_montymul2);
        int iMq_montymul4 = mq_montymul(iMq_montymul3, iMq_montysqr2);
        return mq_montymul(mq_montymul(mq_montysqr(mq_montymul(mq_montysqr(mq_montysqr(mq_montymul(mq_montysqr(mq_montysqr(iMq_montymul4)), iMq_montymul3))), iMq_montymul4)), iMq_montymul), i10);
    }

    public void mq_iNTT(short[] sArr, int i10, int i11) {
        int i12;
        int i13 = 1 << i11;
        int i14 = 1;
        int i15 = i13;
        while (true) {
            ...
            while (i12 < i15) {
                int i18 = i17 + i14;
                short s5 = this.iGMb[i15 + i12];
                for (int i19 = i17; i19 < i18; i19++) {
                    int i20 = i10 + i19;
                    int i21 = sArr[i20] & HPKE.aead_EXPORT_ONLY;
                    int i22 = i20 + i14;
                    int i23 = 65535 & sArr[i22];
                    sArr[i20] = (short) mq_add(i21, i23);
                    sArr[i22] = (short) mq_montymul(mq_sub(i21, i23), s5);
                }
                i12++;
                i17 += i16;
            }
        ...
        int iMq_rshift1 = 4091;
        for (int i24 = i13; i24 > 1; i24 >>= 1) {
            iMq_rshift1 = mq_rshift1(iMq_rshift1);
        }
        while (i12 < i13) {
            int i25 = i10 + i12;
            sArr[i25] = (short) mq_montymul(sArr[i25], iMq_rshift1);
            i12++;
        }
    }

    public int mq_montymul(int i10, int i11) {
        int i12 = i10 * i11;
        int i13 = (((((i12 * 12287) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) * 12289) + i12) >>> 16) - 12289;
        return i13 + ((-(i13 >>> 31)) & 12289);
    }

    public int mq_montysqr(int i10) {
        return mq_montymul(i10, i10);
    }

    public void mq_poly_montymul_ntt(short[] sArr, int i10, short[] sArr2, int i11, int i12) {
        int i13 = 1 << i12;
        for (int i14 = 0; i14 < i13; i14++) {
            int i15 = i10 + i14;
            sArr[i15] = (short) mq_montymul(sArr[i15], sArr2[i11 + i14]);
        }
    }

    public void mq_poly_sub(short[] sArr, int i10, short[] sArr2, int i11, int i12) {
        int i13 = 1 << i12;
        for (int i14 = 0; i14 < i13; i14++) {
            int i15 = i10 + i14;
            sArr[i15] = (short) mq_sub(sArr[i15], sArr2[i11 + i14]);
        }
    }

    public void mq_poly_tomonty(short[] sArr, int i10, int i11) {
        int i12 = 1 << i11;
        for (int i13 = 0; i13 < i12; i13++) {
            int i14 = i10 + i13;
            sArr[i14] = (short) mq_montymul(sArr[i14], 10952);
        }
    }

    public int mq_rshift1(int i10) {
        return (i10 + ((-(i10 & 1)) & 12289)) >>> 1;
    }

    public int mq_sub(int i10, int i11) {
        int i12 = i10 - i11;
        return i12 + ((-(i12 >>> 31)) & 12289);
    }

    public void to_ntt_monty(short[] sArr, int i10, int i11) {
        mq_NTT(sArr, i10, i11);
        mq_poly_tomonty(sArr, i10, i11);
    }

    public int verify_raw(short[] sArr, int i10, short[] sArr2, int i11, short[] sArr3, int i12, int i13, short[] sArr4, int i14) {
        int i15 = 1 << i13;
        for (int i16 = 0; i16 < i15; i16++) {
            short s5 = sArr2[i11 + i16];
            sArr4[i14 + i16] = (short) (s5 + ((-(s5 >>> 31)) & 12289));
        }
        mq_NTT(sArr4, i14, i13);
        mq_poly_montymul_ntt(sArr4, i14, sArr3, i12, i13);
        mq_iNTT(sArr4, i14, i13);
        mq_poly_sub(sArr4, i14, sArr, i10, i13);
        for (int i17 = 0; i17 < i15; i17++) {
            int i18 = i14 + i17;
            int i19 = sArr4[i18] & HPKE.aead_EXPORT_ONLY;
            sArr4[i18] = (short) (i19 - ((-((6144 - i19) >>> 31)) & 12289));
        }
        return this.common.is_short(sArr4, i14, sArr2, i11, i13);
    }

    public int verify_recover(short[] sArr, int i10, short[] sArr2, int i11, short[] sArr3, int i12, short[] sArr4, int i13, int i14, short[] sArr5, int i15) {
        int i16 = 1 << i14;
        for (int i17 = 0; i17 < i16; i17++) {
            short s5 = sArr4[i13 + i17];
            sArr5[i15 + i17] = (short) (s5 + ((-(s5 >> 31)) & 12289));
            short s10 = sArr3[i12 + i17];
            sArr[i10 + i17] = (short) mq_sub(sArr2[i11 + i17], 65535 & (s10 + ((-(s10 >>> 31)) & 12289)));
        }
        mq_NTT(sArr5, i15, i14);
        mq_NTT(sArr5, i10, i14);
        int i18 = 0;
        for (int i19 = 0; i19 < i16; i19++) {
            short s11 = sArr5[i15 + i19];
            i18 |= (s11 & HPKE.aead_EXPORT_ONLY) - 1;
            int i20 = i10 + i19;
            sArr[i20] = (short) mq_div_12289(sArr[i20] & HPKE.aead_EXPORT_ONLY, s11 & HPKE.aead_EXPORT_ONLY);
        }
        mq_iNTT(sArr, i10, i14);
        return ((~i18) & (-this.common.is_short(sArr3, i12, sArr4, i13, i14))) >>> 31;
    }
}
