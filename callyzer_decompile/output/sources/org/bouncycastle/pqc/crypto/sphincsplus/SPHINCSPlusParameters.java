...
public class SPHINCSPlusParameters {
    ...
    private final Integer f44737id;
    ...
    public static class HarakaSEngineProvider implements SPHINCSPlusEngineProvider {
        ...
        /* renamed from: w */
        private final int f28109w;

        public HarakaSEngineProvider(boolean z6, int i10, int i11, int i12, int i13, int i14, int i15) {
            this.robust = z6;
            this.f28108n = i10;
            this.f28109w = i11;
            this.f28105d = i12;
        ...
        public SPHINCSPlusEngine get() {
            return new SPHINCSPlusEngine.HarakaSEngine(this.robust, this.f28108n, this.f28109w, this.f28105d, this.f28104a, this.f28107k, this.f28106h);
        }
    ...
    public static class Sha2EngineProvider implements SPHINCSPlusEngineProvider {
        ...
        public Sha2EngineProvider(boolean z6, int i10, int i11, int i12, int i13, int i14, int i15) {
            this.robust = z6;
            this.f28114n = i10;
            this.f28115w = i11;
            this.f28111d = i12;
        ...
        @Override // org.bouncycastle.pqc.crypto.sphincsplus.SPHINCSPlusEngineProvider
        public SPHINCSPlusEngine get() {
            return new SPHINCSPlusEngine.Sha2Engine(this.robust, this.f28114n, this.f28115w, this.f28111d, this.f28110a, this.f28113k, this.f28112h);
        }
    ...
    public static class Shake256EngineProvider implements SPHINCSPlusEngineProvider {
        ...
        public Shake256EngineProvider(boolean z6, int i10, int i11, int i12, int i13, int i14, int i15) {
            this.robust = z6;
            this.f28120n = i10;
            this.f28121w = i11;
            this.f28117d = i12;
        ...
        @Override // org.bouncycastle.pqc.crypto.sphincsplus.SPHINCSPlusEngineProvider
        public SPHINCSPlusEngine get() {
            return new SPHINCSPlusEngine.Shake256Engine(this.robust, this.f28120n, this.f28121w, this.f28117d, this.f28116a, this.f28119k, this.f28118h);
        }
