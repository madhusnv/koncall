...
class ADRS {
    ...
    public void changeType(int i10) {
        Pack.intToBigEndian(i10, this.value, 16);
    }
    ...
    public void setChainAddress(int i10) {
        Pack.intToBigEndian(i10, this.value, 24);
    }

    public void setHashAddress(int i10) {
        Pack.intToBigEndian(i10, this.value, 28);
    }

    public void setKeyPairAddress(int i10) {
        Pack.intToBigEndian(i10, this.value, 20);
    }

    public void setLayerAddress(int i10) {
        Pack.intToBigEndian(i10, this.value, 0);
    }

    public void setTreeAddress(long j6) {
        Pack.longToBigEndian(j6, this.value, 8);
    }

    public void setTreeHeight(int i10) {
        Pack.intToBigEndian(i10, this.value, 24);
    }

    public void setTreeIndex(int i10) {
        Pack.intToBigEndian(i10, this.value, 28);
    }
