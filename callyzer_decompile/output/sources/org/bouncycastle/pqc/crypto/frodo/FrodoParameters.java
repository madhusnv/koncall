...
public class FrodoParameters implements KEMParameters {
    ...
    private FrodoParameters(String str, int i10, int i11, int i12, short[] sArr, Xof xof, FrodoMatrixGenerator frodoMatrixGenerator) {
        this.name = str;
        this.f28037n = i10;
        this.f28036D = i11;
        this.f28035B = i12;
        this.defaultKeySize = i12 * 64;
        this.engine = new FrodoEngine(i10, i11, i12, sArr, xof, frodoMatrixGenerator);
    }
