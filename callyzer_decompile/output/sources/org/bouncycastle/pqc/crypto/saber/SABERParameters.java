...
public class SABERParameters implements KEMParameters {
    ...
    public static final SABERParameters lightsaberkem192r3 = new SABERParameters("lightsaberkem192r3", 2, BERTags.PRIVATE, false, false);
    public static final SABERParameters saberkem192r3 = new SABERParameters("saberkem192r3", 3, BERTags.PRIVATE, false, false);
    public static final SABERParameters firesaberkem192r3 = new SABERParameters("firesaberkem192r3", 4, BERTags.PRIVATE, false, false);
    ...
    public SABERParameters(String str, int i10, int i11, boolean z6, boolean z10) {
        this.name = str;
        this.f28096l = i10;
        this.defaultKeySize = i11;
        this.engine = new SABEREngine(i10, i11, z6, z10);
    }
