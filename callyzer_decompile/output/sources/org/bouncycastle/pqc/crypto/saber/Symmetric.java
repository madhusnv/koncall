...
abstract class Symmetric {
    ...
    public static class AesSymmetric extends Symmetric {
        ...
        public void hash_h(byte[] bArr, byte[] bArr2, int i10) {
            ...
            this.sha256Digest.doFinal(bArr, i10);
        }

        @Override // org.bouncycastle.pqc.crypto.saber.Symmetric
        public void prf(byte[] bArr, byte[] bArr2, int i10, int i11) {
            this.cipher.init(true, new ParametersWithIV(new KeyParameter(bArr2, 0, i10), new byte[16]));
            this.cipher.processBytes(new byte[i11], 0, i11, bArr, 0);
        }
    }
    ...
    public static class ShakeSymmetric extends Symmetric {
        ...
        public void prf(byte[] bArr, byte[] bArr2, int i10, int i11) {
            ...
            this.shakeDigest.update(bArr2, 0, i10);
            this.shakeDigest.doFinal(bArr, 0, i11);
        }
    }
