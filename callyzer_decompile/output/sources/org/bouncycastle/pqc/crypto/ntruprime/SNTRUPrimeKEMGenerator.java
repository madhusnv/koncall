...
public class SNTRUPrimeKEMGenerator implements EncapsulatedSecretGenerator {
    ...
    public SecretWithEncapsulation generateEncapsulated(AsymmetricKeyParameter asymmetricKeyParameter) {
        ...
        Utils.getRandomShortPolynomial(this.random, bArr, p4, w5);
        byte[] bArr2 = new byte[(p4 + 3) / 4];
        Utils.getEncodedSmallPolynomial(bArr2, bArr, p4);
        short[] sArr = new short[p4];
        Utils.getDecodedPolynomial(sArr, sNTRUPrimePublicKeyParameters.getEncH(), p4, q10);
