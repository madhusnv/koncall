...
public class NTRULPRimeKEMExtractor implements EncapsulatedSecretExtractor {
    ...
    public byte[] extractSecret(byte[] bArr) {
        ...
        Utils.right(bArr6, sArr2, bArr5, q10, w5, tau2, tau3);
        ...
        Utils.getRoundedDecodedPolynomial(sArr3, bArr8, p4, q10);
        byte[] bArr9 = new byte[32];
        System.arraycopy(this.privateKey.getPk(), 0, bArr9, 0, 32);
        short[] sArr4 = new short[p4];
        Utils.generatePolynomialInRQFromSeed(sArr4, bArr9, p4, q10);
        ...
        byte[] bArr10 = new byte[p4];
        Utils.sortGenerateShortPolynomial(bArr10, iArr, p4, w5);
        short[] sArr5 = new short[p4];
        Utils.multiplicationInRQ(sArr5, sArr4, bArr10, p4, q10);
        short[] sArr6 = new short[p4];
        Utils.roundPolynomial(sArr6, sArr5);
        Utils.getRoundedEncodedPolynomial(new byte[roundedPolynomialBytes], sArr6, p4, q10);
        short[] sArr7 = new short[p4];
        Utils.multiplicationInRQ(sArr7, sArr3, bArr10, p4, q10);
        ...
        int i10 = roundedPolynomialBytes + 128;
        int length = (hashWithPrefix2.length / 2) + i10;
        ...
        System.arraycopy(hashWithPrefix2, 0, bArr12, i10, hashWithPrefix2.length / 2);
