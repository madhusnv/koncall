...
public class NTRULPRimeKEMGenerator implements EncapsulatedSecretGenerator {
    ...
    public SecretWithEncapsulation generateEncapsulated(AsymmetricKeyParameter asymmetricKeyParameter) {
        ...
        Utils.getRoundedDecodedPolynomial(sArr, nTRULPRimePublicKeyParameters.getRoundEncA(), p4, q10);
        short[] sArr2 = new short[p4];
        Utils.generatePolynomialInRQFromSeed(sArr2, nTRULPRimePublicKeyParameters.getSeed(), p4, q10);
        ...
        Utils.sortGenerateShortPolynomial(bArr3, iArr, p4, w5);
        short[] sArr3 = new short[p4];
        Utils.multiplicationInRQ(sArr3, sArr2, bArr3, p4, q10);
        short[] sArr4 = new short[p4];
        Utils.roundPolynomial(sArr4, sArr3);
        byte[] bArr4 = new byte[roundedPolynomialBytes];
        Utils.getRoundedEncodedPolynomial(bArr4, sArr4, p4, q10);
        short[] sArr5 = new short[p4];
        Utils.multiplicationInRQ(sArr5, sArr, bArr3, p4, q10);
        byte[] bArr5 = new byte[256];
        Utils.top(bArr5, sArr5, bArr, q10, tau0, tau1);
        byte[] bArr6 = new byte[128];
        Utils.getTopEncodedPolynomial(bArr6, bArr5);
        byte[] bArr7 = new byte[(hashWithPrefix.length / 2) + 32];
