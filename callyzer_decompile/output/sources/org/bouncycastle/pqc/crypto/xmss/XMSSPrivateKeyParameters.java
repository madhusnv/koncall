    ...
    public XMSSPrivateKeyParameters extractKeyShard(int i10) {
        ...
        synchronized (this) {
            ...
            try {
                ...
                xMSSPrivateKeyParametersBuild = new Builder(this.params).withSecretKeySeed(this.secretKeySeed).withSecretKeyPRF(this.secretKeyPRF).withPublicSeed(this.publicSeed).withRoot(this.root).withIndex(getIndex()).withBDSState(this.bdsState.withMaxIndex((this.bdsState.getIndex() + i10) - 1, this.params.getTreeDigestOID())).build();
                if (j6 == getUsagesRemaining()) {
