...
public final class XMSSMTPrivateKeyParameters extends XMSSMTKeyParameters implements XMSSStoreableObjectInterface, Encodable {
    ...
    public static class Builder {
        ...
        public Builder withMaxIndex(long j6) {
            this.maxIndex = j6;
            return this;
        }
    ...
    private XMSSMTPrivateKeyParameters(Builder builder) {
        ...
        if (bArr != null) {
            ...
            int i10 = (height + 7) / 8;
            this.index = XMSSUtil.bytesToXBigEndian(bArr, 0, i10);
    ...
    public XMSSMTPrivateKeyParameters extractKeyShard(int i10) {
        ...
        synchronized (this) {
            ...
            try {
                ...
                xMSSMTPrivateKeyParametersBuild = new Builder(this.params).withSecretKeySeed(this.secretKeySeed).withSecretKeyPRF(this.secretKeyPRF).withPublicSeed(this.publicSeed).withRoot(this.root).withIndex(getIndex()).withBDSState(new BDSStateMap(this.bdsState, (getIndex() + j6) - 1)).build();
