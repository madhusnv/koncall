...
public class RainbowPublicKey extends ASN1Object {
    ...
    public RainbowPublicKey(int i10, short[][] sArr, short[][] sArr2, short[] sArr3) {
        ...
        this.docLength = new ASN1Integer(i10);
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        for (int i10 = 0; i10 < this.coeffQuadratic.length; i10++) {
            aSN1EncodableVector2.add(new DEROctetString(this.coeffQuadratic[i10]));
        }
        ...
        for (int i11 = 0; i11 < this.coeffSingular.length; i11++) {
            aSN1EncodableVectorM4573t.add(new DEROctetString(this.coeffSingular[i11]));
        }
        ASN1EncodableVector aSN1EncodableVectorM4573t2 = AbstractC1452a.m4573t(aSN1EncodableVectorM4573t, aSN1EncodableVector);
        aSN1EncodableVectorM4573t2.add(new DEROctetString(this.coeffScalar));
    ...
    private RainbowPublicKey(ASN1Sequence aSN1Sequence) {
        ...
        for (int i10 = 0; i10 < aSN1Sequence2.size(); i10++) {
            this.coeffQuadratic[i10] = AbstractC1452a.m4553D(aSN1Sequence2, i10);
        }
        ...
        for (int i11 = 0; i11 < aSN1Sequence3.size(); i11++) {
            this.coeffSingular[i11] = AbstractC1452a.m4553D(aSN1Sequence3, i11);
        }
        this.coeffScalar = AbstractC1452a.m4553D((ASN1Sequence) aSN1Sequence.getObjectAt(4), 0);
    }
}
