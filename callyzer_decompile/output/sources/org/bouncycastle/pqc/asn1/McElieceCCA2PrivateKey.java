...
public class McElieceCCA2PrivateKey extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f27979n));
        aSN1EncodableVector.add(new ASN1Integer(this.f27978k));
    ...
    private McElieceCCA2PrivateKey(ASN1Sequence aSN1Sequence) {
        this.f27979n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f27978k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
