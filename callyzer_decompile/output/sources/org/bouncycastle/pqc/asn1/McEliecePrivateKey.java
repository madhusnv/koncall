...
public class McEliecePrivateKey extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f27984n));
        aSN1EncodableVector.add(new ASN1Integer(this.f27983k));
    ...
    private McEliecePrivateKey(ASN1Sequence aSN1Sequence) {
        this.f27984n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f27983k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
