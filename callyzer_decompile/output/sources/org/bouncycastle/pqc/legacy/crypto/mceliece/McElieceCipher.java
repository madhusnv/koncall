...
public class McElieceCipher implements MessageEncryptor {
    ...
    private GF2Vector computeMessageRepresentative(byte[] bArr) {
        byte[] bArr2 = new byte[this.maxPlainTextSize + ((this.f28152k & 7) != 0 ? 1 : 0)];
        System.arraycopy(bArr, 0, bArr2, 0, bArr.length);
        bArr2[bArr.length] = 1;
        return GF2Vector.OS2VP(this.f28152k, bArr2);
    }

    private void initCipherDecrypt(McEliecePrivateKeyParameters mcEliecePrivateKeyParameters) {
        this.f28153n = mcEliecePrivateKeyParameters.getN();
        int k = mcEliecePrivateKeyParameters.getK();
        this.f28152k = k;
        this.maxPlainTextSize = k >> 3;
        this.cipherTextSize = this.f28153n >> 3;
    }

    private void initCipherEncrypt(McEliecePublicKeyParameters mcEliecePublicKeyParameters) {
        this.f28153n = mcEliecePublicKeyParameters.getN();
        this.f28152k = mcEliecePublicKeyParameters.getK();
        this.f28154t = mcEliecePublicKeyParameters.getT();
        this.cipherTextSize = this.f28153n >> 3;
        this.maxPlainTextSize = this.f28152k >> 3;
    }
    ...
    public void init(boolean z6, CipherParameters cipherParameters) {
        ...
        if (!z6) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f44742sr = CryptoServicesRegistrar.getSecureRandom();
            ...
            this.f44742sr = parametersWithRandom.getRandom();
    ...
    public byte[] messageDecrypt(byte[] bArr) {
        ...
        GF2Vector gF2VectorOS2VP = GF2Vector.OS2VP(this.f28153n, bArr);
        ...
        GF2Vector gF2VectorSyndromeDecode = GoppaCode.syndromeDecode((GF2Vector) h10.rightMultiply(gF2Vector), field, goppaPoly, qInv);
        GF2Vector gF2Vector2 = (GF2Vector) ((GF2Vector) gF2Vector.add(gF2VectorSyndromeDecode)).multiply(p12);
        return computeMessage((GF2Vector) sInv.leftMultiply(gF2Vector2.extractRightVector(this.f28152k)));
    }
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        return ((GF2Vector) ((McEliecePublicKeyParameters) this.key).getG().leftMultiply(gF2VectorComputeMessageRepresentative).add(new GF2Vector(this.f28153n, this.f28154t, this.f44742sr))).getEncoded();
    }
}
