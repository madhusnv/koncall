...
public class Treehash {
    ...
    public void initialize() {
        if (!this.seedInitialized) {
            throw new IllegalStateException(AbstractC5601a.m11233d(this.maxHeight, " not initialized", new StringBuilder("Seed ")));
        }
    ...
    public String toString() {
        ...
        for (int i11 = 0; i11 < this.tailLength + 3; i11++) {
            strM4564k = getStatByte()[i11] != null ? AbstractC1452a.m4564k(AbstractC1452a.m4568o(strM4564k), new String(Hex.encode(getStatByte()[i11])), " ") : AbstractC1452a.m4561h(strM4564k, "null ");
        }
        StringBuilder sbM11245p = AbstractC5601a.m11245p(strM4564k, "  ");
        sbM11245p.append(this.messDigestTree.getDigestSize());
