...
public class PolynomialRingGF2m {
    ...
    /* renamed from: p */
    private PolynomialGF2mSmallM f28184p;
    ...
    public PolynomialRingGF2m(GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM) {
        ...
        this.f28184p = polynomialGF2mSmallM;
    ...
    private void computeSquareRootMatrix() {
        int coefficient;
        int degree = this.f28184p.getDegree();
        ...
        for (int i12 = 0; i12 < degree; i12++) {
            ...
            int iInverse = this.field.inverse(polynomialGF2mSmallMArr[i12].getCoefficient(i12));
            polynomialGF2mSmallMArr[i12].multThisWithElement(iInverse);
            this.sqRootMatrix[i12].multThisWithElement(iInverse);
            for (int i14 = 0; i14 < degree; i14++) {
                if (i14 != i12 && (coefficient = polynomialGF2mSmallMArr[i14].getCoefficient(i12)) != 0) {
                    PolynomialGF2mSmallM polynomialGF2mSmallMMultWithElement = polynomialGF2mSmallMArr[i12].multWithElement(coefficient);
                    PolynomialGF2mSmallM polynomialGF2mSmallMMultWithElement2 = this.sqRootMatrix[i12].multWithElement(coefficient);
                    polynomialGF2mSmallMArr[i14].addToThis(polynomialGF2mSmallMMultWithElement);
                    this.sqRootMatrix[i14].addToThis(polynomialGF2mSmallMMultWithElement2);
                }
            }
        }
    }
    ...
    private void computeSquaringMatrix() {
        ...
        while (i10 < degree) {
            ...
            iArr2[i13] = 1;
            this.sqMatrix[i10] = new PolynomialGF2mSmallM(this.field, iArr2).mod(this.f28184p);
            i10++;
        }
    }
