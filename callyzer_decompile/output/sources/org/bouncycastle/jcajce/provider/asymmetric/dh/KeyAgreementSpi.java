...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public byte[] bigIntToBytes(BigInteger bigInteger) {
        return BigIntegers.asUnsignedByteArray((this.f27800p.bitLength() + 7) / 8, bigInteger);
    }
    ...
    public void doInitFromKey(Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (algorithmParameterSpec == null) {
            this.f27800p = dHPrivateKey.getParams().getP();
            this.f27799g = dHPrivateKey.getParams().getG();
        } else if (algorithmParameterSpec instanceof DHParameterSpec) {
            DHParameterSpec dHParameterSpec = (DHParameterSpec) algorithmParameterSpec;
            this.f27800p = dHParameterSpec.getP();
            this.f27799g = dHParameterSpec.getG();
    ...
    public Key engineDoPhase(Key key, boolean z6) throws InvalidKeyException {
        ...
        if (!dHPublicKey.getParams().getG().equals(this.f27799g) || !dHPublicKey.getParams().getP().equals(this.f27800p)) {
            throw new InvalidKeyException("DHPublicKey not for this KeyAgreement!");
        }
        BigInteger y10 = dHPublicKey.getY();
        if (y10 != null && y10.compareTo(TWO) >= 0) {
            BigInteger bigInteger = this.f27800p;
            ...
            if (y10.compareTo(bigInteger.subtract(bigInteger2)) < 0) {
                ...
                BigInteger bigIntegerModPow = y10.modPow(this.f27801x, this.f27800p);
