    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            for (int i10 = 1; i10 <= 36; i10++) {
                ...
                configurableProvider.addAlgorithm("Alg.Alias.Signature.OID." + aSN1ObjectIdentifier + "." + i10, "SPHINCSPLUS");
            }
            ...
            for (int i11 = 0; i11 != 12; i11++) {
                StringBuilder sbM9741o = AbstractC4801l.m9741o("SPHINCSPLUS", "Alg.Alias.Signature.OID.", new StringBuilder("Alg.Alias.Signature."), aSN1ObjectIdentifierArr[i11], configurableProvider);
                sbM9741o.append(aSN1ObjectIdentifierArr[i11]);
                configurableProvider.addAlgorithm(sbM9741o.toString(), "SPHINCSPLUS");
            }
