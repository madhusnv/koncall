...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        if (keySpec instanceof PKCS8EncodedKeySpec) {
            try {
                ...
                try {
                    ...
                    throw new ExtendedInvalidKeySpecException(AbstractC4801l.m9732f(e2, new StringBuilder("unable to process key spec: ")), e2);
                }
            }
        }
        ...
        if (privateKeyBlob instanceof RSAPrivateCrtKeyParameters) {
            return new BCRSAPrivateCrtKey((RSAPrivateCrtKeyParameters) privateKeyBlob);
        }
    ...
    public KeySpec engineGetKeySpec(Key key, Class cls) {
        ...
        if (cls.isAssignableFrom(OpenSSHPublicKeySpec.class) && (key instanceof RSAPublicKey)) {
            try {
                ...
                throw new IllegalArgumentException(AbstractC4801l.m9731e(e2, new StringBuilder("unable to produce encoding: ")));
            }
        }
        ...
        try {
            ...
            throw new IllegalArgumentException(AbstractC4801l.m9731e(e10, new StringBuilder("unable to produce encoding: ")));
        }
    }
    ...
    public PrivateKey generatePrivate(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if (!RSAUtil.isRsaOid(algorithm)) {
            throw new IOException(AbstractC4801l.m9735i("algorithm identifier ", algorithm, " in key not recognised"));
        }
