    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            while (true) {
                ...
                AbstractC4801l.m9750x(new StringBuilder("Alg.Alias.Signature."), aSN1ObjectIdentifierArr[i10], configurableProvider, "DSA");
                registerOid(configurableProvider, aSN1ObjectIdentifierArr[i10], "DSA", keyFactorySpi);
                registerOidAlgorithmParameterGenerator(configurableProvider, aSN1ObjectIdentifierArr[i10], "DSA");
                i10++;
            }
        }
    }
