...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f27813c.equals(x509CRLEntryObject.f27813c);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f27813c.getEncoded(ASN1Encoding.DER);
    ...
    public byte[] getExtensionValue(String str) {
        ...
        try {
            ...
            throw new IllegalStateException(AbstractC4801l.m9732f(e2, new StringBuilder("Exception encoding: ")));
        }
    }
    ...
    public Date getRevocationDate() {
        return this.f27813c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f27813c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f27813c.getExtensions() != null;
    }
