...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public Key engineDoPhase(Key key, boolean z6) throws InvalidKeyException {
        ...
        try {
            ...
            throw new InvalidKeyException(AbstractC0030c.m117h(e2, new StringBuilder("calculation failed: "))) { // from class: org.bouncycastle.jcajce.provider.asymmetric.ecgost.KeyAgreementSpi.1
