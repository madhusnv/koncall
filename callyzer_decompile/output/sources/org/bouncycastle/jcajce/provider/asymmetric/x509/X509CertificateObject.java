...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
    ...
    private static BasicConstraints createBasicConstraints(Certificate certificate) throws CertificateParsingException {
        try {
            ...
            throw new CertificateParsingException(AbstractC0030c.m120k("cannot construct BasicConstraints: ", e2));
        }
    }
    ...
    private static String createSigAlgName(Certificate certificate) throws CertificateParsingException {
        try {
            ...
            throw new CertificateParsingException(AbstractC0030c.m120k("cannot construct SigAlgName: ", e2));
        }
    }
    ...
    private static byte[] createSigAlgParams(Certificate certificate) throws CertificateParsingException {
        try {
            ...
            throw new CertificateParsingException(AbstractC0030c.m120k("cannot construct SigAlgParams: ", e2));
        }
    }
    ...
    private X509CertificateInternal getInternalCertificate() {
        ...
        synchronized (this.cacheLock) {
            try {
                ...
                try {
                    encoded = this.f27815c.getEncoded(ASN1Encoding.DER);
                    x509CertificateEncodingException = null;
                } catch (IOException e2) {
                    encoded = null;
                    x509CertificateEncodingException = new X509CertificateEncodingException(e2);
                }
                X509CertificateInternal x509CertificateInternal3 = new X509CertificateInternal(this.bcHelper, this.f27815c, this.basicConstraints, this.keyUsage, this.sigAlgName, this.sigAlgParams, encoded, x509CertificateEncodingException);
                synchronized (this.cacheLock) {
                    try {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CertificateObject) {
            ...
            } else if ((this.internalCertificateValue == null || x509CertificateObject.internalCertificateValue == null) && (signature = this.f27815c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CertificateObject.f27815c.getSignature())) {
                return false;
            }
