...
public abstract class BaseAgreementSpi extends KeyAgreementSpi {
    ...
    static {
        ...
        Integer numValueOf3 = Integers.valueOf(BERTags.PRIVATE);
        ...
        map2.put(aSN1ObjectIdentifier14.getId(), Integers.valueOf(KyberEngine.KyberPolyBytes));
        ...
        map.put("AES", aSN1ObjectIdentifier);
        ...
        map3.put(aSN1ObjectIdentifier2.getId(), "AES");
        map3.put(aSN1ObjectIdentifier3.getId(), "AES");
        map3.put(aSN1ObjectIdentifier3.getId(), "AES");
    ...
    private byte[] calcSecret() {
        ...
        byte[] bArrDoCalcSecret = doCalcSecret();
        byte[] bArrConcatenate = Arrays.concatenate(bArrDoCalcSecret, this.hybridSpec.getT());
        Arrays.clear(bArrDoCalcSecret);
    ...
    private byte[] getSharedSecretBytes(byte[] bArr, String str, int i10) throws NoSuchAlgorithmException {
        ...
        if (i10 < 0) {
            throw new NoSuchAlgorithmException(m0.m7378k("unknown algorithm encountered: ", str));
        }
        int i12 = i10 / 8;
        ...
        if (!(derivationFunction instanceof DHKEKGenerator)) {
            ...
            try {
                kDFParameters = new DHKDFParameters(new ASN1ObjectIdentifier(str), i10, bArr, this.ukmParameters);
    ...
    public int engineGenerateSecret(byte[] bArr, int i10) throws ShortBufferException {
        ...
        throw new ShortBufferException(AbstractC5601a.m11233d(bArrEngineGenerateSecret.length, " bytes", sb2));
    }
