...
public class BCEdDSAPrivateKey implements EdDSAPrivateKey {
    ...
    private int calculateHashCode() {
        ...
        return Arrays.hashCode(asymmetricKeyParameter instanceof Ed448PublicKeyParameters ? ((Ed448PublicKeyParameters) asymmetricKeyParameter).getEncoded() : ((Ed25519PublicKeyParameters) asymmetricKeyParameter).getEncoded()) + (getAlgorithm().hashCode() * 31);
    }
    ...
    private void populateFromPrivateKeyInfo(PrivateKeyInfo privateKeyInfo) {
        ...
        if (EdECObjectIdentifiers.id_Ed448.equals((ASN1Primitive) privateKeyInfo.getPrivateKeyAlgorithm().getAlgorithm())) {
            ...
            asymmetricKeyParameterGeneratePublicKey = ed448PrivateKeyParameters.generatePublicKey();
        } else {
            ...
            asymmetricKeyParameterGeneratePublicKey = ed25519PrivateKeyParameters.generatePublicKey();
        }
        this.eddsaPublicKey = asymmetricKeyParameterGeneratePublicKey;
