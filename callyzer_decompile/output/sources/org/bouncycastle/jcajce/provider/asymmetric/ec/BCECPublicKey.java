...
public class BCECPublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public byte[] getEncoded() {
        boolean zIsOverrideSet = Properties.isOverrideSet("org.bouncycastle.ec.enable_pc");
        if (this.encoding == null || this.oldPcSet != zIsOverrideSet) {
            boolean z6 = this.withCompression || zIsOverrideSet;
            this.encoding = KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, ECUtils.getDomainParametersFromName(this.ecSpec, z6)), this.ecPublicKey.getQ().getEncoded(z6));
