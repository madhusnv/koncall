...
class EdECUtil {
    public static AsymmetricKeyParameter generatePrivateKeyParameter(PrivateKey privateKey) throws InvalidKeyException {
        ...
        try {
            ...
            throw new InvalidKeyException(AbstractC0030c.m117h(e2, new StringBuilder("cannot identify EdEC/XDH private key: ")));
        }
    }
    ...
    public static AsymmetricKeyParameter generatePublicKeyParameter(PublicKey publicKey) throws InvalidKeyException {
        ...
        try {
            ...
            throw new InvalidKeyException(AbstractC0030c.m117h(e2, new StringBuilder("cannot identify EdEC/XDH public key: ")));
        }
    }
}
