...
public abstract class GMKeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public static class BaseSM2 extends GMKeyPairGeneratorSpi {
        ...
        static {
            ...
            hashtable.put(Integers.valueOf(BERTags.PRIVATE), new ECNamedCurveGenParameterSpec("prime192v1"));
            ...
            ecParameters.put(Integers.valueOf(BERTags.FLAGS), new ECNamedCurveGenParameterSpec("P-224"));
        ...
        public void initialize(int i10, SecureRandom secureRandom) {
            ...
            ECNamedCurveGenParameterSpec eCNamedCurveGenParameterSpec = (ECNamedCurveGenParameterSpec) ecParameters.get(Integers.valueOf(i10));
        ...
        public void initializeNamedCurve(String str, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
            ...
            if (domainParametersFromName == null) {
                throw new InvalidAlgorithmParameterException(m0.m7378k("unknown curve name: ", str));
            }
