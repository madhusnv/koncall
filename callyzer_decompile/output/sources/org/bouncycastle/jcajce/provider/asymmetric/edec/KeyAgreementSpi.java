...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public Key engineDoPhase(Key key, boolean z6) throws InvalidKeyException {
        ...
        if (dHUParameterSpec != null) {
            this.agreement.calculateAgreement(new XDHUPublicParameters(asymmetricKeyParameterGeneratePublicKeyParameter, ((BCXDHPublicKey) dHUParameterSpec.getOtherPartyEphemeralKey()).engineGetKeyParameters()), this.result, 0);
            return null;
        }
        this.agreement.calculateAgreement(asymmetricKeyParameterGeneratePublicKeyParameter, bArr, 0);
        return null;
    }
