...
public class BCDHPrivateKey implements DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    public DHPrivateKeyParameters engineGetKeyParameters() {
        ...
        return dHParameterSpec instanceof DHDomainParameterSpec ? new DHPrivateKeyParameters(this.f27797x, ((DHDomainParameterSpec) dHParameterSpec).getDomainParameters()) : new DHPrivateKeyParameters(this.f27797x, new DHParameters(dHParameterSpec.getP(), this.dhSpec.getG(), null, this.dhSpec.getL()));
    }
    ...
    public String toString() {
        return DHUtil.privateKeyToString("DH", this.f27797x, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
    }

    public BCDHPrivateKey(DHPrivateKey dHPrivateKey) {
        this.f27797x = dHPrivateKey.getX();
        this.dhSpec = dHPrivateKey.getParams();
    }

    public BCDHPrivateKey(DHPrivateKeySpec dHPrivateKeySpec) {
        this.f27797x = dHPrivateKeySpec.getX();
    ...
    public BCDHPrivateKey(PrivateKeyInfo privateKeyInfo) {
        ...
        this.f27797x = aSN1Integer.getValue();
        if (algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.dhKeyAgreement)) {
            ...
            if (dHParameter.getL() != null) {
                ...
                dHPrivateKeyParameters = new DHPrivateKeyParameters(this.f27797x, new DHParameters(dHParameter.getP(), dHParameter.getG(), null, dHParameter.getL().intValue()));
            } else {
                this.dhSpec = new DHParameterSpec(dHParameter.getP(), dHParameter.getG());
                dHPrivateKeyParameters = new DHPrivateKeyParameters(this.f27797x, new DHParameters(dHParameter.getP(), dHParameter.getG()));
            }
        } else {
            ...
            dHPrivateKeyParameters = new DHPrivateKeyParameters(this.f27797x, new DHParameters(domainParameters.getP(), domainParameters.getG(), domainParameters.getQ(), domainParameters.getJ(), (DHValidationParameters) null));
        }
        this.dhPrivateKey = dHPrivateKeyParameters;
    }

    public BCDHPrivateKey(DHPrivateKeyParameters dHPrivateKeyParameters) {
        this.f27797x = dHPrivateKeyParameters.getX();
