...
public class BCElGamalPublicKey implements ElGamalPublicKey, DHPublicKey {
    ...
    public byte[] getEncoded() {
        try {
            return new SubjectPublicKeyInfo(new AlgorithmIdentifier(OIWObjectIdentifiers.elGamalAlgorithm, new ElGamalParameter(this.elSpec.getP(), this.elSpec.getG())), new ASN1Integer(this.f27810y)).getEncoded(ASN1Encoding.DER);
    ...
    public BCElGamalPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f27810y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    public BCElGamalPublicKey(ElGamalPublicKeyParameters elGamalPublicKeyParameters) {
        this.f27810y = elGamalPublicKeyParameters.getY();
