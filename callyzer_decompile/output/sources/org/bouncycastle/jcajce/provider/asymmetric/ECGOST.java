...
public class ECGOST {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            AbstractC4801l.m9750x(AbstractC4801l.m9742p(configurableProvider, "Alg.Alias.KeyAgreement.GOST-3410-2001", "ECGOST3410", "Alg.Alias.KeyAgreement."), CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_ESDH, configurableProvider, "ECGOST3410");
            ...
            AbstractC4801l.m9750x(AbstractC4801l.m9741o("ECGOST3410-2012-256", "Alg.Alias.KeyAgreement.", AbstractC4801l.m9741o("ECGOST3410-2012-512", "Alg.Alias.KeyAgreement.", new StringBuilder("Alg.Alias.KeyAgreement."), aSN1ObjectIdentifier5, configurableProvider), aSN1ObjectIdentifier2, configurableProvider), aSN1ObjectIdentifier4, configurableProvider, "ECGOST3410-2012-512");
        }
    }
}
