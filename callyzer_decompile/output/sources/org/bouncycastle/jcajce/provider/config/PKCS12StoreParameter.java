...
public class PKCS12StoreParameter extends org.bouncycastle.jcajce.PKCS12StoreParameter {
    ...
    public PKCS12StoreParameter(OutputStream outputStream, KeyStore.ProtectionParameter protectionParameter, boolean z6) {
        super(outputStream, protectionParameter, z6);
    }
    ...
    public PKCS12StoreParameter(OutputStream outputStream, char[] cArr, boolean z6) {
        super(outputStream, new KeyStore.PasswordProtection(cArr), z6);
    }
}
