...
public final class SipHash128 {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            AbstractC5601a.m11226A(str, "$Mac24", "Mac.SIPHASH128-2-4", sb2, configurableProvider);
            configurableProvider.addAlgorithm("KeyGenerator.SIPHASH128", AbstractC5601a.m11239j("Mac.SIPHASH128-4-8", AbstractC5601a.m11239j("Alg.Alias.Mac.SIPHASH128", "SIPHASH128-2-4", str, "$Mac48", configurableProvider), str, "$KeyGen", configurableProvider));
