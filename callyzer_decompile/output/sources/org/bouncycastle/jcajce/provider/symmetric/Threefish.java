...
public final class Threefish {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            AbstractC5601a.m11226A(str, "$AlgParams_1024", "AlgorithmParameters.Threefish-1024", AbstractC4801l.m9740n(str, "$AlgParams_512", "AlgorithmParameters.Threefish-512", AbstractC4801l.m9740n(str, "$AlgParams_256", "AlgorithmParameters.Threefish-256", AbstractC4801l.m9740n(str, "$KeyGen_1024", "KeyGenerator.Threefish-1024", AbstractC4801l.m9740n(str, "$KeyGen_512", "KeyGenerator.Threefish-512", AbstractC4801l.m9740n(str, "$KeyGen_256", "KeyGenerator.Threefish-256", AbstractC4801l.m9740n(str, "$ECB_1024", "Cipher.Threefish-1024", AbstractC4801l.m9740n(str, "$ECB_512", "Cipher.Threefish-512", AbstractC4801l.m9740n(str, "$ECB_256", "Cipher.Threefish-256", AbstractC4801l.m9740n(str, "$CMAC_1024", "Mac.Threefish-1024CMAC", AbstractC4801l.m9740n(str, "$CMAC_512", "Mac.Threefish-512CMAC", AbstractC4801l.m9740n(str, "$CMAC_256", "Mac.Threefish-256CMAC", sb2, configurableProvider), configurableProvider), configurableProvider), configurableProvider), configurableProvider), configurableProvider), configurableProvider), configurableProvider), configurableProvider), configurableProvider), configurableProvider), configurableProvider);
        }
    }
