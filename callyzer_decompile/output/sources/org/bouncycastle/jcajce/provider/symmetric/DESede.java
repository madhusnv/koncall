...
public final class DESede {
    ...
    public static class KeyGenerator extends BaseKeyGenerator {
        ...
        public KeyGenerator() {
            super("DESede", BERTags.PRIVATE, new DESedeKeyGenerator());
    ...
    public static class KeyGenerator3 extends BaseKeyGenerator {
        public KeyGenerator3() {
            super("DESede3", BERTags.PRIVATE, new DESedeKeyGenerator());
        }
    }
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            AbstractC5601a.m11226A(str, "$ECB", "Cipher.DESEDE", sb2, configurableProvider);
            ...
            AbstractC5601a.m11226A(str, "$Wrap", "Cipher.DESEDEWRAP", new StringBuilder(), configurableProvider);
            configurableProvider.addAlgorithm("Cipher", PKCSObjectIdentifiers.id_alg_CMS3DESwrap, str + "$Wrap");
            AbstractC5601a.m11226A(str, "$RFC3211", "Cipher.DESEDERFC3211WRAP", new StringBuilder(), configurableProvider);
            ...
            if (configurableProvider.hasAlgorithm("MessageDigest", McElieceCCA2KeyGenParameterSpec.SHA1)) {
                ...
                sb3.append(str);
                AbstractC5601a.m11227B(sb3, "$PBEWithSHAAndDES2Key", configurableProvider, "Cipher.PBEWITHSHAAND2-KEYTRIPLEDES-CBC");
            ...
            StringBuilder sbM9739m = AbstractC4801l.m9739m(str, "$KeyGenerator", "KeyGenerator.DESEDE", "KeyGenerator.", configurableProvider);
            sbM9739m.append(aSN1ObjectIdentifier);
            configurableProvider.addAlgorithm(sbM9739m.toString(), str + "$KeyGenerator3");
            StringBuilder sb4 = new StringBuilder();
            sb4.append(str);
            AbstractC5601a.m11227B(AbstractC5601a.m11246q("$KeyGenerator", "KeyGenerator.DESEDEWRAP", str, sb4, configurableProvider), "$KeyFactory", configurableProvider, "SecretKeyFactory.DESEDE");
            configurableProvider.addAlgorithm("SecretKeyFactory", OIWObjectIdentifiers.desEDE, str + "$KeyFactory");
            AbstractC5601a.m11226A(str, "$CBCMAC", "Mac.DESEDEMAC", AbstractC4801l.m9740n(str, "$CMAC", "Mac.DESEDECMAC", new StringBuilder(), configurableProvider), configurableProvider);
            configurableProvider.addAlgorithm("Mac.DESEDEMAC/CFB8", AbstractC5601a.m11239j("Alg.Alias.Mac.DESEDE", "DESEDEMAC", str, "$DESedeCFB8", configurableProvider));
            configurableProvider.addAlgorithm("Alg.Alias.Mac.DESEDE/CFB8", "DESEDEMAC/CFB8");
            AbstractC5601a.m11226A(str, "$DESede64", "Mac.DESEDEMAC64", new StringBuilder(), configurableProvider);
            configurableProvider.addAlgorithm("Mac.DESEDEMAC64WITHISO7816-4PADDING", AbstractC5601a.m11239j("Alg.Alias.Mac.DESEDE64", "DESEDEMAC64", str, "$DESede64with7816d4", configurableProvider));
            ...
            AbstractC5601a.m11227B(AbstractC5601a.m11246q("$PBEWithSHAAndDES3KeyFactory", "SecretKeyFactory.PBEWITHSHAAND3-KEYTRIPLEDES-CBC", str, AbstractC4801l.m9726D("DESEDE", str, new StringBuilder("Alg.Alias.AlgorithmParameterGenerator."), aSN1ObjectIdentifier, configurableProvider), configurableProvider), "$PBEWithSHAAndDES2KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHAAND2-KEYTRIPLEDES-CBC");
    ...
    public static class PBEWithSHAAndDES3Key extends BaseBlockCipher {
        public PBEWithSHAAndDES3Key() {
            super(new CBCBlockCipher(new DESedeEngine()), 2, 1, BERTags.PRIVATE, 8);
        }
    }

    public static class PBEWithSHAAndDES3KeyFactory extends DES.DESPBEKeyFactory {
        public PBEWithSHAAndDES3KeyFactory() {
            super("PBEwithSHAandDES3Key-CBC", PKCSObjectIdentifiers.pbeWithSHAAnd3_KeyTripleDES_CBC, true, 2, 1, BERTags.PRIVATE, 64);
        }
    }
