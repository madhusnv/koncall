...
public final class RC2 {
    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        public AlgorithmParameters engineGenerateParameters() throws InvalidParameterSpecException {
            if (this.spec != null) {
                try {
                    AlgorithmParameters algorithmParametersCreateParametersInstance = createParametersInstance("RC2");
                    algorithmParametersCreateParametersInstance.init(this.spec);
            ...
            try {
                AlgorithmParameters algorithmParametersCreateParametersInstance2 = createParametersInstance("RC2");
                algorithmParametersCreateParametersInstance2.init(new IvParameterSpec(bArr));
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        public byte[] engineGetEncoded() {
            return Arrays.clone(this.f44634iv);
        }

        @Override // java.security.AlgorithmParametersSpi
        public void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
            if (algorithmParameterSpec instanceof IvParameterSpec) {
                this.f44634iv = ((IvParameterSpec) algorithmParameterSpec).getIV();
                return;
            }
            if (!(algorithmParameterSpec instanceof RC2ParameterSpec)) {
            ...
            if (effectiveKeyBits != -1) {
                ...
                if (effectiveKeyBits < 256) {
                    i10 = table[effectiveKeyBits];
                }
                this.parameterVersion = i10;
            }
            this.f44634iv = rC2ParameterSpec.getIV();
        }
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            ...
            if ((cls == RC2ParameterSpec.class || cls == AlgorithmParameterSpec.class) && (i10 = this.parameterVersion) != -1) {
                return i10 < 256 ? new RC2ParameterSpec(ekb[this.parameterVersion], this.f44634iv) : new RC2ParameterSpec(this.parameterVersion, this.f44634iv);
            }
            if (cls == IvParameterSpec.class) {
                return new IvParameterSpec(this.f44634iv);
            }
        ...
        public void engineInit(byte[] bArr) {
            this.f44634iv = Arrays.clone(bArr);
        }
        ...
        public void engineInit(byte[] bArr, String str) throws IOException {
            if (!isASN1FormatString(str)) {
                ...
                this.f44634iv = rC2CBCParameter.getIV();
            }
        }
    }
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            AbstractC5601a.m11226A(str, "$Wrap", "Cipher.RC2WRAP", AbstractC4801l.m9740n(str, "$ECB", "Cipher.RC2", AbstractC4801l.m9740n(str, "$AlgParams", "AlgorithmParameters.1.2.840.113549.3.2", AbstractC4801l.m9740n(str, "$AlgParams", "AlgorithmParameters.RC2", AbstractC4801l.m9740n(str, "$KeyGenerator", "KeyGenerator.1.2.840.113549.3.2", AbstractC4801l.m9740n(str, "$KeyGenerator", "KeyGenerator.RC2", AbstractC4801l.m9740n(str, "$AlgParamGen", "AlgorithmParameterGenerator.1.2.840.113549.3.2", AbstractC4801l.m9740n(str, "$AlgParamGen", "AlgorithmParameterGenerator.RC2", sb2, configurableProvider), configurableProvider), configurableProvider), configurableProvider), configurableProvider), configurableProvider), configurableProvider), configurableProvider);
            ...
            AbstractC5601a.m11226A(str, "$CBCMAC", "Mac.RC2MAC", new StringBuilder(), configurableProvider);
            configurableProvider.addAlgorithm("Mac.RC2MAC/CFB8", AbstractC5601a.m11239j("Alg.Alias.Mac.RC2", "RC2MAC", str, "$CFB8MAC", configurableProvider));
            ...
            ASN1ObjectIdentifier aSN1ObjectIdentifier = PKCSObjectIdentifiers.pbeWithMD2AndRC2_CBC;
            configurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory", aSN1ObjectIdentifier, "PBEWITHMD2ANDRC2");
            ASN1ObjectIdentifier aSN1ObjectIdentifier2 = PKCSObjectIdentifiers.pbeWithMD5AndRC2_CBC;
            configurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory", aSN1ObjectIdentifier2, "PBEWITHMD5ANDRC2");
            ASN1ObjectIdentifier aSN1ObjectIdentifier3 = PKCSObjectIdentifiers.pbeWithSHA1AndRC2_CBC;
            configurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory", aSN1ObjectIdentifier3, "PBEWITHSHA1ANDRC2");
            ...
            AbstractC5601a.m11226A(str, "$PBEWithSHAAnd40BitKeyFactory", "SecretKeyFactory.PBEWITHSHAAND40BITRC2-CBC", AbstractC4801l.m9740n(str, "$PBEWithSHAAnd128BitKeyFactory", "SecretKeyFactory.PBEWITHSHAAND128BITRC2-CBC", AbstractC4801l.m9740n(str, "$PBEWithSHA1KeyFactory", "SecretKeyFactory.PBEWITHSHA1ANDRC2", AbstractC4801l.m9740n(str, "$PBEWithMD5KeyFactory", "SecretKeyFactory.PBEWITHMD5ANDRC2", AbstractC4801l.m9740n(str, "$PBEWithMD2KeyFactory", "SecretKeyFactory.PBEWITHMD2ANDRC2", new StringBuilder(), configurableProvider), configurableProvider), configurableProvider), configurableProvider), configurableProvider);
            configurableProvider.addAlgorithm("Alg.Alias.Cipher", aSN1ObjectIdentifier, "PBEWITHMD2ANDRC2");
            configurableProvider.addAlgorithm("Alg.Alias.Cipher", aSN1ObjectIdentifier2, "PBEWITHMD5ANDRC2");
            configurableProvider.addAlgorithm("Alg.Alias.Cipher", aSN1ObjectIdentifier3, "PBEWITHSHA1ANDRC2");
            ...
            AbstractC5601a.m11226A(str, "$PBEWithSHA1AndRC2", "Cipher.PBEWITHSHA1ANDRC2", new StringBuilder(), configurableProvider);
            ...
            AbstractC5601a.m11226A(str, "$PBEWithMD5AndRC2", "Cipher.PBEWITHMD5ANDRC2", AbstractC4801l.m9740n(str, "$PBEWithSHAAnd40BitRC2", "Cipher.PBEWITHSHAAND40BITRC2-CBC", AbstractC4801l.m9740n(str, "$PBEWithSHAAnd128BitRC2", "Cipher.PBEWITHSHAAND128BITRC2-CBC", new StringBuilder(), configurableProvider), configurableProvider), configurableProvider);
