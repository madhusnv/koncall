...
public final class Noekeon {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addGMacAlgorithm(configurableProvider, "NOEKEON", AbstractC1452a.m4564k(AbstractC4801l.m9740n(str, "$KeyGen", "KeyGenerator.NOEKEON", AbstractC4801l.m9740n(str, "$ECB", "Cipher.NOEKEON", AbstractC4801l.m9740n(str, "$AlgParamGen", "AlgorithmParameterGenerator.NOEKEON", AbstractC4801l.m9740n(str, "$AlgParams", "AlgorithmParameters.NOEKEON", sb2, configurableProvider), configurableProvider), configurableProvider), configurableProvider), str, "$GMAC"), AbstractC1452a.m4561h(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "NOEKEON", AbstractC1452a.m4561h(str, "$Poly1305"), AbstractC1452a.m4561h(str, "$Poly1305KeyGen"));
        }
    }
