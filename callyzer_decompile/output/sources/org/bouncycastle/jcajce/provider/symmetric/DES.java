...
public final class DES {
    ...
    public static class DESPBEKeyFactory extends BaseSecretKeyFactory {
        ...
        public DESPBEKeyFactory(String str, ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z6, int i10, int i11, int i12, int i13) {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            AbstractC5601a.m11226A(str, "$ECB", "Cipher.DES", sb2, configurableProvider);
            ASN1ObjectIdentifier aSN1ObjectIdentifier = OIWObjectIdentifiers.desCBC;
            AbstractC4801l.m9723A(configurableProvider, str, "$CBC", "Cipher", aSN1ObjectIdentifier);
            ...
            sb3.append(str);
            AbstractC5601a.m11227B(AbstractC5601a.m11246q("$CMAC", "Mac.DESCMAC", str, AbstractC5601a.m11246q("$KeyFactory", "SecretKeyFactory.DES", str, AbstractC5601a.m11246q("$KeyGenerator", "KeyGenerator.DES", str, sb3, configurableProvider), configurableProvider), configurableProvider), "$CBCMAC", configurableProvider, "Mac.DESMAC");
            configurableProvider.addAlgorithm("Mac.DESMAC/CFB8", AbstractC5601a.m11239j("Alg.Alias.Mac.DES", "DESMAC", str, "$DESCFB8", configurableProvider));
            configurableProvider.addAlgorithm("Alg.Alias.Mac.DES/CFB8", "DESMAC/CFB8");
            AbstractC5601a.m11226A(str, "$DES64", "Mac.DESMAC64", new StringBuilder(), configurableProvider);
            configurableProvider.addAlgorithm("Mac.DESMAC64WITHISO7816-4PADDING", AbstractC5601a.m11239j("Alg.Alias.Mac.DES64", "DESMAC64", str, "$DES64with7816d4", configurableProvider));
            ...
            AbstractC5601a.m11226A(str, "$DES9797Alg3", "Mac.DESWITHISO9797", new StringBuilder(), configurableProvider);
            configurableProvider.addAlgorithm("Mac.ISO9797ALG3MAC", AbstractC5601a.m11239j("Alg.Alias.Mac.DESISO9797MAC", "DESWITHISO9797", str, "$DES9797Alg3", configurableProvider));
            configurableProvider.addAlgorithm("Alg.Alias.Mac.ISO9797ALG3", "ISO9797ALG3MAC");
            AbstractC5601a.m11226A(str, "$DES9797Alg3with7816d4", "Mac.ISO9797ALG3WITHISO7816-4PADDING", new StringBuilder(), configurableProvider);
            ...
            StringBuilder sbM11248s = AbstractC5601a.m11248s(configurableProvider, "Alg.Alias.AlgorithmParameters", "DES", str, aSN1ObjectIdentifier);
            sbM11248s.append("$AlgParamGen");
            configurableProvider.addAlgorithm("AlgorithmParameterGenerator.DES", sbM11248s.toString());
            AbstractC5601a.m11227B(AbstractC5601a.m11246q("$PBEWithMD5", "Cipher.PBEWITHMD5ANDDES", str, AbstractC5601a.m11246q("$PBEWithMD2", "Cipher.PBEWITHMD2ANDDES", str, AbstractC4801l.m9726D("DES", str, new StringBuilder("Alg.Alias.AlgorithmParameterGenerator."), aSN1ObjectIdentifier, configurableProvider), configurableProvider), configurableProvider), "$PBEWithSHA1", configurableProvider, "Cipher.PBEWITHSHA1ANDDES");
            ...
            AbstractC5601a.m11226A(str, "$PBEWithSHA1KeyFactory", "SecretKeyFactory.PBEWITHSHA1ANDDES", AbstractC4801l.m9740n(str, "$PBEWithMD5KeyFactory", "SecretKeyFactory.PBEWITHMD5ANDDES", AbstractC4801l.m9740n(str, "$PBEWithMD2KeyFactory", "SecretKeyFactory.PBEWITHMD2ANDDES", new StringBuilder(), configurableProvider), configurableProvider), configurableProvider);
            ...
            AbstractC4801l.m9750x(AbstractC4801l.m9741o("PBEWITHMD5ANDDES", "Alg.Alias.SecretKeyFactory.", new StringBuilder("Alg.Alias.SecretKeyFactory."), aSN1ObjectIdentifier3, configurableProvider), aSN1ObjectIdentifier4, configurableProvider, "PBEWITHSHA1ANDDES");
        }
    }
