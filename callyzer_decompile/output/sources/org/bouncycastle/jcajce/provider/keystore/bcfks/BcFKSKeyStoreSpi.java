...
class BcFKSKeyStoreSpi extends KeyStoreSpi {
    ...
    public static class Def extends BcFKSKeyStoreSpi {
        ...
        @Override // org.bouncycastle.jcajce.provider.keystore.bcfks.BcFKSKeyStoreSpi, java.security.KeyStoreSpi
        public /* bridge */ /* synthetic */ void engineStore(OutputStream outputStream, char[] cArr) throws BadPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, IOException, InvalidKeyException {
            super.engineStore(outputStream, cArr);
        }

        @Override // org.bouncycastle.jcajce.provider.keystore.bcfks.BcFKSKeyStoreSpi, java.security.KeyStoreSpi
        public /* bridge */ /* synthetic */ void engineLoad(KeyStore.LoadStoreParameter loadStoreParameter) throws UnsupportedCallbackException, IOException {
        ...
        @Override // org.bouncycastle.jcajce.provider.keystore.bcfks.BcFKSKeyStoreSpi, java.security.KeyStoreSpi
        public /* bridge */ /* synthetic */ void engineStore(KeyStore.LoadStoreParameter loadStoreParameter) throws BadPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, SignatureException, UnsupportedCallbackException, IOException, InvalidKeyException {
    ...
    public static class SharedKeyStoreSpi extends BcFKSKeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
        ...
        @Override // org.bouncycastle.jcajce.provider.keystore.bcfks.BcFKSKeyStoreSpi, java.security.KeyStoreSpi
        public Key engineGetKey(String str, char[] cArr) throws InvalidKeySpecException, UnrecoverableKeyException {
            try {
                ...
                if (this.cache.containsKey(str) && !Arrays.constantTimeAreEqual(this.cache.get(str), bArrCalculateMac)) {
                    throw new UnrecoverableKeyException(AbstractC5601a.m11238i("unable to recover key (", str, ")"));
                }
                ...
                StringBuilder sbM7383p = m0.m7383p("unable to recover key (", str, "): ");
                sbM7383p.append(e2.getMessage());
                throw new UnrecoverableKeyException(sbM7383p.toString());
            }
        }
    ...
    private byte[] calculateMac(byte[] bArr, AlgorithmIdentifier algorithmIdentifier, KeyDerivationFunc keyDerivationFunc, char[] cArr) throws InvalidKeyException, IOException {
        String id2 = algorithmIdentifier.getAlgorithm().getId();
        Mac macCreateMac = this.helper.createMac(id2);
        try {
            if (cArr == null) {
                cArr = new char[0];
            }
            macCreateMac.init(new SecretKeySpec(generateKey(keyDerivationFunc, "INTEGRITY_CHECK", cArr, -1), id2));
    ...
    private byte[] generateKey(KeyDerivationFunc keyDerivationFunc, String str, char[] cArr, int i10) throws IOException {
        ...
        if (MiscObjectIdentifiers.id_scrypt.equals((ASN1Primitive) keyDerivationFunc.getAlgorithm())) {
            ...
            if (scryptParams.getKeyLength() != null) {
                i10 = scryptParams.getKeyLength().intValue();
            } else if (i10 == -1) {
                throw new IOException("no keyLength found in ScryptParams");
            }
            return SCrypt.generate(Arrays.concatenate(bArrPKCS12PasswordToBytes, bArrPKCS12PasswordToBytes2), scryptParams.getSalt(), scryptParams.getCostParameter().intValue(), scryptParams.getBlockSize().intValue(), scryptParams.getBlockSize().intValue(), i10);
        }
        ...
        if (pBKDF2Params.getKeyLength() != null) {
            i10 = pBKDF2Params.getKeyLength().intValue();
        } else if (i10 == -1) {
    ...
    private KeyDerivationFunc generatePkbdAlgorithmIdentifier(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i10) {
        ...
        throw new IllegalStateException(AbstractC4801l.m9734h("unknown derivation algorithm: ", aSN1ObjectIdentifier));
    }
    ...
    private EncryptedObjectStoreData getEncryptedObjectStoreData(AlgorithmIdentifier algorithmIdentifier, char[] cArr) throws BadPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, IOException {
    ...
    private void verifyMac(byte[] bArr, PbkdMacIntegrityCheck pbkdMacIntegrityCheck, char[] cArr) throws IOException {
    ...
    private void verifySig(ASN1Encodable aSN1Encodable, SignatureCheck signatureCheck, PublicKey publicKey) throws SignatureException, InvalidKeyException, IOException {
    ...
    public Key engineGetKey(String str, char[] cArr) throws InvalidKeySpecException, UnrecoverableKeyException {
        ...
        if (!objectData.getType().equals(PRIVATE_KEY) && !objectData.getType().equals(PROTECTED_PRIVATE_KEY)) {
            if (!objectData.getType().equals(SECRET_KEY) && !objectData.getType().equals(PROTECTED_SECRET_KEY)) {
                throw new UnrecoverableKeyException(AbstractC5601a.m11238i("BCFKS KeyStore unable to recover secret key (", str, "): type not recognized"));
            }
            ...
            try {
                ...
                throw new UnrecoverableKeyException(AbstractC0030c.m117h(e2, m0.m7383p("BCFKS KeyStore unable to recover secret key (", str, "): ")));
            }
        }
        ...
        try {
            ...
            throw new UnrecoverableKeyException(AbstractC0030c.m117h(e10, m0.m7383p("BCFKS KeyStore unable to recover private key (", str, "): ")));
        }
    }
            ...
            if (integrityCheck.getType() == 0) {
                ...
                try {
                    ...
                    if (this.validator == null) {
                        ...
                        X509Certificate[] x509CertificateArr = new X509Certificate[length];
                        for (int i10 = 0; i10 != length; i10++) {
                            x509CertificateArr[i10] = (X509Certificate) certificateFactoryCreateCertificateFactory.generateCertificate(new ByteArrayInputStream(certificates[i10].getEncoded()));
                        }
    ...
    public void engineSetCertificateEntry(String str, Certificate certificate) throws KeyStoreException {
        ...
        if (objectData == null) {
            ...
            if (!objectData.getType().equals(CERTIFICATE)) {
                throw new KeyStoreException(m0.m7378k("BCFKS KeyStore already has a key entry with alias ", str));
            }
    ...
    public void engineSetKeyEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) throws KeyStoreException {
        ...
        if (key instanceof PrivateKey) {
            ...
            try {
                ...
                throw new ExtKeyStoreException(AbstractC4801l.m9732f(e2, new StringBuilder("BCFKS KeyStore exception storing private key: ")), e2);
            }
        } else {
            ...
            try {
                ...
                throw new ExtKeyStoreException(AbstractC4801l.m9732f(e10, new StringBuilder("BCFKS KeyStore exception storing private key: ")), e10);
            }
        }
        this.lastModifiedDate = date;
    }
    ...
    @Override // java.security.KeyStoreSpi
    public void engineStore(OutputStream outputStream, char[] cArr) throws BadPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, IOException, InvalidKeyException {
    ...
    @Override // java.security.KeyStoreSpi
    public void engineLoad(KeyStore.LoadStoreParameter loadStoreParameter) throws UnsupportedCallbackException, IOException {
    ...
    @Override // java.security.KeyStoreSpi
    public void engineStore(KeyStore.LoadStoreParameter loadStoreParameter) throws BadPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, SignatureException, UnsupportedCallbackException, IOException, InvalidKeyException {
    ...
    private KeyDerivationFunc generatePkbdAlgorithmIdentifier(KeyDerivationFunc keyDerivationFunc, int i10) {
        ...
        boolean zEquals = aSN1ObjectIdentifier.equals((ASN1Primitive) keyDerivationFunc.getAlgorithm());
        ...
        if (zEquals) {
            ...
            getDefaultSecureRandom().nextBytes(bArr);
            return new KeyDerivationFunc(aSN1ObjectIdentifier, new ScryptParams(bArr, scryptParams.getCostParameter(), scryptParams.getBlockSize(), scryptParams.getParallelizationParameter(), BigInteger.valueOf(i10)));
        }
        ...
        if (certificateArr != null) {
            try {
                ...
                try {
                    ...
                    throw new ExtKeyStoreException(AbstractC4801l.m9732f(e2, new StringBuilder("BCFKS KeyStore exception storing protected private key: ")), e2);
                }
            } catch (Exception e10) {
            ...
            try {
                ...
                throw new ExtKeyStoreException(AbstractC4801l.m9732f(e11, new StringBuilder("BCFKS KeyStore exception storing protected private key: ")), e11);
            }
        }
        this.lastModifiedDate = date;
    }
