...
public class RIPEMD160 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            StringBuilder sbM9726D = AbstractC4801l.m9726D("RIPEMD160", str, new StringBuilder("Alg.Alias.MessageDigest."), TeleTrusTObjectIdentifiers.ripemd160, configurableProvider);
            sbM9726D.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "RIPEMD160", sbM9726D.toString(), AbstractC1452a.m4561h(str, "$KeyGenerator"));
            ...
            sb3.append(str);
            AbstractC5601a.m11227B(sb3, "$PBEWithHmac", configurableProvider, "Mac.PBEWITHHMACRIPEMD160");
        }
    }
