...
public class Haraka {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            AbstractC5601a.m11226A(str, "$Digest512", "MessageDigest.HARAKA-512", AbstractC4801l.m9740n(str, "$Digest256", "MessageDigest.HARAKA-256", sb2, configurableProvider), configurableProvider);
        }
    }
