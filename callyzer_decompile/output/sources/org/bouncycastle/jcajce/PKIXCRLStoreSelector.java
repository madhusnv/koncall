...
public class PKIXCRLStoreSelector<T extends CRL> implements Selector<T> {
    ...
    public static class Builder {
        ...
        public Builder setCompleteCRLEnabled(boolean z6) {
            this.completeCRLEnabled = z6;
            return this;
        }

        public Builder setDeltaCRLIndicatorEnabled(boolean z6) {
            this.deltaCRLIndicator = z6;
            return this;
        }
        ...
        public void setIssuingDistributionPointEnabled(boolean z6) {
            this.issuingDistributionPointEnabled = z6;
        }
