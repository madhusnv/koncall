...
public class GOST28147ParameterSpec implements AlgorithmParameterSpec {
    ...
    private byte[] f44638iv;
    private byte[] sBox;

    static {
        HashMap map = new HashMap();
        oidMappings = map;
        map.put(CryptoProObjectIdentifiers.id_Gost28147_89_CryptoPro_A_ParamSet, "E-A");
    ...
    private static String getName(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        throw new IllegalArgumentException(AbstractC4801l.m9734h("unknown OID: ", aSN1ObjectIdentifier));
    }

    public byte[] getIV() {
        return Arrays.clone(this.f44638iv);
    }
    ...
    public GOST28147ParameterSpec(ASN1ObjectIdentifier aSN1ObjectIdentifier, byte[] bArr) {
        ...
        this.f44638iv = Arrays.clone(bArr);
    }
