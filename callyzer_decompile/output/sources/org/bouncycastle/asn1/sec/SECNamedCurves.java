...
public class SECNamedCurves {
    ...
    static X9ECParametersHolder secp192k1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.8
        @Override // org.bouncycastle.asn1.x9.X9ECParametersHolder
        public ECCurve createCurve() {
            BigInteger bigIntegerFromHex = SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFEE37");
            BigInteger bigInteger = ECConstants.ZERO;
            BigInteger bigIntegerValueOf = BigInteger.valueOf(3L);
            BigInteger bigIntegerFromHex2 = SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFE26F2FC170F69466A74DEFD8D");
            BigInteger bigIntegerValueOf2 = BigInteger.valueOf(1L);
            return SECNamedCurves.configureCurveGLV(new ECCurve.Fp(bigIntegerFromHex, bigInteger, bigIntegerValueOf, bigIntegerFromHex2, bigIntegerValueOf2, true), new GLVTypeBParameters(new BigInteger("bb85691939b869c1d087f601554b96b80cb4f55b35f433c2", 16), new BigInteger("3d84f26c12238d7b4f3d516613c1759033b1a5800175d0b1", 16), new ScalarSplitParameters(new BigInteger[]{new BigInteger("71169be7330b3038edb025f1", 16), new BigInteger("-b3fb3400dec5c4adceb8655c", 16)}, new BigInteger[]{new BigInteger("12511cfe811d0f4e6bc688b4d", 16), new BigInteger("71169be7330b3038edb025f1", 16)}, new BigInteger("71169be7330b3038edb025f1d0f9", 16), new BigInteger("b3fb3400dec5c4adceb8655d4c94", 16), 208)));
        }
    ...
    static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.10
        @Override // org.bouncycastle.asn1.x9.X9ECParametersHolder
        public ECCurve createCurve() {
            BigInteger bigIntegerFromHex = SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFE56D");
            BigInteger bigInteger = ECConstants.ZERO;
            BigInteger bigIntegerValueOf = BigInteger.valueOf(5L);
            BigInteger bigIntegerFromHex2 = SECNamedCurves.fromHex("010000000000000000000000000001DCE8D2EC6184CAF0A971769FB1F7");
            BigInteger bigIntegerValueOf2 = BigInteger.valueOf(1L);
            return SECNamedCurves.configureCurveGLV(new ECCurve.Fp(bigIntegerFromHex, bigInteger, bigIntegerValueOf, bigIntegerFromHex2, bigIntegerValueOf2, true), new GLVTypeBParameters(new BigInteger("fe0e87005b4e83761908c5131d552a850b3f58b749c37cf5b84d6768", 16), new BigInteger("60dcd2104c4cbc0be6eeefc2bdd610739ec34e317f9b33046c9e4788", 16), new ScalarSplitParameters(new BigInteger[]{new BigInteger("6b8cf07d4ca75c88957d9d670591", 16), new BigInteger("-b8adf1378a6eb73409fa6c9c637d", 16)}, new BigInteger[]{new BigInteger("1243ae1b4d71613bc9f780a03690e", 16), new BigInteger("6b8cf07d4ca75c88957d9d670591", 16)}, new BigInteger("6b8cf07d4ca75c88957d9d67059037a4", 16), new BigInteger("b8adf1378a6eb73409fa6c9c637ba7f5", 16), 240)));
        }
    ...
    static X9ECParametersHolder secp256k1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.12
        @Override // org.bouncycastle.asn1.x9.X9ECParametersHolder
        public ECCurve createCurve() {
            BigInteger bigIntegerFromHex = SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFC2F");
            BigInteger bigInteger = ECConstants.ZERO;
            BigInteger bigIntegerValueOf = BigInteger.valueOf(7L);
            BigInteger bigIntegerFromHex2 = SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141");
            BigInteger bigIntegerValueOf2 = BigInteger.valueOf(1L);
            return SECNamedCurves.configureCurveGLV(new ECCurve.Fp(bigIntegerFromHex, bigInteger, bigIntegerValueOf, bigIntegerFromHex2, bigIntegerValueOf2, true), new GLVTypeBParameters(new BigInteger("7ae96a2b657c07106e64479eac3434e99cf0497512f58995c1396c28719501ee", 16), new BigInteger("5363ad4cc05c30e0a5261c028812645a122e22ea20816678df02967c1b23bd72", 16), new ScalarSplitParameters(new BigInteger[]{new BigInteger("3086d221a7d46bcde86c90e49284eb15", 16), new BigInteger("-e4437ed6010e88286f547fa90abfe4c3", 16)}, new BigInteger[]{new BigInteger("114ca50f7a8e2f3f657c1108d9d44cfd8", 16), new BigInteger("3086d221a7d46bcde86c90e49284eb15", 16)}, new BigInteger("3086d221a7d46bcde86c90e49284eb153dab", 16), new BigInteger("e4437ed6010e88286f547fa90abfe4c42212", 16), 272)));
        }
    ...
    static X9ECParametersHolder sect113r1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.16
        @Override // org.bouncycastle.asn1.x9.X9ECParametersHolder
        public ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m(113, 9, SECNamedCurves.fromHex("003088250CA6E7C7FE649CE85820F7"), SECNamedCurves.fromHex("00E8BEE4D3E2260744188BE0E9C723"), SECNamedCurves.fromHex("0100000000000000D9CCEC8A39E56F"), BigInteger.valueOf(2L)));
        }
    ...
    static X9ECParametersHolder sect113r2 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.17
        @Override // org.bouncycastle.asn1.x9.X9ECParametersHolder
        public ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m(113, 9, SECNamedCurves.fromHex("00689918DBEC7E5A0DD6DFC0AA55C7"), SECNamedCurves.fromHex("0095E9A9EC9B297BD4BF36E059184F"), SECNamedCurves.fromHex("010000000000000108789B2496AF93"), BigInteger.valueOf(2L)));
        }
