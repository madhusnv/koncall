...
public class RevokedInfo extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (cRLReason != null) {
            aSN1EncodableVector.add(new DERTaggedObject(true, 0, (ASN1Encodable) cRLReason));
        }
    ...
    public static RevokedInfo getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
