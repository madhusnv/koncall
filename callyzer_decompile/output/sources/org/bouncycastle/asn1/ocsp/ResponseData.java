...
public class ResponseData extends ASN1Object {
    ...
    private ResponseData(ASN1Sequence aSN1Sequence) {
        ...
        int i11 = i10 + 2;
        this.producedAt = ASN1GeneralizedTime.getInstance(aSN1Sequence.getObjectAt(i10 + 1));
        int i12 = i10 + 3;
        this.responses = (ASN1Sequence) aSN1Sequence.getObjectAt(i11);
        if (aSN1Sequence.size() > i12) {
            this.responseExtensions = Extensions.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(i12), true);
        }
    }

    public static ResponseData getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
