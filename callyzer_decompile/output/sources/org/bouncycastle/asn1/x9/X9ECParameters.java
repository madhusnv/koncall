...
public class X9ECParameters extends ASN1Object implements X9ObjectIdentifiers {
    ...
    /* renamed from: g */
    private X9ECPoint f27541g;

    /* renamed from: h */
    private BigInteger f27542h;

    /* renamed from: n */
    private BigInteger f27543n;
    private byte[] seed;
    ...
    private X9ECParameters(ASN1Sequence aSN1Sequence) {
        ...
        this.f27543n = ((ASN1Integer) aSN1Sequence.getObjectAt(4)).getValue();
        if (aSN1Sequence.size() == 6) {
            this.f27542h = ((ASN1Integer) aSN1Sequence.getObjectAt(5)).getValue();
        }
        X9Curve x9Curve = new X9Curve(X9FieldID.getInstance(aSN1Sequence.getObjectAt(1)), this.f27543n, this.f27542h, ASN1Sequence.getInstance(aSN1Sequence.getObjectAt(2)));
        this.curve = x9Curve.getCurve();
        ASN1Encodable objectAt = aSN1Sequence.getObjectAt(3);
        if (objectAt instanceof X9ECPoint) {
            this.f27541g = (X9ECPoint) objectAt;
        } else {
            this.f27541g = new X9ECPoint(this.curve, (ASN1OctetString) objectAt);
        }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f27541g);
        aSN1EncodableVector.add(new ASN1Integer(this.f27543n));
        if (this.f27542h != null) {
            aSN1EncodableVector.add(new ASN1Integer(this.f27542h));
        }
    ...
    public X9ECParameters(ECCurve eCCurve, X9ECPoint x9ECPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        X9FieldID x9FieldID;
        this.curve = eCCurve;
        this.f27541g = x9ECPoint;
        this.f27543n = bigInteger;
        this.f27542h = bigInteger2;
