...
public class X962Parameters extends ASN1Object implements ASN1Choice {
    ...
    public static X962Parameters getInstance(Object obj) {
        ...
        try {
            ...
            throw new IllegalArgumentException(AbstractC0030c.m117h(e2, new StringBuilder("unable to parse encoded data: ")));
        }
    }
    ...
    public static X962Parameters getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        if (z6) {
