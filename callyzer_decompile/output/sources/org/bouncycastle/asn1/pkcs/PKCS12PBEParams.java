...
public class PKCS12PBEParams extends ASN1Object {
    ...
    ASN1OctetString f44486iv;

    private PKCS12PBEParams(ASN1Sequence aSN1Sequence) {
        this.f44486iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
    ...
    public byte[] getIV() {
        return this.f44486iv.getOctets();
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f44486iv);
        aSN1EncodableVector.add(this.iterations);
        return new DERSequence(aSN1EncodableVector);
    }

    public PKCS12PBEParams(byte[] bArr, int i10) {
        this.f44486iv = new DEROctetString(bArr);
        this.iterations = new ASN1Integer(i10);
    }
}
