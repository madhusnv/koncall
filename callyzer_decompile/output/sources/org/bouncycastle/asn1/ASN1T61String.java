...
public abstract class ASN1T61String extends ASN1Primitive implements ASN1String {
    ...
    public final void encode(ASN1OutputStream aSN1OutputStream, boolean z6) {
        aSN1OutputStream.writeEncodingDL(z6, 20, this.contents);
    }
    ...
    public ASN1T61String(byte[] bArr, boolean z6) {
        this.contents = z6 ? Arrays.clone(bArr) : bArr;
    }

    public static ASN1T61String getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        return (ASN1T61String) TYPE.getContextInstance(aSN1TaggedObject, z6);
    }
}
