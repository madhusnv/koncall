...
public class DeltaCertificateDescriptor extends ASN1Object {
    ...
    private DeltaCertificateDescriptor(ASN1Sequence aSN1Sequence) {
        ...
        ASN1Encodable objectAt3 = aSN1Sequence.getObjectAt(i10);
        while (objectAt3 instanceof ASN1TaggedObject) {
            ...
            ASN1Encodable objectAt4 = aSN1Sequence.getObjectAt(i10);
            i10++;
            objectAt3 = objectAt4;
        }
    ...
    private void addOptional(ASN1EncodableVector aSN1EncodableVector, int i10, boolean z6, ASN1Object aSN1Object) {
        if (aSN1Object != null) {
            aSN1EncodableVector.add(new DERTaggedObject(z6, i10, aSN1Object));
        }
    }
            ...
            while (true) {
                ...
                if (tagNo != 0) {
                    if (tagNo != 1) {
                        ...
                        } else if (!ASN1Sequence.getInstance(aSN1TaggedObject, false).equals((ASN1Primitive) dERSequence)) {
                            break;
                        }
