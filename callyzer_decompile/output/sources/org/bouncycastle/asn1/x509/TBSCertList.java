...
public class TBSCertList extends ASN1Object {
    ...
    public static class RevokedCertificatesEnumeration implements Enumeration {
        ...
        private final Enumeration f44495en;

        public RevokedCertificatesEnumeration(Enumeration enumeration) {
            this.f44495en = enumeration;
        }

        @Override // java.util.Enumeration
        public boolean hasMoreElements() {
            return this.f44495en.hasMoreElements();
        }

        @Override // java.util.Enumeration
        public Object nextElement() {
            return CRLEntry.getInstance(this.f44495en.nextElement());
        }
    }
    ...
    public TBSCertList(ASN1Sequence aSN1Sequence) {
        ...
        this.issuer = X500Name.getInstance(aSN1Sequence.getObjectAt(i10 + 1));
        int i11 = i10 + 3;
        this.thisUpdate = Time.getInstance(aSN1Sequence.getObjectAt(i10 + 2));
        if (i11 < aSN1Sequence.size() && ((aSN1Sequence.getObjectAt(i11) instanceof ASN1UTCTime) || (aSN1Sequence.getObjectAt(i11) instanceof ASN1GeneralizedTime) || (aSN1Sequence.getObjectAt(i11) instanceof Time))) {
            this.nextUpdate = Time.getInstance(aSN1Sequence.getObjectAt(i11));
            i11 = i10 + 4;
        }
        if (i11 < aSN1Sequence.size() && !(aSN1Sequence.getObjectAt(i11) instanceof ASN1TaggedObject)) {
            this.revokedCertificates = ASN1Sequence.getInstance(aSN1Sequence.getObjectAt(i11));
            i11++;
        }
        if (i11 >= aSN1Sequence.size() || !(aSN1Sequence.getObjectAt(i11) instanceof ASN1TaggedObject)) {
            return;
        }
        this.crlExtensions = Extensions.getInstance(ASN1Sequence.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(i11), true));
    }
    ...
    public static TBSCertList getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
