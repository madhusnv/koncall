...
public class Time extends ASN1Object implements ASN1Choice {
    ...
    public Time(Date date) throws NumberFormatException {
        ...
        this.time = (i10 < 1950 || i10 > 2049) ? new DERGeneralizedTime(str) : new DERUTCTime(str.substring(2));
    }
    ...
    public static Time getInstance(Object obj) {
        ...
        throw new IllegalArgumentException(AbstractC5601a.m11234e(obj, "unknown object in factory: "));
    }
    ...
    public static Time getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        if (z6) {
