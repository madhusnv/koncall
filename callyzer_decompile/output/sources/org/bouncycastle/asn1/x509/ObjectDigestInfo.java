...
public class ObjectDigestInfo extends ASN1Object {
    ...
    public ObjectDigestInfo(int i10, ASN1ObjectIdentifier aSN1ObjectIdentifier, AlgorithmIdentifier algorithmIdentifier, byte[] bArr) {
        this.digestedObjectType = new ASN1Enumerated(i10);
        if (i10 == 2) {
    ...
    private ObjectDigestInfo(ASN1Sequence aSN1Sequence) {
        ...
        this.digestAlgorithm = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(i10 + 1));
        this.objectDigest = ASN1BitString.getInstance(aSN1Sequence.getObjectAt(i10 + 2));
    }

    public static ObjectDigestInfo getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
