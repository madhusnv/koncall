...
public class V2TBSCertListGenerator {
    ...
    private static ASN1Sequence createInvalidityDateExtension(ASN1GeneralizedTime aSN1GeneralizedTime) {
        ...
        try {
            ...
            throw new IllegalArgumentException(AbstractC4801l.m9733g("error encoding reason: ", e2));
        }
    }

    private static ASN1Sequence createReasonExtension(int i10) {
        ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector(2);
        CRLReason cRLReasonLookup = CRLReason.lookup(i10);
        try {
    ...
    public void addCRLEntry(ASN1Integer aSN1Integer, Time time, int i10, ASN1GeneralizedTime aSN1GeneralizedTime) {
        ...
        if (i10 >= aSN1SequenceArr.length) {
            aSN1EncodableVector.add(createReasonExtension(i10));
        } else {
            if (i10 < 0) {
                throw new IllegalArgumentException(AbstractC4801l.m9730d(i10, "invalid reason value: "));
            }
            aSN1EncodableVector.add(aSN1SequenceArr[i10]);
        }
        if (aSN1GeneralizedTime != null) {
