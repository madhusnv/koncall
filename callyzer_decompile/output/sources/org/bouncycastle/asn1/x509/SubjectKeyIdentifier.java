...
public class SubjectKeyIdentifier extends ASN1Object {
    ...
    public static SubjectKeyIdentifier getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        return getInstance(ASN1OctetString.getInstance(aSN1TaggedObject, z6));
    }
}
