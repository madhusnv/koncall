...
public class AltSignatureAlgorithm extends ASN1Object {
    ...
    public static AltSignatureAlgorithm getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        return getInstance(AlgorithmIdentifier.getInstance(aSN1TaggedObject, z6));
    }
