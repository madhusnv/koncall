...
public class GeneralNames extends ASN1Object {
    ...
    public static GeneralNames getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        return new GeneralNames(ASN1Sequence.getInstance(aSN1TaggedObject, z6));
    }
