...
public class X509Extensions extends ASN1Object {
    ...
    public static X509Extensions getInstance(Object obj) {
        ...
        if (obj instanceof ASN1TaggedObject) {
            return getInstance(ASN1TaggedObject.getInstance(obj, 128).getBaseObject().toASN1Primitive());
        }
    ...
    public X509Extensions(Vector vector, Hashtable hashtable) {
        ...
        while (enumerationKeys.hasMoreElements()) {
            this.ordering.addElement(ASN1ObjectIdentifier.getInstance(enumerationKeys.nextElement()));
        }
        Enumeration enumerationElements = this.ordering.elements();
        while (enumerationElements.hasMoreElements()) {
            ASN1ObjectIdentifier aSN1ObjectIdentifier = ASN1ObjectIdentifier.getInstance(enumerationElements.nextElement());
            this.extensions.put(aSN1ObjectIdentifier, (X509Extension) hashtable.get(aSN1ObjectIdentifier));
        }
    }

    private ASN1ObjectIdentifier[] getExtensionOIDs(boolean z6) {
        Vector vector = new Vector();
        for (int i10 = 0; i10 != this.ordering.size(); i10++) {
            Object objElementAt = this.ordering.elementAt(i10);
            if (((X509Extension) this.extensions.get(objElementAt)).isCritical() == z6) {
    ...
    public X509Extensions(Vector vector, Vector vector2) {
        ...
        while (enumerationElements2.hasMoreElements()) {
            this.extensions.put((ASN1ObjectIdentifier) enumerationElements2.nextElement(), (X509Extension) vector2.elementAt(i10));
            i10++;
        }
    }
        ...
        while (objects.hasMoreElements()) {
            ...
            if (aSN1Sequence2.size() == 3) {
                ...
                if (aSN1Sequence2.size() != 2) {
                    throw new IllegalArgumentException(AbstractC4801l.m9738l(aSN1Sequence2, new StringBuilder("Bad sequence size: ")));
                }
    ...
    public static X509Extensions getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
