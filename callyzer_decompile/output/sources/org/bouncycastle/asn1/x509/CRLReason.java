...
public class CRLReason extends ASN1Object {
    ...
    public static CRLReason lookup(int i10) {
        Integer numValueOf = Integers.valueOf(i10);
        Hashtable hashtable = table;
        if (!hashtable.containsKey(numValueOf)) {
            hashtable.put(numValueOf, new CRLReason(i10));
        }
    ...
    public String toString() {
        ...
        return m0.m7378k("CRLReason: ", (iIntValue < 0 || iIntValue > 10) ? "invalid" : reasonString[iIntValue]);
    }
}
