...
public class BasicConstraints extends ASN1Object {
    ...
    public String toString() {
        ...
        if (this.pathLenConstraint == null) {
            ...
            sb2.append(this.pathLenConstraint.getValue());
        }
        return sb2.toString();
    }
    ...
    public static BasicConstraints getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        return getInstance(ASN1Sequence.getInstance(aSN1TaggedObject, z6));
    }

    public BasicConstraints(boolean z6) {
        this.cA = ASN1Boolean.getInstance(false);
        this.pathLenConstraint = null;
        if (z6) {
            this.cA = ASN1Boolean.getInstance(true);
