...
public abstract class ASN1GraphicString extends ASN1Primitive implements ASN1String {
    ...
    public ASN1GraphicString(byte[] bArr, boolean z6) {
        if (bArr == null) {
    ...
    public final void encode(ASN1OutputStream aSN1OutputStream, boolean z6) {
        aSN1OutputStream.writeEncodingDL(z6, 25, this.contents);
    }
    ...
    public static ASN1GraphicString getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        return (ASN1GraphicString) TYPE.getContextInstance(aSN1TaggedObject, z6);
    }
}
