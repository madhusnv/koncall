...
public abstract class ASN1OctetString extends ASN1Primitive implements ASN1OctetStringParser {
    ...
    public static ASN1OctetString getInstance(Object obj) {
        ...
        if (obj instanceof ASN1Encodable) {
            ...
            try {
                ...
                throw new IllegalArgumentException(AbstractC4801l.m9731e(e2, new StringBuilder("failed to construct OCTET STRING from byte[]: ")));
            }
        }
    ...
    public String toString() {
        return ModelIdentifier.Helper.PRIMARY_KEY_DELIMITER + Strings.fromByteArray(Hex.encode(this.string));
    }

    public static ASN1OctetString getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        return (ASN1OctetString) TYPE.getContextInstance(aSN1TaggedObject, z6);
    }
