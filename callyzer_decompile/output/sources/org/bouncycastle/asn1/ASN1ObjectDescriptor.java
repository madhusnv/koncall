...
public final class ASN1ObjectDescriptor extends ASN1Primitive {
    ...
    public static ASN1ObjectDescriptor getInstance(Object obj) {
        ...
        if (obj instanceof ASN1Encodable) {
            ...
            try {
                ...
                throw new IllegalArgumentException(AbstractC4801l.m9731e(e2, new StringBuilder("failed to construct object descriptor from byte[]: ")));
            }
        }
    ...
    public void encode(ASN1OutputStream aSN1OutputStream, boolean z6) throws IOException {
        aSN1OutputStream.writeIdentifier(z6, 7);
    ...
    public int encodedLength(boolean z6) {
        return this.baseGraphicString.encodedLength(z6);
    }
    ...
    public static ASN1ObjectDescriptor getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        return (ASN1ObjectDescriptor) TYPE.getContextInstance(aSN1TaggedObject, z6);
    }
}
