...
public abstract class ASN1External extends ASN1Primitive {
    ...
    public ASN1External(ASN1ObjectIdentifier aSN1ObjectIdentifier, ASN1Integer aSN1Integer, ASN1Primitive aSN1Primitive, int i10, ASN1Primitive aSN1Primitive2) {
        ...
        this.encoding = checkEncoding(i10);
        this.externalContent = checkExternalContent(i10, aSN1Primitive2);
    }

    private static int checkEncoding(int i10) {
        if (i10 < 0 || i10 > 2) {
            throw new IllegalArgumentException(AbstractC4801l.m9730d(i10, "invalid encoding value: "));
        }
        return i10;
    }

    private static ASN1Primitive checkExternalContent(int i10, ASN1Primitive aSN1Primitive) {
    ...
    public static ASN1External getInstance(Object obj) {
        ...
        if (obj instanceof ASN1Encodable) {
            ...
            try {
                ...
                throw new IllegalArgumentException(AbstractC4801l.m9731e(e2, new StringBuilder("failed to construct external from byte[]: ")));
            }
        }
        throw new IllegalArgumentException(AbstractC5601a.m11234e(obj, "illegal object in getInstance: "));
    }

    private static ASN1Primitive getObjFromSequence(ASN1Sequence aSN1Sequence, int i10) {
        if (aSN1Sequence.size() > i10) {
            return aSN1Sequence.getObjectAt(i10).toASN1Primitive();
        }
    ...
    public void encode(ASN1OutputStream aSN1OutputStream, boolean z6) throws IOException {
        aSN1OutputStream.writeIdentifier(z6, 40);
    ...
    public int encodedLength(boolean z6) {
        return buildSequence().encodedLength(z6);
    }
    ...
    public ASN1External(ASN1Sequence aSN1Sequence) {
        ...
        if (objFromSequence instanceof ASN1Integer) {
            ...
            i10++;
            objFromSequence = getObjFromSequence(aSN1Sequence, i10);
        }
    ...
    public static ASN1External getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        return (ASN1External) TYPE.getContextInstance(aSN1TaggedObject, z6);
    }
}
