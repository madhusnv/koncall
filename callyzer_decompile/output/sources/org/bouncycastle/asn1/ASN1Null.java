...
public abstract class ASN1Null extends ASN1Primitive {
    ...
    public static ASN1Null getInstance(Object obj) {
        ...
        try {
            ...
            throw new IllegalArgumentException(AbstractC4801l.m9731e(e2, new StringBuilder("failed to construct NULL from byte[]: ")));
        }
    }
    ...
    public static ASN1Null getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        return (ASN1Null) TYPE.getContextInstance(aSN1TaggedObject, z6);
    }
}
