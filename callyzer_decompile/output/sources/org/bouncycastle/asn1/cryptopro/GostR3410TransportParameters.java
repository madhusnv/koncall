...
public class GostR3410TransportParameters extends ASN1Object {
    ...
    private GostR3410TransportParameters(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 2) {
            ...
            this.ukm = AbstractC1452a.m4553D(aSN1Sequence, 1);
            this.ephemeralPublicKey = null;
        } else {
            if (aSN1Sequence.size() != 3) {
                throw new IllegalArgumentException(AbstractC4801l.m9738l(aSN1Sequence, new StringBuilder("unknown sequence length: ")));
            }
            this.encryptionParamSet = ASN1ObjectIdentifier.getInstance(aSN1Sequence.getObjectAt(0));
            this.ephemeralPublicKey = SubjectPublicKeyInfo.getInstance(ASN1TaggedObject.getInstance(aSN1Sequence.getObjectAt(1)), false);
            this.ukm = AbstractC1452a.m4553D(aSN1Sequence, 2);
        }
    }

    public static GostR3410TransportParameters getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        return new GostR3410TransportParameters(ASN1Sequence.getInstance(aSN1TaggedObject, z6));
    }
}
