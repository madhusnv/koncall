...
public class GOST28147Parameters extends ASN1Object {
    ...
    public byte[] getIV() {
        return Arrays.clone(this.f44483iv.getOctets());
    }

    @Override // org.bouncycastle.asn1.ASN1Object, org.bouncycastle.asn1.ASN1Encodable
    public ASN1Primitive toASN1Primitive() {
        ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector(2);
        aSN1EncodableVector.add(this.f44483iv);
    ...
    public GOST28147Parameters(byte[] bArr, ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        this.f44483iv = new DEROctetString(Arrays.clone(bArr));
        this.paramSet = aSN1ObjectIdentifier;
    }

    public static GOST28147Parameters getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
