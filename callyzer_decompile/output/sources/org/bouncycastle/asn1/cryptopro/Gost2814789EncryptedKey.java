...
public class Gost2814789EncryptedKey extends ASN1Object {
    ...
    private Gost2814789EncryptedKey(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 2) {
            this.encryptedKey = AbstractC4801l.m9724B(aSN1Sequence, 0);
            this.macKey = AbstractC4801l.m9724B(aSN1Sequence, 1);
            this.maskKey = null;
        } else {
            ...
            this.macKey = AbstractC4801l.m9724B(aSN1Sequence, 2);
        }
    }
