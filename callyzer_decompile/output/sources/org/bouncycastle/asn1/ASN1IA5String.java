...
public abstract class ASN1IA5String extends ASN1Primitive implements ASN1String {
    ...
    public ASN1IA5String(String str, boolean z6) {
        if (str == null) {
            throw new NullPointerException("'string' cannot be null");
        }
        if (z6 && !isIA5String(str)) {
    ...
    public final void encode(ASN1OutputStream aSN1OutputStream, boolean z6) {
        aSN1OutputStream.writeEncodingDL(z6, 22, this.contents);
    }
    ...
    public ASN1IA5String(byte[] bArr, boolean z6) {
        this.contents = z6 ? Arrays.clone(bArr) : bArr;
    }

    public static ASN1IA5String getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        return (ASN1IA5String) TYPE.getContextInstance(aSN1TaggedObject, z6);
    }
}
