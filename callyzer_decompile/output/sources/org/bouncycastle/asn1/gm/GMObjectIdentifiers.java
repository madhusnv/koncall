...
public interface GMObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch = aSN1ObjectIdentifier.branch("301.3");
        sm2encrypt = aSN1ObjectIdentifierBranch;
        wapip192v1 = aSN1ObjectIdentifier.branch("301.101");
        wapi192v1 = new ASN1ObjectIdentifier("1.2.156.11235.1.1.1");
        wapi192v1_parameters = new ASN1ObjectIdentifier("1.2.156.11235.1.1.2.1");
        sm2encrypt_recommendedParameters = aSN1ObjectIdentifierBranch.branch("1");
        sm2encrypt_specifiedParameters = aSN1ObjectIdentifierBranch.branch("2");
        sm2encrypt_with_sm3 = aSN1ObjectIdentifierBranch.branch("2.1");
        sm2encrypt_with_sha1 = aSN1ObjectIdentifierBranch.branch("2.2");
        sm2encrypt_with_sha224 = aSN1ObjectIdentifierBranch.branch("2.3");
        sm2encrypt_with_sha256 = aSN1ObjectIdentifierBranch.branch("2.4");
        sm2encrypt_with_sha384 = aSN1ObjectIdentifierBranch.branch("2.5");
        sm2encrypt_with_sha512 = aSN1ObjectIdentifierBranch.branch("2.6");
        sm2encrypt_with_rmd160 = aSN1ObjectIdentifierBranch.branch("2.7");
        sm2encrypt_with_whirlpool = aSN1ObjectIdentifierBranch.branch("2.8");
        sm2encrypt_with_blake2b512 = aSN1ObjectIdentifierBranch.branch("2.9");
        sm2encrypt_with_blake2s256 = aSN1ObjectIdentifierBranch.branch("2.10");
        sm2encrypt_with_md5 = aSN1ObjectIdentifierBranch.branch("2.11");
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch2 = aSN1ObjectIdentifier.branch("401");
        sm3 = aSN1ObjectIdentifierBranch2;
        hmac_sm3 = aSN1ObjectIdentifierBranch2.branch("2");
