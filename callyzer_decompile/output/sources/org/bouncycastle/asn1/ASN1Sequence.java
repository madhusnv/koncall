...
public abstract class ASN1Sequence extends ASN1Primitive implements Iterable<ASN1Encodable> {
    ...
    public static ASN1Sequence getInstance(Object obj) {
        ...
        if (obj instanceof ASN1Encodable) {
            ...
            try {
                ...
                throw new IllegalArgumentException(AbstractC4801l.m9731e(e2, new StringBuilder("failed to construct sequence from byte[]: ")));
            }
        }
    ...
    public ASN1BitString[] getConstructedBitStrings() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            aSN1BitStringArr[i10] = ASN1BitString.getInstance(this.elements[i10]);
        }
    ...
    public ASN1OctetString[] getConstructedOctetStrings() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            aSN1OctetStringArr[i10] = ASN1OctetString.getInstance(this.elements[i10]);
        }
    ...
    public ASN1Sequence(ASN1Encodable[] aSN1EncodableArr, boolean z6) {
        this.elements = z6 ? ASN1EncodableVector.cloneElements(aSN1EncodableArr) : aSN1EncodableArr;
    }

    public static ASN1Sequence getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        return (ASN1Sequence) TYPE.getContextInstance(aSN1TaggedObject, z6);
    }
}
