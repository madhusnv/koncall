...
public abstract class ASN1UTF8String extends ASN1Primitive implements ASN1String {
    ...
    public final void encode(ASN1OutputStream aSN1OutputStream, boolean z6) {
        aSN1OutputStream.writeEncodingDL(z6, 12, this.contents);
    }
    ...
    public ASN1UTF8String(byte[] bArr, boolean z6) {
        this.contents = z6 ? Arrays.clone(bArr) : bArr;
    }

    public static ASN1UTF8String getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        return (ASN1UTF8String) TYPE.getContextInstance(aSN1TaggedObject, z6);
    }
}
