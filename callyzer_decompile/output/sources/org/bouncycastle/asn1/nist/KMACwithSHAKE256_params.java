...
public class KMACwithSHAKE256_params extends ASN1Object {
    ...
    public KMACwithSHAKE256_params(int i10) {
    ...
    public KMACwithSHAKE256_params(int i10, byte[] bArr) {
        this.outputLength = i10;
    ...
    private KMACwithSHAKE256_params(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() == 2) {
            this.outputLength = AbstractC4801l.m9728b(aSN1Sequence, 0);
            this.customizationString = AbstractC4801l.m9724B(aSN1Sequence, 1);
            ...
            this.outputLength = 512;
            this.customizationString = AbstractC4801l.m9724B(aSN1Sequence, 0);
        }
    }
}
