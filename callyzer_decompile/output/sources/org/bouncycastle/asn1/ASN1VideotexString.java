...
public abstract class ASN1VideotexString extends ASN1Primitive implements ASN1String {
    ...
    public ASN1VideotexString(byte[] bArr, boolean z6) {
    ...
    public final void encode(ASN1OutputStream aSN1OutputStream, boolean z6) {
        aSN1OutputStream.writeEncodingDL(z6, 21, this.contents);
    }
    ...
    public static ASN1VideotexString getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        return (ASN1VideotexString) TYPE.getContextInstance(aSN1TaggedObject, z6);
    }
}
