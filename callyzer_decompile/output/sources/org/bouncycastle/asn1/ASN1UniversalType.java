...
abstract class ASN1UniversalType extends ASN1Type {
    ...
    public ASN1UniversalType(Class cls, int i10) {
        super(cls);
        this.tag = ASN1Tag.create(0, i10);
    }
    ...
    public final ASN1Primitive getContextInstance(ASN1TaggedObject aSN1TaggedObject, boolean z6) {
        if (128 == aSN1TaggedObject.getTagClass()) {
            return checkedCast(aSN1TaggedObject.getBaseUniversal(z6, this));
        }
