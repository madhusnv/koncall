...
public class ScryptParams extends ASN1Object {
    ...
    private ScryptParams(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() != 4 && aSN1Sequence.size() != 5) {
            throw new IllegalArgumentException(AbstractC4801l.m9738l(aSN1Sequence, new StringBuilder("invalid sequence: size = ")));
        }
        this.salt = AbstractC4801l.m9724B(aSN1Sequence, 0);
