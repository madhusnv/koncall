...
class X509Util {
    ...
    public static byte[] calculateSignature(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str, String str2, PrivateKey privateKey, SecureRandom secureRandom, ASN1Encodable aSN1Encodable) throws SignatureException, InvalidKeyException {
    ...
    public static Implementation getImplementation(String str, String str2) throws NoSuchAlgorithmException {
        ...
        throw new NoSuchAlgorithmException(m0.m7378k("cannot find implementation ", str2));
    }
    ...
    public static Provider getProvider(String str) throws NoSuchProviderException {
        ...
        throw new NoSuchProviderException(AbstractC5601a.m11238i("Provider ", str, " not found"));
    }
    ...
    public static byte[] calculateSignature(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str, PrivateKey privateKey, SecureRandom secureRandom, ASN1Encodable aSN1Encodable) throws SignatureException, InvalidKeyException {
        if (aSN1ObjectIdentifier == null) {
            throw new IllegalStateException("no signature algorithm specified");
        }
    ...
    public static Implementation getImplementation(String str, String str2, Provider provider) throws NoSuchAlgorithmException {
        ...
        if (property2 != null) {
            try {
                ...
                StringBuilder sbM7383p = m0.m7383p("algorithm ", upperCase, " in provider ");
                sbM7383p.append(provider.getName());
                sbM7383p.append(" but no class \"");
                sbM7383p.append(property2);
                sbM7383p.append("\" found!");
                throw new IllegalStateException(sbM7383p.toString());
            } catch (Exception unused2) {
                StringBuilder sbM7383p2 = m0.m7383p("algorithm ", upperCase, " in provider ");
                sbM7383p2.append(provider.getName());
                sbM7383p2.append(" but class \"");
                sbM7383p2.append(property2);
                sbM7383p2.append("\" inaccessible!");
                throw new IllegalStateException(sbM7383p2.toString());
            }
        }
        StringBuilder sbM7383p3 = m0.m7383p("cannot find implementation ", upperCase, " for provider ");
        sbM7383p3.append(provider.getName());
        throw new NoSuchAlgorithmException(sbM7383p3.toString());
    }
}
