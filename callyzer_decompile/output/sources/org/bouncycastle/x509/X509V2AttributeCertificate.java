...
public class X509V2AttributeCertificate implements X509AttributeCertificate {
    ...
    private Set getExtensionOIDs(boolean z6) {
        ...
        while (enumerationOids.hasMoreElements()) {
            ...
            if (extensions.getExtension(aSN1ObjectIdentifier).isCritical() == z6) {
    ...
    private static AttributeCertificate getObject(InputStream inputStream) throws IOException {
        try {
            ...
            throw new IOException(AbstractC4801l.m9732f(e10, new StringBuilder("exception decoding certificate structure: ")));
        }
    }
