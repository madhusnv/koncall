...
public class X509CertStoreSelector extends X509CertSelector implements Selector {
    public static X509CertStoreSelector getInstance(X509CertSelector x509CertSelector) throws IOException {
        ...
        try {
            ...
            throw new IllegalArgumentException(AbstractC4801l.m9733g("error in passed in selector: ", e2));
        }
    }
