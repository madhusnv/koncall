...
public class X509AttributeCertStoreSelector implements Selector {
    ...
    private Set extractGeneralNames(Collection collection) {
        ...
        for (Object generalName : collection) {
            if (!(generalName instanceof GeneralName)) {
                generalName = GeneralName.getInstance(ASN1Primitive.fromByteArray((byte[]) generalName));
            }
                ...
                if (!this.targetNames.isEmpty()) {
                    ...
                    for (Targets targets : targetsObjects) {
                        ...
                        while (true) {
                            ...
                            if (this.targetNames.contains(GeneralName.getInstance(targets2[i10].getTargetName()))) {
                                z6 = true;
                                break;
                            }
                            i10++;
            ...
            if (!this.targetGroups.isEmpty()) {
                ...
                for (Targets targets3 : targetsObjects) {
                    ...
                    while (true) {
                        ...
                        if (this.targetGroups.contains(GeneralName.getInstance(targets4[i11].getTargetGroup()))) {
                            z10 = true;
                            break;
                        }
                        i11++;
