...
public abstract class Nat {
    ...
    /* renamed from: M */
    private static final long f27962M = 4294967295L;

    public static int add(int i10, int[] iArr, int[] iArr2, int[] iArr3) {
        long j6 = 0;
        for (int i11 = 0; i11 < i10; i11++) {
            long j10 = (iArr[i11] & f27962M) + (f27962M & iArr2[i11]) + j6;
            iArr3[i11] = (int) j10;
            j6 = j10 >>> 32;
        }
        return (int) j6;
    ...
    public static int add33At(int i10, int i11, int[] iArr, int i12) {
        long j6 = (iArr[i12] & f27962M) + (i11 & f27962M);
        iArr[i12] = (int) j6;
        long j10 = (f27962M & iArr[r4]) + 1 + (j6 >>> 32);
        iArr[i12 + 1] = (int) j10;
        if ((j10 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int add33To(int i10, int i11, int[] iArr) {
        long j6 = (iArr[0] & f27962M) + (i11 & f27962M);
        iArr[0] = (int) j6;
        long j10 = (f27962M & iArr[1]) + 1 + (j6 >>> 32);
        iArr[1] = (int) j10;
        if ((j10 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addBothTo(int i10, int[] iArr, int i11, int[] iArr2, int i12, int[] iArr3, int i13) {
        ...
        for (int i14 = 0; i14 < i10; i14++) {
            long j10 = (iArr[i11 + i14] & f27962M) + (iArr2[i12 + i14] & f27962M) + (f27962M & iArr3[r7]) + j6;
    ...
    public static int addDWordAt(int i10, long j6, int[] iArr, int i11) {
        long j10 = (iArr[i11] & f27962M) + (j6 & f27962M);
        iArr[i11] = (int) j10;
        long j11 = (f27962M & iArr[r5]) + (j6 >>> 32) + (j10 >>> 32);
        iArr[i11 + 1] = (int) j11;
        if ((j11 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordTo(int i10, long j6, int[] iArr) {
        long j10 = (iArr[0] & f27962M) + (j6 & f27962M);
        iArr[0] = (int) j10;
        long j11 = (f27962M & iArr[1]) + (j6 >>> 32) + (j10 >>> 32);
        iArr[1] = (int) j11;
        if ((j11 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addTo(int i10, int[] iArr, int i11, int[] iArr2, int i12) {
        ...
        for (int i13 = 0; i13 < i10; i13++) {
            long j10 = (iArr[i11 + i13] & f27962M) + (f27962M & iArr2[r7]) + j6;
    ...
    public static int addToEachOther(int i10, int[] iArr, int i11, int[] iArr2, int i12) {
        long j6 = 0;
        for (int i13 = 0; i13 < i10; i13++) {
            long j10 = (iArr[r3] & f27962M) + (f27962M & iArr2[r8]) + j6;
            int i14 = (int) j10;
            iArr[i11 + i13] = i14;
            iArr2[i12 + i13] = i14;
            j6 = j10 >>> 32;
    ...
    public static int addWordAt(int i10, int i11, int[] iArr, int i12) {
        long j6 = (i11 & f27962M) + (f27962M & iArr[i12]);
        iArr[i12] = (int) j6;
        if ((j6 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addWordTo(int i10, int i11, int[] iArr) {
        long j6 = (i11 & f27962M) + (f27962M & iArr[0]);
        iArr[0] = (int) j6;
        if ((j6 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int cadd(int i10, int i11, int[] iArr, int[] iArr2, int[] iArr3) {
        long j6 = (-(i11 & 1)) & f27962M;
        long j10 = 0;
        for (int i12 = 0; i12 < i10; i12++) {
            long j11 = (iArr[i12] & f27962M) + (iArr2[i12] & j6) + j10;
            iArr3[i12] = (int) j11;
            j10 = j11 >>> 32;
        }
        return (int) j10;
    ...
    public static int caddTo(int i10, int i11, int[] iArr, int[] iArr2) {
        long j6 = (-(i11 & 1)) & f27962M;
        long j10 = 0;
        for (int i12 = 0; i12 < i10; i12++) {
            long j11 = (iArr2[i12] & f27962M) + (iArr[i12] & j6) + j10;
            iArr2[i12] = (int) j11;
            j10 = j11 >>> 32;
        }
        return (int) j10;
    ...
    public static int csub(int i10, int i11, int[] iArr, int i12, int[] iArr2, int i13, int[] iArr3, int i14) {
        ...
        long j10 = 0;
        for (int i15 = 0; i15 < i10; i15++) {
            long j11 = ((iArr[i12 + i15] & f27962M) - (iArr2[i13 + i15] & j6)) + j10;
            iArr3[i14 + i15] = (int) j11;
            j10 = j11 >> 32;
        }
        return (int) j10;
    }
    ...
    public static boolean diff(int i10, int[] iArr, int i11, int[] iArr2, int i12, int[] iArr3, int i13) {
        boolean zGte = gte(i10, iArr, i11, iArr2, i12);
        if (zGte) {
    ...
    public static int[] fromBigInteger(int i10, BigInteger bigInteger) {
        ...
        int i11 = (i10 + 31) >> 5;
        int[] iArrCreate = create(i11);
        for (int i12 = 0; i12 < i11; i12++) {
            iArrCreate[i12] = bigInteger.intValue();
    ...
    public static long[] fromBigInteger64(int i10, BigInteger bigInteger) {
        ...
        int i11 = (i10 + 63) >> 6;
        long[] jArrCreate64 = create64(i11);
        for (int i12 = 0; i12 < i11; i12++) {
            jArrCreate64[i12] = bigInteger.longValue();
    ...
    public static int lessThan(int i10, int[] iArr, int i11, int[] iArr2, int i12) {
        long j6 = 0;
        for (int i13 = 0; i13 < i10; i13++) {
            j6 = (((iArr[i11 + i13] & f27962M) - (f27962M & iArr2[i12 + i13])) + j6) >> 32;
        }
        return (int) j6;
    }
    ...
    public static int mul31BothAdd(int i10, int i11, int[] iArr, int i12, int[] iArr2, int[] iArr3, int i13) {
        long j6 = i11 & f27962M;
        long j10 = i12 & f27962M;
        long j11 = 0;
        int i14 = 0;
        do {
            long j12 = ((iArr2[i14] & f27962M) * j10) + ((iArr[i14] & f27962M) * j6) + (iArr3[r9] & f27962M) + j11;
            iArr3[i13 + i14] = (int) j12;
            j11 = j12 >>> 32;
            i14++;
        } while (i14 < i10);
        return (int) j11;
    ...
    public static int mulAddTo(int i10, int[] iArr, int i11, int[] iArr2, int i12, int[] iArr3, int i13) {
        ...
        while (i14 < i10) {
            int i16 = i10;
            int[] iArr4 = iArr3;
            long jMulWordAddTo = j6 + (mulWordAddTo(i16, iArr[i11 + i14], r5, r6, iArr4, i15) & f27962M) + (iArr4[r9] & f27962M);
            iArr4[i15 + i16] = (int) jMulWordAddTo;
            j6 = jMulWordAddTo >>> 32;
            i15++;
            i14++;
            i10 = i16;
    ...
    public static int mulWord(int i10, int i11, int[] iArr, int i12, int[] iArr2, int i13) {
        ...
        int i14 = 0;
        do {
            long j11 = ((iArr[i12 + i14] & f27962M) * j6) + j10;
            iArr2[i13 + i14] = (int) j11;
            j10 = j11 >>> 32;
            i14++;
        } while (i14 < i10);
        return (int) j10;
    ...
    public static int mulWordAddTo(int i10, int i11, int[] iArr, int i12, int[] iArr2, int i13) {
        ...
        int i14 = 0;
        do {
            long j11 = ((iArr[i12 + i14] & f27962M) * j6) + (iArr2[r8] & f27962M) + j10;
            iArr2[i13 + i14] = (int) j11;
            j10 = j11 >>> 32;
            i14++;
        } while (i14 < i10);
    ...
    public static int mulWordDwordAddAt(int i10, int i11, long j6, int[] iArr, int i12) {
        long j10 = i11 & f27962M;
        long j11 = ((j6 & f27962M) * j10) + (iArr[i12] & f27962M);
        iArr[i12] = (int) j11;
        long j12 = j10 * (j6 >>> 32);
        long j13 = j12 + (iArr[r10] & f27962M) + (j11 >>> 32);
        iArr[i12 + 1] = (int) j13;
        long j14 = j13 >>> 32;
        long j15 = j14 + (iArr[r0] & f27962M);
        iArr[i12 + 2] = (int) j15;
        if ((j15 >>> 32) == 0) {
            return 0;
        }
    ...
    public static long shiftUpBit64(int i10, long[] jArr, int i11, long j6, long[] jArr2, int i12) {
        int i13 = 0;
        while (i13 < i10) {
            long j10 = jArr[i11 + i13];
            jArr2[i12 + i13] = (j6 >>> 63) | (j10 << 1);
            i13++;
            j6 = j10;
        }
        return j6 >>> 63;
    ...
    public static long shiftUpBits64(int i10, long[] jArr, int i11, int i12, long j6) {
        int i13 = 0;
        while (i13 < i10) {
            int i14 = i11 + i13;
            long j10 = jArr[i14];
            jArr[i14] = (j6 >>> (-i12)) | (j10 << i12);
            i13++;
            j6 = j10;
        }
        return j6 >>> (-i12);
    ...
    public static void square(int i10, int[] iArr, int i11, int[] iArr2, int i12) {
        ...
        do {
            i16--;
            long j6 = iArr[i11 + i16] & f27962M;
            long j10 = j6 * j6;
            iArr2[(i17 - 1) + i12] = (i15 << 31) | ((int) (j10 >>> 33));
            i17 -= 2;
            iArr2[i12 + i17] = (int) (j10 >>> 1);
            i15 = (int) j10;
        } while (i16 > 0);
        int i18 = i12 + 2;
        long j11 = 0;
        for (i13 = 1; i13 < i10; i13++) {
            long jSquareWordAddTo = j11 + (squareWordAddTo(iArr, i11, i13, iArr2, i12) & f27962M) + (iArr2[i18] & f27962M);
            int i19 = i18 + 1;
            iArr2[i18] = (int) jSquareWordAddTo;
            long j12 = (jSquareWordAddTo >>> 32) + (iArr2[i19] & f27962M);
            i18 += 2;
            iArr2[i19] = (int) j12;
            j11 = j12 >>> 32;
        }
    ...
    public static int squareWordAddTo(int[] iArr, int i10, int i11, int[] iArr2, int i12) {
        long j6 = iArr[i10 + i11] & f27962M;
        int i13 = 0;
        long j10 = 0;
        int i14 = i12;
        do {
            long j11 = ((iArr[i10 + i13] & f27962M) * j6) + (iArr2[r11] & f27962M) + j10;
            iArr2[i11 + i14] = (int) j11;
            j10 = j11 >>> 32;
            i14++;
            i13++;
        } while (i13 < i11);
    ...
    public static int sub(int i10, int[] iArr, int i11, int[] iArr2, int i12, int[] iArr3, int i13) {
        long j6 = 0;
        for (int i14 = 0; i14 < i10; i14++) {
            long j10 = ((iArr[i11 + i14] & f27962M) - (f27962M & iArr2[i12 + i14])) + j6;
            iArr3[i13 + i14] = (int) j10;
            j6 = j10 >> 32;
        }
        return (int) j6;
    ...
    public static int subBothFrom(int i10, int[] iArr, int i11, int[] iArr2, int i12, int[] iArr3, int i13) {
        long j6 = 0;
        for (int i14 = 0; i14 < i10; i14++) {
            long j10 = (((iArr3[r3] & f27962M) - (iArr[i11 + i14] & f27962M)) - (f27962M & iArr2[i12 + i14])) + j6;
            iArr3[i13 + i14] = (int) j10;
            j6 = j10 >> 32;
        }
        return (int) j6;
    ...
    public static int subDWordAt(int i10, long j6, int[] iArr, int i11) {
        long j10 = (iArr[i11] & f27962M) - (j6 & f27962M);
        iArr[i11] = (int) j10;
        long j11 = ((f27962M & iArr[r5]) - (j6 >>> 32)) + (j10 >> 32);
        iArr[i11 + 1] = (int) j11;
    ...
    public static int subDWordFrom(int i10, long j6, int[] iArr) {
        long j10 = (iArr[0] & f27962M) - (j6 & f27962M);
        iArr[0] = (int) j10;
        long j11 = ((f27962M & iArr[1]) - (j6 >>> 32)) + (j10 >> 32);
        iArr[1] = (int) j11;
    ...
    public static int subFrom(int i10, int[] iArr, int i11, int[] iArr2, int i12) {
        long j6 = 0;
        for (int i13 = 0; i13 < i10; i13++) {
            long j10 = ((iArr2[r3] & f27962M) - (f27962M & iArr[i11 + i13])) + j6;
            iArr2[i12 + i13] = (int) j10;
            j6 = j10 >> 32;
        }
        return (int) j6;
    ...
    public static int subWordAt(int i10, int i11, int[] iArr, int i12) {
        long j6 = (iArr[i12] & f27962M) - (f27962M & i11);
        iArr[i12] = (int) j6;
        if ((j6 >> 32) == 0) {
            return 0;
        }
    ...
    public static int subWordFrom(int i10, int i11, int[] iArr) {
        long j6 = (iArr[0] & f27962M) - (f27962M & i11);
        iArr[0] = (int) j6;
        if ((j6 >> 32) == 0) {
            return 0;
        }
    ...
    public static int add33At(int i10, int i11, int[] iArr, int i12, int i13) {
        int i14 = i12 + i13;
        long j6 = (iArr[i14] & f27962M) + (i11 & f27962M);
        iArr[i14] = (int) j6;
        long j10 = (f27962M & iArr[r0]) + 1 + (j6 >>> 32);
        iArr[i14 + 1] = (int) j10;
        if ((j10 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addBothTo(int i10, int[] iArr, int[] iArr2, int[] iArr3) {
        long j6 = 0;
        for (int i11 = 0; i11 < i10; i11++) {
            long j10 = (iArr[i11] & f27962M) + (iArr2[i11] & f27962M) + (f27962M & iArr3[i11]) + j6;
            iArr3[i11] = (int) j10;
            j6 = j10 >>> 32;
        }
        return (int) j6;
    ...
    public static int addDWordAt(int i10, long j6, int[] iArr, int i11, int i12) {
        int i13 = i11 + i12;
        long j10 = (iArr[i13] & f27962M) + (j6 & f27962M);
        iArr[i13] = (int) j10;
        long j11 = (f27962M & iArr[r0]) + (j6 >>> 32) + (j10 >>> 32);
        iArr[i13 + 1] = (int) j11;
        if ((j11 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordTo(int i10, long j6, int[] iArr, int i11) {
        long j10 = (iArr[i11] & f27962M) + (j6 & f27962M);
        iArr[i11] = (int) j10;
        long j11 = (f27962M & iArr[r5]) + (j6 >>> 32) + (j10 >>> 32);
        iArr[i11 + 1] = (int) j11;
    ...
    public static int addTo(int i10, int[] iArr, int i11, int[] iArr2, int i12, int i13) {
        long j6 = i13 & f27962M;
        for (int i14 = 0; i14 < i10; i14++) {
            long j10 = (iArr[i11 + i14] & f27962M) + (iArr2[r6] & f27962M) + j6;
            iArr2[i12 + i14] = (int) j10;
            j6 = j10 >>> 32;
        }
        return (int) j6;
    }
    ...
    public static int lessThan(int i10, int[] iArr, int[] iArr2) {
        long j6 = 0;
        for (int i11 = 0; i11 < i10; i11++) {
            j6 = (((iArr[i11] & f27962M) - (f27962M & iArr2[i11])) + j6) >> 32;
        }
        return (int) j6;
    }
    ...
    public static void mul(int i10, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i11 < i10) {
            int i12 = i10;
            iArr3[i11 + i10] = mulWordAddTo(i12, iArr[i11], iArr2, 0, iArr3, i11);
            i11++;
            i10 = i12;
        }
    }
    ...
    public static int mulAddTo(int i10, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i11 < i10) {
            int i12 = i10;
            int[] iArr4 = iArr3;
            long jMulWordAddTo = j6 + (mulWordAddTo(i12, iArr[i11], r4, 0, iArr4, i11) & f27962M) + (iArr4[r10] & f27962M);
            iArr4[i11 + i12] = (int) jMulWordAddTo;
            j6 = jMulWordAddTo >>> 32;
            i11++;
            i10 = i12;
            iArr2 = iArr2;
    ...
    public static int mulWord(int i10, int i11, int[] iArr, int[] iArr2) {
        ...
        int i12 = 0;
        do {
            long j11 = ((iArr[i12] & f27962M) * j6) + j10;
            iArr2[i12] = (int) j11;
            j10 = j11 >>> 32;
            i12++;
        } while (i12 < i10);
    ...
    public static long shiftUpBits64(int i10, long[] jArr, int i11, int i12, long j6, long[] jArr2, int i13) {
        int i14 = 0;
        while (i14 < i10) {
            long j10 = jArr[i11 + i14];
            jArr2[i13 + i14] = (j6 >>> (-i12)) | (j10 << i12);
            i14++;
            j6 = j10;
        }
        return j6 >>> (-i12);
    ...
    public static void square(int i10, int[] iArr, int[] iArr2) {
        ...
        while (true) {
            i13--;
            long j6 = iArr[i13] & f27962M;
            long j10 = j6 * j6;
            iArr2[i14 - 1] = (i15 << 31) | ((int) (j10 >>> 33));
            i14 -= 2;
            iArr2[i14] = (int) (j10 >>> 1);
            int i16 = (int) j10;
            if (i13 <= 0) {
        ...
        for (i11 = 1; i11 < i10; i11++) {
            long jSquareWordAddTo = j11 + (squareWordAddTo(iArr, i11, iArr2) & f27962M) + (iArr2[i17] & f27962M);
            int i18 = i17 + 1;
            iArr2[i17] = (int) jSquareWordAddTo;
            long j12 = (jSquareWordAddTo >>> 32) + (iArr2[i18] & f27962M);
            i17 += 2;
            iArr2[i18] = (int) j12;
            j11 = j12 >>> 32;
        }
    ...
    public static int squareWordAddTo(int[] iArr, int i10, int[] iArr2) {
        long j6 = iArr[i10] & f27962M;
        long j10 = 0;
        int i11 = 0;
        do {
            long j11 = ((iArr[i11] & f27962M) * j6) + (iArr2[r9] & f27962M) + j10;
    ...
    public static int subBothFrom(int i10, int[] iArr, int[] iArr2, int[] iArr3) {
        long j6 = 0;
        for (int i11 = 0; i11 < i10; i11++) {
            long j10 = (((iArr3[i11] & f27962M) - (iArr[i11] & f27962M)) - (f27962M & iArr2[i11])) + j6;
            iArr3[i11] = (int) j10;
            j6 = j10 >> 32;
        }
        return (int) j6;
    ...
    public static int subDWordAt(int i10, long j6, int[] iArr, int i11, int i12) {
        int i13 = i11 + i12;
        long j10 = (iArr[i13] & f27962M) - (j6 & f27962M);
        iArr[i13] = (int) j10;
        long j11 = ((f27962M & iArr[r0]) - (j6 >>> 32)) + (j10 >> 32);
    ...
    public static int subDWordFrom(int i10, long j6, int[] iArr, int i11) {
        long j10 = (iArr[i11] & f27962M) - (j6 & f27962M);
        iArr[i11] = (int) j10;
        long j11 = ((f27962M & iArr[r5]) - (j6 >>> 32)) + (j10 >> 32);
        iArr[i11 + 1] = (int) j11;
    ...
    public static int subFrom(int i10, int[] iArr, int[] iArr2) {
        long j6 = 0;
        for (int i11 = 0; i11 < i10; i11++) {
            long j10 = ((iArr2[i11] & f27962M) - (f27962M & iArr[i11])) + j6;
            iArr2[i11] = (int) j10;
            j6 = j10 >> 32;
        }
        return (int) j6;
    ...
    public static int subWordAt(int i10, int i11, int[] iArr, int i12, int i13) {
        long j6 = (iArr[r0] & f27962M) - (f27962M & i11);
        iArr[i12 + i13] = (int) j6;
        if ((j6 >> 32) == 0) {
            return 0;
        }
