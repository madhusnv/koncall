...
public class DiscoverEndomorphisms {
    ...
    private static BigInteger[] extEuclidBezout(BigInteger[] bigIntegerArr) {
        boolean z6 = bigIntegerArr[0].compareTo(bigIntegerArr[1]) < 0;
        if (z6) {
            swap(bigIntegerArr);
        }
        ...
        while (bigInteger5.compareTo(ECConstants.ONE) > 0) {
            ...
            BigInteger bigIntegerSubtract2 = bigInteger8.subtract(bigInteger9.multiply(bigInteger7));
    ...
    private static boolean isShorter(BigInteger[] bigIntegerArr, BigInteger[] bigIntegerArr2) {
        ...
        boolean z6 = bigIntegerAbs.compareTo(bigIntegerAbs3) < 0;
        return z6 == (bigIntegerAbs2.compareTo(bigIntegerAbs4) < 0) ? z6 : bigIntegerAbs.multiply(bigIntegerAbs).add(bigIntegerAbs2.multiply(bigIntegerAbs2)).compareTo(bigIntegerAbs3.multiply(bigIntegerAbs3).add(bigIntegerAbs4.multiply(bigIntegerAbs4))) < 0;
    }
    ...
    private static void printGLVTypeAParameters(X9ECParameters x9ECParameters) {
        BigInteger n6 = x9ECParameters.getN();
        BigInteger bigInteger = ECConstants.ONE;
        BigInteger[] bigIntegerArrSolveQuadraticEquation = solveQuadraticEquation(n6, bigInteger, ECConstants.ZERO, bigInteger);
    ...
    private static void printGLVTypeBParameters(X9ECParameters x9ECParameters) {
        BigInteger n6 = x9ECParameters.getN();
        BigInteger bigInteger = ECConstants.ONE;
        BigInteger[] bigIntegerArrSolveQuadraticEquation = solveQuadraticEquation(n6, bigInteger, bigInteger, bigInteger);
    ...
    private static BigInteger roundQuotient(BigInteger bigInteger, BigInteger bigInteger2) {
        boolean z6 = bigInteger.signum() != bigInteger2.signum();
        BigInteger bigIntegerAbs = bigInteger.abs();
        BigInteger bigIntegerAbs2 = bigInteger2.abs();
        BigInteger bigIntegerDivide = bigIntegerAbs.add(bigIntegerAbs2.shiftRight(1)).divide(bigIntegerAbs2);
        return z6 ? bigIntegerDivide.negate() : bigIntegerDivide;
    }
