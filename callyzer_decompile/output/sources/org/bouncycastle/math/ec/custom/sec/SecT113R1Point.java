...
public class SecT113R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementMultiply7.isZero()) {
                return new SecT113R1Point(curve, eCFieldElementMultiply7, curve.getB().sqrt());
            }
        ...
        return new SecT113R1Point(curve, eCFieldElementAdd, eCFieldElementAdd2, new ECFieldElement[]{eCFieldElementFromBigInteger});
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElementM11251v.isZero()) {
            return new SecT113R1Point(curve, eCFieldElementM11251v, curve.getB().sqrt());
        }
        ...
        return new SecT113R1Point(curve, eCFieldElementSquare2, eCFieldElementMultiply.squarePlusProduct(eCFieldElementM11251v, eCFieldElementMultiply2).add(eCFieldElementSquare2).add(eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3});
    }
