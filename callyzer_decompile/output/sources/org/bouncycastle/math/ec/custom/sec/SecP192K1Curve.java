...
public class SecP192K1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f27892q = SecP192K1FieldElement.f27894Q;
    ...
    public SecP192K1Curve() {
        ...
        this.f27854b = fromBigInteger(BigInteger.valueOf(3L));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i10, final int i11) {
        ...
        for (int i13 = 0; i13 < i11; i13++) {
            ...
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawXCoord()).f27895x, 0, iArr, i12);
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawYCoord()).f27895x, 0, iArr, i12 + 6);
            i12 += 12;
        }
    ...
    public ECFieldElement randomFieldElement(SecureRandom secureRandom) {
        int[] iArrCreate = Nat192.create();
        SecP192K1Field.random(secureRandom, iArrCreate);
    ...
    public ECFieldElement randomFieldElementMult(SecureRandom secureRandom) {
        int[] iArrCreate = Nat192.create();
        SecP192K1Field.randomMult(secureRandom, iArrCreate);
        return new SecP192K1FieldElement(iArrCreate);
    }
