...
public class SecP160R2FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f27890Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC73"));

    /* renamed from: x */
    protected int[] f27891x;

    public SecP160R2FieldElement() {
        this.f27891x = Nat160.create();
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.add(this.f27891x, ((SecP160R2FieldElement) eCFieldElement).f27891x, iArrCreate);
    ...
    public ECFieldElement addOne() {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.addOne(this.f27891x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.inv(((SecP160R2FieldElement) eCFieldElement).f27891x, iArrCreate);
        SecP160R2Field.multiply(iArrCreate, this.f27891x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP160R2FieldElement) {
            return Nat160.eq(this.f27891x, ((SecP160R2FieldElement) obj).f27891x);
        }
        return false;
    }
    ...
    public int getFieldSize() {
        return f27890Q.bitLength();
    }

    public int hashCode() {
        return f27890Q.hashCode() ^ Arrays.hashCode(this.f27891x, 0, 5);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement invert() {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.inv(this.f27891x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isOne() {
        return Nat160.isOne(this.f27891x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isZero() {
        return Nat160.isZero(this.f27891x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.multiply(this.f27891x, ((SecP160R2FieldElement) eCFieldElement).f27891x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement negate() {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.negate(this.f27891x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f27891x;
    ...
    public ECFieldElement square() {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.square(this.f27891x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.subtract(this.f27891x, ((SecP160R2FieldElement) eCFieldElement).f27891x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean testBitZero() {
        return Nat160.getBit(this.f27891x, 0) == 1;
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat160.toBigInteger(this.f27891x);
    }

    public SecP160R2FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f27890Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP160R2FieldElement");
        }
        this.f27891x = SecP160R2Field.fromBigInteger(bigInteger);
    }
