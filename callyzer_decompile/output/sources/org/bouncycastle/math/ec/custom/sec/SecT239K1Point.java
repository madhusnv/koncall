    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementM11251v.isZero()) {
                return new SecT239K1Point(curve, eCFieldElementM11251v, curve.getB());
            }
        ...
        return new SecT239K1Point(curve, eCFieldElementM11251v, eCFieldElementAdd, new ECFieldElement[]{eCFieldElementFromBigInteger});
    }
