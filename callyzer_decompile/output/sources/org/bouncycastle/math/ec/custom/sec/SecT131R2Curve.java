...
public class SecT131R2Curve extends ECCurve.AbstractF2m {
    ...
    public SecT131R2Curve() {
        ...
        this.f27853a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("03E5A88919D7CAFCBF415F07C2176573B2")));
        this.f27854b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("04B8266A46C55657AC734CE38F018F2192")));
