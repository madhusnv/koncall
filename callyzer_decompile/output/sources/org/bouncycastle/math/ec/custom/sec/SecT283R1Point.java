...
public class SecT283R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElementM11251v.isZero()) {
            return new SecT283R1Point(curve, eCFieldElementM11251v, curve.getB().sqrt());
        }
        ...
        return new SecT283R1Point(curve, eCFieldElementSquare2, eCFieldElementMultiply.squarePlusProduct(eCFieldElementM11251v, eCFieldElementMultiply2).add(eCFieldElementSquare2).add(eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3});
    }
