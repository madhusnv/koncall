...
public class SecP224R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP224R1FieldElement secP224R1FieldElement = (SecP224R1FieldElement) this.f27863x;
        SecP224R1FieldElement secP224R1FieldElement2 = (SecP224R1FieldElement) this.f27864y;
        ...
        SecP224R1FieldElement secP224R1FieldElement5 = (SecP224R1FieldElement) this.f44646zs[0];
        ...
        if (zIsOne) {
            iArr = secP224R1FieldElement3.f27909x;
            iArr2 = secP224R1FieldElement4.f27909x;
        } else {
            SecP224R1Field.square(secP224R1FieldElement5.f27909x, iArrCreate2);
            SecP224R1Field.multiply(iArrCreate2, secP224R1FieldElement3.f27909x, iArrCreate);
            SecP224R1Field.multiply(iArrCreate2, secP224R1FieldElement5.f27909x, iArrCreate2);
            SecP224R1Field.multiply(iArrCreate2, secP224R1FieldElement4.f27909x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP224R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP224R1FieldElement.f27909x;
            iArr4 = secP224R1FieldElement2.f27909x;
        } else {
            SecP224R1Field.square(secP224R1FieldElement6.f27909x, iArrCreate3);
            SecP224R1Field.multiply(iArrCreate3, secP224R1FieldElement.f27909x, iArrCreateExt);
            SecP224R1Field.multiply(iArrCreate3, secP224R1FieldElement6.f27909x, iArrCreate3);
            SecP224R1Field.multiply(iArrCreate3, secP224R1FieldElement2.f27909x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP224R1Field.square(iArrCreate, secP224R1FieldElement7.f27909x);
        int[] iArr5 = secP224R1FieldElement7.f27909x;
        ...
        SecP224R1Field.subtract(iArrCreate2, secP224R1FieldElement7.f27909x, secP224R1FieldElement8.f27909x);
        SecP224R1Field.multiplyAddToExt(secP224R1FieldElement8.f27909x, iArrCreate, iArrCreateExt);
        SecP224R1Field.reduce(iArrCreateExt, secP224R1FieldElement8.f27909x);
        SecP224R1FieldElement secP224R1FieldElement9 = new SecP224R1FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = secP224R1FieldElement9.f27909x;
            SecP224R1Field.multiply(iArr6, secP224R1FieldElement5.f27909x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP224R1FieldElement9.f27909x;
            SecP224R1Field.multiply(iArr7, secP224R1FieldElement6.f27909x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP224R1Point(this.curve, this.f27863x, this.f27864y.negate(), this.f44646zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP224R1FieldElement secP224R1FieldElement = (SecP224R1FieldElement) this.f27864y;
        if (secP224R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP224R1FieldElement secP224R1FieldElement2 = (SecP224R1FieldElement) this.f27863x;
        SecP224R1FieldElement secP224R1FieldElement3 = (SecP224R1FieldElement) this.f44646zs[0];
        int[] iArrCreate = Nat224.create();
        int[] iArrCreate2 = Nat224.create();
        int[] iArrCreate3 = Nat224.create();
        SecP224R1Field.square(secP224R1FieldElement.f27909x, iArrCreate3);
        int[] iArrCreate4 = Nat224.create();
        SecP224R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP224R1FieldElement3.isOne();
        int[] iArr = secP224R1FieldElement3.f27909x;
        if (!zIsOne) {
            SecP224R1Field.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP224R1Field.subtract(secP224R1FieldElement2.f27909x, iArr, iArrCreate);
        SecP224R1Field.add(secP224R1FieldElement2.f27909x, iArr, iArrCreate2);
        ...
        SecP224R1Field.square(iArrCreate2, secP224R1FieldElement4.f27909x);
        int[] iArr2 = secP224R1FieldElement4.f27909x;
        SecP224R1Field.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = secP224R1FieldElement4.f27909x;
        ...
        SecP224R1Field.subtract(iArrCreate3, secP224R1FieldElement4.f27909x, secP224R1FieldElement5.f27909x);
        int[] iArr4 = secP224R1FieldElement5.f27909x;
        SecP224R1Field.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = secP224R1FieldElement5.f27909x;
        ...
        SecP224R1Field.twice(secP224R1FieldElement.f27909x, secP224R1FieldElement6.f27909x);
        if (!zIsOne) {
            int[] iArr6 = secP224R1FieldElement6.f27909x;
            SecP224R1Field.multiply(iArr6, secP224R1FieldElement3.f27909x, iArr6);
        }
