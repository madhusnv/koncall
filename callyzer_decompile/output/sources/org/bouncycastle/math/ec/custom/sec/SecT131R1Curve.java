...
public class SecT131R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT131R1Curve() {
        ...
        this.f27853a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("07A11B09A76B562144418FF3FF8C2570B8")));
        this.f27854b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0217C05610884B63B9C6C7291678F9D341")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i10, final int i11) {
        ...
        for (int i13 = 0; i13 < i11; i13++) {
            ...
            Nat192.copy64(((SecT131FieldElement) eCPoint.getRawXCoord()).f27929x, 0, jArr, i12);
            Nat192.copy64(((SecT131FieldElement) eCPoint.getRawYCoord()).f27929x, 0, jArr, i12 + 3);
            i12 += 6;
        }
