...
public class SecP160R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP160R1FieldElement secP160R1FieldElement = (SecP160R1FieldElement) this.f27863x;
        SecP160R1FieldElement secP160R1FieldElement2 = (SecP160R1FieldElement) this.f27864y;
        ...
        SecP160R1FieldElement secP160R1FieldElement5 = (SecP160R1FieldElement) this.f44646zs[0];
        ...
        if (zIsOne) {
            iArr = secP160R1FieldElement3.f27887x;
            iArr2 = secP160R1FieldElement4.f27887x;
        } else {
            SecP160R1Field.square(secP160R1FieldElement5.f27887x, iArrCreate2);
            SecP160R1Field.multiply(iArrCreate2, secP160R1FieldElement3.f27887x, iArrCreate);
            SecP160R1Field.multiply(iArrCreate2, secP160R1FieldElement5.f27887x, iArrCreate2);
            SecP160R1Field.multiply(iArrCreate2, secP160R1FieldElement4.f27887x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP160R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP160R1FieldElement.f27887x;
            iArr4 = secP160R1FieldElement2.f27887x;
        } else {
            SecP160R1Field.square(secP160R1FieldElement6.f27887x, iArrCreate3);
            SecP160R1Field.multiply(iArrCreate3, secP160R1FieldElement.f27887x, iArrCreateExt);
            SecP160R1Field.multiply(iArrCreate3, secP160R1FieldElement6.f27887x, iArrCreate3);
            SecP160R1Field.multiply(iArrCreate3, secP160R1FieldElement2.f27887x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP160R1Field.square(iArrCreate, secP160R1FieldElement7.f27887x);
        int[] iArr5 = secP160R1FieldElement7.f27887x;
        ...
        SecP160R1Field.subtract(iArrCreate2, secP160R1FieldElement7.f27887x, secP160R1FieldElement8.f27887x);
        SecP160R1Field.multiplyAddToExt(secP160R1FieldElement8.f27887x, iArrCreate, iArrCreateExt);
        SecP160R1Field.reduce(iArrCreateExt, secP160R1FieldElement8.f27887x);
        SecP160R1FieldElement secP160R1FieldElement9 = new SecP160R1FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = secP160R1FieldElement9.f27887x;
            SecP160R1Field.multiply(iArr6, secP160R1FieldElement5.f27887x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP160R1FieldElement9.f27887x;
            SecP160R1Field.multiply(iArr7, secP160R1FieldElement6.f27887x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160R1Point(this.curve, this.f27863x, this.f27864y.negate(), this.f44646zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP160R1FieldElement secP160R1FieldElement = (SecP160R1FieldElement) this.f27864y;
        if (secP160R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP160R1FieldElement secP160R1FieldElement2 = (SecP160R1FieldElement) this.f27863x;
        SecP160R1FieldElement secP160R1FieldElement3 = (SecP160R1FieldElement) this.f44646zs[0];
        int[] iArrCreate = Nat160.create();
        int[] iArrCreate2 = Nat160.create();
        int[] iArrCreate3 = Nat160.create();
        SecP160R1Field.square(secP160R1FieldElement.f27887x, iArrCreate3);
        int[] iArrCreate4 = Nat160.create();
        SecP160R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP160R1FieldElement3.isOne();
        int[] iArr = secP160R1FieldElement3.f27887x;
        if (!zIsOne) {
            SecP160R1Field.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP160R1Field.subtract(secP160R1FieldElement2.f27887x, iArr, iArrCreate);
        SecP160R1Field.add(secP160R1FieldElement2.f27887x, iArr, iArrCreate2);
        ...
        SecP160R1Field.square(iArrCreate2, secP160R1FieldElement4.f27887x);
        int[] iArr2 = secP160R1FieldElement4.f27887x;
        SecP160R1Field.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = secP160R1FieldElement4.f27887x;
        ...
        SecP160R1Field.subtract(iArrCreate3, secP160R1FieldElement4.f27887x, secP160R1FieldElement5.f27887x);
        int[] iArr4 = secP160R1FieldElement5.f27887x;
        SecP160R1Field.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = secP160R1FieldElement5.f27887x;
        ...
        SecP160R1Field.twice(secP160R1FieldElement.f27887x, secP160R1FieldElement6.f27887x);
        if (!zIsOne) {
            int[] iArr6 = secP160R1FieldElement6.f27887x;
            SecP160R1Field.multiply(iArr6, secP160R1FieldElement3.f27887x, iArr6);
        }
