...
public class SM2P256V1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f27872q = SM2P256V1FieldElement.f27875Q;
    ...
    public SM2P256V1Curve() {
        ...
        this.f27853a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF00000000FFFFFFFFFFFFFFFC")));
        this.f27854b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("28E9FA9E9D9F5E344D5A9E4BCF6509A7F39789F515AB8F92DDBCBD414D940E93")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i10, final int i11) {
        ...
        for (int i13 = 0; i13 < i11; i13++) {
            ...
            Nat256.copy(((SM2P256V1FieldElement) eCPoint.getRawXCoord()).f27876x, 0, iArr, i12);
            Nat256.copy(((SM2P256V1FieldElement) eCPoint.getRawYCoord()).f27876x, 0, iArr, i12 + 8);
            i12 += 16;
        }
