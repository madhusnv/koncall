...
public class SecT571K1Curve extends ECCurve.AbstractF2m {
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i10, final int i11) {
        final long[] jArr = new long[i11 * 18];
        int i12 = 0;
        for (int i13 = 0; i13 < i11; i13++) {
            ECPoint eCPoint = eCPointArr[i10 + i13];
            Nat576.copy64(((SecT571FieldElement) eCPoint.getRawXCoord()).f27936x, 0, jArr, i12);
            Nat576.copy64(((SecT571FieldElement) eCPoint.getRawYCoord()).f27936x, 0, jArr, i12 + 9);
            i12 += 18;
        }
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecT571K1Curve.1
            ...
            public ECPoint lookup(int i14) {
                ...
                for (int i16 = 0; i16 < i11; i16++) {
                    ...
                    for (int i17 = 0; i17 < 9; i17++) {
                        ...
                        jArrCreate642[i17] = jArrCreate642[i17] ^ (jArr2[(i15 + 9) + i17] & j6);
                    }
                    i15 += 18;
                }
            ...
            public ECPoint lookupVar(int i14) {
                ...
                for (int i16 = 0; i16 < 9; i16++) {
                    ...
                    jArrCreate642[i16] = jArr2[9 + i15 + i16];
                }
                return createPoint(jArrCreate64, jArrCreate642);
            }
        };
