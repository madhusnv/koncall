...
public class SecT233R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementAddOne.isZero()) {
                return new SecT233R1Point(curve, eCFieldElementAddOne, curve.getB().sqrt());
            }
            ...
            if (eCFieldElementMultiply7.isZero()) {
                return new SecT233R1Point(curve, eCFieldElementMultiply7, curve.getB().sqrt());
            }
        ...
        return new SecT233R1Point(curve, eCFieldElementAddOne, eCFieldElementAdd, new ECFieldElement[]{eCFieldElementFromBigInteger});
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElementM11251v.isZero()) {
            return new SecT233R1Point(curve, eCFieldElementM11251v, curve.getB().sqrt());
        }
        ...
        return new SecT233R1Point(curve, eCFieldElementSquare2, eCFieldElementMultiply.squarePlusProduct(eCFieldElementM11251v, eCFieldElementMultiply2).add(eCFieldElementSquare2).add(eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3});
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (eCFieldElementMultiplyPlusProduct.isZero()) {
            return new SecT233R1Point(curve, eCFieldElementMultiplyPlusProduct, curve.getB().sqrt());
        }
        ...
        return new SecT233R1Point(curve, eCFieldElementMultiply2, eCFieldElementMultiplyPlusProduct.add(eCFieldElementSquare4).square().multiplyPlusProduct(eCFieldElementAdd, rawYCoord.addOne(), eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3});
    }
