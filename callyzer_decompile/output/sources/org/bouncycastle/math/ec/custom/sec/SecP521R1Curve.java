...
public class SecP521R1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f27924q = SecP521R1FieldElement.f27926Q;
    ...
    public SecP521R1Curve() {
        ...
        this.f27853a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("01FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f27854b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0051953EB9618E1C9A1F929A21A0B68540EEA2DA725B99B315F3B8B489918EF109E156193951EC7E937B1652C0BD3BB1BF073573DF883D2C34F1EF451FD46B503F00")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i10, final int i11) {
        final int[] iArr = new int[i11 * 34];
        int i12 = 0;
        for (int i13 = 0; i13 < i11; i13++) {
            ECPoint eCPoint = eCPointArr[i10 + i13];
            Nat.copy(17, ((SecP521R1FieldElement) eCPoint.getRawXCoord()).f27927x, 0, iArr, i12);
            Nat.copy(17, ((SecP521R1FieldElement) eCPoint.getRawYCoord()).f27927x, 0, iArr, i12 + 17);
            i12 += 34;
        }
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecP521R1Curve.1
            ...
            public ECPoint lookup(int i14) {
                ...
                for (int i16 = 0; i16 < i11; i16++) {
                    ...
                    for (int i18 = 0; i18 < 17; i18++) {
                        ...
                        iArrCreate2[i18] = iArrCreate2[i18] ^ (iArr2[(i15 + 17) + i18] & i17);
                    }
                    i15 += 34;
                }
            ...
            public ECPoint lookupVar(int i14) {
                ...
                for (int i16 = 0; i16 < 17; i16++) {
                    int i17 = iArrCreate[i16];
                    int[] iArr2 = iArr;
                    iArrCreate[i16] = i17 ^ iArr2[i15 + i16];
                    iArrCreate2[i16] = iArrCreate2[i16] ^ iArr2[(i15 + 17) + i16];
                }
                return createPoint(iArrCreate, iArrCreate2);
            }
        };
