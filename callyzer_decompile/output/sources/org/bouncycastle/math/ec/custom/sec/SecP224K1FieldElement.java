...
public class SecP224K1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f27903Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFE56D"));
    private static final int[] PRECOMP_POW2 = {868209154, -587542221, 579297866, -1014948952, -1470801668, 514782679, -1897982644};

    public SecP224K1FieldElement() {
        this.f27904x = Nat224.create();
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.add(this.f27904x, ((SecP224K1FieldElement) eCFieldElement).f27904x, iArrCreate);
    ...
    public ECFieldElement addOne() {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.addOne(this.f27904x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.inv(((SecP224K1FieldElement) eCFieldElement).f27904x, iArrCreate);
        SecP224K1Field.multiply(iArrCreate, this.f27904x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP224K1FieldElement) {
            return Nat224.eq(this.f27904x, ((SecP224K1FieldElement) obj).f27904x);
        }
        return false;
    }
    ...
    public int getFieldSize() {
        return f27903Q.bitLength();
    }

    public int hashCode() {
        return f27903Q.hashCode() ^ Arrays.hashCode(this.f27904x, 0, 7);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement invert() {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.inv(this.f27904x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isOne() {
        return Nat224.isOne(this.f27904x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isZero() {
        return Nat224.isZero(this.f27904x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.multiply(this.f27904x, ((SecP224K1FieldElement) eCFieldElement).f27904x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement negate() {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.negate(this.f27904x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f27904x;
    ...
    public ECFieldElement square() {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.square(this.f27904x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.subtract(this.f27904x, ((SecP224K1FieldElement) eCFieldElement).f27904x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean testBitZero() {
        return Nat224.getBit(this.f27904x, 0) == 1;
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f27904x);
    }

    public SecP224K1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f27903Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP224K1FieldElement");
        }
        this.f27904x = SecP224K1Field.fromBigInteger(bigInteger);
    }
