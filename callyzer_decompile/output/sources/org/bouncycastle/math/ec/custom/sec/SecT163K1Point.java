...
public class SecT163K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementAddOne.isZero()) {
                return new SecT163K1Point(curve, eCFieldElementAddOne, curve.getB());
            }
            ...
            if (eCFieldElementMultiply7.isZero()) {
                return new SecT163K1Point(curve, eCFieldElementMultiply7, curve.getB());
            }
        ...
        return new SecT163K1Point(curve, eCFieldElementAddOne, eCFieldElementAdd, new ECFieldElement[]{eCFieldElementFromBigInteger});
    }
    ...
    public ECPoint twice() {
        ...
        ECFieldElement eCFieldElementM11251v = AbstractC5601a.m11251v(eCFieldElement2, eCFieldElementMultiply, eCFieldElementSquare);
        if (eCFieldElementM11251v.isZero()) {
            return new SecT163K1Point(curve, eCFieldElementM11251v, curve.getB());
        }
        ECFieldElement eCFieldElementSquare2 = eCFieldElementM11251v.square();
        ECFieldElement eCFieldElementMultiply2 = zIsOne ? eCFieldElementM11251v : eCFieldElementM11251v.multiply(eCFieldElementSquare);
        ECFieldElement eCFieldElementSquare3 = eCFieldElement2.add(eCFieldElement).square();
        return new SecT163K1Point(curve, eCFieldElementSquare2, eCFieldElementSquare3.add(eCFieldElementM11251v).add(eCFieldElementSquare).multiply(eCFieldElementSquare3).add(eCFieldElementSquare2), new ECFieldElement[]{eCFieldElementMultiply2});
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (eCFieldElementMultiplyPlusProduct.isZero()) {
            return new SecT163K1Point(curve, eCFieldElementMultiplyPlusProduct, curve.getB());
        }
        ...
        return new SecT163K1Point(curve, eCFieldElementMultiply2, eCFieldElementMultiplyPlusProduct.add(eCFieldElementSquare4).square().multiplyPlusProduct(eCFieldElementAdd, rawYCoord.addOne(), eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3});
    }
