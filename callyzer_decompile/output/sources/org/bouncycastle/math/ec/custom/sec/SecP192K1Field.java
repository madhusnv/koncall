...
public class SecP192K1Field {
    ...
    /* renamed from: P */
    static final int[] f27893P = {-4553, -2, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat192.add(iArr, iArr2, iArr3) != 0 || (iArr3[5] == -1 && Nat192.gte(iArr3, f27893P))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(6, iArr, iArr2) != 0 || (iArr2[5] == -1 && Nat192.gte(iArr2, f27893P))) {
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(6, iArr2, Nat192.add(iArr, f27893P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f27893P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(6, iArr, f27893P) == 0);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        if (Nat192.mul33DWordAdd(PInv33, Nat192.mul33Add(PInv33, iArr, 6, iArr, 0, iArr2, 0), iArr2, 0) != 0 || (iArr2[5] == -1 && Nat192.gte(iArr2, f27893P))) {
            Nat.add33To(6, PInv33, iArr2);
        }
    }

    public static void reduce32(int i10, int[] iArr) {
        if ((i10 == 0 || Nat192.mul33WordAdd(PInv33, i10, iArr, 0) == 0) && !(iArr[5] == -1 && Nat192.gte(iArr, f27893P))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(6, iArr, 0, iArr2) != 0 || (iArr2[5] == -1 && Nat192.gte(iArr2, f27893P))) {
            Nat.add33To(6, PInv33, iArr2);
        }
    }
}
