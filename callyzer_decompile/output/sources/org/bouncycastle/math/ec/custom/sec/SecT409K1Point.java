...
public class SecT409K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementM11251v.isZero()) {
                return new SecT409K1Point(curve, eCFieldElementM11251v, curve.getB());
            }
            ...
            if (eCFieldElementMultiply7.isZero()) {
                return new SecT409K1Point(curve, eCFieldElementMultiply7, curve.getB());
            }
        ...
        return new SecT409K1Point(curve, eCFieldElementM11251v, eCFieldElementAdd, new ECFieldElement[]{eCFieldElementFromBigInteger});
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElementAdd.isZero()) {
            return new SecT409K1Point(curve, eCFieldElementAdd, curve.getB());
        }
        ...
        return new SecT409K1Point(curve, eCFieldElementSquare3, eCFieldElementSquare4.add(eCFieldElementAdd).add(eCFieldElementSquare2).multiply(eCFieldElementSquare4).add(eCFieldElementSquare).add(eCFieldElementSquare3).add(eCFieldElementMultiply), new ECFieldElement[]{eCFieldElementMultiply});
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (eCFieldElementMultiplyPlusProduct.isZero()) {
            return new SecT409K1Point(curve, eCFieldElementMultiplyPlusProduct, curve.getB());
        }
        ...
        return new SecT409K1Point(curve, eCFieldElementMultiply2, eCFieldElementMultiplyPlusProduct.add(eCFieldElementSquare4).square().multiplyPlusProduct(eCFieldElementAdd, eCFieldElementAddOne, eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3});
    }
