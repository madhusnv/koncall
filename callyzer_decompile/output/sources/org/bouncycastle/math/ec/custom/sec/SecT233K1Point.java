    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementM11251v.isZero()) {
                return new SecT233K1Point(curve, eCFieldElementM11251v, curve.getB());
            }
        ...
        return new SecT233K1Point(curve, eCFieldElementM11251v, eCFieldElementAdd, new ECFieldElement[]{eCFieldElementFromBigInteger});
    }
