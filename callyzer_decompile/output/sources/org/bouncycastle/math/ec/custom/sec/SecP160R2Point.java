...
public class SecP160R2Point extends ECPoint.AbstractFp {
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160R2Point(this.curve, this.f27863x, this.f27864y.negate(), this.f44646zs);
    }
    ...
    public ECPoint twice() {
        ...
        int[] iArrCreate2 = Nat160.create();
        int[] iArrCreate3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.f27891x, iArrCreate3);
        int[] iArrCreate4 = Nat160.create();
        SecP160R2Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP160R2FieldElement3.isOne();
        int[] iArr = secP160R2FieldElement3.f27891x;
        if (!zIsOne) {
            SecP160R2Field.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP160R2Field.subtract(secP160R2FieldElement2.f27891x, iArr, iArrCreate);
        SecP160R2Field.add(secP160R2FieldElement2.f27891x, iArr, iArrCreate2);
        ...
        SecP160R2Field.square(iArrCreate2, secP160R2FieldElement4.f27891x);
        int[] iArr2 = secP160R2FieldElement4.f27891x;
        SecP160R2Field.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = secP160R2FieldElement4.f27891x;
        ...
        SecP160R2Field.subtract(iArrCreate3, secP160R2FieldElement4.f27891x, secP160R2FieldElement5.f27891x);
        int[] iArr4 = secP160R2FieldElement5.f27891x;
        SecP160R2Field.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = secP160R2FieldElement5.f27891x;
        ...
        if (!zIsOne) {
            int[] iArr6 = secP160R2FieldElement6.f27891x;
            SecP160R2Field.multiply(iArr6, secP160R2FieldElement3.f27891x, iArr6);
        }
