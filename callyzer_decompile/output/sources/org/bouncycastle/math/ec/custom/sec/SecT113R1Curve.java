...
public class SecT113R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT113R1Curve() {
        ...
        this.f27853a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("003088250CA6E7C7FE649CE85820F7")));
        this.f27854b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("00E8BEE4D3E2260744188BE0E9C723")));
