...
public class SecP224K1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f27901q = SecP224K1FieldElement.f27903Q;
    ...
    public SecP224K1Curve() {
        ...
        this.f27854b = fromBigInteger(BigInteger.valueOf(5L));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i10, final int i11) {
        ...
        for (int i13 = 0; i13 < i11; i13++) {
            ...
            Nat224.copy(((SecP224K1FieldElement) eCPoint.getRawXCoord()).f27904x, 0, iArr, i12);
            Nat224.copy(((SecP224K1FieldElement) eCPoint.getRawYCoord()).f27904x, 0, iArr, i12 + 7);
            i12 += 14;
        }
