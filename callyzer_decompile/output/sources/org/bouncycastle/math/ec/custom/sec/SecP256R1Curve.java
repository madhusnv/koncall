...
public class SecP256R1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f27914q = SecP256R1FieldElement.f27917Q;
    ...
    public SecP256R1Curve() {
        ...
        this.f27853a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f27854b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("5AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i10, final int i11) {
        ...
        for (int i13 = 0; i13 < i11; i13++) {
            ...
            Nat256.copy(((SecP256R1FieldElement) eCPoint.getRawXCoord()).f27918x, 0, iArr, i12);
            Nat256.copy(((SecP256R1FieldElement) eCPoint.getRawYCoord()).f27918x, 0, iArr, i12 + 8);
            i12 += 16;
        }
