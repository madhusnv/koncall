...
class LongArray implements Cloneable {
    ...
    private void addShiftedByBitsSafe(LongArray longArray, int i10, int i11) {
        ...
        long jAddShiftedUp = addShiftedUp(this.m_ints, i13, longArray.m_ints, 0, i12, i14);
        if (jAddShiftedUp != 0) {
            long[] jArr = this.m_ints;
            int i15 = i12 + i13;
            jArr[i15] = jAddShiftedUp ^ jArr[i15];
        }
    }
    ...
    private static long addShiftedUp(long[] jArr, int i10, long[] jArr2, int i11, int i12, int i13) {
        ...
        for (int i15 = 0; i15 < i12; i15++) {
            long j10 = jArr2[i11 + i15];
            int i16 = i10 + i15;
            jArr[i16] = (j6 | (j10 << i13)) ^ jArr[i16];
            j6 = j10 >>> i14;
        }
        return j6;
    }

    private static int bitLength(long j6) {
        int i10;
        int i11 = 32;
        int i12 = (int) (j6 >>> 32);
        if (i12 == 0) {
        ...
        if (i13 == 0) {
            int i14 = i12 >>> 8;
            i10 = i14 == 0 ? bitLengths[i12] : bitLengths[i14] + 8;
        } else {
            int i15 = i12 >>> 24;
            i10 = i15 == 0 ? bitLengths[i13] + 16 : bitLengths[i15] + 24;
        }
        return i11 + i10;
    }
    ...
    private int degreeFrom(int i10) {
        ...
        while (i11 != 0) {
            i11--;
            long j6 = this.m_ints[i11];
            if (j6 != 0) {
                return (i11 << 6) + bitLength(j6);
            }
        }
        return 0;
    }
    ...
    private static void distribute(long[] jArr, int i10, int i11, int i12, int i13) {
        for (int i14 = 0; i14 < i13; i14++) {
            long j6 = jArr[i10 + i14];
            int i15 = i11 + i14;
            jArr[i15] = jArr[i15] ^ j6;
            int i16 = i12 + i14;
            jArr[i16] = j6 ^ jArr[i16];
        }
    }
    ...
    private static void flipWord(long[] jArr, int i10, int i11, long j6) {
        int i12 = i10 + (i11 >>> 6);
        int i13 = i11 & 63;
        if (i13 == 0) {
            jArr[i12] = jArr[i12] ^ j6;
            return;
        }
        jArr[i12] = jArr[i12] ^ (j6 << i13);
        long j10 = j6 >>> (64 - i13);
        if (j10 != 0) {
            int i14 = i12 + 1;
    ...
    private static long interleave2_n(long j6, int i10) {
        while (i10 > 1) {
            i10 -= 2;
            j6 = (interleave4_16to64(((int) (j6 >>> 48)) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) << 3) | (interleave4_16to64(((int) (j6 >>> 16)) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) << 1) | interleave4_16to64(((int) j6) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) | (interleave4_16to64(((int) (j6 >>> 32)) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) << 2);
        }
        if (i10 <= 0) {
            return j6;
        }
        return (interleave2_32to64((int) (j6 >>> 32)) << 1) | interleave2_32to64((int) j6);
    }

    private static long interleave3(long j6) {
        return (interleave3_21to63(((int) (j6 >>> 42)) & 2097151) << 2) | (Long.MIN_VALUE & j6) | interleave3_21to63(((int) j6) & 2097151) | (interleave3_21to63(((int) (j6 >>> 21)) & 2097151) << 1);
    }

    private static long interleave3_13to65(int i10) {
        return (INTERLEAVE5_TABLE[i10 & 127] & 4294967295L) | ((r0[i10 >>> 7] & 4294967295L) << 35);
    }

    private static long interleave3_21to63(int i10) {
        return (INTERLEAVE3_TABLE[i10 & 127] & 4294967295L) | ((r0[i10 >>> 14] & 4294967295L) << 42) | ((r0[(i10 >>> 7) & 127] & 4294967295L) << 21);
    }

    private static long interleave4_16to64(int i10) {
        return (INTERLEAVE4_TABLE[i10 & 255] & 4294967295L) | ((r0[i10 >>> 8] & 4294967295L) << 32);
    }

    private static long interleave5(long j6) {
        return (interleave3_13to65(((int) (j6 >>> 52)) & 8191) << 4) | interleave3_13to65(((int) j6) & 8191) | (interleave3_13to65(((int) (j6 >>> 13)) & 8191) << 1) | (interleave3_13to65(((int) (j6 >>> 26)) & 8191) << 2) | (interleave3_13to65(((int) (j6 >>> 39)) & 8191) << 3);
    }

    private static long interleave7(long j6) {
        long[] jArr = INTERLEAVE7_TABLE;
        return (jArr[((int) (j6 >>> 54)) & 511] << 6) | (Long.MIN_VALUE & j6) | jArr[((int) j6) & 511] | (jArr[((int) (j6 >>> 9)) & 511] << 1) | (jArr[((int) (j6 >>> 18)) & 511] << 2) | (jArr[((int) (j6 >>> 27)) & 511] << 3) | (jArr[((int) (j6 >>> 36)) & 511] << 4) | (jArr[((int) (j6 >>> 45)) & 511] << 5);
    }

    private static void multiplyWord(long j6, long[] jArr, int i10, long[] jArr2, int i11) {
        int i12 = i10;
        long[] jArr3 = jArr2;
        int i13 = i11;
        if ((j6 & 1) != 0) {
        ...
        while (true) {
            ...
            if ((j10 & 1) != 0) {
                long jAddShiftedUp = addShiftedUp(jArr3, i13, jArr, 0, i12, i14);
                if (jAddShiftedUp != 0) {
                    int i15 = i11 + i10;
                    jArr2[i15] = jArr2[i15] ^ jAddShiftedUp;
                }
            }
            i14++;
            i12 = i10;
    ...
    private static int reduceInPlace(long[] jArr, int i10, int i11, int i12, int[] iArr) {
        ...
        int iMax = Math.max(i12, i17 + 64);
        int iMin2 = (Math.min(iMin - iMax, i12 - i18) + i15) >> 6;
        if (iMin2 > 1) {
            int i19 = i16 - iMin2;
            int i20 = i16;
            reduceVectorWise(jArr, i10, i20, i19, i12, iArr);
            i16 = i20;
            while (i16 > i19) {
                i16--;
                jArr[i10 + i16] = 0;
        ...
        int i22 = i16;
        if (i21 > iMax) {
            reduceWordWise(jArr, i10, i22, iMax, i12, iArr);
        } else {
            iMax = i21;
        }
        if (iMax > i12) {
            reduceBitWise(jArr, i10, iMax, i12, iArr);
        }
        return i13;
    }
    ...
    private static void reduceWord(long[] jArr, int i10, int i11, long j6, int i12, int[] iArr) {
        int i13 = i11 - i12;
        int length = iArr.length;
        while (true) {
            length--;
            if (length < 0) {
                flipWord(jArr, i10, i13, j6);
                return;
            }
            flipWord(jArr, i10, iArr[length] + i13, j6);
        }
    }
    ...
    private static void reduceWordWise(long[] jArr, int i10, int i11, int i12, int i13, int[] iArr) {
        ...
        while (true) {
            ...
            if (j6 != 0) {
                jArr[i16] = 0;
                reduceWord(jArr, i10, i15 << 6, j6, i13, iArr);
            }
        }
        int i17 = i12 & 63;
        int i18 = i10 + i14;
        ...
        long j11 = j10 >>> i17;
        if (j11 != 0) {
            jArr[i18] = (j11 << i17) ^ j10;
            reduceWord(jArr, i10, i12, j11, i13, iArr);
        }
    }
    ...
    private static void squareInPlace(long[] jArr, int i10, int i11, int[] iArr) {
        ...
        while (true) {
            ...
            long j6 = jArr[i10];
            jArr[i12 - 1] = interleave2_32to64((int) (j6 >>> 32));
            i12 -= 2;
            jArr[i12] = interleave2_32to64((int) j6);
        }
    }
    ...
    public int degree() {
        ...
        while (length != 0) {
            length--;
            long j6 = this.m_ints[length];
            if (j6 != 0) {
                return (length << 6) + bitLength(j6);
            }
        }
        return 0;
    }
    ...
    public int getUsedLengthFrom(int i10) {
        long[] jArr = this.m_ints;
        int iMin = Math.min(i10, jArr.length);
        if (iMin < 1) {
            return 0;
        }
        if (jArr[0] != 0) {
    ...
    public int hashCode() {
        ...
        for (int i11 = 0; i11 < usedLength; i11++) {
            long j6 = this.m_ints[i11];
            i10 = (((i10 * 31) ^ ((int) j6)) * 31) ^ ((int) (j6 >>> 32));
        }
        return i10;
    }
    ...
    public LongArray modInverse(int i10, int[] iArr) {
        ...
        int iDegreeFrom = 0;
        reduceBit(longArray2.m_ints, 0, i10, i10, iArr);
        ...
        while (true) {
            if (i14 < 0) {
                i14 = -i14;
                iArr2[i11] = i13;
                iArr3[i11] = iDegreeFrom;
                i11 = 1 - i11;
                i13 = iArr2[i11];
                iDegreeFrom = iArr3[i11];
            }
            int i15 = 1 - i11;
            longArrayArr[i11].addShiftedByBitsSafe(longArrayArr[i15], iArr2[i15], i14);
            int iDegreeFrom2 = longArrayArr[i11].degreeFrom(i13);
            if (iDegreeFrom2 == 0) {
                return longArrayArr2[i15];
            }
            int i16 = iArr3[i15];
            longArrayArr2[i11].addShiftedByBitsSafe(longArrayArr2[i15], i16, i14);
            int i17 = i16 + i14;
            if (i17 > iDegreeFrom) {
                iDegreeFrom = i17;
            } else if (i17 == iDegreeFrom) {
                iDegreeFrom = longArrayArr2[i11].degreeFrom(iDegreeFrom);
            }
            i14 += iDegreeFrom2 - i13;
            i13 = iDegreeFrom2;
        }
    }
    ...
    public LongArray modMultiply(LongArray longArray, int i10, int[] iArr) {
        ...
        if (i13 == 1) {
            long j6 = longArray2.m_ints[0];
            if (j6 == 1) {
                return longArray3;
            }
            long[] jArr3 = new long[i15];
            multiplyWord(j6, longArray3.m_ints, i14, jArr3, 0);
            return reduceResult(jArr3, 0, i15, i10, iArr);
        }
        int i16 = (i12 + 70) >>> 6;
        ...
        iArr2[1] = i16;
        System.arraycopy(longArray3.m_ints, 0, jArr4, i16, i14);
        int i18 = 2;
        int i19 = i16;
        while (i18 < 16) {
            int i20 = i19 + i16;
            ...
            if ((i18 & 1) == 0) {
                int i21 = i16;
                shiftUp(jArr4, i20 >>> 1, jArr4, i20, i21, 1);
                i16 = i21;
            } else {
                add(jArr4, i16, jArr4, i20 - i16, jArr4, i20, i16);
                i20 = i20;
            }
            i18++;
            i19 = i20;
        ...
        while (i23 < i13) {
            ...
            int i25 = i23;
            while (true) {
                addBoth(jArr8, i25, jArr6, iArr2[((int) j10) & 15], jArr5, iArr2[((int) (j10 >>> 4)) & 15], i24);
                jArr = jArr8;
                int i26 = i25;
                jArr2 = jArr6;
                i16 = i24;
        ...
        while (true) {
            int i27 = i22 - i15;
            if (i27 == 0) {
                return reduceResult(jArr9, 0, i15, i10, iArr);
            }
            addShiftedUp(jArr9, i27 - i15, jArr9, i27, i15, 8);
            i22 = i27;
        }
    }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i10, int[] iArr) {
        ...
        if (i18 == 1) {
            ...
            multiplyWord(j6, longArray3.m_ints, i19, jArr3, 0);
            return reduceResult(jArr3, 0, i20, i10, iArr);
        }
        int i23 = (i12 + 78) >>> 6;
        int i24 = i23 * 8;
        int[] iArr2 = new int[16];
        ...
        int i27 = i18;
        long[] jArr4 = new long[i25 + 1];
        interleave(longArray2.m_ints, 0, jArr4, 0, i27, 4);
        System.arraycopy(longArray3.m_ints, 0, jArr4, i27, i19);
        int i28 = i27;
        int i29 = 1;
        while (i29 < 8) {
            int i30 = i28 + i23;
            int i31 = i27;
            shiftUp(jArr4, i31, jArr4, i30, i23, i29);
            i27 = i31;
            i29++;
            i28 = i30;
        }
        ...
        while (true) {
            ...
            while (true) {
                ...
                int i35 = i27;
                int i36 = i21;
                long j10 = jArr4[i34] >>> i33;
                while (true) {
                    int i37 = ((int) j10) & i13;
                    if (i37 != 0) {
                        add(jArr4, iArr2[i37] + i34, jArr4, i35, i23);
                    }
                    int i38 = i36 + 1;
                    if (i38 == 8) {
                        break;
        ...
        while (true) {
            int i40 = i39 - 1;
            if (i40 <= i22) {
                return reduceResult(jArr4, iArr2[i22], i20, i10, iArr);
            }
            if ((i40 & 1) == 0) {
                int i41 = i20;
                i17 = i22;
                jArr2 = jArr4;
                addShiftedUp(jArr2, iArr2[i40 >>> 1], jArr4, iArr2[i40], i41, 16);
                i16 = i41;
            } else {
                long[] jArr8 = jArr4;
                i16 = i20;
                i17 = i22;
                jArr2 = jArr8;
                distribute(jArr2, iArr2[i40], iArr2[i39 - 2], iArr2[i17], i16);
            }
            long[] jArr9 = jArr2;
            i22 = i17;
            i20 = i16;
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i10, int[] iArr) {
        ...
        if (i13 == 1) {
            ...
            multiplyWord(j6, longArray3.m_ints, i14, jArr2, 0);
            return reduceResult(jArr2, 0, i15, i10, iArr);
        }
        int i17 = (i12 + 70) >>> 6;
        int[] iArr2 = new int[16];
        int i18 = i17 << 4;
        ...
        iArr2[1] = i17;
        System.arraycopy(longArray3.m_ints, 0, jArr3, i17, i14);
        int i19 = 2;
        int i20 = i17;
        while (i19 < 16) {
            int i21 = i20 + i17;
            ...
            if ((i19 & 1) == 0) {
                int i22 = i17;
                jArr = jArr3;
                shiftUp(jArr, i21 >>> 1, jArr3, i21, i22, 1);
                i17 = i22;
            } else {
                int i23 = i17;
                jArr = jArr3;
                add(jArr, i17, jArr3, i21 - i23, jArr, i21, i23);
                i21 = i21;
            }
            i19++;
            jArr3 = jArr;
        ...
        while (i24 >= 0) {
            ...
            while (i25 < i13) {
                int[] iArr3 = iArr2;
                int i26 = (int) (jArr5[i25] >>> i24);
                int i27 = i17;
                addBoth(jArr6, i25 - 1, jArr3, iArr3[i26 & 15], jArr4, iArr3[(i26 >>> 4) & 15], i27);
                i25 += 2;
                i17 = i27;
                iArr2 = iArr3;
                jArr6 = jArr6;
        ...
        int i28 = i17;
        long[] jArr9 = jArr3;
        for (int i29 = 56; i29 >= 0; i29 -= 8) {
            for (int i30 = 0; i30 < i13; i30 += 2) {
                int i31 = (int) (jArr5[i30] >>> i29);
                long[] jArr10 = jArr9;
                addBoth(jArr8, i30, jArr10, iArr4[i31 & 15], jArr4, iArr4[(i31 >>> 4) & 15], i28);
                jArr9 = jArr10;
            }
            if (i29 > 0) {
                shiftUp(jArr8, 0, i15, 8);
            }
        }
        return reduceResult(jArr8, 0, i15, i10, iArr);
    }

    public LongArray modReduce(int i10, int[] iArr) {
        long[] jArrClone = Arrays.clone(this.m_ints);
        return new LongArray(jArrClone, 0, reduceInPlace(jArrClone, 0, jArrClone.length, i10, iArr));
    }
    ...
    public LongArray modSquare(int i10, int[] iArr) {
        ...
        int i12 = 0;
        while (i12 < i11) {
            long j6 = this.m_ints[i12 >>> 1];
            int i13 = i12 + 1;
            jArr[i12] = interleave2_32to64((int) j6);
            i12 += 2;
            jArr[i13] = interleave2_32to64((int) (j6 >>> 32));
        }
    ...
    public LongArray multiply(LongArray longArray, int i10, int[] iArr) {
        ...
        if (i15 == 1) {
            ...
            multiplyWord(j6, longArray3.m_ints, i16, jArr, 0);
            return new LongArray(jArr, 0, i17);
        }
        int i18 = (i12 + 70) >>> 6;
        int[] iArr2 = new int[16];
        int i19 = i18 << 4;
        ...
        iArr2[1] = i18;
        System.arraycopy(longArray3.m_ints, 0, jArr2, i18, i16);
        int i20 = 2;
        int i21 = i18;
        while (i20 < 16) {
            int i22 = i21 + i18;
            ...
            if ((i20 & 1) == 0) {
                int i23 = i18;
                shiftUp(jArr2, i22 >>> 1, jArr2, i22, i23, 1);
                i14 = i23;
            } else {
                int i24 = i18;
                i14 = i24;
                add(jArr2, i24, jArr2, i22 - i24, jArr2, i22, i14);
                i22 = i22;
            }
            i20++;
            i21 = i22;
        ...
        while (i27 < i15) {
            ...
            while (true) {
                long[] jArr6 = jArr3;
                long[] jArr7 = jArr2;
                addBoth(jArr5, i28, jArr7, iArr2[((int) j10) & 15], jArr6, iArr2[((int) (j10 >>> 4)) & 15], i25);
                int i29 = i28;
                jArr2 = jArr7;
                jArr3 = jArr6;
                i13 = i25;
        ...
        while (true) {
            int i30 = i26 - i17;
            if (i30 == 0) {
                return new LongArray(jArr5, 0, i17);
            }
            addShiftedUp(jArr5, i30 - i17, jArr5, i30, i17, 8);
            i26 = i30;
        }
    }
    ...
    public void reduce(int i10, int[] iArr) {
        long[] jArr = this.m_ints;
        int iReduceInPlace = reduceInPlace(jArr, 0, jArr.length, i10, iArr);
    ...
    public BigInteger toBigInteger() {
        ...
        long j6 = this.m_ints[i10];
        byte[] bArr = new byte[8];
        int i11 = 0;
        boolean z6 = false;
        for (int i12 = 7; i12 >= 0; i12--) {
            byte b10 = (byte) (j6 >>> (i12 * 8));
            if (z6 || b10 != 0) {
                bArr[i11] = b10;
                i11++;
                z6 = true;
    ...
    private static long shiftUp(long[] jArr, int i10, long[] jArr2, int i11, int i12, int i13) {
        ...
        long j6 = 0;
        for (int i15 = 0; i15 < i12; i15++) {
            long j10 = jArr[i10 + i15];
            jArr2[i11 + i15] = j6 | (j10 << i13);
            j6 = j10 >>> i14;
        }
        return j6;
    }
