...
public abstract class Primes {
    ...
    public static class MROutput {
        ...
        private MROutput(boolean z6, BigInteger bigInteger) {
            this.provablyComposite = z6;
    ...
    private static void checkCandidate(BigInteger bigInteger, String str) {
        if (bigInteger == null || bigInteger.signum() < 1 || bigInteger.bitLength() < 2) {
            throw new IllegalArgumentException(AbstractC5601a.m11238i("'", str, "' must be non-null and >= 2"));
        }
    }
    ...
    private static STOutput implSTRandomPrime(Digest digest, int i10, byte[] bArr) {
        ...
        if (i10 < 33) {
            ...
            do {
                ...
                inc(bArr, 1);
                i12++;
                long jExtract32 = (((extract32(bArr2) ^ extract32(bArr3)) & ((-1) >>> (32 - i10))) | (1 << (i10 - 1)) | 1) & 4294967295L;
                if (isPrime32(jExtract32)) {
                    return new STOutput(BigInteger.valueOf(jExtract32), bArr, i12);
                }
            } while (i12 <= i10 * 4);
            throw new IllegalStateException("Too many iterations in Shawe-Taylor Random_Prime Routine");
        }
        STOutput sTOutputImplSTRandomPrime = implSTRandomPrime(digest, (i10 + 3) / 2, bArr);
        ...
        int i13 = i10 - 1;
        int i14 = (i13 / (digestSize * 8)) + 1;
        BigInteger bigIntegerHashGen = hashGen(digest, primeSeed, i14);
        BigInteger bigInteger = ONE;
        BigInteger bit = bigIntegerHashGen.mod(bigInteger.shiftLeft(i13)).setBit(i13);
        ...
        while (true) {
            ...
            if (implHasAnySmallFactors(bigIntegerAdd)) {
                ...
                BigInteger bigIntegerAdd2 = hashGen(digest, primeSeed, i14).mod(bigIntegerAdd.subtract(THREE)).add(TWO);
                ...
                if (bigIntegerAdd.gcd(bigIntegerModPow.subtract(bigInteger3)).equals(bigInteger3) && bigIntegerModPow.modPow(prime, bigIntegerAdd).equals(bigInteger3)) {
                    return new STOutput(bigIntegerAdd, primeSeed, i15);
                }
                c56401 = null;
                bigIntegerShiftLeft2 = bigIntegerAdd3;
                i16 = 0;
            }
            if (i15 >= (i10 * 4) + primeGenCounter) {
                throw new IllegalStateException("Too many iterations in Shawe-Taylor Random_Prime Routine");
            }
            i16 += 2;
    ...
    private static boolean isPrime32(long j6) {
        if ((j6 >>> 32) != 0) {
            throw new IllegalArgumentException("Size limit exceeded");
        }
        if (j6 <= 5) {
            return j6 == 2 || j6 == 3 || j6 == 5;
        }
        if ((1 & j6) == 0 || j6 % 3 == 0 || j6 % 5 == 0) {
            return false;
        }
