...
public class ConfigurationException extends AuthException {
    public /* synthetic */ ConfigurationException(String str, String str2, Throwable th2, int i10, AbstractC4148f abstractC4148f) {
        this(str, str2, (i10 & 4) != 0 ? null : th2);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ConfigurationException(String message, String recoverySuggestion, Throwable th2) {
