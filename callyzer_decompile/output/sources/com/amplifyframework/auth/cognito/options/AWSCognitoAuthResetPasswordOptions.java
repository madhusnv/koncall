...
public final class AWSCognitoAuthResetPasswordOptions extends AuthResetPasswordOptions {
    ...
    public static final class Companion {
        ...
        public final AWSCognitoAuthResetPasswordOptions invoke(InterfaceC2139c block) {
    ...
    public static /* synthetic */ AWSCognitoAuthResetPasswordOptions copy$aws_auth_cognito_release$default(AWSCognitoAuthResetPasswordOptions aWSCognitoAuthResetPasswordOptions, Map map, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            map = aWSCognitoAuthResetPasswordOptions.metadata;
        }
        return aWSCognitoAuthResetPasswordOptions.copy$aws_auth_cognito_release(map);
    }
    ...
    public final AWSCognitoAuthResetPasswordOptions copy$aws_auth_cognito_release(Map<String, String> metadata) {
        AbstractC4154l.m8923f(metadata, "metadata");
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof AWSCognitoAuthResetPasswordOptions) && AbstractC4154l.m8918a(this.metadata, ((AWSCognitoAuthResetPasswordOptions) obj).metadata);
    }
