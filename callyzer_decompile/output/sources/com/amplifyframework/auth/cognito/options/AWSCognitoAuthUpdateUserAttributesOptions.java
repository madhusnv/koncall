...
public final class AWSCognitoAuthUpdateUserAttributesOptions extends AuthUpdateUserAttributesOptions {
    ...
    public static final class Companion {
        ...
        public final AWSCognitoAuthUpdateUserAttributesOptions invoke(InterfaceC2139c block) {
    ...
    public static /* synthetic */ AWSCognitoAuthUpdateUserAttributesOptions copy$aws_auth_cognito_release$default(AWSCognitoAuthUpdateUserAttributesOptions aWSCognitoAuthUpdateUserAttributesOptions, Map map, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            map = aWSCognitoAuthUpdateUserAttributesOptions.metadata;
        }
        return aWSCognitoAuthUpdateUserAttributesOptions.copy$aws_auth_cognito_release(map);
    }
    ...
    public final AWSCognitoAuthUpdateUserAttributesOptions copy$aws_auth_cognito_release(Map<String, String> metadata) {
        AbstractC4154l.m8923f(metadata, "metadata");
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof AWSCognitoAuthUpdateUserAttributesOptions) && AbstractC4154l.m8918a(this.metadata, ((AWSCognitoAuthUpdateUserAttributesOptions) obj).metadata);
    }
