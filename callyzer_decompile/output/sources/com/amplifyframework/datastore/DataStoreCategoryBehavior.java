...
public interface DataStoreCategoryBehavior {
    ...
    <T extends Model> void delete(T t7, Consumer<DataStoreItemChange<T>> consumer, Consumer<DataStoreException> consumer2);

    <T extends Model> void delete(T t7, QueryPredicate queryPredicate, Consumer<DataStoreItemChange<T>> consumer, Consumer<DataStoreException> consumer2);
    ...
    <T extends Model> void save(T t7, Consumer<DataStoreItemChange<T>> consumer, Consumer<DataStoreException> consumer2);

    <T extends Model> void save(T t7, QueryPredicate queryPredicate, Consumer<DataStoreItemChange<T>> consumer, Consumer<DataStoreException> consumer2);
