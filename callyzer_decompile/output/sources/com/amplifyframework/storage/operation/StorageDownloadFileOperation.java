...
public abstract class StorageDownloadFileOperation<R> extends StorageTransferOperation<R, StorageDownloadFileResult> {
    public StorageDownloadFileOperation(R r9) {
    ...
    public StorageDownloadFileOperation(R r9, String str, Consumer<StorageTransferProgress> consumer, Consumer<StorageDownloadFileResult> consumer2, Consumer<StorageException> consumer3) {
