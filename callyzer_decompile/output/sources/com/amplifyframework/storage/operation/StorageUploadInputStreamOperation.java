...
public abstract class StorageUploadInputStreamOperation<R> extends StorageUploadOperation<R, StorageUploadInputStreamResult> {
    public StorageUploadInputStreamOperation(R r9) {
    ...
    public StorageUploadInputStreamOperation(R r9, String str, Consumer<StorageTransferProgress> consumer, Consumer<StorageUploadInputStreamResult> consumer2, Consumer<StorageException> consumer3) {
