...
public final class AbortMultiPartUploadWorker extends SuspendingTransferWorker {
    ...
    /* compiled from: r8-map-id-9a0e3898ebce267aa93fdb2b9ae0dadacb352c01d7a13c4da957b245de4f18d9 */
    @InterfaceC8195e(m15343c = "com.amplifyframework.storage.s3.transfer.worker.AbortMultiPartUploadWorker", m15344f = "AbortMultiPartUploadWorker.kt", m15345l = {58}, m15346m = "performWork")
    /* renamed from: com.amplifyframework.storage.s3.transfer.worker.AbortMultiPartUploadWorker$performWork$1 */
    public static final class C12581 extends AbstractC8193c {
        int I$0;
        Object L$0;
        Object L$1;
        int label;
        ...
        public C12581(InterfaceC7559c<? super C12581> interfaceC7559c) {
    ...
    public static final a0 performWork$lambda$0(AbortMultiPartUploadWorker abortMultiPartUploadWorker, C2554d withConfig) {
        AbstractC4154l.m8923f(withConfig, "$this$withConfig");
        withConfig.f13913m = Boolean.valueOf(abortMultiPartUploadWorker.getTransferRecord$aws_storage_s3_release().getUseAccelerateEndpoint() == 1);
        return a0.f30746a;
    }
    ...
    */
    public java.lang.Object performWork(uw.InterfaceC7559c<? super t8.AbstractC7075u> r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amplifyframework.storage.s3.transfer.worker.AbortMultiPartUploadWorker.performWork(uw.c):java.lang.Object");
    }
}
