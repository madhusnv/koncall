...
public final /* synthetic */ class AmplifyOutputsDataImpl$Geo$SearchIndices$$serializer implements InterfaceC3888y {
    ...
    static {
        ...
        p0 p0Var = new p0("com.amplifyframework.core.configuration.AmplifyOutputsDataImpl.Geo.SearchIndices", amplifyOutputsDataImpl$Geo$SearchIndices$$serializer, 2);
    ...
    public final InterfaceC2401a[] childSerializers() {
        return new InterfaceC2401a[]{AmplifyOutputsDataImpl.Geo.SearchIndices.$childSerializers[0].getValue(), a1.f19869a};
    }

    @Override // fy.InterfaceC2401a
    public final AmplifyOutputsDataImpl.Geo.SearchIndices deserialize(InterfaceC3366c decoder) {
        ...
        InterfaceC6357g[] interfaceC6357gArr = AmplifyOutputsDataImpl.Geo.SearchIndices.$childSerializers;
        boolean z6 = true;
        int i10 = 0;
        Set set = null;
        ...
        return new AmplifyOutputsDataImpl.Geo.SearchIndices(i10, set, strMo7681d, null);
    }
    ...
    @Override // fy.InterfaceC2401a
    public final void serialize(InterfaceC3367d encoder, AmplifyOutputsDataImpl.Geo.SearchIndices value) {
        AbstractC4154l.m8923f(encoder, "encoder");
        AbstractC4154l.m8923f(value, "value");
        InterfaceC3055f interfaceC3055f = descriptor;
        InterfaceC3365b interfaceC3365bMo7711c = encoder.mo7711c(interfaceC3055f);
        AmplifyOutputsDataImpl.Geo.SearchIndices.write$Self$core_release(value, interfaceC3365bMo7711c, interfaceC3055f);
