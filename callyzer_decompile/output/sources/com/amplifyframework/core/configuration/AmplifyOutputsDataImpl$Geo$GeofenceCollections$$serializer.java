...
public final /* synthetic */ class AmplifyOutputsDataImpl$Geo$GeofenceCollections$$serializer implements InterfaceC3888y {
    ...
    static {
        ...
        p0 p0Var = new p0("com.amplifyframework.core.configuration.AmplifyOutputsDataImpl.Geo.GeofenceCollections", amplifyOutputsDataImpl$Geo$GeofenceCollections$$serializer, 2);
    ...
    public final InterfaceC2401a[] childSerializers() {
        return new InterfaceC2401a[]{AmplifyOutputsDataImpl.Geo.GeofenceCollections.$childSerializers[0].getValue(), a1.f19869a};
    }

    @Override // fy.InterfaceC2401a
    public final AmplifyOutputsDataImpl.Geo.GeofenceCollections deserialize(InterfaceC3366c decoder) {
        ...
        InterfaceC6357g[] interfaceC6357gArr = AmplifyOutputsDataImpl.Geo.GeofenceCollections.$childSerializers;
        boolean z6 = true;
        int i10 = 0;
        Set set = null;
        ...
        while (z6) {
            ...
            if (iMo7685o == -1) {
                ...
                set = (Set) interfaceC3364aMo7699c.mo7689u(interfaceC3055f, 0, (InterfaceC2401a) interfaceC6357gArr[0].getValue(), set);
                i10 |= 1;
            } else {
                if (iMo7685o != 1) {
        ...
        return new AmplifyOutputsDataImpl.Geo.GeofenceCollections(i10, set, strMo7681d, null);
    }
    ...
    @Override // fy.InterfaceC2401a
    public final void serialize(InterfaceC3367d encoder, AmplifyOutputsDataImpl.Geo.GeofenceCollections value) {
        AbstractC4154l.m8923f(encoder, "encoder");
        AbstractC4154l.m8923f(value, "value");
        InterfaceC3055f interfaceC3055f = descriptor;
        InterfaceC3365b interfaceC3365bMo7711c = encoder.mo7711c(interfaceC3055f);
        AmplifyOutputsDataImpl.Geo.GeofenceCollections.write$Self$core_release(value, interfaceC3365bMo7711c, interfaceC3055f);
