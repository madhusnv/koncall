...
public class TypeToken<T> {
    ...
    public TypeToken() {
        ...
        this.rawType = AbstractC4770i.m9695h(typeTokenTypeArgument);
    ...
    public static TypeToken<?> getArray(Type type) {
        return new TypeToken<>(new C4767f(type));
    }
    ...
    public static TypeToken<?> getParameterized(Type type, Type... typeArr) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            Class<?> clsM9695h = AbstractC4770i.m9695h(type2);
            TypeVariable<Class<T>> typeVariable = typeParameters[i10];
            for (Type type3 : typeVariable.getBounds()) {
                if (!AbstractC4770i.m9695h(type3).isAssignableFrom(clsM9695h)) {
        ...
        return new TypeToken<>(new C4768g(null, cls, typeArr));
    }
    ...
    private Type getTypeTokenTypeArgument() {
        ...
        if (genericSuperclass instanceof ParameterizedType) {
            ...
            if (parameterizedType.getRawType() == TypeToken.class) {
                Type typeM9688a = AbstractC4770i.m9688a(parameterizedType.getActualTypeArguments()[0]);
                if (isCapturingTypeVariablesForbidden()) {
                    verifyNoTypeVariable(typeM9688a);
                }
                return typeM9688a;
            }
    ...
    public final boolean equals(Object obj) {
        return (obj instanceof TypeToken) && AbstractC4770i.m9692e(this.type, ((TypeToken) obj).type);
    }
    ...
    public final String toString() {
        return AbstractC4770i.m9699l(this.type);
    }
    ...
    public boolean isAssignableFrom(Type type) {
        ...
        if (type2 instanceof Class) {
            return this.rawType.isAssignableFrom(AbstractC4770i.m9695h(type));
        }
        if (type2 instanceof ParameterizedType) {
            return isAssignableFrom(type, (ParameterizedType) type2, new HashMap());
        }
        if (type2 instanceof GenericArrayType) {
            return this.rawType.isAssignableFrom(AbstractC4770i.m9695h(type)) && isAssignableFrom(type, (GenericArrayType) this.type);
        }
    ...
    private TypeToken(Type type) {
        Objects.requireNonNull(type);
        Type typeM9688a = AbstractC4770i.m9688a(type);
        this.type = typeM9688a;
        this.rawType = AbstractC4770i.m9695h(typeM9688a);
        this.hashCode = typeM9688a.hashCode();
    }
    ...
    private static boolean isAssignableFrom(Type type, ParameterizedType parameterizedType, Map<String, Type> map) {
        ...
        Class clsM9695h = AbstractC4770i.m9695h(type);
        ParameterizedType parameterizedType2 = type instanceof ParameterizedType ? (ParameterizedType) type : null;
        if (parameterizedType2 != null) {
            Type[] actualTypeArguments = parameterizedType2.getActualTypeArguments();
            TypeVariable<Class<T>>[] typeParameters = clsM9695h.getTypeParameters();
            for (int i10 = 0; i10 < actualTypeArguments.length; i10++) {
        ...
        for (Type type3 : clsM9695h.getGenericInterfaces()) {
            if (isAssignableFrom(type3, parameterizedType, new HashMap(map))) {
                return true;
            }
        }
        return isAssignableFrom(clsM9695h.getGenericSuperclass(), parameterizedType, new HashMap(map));
    }
}
