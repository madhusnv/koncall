...
public enum EnumC1307w {
    ...
    static {
        for (EnumC1307w enumC1307w : values()) {
            zzap.put(Integer.valueOf(enumC1307w.zzao), enumC1307w);
        }
    }
    ...
    public static EnumC1307w zza(int i10) {
        return (EnumC1307w) zzap.get(Integer.valueOf(i10));
    }
