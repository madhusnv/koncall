...
public enum k7 implements InterfaceC5921b {
    UNKNOWN_EVENT(0),
    ...
    ON_DEVICE_OBJECT_LOAD(BERTags.PRIVATE),
    ...
    AGGREGATED_AUTO_ML_IMAGE_LABELING_INFERENCE(DisplayText.DISPLAY_TEXT_MAXIMUM_SIZE),
