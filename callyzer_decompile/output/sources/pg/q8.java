...
public abstract class q8 {
    ...
    /* renamed from: a */
    public static final void m11834a(l7.a0 navController, InterfaceC3962k interfaceC3962k, int i10) {
        AbstractC4154l.m8923f(navController, "navController");
        C3966o c3966o = (C3966o) interfaceC3962k;
        c3966o.a0(1889687380);
        ...
        if (c3966o.m8598P(i11 & 1, (i11 & 3) != 2)) {
            ...
            d7.w0 w0VarM11692c = AbstractC5928i.m11692c(C4246d.class, c1VarM6992a, c2392fM11854a, c1VarM6992a instanceof InterfaceC1637j ? ((InterfaceC1637j) c1VarM6992a).getDefaultViewModelCreationExtras() : C2536a.f13867b, c3966o);
            c3966o.m8623p(false);
            c3966o.m8623p(false);
            C4246d c4246d = (C4246d) w0VarM11692c;
            C4245c c4245c = (C4245c) C3953b.m8509l(c4246d.f21572g, c3966o).getValue();
            Object objM8618k = c3966o.m8618k(AndroidCompositionLocals_androidKt.f2134b);
            boolean zM8616i = c3966o.m8616i(c4246d);
            Object objM8596M = c3966o.m8596M();
            k2.s0 s0Var = C3961j.f20408a;
            if (zM8616i || objM8596M == s0Var) {
                objM8596M = new C0782a(c4246d, null, 11);
                c3966o.j0(objM8596M);
            }
            ...
            String strM11629c = f9.m11629c(c3966o, R.string.theme);
            boolean zM8616i2 = c3966o.m8616i(navController);
            Object objM8596M2 = c3966o.m8596M();
            if (zM8616i2 || objM8596M2 == s0Var) {
                objM8596M2 = new C0401d(navController, 14);
            ...
            List list = c4245c.f21566a;
            boolean zM8616i3 = c3966o.m8616i(c4246d);
            Object objM8596M3 = c3966o.m8596M();
            if (zM8616i3 || objM8596M3 == s0Var) {
                objM8596M3 = new an.j2(23, c4246d);
        ...
        if (n1VarM8628u != null) {
            n1VarM8628u.f20443d = new C0769n(navController, i10, 5);
        }
    }
}
