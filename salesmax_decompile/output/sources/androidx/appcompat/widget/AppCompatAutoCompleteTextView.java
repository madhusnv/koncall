...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView {
    ...
    /* renamed from: d */
    public static final int[] f5786d = {R.attr.popupBackground};

    /* renamed from: a */
    public final oj0 f5787a;

    /* renamed from: b */
    public final ok0 f5788b;

    /* renamed from: c */
    public final fk0 f5789c;
    ...
    public void drawableStateChanged() {
        ...
        oj0 oj0Var = this.f5787a;
        if (oj0Var != null) {
            oj0Var.m42283b();
        }
        ok0 ok0Var = this.f5788b;
        if (ok0Var != null) {
            ok0Var.m42318b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f5788b.m42325j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f5788b.m42326k();
    }

    @Override // android.widget.TextView, android.view.View
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f5789c.m26943d(hk0.m30674a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z) {
        this.f5789c.m26944e(z);
    }

    @Override // android.widget.TextView
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f5789c.m26940a(keyListener));
    }
    ...
    public void setSupportCompoundDrawablesTintList(ColorStateList colorStateList) {
        this.f5788b.m42338w(colorStateList);
        this.f5788b.m42318b();
    }

    public void setSupportCompoundDrawablesTintMode(PorterDuff.Mode mode) {
        this.f5788b.m42339x(mode);
        this.f5788b.m42318b();
    }
    ...
    public AppCompatAutoCompleteTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        anh anhVarM17525v = anh.m17525v(getContext(), attributeSet, f5786d, i, 0);
