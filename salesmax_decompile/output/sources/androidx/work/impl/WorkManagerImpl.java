...
public class WorkManagerImpl extends WorkManager {
    ...
    public WorkManagerImpl(Context context, Configuration configuration, TaskExecutor taskExecutor) {
        this(context, configuration, taskExecutor, context.getResources().getBoolean(C2574R.bool.workmanager_test_configuration));
    }
    ...
    private void tryInitializeMultiProcessSupport() {
        try {
            int i = RemoteWorkManagerClient.f10575a;
    ...
    @Override // androidx.work.WorkManager
    public zfa getLastCancelAllTimeMillis() {
    ...
    @Override // androidx.work.WorkManager
    public zfa getWorkInfoById(UUID uuid) {
    ...
    @Override // androidx.work.WorkManager
    public AbstractC2145n getWorkInfoByIdLiveData(UUID uuid) {
        return LiveDataUtils.dedupedMappedLiveDataFor(this.mWorkDatabase.workSpecDao().getWorkStatusPojoLiveDataForIds(Collections.singletonList(uuid.toString())), new zl7() { // from class: androidx.work.impl.WorkManagerImpl.2
            @Override // p001o.zl7
    ...
    @Override // androidx.work.WorkManager
    public zfa getWorkInfos(WorkQuery workQuery) {
    ...
    public AbstractC2145n getWorkInfosById(List<String> list) {
    ...
    @Override // androidx.work.WorkManager
    public zfa getWorkInfosByTag(String str) {
    ...
    @Override // androidx.work.WorkManager
    public AbstractC2145n getWorkInfosByTagLiveData(String str) {
    ...
    @Override // androidx.work.WorkManager
    public zfa getWorkInfosForUniqueWork(String str) {
    ...
    @Override // androidx.work.WorkManager
    public AbstractC2145n getWorkInfosForUniqueWorkLiveData(String str) {
    ...
    @Override // androidx.work.WorkManager
    public AbstractC2145n getWorkInfosLiveData(WorkQuery workQuery) {
    ...
    @Override // androidx.work.WorkManager
    public zfa updateWork(WorkRequest workRequest) {
