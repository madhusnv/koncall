...
public final class WorkProgressDao_Impl implements WorkProgressDao {
    ...
    public WorkProgressDao_Impl(RoomDatabase roomDatabase) {
        ...
        this.__insertionAdapterOfWorkProgress = new EntityInsertionAdapter<WorkProgress>(roomDatabase) { // from class: androidx.work.impl.model.WorkProgressDao_Impl.1
            ...
            public void bind(peg pegVar, WorkProgress workProgress) throws Throwable {
                if (workProgress.getWorkSpecId() == null) {
                    pegVar.bindNull(1);
                } else {
                    pegVar.bindString(1, workProgress.getWorkSpecId());
                }
                byte[] byteArrayInternal = Data.toByteArrayInternal(workProgress.getProgress());
                if (byteArrayInternal == null) {
                    pegVar.bindNull(2);
                } else {
                    pegVar.bindBlob(2, byteArrayInternal);
                }
            }
        };
    ...
    public void deleteAll() {
        this.__db.assertNotSuspendingTransaction();
        peg pegVarAcquire = this.__preparedStmtOfDeleteAll.acquire();
        this.__db.beginTransaction();
        try {
            pegVarAcquire.executeUpdateDelete();
            this.__db.setTransactionSuccessful();
            ...
            this.__db.endTransaction();
            this.__preparedStmtOfDeleteAll.release(pegVarAcquire);
        }
    }

    @Override // androidx.work.impl.model.WorkProgressDao
    public Data getProgressForWorkSpecId(String str) throws Throwable {
