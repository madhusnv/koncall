...
public final class DateTimeFormatter {
    ...
    static {
        ...
        DateTimeFormatter formatter4 = new DateTimeFormatterBuilder().parseCaseInsensitive().append(formatter3).appendOffsetId().toFormatter(resolverStyle, isoChronology);
        ...
        BASIC_ISO_DATE = new DateTimeFormatterBuilder().parseCaseInsensitive().appendValue(chronoField, 4).appendValue(chronoField2, 2).appendValue(chronoField3, 2).optionalStart().appendOffset("+HHMMss", "Z").toFormatter(resolverStyle, isoChronology);
