...
public interface ChronoZonedDateTime<D extends ChronoLocalDate> extends Temporal, Comparable<ChronoZonedDateTime<?>> {
    ...
    static /* synthetic */ class C119351 {
    ...
    default int get(TemporalField temporalField) {
        ...
        int i = C119351.$SwitchMap$java$time$temporal$ChronoField[((ChronoField) temporalField).ordinal()];
        if (i != 1) {
    ...
    default long toEpochSecond() {
        return ((toLocalDate().toEpochDay() * SessionListener.SECONDS_IN_A_DAY) + toLocalTime().toSecondOfDay()) - getOffset().getTotalSeconds();
    }
