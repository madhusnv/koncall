...
public final class OffsetDateTime implements Temporal, TemporalAdjuster, Comparable<OffsetDateTime>, Serializable {
    ...
    static /* synthetic */ class C119301 {
    ...
    public int get(TemporalField temporalField) {
        ...
        int i = C119301.$SwitchMap$java$time$temporal$ChronoField[((ChronoField) temporalField).ordinal()];
        if (i != 1) {
    ...
    public OffsetDateTime with(TemporalField temporalField, long j) {
        ...
        int i = C119301.$SwitchMap$java$time$temporal$ChronoField[chronoField.ordinal()];
