...
public abstract class vge {
    /* renamed from: a */
    public static final void m52754a(tge.C17108a c17108a, byte[] bArr) {
        sq8.m48649h(c17108a, "builder");
        ...
        while (true) {
            ...
            if (sq8.m48644c(vejVarM52684d.m52683c(), OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE)) {
                ...
                if (thM53354e != null) {
                    objM54282d = vre.m53351b(wre.m54933a(new an5("expected (string: `com.amazonaws.sts#regionDisabledMessage`)", thM53354e)));
                }
                wre.m54934b(objM54282d);
                c17108a.m49846d((String) objM54282d);
            }
