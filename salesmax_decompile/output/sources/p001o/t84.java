...
public abstract class t84 {
    ...
    public static Map m49558a() {
        ...
        arrayList87.add("TZ");
        map.put(Integer.valueOf(Constants.MAX_HOST_LENGTH), arrayList87);
        ...
        arrayList134.add("SK");
        map.put(Integer.valueOf(MediaError.DetailedErrorCode.DASH_MANIFEST_NO_PERIODS), arrayList134);
        ...
        arrayList137.add("BZ");
        map.put(Integer.valueOf(HttpStatus.SC_NOT_IMPLEMENTED), arrayList137);
        ...
        arrayList140.add("HN");
        map.put(Integer.valueOf(HttpStatus.SC_GATEWAY_TIMEOUT), arrayList140);
        ArrayList arrayList141 = new ArrayList(1);
        arrayList141.add("NI");
        map.put(Integer.valueOf(HttpStatus.SC_HTTP_VERSION_NOT_SUPPORTED), arrayList141);
        ArrayList arrayList142 = new ArrayList(1);
        arrayList142.add("CR");
        map.put(506, arrayList142);
        ArrayList arrayList143 = new ArrayList(1);
        arrayList143.add("PA");
        map.put(Integer.valueOf(HttpStatus.SC_INSUFFICIENT_STORAGE), arrayList143);
