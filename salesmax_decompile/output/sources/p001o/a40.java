...
public class a40 extends z30 {
    ...
    static {
        ...
        sparseIntArray.put(z8e.taskAssignPeopleTitle, 2);
        sparseIntArray.put(z8e.taskAssignSearchField, 3);
        sparseIntArray.put(z8e.taskAssignSearchEditText, 4);
        sparseIntArray.put(z8e.taskAssigneeList, 5);
    }

    public a40(yt4 yt4Var, View view) {
    ...
    public a40(yt4 yt4Var, View view, Object[] objArr) {
