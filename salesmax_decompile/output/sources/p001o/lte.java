...
public abstract class lte {
    ...
    */
    public static final Void m37883b(jl6 jl6Var, o18 o18Var, byte[] bArr) throws Throwable {
        Throwable ng3Var;
                ...
                switch (strMo18271a.hashCode()) {
                    case -1362904677:
                        if (!strMo18271a.equals("UnauthorizedException")) {
                            ...
                            ng3Var = new y2i().mo16296b(jl6Var, o18VarM41344c, bArr);
                            break;
                        }
                    case -574283855:
                        if (strMo18271a.equals("UnsupportedTokenTypeException")) {
                            ng3Var = new e6i().mo16296b(jl6Var, o18VarM41344c, bArr);
                            break;
                        }
                        break;
                    case -392923018:
                    ...
                    case 1674340573:
                        ...
                        break;
                    case 2097301917:
                        if (strMo18271a.equals("UnsupportedOperationException")) {
                            ng3Var = new t5i().mo16296b(jl6Var, o18VarM41344c, bArr);
                            break;
                        }
                        break;
                }
