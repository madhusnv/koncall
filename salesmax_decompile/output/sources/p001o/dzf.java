...
public abstract class dzf {
    /* renamed from: a */
    public static final void m23971a(tff tffVar, czf czfVar) {
        sq8.m48649h(tffVar, "serializer");
        sq8.m48649h(czfVar, "input");
        ...
        if (czfVar.m22131a()) {
            l9gVarMo41871h.mo26542i(h7fVar, czfVar.m22131a());
        }
        if (czfVar.m22132b()) {
            l9gVarMo41871h.mo26542i(h7fVar2, czfVar.m22132b());
        }
