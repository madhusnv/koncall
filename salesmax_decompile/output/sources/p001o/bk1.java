...
public final class bk1 implements ic3 {

    /* renamed from: a */
    public static final C12445a f16451a = new C12445a(null);

    /* renamed from: b */
    public static final bk1 f16452b = new bk1();

    /* renamed from: c */
    public static final kc3 f16453c = kc3.f31903e.m35385a();

    /* renamed from: o.bk1$a */
    public static final class C12445a {
        public C12445a() {
        }

        public /* synthetic */ C12445a(id5 id5Var) {
            this();
        }

        /* renamed from: a */
        public final ic3 m19264a() {
            return bk1.f16452b;
        }
    }

    /* renamed from: o.bk1$b */
    public static final class C12446b implements rl7 {

        /* renamed from: a */
        public static final C12446b f16454a = new C12446b();
    ...
    /* renamed from: o.bk1$c */
    public static final class C12447c implements rl7 {

        /* renamed from: a */
        public static final C12447c f16455a = new C12447c();
    ...
    public CallEngagement mo19263a(CallEvent callEvent, CloudTelephonyCall cloudTelephonyCall) {
        ...
        try {
            ...
            l1 l1Var = (l1) uni.LB().d0(C12446b.f16454a).d0(C12447c.f16455a).m55729h();
            ...
            Object objM55729h = l1Var.yg(cloudTelephonyUserM35377j, cloudTelephonyAccountM35376i, callEvent.getNumber(), cloudTelephonyCall != null ? cloudTelephonyCall.getCallId() : null, callEvent.getCloudProvider(), cloudTelephonyUserM35377j != null ? cloudTelephonyUserM35377j.getRemoteUserId() : null).m0(jwe.m34628c(jwe.f31197a, 0, 0, 3, null)).m55729h();
