...
public final class mo1 implements sn8 {
    @Override // p001o.sn8
    ...
    public Object modifyBeforeTransmit(c2e c2eVar, n64 n64Var) {
        Set set = (Set) c2eVar.mo25341b().mo18191b(po1.m43955d());
        if (set == null) {
            return c2eVar.mo20099c();
        }
        String strM42487c = oo1.m42487c(set);
        String str = (String) ((y38) c2eVar.mo20099c()).getHeaders().get("User-Agent");
        z38 z38VarM26053c = f48.m26053c((y38) c2eVar.mo20099c());
        z38VarM26053c.m58668e().m59810r("User-Agent", str + strM42487c);
