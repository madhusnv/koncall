...
public abstract class urf {
    /* renamed from: c */
    public static final void m51977c(yrf.C18472a c18472a, byte[] bArr) {
        i89 i89Var = new i89(bArr);
        h7f h7fVar = new h7f(aff.C12164k.f14623a, new na9("CodeDeliveryDetails"));
        aff.C12163j c12163j = aff.C12163j.f14622a;
        h7f h7fVar2 = new h7f(c12163j, new na9("Session"));
        h7f h7fVar3 = new h7f(aff.C12155b.f14614a, new na9("UserConfirmed"));
        h7f h7fVar4 = new h7f(c12163j, new na9("UserSub"));
        ...
        while (true) {
            ...
            if (numMo23583m != null && numMo23583m.intValue() == iM29946a) {
                c18472a.m58151g(af3.m16984a(i89Var));
            } else {
                int iM29946a2 = h7fVar2.m29946a();
                if (numMo23583m != null && numMo23583m.intValue() == iM29946a2) {
                    c18472a.m58152h(interfaceC12997cMo23579h.mo31726i());
                } else {
                    int iM29946a3 = h7fVar3.m29946a();
                    if (numMo23583m != null && numMo23583m.intValue() == iM29946a3) {
                        c18472a.m58153i(interfaceC12997cMo23579h.mo31730n());
                    } else {
                        int iM29946a4 = h7fVar4.m29946a();
                        if (numMo23583m != null && numMo23583m.intValue() == iM29946a4) {
                            c18472a.m58154j(interfaceC12997cMo23579h.mo31726i());
    ...
    */
    public static final Void m51978d(jl6 jl6Var, o18 o18Var, byte[] bArr) throws Throwable {
        Throwable ng3Var;
            ...
            if (strMo18271a != null) {
                switch (strMo18271a.hashCode()) {
                    ...
                    case -1003072464:
                        ...
                        break;
                    case -984112259:
                        if (strMo18271a.equals("UsernameExistsException")) {
                            ng3Var = new upi().mo16296b(jl6Var, o18VarM41344c, bArr);
                            break;
                        }
                        break;
                    case -828042111:
                    ...
                    case 1821306386:
                        ...
                        break;
                    case 1946878246:
                        if (strMo18271a.equals("CodeDeliveryFailureException")) {
                            ng3Var = new cf3().mo16296b(jl6Var, o18VarM41344c, bArr);
                            break;
                        }
                        break;
                }
