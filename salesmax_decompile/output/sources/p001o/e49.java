...
public class e49 extends d49 implements jbc.InterfaceC14485a {
    ...
    public e49(yt4 yt4Var, View view) {
    ...
    public void mo16295p() {
        ...
        if (j2 == 0 || leadsTeam == null) {
            ...
            zIsSelected = leadsTeam.isSelected();
        }
        if (j2 != 0) {
            np3.m40895a(this.n0, zIsSelected);
            nr1.g1(this.n0, teamName);
            fjh.m26938c(this.n0, teamName);
        }
        if ((j & 8) != 0) {
    ...
    public e49(yt4 yt4Var, View view, Object[] objArr) {
