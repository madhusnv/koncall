...
public class o29 extends n29 implements jbc.InterfaceC14485a {
    ...
    public o29(yt4 yt4Var, View view) {
    ...
    public final void mo16294c(int i, View view) {
        if (i == 1) {
            ck6 ck6Var = this.s0;
            ReminderData reminderData = this.p0;
            Integer num = this.q0;
            if (ck6Var != null) {
                ck6Var.mo708b(view, num.intValue(), reminderData);
                return;
            }
            return;
        }
        ...
        ck6 ck6Var2 = this.s0;
        ReminderData reminderData2 = this.p0;
        Integer num2 = this.q0;
        if (ck6Var2 != null) {
            ck6Var2.mo708b(view, num2.intValue(), reminderData2);
        }
    }
    ...
    public void i0(ReminderData reminderData) {
        this.p0 = reminderData;
        synchronized (this) {
            this.w0 |= 2;
        }
        m28509h(67);
    ...
    public void mo16295p() {
        ...
        ReminderData reminderData = this.p0;
        long j2 = 18 & j;
        if (j2 == 0 || reminderData == null) {
            name = null;
            zIsSelected = false;
        } else {
            name = reminderData.getName();
            zIsSelected = reminderData.isSelected();
        }
        if (j2 != 0) {
    ...
    public o29(yt4 yt4Var, View view, Object[] objArr) {
