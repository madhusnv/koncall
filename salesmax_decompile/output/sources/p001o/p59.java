...
public class p59 extends o59 implements jbc.InterfaceC14485a {
    ...
    public p59(yt4 yt4Var, View view) {
    ...
    public void mo16295p() {
        ...
        VisitOutcome visitOutcome = this.o0;
        long j2 = 10 & j;
        boolean zIsSelected = (j2 == 0 || visitOutcome == null) ? false : visitOutcome.isSelected();
        if (j2 != 0) {
            np3.m40895a(this.n0, zIsSelected);
            nr1.n1(this.n0, visitOutcome);
        }
        if ((j & 8) != 0) {
    ...
    public p59(yt4 yt4Var, View view, Object[] objArr) {
