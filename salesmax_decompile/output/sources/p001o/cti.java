...
public abstract class cti {
    /* renamed from: c */
    public static final void m21804c(gti.C13822a c13822a, byte[] bArr) {
        i89 i89Var = new i89(bArr);
        h7f h7fVar = new h7f(aff.C12163j.f14622a, new na9("Session"));
        h7f h7fVar2 = new h7f(aff.C12157d.f14616a, new na9("Status"));
        ...
        while (true) {
            ...
            if (numMo23583m != null && numMo23583m.intValue() == iM29946a) {
                c13822a.m29488e(interfaceC12997cMo23579h.mo31726i());
            } else {
                int iM29946a2 = h7fVar2.m29946a();
                if (numMo23583m != null && numMo23583m.intValue() == iM29946a2) {
                    c13822a.m29489f(hti.f27542a.m31129a(interfaceC12997cMo23579h.mo31726i()));
    ...
    */
    public static final Void m21805d(jl6 jl6Var, o18 o18Var, byte[] bArr) throws Throwable {
        Throwable ng3Var;
            ...
            if (strMo18271a != null) {
                switch (strMo18271a.hashCode()) {
                    ...
                    case 1384808312:
                        ...
                        break;
                    case 1603580054:
                        if (strMo18271a.equals("EnableSoftwareTokenMFAException")) {
                            ng3Var = new w66().mo16296b(jl6Var, o18VarM41344c, bArr);
                            break;
                        }
                        break;
                    case 1674340573:
