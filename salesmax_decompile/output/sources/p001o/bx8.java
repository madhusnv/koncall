...
public class bx8 extends ax8 implements jbc.InterfaceC14485a {
    ...
    public bx8(yt4 yt4Var, View view) {
    ...
    public void mo16295p() {
        ...
        CallOutcome callOutcome = this.o0;
        long j2 = 10 & j;
        boolean zIsSelected = (j2 == 0 || callOutcome == null) ? false : callOutcome.isSelected();
        if (j2 != 0) {
            np3.m40895a(this.n0, zIsSelected);
            nr1.h1(this.n0, callOutcome);
        }
        if ((j & 8) != 0) {
    ...
    public bx8(yt4 yt4Var, View view, Object[] objArr) {
