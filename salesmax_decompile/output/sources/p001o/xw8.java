...
public class xw8 extends ww8 implements jbc.InterfaceC14485a {
    ...
    public xw8(yt4 yt4Var, View view) {
    ...
    public final void mo16294c(int i, View view) {
        if (i == 1) {
            ck6 ck6Var = this.q0;
            CallOutcome callOutcome = this.o0;
            Integer num = this.p0;
            if (ck6Var != null) {
        ...
        ck6 ck6Var2 = this.q0;
        CallOutcome callOutcome2 = this.o0;
        Integer num2 = this.p0;
        if (ck6Var2 != null) {
            ck6Var2.mo708b(view, num2.intValue(), callOutcome2);
        }
    }
    ...
    public void i0(CallOutcome callOutcome) {
        this.o0 = callOutcome;
        synchronized (this) {
            this.v0 |= 2;
        }
    ...
    public void mo16295p() {
        ...
        CallOutcome callOutcome = this.o0;
        long j2 = 10 & j;
        String outcomeTitle = (j2 == 0 || callOutcome == null) ? null : callOutcome.getOutcomeTitle();
        if ((j & 8) != 0) {
    ...
    public xw8(yt4 yt4Var, View view, Object[] objArr) {
