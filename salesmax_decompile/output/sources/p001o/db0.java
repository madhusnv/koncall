...
public class db0 extends cb0 {
    ...
    static {
        ...
        K0 = c13274i;
        c13274i.m25699a(0, new String[]{"content_no_template"}, new int[]{13}, new int[]{p9e.content_no_template});
        ...
        sparseIntArray.put(z8e.rvTemplatesList, 17);
    }

    public db0(yt4 yt4Var, View view) {
        this(yt4Var, view, ewi.m25671L(yt4Var, view, 18, K0, L0));
    }
    ...
    public final boolean n0(l44 l44Var, int i) {
        if (i != 0) {
            return false;
        }
        synchronized (this) {
    ...
    public db0(yt4 yt4Var, View view, Object[] objArr) {
        super(yt4Var, view, 1, (l44) objArr[13], (MaterialTextView) objArr[16], (RecyclerView) objArr[15], (RecyclerView) objArr[17], (ShimmerFrameLayout) objArr[14]);
        this.J0 = -1L;
        m25693Z(this.n0);
