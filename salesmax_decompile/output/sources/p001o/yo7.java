...
public abstract class yo7 {
    /* renamed from: c */
    public static final void m58051c(cp7.C12719a c12719a, byte[] bArr) {
        i89 i89Var = new i89(bArr);
        h7f h7fVar = new h7f(aff.C12164k.f14623a, new na9("Credentials"));
        h7f h7fVar2 = new h7f(aff.C12163j.f14622a, new na9("IdentityId"));
        ...
        while (true) {
            ...
            if (numMo23583m != null && numMo23583m.intValue() == iM29946a) {
                c12719a.m21571e(kc4.m35390a(i89Var));
            } else {
                int iM29946a2 = h7fVar2.m29946a();
                if (numMo23583m != null && numMo23583m.intValue() == iM29946a2) {
                    c12719a.m21572f(interfaceC12997cMo23579h.mo31726i());
    ...
    */
    public static final Void m58052d(jl6 jl6Var, o18 o18Var, byte[] bArr) throws Throwable {
        Throwable fg3Var;
            ...
            if (strMo18271a != null) {
                switch (strMo18271a.hashCode()) {
                    ...
                    case -859985393:
                        ...
                        break;
                    case -375455030:
                        if (strMo18271a.equals("InvalidIdentityPoolConfigurationException")) {
                            fg3Var = new or8().mo16296b(jl6Var, o18VarM41344c, bArr);
                            break;
                        }
                        break;
                    case 504305508:
