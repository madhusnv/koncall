...
public class wv1 extends vv1 {
    ...
    static {
        ...
        sparseIntArray.put(z8e.callOutcomeDefinitionList, 14);
        sparseIntArray.put(z8e.fabCreateCallOutcomeDefinition, 15);
    }

    public wv1(yt4 yt4Var, View view) {
    ...
    public wv1(yt4 yt4Var, View view, Object[] objArr) {
        super(yt4Var, view, 0, (RecyclerView) objArr[14], (FloatingActionButton) objArr[15], (ShapeableImageView) objArr[12], (MaterialCardView) objArr[11], (ShimmerFrameLayout) objArr[13]);
        this.E0 = -1L;
