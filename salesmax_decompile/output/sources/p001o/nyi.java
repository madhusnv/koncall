...
public class nyi extends myi {
    ...
    public nyi(yt4 yt4Var, View view) {
    ...
    public nyi(yt4 yt4Var, View view, Object[] objArr) {
        super(yt4Var, view, 0, (View) objArr[4], (ShapeableImageView) objArr[1], (MaterialTextView) objArr[2], (MaterialTextView) objArr[3]);
        this.s0 = -1L;
