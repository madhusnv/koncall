...
public final class ixf extends hxf {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ixf(uxf uxfVar) {
        super(uxfVar);
    ...
    public /* bridge */ /* synthetic */ boolean add(Object obj) {
        return ((Boolean) m32888j(obj)).booleanValue();
    }

    @Override // java.util.Set, java.util.Collection
    public /* bridge */ /* synthetic */ boolean addAll(Collection collection) {
        return ((Boolean) m32889n(collection)).booleanValue();
    }

    @Override // java.util.Set, java.util.Collection
    public boolean contains(Object obj) {
        return m31268d().containsValue(obj);
    }
    ...
    public boolean containsAll(Collection collection) {
        ...
        while (it.hasNext()) {
            if (!m31268d().containsValue(it.next())) {
                return false;
            }
        }
        return true;
    ...
    /* renamed from: j */
    public Void m32888j(Object obj) {
        vxf.m53589b();
        throw new qe9();
    }

    /* renamed from: n */
    public Void m32889n(Collection collection) {
        sq8.m48649h(collection, "elements");
        vxf.m53589b();
        throw new qe9();
    }
    ...
    public c5g iterator() {
        return new c5g(m31268d(), ((qf8) m31268d().m52109f().m52113i().entrySet()).iterator());
    }

    @Override // java.util.Set, java.util.Collection
    public boolean remove(Object obj) {
        return m31268d().m52112k(obj);
    }
