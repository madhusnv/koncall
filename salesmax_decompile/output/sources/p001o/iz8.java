...
import ai.salesmax.model.Field;
...
public class iz8 extends hz8 implements jbc.InterfaceC14485a {
    ...
    public iz8(yt4 yt4Var, View view) {
    ...
    public final void mo16294c(int i, View view) {
        if (i == 1) {
            ...
            Integer num = this.p0;
            if (ck6Var != null) {
                ck6Var.mo708b(view, num.intValue(), field);
                return;
            }
            return;
        }
        ...
        ck6 ck6Var2 = this.q0;
        Field field2 = this.o0;
        Integer num2 = this.p0;
        if (ck6Var2 != null) {
            ck6Var2.mo708b(view, num2.intValue(), field2);
        }
    }
    ...
    public void mo16295p() {
        ...
        Field field = this.o0;
        long j2 = 10 & j;
        String fieldName = (j2 == 0 || field == null) ? null : field.getFieldName();
        if ((j & 8) != 0) {
            this.n0.setOnClickListener(this.t0);
            this.r0.setOnClickListener(this.u0);
        }
        if (j2 != 0) {
            fjh.m26938c(this.s0, fieldName);
        }
    }

    public iz8(yt4 yt4Var, View view, Object[] objArr) {
