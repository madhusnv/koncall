...
public class la0 extends ka0 {
    ...
    static {
        ...
        sparseIntArray.put(z8e.formDefinitionList, 4);
        sparseIntArray.put(z8e.fabCreateFormDefinition, 5);
    }

    public la0(yt4 yt4Var, View view) {
    ...
    public la0(yt4 yt4Var, View view, Object[] objArr) {
