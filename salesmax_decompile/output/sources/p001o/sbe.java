...
public abstract class sbe {
    ...
    public static int Base_Superfone_colorBorder = 0;
    public static int Base_Superfone_colorLightBackground = 1;
    public static int Base_Superfone_colorStroke = 2;
    public static int Base_Superfone_colorTextPrimary = 3;
    ...
    /* renamed from: CastDeviceChooserDialog_castDeviceChooserDialogSecondaryTextTextAppearance */
    public static int f45145xdb007bd5 = 0;

    /* renamed from: CastDeviceChooserDialog_castDeviceChooserDialogTitleTextAppearance */
    public static int f45146x18f52c2c = 1;
    ...
    public static int f45147xcb1f8bb1 = 11;
    ...
    public static int ColorArcProgressBar_back_width = 1;
    public static int ColorArcProgressBar_current_value = 2;
    public static int ColorArcProgressBar_front_color1 = 3;
    public static int ColorArcProgressBar_front_color2 = 4;
    public static int ColorArcProgressBar_front_color3 = 5;
    public static int ColorArcProgressBar_front_color4 = 6;
    public static int ColorArcProgressBar_front_width = 7;
    public static int ColorArcProgressBar_is_need_content = 8;
    public static int ColorArcProgressBar_is_need_dial = 9;
    public static int ColorArcProgressBar_is_need_title = 10;
    public static int ColorArcProgressBar_is_need_unit = 11;
    public static int ColorArcProgressBar_max_value = 12;
    public static int ColorArcProgressBar_string_title = 13;
    public static int ColorArcProgressBar_string_unit = 14;
    public static int ColorArcProgressBar_total_angle = 15;
    ...
    public static int CountryCodePicker_ccpDialog_rippleEnable = 9;
    public static int CountryCodePicker_ccpDialog_searchEditTextTint = 10;
    public static int CountryCodePicker_ccpDialog_showCloseIcon = 11;
    public static int CountryCodePicker_ccpDialog_showFastScroller = 12;
    public static int CountryCodePicker_ccpDialog_showFlag = 13;
    public static int CountryCodePicker_ccpDialog_showNameCode = 14;
    public static int CountryCodePicker_ccpDialog_showPhoneCode = 15;
    public static int CountryCodePicker_ccpDialog_showTitle = 16;
    public static int CountryCodePicker_ccpDialog_textColor = 17;
    public static int CountryCodePicker_ccp_areaCodeDetectedCountry = 18;
    public static int CountryCodePicker_ccp_arrowColor = 19;
    public static int CountryCodePicker_ccp_arrowSize = 20;
    public static int CountryCodePicker_ccp_autoDetectCountry = 21;
    public static int CountryCodePicker_ccp_autoDetectLanguage = 22;
    public static int CountryCodePicker_ccp_autoFormatNumber = 23;
    public static int CountryCodePicker_ccp_clickable = 24;
    public static int CountryCodePicker_ccp_contentColor = 25;
    public static int CountryCodePicker_ccp_countryAutoDetectionPref = 26;
    public static int CountryCodePicker_ccp_countryPreference = 27;
    public static int CountryCodePicker_ccp_customMasterCountries = 28;
    public static int CountryCodePicker_ccp_defaultLanguage = 29;
    public static int CountryCodePicker_ccp_defaultNameCode = 30;
    public static int CountryCodePicker_ccp_defaultPhoneCode = 31;
    public static int CountryCodePicker_ccp_excludedCountries = 32;
    public static int CountryCodePicker_ccp_flagBorderColor = 33;
    public static int CountryCodePicker_ccp_hintExampleNumber = 34;
    public static int CountryCodePicker_ccp_hintExampleNumberType = 35;
    public static int CountryCodePicker_ccp_internationalFormattingOnly = 36;
    public static int CountryCodePicker_ccp_padding = 37;
    public static int CountryCodePicker_ccp_rememberLastSelection = 38;
    public static int CountryCodePicker_ccp_rippleEnable = 39;
    public static int CountryCodePicker_ccp_selectionMemoryTag = 40;
    public static int CountryCodePicker_ccp_showArrow = 41;
    public static int CountryCodePicker_ccp_showFlag = 42;
    public static int CountryCodePicker_ccp_showFullName = 43;
    public static int CountryCodePicker_ccp_showNameCode = 44;
    public static int CountryCodePicker_ccp_showPhoneCode = 45;
    public static int CountryCodePicker_ccp_textGravity = 46;
    public static int CountryCodePicker_ccp_textSize = 47;
    public static int CountryCodePicker_ccp_useDummyEmojiForPreview = 48;
    public static int CountryCodePicker_ccp_useFlagEmoji = 49;
    ...
    public static int CustomCastTheme_castDeviceChooserDialogStyle = 0;
    public static int CustomCastTheme_castExpandedControllerStyle = 1;
    public static int CustomCastTheme_castIntroOverlayStyle = 2;
    public static int CustomCastTheme_castMiniControllerStyle = 3;
    ...
    public static int f45150x374ba37a = 1;
    ...
    public static int f45151x19991881 = 3;
    ...
    public static int PinViewTheme_pinViewStyle = 0;
    public static int PinView_android_cursorVisible = 1;
    public static int PinView_android_itemBackground = 0;
    public static int PinView_cursorColor = 2;
    public static int PinView_cursorWidth = 3;
    public static int PinView_hideLineWhenFilled = 4;
    public static int PinView_itemCount = 5;
    public static int PinView_itemHeight = 6;
    public static int PinView_itemRadius = 7;
    public static int PinView_itemSpacing = 8;
    public static int PinView_itemWidth = 9;
    public static int PinView_lineColor = 10;
    public static int PinView_lineWidth = 11;
    public static int PinView_viewType = 12;
    ...
    public static int f45152xaa980688 = 0;
    ...
    public static int VerticalStepperFormView_form_allow_non_linear_navigation = 0;
    public static int VerticalStepperFormView_form_allow_step_opening_on_header_click = 1;
    public static int VerticalStepperFormView_form_alpha_of_disabled_elements = 2;
    public static int VerticalStepperFormView_form_bottom_navigation_background_color = 3;
    public static int VerticalStepperFormView_form_cancel_button_background_color = 4;

    /* renamed from: VerticalStepperFormView_form_cancel_button_pressed_background_color */
    public static int f45153xd2684357 = 5;
    public static int VerticalStepperFormView_form_cancel_button_pressed_text_color = 6;
    public static int VerticalStepperFormView_form_cancel_button_text = 7;
    public static int VerticalStepperFormView_form_cancel_button_text_color = 8;
    public static int VerticalStepperFormView_form_circle_background_color = 9;
    public static int VerticalStepperFormView_form_circle_completed_background_color = 10;
    public static int VerticalStepperFormView_form_circle_error_background_color = 11;
    public static int VerticalStepperFormView_form_circle_size = 12;
    public static int VerticalStepperFormView_form_circle_text_color = 13;
    public static int VerticalStepperFormView_form_circle_text_size = 14;
    public static int VerticalStepperFormView_form_close_last_step_on_completion = 15;
    public static int VerticalStepperFormView_form_confirmation_step_subtitle_text = 16;
    public static int VerticalStepperFormView_form_confirmation_step_title_text = 17;
    public static int VerticalStepperFormView_form_disabled_elements_background_color = 18;
    public static int VerticalStepperFormView_form_display_bottom_navigation = 19;
    public static int VerticalStepperFormView_form_display_cancel_button_in_last_step = 20;

    /* renamed from: VerticalStepperFormView_form_display_different_background_color_on_disabled_elements */
    public static int f45154x839f37e4 = 21;
    public static int VerticalStepperFormView_form_display_next_button_in_last_step = 22;
    public static int VerticalStepperFormView_form_display_step_buttons = 23;

    /* renamed from: VerticalStepperFormView_form_display_step_data_in_subtitle_of_closed_steps */
    public static int f45155xdfddd0d0 = 24;
    public static int VerticalStepperFormView_form_error_message_text_color = 25;
    public static int VerticalStepperFormView_form_error_message_text_size = 26;

    /* renamed from: VerticalStepperFormView_form_horizontal_margin_from_step_numbers_to_content */
    public static int f45156x3538fdfe = 27;
    public static int VerticalStepperFormView_form_include_confirmation_step = 28;
    public static int VerticalStepperFormView_form_last_button_text = 29;
    public static int VerticalStepperFormView_form_next_button_background_color = 30;

    /* renamed from: VerticalStepperFormView_form_next_button_pressed_background_color */
    public static int f45157x3df443d0 = 31;
    public static int VerticalStepperFormView_form_next_button_pressed_text_color = 32;
    public static int VerticalStepperFormView_form_next_button_text = 33;
    public static int VerticalStepperFormView_form_next_button_text_color = 34;
    public static int VerticalStepperFormView_form_step_error_message_font_family = 35;
    public static int VerticalStepperFormView_form_step_number_font_family = 36;
    public static int VerticalStepperFormView_form_step_subtitle_font_family = 37;
    public static int VerticalStepperFormView_form_step_title_font_family = 38;
    public static int VerticalStepperFormView_form_subtitle_text_color = 39;
    public static int VerticalStepperFormView_form_subtitle_text_size = 40;
    public static int VerticalStepperFormView_form_title_text_color = 41;
    public static int VerticalStepperFormView_form_title_text_size = 42;
    public static int VerticalStepperFormView_form_vertical_line_width = 43;
    public static int ViewBackgroundHelper_android_background = 0;
    public static int ViewBackgroundHelper_backgroundTint = 1;
    public static int ViewBackgroundHelper_backgroundTintMode = 2;
    public static int ViewMultipleContact_superfone_mutiplecontact_data_clickable = 0;
    public static int ViewMultipleContact_superfone_mutiplecontact_data_icon = 1;
    public static int ViewMultipleContact_superfone_mutiplecontact_data_value = 2;
    public static int ViewPager2_android_orientation = 0;
    public static int ViewProfileDataVer2_superfone_profile_data_ver2_clickable = 0;
    public static int ViewProfileDataVer2_superfone_profile_data_ver2_icon = 1;
    public static int ViewProfileDataVer2_superfone_profile_data_ver2_icon_remove = 2;
    public static int ViewProfileDataVer2_superfone_profile_data_ver2_title = 3;
    public static int ViewProfileDataVer2_superfone_profile_data_ver2_value = 4;
    public static int ViewProfileData_superfone_profile_data_clickable = 0;
    public static int ViewProfileData_superfone_profile_data_icon = 1;
    public static int ViewProfileData_superfone_profile_data_title = 2;
    public static int ViewProfileData_superfone_profile_data_value = 3;
    public static int ViewProgressCard_superfone_progress_card_color = 0;
    public static int ViewProgressCard_superfone_progress_card_has_new = 1;
    public static int ViewProgressCard_superfone_progress_card_icon = 2;
    public static int ViewProgressCard_superfone_progress_card_percent = 3;
    public static int ViewProgressCard_superfone_progress_card_subTitle = 4;
    public static int ViewProgressCard_superfone_progress_card_title = 5;
    ...
    public static int attrs_currency_currencyCode = 0;
    ...
    public static int[] CastDeviceChooserDialog = {R.attr.castDeviceChooserDialogSecondaryTextTextAppearance, R.attr.castDeviceChooserDialogTitleTextAppearance};
    ...
    public static int[] CircularProgressIndicator = {R.attr.indeterminateAnimationTypeCircular, R.attr.indeterminateTrackVisible, R.attr.indicatorDirectionCircular, R.attr.indicatorInset, R.attr.indicatorSize};
    ...
    public static int[] CollapsingToolbarLayout = {R.attr.collapsedSubtitleTextAppearance, R.attr.collapsedSubtitleTextColor, R.attr.collapsedTitleGravity, R.attr.collapsedTitleTextAppearance, R.attr.collapsedTitleTextColor, R.attr.contentScrim, R.attr.expandedSubtitleTextAppearance, R.attr.expandedSubtitleTextColor, R.attr.expandedTitleGravity, R.attr.expandedTitleMargin, R.attr.expandedTitleMarginBottom, R.attr.expandedTitleMarginEnd, R.attr.expandedTitleMarginStart, R.attr.expandedTitleMarginTop, R.attr.expandedTitleSpacing, R.attr.expandedTitleTextAppearance, R.attr.expandedTitleTextColor, R.attr.extraMultilineHeightEnabled, R.attr.forceApplySystemWindowInsetTop, R.attr.maxLines, R.attr.scrimAnimationDuration, R.attr.scrimVisibleHeightTrigger, R.attr.statusBarScrim, R.attr.subtitle, R.attr.subtitleMaxLines, R.attr.title, R.attr.titleCollapseMode, R.attr.titleEnabled, R.attr.titleMaxLines, R.attr.titlePositionInterpolator, R.attr.titleTextEllipsize, R.attr.toolbarId};
    public static int[] CollapsingToolbarLayout_Layout = {R.attr.layout_collapseMode, R.attr.layout_collapseParallaxMultiplier};
    public static int[] ColorArcProgressBar = {R.attr.back_color, R.attr.back_width, R.attr.current_value, R.attr.front_color1, R.attr.front_color2, R.attr.front_color3, R.attr.front_color4, R.attr.front_width, R.attr.is_need_content, R.attr.is_need_dial, R.attr.is_need_title, R.attr.is_need_unit, R.attr.max_value, R.attr.string_title, R.attr.string_unit, R.attr.total_angle};
    ...
    public static int[] CustomCastTheme = {R.attr.castDeviceChooserDialogStyle, R.attr.castExpandedControllerStyle, R.attr.castIntroOverlayStyle, R.attr.castMiniControllerStyle};
    ...
    public static int[] DockedToolbar = {R.attr.backgroundTint, R.attr.paddingBottomSystemWindowInsets, R.attr.paddingTopSystemWindowInsets};
    ...
    public static int[] FloatingToolbar = {R.attr.backgroundTint, R.attr.marginBottomSystemWindowInsets, R.attr.marginLeftSystemWindowInsets, R.attr.marginRightSystemWindowInsets, R.attr.marginTopSystemWindowInsets};
    ...
    public static int[] Grid = {R.attr.grid_columnWeights, R.attr.grid_columns, R.attr.grid_horizontalGaps, R.attr.grid_orientation, R.attr.grid_rowWeights, R.attr.grid_rows, R.attr.grid_skips, R.attr.grid_spans, R.attr.grid_useRtl, R.attr.grid_validateInputs, R.attr.grid_verticalGaps};
    ...
    public static int[] LinearProgressIndicator = {R.attr.indeterminateAnimationType, R.attr.indicatorDirectionLinear, R.attr.trackInnerCornerRadius, R.attr.trackStopIndicatorPadding, R.attr.trackStopIndicatorSize};
    ...
    public static int[] LoadingIndicator = {R.attr.containerColor, R.attr.containerHeight, R.attr.containerWidth, R.attr.indicatorColor, R.attr.indicatorSize};
    public static int[] LottieAnimationView = {R.attr.lottie_autoPlay, R.attr.lottie_cacheComposition, R.attr.lottie_colorFilter, R.attr.lottie_enableMergePathsForKitKatAndAbove, R.attr.lottie_fallbackRes, R.attr.lottie_fileName, R.attr.lottie_ignoreDisabledSystemAnimations, R.attr.lottie_imageAssetsFolder, R.attr.lottie_loop, R.attr.lottie_progress, R.attr.lottie_rawRes, R.attr.lottie_renderMode, R.attr.lottie_repeatCount, R.attr.lottie_repeatMode, R.attr.lottie_scale, R.attr.lottie_speed, R.attr.lottie_url};
    ...
    public static int[] MaterialButtonGroup = {android.R.attr.enabled, android.R.attr.spacing, R.attr.buttonSizeChange, R.attr.innerCornerSize, R.attr.shapeAppearance, R.attr.shapeAppearanceOverlay};
    ...
    public static int[] MaterialIntroView = new int[0];
    ...
    public static int[] MaterialSpring = {R.attr.damping, R.attr.stiffness};
    ...
    public static int[] MediaRouteButton = {android.R.attr.minWidth, android.R.attr.minHeight, R.attr.externalRouteEnabledDrawable, R.attr.externalRouteEnabledDrawableStatic, R.attr.mediaRouteButtonTint};
    ...
    public static int[] NavHostFragment = {R.attr.defaultNavHost};
    public static int[] NavInclude = {R.attr.graph};
    public static int[] NavigationBarActiveIndicator = {android.R.attr.height, android.R.attr.width, android.R.attr.color, R.attr.expandedActiveIndicatorPaddingBottom, R.attr.expandedActiveIndicatorPaddingEnd, R.attr.expandedActiveIndicatorPaddingStart, R.attr.expandedActiveIndicatorPaddingTop, R.attr.expandedHeight, R.attr.expandedMarginHorizontal, R.attr.expandedWidth, R.attr.marginHorizontal, R.attr.shapeAppearance};
    public static int[] NavigationBarView = {R.attr.activeIndicatorLabelPadding, R.attr.backgroundTint, R.attr.elevation, R.attr.horizontalItemTextAppearanceActive, R.attr.horizontalItemTextAppearanceInactive, R.attr.iconLabelHorizontalSpacing, R.attr.itemActiveIndicatorStyle, R.attr.itemBackground, R.attr.itemGravity, R.attr.itemIconGravity, R.attr.itemIconSize, R.attr.itemIconTint, R.attr.itemPaddingBottom, R.attr.itemPaddingTop, R.attr.itemRippleColor, R.attr.itemTextAppearanceActive, R.attr.itemTextAppearanceActiveBoldEnabled, R.attr.itemTextAppearanceInactive, R.attr.itemTextColor, R.attr.labelFontScalingEnabled, R.attr.labelMaxLines, R.attr.labelVisibilityMode, R.attr.measureBottomPaddingFromLabelBaseline, R.attr.menu};
    public static int[] NavigationRailView = {R.attr.collapsedItemMinHeight, R.attr.contentMarginTop, R.attr.expanded, R.attr.expandedItemMinHeight, R.attr.expandedMaxWidth, R.attr.expandedMinWidth, R.attr.headerLayout, R.attr.headerMarginBottom, R.attr.itemMinHeight, R.attr.itemSpacing, R.attr.menuGravity, R.attr.paddingBottomSystemWindowInsets, R.attr.paddingStartSystemWindowInsets, R.attr.paddingTopSystemWindowInsets, R.attr.scrollingEnabled, R.attr.shapeAppearance, R.attr.shapeAppearanceOverlay, R.attr.submenuDividersEnabled};
    ...
    public static int[] PinView = {android.R.attr.itemBackground, android.R.attr.cursorVisible, R.attr.cursorColor, R.attr.cursorWidth, R.attr.hideLineWhenFilled, R.attr.itemCount, R.attr.itemHeight, R.attr.itemRadius, R.attr.itemSpacing, R.attr.itemWidth, R.attr.lineColor, R.attr.lineWidth, R.attr.viewType};
    public static int[] PinViewTheme = {R.attr.pinViewStyle};
    ...
    public static int[] StateListSizeChange = {R.attr.widthChange};
    ...
    public static int[] VerticalStepperFormView = {R.attr.form_allow_non_linear_navigation, R.attr.form_allow_step_opening_on_header_click, R.attr.form_alpha_of_disabled_elements, R.attr.form_bottom_navigation_background_color, R.attr.form_cancel_button_background_color, R.attr.form_cancel_button_pressed_background_color, R.attr.form_cancel_button_pressed_text_color, R.attr.form_cancel_button_text, R.attr.form_cancel_button_text_color, R.attr.form_circle_background_color, R.attr.form_circle_completed_background_color, R.attr.form_circle_error_background_color, R.attr.form_circle_size, R.attr.form_circle_text_color, R.attr.form_circle_text_size, R.attr.form_close_last_step_on_completion, R.attr.form_confirmation_step_subtitle_text, R.attr.form_confirmation_step_title_text, R.attr.form_disabled_elements_background_color, R.attr.form_display_bottom_navigation, R.attr.form_display_cancel_button_in_last_step, R.attr.form_display_different_background_color_on_disabled_elements, R.attr.form_display_next_button_in_last_step, R.attr.form_display_step_buttons, R.attr.form_display_step_data_in_subtitle_of_closed_steps, R.attr.form_error_message_text_color, R.attr.form_error_message_text_size, R.attr.form_horizontal_margin_from_step_numbers_to_content, R.attr.form_include_confirmation_step, R.attr.form_last_button_text, R.attr.form_next_button_background_color, R.attr.form_next_button_pressed_background_color, R.attr.form_next_button_pressed_text_color, R.attr.form_next_button_text, R.attr.form_next_button_text_color, R.attr.form_step_error_message_font_family, R.attr.form_step_number_font_family, R.attr.form_step_subtitle_font_family, R.attr.form_step_title_font_family, R.attr.form_subtitle_text_color, R.attr.form_subtitle_text_size, R.attr.form_title_text_color, R.attr.form_title_text_size, R.attr.form_vertical_line_width};
    ...
    public static int[] ViewMultipleContact = {R.attr.superfone_mutiplecontact_data_clickable, R.attr.superfone_mutiplecontact_data_icon, R.attr.superfone_mutiplecontact_data_value};
    public static int[] ViewPager2 = {android.R.attr.orientation};
    public static int[] ViewProfileData = {R.attr.superfone_profile_data_clickable, R.attr.superfone_profile_data_icon, R.attr.superfone_profile_data_title, R.attr.superfone_profile_data_value};
    public static int[] ViewProfileDataVer2 = {R.attr.superfone_profile_data_ver2_clickable, R.attr.superfone_profile_data_ver2_icon, R.attr.superfone_profile_data_ver2_icon_remove, R.attr.superfone_profile_data_ver2_title, R.attr.superfone_profile_data_ver2_value};
    public static int[] ViewProgressCard = {R.attr.superfone_progress_card_color, R.attr.superfone_progress_card_has_new, R.attr.superfone_progress_card_icon, R.attr.superfone_progress_card_percent, R.attr.superfone_progress_card_subTitle, R.attr.superfone_progress_card_title};
    ...
    public static int[] attrs_currency = {R.attr.currencyCode};
    ...
    public static int[] fastscroll__fastScroller = {R.attr.fastscroll__bubbleColor, R.attr.fastscroll__bubbleTextAppearance, R.attr.fastscroll__handleColor};
