...
public abstract class yq0 {
    /* renamed from: c */
    public static final void m58072c(cr0.C12726a c12726a, byte[] bArr) {
        i89 i89Var = new i89(bArr);
        aff.C12163j c12163j = aff.C12163j.f14622a;
        h7f h7fVar = new h7f(c12163j, new na9("SecretCode"));
        ...
        while (true) {
            ...
            if (numMo23583m != null && numMo23583m.intValue() == iM29946a) {
                c12726a.m21601e(interfaceC12997cMo23579h.mo31726i());
            } else {
                int iM29946a2 = h7fVar2.m29946a();
                if (numMo23583m != null && numMo23583m.intValue() == iM29946a2) {
                    c12726a.m21602f(interfaceC12997cMo23579h.mo31726i());
    ...
    */
    public static final Void m58073d(jl6 jl6Var, o18 o18Var, byte[] bArr) throws Throwable {
        Throwable ng3Var;
        ...
        try {
            ...
            if (strMo18271a != null) {
                switch (strMo18271a.hashCode()) {
                    case -2005002116:
                        if (!strMo18271a.equals("ConcurrentModificationException")) {
                            ng3Var = new ng3(ij6VarM32630a.getMessage());
                            break;
                        } else {
                            ng3Var = new gq3().mo16296b(jl6Var, o18VarM41344c, bArr);
                            break;
                        }
                    case -1416998079:
