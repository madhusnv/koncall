...
public final class PaymentOrderSummary$createdBy$1 extends kf9 implements xk7 {
    final /* synthetic */ PaymentOrderSummary this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PaymentOrderSummary$createdBy$1(PaymentOrderSummary paymentOrderSummary) {
        super(1);
    ...
    public final void invoke(LeadsUser leadsUser) {
        ...
        PaymentOrder paymentOrderBuild = paymentOrderSummary.getUnderlyingPaymentOrder().copyOfBuilder().createdById(leadsUser.getId()).build();
