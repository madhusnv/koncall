...
public final class PaymentDataSummary$createdBy$1 extends kf9 implements xk7 {
    final /* synthetic */ PaymentDataSummary this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PaymentDataSummary$createdBy$1(PaymentDataSummary paymentDataSummary) {
        super(1);
    ...
    public final void invoke(LeadsUser leadsUser) {
        ...
        PaymentData paymentDataBuild = paymentDataSummary.getUnderlyingPaymentData().copyOfBuilder().createdById(leadsUser.getId()).build();
