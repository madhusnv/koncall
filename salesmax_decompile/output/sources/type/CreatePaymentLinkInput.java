...
public final class CreatePaymentLinkInput implements InputType {
    ...
    public InputFieldMarshaller marshaller() {
        return new InputFieldMarshaller() { // from class: type.CreatePaymentLinkInput.1
            /* JADX WARN: Multi-variable type inference failed */
            @Override // com.apollographql.apollo.api.InputFieldMarshaller
            public void marshal(InputFieldWriter inputFieldWriter) {
                if (CreatePaymentLinkInput.this.id.defined) {
                    inputFieldWriter.writeString(OutcomeConstants.OUTCOME_ID, (String) CreatePaymentLinkInput.this.id.value);
                }
                inputFieldWriter.writeString("accountId", CreatePaymentLinkInput.this.accountId);
                if (CreatePaymentLinkInput.this.contactId.defined) {
                    inputFieldWriter.writeString("contactId", (String) CreatePaymentLinkInput.this.contactId.value);
                }
                if (CreatePaymentLinkInput.this.paymentProvider.defined) {
                    inputFieldWriter.writeString("paymentProvider", (String) CreatePaymentLinkInput.this.paymentProvider.value);
                }
                if (CreatePaymentLinkInput.this.idInPaymentProvider.defined) {
                    inputFieldWriter.writeString("idInPaymentProvider", (String) CreatePaymentLinkInput.this.idInPaymentProvider.value);
                }
                if (CreatePaymentLinkInput.this.orderId.defined) {
                    inputFieldWriter.writeString("orderId", (String) CreatePaymentLinkInput.this.orderId.value);
                }
                if (CreatePaymentLinkInput.this.acceptPartial.defined) {
                    inputFieldWriter.writeBoolean("acceptPartial", (Boolean) CreatePaymentLinkInput.this.acceptPartial.value);
                }
                if (CreatePaymentLinkInput.this.firstMinPartialAmount.defined) {
                    inputFieldWriter.writeInt("firstMinPartialAmount", (Integer) CreatePaymentLinkInput.this.firstMinPartialAmount.value);
                }
                if (CreatePaymentLinkInput.this.currency.defined) {
                    inputFieldWriter.writeString(FirebaseAnalytics.Param.CURRENCY, (String) CreatePaymentLinkInput.this.currency.value);
                }
                if (CreatePaymentLinkInput.this.amount.defined) {
                    inputFieldWriter.writeInt("amount", (Integer) CreatePaymentLinkInput.this.amount.value);
                }
                if (CreatePaymentLinkInput.this.amountPaid.defined) {
                    inputFieldWriter.writeInt("amountPaid", (Integer) CreatePaymentLinkInput.this.amountPaid.value);
                }
                if (CreatePaymentLinkInput.this.description.defined) {
                    inputFieldWriter.writeString(MediaTrack.ROLE_DESCRIPTION, (String) CreatePaymentLinkInput.this.description.value);
                }
                if (CreatePaymentLinkInput.this.note.defined) {
                    inputFieldWriter.writeString("note", (String) CreatePaymentLinkInput.this.note.value);
                }
                if (CreatePaymentLinkInput.this.shortUrl.defined) {
                    inputFieldWriter.writeString("shortUrl", (String) CreatePaymentLinkInput.this.shortUrl.value);
                }
                if (CreatePaymentLinkInput.this.upiLink.defined) {
                    inputFieldWriter.writeString("upiLink", (String) CreatePaymentLinkInput.this.upiLink.value);
                }
                if (CreatePaymentLinkInput.this.status.defined) {
                    inputFieldWriter.writeString("status", (String) CreatePaymentLinkInput.this.status.value);
                }
                if (CreatePaymentLinkInput.this.expireBy.defined) {
                    inputFieldWriter.writeString("expireBy", (String) CreatePaymentLinkInput.this.expireBy.value);
                }
                if (CreatePaymentLinkInput.this.expiredAt.defined) {
                    inputFieldWriter.writeString("expiredAt", (String) CreatePaymentLinkInput.this.expiredAt.value);
                }
                if (CreatePaymentLinkInput.this.cancelledAt.defined) {
                    inputFieldWriter.writeString("cancelledAt", (String) CreatePaymentLinkInput.this.cancelledAt.value);
                }
                if (CreatePaymentLinkInput.this.createdAt.defined) {
                    inputFieldWriter.writeString("createdAt", (String) CreatePaymentLinkInput.this.createdAt.value);
                }
                if (CreatePaymentLinkInput.this.updatedAt.defined) {
                    inputFieldWriter.writeString("updatedAt", (String) CreatePaymentLinkInput.this.updatedAt.value);
                }
                if (CreatePaymentLinkInput.this.externalUserReference.defined) {
                    inputFieldWriter.writeString("externalUserReference", (String) CreatePaymentLinkInput.this.externalUserReference.value);
                }
                if (CreatePaymentLinkInput.this.createdById.defined) {
                    inputFieldWriter.writeString("createdById", (String) CreatePaymentLinkInput.this.createdById.value);
                }
                if (CreatePaymentLinkInput.this.updatedById.defined) {
                    inputFieldWriter.writeString("updatedById", (String) CreatePaymentLinkInput.this.updatedById.value);
                }
            }
        };
    }
