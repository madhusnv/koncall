...
public final class CreateDealInput implements InputType {
    ...
    public InputFieldMarshaller marshaller() {
        return new InputFieldMarshaller() { // from class: type.CreateDealInput.1
            /* JADX WARN: Multi-variable type inference failed */
            @Override // com.apollographql.apollo.api.InputFieldMarshaller
            public void marshal(InputFieldWriter inputFieldWriter) {
                if (CreateDealInput.this.id.defined) {
                    inputFieldWriter.writeString(OutcomeConstants.OUTCOME_ID, (String) CreateDealInput.this.id.value);
                }
                inputFieldWriter.writeString("accountId", CreateDealInput.this.accountId);
                if (CreateDealInput.this.name.defined) {
                    inputFieldWriter.writeString("name", (String) CreateDealInput.this.name.value);
                }
                if (CreateDealInput.this.description.defined) {
                    inputFieldWriter.writeString(MediaTrack.ROLE_DESCRIPTION, (String) CreateDealInput.this.description.value);
                }
                if (CreateDealInput.this.dealStage.defined) {
                    inputFieldWriter.writeString("dealStage", (String) CreateDealInput.this.dealStage.value);
                }
                if (CreateDealInput.this.dealStageUpdatedAt.defined) {
                    inputFieldWriter.writeString("dealStageUpdatedAt", (String) CreateDealInput.this.dealStageUpdatedAt.value);
                }
                if (CreateDealInput.this.dealState.defined) {
                    inputFieldWriter.writeString("dealState", CreateDealInput.this.dealState.value != 0 ? ((DealState) CreateDealInput.this.dealState.value).name() : null);
                }
                if (CreateDealInput.this.dealOutcome.defined) {
                    inputFieldWriter.writeString("dealOutcome", CreateDealInput.this.dealOutcome.value != 0 ? ((DealOutcome) CreateDealInput.this.dealOutcome.value).name() : null);
                }
                if (CreateDealInput.this.dealLostReason.defined) {
                    inputFieldWriter.writeString("dealLostReason", (String) CreateDealInput.this.dealLostReason.value);
                }
                if (CreateDealInput.this.amount.defined) {
                    inputFieldWriter.writeDouble("amount", (Double) CreateDealInput.this.amount.value);
                }
                if (CreateDealInput.this.currency.defined) {
                    inputFieldWriter.writeString(FirebaseAnalytics.Param.CURRENCY, (String) CreateDealInput.this.currency.value);
                }
                if (CreateDealInput.this.units.defined) {
                    inputFieldWriter.writeList("units", CreateDealInput.this.units.value != 0 ? new InputFieldWriter.ListWriter() { // from class: type.CreateDealInput.1.1
                        @Override // com.apollographql.apollo.api.InputFieldWriter.ListWriter
                        public void write(InputFieldWriter.ListItemWriter listItemWriter) {
                            Iterator it = ((List) CreateDealInput.this.units.value).iterator();
                            while (it.hasNext()) {
                ...
                if (CreateDealInput.this.createdByUser.defined) {
                    inputFieldWriter.writeString("createdByUser", (String) CreateDealInput.this.createdByUser.value);
                }
                if (CreateDealInput.this.lastUpdatedByUser.defined) {
                    inputFieldWriter.writeString("lastUpdatedByUser", (String) CreateDealInput.this.lastUpdatedByUser.value);
                }
                if (CreateDealInput.this.ownerId.defined) {
                    inputFieldWriter.writeString("ownerId", (String) CreateDealInput.this.ownerId.value);
                }
                if (CreateDealInput.this.primaryTeamId.defined) {
                    inputFieldWriter.writeString("primaryTeamId", (String) CreateDealInput.this.primaryTeamId.value);
                }
                if (CreateDealInput.this.openTaskDetail.defined) {
                    inputFieldWriter.writeString("openTaskDetail", (String) CreateDealInput.this.openTaskDetail.value);
                }
                if (CreateDealInput.this.transitionSummary.defined) {
                    inputFieldWriter.writeList("transitionSummary", CreateDealInput.this.transitionSummary.value != 0 ? new InputFieldWriter.ListWriter() { // from class: type.CreateDealInput.1.2
                        @Override // com.apollographql.apollo.api.InputFieldWriter.ListWriter
                        public void write(InputFieldWriter.ListItemWriter listItemWriter) {
                            Iterator it = ((List) CreateDealInput.this.transitionSummary.value).iterator();
                            while (it.hasNext()) {
                ...
                if (CreateDealInput.this.recentEngagements.defined) {
                    inputFieldWriter.writeList("recentEngagements", CreateDealInput.this.recentEngagements.value != 0 ? new InputFieldWriter.ListWriter() { // from class: type.CreateDealInput.1.3
                        @Override // com.apollographql.apollo.api.InputFieldWriter.ListWriter
                        public void write(InputFieldWriter.ListItemWriter listItemWriter) {
                            Iterator it = ((List) CreateDealInput.this.recentEngagements.value).iterator();
                            while (it.hasNext()) {
                                listItemWriter.writeCustom(CustomType.AWSJSON, (String) it.next());
                            }
                        }
                ...
                if (CreateDealInput.this.recentEngagementsUpdatedAt.defined) {
                    inputFieldWriter.writeString("recentEngagementsUpdatedAt", (String) CreateDealInput.this.recentEngagementsUpdatedAt.value);
                }
                if (CreateDealInput.this.lastActivity.defined) {
                    inputFieldWriter.writeString("lastActivity", (String) CreateDealInput.this.lastActivity.value);
                }
                if (CreateDealInput.this.tags.defined) {
                    inputFieldWriter.writeList("tags", CreateDealInput.this.tags.value != 0 ? new InputFieldWriter.ListWriter() { // from class: type.CreateDealInput.1.4
                        @Override // com.apollographql.apollo.api.InputFieldWriter.ListWriter
                        public void write(InputFieldWriter.ListItemWriter listItemWriter) {
                            Iterator it = ((List) CreateDealInput.this.tags.value).iterator();
                            while (it.hasNext()) {
                ...
                if (CreateDealInput.this.dealStageCustomValues.defined) {
                    inputFieldWriter.writeList("dealStageCustomValues", CreateDealInput.this.dealStageCustomValues.value != 0 ? new InputFieldWriter.ListWriter() { // from class: type.CreateDealInput.1.5
                        @Override // com.apollographql.apollo.api.InputFieldWriter.ListWriter
                        public void write(InputFieldWriter.ListItemWriter listItemWriter) {
                            Iterator it = ((List) CreateDealInput.this.dealStageCustomValues.value).iterator();
                            while (it.hasNext()) {
                ...
                if (CreateDealInput.this.customDealData.defined) {
                    inputFieldWriter.writeString("customDealData", (String) CreateDealInput.this.customDealData.value);
                }
                if (CreateDealInput.this.createdAt.defined) {
                    inputFieldWriter.writeString("createdAt", (String) CreateDealInput.this.createdAt.value);
                }
                if (CreateDealInput.this.updatedAt.defined) {
                    inputFieldWriter.writeString("updatedAt", (String) CreateDealInput.this.updatedAt.value);
                }
            }
        };
    }
