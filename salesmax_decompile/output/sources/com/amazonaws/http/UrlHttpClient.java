...
public class UrlHttpClient implements HttpClient {
    ...
    public HttpURLConnection applyHeadersAndMethod(HttpRequest httpRequest, HttpURLConnection httpURLConnection) {
        return applyHeadersAndMethod(httpRequest, httpURLConnection, null);
    }

    public void configureConnection(HttpRequest httpRequest, HttpURLConnection httpURLConnection) throws NoSuchAlgorithmException, KeyManagementException {
    ...
    public void writeContentToConnection(HttpRequest httpRequest, HttpURLConnection httpURLConnection, CurlBuilder curlBuilder) throws IOException {
        ...
        if (curlBuilder != null && byteBufferAllocate != null && byteBufferAllocate.position() != 0) {
            curlBuilder.setContent(new String(byteBufferAllocate.array(), HTTP.UTF_8));
        }
        outputStream.flush();
        outputStream.close();
    }
