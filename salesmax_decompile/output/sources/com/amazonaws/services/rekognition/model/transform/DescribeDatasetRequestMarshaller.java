...
public class DescribeDatasetRequestMarshaller implements Marshaller<Request<DescribeDatasetRequest>, DescribeDatasetRequest> {
    ...
    public Request<DescribeDatasetRequest> marshall(DescribeDatasetRequest describeDatasetRequest) {
        ...
        DefaultRequest defaultRequest = new DefaultRequest(describeDatasetRequest, "AmazonRekognition");
        defaultRequest.addHeader("X-Amz-Target", "RekognitionService.DescribeDataset");
        ...
        try {
            ...
            if (describeDatasetRequest.getDatasetArn() != null) {
                String datasetArn = describeDatasetRequest.getDatasetArn();
