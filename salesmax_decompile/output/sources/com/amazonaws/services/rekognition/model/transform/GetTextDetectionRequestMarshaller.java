...
public class GetTextDetectionRequestMarshaller implements Marshaller<Request<GetTextDetectionRequest>, GetTextDetectionRequest> {
    ...
    public Request<GetTextDetectionRequest> marshall(GetTextDetectionRequest getTextDetectionRequest) {
        if (getTextDetectionRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(GetTextDetectionRequest)");
        }
        DefaultRequest defaultRequest = new DefaultRequest(getTextDetectionRequest, "AmazonRekognition");
        defaultRequest.addHeader("X-Amz-Target", "RekognitionService.GetTextDetection");
