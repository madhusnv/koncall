...
public class DetectFacesRequestMarshaller implements Marshaller<Request<DetectFacesRequest>, DetectFacesRequest> {
    ...
    public Request<DetectFacesRequest> marshall(DetectFacesRequest detectFacesRequest) {
        if (detectFacesRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(DetectFacesRequest)");
        }
        DefaultRequest defaultRequest = new DefaultRequest(detectFacesRequest, "AmazonRekognition");
        defaultRequest.addHeader("X-Amz-Target", "RekognitionService.DetectFaces");
        ...
        try {
            ...
            if (detectFacesRequest.getAttributes() != null) {
                List<String> attributes = detectFacesRequest.getAttributes();
