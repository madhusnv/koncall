...
public class DeleteCollectionRequestMarshaller implements Marshaller<Request<DeleteCollectionRequest>, DeleteCollectionRequest> {
    ...
    public Request<DeleteCollectionRequest> marshall(DeleteCollectionRequest deleteCollectionRequest) {
        if (deleteCollectionRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(DeleteCollectionRequest)");
        }
        DefaultRequest defaultRequest = new DefaultRequest(deleteCollectionRequest, "AmazonRekognition");
        defaultRequest.addHeader("X-Amz-Target", "RekognitionService.DeleteCollection");
