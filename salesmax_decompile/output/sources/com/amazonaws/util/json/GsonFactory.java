...
final class GsonFactory implements AwsJsonFactory {
    ...
    public static /* synthetic */ class C102781 {
    ...
    public static final class GsonReader implements AwsJsonReader {
        ...
        public String nextString() throws IOException {
            ...
            if (!JsonToken.NULL.equals(jsonTokenPeek)) {
                return JsonToken.BOOLEAN.equals(jsonTokenPeek) ? this.reader.nextBoolean() ? "true" : "false" : this.reader.nextString();
            }
    ...
    public static final class GsonWriter implements AwsJsonWriter {
        ...
        public AwsJsonWriter value(Date date) throws IOException {
            this.writer.value(BigDecimal.valueOf(date.getTime()).scaleByPowerOfTen(NEGATIVE_THREE));
            return this;
        }
    ...
    public static AwsJsonToken convert(JsonToken jsonToken) {
        ...
        switch (C102781.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()]) {
            case 1:
