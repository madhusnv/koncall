...
class NamespaceRemovingInputStream extends SdkFilterInputStream {
    ...
    public static final class StringPrefixSlicer {
        ...
        public boolean removePrefix(String str) {
            if (!this.f10620s.startsWith(str)) {
                return false;
            }
            this.f10620s = this.f10620s.substring(str.length());
            return true;
        }

        public boolean removePrefixEndingWith(String str) {
            int iIndexOf = this.f10620s.indexOf(str);
            if (iIndexOf < 0) {
                return false;
            }
            this.f10620s = this.f10620s.substring(iIndexOf + str.length());
            return true;
        }
        ...
        public boolean removeRepeatingPrefix(String str) {
            ...
            while (this.f10620s.startsWith(str)) {
                this.f10620s = this.f10620s.substring(str.length());
            }
            return true;
        }
