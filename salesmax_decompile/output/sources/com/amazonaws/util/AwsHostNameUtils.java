...
public class AwsHostNameUtils {
    ...
    public static String parseServiceName(URI uri) {
        ...
        if (host.endsWith(".amazonaws.com")) {
            ...
            return (strSubstring.endsWith(".s3") || S3_ENDPOINT_PATTERN.matcher(strSubstring).matches()) ? ServiceAbbreviations.S3 : strSubstring.indexOf(46) == -1 ? strSubstring : strSubstring.substring(0, strSubstring.indexOf(46));
        }
    ...
    private static String parseStandardRegionName(String str) {
        ...
        if (strSubstring.equals(VPC_NAME)) {
