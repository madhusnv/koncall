...
public final class GetCampaignDataByOutputQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetCampaignDataByOutput($campaignOutputId: ID, $campaignOutputType: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelCampaignRunDataFilterInput, $limit: Int, $nextToken: String) {\n  getCampaignDataByOutput(campaignOutputId: $campaignOutputId, campaignOutputType: $campaignOutputType, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      contactSource\n      campaignId\n      campaignRunId\n      engagementId\n      campaignOutputType\n      campaignOutputId\n      campaignResponseType\n      campaignResponseId\n      responseCategory\n      responseBody\n      status\n      messageCreatedAt\n      sentAt\n      deliveredAt\n      readAt\n      repliedAt\n      sourceId\n      sourceType\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDataByOutputQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetCampaignDataByOutput";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetCampaignDataByOutput($campaignOutputId: ID, $campaignOutputType: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelCampaignRunDataFilterInput, $limit: Int, $nextToken: String) {\n  getCampaignDataByOutput(campaignOutputId: $campaignOutputId, campaignOutputType: $campaignOutputType, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      contactSource\n      campaignId\n      campaignRunId\n      engagementId\n      campaignOutputType\n      campaignOutputId\n      campaignResponseType\n      campaignResponseId\n      responseCategory\n      responseBody\n      status\n      messageCreatedAt\n      sentAt\n      deliveredAt\n      readAt\n      repliedAt\n      sourceId\n      sourceType\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private String campaignOutputId;
        private ModelStringKeyConditionInput campaignOutputType;
        private ModelCampaignRunDataFilterInput filter;
        private Integer limit;
        private String nextToken;
        private ModelSortDirection sortDirection;

        public GetCampaignDataByOutputQuery build() {
            return new GetCampaignDataByOutputQuery(this.campaignOutputId, this.campaignOutputType, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
        ...
        public Builder campaignOutputType(ModelStringKeyConditionInput modelStringKeyConditionInput) {
            this.campaignOutputType = modelStringKeyConditionInput;
            return this;
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getCampaignDataByOutput", "getCampaignDataByOutput", new UnmodifiableMapBuilder(6).put("campaignOutputType", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "campaignOutputType").build()).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put("campaignOutputId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "campaignOutputId").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetCampaignDataByOutput getCampaignDataByOutput;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetCampaignDataByOutput.Mapper getCampaignDataByOutputFieldMapper = new GetCampaignDataByOutput.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetCampaignDataByOutput) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetCampaignDataByOutput>() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDataByOutputQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetCampaignDataByOutput read(ResponseReader responseReader2) {
                        return Mapper.this.getCampaignDataByOutputFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetCampaignDataByOutput getCampaignDataByOutput) {
            this.getCampaignDataByOutput = getCampaignDataByOutput;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetCampaignDataByOutput getCampaignDataByOutput = this.getCampaignDataByOutput;
            GetCampaignDataByOutput getCampaignDataByOutput2 = ((Data) obj).getCampaignDataByOutput;
            return getCampaignDataByOutput == null ? getCampaignDataByOutput2 == null : getCampaignDataByOutput.equals(getCampaignDataByOutput2);
        }

        public GetCampaignDataByOutput getCampaignDataByOutput() {
            return this.getCampaignDataByOutput;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetCampaignDataByOutput getCampaignDataByOutput = this.getCampaignDataByOutput;
                this.$hashCode = (getCampaignDataByOutput == null ? 0 : getCampaignDataByOutput.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDataByOutputQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetCampaignDataByOutput getCampaignDataByOutput = Data.this.getCampaignDataByOutput;
                    responseWriter.writeObject(responseField, getCampaignDataByOutput != null ? getCampaignDataByOutput.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getCampaignDataByOutput=" + this.getCampaignDataByOutput + "}";
            }
            return this.$toString;
        }
    }

    public static class GetCampaignDataByOutput {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetCampaignDataByOutput> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetCampaignDataByOutput map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetCampaignDataByOutput.$responseFields;
                return new GetCampaignDataByOutput(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDataByOutputQuery.GetCampaignDataByOutput.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDataByOutputQuery.GetCampaignDataByOutput.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetCampaignDataByOutput(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetCampaignDataByOutput)) {
                return false;
            }
            GetCampaignDataByOutput getCampaignDataByOutput = (GetCampaignDataByOutput) obj;
            if (this.__typename.equals(getCampaignDataByOutput.__typename) && this.items.equals(getCampaignDataByOutput.items)) {
                String str = this.nextToken;
                String str2 = getCampaignDataByOutput.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDataByOutputQuery.GetCampaignDataByOutput.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetCampaignDataByOutput.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetCampaignDataByOutput.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetCampaignDataByOutput.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDataByOutputQuery.GetCampaignDataByOutput.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetCampaignDataByOutput.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetCampaignDataByOutput{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDataByOutputQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final ModelStringKeyConditionInput campaignOutputType;
        ...
        public Variables(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelCampaignRunDataFilterInput modelCampaignRunDataFilterInput, Integer num, String str2) {
            ...
            this.limit = num;
            this.nextToken = str2;
            linkedHashMap.put("campaignOutputId", str);
            linkedHashMap.put("campaignOutputType", modelStringKeyConditionInput);
        ...
        public ModelStringKeyConditionInput campaignOutputType() {
            return this.campaignOutputType;
        }
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDataByOutputQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("campaignOutputId", Variables.this.campaignOutputId);
                    inputFieldWriter.writeObject("campaignOutputType", Variables.this.campaignOutputType != null ? Variables.this.campaignOutputType.marshaller() : null);
    ...
    public GetCampaignDataByOutputQuery(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelCampaignRunDataFilterInput modelCampaignRunDataFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelStringKeyConditionInput, modelSortDirection, modelCampaignRunDataFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "0c043639212fbdf1578b471d781797597364f2be29baf9cb6310af7f4ba30cf0";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetCampaignDataByOutput($campaignOutputId: ID, $campaignOutputType: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelCampaignRunDataFilterInput, $limit: Int, $nextToken: String) {\n  getCampaignDataByOutput(campaignOutputId: $campaignOutputId, campaignOutputType: $campaignOutputType, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      contactSource\n      campaignId\n      campaignRunId\n      engagementId\n      campaignOutputType\n      campaignOutputId\n      campaignResponseType\n      campaignResponseId\n      responseCategory\n      responseBody\n      status\n      messageCreatedAt\n      sentAt\n      deliveredAt\n      readAt\n      repliedAt\n      sourceId\n      sourceType\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
