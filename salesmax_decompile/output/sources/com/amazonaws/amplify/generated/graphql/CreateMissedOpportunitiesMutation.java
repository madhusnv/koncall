...
public final class CreateMissedOpportunitiesMutation implements Mutation<Data, Data, Variables> {
    ...
    public static final class Builder {
        ...
        public Builder input(CreateMissedOpportunitiesInput createMissedOpportunitiesInput) {
            this.input = createMissedOpportunitiesInput;
            return this;
        }
    }
    ...
    public static class Contact {
        ...
        public static final class Mapper implements ResponseFieldMapper<Contact> {
            ...
            public Contact map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[5], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Contact.Mapper.1
                ...
                List list2 = responseReader.readList(responseFieldArr[7], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Contact.Mapper.2
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                ...
                List list3 = responseReader.readList(responseFieldArr[34], new ResponseReader.ListReader<Day>() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Contact.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                ...
                List list4 = responseReader.readList(responseFieldArr[92], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Contact.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                });
                List list5 = responseReader.readList(responseFieldArr[93], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Contact.Mapper.5
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                ...
                List list6 = responseReader.readList(responseFieldArr[97], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Contact.Mapper.6
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Contact.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], Contact.this.sharedOwners, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Contact.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[7], Contact.this.sharedTeams, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Contact.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[34], Contact.this.preferredContactDays, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Contact.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[92], Contact.this.userDefinedTags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Contact.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[93], Contact.this.productService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Contact.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[97], Contact.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Contact.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class CreateMissedOpportunities {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<CreateMissedOpportunities> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public CreateMissedOpportunities map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = CreateMissedOpportunities.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
                String str3 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]);
                PrimaryTeam primaryTeam = (PrimaryTeam) responseReader.readObject(responseFieldArr[4], new ResponseReader.ObjectReader<PrimaryTeam>() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.CreateMissedOpportunities.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                ...
                }), (Contact) responseReader.readObject(responseFieldArr[13], new ResponseReader.ObjectReader<Contact>() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.CreateMissedOpportunities.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public Contact read(ResponseReader responseReader2) {
                        return Mapper.this.contactFieldMapper.map(responseReader2);
                    }
                }), (Owner) responseReader.readObject(responseFieldArr[14], new ResponseReader.ObjectReader<Owner>() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.CreateMissedOpportunities.Mapper.4
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public CreateMissedOpportunities(String str, String str2, String str3, String str4, PrimaryTeam primaryTeam, String str5, String str6, MissedOpportunityType missedOpportunityType, String str7, String str8, String str9, String str10, RelatedEngagement relatedEngagement, Contact contact, Owner owner) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateMissedOpportunities)) {
                return false;
            }
            CreateMissedOpportunities createMissedOpportunities = (CreateMissedOpportunities) obj;
            if (this.__typename.equals(createMissedOpportunities.__typename) && this.accountId.equals(createMissedOpportunities.accountId) && this.ownerId.equals(createMissedOpportunities.ownerId) && ((str = this.primaryTeamId) != null ? str.equals(createMissedOpportunities.primaryTeamId) : createMissedOpportunities.primaryTeamId == null) && ((primaryTeam = this.primaryTeam) != null ? primaryTeam.equals(createMissedOpportunities.primaryTeam) : createMissedOpportunities.primaryTeam == null) && this.contactId.equals(createMissedOpportunities.contactId) && ((str2 = this.messageBody) != null ? str2.equals(createMissedOpportunities.messageBody) : createMissedOpportunities.messageBody == null) && this.missedOpportunityType.equals(createMissedOpportunities.missedOpportunityType) && ((str3 = this.callLaterDateTime) != null ? str3.equals(createMissedOpportunities.callLaterDateTime) : createMissedOpportunities.callLaterDateTime == null) && ((str4 = this.relatedEngagementId) != null ? str4.equals(createMissedOpportunities.relatedEngagementId) : createMissedOpportunities.relatedEngagementId == null) && ((str5 = this.createdAt) != null ? str5.equals(createMissedOpportunities.createdAt) : createMissedOpportunities.createdAt == null) && ((str6 = this.updatedAt) != null ? str6.equals(createMissedOpportunities.updatedAt) : createMissedOpportunities.updatedAt == null) && ((relatedEngagement = this.relatedEngagement) != null ? relatedEngagement.equals(createMissedOpportunities.relatedEngagement) : createMissedOpportunities.relatedEngagement == null) && ((contact = this.contact) != null ? contact.equals(createMissedOpportunities.contact) : createMissedOpportunities.contact == null)) {
                Owner owner = this.owner;
                Owner owner2 = createMissedOpportunities.owner;
                if (owner == null) {
                    if (owner2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.CreateMissedOpportunities.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateMissedOpportunities.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateMissedOpportunities.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateMissedOpportunities.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], CreateMissedOpportunities.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], CreateMissedOpportunities.this.primaryTeamId);
                    ResponseField responseField = responseFieldArr[4];
                    PrimaryTeam primaryTeam = CreateMissedOpportunities.this.primaryTeam;
                    responseWriter.writeObject(responseField, primaryTeam != null ? primaryTeam.marshaller() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], CreateMissedOpportunities.this.contactId);
                    responseWriter.writeString(responseFieldArr[6], CreateMissedOpportunities.this.messageBody);
                    responseWriter.writeString(responseFieldArr[7], CreateMissedOpportunities.this.missedOpportunityType.name());
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], CreateMissedOpportunities.this.callLaterDateTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], CreateMissedOpportunities.this.relatedEngagementId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[10], CreateMissedOpportunities.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], CreateMissedOpportunities.this.updatedAt);
                    ResponseField responseField2 = responseFieldArr[12];
                    RelatedEngagement relatedEngagement = CreateMissedOpportunities.this.relatedEngagement;
                    ...
                    Contact contact = CreateMissedOpportunities.this.contact;
                    ...
                    Owner owner = CreateMissedOpportunities.this.owner;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createMissedOpportunities", "createMissedOpportunities", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final CreateMissedOpportunities createMissedOpportunities;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateMissedOpportunities.Mapper createMissedOpportunitiesFieldMapper = new CreateMissedOpportunities.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateMissedOpportunities) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateMissedOpportunities>() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateMissedOpportunities read(ResponseReader responseReader2) {
                        return Mapper.this.createMissedOpportunitiesFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateMissedOpportunities createMissedOpportunities) {
            this.createMissedOpportunities = createMissedOpportunities;
        }

        public CreateMissedOpportunities createMissedOpportunities() {
            return this.createMissedOpportunities;
        }
        ...
        public boolean equals(Object obj) {
            ...
            CreateMissedOpportunities createMissedOpportunities = this.createMissedOpportunities;
            CreateMissedOpportunities createMissedOpportunities2 = ((Data) obj).createMissedOpportunities;
            return createMissedOpportunities == null ? createMissedOpportunities2 == null : createMissedOpportunities.equals(createMissedOpportunities2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateMissedOpportunities createMissedOpportunities = this.createMissedOpportunities;
                this.$hashCode = (createMissedOpportunities == null ? 0 : createMissedOpportunities.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateMissedOpportunities createMissedOpportunities = Data.this.createMissedOpportunities;
                    responseWriter.writeObject(responseField, createMissedOpportunities != null ? createMissedOpportunities.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createMissedOpportunities=" + this.createMissedOpportunities + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Owner {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Owner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Owner.$responseFields;
    ...
    public static class PrimaryTeam {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.PrimaryTeam.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = PrimaryTeam.$responseFields;
    ...
    public static class RelatedEngagement {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.RelatedEngagement.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = RelatedEngagement.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[67], RelatedEngagement.this.taskEngagementActions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.RelatedEngagement.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final CreateMissedOpportunitiesInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateMissedOpportunitiesInput createMissedOpportunitiesInput, ModelMissedOpportunitiesConditionInput modelMissedOpportunitiesConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createMissedOpportunitiesInput;
            this.condition = modelMissedOpportunitiesConditionInput;
            linkedHashMap.put("input", createMissedOpportunitiesInput);
        ...
        public CreateMissedOpportunitiesInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateMissedOpportunitiesMutation.Variables.1
    ...
    public CreateMissedOpportunitiesMutation(CreateMissedOpportunitiesInput createMissedOpportunitiesInput, ModelMissedOpportunitiesConditionInput modelMissedOpportunitiesConditionInput) {
        Utils.checkNotNull(createMissedOpportunitiesInput, "input == null");
        this.variables = new Variables(createMissedOpportunitiesInput, modelMissedOpportunitiesConditionInput);
    }
    ...
    public String operationId() {
        return "cf9a4f185629bebc7be302600a02772a7680d6f75136b9861b868a7f25aa6730";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateMissedOpportunities($input: CreateMissedOpportunitiesInput!, $condition: ModelMissedOpportunitiesConditionInput) {\n  createMissedOpportunities(input: $input, condition: $condition) {\n    __typename\n    accountId\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    contactId\n    messageBody\n    missedOpportunityType\n    callLaterDateTime\n    relatedEngagementId\n    createdAt\n    updatedAt\n    relatedEngagement {\n      __typename\n      id\n      accountId\n      engagementType\n      contactId\n      primaryTeamId\n      toBeAssigned\n      ownerId\n      contactPrimaryTeamId\n      contactOwnerId\n      addedById\n      updatedById\n      callStatus\n      engagementStatus\n      parentEngagementId\n      nextStepTaskId\n      syncStatus\n      externalNumber\n      userNumber\n      callDirection\n      callConnectStatus\n      callStartTime\n      callEndTime\n      durationInMillis\n      callOutcome\n      callOutcomeNature\n      callRecordingExternalResource\n      noteHeading\n      noteAdditionMethod\n      voiceNoteUrl\n      body\n      isManualTask\n      taskHeading\n      taskType\n      taskActivityType\n      taskInputNote\n      taskPriority\n      taskCompletionNote\n      taskCompletionTime\n      taskCompletionType\n      dueDateTime\n      nextFollowUpOn\n      nextFollowUpSetBy\n      reminderDateTime\n      callRecordingUrl\n      callTranscriptUrl\n      callTranscriptSummary\n      uploadedFiledUrl\n      visitTime\n      visitNote\n      visitOutcome\n      visitOutcomeNature\n      videoCallPlatform\n      videoCallLink\n      meetingName\n      meetingCode\n      videoCallMetadata\n      videoCallOutcome\n      paymentDataId\n      calendarEventId\n      calendarName\n      campaignId\n      campaignRun\n      engagementSourceType\n      engagementSource\n      engagementSourceLevelTwo\n      systemAction\n      taskEngagementActions\n      taskEngagementActionsUpdatedAt\n      firstTaskEngagementActionOn\n      taskEngagementActionCount\n      customCallOutcomeData\n      customVisitOutcomeData\n      customTaskCompletionData\n      customTaskInputData\n      customVideoCallInputData\n      deviceId\n      totalCallDuration\n      cloudProviderNumber\n      hangupReason\n      cloudProvider\n      callType\n      phoneCallLogId\n      externalEventRecordId\n      createdAt\n      updatedAt\n    }\n    contact {\n      __typename\n      id\n      accountId\n      ownerId\n      toBeAssigned\n      sharedOwners\n      primaryTeamId\n      sharedTeams\n      accountPriority\n      addedById\n      assignedToId\n      blockedForCallById\n      blockedForCallReason\n      blockedForCallUntil\n      callPriority\n      waChatChannelId\n      contactSource\n      contactSourceDrillDownOne\n      contactSourceDrillDownTwo\n      contactSourceDrillDownThree\n      contactSourceDrillDownOneId\n      contactSourceDrillDownTwoId\n      contactSourceDrillDownThreeId\n      contactStatus\n      contactType\n      department\n      designation\n      lastRepeatEnquiryDate\n      lastRepeatEnquirySource\n      gender\n      isDecisionMaker\n      isPrivate\n      lockPeriod\n      name\n      preferredContactDays\n      profilePhotoUrl\n      referredBy\n      salutation\n      seniority\n      updatedById\n      hasTask\n      openTaskActivityType\n      lastCalledTime\n      lastCallDirection\n      lastCallOutcome\n      lastCallOutcomeNature\n      lastCallUserId\n      lastCallDuration\n      lastCallEngagementId\n      lastVisitTime\n      lastVisitOutcome\n      lastVisitOutcomeNature\n      lastVisitUserId\n      lastVisitEngagementId\n      lastEmailTime\n      lastEmailUserId\n      lastEmailEngagementId\n      lastWhatsappTime\n      lastWhatsappUserId\n      lastWhatsappEngagementId\n      lastWabaBroadcastTime\n      lastWabaBroadcastStatus\n      lastWabaBroadcastTemplate\n      lastWabaBroadcastReplyBody\n      lastWabaBroadcastReplyTime\n      lastWabaBroadcastReplyType\n      lastSmsTime\n      lastSmsUserId\n      lastSmsEngagementId\n      lastNoteAddedTime\n      lastNoteUserId\n      lastNoteEngagementId\n      lastTaskDoneTime\n      lastTaskDoneUserId\n      lastTaskDoneEngagementId\n      openTaskCount\n      lastKnownDisposition\n      lastKnownDispositionTime\n      lastLeadAssignmentDateTime\n      lastEngagementFromAccount\n      lastEngagementFromContact\n      freshLeadTag\n      noWorkAfterAssignment\n      needFollowUpTag\n      needFollowUpTagUpdatedAt\n      activeDealStage\n      activeDealStageUpdatedAt\n      dealDescription\n      isCustomer\n      becameCustomerOn\n      unsuccessfulCallAttempts\n      leadCallsNotAnswered\n      userDefinedTags\n      productService\n      bulkUploadReference\n      assignmentMethod\n      whatsappOptInStatus\n      recentEngagements\n      recentEngagementsUpdatedAt\n      openTaskDetail\n      openVideoCallDetail\n      lastClosedTaskDetail\n      lastClosedTaskDetailUpdatedAt\n      latestRemark\n      customAttributes\n      paymentRequestDetail\n      lastPaymentStatus\n      customDataAddedFromAddContactForm\n      leadLifecycleStage\n      leadLifecycleStageSubCategory\n      manualClosedReason\n      lastDealStageType\n      prospectingAttempts\n      totalProspectingAttemptsAcrossRechurn\n      numberOfTimesRechurned\n      lastProspectingDoneOn\n      firstProspectingDoneOn\n      nextProspectingDueOn\n      nextProspectingSetBy\n      nextProspectingNote\n      movedToOpportunityOn\n      movedToClosedOn\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
