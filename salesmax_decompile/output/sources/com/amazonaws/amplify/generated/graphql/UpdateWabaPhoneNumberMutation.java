...
import type.UpdateWabaPhoneNumberInput;

/* loaded from: classes4.dex */
public final class UpdateWabaPhoneNumberMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation UpdateWabaPhoneNumber($input: UpdateWabaPhoneNumberInput!, $condition: ModelWabaPhoneNumberConditionInput) {\n  updateWabaPhoneNumber(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaPhoneNumberMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "UpdateWabaPhoneNumber";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation UpdateWabaPhoneNumber($input: UpdateWabaPhoneNumberInput!, $condition: ModelWabaPhoneNumberConditionInput) {\n  updateWabaPhoneNumber(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelWabaPhoneNumberConditionInput condition;
        private UpdateWabaPhoneNumberInput input;

        public UpdateWabaPhoneNumberMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new UpdateWabaPhoneNumberMutation(this.input, this.condition);
        }
        ...
        public Builder input(UpdateWabaPhoneNumberInput updateWabaPhoneNumberInput) {
            this.input = updateWabaPhoneNumberInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("updateWabaPhoneNumber", "updateWabaPhoneNumber", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final UpdateWabaPhoneNumber updateWabaPhoneNumber;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final UpdateWabaPhoneNumber.Mapper updateWabaPhoneNumberFieldMapper = new UpdateWabaPhoneNumber.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((UpdateWabaPhoneNumber) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<UpdateWabaPhoneNumber>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaPhoneNumberMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdateWabaPhoneNumber read(ResponseReader responseReader2) {
                        return Mapper.this.updateWabaPhoneNumberFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(UpdateWabaPhoneNumber updateWabaPhoneNumber) {
            this.updateWabaPhoneNumber = updateWabaPhoneNumber;
        }
        ...
        public boolean equals(Object obj) {
            ...
            UpdateWabaPhoneNumber updateWabaPhoneNumber = this.updateWabaPhoneNumber;
            UpdateWabaPhoneNumber updateWabaPhoneNumber2 = ((Data) obj).updateWabaPhoneNumber;
            return updateWabaPhoneNumber == null ? updateWabaPhoneNumber2 == null : updateWabaPhoneNumber.equals(updateWabaPhoneNumber2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                UpdateWabaPhoneNumber updateWabaPhoneNumber = this.updateWabaPhoneNumber;
                this.$hashCode = (updateWabaPhoneNumber == null ? 0 : updateWabaPhoneNumber.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaPhoneNumberMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    UpdateWabaPhoneNumber updateWabaPhoneNumber = Data.this.updateWabaPhoneNumber;
                    responseWriter.writeObject(responseField, updateWabaPhoneNumber != null ? updateWabaPhoneNumber.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{updateWabaPhoneNumber=" + this.updateWabaPhoneNumber + "}";
            }
            return this.$toString;
        }

        public UpdateWabaPhoneNumber updateWabaPhoneNumber() {
            return this.updateWabaPhoneNumber;
        }
    }
    ...
    public static class EntityList {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaPhoneNumberMutation.EntityList.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = EntityList.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[34], EntityList.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaPhoneNumberMutation.EntityList.1.1
    ...
    public static class UpdateWabaPhoneNumber {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public UpdateWabaPhoneNumber(String str, String str2, String str3, String str4, String str5, String str6, Boolean bool, String str7, String str8, String str9, Integer num, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, String str19, String str20, String str21, String str22, String str23, String str24, String str25, String str26, EntityList entityList) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateWabaPhoneNumber)) {
                return false;
            }
            UpdateWabaPhoneNumber updateWabaPhoneNumber = (UpdateWabaPhoneNumber) obj;
            if (this.__typename.equals(updateWabaPhoneNumber.__typename) && this.id.equals(updateWabaPhoneNumber.id) && this.wabaAccountId.equals(updateWabaPhoneNumber.wabaAccountId) && this.accountId.equals(updateWabaPhoneNumber.accountId) && this.phoneNumberId.equals(updateWabaPhoneNumber.phoneNumberId) && this.phoneNumber.equals(updateWabaPhoneNumber.phoneNumber) && ((bool = this.isDefault) != null ? bool.equals(updateWabaPhoneNumber.isDefault) : updateWabaPhoneNumber.isDefault == null) && ((str = this.accessToken) != null ? str.equals(updateWabaPhoneNumber.accessToken) : updateWabaPhoneNumber.accessToken == null) && ((str2 = this.name) != null ? str2.equals(updateWabaPhoneNumber.name) : updateWabaPhoneNumber.name == null) && ((str3 = this.internalName) != null ? str3.equals(updateWabaPhoneNumber.internalName) : updateWabaPhoneNumber.internalName == null) && ((num = this.quota) != null ? num.equals(updateWabaPhoneNumber.quota) : updateWabaPhoneNumber.quota == null) && ((str4 = this.currentLimitCategory) != null ? str4.equals(updateWabaPhoneNumber.currentLimitCategory) : updateWabaPhoneNumber.currentLimitCategory == null) && ((str5 = this.status) != null ? str5.equals(updateWabaPhoneNumber.status) : updateWabaPhoneNumber.status == null) && ((str6 = this.qualityRating) != null ? str6.equals(updateWabaPhoneNumber.qualityRating) : updateWabaPhoneNumber.qualityRating == null) && ((str7 = this.entityListId) != null ? str7.equals(updateWabaPhoneNumber.entityListId) : updateWabaPhoneNumber.entityListId == null) && ((str8 = this.createdAt) != null ? str8.equals(updateWabaPhoneNumber.createdAt) : updateWabaPhoneNumber.createdAt == null) && ((str9 = this.updatedAt) != null ? str9.equals(updateWabaPhoneNumber.updatedAt) : updateWabaPhoneNumber.updatedAt == null) && ((str10 = this.welcomeMessage) != null ? str10.equals(updateWabaPhoneNumber.welcomeMessage) : updateWabaPhoneNumber.welcomeMessage == null) && ((str11 = this.requestedDisplayName) != null ? str11.equals(updateWabaPhoneNumber.requestedDisplayName) : updateWabaPhoneNumber.requestedDisplayName == null) && ((str12 = this.displayNameUpdate) != null ? str12.equals(updateWabaPhoneNumber.displayNameUpdate) : updateWabaPhoneNumber.displayNameUpdate == null) && ((str13 = this.displayNameUpdateDateTime) != null ? str13.equals(updateWabaPhoneNumber.displayNameUpdateDateTime) : updateWabaPhoneNumber.displayNameUpdateDateTime == null) && ((str14 = this.wabaNumberDecision) != null ? str14.equals(updateWabaPhoneNumber.wabaNumberDecision) : updateWabaPhoneNumber.wabaNumberDecision == null) && ((str15 = this.wabaNumberDecisionTime) != null ? str15.equals(updateWabaPhoneNumber.wabaNumberDecisionTime) : updateWabaPhoneNumber.wabaNumberDecisionTime == null) && ((str16 = this.rejectionReason) != null ? str16.equals(updateWabaPhoneNumber.rejectionReason) : updateWabaPhoneNumber.rejectionReason == null) && ((str17 = this.phoneNumberQualityUpdate) != null ? str17.equals(updateWabaPhoneNumber.phoneNumberQualityUpdate) : updateWabaPhoneNumber.phoneNumberQualityUpdate == null) && ((str18 = this.phoneNumberQualityUpdateTime) != null ? str18.equals(updateWabaPhoneNumber.phoneNumberQualityUpdateTime) : updateWabaPhoneNumber.phoneNumberQualityUpdateTime == null) && ((str19 = this.createdById) != null ? str19.equals(updateWabaPhoneNumber.createdById) : updateWabaPhoneNumber.createdById == null) && ((str20 = this.updatedById) != null ? str20.equals(updateWabaPhoneNumber.updatedById) : updateWabaPhoneNumber.updatedById == null)) {
                EntityList entityList = this.entityList;
                EntityList entityList2 = updateWabaPhoneNumber.entityList;
                if (entityList == null) {
                    if (entityList2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaPhoneNumberMutation.UpdateWabaPhoneNumber.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdateWabaPhoneNumber.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UpdateWabaPhoneNumber.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], UpdateWabaPhoneNumber.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], UpdateWabaPhoneNumber.this.wabaAccountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], UpdateWabaPhoneNumber.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], UpdateWabaPhoneNumber.this.phoneNumberId);
                    responseWriter.writeString(responseFieldArr[5], UpdateWabaPhoneNumber.this.phoneNumber);
                    responseWriter.writeBoolean(responseFieldArr[6], UpdateWabaPhoneNumber.this.isDefault);
                    responseWriter.writeString(responseFieldArr[7], UpdateWabaPhoneNumber.this.accessToken);
                    responseWriter.writeString(responseFieldArr[8], UpdateWabaPhoneNumber.this.name);
                    responseWriter.writeString(responseFieldArr[9], UpdateWabaPhoneNumber.this.internalName);
                    responseWriter.writeInt(responseFieldArr[10], UpdateWabaPhoneNumber.this.quota);
                    responseWriter.writeString(responseFieldArr[11], UpdateWabaPhoneNumber.this.currentLimitCategory);
                    responseWriter.writeString(responseFieldArr[12], UpdateWabaPhoneNumber.this.status);
                    responseWriter.writeString(responseFieldArr[13], UpdateWabaPhoneNumber.this.qualityRating);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], UpdateWabaPhoneNumber.this.entityListId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], UpdateWabaPhoneNumber.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], UpdateWabaPhoneNumber.this.updatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], UpdateWabaPhoneNumber.this.welcomeMessage);
                    responseWriter.writeString(responseFieldArr[18], UpdateWabaPhoneNumber.this.requestedDisplayName);
                    responseWriter.writeString(responseFieldArr[19], UpdateWabaPhoneNumber.this.displayNameUpdate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], UpdateWabaPhoneNumber.this.displayNameUpdateDateTime);
                    responseWriter.writeString(responseFieldArr[21], UpdateWabaPhoneNumber.this.wabaNumberDecision);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], UpdateWabaPhoneNumber.this.wabaNumberDecisionTime);
                    responseWriter.writeString(responseFieldArr[23], UpdateWabaPhoneNumber.this.rejectionReason);
                    responseWriter.writeString(responseFieldArr[24], UpdateWabaPhoneNumber.this.phoneNumberQualityUpdate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], UpdateWabaPhoneNumber.this.phoneNumberQualityUpdateTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[26], UpdateWabaPhoneNumber.this.createdById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], UpdateWabaPhoneNumber.this.updatedById);
                    ResponseField responseField = responseFieldArr[28];
                    EntityList entityList = UpdateWabaPhoneNumber.this.entityList;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final UpdateWabaPhoneNumberInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(UpdateWabaPhoneNumberInput updateWabaPhoneNumberInput, ModelWabaPhoneNumberConditionInput modelWabaPhoneNumberConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = updateWabaPhoneNumberInput;
            this.condition = modelWabaPhoneNumberConditionInput;
            linkedHashMap.put("input", updateWabaPhoneNumberInput);
        ...
        public UpdateWabaPhoneNumberInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaPhoneNumberMutation.Variables.1
    ...
    public UpdateWabaPhoneNumberMutation(UpdateWabaPhoneNumberInput updateWabaPhoneNumberInput, ModelWabaPhoneNumberConditionInput modelWabaPhoneNumberConditionInput) {
        Utils.checkNotNull(updateWabaPhoneNumberInput, "input == null");
        this.variables = new Variables(updateWabaPhoneNumberInput, modelWabaPhoneNumberConditionInput);
    }
    ...
    public String operationId() {
        return "b1753cc449cd60b420fc71af2ff4ee59dfc15f6c8e51978e8fd763ab34205327";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation UpdateWabaPhoneNumber($input: UpdateWabaPhoneNumberInput!, $condition: ModelWabaPhoneNumberConditionInput) {\n  updateWabaPhoneNumber(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
