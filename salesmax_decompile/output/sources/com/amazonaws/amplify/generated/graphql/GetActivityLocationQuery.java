...
public final class GetActivityLocationQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetActivityLocation($id: ID!) {\n  getActivityLocation(id: $id) {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetActivityLocationQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetActivityLocation";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetActivityLocation($id: ID!) {\n  getActivityLocation(id: $id) {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private String id;

        public GetActivityLocationQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetActivityLocationQuery(this.id);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getActivityLocation", "getActivityLocation", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetActivityLocation getActivityLocation;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetActivityLocation.Mapper getActivityLocationFieldMapper = new GetActivityLocation.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetActivityLocation) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetActivityLocation>() { // from class: com.amazonaws.amplify.generated.graphql.GetActivityLocationQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetActivityLocation read(ResponseReader responseReader2) {
                        return Mapper.this.getActivityLocationFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetActivityLocation getActivityLocation) {
            this.getActivityLocation = getActivityLocation;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetActivityLocation getActivityLocation = this.getActivityLocation;
            GetActivityLocation getActivityLocation2 = ((Data) obj).getActivityLocation;
            return getActivityLocation == null ? getActivityLocation2 == null : getActivityLocation.equals(getActivityLocation2);
        }

        public GetActivityLocation getActivityLocation() {
            return this.getActivityLocation;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetActivityLocation getActivityLocation = this.getActivityLocation;
                this.$hashCode = (getActivityLocation == null ? 0 : getActivityLocation.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetActivityLocationQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetActivityLocation getActivityLocation = Data.this.getActivityLocation;
                    responseWriter.writeObject(responseField, getActivityLocation != null ? getActivityLocation.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getActivityLocation=" + this.getActivityLocation + "}";
            }
            return this.$toString;
        }
    }

    public static class GetActivityLocation {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetActivityLocation> {
            final User.Mapper userFieldMapper = new User.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetActivityLocation map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetActivityLocation.$responseFields;
                return new GetActivityLocation(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), responseReader.readString(responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[8]), (User) responseReader.readObject(responseFieldArr[9], new ResponseReader.ObjectReader<User>() { // from class: com.amazonaws.amplify.generated.graphql.GetActivityLocationQuery.GetActivityLocation.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetActivityLocation(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, User user) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetActivityLocation)) {
                return false;
            }
            GetActivityLocation getActivityLocation = (GetActivityLocation) obj;
            if (this.__typename.equals(getActivityLocation.__typename) && this.id.equals(getActivityLocation.id) && this.accountId.equals(getActivityLocation.accountId) && ((str = this.engagementId) != null ? str.equals(getActivityLocation.engagementId) : getActivityLocation.engagementId == null) && ((str2 = this.lat) != null ? str2.equals(getActivityLocation.lat) : getActivityLocation.lat == null) && ((str3 = this.lng) != null ? str3.equals(getActivityLocation.lng) : getActivityLocation.lng == null) && this.ownerId.equals(getActivityLocation.ownerId) && ((str4 = this.createdAt) != null ? str4.equals(getActivityLocation.createdAt) : getActivityLocation.createdAt == null) && ((str5 = this.updatedAt) != null ? str5.equals(getActivityLocation.updatedAt) : getActivityLocation.updatedAt == null)) {
                User user = this.user;
                User user2 = getActivityLocation.user;
                if (user == null) {
                    if (user2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetActivityLocationQuery.GetActivityLocation.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetActivityLocation.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetActivityLocation.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetActivityLocation.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetActivityLocation.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], GetActivityLocation.this.engagementId);
                    responseWriter.writeString(responseFieldArr[4], GetActivityLocation.this.lat);
                    responseWriter.writeString(responseFieldArr[5], GetActivityLocation.this.lng);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], GetActivityLocation.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], GetActivityLocation.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], GetActivityLocation.this.updatedAt);
                    ResponseField responseField = responseFieldArr[9];
                    User user = GetActivityLocation.this.user;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetActivityLocation{__typename=" + this.__typename + ", id=" + this.id + ", accountId=" + this.accountId + ", engagementId=" + this.engagementId + ", lat=" + this.lat + ", lng=" + this.lng + ", ownerId=" + this.ownerId + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", user=" + this.user + "}";
            }
            return this.$toString;
        }
    ...
    public static class User {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetActivityLocationQuery.User.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = User.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetActivityLocationQuery.Variables.1
    ...
    public GetActivityLocationQuery(String str) {
    ...
    public String operationId() {
        return "de0ed95dc8f7bf0fad831d190a3ac9ee4cee77797ebd72ef0c1d3b3187652dcf";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetActivityLocation($id: ID!) {\n  getActivityLocation(id: $id) {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
