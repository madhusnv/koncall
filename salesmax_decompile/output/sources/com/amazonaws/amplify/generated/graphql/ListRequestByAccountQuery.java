...
public final class ListRequestByAccountQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListRequestByAccount($accountId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelDeviceRegistrationRequestFilterInput, $limit: Int, $nextToken: String) {\n  listRequestByAccount(accountId: $accountId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      userId\n      requestedDeviceId\n      deviceModel\n      osVersion\n      ipAddress\n      reason\n      status\n      requestedAt\n      approvedBy\n      approvedAt\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListRequestByAccountQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListRequestByAccount";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListRequestByAccount($accountId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelDeviceRegistrationRequestFilterInput, $limit: Int, $nextToken: String) {\n  listRequestByAccount(accountId: $accountId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      userId\n      requestedDeviceId\n      deviceModel\n      osVersion\n      ipAddress\n      reason\n      status\n      requestedAt\n      approvedBy\n      approvedAt\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public ListRequestByAccountQuery build() {
            return new ListRequestByAccountQuery(this.accountId, this.updatedAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listRequestByAccount", "listRequestByAccount", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("updatedAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "updatedAt").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListRequestByAccount listRequestByAccount;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListRequestByAccount.Mapper listRequestByAccountFieldMapper = new ListRequestByAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListRequestByAccount) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListRequestByAccount>() { // from class: com.amazonaws.amplify.generated.graphql.ListRequestByAccountQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListRequestByAccount read(ResponseReader responseReader2) {
                        return Mapper.this.listRequestByAccountFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListRequestByAccount listRequestByAccount) {
            this.listRequestByAccount = listRequestByAccount;
        }
        ...
        public boolean equals(Object obj) {
            ...
            ListRequestByAccount listRequestByAccount = this.listRequestByAccount;
            ListRequestByAccount listRequestByAccount2 = ((Data) obj).listRequestByAccount;
            return listRequestByAccount == null ? listRequestByAccount2 == null : listRequestByAccount.equals(listRequestByAccount2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListRequestByAccount listRequestByAccount = this.listRequestByAccount;
                this.$hashCode = (listRequestByAccount == null ? 0 : listRequestByAccount.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListRequestByAccount listRequestByAccount() {
            return this.listRequestByAccount;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListRequestByAccountQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListRequestByAccount listRequestByAccount = Data.this.listRequestByAccount;
                    responseWriter.writeObject(responseField, listRequestByAccount != null ? listRequestByAccount.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listRequestByAccount=" + this.listRequestByAccount + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListRequestByAccountQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static class ListRequestByAccount {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListRequestByAccount> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListRequestByAccount map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListRequestByAccount.$responseFields;
                return new ListRequestByAccount(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListRequestByAccountQuery.ListRequestByAccount.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListRequestByAccountQuery.ListRequestByAccount.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListRequestByAccount(String str, List<Item> list, String str2) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListRequestByAccount)) {
                return false;
            }
            ListRequestByAccount listRequestByAccount = (ListRequestByAccount) obj;
            if (this.__typename.equals(listRequestByAccount.__typename) && this.items.equals(listRequestByAccount.items)) {
                String str = this.nextToken;
                String str2 = listRequestByAccount.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListRequestByAccountQuery.ListRequestByAccount.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListRequestByAccount.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListRequestByAccount.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListRequestByAccount.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListRequestByAccountQuery.ListRequestByAccount.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListRequestByAccount.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListRequestByAccount{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListRequestByAccountQuery.Variables.1
    ...
    public ListRequestByAccountQuery(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelDeviceRegistrationRequestFilterInput modelDeviceRegistrationRequestFilterInput, Integer num, String str2) {
    ...
    public String operationId() {
        return "9c6ea0acbedce5169ee00088432814fed63757890dd1c30d3920293338f1add1";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListRequestByAccount($accountId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelDeviceRegistrationRequestFilterInput, $limit: Int, $nextToken: String) {\n  listRequestByAccount(accountId: $accountId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      userId\n      requestedDeviceId\n      deviceModel\n      osVersion\n      ipAddress\n      reason\n      status\n      requestedAt\n      approvedBy\n      approvedAt\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
