...
import type.DeleteMentionUserMembershipInput;
import type.ModelMentionUserMembershipConditionInput;
import type.UserRegistrationStatus;

/* loaded from: classes7.dex */
public final class DeleteMentionUserMembershipMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation DeleteMentionUserMembership($input: DeleteMentionUserMembershipInput!, $condition: ModelMentionUserMembershipConditionInput) {\n  deleteMentionUserMembership(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    commentId\n    mentionedUserId\n    isAnnouncement\n    commentedById\n    createdAt\n    updatedAt\n    comment {\n      __typename\n      id\n      accountId\n      ownerId\n      body\n      engagementId\n      activityId\n      parentEngagementId\n      createdAt\n      updatedAt\n    }\n    commentedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.DeleteMentionUserMembershipMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "DeleteMentionUserMembership";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation DeleteMentionUserMembership($input: DeleteMentionUserMembershipInput!, $condition: ModelMentionUserMembershipConditionInput) {\n  deleteMentionUserMembership(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    commentId\n    mentionedUserId\n    isAnnouncement\n    commentedById\n    createdAt\n    updatedAt\n    comment {\n      __typename\n      id\n      accountId\n      ownerId\n      body\n      engagementId\n      activityId\n      parentEngagementId\n      createdAt\n      updatedAt\n    }\n    commentedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelMentionUserMembershipConditionInput condition;
        private DeleteMentionUserMembershipInput input;

        public DeleteMentionUserMembershipMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteMentionUserMembershipMutation(this.input, this.condition);
        }
        ...
        public Builder input(DeleteMentionUserMembershipInput deleteMentionUserMembershipInput) {
            this.input = deleteMentionUserMembershipInput;
            return this;
        }
    }
    ...
    public static class Comment {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteMentionUserMembershipMutation.Comment.1
    ...
    public static class CommentedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteMentionUserMembershipMutation.CommentedBy.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CommentedBy.$responseFields;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteMentionUserMembership", "deleteMentionUserMembership", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final DeleteMentionUserMembership deleteMentionUserMembership;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteMentionUserMembership.Mapper deleteMentionUserMembershipFieldMapper = new DeleteMentionUserMembership.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteMentionUserMembership) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteMentionUserMembership>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteMentionUserMembershipMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteMentionUserMembership read(ResponseReader responseReader2) {
                        return Mapper.this.deleteMentionUserMembershipFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteMentionUserMembership deleteMentionUserMembership) {
            this.deleteMentionUserMembership = deleteMentionUserMembership;
        }

        public DeleteMentionUserMembership deleteMentionUserMembership() {
            return this.deleteMentionUserMembership;
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteMentionUserMembership deleteMentionUserMembership = this.deleteMentionUserMembership;
            DeleteMentionUserMembership deleteMentionUserMembership2 = ((Data) obj).deleteMentionUserMembership;
            return deleteMentionUserMembership == null ? deleteMentionUserMembership2 == null : deleteMentionUserMembership.equals(deleteMentionUserMembership2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteMentionUserMembership deleteMentionUserMembership = this.deleteMentionUserMembership;
                this.$hashCode = (deleteMentionUserMembership == null ? 0 : deleteMentionUserMembership.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteMentionUserMembershipMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteMentionUserMembership deleteMentionUserMembership = Data.this.deleteMentionUserMembership;
                    responseWriter.writeObject(responseField, deleteMentionUserMembership != null ? deleteMentionUserMembership.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteMentionUserMembership=" + this.deleteMentionUserMembership + "}";
            }
            return this.$toString;
        }
    }

    public static class DeleteMentionUserMembership {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<DeleteMentionUserMembership> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public DeleteMentionUserMembership map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = DeleteMentionUserMembership.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                ...
                return new DeleteMentionUserMembership(string, str, str2, str3, str4, string2 != null ? Announcement.valueOf(string2) : null, (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[8]), (Comment) responseReader.readObject(responseFieldArr[9], new ResponseReader.ObjectReader<Comment>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteMentionUserMembershipMutation.DeleteMentionUserMembership.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public Comment read(ResponseReader responseReader2) {
                        return Mapper.this.commentFieldMapper.map(responseReader2);
                    }
                }), (CommentedBy) responseReader.readObject(responseFieldArr[10], new ResponseReader.ObjectReader<CommentedBy>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteMentionUserMembershipMutation.DeleteMentionUserMembership.Mapper.2
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public DeleteMentionUserMembership(String str, String str2, String str3, String str4, String str5, Announcement announcement, String str6, String str7, String str8, Comment comment, CommentedBy commentedBy) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteMentionUserMembership)) {
                return false;
            }
            DeleteMentionUserMembership deleteMentionUserMembership = (DeleteMentionUserMembership) obj;
            if (this.__typename.equals(deleteMentionUserMembership.__typename) && this.id.equals(deleteMentionUserMembership.id) && this.accountId.equals(deleteMentionUserMembership.accountId) && this.commentId.equals(deleteMentionUserMembership.commentId) && ((str = this.mentionedUserId) != null ? str.equals(deleteMentionUserMembership.mentionedUserId) : deleteMentionUserMembership.mentionedUserId == null) && ((announcement = this.isAnnouncement) != null ? announcement.equals(deleteMentionUserMembership.isAnnouncement) : deleteMentionUserMembership.isAnnouncement == null) && this.commentedById.equals(deleteMentionUserMembership.commentedById) && ((str2 = this.createdAt) != null ? str2.equals(deleteMentionUserMembership.createdAt) : deleteMentionUserMembership.createdAt == null) && ((str3 = this.updatedAt) != null ? str3.equals(deleteMentionUserMembership.updatedAt) : deleteMentionUserMembership.updatedAt == null) && ((comment = this.comment) != null ? comment.equals(deleteMentionUserMembership.comment) : deleteMentionUserMembership.comment == null)) {
                CommentedBy commentedBy = this.commentedBy;
                CommentedBy commentedBy2 = deleteMentionUserMembership.commentedBy;
                if (commentedBy == null) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteMentionUserMembershipMutation.DeleteMentionUserMembership.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteMentionUserMembership.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteMentionUserMembership.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteMentionUserMembership.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteMentionUserMembership.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], DeleteMentionUserMembership.this.commentId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], DeleteMentionUserMembership.this.mentionedUserId);
                    ResponseField responseField = responseFieldArr[5];
                    Announcement announcement = DeleteMentionUserMembership.this.isAnnouncement;
                    responseWriter.writeString(responseField, announcement != null ? announcement.name() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], DeleteMentionUserMembership.this.commentedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], DeleteMentionUserMembership.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], DeleteMentionUserMembership.this.updatedAt);
                    ResponseField responseField2 = responseFieldArr[9];
                    Comment comment = DeleteMentionUserMembership.this.comment;
                    ...
                    CommentedBy commentedBy = DeleteMentionUserMembership.this.commentedBy;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "DeleteMentionUserMembership{__typename=" + this.__typename + ", id=" + this.id + ", accountId=" + this.accountId + ", commentId=" + this.commentId + ", mentionedUserId=" + this.mentionedUserId + ", isAnnouncement=" + this.isAnnouncement + ", commentedById=" + this.commentedById + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", comment=" + this.comment + ", commentedBy=" + this.commentedBy + "}";
            }
            return this.$toString;
        }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final DeleteMentionUserMembershipInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteMentionUserMembershipInput deleteMentionUserMembershipInput, ModelMentionUserMembershipConditionInput modelMentionUserMembershipConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteMentionUserMembershipInput;
            this.condition = modelMentionUserMembershipConditionInput;
            linkedHashMap.put("input", deleteMentionUserMembershipInput);
        ...
        public DeleteMentionUserMembershipInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteMentionUserMembershipMutation.Variables.1
    ...
    public DeleteMentionUserMembershipMutation(DeleteMentionUserMembershipInput deleteMentionUserMembershipInput, ModelMentionUserMembershipConditionInput modelMentionUserMembershipConditionInput) {
        Utils.checkNotNull(deleteMentionUserMembershipInput, "input == null");
        this.variables = new Variables(deleteMentionUserMembershipInput, modelMentionUserMembershipConditionInput);
    }
    ...
    public String operationId() {
        return "6b2588d3a276f87ce0f0a1f7b932298e8b1e2963c28255912e16b3648e1d3711";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteMentionUserMembership($input: DeleteMentionUserMembershipInput!, $condition: ModelMentionUserMembershipConditionInput) {\n  deleteMentionUserMembership(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    commentId\n    mentionedUserId\n    isAnnouncement\n    commentedById\n    createdAt\n    updatedAt\n    comment {\n      __typename\n      id\n      accountId\n      ownerId\n      body\n      engagementId\n      activityId\n      parentEngagementId\n      createdAt\n      updatedAt\n    }\n    commentedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
