...
public final class GetWabaByAccountQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetWabaByAccount($accountId: ID, $sortDirection: ModelSortDirection, $filter: ModelWabaAccountFilterInput, $limit: Int, $nextToken: String) {\n  getWabaByAccount(accountId: $accountId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      wabaAccountId\n      wabaAccountName\n      accessToken\n      accountId\n      remainingFreeTierConversationsOverall\n      remainingBalanceOverall\n      remainingBalanceBroadcast\n      blockedBalanceOverall\n      blockedBalanceBroadcast\n      promptForPaymentThreshold\n      createdAt\n      updatedAt\n      currentLimitCategory\n      maxDailyConversationPerPhone\n      maxPhoneNumbersPerBusiness\n      maxPhoneNumbersPerWaba\n      wabaBanState\n      wabaBanDate\n      wabaDecision\n      wabaDecisionTime\n      rejectionReason\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaByAccountQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetWabaByAccount";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetWabaByAccount($accountId: ID, $sortDirection: ModelSortDirection, $filter: ModelWabaAccountFilterInput, $limit: Int, $nextToken: String) {\n  getWabaByAccount(accountId: $accountId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      wabaAccountId\n      wabaAccountName\n      accessToken\n      accountId\n      remainingFreeTierConversationsOverall\n      remainingBalanceOverall\n      remainingBalanceBroadcast\n      blockedBalanceOverall\n      blockedBalanceBroadcast\n      promptForPaymentThreshold\n      createdAt\n      updatedAt\n      currentLimitCategory\n      maxDailyConversationPerPhone\n      maxPhoneNumbersPerBusiness\n      maxPhoneNumbersPerWaba\n      wabaBanState\n      wabaBanDate\n      wabaDecision\n      wabaDecisionTime\n      rejectionReason\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetWabaByAccountQuery build() {
            return new GetWabaByAccountQuery(this.accountId, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getWabaByAccount", "getWabaByAccount", new UnmodifiableMapBuilder(5).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetWabaByAccount getWabaByAccount;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetWabaByAccount.Mapper getWabaByAccountFieldMapper = new GetWabaByAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetWabaByAccount) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetWabaByAccount>() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaByAccountQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetWabaByAccount read(ResponseReader responseReader2) {
                        return Mapper.this.getWabaByAccountFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetWabaByAccount getWabaByAccount) {
            this.getWabaByAccount = getWabaByAccount;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetWabaByAccount getWabaByAccount = this.getWabaByAccount;
            GetWabaByAccount getWabaByAccount2 = ((Data) obj).getWabaByAccount;
            return getWabaByAccount == null ? getWabaByAccount2 == null : getWabaByAccount.equals(getWabaByAccount2);
        }

        public GetWabaByAccount getWabaByAccount() {
            return this.getWabaByAccount;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetWabaByAccount getWabaByAccount = this.getWabaByAccount;
                this.$hashCode = (getWabaByAccount == null ? 0 : getWabaByAccount.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaByAccountQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetWabaByAccount getWabaByAccount = Data.this.getWabaByAccount;
                    responseWriter.writeObject(responseField, getWabaByAccount != null ? getWabaByAccount.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getWabaByAccount=" + this.getWabaByAccount + "}";
            }
            return this.$toString;
        }
    }

    public static class GetWabaByAccount {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetWabaByAccount> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetWabaByAccount map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetWabaByAccount.$responseFields;
                return new GetWabaByAccount(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaByAccountQuery.GetWabaByAccount.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaByAccountQuery.GetWabaByAccount.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetWabaByAccount(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetWabaByAccount)) {
                return false;
            }
            GetWabaByAccount getWabaByAccount = (GetWabaByAccount) obj;
            if (this.__typename.equals(getWabaByAccount.__typename) && this.items.equals(getWabaByAccount.items)) {
                String str = this.nextToken;
                String str2 = getWabaByAccount.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaByAccountQuery.GetWabaByAccount.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetWabaByAccount.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetWabaByAccount.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetWabaByAccount.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaByAccountQuery.GetWabaByAccount.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetWabaByAccount.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetWabaByAccount{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaByAccountQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaByAccountQuery.Variables.1
    ...
    public GetWabaByAccountQuery(String str, ModelSortDirection modelSortDirection, ModelWabaAccountFilterInput modelWabaAccountFilterInput, Integer num, String str2) {
    ...
    public String operationId() {
        return "9795ab93a31c0b11e952e02efde044b1f76c55febd6f7bdb212ed0dd62965528";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetWabaByAccount($accountId: ID, $sortDirection: ModelSortDirection, $filter: ModelWabaAccountFilterInput, $limit: Int, $nextToken: String) {\n  getWabaByAccount(accountId: $accountId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      wabaAccountId\n      wabaAccountName\n      accessToken\n      accountId\n      remainingFreeTierConversationsOverall\n      remainingBalanceOverall\n      remainingBalanceBroadcast\n      blockedBalanceOverall\n      blockedBalanceBroadcast\n      promptForPaymentThreshold\n      createdAt\n      updatedAt\n      currentLimitCategory\n      maxDailyConversationPerPhone\n      maxPhoneNumbersPerBusiness\n      maxPhoneNumbersPerWaba\n      wabaBanState\n      wabaBanDate\n      wabaDecision\n      wabaDecisionTime\n      rejectionReason\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    }
