...
public final class GetStagedLeadQuery implements Query<Data, Data, Variables> {
    ...
    public static class Contact {
        ...
        public static final class Mapper implements ResponseFieldMapper<Contact> {
            ...
            public Contact map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[5], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Contact.Mapper.1
                ...
                List list2 = responseReader.readList(responseFieldArr[7], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Contact.Mapper.2
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                ...
                List list3 = responseReader.readList(responseFieldArr[34], new ResponseReader.ListReader<Day>() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Contact.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                ...
                List list4 = responseReader.readList(responseFieldArr[92], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Contact.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                });
                List list5 = responseReader.readList(responseFieldArr[93], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Contact.Mapper.5
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                ...
                List list6 = responseReader.readList(responseFieldArr[97], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Contact.Mapper.6
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Contact.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], Contact.this.sharedOwners, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Contact.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[7], Contact.this.sharedTeams, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Contact.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[34], Contact.this.preferredContactDays, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Contact.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[92], Contact.this.userDefinedTags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Contact.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[93], Contact.this.productService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Contact.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[97], Contact.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Contact.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getStagedLead", "getStagedLead", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetStagedLead getStagedLead;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetStagedLead.Mapper getStagedLeadFieldMapper = new GetStagedLead.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetStagedLead) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetStagedLead>() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetStagedLead read(ResponseReader responseReader2) {
                        return Mapper.this.getStagedLeadFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetStagedLead getStagedLead) {
            this.getStagedLead = getStagedLead;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetStagedLead getStagedLead = this.getStagedLead;
            GetStagedLead getStagedLead2 = ((Data) obj).getStagedLead;
            return getStagedLead == null ? getStagedLead2 == null : getStagedLead.equals(getStagedLead2);
        }

        public GetStagedLead getStagedLead() {
            return this.getStagedLead;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetStagedLead getStagedLead = this.getStagedLead;
                this.$hashCode = (getStagedLead == null ? 0 : getStagedLead.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetStagedLead getStagedLead = Data.this.getStagedLead;
                    responseWriter.writeObject(responseField, getStagedLead != null ? getStagedLead.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getStagedLead=" + this.getStagedLead + "}";
            }
            return this.$toString;
        }
    }

    public static class GetStagedLead {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public GetStagedLead(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, List<String> list, String str16, String str17, String str18, String str19, Contact contact) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
            this.network = str4;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetStagedLead)) {
                return false;
            }
            GetStagedLead getStagedLead = (GetStagedLead) obj;
            if (this.__typename.equals(getStagedLead.__typename) && this.id.equals(getStagedLead.id) && this.accountId.equals(getStagedLead.accountId) && ((str = this.network) != null ? str.equals(getStagedLead.network) : getStagedLead.network == null) && ((str2 = this.messageType) != null ? str2.equals(getStagedLead.messageType) : getStagedLead.messageType == null) && ((str3 = this.logId) != null ? str3.equals(getStagedLead.logId) : getStagedLead.logId == null) && ((str4 = this.messageId) != null ? str4.equals(getStagedLead.messageId) : getStagedLead.messageId == null) && ((str5 = this.mailFrom) != null ? str5.equals(getStagedLead.mailFrom) : getStagedLead.mailFrom == null) && ((str6 = this.mailTo) != null ? str6.equals(getStagedLead.mailTo) : getStagedLead.mailTo == null) && ((str7 = this.mailSubject) != null ? str7.equals(getStagedLead.mailSubject) : getStagedLead.mailSubject == null) && ((str8 = this.snippet) != null ? str8.equals(getStagedLead.snippet) : getStagedLead.snippet == null) && ((str9 = this.messageDate) != null ? str9.equals(getStagedLead.messageDate) : getStagedLead.messageDate == null) && ((str10 = this.viewedAt) != null ? str10.equals(getStagedLead.viewedAt) : getStagedLead.viewedAt == null) && ((str11 = this.leadCreatedAt) != null ? str11.equals(getStagedLead.leadCreatedAt) : getStagedLead.leadCreatedAt == null) && ((str12 = this.contactId) != null ? str12.equals(getStagedLead.contactId) : getStagedLead.contactId == null) && ((list = this.tags) != null ? list.equals(getStagedLead.tags) : getStagedLead.tags == null) && ((str13 = this.entityListId) != null ? str13.equals(getStagedLead.entityListId) : getStagedLead.entityListId == null) && ((str14 = this.createdById) != null ? str14.equals(getStagedLead.createdById) : getStagedLead.createdById == null) && ((str15 = this.createdAt) != null ? str15.equals(getStagedLead.createdAt) : getStagedLead.createdAt == null) && ((str16 = this.updatedAt) != null ? str16.equals(getStagedLead.updatedAt) : getStagedLead.updatedAt == null)) {
                Contact contact = this.contact;
                Contact contact2 = getStagedLead.contact;
                if (contact == null) {
                    if (contact2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.GetStagedLead.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetStagedLead.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetStagedLead.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetStagedLead.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetStagedLead.this.accountId);
                    responseWriter.writeString(responseFieldArr[3], GetStagedLead.this.network);
                    responseWriter.writeString(responseFieldArr[4], GetStagedLead.this.messageType);
                    responseWriter.writeString(responseFieldArr[5], GetStagedLead.this.logId);
                    responseWriter.writeString(responseFieldArr[6], GetStagedLead.this.messageId);
                    responseWriter.writeString(responseFieldArr[7], GetStagedLead.this.mailFrom);
                    responseWriter.writeString(responseFieldArr[8], GetStagedLead.this.mailTo);
                    responseWriter.writeString(responseFieldArr[9], GetStagedLead.this.mailSubject);
                    responseWriter.writeString(responseFieldArr[10], GetStagedLead.this.snippet);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], GetStagedLead.this.messageDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], GetStagedLead.this.viewedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], GetStagedLead.this.leadCreatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], GetStagedLead.this.contactId);
                    responseWriter.writeList(responseFieldArr[15], GetStagedLead.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.GetStagedLead.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], GetStagedLead.this.entityListId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], GetStagedLead.this.createdById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], GetStagedLead.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], GetStagedLead.this.updatedAt);
                    ResponseField responseField = responseFieldArr[20];
                    Contact contact = GetStagedLead.this.contact;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetStagedLeadQuery.Variables.1
    ...
    public GetStagedLeadQuery(String str) {
    ...
    public String operationId() {
        return "069043b2c15c9fd7b71c66ca92decbe0e1c92b7bf1684efb6ea8191dbe21fd3a";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetStagedLead($id: ID!) {\n  getStagedLead(id: $id) {\n    __typename\n    id\n    accountId\n    network\n    messageType\n    logId\n    messageId\n    mailFrom\n    mailTo\n    mailSubject\n    snippet\n    messageDate\n    viewedAt\n    leadCreatedAt\n    contactId\n    tags\n    entityListId\n    createdById\n    createdAt\n    updatedAt\n    contact {\n      __typename\n      id\n      accountId\n      ownerId\n      toBeAssigned\n      sharedOwners\n      primaryTeamId\n      sharedTeams\n      accountPriority\n      addedById\n      assignedToId\n      blockedForCallById\n      blockedForCallReason\n      blockedForCallUntil\n      callPriority\n      waChatChannelId\n      contactSource\n      contactSourceDrillDownOne\n      contactSourceDrillDownTwo\n      contactSourceDrillDownThree\n      contactSourceDrillDownOneId\n      contactSourceDrillDownTwoId\n      contactSourceDrillDownThreeId\n      contactStatus\n      contactType\n      department\n      designation\n      lastRepeatEnquiryDate\n      lastRepeatEnquirySource\n      gender\n      isDecisionMaker\n      isPrivate\n      lockPeriod\n      name\n      preferredContactDays\n      profilePhotoUrl\n      referredBy\n      salutation\n      seniority\n      updatedById\n      hasTask\n      openTaskActivityType\n      lastCalledTime\n      lastCallDirection\n      lastCallOutcome\n      lastCallOutcomeNature\n      lastCallUserId\n      lastCallDuration\n      lastCallEngagementId\n      lastVisitTime\n      lastVisitOutcome\n      lastVisitOutcomeNature\n      lastVisitUserId\n      lastVisitEngagementId\n      lastEmailTime\n      lastEmailUserId\n      lastEmailEngagementId\n      lastWhatsappTime\n      lastWhatsappUserId\n      lastWhatsappEngagementId\n      lastWabaBroadcastTime\n      lastWabaBroadcastStatus\n      lastWabaBroadcastTemplate\n      lastWabaBroadcastReplyBody\n      lastWabaBroadcastReplyTime\n      lastWabaBroadcastReplyType\n      lastSmsTime\n      lastSmsUserId\n      lastSmsEngagementId\n      lastNoteAddedTime\n      lastNoteUserId\n      lastNoteEngagementId\n      lastTaskDoneTime\n      lastTaskDoneUserId\n      lastTaskDoneEngagementId\n      openTaskCount\n      lastKnownDisposition\n      lastKnownDispositionTime\n      lastLeadAssignmentDateTime\n      lastEngagementFromAccount\n      lastEngagementFromContact\n      freshLeadTag\n      noWorkAfterAssignment\n      needFollowUpTag\n      needFollowUpTagUpdatedAt\n      activeDealStage\n      activeDealStageUpdatedAt\n      dealDescription\n      isCustomer\n      becameCustomerOn\n      unsuccessfulCallAttempts\n      leadCallsNotAnswered\n      userDefinedTags\n      productService\n      bulkUploadReference\n      assignmentMethod\n      whatsappOptInStatus\n      recentEngagements\n      recentEngagementsUpdatedAt\n      openTaskDetail\n      openVideoCallDetail\n      lastClosedTaskDetail\n      lastClosedTaskDetailUpdatedAt\n      latestRemark\n      customAttributes\n      paymentRequestDetail\n      lastPaymentStatus\n      customDataAddedFromAddContactForm\n      leadLifecycleStage\n      leadLifecycleStageSubCategory\n      manualClosedReason\n      lastDealStageType\n      prospectingAttempts\n      totalProspectingAttemptsAcrossRechurn\n      numberOfTimesRechurned\n      lastProspectingDoneOn\n      firstProspectingDoneOn\n      nextProspectingDueOn\n      nextProspectingSetBy\n      nextProspectingNote\n      movedToOpportunityOn\n      movedToClosedOn\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
