...
public final class ListFileObjectRelationshipsQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListFileObjectRelationships($filter: ModelfileObjectRelationshipFilterInput, $limit: Int, $nextToken: String) {\n  listFileObjectRelationships(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      fileId\n      fileUrl\n      contactId\n      engagementId\n      businessId\n      dealId\n      productId\n      createdAt\n      updatedAt\n      parentObjectId\n      parentObjectType\n      fieldName\n      inputContext\n      transcription\n      translatedTranscription\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListFileObjectRelationshipsQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListFileObjectRelationships";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListFileObjectRelationships($filter: ModelfileObjectRelationshipFilterInput, $limit: Int, $nextToken: String) {\n  listFileObjectRelationships(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      fileId\n      fileUrl\n      contactId\n      engagementId\n      businessId\n      dealId\n      productId\n      createdAt\n      updatedAt\n      parentObjectId\n      parentObjectType\n      fieldName\n      inputContext\n      transcription\n      translatedTranscription\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public ListFileObjectRelationshipsQuery build() {
            return new ListFileObjectRelationshipsQuery(this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listFileObjectRelationships", "listFileObjectRelationships", new UnmodifiableMapBuilder(3).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListFileObjectRelationships listFileObjectRelationships;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListFileObjectRelationships.Mapper listFileObjectRelationshipsFieldMapper = new ListFileObjectRelationships.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListFileObjectRelationships) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListFileObjectRelationships>() { // from class: com.amazonaws.amplify.generated.graphql.ListFileObjectRelationshipsQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListFileObjectRelationships read(ResponseReader responseReader2) {
                        return Mapper.this.listFileObjectRelationshipsFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListFileObjectRelationships listFileObjectRelationships) {
            this.listFileObjectRelationships = listFileObjectRelationships;
        }
        ...
        public boolean equals(Object obj) {
            ...
            ListFileObjectRelationships listFileObjectRelationships = this.listFileObjectRelationships;
            ListFileObjectRelationships listFileObjectRelationships2 = ((Data) obj).listFileObjectRelationships;
            return listFileObjectRelationships == null ? listFileObjectRelationships2 == null : listFileObjectRelationships.equals(listFileObjectRelationships2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListFileObjectRelationships listFileObjectRelationships = this.listFileObjectRelationships;
                this.$hashCode = (listFileObjectRelationships == null ? 0 : listFileObjectRelationships.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListFileObjectRelationships listFileObjectRelationships() {
            return this.listFileObjectRelationships;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListFileObjectRelationshipsQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListFileObjectRelationships listFileObjectRelationships = Data.this.listFileObjectRelationships;
                    responseWriter.writeObject(responseField, listFileObjectRelationships != null ? listFileObjectRelationships.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listFileObjectRelationships=" + this.listFileObjectRelationships + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListFileObjectRelationshipsQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static class ListFileObjectRelationships {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListFileObjectRelationships> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListFileObjectRelationships map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListFileObjectRelationships.$responseFields;
                return new ListFileObjectRelationships(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListFileObjectRelationshipsQuery.ListFileObjectRelationships.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListFileObjectRelationshipsQuery.ListFileObjectRelationships.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListFileObjectRelationships(String str, List<Item> list, String str2) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListFileObjectRelationships)) {
                return false;
            }
            ListFileObjectRelationships listFileObjectRelationships = (ListFileObjectRelationships) obj;
            if (this.__typename.equals(listFileObjectRelationships.__typename) && this.items.equals(listFileObjectRelationships.items)) {
                String str = this.nextToken;
                String str2 = listFileObjectRelationships.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListFileObjectRelationshipsQuery.ListFileObjectRelationships.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListFileObjectRelationships.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListFileObjectRelationships.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListFileObjectRelationships.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListFileObjectRelationshipsQuery.ListFileObjectRelationships.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListFileObjectRelationships.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListFileObjectRelationships{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(ModelfileObjectRelationshipFilterInput modelfileObjectRelationshipFilterInput, Integer num, String str) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListFileObjectRelationshipsQuery.Variables.1
    ...
    public ListFileObjectRelationshipsQuery(ModelfileObjectRelationshipFilterInput modelfileObjectRelationshipFilterInput, Integer num, String str) {
        this.variables = new Variables(modelfileObjectRelationshipFilterInput, num, str);
    }
    ...
    public String operationId() {
        return "417991950998de4442808428b8e0764c1aa336aa3eda11d1d83526a19cbd200c";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListFileObjectRelationships($filter: ModelfileObjectRelationshipFilterInput, $limit: Int, $nextToken: String) {\n  listFileObjectRelationships(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      fileId\n      fileUrl\n      contactId\n      engagementId\n      businessId\n      dealId\n      productId\n      createdAt\n      updatedAt\n      parentObjectId\n      parentObjectType\n      fieldName\n      inputContext\n      transcription\n      translatedTranscription\n    }\n    nextToken\n  }\n}";
    }
