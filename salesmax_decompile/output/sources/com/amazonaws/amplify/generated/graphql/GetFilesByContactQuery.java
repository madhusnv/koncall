...
public final class GetFilesByContactQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetFilesByContact($contactId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelfileObjectRelationshipFilterInput, $limit: Int, $nextToken: String) {\n  getFilesByContact(contactId: $contactId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      fileId\n      fileUrl\n      contactId\n      engagementId\n      businessId\n      dealId\n      productId\n      createdAt\n      updatedAt\n      parentObjectId\n      parentObjectType\n      fieldName\n      inputContext\n      transcription\n      translatedTranscription\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByContactQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetFilesByContact";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetFilesByContact($contactId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelfileObjectRelationshipFilterInput, $limit: Int, $nextToken: String) {\n  getFilesByContact(contactId: $contactId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      fileId\n      fileUrl\n      contactId\n      engagementId\n      businessId\n      dealId\n      productId\n      createdAt\n      updatedAt\n      parentObjectId\n      parentObjectType\n      fieldName\n      inputContext\n      transcription\n      translatedTranscription\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetFilesByContactQuery build() {
            return new GetFilesByContactQuery(this.contactId, this.updatedAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getFilesByContact", "getFilesByContact", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put("contactId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "contactId").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("updatedAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "updatedAt").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetFilesByContact getFilesByContact;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetFilesByContact.Mapper getFilesByContactFieldMapper = new GetFilesByContact.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetFilesByContact) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetFilesByContact>() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByContactQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetFilesByContact read(ResponseReader responseReader2) {
                        return Mapper.this.getFilesByContactFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetFilesByContact getFilesByContact) {
            this.getFilesByContact = getFilesByContact;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetFilesByContact getFilesByContact = this.getFilesByContact;
            GetFilesByContact getFilesByContact2 = ((Data) obj).getFilesByContact;
            return getFilesByContact == null ? getFilesByContact2 == null : getFilesByContact.equals(getFilesByContact2);
        }

        public GetFilesByContact getFilesByContact() {
            return this.getFilesByContact;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetFilesByContact getFilesByContact = this.getFilesByContact;
                this.$hashCode = (getFilesByContact == null ? 0 : getFilesByContact.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByContactQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetFilesByContact getFilesByContact = Data.this.getFilesByContact;
                    responseWriter.writeObject(responseField, getFilesByContact != null ? getFilesByContact.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getFilesByContact=" + this.getFilesByContact + "}";
            }
            return this.$toString;
        }
    }

    public static class GetFilesByContact {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetFilesByContact> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetFilesByContact map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetFilesByContact.$responseFields;
                return new GetFilesByContact(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByContactQuery.GetFilesByContact.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByContactQuery.GetFilesByContact.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetFilesByContact(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetFilesByContact)) {
                return false;
            }
            GetFilesByContact getFilesByContact = (GetFilesByContact) obj;
            if (this.__typename.equals(getFilesByContact.__typename) && this.items.equals(getFilesByContact.items)) {
                String str = this.nextToken;
                String str2 = getFilesByContact.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByContactQuery.GetFilesByContact.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetFilesByContact.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetFilesByContact.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetFilesByContact.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByContactQuery.GetFilesByContact.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetFilesByContact.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetFilesByContact{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByContactQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByContactQuery.Variables.1
    ...
    public GetFilesByContactQuery(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelfileObjectRelationshipFilterInput modelfileObjectRelationshipFilterInput, Integer num, String str2) {
    ...
    public String operationId() {
        return "1f23275a37ffb80bafbae8b8df8d454ecc286025a8ffb45d5857d9df2a9f988b";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetFilesByContact($contactId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelfileObjectRelationshipFilterInput, $limit: Int, $nextToken: String) {\n  getFilesByContact(contactId: $contactId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      fileId\n      fileUrl\n      contactId\n      engagementId\n      businessId\n      dealId\n      productId\n      createdAt\n      updatedAt\n      parentObjectId\n      parentObjectType\n      fieldName\n      inputContext\n      transcription\n      translatedTranscription\n    }\n    nextToken\n  }\n}";
    }
