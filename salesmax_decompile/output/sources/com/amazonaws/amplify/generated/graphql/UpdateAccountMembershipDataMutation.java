...
public final class UpdateAccountMembershipDataMutation implements Mutation<Data, Data, Variables> {
    ...
    public static class Account {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.Account.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[15], Account.this.productOrService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.Account.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[39], Account.this.permissions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.Account.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[45], Account.this.salesmaxSalesContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.Account.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[46], Account.this.salesmaxSupportContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.Account.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[51], Account.this.relatedAccountIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.Account.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class AddedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.AddedBy.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = AddedBy.$responseFields;
    ...
    public static class ApprovedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.ApprovedBy.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ApprovedBy.$responseFields;
    ...
    public static final class Builder {
        ...
        public UpdateAccountMembershipDataMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new UpdateAccountMembershipDataMutation(this.input, this.condition);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("updateAccountMembershipData", "updateAccountMembershipData", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final UpdateAccountMembershipData updateAccountMembershipData;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final UpdateAccountMembershipData.Mapper updateAccountMembershipDataFieldMapper = new UpdateAccountMembershipData.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((UpdateAccountMembershipData) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<UpdateAccountMembershipData>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdateAccountMembershipData read(ResponseReader responseReader2) {
                        return Mapper.this.updateAccountMembershipDataFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(UpdateAccountMembershipData updateAccountMembershipData) {
            this.updateAccountMembershipData = updateAccountMembershipData;
        }
        ...
        public boolean equals(Object obj) {
            ...
            UpdateAccountMembershipData updateAccountMembershipData = this.updateAccountMembershipData;
            UpdateAccountMembershipData updateAccountMembershipData2 = ((Data) obj).updateAccountMembershipData;
            return updateAccountMembershipData == null ? updateAccountMembershipData2 == null : updateAccountMembershipData.equals(updateAccountMembershipData2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                UpdateAccountMembershipData updateAccountMembershipData = this.updateAccountMembershipData;
                this.$hashCode = (updateAccountMembershipData == null ? 0 : updateAccountMembershipData.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    UpdateAccountMembershipData updateAccountMembershipData = Data.this.updateAccountMembershipData;
                    responseWriter.writeObject(responseField, updateAccountMembershipData != null ? updateAccountMembershipData.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{updateAccountMembershipData=" + this.updateAccountMembershipData + "}";
            }
            return this.$toString;
        }

        public UpdateAccountMembershipData updateAccountMembershipData() {
            return this.updateAccountMembershipData;
        }
    }
    ...
    public static class NotificationPreference {
        ...
        public static final class Mapper implements ResponseFieldMapper<NotificationPreference> {
            ...
            public NotificationPreference map(ResponseReader responseReader) {
                ...
                return new NotificationPreference(string, string2 != null ? ActivityType.valueOf(string2) : null, responseReader.readList(responseFieldArr[2], new ResponseReader.ListReader<Channels>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.NotificationPreference.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.NotificationPreference.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = NotificationPreference.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[2], NotificationPreference.this.channels, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.NotificationPreference.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class UpdateAccountMembershipData {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<UpdateAccountMembershipData> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public UpdateAccountMembershipData map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = UpdateAccountMembershipData.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
                String str3 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]);
                List list = responseReader.readList(responseFieldArr[4], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.UpdateAccountMembershipData.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                ...
                }), (User) responseReader.readObject(responseFieldArr[42], new ResponseReader.ObjectReader<User>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.UpdateAccountMembershipData.Mapper.4
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public User read(ResponseReader responseReader2) {
                        return Mapper.this.userFieldMapper.map(responseReader2);
                    }
                }), (AddedBy) responseReader.readObject(responseFieldArr[43], new ResponseReader.ObjectReader<AddedBy>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.UpdateAccountMembershipData.Mapper.5
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public AddedBy read(ResponseReader responseReader2) {
                        return Mapper.this.addedByFieldMapper.map(responseReader2);
                    }
                }), (UpdatedBy) responseReader.readObject(responseFieldArr[44], new ResponseReader.ObjectReader<UpdatedBy>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.UpdateAccountMembershipData.Mapper.6
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdatedBy read(ResponseReader responseReader2) {
                        return Mapper.this.updatedByFieldMapper.map(responseReader2);
                    }
                }), (ApprovedBy) responseReader.readObject(responseFieldArr[45], new ResponseReader.ObjectReader<ApprovedBy>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.UpdateAccountMembershipData.Mapper.7
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateAccountMembershipData)) {
                return false;
            }
            UpdateAccountMembershipData updateAccountMembershipData = (UpdateAccountMembershipData) obj;
            if (this.__typename.equals(updateAccountMembershipData.__typename) && this.id.equals(updateAccountMembershipData.id) && this.accountId.equals(updateAccountMembershipData.accountId) && this.userId.equals(updateAccountMembershipData.userId) && ((list = this.allowedDeviceId) != null ? list.equals(updateAccountMembershipData.allowedDeviceId) : updateAccountMembershipData.allowedDeviceId == null) && ((str = this.designation) != null ? str.equals(updateAccountMembershipData.designation) : updateAccountMembershipData.designation == null) && this.authorizationLevel.equals(updateAccountMembershipData.authorizationLevel) && ((str2 = this.signature) != null ? str2.equals(updateAccountMembershipData.signature) : updateAccountMembershipData.signature == null) && ((bool = this.isBillingMember) != null ? bool.equals(updateAccountMembershipData.isBillingMember) : updateAccountMembershipData.isBillingMember == null) && ((str3 = this.addedById) != null ? str3.equals(updateAccountMembershipData.addedById) : updateAccountMembershipData.addedById == null) && ((str4 = this.updatedById) != null ? str4.equals(updateAccountMembershipData.updatedById) : updateAccountMembershipData.updatedById == null) && ((str5 = this.addedOn) != null ? str5.equals(updateAccountMembershipData.addedOn) : updateAccountMembershipData.addedOn == null) && ((str6 = this.approvedById) != null ? str6.equals(updateAccountMembershipData.approvedById) : updateAccountMembershipData.approvedById == null) && ((str7 = this.approvedOn) != null ? str7.equals(updateAccountMembershipData.approvedOn) : updateAccountMembershipData.approvedOn == null) && ((str8 = this.acceptedOn) != null ? str8.equals(updateAccountMembershipData.acceptedOn) : updateAccountMembershipData.acceptedOn == null) && this.userAccountStatus.equals(updateAccountMembershipData.userAccountStatus) && ((str9 = this.whatsappApiAccess) != null ? str9.equals(updateAccountMembershipData.whatsappApiAccess) : updateAccountMembershipData.whatsappApiAccess == null) && ((str10 = this.sharedInboxPermission) != null ? str10.equals(updateAccountMembershipData.sharedInboxPermission) : updateAccountMembershipData.sharedInboxPermission == null) && ((str11 = this.canInitiateNewConversation) != null ? str11.equals(updateAccountMembershipData.canInitiateNewConversation) : updateAccountMembershipData.canInitiateNewConversation == null) && ((str12 = this.canCreateWaCampaigns) != null ? str12.equals(updateAccountMembershipData.canCreateWaCampaigns) : updateAccountMembershipData.canCreateWaCampaigns == null) && this.mapRegisteredMobileNumberToAccount == updateAccountMembershipData.mapRegisteredMobileNumberToAccount && this.mapSecondaryMobileNumberToAccount == updateAccountMembershipData.mapSecondaryMobileNumberToAccount && ((str13 = this.accountEmail) != null ? str13.equals(updateAccountMembershipData.accountEmail) : updateAccountMembershipData.accountEmail == null) && ((bool2 = this.accountEmailVerified) != null ? bool2.equals(updateAccountMembershipData.accountEmailVerified) : updateAccountMembershipData.accountEmailVerified == null) && ((list2 = this.notificationPreferences) != null ? list2.equals(updateAccountMembershipData.notificationPreferences) : updateAccountMembershipData.notificationPreferences == null) && ((str14 = this.migrateToUserIdOnRemoval) != null ? str14.equals(updateAccountMembershipData.migrateToUserIdOnRemoval) : updateAccountMembershipData.migrateToUserIdOnRemoval == null) && ((bool3 = this.prefScreenPop) != null ? bool3.equals(updateAccountMembershipData.prefScreenPop) : updateAccountMembershipData.prefScreenPop == null) && ((bool4 = this.prefSaveBusinessCall) != null ? bool4.equals(updateAccountMembershipData.prefSaveBusinessCall) : updateAccountMembershipData.prefSaveBusinessCall == null) && ((bool5 = this.prefPostCallDisposition) != null ? bool5.equals(updateAccountMembershipData.prefPostCallDisposition) : updateAccountMembershipData.prefPostCallDisposition == null) && ((num = this.prefDefaultSimToCall) != null ? num.equals(updateAccountMembershipData.prefDefaultSimToCall) : updateAccountMembershipData.prefDefaultSimToCall == null) && ((bool6 = this.prefTrackLocationOnActivity) != null ? bool6.equals(updateAccountMembershipData.prefTrackLocationOnActivity) : updateAccountMembershipData.prefTrackLocationOnActivity == null) && ((bool7 = this.prefUseBusinessWhatsapp) != null ? bool7.equals(updateAccountMembershipData.prefUseBusinessWhatsapp) : updateAccountMembershipData.prefUseBusinessWhatsapp == null) && ((bool8 = this.prefTrackAllCalls) != null ? bool8.equals(updateAccountMembershipData.prefTrackAllCalls) : updateAccountMembershipData.prefTrackAllCalls == null) && ((num2 = this.prefTrackAllCallsSpecificSim) != null ? num2.equals(updateAccountMembershipData.prefTrackAllCallsSpecificSim) : updateAccountMembershipData.prefTrackAllCallsSpecificSim == null) && ((bool9 = this.onLeave) != null ? bool9.equals(updateAccountMembershipData.onLeave) : updateAccountMembershipData.onLeave == null) && ((str15 = this.onLeaveTill) != null ? str15.equals(updateAccountMembershipData.onLeaveTill) : updateAccountMembershipData.onLeaveTill == null) && ((str16 = this.lastViewedChatNotification) != null ? str16.equals(updateAccountMembershipData.lastViewedChatNotification) : updateAccountMembershipData.lastViewedChatNotification == null) && ((str17 = this.prefReadOnlyInfo) != null ? str17.equals(updateAccountMembershipData.prefReadOnlyInfo) : updateAccountMembershipData.prefReadOnlyInfo == null) && ((str18 = this.customMemberAttributes) != null ? str18.equals(updateAccountMembershipData.customMemberAttributes) : updateAccountMembershipData.customMemberAttributes == null) && ((str19 = this.createdAt) != null ? str19.equals(updateAccountMembershipData.createdAt) : updateAccountMembershipData.createdAt == null) && ((str20 = this.updatedAt) != null ? str20.equals(updateAccountMembershipData.updatedAt) : updateAccountMembershipData.updatedAt == null) && ((account = this.account) != null ? account.equals(updateAccountMembershipData.account) : updateAccountMembershipData.account == null) && ((user = this.user) != null ? user.equals(updateAccountMembershipData.user) : updateAccountMembershipData.user == null) && ((addedBy = this.addedBy) != null ? addedBy.equals(updateAccountMembershipData.addedBy) : updateAccountMembershipData.addedBy == null) && ((updatedBy = this.updatedBy) != null ? updatedBy.equals(updateAccountMembershipData.updatedBy) : updateAccountMembershipData.updatedBy == null)) {
                ApprovedBy approvedBy = this.approvedBy;
                ApprovedBy approvedBy2 = updateAccountMembershipData.approvedBy;
                if (approvedBy == null) {
                    if (approvedBy2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.UpdateAccountMembershipData.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdateAccountMembershipData.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UpdateAccountMembershipData.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], UpdateAccountMembershipData.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], UpdateAccountMembershipData.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], UpdateAccountMembershipData.this.userId);
                    responseWriter.writeList(responseFieldArr[4], UpdateAccountMembershipData.this.allowedDeviceId, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.UpdateAccountMembershipData.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[5], UpdateAccountMembershipData.this.designation);
                    responseWriter.writeString(responseFieldArr[6], UpdateAccountMembershipData.this.authorizationLevel.name());
                    responseWriter.writeString(responseFieldArr[7], UpdateAccountMembershipData.this.signature);
                    responseWriter.writeBoolean(responseFieldArr[8], UpdateAccountMembershipData.this.isBillingMember);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], UpdateAccountMembershipData.this.addedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[10], UpdateAccountMembershipData.this.updatedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], UpdateAccountMembershipData.this.addedOn);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], UpdateAccountMembershipData.this.approvedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], UpdateAccountMembershipData.this.approvedOn);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], UpdateAccountMembershipData.this.acceptedOn);
                    responseWriter.writeString(responseFieldArr[15], UpdateAccountMembershipData.this.userAccountStatus.name());
                    responseWriter.writeString(responseFieldArr[16], UpdateAccountMembershipData.this.whatsappApiAccess);
                    responseWriter.writeString(responseFieldArr[17], UpdateAccountMembershipData.this.sharedInboxPermission);
                    responseWriter.writeString(responseFieldArr[18], UpdateAccountMembershipData.this.canInitiateNewConversation);
                    responseWriter.writeString(responseFieldArr[19], UpdateAccountMembershipData.this.canCreateWaCampaigns);
                    responseWriter.writeBoolean(responseFieldArr[20], Boolean.valueOf(UpdateAccountMembershipData.this.mapRegisteredMobileNumberToAccount));
                    responseWriter.writeBoolean(responseFieldArr[21], Boolean.valueOf(UpdateAccountMembershipData.this.mapSecondaryMobileNumberToAccount));
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], UpdateAccountMembershipData.this.accountEmail);
                    responseWriter.writeBoolean(responseFieldArr[23], UpdateAccountMembershipData.this.accountEmailVerified);
                    responseWriter.writeList(responseFieldArr[24], UpdateAccountMembershipData.this.notificationPreferences, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.UpdateAccountMembershipData.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((NotificationPreference) obj).marshaller());
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], UpdateAccountMembershipData.this.migrateToUserIdOnRemoval);
                    responseWriter.writeBoolean(responseFieldArr[26], UpdateAccountMembershipData.this.prefScreenPop);
                    responseWriter.writeBoolean(responseFieldArr[27], UpdateAccountMembershipData.this.prefSaveBusinessCall);
                    responseWriter.writeBoolean(responseFieldArr[28], UpdateAccountMembershipData.this.prefPostCallDisposition);
                    responseWriter.writeInt(responseFieldArr[29], UpdateAccountMembershipData.this.prefDefaultSimToCall);
                    responseWriter.writeBoolean(responseFieldArr[30], UpdateAccountMembershipData.this.prefTrackLocationOnActivity);
                    responseWriter.writeBoolean(responseFieldArr[31], UpdateAccountMembershipData.this.prefUseBusinessWhatsapp);
                    responseWriter.writeBoolean(responseFieldArr[32], UpdateAccountMembershipData.this.prefTrackAllCalls);
                    responseWriter.writeInt(responseFieldArr[33], UpdateAccountMembershipData.this.prefTrackAllCallsSpecificSim);
                    responseWriter.writeBoolean(responseFieldArr[34], UpdateAccountMembershipData.this.onLeave);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[35], UpdateAccountMembershipData.this.onLeaveTill);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[36], UpdateAccountMembershipData.this.lastViewedChatNotification);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[37], UpdateAccountMembershipData.this.prefReadOnlyInfo);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], UpdateAccountMembershipData.this.customMemberAttributes);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[39], UpdateAccountMembershipData.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[40], UpdateAccountMembershipData.this.updatedAt);
                    ResponseField responseField = responseFieldArr[41];
                    Account account = UpdateAccountMembershipData.this.account;
                    ...
                    UpdatedBy updatedBy = UpdateAccountMembershipData.this.updatedBy;
                    ...
                    ApprovedBy approvedBy = UpdateAccountMembershipData.this.approvedBy;
    ...
    public static class UpdatedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.UpdatedBy.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdatedBy.$responseFields;
    ...
    public static class User {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.User.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = User.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMembershipDataMutation.Variables.1
    ...
    public UpdateAccountMembershipDataMutation(UpdateAccountMembershipInput updateAccountMembershipInput, ModelAccountMembershipConditionInput modelAccountMembershipConditionInput) {
    ...
    public String operationId() {
        return "7e7ec3a96a68d964bac774fd6db0e067460e66a9cceffe21211b418518a87601";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation UpdateAccountMembershipData($input: UpdateAccountMembershipInput!, $condition: ModelAccountMembershipConditionInput) {\n  updateAccountMembershipData(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    userId\n    allowedDeviceId\n    designation\n    authorizationLevel\n    signature\n    isBillingMember\n    addedById\n    updatedById\n    addedOn\n    approvedById\n    approvedOn\n    acceptedOn\n    userAccountStatus\n    whatsappApiAccess\n    sharedInboxPermission\n    canInitiateNewConversation\n    canCreateWaCampaigns\n    mapRegisteredMobileNumberToAccount\n    mapSecondaryMobileNumberToAccount\n    accountEmail\n    accountEmailVerified\n    notificationPreferences {\n      __typename\n      notificationType\n      channels\n    }\n    migrateToUserIdOnRemoval\n    prefScreenPop\n    prefSaveBusinessCall\n    prefPostCallDisposition\n    prefDefaultSimToCall\n    prefTrackLocationOnActivity\n    prefUseBusinessWhatsapp\n    prefTrackAllCalls\n    prefTrackAllCallsSpecificSim\n    onLeave\n    onLeaveTill\n    lastViewedChatNotification\n    prefReadOnlyInfo\n    customMemberAttributes\n    createdAt\n    updatedAt\n    account {\n      __typename\n      id\n      accountName\n      accountType\n      deviceKey\n      deviceKeyLastUpdated\n      accountStatus\n      businessLogoUrl\n      createdById\n      dateFormat\n      dateTimeViewStyle\n      defaultCurrency\n      denomination\n      industry\n      nameOfBusiness\n      productOrService\n      timeFormat\n      timeZone\n      plan\n      paidUpTo\n      seats\n      freeSeats\n      currentTotalUsers\n      currentActiveUsers\n      extraActiveUsers\n      pricePerSeat\n      allowAddingSeat\n      allowAddingSeatTill\n      seatReductionMarkedForNextCycle\n      billingCurrency\n      billingEmail\n      taxId\n      taxIdType\n      trialAccountEndDate\n      trialExtensionTimes\n      eligibleForExtension\n      paidForTillDate\n      updatedById\n      website\n      permissions\n      enableCustomCharts\n      createdAt\n      updatedAt\n      dealMode\n      openAiApiKey\n      salesmaxSalesContacts\n      salesmaxSupportContacts\n      chatWidgetConfig\n      onboardingStatus\n      integrationNeeded\n      matchingDealId\n      relatedAccountIds\n      lastChurnDate\n      lastChurnReason\n      possibleReactivationDate\n      locationPeriodicFrequency\n      lastPaymentDataId\n      lastPaymentDataCreatedAt\n      nextRenewalDateIfPaid\n      lastPaymentStatus\n      partPaymentAmountIfAny\n    }\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    addedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    approvedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
