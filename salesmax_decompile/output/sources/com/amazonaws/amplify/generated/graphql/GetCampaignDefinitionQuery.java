...
public final class GetCampaignDefinitionQuery implements Query<Data, Data, Variables> {
    ...
    public static class AssociatedList {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.AssociatedList.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[34], AssociatedList.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.AssociatedList.1.1
    ...
    public static final class Builder {
        ...
        public GetCampaignDefinitionQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetCampaignDefinitionQuery(this.id);
        }
    ...
    public static class CampaignOwner {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.CampaignOwner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CampaignOwner.$responseFields;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getCampaignDefinition", "getCampaignDefinition", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetCampaignDefinition getCampaignDefinition;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetCampaignDefinition.Mapper getCampaignDefinitionFieldMapper = new GetCampaignDefinition.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetCampaignDefinition) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetCampaignDefinition>() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetCampaignDefinition read(ResponseReader responseReader2) {
                        return Mapper.this.getCampaignDefinitionFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetCampaignDefinition getCampaignDefinition) {
            this.getCampaignDefinition = getCampaignDefinition;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetCampaignDefinition getCampaignDefinition = this.getCampaignDefinition;
            GetCampaignDefinition getCampaignDefinition2 = ((Data) obj).getCampaignDefinition;
            return getCampaignDefinition == null ? getCampaignDefinition2 == null : getCampaignDefinition.equals(getCampaignDefinition2);
        }

        public GetCampaignDefinition getCampaignDefinition() {
            return this.getCampaignDefinition;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetCampaignDefinition getCampaignDefinition = this.getCampaignDefinition;
                this.$hashCode = (getCampaignDefinition == null ? 0 : getCampaignDefinition.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetCampaignDefinition getCampaignDefinition = Data.this.getCampaignDefinition;
                    responseWriter.writeObject(responseField, getCampaignDefinition != null ? getCampaignDefinition.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getCampaignDefinition=" + this.getCampaignDefinition + "}";
            }
            return this.$toString;
        }
    }

    public static class GetCampaignDefinition {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<GetCampaignDefinition> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetCampaignDefinition map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetCampaignDefinition.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
                String string2 = responseReader.readString(responseFieldArr[3]);
                ...
                List list = responseReader.readList(responseFieldArr[15], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.GetCampaignDefinition.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                });
                List list2 = responseReader.readList(responseFieldArr[16], new ResponseReader.ListReader<TimeSlotToSend>() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.GetCampaignDefinition.Mapper.2
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public TimeSlotToSend read(ResponseReader.ListItemReader listItemReader) {
                        return (TimeSlotToSend) listItemReader.readObject(new ResponseReader.ObjectReader<TimeSlotToSend>() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.GetCampaignDefinition.Mapper.2.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                PrimaryTeam primaryTeam = (PrimaryTeam) responseReader.readObject(responseFieldArr[19], new ResponseReader.ObjectReader<PrimaryTeam>() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.GetCampaignDefinition.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), (CampaignOwner) responseReader.readObject(responseFieldArr[36], new ResponseReader.ObjectReader<CampaignOwner>() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.GetCampaignDefinition.Mapper.6
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetCampaignDefinition(String str, String str2, String str3, String str4, String str5, String str6, String str7, CampaignType campaignType, String str8, String str9, CampaignRunFrequencyUnit campaignRunFrequencyUnit, Integer num, String str10, String str11, Integer num2, List<String> list, List<TimeSlotToSend> list2, String str12, String str13, PrimaryTeam primaryTeam, CampaignStatus campaignStatus, String str14, String str15, Boolean bool, Boolean bool2, Integer num3, Integer num4, Integer num5, Integer num6, Integer num7, Integer num8, List<String> list3, Integer num9, String str16, String str17, AssociatedList associatedList, CampaignOwner campaignOwner) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetCampaignDefinition)) {
                return false;
            }
            GetCampaignDefinition getCampaignDefinition = (GetCampaignDefinition) obj;
            if (this.__typename.equals(getCampaignDefinition.__typename) && this.id.equals(getCampaignDefinition.id) && this.accountId.equals(getCampaignDefinition.accountId) && this.name.equals(getCampaignDefinition.name) && this.description.equals(getCampaignDefinition.description) && ((str = this.campaignCategory) != null ? str.equals(getCampaignDefinition.campaignCategory) : getCampaignDefinition.campaignCategory == null) && ((str2 = this.campaignSubCategory) != null ? str2.equals(getCampaignDefinition.campaignSubCategory) : getCampaignDefinition.campaignSubCategory == null) && this.campaignType.equals(getCampaignDefinition.campaignType) && ((str3 = this.campaignChannelIdentifier) != null ? str3.equals(getCampaignDefinition.campaignChannelIdentifier) : getCampaignDefinition.campaignChannelIdentifier == null) && ((str4 = this.campaignData) != null ? str4.equals(getCampaignDefinition.campaignData) : getCampaignDefinition.campaignData == null) && ((campaignRunFrequencyUnit = this.campaignRunFrequencyUnit) != null ? campaignRunFrequencyUnit.equals(getCampaignDefinition.campaignRunFrequencyUnit) : getCampaignDefinition.campaignRunFrequencyUnit == null) && ((num = this.campaignRunFrequencyValue) != null ? num.equals(getCampaignDefinition.campaignRunFrequencyValue) : getCampaignDefinition.campaignRunFrequencyValue == null) && ((str5 = this.startDateOfRun) != null ? str5.equals(getCampaignDefinition.startDateOfRun) : getCampaignDefinition.startDateOfRun == null) && ((str6 = this.endDateOfRun) != null ? str6.equals(getCampaignDefinition.endDateOfRun) : getCampaignDefinition.endDateOfRun == null) && ((num2 = this.durationOfRunInDays) != null ? num2.equals(getCampaignDefinition.durationOfRunInDays) : getCampaignDefinition.durationOfRunInDays == null) && ((list = this.daysToSend) != null ? list.equals(getCampaignDefinition.daysToSend) : getCampaignDefinition.daysToSend == null) && ((list2 = this.timeSlotToSend) != null ? list2.equals(getCampaignDefinition.timeSlotToSend) : getCampaignDefinition.timeSlotToSend == null) && this.ownerId.equals(getCampaignDefinition.ownerId) && ((str7 = this.primaryTeamId) != null ? str7.equals(getCampaignDefinition.primaryTeamId) : getCampaignDefinition.primaryTeamId == null) && ((primaryTeam = this.primaryTeam) != null ? primaryTeam.equals(getCampaignDefinition.primaryTeam) : getCampaignDefinition.primaryTeam == null) && this.status.equals(getCampaignDefinition.status) && ((str8 = this.systemPauseReason) != null ? str8.equals(getCampaignDefinition.systemPauseReason) : getCampaignDefinition.systemPauseReason == null) && this.associatedEntityListId.equals(getCampaignDefinition.associatedEntityListId) && ((bool = this.includeHistoricalMemberships) != null ? bool.equals(getCampaignDefinition.includeHistoricalMemberships) : getCampaignDefinition.includeHistoricalMemberships == null) && ((bool2 = this.allowMultiple) != null ? bool2.equals(getCampaignDefinition.allowMultiple) : getCampaignDefinition.allowMultiple == null) && ((num3 = this.messageCreated) != null ? num3.equals(getCampaignDefinition.messageCreated) : getCampaignDefinition.messageCreated == null) && ((num4 = this.sentCount) != null ? num4.equals(getCampaignDefinition.sentCount) : getCampaignDefinition.sentCount == null) && ((num5 = this.deliveredCount) != null ? num5.equals(getCampaignDefinition.deliveredCount) : getCampaignDefinition.deliveredCount == null) && ((num6 = this.readCount) != null ? num6.equals(getCampaignDefinition.readCount) : getCampaignDefinition.readCount == null) && ((num7 = this.repliedCount) != null ? num7.equals(getCampaignDefinition.repliedCount) : getCampaignDefinition.repliedCount == null) && ((num8 = this.failedCount) != null ? num8.equals(getCampaignDefinition.failedCount) : getCampaignDefinition.failedCount == null) && ((list3 = this.tags) != null ? list3.equals(getCampaignDefinition.tags) : getCampaignDefinition.tags == null) && ((num9 = this.leadLimit) != null ? num9.equals(getCampaignDefinition.leadLimit) : getCampaignDefinition.leadLimit == null) && ((str9 = this.createdAt) != null ? str9.equals(getCampaignDefinition.createdAt) : getCampaignDefinition.createdAt == null) && ((str10 = this.updatedAt) != null ? str10.equals(getCampaignDefinition.updatedAt) : getCampaignDefinition.updatedAt == null) && ((associatedList = this.associatedList) != null ? associatedList.equals(getCampaignDefinition.associatedList) : getCampaignDefinition.associatedList == null)) {
                CampaignOwner campaignOwner = this.campaignOwner;
                CampaignOwner campaignOwner2 = getCampaignDefinition.campaignOwner;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.GetCampaignDefinition.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetCampaignDefinition.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetCampaignDefinition.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetCampaignDefinition.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetCampaignDefinition.this.accountId);
                    responseWriter.writeString(responseFieldArr[3], GetCampaignDefinition.this.name);
                    responseWriter.writeString(responseFieldArr[4], GetCampaignDefinition.this.description);
                    responseWriter.writeString(responseFieldArr[5], GetCampaignDefinition.this.campaignCategory);
                    responseWriter.writeString(responseFieldArr[6], GetCampaignDefinition.this.campaignSubCategory);
                    responseWriter.writeString(responseFieldArr[7], GetCampaignDefinition.this.campaignType.name());
                    responseWriter.writeString(responseFieldArr[8], GetCampaignDefinition.this.campaignChannelIdentifier);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], GetCampaignDefinition.this.campaignData);
                    ResponseField responseField = responseFieldArr[10];
                    CampaignRunFrequencyUnit campaignRunFrequencyUnit = GetCampaignDefinition.this.campaignRunFrequencyUnit;
                    responseWriter.writeString(responseField, campaignRunFrequencyUnit != null ? campaignRunFrequencyUnit.name() : null);
                    responseWriter.writeInt(responseFieldArr[11], GetCampaignDefinition.this.campaignRunFrequencyValue);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], GetCampaignDefinition.this.startDateOfRun);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], GetCampaignDefinition.this.endDateOfRun);
                    responseWriter.writeInt(responseFieldArr[14], GetCampaignDefinition.this.durationOfRunInDays);
                    responseWriter.writeList(responseFieldArr[15], GetCampaignDefinition.this.daysToSend, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.GetCampaignDefinition.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[16], GetCampaignDefinition.this.timeSlotToSend, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.GetCampaignDefinition.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((TimeSlotToSend) obj).marshaller());
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], GetCampaignDefinition.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], GetCampaignDefinition.this.primaryTeamId);
                    ResponseField responseField2 = responseFieldArr[19];
                    PrimaryTeam primaryTeam = GetCampaignDefinition.this.primaryTeam;
                    responseWriter.writeObject(responseField2, primaryTeam != null ? primaryTeam.marshaller() : null);
                    responseWriter.writeString(responseFieldArr[20], GetCampaignDefinition.this.status.name());
                    responseWriter.writeString(responseFieldArr[21], GetCampaignDefinition.this.systemPauseReason);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], GetCampaignDefinition.this.associatedEntityListId);
                    responseWriter.writeBoolean(responseFieldArr[23], GetCampaignDefinition.this.includeHistoricalMemberships);
                    responseWriter.writeBoolean(responseFieldArr[24], GetCampaignDefinition.this.allowMultiple);
                    responseWriter.writeInt(responseFieldArr[25], GetCampaignDefinition.this.messageCreated);
                    responseWriter.writeInt(responseFieldArr[26], GetCampaignDefinition.this.sentCount);
                    responseWriter.writeInt(responseFieldArr[27], GetCampaignDefinition.this.deliveredCount);
                    responseWriter.writeInt(responseFieldArr[28], GetCampaignDefinition.this.readCount);
                    responseWriter.writeInt(responseFieldArr[29], GetCampaignDefinition.this.repliedCount);
                    responseWriter.writeInt(responseFieldArr[30], GetCampaignDefinition.this.failedCount);
                    responseWriter.writeList(responseFieldArr[31], GetCampaignDefinition.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.GetCampaignDefinition.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeInt(responseFieldArr[32], GetCampaignDefinition.this.leadLimit);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[33], GetCampaignDefinition.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[34], GetCampaignDefinition.this.updatedAt);
                    ResponseField responseField3 = responseFieldArr[35];
                    AssociatedList associatedList = GetCampaignDefinition.this.associatedList;
                    ...
                    CampaignOwner campaignOwner = GetCampaignDefinition.this.campaignOwner;
    ...
    public static class PrimaryTeam {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.PrimaryTeam.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = PrimaryTeam.$responseFields;
    ...
    public static class TimeSlotToSend {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.TimeSlotToSend.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = TimeSlotToSend.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCampaignDefinitionQuery.Variables.1
    ...
    public GetCampaignDefinitionQuery(String str) {
    ...
    public String operationId() {
        return "e733d86ed082820f1cb2ff5d09aaf7b2ec5cf8c5525adae26762f7ffcd7f1806";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetCampaignDefinition($id: ID!) {\n  getCampaignDefinition(id: $id) {\n    __typename\n    id\n    accountId\n    name\n    description\n    campaignCategory\n    campaignSubCategory\n    campaignType\n    campaignChannelIdentifier\n    campaignData\n    campaignRunFrequencyUnit\n    campaignRunFrequencyValue\n    startDateOfRun\n    endDateOfRun\n    durationOfRunInDays\n    daysToSend\n    timeSlotToSend {\n      __typename\n      timeStart\n      timeEnd\n    }\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    status\n    systemPauseReason\n    associatedEntityListId\n    includeHistoricalMemberships\n    allowMultiple\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    tags\n    leadLimit\n    createdAt\n    updatedAt\n    associatedList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n    campaignOwner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
