...
import type.DeleteAccountSubscriptionBillCycleInput;
import type.ModelAccountSubscriptionBillCycleConditionInput;

/* loaded from: classes6.dex */
public final class DeleteAccountSubscriptionBillCycleMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation DeleteAccountSubscriptionBillCycle($input: DeleteAccountSubscriptionBillCycleInput!, $condition: ModelAccountSubscriptionBillCycleConditionInput) {\n  deleteAccountSubscriptionBillCycle(input: $input, condition: $condition) {\n    __typename\n    id\n    productAccountId\n    accountId\n    addedById\n    period\n    lastBillDate\n    nextBillDate\n    createdAt\n    updatedAt\n    productAccount {\n      __typename\n      id\n      accountName\n      accountType\n      deviceKey\n      deviceKeyLastUpdated\n      accountStatus\n      businessLogoUrl\n      createdById\n      dateFormat\n      dateTimeViewStyle\n      defaultCurrency\n      denomination\n      industry\n      nameOfBusiness\n      productOrService\n      timeFormat\n      timeZone\n      plan\n      paidUpTo\n      seats\n      freeSeats\n      currentTotalUsers\n      currentActiveUsers\n      extraActiveUsers\n      pricePerSeat\n      allowAddingSeat\n      allowAddingSeatTill\n      seatReductionMarkedForNextCycle\n      billingCurrency\n      billingEmail\n      taxId\n      taxIdType\n      trialAccountEndDate\n      trialExtensionTimes\n      eligibleForExtension\n      paidForTillDate\n      updatedById\n      website\n      permissions\n      enableCustomCharts\n      createdAt\n      updatedAt\n      dealMode\n      openAiApiKey\n      salesmaxSalesContacts\n      salesmaxSupportContacts\n      chatWidgetConfig\n      onboardingStatus\n      integrationNeeded\n      matchingDealId\n      relatedAccountIds\n      lastChurnDate\n      lastChurnReason\n      possibleReactivationDate\n      locationPeriodicFrequency\n      lastPaymentDataId\n      lastPaymentDataCreatedAt\n      nextRenewalDateIfPaid\n      lastPaymentStatus\n      partPaymentAmountIfAny\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountSubscriptionBillCycleMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "DeleteAccountSubscriptionBillCycle";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation DeleteAccountSubscriptionBillCycle($input: DeleteAccountSubscriptionBillCycleInput!, $condition: ModelAccountSubscriptionBillCycleConditionInput) {\n  deleteAccountSubscriptionBillCycle(input: $input, condition: $condition) {\n    __typename\n    id\n    productAccountId\n    accountId\n    addedById\n    period\n    lastBillDate\n    nextBillDate\n    createdAt\n    updatedAt\n    productAccount {\n      __typename\n      id\n      accountName\n      accountType\n      deviceKey\n      deviceKeyLastUpdated\n      accountStatus\n      businessLogoUrl\n      createdById\n      dateFormat\n      dateTimeViewStyle\n      defaultCurrency\n      denomination\n      industry\n      nameOfBusiness\n      productOrService\n      timeFormat\n      timeZone\n      plan\n      paidUpTo\n      seats\n      freeSeats\n      currentTotalUsers\n      currentActiveUsers\n      extraActiveUsers\n      pricePerSeat\n      allowAddingSeat\n      allowAddingSeatTill\n      seatReductionMarkedForNextCycle\n      billingCurrency\n      billingEmail\n      taxId\n      taxIdType\n      trialAccountEndDate\n      trialExtensionTimes\n      eligibleForExtension\n      paidForTillDate\n      updatedById\n      website\n      permissions\n      enableCustomCharts\n      createdAt\n      updatedAt\n      dealMode\n      openAiApiKey\n      salesmaxSalesContacts\n      salesmaxSupportContacts\n      chatWidgetConfig\n      onboardingStatus\n      integrationNeeded\n      matchingDealId\n      relatedAccountIds\n      lastChurnDate\n      lastChurnReason\n      possibleReactivationDate\n      locationPeriodicFrequency\n      lastPaymentDataId\n      lastPaymentDataCreatedAt\n      nextRenewalDateIfPaid\n      lastPaymentStatus\n      partPaymentAmountIfAny\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelAccountSubscriptionBillCycleConditionInput condition;
        private DeleteAccountSubscriptionBillCycleInput input;

        public DeleteAccountSubscriptionBillCycleMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteAccountSubscriptionBillCycleMutation(this.input, this.condition);
        }

        public Builder condition(ModelAccountSubscriptionBillCycleConditionInput modelAccountSubscriptionBillCycleConditionInput) {
            this.condition = modelAccountSubscriptionBillCycleConditionInput;
            return this;
        }

        public Builder input(DeleteAccountSubscriptionBillCycleInput deleteAccountSubscriptionBillCycleInput) {
            this.input = deleteAccountSubscriptionBillCycleInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteAccountSubscriptionBillCycle", "deleteAccountSubscriptionBillCycle", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final DeleteAccountSubscriptionBillCycle deleteAccountSubscriptionBillCycle;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteAccountSubscriptionBillCycle.Mapper deleteAccountSubscriptionBillCycleFieldMapper = new DeleteAccountSubscriptionBillCycle.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteAccountSubscriptionBillCycle) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteAccountSubscriptionBillCycle>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountSubscriptionBillCycleMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteAccountSubscriptionBillCycle read(ResponseReader responseReader2) {
                        return Mapper.this.deleteAccountSubscriptionBillCycleFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteAccountSubscriptionBillCycle deleteAccountSubscriptionBillCycle) {
            this.deleteAccountSubscriptionBillCycle = deleteAccountSubscriptionBillCycle;
        }

        public DeleteAccountSubscriptionBillCycle deleteAccountSubscriptionBillCycle() {
            return this.deleteAccountSubscriptionBillCycle;
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteAccountSubscriptionBillCycle deleteAccountSubscriptionBillCycle = this.deleteAccountSubscriptionBillCycle;
            DeleteAccountSubscriptionBillCycle deleteAccountSubscriptionBillCycle2 = ((Data) obj).deleteAccountSubscriptionBillCycle;
            return deleteAccountSubscriptionBillCycle == null ? deleteAccountSubscriptionBillCycle2 == null : deleteAccountSubscriptionBillCycle.equals(deleteAccountSubscriptionBillCycle2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteAccountSubscriptionBillCycle deleteAccountSubscriptionBillCycle = this.deleteAccountSubscriptionBillCycle;
                this.$hashCode = (deleteAccountSubscriptionBillCycle == null ? 0 : deleteAccountSubscriptionBillCycle.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountSubscriptionBillCycleMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteAccountSubscriptionBillCycle deleteAccountSubscriptionBillCycle = Data.this.deleteAccountSubscriptionBillCycle;
                    responseWriter.writeObject(responseField, deleteAccountSubscriptionBillCycle != null ? deleteAccountSubscriptionBillCycle.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteAccountSubscriptionBillCycle=" + this.deleteAccountSubscriptionBillCycle + "}";
            }
            return this.$toString;
        }
    }

    public static class DeleteAccountSubscriptionBillCycle {
        ...
        public static final class Mapper implements ResponseFieldMapper<DeleteAccountSubscriptionBillCycle> {
            final ProductAccount.Mapper productAccountFieldMapper = new ProductAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public DeleteAccountSubscriptionBillCycle map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = DeleteAccountSubscriptionBillCycle.$responseFields;
                return new DeleteAccountSubscriptionBillCycle(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[8]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[9]), (ProductAccount) responseReader.readObject(responseFieldArr[10], new ResponseReader.ObjectReader<ProductAccount>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountSubscriptionBillCycleMutation.DeleteAccountSubscriptionBillCycle.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public DeleteAccountSubscriptionBillCycle(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, ProductAccount productAccount) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteAccountSubscriptionBillCycle)) {
                return false;
            }
            DeleteAccountSubscriptionBillCycle deleteAccountSubscriptionBillCycle = (DeleteAccountSubscriptionBillCycle) obj;
            if (this.__typename.equals(deleteAccountSubscriptionBillCycle.__typename) && this.id.equals(deleteAccountSubscriptionBillCycle.id) && this.productAccountId.equals(deleteAccountSubscriptionBillCycle.productAccountId) && this.accountId.equals(deleteAccountSubscriptionBillCycle.accountId) && this.addedById.equals(deleteAccountSubscriptionBillCycle.addedById) && ((str = this.period) != null ? str.equals(deleteAccountSubscriptionBillCycle.period) : deleteAccountSubscriptionBillCycle.period == null) && this.lastBillDate.equals(deleteAccountSubscriptionBillCycle.lastBillDate) && this.nextBillDate.equals(deleteAccountSubscriptionBillCycle.nextBillDate) && this.createdAt.equals(deleteAccountSubscriptionBillCycle.createdAt) && this.updatedAt.equals(deleteAccountSubscriptionBillCycle.updatedAt)) {
                ProductAccount productAccount = this.productAccount;
                ProductAccount productAccount2 = deleteAccountSubscriptionBillCycle.productAccount;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountSubscriptionBillCycleMutation.DeleteAccountSubscriptionBillCycle.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteAccountSubscriptionBillCycle.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteAccountSubscriptionBillCycle.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteAccountSubscriptionBillCycle.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteAccountSubscriptionBillCycle.this.productAccountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], DeleteAccountSubscriptionBillCycle.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], DeleteAccountSubscriptionBillCycle.this.addedById);
                    responseWriter.writeString(responseFieldArr[5], DeleteAccountSubscriptionBillCycle.this.period);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], DeleteAccountSubscriptionBillCycle.this.lastBillDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], DeleteAccountSubscriptionBillCycle.this.nextBillDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], DeleteAccountSubscriptionBillCycle.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], DeleteAccountSubscriptionBillCycle.this.updatedAt);
                    ResponseField responseField = responseFieldArr[10];
                    ProductAccount productAccount = DeleteAccountSubscriptionBillCycle.this.productAccount;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "DeleteAccountSubscriptionBillCycle{__typename=" + this.__typename + ", id=" + this.id + ", productAccountId=" + this.productAccountId + ", accountId=" + this.accountId + ", addedById=" + this.addedById + ", period=" + this.period + ", lastBillDate=" + this.lastBillDate + ", nextBillDate=" + this.nextBillDate + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", productAccount=" + this.productAccount + "}";
            }
            return this.$toString;
        }
    ...
    public static class ProductAccount {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountSubscriptionBillCycleMutation.ProductAccount.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ProductAccount.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[15], ProductAccount.this.productOrService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountSubscriptionBillCycleMutation.ProductAccount.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[39], ProductAccount.this.permissions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountSubscriptionBillCycleMutation.ProductAccount.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[45], ProductAccount.this.salesmaxSalesContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountSubscriptionBillCycleMutation.ProductAccount.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[46], ProductAccount.this.salesmaxSupportContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountSubscriptionBillCycleMutation.ProductAccount.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[51], ProductAccount.this.relatedAccountIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountSubscriptionBillCycleMutation.ProductAccount.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static final class Variables extends Operation.Variables {
        private final ModelAccountSubscriptionBillCycleConditionInput condition;
        private final DeleteAccountSubscriptionBillCycleInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteAccountSubscriptionBillCycleInput deleteAccountSubscriptionBillCycleInput, ModelAccountSubscriptionBillCycleConditionInput modelAccountSubscriptionBillCycleConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteAccountSubscriptionBillCycleInput;
            this.condition = modelAccountSubscriptionBillCycleConditionInput;
            linkedHashMap.put("input", deleteAccountSubscriptionBillCycleInput);
            linkedHashMap.put("condition", modelAccountSubscriptionBillCycleConditionInput);
        }

        public ModelAccountSubscriptionBillCycleConditionInput condition() {
            return this.condition;
        }

        public DeleteAccountSubscriptionBillCycleInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountSubscriptionBillCycleMutation.Variables.1
    ...
    public DeleteAccountSubscriptionBillCycleMutation(DeleteAccountSubscriptionBillCycleInput deleteAccountSubscriptionBillCycleInput, ModelAccountSubscriptionBillCycleConditionInput modelAccountSubscriptionBillCycleConditionInput) {
        Utils.checkNotNull(deleteAccountSubscriptionBillCycleInput, "input == null");
        this.variables = new Variables(deleteAccountSubscriptionBillCycleInput, modelAccountSubscriptionBillCycleConditionInput);
    }
    ...
    public String operationId() {
        return "d6a3cec749dc47c843fab026287a13262e7971b1b31d8eb9e1104a2fd021f67e";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteAccountSubscriptionBillCycle($input: DeleteAccountSubscriptionBillCycleInput!, $condition: ModelAccountSubscriptionBillCycleConditionInput) {\n  deleteAccountSubscriptionBillCycle(input: $input, condition: $condition) {\n    __typename\n    id\n    productAccountId\n    accountId\n    addedById\n    period\n    lastBillDate\n    nextBillDate\n    createdAt\n    updatedAt\n    productAccount {\n      __typename\n      id\n      accountName\n      accountType\n      deviceKey\n      deviceKeyLastUpdated\n      accountStatus\n      businessLogoUrl\n      createdById\n      dateFormat\n      dateTimeViewStyle\n      defaultCurrency\n      denomination\n      industry\n      nameOfBusiness\n      productOrService\n      timeFormat\n      timeZone\n      plan\n      paidUpTo\n      seats\n      freeSeats\n      currentTotalUsers\n      currentActiveUsers\n      extraActiveUsers\n      pricePerSeat\n      allowAddingSeat\n      allowAddingSeatTill\n      seatReductionMarkedForNextCycle\n      billingCurrency\n      billingEmail\n      taxId\n      taxIdType\n      trialAccountEndDate\n      trialExtensionTimes\n      eligibleForExtension\n      paidForTillDate\n      updatedById\n      website\n      permissions\n      enableCustomCharts\n      createdAt\n      updatedAt\n      dealMode\n      openAiApiKey\n      salesmaxSalesContacts\n      salesmaxSupportContacts\n      chatWidgetConfig\n      onboardingStatus\n      integrationNeeded\n      matchingDealId\n      relatedAccountIds\n      lastChurnDate\n      lastChurnReason\n      possibleReactivationDate\n      locationPeriodicFrequency\n      lastPaymentDataId\n      lastPaymentDataCreatedAt\n      nextRenewalDateIfPaid\n      lastPaymentStatus\n      partPaymentAmountIfAny\n    }\n  }\n}";
    }
