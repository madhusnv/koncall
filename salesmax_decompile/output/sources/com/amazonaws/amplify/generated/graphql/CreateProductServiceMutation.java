...
public final class CreateProductServiceMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation CreateProductService($input: CreateProductServiceInput!, $condition: ModelProductServiceConditionInput) {\n  createProductService(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    externalReference {\n      __typename\n      externalReferenceId\n      externalReferenceIdSource\n      externalReferenceSourceDate\n    }\n    name\n    description\n    type\n    measurementUnit\n    incrementBy\n    hsCode\n    skuCode\n    standardPricePerUnit\n    currency\n    parentProductId\n    productPicture\n    startDate\n    endDate\n    isArchived\n    createdBy\n    updatedBy\n    createdAt\n    updatedAt\n    parentProduct {\n      __typename\n      id\n      accountId\n      name\n      description\n      type\n      measurementUnit\n      incrementBy\n      hsCode\n      skuCode\n      standardPricePerUnit\n      currency\n      parentProductId\n      productPicture\n      startDate\n      endDate\n      isArchived\n      createdBy\n      updatedBy\n      createdAt\n      updatedAt\n    }\n    childProductss {\n      __typename\n      nextToken\n    }\n    linkedProductFiles {\n      __typename\n      nextToken\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductServiceMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "CreateProductService";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation CreateProductService($input: CreateProductServiceInput!, $condition: ModelProductServiceConditionInput) {\n  createProductService(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    externalReference {\n      __typename\n      externalReferenceId\n      externalReferenceIdSource\n      externalReferenceSourceDate\n    }\n    name\n    description\n    type\n    measurementUnit\n    incrementBy\n    hsCode\n    skuCode\n    standardPricePerUnit\n    currency\n    parentProductId\n    productPicture\n    startDate\n    endDate\n    isArchived\n    createdBy\n    updatedBy\n    createdAt\n    updatedAt\n    parentProduct {\n      __typename\n      id\n      accountId\n      name\n      description\n      type\n      measurementUnit\n      incrementBy\n      hsCode\n      skuCode\n      standardPricePerUnit\n      currency\n      parentProductId\n      productPicture\n      startDate\n      endDate\n      isArchived\n      createdBy\n      updatedBy\n      createdAt\n      updatedAt\n    }\n    childProductss {\n      __typename\n      nextToken\n    }\n    linkedProductFiles {\n      __typename\n      nextToken\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelProductServiceConditionInput condition;
        private CreateProductServiceInput input;

        public CreateProductServiceMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new CreateProductServiceMutation(this.input, this.condition);
        }
        ...
        public Builder input(CreateProductServiceInput createProductServiceInput) {
            this.input = createProductServiceInput;
            return this;
        }
    }
    ...
    public static class ChildProductss {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductServiceMutation.ChildProductss.1
    ...
    public static class CreateProductService {
        ...
        final ProductServiceType f58061type;
        final String updatedAt;
        final String updatedBy;

        public static final class Mapper implements ResponseFieldMapper<CreateProductService> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public CreateProductService map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = CreateProductService.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
                List list = responseReader.readList(responseFieldArr[3], new ResponseReader.ListReader<ExternalReference>() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductServiceMutation.CreateProductService.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public ExternalReference read(ResponseReader.ListItemReader listItemReader) {
                        return (ExternalReference) listItemReader.readObject(new ResponseReader.ObjectReader<ExternalReference>() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductServiceMutation.CreateProductService.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                ...
                }), (LinkedProductFiles) responseReader.readObject(responseFieldArr[24], new ResponseReader.ObjectReader<LinkedProductFiles>() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductServiceMutation.CreateProductService.Mapper.4
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public CreateProductService(String str, String str2, String str3, List<ExternalReference> list, String str4, String str5, ProductServiceType productServiceType, String str6, Integer num, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, Boolean bool, String str15, String str16, String str17, String str18, ParentProduct parentProduct, ChildProductss childProductss, LinkedProductFiles linkedProductFiles) {
            ...
            this.f58061type = productServiceType;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateProductService)) {
                return false;
            }
            CreateProductService createProductService = (CreateProductService) obj;
            if (this.__typename.equals(createProductService.__typename) && this.id.equals(createProductService.id) && this.accountId.equals(createProductService.accountId) && ((list = this.externalReference) != null ? list.equals(createProductService.externalReference) : createProductService.externalReference == null) && ((str = this.name) != null ? str.equals(createProductService.name) : createProductService.name == null) && ((str2 = this.description) != null ? str2.equals(createProductService.description) : createProductService.description == null) && ((productServiceType = this.f58061type) != null ? productServiceType.equals(createProductService.f58061type) : createProductService.f58061type == null) && ((str3 = this.measurementUnit) != null ? str3.equals(createProductService.measurementUnit) : createProductService.measurementUnit == null) && ((num = this.incrementBy) != null ? num.equals(createProductService.incrementBy) : createProductService.incrementBy == null) && ((str4 = this.hsCode) != null ? str4.equals(createProductService.hsCode) : createProductService.hsCode == null) && ((str5 = this.skuCode) != null ? str5.equals(createProductService.skuCode) : createProductService.skuCode == null) && ((str6 = this.standardPricePerUnit) != null ? str6.equals(createProductService.standardPricePerUnit) : createProductService.standardPricePerUnit == null) && ((str7 = this.currency) != null ? str7.equals(createProductService.currency) : createProductService.currency == null) && ((str8 = this.parentProductId) != null ? str8.equals(createProductService.parentProductId) : createProductService.parentProductId == null) && ((str9 = this.productPicture) != null ? str9.equals(createProductService.productPicture) : createProductService.productPicture == null) && ((str10 = this.startDate) != null ? str10.equals(createProductService.startDate) : createProductService.startDate == null) && ((str11 = this.endDate) != null ? str11.equals(createProductService.endDate) : createProductService.endDate == null) && ((bool = this.isArchived) != null ? bool.equals(createProductService.isArchived) : createProductService.isArchived == null) && ((str12 = this.createdBy) != null ? str12.equals(createProductService.createdBy) : createProductService.createdBy == null) && ((str13 = this.updatedBy) != null ? str13.equals(createProductService.updatedBy) : createProductService.updatedBy == null) && ((str14 = this.createdAt) != null ? str14.equals(createProductService.createdAt) : createProductService.createdAt == null) && ((str15 = this.updatedAt) != null ? str15.equals(createProductService.updatedAt) : createProductService.updatedAt == null) && ((parentProduct = this.parentProduct) != null ? parentProduct.equals(createProductService.parentProduct) : createProductService.parentProduct == null) && ((childProductss = this.childProductss) != null ? childProductss.equals(createProductService.childProductss) : createProductService.childProductss == null)) {
                LinkedProductFiles linkedProductFiles = this.linkedProductFiles;
                LinkedProductFiles linkedProductFiles2 = createProductService.linkedProductFiles;
        ...
        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ...
                ProductServiceType productServiceType = this.f58061type;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductServiceMutation.CreateProductService.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateProductService.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateProductService.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateProductService.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], CreateProductService.this.accountId);
                    responseWriter.writeList(responseFieldArr[3], CreateProductService.this.externalReference, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductServiceMutation.CreateProductService.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((ExternalReference) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[4], CreateProductService.this.name);
                    responseWriter.writeString(responseFieldArr[5], CreateProductService.this.description);
                    ResponseField responseField = responseFieldArr[6];
                    ProductServiceType productServiceType = CreateProductService.this.f58061type;
                    responseWriter.writeString(responseField, productServiceType != null ? productServiceType.name() : null);
                    responseWriter.writeString(responseFieldArr[7], CreateProductService.this.measurementUnit);
                    responseWriter.writeInt(responseFieldArr[8], CreateProductService.this.incrementBy);
                    responseWriter.writeString(responseFieldArr[9], CreateProductService.this.hsCode);
                    responseWriter.writeString(responseFieldArr[10], CreateProductService.this.skuCode);
                    responseWriter.writeString(responseFieldArr[11], CreateProductService.this.standardPricePerUnit);
                    responseWriter.writeString(responseFieldArr[12], CreateProductService.this.currency);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], CreateProductService.this.parentProductId);
                    responseWriter.writeString(responseFieldArr[14], CreateProductService.this.productPicture);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], CreateProductService.this.startDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], CreateProductService.this.endDate);
                    responseWriter.writeBoolean(responseFieldArr[17], CreateProductService.this.isArchived);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], CreateProductService.this.createdBy);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], CreateProductService.this.updatedBy);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], CreateProductService.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], CreateProductService.this.updatedAt);
                    ResponseField responseField2 = responseFieldArr[22];
                    ParentProduct parentProduct = CreateProductService.this.parentProduct;
                    ...
                    ChildProductss childProductss = CreateProductService.this.childProductss;
                    ...
                    LinkedProductFiles linkedProductFiles = CreateProductService.this.linkedProductFiles;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createProductService", "createProductService", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateProductService.Mapper createProductServiceFieldMapper = new CreateProductService.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateProductService) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateProductService>() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductServiceMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateProductService read(ResponseReader responseReader2) {
                        return Mapper.this.createProductServiceFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateProductService createProductService) {
        ...
        public boolean equals(Object obj) {
            ...
            CreateProductService createProductService = this.createProductService;
            CreateProductService createProductService2 = ((Data) obj).createProductService;
            return createProductService == null ? createProductService2 == null : createProductService.equals(createProductService2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateProductService createProductService = this.createProductService;
                this.$hashCode = (createProductService == null ? 0 : createProductService.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductServiceMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateProductService createProductService = Data.this.createProductService;
                    responseWriter.writeObject(responseField, createProductService != null ? createProductService.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createProductService=" + this.createProductService + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class ExternalReference {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductServiceMutation.ExternalReference.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ExternalReference.$responseFields;
    ...
    public static class LinkedProductFiles {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductServiceMutation.LinkedProductFiles.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = LinkedProductFiles.$responseFields;
    ...
    public static class ParentProduct {
        ...
        /* renamed from: type, reason: collision with root package name */
        final ProductServiceType f58062type;
        final String updatedAt;
        final String updatedBy;
        ...
        public ParentProduct(String str, String str2, String str3, String str4, String str5, ProductServiceType productServiceType, String str6, Integer num, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, Boolean bool, String str15, String str16, String str17, String str18) {
            ...
            this.name = str4;
            this.description = str5;
            this.f58062type = productServiceType;
            this.measurementUnit = str6;
            this.incrementBy = num;
            this.hsCode = str7;
            this.skuCode = str8;
        ...
        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ...
                ProductServiceType productServiceType = this.f58062type;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductServiceMutation.ParentProduct.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ParentProduct.$responseFields;
                    ...
                    ProductServiceType productServiceType = ParentProduct.this.f58062type;
                    responseWriter.writeString(responseField, productServiceType != null ? productServiceType.name() : null);
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final CreateProductServiceInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateProductServiceInput createProductServiceInput, ModelProductServiceConditionInput modelProductServiceConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createProductServiceInput;
            this.condition = modelProductServiceConditionInput;
            linkedHashMap.put("input", createProductServiceInput);
        ...
        public CreateProductServiceInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductServiceMutation.Variables.1
    ...
    public CreateProductServiceMutation(CreateProductServiceInput createProductServiceInput, ModelProductServiceConditionInput modelProductServiceConditionInput) {
        Utils.checkNotNull(createProductServiceInput, "input == null");
        this.variables = new Variables(createProductServiceInput, modelProductServiceConditionInput);
    }
    ...
    public String operationId() {
        return "2afefe747ed557a381611b17852969ed12493eb5972b120f37ff80674ec0508b";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateProductService($input: CreateProductServiceInput!, $condition: ModelProductServiceConditionInput) {\n  createProductService(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    externalReference {\n      __typename\n      externalReferenceId\n      externalReferenceIdSource\n      externalReferenceSourceDate\n    }\n    name\n    description\n    type\n    measurementUnit\n    incrementBy\n    hsCode\n    skuCode\n    standardPricePerUnit\n    currency\n    parentProductId\n    productPicture\n    startDate\n    endDate\n    isArchived\n    createdBy\n    updatedBy\n    createdAt\n    updatedAt\n    parentProduct {\n      __typename\n      id\n      accountId\n      name\n      description\n      type\n      measurementUnit\n      incrementBy\n      hsCode\n      skuCode\n      standardPricePerUnit\n      currency\n      parentProductId\n      productPicture\n      startDate\n      endDate\n      isArchived\n      createdBy\n      updatedBy\n      createdAt\n      updatedAt\n    }\n    childProductss {\n      __typename\n      nextToken\n    }\n    linkedProductFiles {\n      __typename\n      nextToken\n    }\n  }\n}";
    }
