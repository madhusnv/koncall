...
import type.ModelLinkShareByOwnerCompositeKeyConditionInput;
import type.ModelLinkShareFilterInput;
import type.ModelSortDirection;

/* loaded from: classes7.dex */
public final class GetFilesByOwnerQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetFilesByOwner($accountId: ID, $sharedByIdUpdatedAt: ModelLinkShareByOwnerCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelLinkShareFilterInput, $limit: Int, $nextToken: String) {\n  getFilesByOwner(accountId: $accountId, sharedByIdUpdatedAt: $sharedByIdUpdatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      contactName\n      engagementId\n      fileKey\n      mimeType\n      externalLink\n      sharedById\n      sharedByName\n      sharedByEmail\n      templateTitle\n      accountName\n      accountLogoUrl\n      accountWebsite\n      sharedByNumber\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByOwnerQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetFilesByOwner";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetFilesByOwner($accountId: ID, $sharedByIdUpdatedAt: ModelLinkShareByOwnerCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelLinkShareFilterInput, $limit: Int, $nextToken: String) {\n  getFilesByOwner(accountId: $accountId, sharedByIdUpdatedAt: $sharedByIdUpdatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      contactName\n      engagementId\n      fileKey\n      mimeType\n      externalLink\n      sharedById\n      sharedByName\n      sharedByEmail\n      templateTitle\n      accountName\n      accountLogoUrl\n      accountWebsite\n      sharedByNumber\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        private ModelLinkShareByOwnerCompositeKeyConditionInput sharedByIdUpdatedAt;
        ...
        public GetFilesByOwnerQuery build() {
            return new GetFilesByOwnerQuery(this.accountId, this.sharedByIdUpdatedAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
        ...
        public Builder sharedByIdUpdatedAt(ModelLinkShareByOwnerCompositeKeyConditionInput modelLinkShareByOwnerCompositeKeyConditionInput) {
            this.sharedByIdUpdatedAt = modelLinkShareByOwnerCompositeKeyConditionInput;
            return this;
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getFilesByOwner", "getFilesByOwner", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("sharedByIdUpdatedAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sharedByIdUpdatedAt").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetFilesByOwner getFilesByOwner;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetFilesByOwner.Mapper getFilesByOwnerFieldMapper = new GetFilesByOwner.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetFilesByOwner) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetFilesByOwner>() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByOwnerQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetFilesByOwner read(ResponseReader responseReader2) {
                        return Mapper.this.getFilesByOwnerFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetFilesByOwner getFilesByOwner) {
            this.getFilesByOwner = getFilesByOwner;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetFilesByOwner getFilesByOwner = this.getFilesByOwner;
            GetFilesByOwner getFilesByOwner2 = ((Data) obj).getFilesByOwner;
            return getFilesByOwner == null ? getFilesByOwner2 == null : getFilesByOwner.equals(getFilesByOwner2);
        }

        public GetFilesByOwner getFilesByOwner() {
            return this.getFilesByOwner;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetFilesByOwner getFilesByOwner = this.getFilesByOwner;
                this.$hashCode = (getFilesByOwner == null ? 0 : getFilesByOwner.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByOwnerQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetFilesByOwner getFilesByOwner = Data.this.getFilesByOwner;
                    responseWriter.writeObject(responseField, getFilesByOwner != null ? getFilesByOwner.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getFilesByOwner=" + this.getFilesByOwner + "}";
            }
            return this.$toString;
        }
    }

    public static class GetFilesByOwner {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetFilesByOwner> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetFilesByOwner map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetFilesByOwner.$responseFields;
                return new GetFilesByOwner(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByOwnerQuery.GetFilesByOwner.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByOwnerQuery.GetFilesByOwner.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetFilesByOwner(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetFilesByOwner)) {
                return false;
            }
            GetFilesByOwner getFilesByOwner = (GetFilesByOwner) obj;
            if (this.__typename.equals(getFilesByOwner.__typename) && this.items.equals(getFilesByOwner.items)) {
                String str = this.nextToken;
                String str2 = getFilesByOwner.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByOwnerQuery.GetFilesByOwner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetFilesByOwner.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetFilesByOwner.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetFilesByOwner.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByOwnerQuery.GetFilesByOwner.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetFilesByOwner.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetFilesByOwner{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByOwnerQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final ModelLinkShareByOwnerCompositeKeyConditionInput sharedByIdUpdatedAt;
        private final ModelSortDirection sortDirection;
        private final transient Map<String, Object> valueMap;

        public Variables(String str, ModelLinkShareByOwnerCompositeKeyConditionInput modelLinkShareByOwnerCompositeKeyConditionInput, ModelSortDirection modelSortDirection, ModelLinkShareFilterInput modelLinkShareFilterInput, Integer num, String str2) {
            ...
            linkedHashMap.put("sharedByIdUpdatedAt", modelLinkShareByOwnerCompositeKeyConditionInput);
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByOwnerQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("accountId", Variables.this.accountId);
                    inputFieldWriter.writeObject("sharedByIdUpdatedAt", Variables.this.sharedByIdUpdatedAt != null ? Variables.this.sharedByIdUpdatedAt.marshaller() : null);
        ...
        public ModelLinkShareByOwnerCompositeKeyConditionInput sharedByIdUpdatedAt() {
            return this.sharedByIdUpdatedAt;
        }
    ...
    public GetFilesByOwnerQuery(String str, ModelLinkShareByOwnerCompositeKeyConditionInput modelLinkShareByOwnerCompositeKeyConditionInput, ModelSortDirection modelSortDirection, ModelLinkShareFilterInput modelLinkShareFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelLinkShareByOwnerCompositeKeyConditionInput, modelSortDirection, modelLinkShareFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "fc1c79526a51c5185af21ab58040c3cd808eb306024c60bc14704dbb15beef6d";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetFilesByOwner($accountId: ID, $sharedByIdUpdatedAt: ModelLinkShareByOwnerCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelLinkShareFilterInput, $limit: Int, $nextToken: String) {\n  getFilesByOwner(accountId: $accountId, sharedByIdUpdatedAt: $sharedByIdUpdatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      contactName\n      engagementId\n      fileKey\n      mimeType\n      externalLink\n      sharedById\n      sharedByName\n      sharedByEmail\n      templateTitle\n      accountName\n      accountLogoUrl\n      accountWebsite\n      sharedByNumber\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
