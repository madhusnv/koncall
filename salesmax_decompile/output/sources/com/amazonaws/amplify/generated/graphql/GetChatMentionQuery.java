...
public final class GetChatMentionQuery implements Query<Data, Data, Variables> {
    ...
    public static class Channel {
        ...
        public static final class Mapper implements ResponseFieldMapper<Channel> {
            ...
            public Channel map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[6], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetChatMentionQuery.Channel.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChatMentionQuery.Channel.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[6], Channel.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetChatMentionQuery.Channel.1.1
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getChatMention", "getChatMention", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetChatMention getChatMention;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetChatMention.Mapper getChatMentionFieldMapper = new GetChatMention.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetChatMention) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetChatMention>() { // from class: com.amazonaws.amplify.generated.graphql.GetChatMentionQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetChatMention read(ResponseReader responseReader2) {
                        return Mapper.this.getChatMentionFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetChatMention getChatMention) {
            this.getChatMention = getChatMention;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetChatMention getChatMention = this.getChatMention;
            GetChatMention getChatMention2 = ((Data) obj).getChatMention;
            return getChatMention == null ? getChatMention2 == null : getChatMention.equals(getChatMention2);
        }

        public GetChatMention getChatMention() {
            return this.getChatMention;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetChatMention getChatMention = this.getChatMention;
                this.$hashCode = (getChatMention == null ? 0 : getChatMention.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChatMentionQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetChatMention getChatMention = Data.this.getChatMention;
                    responseWriter.writeObject(responseField, getChatMention != null ? getChatMention.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getChatMention=" + this.getChatMention + "}";
            }
            return this.$toString;
        }
    }

    public static class GetChatMention {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<GetChatMention> {
            final Channel.Mapper channelFieldMapper = new Channel.Mapper();
            final MentionedMessage.Mapper mentionedMessageFieldMapper = new MentionedMessage.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetChatMention map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetChatMention.$responseFields;
                return new GetChatMention(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[4]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[5]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), responseReader.readString(responseFieldArr[7]), (Long) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[8]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[9]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[10]), (Channel) responseReader.readObject(responseFieldArr[11], new ResponseReader.ObjectReader<Channel>() { // from class: com.amazonaws.amplify.generated.graphql.GetChatMentionQuery.GetChatMention.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public Channel read(ResponseReader responseReader2) {
                        return Mapper.this.channelFieldMapper.map(responseReader2);
                    }
                }), (MentionedMessage) responseReader.readObject(responseFieldArr[12], new ResponseReader.ObjectReader<MentionedMessage>() { // from class: com.amazonaws.amplify.generated.graphql.GetChatMentionQuery.GetChatMention.Mapper.2
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetChatMention(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, Long l, String str9, String str10, Channel channel, MentionedMessage mentionedMessage) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetChatMention)) {
                return false;
            }
            GetChatMention getChatMention = (GetChatMention) obj;
            if (this.__typename.equals(getChatMention.__typename) && this.id.equals(getChatMention.id) && this.accountId.equals(getChatMention.accountId) && this.mentionedUserId.equals(getChatMention.mentionedUserId) && this.mentionedMessageId.equals(getChatMention.mentionedMessageId) && this.channelId.equals(getChatMention.channelId) && ((str = this.mentionedById) != null ? str.equals(getChatMention.mentionedById) : getChatMention.mentionedById == null) && ((str2 = this.status) != null ? str2.equals(getChatMention.status) : getChatMention.status == null) && ((l = this.expirationUnixTime) != null ? l.equals(getChatMention.expirationUnixTime) : getChatMention.expirationUnixTime == null) && ((str3 = this.createdAt) != null ? str3.equals(getChatMention.createdAt) : getChatMention.createdAt == null) && ((str4 = this.updatedAt) != null ? str4.equals(getChatMention.updatedAt) : getChatMention.updatedAt == null) && ((channel = this.channel) != null ? channel.equals(getChatMention.channel) : getChatMention.channel == null)) {
                MentionedMessage mentionedMessage = this.mentionedMessage;
                MentionedMessage mentionedMessage2 = getChatMention.mentionedMessage;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChatMentionQuery.GetChatMention.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetChatMention.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetChatMention.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetChatMention.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetChatMention.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], GetChatMention.this.mentionedUserId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], GetChatMention.this.mentionedMessageId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], GetChatMention.this.channelId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], GetChatMention.this.mentionedById);
                    responseWriter.writeString(responseFieldArr[7], GetChatMention.this.status);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], GetChatMention.this.expirationUnixTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], GetChatMention.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[10], GetChatMention.this.updatedAt);
                    ResponseField responseField = responseFieldArr[11];
                    Channel channel = GetChatMention.this.channel;
                    ...
                    MentionedMessage mentionedMessage = GetChatMention.this.mentionedMessage;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetChatMention{__typename=" + this.__typename + ", id=" + this.id + ", accountId=" + this.accountId + ", mentionedUserId=" + this.mentionedUserId + ", mentionedMessageId=" + this.mentionedMessageId + ", channelId=" + this.channelId + ", mentionedById=" + this.mentionedById + ", status=" + this.status + ", expirationUnixTime=" + this.expirationUnixTime + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", channel=" + this.channel + ", mentionedMessage=" + this.mentionedMessage + "}";
            }
            return this.$toString;
        }
    ...
    public static class MentionedMessage {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChatMentionQuery.MentionedMessage.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = MentionedMessage.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[36], MentionedMessage.this.contactObjectToSend, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetChatMentionQuery.MentionedMessage.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChatMentionQuery.Variables.1
    ...
    public GetChatMentionQuery(String str) {
    ...
    public String operationId() {
        return "e4c11b9274ad684dd27fad37d8de2a27c03be90eebbac7b0732f4e30d87cc59a";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetChatMention($id: ID!) {\n  getChatMention(id: $id) {\n    __typename\n    id\n    accountId\n    mentionedUserId\n    mentionedMessageId\n    channelId\n    mentionedById\n    status\n    expirationUnixTime\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    mentionedMessage {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      messagePlatform\n      externalMessageReferenceId\n      externalConversationId\n      recipientExternalId\n      recipientExternalIdType\n      channelId\n      contactId\n      visitorId\n      referredContactId\n      messageType\n      messageSubType\n      messageCategory\n      messageSendCategory\n      replyingToMessageId\n      replyingToMessageIdExternal\n      responseMessageId\n      followUpType\n      replyType\n      replyTypeId\n      referredProductCatalogId\n      referredProductRetailerId\n      referral\n      isStarred\n      status\n      errorMessages\n      sentAt\n      deliveredAt\n      readAt\n      internalTemplateId\n      externalTemplateId\n      externalTemplateCategory\n      text\n      contactObjectToSend\n      locationObjectToSend\n      adddressMessageParameters\n      headerText\n      footerText\n      headerType\n      mediaObjectId\n      mediaMetadata\n      hasImage\n      thumbnailUrl\n      isInbound\n      chatUserId\n      chatUserName\n      chatBotId\n      chatUserAccountIdIfExternal\n      chatUserAccountNameIfExternal\n      directChatUserId\n      primaryTeamId\n      linkedEngagementIdIfBroadcast\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
