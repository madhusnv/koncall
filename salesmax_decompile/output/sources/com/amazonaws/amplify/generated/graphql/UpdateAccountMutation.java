...
public final class UpdateAccountMutation implements Mutation<Data, Data, Variables> {
    ...
    public static class AccountStats {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.AccountStats.1
    ...
    public static final class Builder {
        ...
        public UpdateAccountMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new UpdateAccountMutation(this.input);
        }
    ...
    public static class CreatedByUser {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.CreatedByUser.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreatedByUser.$responseFields;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("updateAccount", "updateAccount", new UnmodifiableMapBuilder(1).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<Data> {
            final UpdateAccount.Mapper updateAccountFieldMapper = new UpdateAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((UpdateAccount) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<UpdateAccount>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdateAccount read(ResponseReader responseReader2) {
                        return Mapper.this.updateAccountFieldMapper.map(responseReader2);
                    }
                }));
            }
        }
        ...
        public boolean equals(Object obj) {
            ...
            UpdateAccount updateAccount2 = ((Data) obj).updateAccount;
            return updateAccount == null ? updateAccount2 == null : updateAccount.equals(updateAccount2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                UpdateAccount updateAccount = this.updateAccount;
                this.$hashCode = (updateAccount == null ? 0 : updateAccount.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    UpdateAccount updateAccount = Data.this.updateAccount;
                    responseWriter.writeObject(responseField, updateAccount != null ? updateAccount.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{updateAccount=" + this.updateAccount + "}";
            }
            return this.$toString;
        }
    ...
    public static class LastPaymentData {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.LastPaymentData.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = LastPaymentData.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[17], LastPaymentData.this.paidByContactIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.LastPaymentData.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], LastPaymentData.this.transactionId, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.LastPaymentData.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class MatchingDeal {
        ...
        public static final class Mapper implements ResponseFieldMapper<MatchingDeal> {
            ...
            public MatchingDeal map(ResponseReader responseReader) {
                ...
                }), responseReader.readList(responseFieldArr[18], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.MatchingDeal.Mapper.2
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.AWSJSON);
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.MatchingDeal.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = MatchingDeal.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[17], MatchingDeal.this.transitionSummary, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.MatchingDeal.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], MatchingDeal.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.MatchingDeal.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[21], MatchingDeal.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.MatchingDeal.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class Subscriptions {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.Subscriptions.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Subscriptions.$responseFields;
    ...
    public static class UpdateAccount {
        ...
        public static final class Mapper implements ResponseFieldMapper<UpdateAccount> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public UpdateAccount map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = UpdateAccount.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String string2 = responseReader.readString(responseFieldArr[2]);
                String string3 = responseReader.readString(responseFieldArr[3]);
                ...
                }), responseReader.readList(responseFieldArr[40], new ResponseReader.ListReader<WebPreference>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.UpdateAccount.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public WebPreference read(ResponseReader.ListItemReader listItemReader) {
                        return (WebPreference) listItemReader.readObject(new ResponseReader.ObjectReader<WebPreference>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.UpdateAccount.Mapper.3.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), (MatchingDeal) responseReader.readObject(responseFieldArr[66], new ResponseReader.ObjectReader<MatchingDeal>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.UpdateAccount.Mapper.11
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public MatchingDeal read(ResponseReader responseReader2) {
                        return Mapper.this.matchingDealFieldMapper.map(responseReader2);
                    }
                }), (CreatedByUser) responseReader.readObject(responseFieldArr[67], new ResponseReader.ObjectReader<CreatedByUser>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.UpdateAccount.Mapper.12
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreatedByUser read(ResponseReader responseReader2) {
                        return Mapper.this.createdByUserFieldMapper.map(responseReader2);
                    }
                }), (UpdatedByUser) responseReader.readObject(responseFieldArr[68], new ResponseReader.ObjectReader<UpdatedByUser>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.UpdateAccount.Mapper.13
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (this.__typename.equals(updateAccount.__typename) && this.id.equals(updateAccount.id) && this.accountName.equals(updateAccount.accountName) && this.accountType.equals(updateAccount.accountType) && ((str = this.deviceKey) != null ? str.equals(updateAccount.deviceKey) : updateAccount.deviceKey == null) && ((str2 = this.deviceKeyLastUpdated) != null ? str2.equals(updateAccount.deviceKeyLastUpdated) : updateAccount.deviceKeyLastUpdated == null) && ((accountStatus = this.accountStatus) != null ? accountStatus.equals(updateAccount.accountStatus) : updateAccount.accountStatus == null) && ((str3 = this.businessLogoUrl) != null ? str3.equals(updateAccount.businessLogoUrl) : updateAccount.businessLogoUrl == null) && ((str4 = this.createdById) != null ? str4.equals(updateAccount.createdById) : updateAccount.createdById == null) && ((str5 = this.dateFormat) != null ? str5.equals(updateAccount.dateFormat) : updateAccount.dateFormat == null) && ((str6 = this.dateTimeViewStyle) != null ? str6.equals(updateAccount.dateTimeViewStyle) : updateAccount.dateTimeViewStyle == null) && ((str7 = this.defaultCurrency) != null ? str7.equals(updateAccount.defaultCurrency) : updateAccount.defaultCurrency == null) && ((str8 = this.denomination) != null ? str8.equals(updateAccount.denomination) : updateAccount.denomination == null) && ((str9 = this.industry) != null ? str9.equals(updateAccount.industry) : updateAccount.industry == null) && ((str10 = this.nameOfBusiness) != null ? str10.equals(updateAccount.nameOfBusiness) : updateAccount.nameOfBusiness == null) && ((list = this.productOrService) != null ? list.equals(updateAccount.productOrService) : updateAccount.productOrService == null) && ((str11 = this.timeFormat) != null ? str11.equals(updateAccount.timeFormat) : updateAccount.timeFormat == null) && ((str12 = this.timeZone) != null ? str12.equals(updateAccount.timeZone) : updateAccount.timeZone == null) && ((str13 = this.plan) != null ? str13.equals(updateAccount.plan) : updateAccount.plan == null) && ((str14 = this.paidUpTo) != null ? str14.equals(updateAccount.paidUpTo) : updateAccount.paidUpTo == null) && ((num = this.seats) != null ? num.equals(updateAccount.seats) : updateAccount.seats == null) && ((num2 = this.freeSeats) != null ? num2.equals(updateAccount.freeSeats) : updateAccount.freeSeats == null) && ((num3 = this.currentTotalUsers) != null ? num3.equals(updateAccount.currentTotalUsers) : updateAccount.currentTotalUsers == null) && ((num4 = this.currentActiveUsers) != null ? num4.equals(updateAccount.currentActiveUsers) : updateAccount.currentActiveUsers == null) && ((num5 = this.extraActiveUsers) != null ? num5.equals(updateAccount.extraActiveUsers) : updateAccount.extraActiveUsers == null) && ((num6 = this.pricePerSeat) != null ? num6.equals(updateAccount.pricePerSeat) : updateAccount.pricePerSeat == null) && ((bool = this.allowAddingSeat) != null ? bool.equals(updateAccount.allowAddingSeat) : updateAccount.allowAddingSeat == null) && ((str15 = this.allowAddingSeatTill) != null ? str15.equals(updateAccount.allowAddingSeatTill) : updateAccount.allowAddingSeatTill == null) && ((num7 = this.seatReductionMarkedForNextCycle) != null ? num7.equals(updateAccount.seatReductionMarkedForNextCycle) : updateAccount.seatReductionMarkedForNextCycle == null) && ((str16 = this.billingCurrency) != null ? str16.equals(updateAccount.billingCurrency) : updateAccount.billingCurrency == null) && ((str17 = this.billingEmail) != null ? str17.equals(updateAccount.billingEmail) : updateAccount.billingEmail == null) && ((str18 = this.taxId) != null ? str18.equals(updateAccount.taxId) : updateAccount.taxId == null) && ((str19 = this.taxIdType) != null ? str19.equals(updateAccount.taxIdType) : updateAccount.taxIdType == null) && ((str20 = this.trialAccountEndDate) != null ? str20.equals(updateAccount.trialAccountEndDate) : updateAccount.trialAccountEndDate == null) && ((num8 = this.trialExtensionTimes) != null ? num8.equals(updateAccount.trialExtensionTimes) : updateAccount.trialExtensionTimes == null) && ((bool2 = this.eligibleForExtension) != null ? bool2.equals(updateAccount.eligibleForExtension) : updateAccount.eligibleForExtension == null) && ((str21 = this.paidForTillDate) != null ? str21.equals(updateAccount.paidForTillDate) : updateAccount.paidForTillDate == null) && ((str22 = this.updatedById) != null ? str22.equals(updateAccount.updatedById) : updateAccount.updatedById == null) && ((str23 = this.website) != null ? str23.equals(updateAccount.website) : updateAccount.website == null) && ((list2 = this.workingHours) != null ? list2.equals(updateAccount.workingHours) : updateAccount.workingHours == null) && ((list3 = this.webPreferences) != null ? list3.equals(updateAccount.webPreferences) : updateAccount.webPreferences == null) && ((list4 = this.permissions) != null ? list4.equals(updateAccount.permissions) : updateAccount.permissions == null) && ((bool3 = this.enableCustomCharts) != null ? bool3.equals(updateAccount.enableCustomCharts) : updateAccount.enableCustomCharts == null) && ((str24 = this.createdAt) != null ? str24.equals(updateAccount.createdAt) : updateAccount.createdAt == null) && ((str25 = this.updatedAt) != null ? str25.equals(updateAccount.updatedAt) : updateAccount.updatedAt == null) && ((str26 = this.dealMode) != null ? str26.equals(updateAccount.dealMode) : updateAccount.dealMode == null) && ((str27 = this.openAiApiKey) != null ? str27.equals(updateAccount.openAiApiKey) : updateAccount.openAiApiKey == null) && ((list5 = this.salesmaxSalesContacts) != null ? list5.equals(updateAccount.salesmaxSalesContacts) : updateAccount.salesmaxSalesContacts == null) && ((list6 = this.salesmaxSupportContacts) != null ? list6.equals(updateAccount.salesmaxSupportContacts) : updateAccount.salesmaxSupportContacts == null) && ((str28 = this.chatWidgetConfig) != null ? str28.equals(updateAccount.chatWidgetConfig) : updateAccount.chatWidgetConfig == null) && ((str29 = this.onboardingStatus) != null ? str29.equals(updateAccount.onboardingStatus) : updateAccount.onboardingStatus == null) && ((str30 = this.integrationNeeded) != null ? str30.equals(updateAccount.integrationNeeded) : updateAccount.integrationNeeded == null) && ((str31 = this.matchingDealId) != null ? str31.equals(updateAccount.matchingDealId) : updateAccount.matchingDealId == null) && ((list7 = this.relatedAccountIds) != null ? list7.equals(updateAccount.relatedAccountIds) : updateAccount.relatedAccountIds == null) && ((accountStats = this.accountStats) != null ? accountStats.equals(updateAccount.accountStats) : updateAccount.accountStats == null) && ((str32 = this.lastChurnDate) != null ? str32.equals(updateAccount.lastChurnDate) : updateAccount.lastChurnDate == null) && ((str33 = this.lastChurnReason) != null ? str33.equals(updateAccount.lastChurnReason) : updateAccount.lastChurnReason == null) && ((str34 = this.possibleReactivationDate) != null ? str34.equals(updateAccount.possibleReactivationDate) : updateAccount.possibleReactivationDate == null) && ((d = this.locationPeriodicFrequency) != null ? d.equals(updateAccount.locationPeriodicFrequency) : updateAccount.locationPeriodicFrequency == null) && ((str35 = this.lastPaymentDataId) != null ? str35.equals(updateAccount.lastPaymentDataId) : updateAccount.lastPaymentDataId == null) && ((str36 = this.lastPaymentDataCreatedAt) != null ? str36.equals(updateAccount.lastPaymentDataCreatedAt) : updateAccount.lastPaymentDataCreatedAt == null) && ((str37 = this.nextRenewalDateIfPaid) != null ? str37.equals(updateAccount.nextRenewalDateIfPaid) : updateAccount.nextRenewalDateIfPaid == null) && ((str38 = this.lastPaymentStatus) != null ? str38.equals(updateAccount.lastPaymentStatus) : updateAccount.lastPaymentStatus == null) && ((num9 = this.partPaymentAmountIfAny) != null ? num9.equals(updateAccount.partPaymentAmountIfAny) : updateAccount.partPaymentAmountIfAny == null) && ((subscriptions = this.subscriptions) != null ? subscriptions.equals(updateAccount.subscriptions) : updateAccount.subscriptions == null) && ((lastPaymentData = this.lastPaymentData) != null ? lastPaymentData.equals(updateAccount.lastPaymentData) : updateAccount.lastPaymentData == null) && ((matchingDeal = this.matchingDeal) != null ? matchingDeal.equals(updateAccount.matchingDeal) : updateAccount.matchingDeal == null) && ((createdByUser = this.createdByUser) != null ? createdByUser.equals(updateAccount.createdByUser) : updateAccount.createdByUser == null)) {
                UpdatedByUser updatedByUser = this.updatedByUser;
                UpdatedByUser updatedByUser2 = updateAccount.updatedByUser;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.UpdateAccount.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdateAccount.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UpdateAccount.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], UpdateAccount.this.id);
                    responseWriter.writeString(responseFieldArr[2], UpdateAccount.this.accountName);
                    responseWriter.writeString(responseFieldArr[3], UpdateAccount.this.accountType.name());
                    responseWriter.writeString(responseFieldArr[4], UpdateAccount.this.deviceKey);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], UpdateAccount.this.deviceKeyLastUpdated);
                    ResponseField responseField = responseFieldArr[6];
                    AccountStatus accountStatus = UpdateAccount.this.accountStatus;
                    responseWriter.writeString(responseField, accountStatus != null ? accountStatus.name() : null);
                    responseWriter.writeString(responseFieldArr[7], UpdateAccount.this.businessLogoUrl);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], UpdateAccount.this.createdById);
                    responseWriter.writeString(responseFieldArr[9], UpdateAccount.this.dateFormat);
                    responseWriter.writeString(responseFieldArr[10], UpdateAccount.this.dateTimeViewStyle);
                    responseWriter.writeString(responseFieldArr[11], UpdateAccount.this.defaultCurrency);
                    responseWriter.writeString(responseFieldArr[12], UpdateAccount.this.denomination);
                    responseWriter.writeString(responseFieldArr[13], UpdateAccount.this.industry);
                    responseWriter.writeString(responseFieldArr[14], UpdateAccount.this.nameOfBusiness);
                    responseWriter.writeList(responseFieldArr[15], UpdateAccount.this.productOrService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.UpdateAccount.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[16], UpdateAccount.this.timeFormat);
                    responseWriter.writeString(responseFieldArr[17], UpdateAccount.this.timeZone);
                    responseWriter.writeString(responseFieldArr[18], UpdateAccount.this.plan);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], UpdateAccount.this.paidUpTo);
                    responseWriter.writeInt(responseFieldArr[20], UpdateAccount.this.seats);
                    responseWriter.writeInt(responseFieldArr[21], UpdateAccount.this.freeSeats);
                    responseWriter.writeInt(responseFieldArr[22], UpdateAccount.this.currentTotalUsers);
                    responseWriter.writeInt(responseFieldArr[23], UpdateAccount.this.currentActiveUsers);
                    responseWriter.writeInt(responseFieldArr[24], UpdateAccount.this.extraActiveUsers);
                    responseWriter.writeInt(responseFieldArr[25], UpdateAccount.this.pricePerSeat);
                    responseWriter.writeBoolean(responseFieldArr[26], UpdateAccount.this.allowAddingSeat);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], UpdateAccount.this.allowAddingSeatTill);
                    responseWriter.writeInt(responseFieldArr[28], UpdateAccount.this.seatReductionMarkedForNextCycle);
                    responseWriter.writeString(responseFieldArr[29], UpdateAccount.this.billingCurrency);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[30], UpdateAccount.this.billingEmail);
                    responseWriter.writeString(responseFieldArr[31], UpdateAccount.this.taxId);
                    responseWriter.writeString(responseFieldArr[32], UpdateAccount.this.taxIdType);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[33], UpdateAccount.this.trialAccountEndDate);
                    responseWriter.writeInt(responseFieldArr[34], UpdateAccount.this.trialExtensionTimes);
                    responseWriter.writeBoolean(responseFieldArr[35], UpdateAccount.this.eligibleForExtension);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[36], UpdateAccount.this.paidForTillDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[37], UpdateAccount.this.updatedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], UpdateAccount.this.website);
                    responseWriter.writeList(responseFieldArr[39], UpdateAccount.this.workingHours, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.UpdateAccount.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((WorkingHour) obj).marshaller());
                        }
                    });
                    responseWriter.writeList(responseFieldArr[40], UpdateAccount.this.webPreferences, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.UpdateAccount.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((WebPreference) obj).marshaller());
                        }
                    });
                    responseWriter.writeList(responseFieldArr[41], UpdateAccount.this.permissions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.UpdateAccount.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    });
                    responseWriter.writeBoolean(responseFieldArr[42], UpdateAccount.this.enableCustomCharts);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[43], UpdateAccount.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[44], UpdateAccount.this.updatedAt);
                    responseWriter.writeString(responseFieldArr[45], UpdateAccount.this.dealMode);
                    responseWriter.writeString(responseFieldArr[46], UpdateAccount.this.openAiApiKey);
                    responseWriter.writeList(responseFieldArr[47], UpdateAccount.this.salesmaxSalesContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.UpdateAccount.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[48], UpdateAccount.this.salesmaxSupportContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.UpdateAccount.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[49], UpdateAccount.this.chatWidgetConfig);
                    responseWriter.writeString(responseFieldArr[50], UpdateAccount.this.onboardingStatus);
                    responseWriter.writeString(responseFieldArr[51], UpdateAccount.this.integrationNeeded);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[52], UpdateAccount.this.matchingDealId);
                    responseWriter.writeList(responseFieldArr[53], UpdateAccount.this.relatedAccountIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.UpdateAccount.1.7
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    ...
                    AccountStats accountStats = UpdateAccount.this.accountStats;
                    responseWriter.writeObject(responseField2, accountStats != null ? accountStats.marshaller() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[55], UpdateAccount.this.lastChurnDate);
                    responseWriter.writeString(responseFieldArr[56], UpdateAccount.this.lastChurnReason);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[57], UpdateAccount.this.possibleReactivationDate);
                    responseWriter.writeDouble(responseFieldArr[58], UpdateAccount.this.locationPeriodicFrequency);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[59], UpdateAccount.this.lastPaymentDataId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[60], UpdateAccount.this.lastPaymentDataCreatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[61], UpdateAccount.this.nextRenewalDateIfPaid);
                    responseWriter.writeString(responseFieldArr[62], UpdateAccount.this.lastPaymentStatus);
                    responseWriter.writeInt(responseFieldArr[63], UpdateAccount.this.partPaymentAmountIfAny);
                    ResponseField responseField3 = responseFieldArr[64];
                    Subscriptions subscriptions = UpdateAccount.this.subscriptions;
                    ...
                    LastPaymentData lastPaymentData = UpdateAccount.this.lastPaymentData;
                    ...
                    MatchingDeal matchingDeal = UpdateAccount.this.matchingDeal;
                    ...
                    CreatedByUser createdByUser = UpdateAccount.this.createdByUser;
                    ...
                    UpdatedByUser updatedByUser = UpdateAccount.this.updatedByUser;
    ...
    public static class UpdatedByUser {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.UpdatedByUser.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdatedByUser.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(UpdateAccountInput updateAccountInput) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.Variables.1
    ...
    public static class WebPreference {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.WebPreference.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = WebPreference.$responseFields;
    ...
    public static class WorkingHour {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMutation.WorkingHour.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = WorkingHour.$responseFields;
    ...
    public UpdateAccountMutation(UpdateAccountInput updateAccountInput) {
        Utils.checkNotNull(updateAccountInput, "input == null");
        this.variables = new Variables(updateAccountInput);
    }
    ...
    public String operationId() {
        return "3056e32473ff58a6bb7bc73de488503668b9a587ca5adfa37831de2a3dbb2d54";
    }
