...
import type.InviteUserInput;
import type.ModelUserConditionInput;
import type.UserRegistrationStatus;

/* loaded from: classes8.dex */
public final class InviteUserMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation InviteUser($input: InviteUserInput!, $condition: ModelUserConditionInput) {\n  inviteUser(input: $input, condition: $condition) {\n    __typename\n    id\n    addedSourceType\n    name\n    profilePictureUrl\n    registeredEmail\n    registeredEmailVerified\n    registeredNumber\n    registeredNumberVerified\n    secondaryNumber\n    secondaryNumberVerified\n    userRegistrationStatus\n    lastSelectedAccountWeb\n    lastSelectedAccountApp\n    appVersion\n    deviceModel\n    deviceManufacturer\n    androidVersionRelease\n    webPreferences {\n      __typename\n      key\n      value\n    }\n    createdAt\n    updatedAt\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.InviteUserMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "InviteUser";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation InviteUser($input: InviteUserInput!, $condition: ModelUserConditionInput) {\n  inviteUser(input: $input, condition: $condition) {\n    __typename\n    id\n    addedSourceType\n    name\n    profilePictureUrl\n    registeredEmail\n    registeredEmailVerified\n    registeredNumber\n    registeredNumberVerified\n    secondaryNumber\n    secondaryNumberVerified\n    userRegistrationStatus\n    lastSelectedAccountWeb\n    lastSelectedAccountApp\n    appVersion\n    deviceModel\n    deviceManufacturer\n    androidVersionRelease\n    webPreferences {\n      __typename\n      key\n      value\n    }\n    createdAt\n    updatedAt\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelUserConditionInput condition;
        private InviteUserInput input;

        public InviteUserMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new InviteUserMutation(this.input, this.condition);
        }
        ...
        public Builder input(InviteUserInput inviteUserInput) {
            this.input = inviteUserInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("inviteUser", "inviteUser", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        ...
        public static final class Mapper implements ResponseFieldMapper<Data> {
            final InviteUser.Mapper inviteUserFieldMapper = new InviteUser.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((InviteUser) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<InviteUser>() { // from class: com.amazonaws.amplify.generated.graphql.InviteUserMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public InviteUser read(ResponseReader responseReader2) {
                        return Mapper.this.inviteUserFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(InviteUser inviteUser) {
        ...
        public boolean equals(Object obj) {
            ...
            InviteUser inviteUser2 = ((Data) obj).inviteUser;
            return inviteUser == null ? inviteUser2 == null : inviteUser.equals(inviteUser2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                InviteUser inviteUser = this.inviteUser;
                this.$hashCode = (inviteUser == null ? 0 : inviteUser.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.InviteUserMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    InviteUser inviteUser = Data.this.inviteUser;
                    responseWriter.writeObject(responseField, inviteUser != null ? inviteUser.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{inviteUser=" + this.inviteUser + "}";
            }
    ...
    public static class InviteUser {
        ...
        public static final class Mapper implements ResponseFieldMapper<InviteUser> {
            final WebPreference.Mapper webPreferenceFieldMapper = new WebPreference.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public InviteUser map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = InviteUser.$responseFields;
        ...
        public InviteUser(String str, String str2, AddedSourceType addedSourceType, String str3, String str4, String str5, Boolean bool, String str6, Boolean bool2, String str7, Boolean bool3, UserRegistrationStatus userRegistrationStatus, String str8, String str9, String str10, String str11, String str12, String str13, List<WebPreference> list, String str14, String str15) {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.__typename.equals(inviteUser.__typename) && this.id.equals(inviteUser.id) && this.addedSourceType.equals(inviteUser.addedSourceType) && this.name.equals(inviteUser.name) && ((str = this.profilePictureUrl) != null ? str.equals(inviteUser.profilePictureUrl) : inviteUser.profilePictureUrl == null) && ((str2 = this.registeredEmail) != null ? str2.equals(inviteUser.registeredEmail) : inviteUser.registeredEmail == null) && ((bool = this.registeredEmailVerified) != null ? bool.equals(inviteUser.registeredEmailVerified) : inviteUser.registeredEmailVerified == null) && this.registeredNumber.equals(inviteUser.registeredNumber) && ((bool2 = this.registeredNumberVerified) != null ? bool2.equals(inviteUser.registeredNumberVerified) : inviteUser.registeredNumberVerified == null) && ((str3 = this.secondaryNumber) != null ? str3.equals(inviteUser.secondaryNumber) : inviteUser.secondaryNumber == null) && ((bool3 = this.secondaryNumberVerified) != null ? bool3.equals(inviteUser.secondaryNumberVerified) : inviteUser.secondaryNumberVerified == null) && this.userRegistrationStatus.equals(inviteUser.userRegistrationStatus) && ((str4 = this.lastSelectedAccountWeb) != null ? str4.equals(inviteUser.lastSelectedAccountWeb) : inviteUser.lastSelectedAccountWeb == null) && ((str5 = this.lastSelectedAccountApp) != null ? str5.equals(inviteUser.lastSelectedAccountApp) : inviteUser.lastSelectedAccountApp == null) && ((str6 = this.appVersion) != null ? str6.equals(inviteUser.appVersion) : inviteUser.appVersion == null) && ((str7 = this.deviceModel) != null ? str7.equals(inviteUser.deviceModel) : inviteUser.deviceModel == null) && ((str8 = this.deviceManufacturer) != null ? str8.equals(inviteUser.deviceManufacturer) : inviteUser.deviceManufacturer == null) && ((str9 = this.androidVersionRelease) != null ? str9.equals(inviteUser.androidVersionRelease) : inviteUser.androidVersionRelease == null) && ((list = this.webPreferences) != null ? list.equals(inviteUser.webPreferences) : inviteUser.webPreferences == null) && ((str10 = this.createdAt) != null ? str10.equals(inviteUser.createdAt) : inviteUser.createdAt == null)) {
                String str11 = this.updatedAt;
                String str12 = inviteUser.updatedAt;
                if (str11 == null) {
                    if (str12 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.InviteUserMutation.InviteUser.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = InviteUser.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], InviteUser.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], InviteUser.this.id);
                    responseWriter.writeString(responseFieldArr[2], InviteUser.this.addedSourceType.name());
                    responseWriter.writeString(responseFieldArr[3], InviteUser.this.name);
                    responseWriter.writeString(responseFieldArr[4], InviteUser.this.profilePictureUrl);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], InviteUser.this.registeredEmail);
                    responseWriter.writeBoolean(responseFieldArr[6], InviteUser.this.registeredEmailVerified);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], InviteUser.this.registeredNumber);
                    responseWriter.writeBoolean(responseFieldArr[8], InviteUser.this.registeredNumberVerified);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], InviteUser.this.secondaryNumber);
                    responseWriter.writeBoolean(responseFieldArr[10], InviteUser.this.secondaryNumberVerified);
                    responseWriter.writeString(responseFieldArr[11], InviteUser.this.userRegistrationStatus.name());
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], InviteUser.this.lastSelectedAccountWeb);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], InviteUser.this.lastSelectedAccountApp);
                    responseWriter.writeString(responseFieldArr[14], InviteUser.this.appVersion);
                    responseWriter.writeString(responseFieldArr[15], InviteUser.this.deviceModel);
                    responseWriter.writeString(responseFieldArr[16], InviteUser.this.deviceManufacturer);
                    responseWriter.writeString(responseFieldArr[17], InviteUser.this.androidVersionRelease);
                    responseWriter.writeList(responseFieldArr[18], InviteUser.this.webPreferences, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.InviteUserMutation.InviteUser.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((WebPreference) obj).marshaller());
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], InviteUser.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], InviteUser.this.updatedAt);
                }
            };
        }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final InviteUserInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(InviteUserInput inviteUserInput, ModelUserConditionInput modelUserConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = inviteUserInput;
            this.condition = modelUserConditionInput;
            linkedHashMap.put("input", inviteUserInput);
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.InviteUserMutation.Variables.1
    ...
    public static class WebPreference {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.InviteUserMutation.WebPreference.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = WebPreference.$responseFields;
    ...
    public InviteUserMutation(InviteUserInput inviteUserInput, ModelUserConditionInput modelUserConditionInput) {
        Utils.checkNotNull(inviteUserInput, "input == null");
        this.variables = new Variables(inviteUserInput, modelUserConditionInput);
    }
    ...
    public String operationId() {
        return "b7fe2152529fe2e858ac140b61d760cceb710a9f558998f234d1b18e4b6d2810";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation InviteUser($input: InviteUserInput!, $condition: ModelUserConditionInput) {\n  inviteUser(input: $input, condition: $condition) {\n    __typename\n    id\n    addedSourceType\n    name\n    profilePictureUrl\n    registeredEmail\n    registeredEmailVerified\n    registeredNumber\n    registeredNumberVerified\n    secondaryNumber\n    secondaryNumberVerified\n    userRegistrationStatus\n    lastSelectedAccountWeb\n    lastSelectedAccountApp\n    appVersion\n    deviceModel\n    deviceManufacturer\n    androidVersionRelease\n    webPreferences {\n      __typename\n      key\n      value\n    }\n    createdAt\n    updatedAt\n  }\n}";
    }
