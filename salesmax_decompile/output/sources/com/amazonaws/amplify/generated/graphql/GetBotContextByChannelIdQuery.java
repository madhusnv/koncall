...
public final class GetBotContextByChannelIdQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetBotContextByChannelId($accountId: ID, $channelId: ModelIDKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelChatBotContextFilterInput, $limit: Int, $nextToken: String) {\n  getBotContextByChannelId(accountId: $accountId, channelId: $channelId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      handlerChatBot\n      masterChatBot\n      accountId\n      contactId\n      userId\n      channelId\n      lastChatMessageId\n      createdAt\n      updatedAt\n      isPaused\n      pausedBy\n      pausedById\n      pausedAt\n      currentIntent\n      intentList\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByChannelIdQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetBotContextByChannelId";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetBotContextByChannelId($accountId: ID, $channelId: ModelIDKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelChatBotContextFilterInput, $limit: Int, $nextToken: String) {\n  getBotContextByChannelId(accountId: $accountId, channelId: $channelId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      handlerChatBot\n      masterChatBot\n      accountId\n      contactId\n      userId\n      channelId\n      lastChatMessageId\n      createdAt\n      updatedAt\n      isPaused\n      pausedBy\n      pausedById\n      pausedAt\n      currentIntent\n      intentList\n    }\n    nextToken\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private String accountId;
        private ModelIDKeyConditionInput channelId;
        ...
        public GetBotContextByChannelIdQuery build() {
            return new GetBotContextByChannelIdQuery(this.accountId, this.channelId, this.sortDirection, this.filter, this.limit, this.nextToken);
        }

        public Builder channelId(ModelIDKeyConditionInput modelIDKeyConditionInput) {
            this.channelId = modelIDKeyConditionInput;
            return this;
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getBotContextByChannelId", "getBotContextByChannelId", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("channelId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "channelId").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetBotContextByChannelId getBotContextByChannelId;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetBotContextByChannelId.Mapper getBotContextByChannelIdFieldMapper = new GetBotContextByChannelId.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetBotContextByChannelId) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetBotContextByChannelId>() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByChannelIdQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetBotContextByChannelId read(ResponseReader responseReader2) {
                        return Mapper.this.getBotContextByChannelIdFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetBotContextByChannelId getBotContextByChannelId) {
            this.getBotContextByChannelId = getBotContextByChannelId;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetBotContextByChannelId getBotContextByChannelId = this.getBotContextByChannelId;
            GetBotContextByChannelId getBotContextByChannelId2 = ((Data) obj).getBotContextByChannelId;
            return getBotContextByChannelId == null ? getBotContextByChannelId2 == null : getBotContextByChannelId.equals(getBotContextByChannelId2);
        }

        public GetBotContextByChannelId getBotContextByChannelId() {
            return this.getBotContextByChannelId;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetBotContextByChannelId getBotContextByChannelId = this.getBotContextByChannelId;
                this.$hashCode = (getBotContextByChannelId == null ? 0 : getBotContextByChannelId.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByChannelIdQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetBotContextByChannelId getBotContextByChannelId = Data.this.getBotContextByChannelId;
                    responseWriter.writeObject(responseField, getBotContextByChannelId != null ? getBotContextByChannelId.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getBotContextByChannelId=" + this.getBotContextByChannelId + "}";
            }
            return this.$toString;
        }
    }

    public static class GetBotContextByChannelId {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetBotContextByChannelId> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetBotContextByChannelId map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetBotContextByChannelId.$responseFields;
                return new GetBotContextByChannelId(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByChannelIdQuery.GetBotContextByChannelId.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByChannelIdQuery.GetBotContextByChannelId.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetBotContextByChannelId(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetBotContextByChannelId)) {
                return false;
            }
            GetBotContextByChannelId getBotContextByChannelId = (GetBotContextByChannelId) obj;
            if (this.__typename.equals(getBotContextByChannelId.__typename) && this.items.equals(getBotContextByChannelId.items)) {
                String str = this.nextToken;
                String str2 = getBotContextByChannelId.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByChannelIdQuery.GetBotContextByChannelId.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetBotContextByChannelId.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetBotContextByChannelId.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetBotContextByChannelId.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByChannelIdQuery.GetBotContextByChannelId.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetBotContextByChannelId.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetBotContextByChannelId{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByChannelIdQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[16], Item.this.intentList, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByChannelIdQuery.Item.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final ModelIDKeyConditionInput channelId;
        ...
        public Variables(String str, ModelIDKeyConditionInput modelIDKeyConditionInput, ModelSortDirection modelSortDirection, ModelChatBotContextFilterInput modelChatBotContextFilterInput, Integer num, String str2) {
            ...
            linkedHashMap.put("channelId", modelIDKeyConditionInput);
        ...
        public ModelIDKeyConditionInput channelId() {
            return this.channelId;
        }
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByChannelIdQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("accountId", Variables.this.accountId);
                    inputFieldWriter.writeObject("channelId", Variables.this.channelId != null ? Variables.this.channelId.marshaller() : null);
    ...
    public GetBotContextByChannelIdQuery(String str, ModelIDKeyConditionInput modelIDKeyConditionInput, ModelSortDirection modelSortDirection, ModelChatBotContextFilterInput modelChatBotContextFilterInput, Integer num, String str2) {
    ...
    public String operationId() {
        return "7d490f84e502ab6a12c437753ad389c0ebfcdeac26cf5ade7704796b8960afe2";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetBotContextByChannelId($accountId: ID, $channelId: ModelIDKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelChatBotContextFilterInput, $limit: Int, $nextToken: String) {\n  getBotContextByChannelId(accountId: $accountId, channelId: $channelId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      handlerChatBot\n      masterChatBot\n      accountId\n      contactId\n      userId\n      channelId\n      lastChatMessageId\n      createdAt\n      updatedAt\n      isPaused\n      pausedBy\n      pausedById\n      pausedAt\n      currentIntent\n      intentList\n    }\n    nextToken\n  }\n}";
    }
