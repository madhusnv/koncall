...
import type.DeleteEntityListInput;
...
public final class DeleteEntityListMutation implements Mutation<Data, Data, Variables> {
    ...
    public static class AssociatedDistribution {
        ...
        public static final class Mapper implements ResponseFieldMapper<AssociatedDistribution> {
            ...
            public AssociatedDistribution map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[5], new ResponseReader.ListReader<DistributedEntityType>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteEntityListMutation.AssociatedDistribution.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteEntityListMutation.AssociatedDistribution.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], AssociatedDistribution.this.distributedEntityType, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteEntityListMutation.AssociatedDistribution.1.1
    ...
    public static final class Builder {
        ...
        private DeleteEntityListInput input;

        public DeleteEntityListMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteEntityListMutation(this.input, this.condition);
        }
        ...
        public Builder input(DeleteEntityListInput deleteEntityListInput) {
            this.input = deleteEntityListInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteEntityList", "deleteEntityList", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final DeleteEntityList deleteEntityList;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteEntityList.Mapper deleteEntityListFieldMapper = new DeleteEntityList.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteEntityList) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteEntityList>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteEntityListMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteEntityList read(ResponseReader responseReader2) {
                        return Mapper.this.deleteEntityListFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteEntityList deleteEntityList) {
            this.deleteEntityList = deleteEntityList;
        }

        public DeleteEntityList deleteEntityList() {
        ...
        public boolean equals(Object obj) {
            ...
            DeleteEntityList deleteEntityList = this.deleteEntityList;
            DeleteEntityList deleteEntityList2 = ((Data) obj).deleteEntityList;
            return deleteEntityList == null ? deleteEntityList2 == null : deleteEntityList.equals(deleteEntityList2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteEntityList deleteEntityList = this.deleteEntityList;
                this.$hashCode = (deleteEntityList == null ? 0 : deleteEntityList.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteEntityListMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteEntityList deleteEntityList = Data.this.deleteEntityList;
                    responseWriter.writeObject(responseField, deleteEntityList != null ? deleteEntityList.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteEntityList=" + this.deleteEntityList + "}";
            }
            return this.$toString;
        }
    }

    public static class DeleteEntityList {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<DeleteEntityList> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public DeleteEntityList map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = DeleteEntityList.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
                String string2 = responseReader.readString(responseFieldArr[3]);
                ...
                }), (EntityActionDefinition) responseReader.readObject(responseFieldArr[40], new ResponseReader.ObjectReader<EntityActionDefinition>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteEntityListMutation.DeleteEntityList.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), (Owner) responseReader.readObject(responseFieldArr[41], new ResponseReader.ObjectReader<Owner>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteEntityListMutation.DeleteEntityList.Mapper.4
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteEntityList)) {
                return false;
            }
            DeleteEntityList deleteEntityList = (DeleteEntityList) obj;
            if (this.__typename.equals(deleteEntityList.__typename) && this.id.equals(deleteEntityList.id) && this.accountId.equals(deleteEntityList.accountId) && this.entityTypeInList.equals(deleteEntityList.entityTypeInList) && this.entityListType.equals(deleteEntityList.entityListType) && ((str = this.listName) != null ? str.equals(deleteEntityList.listName) : deleteEntityList.listName == null) && ((str2 = this.description) != null ? str2.equals(deleteEntityList.description) : deleteEntityList.description == null) && ((entityListStatus = this.status) != null ? entityListStatus.equals(deleteEntityList.status) : deleteEntityList.status == null) && ((num = this.successfulCount) != null ? num.equals(deleteEntityList.successfulCount) : deleteEntityList.successfulCount == null) && ((num2 = this.duplicateCount) != null ? num2.equals(deleteEntityList.duplicateCount) : deleteEntityList.duplicateCount == null) && ((num3 = this.invalidNumbersCount) != null ? num3.equals(deleteEntityList.invalidNumbersCount) : deleteEntityList.invalidNumbersCount == null) && ((num4 = this.invalidEmailCount) != null ? num4.equals(deleteEntityList.invalidEmailCount) : deleteEntityList.invalidEmailCount == null) && ((num5 = this.doNotTrackCount) != null ? num5.equals(deleteEntityList.doNotTrackCount) : deleteEntityList.doNotTrackCount == null) && ((num6 = this.otherFailedCount) != null ? num6.equals(deleteEntityList.otherFailedCount) : deleteEntityList.otherFailedCount == null) && this.ownerId.equals(deleteEntityList.ownerId) && this.listCreationType.equals(deleteEntityList.listCreationType) && ((str3 = this.listCategory) != null ? str3.equals(deleteEntityList.listCategory) : deleteEntityList.listCategory == null) && ((str4 = this.rawBulkUploadFileRef) != null ? str4.equals(deleteEntityList.rawBulkUploadFileRef) : deleteEntityList.rawBulkUploadFileRef == null) && ((str5 = this.rawBulkUploadFileHash) != null ? str5.equals(deleteEntityList.rawBulkUploadFileHash) : deleteEntityList.rawBulkUploadFileHash == null) && ((str6 = this.modifiedBulkUploadFileRef) != null ? str6.equals(deleteEntityList.modifiedBulkUploadFileRef) : deleteEntityList.modifiedBulkUploadFileRef == null) && ((str7 = this.finalBulkUploadFileRef) != null ? str7.equals(deleteEntityList.finalBulkUploadFileRef) : deleteEntityList.finalBulkUploadFileRef == null) && ((str8 = this.leadSourceForBulkUpload) != null ? str8.equals(deleteEntityList.leadSourceForBulkUpload) : deleteEntityList.leadSourceForBulkUpload == null) && ((str9 = this.defaultCountryCode) != null ? str9.equals(deleteEntityList.defaultCountryCode) : deleteEntityList.defaultCountryCode == null) && ((str10 = this.defaultCountryIso) != null ? str10.equals(deleteEntityList.defaultCountryIso) : deleteEntityList.defaultCountryIso == null) && ((str11 = this.notificationBody) != null ? str11.equals(deleteEntityList.notificationBody) : deleteEntityList.notificationBody == null) && ((str12 = this.rule) != null ? str12.equals(deleteEntityList.rule) : deleteEntityList.rule == null) && ((contactAssignmentStatus = this.toBeAssigned) != null ? contactAssignmentStatus.equals(deleteEntityList.toBeAssigned) : deleteEntityList.toBeAssigned == null) && ((str13 = this.assignedUserId) != null ? str13.equals(deleteEntityList.assignedUserId) : deleteEntityList.assignedUserId == null) && ((str14 = this.assignedTeamId) != null ? str14.equals(deleteEntityList.assignedTeamId) : deleteEntityList.assignedTeamId == null) && ((str15 = this.associatedDistributionId) != null ? str15.equals(deleteEntityList.associatedDistributionId) : deleteEntityList.associatedDistributionId == null) && ((str16 = this.entityActionDefinitionReference) != null ? str16.equals(deleteEntityList.entityActionDefinitionReference) : deleteEntityList.entityActionDefinitionReference == null) && ((bool = this.redistributeEntities) != null ? bool.equals(deleteEntityList.redistributeEntities) : deleteEntityList.redistributeEntities == null) && ((str17 = this.redistributionRequestedAt) != null ? str17.equals(deleteEntityList.redistributionRequestedAt) : deleteEntityList.redistributionRequestedAt == null) && ((str18 = this.dupliacteLeadList) != null ? str18.equals(deleteEntityList.dupliacteLeadList) : deleteEntityList.dupliacteLeadList == null) && ((list = this.tags) != null ? list.equals(deleteEntityList.tags) : deleteEntityList.tags == null) && ((str19 = this.chatMessagePlatform) != null ? str19.equals(deleteEntityList.chatMessagePlatform) : deleteEntityList.chatMessagePlatform == null) && ((bool2 = this.allowMultiple) != null ? bool2.equals(deleteEntityList.allowMultiple) : deleteEntityList.allowMultiple == null) && ((str20 = this.createdAt) != null ? str20.equals(deleteEntityList.createdAt) : deleteEntityList.createdAt == null) && ((str21 = this.updatedAt) != null ? str21.equals(deleteEntityList.updatedAt) : deleteEntityList.updatedAt == null) && ((associatedDistribution = this.associatedDistribution) != null ? associatedDistribution.equals(deleteEntityList.associatedDistribution) : deleteEntityList.associatedDistribution == null) && ((entityActionDefinition = this.entityActionDefinition) != null ? entityActionDefinition.equals(deleteEntityList.entityActionDefinition) : deleteEntityList.entityActionDefinition == null)) {
                Owner owner = this.owner;
                Owner owner2 = deleteEntityList.owner;
                if (owner == null) {
                    if (owner2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteEntityListMutation.DeleteEntityList.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteEntityList.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteEntityList.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteEntityList.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteEntityList.this.accountId);
                    responseWriter.writeString(responseFieldArr[3], DeleteEntityList.this.entityTypeInList);
                    responseWriter.writeString(responseFieldArr[4], DeleteEntityList.this.entityListType.name());
                    responseWriter.writeString(responseFieldArr[5], DeleteEntityList.this.listName);
                    responseWriter.writeString(responseFieldArr[6], DeleteEntityList.this.description);
                    ResponseField responseField = responseFieldArr[7];
                    EntityListStatus entityListStatus = DeleteEntityList.this.status;
                    responseWriter.writeString(responseField, entityListStatus != null ? entityListStatus.name() : null);
                    responseWriter.writeInt(responseFieldArr[8], DeleteEntityList.this.successfulCount);
                    responseWriter.writeInt(responseFieldArr[9], DeleteEntityList.this.duplicateCount);
                    responseWriter.writeInt(responseFieldArr[10], DeleteEntityList.this.invalidNumbersCount);
                    responseWriter.writeInt(responseFieldArr[11], DeleteEntityList.this.invalidEmailCount);
                    responseWriter.writeInt(responseFieldArr[12], DeleteEntityList.this.doNotTrackCount);
                    responseWriter.writeInt(responseFieldArr[13], DeleteEntityList.this.otherFailedCount);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], DeleteEntityList.this.ownerId);
                    responseWriter.writeString(responseFieldArr[15], DeleteEntityList.this.listCreationType.name());
                    responseWriter.writeString(responseFieldArr[16], DeleteEntityList.this.listCategory);
                    responseWriter.writeString(responseFieldArr[17], DeleteEntityList.this.rawBulkUploadFileRef);
                    responseWriter.writeString(responseFieldArr[18], DeleteEntityList.this.rawBulkUploadFileHash);
                    responseWriter.writeString(responseFieldArr[19], DeleteEntityList.this.modifiedBulkUploadFileRef);
                    responseWriter.writeString(responseFieldArr[20], DeleteEntityList.this.finalBulkUploadFileRef);
                    responseWriter.writeString(responseFieldArr[21], DeleteEntityList.this.leadSourceForBulkUpload);
                    responseWriter.writeString(responseFieldArr[22], DeleteEntityList.this.defaultCountryCode);
                    responseWriter.writeString(responseFieldArr[23], DeleteEntityList.this.defaultCountryIso);
                    responseWriter.writeString(responseFieldArr[24], DeleteEntityList.this.notificationBody);
                    responseWriter.writeString(responseFieldArr[25], DeleteEntityList.this.rule);
                    ResponseField responseField2 = responseFieldArr[26];
                    ContactAssignmentStatus contactAssignmentStatus = DeleteEntityList.this.toBeAssigned;
                    responseWriter.writeString(responseField2, contactAssignmentStatus != null ? contactAssignmentStatus.name() : null);
                    responseWriter.writeString(responseFieldArr[27], DeleteEntityList.this.assignedUserId);
                    responseWriter.writeString(responseFieldArr[28], DeleteEntityList.this.assignedTeamId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[29], DeleteEntityList.this.associatedDistributionId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[30], DeleteEntityList.this.entityActionDefinitionReference);
                    responseWriter.writeBoolean(responseFieldArr[31], DeleteEntityList.this.redistributeEntities);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[32], DeleteEntityList.this.redistributionRequestedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[33], DeleteEntityList.this.dupliacteLeadList);
                    responseWriter.writeList(responseFieldArr[34], DeleteEntityList.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteEntityListMutation.DeleteEntityList.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[35], DeleteEntityList.this.chatMessagePlatform);
                    responseWriter.writeBoolean(responseFieldArr[36], DeleteEntityList.this.allowMultiple);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[37], DeleteEntityList.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], DeleteEntityList.this.updatedAt);
                    ResponseField responseField3 = responseFieldArr[39];
                    AssociatedDistribution associatedDistribution = DeleteEntityList.this.associatedDistribution;
                    ...
                    EntityActionDefinition entityActionDefinition = DeleteEntityList.this.entityActionDefinition;
                    ...
                    Owner owner = DeleteEntityList.this.owner;
    ...
    public static class EntityActionDefinition {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteEntityListMutation.EntityActionDefinition.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = EntityActionDefinition.$responseFields;
    ...
    public static class Owner {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteEntityListMutation.Owner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Owner.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final DeleteEntityListInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteEntityListInput deleteEntityListInput, ModelEntityListConditionInput modelEntityListConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteEntityListInput;
            this.condition = modelEntityListConditionInput;
            linkedHashMap.put("input", deleteEntityListInput);
        ...
        public DeleteEntityListInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteEntityListMutation.Variables.1
    ...
    public DeleteEntityListMutation(DeleteEntityListInput deleteEntityListInput, ModelEntityListConditionInput modelEntityListConditionInput) {
        Utils.checkNotNull(deleteEntityListInput, "input == null");
        this.variables = new Variables(deleteEntityListInput, modelEntityListConditionInput);
    }
    ...
    public String operationId() {
        return "b9f855912779e3105597a1e2768a1d6f513c09668762b7b5f4192c10bcae4be8";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteEntityList($input: DeleteEntityListInput!, $condition: ModelEntityListConditionInput) {\n  deleteEntityList(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    entityTypeInList\n    entityListType\n    listName\n    description\n    status\n    successfulCount\n    duplicateCount\n    invalidNumbersCount\n    invalidEmailCount\n    doNotTrackCount\n    otherFailedCount\n    ownerId\n    listCreationType\n    listCategory\n    rawBulkUploadFileRef\n    rawBulkUploadFileHash\n    modifiedBulkUploadFileRef\n    finalBulkUploadFileRef\n    leadSourceForBulkUpload\n    defaultCountryCode\n    defaultCountryIso\n    notificationBody\n    rule\n    toBeAssigned\n    assignedUserId\n    assignedTeamId\n    associatedDistributionId\n    entityActionDefinitionReference\n    redistributeEntities\n    redistributionRequestedAt\n    dupliacteLeadList\n    tags\n    chatMessagePlatform\n    allowMultiple\n    createdAt\n    updatedAt\n    associatedDistribution {\n      __typename\n      id\n      accountId\n      name\n      description\n      distributedEntityType\n      ifOwnerExists\n      assignLeadOwnerToTask\n      remeberAssigneeInDistributionScope\n      remeberAssigneeInGlobalScope\n      ownerId\n      distributionCreationType\n      createdAt\n      updatedAt\n    }\n    entityActionDefinition {\n      __typename\n      id\n      accountId\n      name\n      description\n      action\n      target\n      subscriptionType\n      periodicFrequency\n      periodicFrequencyUnit\n      startDateTime\n      endDateTime\n      status\n      ownerId\n      createdAt\n      updatedAt\n      createdBy\n      updatedBy\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
