...
import type.ModelProductPlanSubscriptionConditionInput;
import type.UpdateProductPlanSubscriptionInput;

/* loaded from: classes4.dex */
public final class UpdateProductPlanSubscriptionMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation UpdateProductPlanSubscription($input: UpdateProductPlanSubscriptionInput!, $condition: ModelProductPlanSubscriptionConditionInput) {\n  updateProductPlanSubscription(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    addedById\n    productAccountId\n    productPlanId\n    planDescription\n    planStatus\n    planFeePerUnit\n    planFeeProRataPerUnit\n    period\n    amount\n    currency\n    status\n    numberOfUnits\n    numberOfFreeUnits\n    unitType\n    subscriptionPaymentStatus\n    subscriptionStartDate\n    subscriptionEndDate\n    createdAt\n    updatedAt\n    productPlan {\n      __typename\n      id\n      accountId\n      productId\n      planDescription\n      planStatus\n      period\n      fee\n      proRataFee\n      currency\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.UpdateProductPlanSubscriptionMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "UpdateProductPlanSubscription";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation UpdateProductPlanSubscription($input: UpdateProductPlanSubscriptionInput!, $condition: ModelProductPlanSubscriptionConditionInput) {\n  updateProductPlanSubscription(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    addedById\n    productAccountId\n    productPlanId\n    planDescription\n    planStatus\n    planFeePerUnit\n    planFeeProRataPerUnit\n    period\n    amount\n    currency\n    status\n    numberOfUnits\n    numberOfFreeUnits\n    unitType\n    subscriptionPaymentStatus\n    subscriptionStartDate\n    subscriptionEndDate\n    createdAt\n    updatedAt\n    productPlan {\n      __typename\n      id\n      accountId\n      productId\n      planDescription\n      planStatus\n      period\n      fee\n      proRataFee\n      currency\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelProductPlanSubscriptionConditionInput condition;
        private UpdateProductPlanSubscriptionInput input;

        public UpdateProductPlanSubscriptionMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new UpdateProductPlanSubscriptionMutation(this.input, this.condition);
        }

        public Builder condition(ModelProductPlanSubscriptionConditionInput modelProductPlanSubscriptionConditionInput) {
            this.condition = modelProductPlanSubscriptionConditionInput;
            return this;
        }

        public Builder input(UpdateProductPlanSubscriptionInput updateProductPlanSubscriptionInput) {
            this.input = updateProductPlanSubscriptionInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("updateProductPlanSubscription", "updateProductPlanSubscription", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final UpdateProductPlanSubscription updateProductPlanSubscription;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final UpdateProductPlanSubscription.Mapper updateProductPlanSubscriptionFieldMapper = new UpdateProductPlanSubscription.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((UpdateProductPlanSubscription) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<UpdateProductPlanSubscription>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateProductPlanSubscriptionMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdateProductPlanSubscription read(ResponseReader responseReader2) {
                        return Mapper.this.updateProductPlanSubscriptionFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(UpdateProductPlanSubscription updateProductPlanSubscription) {
            this.updateProductPlanSubscription = updateProductPlanSubscription;
        }
        ...
        public boolean equals(Object obj) {
            ...
            UpdateProductPlanSubscription updateProductPlanSubscription = this.updateProductPlanSubscription;
            UpdateProductPlanSubscription updateProductPlanSubscription2 = ((Data) obj).updateProductPlanSubscription;
            return updateProductPlanSubscription == null ? updateProductPlanSubscription2 == null : updateProductPlanSubscription.equals(updateProductPlanSubscription2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                UpdateProductPlanSubscription updateProductPlanSubscription = this.updateProductPlanSubscription;
                this.$hashCode = (updateProductPlanSubscription == null ? 0 : updateProductPlanSubscription.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateProductPlanSubscriptionMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    UpdateProductPlanSubscription updateProductPlanSubscription = Data.this.updateProductPlanSubscription;
                    responseWriter.writeObject(responseField, updateProductPlanSubscription != null ? updateProductPlanSubscription.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{updateProductPlanSubscription=" + this.updateProductPlanSubscription + "}";
            }
            return this.$toString;
        }

        public UpdateProductPlanSubscription updateProductPlanSubscription() {
            return this.updateProductPlanSubscription;
        }
    }
    ...
    public static class ProductPlan {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateProductPlanSubscriptionMutation.ProductPlan.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ProductPlan.$responseFields;
    ...
    public static class UpdateProductPlanSubscription {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public UpdateProductPlanSubscription(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, Integer num, Integer num2, String str9, Integer num3, String str10, String str11, Integer num4, Integer num5, String str12, String str13, String str14, String str15, String str16, String str17, ProductPlan productPlan) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateProductPlanSubscription)) {
                return false;
            }
            UpdateProductPlanSubscription updateProductPlanSubscription = (UpdateProductPlanSubscription) obj;
            if (this.__typename.equals(updateProductPlanSubscription.__typename) && this.id.equals(updateProductPlanSubscription.id) && this.accountId.equals(updateProductPlanSubscription.accountId) && this.addedById.equals(updateProductPlanSubscription.addedById) && ((str = this.productAccountId) != null ? str.equals(updateProductPlanSubscription.productAccountId) : updateProductPlanSubscription.productAccountId == null) && this.productPlanId.equals(updateProductPlanSubscription.productPlanId) && ((str2 = this.planDescription) != null ? str2.equals(updateProductPlanSubscription.planDescription) : updateProductPlanSubscription.planDescription == null) && ((str3 = this.planStatus) != null ? str3.equals(updateProductPlanSubscription.planStatus) : updateProductPlanSubscription.planStatus == null) && ((num = this.planFeePerUnit) != null ? num.equals(updateProductPlanSubscription.planFeePerUnit) : updateProductPlanSubscription.planFeePerUnit == null) && ((num2 = this.planFeeProRataPerUnit) != null ? num2.equals(updateProductPlanSubscription.planFeeProRataPerUnit) : updateProductPlanSubscription.planFeeProRataPerUnit == null) && ((str4 = this.period) != null ? str4.equals(updateProductPlanSubscription.period) : updateProductPlanSubscription.period == null) && ((num3 = this.amount) != null ? num3.equals(updateProductPlanSubscription.amount) : updateProductPlanSubscription.amount == null) && ((str5 = this.currency) != null ? str5.equals(updateProductPlanSubscription.currency) : updateProductPlanSubscription.currency == null) && ((str6 = this.status) != null ? str6.equals(updateProductPlanSubscription.status) : updateProductPlanSubscription.status == null) && ((num4 = this.numberOfUnits) != null ? num4.equals(updateProductPlanSubscription.numberOfUnits) : updateProductPlanSubscription.numberOfUnits == null) && ((num5 = this.numberOfFreeUnits) != null ? num5.equals(updateProductPlanSubscription.numberOfFreeUnits) : updateProductPlanSubscription.numberOfFreeUnits == null) && ((str7 = this.unitType) != null ? str7.equals(updateProductPlanSubscription.unitType) : updateProductPlanSubscription.unitType == null) && ((str8 = this.subscriptionPaymentStatus) != null ? str8.equals(updateProductPlanSubscription.subscriptionPaymentStatus) : updateProductPlanSubscription.subscriptionPaymentStatus == null) && this.subscriptionStartDate.equals(updateProductPlanSubscription.subscriptionStartDate) && ((str9 = this.subscriptionEndDate) != null ? str9.equals(updateProductPlanSubscription.subscriptionEndDate) : updateProductPlanSubscription.subscriptionEndDate == null) && this.createdAt.equals(updateProductPlanSubscription.createdAt) && this.updatedAt.equals(updateProductPlanSubscription.updatedAt)) {
                ProductPlan productPlan = this.productPlan;
                ProductPlan productPlan2 = updateProductPlanSubscription.productPlan;
                if (productPlan == null) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateProductPlanSubscriptionMutation.UpdateProductPlanSubscription.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdateProductPlanSubscription.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UpdateProductPlanSubscription.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], UpdateProductPlanSubscription.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], UpdateProductPlanSubscription.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], UpdateProductPlanSubscription.this.addedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], UpdateProductPlanSubscription.this.productAccountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], UpdateProductPlanSubscription.this.productPlanId);
                    responseWriter.writeString(responseFieldArr[6], UpdateProductPlanSubscription.this.planDescription);
                    responseWriter.writeString(responseFieldArr[7], UpdateProductPlanSubscription.this.planStatus);
                    responseWriter.writeInt(responseFieldArr[8], UpdateProductPlanSubscription.this.planFeePerUnit);
                    responseWriter.writeInt(responseFieldArr[9], UpdateProductPlanSubscription.this.planFeeProRataPerUnit);
                    responseWriter.writeString(responseFieldArr[10], UpdateProductPlanSubscription.this.period);
                    responseWriter.writeInt(responseFieldArr[11], UpdateProductPlanSubscription.this.amount);
                    responseWriter.writeString(responseFieldArr[12], UpdateProductPlanSubscription.this.currency);
                    responseWriter.writeString(responseFieldArr[13], UpdateProductPlanSubscription.this.status);
                    responseWriter.writeInt(responseFieldArr[14], UpdateProductPlanSubscription.this.numberOfUnits);
                    responseWriter.writeInt(responseFieldArr[15], UpdateProductPlanSubscription.this.numberOfFreeUnits);
                    responseWriter.writeString(responseFieldArr[16], UpdateProductPlanSubscription.this.unitType);
                    responseWriter.writeString(responseFieldArr[17], UpdateProductPlanSubscription.this.subscriptionPaymentStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], UpdateProductPlanSubscription.this.subscriptionStartDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], UpdateProductPlanSubscription.this.subscriptionEndDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], UpdateProductPlanSubscription.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], UpdateProductPlanSubscription.this.updatedAt);
                    ResponseField responseField = responseFieldArr[22];
                    ProductPlan productPlan = UpdateProductPlanSubscription.this.productPlan;
    ...
    public static final class Variables extends Operation.Variables {
        private final ModelProductPlanSubscriptionConditionInput condition;
        private final UpdateProductPlanSubscriptionInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(UpdateProductPlanSubscriptionInput updateProductPlanSubscriptionInput, ModelProductPlanSubscriptionConditionInput modelProductPlanSubscriptionConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = updateProductPlanSubscriptionInput;
            this.condition = modelProductPlanSubscriptionConditionInput;
            linkedHashMap.put("input", updateProductPlanSubscriptionInput);
            linkedHashMap.put("condition", modelProductPlanSubscriptionConditionInput);
        }

        public ModelProductPlanSubscriptionConditionInput condition() {
            return this.condition;
        }

        public UpdateProductPlanSubscriptionInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateProductPlanSubscriptionMutation.Variables.1
    ...
    public UpdateProductPlanSubscriptionMutation(UpdateProductPlanSubscriptionInput updateProductPlanSubscriptionInput, ModelProductPlanSubscriptionConditionInput modelProductPlanSubscriptionConditionInput) {
        Utils.checkNotNull(updateProductPlanSubscriptionInput, "input == null");
        this.variables = new Variables(updateProductPlanSubscriptionInput, modelProductPlanSubscriptionConditionInput);
    }
    ...
    public String operationId() {
        return "d326e9817af560ed6d3b0c457b7c5806384c1b24f630ea2b5a2dd8d5b7e8b557";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation UpdateProductPlanSubscription($input: UpdateProductPlanSubscriptionInput!, $condition: ModelProductPlanSubscriptionConditionInput) {\n  updateProductPlanSubscription(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    addedById\n    productAccountId\n    productPlanId\n    planDescription\n    planStatus\n    planFeePerUnit\n    planFeeProRataPerUnit\n    period\n    amount\n    currency\n    status\n    numberOfUnits\n    numberOfFreeUnits\n    unitType\n    subscriptionPaymentStatus\n    subscriptionStartDate\n    subscriptionEndDate\n    createdAt\n    updatedAt\n    productPlan {\n      __typename\n      id\n      accountId\n      productId\n      planDescription\n      planStatus\n      period\n      fee\n      proRataFee\n      currency\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
