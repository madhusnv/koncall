...
import type.DeleteCustomValueInput;
import type.ModelCustomValueConditionInput;

/* loaded from: classes6.dex */
public final class DeleteCustomValueMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation DeleteCustomValue($input: DeleteCustomValueInput!, $condition: ModelCustomValueConditionInput) {\n  deleteCustomValue(input: $input, condition: $condition) {\n    __typename\n    propertyDefinitionId\n    accountId\n    parentObjectId\n    parentObjectType\n    value\n    createSourceId\n    createSourceType\n    createdAt\n    updatedAt\n    propertyDefinition {\n      __typename\n      id\n      accountId\n      propertyName\n      displayName\n      description\n      scalarType\n      dataType\n      isMultiple\n      parentObjectType\n      isSystemProperty\n      isArchived\n      displayOrder\n      createdById\n      updaedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCustomValueMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "DeleteCustomValue";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation DeleteCustomValue($input: DeleteCustomValueInput!, $condition: ModelCustomValueConditionInput) {\n  deleteCustomValue(input: $input, condition: $condition) {\n    __typename\n    propertyDefinitionId\n    accountId\n    parentObjectId\n    parentObjectType\n    value\n    createSourceId\n    createSourceType\n    createdAt\n    updatedAt\n    propertyDefinition {\n      __typename\n      id\n      accountId\n      propertyName\n      displayName\n      description\n      scalarType\n      dataType\n      isMultiple\n      parentObjectType\n      isSystemProperty\n      isArchived\n      displayOrder\n      createdById\n      updaedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelCustomValueConditionInput condition;
        private DeleteCustomValueInput input;

        public DeleteCustomValueMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteCustomValueMutation(this.input, this.condition);
        }
        ...
        public Builder input(DeleteCustomValueInput deleteCustomValueInput) {
            this.input = deleteCustomValueInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteCustomValue", "deleteCustomValue", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final DeleteCustomValue deleteCustomValue;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteCustomValue.Mapper deleteCustomValueFieldMapper = new DeleteCustomValue.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteCustomValue) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteCustomValue>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCustomValueMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteCustomValue read(ResponseReader responseReader2) {
                        return Mapper.this.deleteCustomValueFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteCustomValue deleteCustomValue) {
            this.deleteCustomValue = deleteCustomValue;
        }

        public DeleteCustomValue deleteCustomValue() {
            return this.deleteCustomValue;
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteCustomValue deleteCustomValue = this.deleteCustomValue;
            DeleteCustomValue deleteCustomValue2 = ((Data) obj).deleteCustomValue;
            return deleteCustomValue == null ? deleteCustomValue2 == null : deleteCustomValue.equals(deleteCustomValue2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteCustomValue deleteCustomValue = this.deleteCustomValue;
                this.$hashCode = (deleteCustomValue == null ? 0 : deleteCustomValue.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCustomValueMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteCustomValue deleteCustomValue = Data.this.deleteCustomValue;
                    responseWriter.writeObject(responseField, deleteCustomValue != null ? deleteCustomValue.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteCustomValue=" + this.deleteCustomValue + "}";
            }
            return this.$toString;
        }
    }

    public static class DeleteCustomValue {
        ...
        public DeleteCustomValue(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, PropertyDefinition propertyDefinition) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteCustomValue)) {
                return false;
            }
            DeleteCustomValue deleteCustomValue = (DeleteCustomValue) obj;
            if (this.__typename.equals(deleteCustomValue.__typename) && this.propertyDefinitionId.equals(deleteCustomValue.propertyDefinitionId) && this.accountId.equals(deleteCustomValue.accountId) && this.parentObjectId.equals(deleteCustomValue.parentObjectId) && ((str = this.parentObjectType) != null ? str.equals(deleteCustomValue.parentObjectType) : deleteCustomValue.parentObjectType == null) && this.value.equals(deleteCustomValue.value) && ((str2 = this.createSourceId) != null ? str2.equals(deleteCustomValue.createSourceId) : deleteCustomValue.createSourceId == null) && ((str3 = this.createSourceType) != null ? str3.equals(deleteCustomValue.createSourceType) : deleteCustomValue.createSourceType == null) && ((str4 = this.createdAt) != null ? str4.equals(deleteCustomValue.createdAt) : deleteCustomValue.createdAt == null) && ((str5 = this.updatedAt) != null ? str5.equals(deleteCustomValue.updatedAt) : deleteCustomValue.updatedAt == null)) {
                PropertyDefinition propertyDefinition = this.propertyDefinition;
                PropertyDefinition propertyDefinition2 = deleteCustomValue.propertyDefinition;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCustomValueMutation.DeleteCustomValue.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteCustomValue.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteCustomValue.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteCustomValue.this.propertyDefinitionId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteCustomValue.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], DeleteCustomValue.this.parentObjectId);
                    responseWriter.writeString(responseFieldArr[4], DeleteCustomValue.this.parentObjectType);
                    responseWriter.writeString(responseFieldArr[5], DeleteCustomValue.this.value);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], DeleteCustomValue.this.createSourceId);
                    responseWriter.writeString(responseFieldArr[7], DeleteCustomValue.this.createSourceType);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], DeleteCustomValue.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], DeleteCustomValue.this.updatedAt);
                    ResponseField responseField = responseFieldArr[10];
                    PropertyDefinition propertyDefinition = DeleteCustomValue.this.propertyDefinition;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "DeleteCustomValue{__typename=" + this.__typename + ", propertyDefinitionId=" + this.propertyDefinitionId + ", accountId=" + this.accountId + ", parentObjectId=" + this.parentObjectId + ", parentObjectType=" + this.parentObjectType + ", value=" + this.value + ", createSourceId=" + this.createSourceId + ", createSourceType=" + this.createSourceType + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", propertyDefinition=" + this.propertyDefinition + "}";
            }
            return this.$toString;
        }
    ...
    public static class PropertyDefinition {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCustomValueMutation.PropertyDefinition.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = PropertyDefinition.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final DeleteCustomValueInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteCustomValueInput deleteCustomValueInput, ModelCustomValueConditionInput modelCustomValueConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteCustomValueInput;
            this.condition = modelCustomValueConditionInput;
            linkedHashMap.put("input", deleteCustomValueInput);
        ...
        public DeleteCustomValueInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCustomValueMutation.Variables.1
    ...
    public DeleteCustomValueMutation(DeleteCustomValueInput deleteCustomValueInput, ModelCustomValueConditionInput modelCustomValueConditionInput) {
        Utils.checkNotNull(deleteCustomValueInput, "input == null");
        this.variables = new Variables(deleteCustomValueInput, modelCustomValueConditionInput);
    }
    ...
    public String operationId() {
        return "8aa510418c10dc9934144c66bad419eb5c5b3676dd4a7f81ae8528a7a465c0c5";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteCustomValue($input: DeleteCustomValueInput!, $condition: ModelCustomValueConditionInput) {\n  deleteCustomValue(input: $input, condition: $condition) {\n    __typename\n    propertyDefinitionId\n    accountId\n    parentObjectId\n    parentObjectType\n    value\n    createSourceId\n    createSourceType\n    createdAt\n    updatedAt\n    propertyDefinition {\n      __typename\n      id\n      accountId\n      propertyName\n      displayName\n      description\n      scalarType\n      dataType\n      isMultiple\n      parentObjectType\n      isSystemProperty\n      isArchived\n      displayOrder\n      createdById\n      updaedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
