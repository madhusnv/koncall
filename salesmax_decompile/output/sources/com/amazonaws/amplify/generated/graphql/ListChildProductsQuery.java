...
public final class ListChildProductsQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListChildProducts($parentProductId: ID, $sortDirection: ModelSortDirection, $filter: ModelProductServiceFilterInput, $limit: Int, $nextToken: String) {\n  listChildProducts(parentProductId: $parentProductId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      name\n      description\n      type\n      measurementUnit\n      incrementBy\n      hsCode\n      skuCode\n      standardPricePerUnit\n      currency\n      parentProductId\n      productPicture\n      startDate\n      endDate\n      isArchived\n      createdBy\n      updatedBy\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListChildProductsQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListChildProducts";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListChildProducts($parentProductId: ID, $sortDirection: ModelSortDirection, $filter: ModelProductServiceFilterInput, $limit: Int, $nextToken: String) {\n  listChildProducts(parentProductId: $parentProductId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      name\n      description\n      type\n      measurementUnit\n      incrementBy\n      hsCode\n      skuCode\n      standardPricePerUnit\n      currency\n      parentProductId\n      productPicture\n      startDate\n      endDate\n      isArchived\n      createdBy\n      updatedBy\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelProductServiceFilterInput filter;
        private Integer limit;
        private String nextToken;
        private String parentProductId;
        private ModelSortDirection sortDirection;

        public ListChildProductsQuery build() {
            return new ListChildProductsQuery(this.parentProductId, this.sortDirection, this.filter, this.limit, this.nextToken);
        }

        public Builder filter(ModelProductServiceFilterInput modelProductServiceFilterInput) {
            this.filter = modelProductServiceFilterInput;
            return this;
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listChildProducts", "listChildProducts", new UnmodifiableMapBuilder(5).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put("parentProductId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "parentProductId").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListChildProducts listChildProducts;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListChildProducts.Mapper listChildProductsFieldMapper = new ListChildProducts.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListChildProducts) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListChildProducts>() { // from class: com.amazonaws.amplify.generated.graphql.ListChildProductsQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListChildProducts read(ResponseReader responseReader2) {
                        return Mapper.this.listChildProductsFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListChildProducts listChildProducts) {
        ...
        public boolean equals(Object obj) {
            ...
            ListChildProducts listChildProducts = this.listChildProducts;
            ListChildProducts listChildProducts2 = ((Data) obj).listChildProducts;
            return listChildProducts == null ? listChildProducts2 == null : listChildProducts.equals(listChildProducts2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListChildProducts listChildProducts = this.listChildProducts;
                this.$hashCode = (listChildProducts == null ? 0 : listChildProducts.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListChildProducts listChildProducts() {
            return this.listChildProducts;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListChildProductsQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListChildProducts listChildProducts = Data.this.listChildProducts;
                    responseWriter.writeObject(responseField, listChildProducts != null ? listChildProducts.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listChildProducts=" + this.listChildProducts + "}";
            }
    ...
    public static class Item {
        ...
        final ProductServiceType f58073type;
        ...
        public Item(String str, String str2, String str3, String str4, String str5, ProductServiceType productServiceType, String str6, Integer num, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, Boolean bool, String str15, String str16, String str17, String str18) {
            ...
            this.f58073type = productServiceType;
        ...
        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ...
                ProductServiceType productServiceType = this.f58073type;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListChildProductsQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    ProductServiceType productServiceType = Item.this.f58073type;
    ...
    public static class ListChildProducts {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListChildProducts> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListChildProducts map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListChildProducts.$responseFields;
                return new ListChildProducts(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListChildProductsQuery.ListChildProducts.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListChildProductsQuery.ListChildProducts.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListChildProducts(String str, List<Item> list, String str2) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListChildProducts)) {
                return false;
            }
            ListChildProducts listChildProducts = (ListChildProducts) obj;
            if (this.__typename.equals(listChildProducts.__typename) && this.items.equals(listChildProducts.items)) {
                String str = this.nextToken;
                String str2 = listChildProducts.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListChildProductsQuery.ListChildProducts.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListChildProducts.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListChildProducts.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListChildProducts.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListChildProductsQuery.ListChildProducts.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListChildProducts.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListChildProducts{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        private final ModelProductServiceFilterInput filter;
        ...
        public Variables(String str, ModelSortDirection modelSortDirection, ModelProductServiceFilterInput modelProductServiceFilterInput, Integer num, String str2) {
            ...
            this.limit = num;
            this.nextToken = str2;
            linkedHashMap.put("parentProductId", str);
            linkedHashMap.put("sortDirection", modelSortDirection);
            linkedHashMap.put("filter", modelProductServiceFilterInput);
            linkedHashMap.put("limit", num);
            linkedHashMap.put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, str2);
        }

        public ModelProductServiceFilterInput filter() {
            return this.filter;
        }
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListChildProductsQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("parentProductId", Variables.this.parentProductId);
    ...
    public ListChildProductsQuery(String str, ModelSortDirection modelSortDirection, ModelProductServiceFilterInput modelProductServiceFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelSortDirection, modelProductServiceFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "efae68193dd25d98b5539add813768e6d3f6eac18c10b3885c735154921bbcdb";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListChildProducts($parentProductId: ID, $sortDirection: ModelSortDirection, $filter: ModelProductServiceFilterInput, $limit: Int, $nextToken: String) {\n  listChildProducts(parentProductId: $parentProductId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      name\n      description\n      type\n      measurementUnit\n      incrementBy\n      hsCode\n      skuCode\n      standardPricePerUnit\n      currency\n      parentProductId\n      productPicture\n      startDate\n      endDate\n      isArchived\n      createdBy\n      updatedBy\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
