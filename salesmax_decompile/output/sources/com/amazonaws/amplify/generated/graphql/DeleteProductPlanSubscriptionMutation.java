...
import type.DeleteProductPlanSubscriptionInput;
import type.ModelProductPlanSubscriptionConditionInput;

/* loaded from: classes7.dex */
public final class DeleteProductPlanSubscriptionMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation DeleteProductPlanSubscription($input: DeleteProductPlanSubscriptionInput!, $condition: ModelProductPlanSubscriptionConditionInput) {\n  deleteProductPlanSubscription(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    addedById\n    productAccountId\n    productPlanId\n    planDescription\n    planStatus\n    planFeePerUnit\n    planFeeProRataPerUnit\n    period\n    amount\n    currency\n    status\n    numberOfUnits\n    numberOfFreeUnits\n    unitType\n    subscriptionPaymentStatus\n    subscriptionStartDate\n    subscriptionEndDate\n    createdAt\n    updatedAt\n    productPlan {\n      __typename\n      id\n      accountId\n      productId\n      planDescription\n      planStatus\n      period\n      fee\n      proRataFee\n      currency\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.DeleteProductPlanSubscriptionMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "DeleteProductPlanSubscription";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation DeleteProductPlanSubscription($input: DeleteProductPlanSubscriptionInput!, $condition: ModelProductPlanSubscriptionConditionInput) {\n  deleteProductPlanSubscription(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    addedById\n    productAccountId\n    productPlanId\n    planDescription\n    planStatus\n    planFeePerUnit\n    planFeeProRataPerUnit\n    period\n    amount\n    currency\n    status\n    numberOfUnits\n    numberOfFreeUnits\n    unitType\n    subscriptionPaymentStatus\n    subscriptionStartDate\n    subscriptionEndDate\n    createdAt\n    updatedAt\n    productPlan {\n      __typename\n      id\n      accountId\n      productId\n      planDescription\n      planStatus\n      period\n      fee\n      proRataFee\n      currency\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelProductPlanSubscriptionConditionInput condition;
        private DeleteProductPlanSubscriptionInput input;

        public DeleteProductPlanSubscriptionMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteProductPlanSubscriptionMutation(this.input, this.condition);
        }
        ...
        public Builder input(DeleteProductPlanSubscriptionInput deleteProductPlanSubscriptionInput) {
            this.input = deleteProductPlanSubscriptionInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteProductPlanSubscription", "deleteProductPlanSubscription", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final DeleteProductPlanSubscription deleteProductPlanSubscription;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteProductPlanSubscription.Mapper deleteProductPlanSubscriptionFieldMapper = new DeleteProductPlanSubscription.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteProductPlanSubscription) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteProductPlanSubscription>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteProductPlanSubscriptionMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteProductPlanSubscription read(ResponseReader responseReader2) {
                        return Mapper.this.deleteProductPlanSubscriptionFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteProductPlanSubscription deleteProductPlanSubscription) {
            this.deleteProductPlanSubscription = deleteProductPlanSubscription;
        }

        public DeleteProductPlanSubscription deleteProductPlanSubscription() {
            return this.deleteProductPlanSubscription;
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteProductPlanSubscription deleteProductPlanSubscription = this.deleteProductPlanSubscription;
            DeleteProductPlanSubscription deleteProductPlanSubscription2 = ((Data) obj).deleteProductPlanSubscription;
            return deleteProductPlanSubscription == null ? deleteProductPlanSubscription2 == null : deleteProductPlanSubscription.equals(deleteProductPlanSubscription2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteProductPlanSubscription deleteProductPlanSubscription = this.deleteProductPlanSubscription;
                this.$hashCode = (deleteProductPlanSubscription == null ? 0 : deleteProductPlanSubscription.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteProductPlanSubscriptionMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteProductPlanSubscription deleteProductPlanSubscription = Data.this.deleteProductPlanSubscription;
                    responseWriter.writeObject(responseField, deleteProductPlanSubscription != null ? deleteProductPlanSubscription.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteProductPlanSubscription=" + this.deleteProductPlanSubscription + "}";
            }
            return this.$toString;
        }
    }

    public static class DeleteProductPlanSubscription {
        ...
        public DeleteProductPlanSubscription(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, Integer num, Integer num2, String str9, Integer num3, String str10, String str11, Integer num4, Integer num5, String str12, String str13, String str14, String str15, String str16, String str17, ProductPlan productPlan) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteProductPlanSubscription)) {
                return false;
            }
            DeleteProductPlanSubscription deleteProductPlanSubscription = (DeleteProductPlanSubscription) obj;
            if (this.__typename.equals(deleteProductPlanSubscription.__typename) && this.id.equals(deleteProductPlanSubscription.id) && this.accountId.equals(deleteProductPlanSubscription.accountId) && this.addedById.equals(deleteProductPlanSubscription.addedById) && ((str = this.productAccountId) != null ? str.equals(deleteProductPlanSubscription.productAccountId) : deleteProductPlanSubscription.productAccountId == null) && this.productPlanId.equals(deleteProductPlanSubscription.productPlanId) && ((str2 = this.planDescription) != null ? str2.equals(deleteProductPlanSubscription.planDescription) : deleteProductPlanSubscription.planDescription == null) && ((str3 = this.planStatus) != null ? str3.equals(deleteProductPlanSubscription.planStatus) : deleteProductPlanSubscription.planStatus == null) && ((num = this.planFeePerUnit) != null ? num.equals(deleteProductPlanSubscription.planFeePerUnit) : deleteProductPlanSubscription.planFeePerUnit == null) && ((num2 = this.planFeeProRataPerUnit) != null ? num2.equals(deleteProductPlanSubscription.planFeeProRataPerUnit) : deleteProductPlanSubscription.planFeeProRataPerUnit == null) && ((str4 = this.period) != null ? str4.equals(deleteProductPlanSubscription.period) : deleteProductPlanSubscription.period == null) && ((num3 = this.amount) != null ? num3.equals(deleteProductPlanSubscription.amount) : deleteProductPlanSubscription.amount == null) && ((str5 = this.currency) != null ? str5.equals(deleteProductPlanSubscription.currency) : deleteProductPlanSubscription.currency == null) && ((str6 = this.status) != null ? str6.equals(deleteProductPlanSubscription.status) : deleteProductPlanSubscription.status == null) && ((num4 = this.numberOfUnits) != null ? num4.equals(deleteProductPlanSubscription.numberOfUnits) : deleteProductPlanSubscription.numberOfUnits == null) && ((num5 = this.numberOfFreeUnits) != null ? num5.equals(deleteProductPlanSubscription.numberOfFreeUnits) : deleteProductPlanSubscription.numberOfFreeUnits == null) && ((str7 = this.unitType) != null ? str7.equals(deleteProductPlanSubscription.unitType) : deleteProductPlanSubscription.unitType == null) && ((str8 = this.subscriptionPaymentStatus) != null ? str8.equals(deleteProductPlanSubscription.subscriptionPaymentStatus) : deleteProductPlanSubscription.subscriptionPaymentStatus == null) && this.subscriptionStartDate.equals(deleteProductPlanSubscription.subscriptionStartDate) && ((str9 = this.subscriptionEndDate) != null ? str9.equals(deleteProductPlanSubscription.subscriptionEndDate) : deleteProductPlanSubscription.subscriptionEndDate == null) && this.createdAt.equals(deleteProductPlanSubscription.createdAt) && this.updatedAt.equals(deleteProductPlanSubscription.updatedAt)) {
                ProductPlan productPlan = this.productPlan;
                ProductPlan productPlan2 = deleteProductPlanSubscription.productPlan;
                if (productPlan == null) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteProductPlanSubscriptionMutation.DeleteProductPlanSubscription.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteProductPlanSubscription.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteProductPlanSubscription.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteProductPlanSubscription.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteProductPlanSubscription.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], DeleteProductPlanSubscription.this.addedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], DeleteProductPlanSubscription.this.productAccountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], DeleteProductPlanSubscription.this.productPlanId);
                    responseWriter.writeString(responseFieldArr[6], DeleteProductPlanSubscription.this.planDescription);
                    responseWriter.writeString(responseFieldArr[7], DeleteProductPlanSubscription.this.planStatus);
                    responseWriter.writeInt(responseFieldArr[8], DeleteProductPlanSubscription.this.planFeePerUnit);
                    responseWriter.writeInt(responseFieldArr[9], DeleteProductPlanSubscription.this.planFeeProRataPerUnit);
                    responseWriter.writeString(responseFieldArr[10], DeleteProductPlanSubscription.this.period);
                    responseWriter.writeInt(responseFieldArr[11], DeleteProductPlanSubscription.this.amount);
                    responseWriter.writeString(responseFieldArr[12], DeleteProductPlanSubscription.this.currency);
                    responseWriter.writeString(responseFieldArr[13], DeleteProductPlanSubscription.this.status);
                    responseWriter.writeInt(responseFieldArr[14], DeleteProductPlanSubscription.this.numberOfUnits);
                    responseWriter.writeInt(responseFieldArr[15], DeleteProductPlanSubscription.this.numberOfFreeUnits);
                    responseWriter.writeString(responseFieldArr[16], DeleteProductPlanSubscription.this.unitType);
                    responseWriter.writeString(responseFieldArr[17], DeleteProductPlanSubscription.this.subscriptionPaymentStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], DeleteProductPlanSubscription.this.subscriptionStartDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], DeleteProductPlanSubscription.this.subscriptionEndDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], DeleteProductPlanSubscription.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], DeleteProductPlanSubscription.this.updatedAt);
                    ResponseField responseField = responseFieldArr[22];
                    ProductPlan productPlan = DeleteProductPlanSubscription.this.productPlan;
    ...
    public static class ProductPlan {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteProductPlanSubscriptionMutation.ProductPlan.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ProductPlan.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final DeleteProductPlanSubscriptionInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteProductPlanSubscriptionInput deleteProductPlanSubscriptionInput, ModelProductPlanSubscriptionConditionInput modelProductPlanSubscriptionConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteProductPlanSubscriptionInput;
            this.condition = modelProductPlanSubscriptionConditionInput;
            linkedHashMap.put("input", deleteProductPlanSubscriptionInput);
        ...
        public DeleteProductPlanSubscriptionInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteProductPlanSubscriptionMutation.Variables.1
    ...
    public DeleteProductPlanSubscriptionMutation(DeleteProductPlanSubscriptionInput deleteProductPlanSubscriptionInput, ModelProductPlanSubscriptionConditionInput modelProductPlanSubscriptionConditionInput) {
        Utils.checkNotNull(deleteProductPlanSubscriptionInput, "input == null");
        this.variables = new Variables(deleteProductPlanSubscriptionInput, modelProductPlanSubscriptionConditionInput);
    }
    ...
    public String operationId() {
        return "1434d2d91d9539f511bd357b7003d186ce062867b832efbbb92512cbaac19a38";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteProductPlanSubscription($input: DeleteProductPlanSubscriptionInput!, $condition: ModelProductPlanSubscriptionConditionInput) {\n  deleteProductPlanSubscription(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    addedById\n    productAccountId\n    productPlanId\n    planDescription\n    planStatus\n    planFeePerUnit\n    planFeeProRataPerUnit\n    period\n    amount\n    currency\n    status\n    numberOfUnits\n    numberOfFreeUnits\n    unitType\n    subscriptionPaymentStatus\n    subscriptionStartDate\n    subscriptionEndDate\n    createdAt\n    updatedAt\n    productPlan {\n      __typename\n      id\n      accountId\n      productId\n      planDescription\n      planStatus\n      period\n      fee\n      proRataFee\n      currency\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
