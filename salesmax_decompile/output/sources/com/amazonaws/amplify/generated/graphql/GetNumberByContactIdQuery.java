...
public final class GetNumberByContactIdQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetNumberByContactId($contactId: ID, $phoneNumber: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelContactNumberFilterInput, $limit: Int, $nextToken: String) {\n  getNumberByContactId(contactId: $contactId, phoneNumber: $phoneNumber, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      contactId\n      accountId\n      contactNumberType\n      isPrimary\n      isValid\n      isVerified\n      isWhatsappNumber\n      isWrongNumber\n      isSpam\n      doNotTrack\n      doNotTrackSetBy\n      phoneNumber\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetNumberByContactIdQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetNumberByContactId";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetNumberByContactId($contactId: ID, $phoneNumber: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelContactNumberFilterInput, $limit: Int, $nextToken: String) {\n  getNumberByContactId(contactId: $contactId, phoneNumber: $phoneNumber, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      contactId\n      accountId\n      contactNumberType\n      isPrimary\n      isValid\n      isVerified\n      isWhatsappNumber\n      isWrongNumber\n      isSpam\n      doNotTrack\n      doNotTrackSetBy\n      phoneNumber\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetNumberByContactIdQuery build() {
            return new GetNumberByContactIdQuery(this.contactId, this.phoneNumber, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getNumberByContactId", "getNumberByContactId", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put("phoneNumber", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "phoneNumber").build()).put("contactId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "contactId").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetNumberByContactId getNumberByContactId;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetNumberByContactId.Mapper getNumberByContactIdFieldMapper = new GetNumberByContactId.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetNumberByContactId) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetNumberByContactId>() { // from class: com.amazonaws.amplify.generated.graphql.GetNumberByContactIdQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetNumberByContactId read(ResponseReader responseReader2) {
                        return Mapper.this.getNumberByContactIdFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetNumberByContactId getNumberByContactId) {
            this.getNumberByContactId = getNumberByContactId;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetNumberByContactId getNumberByContactId = this.getNumberByContactId;
            GetNumberByContactId getNumberByContactId2 = ((Data) obj).getNumberByContactId;
            return getNumberByContactId == null ? getNumberByContactId2 == null : getNumberByContactId.equals(getNumberByContactId2);
        }

        public GetNumberByContactId getNumberByContactId() {
            return this.getNumberByContactId;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetNumberByContactId getNumberByContactId = this.getNumberByContactId;
                this.$hashCode = (getNumberByContactId == null ? 0 : getNumberByContactId.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetNumberByContactIdQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetNumberByContactId getNumberByContactId = Data.this.getNumberByContactId;
                    responseWriter.writeObject(responseField, getNumberByContactId != null ? getNumberByContactId.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getNumberByContactId=" + this.getNumberByContactId + "}";
            }
            return this.$toString;
        }
    }

    public static class GetNumberByContactId {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetNumberByContactId> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetNumberByContactId map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetNumberByContactId.$responseFields;
                return new GetNumberByContactId(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetNumberByContactIdQuery.GetNumberByContactId.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetNumberByContactIdQuery.GetNumberByContactId.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetNumberByContactId(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetNumberByContactId)) {
                return false;
            }
            GetNumberByContactId getNumberByContactId = (GetNumberByContactId) obj;
            if (this.__typename.equals(getNumberByContactId.__typename) && this.items.equals(getNumberByContactId.items)) {
                String str = this.nextToken;
                String str2 = getNumberByContactId.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetNumberByContactIdQuery.GetNumberByContactId.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetNumberByContactId.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetNumberByContactId.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetNumberByContactId.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetNumberByContactIdQuery.GetNumberByContactId.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetNumberByContactId.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetNumberByContactId{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetNumberByContactIdQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelContactNumberFilterInput modelContactNumberFilterInput, Integer num, String str2) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetNumberByContactIdQuery.Variables.1
    ...
    public GetNumberByContactIdQuery(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelContactNumberFilterInput modelContactNumberFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelStringKeyConditionInput, modelSortDirection, modelContactNumberFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "9fb9a32da8f1e91ee8e03f197e204113edda77e402f2ddb03ec9067b46af9c70";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetNumberByContactId($contactId: ID, $phoneNumber: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelContactNumberFilterInput, $limit: Int, $nextToken: String) {\n  getNumberByContactId(contactId: $contactId, phoneNumber: $phoneNumber, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      contactId\n      accountId\n      contactNumberType\n      isPrimary\n      isValid\n      isVerified\n      isWhatsappNumber\n      isWrongNumber\n      isSpam\n      doNotTrack\n      doNotTrackSetBy\n      phoneNumber\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
