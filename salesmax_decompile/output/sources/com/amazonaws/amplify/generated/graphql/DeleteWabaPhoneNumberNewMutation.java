...
import type.DeleteWabaPhoneNumberNewInput;
...
public final class DeleteWabaPhoneNumberNewMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation DeleteWabaPhoneNumberNew($input: DeleteWabaPhoneNumberNewInput!, $condition: ModelWabaPhoneNumberNewConditionInput) {\n  deleteWabaPhoneNumberNew(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWabaPhoneNumberNewMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "DeleteWabaPhoneNumberNew";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation DeleteWabaPhoneNumberNew($input: DeleteWabaPhoneNumberNewInput!, $condition: ModelWabaPhoneNumberNewConditionInput) {\n  deleteWabaPhoneNumberNew(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelWabaPhoneNumberNewConditionInput condition;
        private DeleteWabaPhoneNumberNewInput input;

        public DeleteWabaPhoneNumberNewMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteWabaPhoneNumberNewMutation(this.input, this.condition);
        }
        ...
        public Builder input(DeleteWabaPhoneNumberNewInput deleteWabaPhoneNumberNewInput) {
            this.input = deleteWabaPhoneNumberNewInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteWabaPhoneNumberNew", "deleteWabaPhoneNumberNew", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final DeleteWabaPhoneNumberNew deleteWabaPhoneNumberNew;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteWabaPhoneNumberNew.Mapper deleteWabaPhoneNumberNewFieldMapper = new DeleteWabaPhoneNumberNew.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteWabaPhoneNumberNew) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteWabaPhoneNumberNew>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWabaPhoneNumberNewMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteWabaPhoneNumberNew read(ResponseReader responseReader2) {
                        return Mapper.this.deleteWabaPhoneNumberNewFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteWabaPhoneNumberNew deleteWabaPhoneNumberNew) {
            this.deleteWabaPhoneNumberNew = deleteWabaPhoneNumberNew;
        }

        public DeleteWabaPhoneNumberNew deleteWabaPhoneNumberNew() {
            return this.deleteWabaPhoneNumberNew;
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteWabaPhoneNumberNew deleteWabaPhoneNumberNew = this.deleteWabaPhoneNumberNew;
            DeleteWabaPhoneNumberNew deleteWabaPhoneNumberNew2 = ((Data) obj).deleteWabaPhoneNumberNew;
            return deleteWabaPhoneNumberNew == null ? deleteWabaPhoneNumberNew2 == null : deleteWabaPhoneNumberNew.equals(deleteWabaPhoneNumberNew2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteWabaPhoneNumberNew deleteWabaPhoneNumberNew = this.deleteWabaPhoneNumberNew;
                this.$hashCode = (deleteWabaPhoneNumberNew == null ? 0 : deleteWabaPhoneNumberNew.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWabaPhoneNumberNewMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteWabaPhoneNumberNew deleteWabaPhoneNumberNew = Data.this.deleteWabaPhoneNumberNew;
                    responseWriter.writeObject(responseField, deleteWabaPhoneNumberNew != null ? deleteWabaPhoneNumberNew.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteWabaPhoneNumberNew=" + this.deleteWabaPhoneNumberNew + "}";
            }
            return this.$toString;
        }
    }

    public static class DeleteWabaPhoneNumberNew {
        ...
        public DeleteWabaPhoneNumberNew(String str, String str2, String str3, String str4, String str5, String str6, Boolean bool, String str7, String str8, String str9, Integer num, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, String str19, String str20, String str21, String str22, String str23, String str24, String str25, String str26, EntityList entityList) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteWabaPhoneNumberNew)) {
                return false;
            }
            DeleteWabaPhoneNumberNew deleteWabaPhoneNumberNew = (DeleteWabaPhoneNumberNew) obj;
            if (this.__typename.equals(deleteWabaPhoneNumberNew.__typename) && this.id.equals(deleteWabaPhoneNumberNew.id) && this.wabaAccountId.equals(deleteWabaPhoneNumberNew.wabaAccountId) && this.accountId.equals(deleteWabaPhoneNumberNew.accountId) && this.phoneNumberId.equals(deleteWabaPhoneNumberNew.phoneNumberId) && this.phoneNumber.equals(deleteWabaPhoneNumberNew.phoneNumber) && ((bool = this.isDefault) != null ? bool.equals(deleteWabaPhoneNumberNew.isDefault) : deleteWabaPhoneNumberNew.isDefault == null) && ((str = this.accessToken) != null ? str.equals(deleteWabaPhoneNumberNew.accessToken) : deleteWabaPhoneNumberNew.accessToken == null) && ((str2 = this.name) != null ? str2.equals(deleteWabaPhoneNumberNew.name) : deleteWabaPhoneNumberNew.name == null) && ((str3 = this.internalName) != null ? str3.equals(deleteWabaPhoneNumberNew.internalName) : deleteWabaPhoneNumberNew.internalName == null) && ((num = this.quota) != null ? num.equals(deleteWabaPhoneNumberNew.quota) : deleteWabaPhoneNumberNew.quota == null) && ((str4 = this.currentLimitCategory) != null ? str4.equals(deleteWabaPhoneNumberNew.currentLimitCategory) : deleteWabaPhoneNumberNew.currentLimitCategory == null) && ((str5 = this.status) != null ? str5.equals(deleteWabaPhoneNumberNew.status) : deleteWabaPhoneNumberNew.status == null) && ((str6 = this.qualityRating) != null ? str6.equals(deleteWabaPhoneNumberNew.qualityRating) : deleteWabaPhoneNumberNew.qualityRating == null) && ((str7 = this.entityListId) != null ? str7.equals(deleteWabaPhoneNumberNew.entityListId) : deleteWabaPhoneNumberNew.entityListId == null) && ((str8 = this.createdAt) != null ? str8.equals(deleteWabaPhoneNumberNew.createdAt) : deleteWabaPhoneNumberNew.createdAt == null) && ((str9 = this.updatedAt) != null ? str9.equals(deleteWabaPhoneNumberNew.updatedAt) : deleteWabaPhoneNumberNew.updatedAt == null) && ((str10 = this.welcomeMessage) != null ? str10.equals(deleteWabaPhoneNumberNew.welcomeMessage) : deleteWabaPhoneNumberNew.welcomeMessage == null) && ((str11 = this.requestedDisplayName) != null ? str11.equals(deleteWabaPhoneNumberNew.requestedDisplayName) : deleteWabaPhoneNumberNew.requestedDisplayName == null) && ((str12 = this.displayNameUpdate) != null ? str12.equals(deleteWabaPhoneNumberNew.displayNameUpdate) : deleteWabaPhoneNumberNew.displayNameUpdate == null) && ((str13 = this.displayNameUpdateDateTime) != null ? str13.equals(deleteWabaPhoneNumberNew.displayNameUpdateDateTime) : deleteWabaPhoneNumberNew.displayNameUpdateDateTime == null) && ((str14 = this.wabaNumberDecision) != null ? str14.equals(deleteWabaPhoneNumberNew.wabaNumberDecision) : deleteWabaPhoneNumberNew.wabaNumberDecision == null) && ((str15 = this.wabaNumberDecisionTime) != null ? str15.equals(deleteWabaPhoneNumberNew.wabaNumberDecisionTime) : deleteWabaPhoneNumberNew.wabaNumberDecisionTime == null) && ((str16 = this.rejectionReason) != null ? str16.equals(deleteWabaPhoneNumberNew.rejectionReason) : deleteWabaPhoneNumberNew.rejectionReason == null) && ((str17 = this.phoneNumberQualityUpdate) != null ? str17.equals(deleteWabaPhoneNumberNew.phoneNumberQualityUpdate) : deleteWabaPhoneNumberNew.phoneNumberQualityUpdate == null) && ((str18 = this.phoneNumberQualityUpdateTime) != null ? str18.equals(deleteWabaPhoneNumberNew.phoneNumberQualityUpdateTime) : deleteWabaPhoneNumberNew.phoneNumberQualityUpdateTime == null) && ((str19 = this.createdById) != null ? str19.equals(deleteWabaPhoneNumberNew.createdById) : deleteWabaPhoneNumberNew.createdById == null) && ((str20 = this.updatedById) != null ? str20.equals(deleteWabaPhoneNumberNew.updatedById) : deleteWabaPhoneNumberNew.updatedById == null)) {
                EntityList entityList = this.entityList;
                EntityList entityList2 = deleteWabaPhoneNumberNew.entityList;
                if (entityList == null) {
                    if (entityList2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWabaPhoneNumberNewMutation.DeleteWabaPhoneNumberNew.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteWabaPhoneNumberNew.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteWabaPhoneNumberNew.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteWabaPhoneNumberNew.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteWabaPhoneNumberNew.this.wabaAccountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], DeleteWabaPhoneNumberNew.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], DeleteWabaPhoneNumberNew.this.phoneNumberId);
                    responseWriter.writeString(responseFieldArr[5], DeleteWabaPhoneNumberNew.this.phoneNumber);
                    responseWriter.writeBoolean(responseFieldArr[6], DeleteWabaPhoneNumberNew.this.isDefault);
                    responseWriter.writeString(responseFieldArr[7], DeleteWabaPhoneNumberNew.this.accessToken);
                    responseWriter.writeString(responseFieldArr[8], DeleteWabaPhoneNumberNew.this.name);
                    responseWriter.writeString(responseFieldArr[9], DeleteWabaPhoneNumberNew.this.internalName);
                    responseWriter.writeInt(responseFieldArr[10], DeleteWabaPhoneNumberNew.this.quota);
                    responseWriter.writeString(responseFieldArr[11], DeleteWabaPhoneNumberNew.this.currentLimitCategory);
                    responseWriter.writeString(responseFieldArr[12], DeleteWabaPhoneNumberNew.this.status);
                    responseWriter.writeString(responseFieldArr[13], DeleteWabaPhoneNumberNew.this.qualityRating);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], DeleteWabaPhoneNumberNew.this.entityListId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], DeleteWabaPhoneNumberNew.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], DeleteWabaPhoneNumberNew.this.updatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], DeleteWabaPhoneNumberNew.this.welcomeMessage);
                    responseWriter.writeString(responseFieldArr[18], DeleteWabaPhoneNumberNew.this.requestedDisplayName);
                    responseWriter.writeString(responseFieldArr[19], DeleteWabaPhoneNumberNew.this.displayNameUpdate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], DeleteWabaPhoneNumberNew.this.displayNameUpdateDateTime);
                    responseWriter.writeString(responseFieldArr[21], DeleteWabaPhoneNumberNew.this.wabaNumberDecision);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], DeleteWabaPhoneNumberNew.this.wabaNumberDecisionTime);
                    responseWriter.writeString(responseFieldArr[23], DeleteWabaPhoneNumberNew.this.rejectionReason);
                    responseWriter.writeString(responseFieldArr[24], DeleteWabaPhoneNumberNew.this.phoneNumberQualityUpdate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], DeleteWabaPhoneNumberNew.this.phoneNumberQualityUpdateTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[26], DeleteWabaPhoneNumberNew.this.createdById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], DeleteWabaPhoneNumberNew.this.updatedById);
                    ResponseField responseField = responseFieldArr[28];
                    EntityList entityList = DeleteWabaPhoneNumberNew.this.entityList;
    ...
    public static class EntityList {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWabaPhoneNumberNewMutation.EntityList.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = EntityList.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[34], EntityList.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWabaPhoneNumberNewMutation.EntityList.1.1
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final DeleteWabaPhoneNumberNewInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteWabaPhoneNumberNewInput deleteWabaPhoneNumberNewInput, ModelWabaPhoneNumberNewConditionInput modelWabaPhoneNumberNewConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteWabaPhoneNumberNewInput;
            this.condition = modelWabaPhoneNumberNewConditionInput;
            linkedHashMap.put("input", deleteWabaPhoneNumberNewInput);
        ...
        public DeleteWabaPhoneNumberNewInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWabaPhoneNumberNewMutation.Variables.1
    ...
    public DeleteWabaPhoneNumberNewMutation(DeleteWabaPhoneNumberNewInput deleteWabaPhoneNumberNewInput, ModelWabaPhoneNumberNewConditionInput modelWabaPhoneNumberNewConditionInput) {
        Utils.checkNotNull(deleteWabaPhoneNumberNewInput, "input == null");
        this.variables = new Variables(deleteWabaPhoneNumberNewInput, modelWabaPhoneNumberNewConditionInput);
    }
    ...
    public String operationId() {
        return "13fb79451eff9c5c1c3248adb3a9936ad7b3faeecefe3b9781f8ddf97376e8f8";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteWabaPhoneNumberNew($input: DeleteWabaPhoneNumberNewInput!, $condition: ModelWabaPhoneNumberNewConditionInput) {\n  deleteWabaPhoneNumberNew(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
