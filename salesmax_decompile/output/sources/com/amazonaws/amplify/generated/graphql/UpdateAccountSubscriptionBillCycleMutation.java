...
import type.UpdateAccountSubscriptionBillCycleInput;

/* loaded from: classes4.dex */
public final class UpdateAccountSubscriptionBillCycleMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation UpdateAccountSubscriptionBillCycle($input: UpdateAccountSubscriptionBillCycleInput!, $condition: ModelAccountSubscriptionBillCycleConditionInput) {\n  updateAccountSubscriptionBillCycle(input: $input, condition: $condition) {\n    __typename\n    id\n    productAccountId\n    accountId\n    addedById\n    period\n    lastBillDate\n    nextBillDate\n    createdAt\n    updatedAt\n    productAccount {\n      __typename\n      id\n      accountName\n      accountType\n      deviceKey\n      deviceKeyLastUpdated\n      accountStatus\n      businessLogoUrl\n      createdById\n      dateFormat\n      dateTimeViewStyle\n      defaultCurrency\n      denomination\n      industry\n      nameOfBusiness\n      productOrService\n      timeFormat\n      timeZone\n      plan\n      paidUpTo\n      seats\n      freeSeats\n      currentTotalUsers\n      currentActiveUsers\n      extraActiveUsers\n      pricePerSeat\n      allowAddingSeat\n      allowAddingSeatTill\n      seatReductionMarkedForNextCycle\n      billingCurrency\n      billingEmail\n      taxId\n      taxIdType\n      trialAccountEndDate\n      trialExtensionTimes\n      eligibleForExtension\n      paidForTillDate\n      updatedById\n      website\n      permissions\n      enableCustomCharts\n      createdAt\n      updatedAt\n      dealMode\n      openAiApiKey\n      salesmaxSalesContacts\n      salesmaxSupportContacts\n      chatWidgetConfig\n      onboardingStatus\n      integrationNeeded\n      matchingDealId\n      relatedAccountIds\n      lastChurnDate\n      lastChurnReason\n      possibleReactivationDate\n      locationPeriodicFrequency\n      lastPaymentDataId\n      lastPaymentDataCreatedAt\n      nextRenewalDateIfPaid\n      lastPaymentStatus\n      partPaymentAmountIfAny\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountSubscriptionBillCycleMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "UpdateAccountSubscriptionBillCycle";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation UpdateAccountSubscriptionBillCycle($input: UpdateAccountSubscriptionBillCycleInput!, $condition: ModelAccountSubscriptionBillCycleConditionInput) {\n  updateAccountSubscriptionBillCycle(input: $input, condition: $condition) {\n    __typename\n    id\n    productAccountId\n    accountId\n    addedById\n    period\n    lastBillDate\n    nextBillDate\n    createdAt\n    updatedAt\n    productAccount {\n      __typename\n      id\n      accountName\n      accountType\n      deviceKey\n      deviceKeyLastUpdated\n      accountStatus\n      businessLogoUrl\n      createdById\n      dateFormat\n      dateTimeViewStyle\n      defaultCurrency\n      denomination\n      industry\n      nameOfBusiness\n      productOrService\n      timeFormat\n      timeZone\n      plan\n      paidUpTo\n      seats\n      freeSeats\n      currentTotalUsers\n      currentActiveUsers\n      extraActiveUsers\n      pricePerSeat\n      allowAddingSeat\n      allowAddingSeatTill\n      seatReductionMarkedForNextCycle\n      billingCurrency\n      billingEmail\n      taxId\n      taxIdType\n      trialAccountEndDate\n      trialExtensionTimes\n      eligibleForExtension\n      paidForTillDate\n      updatedById\n      website\n      permissions\n      enableCustomCharts\n      createdAt\n      updatedAt\n      dealMode\n      openAiApiKey\n      salesmaxSalesContacts\n      salesmaxSupportContacts\n      chatWidgetConfig\n      onboardingStatus\n      integrationNeeded\n      matchingDealId\n      relatedAccountIds\n      lastChurnDate\n      lastChurnReason\n      possibleReactivationDate\n      locationPeriodicFrequency\n      lastPaymentDataId\n      lastPaymentDataCreatedAt\n      nextRenewalDateIfPaid\n      lastPaymentStatus\n      partPaymentAmountIfAny\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelAccountSubscriptionBillCycleConditionInput condition;
        private UpdateAccountSubscriptionBillCycleInput input;

        public UpdateAccountSubscriptionBillCycleMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new UpdateAccountSubscriptionBillCycleMutation(this.input, this.condition);
        }
        ...
        public Builder input(UpdateAccountSubscriptionBillCycleInput updateAccountSubscriptionBillCycleInput) {
            this.input = updateAccountSubscriptionBillCycleInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("updateAccountSubscriptionBillCycle", "updateAccountSubscriptionBillCycle", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final UpdateAccountSubscriptionBillCycle updateAccountSubscriptionBillCycle;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final UpdateAccountSubscriptionBillCycle.Mapper updateAccountSubscriptionBillCycleFieldMapper = new UpdateAccountSubscriptionBillCycle.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((UpdateAccountSubscriptionBillCycle) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<UpdateAccountSubscriptionBillCycle>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountSubscriptionBillCycleMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdateAccountSubscriptionBillCycle read(ResponseReader responseReader2) {
                        return Mapper.this.updateAccountSubscriptionBillCycleFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(UpdateAccountSubscriptionBillCycle updateAccountSubscriptionBillCycle) {
            this.updateAccountSubscriptionBillCycle = updateAccountSubscriptionBillCycle;
        }
        ...
        public boolean equals(Object obj) {
            ...
            UpdateAccountSubscriptionBillCycle updateAccountSubscriptionBillCycle = this.updateAccountSubscriptionBillCycle;
            UpdateAccountSubscriptionBillCycle updateAccountSubscriptionBillCycle2 = ((Data) obj).updateAccountSubscriptionBillCycle;
            return updateAccountSubscriptionBillCycle == null ? updateAccountSubscriptionBillCycle2 == null : updateAccountSubscriptionBillCycle.equals(updateAccountSubscriptionBillCycle2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                UpdateAccountSubscriptionBillCycle updateAccountSubscriptionBillCycle = this.updateAccountSubscriptionBillCycle;
                this.$hashCode = (updateAccountSubscriptionBillCycle == null ? 0 : updateAccountSubscriptionBillCycle.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountSubscriptionBillCycleMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    UpdateAccountSubscriptionBillCycle updateAccountSubscriptionBillCycle = Data.this.updateAccountSubscriptionBillCycle;
                    responseWriter.writeObject(responseField, updateAccountSubscriptionBillCycle != null ? updateAccountSubscriptionBillCycle.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{updateAccountSubscriptionBillCycle=" + this.updateAccountSubscriptionBillCycle + "}";
            }
            return this.$toString;
        }

        public UpdateAccountSubscriptionBillCycle updateAccountSubscriptionBillCycle() {
            return this.updateAccountSubscriptionBillCycle;
        }
    }
    ...
    public static class ProductAccount {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountSubscriptionBillCycleMutation.ProductAccount.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ProductAccount.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[15], ProductAccount.this.productOrService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountSubscriptionBillCycleMutation.ProductAccount.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[39], ProductAccount.this.permissions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountSubscriptionBillCycleMutation.ProductAccount.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[45], ProductAccount.this.salesmaxSalesContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountSubscriptionBillCycleMutation.ProductAccount.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[46], ProductAccount.this.salesmaxSupportContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountSubscriptionBillCycleMutation.ProductAccount.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[51], ProductAccount.this.relatedAccountIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountSubscriptionBillCycleMutation.ProductAccount.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class UpdateAccountSubscriptionBillCycle {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<UpdateAccountSubscriptionBillCycle> {
            final ProductAccount.Mapper productAccountFieldMapper = new ProductAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public UpdateAccountSubscriptionBillCycle map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = UpdateAccountSubscriptionBillCycle.$responseFields;
                return new UpdateAccountSubscriptionBillCycle(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[8]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[9]), (ProductAccount) responseReader.readObject(responseFieldArr[10], new ResponseReader.ObjectReader<ProductAccount>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountSubscriptionBillCycleMutation.UpdateAccountSubscriptionBillCycle.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public UpdateAccountSubscriptionBillCycle(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, ProductAccount productAccount) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateAccountSubscriptionBillCycle)) {
                return false;
            }
            UpdateAccountSubscriptionBillCycle updateAccountSubscriptionBillCycle = (UpdateAccountSubscriptionBillCycle) obj;
            if (this.__typename.equals(updateAccountSubscriptionBillCycle.__typename) && this.id.equals(updateAccountSubscriptionBillCycle.id) && this.productAccountId.equals(updateAccountSubscriptionBillCycle.productAccountId) && this.accountId.equals(updateAccountSubscriptionBillCycle.accountId) && this.addedById.equals(updateAccountSubscriptionBillCycle.addedById) && ((str = this.period) != null ? str.equals(updateAccountSubscriptionBillCycle.period) : updateAccountSubscriptionBillCycle.period == null) && this.lastBillDate.equals(updateAccountSubscriptionBillCycle.lastBillDate) && this.nextBillDate.equals(updateAccountSubscriptionBillCycle.nextBillDate) && this.createdAt.equals(updateAccountSubscriptionBillCycle.createdAt) && this.updatedAt.equals(updateAccountSubscriptionBillCycle.updatedAt)) {
                ProductAccount productAccount = this.productAccount;
                ProductAccount productAccount2 = updateAccountSubscriptionBillCycle.productAccount;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountSubscriptionBillCycleMutation.UpdateAccountSubscriptionBillCycle.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdateAccountSubscriptionBillCycle.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UpdateAccountSubscriptionBillCycle.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], UpdateAccountSubscriptionBillCycle.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], UpdateAccountSubscriptionBillCycle.this.productAccountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], UpdateAccountSubscriptionBillCycle.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], UpdateAccountSubscriptionBillCycle.this.addedById);
                    responseWriter.writeString(responseFieldArr[5], UpdateAccountSubscriptionBillCycle.this.period);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], UpdateAccountSubscriptionBillCycle.this.lastBillDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], UpdateAccountSubscriptionBillCycle.this.nextBillDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], UpdateAccountSubscriptionBillCycle.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], UpdateAccountSubscriptionBillCycle.this.updatedAt);
                    ResponseField responseField = responseFieldArr[10];
                    ProductAccount productAccount = UpdateAccountSubscriptionBillCycle.this.productAccount;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "UpdateAccountSubscriptionBillCycle{__typename=" + this.__typename + ", id=" + this.id + ", productAccountId=" + this.productAccountId + ", accountId=" + this.accountId + ", addedById=" + this.addedById + ", period=" + this.period + ", lastBillDate=" + this.lastBillDate + ", nextBillDate=" + this.nextBillDate + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", productAccount=" + this.productAccount + "}";
            }
            return this.$toString;
        }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final UpdateAccountSubscriptionBillCycleInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(UpdateAccountSubscriptionBillCycleInput updateAccountSubscriptionBillCycleInput, ModelAccountSubscriptionBillCycleConditionInput modelAccountSubscriptionBillCycleConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = updateAccountSubscriptionBillCycleInput;
            this.condition = modelAccountSubscriptionBillCycleConditionInput;
            linkedHashMap.put("input", updateAccountSubscriptionBillCycleInput);
        ...
        public UpdateAccountSubscriptionBillCycleInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountSubscriptionBillCycleMutation.Variables.1
    ...
    public UpdateAccountSubscriptionBillCycleMutation(UpdateAccountSubscriptionBillCycleInput updateAccountSubscriptionBillCycleInput, ModelAccountSubscriptionBillCycleConditionInput modelAccountSubscriptionBillCycleConditionInput) {
        Utils.checkNotNull(updateAccountSubscriptionBillCycleInput, "input == null");
        this.variables = new Variables(updateAccountSubscriptionBillCycleInput, modelAccountSubscriptionBillCycleConditionInput);
    }
    ...
    public String operationId() {
        return "56cef660d205846dec24219e02a185fd9f7b50511c83335015fa677bc82dfcc5";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation UpdateAccountSubscriptionBillCycle($input: UpdateAccountSubscriptionBillCycleInput!, $condition: ModelAccountSubscriptionBillCycleConditionInput) {\n  updateAccountSubscriptionBillCycle(input: $input, condition: $condition) {\n    __typename\n    id\n    productAccountId\n    accountId\n    addedById\n    period\n    lastBillDate\n    nextBillDate\n    createdAt\n    updatedAt\n    productAccount {\n      __typename\n      id\n      accountName\n      accountType\n      deviceKey\n      deviceKeyLastUpdated\n      accountStatus\n      businessLogoUrl\n      createdById\n      dateFormat\n      dateTimeViewStyle\n      defaultCurrency\n      denomination\n      industry\n      nameOfBusiness\n      productOrService\n      timeFormat\n      timeZone\n      plan\n      paidUpTo\n      seats\n      freeSeats\n      currentTotalUsers\n      currentActiveUsers\n      extraActiveUsers\n      pricePerSeat\n      allowAddingSeat\n      allowAddingSeatTill\n      seatReductionMarkedForNextCycle\n      billingCurrency\n      billingEmail\n      taxId\n      taxIdType\n      trialAccountEndDate\n      trialExtensionTimes\n      eligibleForExtension\n      paidForTillDate\n      updatedById\n      website\n      permissions\n      enableCustomCharts\n      createdAt\n      updatedAt\n      dealMode\n      openAiApiKey\n      salesmaxSalesContacts\n      salesmaxSupportContacts\n      chatWidgetConfig\n      onboardingStatus\n      integrationNeeded\n      matchingDealId\n      relatedAccountIds\n      lastChurnDate\n      lastChurnReason\n      possibleReactivationDate\n      locationPeriodicFrequency\n      lastPaymentDataId\n      lastPaymentDataCreatedAt\n      nextRenewalDateIfPaid\n      lastPaymentStatus\n      partPaymentAmountIfAny\n    }\n  }\n}";
    }
