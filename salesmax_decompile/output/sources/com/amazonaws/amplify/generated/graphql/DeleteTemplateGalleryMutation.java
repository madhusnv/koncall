...
import type.DeleteTemplateGalleryInput;
import type.HasParent;
import type.ModelTemplateGalleryConditionInput;
import type.ScopeLevel;

/* loaded from: classes7.dex */
public final class DeleteTemplateGalleryMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation DeleteTemplateGallery($input: DeleteTemplateGalleryInput!, $condition: ModelTemplateGalleryConditionInput) {\n  deleteTemplateGallery(input: $input, condition: $condition) {\n    __typename\n    id\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    categoryLevelOne\n    categoryLevelTwo\n    applicableForIndustry\n    viewedTimes\n    savedToWorkspaceTimes\n    sentToWhatsappTimes\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "DeleteTemplateGallery";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation DeleteTemplateGallery($input: DeleteTemplateGalleryInput!, $condition: ModelTemplateGalleryConditionInput) {\n  deleteTemplateGallery(input: $input, condition: $condition) {\n    __typename\n    id\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    categoryLevelOne\n    categoryLevelTwo\n    applicableForIndustry\n    viewedTimes\n    savedToWorkspaceTimes\n    sentToWhatsappTimes\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelTemplateGalleryConditionInput condition;
        private DeleteTemplateGalleryInput input;

        public DeleteTemplateGalleryMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteTemplateGalleryMutation(this.input, this.condition);
        }
        ...
        public Builder input(DeleteTemplateGalleryInput deleteTemplateGalleryInput) {
            this.input = deleteTemplateGalleryInput;
            return this;
        }
    }
    ...
    public static class Component {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.Component.1
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteTemplateGallery", "deleteTemplateGallery", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final DeleteTemplateGallery deleteTemplateGallery;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteTemplateGallery.Mapper deleteTemplateGalleryFieldMapper = new DeleteTemplateGallery.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteTemplateGallery) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteTemplateGallery>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteTemplateGallery read(ResponseReader responseReader2) {
                        return Mapper.this.deleteTemplateGalleryFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteTemplateGallery deleteTemplateGallery) {
            this.deleteTemplateGallery = deleteTemplateGallery;
        }

        public DeleteTemplateGallery deleteTemplateGallery() {
            return this.deleteTemplateGallery;
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteTemplateGallery deleteTemplateGallery = this.deleteTemplateGallery;
            DeleteTemplateGallery deleteTemplateGallery2 = ((Data) obj).deleteTemplateGallery;
            return deleteTemplateGallery == null ? deleteTemplateGallery2 == null : deleteTemplateGallery.equals(deleteTemplateGallery2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteTemplateGallery deleteTemplateGallery = this.deleteTemplateGallery;
                this.$hashCode = (deleteTemplateGallery == null ? 0 : deleteTemplateGallery.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteTemplateGallery deleteTemplateGallery = Data.this.deleteTemplateGallery;
                    responseWriter.writeObject(responseField, deleteTemplateGallery != null ? deleteTemplateGallery.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteTemplateGallery=" + this.deleteTemplateGallery + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class DefaultMedia {
        ...
        public static final class Mapper implements ResponseFieldMapper<DefaultMedia> {
            ...
            public DefaultMedia map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[9], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.DefaultMedia.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.DefaultMedia.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultMedia.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[9], DefaultMedia.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.DefaultMedia.1.1
    ...
    public static class DefaultVariableMap {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.DefaultVariableMap.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultVariableMap.$responseFields;
    ...
    public static class DeleteTemplateGallery {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<DeleteTemplateGallery> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public DeleteTemplateGallery map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = DeleteTemplateGallery.$responseFields;
                return new DeleteTemplateGallery(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), responseReader.readString(responseFieldArr[2]), responseReader.readString(responseFieldArr[3]), responseReader.readList(responseFieldArr[4], new ResponseReader.ListReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.DeleteTemplateGallery.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Component read(ResponseReader.ListItemReader listItemReader) {
                        return (Component) listItemReader.readObject(new ResponseReader.ObjectReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.DeleteTemplateGallery.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), responseReader.readString(responseFieldArr[14]), responseReader.readList(responseFieldArr[15], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.DeleteTemplateGallery.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                }), responseReader.readString(responseFieldArr[16]), responseReader.readString(responseFieldArr[17]), responseReader.readList(responseFieldArr[18], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.DeleteTemplateGallery.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                }), responseReader.readInt(responseFieldArr[19]), responseReader.readInt(responseFieldArr[20]), responseReader.readInt(responseFieldArr[21]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[22]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[23]), (DefaultMedia) responseReader.readObject(responseFieldArr[24], new ResponseReader.ObjectReader<DefaultMedia>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.DeleteTemplateGallery.Mapper.5
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public DeleteTemplateGallery(String str, String str2, String str3, String str4, List<Component> list, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, List<DefaultVariableMap> list2, String str13, List<String> list3, String str14, String str15, List<String> list4, Integer num, Integer num2, Integer num3, String str16, String str17, DefaultMedia defaultMedia) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.platform = str3;
            this.name = str4;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteTemplateGallery)) {
                return false;
            }
            DeleteTemplateGallery deleteTemplateGallery = (DeleteTemplateGallery) obj;
            if (this.__typename.equals(deleteTemplateGallery.__typename) && this.id.equals(deleteTemplateGallery.id) && ((str = this.platform) != null ? str.equals(deleteTemplateGallery.platform) : deleteTemplateGallery.platform == null) && ((str2 = this.name) != null ? str2.equals(deleteTemplateGallery.name) : deleteTemplateGallery.name == null) && ((list = this.components) != null ? list.equals(deleteTemplateGallery.components) : deleteTemplateGallery.components == null) && ((str3 = this.language) != null ? str3.equals(deleteTemplateGallery.language) : deleteTemplateGallery.language == null) && ((str4 = this.status) != null ? str4.equals(deleteTemplateGallery.status) : deleteTemplateGallery.status == null) && ((str5 = this.category) != null ? str5.equals(deleteTemplateGallery.category) : deleteTemplateGallery.category == null) && ((str6 = this.createdBy) != null ? str6.equals(deleteTemplateGallery.createdBy) : deleteTemplateGallery.createdBy == null) && ((str7 = this.updatedBy) != null ? str7.equals(deleteTemplateGallery.updatedBy) : deleteTemplateGallery.updatedBy == null) && ((str8 = this.archivedStatus) != null ? str8.equals(deleteTemplateGallery.archivedStatus) : deleteTemplateGallery.archivedStatus == null) && ((str9 = this.archivedAt) != null ? str9.equals(deleteTemplateGallery.archivedAt) : deleteTemplateGallery.archivedAt == null) && ((str10 = this.defaultMediaId) != null ? str10.equals(deleteTemplateGallery.defaultMediaId) : deleteTemplateGallery.defaultMediaId == null) && ((list2 = this.defaultVariableMap) != null ? list2.equals(deleteTemplateGallery.defaultVariableMap) : deleteTemplateGallery.defaultVariableMap == null) && ((str11 = this.templateId) != null ? str11.equals(deleteTemplateGallery.templateId) : deleteTemplateGallery.templateId == null) && ((list3 = this.tags) != null ? list3.equals(deleteTemplateGallery.tags) : deleteTemplateGallery.tags == null) && ((str12 = this.categoryLevelOne) != null ? str12.equals(deleteTemplateGallery.categoryLevelOne) : deleteTemplateGallery.categoryLevelOne == null) && ((str13 = this.categoryLevelTwo) != null ? str13.equals(deleteTemplateGallery.categoryLevelTwo) : deleteTemplateGallery.categoryLevelTwo == null) && ((list4 = this.applicableForIndustry) != null ? list4.equals(deleteTemplateGallery.applicableForIndustry) : deleteTemplateGallery.applicableForIndustry == null) && ((num = this.viewedTimes) != null ? num.equals(deleteTemplateGallery.viewedTimes) : deleteTemplateGallery.viewedTimes == null) && ((num2 = this.savedToWorkspaceTimes) != null ? num2.equals(deleteTemplateGallery.savedToWorkspaceTimes) : deleteTemplateGallery.savedToWorkspaceTimes == null) && ((num3 = this.sentToWhatsappTimes) != null ? num3.equals(deleteTemplateGallery.sentToWhatsappTimes) : deleteTemplateGallery.sentToWhatsappTimes == null) && ((str14 = this.createdAt) != null ? str14.equals(deleteTemplateGallery.createdAt) : deleteTemplateGallery.createdAt == null) && ((str15 = this.updatedAt) != null ? str15.equals(deleteTemplateGallery.updatedAt) : deleteTemplateGallery.updatedAt == null)) {
                DefaultMedia defaultMedia = this.defaultMedia;
                DefaultMedia defaultMedia2 = deleteTemplateGallery.defaultMedia;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.DeleteTemplateGallery.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteTemplateGallery.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteTemplateGallery.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteTemplateGallery.this.id);
                    responseWriter.writeString(responseFieldArr[2], DeleteTemplateGallery.this.platform);
                    responseWriter.writeString(responseFieldArr[3], DeleteTemplateGallery.this.name);
                    responseWriter.writeList(responseFieldArr[4], DeleteTemplateGallery.this.components, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.DeleteTemplateGallery.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Component) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[5], DeleteTemplateGallery.this.language);
                    responseWriter.writeString(responseFieldArr[6], DeleteTemplateGallery.this.status);
                    responseWriter.writeString(responseFieldArr[7], DeleteTemplateGallery.this.category);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], DeleteTemplateGallery.this.createdBy);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], DeleteTemplateGallery.this.updatedBy);
                    responseWriter.writeString(responseFieldArr[10], DeleteTemplateGallery.this.archivedStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], DeleteTemplateGallery.this.archivedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], DeleteTemplateGallery.this.defaultMediaId);
                    responseWriter.writeList(responseFieldArr[13], DeleteTemplateGallery.this.defaultVariableMap, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.DeleteTemplateGallery.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((DefaultVariableMap) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[14], DeleteTemplateGallery.this.templateId);
                    responseWriter.writeList(responseFieldArr[15], DeleteTemplateGallery.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.DeleteTemplateGallery.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[16], DeleteTemplateGallery.this.categoryLevelOne);
                    responseWriter.writeString(responseFieldArr[17], DeleteTemplateGallery.this.categoryLevelTwo);
                    responseWriter.writeList(responseFieldArr[18], DeleteTemplateGallery.this.applicableForIndustry, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.DeleteTemplateGallery.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeInt(responseFieldArr[19], DeleteTemplateGallery.this.viewedTimes);
                    responseWriter.writeInt(responseFieldArr[20], DeleteTemplateGallery.this.savedToWorkspaceTimes);
                    responseWriter.writeInt(responseFieldArr[21], DeleteTemplateGallery.this.sentToWhatsappTimes);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], DeleteTemplateGallery.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], DeleteTemplateGallery.this.updatedAt);
                    ResponseField responseField = responseFieldArr[24];
                    DefaultMedia defaultMedia = DeleteTemplateGallery.this.defaultMedia;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final DeleteTemplateGalleryInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteTemplateGalleryInput deleteTemplateGalleryInput, ModelTemplateGalleryConditionInput modelTemplateGalleryConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteTemplateGalleryInput;
            this.condition = modelTemplateGalleryConditionInput;
            linkedHashMap.put("input", deleteTemplateGalleryInput);
        ...
        public DeleteTemplateGalleryInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteTemplateGalleryMutation.Variables.1
    ...
    public DeleteTemplateGalleryMutation(DeleteTemplateGalleryInput deleteTemplateGalleryInput, ModelTemplateGalleryConditionInput modelTemplateGalleryConditionInput) {
        Utils.checkNotNull(deleteTemplateGalleryInput, "input == null");
        this.variables = new Variables(deleteTemplateGalleryInput, modelTemplateGalleryConditionInput);
    }
    ...
    public String operationId() {
        return "ec10ca50f34c0554021aedceda6ae309308a30213c7ba97c84b1e15dd1175185";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteTemplateGallery($input: DeleteTemplateGalleryInput!, $condition: ModelTemplateGalleryConditionInput) {\n  deleteTemplateGallery(input: $input, condition: $condition) {\n    __typename\n    id\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    categoryLevelOne\n    categoryLevelTwo\n    applicableForIndustry\n    viewedTimes\n    savedToWorkspaceTimes\n    sentToWhatsappTimes\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
