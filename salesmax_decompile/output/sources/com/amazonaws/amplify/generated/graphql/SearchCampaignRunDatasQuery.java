...
import type.SearchableCampaignRunDataFilterInput;
import type.SearchableCampaignRunDataSortInput;

/* loaded from: classes4.dex */
public final class SearchCampaignRunDatasQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query SearchCampaignRunDatas($filter: SearchableCampaignRunDataFilterInput, $sort: SearchableCampaignRunDataSortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchCampaignRunDatas(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      contactSource\n      campaignId\n      campaignRunId\n      engagementId\n      campaignOutputType\n      campaignOutputId\n      campaignResponseType\n      campaignResponseId\n      responseCategory\n      responseBody\n      status\n      messageCreatedAt\n      sentAt\n      deliveredAt\n      readAt\n      repliedAt\n      sourceId\n      sourceType\n      createdAt\n      updatedAt\n    }\n    nextToken\n    total\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.SearchCampaignRunDatasQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "SearchCampaignRunDatas";
        }
    };
    public static final String QUERY_DOCUMENT = "query SearchCampaignRunDatas($filter: SearchableCampaignRunDataFilterInput, $sort: SearchableCampaignRunDataSortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchCampaignRunDatas(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      contactSource\n      campaignId\n      campaignRunId\n      engagementId\n      campaignOutputType\n      campaignOutputId\n      campaignResponseType\n      campaignResponseId\n      responseCategory\n      responseBody\n      status\n      messageCreatedAt\n      sentAt\n      deliveredAt\n      readAt\n      repliedAt\n      sourceId\n      sourceType\n      createdAt\n      updatedAt\n    }\n    nextToken\n    total\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private SearchableCampaignRunDataFilterInput filter;
        private Integer from;
        private Integer limit;
        private String nextToken;
        private SearchableCampaignRunDataSortInput sort;

        public SearchCampaignRunDatasQuery build() {
            return new SearchCampaignRunDatasQuery(this.filter, this.sort, this.limit, this.nextToken, this.from);
        }

        public Builder filter(SearchableCampaignRunDataFilterInput searchableCampaignRunDataFilterInput) {
            this.filter = searchableCampaignRunDataFilterInput;
            return this;
        }
        ...
        public Builder sort(SearchableCampaignRunDataSortInput searchableCampaignRunDataSortInput) {
            this.sort = searchableCampaignRunDataSortInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("searchCampaignRunDatas", "searchCampaignRunDatas", new UnmodifiableMapBuilder(5).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put(Constants.MessagePayloadKeys.FROM, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, Constants.MessagePayloadKeys.FROM).build()).put("sort", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sort").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final SearchCampaignRunDatas searchCampaignRunDatas;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final SearchCampaignRunDatas.Mapper searchCampaignRunDatasFieldMapper = new SearchCampaignRunDatas.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((SearchCampaignRunDatas) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<SearchCampaignRunDatas>() { // from class: com.amazonaws.amplify.generated.graphql.SearchCampaignRunDatasQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public SearchCampaignRunDatas read(ResponseReader responseReader2) {
                        return Mapper.this.searchCampaignRunDatasFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(SearchCampaignRunDatas searchCampaignRunDatas) {
            this.searchCampaignRunDatas = searchCampaignRunDatas;
        }
        ...
        public boolean equals(Object obj) {
            ...
            SearchCampaignRunDatas searchCampaignRunDatas = this.searchCampaignRunDatas;
            SearchCampaignRunDatas searchCampaignRunDatas2 = ((Data) obj).searchCampaignRunDatas;
            return searchCampaignRunDatas == null ? searchCampaignRunDatas2 == null : searchCampaignRunDatas.equals(searchCampaignRunDatas2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                SearchCampaignRunDatas searchCampaignRunDatas = this.searchCampaignRunDatas;
                this.$hashCode = (searchCampaignRunDatas == null ? 0 : searchCampaignRunDatas.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchCampaignRunDatasQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    SearchCampaignRunDatas searchCampaignRunDatas = Data.this.searchCampaignRunDatas;
                    responseWriter.writeObject(responseField, searchCampaignRunDatas != null ? searchCampaignRunDatas.marshaller() : null);
                }
            };
        }

        public SearchCampaignRunDatas searchCampaignRunDatas() {
            return this.searchCampaignRunDatas;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{searchCampaignRunDatas=" + this.searchCampaignRunDatas + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchCampaignRunDatasQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static class SearchCampaignRunDatas {
        ...
        public static final class Mapper implements ResponseFieldMapper<SearchCampaignRunDatas> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public SearchCampaignRunDatas map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = SearchCampaignRunDatas.$responseFields;
                return new SearchCampaignRunDatas(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.SearchCampaignRunDatasQuery.SearchCampaignRunDatas.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.SearchCampaignRunDatasQuery.SearchCampaignRunDatas.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public SearchCampaignRunDatas(String str, List<Item> list, String str2, Integer num) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof SearchCampaignRunDatas)) {
                return false;
            }
            SearchCampaignRunDatas searchCampaignRunDatas = (SearchCampaignRunDatas) obj;
            if (this.__typename.equals(searchCampaignRunDatas.__typename) && this.items.equals(searchCampaignRunDatas.items) && ((str = this.nextToken) != null ? str.equals(searchCampaignRunDatas.nextToken) : searchCampaignRunDatas.nextToken == null)) {
                Integer num = this.total;
                Integer num2 = searchCampaignRunDatas.total;
                if (num == null) {
                    if (num2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchCampaignRunDatasQuery.SearchCampaignRunDatas.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = SearchCampaignRunDatas.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], SearchCampaignRunDatas.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], SearchCampaignRunDatas.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.SearchCampaignRunDatasQuery.SearchCampaignRunDatas.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], SearchCampaignRunDatas.this.nextToken);
                    responseWriter.writeInt(responseFieldArr[3], SearchCampaignRunDatas.this.total);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "SearchCampaignRunDatas{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + ", total=" + this.total + "}";
            }
            return this.$toString;
        }
    ...
    public static final class Variables extends Operation.Variables {
        private final SearchableCampaignRunDataFilterInput filter;
        private final Integer from;
        private final Integer limit;
        private final String nextToken;
        private final SearchableCampaignRunDataSortInput sort;
        private final transient Map<String, Object> valueMap;

        public Variables(SearchableCampaignRunDataFilterInput searchableCampaignRunDataFilterInput, SearchableCampaignRunDataSortInput searchableCampaignRunDataSortInput, Integer num, String str, Integer num2) {
            ...
            this.nextToken = str;
            this.from = num2;
            linkedHashMap.put("filter", searchableCampaignRunDataFilterInput);
            linkedHashMap.put("sort", searchableCampaignRunDataSortInput);
        ...
        public SearchableCampaignRunDataFilterInput filter() {
            return this.filter;
        }
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchCampaignRunDatasQuery.Variables.1
        ...
        public SearchableCampaignRunDataSortInput sort() {
            return this.sort;
        }
    ...
    public SearchCampaignRunDatasQuery(SearchableCampaignRunDataFilterInput searchableCampaignRunDataFilterInput, SearchableCampaignRunDataSortInput searchableCampaignRunDataSortInput, Integer num, String str, Integer num2) {
        this.variables = new Variables(searchableCampaignRunDataFilterInput, searchableCampaignRunDataSortInput, num, str, num2);
    }
    ...
    public String operationId() {
        return "9e54aadcd997727f12a123846f0c27792c28352c4b8f7bf68b2366b8fb7dab0f";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query SearchCampaignRunDatas($filter: SearchableCampaignRunDataFilterInput, $sort: SearchableCampaignRunDataSortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchCampaignRunDatas(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      contactSource\n      campaignId\n      campaignRunId\n      engagementId\n      campaignOutputType\n      campaignOutputId\n      campaignResponseType\n      campaignResponseId\n      responseCategory\n      responseBody\n      status\n      messageCreatedAt\n      sentAt\n      deliveredAt\n      readAt\n      repliedAt\n      sourceId\n      sourceType\n      createdAt\n      updatedAt\n    }\n    nextToken\n    total\n  }\n}";
    }
