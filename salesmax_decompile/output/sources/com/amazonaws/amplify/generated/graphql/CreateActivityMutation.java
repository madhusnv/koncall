...
import type.CreateActivityInput;
...
public final class CreateActivityMutation implements Mutation<Data, Data, Variables> {
    ...
    public static class ActivityDoneByUser {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.ActivityDoneByUser.1
    ...
    public static final class Builder {
        ...
        private CreateActivityInput input;

        public CreateActivityMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new CreateActivityMutation(this.input, this.condition);
        }
        ...
        public Builder input(CreateActivityInput createActivityInput) {
            this.input = createActivityInput;
            return this;
        }
    }
    ...
    public static class Comments {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Comments.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Comments.$responseFields;
    ...
    public static class Contact {
        ...
        public static final class Mapper implements ResponseFieldMapper<Contact> {
            ...
            public Contact map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[5], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Contact.Mapper.1
                ...
                List list2 = responseReader.readList(responseFieldArr[7], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Contact.Mapper.2
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                ...
                List list3 = responseReader.readList(responseFieldArr[34], new ResponseReader.ListReader<Day>() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Contact.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                ...
                List list4 = responseReader.readList(responseFieldArr[92], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Contact.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                });
                List list5 = responseReader.readList(responseFieldArr[93], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Contact.Mapper.5
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                ...
                List list6 = responseReader.readList(responseFieldArr[97], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Contact.Mapper.6
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Contact.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Contact.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[5], Contact.this.sharedOwners, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Contact.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[7], Contact.this.sharedTeams, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Contact.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[34], Contact.this.preferredContactDays, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Contact.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[92], Contact.this.userDefinedTags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Contact.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[93], Contact.this.productService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Contact.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[97], Contact.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Contact.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class CreateActivity {
        ...
        public static final class Mapper implements ResponseFieldMapper<CreateActivity> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public CreateActivity map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = CreateActivity.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
                String str3 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]);
                ...
                }), (Contact) responseReader.readObject(responseFieldArr[18], new ResponseReader.ObjectReader<Contact>() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.CreateActivity.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public Contact read(ResponseReader responseReader2) {
                        return Mapper.this.contactFieldMapper.map(responseReader2);
                    }
                }), (User) responseReader.readObject(responseFieldArr[19], new ResponseReader.ObjectReader<User>() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.CreateActivity.Mapper.4
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public User read(ResponseReader responseReader2) {
                        return Mapper.this.userFieldMapper.map(responseReader2);
                    }
                }), (ActivityDoneByUser) responseReader.readObject(responseFieldArr[20], new ResponseReader.ObjectReader<ActivityDoneByUser>() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.CreateActivity.Mapper.5
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public CreateActivity(String str, String str2, String str3, String str4, ActivityRelatedObjectType activityRelatedObjectType, String str5, ActivityCategory activityCategory, ActivityType activityType, String str6, String str7, String str8, String str9, PrimaryTeam primaryTeam, String str10, String str11, String str12, String str13, Comments comments, Contact contact, User user, ActivityDoneByUser activityDoneByUser) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.threadId = str3;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateActivity)) {
                return false;
            }
            CreateActivity createActivity = (CreateActivity) obj;
            if (this.__typename.equals(createActivity.__typename) && this.id.equals(createActivity.id) && ((str = this.threadId) != null ? str.equals(createActivity.threadId) : createActivity.threadId == null) && this.accountId.equals(createActivity.accountId) && this.activityRelatedObjectType.equals(createActivity.activityRelatedObjectType) && this.activityRelatedObjectId.equals(createActivity.activityRelatedObjectId) && this.activityCategory.equals(createActivity.activityCategory) && this.activityType.equals(createActivity.activityType) && ((str2 = this.body) != null ? str2.equals(createActivity.body) : createActivity.body == null) && ((str3 = this.note) != null ? str3.equals(createActivity.note) : createActivity.note == null) && this.ownerId.equals(createActivity.ownerId) && ((str4 = this.primaryTeamId) != null ? str4.equals(createActivity.primaryTeamId) : createActivity.primaryTeamId == null) && ((primaryTeam = this.primaryTeam) != null ? primaryTeam.equals(createActivity.primaryTeam) : createActivity.primaryTeam == null) && ((str5 = this.contactId) != null ? str5.equals(createActivity.contactId) : createActivity.contactId == null) && ((str6 = this.activityDoneByUserId) != null ? str6.equals(createActivity.activityDoneByUserId) : createActivity.activityDoneByUserId == null) && ((str7 = this.createdAt) != null ? str7.equals(createActivity.createdAt) : createActivity.createdAt == null) && ((str8 = this.updatedAt) != null ? str8.equals(createActivity.updatedAt) : createActivity.updatedAt == null) && ((comments = this.comments) != null ? comments.equals(createActivity.comments) : createActivity.comments == null) && ((contact = this.contact) != null ? contact.equals(createActivity.contact) : createActivity.contact == null) && ((user = this.user) != null ? user.equals(createActivity.user) : createActivity.user == null)) {
                ActivityDoneByUser activityDoneByUser = this.activityDoneByUser;
                ActivityDoneByUser activityDoneByUser2 = createActivity.activityDoneByUser;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.CreateActivity.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateActivity.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateActivity.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateActivity.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], CreateActivity.this.threadId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], CreateActivity.this.accountId);
                    responseWriter.writeString(responseFieldArr[4], CreateActivity.this.activityRelatedObjectType.name());
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], CreateActivity.this.activityRelatedObjectId);
                    responseWriter.writeString(responseFieldArr[6], CreateActivity.this.activityCategory.name());
                    responseWriter.writeString(responseFieldArr[7], CreateActivity.this.activityType.name());
                    responseWriter.writeString(responseFieldArr[8], CreateActivity.this.body);
                    responseWriter.writeString(responseFieldArr[9], CreateActivity.this.note);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[10], CreateActivity.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], CreateActivity.this.primaryTeamId);
                    ResponseField responseField = responseFieldArr[12];
                    PrimaryTeam primaryTeam = CreateActivity.this.primaryTeam;
                    responseWriter.writeObject(responseField, primaryTeam != null ? primaryTeam.marshaller() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], CreateActivity.this.contactId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], CreateActivity.this.activityDoneByUserId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], CreateActivity.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], CreateActivity.this.updatedAt);
                    ResponseField responseField2 = responseFieldArr[17];
                    Comments comments = CreateActivity.this.comments;
                    ...
                    Contact contact = CreateActivity.this.contact;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createActivity", "createActivity", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateActivity.Mapper createActivityFieldMapper = new CreateActivity.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateActivity) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateActivity>() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateActivity read(ResponseReader responseReader2) {
                        return Mapper.this.createActivityFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateActivity createActivity) {
        ...
        public boolean equals(Object obj) {
            ...
            CreateActivity createActivity2 = ((Data) obj).createActivity;
            return createActivity == null ? createActivity2 == null : createActivity.equals(createActivity2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateActivity createActivity = this.createActivity;
                this.$hashCode = (createActivity == null ? 0 : createActivity.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateActivity createActivity = Data.this.createActivity;
                    responseWriter.writeObject(responseField, createActivity != null ? createActivity.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createActivity=" + this.createActivity + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class PrimaryTeam {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.PrimaryTeam.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = PrimaryTeam.$responseFields;
    ...
    public static class User {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.User.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = User.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final CreateActivityInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateActivityInput createActivityInput, ModelActivityConditionInput modelActivityConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createActivityInput;
            this.condition = modelActivityConditionInput;
            linkedHashMap.put("input", createActivityInput);
        ...
        public CreateActivityInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityMutation.Variables.1
    ...
    public CreateActivityMutation(CreateActivityInput createActivityInput, ModelActivityConditionInput modelActivityConditionInput) {
        Utils.checkNotNull(createActivityInput, "input == null");
        this.variables = new Variables(createActivityInput, modelActivityConditionInput);
    }
    ...
    public String operationId() {
        return "bb0c3e524ea5d347dc8701cde07675929f0df4bb4a46117f115986a0332c5f35";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateActivity($input: CreateActivityInput!, $condition: ModelActivityConditionInput) {\n  createActivity(input: $input, condition: $condition) {\n    __typename\n    id\n    threadId\n    accountId\n    activityRelatedObjectType\n    activityRelatedObjectId\n    activityCategory\n    activityType\n    body\n    note\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    contactId\n    activityDoneByUserId\n    createdAt\n    updatedAt\n    comments {\n      __typename\n      nextToken\n    }\n    contact {\n      __typename\n      id\n      accountId\n      ownerId\n      toBeAssigned\n      sharedOwners\n      primaryTeamId\n      sharedTeams\n      accountPriority\n      addedById\n      assignedToId\n      blockedForCallById\n      blockedForCallReason\n      blockedForCallUntil\n      callPriority\n      waChatChannelId\n      contactSource\n      contactSourceDrillDownOne\n      contactSourceDrillDownTwo\n      contactSourceDrillDownThree\n      contactSourceDrillDownOneId\n      contactSourceDrillDownTwoId\n      contactSourceDrillDownThreeId\n      contactStatus\n      contactType\n      department\n      designation\n      lastRepeatEnquiryDate\n      lastRepeatEnquirySource\n      gender\n      isDecisionMaker\n      isPrivate\n      lockPeriod\n      name\n      preferredContactDays\n      profilePhotoUrl\n      referredBy\n      salutation\n      seniority\n      updatedById\n      hasTask\n      openTaskActivityType\n      lastCalledTime\n      lastCallDirection\n      lastCallOutcome\n      lastCallOutcomeNature\n      lastCallUserId\n      lastCallDuration\n      lastCallEngagementId\n      lastVisitTime\n      lastVisitOutcome\n      lastVisitOutcomeNature\n      lastVisitUserId\n      lastVisitEngagementId\n      lastEmailTime\n      lastEmailUserId\n      lastEmailEngagementId\n      lastWhatsappTime\n      lastWhatsappUserId\n      lastWhatsappEngagementId\n      lastWabaBroadcastTime\n      lastWabaBroadcastStatus\n      lastWabaBroadcastTemplate\n      lastWabaBroadcastReplyBody\n      lastWabaBroadcastReplyTime\n      lastWabaBroadcastReplyType\n      lastSmsTime\n      lastSmsUserId\n      lastSmsEngagementId\n      lastNoteAddedTime\n      lastNoteUserId\n      lastNoteEngagementId\n      lastTaskDoneTime\n      lastTaskDoneUserId\n      lastTaskDoneEngagementId\n      openTaskCount\n      lastKnownDisposition\n      lastKnownDispositionTime\n      lastLeadAssignmentDateTime\n      lastEngagementFromAccount\n      lastEngagementFromContact\n      freshLeadTag\n      noWorkAfterAssignment\n      needFollowUpTag\n      needFollowUpTagUpdatedAt\n      activeDealStage\n      activeDealStageUpdatedAt\n      dealDescription\n      isCustomer\n      becameCustomerOn\n      unsuccessfulCallAttempts\n      leadCallsNotAnswered\n      userDefinedTags\n      productService\n      bulkUploadReference\n      assignmentMethod\n      whatsappOptInStatus\n      recentEngagements\n      recentEngagementsUpdatedAt\n      openTaskDetail\n      openVideoCallDetail\n      lastClosedTaskDetail\n      lastClosedTaskDetailUpdatedAt\n      latestRemark\n      customAttributes\n      paymentRequestDetail\n      lastPaymentStatus\n      customDataAddedFromAddContactForm\n      leadLifecycleStage\n      leadLifecycleStageSubCategory\n      manualClosedReason\n      lastDealStageType\n      prospectingAttempts\n      totalProspectingAttemptsAcrossRechurn\n      numberOfTimesRechurned\n      lastProspectingDoneOn\n      firstProspectingDoneOn\n      nextProspectingDueOn\n      nextProspectingSetBy\n      nextProspectingNote\n      movedToOpportunityOn\n      movedToClosedOn\n      createdAt\n      updatedAt\n    }\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    activityDoneByUser {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
