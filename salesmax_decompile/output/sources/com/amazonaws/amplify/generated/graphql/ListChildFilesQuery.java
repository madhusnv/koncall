...
import type.ModelUploadedFileFilterInput;
import type.ScopeLevel;

/* loaded from: classes4.dex */
public final class ListChildFilesQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListChildFiles($parentFileId: ID, $sortDirection: ModelSortDirection, $filter: ModelUploadedFileFilterInput, $limit: Int, $nextToken: String) {\n  listChildFiles(parentFileId: $parentFileId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListChildFilesQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListChildFiles";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListChildFiles($parentFileId: ID, $sortDirection: ModelSortDirection, $filter: ModelUploadedFileFilterInput, $limit: Int, $nextToken: String) {\n  listChildFiles(parentFileId: $parentFileId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelUploadedFileFilterInput filter;
        private Integer limit;
        private String nextToken;
        private String parentFileId;
        private ModelSortDirection sortDirection;

        public ListChildFilesQuery build() {
            return new ListChildFilesQuery(this.parentFileId, this.sortDirection, this.filter, this.limit, this.nextToken);
        }

        public Builder filter(ModelUploadedFileFilterInput modelUploadedFileFilterInput) {
            this.filter = modelUploadedFileFilterInput;
            return this;
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listChildFiles", "listChildFiles", new UnmodifiableMapBuilder(5).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put("parentFileId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "parentFileId").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListChildFiles listChildFiles;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListChildFiles.Mapper listChildFilesFieldMapper = new ListChildFiles.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListChildFiles) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListChildFiles>() { // from class: com.amazonaws.amplify.generated.graphql.ListChildFilesQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListChildFiles read(ResponseReader responseReader2) {
                        return Mapper.this.listChildFilesFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListChildFiles listChildFiles) {
        ...
        public boolean equals(Object obj) {
            ...
            ListChildFiles listChildFiles = this.listChildFiles;
            ListChildFiles listChildFiles2 = ((Data) obj).listChildFiles;
            return listChildFiles == null ? listChildFiles2 == null : listChildFiles.equals(listChildFiles2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListChildFiles listChildFiles = this.listChildFiles;
                this.$hashCode = (listChildFiles == null ? 0 : listChildFiles.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListChildFiles listChildFiles() {
            return this.listChildFiles;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListChildFilesQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListChildFiles listChildFiles = Data.this.listChildFiles;
                    responseWriter.writeObject(responseField, listChildFiles != null ? listChildFiles.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listChildFiles=" + this.listChildFiles + "}";
            }
    ...
    public static class Item {
        ...
        public static final class Mapper implements ResponseFieldMapper<Item> {
            ...
            public Item map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[9], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.ListChildFilesQuery.Item.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListChildFilesQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[9], Item.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListChildFilesQuery.Item.1.1
    ...
    public static class ListChildFiles {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListChildFiles> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListChildFiles map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListChildFiles.$responseFields;
                return new ListChildFiles(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListChildFilesQuery.ListChildFiles.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListChildFilesQuery.ListChildFiles.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListChildFiles(String str, List<Item> list, String str2) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListChildFiles)) {
                return false;
            }
            ListChildFiles listChildFiles = (ListChildFiles) obj;
            if (this.__typename.equals(listChildFiles.__typename) && this.items.equals(listChildFiles.items)) {
                String str = this.nextToken;
                String str2 = listChildFiles.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListChildFilesQuery.ListChildFiles.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListChildFiles.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListChildFiles.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListChildFiles.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListChildFilesQuery.ListChildFiles.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListChildFiles.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListChildFiles{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        private final ModelUploadedFileFilterInput filter;
        ...
        public Variables(String str, ModelSortDirection modelSortDirection, ModelUploadedFileFilterInput modelUploadedFileFilterInput, Integer num, String str2) {
            ...
            this.limit = num;
            this.nextToken = str2;
            linkedHashMap.put("parentFileId", str);
            linkedHashMap.put("sortDirection", modelSortDirection);
            linkedHashMap.put("filter", modelUploadedFileFilterInput);
            linkedHashMap.put("limit", num);
            linkedHashMap.put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, str2);
        }

        public ModelUploadedFileFilterInput filter() {
            return this.filter;
        }
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListChildFilesQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("parentFileId", Variables.this.parentFileId);
    ...
    public ListChildFilesQuery(String str, ModelSortDirection modelSortDirection, ModelUploadedFileFilterInput modelUploadedFileFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelSortDirection, modelUploadedFileFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "6e24d76ff26180d1dce8a4be8700edf806e1b94aa91de568f7713e2a3c38bd83";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListChildFiles($parentFileId: ID, $sortDirection: ModelSortDirection, $filter: ModelUploadedFileFilterInput, $limit: Int, $nextToken: String) {\n  listChildFiles(parentFileId: $parentFileId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
