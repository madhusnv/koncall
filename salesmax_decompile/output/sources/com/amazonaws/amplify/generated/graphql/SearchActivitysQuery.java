...
public final class SearchActivitysQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query SearchActivitys($filter: SearchableActivityFilterInput, $sort: SearchableActivitySortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchActivitys(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      id\n      threadId\n      accountId\n      activityRelatedObjectType\n      activityRelatedObjectId\n      activityCategory\n      activityType\n      body\n      note\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      createdAt\n      updatedAt\n    }\n    nextToken\n    total\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.SearchActivitysQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "SearchActivitys";
        }
    };
    public static final String QUERY_DOCUMENT = "query SearchActivitys($filter: SearchableActivityFilterInput, $sort: SearchableActivitySortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchActivitys(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      id\n      threadId\n      accountId\n      activityRelatedObjectType\n      activityRelatedObjectId\n      activityCategory\n      activityType\n      body\n      note\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      createdAt\n      updatedAt\n    }\n    nextToken\n    total\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private SearchableActivityFilterInput filter;
        private Integer from;
        private Integer limit;
        private String nextToken;
        private SearchableActivitySortInput sort;

        public SearchActivitysQuery build() {
            return new SearchActivitysQuery(this.filter, this.sort, this.limit, this.nextToken, this.from);
        }

        public Builder filter(SearchableActivityFilterInput searchableActivityFilterInput) {
            this.filter = searchableActivityFilterInput;
            return this;
        }
        ...
        public Builder sort(SearchableActivitySortInput searchableActivitySortInput) {
            this.sort = searchableActivitySortInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("searchActivitys", "searchActivitys", new UnmodifiableMapBuilder(5).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put(Constants.MessagePayloadKeys.FROM, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, Constants.MessagePayloadKeys.FROM).build()).put("sort", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sort").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final SearchActivitys searchActivitys;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final SearchActivitys.Mapper searchActivitysFieldMapper = new SearchActivitys.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((SearchActivitys) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<SearchActivitys>() { // from class: com.amazonaws.amplify.generated.graphql.SearchActivitysQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public SearchActivitys read(ResponseReader responseReader2) {
                        return Mapper.this.searchActivitysFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(SearchActivitys searchActivitys) {
            this.searchActivitys = searchActivitys;
        }
        ...
        public boolean equals(Object obj) {
            ...
            SearchActivitys searchActivitys = this.searchActivitys;
            SearchActivitys searchActivitys2 = ((Data) obj).searchActivitys;
            return searchActivitys == null ? searchActivitys2 == null : searchActivitys.equals(searchActivitys2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                SearchActivitys searchActivitys = this.searchActivitys;
                this.$hashCode = (searchActivitys == null ? 0 : searchActivitys.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchActivitysQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    SearchActivitys searchActivitys = Data.this.searchActivitys;
                    responseWriter.writeObject(responseField, searchActivitys != null ? searchActivitys.marshaller() : null);
                }
            };
        }

        public SearchActivitys searchActivitys() {
            return this.searchActivitys;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{searchActivitys=" + this.searchActivitys + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchActivitysQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static class SearchActivitys {
        ...
        public static final class Mapper implements ResponseFieldMapper<SearchActivitys> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public SearchActivitys map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = SearchActivitys.$responseFields;
                return new SearchActivitys(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.SearchActivitysQuery.SearchActivitys.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.SearchActivitysQuery.SearchActivitys.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public SearchActivitys(String str, List<Item> list, String str2, Integer num) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof SearchActivitys)) {
                return false;
            }
            SearchActivitys searchActivitys = (SearchActivitys) obj;
            if (this.__typename.equals(searchActivitys.__typename) && this.items.equals(searchActivitys.items) && ((str = this.nextToken) != null ? str.equals(searchActivitys.nextToken) : searchActivitys.nextToken == null)) {
                Integer num = this.total;
                Integer num2 = searchActivitys.total;
                if (num == null) {
                    if (num2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchActivitysQuery.SearchActivitys.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = SearchActivitys.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], SearchActivitys.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], SearchActivitys.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.SearchActivitysQuery.SearchActivitys.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], SearchActivitys.this.nextToken);
                    responseWriter.writeInt(responseFieldArr[3], SearchActivitys.this.total);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "SearchActivitys{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + ", total=" + this.total + "}";
            }
            return this.$toString;
        }
    ...
    public static final class Variables extends Operation.Variables {
        private final SearchableActivityFilterInput filter;
        private final Integer from;
        private final Integer limit;
        private final String nextToken;
        private final SearchableActivitySortInput sort;
        private final transient Map<String, Object> valueMap;

        public Variables(SearchableActivityFilterInput searchableActivityFilterInput, SearchableActivitySortInput searchableActivitySortInput, Integer num, String str, Integer num2) {
            ...
            this.nextToken = str;
            this.from = num2;
            linkedHashMap.put("filter", searchableActivityFilterInput);
            linkedHashMap.put("sort", searchableActivitySortInput);
        ...
        public SearchableActivityFilterInput filter() {
            return this.filter;
        }
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchActivitysQuery.Variables.1
        ...
        public SearchableActivitySortInput sort() {
            return this.sort;
        }
    ...
    public SearchActivitysQuery(SearchableActivityFilterInput searchableActivityFilterInput, SearchableActivitySortInput searchableActivitySortInput, Integer num, String str, Integer num2) {
        this.variables = new Variables(searchableActivityFilterInput, searchableActivitySortInput, num, str, num2);
    }
    ...
    public String operationId() {
        return "9f2209173e9982eec956acad3e70cfb88c5ffda5ec64a6d5aa51c04c857ec142";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query SearchActivitys($filter: SearchableActivityFilterInput, $sort: SearchableActivitySortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchActivitys(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      id\n      threadId\n      accountId\n      activityRelatedObjectType\n      activityRelatedObjectId\n      activityCategory\n      activityType\n      body\n      note\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      createdAt\n      updatedAt\n    }\n    nextToken\n    total\n  }\n}";
    }
