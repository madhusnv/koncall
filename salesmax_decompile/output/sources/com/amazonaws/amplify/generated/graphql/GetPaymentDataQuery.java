...
public final class GetPaymentDataQuery implements Query<Data, Data, Variables> {
    ...
    public static class Contact {
        ...
        public static final class Mapper implements ResponseFieldMapper<Contact> {
            ...
            public Contact map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[5], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Contact.Mapper.1
                ...
                List list2 = responseReader.readList(responseFieldArr[7], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Contact.Mapper.2
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                ...
                List list3 = responseReader.readList(responseFieldArr[34], new ResponseReader.ListReader<Day>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Contact.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                ...
                List list4 = responseReader.readList(responseFieldArr[92], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Contact.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                });
                List list5 = responseReader.readList(responseFieldArr[93], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Contact.Mapper.5
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                ...
                List list6 = responseReader.readList(responseFieldArr[97], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Contact.Mapper.6
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Contact.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], Contact.this.sharedOwners, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Contact.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[7], Contact.this.sharedTeams, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Contact.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[34], Contact.this.preferredContactDays, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Contact.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[92], Contact.this.userDefinedTags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Contact.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[93], Contact.this.productService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Contact.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[97], Contact.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Contact.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getPaymentData", "getPaymentData", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetPaymentData getPaymentData;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetPaymentData.Mapper getPaymentDataFieldMapper = new GetPaymentData.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetPaymentData) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetPaymentData>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetPaymentData read(ResponseReader responseReader2) {
                        return Mapper.this.getPaymentDataFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetPaymentData getPaymentData) {
        ...
        public boolean equals(Object obj) {
            ...
            GetPaymentData getPaymentData = this.getPaymentData;
            GetPaymentData getPaymentData2 = ((Data) obj).getPaymentData;
            return getPaymentData == null ? getPaymentData2 == null : getPaymentData.equals(getPaymentData2);
        }

        public GetPaymentData getPaymentData() {
        ...
        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetPaymentData getPaymentData = this.getPaymentData;
                this.$hashCode = (getPaymentData == null ? 0 : getPaymentData.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetPaymentData getPaymentData = Data.this.getPaymentData;
                    responseWriter.writeObject(responseField, getPaymentData != null ? getPaymentData.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getPaymentData=" + this.getPaymentData + "}";
            }
            return this.$toString;
        }
    }

    public static class GetPaymentData {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<GetPaymentData> {
        ...
        public GetPaymentData(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, Integer num, Integer num2, String str12, String str13, String str14, String str15, List<String> list, List<String> list2, String str16, String str17, String str18, String str19, String str20, String str21, PaymentLink paymentLink, Order order, PaymentEvents paymentEvents, Contact contact) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
            this.contactId = str4;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetPaymentData)) {
                return false;
            }
            GetPaymentData getPaymentData = (GetPaymentData) obj;
            if (this.__typename.equals(getPaymentData.__typename) && this.id.equals(getPaymentData.id) && this.accountId.equals(getPaymentData.accountId) && ((str = this.contactId) != null ? str.equals(getPaymentData.contactId) : getPaymentData.contactId == null) && ((str2 = this.paymentRequestType) != null ? str2.equals(getPaymentData.paymentRequestType) : getPaymentData.paymentRequestType == null) && ((str3 = this.engagementId) != null ? str3.equals(getPaymentData.engagementId) : getPaymentData.engagementId == null) && ((str4 = this.paymentProvider) != null ? str4.equals(getPaymentData.paymentProvider) : getPaymentData.paymentProvider == null) && ((str5 = this.orderIdInPaymentProvider) != null ? str5.equals(getPaymentData.orderIdInPaymentProvider) : getPaymentData.orderIdInPaymentProvider == null) && ((str6 = this.orderId) != null ? str6.equals(getPaymentData.orderId) : getPaymentData.orderId == null) && ((str7 = this.paymentLinkId) != null ? str7.equals(getPaymentData.paymentLinkId) : getPaymentData.paymentLinkId == null) && ((str8 = this.paymentLinkUrl) != null ? str8.equals(getPaymentData.paymentLinkUrl) : getPaymentData.paymentLinkUrl == null) && ((num = this.amount) != null ? num.equals(getPaymentData.amount) : getPaymentData.amount == null) && ((num2 = this.amountPaid) != null ? num2.equals(getPaymentData.amountPaid) : getPaymentData.amountPaid == null) && ((str9 = this.currency) != null ? str9.equals(getPaymentData.currency) : getPaymentData.currency == null) && ((str10 = this.status) != null ? str10.equals(getPaymentData.status) : getPaymentData.status == null) && ((str11 = this.lastPaymentStatus) != null ? str11.equals(getPaymentData.lastPaymentStatus) : getPaymentData.lastPaymentStatus == null) && ((str12 = this.finalPaymentDate) != null ? str12.equals(getPaymentData.finalPaymentDate) : getPaymentData.finalPaymentDate == null) && ((list = this.paidByContactIds) != null ? list.equals(getPaymentData.paidByContactIds) : getPaymentData.paidByContactIds == null) && ((list2 = this.transactionId) != null ? list2.equals(getPaymentData.transactionId) : getPaymentData.transactionId == null) && ((str13 = this.note) != null ? str13.equals(getPaymentData.note) : getPaymentData.note == null) && ((str14 = this.createdAt) != null ? str14.equals(getPaymentData.createdAt) : getPaymentData.createdAt == null) && ((str15 = this.updatedAt) != null ? str15.equals(getPaymentData.updatedAt) : getPaymentData.updatedAt == null) && ((str16 = this.customPaymentData) != null ? str16.equals(getPaymentData.customPaymentData) : getPaymentData.customPaymentData == null) && ((str17 = this.createdById) != null ? str17.equals(getPaymentData.createdById) : getPaymentData.createdById == null) && ((str18 = this.updatedById) != null ? str18.equals(getPaymentData.updatedById) : getPaymentData.updatedById == null) && ((paymentLink = this.paymentLink) != null ? paymentLink.equals(getPaymentData.paymentLink) : getPaymentData.paymentLink == null) && ((order = this.order) != null ? order.equals(getPaymentData.order) : getPaymentData.order == null) && ((paymentEvents = this.paymentEvents) != null ? paymentEvents.equals(getPaymentData.paymentEvents) : getPaymentData.paymentEvents == null)) {
                Contact contact = this.contact;
                Contact contact2 = getPaymentData.contact;
                if (contact == null) {
                    if (contact2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.GetPaymentData.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetPaymentData.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetPaymentData.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetPaymentData.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetPaymentData.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], GetPaymentData.this.contactId);
                    responseWriter.writeString(responseFieldArr[4], GetPaymentData.this.paymentRequestType);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], GetPaymentData.this.engagementId);
                    responseWriter.writeString(responseFieldArr[6], GetPaymentData.this.paymentProvider);
                    responseWriter.writeString(responseFieldArr[7], GetPaymentData.this.orderIdInPaymentProvider);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], GetPaymentData.this.orderId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], GetPaymentData.this.paymentLinkId);
                    responseWriter.writeString(responseFieldArr[10], GetPaymentData.this.paymentLinkUrl);
                    responseWriter.writeInt(responseFieldArr[11], GetPaymentData.this.amount);
                    responseWriter.writeInt(responseFieldArr[12], GetPaymentData.this.amountPaid);
                    responseWriter.writeString(responseFieldArr[13], GetPaymentData.this.currency);
                    responseWriter.writeString(responseFieldArr[14], GetPaymentData.this.status);
                    responseWriter.writeString(responseFieldArr[15], GetPaymentData.this.lastPaymentStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], GetPaymentData.this.finalPaymentDate);
                    responseWriter.writeList(responseFieldArr[17], GetPaymentData.this.paidByContactIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.GetPaymentData.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], GetPaymentData.this.transactionId, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.GetPaymentData.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[19], GetPaymentData.this.note);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], GetPaymentData.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], GetPaymentData.this.updatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], GetPaymentData.this.customPaymentData);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], GetPaymentData.this.createdById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[24], GetPaymentData.this.updatedById);
                    ResponseField responseField = responseFieldArr[25];
                    PaymentLink paymentLink = GetPaymentData.this.paymentLink;
                    ...
                    Order order = GetPaymentData.this.order;
                    ...
                    PaymentEvents paymentEvents = GetPaymentData.this.paymentEvents;
                    ...
                    Contact contact = GetPaymentData.this.contact;
    ...
    public static class Order {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Order.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Order.$responseFields;
    ...
    public static class PaymentEvents {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.PaymentEvents.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = PaymentEvents.$responseFields;
    ...
    public static class PaymentLink {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.PaymentLink.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = PaymentLink.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataQuery.Variables.1
    ...
    public GetPaymentDataQuery(String str) {
    ...
    public String operationId() {
        return "eedb04b82e4af99e638f7a50407c1913cf9fc813849e1018793c4f491f915df7";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetPaymentData($id: ID!) {\n  getPaymentData(id: $id) {\n    __typename\n    id\n    accountId\n    contactId\n    paymentRequestType\n    engagementId\n    paymentProvider\n    orderIdInPaymentProvider\n    orderId\n    paymentLinkId\n    paymentLinkUrl\n    amount\n    amountPaid\n    currency\n    status\n    lastPaymentStatus\n    finalPaymentDate\n    paidByContactIds\n    transactionId\n    note\n    createdAt\n    updatedAt\n    customPaymentData\n    createdById\n    updatedById\n    paymentLink {\n      __typename\n      id\n      accountId\n      contactId\n      paymentProvider\n      idInPaymentProvider\n      orderId\n      acceptPartial\n      firstMinPartialAmount\n      currency\n      amount\n      amountPaid\n      description\n      note\n      shortUrl\n      upiLink\n      status\n      expireBy\n      expiredAt\n      cancelledAt\n      createdAt\n      updatedAt\n      externalUserReference\n      createdById\n      updatedById\n    }\n    order {\n      __typename\n      id\n      accountId\n      contactId\n      paymentProvider\n      idInPaymentProvider\n      currency\n      amount\n      amountPaid\n      status\n      note\n      receipt\n      createdAt\n      updatedAt\n      createdById\n      updatedById\n    }\n    paymentEvents {\n      __typename\n      nextToken\n    }\n    contact {\n      __typename\n      id\n      accountId\n      ownerId\n      toBeAssigned\n      sharedOwners\n      primaryTeamId\n      sharedTeams\n      accountPriority\n      addedById\n      assignedToId\n      blockedForCallById\n      blockedForCallReason\n      blockedForCallUntil\n      callPriority\n      waChatChannelId\n      contactSource\n      contactSourceDrillDownOne\n      contactSourceDrillDownTwo\n      contactSourceDrillDownThree\n      contactSourceDrillDownOneId\n      contactSourceDrillDownTwoId\n      contactSourceDrillDownThreeId\n      contactStatus\n      contactType\n      department\n      designation\n      lastRepeatEnquiryDate\n      lastRepeatEnquirySource\n      gender\n      isDecisionMaker\n      isPrivate\n      lockPeriod\n      name\n      preferredContactDays\n      profilePhotoUrl\n      referredBy\n      salutation\n      seniority\n      updatedById\n      hasTask\n      openTaskActivityType\n      lastCalledTime\n      lastCallDirection\n      lastCallOutcome\n      lastCallOutcomeNature\n      lastCallUserId\n      lastCallDuration\n      lastCallEngagementId\n      lastVisitTime\n      lastVisitOutcome\n      lastVisitOutcomeNature\n      lastVisitUserId\n      lastVisitEngagementId\n      lastEmailTime\n      lastEmailUserId\n      lastEmailEngagementId\n      lastWhatsappTime\n      lastWhatsappUserId\n      lastWhatsappEngagementId\n      lastWabaBroadcastTime\n      lastWabaBroadcastStatus\n      lastWabaBroadcastTemplate\n      lastWabaBroadcastReplyBody\n      lastWabaBroadcastReplyTime\n      lastWabaBroadcastReplyType\n      lastSmsTime\n      lastSmsUserId\n      lastSmsEngagementId\n      lastNoteAddedTime\n      lastNoteUserId\n      lastNoteEngagementId\n      lastTaskDoneTime\n      lastTaskDoneUserId\n      lastTaskDoneEngagementId\n      openTaskCount\n      lastKnownDisposition\n      lastKnownDispositionTime\n      lastLeadAssignmentDateTime\n      lastEngagementFromAccount\n      lastEngagementFromContact\n      freshLeadTag\n      noWorkAfterAssignment\n      needFollowUpTag\n      needFollowUpTagUpdatedAt\n      activeDealStage\n      activeDealStageUpdatedAt\n      dealDescription\n      isCustomer\n      becameCustomerOn\n      unsuccessfulCallAttempts\n      leadCallsNotAnswered\n      userDefinedTags\n      productService\n      bulkUploadReference\n      assignmentMethod\n      whatsappOptInStatus\n      recentEngagements\n      recentEngagementsUpdatedAt\n      openTaskDetail\n      openVideoCallDetail\n      lastClosedTaskDetail\n      lastClosedTaskDetailUpdatedAt\n      latestRemark\n      customAttributes\n      paymentRequestDetail\n      lastPaymentStatus\n      customDataAddedFromAddContactForm\n      leadLifecycleStage\n      leadLifecycleStageSubCategory\n      manualClosedReason\n      lastDealStageType\n      prospectingAttempts\n      totalProspectingAttemptsAcrossRechurn\n      numberOfTimesRechurned\n      lastProspectingDoneOn\n      firstProspectingDoneOn\n      nextProspectingDueOn\n      nextProspectingSetBy\n      nextProspectingNote\n      movedToOpportunityOn\n      movedToClosedOn\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
