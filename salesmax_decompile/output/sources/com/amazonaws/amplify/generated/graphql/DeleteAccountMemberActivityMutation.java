...
import type.DeleteAccountMemberActivityInput;
import type.ModelAccountMemberActivityConditionInput;

/* loaded from: classes6.dex */
public final class DeleteAccountMemberActivityMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation DeleteAccountMemberActivity($input: DeleteAccountMemberActivityInput!, $condition: ModelAccountMemberActivityConditionInput) {\n  deleteAccountMemberActivity(input: $input, condition: $condition) {\n    __typename\n    accountId\n    userId\n    lastActivityId\n    lastViewedNotifications\n    lastViewedCommentMentions\n    lastViewedRecentTasks\n    lastViewedRecentActivities\n    lastViewedMissedActions\n    lastViewedPendingAssignments\n    lastViewedCommentAndMentions\n    lastActivityTime\n    lastActivityType\n    lastActivityBody\n    lastCallLogged\n    lastNoteAdded\n    lastCommentAdded\n    lastTaskCompleted\n    lastTaskCreated\n    lastVisitLogged\n    lastContactAdded\n    lastEmailSent\n    lastWhatsappSent\n    lastSmsSent\n    lastKnownLocation\n    lastKnownLocationTime\n    inCall\n    inCallWithContactId\n    inCallWithContactName\n    inCallWithContactNumber\n    inCallRequestedAt\n    lastInCallUpdatedAt\n    callPlacementId\n    createdAt\n    updatedAt\n    lastActivity {\n      __typename\n      id\n      threadId\n      accountId\n      activityRelatedObjectType\n      activityRelatedObjectId\n      activityCategory\n      activityType\n      body\n      note\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMemberActivityMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "DeleteAccountMemberActivity";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation DeleteAccountMemberActivity($input: DeleteAccountMemberActivityInput!, $condition: ModelAccountMemberActivityConditionInput) {\n  deleteAccountMemberActivity(input: $input, condition: $condition) {\n    __typename\n    accountId\n    userId\n    lastActivityId\n    lastViewedNotifications\n    lastViewedCommentMentions\n    lastViewedRecentTasks\n    lastViewedRecentActivities\n    lastViewedMissedActions\n    lastViewedPendingAssignments\n    lastViewedCommentAndMentions\n    lastActivityTime\n    lastActivityType\n    lastActivityBody\n    lastCallLogged\n    lastNoteAdded\n    lastCommentAdded\n    lastTaskCompleted\n    lastTaskCreated\n    lastVisitLogged\n    lastContactAdded\n    lastEmailSent\n    lastWhatsappSent\n    lastSmsSent\n    lastKnownLocation\n    lastKnownLocationTime\n    inCall\n    inCallWithContactId\n    inCallWithContactName\n    inCallWithContactNumber\n    inCallRequestedAt\n    lastInCallUpdatedAt\n    callPlacementId\n    createdAt\n    updatedAt\n    lastActivity {\n      __typename\n      id\n      threadId\n      accountId\n      activityRelatedObjectType\n      activityRelatedObjectId\n      activityCategory\n      activityType\n      body\n      note\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelAccountMemberActivityConditionInput condition;
        private DeleteAccountMemberActivityInput input;

        public DeleteAccountMemberActivityMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteAccountMemberActivityMutation(this.input, this.condition);
        }
        ...
        public Builder input(DeleteAccountMemberActivityInput deleteAccountMemberActivityInput) {
            this.input = deleteAccountMemberActivityInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteAccountMemberActivity", "deleteAccountMemberActivity", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final DeleteAccountMemberActivity deleteAccountMemberActivity;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteAccountMemberActivity.Mapper deleteAccountMemberActivityFieldMapper = new DeleteAccountMemberActivity.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteAccountMemberActivity) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteAccountMemberActivity>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMemberActivityMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteAccountMemberActivity read(ResponseReader responseReader2) {
                        return Mapper.this.deleteAccountMemberActivityFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteAccountMemberActivity deleteAccountMemberActivity) {
            this.deleteAccountMemberActivity = deleteAccountMemberActivity;
        }

        public DeleteAccountMemberActivity deleteAccountMemberActivity() {
            return this.deleteAccountMemberActivity;
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteAccountMemberActivity deleteAccountMemberActivity = this.deleteAccountMemberActivity;
            DeleteAccountMemberActivity deleteAccountMemberActivity2 = ((Data) obj).deleteAccountMemberActivity;
            return deleteAccountMemberActivity == null ? deleteAccountMemberActivity2 == null : deleteAccountMemberActivity.equals(deleteAccountMemberActivity2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteAccountMemberActivity deleteAccountMemberActivity = this.deleteAccountMemberActivity;
                this.$hashCode = (deleteAccountMemberActivity == null ? 0 : deleteAccountMemberActivity.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMemberActivityMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteAccountMemberActivity deleteAccountMemberActivity = Data.this.deleteAccountMemberActivity;
                    responseWriter.writeObject(responseField, deleteAccountMemberActivity != null ? deleteAccountMemberActivity.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteAccountMemberActivity=" + this.deleteAccountMemberActivity + "}";
            }
            return this.$toString;
        }
    }

    public static class DeleteAccountMemberActivity {
        ...
        public static final class Mapper implements ResponseFieldMapper<DeleteAccountMemberActivity> {
            final LastActivity.Mapper lastActivityFieldMapper = new LastActivity.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public DeleteAccountMemberActivity map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = DeleteAccountMemberActivity.$responseFields;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteAccountMemberActivity)) {
                return false;
            }
            DeleteAccountMemberActivity deleteAccountMemberActivity = (DeleteAccountMemberActivity) obj;
            if (this.__typename.equals(deleteAccountMemberActivity.__typename) && this.accountId.equals(deleteAccountMemberActivity.accountId) && this.userId.equals(deleteAccountMemberActivity.userId) && ((str = this.lastActivityId) != null ? str.equals(deleteAccountMemberActivity.lastActivityId) : deleteAccountMemberActivity.lastActivityId == null) && ((str2 = this.lastViewedNotifications) != null ? str2.equals(deleteAccountMemberActivity.lastViewedNotifications) : deleteAccountMemberActivity.lastViewedNotifications == null) && ((str3 = this.lastViewedCommentMentions) != null ? str3.equals(deleteAccountMemberActivity.lastViewedCommentMentions) : deleteAccountMemberActivity.lastViewedCommentMentions == null) && ((str4 = this.lastViewedRecentTasks) != null ? str4.equals(deleteAccountMemberActivity.lastViewedRecentTasks) : deleteAccountMemberActivity.lastViewedRecentTasks == null) && ((str5 = this.lastViewedRecentActivities) != null ? str5.equals(deleteAccountMemberActivity.lastViewedRecentActivities) : deleteAccountMemberActivity.lastViewedRecentActivities == null) && ((str6 = this.lastViewedMissedActions) != null ? str6.equals(deleteAccountMemberActivity.lastViewedMissedActions) : deleteAccountMemberActivity.lastViewedMissedActions == null) && ((str7 = this.lastViewedPendingAssignments) != null ? str7.equals(deleteAccountMemberActivity.lastViewedPendingAssignments) : deleteAccountMemberActivity.lastViewedPendingAssignments == null) && ((str8 = this.lastViewedCommentAndMentions) != null ? str8.equals(deleteAccountMemberActivity.lastViewedCommentAndMentions) : deleteAccountMemberActivity.lastViewedCommentAndMentions == null) && ((str9 = this.lastActivityTime) != null ? str9.equals(deleteAccountMemberActivity.lastActivityTime) : deleteAccountMemberActivity.lastActivityTime == null) && ((activityType = this.lastActivityType) != null ? activityType.equals(deleteAccountMemberActivity.lastActivityType) : deleteAccountMemberActivity.lastActivityType == null) && ((str10 = this.lastActivityBody) != null ? str10.equals(deleteAccountMemberActivity.lastActivityBody) : deleteAccountMemberActivity.lastActivityBody == null) && ((str11 = this.lastCallLogged) != null ? str11.equals(deleteAccountMemberActivity.lastCallLogged) : deleteAccountMemberActivity.lastCallLogged == null) && ((str12 = this.lastNoteAdded) != null ? str12.equals(deleteAccountMemberActivity.lastNoteAdded) : deleteAccountMemberActivity.lastNoteAdded == null) && ((str13 = this.lastCommentAdded) != null ? str13.equals(deleteAccountMemberActivity.lastCommentAdded) : deleteAccountMemberActivity.lastCommentAdded == null) && ((str14 = this.lastTaskCompleted) != null ? str14.equals(deleteAccountMemberActivity.lastTaskCompleted) : deleteAccountMemberActivity.lastTaskCompleted == null) && ((str15 = this.lastTaskCreated) != null ? str15.equals(deleteAccountMemberActivity.lastTaskCreated) : deleteAccountMemberActivity.lastTaskCreated == null) && ((str16 = this.lastVisitLogged) != null ? str16.equals(deleteAccountMemberActivity.lastVisitLogged) : deleteAccountMemberActivity.lastVisitLogged == null) && ((str17 = this.lastContactAdded) != null ? str17.equals(deleteAccountMemberActivity.lastContactAdded) : deleteAccountMemberActivity.lastContactAdded == null) && ((str18 = this.lastEmailSent) != null ? str18.equals(deleteAccountMemberActivity.lastEmailSent) : deleteAccountMemberActivity.lastEmailSent == null) && ((str19 = this.lastWhatsappSent) != null ? str19.equals(deleteAccountMemberActivity.lastWhatsappSent) : deleteAccountMemberActivity.lastWhatsappSent == null) && ((str20 = this.lastSmsSent) != null ? str20.equals(deleteAccountMemberActivity.lastSmsSent) : deleteAccountMemberActivity.lastSmsSent == null) && ((str21 = this.lastKnownLocation) != null ? str21.equals(deleteAccountMemberActivity.lastKnownLocation) : deleteAccountMemberActivity.lastKnownLocation == null) && ((str22 = this.lastKnownLocationTime) != null ? str22.equals(deleteAccountMemberActivity.lastKnownLocationTime) : deleteAccountMemberActivity.lastKnownLocationTime == null) && ((str23 = this.inCall) != null ? str23.equals(deleteAccountMemberActivity.inCall) : deleteAccountMemberActivity.inCall == null) && ((str24 = this.inCallWithContactId) != null ? str24.equals(deleteAccountMemberActivity.inCallWithContactId) : deleteAccountMemberActivity.inCallWithContactId == null) && ((str25 = this.inCallWithContactName) != null ? str25.equals(deleteAccountMemberActivity.inCallWithContactName) : deleteAccountMemberActivity.inCallWithContactName == null) && ((str26 = this.inCallWithContactNumber) != null ? str26.equals(deleteAccountMemberActivity.inCallWithContactNumber) : deleteAccountMemberActivity.inCallWithContactNumber == null) && ((str27 = this.inCallRequestedAt) != null ? str27.equals(deleteAccountMemberActivity.inCallRequestedAt) : deleteAccountMemberActivity.inCallRequestedAt == null) && ((str28 = this.lastInCallUpdatedAt) != null ? str28.equals(deleteAccountMemberActivity.lastInCallUpdatedAt) : deleteAccountMemberActivity.lastInCallUpdatedAt == null) && ((str29 = this.callPlacementId) != null ? str29.equals(deleteAccountMemberActivity.callPlacementId) : deleteAccountMemberActivity.callPlacementId == null) && ((str30 = this.createdAt) != null ? str30.equals(deleteAccountMemberActivity.createdAt) : deleteAccountMemberActivity.createdAt == null) && ((str31 = this.updatedAt) != null ? str31.equals(deleteAccountMemberActivity.updatedAt) : deleteAccountMemberActivity.updatedAt == null)) {
                LastActivity lastActivity = this.lastActivity;
                LastActivity lastActivity2 = deleteAccountMemberActivity.lastActivity;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMemberActivityMutation.DeleteAccountMemberActivity.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteAccountMemberActivity.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteAccountMemberActivity.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteAccountMemberActivity.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteAccountMemberActivity.this.userId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], DeleteAccountMemberActivity.this.lastActivityId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], DeleteAccountMemberActivity.this.lastViewedNotifications);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], DeleteAccountMemberActivity.this.lastViewedCommentMentions);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], DeleteAccountMemberActivity.this.lastViewedRecentTasks);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], DeleteAccountMemberActivity.this.lastViewedRecentActivities);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], DeleteAccountMemberActivity.this.lastViewedMissedActions);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], DeleteAccountMemberActivity.this.lastViewedPendingAssignments);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[10], DeleteAccountMemberActivity.this.lastViewedCommentAndMentions);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], DeleteAccountMemberActivity.this.lastActivityTime);
                    ResponseField responseField = responseFieldArr[12];
                    ActivityType activityType = DeleteAccountMemberActivity.this.lastActivityType;
                    responseWriter.writeString(responseField, activityType != null ? activityType.name() : null);
                    responseWriter.writeString(responseFieldArr[13], DeleteAccountMemberActivity.this.lastActivityBody);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], DeleteAccountMemberActivity.this.lastCallLogged);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], DeleteAccountMemberActivity.this.lastNoteAdded);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], DeleteAccountMemberActivity.this.lastCommentAdded);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], DeleteAccountMemberActivity.this.lastTaskCompleted);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], DeleteAccountMemberActivity.this.lastTaskCreated);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], DeleteAccountMemberActivity.this.lastVisitLogged);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], DeleteAccountMemberActivity.this.lastContactAdded);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], DeleteAccountMemberActivity.this.lastEmailSent);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], DeleteAccountMemberActivity.this.lastWhatsappSent);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], DeleteAccountMemberActivity.this.lastSmsSent);
                    responseWriter.writeString(responseFieldArr[24], DeleteAccountMemberActivity.this.lastKnownLocation);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], DeleteAccountMemberActivity.this.lastKnownLocationTime);
                    responseWriter.writeString(responseFieldArr[26], DeleteAccountMemberActivity.this.inCall);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], DeleteAccountMemberActivity.this.inCallWithContactId);
                    responseWriter.writeString(responseFieldArr[28], DeleteAccountMemberActivity.this.inCallWithContactName);
                    responseWriter.writeString(responseFieldArr[29], DeleteAccountMemberActivity.this.inCallWithContactNumber);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[30], DeleteAccountMemberActivity.this.inCallRequestedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[31], DeleteAccountMemberActivity.this.lastInCallUpdatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[32], DeleteAccountMemberActivity.this.callPlacementId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[33], DeleteAccountMemberActivity.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[34], DeleteAccountMemberActivity.this.updatedAt);
                    ResponseField responseField2 = responseFieldArr[35];
                    LastActivity lastActivity = DeleteAccountMemberActivity.this.lastActivity;
    ...
    public static class LastActivity {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMemberActivityMutation.LastActivity.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = LastActivity.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final DeleteAccountMemberActivityInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteAccountMemberActivityInput deleteAccountMemberActivityInput, ModelAccountMemberActivityConditionInput modelAccountMemberActivityConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteAccountMemberActivityInput;
            this.condition = modelAccountMemberActivityConditionInput;
            linkedHashMap.put("input", deleteAccountMemberActivityInput);
        ...
        public DeleteAccountMemberActivityInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMemberActivityMutation.Variables.1
    ...
    public DeleteAccountMemberActivityMutation(DeleteAccountMemberActivityInput deleteAccountMemberActivityInput, ModelAccountMemberActivityConditionInput modelAccountMemberActivityConditionInput) {
        Utils.checkNotNull(deleteAccountMemberActivityInput, "input == null");
        this.variables = new Variables(deleteAccountMemberActivityInput, modelAccountMemberActivityConditionInput);
    }
    ...
    public String operationId() {
        return "017fba5277908db4dedf9f78b45202ef1714be04da70892fb8737a5f8e3f5c86";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteAccountMemberActivity($input: DeleteAccountMemberActivityInput!, $condition: ModelAccountMemberActivityConditionInput) {\n  deleteAccountMemberActivity(input: $input, condition: $condition) {\n    __typename\n    accountId\n    userId\n    lastActivityId\n    lastViewedNotifications\n    lastViewedCommentMentions\n    lastViewedRecentTasks\n    lastViewedRecentActivities\n    lastViewedMissedActions\n    lastViewedPendingAssignments\n    lastViewedCommentAndMentions\n    lastActivityTime\n    lastActivityType\n    lastActivityBody\n    lastCallLogged\n    lastNoteAdded\n    lastCommentAdded\n    lastTaskCompleted\n    lastTaskCreated\n    lastVisitLogged\n    lastContactAdded\n    lastEmailSent\n    lastWhatsappSent\n    lastSmsSent\n    lastKnownLocation\n    lastKnownLocationTime\n    inCall\n    inCallWithContactId\n    inCallWithContactName\n    inCallWithContactNumber\n    inCallRequestedAt\n    lastInCallUpdatedAt\n    callPlacementId\n    createdAt\n    updatedAt\n    lastActivity {\n      __typename\n      id\n      threadId\n      accountId\n      activityRelatedObjectType\n      activityRelatedObjectId\n      activityCategory\n      activityType\n      body\n      note\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
