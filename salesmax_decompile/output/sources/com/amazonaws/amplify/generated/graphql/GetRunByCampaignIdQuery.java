...
public final class GetRunByCampaignIdQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetRunByCampaignId($campaignId: ID, $sortDirection: ModelSortDirection, $filter: ModelCampaignRunFilterInput, $limit: Int, $nextToken: String) {\n  getRunByCampaignId(campaignId: $campaignId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      campaignId\n      campaignName\n      campaignType\n      campaignChannelIdentifier\n      name\n      startDate\n      endDate\n      status\n      systemPauseReason\n      leadCount\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      ownerId\n      primaryTeamId\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetRunByCampaignIdQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetRunByCampaignId";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetRunByCampaignId($campaignId: ID, $sortDirection: ModelSortDirection, $filter: ModelCampaignRunFilterInput, $limit: Int, $nextToken: String) {\n  getRunByCampaignId(campaignId: $campaignId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      campaignId\n      campaignName\n      campaignType\n      campaignChannelIdentifier\n      name\n      startDate\n      endDate\n      status\n      systemPauseReason\n      leadCount\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      ownerId\n      primaryTeamId\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetRunByCampaignIdQuery build() {
            return new GetRunByCampaignIdQuery(this.campaignId, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getRunByCampaignId", "getRunByCampaignId", new UnmodifiableMapBuilder(5).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put("campaignId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "campaignId").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetRunByCampaignId getRunByCampaignId;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetRunByCampaignId.Mapper getRunByCampaignIdFieldMapper = new GetRunByCampaignId.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetRunByCampaignId) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetRunByCampaignId>() { // from class: com.amazonaws.amplify.generated.graphql.GetRunByCampaignIdQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetRunByCampaignId read(ResponseReader responseReader2) {
                        return Mapper.this.getRunByCampaignIdFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetRunByCampaignId getRunByCampaignId) {
            this.getRunByCampaignId = getRunByCampaignId;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetRunByCampaignId getRunByCampaignId = this.getRunByCampaignId;
            GetRunByCampaignId getRunByCampaignId2 = ((Data) obj).getRunByCampaignId;
            return getRunByCampaignId == null ? getRunByCampaignId2 == null : getRunByCampaignId.equals(getRunByCampaignId2);
        }

        public GetRunByCampaignId getRunByCampaignId() {
            return this.getRunByCampaignId;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetRunByCampaignId getRunByCampaignId = this.getRunByCampaignId;
                this.$hashCode = (getRunByCampaignId == null ? 0 : getRunByCampaignId.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetRunByCampaignIdQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetRunByCampaignId getRunByCampaignId = Data.this.getRunByCampaignId;
                    responseWriter.writeObject(responseField, getRunByCampaignId != null ? getRunByCampaignId.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getRunByCampaignId=" + this.getRunByCampaignId + "}";
            }
            return this.$toString;
        }
    }

    public static class GetRunByCampaignId {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetRunByCampaignId> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetRunByCampaignId map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetRunByCampaignId.$responseFields;
                return new GetRunByCampaignId(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetRunByCampaignIdQuery.GetRunByCampaignId.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetRunByCampaignIdQuery.GetRunByCampaignId.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetRunByCampaignId(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetRunByCampaignId)) {
                return false;
            }
            GetRunByCampaignId getRunByCampaignId = (GetRunByCampaignId) obj;
            if (this.__typename.equals(getRunByCampaignId.__typename) && this.items.equals(getRunByCampaignId.items)) {
                String str = this.nextToken;
                String str2 = getRunByCampaignId.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetRunByCampaignIdQuery.GetRunByCampaignId.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetRunByCampaignId.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetRunByCampaignId.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetRunByCampaignId.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetRunByCampaignIdQuery.GetRunByCampaignId.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetRunByCampaignId.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetRunByCampaignId{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetRunByCampaignIdQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(String str, ModelSortDirection modelSortDirection, ModelCampaignRunFilterInput modelCampaignRunFilterInput, Integer num, String str2) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetRunByCampaignIdQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("campaignId", Variables.this.campaignId);
    ...
    public GetRunByCampaignIdQuery(String str, ModelSortDirection modelSortDirection, ModelCampaignRunFilterInput modelCampaignRunFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelSortDirection, modelCampaignRunFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "551960a5100e836b3cc5248735c41905e5006a40fe7c21ed71fcbb25737095b3";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetRunByCampaignId($campaignId: ID, $sortDirection: ModelSortDirection, $filter: ModelCampaignRunFilterInput, $limit: Int, $nextToken: String) {\n  getRunByCampaignId(campaignId: $campaignId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      campaignId\n      campaignName\n      campaignType\n      campaignChannelIdentifier\n      name\n      startDate\n      endDate\n      status\n      systemPauseReason\n      leadCount\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      ownerId\n      primaryTeamId\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
