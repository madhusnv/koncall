...
public final class GetCustomFormAttachConditionQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetCustomFormAttachCondition($id: ID!) {\n  getCustomFormAttachCondition(id: $id) {\n    __typename\n    id\n    accountId\n    formId\n    formType\n    callOutcome\n    visitOutcome\n    taskInputType\n    taskType\n    taskOutcomeType\n    dealStage\n    paymentStatus\n    documentCategory\n    documentSubCategory\n    isDefaultFormForType\n    hideDefaultNote\n    createdById\n    updatedById\n    createdAt\n    updatedAt\n    formDefinition {\n      __typename\n      id\n      accountId\n      formName\n      displayName\n      formTitle\n      createdById\n      updaedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetCustomFormAttachConditionQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetCustomFormAttachCondition";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetCustomFormAttachCondition($id: ID!) {\n  getCustomFormAttachCondition(id: $id) {\n    __typename\n    id\n    accountId\n    formId\n    formType\n    callOutcome\n    visitOutcome\n    taskInputType\n    taskType\n    taskOutcomeType\n    dealStage\n    paymentStatus\n    documentCategory\n    documentSubCategory\n    isDefaultFormForType\n    hideDefaultNote\n    createdById\n    updatedById\n    createdAt\n    updatedAt\n    formDefinition {\n      __typename\n      id\n      accountId\n      formName\n      displayName\n      formTitle\n      createdById\n      updaedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private String id;

        public GetCustomFormAttachConditionQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetCustomFormAttachConditionQuery(this.id);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getCustomFormAttachCondition", "getCustomFormAttachCondition", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetCustomFormAttachCondition getCustomFormAttachCondition;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetCustomFormAttachCondition.Mapper getCustomFormAttachConditionFieldMapper = new GetCustomFormAttachCondition.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetCustomFormAttachCondition) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetCustomFormAttachCondition>() { // from class: com.amazonaws.amplify.generated.graphql.GetCustomFormAttachConditionQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetCustomFormAttachCondition read(ResponseReader responseReader2) {
                        return Mapper.this.getCustomFormAttachConditionFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetCustomFormAttachCondition getCustomFormAttachCondition) {
            this.getCustomFormAttachCondition = getCustomFormAttachCondition;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetCustomFormAttachCondition getCustomFormAttachCondition = this.getCustomFormAttachCondition;
            GetCustomFormAttachCondition getCustomFormAttachCondition2 = ((Data) obj).getCustomFormAttachCondition;
            return getCustomFormAttachCondition == null ? getCustomFormAttachCondition2 == null : getCustomFormAttachCondition.equals(getCustomFormAttachCondition2);
        }

        public GetCustomFormAttachCondition getCustomFormAttachCondition() {
            return this.getCustomFormAttachCondition;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetCustomFormAttachCondition getCustomFormAttachCondition = this.getCustomFormAttachCondition;
                this.$hashCode = (getCustomFormAttachCondition == null ? 0 : getCustomFormAttachCondition.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCustomFormAttachConditionQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetCustomFormAttachCondition getCustomFormAttachCondition = Data.this.getCustomFormAttachCondition;
                    responseWriter.writeObject(responseField, getCustomFormAttachCondition != null ? getCustomFormAttachCondition.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getCustomFormAttachCondition=" + this.getCustomFormAttachCondition + "}";
            }
    ...
    public static class FormDefinition {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCustomFormAttachConditionQuery.FormDefinition.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = FormDefinition.$responseFields;
    ...
    public static class GetCustomFormAttachCondition {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public GetCustomFormAttachCondition(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, Boolean bool, String str16, String str17, String str18, String str19, FormDefinition formDefinition) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetCustomFormAttachCondition)) {
                return false;
            }
            GetCustomFormAttachCondition getCustomFormAttachCondition = (GetCustomFormAttachCondition) obj;
            if (this.__typename.equals(getCustomFormAttachCondition.__typename) && this.id.equals(getCustomFormAttachCondition.id) && this.accountId.equals(getCustomFormAttachCondition.accountId) && this.formId.equals(getCustomFormAttachCondition.formId) && ((str = this.formType) != null ? str.equals(getCustomFormAttachCondition.formType) : getCustomFormAttachCondition.formType == null) && ((str2 = this.callOutcome) != null ? str2.equals(getCustomFormAttachCondition.callOutcome) : getCustomFormAttachCondition.callOutcome == null) && ((str3 = this.visitOutcome) != null ? str3.equals(getCustomFormAttachCondition.visitOutcome) : getCustomFormAttachCondition.visitOutcome == null) && ((str4 = this.taskInputType) != null ? str4.equals(getCustomFormAttachCondition.taskInputType) : getCustomFormAttachCondition.taskInputType == null) && ((str5 = this.taskType) != null ? str5.equals(getCustomFormAttachCondition.taskType) : getCustomFormAttachCondition.taskType == null) && ((str6 = this.taskOutcomeType) != null ? str6.equals(getCustomFormAttachCondition.taskOutcomeType) : getCustomFormAttachCondition.taskOutcomeType == null) && ((str7 = this.dealStage) != null ? str7.equals(getCustomFormAttachCondition.dealStage) : getCustomFormAttachCondition.dealStage == null) && ((str8 = this.paymentStatus) != null ? str8.equals(getCustomFormAttachCondition.paymentStatus) : getCustomFormAttachCondition.paymentStatus == null) && ((str9 = this.documentCategory) != null ? str9.equals(getCustomFormAttachCondition.documentCategory) : getCustomFormAttachCondition.documentCategory == null) && ((str10 = this.documentSubCategory) != null ? str10.equals(getCustomFormAttachCondition.documentSubCategory) : getCustomFormAttachCondition.documentSubCategory == null) && ((str11 = this.isDefaultFormForType) != null ? str11.equals(getCustomFormAttachCondition.isDefaultFormForType) : getCustomFormAttachCondition.isDefaultFormForType == null) && ((bool = this.hideDefaultNote) != null ? bool.equals(getCustomFormAttachCondition.hideDefaultNote) : getCustomFormAttachCondition.hideDefaultNote == null) && ((str12 = this.createdById) != null ? str12.equals(getCustomFormAttachCondition.createdById) : getCustomFormAttachCondition.createdById == null) && ((str13 = this.updatedById) != null ? str13.equals(getCustomFormAttachCondition.updatedById) : getCustomFormAttachCondition.updatedById == null) && ((str14 = this.createdAt) != null ? str14.equals(getCustomFormAttachCondition.createdAt) : getCustomFormAttachCondition.createdAt == null) && ((str15 = this.updatedAt) != null ? str15.equals(getCustomFormAttachCondition.updatedAt) : getCustomFormAttachCondition.updatedAt == null)) {
                FormDefinition formDefinition = this.formDefinition;
                FormDefinition formDefinition2 = getCustomFormAttachCondition.formDefinition;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCustomFormAttachConditionQuery.GetCustomFormAttachCondition.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetCustomFormAttachCondition.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetCustomFormAttachCondition.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetCustomFormAttachCondition.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetCustomFormAttachCondition.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], GetCustomFormAttachCondition.this.formId);
                    responseWriter.writeString(responseFieldArr[4], GetCustomFormAttachCondition.this.formType);
                    responseWriter.writeString(responseFieldArr[5], GetCustomFormAttachCondition.this.callOutcome);
                    responseWriter.writeString(responseFieldArr[6], GetCustomFormAttachCondition.this.visitOutcome);
                    responseWriter.writeString(responseFieldArr[7], GetCustomFormAttachCondition.this.taskInputType);
                    responseWriter.writeString(responseFieldArr[8], GetCustomFormAttachCondition.this.taskType);
                    responseWriter.writeString(responseFieldArr[9], GetCustomFormAttachCondition.this.taskOutcomeType);
                    responseWriter.writeString(responseFieldArr[10], GetCustomFormAttachCondition.this.dealStage);
                    responseWriter.writeString(responseFieldArr[11], GetCustomFormAttachCondition.this.paymentStatus);
                    responseWriter.writeString(responseFieldArr[12], GetCustomFormAttachCondition.this.documentCategory);
                    responseWriter.writeString(responseFieldArr[13], GetCustomFormAttachCondition.this.documentSubCategory);
                    responseWriter.writeString(responseFieldArr[14], GetCustomFormAttachCondition.this.isDefaultFormForType);
                    responseWriter.writeBoolean(responseFieldArr[15], GetCustomFormAttachCondition.this.hideDefaultNote);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], GetCustomFormAttachCondition.this.createdById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], GetCustomFormAttachCondition.this.updatedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], GetCustomFormAttachCondition.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], GetCustomFormAttachCondition.this.updatedAt);
                    ResponseField responseField = responseFieldArr[20];
                    FormDefinition formDefinition = GetCustomFormAttachCondition.this.formDefinition;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCustomFormAttachConditionQuery.Variables.1
    ...
    public GetCustomFormAttachConditionQuery(String str) {
    ...
    public String operationId() {
        return "d20ec1fbcf398c5d8a1b30a8034a34372604aa97620116c21b65ba80ba7d1df6";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetCustomFormAttachCondition($id: ID!) {\n  getCustomFormAttachCondition(id: $id) {\n    __typename\n    id\n    accountId\n    formId\n    formType\n    callOutcome\n    visitOutcome\n    taskInputType\n    taskType\n    taskOutcomeType\n    dealStage\n    paymentStatus\n    documentCategory\n    documentSubCategory\n    isDefaultFormForType\n    hideDefaultNote\n    createdById\n    updatedById\n    createdAt\n    updatedAt\n    formDefinition {\n      __typename\n      id\n      accountId\n      formName\n      displayName\n      formTitle\n      createdById\n      updaedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
