...
import type.DeleteBusinessInput;
import type.UserRegistrationStatus;

/* loaded from: classes6.dex */
public final class DeleteBusinessMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation DeleteBusiness($input: DeleteBusinessInput!) {\n  deleteBusiness(input: $input) {\n    __typename\n    id\n    accountId\n    name\n    addresses {\n      __typename\n      addressType\n      establishmentName\n      area\n      city\n      country\n      googlePlaceId\n      isPrimaryAddress\n      landmark\n      lat\n      lng\n      rawAddressText\n      region\n      state\n      streetAddress\n      zipcode\n    }\n    industry\n    priority\n    website\n    domain\n    logo\n    userDefinedTags\n    addedById\n    updatedById\n    createdAt\n    updatedAt\n    deals {\n      __typename\n      nextToken\n    }\n    contacts {\n      __typename\n      nextToken\n    }\n    addedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.DeleteBusinessMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "DeleteBusiness";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation DeleteBusiness($input: DeleteBusinessInput!) {\n  deleteBusiness(input: $input) {\n    __typename\n    id\n    accountId\n    name\n    addresses {\n      __typename\n      addressType\n      establishmentName\n      area\n      city\n      country\n      googlePlaceId\n      isPrimaryAddress\n      landmark\n      lat\n      lng\n      rawAddressText\n      region\n      state\n      streetAddress\n      zipcode\n    }\n    industry\n    priority\n    website\n    domain\n    logo\n    userDefinedTags\n    addedById\n    updatedById\n    createdAt\n    updatedAt\n    deals {\n      __typename\n      nextToken\n    }\n    contacts {\n      __typename\n      nextToken\n    }\n    addedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    ...
    public static class AddedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteBusinessMutation.AddedBy.1
    ...
    public static class Address {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteBusinessMutation.Address.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Address.$responseFields;
    ...
    public static final class Builder {
        private DeleteBusinessInput input;

        public DeleteBusinessMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteBusinessMutation(this.input);
        }

        public Builder input(DeleteBusinessInput deleteBusinessInput) {
            this.input = deleteBusinessInput;
            return this;
        }
    }
    ...
    public static class Contacts {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteBusinessMutation.Contacts.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Contacts.$responseFields;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteBusiness", "deleteBusiness", new UnmodifiableMapBuilder(1).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteBusiness.Mapper deleteBusinessFieldMapper = new DeleteBusiness.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteBusiness) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteBusiness>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteBusinessMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteBusiness read(ResponseReader responseReader2) {
                        return Mapper.this.deleteBusinessFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteBusiness deleteBusiness) {
            this.deleteBusiness = deleteBusiness;
        }

        public DeleteBusiness deleteBusiness() {
        ...
        public boolean equals(Object obj) {
            ...
            DeleteBusiness deleteBusiness = this.deleteBusiness;
            DeleteBusiness deleteBusiness2 = ((Data) obj).deleteBusiness;
            return deleteBusiness == null ? deleteBusiness2 == null : deleteBusiness.equals(deleteBusiness2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteBusiness deleteBusiness = this.deleteBusiness;
                this.$hashCode = (deleteBusiness == null ? 0 : deleteBusiness.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteBusinessMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteBusiness deleteBusiness = Data.this.deleteBusiness;
                    responseWriter.writeObject(responseField, deleteBusiness != null ? deleteBusiness.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteBusiness=" + this.deleteBusiness + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Deals {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteBusinessMutation.Deals.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Deals.$responseFields;
    ...
    public static class DeleteBusiness {
        ...
        public static final class Mapper implements ResponseFieldMapper<DeleteBusiness> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public DeleteBusiness map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = DeleteBusiness.$responseFields;
                return new DeleteBusiness(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), responseReader.readString(responseFieldArr[3]), responseReader.readList(responseFieldArr[4], new ResponseReader.ListReader<Address>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteBusinessMutation.DeleteBusiness.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Address read(ResponseReader.ListItemReader listItemReader) {
                        return (Address) listItemReader.readObject(new ResponseReader.ObjectReader<Address>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteBusinessMutation.DeleteBusiness.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public DeleteBusiness(String str, String str2, String str3, String str4, List<Address> list, String str5, String str6, String str7, String str8, String str9, List<String> list2, String str10, String str11, String str12, String str13, Deals deals, Contacts contacts, AddedBy addedBy, UpdatedBy updatedBy) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteBusiness)) {
                return false;
            }
            DeleteBusiness deleteBusiness = (DeleteBusiness) obj;
            if (this.__typename.equals(deleteBusiness.__typename) && this.id.equals(deleteBusiness.id) && this.accountId.equals(deleteBusiness.accountId) && this.name.equals(deleteBusiness.name) && ((list = this.addresses) != null ? list.equals(deleteBusiness.addresses) : deleteBusiness.addresses == null) && ((str = this.industry) != null ? str.equals(deleteBusiness.industry) : deleteBusiness.industry == null) && ((str2 = this.priority) != null ? str2.equals(deleteBusiness.priority) : deleteBusiness.priority == null) && ((str3 = this.website) != null ? str3.equals(deleteBusiness.website) : deleteBusiness.website == null) && ((str4 = this.domain) != null ? str4.equals(deleteBusiness.domain) : deleteBusiness.domain == null) && ((str5 = this.logo) != null ? str5.equals(deleteBusiness.logo) : deleteBusiness.logo == null) && ((list2 = this.userDefinedTags) != null ? list2.equals(deleteBusiness.userDefinedTags) : deleteBusiness.userDefinedTags == null) && ((str6 = this.addedById) != null ? str6.equals(deleteBusiness.addedById) : deleteBusiness.addedById == null) && ((str7 = this.updatedById) != null ? str7.equals(deleteBusiness.updatedById) : deleteBusiness.updatedById == null) && ((str8 = this.createdAt) != null ? str8.equals(deleteBusiness.createdAt) : deleteBusiness.createdAt == null) && ((str9 = this.updatedAt) != null ? str9.equals(deleteBusiness.updatedAt) : deleteBusiness.updatedAt == null) && ((deals = this.deals) != null ? deals.equals(deleteBusiness.deals) : deleteBusiness.deals == null) && ((contacts = this.contacts) != null ? contacts.equals(deleteBusiness.contacts) : deleteBusiness.contacts == null) && ((addedBy = this.addedBy) != null ? addedBy.equals(deleteBusiness.addedBy) : deleteBusiness.addedBy == null)) {
                UpdatedBy updatedBy = this.updatedBy;
                UpdatedBy updatedBy2 = deleteBusiness.updatedBy;
                if (updatedBy == null) {
                    if (updatedBy2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteBusinessMutation.DeleteBusiness.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteBusiness.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteBusiness.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteBusiness.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteBusiness.this.accountId);
                    responseWriter.writeString(responseFieldArr[3], DeleteBusiness.this.name);
                    responseWriter.writeList(responseFieldArr[4], DeleteBusiness.this.addresses, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteBusinessMutation.DeleteBusiness.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Address) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[5], DeleteBusiness.this.industry);
                    responseWriter.writeString(responseFieldArr[6], DeleteBusiness.this.priority);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], DeleteBusiness.this.website);
                    responseWriter.writeString(responseFieldArr[8], DeleteBusiness.this.domain);
                    responseWriter.writeString(responseFieldArr[9], DeleteBusiness.this.logo);
                    responseWriter.writeList(responseFieldArr[10], DeleteBusiness.this.userDefinedTags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteBusinessMutation.DeleteBusiness.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], DeleteBusiness.this.addedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], DeleteBusiness.this.updatedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], DeleteBusiness.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], DeleteBusiness.this.updatedAt);
                    ResponseField responseField = responseFieldArr[15];
                    Deals deals = DeleteBusiness.this.deals;
                    ...
                    Contacts contacts = DeleteBusiness.this.contacts;
                    ...
                    AddedBy addedBy = DeleteBusiness.this.addedBy;
                    ...
                    UpdatedBy updatedBy = DeleteBusiness.this.updatedBy;
    ...
    public static class UpdatedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteBusinessMutation.UpdatedBy.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdatedBy.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        private final DeleteBusinessInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteBusinessInput deleteBusinessInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteBusinessInput;
            linkedHashMap.put("input", deleteBusinessInput);
        }

        public DeleteBusinessInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteBusinessMutation.Variables.1
    ...
    public DeleteBusinessMutation(DeleteBusinessInput deleteBusinessInput) {
        Utils.checkNotNull(deleteBusinessInput, "input == null");
        this.variables = new Variables(deleteBusinessInput);
    }
    ...
    public String operationId() {
        return "6730c786f145e999499bd6e9a4ecdf8518e9f0f97f71020c911fed92bcce06ee";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteBusiness($input: DeleteBusinessInput!) {\n  deleteBusiness(input: $input) {\n    __typename\n    id\n    accountId\n    name\n    addresses {\n      __typename\n      addressType\n      establishmentName\n      area\n      city\n      country\n      googlePlaceId\n      isPrimaryAddress\n      landmark\n      lat\n      lng\n      rawAddressText\n      region\n      state\n      streetAddress\n      zipcode\n    }\n    industry\n    priority\n    website\n    domain\n    logo\n    userDefinedTags\n    addedById\n    updatedById\n    createdAt\n    updatedAt\n    deals {\n      __typename\n      nextToken\n    }\n    contacts {\n      __typename\n      nextToken\n    }\n    addedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
