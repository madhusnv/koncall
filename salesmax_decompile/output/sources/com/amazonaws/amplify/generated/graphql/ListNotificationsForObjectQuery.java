...
public final class ListNotificationsForObjectQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListNotificationsForObject($notificationRelatedObjectId: ID, $scheduledAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelNotificationStagingFilterInput, $limit: Int, $nextToken: String) {\n  listNotificationsForObject(notificationRelatedObjectId: $notificationRelatedObjectId, scheduledAt: $scheduledAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      notificationId\n      notificationChannel\n      notificationStatus\n      notificationType\n      notificationRelatedObjectType\n      notificationRelatedObjectId\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      content\n      createdAt\n      updatedAt\n      scheduledAt\n      expirationUnixTime\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListNotificationsForObjectQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListNotificationsForObject";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListNotificationsForObject($notificationRelatedObjectId: ID, $scheduledAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelNotificationStagingFilterInput, $limit: Int, $nextToken: String) {\n  listNotificationsForObject(notificationRelatedObjectId: $notificationRelatedObjectId, scheduledAt: $scheduledAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      notificationId\n      notificationChannel\n      notificationStatus\n      notificationType\n      notificationRelatedObjectType\n      notificationRelatedObjectId\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      content\n      createdAt\n      updatedAt\n      scheduledAt\n      expirationUnixTime\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        private ModelStringKeyConditionInput scheduledAt;
        private ModelSortDirection sortDirection;

        public ListNotificationsForObjectQuery build() {
            return new ListNotificationsForObjectQuery(this.notificationRelatedObjectId, this.scheduledAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
        ...
        public Builder scheduledAt(ModelStringKeyConditionInput modelStringKeyConditionInput) {
            this.scheduledAt = modelStringKeyConditionInput;
            return this;
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listNotificationsForObject", "listNotificationsForObject", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put("notificationRelatedObjectId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "notificationRelatedObjectId").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("scheduledAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "scheduledAt").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListNotificationsForObject listNotificationsForObject;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListNotificationsForObject.Mapper listNotificationsForObjectFieldMapper = new ListNotificationsForObject.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListNotificationsForObject) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListNotificationsForObject>() { // from class: com.amazonaws.amplify.generated.graphql.ListNotificationsForObjectQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListNotificationsForObject read(ResponseReader responseReader2) {
                        return Mapper.this.listNotificationsForObjectFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListNotificationsForObject listNotificationsForObject) {
            this.listNotificationsForObject = listNotificationsForObject;
        }
        ...
        public boolean equals(Object obj) {
            ...
            ListNotificationsForObject listNotificationsForObject = this.listNotificationsForObject;
            ListNotificationsForObject listNotificationsForObject2 = ((Data) obj).listNotificationsForObject;
            return listNotificationsForObject == null ? listNotificationsForObject2 == null : listNotificationsForObject.equals(listNotificationsForObject2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListNotificationsForObject listNotificationsForObject = this.listNotificationsForObject;
                this.$hashCode = (listNotificationsForObject == null ? 0 : listNotificationsForObject.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListNotificationsForObject listNotificationsForObject() {
            return this.listNotificationsForObject;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListNotificationsForObjectQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListNotificationsForObject listNotificationsForObject = Data.this.listNotificationsForObject;
                    responseWriter.writeObject(responseField, listNotificationsForObject != null ? listNotificationsForObject.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listNotificationsForObject=" + this.listNotificationsForObject + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListNotificationsForObjectQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static class ListNotificationsForObject {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListNotificationsForObject> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListNotificationsForObject map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListNotificationsForObject.$responseFields;
                return new ListNotificationsForObject(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListNotificationsForObjectQuery.ListNotificationsForObject.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListNotificationsForObjectQuery.ListNotificationsForObject.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListNotificationsForObject(String str, List<Item> list, String str2) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListNotificationsForObject)) {
                return false;
            }
            ListNotificationsForObject listNotificationsForObject = (ListNotificationsForObject) obj;
            if (this.__typename.equals(listNotificationsForObject.__typename) && this.items.equals(listNotificationsForObject.items)) {
                String str = this.nextToken;
                String str2 = listNotificationsForObject.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListNotificationsForObjectQuery.ListNotificationsForObject.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListNotificationsForObject.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListNotificationsForObject.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListNotificationsForObject.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListNotificationsForObjectQuery.ListNotificationsForObject.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListNotificationsForObject.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListNotificationsForObject{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final ModelStringKeyConditionInput scheduledAt;
        private final ModelSortDirection sortDirection;
        private final transient Map<String, Object> valueMap;

        public Variables(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelNotificationStagingFilterInput modelNotificationStagingFilterInput, Integer num, String str2) {
            ...
            this.limit = num;
            this.nextToken = str2;
            linkedHashMap.put("notificationRelatedObjectId", str);
            linkedHashMap.put("scheduledAt", modelStringKeyConditionInput);
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListNotificationsForObjectQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("notificationRelatedObjectId", Variables.this.notificationRelatedObjectId);
                    inputFieldWriter.writeObject("scheduledAt", Variables.this.scheduledAt != null ? Variables.this.scheduledAt.marshaller() : null);
        ...
        public ModelStringKeyConditionInput scheduledAt() {
            return this.scheduledAt;
        }
    ...
    public ListNotificationsForObjectQuery(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelNotificationStagingFilterInput modelNotificationStagingFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelStringKeyConditionInput, modelSortDirection, modelNotificationStagingFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "c43b09ceb7bba7fcc70dd4d253d403b32e9fbdfd1a1fcf18907ab8832d068307";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListNotificationsForObject($notificationRelatedObjectId: ID, $scheduledAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelNotificationStagingFilterInput, $limit: Int, $nextToken: String) {\n  listNotificationsForObject(notificationRelatedObjectId: $notificationRelatedObjectId, scheduledAt: $scheduledAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      notificationId\n      notificationChannel\n      notificationStatus\n      notificationType\n      notificationRelatedObjectType\n      notificationRelatedObjectId\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      content\n      createdAt\n      updatedAt\n      scheduledAt\n      expirationUnixTime\n    }\n    nextToken\n  }\n}";
    }
