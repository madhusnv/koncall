...
public final class SearchSavedTableViewssQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query SearchSavedTableViewss($filter: SearchableSavedTableViewsFilterInput, $sort: SearchableSavedTableViewsSortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchSavedTableViewss(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      accountId\n      ownerId\n      tableName\n      viewName\n      isSystemCreated\n      includeAll\n      filterModel\n      sortModel\n      columnState\n      hiddenColumnms\n      scopeLevel\n      scopeId\n      forUserIds\n      forTeamIds\n      forAuthorizations\n      isMetrics\n      isOnlyMetrics\n      dbFilterModel\n      showMetricsOnDashboard\n      showMetricsInApp\n      addedToAppHomeOn\n      createdAt\n      updatedAt\n    }\n    nextToken\n    total\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.SearchSavedTableViewssQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "SearchSavedTableViewss";
        }
    };
    public static final String QUERY_DOCUMENT = "query SearchSavedTableViewss($filter: SearchableSavedTableViewsFilterInput, $sort: SearchableSavedTableViewsSortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchSavedTableViewss(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      accountId\n      ownerId\n      tableName\n      viewName\n      isSystemCreated\n      includeAll\n      filterModel\n      sortModel\n      columnState\n      hiddenColumnms\n      scopeLevel\n      scopeId\n      forUserIds\n      forTeamIds\n      forAuthorizations\n      isMetrics\n      isOnlyMetrics\n      dbFilterModel\n      showMetricsOnDashboard\n      showMetricsInApp\n      addedToAppHomeOn\n      createdAt\n      updatedAt\n    }\n    nextToken\n    total\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private SearchableSavedTableViewsFilterInput filter;
        private Integer from;
        private Integer limit;
        private String nextToken;
        private SearchableSavedTableViewsSortInput sort;

        public SearchSavedTableViewssQuery build() {
            return new SearchSavedTableViewssQuery(this.filter, this.sort, this.limit, this.nextToken, this.from);
        }

        public Builder filter(SearchableSavedTableViewsFilterInput searchableSavedTableViewsFilterInput) {
            this.filter = searchableSavedTableViewsFilterInput;
            return this;
        }
        ...
        public Builder sort(SearchableSavedTableViewsSortInput searchableSavedTableViewsSortInput) {
            this.sort = searchableSavedTableViewsSortInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("searchSavedTableViewss", "searchSavedTableViewss", new UnmodifiableMapBuilder(5).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put(Constants.MessagePayloadKeys.FROM, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, Constants.MessagePayloadKeys.FROM).build()).put("sort", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sort").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final SearchSavedTableViewss searchSavedTableViewss;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final SearchSavedTableViewss.Mapper searchSavedTableViewssFieldMapper = new SearchSavedTableViewss.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((SearchSavedTableViewss) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<SearchSavedTableViewss>() { // from class: com.amazonaws.amplify.generated.graphql.SearchSavedTableViewssQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public SearchSavedTableViewss read(ResponseReader responseReader2) {
                        return Mapper.this.searchSavedTableViewssFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(SearchSavedTableViewss searchSavedTableViewss) {
            this.searchSavedTableViewss = searchSavedTableViewss;
        }
        ...
        public boolean equals(Object obj) {
            ...
            SearchSavedTableViewss searchSavedTableViewss = this.searchSavedTableViewss;
            SearchSavedTableViewss searchSavedTableViewss2 = ((Data) obj).searchSavedTableViewss;
            return searchSavedTableViewss == null ? searchSavedTableViewss2 == null : searchSavedTableViewss.equals(searchSavedTableViewss2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                SearchSavedTableViewss searchSavedTableViewss = this.searchSavedTableViewss;
                this.$hashCode = (searchSavedTableViewss == null ? 0 : searchSavedTableViewss.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchSavedTableViewssQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    SearchSavedTableViewss searchSavedTableViewss = Data.this.searchSavedTableViewss;
                    responseWriter.writeObject(responseField, searchSavedTableViewss != null ? searchSavedTableViewss.marshaller() : null);
                }
            };
        }

        public SearchSavedTableViewss searchSavedTableViewss() {
            return this.searchSavedTableViewss;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{searchSavedTableViewss=" + this.searchSavedTableViewss + "}";
            }
    ...
    public static class Item {
        ...
        public static final class Mapper implements ResponseFieldMapper<Item> {
            ...
            public Item map(ResponseReader responseReader) {
                ...
                return new Item(string, str, str2, string2, string3, bool, bool2, str3, str4, str5, str6, string4 != null ? ScopeLevel.valueOf(string4) : null, (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[12]), responseReader.readList(responseFieldArr[13], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.SearchSavedTableViewssQuery.Item.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                }), responseReader.readList(responseFieldArr[14], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.SearchSavedTableViewssQuery.Item.Mapper.2
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                }), responseReader.readList(responseFieldArr[15], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.SearchSavedTableViewssQuery.Item.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchSavedTableViewssQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[13], Item.this.forUserIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.SearchSavedTableViewssQuery.Item.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[14], Item.this.forTeamIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.SearchSavedTableViewssQuery.Item.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[15], Item.this.forAuthorizations, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.SearchSavedTableViewssQuery.Item.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class SearchSavedTableViewss {
        ...
        public static final class Mapper implements ResponseFieldMapper<SearchSavedTableViewss> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public SearchSavedTableViewss map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = SearchSavedTableViewss.$responseFields;
                return new SearchSavedTableViewss(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.SearchSavedTableViewssQuery.SearchSavedTableViewss.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.SearchSavedTableViewssQuery.SearchSavedTableViewss.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public SearchSavedTableViewss(String str, List<Item> list, String str2, Integer num) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof SearchSavedTableViewss)) {
                return false;
            }
            SearchSavedTableViewss searchSavedTableViewss = (SearchSavedTableViewss) obj;
            if (this.__typename.equals(searchSavedTableViewss.__typename) && this.items.equals(searchSavedTableViewss.items) && ((str = this.nextToken) != null ? str.equals(searchSavedTableViewss.nextToken) : searchSavedTableViewss.nextToken == null)) {
                Integer num = this.total;
                Integer num2 = searchSavedTableViewss.total;
                if (num == null) {
                    if (num2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchSavedTableViewssQuery.SearchSavedTableViewss.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = SearchSavedTableViewss.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], SearchSavedTableViewss.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], SearchSavedTableViewss.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.SearchSavedTableViewssQuery.SearchSavedTableViewss.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], SearchSavedTableViewss.this.nextToken);
                    responseWriter.writeInt(responseFieldArr[3], SearchSavedTableViewss.this.total);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "SearchSavedTableViewss{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + ", total=" + this.total + "}";
            }
            return this.$toString;
        }
    ...
    public static final class Variables extends Operation.Variables {
        private final SearchableSavedTableViewsFilterInput filter;
        private final Integer from;
        private final Integer limit;
        private final String nextToken;
        private final SearchableSavedTableViewsSortInput sort;
        private final transient Map<String, Object> valueMap;

        public Variables(SearchableSavedTableViewsFilterInput searchableSavedTableViewsFilterInput, SearchableSavedTableViewsSortInput searchableSavedTableViewsSortInput, Integer num, String str, Integer num2) {
            ...
            this.nextToken = str;
            this.from = num2;
            linkedHashMap.put("filter", searchableSavedTableViewsFilterInput);
            linkedHashMap.put("sort", searchableSavedTableViewsSortInput);
        ...
        public SearchableSavedTableViewsFilterInput filter() {
            return this.filter;
        }
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchSavedTableViewssQuery.Variables.1
        ...
        public SearchableSavedTableViewsSortInput sort() {
            return this.sort;
        }
    ...
    public SearchSavedTableViewssQuery(SearchableSavedTableViewsFilterInput searchableSavedTableViewsFilterInput, SearchableSavedTableViewsSortInput searchableSavedTableViewsSortInput, Integer num, String str, Integer num2) {
        this.variables = new Variables(searchableSavedTableViewsFilterInput, searchableSavedTableViewsSortInput, num, str, num2);
    }
    ...
    public String operationId() {
        return "821185d457e234d625e22e2950fa407d0bfa267ce3fe11b29ebe485830ab33e9";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query SearchSavedTableViewss($filter: SearchableSavedTableViewsFilterInput, $sort: SearchableSavedTableViewsSortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchSavedTableViewss(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      accountId\n      ownerId\n      tableName\n      viewName\n      isSystemCreated\n      includeAll\n      filterModel\n      sortModel\n      columnState\n      hiddenColumnms\n      scopeLevel\n      scopeId\n      forUserIds\n      forTeamIds\n      forAuthorizations\n      isMetrics\n      isOnlyMetrics\n      dbFilterModel\n      showMetricsOnDashboard\n      showMetricsInApp\n      addedToAppHomeOn\n      createdAt\n      updatedAt\n    }\n    nextToken\n    total\n  }\n}";
    }
