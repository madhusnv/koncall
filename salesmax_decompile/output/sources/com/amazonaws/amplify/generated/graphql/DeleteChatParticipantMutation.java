...
import type.DeleteChatParticipantInput;
import type.ModelChatParticipantConditionInput;
import type.UserRegistrationStatus;

/* loaded from: classes6.dex */
public final class DeleteChatParticipantMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation DeleteChatParticipant($input: DeleteChatParticipantInput!, $condition: ModelChatParticipantConditionInput) {\n  deleteChatParticipant(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    channelId\n    phoneNumberIdExternal\n    participantId\n    participationStatus\n    unreadMessageCount\n    lastViewed\n    isStarred\n    joinedAt\n    leftAt\n    channelName\n    channelType\n    channelSubType\n    channelStatus\n    channelWillBeChargedNext\n    channelOpenUntil\n    lastMessageByLeadTime\n    lastMessageByUserTime\n    isLastMessageByLead\n    lastOutboundMessageId\n    lastOutboundMessageStatus\n    isNewMessageUpdate\n    tags\n    participantScopeIfInternal\n    userIdsForDirectChannel\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    participant {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.DeleteChatParticipantMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "DeleteChatParticipant";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation DeleteChatParticipant($input: DeleteChatParticipantInput!, $condition: ModelChatParticipantConditionInput) {\n  deleteChatParticipant(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    channelId\n    phoneNumberIdExternal\n    participantId\n    participationStatus\n    unreadMessageCount\n    lastViewed\n    isStarred\n    joinedAt\n    leftAt\n    channelName\n    channelType\n    channelSubType\n    channelStatus\n    channelWillBeChargedNext\n    channelOpenUntil\n    lastMessageByLeadTime\n    lastMessageByUserTime\n    isLastMessageByLead\n    lastOutboundMessageId\n    lastOutboundMessageStatus\n    isNewMessageUpdate\n    tags\n    participantScopeIfInternal\n    userIdsForDirectChannel\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    participant {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelChatParticipantConditionInput condition;
        private DeleteChatParticipantInput input;

        public DeleteChatParticipantMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteChatParticipantMutation(this.input, this.condition);
        }

        public Builder condition(ModelChatParticipantConditionInput modelChatParticipantConditionInput) {
            this.condition = modelChatParticipantConditionInput;
            return this;
        }

        public Builder input(DeleteChatParticipantInput deleteChatParticipantInput) {
            this.input = deleteChatParticipantInput;
            return this;
        }
    }
    ...
    public static class Channel {
        ...
        public static final class Mapper implements ResponseFieldMapper<Channel> {
            ...
            public Channel map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[6], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteChatParticipantMutation.Channel.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteChatParticipantMutation.Channel.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[6], Channel.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteChatParticipantMutation.Channel.1.1
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteChatParticipant", "deleteChatParticipant", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final DeleteChatParticipant deleteChatParticipant;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteChatParticipant.Mapper deleteChatParticipantFieldMapper = new DeleteChatParticipant.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteChatParticipant) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteChatParticipant>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteChatParticipantMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteChatParticipant read(ResponseReader responseReader2) {
                        return Mapper.this.deleteChatParticipantFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteChatParticipant deleteChatParticipant) {
            this.deleteChatParticipant = deleteChatParticipant;
        }

        public DeleteChatParticipant deleteChatParticipant() {
            return this.deleteChatParticipant;
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteChatParticipant deleteChatParticipant = this.deleteChatParticipant;
            DeleteChatParticipant deleteChatParticipant2 = ((Data) obj).deleteChatParticipant;
            return deleteChatParticipant == null ? deleteChatParticipant2 == null : deleteChatParticipant.equals(deleteChatParticipant2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteChatParticipant deleteChatParticipant = this.deleteChatParticipant;
                this.$hashCode = (deleteChatParticipant == null ? 0 : deleteChatParticipant.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteChatParticipantMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteChatParticipant deleteChatParticipant = Data.this.deleteChatParticipant;
                    responseWriter.writeObject(responseField, deleteChatParticipant != null ? deleteChatParticipant.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteChatParticipant=" + this.deleteChatParticipant + "}";
            }
            return this.$toString;
        }
    }

    public static class DeleteChatParticipant {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteChatParticipant)) {
                return false;
            }
            DeleteChatParticipant deleteChatParticipant = (DeleteChatParticipant) obj;
            if (this.__typename.equals(deleteChatParticipant.__typename) && this.id.equals(deleteChatParticipant.id) && this.accountId.equals(deleteChatParticipant.accountId) && this.channelId.equals(deleteChatParticipant.channelId) && ((str = this.phoneNumberIdExternal) != null ? str.equals(deleteChatParticipant.phoneNumberIdExternal) : deleteChatParticipant.phoneNumberIdExternal == null) && this.participantId.equals(deleteChatParticipant.participantId) && this.participationStatus.equals(deleteChatParticipant.participationStatus) && ((num = this.unreadMessageCount) != null ? num.equals(deleteChatParticipant.unreadMessageCount) : deleteChatParticipant.unreadMessageCount == null) && ((str2 = this.lastViewed) != null ? str2.equals(deleteChatParticipant.lastViewed) : deleteChatParticipant.lastViewed == null) && ((bool = this.isStarred) != null ? bool.equals(deleteChatParticipant.isStarred) : deleteChatParticipant.isStarred == null) && ((str3 = this.joinedAt) != null ? str3.equals(deleteChatParticipant.joinedAt) : deleteChatParticipant.joinedAt == null) && ((str4 = this.leftAt) != null ? str4.equals(deleteChatParticipant.leftAt) : deleteChatParticipant.leftAt == null) && ((str5 = this.channelName) != null ? str5.equals(deleteChatParticipant.channelName) : deleteChatParticipant.channelName == null) && ((str6 = this.channelType) != null ? str6.equals(deleteChatParticipant.channelType) : deleteChatParticipant.channelType == null) && ((str7 = this.channelSubType) != null ? str7.equals(deleteChatParticipant.channelSubType) : deleteChatParticipant.channelSubType == null) && ((str8 = this.channelStatus) != null ? str8.equals(deleteChatParticipant.channelStatus) : deleteChatParticipant.channelStatus == null) && ((str9 = this.channelWillBeChargedNext) != null ? str9.equals(deleteChatParticipant.channelWillBeChargedNext) : deleteChatParticipant.channelWillBeChargedNext == null) && ((str10 = this.channelOpenUntil) != null ? str10.equals(deleteChatParticipant.channelOpenUntil) : deleteChatParticipant.channelOpenUntil == null) && ((str11 = this.lastMessageByLeadTime) != null ? str11.equals(deleteChatParticipant.lastMessageByLeadTime) : deleteChatParticipant.lastMessageByLeadTime == null) && ((str12 = this.lastMessageByUserTime) != null ? str12.equals(deleteChatParticipant.lastMessageByUserTime) : deleteChatParticipant.lastMessageByUserTime == null) && ((bool2 = this.isLastMessageByLead) != null ? bool2.equals(deleteChatParticipant.isLastMessageByLead) : deleteChatParticipant.isLastMessageByLead == null) && ((str13 = this.lastOutboundMessageId) != null ? str13.equals(deleteChatParticipant.lastOutboundMessageId) : deleteChatParticipant.lastOutboundMessageId == null) && ((str14 = this.lastOutboundMessageStatus) != null ? str14.equals(deleteChatParticipant.lastOutboundMessageStatus) : deleteChatParticipant.lastOutboundMessageStatus == null) && ((bool3 = this.isNewMessageUpdate) != null ? bool3.equals(deleteChatParticipant.isNewMessageUpdate) : deleteChatParticipant.isNewMessageUpdate == null) && ((list = this.tags) != null ? list.equals(deleteChatParticipant.tags) : deleteChatParticipant.tags == null) && ((str15 = this.participantScopeIfInternal) != null ? str15.equals(deleteChatParticipant.participantScopeIfInternal) : deleteChatParticipant.participantScopeIfInternal == null) && ((str16 = this.userIdsForDirectChannel) != null ? str16.equals(deleteChatParticipant.userIdsForDirectChannel) : deleteChatParticipant.userIdsForDirectChannel == null) && ((str17 = this.createdAt) != null ? str17.equals(deleteChatParticipant.createdAt) : deleteChatParticipant.createdAt == null) && ((str18 = this.updatedAt) != null ? str18.equals(deleteChatParticipant.updatedAt) : deleteChatParticipant.updatedAt == null) && ((channel = this.channel) != null ? channel.equals(deleteChatParticipant.channel) : deleteChatParticipant.channel == null)) {
                Participant participant = this.participant;
                Participant participant2 = deleteChatParticipant.participant;
                if (participant == null) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteChatParticipantMutation.DeleteChatParticipant.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteChatParticipant.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteChatParticipant.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteChatParticipant.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteChatParticipant.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], DeleteChatParticipant.this.channelId);
                    responseWriter.writeString(responseFieldArr[4], DeleteChatParticipant.this.phoneNumberIdExternal);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], DeleteChatParticipant.this.participantId);
                    responseWriter.writeString(responseFieldArr[6], DeleteChatParticipant.this.participationStatus);
                    responseWriter.writeInt(responseFieldArr[7], DeleteChatParticipant.this.unreadMessageCount);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], DeleteChatParticipant.this.lastViewed);
                    responseWriter.writeBoolean(responseFieldArr[9], DeleteChatParticipant.this.isStarred);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[10], DeleteChatParticipant.this.joinedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], DeleteChatParticipant.this.leftAt);
                    responseWriter.writeString(responseFieldArr[12], DeleteChatParticipant.this.channelName);
                    responseWriter.writeString(responseFieldArr[13], DeleteChatParticipant.this.channelType);
                    responseWriter.writeString(responseFieldArr[14], DeleteChatParticipant.this.channelSubType);
                    responseWriter.writeString(responseFieldArr[15], DeleteChatParticipant.this.channelStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], DeleteChatParticipant.this.channelWillBeChargedNext);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], DeleteChatParticipant.this.channelOpenUntil);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], DeleteChatParticipant.this.lastMessageByLeadTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], DeleteChatParticipant.this.lastMessageByUserTime);
                    responseWriter.writeBoolean(responseFieldArr[20], DeleteChatParticipant.this.isLastMessageByLead);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], DeleteChatParticipant.this.lastOutboundMessageId);
                    responseWriter.writeString(responseFieldArr[22], DeleteChatParticipant.this.lastOutboundMessageStatus);
                    responseWriter.writeBoolean(responseFieldArr[23], DeleteChatParticipant.this.isNewMessageUpdate);
                    responseWriter.writeList(responseFieldArr[24], DeleteChatParticipant.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteChatParticipantMutation.DeleteChatParticipant.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[25], DeleteChatParticipant.this.participantScopeIfInternal);
                    responseWriter.writeString(responseFieldArr[26], DeleteChatParticipant.this.userIdsForDirectChannel);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], DeleteChatParticipant.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[28], DeleteChatParticipant.this.updatedAt);
                    ResponseField responseField = responseFieldArr[29];
                    Channel channel = DeleteChatParticipant.this.channel;
                    ...
                    Participant participant = DeleteChatParticipant.this.participant;
    ...
    public static class Participant {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteChatParticipantMutation.Participant.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Participant.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        private final ModelChatParticipantConditionInput condition;
        private final DeleteChatParticipantInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteChatParticipantInput deleteChatParticipantInput, ModelChatParticipantConditionInput modelChatParticipantConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteChatParticipantInput;
            this.condition = modelChatParticipantConditionInput;
            linkedHashMap.put("input", deleteChatParticipantInput);
            linkedHashMap.put("condition", modelChatParticipantConditionInput);
        }

        public ModelChatParticipantConditionInput condition() {
            return this.condition;
        }

        public DeleteChatParticipantInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteChatParticipantMutation.Variables.1
    ...
    public DeleteChatParticipantMutation(DeleteChatParticipantInput deleteChatParticipantInput, ModelChatParticipantConditionInput modelChatParticipantConditionInput) {
        Utils.checkNotNull(deleteChatParticipantInput, "input == null");
        this.variables = new Variables(deleteChatParticipantInput, modelChatParticipantConditionInput);
    }
    ...
    public String operationId() {
        return "9bebeb43afecb84469b77d57be8599ab6a417d4e14c42acac40200f83d17ed9e";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteChatParticipant($input: DeleteChatParticipantInput!, $condition: ModelChatParticipantConditionInput) {\n  deleteChatParticipant(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    channelId\n    phoneNumberIdExternal\n    participantId\n    participationStatus\n    unreadMessageCount\n    lastViewed\n    isStarred\n    joinedAt\n    leftAt\n    channelName\n    channelType\n    channelSubType\n    channelStatus\n    channelWillBeChargedNext\n    channelOpenUntil\n    lastMessageByLeadTime\n    lastMessageByUserTime\n    isLastMessageByLead\n    lastOutboundMessageId\n    lastOutboundMessageStatus\n    isNewMessageUpdate\n    tags\n    participantScopeIfInternal\n    userIdsForDirectChannel\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    participant {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
