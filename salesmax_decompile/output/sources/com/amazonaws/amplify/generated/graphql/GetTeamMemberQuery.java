...
public final class GetTeamMemberQuery implements Query<Data, Data, Variables> {
    ...
    public static class Account {
        ...
        public static final class Mapper implements ResponseFieldMapper<Account> {
            ...
            public Account map(ResponseReader responseReader) {
                ...
                }), responseReader.readList(responseFieldArr[46], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.Account.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.Account.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[15], Account.this.productOrService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.Account.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[39], Account.this.permissions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.Account.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[45], Account.this.salesmaxSalesContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.Account.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[46], Account.this.salesmaxSupportContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.Account.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[51], Account.this.relatedAccountIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.Account.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static final class Builder {
        ...
        public GetTeamMemberQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetTeamMemberQuery(this.id);
        }
    ...
    public static class CreatedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.CreatedBy.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreatedBy.$responseFields;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getTeamMember", "getTeamMember", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetTeamMember getTeamMember;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetTeamMember.Mapper getTeamMemberFieldMapper = new GetTeamMember.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetTeamMember) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetTeamMember>() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetTeamMember read(ResponseReader responseReader2) {
                        return Mapper.this.getTeamMemberFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetTeamMember getTeamMember) {
            this.getTeamMember = getTeamMember;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetTeamMember getTeamMember = this.getTeamMember;
            GetTeamMember getTeamMember2 = ((Data) obj).getTeamMember;
            return getTeamMember == null ? getTeamMember2 == null : getTeamMember.equals(getTeamMember2);
        }

        public GetTeamMember getTeamMember() {
        ...
        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetTeamMember getTeamMember = this.getTeamMember;
                this.$hashCode = (getTeamMember == null ? 0 : getTeamMember.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetTeamMember getTeamMember = Data.this.getTeamMember;
                    responseWriter.writeObject(responseField, getTeamMember != null ? getTeamMember.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getTeamMember=" + this.getTeamMember + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class GetTeamMember {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetTeamMember> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetTeamMember map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetTeamMember.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
                Team team = (Team) responseReader.readObject(responseFieldArr[3], new ResponseReader.ObjectReader<Team>() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.GetTeamMember.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                MemberTeam memberTeam = (MemberTeam) responseReader.readObject(responseFieldArr[10], new ResponseReader.ObjectReader<MemberTeam>() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.GetTeamMember.Mapper.2
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                return new GetTeamMember(string, str, str2, team, str3, teamRoleValueOf, str4, str5, str6, str7, memberTeam, string3 != null ? TeamMemberType.valueOf(string3) : null, responseReader.readBoolean(responseFieldArr[12]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[13]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[14]), (Account) responseReader.readObject(responseFieldArr[15], new ResponseReader.ObjectReader<Account>() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.GetTeamMember.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public Account read(ResponseReader responseReader2) {
                        return Mapper.this.accountFieldMapper.map(responseReader2);
                    }
                }), (UpdatedBy) responseReader.readObject(responseFieldArr[16], new ResponseReader.ObjectReader<UpdatedBy>() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.GetTeamMember.Mapper.4
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdatedBy read(ResponseReader responseReader2) {
                        return Mapper.this.updatedByFieldMapper.map(responseReader2);
                    }
                }), (CreatedBy) responseReader.readObject(responseFieldArr[17], new ResponseReader.ObjectReader<CreatedBy>() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.GetTeamMember.Mapper.5
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreatedBy read(ResponseReader responseReader2) {
                        return Mapper.this.createdByFieldMapper.map(responseReader2);
                    }
                }), (User) responseReader.readObject(responseFieldArr[18], new ResponseReader.ObjectReader<User>() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.GetTeamMember.Mapper.6
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetTeamMember(String str, String str2, String str3, Team team, String str4, TeamRole teamRole, String str5, String str6, String str7, String str8, MemberTeam memberTeam, TeamMemberType teamMemberType, Boolean bool, String str9, String str10, Account account, UpdatedBy updatedBy, CreatedBy createdBy, User user) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (this.__typename.equals(getTeamMember.__typename) && this.id.equals(getTeamMember.id) && this.teamId.equals(getTeamMember.teamId) && ((team = this.team) != null ? team.equals(getTeamMember.team) : getTeamMember.team == null) && this.accountId.equals(getTeamMember.accountId) && this.teamRole.equals(getTeamMember.teamRole) && this.updatedById.equals(getTeamMember.updatedById) && this.createdById.equals(getTeamMember.createdById) && this.userId.equals(getTeamMember.userId) && ((str = this.memberTeamId) != null ? str.equals(getTeamMember.memberTeamId) : getTeamMember.memberTeamId == null) && ((memberTeam = this.memberTeam) != null ? memberTeam.equals(getTeamMember.memberTeam) : getTeamMember.memberTeam == null) && this.memberType.equals(getTeamMember.memberType) && ((bool = this.isDefaultTeam) != null ? bool.equals(getTeamMember.isDefaultTeam) : getTeamMember.isDefaultTeam == null) && ((str2 = this.createdAt) != null ? str2.equals(getTeamMember.createdAt) : getTeamMember.createdAt == null) && ((str3 = this.updatedAt) != null ? str3.equals(getTeamMember.updatedAt) : getTeamMember.updatedAt == null) && ((account = this.account) != null ? account.equals(getTeamMember.account) : getTeamMember.account == null) && ((updatedBy = this.updatedBy) != null ? updatedBy.equals(getTeamMember.updatedBy) : getTeamMember.updatedBy == null) && ((createdBy = this.createdBy) != null ? createdBy.equals(getTeamMember.createdBy) : getTeamMember.createdBy == null)) {
                User user = this.user;
                User user2 = getTeamMember.user;
                if (user == null) {
                    if (user2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.GetTeamMember.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetTeamMember.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetTeamMember.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetTeamMember.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetTeamMember.this.teamId);
                    ResponseField responseField = responseFieldArr[3];
                    Team team = GetTeamMember.this.team;
                    responseWriter.writeObject(responseField, team != null ? team.marshaller() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], GetTeamMember.this.accountId);
                    responseWriter.writeString(responseFieldArr[5], GetTeamMember.this.teamRole.name());
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], GetTeamMember.this.updatedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], GetTeamMember.this.createdById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], GetTeamMember.this.userId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], GetTeamMember.this.memberTeamId);
                    ResponseField responseField2 = responseFieldArr[10];
                    MemberTeam memberTeam = GetTeamMember.this.memberTeam;
                    responseWriter.writeObject(responseField2, memberTeam != null ? memberTeam.marshaller() : null);
                    responseWriter.writeString(responseFieldArr[11], GetTeamMember.this.memberType.name());
                    responseWriter.writeBoolean(responseFieldArr[12], GetTeamMember.this.isDefaultTeam);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], GetTeamMember.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], GetTeamMember.this.updatedAt);
                    ResponseField responseField3 = responseFieldArr[15];
                    Account account = GetTeamMember.this.account;
                    ...
                    UpdatedBy updatedBy = GetTeamMember.this.updatedBy;
                    ...
                    CreatedBy createdBy = GetTeamMember.this.createdBy;
                    ...
                    User user = GetTeamMember.this.user;
    ...
    public static class MemberTeam {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.MemberTeam.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = MemberTeam.$responseFields;
    ...
    public static class Team {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.Team.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Team.$responseFields;
    ...
    public static class UpdatedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.UpdatedBy.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdatedBy.$responseFields;
    ...
    public static class User {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.User.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = User.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTeamMemberQuery.Variables.1
    ...
    public GetTeamMemberQuery(String str) {
    ...
    public String operationId() {
        return "71ffcf2eded9943c958d27bfd1dcb137ad3659aad1f463095771df9ce586adf7";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetTeamMember($id: ID!) {\n  getTeamMember(id: $id) {\n    __typename\n    id\n    teamId\n    team {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    accountId\n    teamRole\n    updatedById\n    createdById\n    userId\n    memberTeamId\n    memberTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    memberType\n    isDefaultTeam\n    createdAt\n    updatedAt\n    account {\n      __typename\n      id\n      accountName\n      accountType\n      deviceKey\n      deviceKeyLastUpdated\n      accountStatus\n      businessLogoUrl\n      createdById\n      dateFormat\n      dateTimeViewStyle\n      defaultCurrency\n      denomination\n      industry\n      nameOfBusiness\n      productOrService\n      timeFormat\n      timeZone\n      plan\n      paidUpTo\n      seats\n      freeSeats\n      currentTotalUsers\n      currentActiveUsers\n      extraActiveUsers\n      pricePerSeat\n      allowAddingSeat\n      allowAddingSeatTill\n      seatReductionMarkedForNextCycle\n      billingCurrency\n      billingEmail\n      taxId\n      taxIdType\n      trialAccountEndDate\n      trialExtensionTimes\n      eligibleForExtension\n      paidForTillDate\n      updatedById\n      website\n      permissions\n      enableCustomCharts\n      createdAt\n      updatedAt\n      dealMode\n      openAiApiKey\n      salesmaxSalesContacts\n      salesmaxSupportContacts\n      chatWidgetConfig\n      onboardingStatus\n      integrationNeeded\n      matchingDealId\n      relatedAccountIds\n      lastChurnDate\n      lastChurnReason\n      possibleReactivationDate\n      locationPeriodicFrequency\n      lastPaymentDataId\n      lastPaymentDataCreatedAt\n      nextRenewalDateIfPaid\n      lastPaymentStatus\n      partPaymentAmountIfAny\n    }\n    updatedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    createdBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
