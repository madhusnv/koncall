...
public final class UpdatePaymentDataMutation implements Mutation<Data, Data, Variables> {
    ...
    public static final class Builder {
        ...
        public Builder input(UpdatePaymentDataInput updatePaymentDataInput) {
            this.input = updatePaymentDataInput;
            return this;
        }
    }
    ...
    public static class Contact {
        ...
        public static final class Mapper implements ResponseFieldMapper<Contact> {
            ...
            public Contact map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[5], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Contact.Mapper.1
                ...
                List list2 = responseReader.readList(responseFieldArr[7], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Contact.Mapper.2
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                ...
                List list3 = responseReader.readList(responseFieldArr[34], new ResponseReader.ListReader<Day>() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Contact.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                ...
                List list4 = responseReader.readList(responseFieldArr[92], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Contact.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                });
                List list5 = responseReader.readList(responseFieldArr[93], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Contact.Mapper.5
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                ...
                List list6 = responseReader.readList(responseFieldArr[97], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Contact.Mapper.6
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Contact.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], Contact.this.sharedOwners, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Contact.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[7], Contact.this.sharedTeams, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Contact.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[34], Contact.this.preferredContactDays, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Contact.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[92], Contact.this.userDefinedTags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Contact.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[93], Contact.this.productService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Contact.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[97], Contact.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Contact.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("updatePaymentData", "updatePaymentData", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final UpdatePaymentData updatePaymentData;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final UpdatePaymentData.Mapper updatePaymentDataFieldMapper = new UpdatePaymentData.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((UpdatePaymentData) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<UpdatePaymentData>() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdatePaymentData read(ResponseReader responseReader2) {
                        return Mapper.this.updatePaymentDataFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(UpdatePaymentData updatePaymentData) {
        ...
        public boolean equals(Object obj) {
            ...
            UpdatePaymentData updatePaymentData = this.updatePaymentData;
            UpdatePaymentData updatePaymentData2 = ((Data) obj).updatePaymentData;
            return updatePaymentData == null ? updatePaymentData2 == null : updatePaymentData.equals(updatePaymentData2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                UpdatePaymentData updatePaymentData = this.updatePaymentData;
                this.$hashCode = (updatePaymentData == null ? 0 : updatePaymentData.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    UpdatePaymentData updatePaymentData = Data.this.updatePaymentData;
                    responseWriter.writeObject(responseField, updatePaymentData != null ? updatePaymentData.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{updatePaymentData=" + this.updatePaymentData + "}";
            }
            return this.$toString;
        }

        public UpdatePaymentData updatePaymentData() {
    ...
    public static class Order {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Order.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Order.$responseFields;
    ...
    public static class PaymentEvents {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.PaymentEvents.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = PaymentEvents.$responseFields;
    ...
    public static class PaymentLink {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.PaymentLink.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = PaymentLink.$responseFields;
    ...
    public static class UpdatePaymentData {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<UpdatePaymentData> {
        ...
        public UpdatePaymentData(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, Integer num, Integer num2, String str12, String str13, String str14, String str15, List<String> list, List<String> list2, String str16, String str17, String str18, String str19, String str20, String str21, PaymentLink paymentLink, Order order, PaymentEvents paymentEvents, Contact contact) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
            this.contactId = str4;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdatePaymentData)) {
                return false;
            }
            UpdatePaymentData updatePaymentData = (UpdatePaymentData) obj;
            if (this.__typename.equals(updatePaymentData.__typename) && this.id.equals(updatePaymentData.id) && this.accountId.equals(updatePaymentData.accountId) && ((str = this.contactId) != null ? str.equals(updatePaymentData.contactId) : updatePaymentData.contactId == null) && ((str2 = this.paymentRequestType) != null ? str2.equals(updatePaymentData.paymentRequestType) : updatePaymentData.paymentRequestType == null) && ((str3 = this.engagementId) != null ? str3.equals(updatePaymentData.engagementId) : updatePaymentData.engagementId == null) && ((str4 = this.paymentProvider) != null ? str4.equals(updatePaymentData.paymentProvider) : updatePaymentData.paymentProvider == null) && ((str5 = this.orderIdInPaymentProvider) != null ? str5.equals(updatePaymentData.orderIdInPaymentProvider) : updatePaymentData.orderIdInPaymentProvider == null) && ((str6 = this.orderId) != null ? str6.equals(updatePaymentData.orderId) : updatePaymentData.orderId == null) && ((str7 = this.paymentLinkId) != null ? str7.equals(updatePaymentData.paymentLinkId) : updatePaymentData.paymentLinkId == null) && ((str8 = this.paymentLinkUrl) != null ? str8.equals(updatePaymentData.paymentLinkUrl) : updatePaymentData.paymentLinkUrl == null) && ((num = this.amount) != null ? num.equals(updatePaymentData.amount) : updatePaymentData.amount == null) && ((num2 = this.amountPaid) != null ? num2.equals(updatePaymentData.amountPaid) : updatePaymentData.amountPaid == null) && ((str9 = this.currency) != null ? str9.equals(updatePaymentData.currency) : updatePaymentData.currency == null) && ((str10 = this.status) != null ? str10.equals(updatePaymentData.status) : updatePaymentData.status == null) && ((str11 = this.lastPaymentStatus) != null ? str11.equals(updatePaymentData.lastPaymentStatus) : updatePaymentData.lastPaymentStatus == null) && ((str12 = this.finalPaymentDate) != null ? str12.equals(updatePaymentData.finalPaymentDate) : updatePaymentData.finalPaymentDate == null) && ((list = this.paidByContactIds) != null ? list.equals(updatePaymentData.paidByContactIds) : updatePaymentData.paidByContactIds == null) && ((list2 = this.transactionId) != null ? list2.equals(updatePaymentData.transactionId) : updatePaymentData.transactionId == null) && ((str13 = this.note) != null ? str13.equals(updatePaymentData.note) : updatePaymentData.note == null) && ((str14 = this.createdAt) != null ? str14.equals(updatePaymentData.createdAt) : updatePaymentData.createdAt == null) && ((str15 = this.updatedAt) != null ? str15.equals(updatePaymentData.updatedAt) : updatePaymentData.updatedAt == null) && ((str16 = this.customPaymentData) != null ? str16.equals(updatePaymentData.customPaymentData) : updatePaymentData.customPaymentData == null) && ((str17 = this.createdById) != null ? str17.equals(updatePaymentData.createdById) : updatePaymentData.createdById == null) && ((str18 = this.updatedById) != null ? str18.equals(updatePaymentData.updatedById) : updatePaymentData.updatedById == null) && ((paymentLink = this.paymentLink) != null ? paymentLink.equals(updatePaymentData.paymentLink) : updatePaymentData.paymentLink == null) && ((order = this.order) != null ? order.equals(updatePaymentData.order) : updatePaymentData.order == null) && ((paymentEvents = this.paymentEvents) != null ? paymentEvents.equals(updatePaymentData.paymentEvents) : updatePaymentData.paymentEvents == null)) {
                Contact contact = this.contact;
                Contact contact2 = updatePaymentData.contact;
                if (contact == null) {
                    if (contact2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.UpdatePaymentData.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdatePaymentData.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UpdatePaymentData.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], UpdatePaymentData.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], UpdatePaymentData.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], UpdatePaymentData.this.contactId);
                    responseWriter.writeString(responseFieldArr[4], UpdatePaymentData.this.paymentRequestType);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], UpdatePaymentData.this.engagementId);
                    responseWriter.writeString(responseFieldArr[6], UpdatePaymentData.this.paymentProvider);
                    responseWriter.writeString(responseFieldArr[7], UpdatePaymentData.this.orderIdInPaymentProvider);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], UpdatePaymentData.this.orderId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], UpdatePaymentData.this.paymentLinkId);
                    responseWriter.writeString(responseFieldArr[10], UpdatePaymentData.this.paymentLinkUrl);
                    responseWriter.writeInt(responseFieldArr[11], UpdatePaymentData.this.amount);
                    responseWriter.writeInt(responseFieldArr[12], UpdatePaymentData.this.amountPaid);
                    responseWriter.writeString(responseFieldArr[13], UpdatePaymentData.this.currency);
                    responseWriter.writeString(responseFieldArr[14], UpdatePaymentData.this.status);
                    responseWriter.writeString(responseFieldArr[15], UpdatePaymentData.this.lastPaymentStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], UpdatePaymentData.this.finalPaymentDate);
                    responseWriter.writeList(responseFieldArr[17], UpdatePaymentData.this.paidByContactIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.UpdatePaymentData.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], UpdatePaymentData.this.transactionId, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.UpdatePaymentData.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[19], UpdatePaymentData.this.note);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], UpdatePaymentData.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], UpdatePaymentData.this.updatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], UpdatePaymentData.this.customPaymentData);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], UpdatePaymentData.this.createdById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[24], UpdatePaymentData.this.updatedById);
                    ResponseField responseField = responseFieldArr[25];
                    PaymentLink paymentLink = UpdatePaymentData.this.paymentLink;
                    ...
                    Order order = UpdatePaymentData.this.order;
                    ...
                    PaymentEvents paymentEvents = UpdatePaymentData.this.paymentEvents;
                    ...
                    Contact contact = UpdatePaymentData.this.contact;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final UpdatePaymentDataInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(UpdatePaymentDataInput updatePaymentDataInput, ModelPaymentDataConditionInput modelPaymentDataConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = updatePaymentDataInput;
            this.condition = modelPaymentDataConditionInput;
            linkedHashMap.put("input", updatePaymentDataInput);
        ...
        public UpdatePaymentDataInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdatePaymentDataMutation.Variables.1
    ...
    public UpdatePaymentDataMutation(UpdatePaymentDataInput updatePaymentDataInput, ModelPaymentDataConditionInput modelPaymentDataConditionInput) {
        Utils.checkNotNull(updatePaymentDataInput, "input == null");
        this.variables = new Variables(updatePaymentDataInput, modelPaymentDataConditionInput);
    }
    ...
    public String operationId() {
        return "b9a8d6b109b5c0b84de80fac5bca6d671dffd528c51cb78a6135a95f12073540";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation UpdatePaymentData($input: UpdatePaymentDataInput!, $condition: ModelPaymentDataConditionInput) {\n  updatePaymentData(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    contactId\n    paymentRequestType\n    engagementId\n    paymentProvider\n    orderIdInPaymentProvider\n    orderId\n    paymentLinkId\n    paymentLinkUrl\n    amount\n    amountPaid\n    currency\n    status\n    lastPaymentStatus\n    finalPaymentDate\n    paidByContactIds\n    transactionId\n    note\n    createdAt\n    updatedAt\n    customPaymentData\n    createdById\n    updatedById\n    paymentLink {\n      __typename\n      id\n      accountId\n      contactId\n      paymentProvider\n      idInPaymentProvider\n      orderId\n      acceptPartial\n      firstMinPartialAmount\n      currency\n      amount\n      amountPaid\n      description\n      note\n      shortUrl\n      upiLink\n      status\n      expireBy\n      expiredAt\n      cancelledAt\n      createdAt\n      updatedAt\n      externalUserReference\n      createdById\n      updatedById\n    }\n    order {\n      __typename\n      id\n      accountId\n      contactId\n      paymentProvider\n      idInPaymentProvider\n      currency\n      amount\n      amountPaid\n      status\n      note\n      receipt\n      createdAt\n      updatedAt\n      createdById\n      updatedById\n    }\n    paymentEvents {\n      __typename\n      nextToken\n    }\n    contact {\n      __typename\n      id\n      accountId\n      ownerId\n      toBeAssigned\n      sharedOwners\n      primaryTeamId\n      sharedTeams\n      accountPriority\n      addedById\n      assignedToId\n      blockedForCallById\n      blockedForCallReason\n      blockedForCallUntil\n      callPriority\n      waChatChannelId\n      contactSource\n      contactSourceDrillDownOne\n      contactSourceDrillDownTwo\n      contactSourceDrillDownThree\n      contactSourceDrillDownOneId\n      contactSourceDrillDownTwoId\n      contactSourceDrillDownThreeId\n      contactStatus\n      contactType\n      department\n      designation\n      lastRepeatEnquiryDate\n      lastRepeatEnquirySource\n      gender\n      isDecisionMaker\n      isPrivate\n      lockPeriod\n      name\n      preferredContactDays\n      profilePhotoUrl\n      referredBy\n      salutation\n      seniority\n      updatedById\n      hasTask\n      openTaskActivityType\n      lastCalledTime\n      lastCallDirection\n      lastCallOutcome\n      lastCallOutcomeNature\n      lastCallUserId\n      lastCallDuration\n      lastCallEngagementId\n      lastVisitTime\n      lastVisitOutcome\n      lastVisitOutcomeNature\n      lastVisitUserId\n      lastVisitEngagementId\n      lastEmailTime\n      lastEmailUserId\n      lastEmailEngagementId\n      lastWhatsappTime\n      lastWhatsappUserId\n      lastWhatsappEngagementId\n      lastWabaBroadcastTime\n      lastWabaBroadcastStatus\n      lastWabaBroadcastTemplate\n      lastWabaBroadcastReplyBody\n      lastWabaBroadcastReplyTime\n      lastWabaBroadcastReplyType\n      lastSmsTime\n      lastSmsUserId\n      lastSmsEngagementId\n      lastNoteAddedTime\n      lastNoteUserId\n      lastNoteEngagementId\n      lastTaskDoneTime\n      lastTaskDoneUserId\n      lastTaskDoneEngagementId\n      openTaskCount\n      lastKnownDisposition\n      lastKnownDispositionTime\n      lastLeadAssignmentDateTime\n      lastEngagementFromAccount\n      lastEngagementFromContact\n      freshLeadTag\n      noWorkAfterAssignment\n      needFollowUpTag\n      needFollowUpTagUpdatedAt\n      activeDealStage\n      activeDealStageUpdatedAt\n      dealDescription\n      isCustomer\n      becameCustomerOn\n      unsuccessfulCallAttempts\n      leadCallsNotAnswered\n      userDefinedTags\n      productService\n      bulkUploadReference\n      assignmentMethod\n      whatsappOptInStatus\n      recentEngagements\n      recentEngagementsUpdatedAt\n      openTaskDetail\n      openVideoCallDetail\n      lastClosedTaskDetail\n      lastClosedTaskDetailUpdatedAt\n      latestRemark\n      customAttributes\n      paymentRequestDetail\n      lastPaymentStatus\n      customDataAddedFromAddContactForm\n      leadLifecycleStage\n      leadLifecycleStageSubCategory\n      manualClosedReason\n      lastDealStageType\n      prospectingAttempts\n      totalProspectingAttemptsAcrossRechurn\n      numberOfTimesRechurned\n      lastProspectingDoneOn\n      firstProspectingDoneOn\n      nextProspectingDueOn\n      nextProspectingSetBy\n      nextProspectingNote\n      movedToOpportunityOn\n      movedToClosedOn\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
