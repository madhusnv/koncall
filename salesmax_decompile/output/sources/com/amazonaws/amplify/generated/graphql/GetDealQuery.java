...
public final class GetDealQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetDeal($id: ID!) {\n  getDeal(id: $id) {\n    __typename\n    id\n    accountId\n    name\n    description\n    dealStage\n    dealStageUpdatedAt\n    dealState\n    dealOutcome\n    dealLostReason\n    amount\n    currency\n    units {\n      __typename\n      productId\n      units\n      negotiatedPricePerUnit\n    }\n    createdByUser\n    lastUpdatedByUser\n    ownerId\n    primaryTeamId\n    openTaskDetail\n    transitionSummary\n    recentEngagements\n    recentEngagementsUpdatedAt\n    lastActivity\n    tags\n    dealStageCustomValues {\n      __typename\n      dealStage\n      customValue\n    }\n    customDealData\n    createdAt\n    updatedAt\n    associations {\n      __typename\n      nextToken\n    }\n    transitions {\n      __typename\n      nextToken\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetDeal";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetDeal($id: ID!) {\n  getDeal(id: $id) {\n    __typename\n    id\n    accountId\n    name\n    description\n    dealStage\n    dealStageUpdatedAt\n    dealState\n    dealOutcome\n    dealLostReason\n    amount\n    currency\n    units {\n      __typename\n      productId\n      units\n      negotiatedPricePerUnit\n    }\n    createdByUser\n    lastUpdatedByUser\n    ownerId\n    primaryTeamId\n    openTaskDetail\n    transitionSummary\n    recentEngagements\n    recentEngagementsUpdatedAt\n    lastActivity\n    tags\n    dealStageCustomValues {\n      __typename\n      dealStage\n      customValue\n    }\n    customDealData\n    createdAt\n    updatedAt\n    associations {\n      __typename\n      nextToken\n    }\n    transitions {\n      __typename\n      nextToken\n    }\n  }\n}";
    ...
    public static class Associations {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.Associations.1
    ...
    public static final class Builder {
        ...
        public GetDealQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetDealQuery(this.id);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getDeal", "getDeal", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetDeal getDeal;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetDeal.Mapper getDealFieldMapper = new GetDeal.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetDeal) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetDeal>() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetDeal read(ResponseReader responseReader2) {
                        return Mapper.this.getDealFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetDeal getDeal) {
        ...
        public boolean equals(Object obj) {
            ...
            GetDeal getDeal = this.getDeal;
            GetDeal getDeal2 = ((Data) obj).getDeal;
            return getDeal == null ? getDeal2 == null : getDeal.equals(getDeal2);
        }

        public GetDeal getDeal() {
            return this.getDeal;
        }
        ...
        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetDeal getDeal = this.getDeal;
                this.$hashCode = (getDeal == null ? 0 : getDeal.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetDeal getDeal = Data.this.getDeal;
                    responseWriter.writeObject(responseField, getDeal != null ? getDeal.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getDeal=" + this.getDeal + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class DealStageCustomValue {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.DealStageCustomValue.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DealStageCustomValue.$responseFields;
    ...
    public static class GetDeal {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetDeal> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetDeal map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetDeal.$responseFields;
                ...
                }), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[13]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[14]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[15]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[16]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[17]), responseReader.readList(responseFieldArr[18], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.GetDeal.Mapper.2
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.AWSJSON);
                    }
                }), responseReader.readList(responseFieldArr[19], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.GetDeal.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.AWSJSON);
                    }
                }), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[20]), responseReader.readString(responseFieldArr[21]), responseReader.readList(responseFieldArr[22], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.GetDeal.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                }), responseReader.readList(responseFieldArr[23], new ResponseReader.ListReader<DealStageCustomValue>() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.GetDeal.Mapper.5
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public DealStageCustomValue read(ResponseReader.ListItemReader listItemReader) {
                        return (DealStageCustomValue) listItemReader.readObject(new ResponseReader.ObjectReader<DealStageCustomValue>() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.GetDeal.Mapper.5.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetDeal)) {
                return false;
            }
            GetDeal getDeal = (GetDeal) obj;
            if (this.__typename.equals(getDeal.__typename) && this.id.equals(getDeal.id) && this.accountId.equals(getDeal.accountId) && ((str = this.name) != null ? str.equals(getDeal.name) : getDeal.name == null) && ((str2 = this.description) != null ? str2.equals(getDeal.description) : getDeal.description == null) && ((str3 = this.dealStage) != null ? str3.equals(getDeal.dealStage) : getDeal.dealStage == null) && ((str4 = this.dealStageUpdatedAt) != null ? str4.equals(getDeal.dealStageUpdatedAt) : getDeal.dealStageUpdatedAt == null) && ((dealState = this.dealState) != null ? dealState.equals(getDeal.dealState) : getDeal.dealState == null) && ((dealOutcome = this.dealOutcome) != null ? dealOutcome.equals(getDeal.dealOutcome) : getDeal.dealOutcome == null) && ((str5 = this.dealLostReason) != null ? str5.equals(getDeal.dealLostReason) : getDeal.dealLostReason == null) && ((d = this.amount) != null ? d.equals(getDeal.amount) : getDeal.amount == null) && ((str6 = this.currency) != null ? str6.equals(getDeal.currency) : getDeal.currency == null) && ((list = this.units) != null ? list.equals(getDeal.units) : getDeal.units == null) && ((str7 = this.createdByUser) != null ? str7.equals(getDeal.createdByUser) : getDeal.createdByUser == null) && ((str8 = this.lastUpdatedByUser) != null ? str8.equals(getDeal.lastUpdatedByUser) : getDeal.lastUpdatedByUser == null) && ((str9 = this.ownerId) != null ? str9.equals(getDeal.ownerId) : getDeal.ownerId == null) && ((str10 = this.primaryTeamId) != null ? str10.equals(getDeal.primaryTeamId) : getDeal.primaryTeamId == null) && ((str11 = this.openTaskDetail) != null ? str11.equals(getDeal.openTaskDetail) : getDeal.openTaskDetail == null) && ((list2 = this.transitionSummary) != null ? list2.equals(getDeal.transitionSummary) : getDeal.transitionSummary == null) && ((list3 = this.recentEngagements) != null ? list3.equals(getDeal.recentEngagements) : getDeal.recentEngagements == null) && ((str12 = this.recentEngagementsUpdatedAt) != null ? str12.equals(getDeal.recentEngagementsUpdatedAt) : getDeal.recentEngagementsUpdatedAt == null) && ((str13 = this.lastActivity) != null ? str13.equals(getDeal.lastActivity) : getDeal.lastActivity == null) && ((list4 = this.tags) != null ? list4.equals(getDeal.tags) : getDeal.tags == null) && ((list5 = this.dealStageCustomValues) != null ? list5.equals(getDeal.dealStageCustomValues) : getDeal.dealStageCustomValues == null) && ((str14 = this.customDealData) != null ? str14.equals(getDeal.customDealData) : getDeal.customDealData == null) && ((str15 = this.createdAt) != null ? str15.equals(getDeal.createdAt) : getDeal.createdAt == null) && ((str16 = this.updatedAt) != null ? str16.equals(getDeal.updatedAt) : getDeal.updatedAt == null) && ((associations = this.associations) != null ? associations.equals(getDeal.associations) : getDeal.associations == null)) {
                Transitions transitions = this.transitions;
                Transitions transitions2 = getDeal.transitions;
                if (transitions == null) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.GetDeal.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetDeal.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetDeal.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetDeal.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetDeal.this.accountId);
                    responseWriter.writeString(responseFieldArr[3], GetDeal.this.name);
                    responseWriter.writeString(responseFieldArr[4], GetDeal.this.description);
                    responseWriter.writeString(responseFieldArr[5], GetDeal.this.dealStage);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], GetDeal.this.dealStageUpdatedAt);
                    ResponseField responseField = responseFieldArr[7];
                    DealState dealState = GetDeal.this.dealState;
                    ...
                    DealOutcome dealOutcome = GetDeal.this.dealOutcome;
                    responseWriter.writeString(responseField2, dealOutcome != null ? dealOutcome.name() : null);
                    responseWriter.writeString(responseFieldArr[9], GetDeal.this.dealLostReason);
                    responseWriter.writeDouble(responseFieldArr[10], GetDeal.this.amount);
                    responseWriter.writeString(responseFieldArr[11], GetDeal.this.currency);
                    responseWriter.writeList(responseFieldArr[12], GetDeal.this.units, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.GetDeal.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Unit) obj).marshaller());
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], GetDeal.this.createdByUser);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], GetDeal.this.lastUpdatedByUser);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], GetDeal.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], GetDeal.this.primaryTeamId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], GetDeal.this.openTaskDetail);
                    responseWriter.writeList(responseFieldArr[18], GetDeal.this.transitionSummary, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.GetDeal.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[19], GetDeal.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.GetDeal.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], GetDeal.this.recentEngagementsUpdatedAt);
                    responseWriter.writeString(responseFieldArr[21], GetDeal.this.lastActivity);
                    responseWriter.writeList(responseFieldArr[22], GetDeal.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.GetDeal.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[23], GetDeal.this.dealStageCustomValues, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.GetDeal.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((DealStageCustomValue) obj).marshaller());
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[24], GetDeal.this.customDealData);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], GetDeal.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[26], GetDeal.this.updatedAt);
                    ResponseField responseField3 = responseFieldArr[27];
                    Associations associations = GetDeal.this.associations;
                    ...
                    Transitions transitions = GetDeal.this.transitions;
    ...
    public static class Transitions {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.Transitions.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Transitions.$responseFields;
    ...
    public static class Unit {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.Unit.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Unit.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetDealQuery.Variables.1
    ...
    public GetDealQuery(String str) {
    ...
    public String operationId() {
        return "4b226eda15069b0cfee37f63f44de047716816a1741a4f43c201b65d28c936d1";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetDeal($id: ID!) {\n  getDeal(id: $id) {\n    __typename\n    id\n    accountId\n    name\n    description\n    dealStage\n    dealStageUpdatedAt\n    dealState\n    dealOutcome\n    dealLostReason\n    amount\n    currency\n    units {\n      __typename\n      productId\n      units\n      negotiatedPricePerUnit\n    }\n    createdByUser\n    lastUpdatedByUser\n    ownerId\n    primaryTeamId\n    openTaskDetail\n    transitionSummary\n    recentEngagements\n    recentEngagementsUpdatedAt\n    lastActivity\n    tags\n    dealStageCustomValues {\n      __typename\n      dealStage\n      customValue\n    }\n    customDealData\n    createdAt\n    updatedAt\n    associations {\n      __typename\n      nextToken\n    }\n    transitions {\n      __typename\n      nextToken\n    }\n  }\n}";
    }
