...
public final class ListWabaPhoneNumbersQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListWabaPhoneNumbers($filter: ModelWabaPhoneNumberFilterInput, $limit: Int, $nextToken: String) {\n  listWabaPhoneNumbers(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      wabaAccountId\n      accountId\n      phoneNumberId\n      phoneNumber\n      isDefault\n      accessToken\n      name\n      internalName\n      quota\n      currentLimitCategory\n      status\n      qualityRating\n      entityListId\n      createdAt\n      updatedAt\n      welcomeMessage\n      requestedDisplayName\n      displayNameUpdate\n      displayNameUpdateDateTime\n      wabaNumberDecision\n      wabaNumberDecisionTime\n      rejectionReason\n      phoneNumberQualityUpdate\n      phoneNumberQualityUpdateTime\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListWabaPhoneNumbersQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListWabaPhoneNumbers";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListWabaPhoneNumbers($filter: ModelWabaPhoneNumberFilterInput, $limit: Int, $nextToken: String) {\n  listWabaPhoneNumbers(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      wabaAccountId\n      accountId\n      phoneNumberId\n      phoneNumber\n      isDefault\n      accessToken\n      name\n      internalName\n      quota\n      currentLimitCategory\n      status\n      qualityRating\n      entityListId\n      createdAt\n      updatedAt\n      welcomeMessage\n      requestedDisplayName\n      displayNameUpdate\n      displayNameUpdateDateTime\n      wabaNumberDecision\n      wabaNumberDecisionTime\n      rejectionReason\n      phoneNumberQualityUpdate\n      phoneNumberQualityUpdateTime\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public ListWabaPhoneNumbersQuery build() {
            return new ListWabaPhoneNumbersQuery(this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listWabaPhoneNumbers", "listWabaPhoneNumbers", new UnmodifiableMapBuilder(3).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListWabaPhoneNumbers listWabaPhoneNumbers;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListWabaPhoneNumbers.Mapper listWabaPhoneNumbersFieldMapper = new ListWabaPhoneNumbers.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListWabaPhoneNumbers) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListWabaPhoneNumbers>() { // from class: com.amazonaws.amplify.generated.graphql.ListWabaPhoneNumbersQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListWabaPhoneNumbers read(ResponseReader responseReader2) {
                        return Mapper.this.listWabaPhoneNumbersFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListWabaPhoneNumbers listWabaPhoneNumbers) {
            this.listWabaPhoneNumbers = listWabaPhoneNumbers;
        }
        ...
        public boolean equals(Object obj) {
            ...
            ListWabaPhoneNumbers listWabaPhoneNumbers = this.listWabaPhoneNumbers;
            ListWabaPhoneNumbers listWabaPhoneNumbers2 = ((Data) obj).listWabaPhoneNumbers;
            return listWabaPhoneNumbers == null ? listWabaPhoneNumbers2 == null : listWabaPhoneNumbers.equals(listWabaPhoneNumbers2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListWabaPhoneNumbers listWabaPhoneNumbers = this.listWabaPhoneNumbers;
                this.$hashCode = (listWabaPhoneNumbers == null ? 0 : listWabaPhoneNumbers.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListWabaPhoneNumbers listWabaPhoneNumbers() {
            return this.listWabaPhoneNumbers;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListWabaPhoneNumbersQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListWabaPhoneNumbers listWabaPhoneNumbers = Data.this.listWabaPhoneNumbers;
                    responseWriter.writeObject(responseField, listWabaPhoneNumbers != null ? listWabaPhoneNumbers.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listWabaPhoneNumbers=" + this.listWabaPhoneNumbers + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListWabaPhoneNumbersQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static class ListWabaPhoneNumbers {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListWabaPhoneNumbers> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListWabaPhoneNumbers map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListWabaPhoneNumbers.$responseFields;
                return new ListWabaPhoneNumbers(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListWabaPhoneNumbersQuery.ListWabaPhoneNumbers.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListWabaPhoneNumbersQuery.ListWabaPhoneNumbers.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListWabaPhoneNumbers(String str, List<Item> list, String str2) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListWabaPhoneNumbers)) {
                return false;
            }
            ListWabaPhoneNumbers listWabaPhoneNumbers = (ListWabaPhoneNumbers) obj;
            if (this.__typename.equals(listWabaPhoneNumbers.__typename) && this.items.equals(listWabaPhoneNumbers.items)) {
                String str = this.nextToken;
                String str2 = listWabaPhoneNumbers.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListWabaPhoneNumbersQuery.ListWabaPhoneNumbers.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListWabaPhoneNumbers.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListWabaPhoneNumbers.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListWabaPhoneNumbers.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListWabaPhoneNumbersQuery.ListWabaPhoneNumbers.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListWabaPhoneNumbers.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListWabaPhoneNumbers{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(ModelWabaPhoneNumberFilterInput modelWabaPhoneNumberFilterInput, Integer num, String str) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListWabaPhoneNumbersQuery.Variables.1
    ...
    public ListWabaPhoneNumbersQuery(ModelWabaPhoneNumberFilterInput modelWabaPhoneNumberFilterInput, Integer num, String str) {
        this.variables = new Variables(modelWabaPhoneNumberFilterInput, num, str);
    }
    ...
    public String operationId() {
        return "91ede077033e7fede6998f71c4da1cce825632d25d5b843679ef96aae5752c9c";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListWabaPhoneNumbers($filter: ModelWabaPhoneNumberFilterInput, $limit: Int, $nextToken: String) {\n  listWabaPhoneNumbers(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      wabaAccountId\n      accountId\n      phoneNumberId\n      phoneNumber\n      isDefault\n      accessToken\n      name\n      internalName\n      quota\n      currentLimitCategory\n      status\n      qualityRating\n      entityListId\n      createdAt\n      updatedAt\n      welcomeMessage\n      requestedDisplayName\n      displayNameUpdate\n      displayNameUpdateDateTime\n      wabaNumberDecision\n      wabaNumberDecisionTime\n      rejectionReason\n      phoneNumberQualityUpdate\n      phoneNumberQualityUpdateTime\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    }
