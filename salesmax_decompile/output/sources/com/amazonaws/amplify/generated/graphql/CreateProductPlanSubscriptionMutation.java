...
import type.CreateProductPlanSubscriptionInput;
import type.CustomType;
import type.ModelProductPlanSubscriptionConditionInput;

/* loaded from: classes6.dex */
public final class CreateProductPlanSubscriptionMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation CreateProductPlanSubscription($input: CreateProductPlanSubscriptionInput!, $condition: ModelProductPlanSubscriptionConditionInput) {\n  createProductPlanSubscription(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    addedById\n    productAccountId\n    productPlanId\n    planDescription\n    planStatus\n    planFeePerUnit\n    planFeeProRataPerUnit\n    period\n    amount\n    currency\n    status\n    numberOfUnits\n    numberOfFreeUnits\n    unitType\n    subscriptionPaymentStatus\n    subscriptionStartDate\n    subscriptionEndDate\n    createdAt\n    updatedAt\n    productPlan {\n      __typename\n      id\n      accountId\n      productId\n      planDescription\n      planStatus\n      period\n      fee\n      proRataFee\n      currency\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductPlanSubscriptionMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "CreateProductPlanSubscription";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation CreateProductPlanSubscription($input: CreateProductPlanSubscriptionInput!, $condition: ModelProductPlanSubscriptionConditionInput) {\n  createProductPlanSubscription(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    addedById\n    productAccountId\n    productPlanId\n    planDescription\n    planStatus\n    planFeePerUnit\n    planFeeProRataPerUnit\n    period\n    amount\n    currency\n    status\n    numberOfUnits\n    numberOfFreeUnits\n    unitType\n    subscriptionPaymentStatus\n    subscriptionStartDate\n    subscriptionEndDate\n    createdAt\n    updatedAt\n    productPlan {\n      __typename\n      id\n      accountId\n      productId\n      planDescription\n      planStatus\n      period\n      fee\n      proRataFee\n      currency\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelProductPlanSubscriptionConditionInput condition;
        private CreateProductPlanSubscriptionInput input;

        public CreateProductPlanSubscriptionMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new CreateProductPlanSubscriptionMutation(this.input, this.condition);
        }
        ...
        public Builder input(CreateProductPlanSubscriptionInput createProductPlanSubscriptionInput) {
            this.input = createProductPlanSubscriptionInput;
            return this;
        }
    }

    public static class CreateProductPlanSubscription {
        ...
        public CreateProductPlanSubscription(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, Integer num, Integer num2, String str9, Integer num3, String str10, String str11, Integer num4, Integer num5, String str12, String str13, String str14, String str15, String str16, String str17, ProductPlan productPlan) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateProductPlanSubscription)) {
                return false;
            }
            CreateProductPlanSubscription createProductPlanSubscription = (CreateProductPlanSubscription) obj;
            if (this.__typename.equals(createProductPlanSubscription.__typename) && this.id.equals(createProductPlanSubscription.id) && this.accountId.equals(createProductPlanSubscription.accountId) && this.addedById.equals(createProductPlanSubscription.addedById) && ((str = this.productAccountId) != null ? str.equals(createProductPlanSubscription.productAccountId) : createProductPlanSubscription.productAccountId == null) && this.productPlanId.equals(createProductPlanSubscription.productPlanId) && ((str2 = this.planDescription) != null ? str2.equals(createProductPlanSubscription.planDescription) : createProductPlanSubscription.planDescription == null) && ((str3 = this.planStatus) != null ? str3.equals(createProductPlanSubscription.planStatus) : createProductPlanSubscription.planStatus == null) && ((num = this.planFeePerUnit) != null ? num.equals(createProductPlanSubscription.planFeePerUnit) : createProductPlanSubscription.planFeePerUnit == null) && ((num2 = this.planFeeProRataPerUnit) != null ? num2.equals(createProductPlanSubscription.planFeeProRataPerUnit) : createProductPlanSubscription.planFeeProRataPerUnit == null) && ((str4 = this.period) != null ? str4.equals(createProductPlanSubscription.period) : createProductPlanSubscription.period == null) && ((num3 = this.amount) != null ? num3.equals(createProductPlanSubscription.amount) : createProductPlanSubscription.amount == null) && ((str5 = this.currency) != null ? str5.equals(createProductPlanSubscription.currency) : createProductPlanSubscription.currency == null) && ((str6 = this.status) != null ? str6.equals(createProductPlanSubscription.status) : createProductPlanSubscription.status == null) && ((num4 = this.numberOfUnits) != null ? num4.equals(createProductPlanSubscription.numberOfUnits) : createProductPlanSubscription.numberOfUnits == null) && ((num5 = this.numberOfFreeUnits) != null ? num5.equals(createProductPlanSubscription.numberOfFreeUnits) : createProductPlanSubscription.numberOfFreeUnits == null) && ((str7 = this.unitType) != null ? str7.equals(createProductPlanSubscription.unitType) : createProductPlanSubscription.unitType == null) && ((str8 = this.subscriptionPaymentStatus) != null ? str8.equals(createProductPlanSubscription.subscriptionPaymentStatus) : createProductPlanSubscription.subscriptionPaymentStatus == null) && this.subscriptionStartDate.equals(createProductPlanSubscription.subscriptionStartDate) && ((str9 = this.subscriptionEndDate) != null ? str9.equals(createProductPlanSubscription.subscriptionEndDate) : createProductPlanSubscription.subscriptionEndDate == null) && this.createdAt.equals(createProductPlanSubscription.createdAt) && this.updatedAt.equals(createProductPlanSubscription.updatedAt)) {
                ProductPlan productPlan = this.productPlan;
                ProductPlan productPlan2 = createProductPlanSubscription.productPlan;
                if (productPlan == null) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductPlanSubscriptionMutation.CreateProductPlanSubscription.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateProductPlanSubscription.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateProductPlanSubscription.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateProductPlanSubscription.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], CreateProductPlanSubscription.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], CreateProductPlanSubscription.this.addedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], CreateProductPlanSubscription.this.productAccountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], CreateProductPlanSubscription.this.productPlanId);
                    responseWriter.writeString(responseFieldArr[6], CreateProductPlanSubscription.this.planDescription);
                    responseWriter.writeString(responseFieldArr[7], CreateProductPlanSubscription.this.planStatus);
                    responseWriter.writeInt(responseFieldArr[8], CreateProductPlanSubscription.this.planFeePerUnit);
                    responseWriter.writeInt(responseFieldArr[9], CreateProductPlanSubscription.this.planFeeProRataPerUnit);
                    responseWriter.writeString(responseFieldArr[10], CreateProductPlanSubscription.this.period);
                    responseWriter.writeInt(responseFieldArr[11], CreateProductPlanSubscription.this.amount);
                    responseWriter.writeString(responseFieldArr[12], CreateProductPlanSubscription.this.currency);
                    responseWriter.writeString(responseFieldArr[13], CreateProductPlanSubscription.this.status);
                    responseWriter.writeInt(responseFieldArr[14], CreateProductPlanSubscription.this.numberOfUnits);
                    responseWriter.writeInt(responseFieldArr[15], CreateProductPlanSubscription.this.numberOfFreeUnits);
                    responseWriter.writeString(responseFieldArr[16], CreateProductPlanSubscription.this.unitType);
                    responseWriter.writeString(responseFieldArr[17], CreateProductPlanSubscription.this.subscriptionPaymentStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], CreateProductPlanSubscription.this.subscriptionStartDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], CreateProductPlanSubscription.this.subscriptionEndDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], CreateProductPlanSubscription.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], CreateProductPlanSubscription.this.updatedAt);
                    ResponseField responseField = responseFieldArr[22];
                    ProductPlan productPlan = CreateProductPlanSubscription.this.productPlan;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createProductPlanSubscription", "createProductPlanSubscription", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final CreateProductPlanSubscription createProductPlanSubscription;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateProductPlanSubscription.Mapper createProductPlanSubscriptionFieldMapper = new CreateProductPlanSubscription.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateProductPlanSubscription) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateProductPlanSubscription>() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductPlanSubscriptionMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateProductPlanSubscription read(ResponseReader responseReader2) {
                        return Mapper.this.createProductPlanSubscriptionFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateProductPlanSubscription createProductPlanSubscription) {
            this.createProductPlanSubscription = createProductPlanSubscription;
        }

        public CreateProductPlanSubscription createProductPlanSubscription() {
            return this.createProductPlanSubscription;
        }
        ...
        public boolean equals(Object obj) {
            ...
            CreateProductPlanSubscription createProductPlanSubscription = this.createProductPlanSubscription;
            CreateProductPlanSubscription createProductPlanSubscription2 = ((Data) obj).createProductPlanSubscription;
            return createProductPlanSubscription == null ? createProductPlanSubscription2 == null : createProductPlanSubscription.equals(createProductPlanSubscription2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateProductPlanSubscription createProductPlanSubscription = this.createProductPlanSubscription;
                this.$hashCode = (createProductPlanSubscription == null ? 0 : createProductPlanSubscription.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductPlanSubscriptionMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateProductPlanSubscription createProductPlanSubscription = Data.this.createProductPlanSubscription;
                    responseWriter.writeObject(responseField, createProductPlanSubscription != null ? createProductPlanSubscription.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createProductPlanSubscription=" + this.createProductPlanSubscription + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class ProductPlan {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductPlanSubscriptionMutation.ProductPlan.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ProductPlan.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final CreateProductPlanSubscriptionInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateProductPlanSubscriptionInput createProductPlanSubscriptionInput, ModelProductPlanSubscriptionConditionInput modelProductPlanSubscriptionConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createProductPlanSubscriptionInput;
            this.condition = modelProductPlanSubscriptionConditionInput;
            linkedHashMap.put("input", createProductPlanSubscriptionInput);
        ...
        public CreateProductPlanSubscriptionInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateProductPlanSubscriptionMutation.Variables.1
    ...
    public CreateProductPlanSubscriptionMutation(CreateProductPlanSubscriptionInput createProductPlanSubscriptionInput, ModelProductPlanSubscriptionConditionInput modelProductPlanSubscriptionConditionInput) {
        Utils.checkNotNull(createProductPlanSubscriptionInput, "input == null");
        this.variables = new Variables(createProductPlanSubscriptionInput, modelProductPlanSubscriptionConditionInput);
    }
    ...
    public String operationId() {
        return "2bb9d200b5d10eb949c014c4f526984a673c898e8c9bdedd26a1a96ea0938e2c";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateProductPlanSubscription($input: CreateProductPlanSubscriptionInput!, $condition: ModelProductPlanSubscriptionConditionInput) {\n  createProductPlanSubscription(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    addedById\n    productAccountId\n    productPlanId\n    planDescription\n    planStatus\n    planFeePerUnit\n    planFeeProRataPerUnit\n    period\n    amount\n    currency\n    status\n    numberOfUnits\n    numberOfFreeUnits\n    unitType\n    subscriptionPaymentStatus\n    subscriptionStartDate\n    subscriptionEndDate\n    createdAt\n    updatedAt\n    productPlan {\n      __typename\n      id\n      accountId\n      productId\n      planDescription\n      planStatus\n      period\n      fee\n      proRataFee\n      currency\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
