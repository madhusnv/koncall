...
import type.CreateWabaPhoneNumberNewInput;
...
public final class CreateWabaPhoneNumberNewMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation CreateWabaPhoneNumberNew($input: CreateWabaPhoneNumberNewInput!, $condition: ModelWabaPhoneNumberNewConditionInput) {\n  createWabaPhoneNumberNew(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.CreateWabaPhoneNumberNewMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "CreateWabaPhoneNumberNew";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation CreateWabaPhoneNumberNew($input: CreateWabaPhoneNumberNewInput!, $condition: ModelWabaPhoneNumberNewConditionInput) {\n  createWabaPhoneNumberNew(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelWabaPhoneNumberNewConditionInput condition;
        private CreateWabaPhoneNumberNewInput input;

        public CreateWabaPhoneNumberNewMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new CreateWabaPhoneNumberNewMutation(this.input, this.condition);
        }
        ...
        public Builder input(CreateWabaPhoneNumberNewInput createWabaPhoneNumberNewInput) {
            this.input = createWabaPhoneNumberNewInput;
            return this;
        }
    }

    public static class CreateWabaPhoneNumberNew {
        ...
        public CreateWabaPhoneNumberNew(String str, String str2, String str3, String str4, String str5, String str6, Boolean bool, String str7, String str8, String str9, Integer num, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, String str19, String str20, String str21, String str22, String str23, String str24, String str25, String str26, EntityList entityList) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateWabaPhoneNumberNew)) {
                return false;
            }
            CreateWabaPhoneNumberNew createWabaPhoneNumberNew = (CreateWabaPhoneNumberNew) obj;
            if (this.__typename.equals(createWabaPhoneNumberNew.__typename) && this.id.equals(createWabaPhoneNumberNew.id) && this.wabaAccountId.equals(createWabaPhoneNumberNew.wabaAccountId) && this.accountId.equals(createWabaPhoneNumberNew.accountId) && this.phoneNumberId.equals(createWabaPhoneNumberNew.phoneNumberId) && this.phoneNumber.equals(createWabaPhoneNumberNew.phoneNumber) && ((bool = this.isDefault) != null ? bool.equals(createWabaPhoneNumberNew.isDefault) : createWabaPhoneNumberNew.isDefault == null) && ((str = this.accessToken) != null ? str.equals(createWabaPhoneNumberNew.accessToken) : createWabaPhoneNumberNew.accessToken == null) && ((str2 = this.name) != null ? str2.equals(createWabaPhoneNumberNew.name) : createWabaPhoneNumberNew.name == null) && ((str3 = this.internalName) != null ? str3.equals(createWabaPhoneNumberNew.internalName) : createWabaPhoneNumberNew.internalName == null) && ((num = this.quota) != null ? num.equals(createWabaPhoneNumberNew.quota) : createWabaPhoneNumberNew.quota == null) && ((str4 = this.currentLimitCategory) != null ? str4.equals(createWabaPhoneNumberNew.currentLimitCategory) : createWabaPhoneNumberNew.currentLimitCategory == null) && ((str5 = this.status) != null ? str5.equals(createWabaPhoneNumberNew.status) : createWabaPhoneNumberNew.status == null) && ((str6 = this.qualityRating) != null ? str6.equals(createWabaPhoneNumberNew.qualityRating) : createWabaPhoneNumberNew.qualityRating == null) && ((str7 = this.entityListId) != null ? str7.equals(createWabaPhoneNumberNew.entityListId) : createWabaPhoneNumberNew.entityListId == null) && ((str8 = this.createdAt) != null ? str8.equals(createWabaPhoneNumberNew.createdAt) : createWabaPhoneNumberNew.createdAt == null) && ((str9 = this.updatedAt) != null ? str9.equals(createWabaPhoneNumberNew.updatedAt) : createWabaPhoneNumberNew.updatedAt == null) && ((str10 = this.welcomeMessage) != null ? str10.equals(createWabaPhoneNumberNew.welcomeMessage) : createWabaPhoneNumberNew.welcomeMessage == null) && ((str11 = this.requestedDisplayName) != null ? str11.equals(createWabaPhoneNumberNew.requestedDisplayName) : createWabaPhoneNumberNew.requestedDisplayName == null) && ((str12 = this.displayNameUpdate) != null ? str12.equals(createWabaPhoneNumberNew.displayNameUpdate) : createWabaPhoneNumberNew.displayNameUpdate == null) && ((str13 = this.displayNameUpdateDateTime) != null ? str13.equals(createWabaPhoneNumberNew.displayNameUpdateDateTime) : createWabaPhoneNumberNew.displayNameUpdateDateTime == null) && ((str14 = this.wabaNumberDecision) != null ? str14.equals(createWabaPhoneNumberNew.wabaNumberDecision) : createWabaPhoneNumberNew.wabaNumberDecision == null) && ((str15 = this.wabaNumberDecisionTime) != null ? str15.equals(createWabaPhoneNumberNew.wabaNumberDecisionTime) : createWabaPhoneNumberNew.wabaNumberDecisionTime == null) && ((str16 = this.rejectionReason) != null ? str16.equals(createWabaPhoneNumberNew.rejectionReason) : createWabaPhoneNumberNew.rejectionReason == null) && ((str17 = this.phoneNumberQualityUpdate) != null ? str17.equals(createWabaPhoneNumberNew.phoneNumberQualityUpdate) : createWabaPhoneNumberNew.phoneNumberQualityUpdate == null) && ((str18 = this.phoneNumberQualityUpdateTime) != null ? str18.equals(createWabaPhoneNumberNew.phoneNumberQualityUpdateTime) : createWabaPhoneNumberNew.phoneNumberQualityUpdateTime == null) && ((str19 = this.createdById) != null ? str19.equals(createWabaPhoneNumberNew.createdById) : createWabaPhoneNumberNew.createdById == null) && ((str20 = this.updatedById) != null ? str20.equals(createWabaPhoneNumberNew.updatedById) : createWabaPhoneNumberNew.updatedById == null)) {
                EntityList entityList = this.entityList;
                EntityList entityList2 = createWabaPhoneNumberNew.entityList;
                if (entityList == null) {
                    if (entityList2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWabaPhoneNumberNewMutation.CreateWabaPhoneNumberNew.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateWabaPhoneNumberNew.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateWabaPhoneNumberNew.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateWabaPhoneNumberNew.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], CreateWabaPhoneNumberNew.this.wabaAccountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], CreateWabaPhoneNumberNew.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], CreateWabaPhoneNumberNew.this.phoneNumberId);
                    responseWriter.writeString(responseFieldArr[5], CreateWabaPhoneNumberNew.this.phoneNumber);
                    responseWriter.writeBoolean(responseFieldArr[6], CreateWabaPhoneNumberNew.this.isDefault);
                    responseWriter.writeString(responseFieldArr[7], CreateWabaPhoneNumberNew.this.accessToken);
                    responseWriter.writeString(responseFieldArr[8], CreateWabaPhoneNumberNew.this.name);
                    responseWriter.writeString(responseFieldArr[9], CreateWabaPhoneNumberNew.this.internalName);
                    responseWriter.writeInt(responseFieldArr[10], CreateWabaPhoneNumberNew.this.quota);
                    responseWriter.writeString(responseFieldArr[11], CreateWabaPhoneNumberNew.this.currentLimitCategory);
                    responseWriter.writeString(responseFieldArr[12], CreateWabaPhoneNumberNew.this.status);
                    responseWriter.writeString(responseFieldArr[13], CreateWabaPhoneNumberNew.this.qualityRating);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], CreateWabaPhoneNumberNew.this.entityListId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], CreateWabaPhoneNumberNew.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], CreateWabaPhoneNumberNew.this.updatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], CreateWabaPhoneNumberNew.this.welcomeMessage);
                    responseWriter.writeString(responseFieldArr[18], CreateWabaPhoneNumberNew.this.requestedDisplayName);
                    responseWriter.writeString(responseFieldArr[19], CreateWabaPhoneNumberNew.this.displayNameUpdate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], CreateWabaPhoneNumberNew.this.displayNameUpdateDateTime);
                    responseWriter.writeString(responseFieldArr[21], CreateWabaPhoneNumberNew.this.wabaNumberDecision);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], CreateWabaPhoneNumberNew.this.wabaNumberDecisionTime);
                    responseWriter.writeString(responseFieldArr[23], CreateWabaPhoneNumberNew.this.rejectionReason);
                    responseWriter.writeString(responseFieldArr[24], CreateWabaPhoneNumberNew.this.phoneNumberQualityUpdate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], CreateWabaPhoneNumberNew.this.phoneNumberQualityUpdateTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[26], CreateWabaPhoneNumberNew.this.createdById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], CreateWabaPhoneNumberNew.this.updatedById);
                    ResponseField responseField = responseFieldArr[28];
                    EntityList entityList = CreateWabaPhoneNumberNew.this.entityList;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createWabaPhoneNumberNew", "createWabaPhoneNumberNew", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final CreateWabaPhoneNumberNew createWabaPhoneNumberNew;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateWabaPhoneNumberNew.Mapper createWabaPhoneNumberNewFieldMapper = new CreateWabaPhoneNumberNew.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateWabaPhoneNumberNew) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateWabaPhoneNumberNew>() { // from class: com.amazonaws.amplify.generated.graphql.CreateWabaPhoneNumberNewMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateWabaPhoneNumberNew read(ResponseReader responseReader2) {
                        return Mapper.this.createWabaPhoneNumberNewFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateWabaPhoneNumberNew createWabaPhoneNumberNew) {
            this.createWabaPhoneNumberNew = createWabaPhoneNumberNew;
        }

        public CreateWabaPhoneNumberNew createWabaPhoneNumberNew() {
            return this.createWabaPhoneNumberNew;
        }
        ...
        public boolean equals(Object obj) {
            ...
            CreateWabaPhoneNumberNew createWabaPhoneNumberNew = this.createWabaPhoneNumberNew;
            CreateWabaPhoneNumberNew createWabaPhoneNumberNew2 = ((Data) obj).createWabaPhoneNumberNew;
            return createWabaPhoneNumberNew == null ? createWabaPhoneNumberNew2 == null : createWabaPhoneNumberNew.equals(createWabaPhoneNumberNew2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateWabaPhoneNumberNew createWabaPhoneNumberNew = this.createWabaPhoneNumberNew;
                this.$hashCode = (createWabaPhoneNumberNew == null ? 0 : createWabaPhoneNumberNew.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWabaPhoneNumberNewMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateWabaPhoneNumberNew createWabaPhoneNumberNew = Data.this.createWabaPhoneNumberNew;
                    responseWriter.writeObject(responseField, createWabaPhoneNumberNew != null ? createWabaPhoneNumberNew.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createWabaPhoneNumberNew=" + this.createWabaPhoneNumberNew + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class EntityList {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWabaPhoneNumberNewMutation.EntityList.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = EntityList.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[34], EntityList.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateWabaPhoneNumberNewMutation.EntityList.1.1
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final CreateWabaPhoneNumberNewInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateWabaPhoneNumberNewInput createWabaPhoneNumberNewInput, ModelWabaPhoneNumberNewConditionInput modelWabaPhoneNumberNewConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createWabaPhoneNumberNewInput;
            this.condition = modelWabaPhoneNumberNewConditionInput;
            linkedHashMap.put("input", createWabaPhoneNumberNewInput);
        ...
        public CreateWabaPhoneNumberNewInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWabaPhoneNumberNewMutation.Variables.1
    ...
    public CreateWabaPhoneNumberNewMutation(CreateWabaPhoneNumberNewInput createWabaPhoneNumberNewInput, ModelWabaPhoneNumberNewConditionInput modelWabaPhoneNumberNewConditionInput) {
        Utils.checkNotNull(createWabaPhoneNumberNewInput, "input == null");
        this.variables = new Variables(createWabaPhoneNumberNewInput, modelWabaPhoneNumberNewConditionInput);
    }
    ...
    public String operationId() {
        return "7a65319f3a55ad0ba9f38e936c5f8a0e1555652b787d13be62ed701dc2930db7";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateWabaPhoneNumberNew($input: CreateWabaPhoneNumberNewInput!, $condition: ModelWabaPhoneNumberNewConditionInput) {\n  createWabaPhoneNumberNew(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
