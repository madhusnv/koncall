...
import type.CreateEntityListInput;
...
public final class CreateEntityListMutation implements Mutation<Data, Data, Variables> {
    ...
    public static class AssociatedDistribution {
        ...
        public static final class Mapper implements ResponseFieldMapper<AssociatedDistribution> {
            ...
            public AssociatedDistribution map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[5], new ResponseReader.ListReader<DistributedEntityType>() { // from class: com.amazonaws.amplify.generated.graphql.CreateEntityListMutation.AssociatedDistribution.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateEntityListMutation.AssociatedDistribution.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], AssociatedDistribution.this.distributedEntityType, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateEntityListMutation.AssociatedDistribution.1.1
    ...
    public static final class Builder {
        ...
        private CreateEntityListInput input;

        public CreateEntityListMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new CreateEntityListMutation(this.input, this.condition);
        }
        ...
        public Builder input(CreateEntityListInput createEntityListInput) {
            this.input = createEntityListInput;
            return this;
        }
    }

    public static class CreateEntityList {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<CreateEntityList> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public CreateEntityList map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = CreateEntityList.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
                String string2 = responseReader.readString(responseFieldArr[3]);
                ...
                }), (EntityActionDefinition) responseReader.readObject(responseFieldArr[40], new ResponseReader.ObjectReader<EntityActionDefinition>() { // from class: com.amazonaws.amplify.generated.graphql.CreateEntityListMutation.CreateEntityList.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), (Owner) responseReader.readObject(responseFieldArr[41], new ResponseReader.ObjectReader<Owner>() { // from class: com.amazonaws.amplify.generated.graphql.CreateEntityListMutation.CreateEntityList.Mapper.4
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateEntityList)) {
                return false;
            }
            CreateEntityList createEntityList = (CreateEntityList) obj;
            if (this.__typename.equals(createEntityList.__typename) && this.id.equals(createEntityList.id) && this.accountId.equals(createEntityList.accountId) && this.entityTypeInList.equals(createEntityList.entityTypeInList) && this.entityListType.equals(createEntityList.entityListType) && ((str = this.listName) != null ? str.equals(createEntityList.listName) : createEntityList.listName == null) && ((str2 = this.description) != null ? str2.equals(createEntityList.description) : createEntityList.description == null) && ((entityListStatus = this.status) != null ? entityListStatus.equals(createEntityList.status) : createEntityList.status == null) && ((num = this.successfulCount) != null ? num.equals(createEntityList.successfulCount) : createEntityList.successfulCount == null) && ((num2 = this.duplicateCount) != null ? num2.equals(createEntityList.duplicateCount) : createEntityList.duplicateCount == null) && ((num3 = this.invalidNumbersCount) != null ? num3.equals(createEntityList.invalidNumbersCount) : createEntityList.invalidNumbersCount == null) && ((num4 = this.invalidEmailCount) != null ? num4.equals(createEntityList.invalidEmailCount) : createEntityList.invalidEmailCount == null) && ((num5 = this.doNotTrackCount) != null ? num5.equals(createEntityList.doNotTrackCount) : createEntityList.doNotTrackCount == null) && ((num6 = this.otherFailedCount) != null ? num6.equals(createEntityList.otherFailedCount) : createEntityList.otherFailedCount == null) && this.ownerId.equals(createEntityList.ownerId) && this.listCreationType.equals(createEntityList.listCreationType) && ((str3 = this.listCategory) != null ? str3.equals(createEntityList.listCategory) : createEntityList.listCategory == null) && ((str4 = this.rawBulkUploadFileRef) != null ? str4.equals(createEntityList.rawBulkUploadFileRef) : createEntityList.rawBulkUploadFileRef == null) && ((str5 = this.rawBulkUploadFileHash) != null ? str5.equals(createEntityList.rawBulkUploadFileHash) : createEntityList.rawBulkUploadFileHash == null) && ((str6 = this.modifiedBulkUploadFileRef) != null ? str6.equals(createEntityList.modifiedBulkUploadFileRef) : createEntityList.modifiedBulkUploadFileRef == null) && ((str7 = this.finalBulkUploadFileRef) != null ? str7.equals(createEntityList.finalBulkUploadFileRef) : createEntityList.finalBulkUploadFileRef == null) && ((str8 = this.leadSourceForBulkUpload) != null ? str8.equals(createEntityList.leadSourceForBulkUpload) : createEntityList.leadSourceForBulkUpload == null) && ((str9 = this.defaultCountryCode) != null ? str9.equals(createEntityList.defaultCountryCode) : createEntityList.defaultCountryCode == null) && ((str10 = this.defaultCountryIso) != null ? str10.equals(createEntityList.defaultCountryIso) : createEntityList.defaultCountryIso == null) && ((str11 = this.notificationBody) != null ? str11.equals(createEntityList.notificationBody) : createEntityList.notificationBody == null) && ((str12 = this.rule) != null ? str12.equals(createEntityList.rule) : createEntityList.rule == null) && ((contactAssignmentStatus = this.toBeAssigned) != null ? contactAssignmentStatus.equals(createEntityList.toBeAssigned) : createEntityList.toBeAssigned == null) && ((str13 = this.assignedUserId) != null ? str13.equals(createEntityList.assignedUserId) : createEntityList.assignedUserId == null) && ((str14 = this.assignedTeamId) != null ? str14.equals(createEntityList.assignedTeamId) : createEntityList.assignedTeamId == null) && ((str15 = this.associatedDistributionId) != null ? str15.equals(createEntityList.associatedDistributionId) : createEntityList.associatedDistributionId == null) && ((str16 = this.entityActionDefinitionReference) != null ? str16.equals(createEntityList.entityActionDefinitionReference) : createEntityList.entityActionDefinitionReference == null) && ((bool = this.redistributeEntities) != null ? bool.equals(createEntityList.redistributeEntities) : createEntityList.redistributeEntities == null) && ((str17 = this.redistributionRequestedAt) != null ? str17.equals(createEntityList.redistributionRequestedAt) : createEntityList.redistributionRequestedAt == null) && ((str18 = this.dupliacteLeadList) != null ? str18.equals(createEntityList.dupliacteLeadList) : createEntityList.dupliacteLeadList == null) && ((list = this.tags) != null ? list.equals(createEntityList.tags) : createEntityList.tags == null) && ((str19 = this.chatMessagePlatform) != null ? str19.equals(createEntityList.chatMessagePlatform) : createEntityList.chatMessagePlatform == null) && ((bool2 = this.allowMultiple) != null ? bool2.equals(createEntityList.allowMultiple) : createEntityList.allowMultiple == null) && ((str20 = this.createdAt) != null ? str20.equals(createEntityList.createdAt) : createEntityList.createdAt == null) && ((str21 = this.updatedAt) != null ? str21.equals(createEntityList.updatedAt) : createEntityList.updatedAt == null) && ((associatedDistribution = this.associatedDistribution) != null ? associatedDistribution.equals(createEntityList.associatedDistribution) : createEntityList.associatedDistribution == null) && ((entityActionDefinition = this.entityActionDefinition) != null ? entityActionDefinition.equals(createEntityList.entityActionDefinition) : createEntityList.entityActionDefinition == null)) {
                Owner owner = this.owner;
                Owner owner2 = createEntityList.owner;
                if (owner == null) {
                    if (owner2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateEntityListMutation.CreateEntityList.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateEntityList.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateEntityList.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateEntityList.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], CreateEntityList.this.accountId);
                    responseWriter.writeString(responseFieldArr[3], CreateEntityList.this.entityTypeInList);
                    responseWriter.writeString(responseFieldArr[4], CreateEntityList.this.entityListType.name());
                    responseWriter.writeString(responseFieldArr[5], CreateEntityList.this.listName);
                    responseWriter.writeString(responseFieldArr[6], CreateEntityList.this.description);
                    ResponseField responseField = responseFieldArr[7];
                    EntityListStatus entityListStatus = CreateEntityList.this.status;
                    responseWriter.writeString(responseField, entityListStatus != null ? entityListStatus.name() : null);
                    responseWriter.writeInt(responseFieldArr[8], CreateEntityList.this.successfulCount);
                    responseWriter.writeInt(responseFieldArr[9], CreateEntityList.this.duplicateCount);
                    responseWriter.writeInt(responseFieldArr[10], CreateEntityList.this.invalidNumbersCount);
                    responseWriter.writeInt(responseFieldArr[11], CreateEntityList.this.invalidEmailCount);
                    responseWriter.writeInt(responseFieldArr[12], CreateEntityList.this.doNotTrackCount);
                    responseWriter.writeInt(responseFieldArr[13], CreateEntityList.this.otherFailedCount);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], CreateEntityList.this.ownerId);
                    responseWriter.writeString(responseFieldArr[15], CreateEntityList.this.listCreationType.name());
                    responseWriter.writeString(responseFieldArr[16], CreateEntityList.this.listCategory);
                    responseWriter.writeString(responseFieldArr[17], CreateEntityList.this.rawBulkUploadFileRef);
                    responseWriter.writeString(responseFieldArr[18], CreateEntityList.this.rawBulkUploadFileHash);
                    responseWriter.writeString(responseFieldArr[19], CreateEntityList.this.modifiedBulkUploadFileRef);
                    responseWriter.writeString(responseFieldArr[20], CreateEntityList.this.finalBulkUploadFileRef);
                    responseWriter.writeString(responseFieldArr[21], CreateEntityList.this.leadSourceForBulkUpload);
                    responseWriter.writeString(responseFieldArr[22], CreateEntityList.this.defaultCountryCode);
                    responseWriter.writeString(responseFieldArr[23], CreateEntityList.this.defaultCountryIso);
                    responseWriter.writeString(responseFieldArr[24], CreateEntityList.this.notificationBody);
                    responseWriter.writeString(responseFieldArr[25], CreateEntityList.this.rule);
                    ResponseField responseField2 = responseFieldArr[26];
                    ContactAssignmentStatus contactAssignmentStatus = CreateEntityList.this.toBeAssigned;
                    responseWriter.writeString(responseField2, contactAssignmentStatus != null ? contactAssignmentStatus.name() : null);
                    responseWriter.writeString(responseFieldArr[27], CreateEntityList.this.assignedUserId);
                    responseWriter.writeString(responseFieldArr[28], CreateEntityList.this.assignedTeamId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[29], CreateEntityList.this.associatedDistributionId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[30], CreateEntityList.this.entityActionDefinitionReference);
                    responseWriter.writeBoolean(responseFieldArr[31], CreateEntityList.this.redistributeEntities);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[32], CreateEntityList.this.redistributionRequestedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[33], CreateEntityList.this.dupliacteLeadList);
                    responseWriter.writeList(responseFieldArr[34], CreateEntityList.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateEntityListMutation.CreateEntityList.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[35], CreateEntityList.this.chatMessagePlatform);
                    responseWriter.writeBoolean(responseFieldArr[36], CreateEntityList.this.allowMultiple);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[37], CreateEntityList.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], CreateEntityList.this.updatedAt);
                    ResponseField responseField3 = responseFieldArr[39];
                    AssociatedDistribution associatedDistribution = CreateEntityList.this.associatedDistribution;
                    ...
                    EntityActionDefinition entityActionDefinition = CreateEntityList.this.entityActionDefinition;
                    ...
                    Owner owner = CreateEntityList.this.owner;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createEntityList", "createEntityList", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final CreateEntityList createEntityList;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateEntityList.Mapper createEntityListFieldMapper = new CreateEntityList.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateEntityList) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateEntityList>() { // from class: com.amazonaws.amplify.generated.graphql.CreateEntityListMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateEntityList read(ResponseReader responseReader2) {
                        return Mapper.this.createEntityListFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateEntityList createEntityList) {
            this.createEntityList = createEntityList;
        }

        public CreateEntityList createEntityList() {
        ...
        public boolean equals(Object obj) {
            ...
            CreateEntityList createEntityList = this.createEntityList;
            CreateEntityList createEntityList2 = ((Data) obj).createEntityList;
            return createEntityList == null ? createEntityList2 == null : createEntityList.equals(createEntityList2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateEntityList createEntityList = this.createEntityList;
                this.$hashCode = (createEntityList == null ? 0 : createEntityList.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateEntityListMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateEntityList createEntityList = Data.this.createEntityList;
                    responseWriter.writeObject(responseField, createEntityList != null ? createEntityList.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createEntityList=" + this.createEntityList + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class EntityActionDefinition {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateEntityListMutation.EntityActionDefinition.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = EntityActionDefinition.$responseFields;
    ...
    public static class Owner {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateEntityListMutation.Owner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Owner.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final CreateEntityListInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateEntityListInput createEntityListInput, ModelEntityListConditionInput modelEntityListConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createEntityListInput;
            this.condition = modelEntityListConditionInput;
            linkedHashMap.put("input", createEntityListInput);
        ...
        public CreateEntityListInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateEntityListMutation.Variables.1
    ...
    public CreateEntityListMutation(CreateEntityListInput createEntityListInput, ModelEntityListConditionInput modelEntityListConditionInput) {
        Utils.checkNotNull(createEntityListInput, "input == null");
        this.variables = new Variables(createEntityListInput, modelEntityListConditionInput);
    }
    ...
    public String operationId() {
        return "d88f29b901045b76d9599d7b90a96254990657539ad2f1f9deda0bddae54fc68";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateEntityList($input: CreateEntityListInput!, $condition: ModelEntityListConditionInput) {\n  createEntityList(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    entityTypeInList\n    entityListType\n    listName\n    description\n    status\n    successfulCount\n    duplicateCount\n    invalidNumbersCount\n    invalidEmailCount\n    doNotTrackCount\n    otherFailedCount\n    ownerId\n    listCreationType\n    listCategory\n    rawBulkUploadFileRef\n    rawBulkUploadFileHash\n    modifiedBulkUploadFileRef\n    finalBulkUploadFileRef\n    leadSourceForBulkUpload\n    defaultCountryCode\n    defaultCountryIso\n    notificationBody\n    rule\n    toBeAssigned\n    assignedUserId\n    assignedTeamId\n    associatedDistributionId\n    entityActionDefinitionReference\n    redistributeEntities\n    redistributionRequestedAt\n    dupliacteLeadList\n    tags\n    chatMessagePlatform\n    allowMultiple\n    createdAt\n    updatedAt\n    associatedDistribution {\n      __typename\n      id\n      accountId\n      name\n      description\n      distributedEntityType\n      ifOwnerExists\n      assignLeadOwnerToTask\n      remeberAssigneeInDistributionScope\n      remeberAssigneeInGlobalScope\n      ownerId\n      distributionCreationType\n      createdAt\n      updatedAt\n    }\n    entityActionDefinition {\n      __typename\n      id\n      accountId\n      name\n      description\n      action\n      target\n      subscriptionType\n      periodicFrequency\n      periodicFrequencyUnit\n      startDateTime\n      endDateTime\n      status\n      ownerId\n      createdAt\n      updatedAt\n      createdBy\n      updatedBy\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
