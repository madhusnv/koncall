...
import type.ModelActivityLocationConditionInput;
import type.UpdateActivityLocationInput;
import type.UserRegistrationStatus;

/* loaded from: classes4.dex */
public final class UpdateActivityLocationMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation UpdateActivityLocation($input: UpdateActivityLocationInput!, $condition: ModelActivityLocationConditionInput) {\n  updateActivityLocation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.UpdateActivityLocationMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "UpdateActivityLocation";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation UpdateActivityLocation($input: UpdateActivityLocationInput!, $condition: ModelActivityLocationConditionInput) {\n  updateActivityLocation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelActivityLocationConditionInput condition;
        private UpdateActivityLocationInput input;

        public UpdateActivityLocationMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new UpdateActivityLocationMutation(this.input, this.condition);
        }

        public Builder condition(ModelActivityLocationConditionInput modelActivityLocationConditionInput) {
            this.condition = modelActivityLocationConditionInput;
            return this;
        }

        public Builder input(UpdateActivityLocationInput updateActivityLocationInput) {
            this.input = updateActivityLocationInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("updateActivityLocation", "updateActivityLocation", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final UpdateActivityLocation updateActivityLocation;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final UpdateActivityLocation.Mapper updateActivityLocationFieldMapper = new UpdateActivityLocation.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((UpdateActivityLocation) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<UpdateActivityLocation>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateActivityLocationMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdateActivityLocation read(ResponseReader responseReader2) {
                        return Mapper.this.updateActivityLocationFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(UpdateActivityLocation updateActivityLocation) {
            this.updateActivityLocation = updateActivityLocation;
        }
        ...
        public boolean equals(Object obj) {
            ...
            UpdateActivityLocation updateActivityLocation = this.updateActivityLocation;
            UpdateActivityLocation updateActivityLocation2 = ((Data) obj).updateActivityLocation;
            return updateActivityLocation == null ? updateActivityLocation2 == null : updateActivityLocation.equals(updateActivityLocation2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                UpdateActivityLocation updateActivityLocation = this.updateActivityLocation;
                this.$hashCode = (updateActivityLocation == null ? 0 : updateActivityLocation.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateActivityLocationMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    UpdateActivityLocation updateActivityLocation = Data.this.updateActivityLocation;
                    responseWriter.writeObject(responseField, updateActivityLocation != null ? updateActivityLocation.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{updateActivityLocation=" + this.updateActivityLocation + "}";
            }
            return this.$toString;
        }

        public UpdateActivityLocation updateActivityLocation() {
            return this.updateActivityLocation;
        }
    }

    public static class UpdateActivityLocation {
        ...
        public static final class Mapper implements ResponseFieldMapper<UpdateActivityLocation> {
            final User.Mapper userFieldMapper = new User.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public UpdateActivityLocation map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = UpdateActivityLocation.$responseFields;
                return new UpdateActivityLocation(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), responseReader.readString(responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[8]), (User) responseReader.readObject(responseFieldArr[9], new ResponseReader.ObjectReader<User>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateActivityLocationMutation.UpdateActivityLocation.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public UpdateActivityLocation(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, User user) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateActivityLocation)) {
                return false;
            }
            UpdateActivityLocation updateActivityLocation = (UpdateActivityLocation) obj;
            if (this.__typename.equals(updateActivityLocation.__typename) && this.id.equals(updateActivityLocation.id) && this.accountId.equals(updateActivityLocation.accountId) && ((str = this.engagementId) != null ? str.equals(updateActivityLocation.engagementId) : updateActivityLocation.engagementId == null) && ((str2 = this.lat) != null ? str2.equals(updateActivityLocation.lat) : updateActivityLocation.lat == null) && ((str3 = this.lng) != null ? str3.equals(updateActivityLocation.lng) : updateActivityLocation.lng == null) && this.ownerId.equals(updateActivityLocation.ownerId) && ((str4 = this.createdAt) != null ? str4.equals(updateActivityLocation.createdAt) : updateActivityLocation.createdAt == null) && ((str5 = this.updatedAt) != null ? str5.equals(updateActivityLocation.updatedAt) : updateActivityLocation.updatedAt == null)) {
                User user = this.user;
                User user2 = updateActivityLocation.user;
                if (user == null) {
                    if (user2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateActivityLocationMutation.UpdateActivityLocation.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdateActivityLocation.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UpdateActivityLocation.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], UpdateActivityLocation.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], UpdateActivityLocation.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], UpdateActivityLocation.this.engagementId);
                    responseWriter.writeString(responseFieldArr[4], UpdateActivityLocation.this.lat);
                    responseWriter.writeString(responseFieldArr[5], UpdateActivityLocation.this.lng);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], UpdateActivityLocation.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], UpdateActivityLocation.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], UpdateActivityLocation.this.updatedAt);
                    ResponseField responseField = responseFieldArr[9];
                    User user = UpdateActivityLocation.this.user;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "UpdateActivityLocation{__typename=" + this.__typename + ", id=" + this.id + ", accountId=" + this.accountId + ", engagementId=" + this.engagementId + ", lat=" + this.lat + ", lng=" + this.lng + ", ownerId=" + this.ownerId + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", user=" + this.user + "}";
            }
            return this.$toString;
        }
    ...
    public static class User {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateActivityLocationMutation.User.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = User.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        private final ModelActivityLocationConditionInput condition;
        private final UpdateActivityLocationInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(UpdateActivityLocationInput updateActivityLocationInput, ModelActivityLocationConditionInput modelActivityLocationConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = updateActivityLocationInput;
            this.condition = modelActivityLocationConditionInput;
            linkedHashMap.put("input", updateActivityLocationInput);
            linkedHashMap.put("condition", modelActivityLocationConditionInput);
        }

        public ModelActivityLocationConditionInput condition() {
            return this.condition;
        }

        public UpdateActivityLocationInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateActivityLocationMutation.Variables.1
    ...
    public UpdateActivityLocationMutation(UpdateActivityLocationInput updateActivityLocationInput, ModelActivityLocationConditionInput modelActivityLocationConditionInput) {
        Utils.checkNotNull(updateActivityLocationInput, "input == null");
        this.variables = new Variables(updateActivityLocationInput, modelActivityLocationConditionInput);
    }
    ...
    public String operationId() {
        return "d90f1fc122ae266aa145bfbf4d09832beb6695540822ab2a8f9550ee9fa9eb01";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation UpdateActivityLocation($input: UpdateActivityLocationInput!, $condition: ModelActivityLocationConditionInput) {\n  updateActivityLocation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
