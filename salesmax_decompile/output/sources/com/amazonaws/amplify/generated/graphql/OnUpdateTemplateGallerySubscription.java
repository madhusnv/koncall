...
public final class OnUpdateTemplateGallerySubscription implements Subscription<Data, Data, Operation.Variables> {
    public static final String OPERATION_DEFINITION = "subscription OnUpdateTemplateGallery {\n  onUpdateTemplateGallery {\n    __typename\n    id\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    categoryLevelOne\n    categoryLevelTwo\n    applicableForIndustry\n    viewedTimes\n    savedToWorkspaceTimes\n    sentToWhatsappTimes\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "OnUpdateTemplateGallery";
        }
    };
    public static final String QUERY_DOCUMENT = "subscription OnUpdateTemplateGallery {\n  onUpdateTemplateGallery {\n    __typename\n    id\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    categoryLevelOne\n    categoryLevelTwo\n    applicableForIndustry\n    viewedTimes\n    savedToWorkspaceTimes\n    sentToWhatsappTimes\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Operation.Variables variables = Operation.EMPTY_VARIABLES;

    public static final class Builder {
        public OnUpdateTemplateGallerySubscription build() {
            return new OnUpdateTemplateGallerySubscription();
        }
    }
    ...
    public static class Component {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.Component.1
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("onUpdateTemplateGallery", "onUpdateTemplateGallery", null, true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnUpdateTemplateGallery onUpdateTemplateGallery;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final OnUpdateTemplateGallery.Mapper onUpdateTemplateGalleryFieldMapper = new OnUpdateTemplateGallery.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((OnUpdateTemplateGallery) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<OnUpdateTemplateGallery>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public OnUpdateTemplateGallery read(ResponseReader responseReader2) {
                        return Mapper.this.onUpdateTemplateGalleryFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(OnUpdateTemplateGallery onUpdateTemplateGallery) {
            this.onUpdateTemplateGallery = onUpdateTemplateGallery;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnUpdateTemplateGallery onUpdateTemplateGallery = this.onUpdateTemplateGallery;
            OnUpdateTemplateGallery onUpdateTemplateGallery2 = ((Data) obj).onUpdateTemplateGallery;
            return onUpdateTemplateGallery == null ? onUpdateTemplateGallery2 == null : onUpdateTemplateGallery.equals(onUpdateTemplateGallery2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnUpdateTemplateGallery onUpdateTemplateGallery = this.onUpdateTemplateGallery;
                this.$hashCode = (onUpdateTemplateGallery == null ? 0 : onUpdateTemplateGallery.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    OnUpdateTemplateGallery onUpdateTemplateGallery = Data.this.onUpdateTemplateGallery;
                    responseWriter.writeObject(responseField, onUpdateTemplateGallery != null ? onUpdateTemplateGallery.marshaller() : null);
                }
            };
        }

        public OnUpdateTemplateGallery onUpdateTemplateGallery() {
            return this.onUpdateTemplateGallery;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onUpdateTemplateGallery=" + this.onUpdateTemplateGallery + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class DefaultMedia {
        ...
        public static final class Mapper implements ResponseFieldMapper<DefaultMedia> {
            ...
            public DefaultMedia map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[9], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.DefaultMedia.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.DefaultMedia.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultMedia.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[9], DefaultMedia.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.DefaultMedia.1.1
    ...
    public static class DefaultVariableMap {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.DefaultVariableMap.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultVariableMap.$responseFields;
    ...
    public static class OnUpdateTemplateGallery {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<OnUpdateTemplateGallery> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public OnUpdateTemplateGallery map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = OnUpdateTemplateGallery.$responseFields;
                return new OnUpdateTemplateGallery(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), responseReader.readString(responseFieldArr[2]), responseReader.readString(responseFieldArr[3]), responseReader.readList(responseFieldArr[4], new ResponseReader.ListReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.OnUpdateTemplateGallery.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Component read(ResponseReader.ListItemReader listItemReader) {
                        return (Component) listItemReader.readObject(new ResponseReader.ObjectReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.OnUpdateTemplateGallery.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    ...
                    public DefaultVariableMap read(ResponseReader.ListItemReader listItemReader) {
                        return (DefaultVariableMap) listItemReader.readObject(new ResponseReader.ObjectReader<DefaultVariableMap>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.OnUpdateTemplateGallery.Mapper.2.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), responseReader.readString(responseFieldArr[14]), responseReader.readList(responseFieldArr[15], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.OnUpdateTemplateGallery.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                }), responseReader.readString(responseFieldArr[16]), responseReader.readString(responseFieldArr[17]), responseReader.readList(responseFieldArr[18], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.OnUpdateTemplateGallery.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
        ...
        public OnUpdateTemplateGallery(String str, String str2, String str3, String str4, List<Component> list, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, List<DefaultVariableMap> list2, String str13, List<String> list3, String str14, String str15, List<String> list4, Integer num, Integer num2, Integer num3, String str16, String str17, DefaultMedia defaultMedia) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.platform = str3;
            this.name = str4;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnUpdateTemplateGallery)) {
                return false;
            }
            OnUpdateTemplateGallery onUpdateTemplateGallery = (OnUpdateTemplateGallery) obj;
            if (this.__typename.equals(onUpdateTemplateGallery.__typename) && this.id.equals(onUpdateTemplateGallery.id) && ((str = this.platform) != null ? str.equals(onUpdateTemplateGallery.platform) : onUpdateTemplateGallery.platform == null) && ((str2 = this.name) != null ? str2.equals(onUpdateTemplateGallery.name) : onUpdateTemplateGallery.name == null) && ((list = this.components) != null ? list.equals(onUpdateTemplateGallery.components) : onUpdateTemplateGallery.components == null) && ((str3 = this.language) != null ? str3.equals(onUpdateTemplateGallery.language) : onUpdateTemplateGallery.language == null) && ((str4 = this.status) != null ? str4.equals(onUpdateTemplateGallery.status) : onUpdateTemplateGallery.status == null) && ((str5 = this.category) != null ? str5.equals(onUpdateTemplateGallery.category) : onUpdateTemplateGallery.category == null) && ((str6 = this.createdBy) != null ? str6.equals(onUpdateTemplateGallery.createdBy) : onUpdateTemplateGallery.createdBy == null) && ((str7 = this.updatedBy) != null ? str7.equals(onUpdateTemplateGallery.updatedBy) : onUpdateTemplateGallery.updatedBy == null) && ((str8 = this.archivedStatus) != null ? str8.equals(onUpdateTemplateGallery.archivedStatus) : onUpdateTemplateGallery.archivedStatus == null) && ((str9 = this.archivedAt) != null ? str9.equals(onUpdateTemplateGallery.archivedAt) : onUpdateTemplateGallery.archivedAt == null) && ((str10 = this.defaultMediaId) != null ? str10.equals(onUpdateTemplateGallery.defaultMediaId) : onUpdateTemplateGallery.defaultMediaId == null) && ((list2 = this.defaultVariableMap) != null ? list2.equals(onUpdateTemplateGallery.defaultVariableMap) : onUpdateTemplateGallery.defaultVariableMap == null) && ((str11 = this.templateId) != null ? str11.equals(onUpdateTemplateGallery.templateId) : onUpdateTemplateGallery.templateId == null) && ((list3 = this.tags) != null ? list3.equals(onUpdateTemplateGallery.tags) : onUpdateTemplateGallery.tags == null) && ((str12 = this.categoryLevelOne) != null ? str12.equals(onUpdateTemplateGallery.categoryLevelOne) : onUpdateTemplateGallery.categoryLevelOne == null) && ((str13 = this.categoryLevelTwo) != null ? str13.equals(onUpdateTemplateGallery.categoryLevelTwo) : onUpdateTemplateGallery.categoryLevelTwo == null) && ((list4 = this.applicableForIndustry) != null ? list4.equals(onUpdateTemplateGallery.applicableForIndustry) : onUpdateTemplateGallery.applicableForIndustry == null) && ((num = this.viewedTimes) != null ? num.equals(onUpdateTemplateGallery.viewedTimes) : onUpdateTemplateGallery.viewedTimes == null) && ((num2 = this.savedToWorkspaceTimes) != null ? num2.equals(onUpdateTemplateGallery.savedToWorkspaceTimes) : onUpdateTemplateGallery.savedToWorkspaceTimes == null) && ((num3 = this.sentToWhatsappTimes) != null ? num3.equals(onUpdateTemplateGallery.sentToWhatsappTimes) : onUpdateTemplateGallery.sentToWhatsappTimes == null) && ((str14 = this.createdAt) != null ? str14.equals(onUpdateTemplateGallery.createdAt) : onUpdateTemplateGallery.createdAt == null) && ((str15 = this.updatedAt) != null ? str15.equals(onUpdateTemplateGallery.updatedAt) : onUpdateTemplateGallery.updatedAt == null)) {
                DefaultMedia defaultMedia = this.defaultMedia;
                DefaultMedia defaultMedia2 = onUpdateTemplateGallery.defaultMedia;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.OnUpdateTemplateGallery.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = OnUpdateTemplateGallery.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], OnUpdateTemplateGallery.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], OnUpdateTemplateGallery.this.id);
                    responseWriter.writeString(responseFieldArr[2], OnUpdateTemplateGallery.this.platform);
                    responseWriter.writeString(responseFieldArr[3], OnUpdateTemplateGallery.this.name);
                    responseWriter.writeList(responseFieldArr[4], OnUpdateTemplateGallery.this.components, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.OnUpdateTemplateGallery.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Component) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[5], OnUpdateTemplateGallery.this.language);
                    responseWriter.writeString(responseFieldArr[6], OnUpdateTemplateGallery.this.status);
                    responseWriter.writeString(responseFieldArr[7], OnUpdateTemplateGallery.this.category);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], OnUpdateTemplateGallery.this.createdBy);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], OnUpdateTemplateGallery.this.updatedBy);
                    responseWriter.writeString(responseFieldArr[10], OnUpdateTemplateGallery.this.archivedStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], OnUpdateTemplateGallery.this.archivedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], OnUpdateTemplateGallery.this.defaultMediaId);
                    responseWriter.writeList(responseFieldArr[13], OnUpdateTemplateGallery.this.defaultVariableMap, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.OnUpdateTemplateGallery.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((DefaultVariableMap) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[14], OnUpdateTemplateGallery.this.templateId);
                    responseWriter.writeList(responseFieldArr[15], OnUpdateTemplateGallery.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.OnUpdateTemplateGallery.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[16], OnUpdateTemplateGallery.this.categoryLevelOne);
                    responseWriter.writeString(responseFieldArr[17], OnUpdateTemplateGallery.this.categoryLevelTwo);
                    responseWriter.writeList(responseFieldArr[18], OnUpdateTemplateGallery.this.applicableForIndustry, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateTemplateGallerySubscription.OnUpdateTemplateGallery.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeInt(responseFieldArr[19], OnUpdateTemplateGallery.this.viewedTimes);
                    responseWriter.writeInt(responseFieldArr[20], OnUpdateTemplateGallery.this.savedToWorkspaceTimes);
                    responseWriter.writeInt(responseFieldArr[21], OnUpdateTemplateGallery.this.sentToWhatsappTimes);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], OnUpdateTemplateGallery.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], OnUpdateTemplateGallery.this.updatedAt);
                    ResponseField responseField = responseFieldArr[24];
                    DefaultMedia defaultMedia = OnUpdateTemplateGallery.this.defaultMedia;
    ...
    public String operationId() {
        return "eeff26be839492bd3efb3c7beaab7df0fabeb0995fa46e545e808ab3548faf56";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "subscription OnUpdateTemplateGallery {\n  onUpdateTemplateGallery {\n    __typename\n    id\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    categoryLevelOne\n    categoryLevelTwo\n    applicableForIndustry\n    viewedTimes\n    savedToWorkspaceTimes\n    sentToWhatsappTimes\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
