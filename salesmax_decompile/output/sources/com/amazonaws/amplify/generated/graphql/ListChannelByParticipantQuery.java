...
public final class ListChannelByParticipantQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListChannelByParticipant($accountId: ID, $participantIdUpdatedAt: ModelChatParticipantChannelByParticipantCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelChatParticipantFilterInput, $limit: Int, $nextToken: String) {\n  listChannelByParticipant(accountId: $accountId, participantIdUpdatedAt: $participantIdUpdatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      channelId\n      phoneNumberIdExternal\n      participantId\n      participationStatus\n      unreadMessageCount\n      lastViewed\n      isStarred\n      joinedAt\n      leftAt\n      channelName\n      channelType\n      channelSubType\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      isNewMessageUpdate\n      tags\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListChannelByParticipantQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListChannelByParticipant";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListChannelByParticipant($accountId: ID, $participantIdUpdatedAt: ModelChatParticipantChannelByParticipantCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelChatParticipantFilterInput, $limit: Int, $nextToken: String) {\n  listChannelByParticipant(accountId: $accountId, participantIdUpdatedAt: $participantIdUpdatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      channelId\n      phoneNumberIdExternal\n      participantId\n      participationStatus\n      unreadMessageCount\n      lastViewed\n      isStarred\n      joinedAt\n      leftAt\n      channelName\n      channelType\n      channelSubType\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      isNewMessageUpdate\n      tags\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        private C19063x745baff2 participantIdUpdatedAt;
        ...
        public ListChannelByParticipantQuery build() {
            return new ListChannelByParticipantQuery(this.accountId, this.participantIdUpdatedAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
        ...
        public Builder participantIdUpdatedAt(C19063x745baff2 c19063x745baff2) {
            this.participantIdUpdatedAt = c19063x745baff2;
            return this;
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listChannelByParticipant", "listChannelByParticipant", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put("participantIdUpdatedAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "participantIdUpdatedAt").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListChannelByParticipant listChannelByParticipant;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListChannelByParticipant.Mapper listChannelByParticipantFieldMapper = new ListChannelByParticipant.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListChannelByParticipant) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListChannelByParticipant>() { // from class: com.amazonaws.amplify.generated.graphql.ListChannelByParticipantQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListChannelByParticipant read(ResponseReader responseReader2) {
                        return Mapper.this.listChannelByParticipantFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListChannelByParticipant listChannelByParticipant) {
            this.listChannelByParticipant = listChannelByParticipant;
        }
        ...
        public boolean equals(Object obj) {
            ...
            ListChannelByParticipant listChannelByParticipant = this.listChannelByParticipant;
            ListChannelByParticipant listChannelByParticipant2 = ((Data) obj).listChannelByParticipant;
            return listChannelByParticipant == null ? listChannelByParticipant2 == null : listChannelByParticipant.equals(listChannelByParticipant2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListChannelByParticipant listChannelByParticipant = this.listChannelByParticipant;
                this.$hashCode = (listChannelByParticipant == null ? 0 : listChannelByParticipant.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListChannelByParticipant listChannelByParticipant() {
            return this.listChannelByParticipant;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListChannelByParticipantQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListChannelByParticipant listChannelByParticipant = Data.this.listChannelByParticipant;
                    responseWriter.writeObject(responseField, listChannelByParticipant != null ? listChannelByParticipant.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listChannelByParticipant=" + this.listChannelByParticipant + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListChannelByParticipantQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[24], Item.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListChannelByParticipantQuery.Item.1.1
    ...
    public static class ListChannelByParticipant {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListChannelByParticipant> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListChannelByParticipant map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListChannelByParticipant.$responseFields;
                return new ListChannelByParticipant(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListChannelByParticipantQuery.ListChannelByParticipant.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListChannelByParticipantQuery.ListChannelByParticipant.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListChannelByParticipant(String str, List<Item> list, String str2) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListChannelByParticipant)) {
                return false;
            }
            ListChannelByParticipant listChannelByParticipant = (ListChannelByParticipant) obj;
            if (this.__typename.equals(listChannelByParticipant.__typename) && this.items.equals(listChannelByParticipant.items)) {
                String str = this.nextToken;
                String str2 = listChannelByParticipant.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListChannelByParticipantQuery.ListChannelByParticipant.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListChannelByParticipant.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListChannelByParticipant.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListChannelByParticipant.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListChannelByParticipantQuery.ListChannelByParticipant.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListChannelByParticipant.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListChannelByParticipant{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final C19063x745baff2 participantIdUpdatedAt;
        private final ModelSortDirection sortDirection;
        private final transient Map<String, Object> valueMap;

        public Variables(String str, C19063x745baff2 c19063x745baff2, ModelSortDirection modelSortDirection, ModelChatParticipantFilterInput modelChatParticipantFilterInput, Integer num, String str2) {
            ...
            linkedHashMap.put("participantIdUpdatedAt", c19063x745baff2);
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListChannelByParticipantQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("accountId", Variables.this.accountId);
                    inputFieldWriter.writeObject("participantIdUpdatedAt", Variables.this.participantIdUpdatedAt != null ? Variables.this.participantIdUpdatedAt.marshaller() : null);
        ...
        public C19063x745baff2 participantIdUpdatedAt() {
            return this.participantIdUpdatedAt;
        }
    ...
    public ListChannelByParticipantQuery(String str, C19063x745baff2 c19063x745baff2, ModelSortDirection modelSortDirection, ModelChatParticipantFilterInput modelChatParticipantFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, c19063x745baff2, modelSortDirection, modelChatParticipantFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "4bb6a8dadc99062aca5dd08ef56da27b8bd7afe5c2a5f4e30d4b5bd4b5d6d622";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListChannelByParticipant($accountId: ID, $participantIdUpdatedAt: ModelChatParticipantChannelByParticipantCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelChatParticipantFilterInput, $limit: Int, $nextToken: String) {\n  listChannelByParticipant(accountId: $accountId, participantIdUpdatedAt: $participantIdUpdatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      channelId\n      phoneNumberIdExternal\n      participantId\n      participationStatus\n      unreadMessageCount\n      lastViewed\n      isStarred\n      joinedAt\n      leftAt\n      channelName\n      channelType\n      channelSubType\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      isNewMessageUpdate\n      tags\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
