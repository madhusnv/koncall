...
public final class CheckParticipantInAChannelQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query CheckParticipantInAChannel($channelId: ID, $participantId: ModelIDKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelChatParticipantFilterInput, $limit: Int, $nextToken: String) {\n  checkParticipantInAChannel(channelId: $channelId, participantId: $participantId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      channelId\n      phoneNumberIdExternal\n      participantId\n      participationStatus\n      unreadMessageCount\n      lastViewed\n      isStarred\n      joinedAt\n      leftAt\n      channelName\n      channelType\n      channelSubType\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      isNewMessageUpdate\n      tags\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.CheckParticipantInAChannelQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "CheckParticipantInAChannel";
        }
    };
    public static final String QUERY_DOCUMENT = "query CheckParticipantInAChannel($channelId: ID, $participantId: ModelIDKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelChatParticipantFilterInput, $limit: Int, $nextToken: String) {\n  checkParticipantInAChannel(channelId: $channelId, participantId: $participantId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      channelId\n      phoneNumberIdExternal\n      participantId\n      participationStatus\n      unreadMessageCount\n      lastViewed\n      isStarred\n      joinedAt\n      leftAt\n      channelName\n      channelType\n      channelSubType\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      isNewMessageUpdate\n      tags\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        private ModelIDKeyConditionInput participantId;
        private ModelSortDirection sortDirection;

        public CheckParticipantInAChannelQuery build() {
            return new CheckParticipantInAChannelQuery(this.channelId, this.participantId, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
        ...
        public Builder participantId(ModelIDKeyConditionInput modelIDKeyConditionInput) {
            this.participantId = modelIDKeyConditionInput;
            return this;
        }
    ...
    public static class CheckParticipantInAChannel {
        ...
        public static final class Mapper implements ResponseFieldMapper<CheckParticipantInAChannel> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public CheckParticipantInAChannel map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = CheckParticipantInAChannel.$responseFields;
                return new CheckParticipantInAChannel(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.CheckParticipantInAChannelQuery.CheckParticipantInAChannel.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.CheckParticipantInAChannelQuery.CheckParticipantInAChannel.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
        ...
        public CheckParticipantInAChannel(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CheckParticipantInAChannel)) {
                return false;
            }
            CheckParticipantInAChannel checkParticipantInAChannel = (CheckParticipantInAChannel) obj;
            if (this.__typename.equals(checkParticipantInAChannel.__typename) && this.items.equals(checkParticipantInAChannel.items)) {
                String str = this.nextToken;
                String str2 = checkParticipantInAChannel.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CheckParticipantInAChannelQuery.CheckParticipantInAChannel.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CheckParticipantInAChannel.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CheckParticipantInAChannel.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], CheckParticipantInAChannel.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CheckParticipantInAChannelQuery.CheckParticipantInAChannel.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], CheckParticipantInAChannel.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "CheckParticipantInAChannel{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("checkParticipantInAChannel", "checkParticipantInAChannel", new UnmodifiableMapBuilder(6).put("participantId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "participantId").build()).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("channelId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "channelId").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final CheckParticipantInAChannel checkParticipantInAChannel;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CheckParticipantInAChannel.Mapper checkParticipantInAChannelFieldMapper = new CheckParticipantInAChannel.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CheckParticipantInAChannel) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CheckParticipantInAChannel>() { // from class: com.amazonaws.amplify.generated.graphql.CheckParticipantInAChannelQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CheckParticipantInAChannel read(ResponseReader responseReader2) {
                        return Mapper.this.checkParticipantInAChannelFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CheckParticipantInAChannel checkParticipantInAChannel) {
            this.checkParticipantInAChannel = checkParticipantInAChannel;
        }

        public CheckParticipantInAChannel checkParticipantInAChannel() {
            return this.checkParticipantInAChannel;
        }
        ...
        public boolean equals(Object obj) {
            ...
            CheckParticipantInAChannel checkParticipantInAChannel = this.checkParticipantInAChannel;
            CheckParticipantInAChannel checkParticipantInAChannel2 = ((Data) obj).checkParticipantInAChannel;
            return checkParticipantInAChannel == null ? checkParticipantInAChannel2 == null : checkParticipantInAChannel.equals(checkParticipantInAChannel2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CheckParticipantInAChannel checkParticipantInAChannel = this.checkParticipantInAChannel;
                this.$hashCode = (checkParticipantInAChannel == null ? 0 : checkParticipantInAChannel.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CheckParticipantInAChannelQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CheckParticipantInAChannel checkParticipantInAChannel = Data.this.checkParticipantInAChannel;
                    responseWriter.writeObject(responseField, checkParticipantInAChannel != null ? checkParticipantInAChannel.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{checkParticipantInAChannel=" + this.checkParticipantInAChannel + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CheckParticipantInAChannelQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[24], Item.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CheckParticipantInAChannelQuery.Item.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final ModelIDKeyConditionInput participantId;
        private final ModelSortDirection sortDirection;
        private final transient Map<String, Object> valueMap;

        public Variables(String str, ModelIDKeyConditionInput modelIDKeyConditionInput, ModelSortDirection modelSortDirection, ModelChatParticipantFilterInput modelChatParticipantFilterInput, Integer num, String str2) {
            ...
            linkedHashMap.put("participantId", modelIDKeyConditionInput);
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CheckParticipantInAChannelQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("channelId", Variables.this.channelId);
                    inputFieldWriter.writeObject("participantId", Variables.this.participantId != null ? Variables.this.participantId.marshaller() : null);
        ...
        public ModelIDKeyConditionInput participantId() {
            return this.participantId;
        }
    ...
    public CheckParticipantInAChannelQuery(String str, ModelIDKeyConditionInput modelIDKeyConditionInput, ModelSortDirection modelSortDirection, ModelChatParticipantFilterInput modelChatParticipantFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelIDKeyConditionInput, modelSortDirection, modelChatParticipantFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "d646e88bc45932b2d0eab171cc4190c768f0fae1df402b9f14d02d450a72188e";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query CheckParticipantInAChannel($channelId: ID, $participantId: ModelIDKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelChatParticipantFilterInput, $limit: Int, $nextToken: String) {\n  checkParticipantInAChannel(channelId: $channelId, participantId: $participantId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      channelId\n      phoneNumberIdExternal\n      participantId\n      participationStatus\n      unreadMessageCount\n      lastViewed\n      isStarred\n      joinedAt\n      leftAt\n      channelName\n      channelType\n      channelSubType\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      isNewMessageUpdate\n      tags\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
