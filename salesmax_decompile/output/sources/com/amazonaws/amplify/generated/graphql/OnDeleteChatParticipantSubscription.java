...
public final class OnDeleteChatParticipantSubscription implements Subscription<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "subscription OnDeleteChatParticipant($accountId: ID!, $participantId: ID!) {\n  onDeleteChatParticipant(accountId: $accountId, participantId: $participantId) {\n    __typename\n    id\n    accountId\n    channelId\n    phoneNumberIdExternal\n    participantId\n    participationStatus\n    unreadMessageCount\n    lastViewed\n    isStarred\n    joinedAt\n    leftAt\n    channelName\n    channelType\n    channelSubType\n    channelStatus\n    channelWillBeChargedNext\n    channelOpenUntil\n    lastMessageByLeadTime\n    lastMessageByUserTime\n    isLastMessageByLead\n    lastOutboundMessageId\n    lastOutboundMessageStatus\n    isNewMessageUpdate\n    tags\n    participantScopeIfInternal\n    userIdsForDirectChannel\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    participant {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteChatParticipantSubscription.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "OnDeleteChatParticipant";
        }
    };
    public static final String QUERY_DOCUMENT = "subscription OnDeleteChatParticipant($accountId: ID!, $participantId: ID!) {\n  onDeleteChatParticipant(accountId: $accountId, participantId: $participantId) {\n    __typename\n    id\n    accountId\n    channelId\n    phoneNumberIdExternal\n    participantId\n    participationStatus\n    unreadMessageCount\n    lastViewed\n    isStarred\n    joinedAt\n    leftAt\n    channelName\n    channelType\n    channelSubType\n    channelStatus\n    channelWillBeChargedNext\n    channelOpenUntil\n    lastMessageByLeadTime\n    lastMessageByUserTime\n    isLastMessageByLead\n    lastOutboundMessageId\n    lastOutboundMessageStatus\n    isNewMessageUpdate\n    tags\n    participantScopeIfInternal\n    userIdsForDirectChannel\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    participant {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    ...
    public static final class Builder {
        ...
        public OnDeleteChatParticipantSubscription build() {
            Utils.checkNotNull(this.accountId, "accountId == null");
            Utils.checkNotNull(this.participantId, "participantId == null");
            return new OnDeleteChatParticipantSubscription(this.accountId, this.participantId);
        }
    ...
    public static class Channel {
        ...
        public static final class Mapper implements ResponseFieldMapper<Channel> {
            ...
            public Channel map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[6], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteChatParticipantSubscription.Channel.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteChatParticipantSubscription.Channel.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[6], Channel.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteChatParticipantSubscription.Channel.1.1
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("onDeleteChatParticipant", "onDeleteChatParticipant", new UnmodifiableMapBuilder(2).put("participantId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "participantId").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnDeleteChatParticipant onDeleteChatParticipant;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final OnDeleteChatParticipant.Mapper onDeleteChatParticipantFieldMapper = new OnDeleteChatParticipant.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((OnDeleteChatParticipant) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<OnDeleteChatParticipant>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteChatParticipantSubscription.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public OnDeleteChatParticipant read(ResponseReader responseReader2) {
                        return Mapper.this.onDeleteChatParticipantFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(OnDeleteChatParticipant onDeleteChatParticipant) {
            this.onDeleteChatParticipant = onDeleteChatParticipant;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnDeleteChatParticipant onDeleteChatParticipant = this.onDeleteChatParticipant;
            OnDeleteChatParticipant onDeleteChatParticipant2 = ((Data) obj).onDeleteChatParticipant;
            return onDeleteChatParticipant == null ? onDeleteChatParticipant2 == null : onDeleteChatParticipant.equals(onDeleteChatParticipant2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnDeleteChatParticipant onDeleteChatParticipant = this.onDeleteChatParticipant;
                this.$hashCode = (onDeleteChatParticipant == null ? 0 : onDeleteChatParticipant.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteChatParticipantSubscription.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    OnDeleteChatParticipant onDeleteChatParticipant = Data.this.onDeleteChatParticipant;
                    responseWriter.writeObject(responseField, onDeleteChatParticipant != null ? onDeleteChatParticipant.marshaller() : null);
                }
            };
        }

        public OnDeleteChatParticipant onDeleteChatParticipant() {
            return this.onDeleteChatParticipant;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onDeleteChatParticipant=" + this.onDeleteChatParticipant + "}";
            }
            return this.$toString;
        }
    }

    public static class OnDeleteChatParticipant {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnDeleteChatParticipant)) {
                return false;
            }
            OnDeleteChatParticipant onDeleteChatParticipant = (OnDeleteChatParticipant) obj;
            if (this.__typename.equals(onDeleteChatParticipant.__typename) && this.id.equals(onDeleteChatParticipant.id) && this.accountId.equals(onDeleteChatParticipant.accountId) && this.channelId.equals(onDeleteChatParticipant.channelId) && ((str = this.phoneNumberIdExternal) != null ? str.equals(onDeleteChatParticipant.phoneNumberIdExternal) : onDeleteChatParticipant.phoneNumberIdExternal == null) && this.participantId.equals(onDeleteChatParticipant.participantId) && this.participationStatus.equals(onDeleteChatParticipant.participationStatus) && ((num = this.unreadMessageCount) != null ? num.equals(onDeleteChatParticipant.unreadMessageCount) : onDeleteChatParticipant.unreadMessageCount == null) && ((str2 = this.lastViewed) != null ? str2.equals(onDeleteChatParticipant.lastViewed) : onDeleteChatParticipant.lastViewed == null) && ((bool = this.isStarred) != null ? bool.equals(onDeleteChatParticipant.isStarred) : onDeleteChatParticipant.isStarred == null) && ((str3 = this.joinedAt) != null ? str3.equals(onDeleteChatParticipant.joinedAt) : onDeleteChatParticipant.joinedAt == null) && ((str4 = this.leftAt) != null ? str4.equals(onDeleteChatParticipant.leftAt) : onDeleteChatParticipant.leftAt == null) && ((str5 = this.channelName) != null ? str5.equals(onDeleteChatParticipant.channelName) : onDeleteChatParticipant.channelName == null) && ((str6 = this.channelType) != null ? str6.equals(onDeleteChatParticipant.channelType) : onDeleteChatParticipant.channelType == null) && ((str7 = this.channelSubType) != null ? str7.equals(onDeleteChatParticipant.channelSubType) : onDeleteChatParticipant.channelSubType == null) && ((str8 = this.channelStatus) != null ? str8.equals(onDeleteChatParticipant.channelStatus) : onDeleteChatParticipant.channelStatus == null) && ((str9 = this.channelWillBeChargedNext) != null ? str9.equals(onDeleteChatParticipant.channelWillBeChargedNext) : onDeleteChatParticipant.channelWillBeChargedNext == null) && ((str10 = this.channelOpenUntil) != null ? str10.equals(onDeleteChatParticipant.channelOpenUntil) : onDeleteChatParticipant.channelOpenUntil == null) && ((str11 = this.lastMessageByLeadTime) != null ? str11.equals(onDeleteChatParticipant.lastMessageByLeadTime) : onDeleteChatParticipant.lastMessageByLeadTime == null) && ((str12 = this.lastMessageByUserTime) != null ? str12.equals(onDeleteChatParticipant.lastMessageByUserTime) : onDeleteChatParticipant.lastMessageByUserTime == null) && ((bool2 = this.isLastMessageByLead) != null ? bool2.equals(onDeleteChatParticipant.isLastMessageByLead) : onDeleteChatParticipant.isLastMessageByLead == null) && ((str13 = this.lastOutboundMessageId) != null ? str13.equals(onDeleteChatParticipant.lastOutboundMessageId) : onDeleteChatParticipant.lastOutboundMessageId == null) && ((str14 = this.lastOutboundMessageStatus) != null ? str14.equals(onDeleteChatParticipant.lastOutboundMessageStatus) : onDeleteChatParticipant.lastOutboundMessageStatus == null) && ((bool3 = this.isNewMessageUpdate) != null ? bool3.equals(onDeleteChatParticipant.isNewMessageUpdate) : onDeleteChatParticipant.isNewMessageUpdate == null) && ((list = this.tags) != null ? list.equals(onDeleteChatParticipant.tags) : onDeleteChatParticipant.tags == null) && ((str15 = this.participantScopeIfInternal) != null ? str15.equals(onDeleteChatParticipant.participantScopeIfInternal) : onDeleteChatParticipant.participantScopeIfInternal == null) && ((str16 = this.userIdsForDirectChannel) != null ? str16.equals(onDeleteChatParticipant.userIdsForDirectChannel) : onDeleteChatParticipant.userIdsForDirectChannel == null) && ((str17 = this.createdAt) != null ? str17.equals(onDeleteChatParticipant.createdAt) : onDeleteChatParticipant.createdAt == null) && ((str18 = this.updatedAt) != null ? str18.equals(onDeleteChatParticipant.updatedAt) : onDeleteChatParticipant.updatedAt == null) && ((channel = this.channel) != null ? channel.equals(onDeleteChatParticipant.channel) : onDeleteChatParticipant.channel == null)) {
                Participant participant = this.participant;
                Participant participant2 = onDeleteChatParticipant.participant;
                if (participant == null) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteChatParticipantSubscription.OnDeleteChatParticipant.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = OnDeleteChatParticipant.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], OnDeleteChatParticipant.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], OnDeleteChatParticipant.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], OnDeleteChatParticipant.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], OnDeleteChatParticipant.this.channelId);
                    responseWriter.writeString(responseFieldArr[4], OnDeleteChatParticipant.this.phoneNumberIdExternal);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], OnDeleteChatParticipant.this.participantId);
                    responseWriter.writeString(responseFieldArr[6], OnDeleteChatParticipant.this.participationStatus);
                    responseWriter.writeInt(responseFieldArr[7], OnDeleteChatParticipant.this.unreadMessageCount);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], OnDeleteChatParticipant.this.lastViewed);
                    responseWriter.writeBoolean(responseFieldArr[9], OnDeleteChatParticipant.this.isStarred);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[10], OnDeleteChatParticipant.this.joinedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], OnDeleteChatParticipant.this.leftAt);
                    responseWriter.writeString(responseFieldArr[12], OnDeleteChatParticipant.this.channelName);
                    responseWriter.writeString(responseFieldArr[13], OnDeleteChatParticipant.this.channelType);
                    responseWriter.writeString(responseFieldArr[14], OnDeleteChatParticipant.this.channelSubType);
                    responseWriter.writeString(responseFieldArr[15], OnDeleteChatParticipant.this.channelStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], OnDeleteChatParticipant.this.channelWillBeChargedNext);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], OnDeleteChatParticipant.this.channelOpenUntil);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], OnDeleteChatParticipant.this.lastMessageByLeadTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], OnDeleteChatParticipant.this.lastMessageByUserTime);
                    responseWriter.writeBoolean(responseFieldArr[20], OnDeleteChatParticipant.this.isLastMessageByLead);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], OnDeleteChatParticipant.this.lastOutboundMessageId);
                    responseWriter.writeString(responseFieldArr[22], OnDeleteChatParticipant.this.lastOutboundMessageStatus);
                    responseWriter.writeBoolean(responseFieldArr[23], OnDeleteChatParticipant.this.isNewMessageUpdate);
                    responseWriter.writeList(responseFieldArr[24], OnDeleteChatParticipant.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteChatParticipantSubscription.OnDeleteChatParticipant.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[25], OnDeleteChatParticipant.this.participantScopeIfInternal);
                    responseWriter.writeString(responseFieldArr[26], OnDeleteChatParticipant.this.userIdsForDirectChannel);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], OnDeleteChatParticipant.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[28], OnDeleteChatParticipant.this.updatedAt);
                    ResponseField responseField = responseFieldArr[29];
                    Channel channel = OnDeleteChatParticipant.this.channel;
                    ...
                    Participant participant = OnDeleteChatParticipant.this.participant;
    ...
    public static class Participant {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteChatParticipantSubscription.Participant.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Participant.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteChatParticipantSubscription.Variables.1
    ...
    public OnDeleteChatParticipantSubscription(String str, String str2) {
    ...
    public String operationId() {
        return "fd1c2a93cde6f73360fa343f26d0393509d83b60d03b9b2d25048e130a481828";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "subscription OnDeleteChatParticipant($accountId: ID!, $participantId: ID!) {\n  onDeleteChatParticipant(accountId: $accountId, participantId: $participantId) {\n    __typename\n    id\n    accountId\n    channelId\n    phoneNumberIdExternal\n    participantId\n    participationStatus\n    unreadMessageCount\n    lastViewed\n    isStarred\n    joinedAt\n    leftAt\n    channelName\n    channelType\n    channelSubType\n    channelStatus\n    channelWillBeChargedNext\n    channelOpenUntil\n    lastMessageByLeadTime\n    lastMessageByUserTime\n    isLastMessageByLead\n    lastOutboundMessageId\n    lastOutboundMessageStatus\n    isNewMessageUpdate\n    tags\n    participantScopeIfInternal\n    userIdsForDirectChannel\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    participant {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
