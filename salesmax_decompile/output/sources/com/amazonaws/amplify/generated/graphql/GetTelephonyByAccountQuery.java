...
public final class GetTelephonyByAccountQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetTelephonyByAccount($accountId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelCloudTelephonyAccountFilterInput, $limit: Int, $nextToken: String) {\n  getTelephonyByAccount(accountId: $accountId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      providerName\n      telephonyNumber\n      providerAccountId\n      displayNumber\n      hasOutbound\n      createNewLead\n      accessToken\n      cloudTelephonySubdomain\n      cloudTelephonyAccountSid\n      createdAt\n      updatedAt\n      entityListId\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetTelephonyByAccountQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetTelephonyByAccount";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetTelephonyByAccount($accountId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelCloudTelephonyAccountFilterInput, $limit: Int, $nextToken: String) {\n  getTelephonyByAccount(accountId: $accountId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      providerName\n      telephonyNumber\n      providerAccountId\n      displayNumber\n      hasOutbound\n      createNewLead\n      accessToken\n      cloudTelephonySubdomain\n      cloudTelephonyAccountSid\n      createdAt\n      updatedAt\n      entityListId\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetTelephonyByAccountQuery build() {
            return new GetTelephonyByAccountQuery(this.accountId, this.updatedAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getTelephonyByAccount", "getTelephonyByAccount", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("updatedAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "updatedAt").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetTelephonyByAccount getTelephonyByAccount;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetTelephonyByAccount.Mapper getTelephonyByAccountFieldMapper = new GetTelephonyByAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetTelephonyByAccount) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetTelephonyByAccount>() { // from class: com.amazonaws.amplify.generated.graphql.GetTelephonyByAccountQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetTelephonyByAccount read(ResponseReader responseReader2) {
                        return Mapper.this.getTelephonyByAccountFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetTelephonyByAccount getTelephonyByAccount) {
            this.getTelephonyByAccount = getTelephonyByAccount;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetTelephonyByAccount getTelephonyByAccount = this.getTelephonyByAccount;
            GetTelephonyByAccount getTelephonyByAccount2 = ((Data) obj).getTelephonyByAccount;
            return getTelephonyByAccount == null ? getTelephonyByAccount2 == null : getTelephonyByAccount.equals(getTelephonyByAccount2);
        }

        public GetTelephonyByAccount getTelephonyByAccount() {
            return this.getTelephonyByAccount;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetTelephonyByAccount getTelephonyByAccount = this.getTelephonyByAccount;
                this.$hashCode = (getTelephonyByAccount == null ? 0 : getTelephonyByAccount.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTelephonyByAccountQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetTelephonyByAccount getTelephonyByAccount = Data.this.getTelephonyByAccount;
                    responseWriter.writeObject(responseField, getTelephonyByAccount != null ? getTelephonyByAccount.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getTelephonyByAccount=" + this.getTelephonyByAccount + "}";
            }
            return this.$toString;
        }
    }

    public static class GetTelephonyByAccount {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetTelephonyByAccount> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetTelephonyByAccount map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetTelephonyByAccount.$responseFields;
                return new GetTelephonyByAccount(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetTelephonyByAccountQuery.GetTelephonyByAccount.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetTelephonyByAccountQuery.GetTelephonyByAccount.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetTelephonyByAccount(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetTelephonyByAccount)) {
                return false;
            }
            GetTelephonyByAccount getTelephonyByAccount = (GetTelephonyByAccount) obj;
            if (this.__typename.equals(getTelephonyByAccount.__typename) && this.items.equals(getTelephonyByAccount.items)) {
                String str = this.nextToken;
                String str2 = getTelephonyByAccount.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTelephonyByAccountQuery.GetTelephonyByAccount.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetTelephonyByAccount.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetTelephonyByAccount.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetTelephonyByAccount.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetTelephonyByAccountQuery.GetTelephonyByAccount.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetTelephonyByAccount.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetTelephonyByAccount{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTelephonyByAccountQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTelephonyByAccountQuery.Variables.1
    ...
    public GetTelephonyByAccountQuery(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelCloudTelephonyAccountFilterInput modelCloudTelephonyAccountFilterInput, Integer num, String str2) {
    ...
    public String operationId() {
        return "6e3cf04fd037ba562d70197ac6e77432229161198f5f5907e17f91935faf7df6";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetTelephonyByAccount($accountId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelCloudTelephonyAccountFilterInput, $limit: Int, $nextToken: String) {\n  getTelephonyByAccount(accountId: $accountId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      providerName\n      telephonyNumber\n      providerAccountId\n      displayNumber\n      hasOutbound\n      createNewLead\n      accessToken\n      cloudTelephonySubdomain\n      cloudTelephonyAccountSid\n      createdAt\n      updatedAt\n      entityListId\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    }
