...
public final class DeleteAccountMutation implements Mutation<Data, Data, Variables> {
    ...
    public static final String QUERY_DOCUMENT = "mutation DeleteAccount($input: DeleteAccountInput!) {\n  deleteAccount(input: $input) {\n    __typename\n    id\n    accountName\n    accountType\n    deviceKey\n    deviceKeyLastUpdated\n    accountStatus\n    businessLogoUrl\n    createdById\n    dateFormat\n    dateTimeViewStyle\n    defaultCurrency\n    denomination\n    industry\n    nameOfBusiness\n    productOrService\n    timeFormat\n    timeZone\n    plan\n    paidUpTo\n    seats\n    freeSeats\n    currentTotalUsers\n    currentActiveUsers\n    extraActiveUsers\n    pricePerSeat\n    allowAddingSeat\n    allowAddingSeatTill\n    seatReductionMarkedForNextCycle\n    billingCurrency\n    billingEmail\n    taxId\n    taxIdType\n    trialAccountEndDate\n    trialExtensionTimes\n    eligibleForExtension\n    paidForTillDate\n    updatedById\n    website\n    workingHours {\n      __typename\n      day\n      startTime\n      endTime\n    }\n    webPreferences {\n      __typename\n      key\n      value\n    }\n    permissions\n    enableCustomCharts\n    createdAt\n    updatedAt\n    dealMode\n    openAiApiKey\n    salesmaxSalesContacts\n    salesmaxSupportContacts\n    chatWidgetConfig\n    onboardingStatus\n    integrationNeeded\n    matchingDealId\n    relatedAccountIds\n    accountStats {\n      __typename\n      callSevenDays\n      wabaConversationSevenDays\n      wabaBroadcastSevenDays\n      paymentSevenDays\n      taskSevenDays\n      callPreviousSevenDays\n      wabaConversationPreviousSevenDays\n      contactCreatedPreviousSevenDays\n      bulkActionsSeventDays\n      bulkActionsSeventDays_BULK_UPLOAD\n      bulkActionsSeventDays_CREATE_TAG\n      bulkActionsSeventDays_CAMPAIGN_WITH_RULE\n      bulkActionsSeventDays_BULK_UPDATE\n      bulkActionsSeventDays_GENERATE_REPORT\n      bulkActionsSeventDays_REMOVE_USER\n      bulkActionsPreviousSeventDays\n      onboardingStepsDone\n    }\n    lastChurnDate\n    lastChurnReason\n    possibleReactivationDate\n    locationPeriodicFrequency\n    lastPaymentDataId\n    lastPaymentDataCreatedAt\n    nextRenewalDateIfPaid\n    lastPaymentStatus\n    partPaymentAmountIfAny\n    subscriptions {\n      __typename\n      nextToken\n    }\n    lastPaymentData {\n      __typename\n      id\n      accountId\n      contactId\n      paymentRequestType\n      engagementId\n      paymentProvider\n      orderIdInPaymentProvider\n      orderId\n      paymentLinkId\n      paymentLinkUrl\n      amount\n      amountPaid\n      currency\n      status\n      lastPaymentStatus\n      finalPaymentDate\n      paidByContactIds\n      transactionId\n      note\n      createdAt\n      updatedAt\n      customPaymentData\n      createdById\n      updatedById\n    }\n    matchingDeal {\n      __typename\n      id\n      accountId\n      name\n      description\n      dealStage\n      dealStageUpdatedAt\n      dealState\n      dealOutcome\n      dealLostReason\n      amount\n      currency\n      createdByUser\n      lastUpdatedByUser\n      ownerId\n      primaryTeamId\n      openTaskDetail\n      transitionSummary\n      recentEngagements\n      recentEngagementsUpdatedAt\n      lastActivity\n      tags\n      customDealData\n      createdAt\n      updatedAt\n    }\n    createdByUser {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedByUser {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    ...
    public static class AccountStats {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.AccountStats.1
    ...
    public static final class Builder {
        private DeleteAccountInput input;

        public DeleteAccountMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteAccountMutation(this.input);
        }

        public Builder input(DeleteAccountInput deleteAccountInput) {
            this.input = deleteAccountInput;
            return this;
        }
    }
    ...
    public static class CreatedByUser {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.CreatedByUser.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreatedByUser.$responseFields;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteAccount", "deleteAccount", new UnmodifiableMapBuilder(1).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteAccount.Mapper deleteAccountFieldMapper = new DeleteAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteAccount) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteAccount>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteAccount read(ResponseReader responseReader2) {
                        return Mapper.this.deleteAccountFieldMapper.map(responseReader2);
                    }
                }));
            }
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteAccount deleteAccount2 = ((Data) obj).deleteAccount;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.Data.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    DeleteAccount deleteAccount = Data.this.deleteAccount;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteAccount=" + this.deleteAccount + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class DeleteAccount {
        ...
        public static final class Mapper implements ResponseFieldMapper<DeleteAccount> {
            ...
            public DeleteAccount map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = DeleteAccount.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String string2 = responseReader.readString(responseFieldArr[2]);
                String string3 = responseReader.readString(responseFieldArr[3]);
                ...
                }), responseReader.readList(responseFieldArr[40], new ResponseReader.ListReader<WebPreference>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.DeleteAccount.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public WebPreference read(ResponseReader.ListItemReader listItemReader) {
                        return (WebPreference) listItemReader.readObject(new ResponseReader.ObjectReader<WebPreference>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.DeleteAccount.Mapper.3.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), (MatchingDeal) responseReader.readObject(responseFieldArr[66], new ResponseReader.ObjectReader<MatchingDeal>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.DeleteAccount.Mapper.11
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public MatchingDeal read(ResponseReader responseReader2) {
                        return Mapper.this.matchingDealFieldMapper.map(responseReader2);
                    }
                }), (CreatedByUser) responseReader.readObject(responseFieldArr[67], new ResponseReader.ObjectReader<CreatedByUser>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.DeleteAccount.Mapper.12
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreatedByUser read(ResponseReader responseReader2) {
                        return Mapper.this.createdByUserFieldMapper.map(responseReader2);
                    }
                }), (UpdatedByUser) responseReader.readObject(responseFieldArr[68], new ResponseReader.ObjectReader<UpdatedByUser>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.DeleteAccount.Mapper.13
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (this.__typename.equals(deleteAccount.__typename) && this.id.equals(deleteAccount.id) && this.accountName.equals(deleteAccount.accountName) && this.accountType.equals(deleteAccount.accountType) && ((str = this.deviceKey) != null ? str.equals(deleteAccount.deviceKey) : deleteAccount.deviceKey == null) && ((str2 = this.deviceKeyLastUpdated) != null ? str2.equals(deleteAccount.deviceKeyLastUpdated) : deleteAccount.deviceKeyLastUpdated == null) && ((accountStatus = this.accountStatus) != null ? accountStatus.equals(deleteAccount.accountStatus) : deleteAccount.accountStatus == null) && ((str3 = this.businessLogoUrl) != null ? str3.equals(deleteAccount.businessLogoUrl) : deleteAccount.businessLogoUrl == null) && ((str4 = this.createdById) != null ? str4.equals(deleteAccount.createdById) : deleteAccount.createdById == null) && ((str5 = this.dateFormat) != null ? str5.equals(deleteAccount.dateFormat) : deleteAccount.dateFormat == null) && ((str6 = this.dateTimeViewStyle) != null ? str6.equals(deleteAccount.dateTimeViewStyle) : deleteAccount.dateTimeViewStyle == null) && ((str7 = this.defaultCurrency) != null ? str7.equals(deleteAccount.defaultCurrency) : deleteAccount.defaultCurrency == null) && ((str8 = this.denomination) != null ? str8.equals(deleteAccount.denomination) : deleteAccount.denomination == null) && ((str9 = this.industry) != null ? str9.equals(deleteAccount.industry) : deleteAccount.industry == null) && ((str10 = this.nameOfBusiness) != null ? str10.equals(deleteAccount.nameOfBusiness) : deleteAccount.nameOfBusiness == null) && ((list = this.productOrService) != null ? list.equals(deleteAccount.productOrService) : deleteAccount.productOrService == null) && ((str11 = this.timeFormat) != null ? str11.equals(deleteAccount.timeFormat) : deleteAccount.timeFormat == null) && ((str12 = this.timeZone) != null ? str12.equals(deleteAccount.timeZone) : deleteAccount.timeZone == null) && ((str13 = this.plan) != null ? str13.equals(deleteAccount.plan) : deleteAccount.plan == null) && ((str14 = this.paidUpTo) != null ? str14.equals(deleteAccount.paidUpTo) : deleteAccount.paidUpTo == null) && ((num = this.seats) != null ? num.equals(deleteAccount.seats) : deleteAccount.seats == null) && ((num2 = this.freeSeats) != null ? num2.equals(deleteAccount.freeSeats) : deleteAccount.freeSeats == null) && ((num3 = this.currentTotalUsers) != null ? num3.equals(deleteAccount.currentTotalUsers) : deleteAccount.currentTotalUsers == null) && ((num4 = this.currentActiveUsers) != null ? num4.equals(deleteAccount.currentActiveUsers) : deleteAccount.currentActiveUsers == null) && ((num5 = this.extraActiveUsers) != null ? num5.equals(deleteAccount.extraActiveUsers) : deleteAccount.extraActiveUsers == null) && ((num6 = this.pricePerSeat) != null ? num6.equals(deleteAccount.pricePerSeat) : deleteAccount.pricePerSeat == null) && ((bool = this.allowAddingSeat) != null ? bool.equals(deleteAccount.allowAddingSeat) : deleteAccount.allowAddingSeat == null) && ((str15 = this.allowAddingSeatTill) != null ? str15.equals(deleteAccount.allowAddingSeatTill) : deleteAccount.allowAddingSeatTill == null) && ((num7 = this.seatReductionMarkedForNextCycle) != null ? num7.equals(deleteAccount.seatReductionMarkedForNextCycle) : deleteAccount.seatReductionMarkedForNextCycle == null) && ((str16 = this.billingCurrency) != null ? str16.equals(deleteAccount.billingCurrency) : deleteAccount.billingCurrency == null) && ((str17 = this.billingEmail) != null ? str17.equals(deleteAccount.billingEmail) : deleteAccount.billingEmail == null) && ((str18 = this.taxId) != null ? str18.equals(deleteAccount.taxId) : deleteAccount.taxId == null) && ((str19 = this.taxIdType) != null ? str19.equals(deleteAccount.taxIdType) : deleteAccount.taxIdType == null) && ((str20 = this.trialAccountEndDate) != null ? str20.equals(deleteAccount.trialAccountEndDate) : deleteAccount.trialAccountEndDate == null) && ((num8 = this.trialExtensionTimes) != null ? num8.equals(deleteAccount.trialExtensionTimes) : deleteAccount.trialExtensionTimes == null) && ((bool2 = this.eligibleForExtension) != null ? bool2.equals(deleteAccount.eligibleForExtension) : deleteAccount.eligibleForExtension == null) && ((str21 = this.paidForTillDate) != null ? str21.equals(deleteAccount.paidForTillDate) : deleteAccount.paidForTillDate == null) && ((str22 = this.updatedById) != null ? str22.equals(deleteAccount.updatedById) : deleteAccount.updatedById == null) && ((str23 = this.website) != null ? str23.equals(deleteAccount.website) : deleteAccount.website == null) && ((list2 = this.workingHours) != null ? list2.equals(deleteAccount.workingHours) : deleteAccount.workingHours == null) && ((list3 = this.webPreferences) != null ? list3.equals(deleteAccount.webPreferences) : deleteAccount.webPreferences == null) && ((list4 = this.permissions) != null ? list4.equals(deleteAccount.permissions) : deleteAccount.permissions == null) && ((bool3 = this.enableCustomCharts) != null ? bool3.equals(deleteAccount.enableCustomCharts) : deleteAccount.enableCustomCharts == null) && ((str24 = this.createdAt) != null ? str24.equals(deleteAccount.createdAt) : deleteAccount.createdAt == null) && ((str25 = this.updatedAt) != null ? str25.equals(deleteAccount.updatedAt) : deleteAccount.updatedAt == null) && ((str26 = this.dealMode) != null ? str26.equals(deleteAccount.dealMode) : deleteAccount.dealMode == null) && ((str27 = this.openAiApiKey) != null ? str27.equals(deleteAccount.openAiApiKey) : deleteAccount.openAiApiKey == null) && ((list5 = this.salesmaxSalesContacts) != null ? list5.equals(deleteAccount.salesmaxSalesContacts) : deleteAccount.salesmaxSalesContacts == null) && ((list6 = this.salesmaxSupportContacts) != null ? list6.equals(deleteAccount.salesmaxSupportContacts) : deleteAccount.salesmaxSupportContacts == null) && ((str28 = this.chatWidgetConfig) != null ? str28.equals(deleteAccount.chatWidgetConfig) : deleteAccount.chatWidgetConfig == null) && ((str29 = this.onboardingStatus) != null ? str29.equals(deleteAccount.onboardingStatus) : deleteAccount.onboardingStatus == null) && ((str30 = this.integrationNeeded) != null ? str30.equals(deleteAccount.integrationNeeded) : deleteAccount.integrationNeeded == null) && ((str31 = this.matchingDealId) != null ? str31.equals(deleteAccount.matchingDealId) : deleteAccount.matchingDealId == null) && ((list7 = this.relatedAccountIds) != null ? list7.equals(deleteAccount.relatedAccountIds) : deleteAccount.relatedAccountIds == null) && ((accountStats = this.accountStats) != null ? accountStats.equals(deleteAccount.accountStats) : deleteAccount.accountStats == null) && ((str32 = this.lastChurnDate) != null ? str32.equals(deleteAccount.lastChurnDate) : deleteAccount.lastChurnDate == null) && ((str33 = this.lastChurnReason) != null ? str33.equals(deleteAccount.lastChurnReason) : deleteAccount.lastChurnReason == null) && ((str34 = this.possibleReactivationDate) != null ? str34.equals(deleteAccount.possibleReactivationDate) : deleteAccount.possibleReactivationDate == null) && ((d = this.locationPeriodicFrequency) != null ? d.equals(deleteAccount.locationPeriodicFrequency) : deleteAccount.locationPeriodicFrequency == null) && ((str35 = this.lastPaymentDataId) != null ? str35.equals(deleteAccount.lastPaymentDataId) : deleteAccount.lastPaymentDataId == null) && ((str36 = this.lastPaymentDataCreatedAt) != null ? str36.equals(deleteAccount.lastPaymentDataCreatedAt) : deleteAccount.lastPaymentDataCreatedAt == null) && ((str37 = this.nextRenewalDateIfPaid) != null ? str37.equals(deleteAccount.nextRenewalDateIfPaid) : deleteAccount.nextRenewalDateIfPaid == null) && ((str38 = this.lastPaymentStatus) != null ? str38.equals(deleteAccount.lastPaymentStatus) : deleteAccount.lastPaymentStatus == null) && ((num9 = this.partPaymentAmountIfAny) != null ? num9.equals(deleteAccount.partPaymentAmountIfAny) : deleteAccount.partPaymentAmountIfAny == null) && ((subscriptions = this.subscriptions) != null ? subscriptions.equals(deleteAccount.subscriptions) : deleteAccount.subscriptions == null) && ((lastPaymentData = this.lastPaymentData) != null ? lastPaymentData.equals(deleteAccount.lastPaymentData) : deleteAccount.lastPaymentData == null) && ((matchingDeal = this.matchingDeal) != null ? matchingDeal.equals(deleteAccount.matchingDeal) : deleteAccount.matchingDeal == null) && ((createdByUser = this.createdByUser) != null ? createdByUser.equals(deleteAccount.createdByUser) : deleteAccount.createdByUser == null)) {
                UpdatedByUser updatedByUser = this.updatedByUser;
                UpdatedByUser updatedByUser2 = deleteAccount.updatedByUser;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.DeleteAccount.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteAccount.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteAccount.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteAccount.this.id);
                    responseWriter.writeString(responseFieldArr[2], DeleteAccount.this.accountName);
                    responseWriter.writeString(responseFieldArr[3], DeleteAccount.this.accountType.name());
                    responseWriter.writeString(responseFieldArr[4], DeleteAccount.this.deviceKey);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], DeleteAccount.this.deviceKeyLastUpdated);
                    ResponseField responseField = responseFieldArr[6];
                    AccountStatus accountStatus = DeleteAccount.this.accountStatus;
                    responseWriter.writeString(responseField, accountStatus != null ? accountStatus.name() : null);
                    responseWriter.writeString(responseFieldArr[7], DeleteAccount.this.businessLogoUrl);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], DeleteAccount.this.createdById);
                    responseWriter.writeString(responseFieldArr[9], DeleteAccount.this.dateFormat);
                    responseWriter.writeString(responseFieldArr[10], DeleteAccount.this.dateTimeViewStyle);
                    responseWriter.writeString(responseFieldArr[11], DeleteAccount.this.defaultCurrency);
                    responseWriter.writeString(responseFieldArr[12], DeleteAccount.this.denomination);
                    responseWriter.writeString(responseFieldArr[13], DeleteAccount.this.industry);
                    responseWriter.writeString(responseFieldArr[14], DeleteAccount.this.nameOfBusiness);
                    responseWriter.writeList(responseFieldArr[15], DeleteAccount.this.productOrService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.DeleteAccount.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[16], DeleteAccount.this.timeFormat);
                    responseWriter.writeString(responseFieldArr[17], DeleteAccount.this.timeZone);
                    responseWriter.writeString(responseFieldArr[18], DeleteAccount.this.plan);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], DeleteAccount.this.paidUpTo);
                    responseWriter.writeInt(responseFieldArr[20], DeleteAccount.this.seats);
                    responseWriter.writeInt(responseFieldArr[21], DeleteAccount.this.freeSeats);
                    responseWriter.writeInt(responseFieldArr[22], DeleteAccount.this.currentTotalUsers);
                    responseWriter.writeInt(responseFieldArr[23], DeleteAccount.this.currentActiveUsers);
                    responseWriter.writeInt(responseFieldArr[24], DeleteAccount.this.extraActiveUsers);
                    responseWriter.writeInt(responseFieldArr[25], DeleteAccount.this.pricePerSeat);
                    responseWriter.writeBoolean(responseFieldArr[26], DeleteAccount.this.allowAddingSeat);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], DeleteAccount.this.allowAddingSeatTill);
                    responseWriter.writeInt(responseFieldArr[28], DeleteAccount.this.seatReductionMarkedForNextCycle);
                    responseWriter.writeString(responseFieldArr[29], DeleteAccount.this.billingCurrency);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[30], DeleteAccount.this.billingEmail);
                    responseWriter.writeString(responseFieldArr[31], DeleteAccount.this.taxId);
                    responseWriter.writeString(responseFieldArr[32], DeleteAccount.this.taxIdType);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[33], DeleteAccount.this.trialAccountEndDate);
                    responseWriter.writeInt(responseFieldArr[34], DeleteAccount.this.trialExtensionTimes);
                    responseWriter.writeBoolean(responseFieldArr[35], DeleteAccount.this.eligibleForExtension);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[36], DeleteAccount.this.paidForTillDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[37], DeleteAccount.this.updatedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], DeleteAccount.this.website);
                    responseWriter.writeList(responseFieldArr[39], DeleteAccount.this.workingHours, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.DeleteAccount.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((WorkingHour) obj).marshaller());
                        }
                    });
                    responseWriter.writeList(responseFieldArr[40], DeleteAccount.this.webPreferences, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.DeleteAccount.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((WebPreference) obj).marshaller());
                        }
                    });
                    responseWriter.writeList(responseFieldArr[41], DeleteAccount.this.permissions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.DeleteAccount.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    });
                    responseWriter.writeBoolean(responseFieldArr[42], DeleteAccount.this.enableCustomCharts);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[43], DeleteAccount.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[44], DeleteAccount.this.updatedAt);
                    responseWriter.writeString(responseFieldArr[45], DeleteAccount.this.dealMode);
                    responseWriter.writeString(responseFieldArr[46], DeleteAccount.this.openAiApiKey);
                    responseWriter.writeList(responseFieldArr[47], DeleteAccount.this.salesmaxSalesContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.DeleteAccount.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[48], DeleteAccount.this.salesmaxSupportContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.DeleteAccount.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[49], DeleteAccount.this.chatWidgetConfig);
                    responseWriter.writeString(responseFieldArr[50], DeleteAccount.this.onboardingStatus);
                    responseWriter.writeString(responseFieldArr[51], DeleteAccount.this.integrationNeeded);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[52], DeleteAccount.this.matchingDealId);
                    responseWriter.writeList(responseFieldArr[53], DeleteAccount.this.relatedAccountIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.DeleteAccount.1.7
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    AccountStats accountStats = DeleteAccount.this.accountStats;
                    responseWriter.writeObject(responseField2, accountStats != null ? accountStats.marshaller() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[55], DeleteAccount.this.lastChurnDate);
                    responseWriter.writeString(responseFieldArr[56], DeleteAccount.this.lastChurnReason);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[57], DeleteAccount.this.possibleReactivationDate);
                    responseWriter.writeDouble(responseFieldArr[58], DeleteAccount.this.locationPeriodicFrequency);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[59], DeleteAccount.this.lastPaymentDataId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[60], DeleteAccount.this.lastPaymentDataCreatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[61], DeleteAccount.this.nextRenewalDateIfPaid);
                    responseWriter.writeString(responseFieldArr[62], DeleteAccount.this.lastPaymentStatus);
                    responseWriter.writeInt(responseFieldArr[63], DeleteAccount.this.partPaymentAmountIfAny);
                    ResponseField responseField3 = responseFieldArr[64];
                    Subscriptions subscriptions = DeleteAccount.this.subscriptions;
                    ...
                    LastPaymentData lastPaymentData = DeleteAccount.this.lastPaymentData;
                    ...
                    MatchingDeal matchingDeal = DeleteAccount.this.matchingDeal;
                    ...
                    CreatedByUser createdByUser = DeleteAccount.this.createdByUser;
                    ...
                    UpdatedByUser updatedByUser = DeleteAccount.this.updatedByUser;
    ...
    public static class LastPaymentData {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.LastPaymentData.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = LastPaymentData.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[17], LastPaymentData.this.paidByContactIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.LastPaymentData.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], LastPaymentData.this.transactionId, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.LastPaymentData.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class MatchingDeal {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.MatchingDeal.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = MatchingDeal.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[17], MatchingDeal.this.transitionSummary, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.MatchingDeal.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], MatchingDeal.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.MatchingDeal.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[21], MatchingDeal.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.MatchingDeal.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class Subscriptions {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.Subscriptions.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Subscriptions.$responseFields;
    ...
    public static class UpdatedByUser {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.UpdatedByUser.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdatedByUser.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        private final DeleteAccountInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteAccountInput deleteAccountInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteAccountInput;
            linkedHashMap.put("input", deleteAccountInput);
        }
    ...
    public static class WebPreference {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.WebPreference.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = WebPreference.$responseFields;
    ...
    public static class WorkingHour {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteAccountMutation.WorkingHour.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = WorkingHour.$responseFields;
    ...
    public DeleteAccountMutation(DeleteAccountInput deleteAccountInput) {
        Utils.checkNotNull(deleteAccountInput, "input == null");
    ...
    public String operationId() {
        return "f4c8fb772bf65545d18c5e07429e6304a1acd49e6efa660a6fbc9b15bfa8a30c";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteAccount($input: DeleteAccountInput!) {\n  deleteAccount(input: $input) {\n    __typename\n    id\n    accountName\n    accountType\n    deviceKey\n    deviceKeyLastUpdated\n    accountStatus\n    businessLogoUrl\n    createdById\n    dateFormat\n    dateTimeViewStyle\n    defaultCurrency\n    denomination\n    industry\n    nameOfBusiness\n    productOrService\n    timeFormat\n    timeZone\n    plan\n    paidUpTo\n    seats\n    freeSeats\n    currentTotalUsers\n    currentActiveUsers\n    extraActiveUsers\n    pricePerSeat\n    allowAddingSeat\n    allowAddingSeatTill\n    seatReductionMarkedForNextCycle\n    billingCurrency\n    billingEmail\n    taxId\n    taxIdType\n    trialAccountEndDate\n    trialExtensionTimes\n    eligibleForExtension\n    paidForTillDate\n    updatedById\n    website\n    workingHours {\n      __typename\n      day\n      startTime\n      endTime\n    }\n    webPreferences {\n      __typename\n      key\n      value\n    }\n    permissions\n    enableCustomCharts\n    createdAt\n    updatedAt\n    dealMode\n    openAiApiKey\n    salesmaxSalesContacts\n    salesmaxSupportContacts\n    chatWidgetConfig\n    onboardingStatus\n    integrationNeeded\n    matchingDealId\n    relatedAccountIds\n    accountStats {\n      __typename\n      callSevenDays\n      wabaConversationSevenDays\n      wabaBroadcastSevenDays\n      paymentSevenDays\n      taskSevenDays\n      callPreviousSevenDays\n      wabaConversationPreviousSevenDays\n      contactCreatedPreviousSevenDays\n      bulkActionsSeventDays\n      bulkActionsSeventDays_BULK_UPLOAD\n      bulkActionsSeventDays_CREATE_TAG\n      bulkActionsSeventDays_CAMPAIGN_WITH_RULE\n      bulkActionsSeventDays_BULK_UPDATE\n      bulkActionsSeventDays_GENERATE_REPORT\n      bulkActionsSeventDays_REMOVE_USER\n      bulkActionsPreviousSeventDays\n      onboardingStepsDone\n    }\n    lastChurnDate\n    lastChurnReason\n    possibleReactivationDate\n    locationPeriodicFrequency\n    lastPaymentDataId\n    lastPaymentDataCreatedAt\n    nextRenewalDateIfPaid\n    lastPaymentStatus\n    partPaymentAmountIfAny\n    subscriptions {\n      __typename\n      nextToken\n    }\n    lastPaymentData {\n      __typename\n      id\n      accountId\n      contactId\n      paymentRequestType\n      engagementId\n      paymentProvider\n      orderIdInPaymentProvider\n      orderId\n      paymentLinkId\n      paymentLinkUrl\n      amount\n      amountPaid\n      currency\n      status\n      lastPaymentStatus\n      finalPaymentDate\n      paidByContactIds\n      transactionId\n      note\n      createdAt\n      updatedAt\n      customPaymentData\n      createdById\n      updatedById\n    }\n    matchingDeal {\n      __typename\n      id\n      accountId\n      name\n      description\n      dealStage\n      dealStageUpdatedAt\n      dealState\n      dealOutcome\n      dealLostReason\n      amount\n      currency\n      createdByUser\n      lastUpdatedByUser\n      ownerId\n      primaryTeamId\n      openTaskDetail\n      transitionSummary\n      recentEngagements\n      recentEngagementsUpdatedAt\n      lastActivity\n      tags\n      customDealData\n      createdAt\n      updatedAt\n    }\n    createdByUser {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedByUser {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
