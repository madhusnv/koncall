...
import type.DeleteActivityLocationInput;
import type.ModelActivityLocationConditionInput;
import type.UserRegistrationStatus;

/* loaded from: classes6.dex */
public final class DeleteActivityLocationMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation DeleteActivityLocation($input: DeleteActivityLocationInput!, $condition: ModelActivityLocationConditionInput) {\n  deleteActivityLocation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.DeleteActivityLocationMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "DeleteActivityLocation";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation DeleteActivityLocation($input: DeleteActivityLocationInput!, $condition: ModelActivityLocationConditionInput) {\n  deleteActivityLocation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelActivityLocationConditionInput condition;
        private DeleteActivityLocationInput input;

        public DeleteActivityLocationMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteActivityLocationMutation(this.input, this.condition);
        }
        ...
        public Builder input(DeleteActivityLocationInput deleteActivityLocationInput) {
            this.input = deleteActivityLocationInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteActivityLocation", "deleteActivityLocation", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final DeleteActivityLocation deleteActivityLocation;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteActivityLocation.Mapper deleteActivityLocationFieldMapper = new DeleteActivityLocation.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteActivityLocation) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteActivityLocation>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteActivityLocationMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteActivityLocation read(ResponseReader responseReader2) {
                        return Mapper.this.deleteActivityLocationFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteActivityLocation deleteActivityLocation) {
            this.deleteActivityLocation = deleteActivityLocation;
        }

        public DeleteActivityLocation deleteActivityLocation() {
            return this.deleteActivityLocation;
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteActivityLocation deleteActivityLocation = this.deleteActivityLocation;
            DeleteActivityLocation deleteActivityLocation2 = ((Data) obj).deleteActivityLocation;
            return deleteActivityLocation == null ? deleteActivityLocation2 == null : deleteActivityLocation.equals(deleteActivityLocation2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteActivityLocation deleteActivityLocation = this.deleteActivityLocation;
                this.$hashCode = (deleteActivityLocation == null ? 0 : deleteActivityLocation.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteActivityLocationMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteActivityLocation deleteActivityLocation = Data.this.deleteActivityLocation;
                    responseWriter.writeObject(responseField, deleteActivityLocation != null ? deleteActivityLocation.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteActivityLocation=" + this.deleteActivityLocation + "}";
            }
            return this.$toString;
        }
    }

    public static class DeleteActivityLocation {
        ...
        public static final class Mapper implements ResponseFieldMapper<DeleteActivityLocation> {
            final User.Mapper userFieldMapper = new User.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public DeleteActivityLocation map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = DeleteActivityLocation.$responseFields;
                return new DeleteActivityLocation(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), responseReader.readString(responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[8]), (User) responseReader.readObject(responseFieldArr[9], new ResponseReader.ObjectReader<User>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteActivityLocationMutation.DeleteActivityLocation.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public DeleteActivityLocation(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, User user) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteActivityLocation)) {
                return false;
            }
            DeleteActivityLocation deleteActivityLocation = (DeleteActivityLocation) obj;
            if (this.__typename.equals(deleteActivityLocation.__typename) && this.id.equals(deleteActivityLocation.id) && this.accountId.equals(deleteActivityLocation.accountId) && ((str = this.engagementId) != null ? str.equals(deleteActivityLocation.engagementId) : deleteActivityLocation.engagementId == null) && ((str2 = this.lat) != null ? str2.equals(deleteActivityLocation.lat) : deleteActivityLocation.lat == null) && ((str3 = this.lng) != null ? str3.equals(deleteActivityLocation.lng) : deleteActivityLocation.lng == null) && this.ownerId.equals(deleteActivityLocation.ownerId) && ((str4 = this.createdAt) != null ? str4.equals(deleteActivityLocation.createdAt) : deleteActivityLocation.createdAt == null) && ((str5 = this.updatedAt) != null ? str5.equals(deleteActivityLocation.updatedAt) : deleteActivityLocation.updatedAt == null)) {
                User user = this.user;
                User user2 = deleteActivityLocation.user;
                if (user == null) {
                    if (user2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteActivityLocationMutation.DeleteActivityLocation.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteActivityLocation.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteActivityLocation.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteActivityLocation.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteActivityLocation.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], DeleteActivityLocation.this.engagementId);
                    responseWriter.writeString(responseFieldArr[4], DeleteActivityLocation.this.lat);
                    responseWriter.writeString(responseFieldArr[5], DeleteActivityLocation.this.lng);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], DeleteActivityLocation.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], DeleteActivityLocation.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], DeleteActivityLocation.this.updatedAt);
                    ResponseField responseField = responseFieldArr[9];
                    User user = DeleteActivityLocation.this.user;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "DeleteActivityLocation{__typename=" + this.__typename + ", id=" + this.id + ", accountId=" + this.accountId + ", engagementId=" + this.engagementId + ", lat=" + this.lat + ", lng=" + this.lng + ", ownerId=" + this.ownerId + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", user=" + this.user + "}";
            }
            return this.$toString;
        }
    ...
    public static class User {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteActivityLocationMutation.User.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = User.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final DeleteActivityLocationInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteActivityLocationInput deleteActivityLocationInput, ModelActivityLocationConditionInput modelActivityLocationConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteActivityLocationInput;
            this.condition = modelActivityLocationConditionInput;
            linkedHashMap.put("input", deleteActivityLocationInput);
        ...
        public DeleteActivityLocationInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteActivityLocationMutation.Variables.1
    ...
    public DeleteActivityLocationMutation(DeleteActivityLocationInput deleteActivityLocationInput, ModelActivityLocationConditionInput modelActivityLocationConditionInput) {
        Utils.checkNotNull(deleteActivityLocationInput, "input == null");
        this.variables = new Variables(deleteActivityLocationInput, modelActivityLocationConditionInput);
    }
    ...
    public String operationId() {
        return "1c5343c395d46bee2d970bafaee7399220678426afea394f5ca32597ec7b4957";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteActivityLocation($input: DeleteActivityLocationInput!, $condition: ModelActivityLocationConditionInput) {\n  deleteActivityLocation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
