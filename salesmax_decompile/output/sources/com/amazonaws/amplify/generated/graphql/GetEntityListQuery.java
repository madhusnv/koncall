...
public final class GetEntityListQuery implements Query<Data, Data, Variables> {
    ...
    public static class AssociatedDistribution {
        ...
        public static final class Mapper implements ResponseFieldMapper<AssociatedDistribution> {
            ...
            public AssociatedDistribution map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[5], new ResponseReader.ListReader<DistributedEntityType>() { // from class: com.amazonaws.amplify.generated.graphql.GetEntityListQuery.AssociatedDistribution.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetEntityListQuery.AssociatedDistribution.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], AssociatedDistribution.this.distributedEntityType, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetEntityListQuery.AssociatedDistribution.1.1
    ...
    public static final class Builder {
        ...
        public GetEntityListQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetEntityListQuery(this.id);
        }
    ...
    public static class Data implements Operation.Data {
        ...
        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetEntityList.Mapper getEntityListFieldMapper = new GetEntityList.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetEntityList) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetEntityList>() { // from class: com.amazonaws.amplify.generated.graphql.GetEntityListQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetEntityList read(ResponseReader responseReader2) {
                        return Mapper.this.getEntityListFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetEntityList getEntityList) {
        ...
        public boolean equals(Object obj) {
            ...
            GetEntityList getEntityList = this.getEntityList;
            GetEntityList getEntityList2 = ((Data) obj).getEntityList;
            return getEntityList == null ? getEntityList2 == null : getEntityList.equals(getEntityList2);
        }

        public GetEntityList getEntityList() {
        ...
        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetEntityList getEntityList = this.getEntityList;
                this.$hashCode = (getEntityList == null ? 0 : getEntityList.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetEntityListQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetEntityList getEntityList = Data.this.getEntityList;
                    responseWriter.writeObject(responseField, getEntityList != null ? getEntityList.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getEntityList=" + this.getEntityList + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class EntityActionDefinition {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetEntityListQuery.EntityActionDefinition.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = EntityActionDefinition.$responseFields;
    ...
    public static class GetEntityList {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetEntityList> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetEntityList map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetEntityList.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
                String string2 = responseReader.readString(responseFieldArr[3]);
                ...
                }), (EntityActionDefinition) responseReader.readObject(responseFieldArr[40], new ResponseReader.ObjectReader<EntityActionDefinition>() { // from class: com.amazonaws.amplify.generated.graphql.GetEntityListQuery.GetEntityList.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), (Owner) responseReader.readObject(responseFieldArr[41], new ResponseReader.ObjectReader<Owner>() { // from class: com.amazonaws.amplify.generated.graphql.GetEntityListQuery.GetEntityList.Mapper.4
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetEntityList)) {
                return false;
            }
            GetEntityList getEntityList = (GetEntityList) obj;
            if (this.__typename.equals(getEntityList.__typename) && this.id.equals(getEntityList.id) && this.accountId.equals(getEntityList.accountId) && this.entityTypeInList.equals(getEntityList.entityTypeInList) && this.entityListType.equals(getEntityList.entityListType) && ((str = this.listName) != null ? str.equals(getEntityList.listName) : getEntityList.listName == null) && ((str2 = this.description) != null ? str2.equals(getEntityList.description) : getEntityList.description == null) && ((entityListStatus = this.status) != null ? entityListStatus.equals(getEntityList.status) : getEntityList.status == null) && ((num = this.successfulCount) != null ? num.equals(getEntityList.successfulCount) : getEntityList.successfulCount == null) && ((num2 = this.duplicateCount) != null ? num2.equals(getEntityList.duplicateCount) : getEntityList.duplicateCount == null) && ((num3 = this.invalidNumbersCount) != null ? num3.equals(getEntityList.invalidNumbersCount) : getEntityList.invalidNumbersCount == null) && ((num4 = this.invalidEmailCount) != null ? num4.equals(getEntityList.invalidEmailCount) : getEntityList.invalidEmailCount == null) && ((num5 = this.doNotTrackCount) != null ? num5.equals(getEntityList.doNotTrackCount) : getEntityList.doNotTrackCount == null) && ((num6 = this.otherFailedCount) != null ? num6.equals(getEntityList.otherFailedCount) : getEntityList.otherFailedCount == null) && this.ownerId.equals(getEntityList.ownerId) && this.listCreationType.equals(getEntityList.listCreationType) && ((str3 = this.listCategory) != null ? str3.equals(getEntityList.listCategory) : getEntityList.listCategory == null) && ((str4 = this.rawBulkUploadFileRef) != null ? str4.equals(getEntityList.rawBulkUploadFileRef) : getEntityList.rawBulkUploadFileRef == null) && ((str5 = this.rawBulkUploadFileHash) != null ? str5.equals(getEntityList.rawBulkUploadFileHash) : getEntityList.rawBulkUploadFileHash == null) && ((str6 = this.modifiedBulkUploadFileRef) != null ? str6.equals(getEntityList.modifiedBulkUploadFileRef) : getEntityList.modifiedBulkUploadFileRef == null) && ((str7 = this.finalBulkUploadFileRef) != null ? str7.equals(getEntityList.finalBulkUploadFileRef) : getEntityList.finalBulkUploadFileRef == null) && ((str8 = this.leadSourceForBulkUpload) != null ? str8.equals(getEntityList.leadSourceForBulkUpload) : getEntityList.leadSourceForBulkUpload == null) && ((str9 = this.defaultCountryCode) != null ? str9.equals(getEntityList.defaultCountryCode) : getEntityList.defaultCountryCode == null) && ((str10 = this.defaultCountryIso) != null ? str10.equals(getEntityList.defaultCountryIso) : getEntityList.defaultCountryIso == null) && ((str11 = this.notificationBody) != null ? str11.equals(getEntityList.notificationBody) : getEntityList.notificationBody == null) && ((str12 = this.rule) != null ? str12.equals(getEntityList.rule) : getEntityList.rule == null) && ((contactAssignmentStatus = this.toBeAssigned) != null ? contactAssignmentStatus.equals(getEntityList.toBeAssigned) : getEntityList.toBeAssigned == null) && ((str13 = this.assignedUserId) != null ? str13.equals(getEntityList.assignedUserId) : getEntityList.assignedUserId == null) && ((str14 = this.assignedTeamId) != null ? str14.equals(getEntityList.assignedTeamId) : getEntityList.assignedTeamId == null) && ((str15 = this.associatedDistributionId) != null ? str15.equals(getEntityList.associatedDistributionId) : getEntityList.associatedDistributionId == null) && ((str16 = this.entityActionDefinitionReference) != null ? str16.equals(getEntityList.entityActionDefinitionReference) : getEntityList.entityActionDefinitionReference == null) && ((bool = this.redistributeEntities) != null ? bool.equals(getEntityList.redistributeEntities) : getEntityList.redistributeEntities == null) && ((str17 = this.redistributionRequestedAt) != null ? str17.equals(getEntityList.redistributionRequestedAt) : getEntityList.redistributionRequestedAt == null) && ((str18 = this.dupliacteLeadList) != null ? str18.equals(getEntityList.dupliacteLeadList) : getEntityList.dupliacteLeadList == null) && ((list = this.tags) != null ? list.equals(getEntityList.tags) : getEntityList.tags == null) && ((str19 = this.chatMessagePlatform) != null ? str19.equals(getEntityList.chatMessagePlatform) : getEntityList.chatMessagePlatform == null) && ((bool2 = this.allowMultiple) != null ? bool2.equals(getEntityList.allowMultiple) : getEntityList.allowMultiple == null) && ((str20 = this.createdAt) != null ? str20.equals(getEntityList.createdAt) : getEntityList.createdAt == null) && ((str21 = this.updatedAt) != null ? str21.equals(getEntityList.updatedAt) : getEntityList.updatedAt == null) && ((associatedDistribution = this.associatedDistribution) != null ? associatedDistribution.equals(getEntityList.associatedDistribution) : getEntityList.associatedDistribution == null) && ((entityActionDefinition = this.entityActionDefinition) != null ? entityActionDefinition.equals(getEntityList.entityActionDefinition) : getEntityList.entityActionDefinition == null)) {
                Owner owner = this.owner;
                Owner owner2 = getEntityList.owner;
                if (owner == null) {
                    if (owner2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetEntityListQuery.GetEntityList.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetEntityList.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetEntityList.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetEntityList.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetEntityList.this.accountId);
                    responseWriter.writeString(responseFieldArr[3], GetEntityList.this.entityTypeInList);
                    responseWriter.writeString(responseFieldArr[4], GetEntityList.this.entityListType.name());
                    responseWriter.writeString(responseFieldArr[5], GetEntityList.this.listName);
                    responseWriter.writeString(responseFieldArr[6], GetEntityList.this.description);
                    ResponseField responseField = responseFieldArr[7];
                    EntityListStatus entityListStatus = GetEntityList.this.status;
                    responseWriter.writeString(responseField, entityListStatus != null ? entityListStatus.name() : null);
                    responseWriter.writeInt(responseFieldArr[8], GetEntityList.this.successfulCount);
                    responseWriter.writeInt(responseFieldArr[9], GetEntityList.this.duplicateCount);
                    responseWriter.writeInt(responseFieldArr[10], GetEntityList.this.invalidNumbersCount);
                    responseWriter.writeInt(responseFieldArr[11], GetEntityList.this.invalidEmailCount);
                    responseWriter.writeInt(responseFieldArr[12], GetEntityList.this.doNotTrackCount);
                    responseWriter.writeInt(responseFieldArr[13], GetEntityList.this.otherFailedCount);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], GetEntityList.this.ownerId);
                    responseWriter.writeString(responseFieldArr[15], GetEntityList.this.listCreationType.name());
                    responseWriter.writeString(responseFieldArr[16], GetEntityList.this.listCategory);
                    responseWriter.writeString(responseFieldArr[17], GetEntityList.this.rawBulkUploadFileRef);
                    responseWriter.writeString(responseFieldArr[18], GetEntityList.this.rawBulkUploadFileHash);
                    responseWriter.writeString(responseFieldArr[19], GetEntityList.this.modifiedBulkUploadFileRef);
                    responseWriter.writeString(responseFieldArr[20], GetEntityList.this.finalBulkUploadFileRef);
                    responseWriter.writeString(responseFieldArr[21], GetEntityList.this.leadSourceForBulkUpload);
                    responseWriter.writeString(responseFieldArr[22], GetEntityList.this.defaultCountryCode);
                    responseWriter.writeString(responseFieldArr[23], GetEntityList.this.defaultCountryIso);
                    responseWriter.writeString(responseFieldArr[24], GetEntityList.this.notificationBody);
                    responseWriter.writeString(responseFieldArr[25], GetEntityList.this.rule);
                    ResponseField responseField2 = responseFieldArr[26];
                    ContactAssignmentStatus contactAssignmentStatus = GetEntityList.this.toBeAssigned;
                    responseWriter.writeString(responseField2, contactAssignmentStatus != null ? contactAssignmentStatus.name() : null);
                    responseWriter.writeString(responseFieldArr[27], GetEntityList.this.assignedUserId);
                    responseWriter.writeString(responseFieldArr[28], GetEntityList.this.assignedTeamId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[29], GetEntityList.this.associatedDistributionId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[30], GetEntityList.this.entityActionDefinitionReference);
                    responseWriter.writeBoolean(responseFieldArr[31], GetEntityList.this.redistributeEntities);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[32], GetEntityList.this.redistributionRequestedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[33], GetEntityList.this.dupliacteLeadList);
                    responseWriter.writeList(responseFieldArr[34], GetEntityList.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetEntityListQuery.GetEntityList.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[35], GetEntityList.this.chatMessagePlatform);
                    responseWriter.writeBoolean(responseFieldArr[36], GetEntityList.this.allowMultiple);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[37], GetEntityList.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], GetEntityList.this.updatedAt);
                    ResponseField responseField3 = responseFieldArr[39];
                    AssociatedDistribution associatedDistribution = GetEntityList.this.associatedDistribution;
                    ...
                    EntityActionDefinition entityActionDefinition = GetEntityList.this.entityActionDefinition;
                    ...
                    Owner owner = GetEntityList.this.owner;
    ...
    public static class Owner {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetEntityListQuery.Owner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Owner.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetEntityListQuery.Variables.1
    ...
    public GetEntityListQuery(String str) {
    ...
    public String operationId() {
        return "f569c82a43c86f5c54f4bb28489e09c35fea1d0cfe5312e6724be2a6c26594f8";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetEntityList($id: ID!) {\n  getEntityList(id: $id) {\n    __typename\n    id\n    accountId\n    entityTypeInList\n    entityListType\n    listName\n    description\n    status\n    successfulCount\n    duplicateCount\n    invalidNumbersCount\n    invalidEmailCount\n    doNotTrackCount\n    otherFailedCount\n    ownerId\n    listCreationType\n    listCategory\n    rawBulkUploadFileRef\n    rawBulkUploadFileHash\n    modifiedBulkUploadFileRef\n    finalBulkUploadFileRef\n    leadSourceForBulkUpload\n    defaultCountryCode\n    defaultCountryIso\n    notificationBody\n    rule\n    toBeAssigned\n    assignedUserId\n    assignedTeamId\n    associatedDistributionId\n    entityActionDefinitionReference\n    redistributeEntities\n    redistributionRequestedAt\n    dupliacteLeadList\n    tags\n    chatMessagePlatform\n    allowMultiple\n    createdAt\n    updatedAt\n    associatedDistribution {\n      __typename\n      id\n      accountId\n      name\n      description\n      distributedEntityType\n      ifOwnerExists\n      assignLeadOwnerToTask\n      remeberAssigneeInDistributionScope\n      remeberAssigneeInGlobalScope\n      ownerId\n      distributionCreationType\n      createdAt\n      updatedAt\n    }\n    entityActionDefinition {\n      __typename\n      id\n      accountId\n      name\n      description\n      action\n      target\n      subscriptionType\n      periodicFrequency\n      periodicFrequencyUnit\n      startDateTime\n      endDateTime\n      status\n      ownerId\n      createdAt\n      updatedAt\n      createdBy\n      updatedBy\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
