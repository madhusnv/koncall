...
public final class OnCreateActivityLocationSubscription implements Subscription<Data, Data, Operation.Variables> {
    public static final String OPERATION_DEFINITION = "subscription OnCreateActivityLocation {\n  onCreateActivityLocation {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateActivityLocationSubscription.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "OnCreateActivityLocation";
        }
    };
    public static final String QUERY_DOCUMENT = "subscription OnCreateActivityLocation {\n  onCreateActivityLocation {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Operation.Variables variables = Operation.EMPTY_VARIABLES;

    public static final class Builder {
        public OnCreateActivityLocationSubscription build() {
            return new OnCreateActivityLocationSubscription();
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("onCreateActivityLocation", "onCreateActivityLocation", null, true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnCreateActivityLocation onCreateActivityLocation;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final OnCreateActivityLocation.Mapper onCreateActivityLocationFieldMapper = new OnCreateActivityLocation.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((OnCreateActivityLocation) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<OnCreateActivityLocation>() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateActivityLocationSubscription.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public OnCreateActivityLocation read(ResponseReader responseReader2) {
                        return Mapper.this.onCreateActivityLocationFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(OnCreateActivityLocation onCreateActivityLocation) {
            this.onCreateActivityLocation = onCreateActivityLocation;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnCreateActivityLocation onCreateActivityLocation = this.onCreateActivityLocation;
            OnCreateActivityLocation onCreateActivityLocation2 = ((Data) obj).onCreateActivityLocation;
            return onCreateActivityLocation == null ? onCreateActivityLocation2 == null : onCreateActivityLocation.equals(onCreateActivityLocation2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnCreateActivityLocation onCreateActivityLocation = this.onCreateActivityLocation;
                this.$hashCode = (onCreateActivityLocation == null ? 0 : onCreateActivityLocation.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateActivityLocationSubscription.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    OnCreateActivityLocation onCreateActivityLocation = Data.this.onCreateActivityLocation;
                    responseWriter.writeObject(responseField, onCreateActivityLocation != null ? onCreateActivityLocation.marshaller() : null);
                }
            };
        }

        public OnCreateActivityLocation onCreateActivityLocation() {
            return this.onCreateActivityLocation;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onCreateActivityLocation=" + this.onCreateActivityLocation + "}";
            }
            return this.$toString;
        }
    }

    public static class OnCreateActivityLocation {
        ...
        public static final class Mapper implements ResponseFieldMapper<OnCreateActivityLocation> {
            final User.Mapper userFieldMapper = new User.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public OnCreateActivityLocation map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = OnCreateActivityLocation.$responseFields;
                return new OnCreateActivityLocation(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), responseReader.readString(responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[8]), (User) responseReader.readObject(responseFieldArr[9], new ResponseReader.ObjectReader<User>() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateActivityLocationSubscription.OnCreateActivityLocation.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public OnCreateActivityLocation(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, User user) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnCreateActivityLocation)) {
                return false;
            }
            OnCreateActivityLocation onCreateActivityLocation = (OnCreateActivityLocation) obj;
            if (this.__typename.equals(onCreateActivityLocation.__typename) && this.id.equals(onCreateActivityLocation.id) && this.accountId.equals(onCreateActivityLocation.accountId) && ((str = this.engagementId) != null ? str.equals(onCreateActivityLocation.engagementId) : onCreateActivityLocation.engagementId == null) && ((str2 = this.lat) != null ? str2.equals(onCreateActivityLocation.lat) : onCreateActivityLocation.lat == null) && ((str3 = this.lng) != null ? str3.equals(onCreateActivityLocation.lng) : onCreateActivityLocation.lng == null) && this.ownerId.equals(onCreateActivityLocation.ownerId) && ((str4 = this.createdAt) != null ? str4.equals(onCreateActivityLocation.createdAt) : onCreateActivityLocation.createdAt == null) && ((str5 = this.updatedAt) != null ? str5.equals(onCreateActivityLocation.updatedAt) : onCreateActivityLocation.updatedAt == null)) {
                User user = this.user;
                User user2 = onCreateActivityLocation.user;
                if (user == null) {
                    if (user2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateActivityLocationSubscription.OnCreateActivityLocation.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = OnCreateActivityLocation.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], OnCreateActivityLocation.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], OnCreateActivityLocation.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], OnCreateActivityLocation.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], OnCreateActivityLocation.this.engagementId);
                    responseWriter.writeString(responseFieldArr[4], OnCreateActivityLocation.this.lat);
                    responseWriter.writeString(responseFieldArr[5], OnCreateActivityLocation.this.lng);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], OnCreateActivityLocation.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], OnCreateActivityLocation.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], OnCreateActivityLocation.this.updatedAt);
                    ResponseField responseField = responseFieldArr[9];
                    User user = OnCreateActivityLocation.this.user;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "OnCreateActivityLocation{__typename=" + this.__typename + ", id=" + this.id + ", accountId=" + this.accountId + ", engagementId=" + this.engagementId + ", lat=" + this.lat + ", lng=" + this.lng + ", ownerId=" + this.ownerId + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", user=" + this.user + "}";
            }
            return this.$toString;
        }
    ...
    public static class User {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateActivityLocationSubscription.User.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = User.$responseFields;
    ...
    public String operationId() {
        return "2492e93d721047aaa1950a5aff2e14913106317293eda76bb1152b3d0af60450";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "subscription OnCreateActivityLocation {\n  onCreateActivityLocation {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
