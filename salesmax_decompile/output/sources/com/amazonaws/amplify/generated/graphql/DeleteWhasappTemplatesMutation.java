...
import type.DeleteWhasappTemplatesInput;
import type.HasParent;
import type.ModelWhasappTemplatesConditionInput;
import type.ScopeLevel;

/* loaded from: classes7.dex */
public final class DeleteWhasappTemplatesMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation DeleteWhasappTemplates($input: DeleteWhasappTemplatesInput!, $condition: ModelWhasappTemplatesConditionInput) {\n  deleteWhasappTemplates(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "DeleteWhasappTemplates";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation DeleteWhasappTemplates($input: DeleteWhasappTemplatesInput!, $condition: ModelWhasappTemplatesConditionInput) {\n  deleteWhasappTemplates(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    ...
    public static class ActionInteractive {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.ActionInteractive.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], ActionInteractive.this.savedAddresses, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.ActionInteractive.1.1
    ...
    public static final class Builder {
        ...
        private DeleteWhasappTemplatesInput input;

        public DeleteWhasappTemplatesMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteWhasappTemplatesMutation(this.input, this.condition);
        }
        ...
        public Builder input(DeleteWhasappTemplatesInput deleteWhasappTemplatesInput) {
            this.input = deleteWhasappTemplatesInput;
            return this;
        }
    }
    ...
    public static class Component {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.Component.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteWhasappTemplates", "deleteWhasappTemplates", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final DeleteWhasappTemplates deleteWhasappTemplates;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteWhasappTemplates.Mapper deleteWhasappTemplatesFieldMapper = new DeleteWhasappTemplates.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteWhasappTemplates) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteWhasappTemplates>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteWhasappTemplates read(ResponseReader responseReader2) {
                        return Mapper.this.deleteWhasappTemplatesFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteWhasappTemplates deleteWhasappTemplates) {
            this.deleteWhasappTemplates = deleteWhasappTemplates;
        }

        public DeleteWhasappTemplates deleteWhasappTemplates() {
            return this.deleteWhasappTemplates;
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteWhasappTemplates deleteWhasappTemplates = this.deleteWhasappTemplates;
            DeleteWhasappTemplates deleteWhasappTemplates2 = ((Data) obj).deleteWhasappTemplates;
            return deleteWhasappTemplates == null ? deleteWhasappTemplates2 == null : deleteWhasappTemplates.equals(deleteWhasappTemplates2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteWhasappTemplates deleteWhasappTemplates = this.deleteWhasappTemplates;
                this.$hashCode = (deleteWhasappTemplates == null ? 0 : deleteWhasappTemplates.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteWhasappTemplates deleteWhasappTemplates = Data.this.deleteWhasappTemplates;
                    responseWriter.writeObject(responseField, deleteWhasappTemplates != null ? deleteWhasappTemplates.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteWhasappTemplates=" + this.deleteWhasappTemplates + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class DefaultMedia {
        ...
        public static final class Mapper implements ResponseFieldMapper<DefaultMedia> {
            ...
            public DefaultMedia map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[9], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.DefaultMedia.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.DefaultMedia.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultMedia.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[9], DefaultMedia.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.DefaultMedia.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class DefaultVariableMap {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.DefaultVariableMap.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultVariableMap.$responseFields;
    ...
    public static class DeleteWhasappTemplates {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<DeleteWhasappTemplates> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public DeleteWhasappTemplates map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = DeleteWhasappTemplates.$responseFields;
                return new DeleteWhasappTemplates(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), responseReader.readString(responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), responseReader.readString(responseFieldArr[6]), responseReader.readString(responseFieldArr[7]), responseReader.readList(responseFieldArr[8], new ResponseReader.ListReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.DeleteWhasappTemplates.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Component read(ResponseReader.ListItemReader listItemReader) {
                        return (Component) listItemReader.readObject(new ResponseReader.ObjectReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.DeleteWhasappTemplates.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteWhasappTemplates)) {
                return false;
            }
            DeleteWhasappTemplates deleteWhasappTemplates = (DeleteWhasappTemplates) obj;
            if (this.__typename.equals(deleteWhasappTemplates.__typename) && this.id.equals(deleteWhasappTemplates.id) && this.accountId.equals(deleteWhasappTemplates.accountId) && ((str = this.whatsappBusinessAccount) != null ? str.equals(deleteWhasappTemplates.whatsappBusinessAccount) : deleteWhasappTemplates.whatsappBusinessAccount == null) && ((str2 = this.templateType) != null ? str2.equals(deleteWhasappTemplates.templateType) : deleteWhasappTemplates.templateType == null) && ((str3 = this.snippetType) != null ? str3.equals(deleteWhasappTemplates.snippetType) : deleteWhasappTemplates.snippetType == null) && ((str4 = this.platform) != null ? str4.equals(deleteWhasappTemplates.platform) : deleteWhasappTemplates.platform == null) && ((str5 = this.name) != null ? str5.equals(deleteWhasappTemplates.name) : deleteWhasappTemplates.name == null) && ((list = this.components) != null ? list.equals(deleteWhasappTemplates.components) : deleteWhasappTemplates.components == null) && ((str6 = this.language) != null ? str6.equals(deleteWhasappTemplates.language) : deleteWhasappTemplates.language == null) && ((str7 = this.status) != null ? str7.equals(deleteWhasappTemplates.status) : deleteWhasappTemplates.status == null) && ((str8 = this.category) != null ? str8.equals(deleteWhasappTemplates.category) : deleteWhasappTemplates.category == null) && ((str9 = this.subCategory) != null ? str9.equals(deleteWhasappTemplates.subCategory) : deleteWhasappTemplates.subCategory == null) && ((str10 = this.snippetCategory) != null ? str10.equals(deleteWhasappTemplates.snippetCategory) : deleteWhasappTemplates.snippetCategory == null) && ((str11 = this.snippetSubCategory) != null ? str11.equals(deleteWhasappTemplates.snippetSubCategory) : deleteWhasappTemplates.snippetSubCategory == null) && ((str12 = this.createdBy) != null ? str12.equals(deleteWhasappTemplates.createdBy) : deleteWhasappTemplates.createdBy == null) && ((str13 = this.updatedBy) != null ? str13.equals(deleteWhasappTemplates.updatedBy) : deleteWhasappTemplates.updatedBy == null) && ((str14 = this.archivedStatus) != null ? str14.equals(deleteWhasappTemplates.archivedStatus) : deleteWhasappTemplates.archivedStatus == null) && ((str15 = this.archivedAt) != null ? str15.equals(deleteWhasappTemplates.archivedAt) : deleteWhasappTemplates.archivedAt == null) && ((str16 = this.defaultMediaId) != null ? str16.equals(deleteWhasappTemplates.defaultMediaId) : deleteWhasappTemplates.defaultMediaId == null) && ((list2 = this.defaultVariableMap) != null ? list2.equals(deleteWhasappTemplates.defaultVariableMap) : deleteWhasappTemplates.defaultVariableMap == null) && ((str17 = this.templateId) != null ? str17.equals(deleteWhasappTemplates.templateId) : deleteWhasappTemplates.templateId == null) && ((list3 = this.tags) != null ? list3.equals(deleteWhasappTemplates.tags) : deleteWhasappTemplates.tags == null) && ((bool = this.isSample) != null ? bool.equals(deleteWhasappTemplates.isSample) : deleteWhasappTemplates.isSample == null) && ((str18 = this.messageType) != null ? str18.equals(deleteWhasappTemplates.messageType) : deleteWhasappTemplates.messageType == null) && ((str19 = this.messageSubType) != null ? str19.equals(deleteWhasappTemplates.messageSubType) : deleteWhasappTemplates.messageSubType == null) && ((str20 = this.text) != null ? str20.equals(deleteWhasappTemplates.text) : deleteWhasappTemplates.text == null) && ((str21 = this.locationObjectToSend) != null ? str21.equals(deleteWhasappTemplates.locationObjectToSend) : deleteWhasappTemplates.locationObjectToSend == null) && ((str22 = this.headerText) != null ? str22.equals(deleteWhasappTemplates.headerText) : deleteWhasappTemplates.headerText == null) && ((str23 = this.footerText) != null ? str23.equals(deleteWhasappTemplates.footerText) : deleteWhasappTemplates.footerText == null) && ((str24 = this.headerType) != null ? str24.equals(deleteWhasappTemplates.headerType) : deleteWhasappTemplates.headerType == null) && ((actionInteractive = this.actionInteractive) != null ? actionInteractive.equals(deleteWhasappTemplates.actionInteractive) : deleteWhasappTemplates.actionInteractive == null) && ((str25 = this.messageTemplateQualityNew) != null ? str25.equals(deleteWhasappTemplates.messageTemplateQualityNew) : deleteWhasappTemplates.messageTemplateQualityNew == null) && ((str26 = this.messageTemplateQualityPrevious) != null ? str26.equals(deleteWhasappTemplates.messageTemplateQualityPrevious) : deleteWhasappTemplates.messageTemplateQualityPrevious == null) && ((str27 = this.messageTemplateQualityUpdatedAt) != null ? str27.equals(deleteWhasappTemplates.messageTemplateQualityUpdatedAt) : deleteWhasappTemplates.messageTemplateQualityUpdatedAt == null) && ((str28 = this.messageTemplateStatusUpdatedAt) != null ? str28.equals(deleteWhasappTemplates.messageTemplateStatusUpdatedAt) : deleteWhasappTemplates.messageTemplateStatusUpdatedAt == null) && ((str29 = this.stausUpdateReason) != null ? str29.equals(deleteWhasappTemplates.stausUpdateReason) : deleteWhasappTemplates.stausUpdateReason == null) && ((str30 = this.otherDetail) != null ? str30.equals(deleteWhasappTemplates.otherDetail) : deleteWhasappTemplates.otherDetail == null) && ((str31 = this.lastUsed) != null ? str31.equals(deleteWhasappTemplates.lastUsed) : deleteWhasappTemplates.lastUsed == null) && ((str32 = this.createdAt) != null ? str32.equals(deleteWhasappTemplates.createdAt) : deleteWhasappTemplates.createdAt == null) && ((str33 = this.updatedAt) != null ? str33.equals(deleteWhasappTemplates.updatedAt) : deleteWhasappTemplates.updatedAt == null)) {
                DefaultMedia defaultMedia = this.defaultMedia;
                DefaultMedia defaultMedia2 = deleteWhasappTemplates.defaultMedia;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.DeleteWhasappTemplates.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteWhasappTemplates.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteWhasappTemplates.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteWhasappTemplates.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteWhasappTemplates.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], DeleteWhasappTemplates.this.whatsappBusinessAccount);
                    responseWriter.writeString(responseFieldArr[4], DeleteWhasappTemplates.this.templateType);
                    responseWriter.writeString(responseFieldArr[5], DeleteWhasappTemplates.this.snippetType);
                    responseWriter.writeString(responseFieldArr[6], DeleteWhasappTemplates.this.platform);
                    responseWriter.writeString(responseFieldArr[7], DeleteWhasappTemplates.this.name);
                    responseWriter.writeList(responseFieldArr[8], DeleteWhasappTemplates.this.components, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.DeleteWhasappTemplates.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Component) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[9], DeleteWhasappTemplates.this.language);
                    responseWriter.writeString(responseFieldArr[10], DeleteWhasappTemplates.this.status);
                    responseWriter.writeString(responseFieldArr[11], DeleteWhasappTemplates.this.category);
                    responseWriter.writeString(responseFieldArr[12], DeleteWhasappTemplates.this.subCategory);
                    responseWriter.writeString(responseFieldArr[13], DeleteWhasappTemplates.this.snippetCategory);
                    responseWriter.writeString(responseFieldArr[14], DeleteWhasappTemplates.this.snippetSubCategory);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], DeleteWhasappTemplates.this.createdBy);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], DeleteWhasappTemplates.this.updatedBy);
                    responseWriter.writeString(responseFieldArr[17], DeleteWhasappTemplates.this.archivedStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], DeleteWhasappTemplates.this.archivedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], DeleteWhasappTemplates.this.defaultMediaId);
                    responseWriter.writeList(responseFieldArr[20], DeleteWhasappTemplates.this.defaultVariableMap, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.DeleteWhasappTemplates.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((DefaultVariableMap) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[21], DeleteWhasappTemplates.this.templateId);
                    responseWriter.writeList(responseFieldArr[22], DeleteWhasappTemplates.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.DeleteWhasappTemplates.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeBoolean(responseFieldArr[23], DeleteWhasappTemplates.this.isSample);
                    responseWriter.writeString(responseFieldArr[24], DeleteWhasappTemplates.this.messageType);
                    responseWriter.writeString(responseFieldArr[25], DeleteWhasappTemplates.this.messageSubType);
                    responseWriter.writeString(responseFieldArr[26], DeleteWhasappTemplates.this.text);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], DeleteWhasappTemplates.this.locationObjectToSend);
                    responseWriter.writeString(responseFieldArr[28], DeleteWhasappTemplates.this.headerText);
                    responseWriter.writeString(responseFieldArr[29], DeleteWhasappTemplates.this.footerText);
                    responseWriter.writeString(responseFieldArr[30], DeleteWhasappTemplates.this.headerType);
                    ResponseField responseField = responseFieldArr[31];
                    ActionInteractive actionInteractive = DeleteWhasappTemplates.this.actionInteractive;
                    responseWriter.writeObject(responseField, actionInteractive != null ? actionInteractive.marshaller() : null);
                    responseWriter.writeString(responseFieldArr[32], DeleteWhasappTemplates.this.messageTemplateQualityNew);
                    responseWriter.writeString(responseFieldArr[33], DeleteWhasappTemplates.this.messageTemplateQualityPrevious);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[34], DeleteWhasappTemplates.this.messageTemplateQualityUpdatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[35], DeleteWhasappTemplates.this.messageTemplateStatusUpdatedAt);
                    responseWriter.writeString(responseFieldArr[36], DeleteWhasappTemplates.this.stausUpdateReason);
                    responseWriter.writeString(responseFieldArr[37], DeleteWhasappTemplates.this.otherDetail);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], DeleteWhasappTemplates.this.lastUsed);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[39], DeleteWhasappTemplates.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[40], DeleteWhasappTemplates.this.updatedAt);
                    ResponseField responseField2 = responseFieldArr[41];
                    DefaultMedia defaultMedia = DeleteWhasappTemplates.this.defaultMedia;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final DeleteWhasappTemplatesInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteWhasappTemplatesInput deleteWhasappTemplatesInput, ModelWhasappTemplatesConditionInput modelWhasappTemplatesConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteWhasappTemplatesInput;
            this.condition = modelWhasappTemplatesConditionInput;
            linkedHashMap.put("input", deleteWhasappTemplatesInput);
        ...
        public DeleteWhasappTemplatesInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWhasappTemplatesMutation.Variables.1
    ...
    public DeleteWhasappTemplatesMutation(DeleteWhasappTemplatesInput deleteWhasappTemplatesInput, ModelWhasappTemplatesConditionInput modelWhasappTemplatesConditionInput) {
        Utils.checkNotNull(deleteWhasappTemplatesInput, "input == null");
        this.variables = new Variables(deleteWhasappTemplatesInput, modelWhasappTemplatesConditionInput);
    }
    ...
    public String operationId() {
        return "ba18eb3f6bb3b6b05a6d7ac1316eba908eb1ccbca1223ca4fbe5b2389a695977";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteWhasappTemplates($input: DeleteWhasappTemplatesInput!, $condition: ModelWhasappTemplatesConditionInput) {\n  deleteWhasappTemplates(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
