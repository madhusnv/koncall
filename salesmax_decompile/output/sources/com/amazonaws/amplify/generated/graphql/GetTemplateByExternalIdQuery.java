...
public final class GetTemplateByExternalIdQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetTemplateByExternalId($templateId: String, $sortDirection: ModelSortDirection, $filter: ModelWhasappTemplatesFilterInput, $limit: Int, $nextToken: String) {\n  getTemplateByExternalId(templateId: $templateId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      whatsappBusinessAccount\n      templateType\n      snippetType\n      platform\n      name\n      language\n      status\n      category\n      subCategory\n      snippetCategory\n      snippetSubCategory\n      createdBy\n      updatedBy\n      archivedStatus\n      archivedAt\n      defaultMediaId\n      templateId\n      tags\n      isSample\n      messageType\n      messageSubType\n      text\n      locationObjectToSend\n      headerText\n      footerText\n      headerType\n      messageTemplateQualityNew\n      messageTemplateQualityPrevious\n      messageTemplateQualityUpdatedAt\n      messageTemplateStatusUpdatedAt\n      stausUpdateReason\n      otherDetail\n      lastUsed\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateByExternalIdQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetTemplateByExternalId";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetTemplateByExternalId($templateId: String, $sortDirection: ModelSortDirection, $filter: ModelWhasappTemplatesFilterInput, $limit: Int, $nextToken: String) {\n  getTemplateByExternalId(templateId: $templateId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      whatsappBusinessAccount\n      templateType\n      snippetType\n      platform\n      name\n      language\n      status\n      category\n      subCategory\n      snippetCategory\n      snippetSubCategory\n      createdBy\n      updatedBy\n      archivedStatus\n      archivedAt\n      defaultMediaId\n      templateId\n      tags\n      isSample\n      messageType\n      messageSubType\n      text\n      locationObjectToSend\n      headerText\n      footerText\n      headerType\n      messageTemplateQualityNew\n      messageTemplateQualityPrevious\n      messageTemplateQualityUpdatedAt\n      messageTemplateStatusUpdatedAt\n      stausUpdateReason\n      otherDetail\n      lastUsed\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetTemplateByExternalIdQuery build() {
            return new GetTemplateByExternalIdQuery(this.templateId, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getTemplateByExternalId", "getTemplateByExternalId", new UnmodifiableMapBuilder(5).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("templateId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "templateId").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetTemplateByExternalId getTemplateByExternalId;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetTemplateByExternalId.Mapper getTemplateByExternalIdFieldMapper = new GetTemplateByExternalId.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetTemplateByExternalId) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetTemplateByExternalId>() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateByExternalIdQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetTemplateByExternalId read(ResponseReader responseReader2) {
                        return Mapper.this.getTemplateByExternalIdFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetTemplateByExternalId getTemplateByExternalId) {
            this.getTemplateByExternalId = getTemplateByExternalId;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetTemplateByExternalId getTemplateByExternalId = this.getTemplateByExternalId;
            GetTemplateByExternalId getTemplateByExternalId2 = ((Data) obj).getTemplateByExternalId;
            return getTemplateByExternalId == null ? getTemplateByExternalId2 == null : getTemplateByExternalId.equals(getTemplateByExternalId2);
        }

        public GetTemplateByExternalId getTemplateByExternalId() {
            return this.getTemplateByExternalId;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetTemplateByExternalId getTemplateByExternalId = this.getTemplateByExternalId;
                this.$hashCode = (getTemplateByExternalId == null ? 0 : getTemplateByExternalId.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateByExternalIdQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetTemplateByExternalId getTemplateByExternalId = Data.this.getTemplateByExternalId;
                    responseWriter.writeObject(responseField, getTemplateByExternalId != null ? getTemplateByExternalId.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getTemplateByExternalId=" + this.getTemplateByExternalId + "}";
            }
            return this.$toString;
        }
    }

    public static class GetTemplateByExternalId {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetTemplateByExternalId> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetTemplateByExternalId map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetTemplateByExternalId.$responseFields;
                return new GetTemplateByExternalId(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateByExternalIdQuery.GetTemplateByExternalId.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateByExternalIdQuery.GetTemplateByExternalId.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetTemplateByExternalId(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetTemplateByExternalId)) {
                return false;
            }
            GetTemplateByExternalId getTemplateByExternalId = (GetTemplateByExternalId) obj;
            if (this.__typename.equals(getTemplateByExternalId.__typename) && this.items.equals(getTemplateByExternalId.items)) {
                String str = this.nextToken;
                String str2 = getTemplateByExternalId.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateByExternalIdQuery.GetTemplateByExternalId.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetTemplateByExternalId.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetTemplateByExternalId.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetTemplateByExternalId.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateByExternalIdQuery.GetTemplateByExternalId.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetTemplateByExternalId.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetTemplateByExternalId{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateByExternalIdQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[20], Item.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateByExternalIdQuery.Item.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(String str, ModelSortDirection modelSortDirection, ModelWhasappTemplatesFilterInput modelWhasappTemplatesFilterInput, Integer num, String str2) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateByExternalIdQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("templateId", Variables.this.templateId);
    ...
    public GetTemplateByExternalIdQuery(String str, ModelSortDirection modelSortDirection, ModelWhasappTemplatesFilterInput modelWhasappTemplatesFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelSortDirection, modelWhasappTemplatesFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "858d69ca54adb6ae1d5d368a4ccc7c0498edcbb9f01594b3ec8ab89a4b4078fc";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetTemplateByExternalId($templateId: String, $sortDirection: ModelSortDirection, $filter: ModelWhasappTemplatesFilterInput, $limit: Int, $nextToken: String) {\n  getTemplateByExternalId(templateId: $templateId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      whatsappBusinessAccount\n      templateType\n      snippetType\n      platform\n      name\n      language\n      status\n      category\n      subCategory\n      snippetCategory\n      snippetSubCategory\n      createdBy\n      updatedBy\n      archivedStatus\n      archivedAt\n      defaultMediaId\n      templateId\n      tags\n      isSample\n      messageType\n      messageSubType\n      text\n      locationObjectToSend\n      headerText\n      footerText\n      headerType\n      messageTemplateQualityNew\n      messageTemplateQualityPrevious\n      messageTemplateQualityUpdatedAt\n      messageTemplateStatusUpdatedAt\n      stausUpdateReason\n      otherDetail\n      lastUsed\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
