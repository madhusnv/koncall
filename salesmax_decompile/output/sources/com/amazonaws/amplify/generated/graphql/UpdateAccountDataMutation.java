...
public final class UpdateAccountDataMutation implements Mutation<Data, Data, Variables> {
    ...
    public static class AccountStats {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.AccountStats.1
    ...
    public static final class Builder {
        private ModelAccountConditionInput condition;
        private UpdateAccountInput input;

        public UpdateAccountDataMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new UpdateAccountDataMutation(this.input, this.condition);
        }

        public Builder condition(ModelAccountConditionInput modelAccountConditionInput) {
            this.condition = modelAccountConditionInput;
            return this;
        }

        public Builder input(UpdateAccountInput updateAccountInput) {
            this.input = updateAccountInput;
            return this;
        }
    }
    ...
    public static class CreatedByUser {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.CreatedByUser.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreatedByUser.$responseFields;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("updateAccountData", "updateAccountData", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final UpdateAccountData updateAccountData;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final UpdateAccountData.Mapper updateAccountDataFieldMapper = new UpdateAccountData.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((UpdateAccountData) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<UpdateAccountData>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdateAccountData read(ResponseReader responseReader2) {
                        return Mapper.this.updateAccountDataFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(UpdateAccountData updateAccountData) {
            this.updateAccountData = updateAccountData;
        }
        ...
        public boolean equals(Object obj) {
            ...
            UpdateAccountData updateAccountData = this.updateAccountData;
            UpdateAccountData updateAccountData2 = ((Data) obj).updateAccountData;
            return updateAccountData == null ? updateAccountData2 == null : updateAccountData.equals(updateAccountData2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                UpdateAccountData updateAccountData = this.updateAccountData;
                this.$hashCode = (updateAccountData == null ? 0 : updateAccountData.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    UpdateAccountData updateAccountData = Data.this.updateAccountData;
                    responseWriter.writeObject(responseField, updateAccountData != null ? updateAccountData.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{updateAccountData=" + this.updateAccountData + "}";
            }
            return this.$toString;
        }

        public UpdateAccountData updateAccountData() {
    ...
    public static class LastPaymentData {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.LastPaymentData.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = LastPaymentData.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[17], LastPaymentData.this.paidByContactIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.LastPaymentData.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], LastPaymentData.this.transactionId, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.LastPaymentData.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class MatchingDeal {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.MatchingDeal.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = MatchingDeal.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[17], MatchingDeal.this.transitionSummary, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.MatchingDeal.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], MatchingDeal.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.MatchingDeal.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[21], MatchingDeal.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.MatchingDeal.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class Subscriptions {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.Subscriptions.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Subscriptions.$responseFields;
    ...
    public static class UpdateAccountData {
        ...
        public static final class Mapper implements ResponseFieldMapper<UpdateAccountData> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public UpdateAccountData map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = UpdateAccountData.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String string2 = responseReader.readString(responseFieldArr[2]);
                String string3 = responseReader.readString(responseFieldArr[3]);
                ...
                }), responseReader.readList(responseFieldArr[40], new ResponseReader.ListReader<WebPreference>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.UpdateAccountData.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public WebPreference read(ResponseReader.ListItemReader listItemReader) {
                        return (WebPreference) listItemReader.readObject(new ResponseReader.ObjectReader<WebPreference>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.UpdateAccountData.Mapper.3.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), (MatchingDeal) responseReader.readObject(responseFieldArr[66], new ResponseReader.ObjectReader<MatchingDeal>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.UpdateAccountData.Mapper.11
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public MatchingDeal read(ResponseReader responseReader2) {
                        return Mapper.this.matchingDealFieldMapper.map(responseReader2);
                    }
                }), (CreatedByUser) responseReader.readObject(responseFieldArr[67], new ResponseReader.ObjectReader<CreatedByUser>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.UpdateAccountData.Mapper.12
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreatedByUser read(ResponseReader responseReader2) {
                        return Mapper.this.createdByUserFieldMapper.map(responseReader2);
                    }
                }), (UpdatedByUser) responseReader.readObject(responseFieldArr[68], new ResponseReader.ObjectReader<UpdatedByUser>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.UpdateAccountData.Mapper.13
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (this.__typename.equals(updateAccountData.__typename) && this.id.equals(updateAccountData.id) && this.accountName.equals(updateAccountData.accountName) && this.accountType.equals(updateAccountData.accountType) && ((str = this.deviceKey) != null ? str.equals(updateAccountData.deviceKey) : updateAccountData.deviceKey == null) && ((str2 = this.deviceKeyLastUpdated) != null ? str2.equals(updateAccountData.deviceKeyLastUpdated) : updateAccountData.deviceKeyLastUpdated == null) && ((accountStatus = this.accountStatus) != null ? accountStatus.equals(updateAccountData.accountStatus) : updateAccountData.accountStatus == null) && ((str3 = this.businessLogoUrl) != null ? str3.equals(updateAccountData.businessLogoUrl) : updateAccountData.businessLogoUrl == null) && ((str4 = this.createdById) != null ? str4.equals(updateAccountData.createdById) : updateAccountData.createdById == null) && ((str5 = this.dateFormat) != null ? str5.equals(updateAccountData.dateFormat) : updateAccountData.dateFormat == null) && ((str6 = this.dateTimeViewStyle) != null ? str6.equals(updateAccountData.dateTimeViewStyle) : updateAccountData.dateTimeViewStyle == null) && ((str7 = this.defaultCurrency) != null ? str7.equals(updateAccountData.defaultCurrency) : updateAccountData.defaultCurrency == null) && ((str8 = this.denomination) != null ? str8.equals(updateAccountData.denomination) : updateAccountData.denomination == null) && ((str9 = this.industry) != null ? str9.equals(updateAccountData.industry) : updateAccountData.industry == null) && ((str10 = this.nameOfBusiness) != null ? str10.equals(updateAccountData.nameOfBusiness) : updateAccountData.nameOfBusiness == null) && ((list = this.productOrService) != null ? list.equals(updateAccountData.productOrService) : updateAccountData.productOrService == null) && ((str11 = this.timeFormat) != null ? str11.equals(updateAccountData.timeFormat) : updateAccountData.timeFormat == null) && ((str12 = this.timeZone) != null ? str12.equals(updateAccountData.timeZone) : updateAccountData.timeZone == null) && ((str13 = this.plan) != null ? str13.equals(updateAccountData.plan) : updateAccountData.plan == null) && ((str14 = this.paidUpTo) != null ? str14.equals(updateAccountData.paidUpTo) : updateAccountData.paidUpTo == null) && ((num = this.seats) != null ? num.equals(updateAccountData.seats) : updateAccountData.seats == null) && ((num2 = this.freeSeats) != null ? num2.equals(updateAccountData.freeSeats) : updateAccountData.freeSeats == null) && ((num3 = this.currentTotalUsers) != null ? num3.equals(updateAccountData.currentTotalUsers) : updateAccountData.currentTotalUsers == null) && ((num4 = this.currentActiveUsers) != null ? num4.equals(updateAccountData.currentActiveUsers) : updateAccountData.currentActiveUsers == null) && ((num5 = this.extraActiveUsers) != null ? num5.equals(updateAccountData.extraActiveUsers) : updateAccountData.extraActiveUsers == null) && ((num6 = this.pricePerSeat) != null ? num6.equals(updateAccountData.pricePerSeat) : updateAccountData.pricePerSeat == null) && ((bool = this.allowAddingSeat) != null ? bool.equals(updateAccountData.allowAddingSeat) : updateAccountData.allowAddingSeat == null) && ((str15 = this.allowAddingSeatTill) != null ? str15.equals(updateAccountData.allowAddingSeatTill) : updateAccountData.allowAddingSeatTill == null) && ((num7 = this.seatReductionMarkedForNextCycle) != null ? num7.equals(updateAccountData.seatReductionMarkedForNextCycle) : updateAccountData.seatReductionMarkedForNextCycle == null) && ((str16 = this.billingCurrency) != null ? str16.equals(updateAccountData.billingCurrency) : updateAccountData.billingCurrency == null) && ((str17 = this.billingEmail) != null ? str17.equals(updateAccountData.billingEmail) : updateAccountData.billingEmail == null) && ((str18 = this.taxId) != null ? str18.equals(updateAccountData.taxId) : updateAccountData.taxId == null) && ((str19 = this.taxIdType) != null ? str19.equals(updateAccountData.taxIdType) : updateAccountData.taxIdType == null) && ((str20 = this.trialAccountEndDate) != null ? str20.equals(updateAccountData.trialAccountEndDate) : updateAccountData.trialAccountEndDate == null) && ((num8 = this.trialExtensionTimes) != null ? num8.equals(updateAccountData.trialExtensionTimes) : updateAccountData.trialExtensionTimes == null) && ((bool2 = this.eligibleForExtension) != null ? bool2.equals(updateAccountData.eligibleForExtension) : updateAccountData.eligibleForExtension == null) && ((str21 = this.paidForTillDate) != null ? str21.equals(updateAccountData.paidForTillDate) : updateAccountData.paidForTillDate == null) && ((str22 = this.updatedById) != null ? str22.equals(updateAccountData.updatedById) : updateAccountData.updatedById == null) && ((str23 = this.website) != null ? str23.equals(updateAccountData.website) : updateAccountData.website == null) && ((list2 = this.workingHours) != null ? list2.equals(updateAccountData.workingHours) : updateAccountData.workingHours == null) && ((list3 = this.webPreferences) != null ? list3.equals(updateAccountData.webPreferences) : updateAccountData.webPreferences == null) && ((list4 = this.permissions) != null ? list4.equals(updateAccountData.permissions) : updateAccountData.permissions == null) && ((bool3 = this.enableCustomCharts) != null ? bool3.equals(updateAccountData.enableCustomCharts) : updateAccountData.enableCustomCharts == null) && ((str24 = this.createdAt) != null ? str24.equals(updateAccountData.createdAt) : updateAccountData.createdAt == null) && ((str25 = this.updatedAt) != null ? str25.equals(updateAccountData.updatedAt) : updateAccountData.updatedAt == null) && ((str26 = this.dealMode) != null ? str26.equals(updateAccountData.dealMode) : updateAccountData.dealMode == null) && ((str27 = this.openAiApiKey) != null ? str27.equals(updateAccountData.openAiApiKey) : updateAccountData.openAiApiKey == null) && ((list5 = this.salesmaxSalesContacts) != null ? list5.equals(updateAccountData.salesmaxSalesContacts) : updateAccountData.salesmaxSalesContacts == null) && ((list6 = this.salesmaxSupportContacts) != null ? list6.equals(updateAccountData.salesmaxSupportContacts) : updateAccountData.salesmaxSupportContacts == null) && ((str28 = this.chatWidgetConfig) != null ? str28.equals(updateAccountData.chatWidgetConfig) : updateAccountData.chatWidgetConfig == null) && ((str29 = this.onboardingStatus) != null ? str29.equals(updateAccountData.onboardingStatus) : updateAccountData.onboardingStatus == null) && ((str30 = this.integrationNeeded) != null ? str30.equals(updateAccountData.integrationNeeded) : updateAccountData.integrationNeeded == null) && ((str31 = this.matchingDealId) != null ? str31.equals(updateAccountData.matchingDealId) : updateAccountData.matchingDealId == null) && ((list7 = this.relatedAccountIds) != null ? list7.equals(updateAccountData.relatedAccountIds) : updateAccountData.relatedAccountIds == null) && ((accountStats = this.accountStats) != null ? accountStats.equals(updateAccountData.accountStats) : updateAccountData.accountStats == null) && ((str32 = this.lastChurnDate) != null ? str32.equals(updateAccountData.lastChurnDate) : updateAccountData.lastChurnDate == null) && ((str33 = this.lastChurnReason) != null ? str33.equals(updateAccountData.lastChurnReason) : updateAccountData.lastChurnReason == null) && ((str34 = this.possibleReactivationDate) != null ? str34.equals(updateAccountData.possibleReactivationDate) : updateAccountData.possibleReactivationDate == null) && ((d = this.locationPeriodicFrequency) != null ? d.equals(updateAccountData.locationPeriodicFrequency) : updateAccountData.locationPeriodicFrequency == null) && ((str35 = this.lastPaymentDataId) != null ? str35.equals(updateAccountData.lastPaymentDataId) : updateAccountData.lastPaymentDataId == null) && ((str36 = this.lastPaymentDataCreatedAt) != null ? str36.equals(updateAccountData.lastPaymentDataCreatedAt) : updateAccountData.lastPaymentDataCreatedAt == null) && ((str37 = this.nextRenewalDateIfPaid) != null ? str37.equals(updateAccountData.nextRenewalDateIfPaid) : updateAccountData.nextRenewalDateIfPaid == null) && ((str38 = this.lastPaymentStatus) != null ? str38.equals(updateAccountData.lastPaymentStatus) : updateAccountData.lastPaymentStatus == null) && ((num9 = this.partPaymentAmountIfAny) != null ? num9.equals(updateAccountData.partPaymentAmountIfAny) : updateAccountData.partPaymentAmountIfAny == null) && ((subscriptions = this.subscriptions) != null ? subscriptions.equals(updateAccountData.subscriptions) : updateAccountData.subscriptions == null) && ((lastPaymentData = this.lastPaymentData) != null ? lastPaymentData.equals(updateAccountData.lastPaymentData) : updateAccountData.lastPaymentData == null) && ((matchingDeal = this.matchingDeal) != null ? matchingDeal.equals(updateAccountData.matchingDeal) : updateAccountData.matchingDeal == null) && ((createdByUser = this.createdByUser) != null ? createdByUser.equals(updateAccountData.createdByUser) : updateAccountData.createdByUser == null)) {
                UpdatedByUser updatedByUser = this.updatedByUser;
                UpdatedByUser updatedByUser2 = updateAccountData.updatedByUser;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.UpdateAccountData.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdateAccountData.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UpdateAccountData.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], UpdateAccountData.this.id);
                    responseWriter.writeString(responseFieldArr[2], UpdateAccountData.this.accountName);
                    responseWriter.writeString(responseFieldArr[3], UpdateAccountData.this.accountType.name());
                    responseWriter.writeString(responseFieldArr[4], UpdateAccountData.this.deviceKey);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], UpdateAccountData.this.deviceKeyLastUpdated);
                    ResponseField responseField = responseFieldArr[6];
                    AccountStatus accountStatus = UpdateAccountData.this.accountStatus;
                    responseWriter.writeString(responseField, accountStatus != null ? accountStatus.name() : null);
                    responseWriter.writeString(responseFieldArr[7], UpdateAccountData.this.businessLogoUrl);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], UpdateAccountData.this.createdById);
                    responseWriter.writeString(responseFieldArr[9], UpdateAccountData.this.dateFormat);
                    responseWriter.writeString(responseFieldArr[10], UpdateAccountData.this.dateTimeViewStyle);
                    responseWriter.writeString(responseFieldArr[11], UpdateAccountData.this.defaultCurrency);
                    responseWriter.writeString(responseFieldArr[12], UpdateAccountData.this.denomination);
                    responseWriter.writeString(responseFieldArr[13], UpdateAccountData.this.industry);
                    responseWriter.writeString(responseFieldArr[14], UpdateAccountData.this.nameOfBusiness);
                    responseWriter.writeList(responseFieldArr[15], UpdateAccountData.this.productOrService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.UpdateAccountData.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[16], UpdateAccountData.this.timeFormat);
                    responseWriter.writeString(responseFieldArr[17], UpdateAccountData.this.timeZone);
                    responseWriter.writeString(responseFieldArr[18], UpdateAccountData.this.plan);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], UpdateAccountData.this.paidUpTo);
                    responseWriter.writeInt(responseFieldArr[20], UpdateAccountData.this.seats);
                    responseWriter.writeInt(responseFieldArr[21], UpdateAccountData.this.freeSeats);
                    responseWriter.writeInt(responseFieldArr[22], UpdateAccountData.this.currentTotalUsers);
                    responseWriter.writeInt(responseFieldArr[23], UpdateAccountData.this.currentActiveUsers);
                    responseWriter.writeInt(responseFieldArr[24], UpdateAccountData.this.extraActiveUsers);
                    responseWriter.writeInt(responseFieldArr[25], UpdateAccountData.this.pricePerSeat);
                    responseWriter.writeBoolean(responseFieldArr[26], UpdateAccountData.this.allowAddingSeat);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], UpdateAccountData.this.allowAddingSeatTill);
                    responseWriter.writeInt(responseFieldArr[28], UpdateAccountData.this.seatReductionMarkedForNextCycle);
                    responseWriter.writeString(responseFieldArr[29], UpdateAccountData.this.billingCurrency);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[30], UpdateAccountData.this.billingEmail);
                    responseWriter.writeString(responseFieldArr[31], UpdateAccountData.this.taxId);
                    responseWriter.writeString(responseFieldArr[32], UpdateAccountData.this.taxIdType);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[33], UpdateAccountData.this.trialAccountEndDate);
                    responseWriter.writeInt(responseFieldArr[34], UpdateAccountData.this.trialExtensionTimes);
                    responseWriter.writeBoolean(responseFieldArr[35], UpdateAccountData.this.eligibleForExtension);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[36], UpdateAccountData.this.paidForTillDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[37], UpdateAccountData.this.updatedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], UpdateAccountData.this.website);
                    responseWriter.writeList(responseFieldArr[39], UpdateAccountData.this.workingHours, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.UpdateAccountData.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((WorkingHour) obj).marshaller());
                        }
                    });
                    responseWriter.writeList(responseFieldArr[40], UpdateAccountData.this.webPreferences, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.UpdateAccountData.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((WebPreference) obj).marshaller());
                        }
                    });
                    responseWriter.writeList(responseFieldArr[41], UpdateAccountData.this.permissions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.UpdateAccountData.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    });
                    responseWriter.writeBoolean(responseFieldArr[42], UpdateAccountData.this.enableCustomCharts);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[43], UpdateAccountData.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[44], UpdateAccountData.this.updatedAt);
                    responseWriter.writeString(responseFieldArr[45], UpdateAccountData.this.dealMode);
                    responseWriter.writeString(responseFieldArr[46], UpdateAccountData.this.openAiApiKey);
                    responseWriter.writeList(responseFieldArr[47], UpdateAccountData.this.salesmaxSalesContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.UpdateAccountData.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[48], UpdateAccountData.this.salesmaxSupportContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.UpdateAccountData.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[49], UpdateAccountData.this.chatWidgetConfig);
                    responseWriter.writeString(responseFieldArr[50], UpdateAccountData.this.onboardingStatus);
                    responseWriter.writeString(responseFieldArr[51], UpdateAccountData.this.integrationNeeded);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[52], UpdateAccountData.this.matchingDealId);
                    responseWriter.writeList(responseFieldArr[53], UpdateAccountData.this.relatedAccountIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.UpdateAccountData.1.7
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    ...
                    AccountStats accountStats = UpdateAccountData.this.accountStats;
                    responseWriter.writeObject(responseField2, accountStats != null ? accountStats.marshaller() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[55], UpdateAccountData.this.lastChurnDate);
                    responseWriter.writeString(responseFieldArr[56], UpdateAccountData.this.lastChurnReason);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[57], UpdateAccountData.this.possibleReactivationDate);
                    responseWriter.writeDouble(responseFieldArr[58], UpdateAccountData.this.locationPeriodicFrequency);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[59], UpdateAccountData.this.lastPaymentDataId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[60], UpdateAccountData.this.lastPaymentDataCreatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[61], UpdateAccountData.this.nextRenewalDateIfPaid);
                    responseWriter.writeString(responseFieldArr[62], UpdateAccountData.this.lastPaymentStatus);
                    responseWriter.writeInt(responseFieldArr[63], UpdateAccountData.this.partPaymentAmountIfAny);
                    ResponseField responseField3 = responseFieldArr[64];
                    Subscriptions subscriptions = UpdateAccountData.this.subscriptions;
                    ...
                    LastPaymentData lastPaymentData = UpdateAccountData.this.lastPaymentData;
                    ...
                    MatchingDeal matchingDeal = UpdateAccountData.this.matchingDeal;
                    ...
                    CreatedByUser createdByUser = UpdateAccountData.this.createdByUser;
                    ...
                    UpdatedByUser updatedByUser = UpdateAccountData.this.updatedByUser;
    ...
    public static class UpdatedByUser {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.UpdatedByUser.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdatedByUser.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        private final ModelAccountConditionInput condition;
        private final UpdateAccountInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(UpdateAccountInput updateAccountInput, ModelAccountConditionInput modelAccountConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = updateAccountInput;
            this.condition = modelAccountConditionInput;
            linkedHashMap.put("input", updateAccountInput);
            linkedHashMap.put("condition", modelAccountConditionInput);
        }

        public ModelAccountConditionInput condition() {
            return this.condition;
        }

        public UpdateAccountInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.Variables.1
    ...
    public static class WebPreference {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.WebPreference.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = WebPreference.$responseFields;
    ...
    public static class WorkingHour {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountDataMutation.WorkingHour.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = WorkingHour.$responseFields;
    ...
    public UpdateAccountDataMutation(UpdateAccountInput updateAccountInput, ModelAccountConditionInput modelAccountConditionInput) {
        Utils.checkNotNull(updateAccountInput, "input == null");
        this.variables = new Variables(updateAccountInput, modelAccountConditionInput);
    }
    ...
    public String operationId() {
        return "66abee38b56da09d57c4098b564c21619c97effd028212085286617f10b37a63";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation UpdateAccountData($input: UpdateAccountInput!, $condition: ModelAccountConditionInput) {\n  updateAccountData(input: $input, condition: $condition) {\n    __typename\n    id\n    accountName\n    accountType\n    deviceKey\n    deviceKeyLastUpdated\n    accountStatus\n    businessLogoUrl\n    createdById\n    dateFormat\n    dateTimeViewStyle\n    defaultCurrency\n    denomination\n    industry\n    nameOfBusiness\n    productOrService\n    timeFormat\n    timeZone\n    plan\n    paidUpTo\n    seats\n    freeSeats\n    currentTotalUsers\n    currentActiveUsers\n    extraActiveUsers\n    pricePerSeat\n    allowAddingSeat\n    allowAddingSeatTill\n    seatReductionMarkedForNextCycle\n    billingCurrency\n    billingEmail\n    taxId\n    taxIdType\n    trialAccountEndDate\n    trialExtensionTimes\n    eligibleForExtension\n    paidForTillDate\n    updatedById\n    website\n    workingHours {\n      __typename\n      day\n      startTime\n      endTime\n    }\n    webPreferences {\n      __typename\n      key\n      value\n    }\n    permissions\n    enableCustomCharts\n    createdAt\n    updatedAt\n    dealMode\n    openAiApiKey\n    salesmaxSalesContacts\n    salesmaxSupportContacts\n    chatWidgetConfig\n    onboardingStatus\n    integrationNeeded\n    matchingDealId\n    relatedAccountIds\n    accountStats {\n      __typename\n      callSevenDays\n      wabaConversationSevenDays\n      wabaBroadcastSevenDays\n      paymentSevenDays\n      taskSevenDays\n      callPreviousSevenDays\n      wabaConversationPreviousSevenDays\n      contactCreatedPreviousSevenDays\n      bulkActionsSeventDays\n      bulkActionsSeventDays_BULK_UPLOAD\n      bulkActionsSeventDays_CREATE_TAG\n      bulkActionsSeventDays_CAMPAIGN_WITH_RULE\n      bulkActionsSeventDays_BULK_UPDATE\n      bulkActionsSeventDays_GENERATE_REPORT\n      bulkActionsSeventDays_REMOVE_USER\n      bulkActionsPreviousSeventDays\n      onboardingStepsDone\n    }\n    lastChurnDate\n    lastChurnReason\n    possibleReactivationDate\n    locationPeriodicFrequency\n    lastPaymentDataId\n    lastPaymentDataCreatedAt\n    nextRenewalDateIfPaid\n    lastPaymentStatus\n    partPaymentAmountIfAny\n    subscriptions {\n      __typename\n      nextToken\n    }\n    lastPaymentData {\n      __typename\n      id\n      accountId\n      contactId\n      paymentRequestType\n      engagementId\n      paymentProvider\n      orderIdInPaymentProvider\n      orderId\n      paymentLinkId\n      paymentLinkUrl\n      amount\n      amountPaid\n      currency\n      status\n      lastPaymentStatus\n      finalPaymentDate\n      paidByContactIds\n      transactionId\n      note\n      createdAt\n      updatedAt\n      customPaymentData\n      createdById\n      updatedById\n    }\n    matchingDeal {\n      __typename\n      id\n      accountId\n      name\n      description\n      dealStage\n      dealStageUpdatedAt\n      dealState\n      dealOutcome\n      dealLostReason\n      amount\n      currency\n      createdByUser\n      lastUpdatedByUser\n      ownerId\n      primaryTeamId\n      openTaskDetail\n      transitionSummary\n      recentEngagements\n      recentEngagementsUpdatedAt\n      lastActivity\n      tags\n      customDealData\n      createdAt\n      updatedAt\n    }\n    createdByUser {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedByUser {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
