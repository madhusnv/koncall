...
import type.DeleteCampaignRunInput;
import type.ModelCampaignRunConditionInput;
import type.UserRegistrationStatus;

/* loaded from: classes6.dex */
public final class DeleteCampaignRunMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation DeleteCampaignRun($input: DeleteCampaignRunInput!, $condition: ModelCampaignRunConditionInput) {\n  deleteCampaignRun(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCampaignRunMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "DeleteCampaignRun";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation DeleteCampaignRun($input: DeleteCampaignRunInput!, $condition: ModelCampaignRunConditionInput) {\n  deleteCampaignRun(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelCampaignRunConditionInput condition;
        private DeleteCampaignRunInput input;

        public DeleteCampaignRunMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteCampaignRunMutation(this.input, this.condition);
        }
        ...
        public Builder input(DeleteCampaignRunInput deleteCampaignRunInput) {
            this.input = deleteCampaignRunInput;
            return this;
        }
    }
    ...
    public static class Campaign {
        ...
        public static final class Mapper implements ResponseFieldMapper<Campaign> {
            ...
            public Campaign map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[15], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCampaignRunMutation.Campaign.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCampaignRunMutation.Campaign.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[15], Campaign.this.daysToSend, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCampaignRunMutation.Campaign.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[29], Campaign.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCampaignRunMutation.Campaign.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteCampaignRun", "deleteCampaignRun", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final DeleteCampaignRun deleteCampaignRun;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteCampaignRun.Mapper deleteCampaignRunFieldMapper = new DeleteCampaignRun.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteCampaignRun) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteCampaignRun>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCampaignRunMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteCampaignRun read(ResponseReader responseReader2) {
                        return Mapper.this.deleteCampaignRunFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteCampaignRun deleteCampaignRun) {
            this.deleteCampaignRun = deleteCampaignRun;
        }

        public DeleteCampaignRun deleteCampaignRun() {
            return this.deleteCampaignRun;
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteCampaignRun deleteCampaignRun = this.deleteCampaignRun;
            DeleteCampaignRun deleteCampaignRun2 = ((Data) obj).deleteCampaignRun;
            return deleteCampaignRun == null ? deleteCampaignRun2 == null : deleteCampaignRun.equals(deleteCampaignRun2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteCampaignRun deleteCampaignRun = this.deleteCampaignRun;
                this.$hashCode = (deleteCampaignRun == null ? 0 : deleteCampaignRun.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCampaignRunMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteCampaignRun deleteCampaignRun = Data.this.deleteCampaignRun;
                    responseWriter.writeObject(responseField, deleteCampaignRun != null ? deleteCampaignRun.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteCampaignRun=" + this.deleteCampaignRun + "}";
            }
            return this.$toString;
        }
    }

    public static class DeleteCampaignRun {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<DeleteCampaignRun> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public DeleteCampaignRun map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = DeleteCampaignRun.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
        ...
        public DeleteCampaignRun(String str, String str2, String str3, String str4, String str5, CampaignType campaignType, String str6, String str7, String str8, String str9, CampaignStatus campaignStatus, String str10, Integer num, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, Integer num7, String str11, String str12, PrimaryTeam primaryTeam, String str13, String str14, Campaign campaign, Owner owner) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteCampaignRun)) {
                return false;
            }
            DeleteCampaignRun deleteCampaignRun = (DeleteCampaignRun) obj;
            if (this.__typename.equals(deleteCampaignRun.__typename) && this.id.equals(deleteCampaignRun.id) && this.accountId.equals(deleteCampaignRun.accountId) && this.campaignId.equals(deleteCampaignRun.campaignId) && ((str = this.campaignName) != null ? str.equals(deleteCampaignRun.campaignName) : deleteCampaignRun.campaignName == null) && ((campaignType = this.campaignType) != null ? campaignType.equals(deleteCampaignRun.campaignType) : deleteCampaignRun.campaignType == null) && ((str2 = this.campaignChannelIdentifier) != null ? str2.equals(deleteCampaignRun.campaignChannelIdentifier) : deleteCampaignRun.campaignChannelIdentifier == null) && this.name.equals(deleteCampaignRun.name) && ((str3 = this.startDate) != null ? str3.equals(deleteCampaignRun.startDate) : deleteCampaignRun.startDate == null) && ((str4 = this.endDate) != null ? str4.equals(deleteCampaignRun.endDate) : deleteCampaignRun.endDate == null) && this.status.equals(deleteCampaignRun.status) && ((str5 = this.systemPauseReason) != null ? str5.equals(deleteCampaignRun.systemPauseReason) : deleteCampaignRun.systemPauseReason == null) && ((num = this.leadCount) != null ? num.equals(deleteCampaignRun.leadCount) : deleteCampaignRun.leadCount == null) && ((num2 = this.messageCreated) != null ? num2.equals(deleteCampaignRun.messageCreated) : deleteCampaignRun.messageCreated == null) && ((num3 = this.sentCount) != null ? num3.equals(deleteCampaignRun.sentCount) : deleteCampaignRun.sentCount == null) && ((num4 = this.deliveredCount) != null ? num4.equals(deleteCampaignRun.deliveredCount) : deleteCampaignRun.deliveredCount == null) && ((num5 = this.readCount) != null ? num5.equals(deleteCampaignRun.readCount) : deleteCampaignRun.readCount == null) && ((num6 = this.repliedCount) != null ? num6.equals(deleteCampaignRun.repliedCount) : deleteCampaignRun.repliedCount == null) && ((num7 = this.failedCount) != null ? num7.equals(deleteCampaignRun.failedCount) : deleteCampaignRun.failedCount == null) && this.ownerId.equals(deleteCampaignRun.ownerId) && ((str6 = this.primaryTeamId) != null ? str6.equals(deleteCampaignRun.primaryTeamId) : deleteCampaignRun.primaryTeamId == null) && ((primaryTeam = this.primaryTeam) != null ? primaryTeam.equals(deleteCampaignRun.primaryTeam) : deleteCampaignRun.primaryTeam == null) && ((str7 = this.createdAt) != null ? str7.equals(deleteCampaignRun.createdAt) : deleteCampaignRun.createdAt == null) && ((str8 = this.updatedAt) != null ? str8.equals(deleteCampaignRun.updatedAt) : deleteCampaignRun.updatedAt == null) && ((campaign = this.campaign) != null ? campaign.equals(deleteCampaignRun.campaign) : deleteCampaignRun.campaign == null)) {
                Owner owner = this.owner;
                Owner owner2 = deleteCampaignRun.owner;
                if (owner == null) {
                    if (owner2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCampaignRunMutation.DeleteCampaignRun.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteCampaignRun.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteCampaignRun.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteCampaignRun.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteCampaignRun.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], DeleteCampaignRun.this.campaignId);
                    responseWriter.writeString(responseFieldArr[4], DeleteCampaignRun.this.campaignName);
                    ResponseField responseField = responseFieldArr[5];
                    CampaignType campaignType = DeleteCampaignRun.this.campaignType;
                    responseWriter.writeString(responseField, campaignType != null ? campaignType.name() : null);
                    responseWriter.writeString(responseFieldArr[6], DeleteCampaignRun.this.campaignChannelIdentifier);
                    responseWriter.writeString(responseFieldArr[7], DeleteCampaignRun.this.name);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], DeleteCampaignRun.this.startDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], DeleteCampaignRun.this.endDate);
                    responseWriter.writeString(responseFieldArr[10], DeleteCampaignRun.this.status.name());
                    responseWriter.writeString(responseFieldArr[11], DeleteCampaignRun.this.systemPauseReason);
                    responseWriter.writeInt(responseFieldArr[12], DeleteCampaignRun.this.leadCount);
                    responseWriter.writeInt(responseFieldArr[13], DeleteCampaignRun.this.messageCreated);
                    responseWriter.writeInt(responseFieldArr[14], DeleteCampaignRun.this.sentCount);
                    responseWriter.writeInt(responseFieldArr[15], DeleteCampaignRun.this.deliveredCount);
                    responseWriter.writeInt(responseFieldArr[16], DeleteCampaignRun.this.readCount);
                    responseWriter.writeInt(responseFieldArr[17], DeleteCampaignRun.this.repliedCount);
                    responseWriter.writeInt(responseFieldArr[18], DeleteCampaignRun.this.failedCount);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], DeleteCampaignRun.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], DeleteCampaignRun.this.primaryTeamId);
                    ResponseField responseField2 = responseFieldArr[21];
                    PrimaryTeam primaryTeam = DeleteCampaignRun.this.primaryTeam;
                    responseWriter.writeObject(responseField2, primaryTeam != null ? primaryTeam.marshaller() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], DeleteCampaignRun.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], DeleteCampaignRun.this.updatedAt);
                    ResponseField responseField3 = responseFieldArr[24];
                    Campaign campaign = DeleteCampaignRun.this.campaign;
                    ...
                    Owner owner = DeleteCampaignRun.this.owner;
    ...
    public static class Owner {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCampaignRunMutation.Owner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Owner.$responseFields;
    ...
    public static class PrimaryTeam {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCampaignRunMutation.PrimaryTeam.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = PrimaryTeam.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final DeleteCampaignRunInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteCampaignRunInput deleteCampaignRunInput, ModelCampaignRunConditionInput modelCampaignRunConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteCampaignRunInput;
            this.condition = modelCampaignRunConditionInput;
            linkedHashMap.put("input", deleteCampaignRunInput);
        ...
        public DeleteCampaignRunInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCampaignRunMutation.Variables.1
    ...
    public DeleteCampaignRunMutation(DeleteCampaignRunInput deleteCampaignRunInput, ModelCampaignRunConditionInput modelCampaignRunConditionInput) {
        Utils.checkNotNull(deleteCampaignRunInput, "input == null");
        this.variables = new Variables(deleteCampaignRunInput, modelCampaignRunConditionInput);
    }
    ...
    public String operationId() {
        return "ce5750861a6cee661d9f348aef539bae533b9a51db8bb999c4d6c3909a952984";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteCampaignRun($input: DeleteCampaignRunInput!, $condition: ModelCampaignRunConditionInput) {\n  deleteCampaignRun(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
