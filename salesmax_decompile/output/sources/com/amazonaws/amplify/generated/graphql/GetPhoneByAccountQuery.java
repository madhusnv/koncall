...
import type.ModelWabaPhoneNumberFilterInput;

/* loaded from: classes7.dex */
public final class GetPhoneByAccountQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetPhoneByAccount($accountId: ID, $phoneNumber: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelWabaPhoneNumberFilterInput, $limit: Int, $nextToken: String) {\n  getPhoneByAccount(accountId: $accountId, phoneNumber: $phoneNumber, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      wabaAccountId\n      accountId\n      phoneNumberId\n      phoneNumber\n      isDefault\n      accessToken\n      name\n      internalName\n      quota\n      currentLimitCategory\n      status\n      qualityRating\n      entityListId\n      createdAt\n      updatedAt\n      welcomeMessage\n      requestedDisplayName\n      displayNameUpdate\n      displayNameUpdateDateTime\n      wabaNumberDecision\n      wabaNumberDecisionTime\n      rejectionReason\n      phoneNumberQualityUpdate\n      phoneNumberQualityUpdateTime\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetPhoneByAccountQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetPhoneByAccount";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetPhoneByAccount($accountId: ID, $phoneNumber: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelWabaPhoneNumberFilterInput, $limit: Int, $nextToken: String) {\n  getPhoneByAccount(accountId: $accountId, phoneNumber: $phoneNumber, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      wabaAccountId\n      accountId\n      phoneNumberId\n      phoneNumber\n      isDefault\n      accessToken\n      name\n      internalName\n      quota\n      currentLimitCategory\n      status\n      qualityRating\n      entityListId\n      createdAt\n      updatedAt\n      welcomeMessage\n      requestedDisplayName\n      displayNameUpdate\n      displayNameUpdateDateTime\n      wabaNumberDecision\n      wabaNumberDecisionTime\n      rejectionReason\n      phoneNumberQualityUpdate\n      phoneNumberQualityUpdateTime\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private String accountId;
        private ModelWabaPhoneNumberFilterInput filter;
        private Integer limit;
        private String nextToken;
        private ModelStringKeyConditionInput phoneNumber;
        ...
        public GetPhoneByAccountQuery build() {
            return new GetPhoneByAccountQuery(this.accountId, this.phoneNumber, this.sortDirection, this.filter, this.limit, this.nextToken);
        }

        public Builder filter(ModelWabaPhoneNumberFilterInput modelWabaPhoneNumberFilterInput) {
            this.filter = modelWabaPhoneNumberFilterInput;
            return this;
        }
        ...
        public Builder phoneNumber(ModelStringKeyConditionInput modelStringKeyConditionInput) {
            this.phoneNumber = modelStringKeyConditionInput;
            return this;
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getPhoneByAccount", "getPhoneByAccount", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put("phoneNumber", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "phoneNumber").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetPhoneByAccount getPhoneByAccount;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetPhoneByAccount.Mapper getPhoneByAccountFieldMapper = new GetPhoneByAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetPhoneByAccount) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetPhoneByAccount>() { // from class: com.amazonaws.amplify.generated.graphql.GetPhoneByAccountQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetPhoneByAccount read(ResponseReader responseReader2) {
                        return Mapper.this.getPhoneByAccountFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetPhoneByAccount getPhoneByAccount) {
            this.getPhoneByAccount = getPhoneByAccount;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetPhoneByAccount getPhoneByAccount = this.getPhoneByAccount;
            GetPhoneByAccount getPhoneByAccount2 = ((Data) obj).getPhoneByAccount;
            return getPhoneByAccount == null ? getPhoneByAccount2 == null : getPhoneByAccount.equals(getPhoneByAccount2);
        }

        public GetPhoneByAccount getPhoneByAccount() {
            return this.getPhoneByAccount;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetPhoneByAccount getPhoneByAccount = this.getPhoneByAccount;
                this.$hashCode = (getPhoneByAccount == null ? 0 : getPhoneByAccount.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPhoneByAccountQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetPhoneByAccount getPhoneByAccount = Data.this.getPhoneByAccount;
                    responseWriter.writeObject(responseField, getPhoneByAccount != null ? getPhoneByAccount.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getPhoneByAccount=" + this.getPhoneByAccount + "}";
            }
            return this.$toString;
        }
    }

    public static class GetPhoneByAccount {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetPhoneByAccount> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetPhoneByAccount map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetPhoneByAccount.$responseFields;
                return new GetPhoneByAccount(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetPhoneByAccountQuery.GetPhoneByAccount.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetPhoneByAccountQuery.GetPhoneByAccount.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetPhoneByAccount(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetPhoneByAccount)) {
                return false;
            }
            GetPhoneByAccount getPhoneByAccount = (GetPhoneByAccount) obj;
            if (this.__typename.equals(getPhoneByAccount.__typename) && this.items.equals(getPhoneByAccount.items)) {
                String str = this.nextToken;
                String str2 = getPhoneByAccount.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPhoneByAccountQuery.GetPhoneByAccount.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetPhoneByAccount.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetPhoneByAccount.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetPhoneByAccount.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPhoneByAccountQuery.GetPhoneByAccount.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetPhoneByAccount.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetPhoneByAccount{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPhoneByAccountQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final ModelWabaPhoneNumberFilterInput filter;
        private final Integer limit;
        private final String nextToken;
        private final ModelStringKeyConditionInput phoneNumber;
        private final ModelSortDirection sortDirection;
        private final transient Map<String, Object> valueMap;

        public Variables(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelWabaPhoneNumberFilterInput modelWabaPhoneNumberFilterInput, Integer num, String str2) {
            ...
            linkedHashMap.put("phoneNumber", modelStringKeyConditionInput);
            linkedHashMap.put("sortDirection", modelSortDirection);
            linkedHashMap.put("filter", modelWabaPhoneNumberFilterInput);
        ...
        public ModelWabaPhoneNumberFilterInput filter() {
            return this.filter;
        }
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPhoneByAccountQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("accountId", Variables.this.accountId);
                    inputFieldWriter.writeObject("phoneNumber", Variables.this.phoneNumber != null ? Variables.this.phoneNumber.marshaller() : null);
        ...
        public ModelStringKeyConditionInput phoneNumber() {
            return this.phoneNumber;
        }
    ...
    public GetPhoneByAccountQuery(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelWabaPhoneNumberFilterInput modelWabaPhoneNumberFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelStringKeyConditionInput, modelSortDirection, modelWabaPhoneNumberFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "f728699048970e61b369d8e75cc07276aa7a9f586a61e639996ba5b78426517d";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetPhoneByAccount($accountId: ID, $phoneNumber: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelWabaPhoneNumberFilterInput, $limit: Int, $nextToken: String) {\n  getPhoneByAccount(accountId: $accountId, phoneNumber: $phoneNumber, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      wabaAccountId\n      accountId\n      phoneNumberId\n      phoneNumber\n      isDefault\n      accessToken\n      name\n      internalName\n      quota\n      currentLimitCategory\n      status\n      qualityRating\n      entityListId\n      createdAt\n      updatedAt\n      welcomeMessage\n      requestedDisplayName\n      displayNameUpdate\n      displayNameUpdateDateTime\n      wabaNumberDecision\n      wabaNumberDecisionTime\n      rejectionReason\n      phoneNumberQualityUpdate\n      phoneNumberQualityUpdateTime\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    }
