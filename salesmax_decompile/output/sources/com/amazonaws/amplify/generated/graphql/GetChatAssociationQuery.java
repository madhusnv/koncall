...
public final class GetChatAssociationQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetChatAssociation($id: ID!) {\n  getChatAssociation(id: $id) {\n    __typename\n    id\n    accountId\n    channelId\n    relatedObjectId\n    relatedObjectType\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetChatAssociationQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetChatAssociation";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetChatAssociation($id: ID!) {\n  getChatAssociation(id: $id) {\n    __typename\n    id\n    accountId\n    channelId\n    relatedObjectId\n    relatedObjectType\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private String id;

        public GetChatAssociationQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetChatAssociationQuery(this.id);
        }
    ...
    public static class Channel {
        ...
        public static final class Mapper implements ResponseFieldMapper<Channel> {
            ...
            public Channel map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[6], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetChatAssociationQuery.Channel.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChatAssociationQuery.Channel.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[6], Channel.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetChatAssociationQuery.Channel.1.1
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getChatAssociation", "getChatAssociation", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetChatAssociation getChatAssociation;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetChatAssociation.Mapper getChatAssociationFieldMapper = new GetChatAssociation.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetChatAssociation) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetChatAssociation>() { // from class: com.amazonaws.amplify.generated.graphql.GetChatAssociationQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetChatAssociation read(ResponseReader responseReader2) {
                        return Mapper.this.getChatAssociationFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetChatAssociation getChatAssociation) {
            this.getChatAssociation = getChatAssociation;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetChatAssociation getChatAssociation = this.getChatAssociation;
            GetChatAssociation getChatAssociation2 = ((Data) obj).getChatAssociation;
            return getChatAssociation == null ? getChatAssociation2 == null : getChatAssociation.equals(getChatAssociation2);
        }

        public GetChatAssociation getChatAssociation() {
            return this.getChatAssociation;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetChatAssociation getChatAssociation = this.getChatAssociation;
                this.$hashCode = (getChatAssociation == null ? 0 : getChatAssociation.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChatAssociationQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetChatAssociation getChatAssociation = Data.this.getChatAssociation;
                    responseWriter.writeObject(responseField, getChatAssociation != null ? getChatAssociation.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getChatAssociation=" + this.getChatAssociation + "}";
            }
            return this.$toString;
        }
    }

    public static class GetChatAssociation {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<GetChatAssociation> {
            final Channel.Mapper channelFieldMapper = new Channel.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetChatAssociation map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetChatAssociation.$responseFields;
                return new GetChatAssociation(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (Channel) responseReader.readObject(responseFieldArr[8], new ResponseReader.ObjectReader<Channel>() { // from class: com.amazonaws.amplify.generated.graphql.GetChatAssociationQuery.GetChatAssociation.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetChatAssociation(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, Channel channel) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetChatAssociation)) {
                return false;
            }
            GetChatAssociation getChatAssociation = (GetChatAssociation) obj;
            if (this.__typename.equals(getChatAssociation.__typename) && this.id.equals(getChatAssociation.id) && this.accountId.equals(getChatAssociation.accountId) && this.channelId.equals(getChatAssociation.channelId) && this.relatedObjectId.equals(getChatAssociation.relatedObjectId) && this.relatedObjectType.equals(getChatAssociation.relatedObjectType) && ((str = this.createdAt) != null ? str.equals(getChatAssociation.createdAt) : getChatAssociation.createdAt == null) && ((str2 = this.updatedAt) != null ? str2.equals(getChatAssociation.updatedAt) : getChatAssociation.updatedAt == null)) {
                Channel channel = this.channel;
                Channel channel2 = getChatAssociation.channel;
                if (channel == null) {
                    if (channel2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChatAssociationQuery.GetChatAssociation.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetChatAssociation.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetChatAssociation.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetChatAssociation.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetChatAssociation.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], GetChatAssociation.this.channelId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], GetChatAssociation.this.relatedObjectId);
                    responseWriter.writeString(responseFieldArr[5], GetChatAssociation.this.relatedObjectType);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], GetChatAssociation.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], GetChatAssociation.this.updatedAt);
                    ResponseField responseField = responseFieldArr[8];
                    Channel channel = GetChatAssociation.this.channel;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetChatAssociation{__typename=" + this.__typename + ", id=" + this.id + ", accountId=" + this.accountId + ", channelId=" + this.channelId + ", relatedObjectId=" + this.relatedObjectId + ", relatedObjectType=" + this.relatedObjectType + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", channel=" + this.channel + "}";
            }
            return this.$toString;
        }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChatAssociationQuery.Variables.1
    ...
    public GetChatAssociationQuery(String str) {
    ...
    public String operationId() {
        return "b9d4b89b2043ef43231c13e61bb37053a6d28684d15d5bce8abfba1b1641f671";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetChatAssociation($id: ID!) {\n  getChatAssociation(id: $id) {\n    __typename\n    id\n    accountId\n    channelId\n    relatedObjectId\n    relatedObjectType\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
