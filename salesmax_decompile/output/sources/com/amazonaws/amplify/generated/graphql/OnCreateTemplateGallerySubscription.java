...
public final class OnCreateTemplateGallerySubscription implements Subscription<Data, Data, Operation.Variables> {
    public static final String OPERATION_DEFINITION = "subscription OnCreateTemplateGallery {\n  onCreateTemplateGallery {\n    __typename\n    id\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    categoryLevelOne\n    categoryLevelTwo\n    applicableForIndustry\n    viewedTimes\n    savedToWorkspaceTimes\n    sentToWhatsappTimes\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "OnCreateTemplateGallery";
        }
    };
    public static final String QUERY_DOCUMENT = "subscription OnCreateTemplateGallery {\n  onCreateTemplateGallery {\n    __typename\n    id\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    categoryLevelOne\n    categoryLevelTwo\n    applicableForIndustry\n    viewedTimes\n    savedToWorkspaceTimes\n    sentToWhatsappTimes\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Operation.Variables variables = Operation.EMPTY_VARIABLES;

    public static final class Builder {
        public OnCreateTemplateGallerySubscription build() {
            return new OnCreateTemplateGallerySubscription();
        }
    }
    ...
    public static class Component {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.Component.1
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("onCreateTemplateGallery", "onCreateTemplateGallery", null, true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnCreateTemplateGallery onCreateTemplateGallery;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final OnCreateTemplateGallery.Mapper onCreateTemplateGalleryFieldMapper = new OnCreateTemplateGallery.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((OnCreateTemplateGallery) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<OnCreateTemplateGallery>() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public OnCreateTemplateGallery read(ResponseReader responseReader2) {
                        return Mapper.this.onCreateTemplateGalleryFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(OnCreateTemplateGallery onCreateTemplateGallery) {
            this.onCreateTemplateGallery = onCreateTemplateGallery;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnCreateTemplateGallery onCreateTemplateGallery = this.onCreateTemplateGallery;
            OnCreateTemplateGallery onCreateTemplateGallery2 = ((Data) obj).onCreateTemplateGallery;
            return onCreateTemplateGallery == null ? onCreateTemplateGallery2 == null : onCreateTemplateGallery.equals(onCreateTemplateGallery2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnCreateTemplateGallery onCreateTemplateGallery = this.onCreateTemplateGallery;
                this.$hashCode = (onCreateTemplateGallery == null ? 0 : onCreateTemplateGallery.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    OnCreateTemplateGallery onCreateTemplateGallery = Data.this.onCreateTemplateGallery;
                    responseWriter.writeObject(responseField, onCreateTemplateGallery != null ? onCreateTemplateGallery.marshaller() : null);
                }
            };
        }

        public OnCreateTemplateGallery onCreateTemplateGallery() {
            return this.onCreateTemplateGallery;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onCreateTemplateGallery=" + this.onCreateTemplateGallery + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class DefaultMedia {
        ...
        public static final class Mapper implements ResponseFieldMapper<DefaultMedia> {
            ...
            public DefaultMedia map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[9], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.DefaultMedia.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.DefaultMedia.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultMedia.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[9], DefaultMedia.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.DefaultMedia.1.1
    ...
    public static class DefaultVariableMap {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.DefaultVariableMap.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultVariableMap.$responseFields;
    ...
    public static class OnCreateTemplateGallery {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<OnCreateTemplateGallery> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public OnCreateTemplateGallery map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = OnCreateTemplateGallery.$responseFields;
                return new OnCreateTemplateGallery(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), responseReader.readString(responseFieldArr[2]), responseReader.readString(responseFieldArr[3]), responseReader.readList(responseFieldArr[4], new ResponseReader.ListReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.OnCreateTemplateGallery.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Component read(ResponseReader.ListItemReader listItemReader) {
                        return (Component) listItemReader.readObject(new ResponseReader.ObjectReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.OnCreateTemplateGallery.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), responseReader.readString(responseFieldArr[14]), responseReader.readList(responseFieldArr[15], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.OnCreateTemplateGallery.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                }), responseReader.readString(responseFieldArr[16]), responseReader.readString(responseFieldArr[17]), responseReader.readList(responseFieldArr[18], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.OnCreateTemplateGallery.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                }), responseReader.readInt(responseFieldArr[19]), responseReader.readInt(responseFieldArr[20]), responseReader.readInt(responseFieldArr[21]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[22]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[23]), (DefaultMedia) responseReader.readObject(responseFieldArr[24], new ResponseReader.ObjectReader<DefaultMedia>() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.OnCreateTemplateGallery.Mapper.5
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public OnCreateTemplateGallery(String str, String str2, String str3, String str4, List<Component> list, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, List<DefaultVariableMap> list2, String str13, List<String> list3, String str14, String str15, List<String> list4, Integer num, Integer num2, Integer num3, String str16, String str17, DefaultMedia defaultMedia) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.platform = str3;
            this.name = str4;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnCreateTemplateGallery)) {
                return false;
            }
            OnCreateTemplateGallery onCreateTemplateGallery = (OnCreateTemplateGallery) obj;
            if (this.__typename.equals(onCreateTemplateGallery.__typename) && this.id.equals(onCreateTemplateGallery.id) && ((str = this.platform) != null ? str.equals(onCreateTemplateGallery.platform) : onCreateTemplateGallery.platform == null) && ((str2 = this.name) != null ? str2.equals(onCreateTemplateGallery.name) : onCreateTemplateGallery.name == null) && ((list = this.components) != null ? list.equals(onCreateTemplateGallery.components) : onCreateTemplateGallery.components == null) && ((str3 = this.language) != null ? str3.equals(onCreateTemplateGallery.language) : onCreateTemplateGallery.language == null) && ((str4 = this.status) != null ? str4.equals(onCreateTemplateGallery.status) : onCreateTemplateGallery.status == null) && ((str5 = this.category) != null ? str5.equals(onCreateTemplateGallery.category) : onCreateTemplateGallery.category == null) && ((str6 = this.createdBy) != null ? str6.equals(onCreateTemplateGallery.createdBy) : onCreateTemplateGallery.createdBy == null) && ((str7 = this.updatedBy) != null ? str7.equals(onCreateTemplateGallery.updatedBy) : onCreateTemplateGallery.updatedBy == null) && ((str8 = this.archivedStatus) != null ? str8.equals(onCreateTemplateGallery.archivedStatus) : onCreateTemplateGallery.archivedStatus == null) && ((str9 = this.archivedAt) != null ? str9.equals(onCreateTemplateGallery.archivedAt) : onCreateTemplateGallery.archivedAt == null) && ((str10 = this.defaultMediaId) != null ? str10.equals(onCreateTemplateGallery.defaultMediaId) : onCreateTemplateGallery.defaultMediaId == null) && ((list2 = this.defaultVariableMap) != null ? list2.equals(onCreateTemplateGallery.defaultVariableMap) : onCreateTemplateGallery.defaultVariableMap == null) && ((str11 = this.templateId) != null ? str11.equals(onCreateTemplateGallery.templateId) : onCreateTemplateGallery.templateId == null) && ((list3 = this.tags) != null ? list3.equals(onCreateTemplateGallery.tags) : onCreateTemplateGallery.tags == null) && ((str12 = this.categoryLevelOne) != null ? str12.equals(onCreateTemplateGallery.categoryLevelOne) : onCreateTemplateGallery.categoryLevelOne == null) && ((str13 = this.categoryLevelTwo) != null ? str13.equals(onCreateTemplateGallery.categoryLevelTwo) : onCreateTemplateGallery.categoryLevelTwo == null) && ((list4 = this.applicableForIndustry) != null ? list4.equals(onCreateTemplateGallery.applicableForIndustry) : onCreateTemplateGallery.applicableForIndustry == null) && ((num = this.viewedTimes) != null ? num.equals(onCreateTemplateGallery.viewedTimes) : onCreateTemplateGallery.viewedTimes == null) && ((num2 = this.savedToWorkspaceTimes) != null ? num2.equals(onCreateTemplateGallery.savedToWorkspaceTimes) : onCreateTemplateGallery.savedToWorkspaceTimes == null) && ((num3 = this.sentToWhatsappTimes) != null ? num3.equals(onCreateTemplateGallery.sentToWhatsappTimes) : onCreateTemplateGallery.sentToWhatsappTimes == null) && ((str14 = this.createdAt) != null ? str14.equals(onCreateTemplateGallery.createdAt) : onCreateTemplateGallery.createdAt == null) && ((str15 = this.updatedAt) != null ? str15.equals(onCreateTemplateGallery.updatedAt) : onCreateTemplateGallery.updatedAt == null)) {
                DefaultMedia defaultMedia = this.defaultMedia;
                DefaultMedia defaultMedia2 = onCreateTemplateGallery.defaultMedia;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.OnCreateTemplateGallery.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = OnCreateTemplateGallery.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], OnCreateTemplateGallery.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], OnCreateTemplateGallery.this.id);
                    responseWriter.writeString(responseFieldArr[2], OnCreateTemplateGallery.this.platform);
                    responseWriter.writeString(responseFieldArr[3], OnCreateTemplateGallery.this.name);
                    responseWriter.writeList(responseFieldArr[4], OnCreateTemplateGallery.this.components, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.OnCreateTemplateGallery.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Component) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[5], OnCreateTemplateGallery.this.language);
                    responseWriter.writeString(responseFieldArr[6], OnCreateTemplateGallery.this.status);
                    responseWriter.writeString(responseFieldArr[7], OnCreateTemplateGallery.this.category);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], OnCreateTemplateGallery.this.createdBy);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], OnCreateTemplateGallery.this.updatedBy);
                    responseWriter.writeString(responseFieldArr[10], OnCreateTemplateGallery.this.archivedStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], OnCreateTemplateGallery.this.archivedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], OnCreateTemplateGallery.this.defaultMediaId);
                    responseWriter.writeList(responseFieldArr[13], OnCreateTemplateGallery.this.defaultVariableMap, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.OnCreateTemplateGallery.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((DefaultVariableMap) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[14], OnCreateTemplateGallery.this.templateId);
                    responseWriter.writeList(responseFieldArr[15], OnCreateTemplateGallery.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.OnCreateTemplateGallery.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[16], OnCreateTemplateGallery.this.categoryLevelOne);
                    responseWriter.writeString(responseFieldArr[17], OnCreateTemplateGallery.this.categoryLevelTwo);
                    responseWriter.writeList(responseFieldArr[18], OnCreateTemplateGallery.this.applicableForIndustry, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateTemplateGallerySubscription.OnCreateTemplateGallery.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeInt(responseFieldArr[19], OnCreateTemplateGallery.this.viewedTimes);
                    responseWriter.writeInt(responseFieldArr[20], OnCreateTemplateGallery.this.savedToWorkspaceTimes);
                    responseWriter.writeInt(responseFieldArr[21], OnCreateTemplateGallery.this.sentToWhatsappTimes);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], OnCreateTemplateGallery.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], OnCreateTemplateGallery.this.updatedAt);
                    ResponseField responseField = responseFieldArr[24];
                    DefaultMedia defaultMedia = OnCreateTemplateGallery.this.defaultMedia;
    ...
    public String operationId() {
        return "19f17051dd6b943991b437c629975bbeff7ad3f270d2332586014e573c32606f";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "subscription OnCreateTemplateGallery {\n  onCreateTemplateGallery {\n    __typename\n    id\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    categoryLevelOne\n    categoryLevelTwo\n    applicableForIndustry\n    viewedTimes\n    savedToWorkspaceTimes\n    sentToWhatsappTimes\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
