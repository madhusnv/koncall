...
public final class GetBotContextByUserIdQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetBotContextByUserId($accountId: ID, $userId: ModelIDKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelChatBotContextFilterInput, $limit: Int, $nextToken: String) {\n  getBotContextByUserId(accountId: $accountId, userId: $userId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      handlerChatBot\n      masterChatBot\n      accountId\n      contactId\n      userId\n      channelId\n      lastChatMessageId\n      createdAt\n      updatedAt\n      isPaused\n      pausedBy\n      pausedById\n      pausedAt\n      currentIntent\n      intentList\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByUserIdQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetBotContextByUserId";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetBotContextByUserId($accountId: ID, $userId: ModelIDKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelChatBotContextFilterInput, $limit: Int, $nextToken: String) {\n  getBotContextByUserId(accountId: $accountId, userId: $userId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      handlerChatBot\n      masterChatBot\n      accountId\n      contactId\n      userId\n      channelId\n      lastChatMessageId\n      createdAt\n      updatedAt\n      isPaused\n      pausedBy\n      pausedById\n      pausedAt\n      currentIntent\n      intentList\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetBotContextByUserIdQuery build() {
            return new GetBotContextByUserIdQuery(this.accountId, this.userId, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getBotContextByUserId", "getBotContextByUserId", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("userId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "userId").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetBotContextByUserId getBotContextByUserId;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetBotContextByUserId.Mapper getBotContextByUserIdFieldMapper = new GetBotContextByUserId.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetBotContextByUserId) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetBotContextByUserId>() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByUserIdQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetBotContextByUserId read(ResponseReader responseReader2) {
                        return Mapper.this.getBotContextByUserIdFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetBotContextByUserId getBotContextByUserId) {
            this.getBotContextByUserId = getBotContextByUserId;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetBotContextByUserId getBotContextByUserId = this.getBotContextByUserId;
            GetBotContextByUserId getBotContextByUserId2 = ((Data) obj).getBotContextByUserId;
            return getBotContextByUserId == null ? getBotContextByUserId2 == null : getBotContextByUserId.equals(getBotContextByUserId2);
        }

        public GetBotContextByUserId getBotContextByUserId() {
            return this.getBotContextByUserId;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetBotContextByUserId getBotContextByUserId = this.getBotContextByUserId;
                this.$hashCode = (getBotContextByUserId == null ? 0 : getBotContextByUserId.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByUserIdQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetBotContextByUserId getBotContextByUserId = Data.this.getBotContextByUserId;
                    responseWriter.writeObject(responseField, getBotContextByUserId != null ? getBotContextByUserId.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getBotContextByUserId=" + this.getBotContextByUserId + "}";
            }
            return this.$toString;
        }
    }

    public static class GetBotContextByUserId {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetBotContextByUserId> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetBotContextByUserId map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetBotContextByUserId.$responseFields;
                return new GetBotContextByUserId(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByUserIdQuery.GetBotContextByUserId.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByUserIdQuery.GetBotContextByUserId.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetBotContextByUserId(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetBotContextByUserId)) {
                return false;
            }
            GetBotContextByUserId getBotContextByUserId = (GetBotContextByUserId) obj;
            if (this.__typename.equals(getBotContextByUserId.__typename) && this.items.equals(getBotContextByUserId.items)) {
                String str = this.nextToken;
                String str2 = getBotContextByUserId.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByUserIdQuery.GetBotContextByUserId.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetBotContextByUserId.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetBotContextByUserId.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetBotContextByUserId.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByUserIdQuery.GetBotContextByUserId.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetBotContextByUserId.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetBotContextByUserId{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByUserIdQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[16], Item.this.intentList, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByUserIdQuery.Item.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBotContextByUserIdQuery.Variables.1
    ...
    public GetBotContextByUserIdQuery(String str, ModelIDKeyConditionInput modelIDKeyConditionInput, ModelSortDirection modelSortDirection, ModelChatBotContextFilterInput modelChatBotContextFilterInput, Integer num, String str2) {
    ...
    public String operationId() {
        return "466ad9842b07ecb9620cdd968b5fcb05613676eb90a7a57d8236c171d5a9794a";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetBotContextByUserId($accountId: ID, $userId: ModelIDKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelChatBotContextFilterInput, $limit: Int, $nextToken: String) {\n  getBotContextByUserId(accountId: $accountId, userId: $userId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      handlerChatBot\n      masterChatBot\n      accountId\n      contactId\n      userId\n      channelId\n      lastChatMessageId\n      createdAt\n      updatedAt\n      isPaused\n      pausedBy\n      pausedById\n      pausedAt\n      currentIntent\n      intentList\n    }\n    nextToken\n  }\n}";
    }
