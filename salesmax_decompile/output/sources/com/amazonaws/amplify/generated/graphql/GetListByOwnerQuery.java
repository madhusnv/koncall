...
import type.ModelEntityListByListOwnerCompositeKeyConditionInput;
import type.ModelEntityListFilterInput;
import type.ModelSortDirection;

/* loaded from: classes7.dex */
public final class GetListByOwnerQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetListByOwner($accountId: ID, $ownerIdEntityTypeInListUpdatedAt: ModelEntityListByListOwnerCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelEntityListFilterInput, $limit: Int, $nextToken: String) {\n  getListByOwner(accountId: $accountId, ownerIdEntityTypeInListUpdatedAt: $ownerIdEntityTypeInListUpdatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetListByOwnerQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetListByOwner";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetListByOwner($accountId: ID, $ownerIdEntityTypeInListUpdatedAt: ModelEntityListByListOwnerCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelEntityListFilterInput, $limit: Int, $nextToken: String) {\n  getListByOwner(accountId: $accountId, ownerIdEntityTypeInListUpdatedAt: $ownerIdEntityTypeInListUpdatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private String accountId;
        private ModelEntityListFilterInput filter;
        private Integer limit;
        private String nextToken;
        private ModelEntityListByListOwnerCompositeKeyConditionInput ownerIdEntityTypeInListUpdatedAt;
        ...
        public GetListByOwnerQuery build() {
            return new GetListByOwnerQuery(this.accountId, this.ownerIdEntityTypeInListUpdatedAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }

        public Builder filter(ModelEntityListFilterInput modelEntityListFilterInput) {
            this.filter = modelEntityListFilterInput;
            return this;
        }
        ...
        public Builder ownerIdEntityTypeInListUpdatedAt(ModelEntityListByListOwnerCompositeKeyConditionInput modelEntityListByListOwnerCompositeKeyConditionInput) {
            this.ownerIdEntityTypeInListUpdatedAt = modelEntityListByListOwnerCompositeKeyConditionInput;
            return this;
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getListByOwner", "getListByOwner", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("ownerIdEntityTypeInListUpdatedAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "ownerIdEntityTypeInListUpdatedAt").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetListByOwner getListByOwner;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetListByOwner.Mapper getListByOwnerFieldMapper = new GetListByOwner.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetListByOwner) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetListByOwner>() { // from class: com.amazonaws.amplify.generated.graphql.GetListByOwnerQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetListByOwner read(ResponseReader responseReader2) {
                        return Mapper.this.getListByOwnerFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetListByOwner getListByOwner) {
            this.getListByOwner = getListByOwner;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetListByOwner getListByOwner = this.getListByOwner;
            GetListByOwner getListByOwner2 = ((Data) obj).getListByOwner;
            return getListByOwner == null ? getListByOwner2 == null : getListByOwner.equals(getListByOwner2);
        }

        public GetListByOwner getListByOwner() {
            return this.getListByOwner;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetListByOwner getListByOwner = this.getListByOwner;
                this.$hashCode = (getListByOwner == null ? 0 : getListByOwner.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetListByOwnerQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetListByOwner getListByOwner = Data.this.getListByOwner;
                    responseWriter.writeObject(responseField, getListByOwner != null ? getListByOwner.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getListByOwner=" + this.getListByOwner + "}";
            }
            return this.$toString;
        }
    }

    public static class GetListByOwner {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetListByOwner> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetListByOwner map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetListByOwner.$responseFields;
                return new GetListByOwner(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetListByOwnerQuery.GetListByOwner.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetListByOwnerQuery.GetListByOwner.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetListByOwner(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetListByOwner)) {
                return false;
            }
            GetListByOwner getListByOwner = (GetListByOwner) obj;
            if (this.__typename.equals(getListByOwner.__typename) && this.items.equals(getListByOwner.items)) {
                String str = this.nextToken;
                String str2 = getListByOwner.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetListByOwnerQuery.GetListByOwner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetListByOwner.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetListByOwner.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetListByOwner.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetListByOwnerQuery.GetListByOwner.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetListByOwner.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetListByOwner{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetListByOwnerQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[34], Item.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetListByOwnerQuery.Item.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final ModelEntityListFilterInput filter;
        private final Integer limit;
        private final String nextToken;
        private final ModelEntityListByListOwnerCompositeKeyConditionInput ownerIdEntityTypeInListUpdatedAt;
        private final ModelSortDirection sortDirection;
        private final transient Map<String, Object> valueMap;

        public Variables(String str, ModelEntityListByListOwnerCompositeKeyConditionInput modelEntityListByListOwnerCompositeKeyConditionInput, ModelSortDirection modelSortDirection, ModelEntityListFilterInput modelEntityListFilterInput, Integer num, String str2) {
            ...
            linkedHashMap.put("ownerIdEntityTypeInListUpdatedAt", modelEntityListByListOwnerCompositeKeyConditionInput);
            linkedHashMap.put("sortDirection", modelSortDirection);
            linkedHashMap.put("filter", modelEntityListFilterInput);
        ...
        public ModelEntityListFilterInput filter() {
            return this.filter;
        }
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetListByOwnerQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("accountId", Variables.this.accountId);
                    inputFieldWriter.writeObject("ownerIdEntityTypeInListUpdatedAt", Variables.this.ownerIdEntityTypeInListUpdatedAt != null ? Variables.this.ownerIdEntityTypeInListUpdatedAt.marshaller() : null);
        ...
        public ModelEntityListByListOwnerCompositeKeyConditionInput ownerIdEntityTypeInListUpdatedAt() {
            return this.ownerIdEntityTypeInListUpdatedAt;
        }
    ...
    public GetListByOwnerQuery(String str, ModelEntityListByListOwnerCompositeKeyConditionInput modelEntityListByListOwnerCompositeKeyConditionInput, ModelSortDirection modelSortDirection, ModelEntityListFilterInput modelEntityListFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelEntityListByListOwnerCompositeKeyConditionInput, modelSortDirection, modelEntityListFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "c7d5cb49e6126d2f6f7c18a7c82e79b6712aa5613db053621dca79ed346912dd";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetListByOwner($accountId: ID, $ownerIdEntityTypeInListUpdatedAt: ModelEntityListByListOwnerCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelEntityListFilterInput, $limit: Int, $nextToken: String) {\n  getListByOwner(accountId: $accountId, ownerIdEntityTypeInListUpdatedAt: $ownerIdEntityTypeInListUpdatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
