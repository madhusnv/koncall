...
public final class OnDeleteTemplateGallerySubscription implements Subscription<Data, Data, Operation.Variables> {
    public static final String OPERATION_DEFINITION = "subscription OnDeleteTemplateGallery {\n  onDeleteTemplateGallery {\n    __typename\n    id\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    categoryLevelOne\n    categoryLevelTwo\n    applicableForIndustry\n    viewedTimes\n    savedToWorkspaceTimes\n    sentToWhatsappTimes\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "OnDeleteTemplateGallery";
        }
    };
    public static final String QUERY_DOCUMENT = "subscription OnDeleteTemplateGallery {\n  onDeleteTemplateGallery {\n    __typename\n    id\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    categoryLevelOne\n    categoryLevelTwo\n    applicableForIndustry\n    viewedTimes\n    savedToWorkspaceTimes\n    sentToWhatsappTimes\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Operation.Variables variables = Operation.EMPTY_VARIABLES;

    public static final class Builder {
        public OnDeleteTemplateGallerySubscription build() {
            return new OnDeleteTemplateGallerySubscription();
        }
    }
    ...
    public static class Component {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.Component.1
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("onDeleteTemplateGallery", "onDeleteTemplateGallery", null, true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnDeleteTemplateGallery onDeleteTemplateGallery;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final OnDeleteTemplateGallery.Mapper onDeleteTemplateGalleryFieldMapper = new OnDeleteTemplateGallery.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((OnDeleteTemplateGallery) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<OnDeleteTemplateGallery>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public OnDeleteTemplateGallery read(ResponseReader responseReader2) {
                        return Mapper.this.onDeleteTemplateGalleryFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(OnDeleteTemplateGallery onDeleteTemplateGallery) {
            this.onDeleteTemplateGallery = onDeleteTemplateGallery;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnDeleteTemplateGallery onDeleteTemplateGallery = this.onDeleteTemplateGallery;
            OnDeleteTemplateGallery onDeleteTemplateGallery2 = ((Data) obj).onDeleteTemplateGallery;
            return onDeleteTemplateGallery == null ? onDeleteTemplateGallery2 == null : onDeleteTemplateGallery.equals(onDeleteTemplateGallery2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnDeleteTemplateGallery onDeleteTemplateGallery = this.onDeleteTemplateGallery;
                this.$hashCode = (onDeleteTemplateGallery == null ? 0 : onDeleteTemplateGallery.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    OnDeleteTemplateGallery onDeleteTemplateGallery = Data.this.onDeleteTemplateGallery;
                    responseWriter.writeObject(responseField, onDeleteTemplateGallery != null ? onDeleteTemplateGallery.marshaller() : null);
                }
            };
        }

        public OnDeleteTemplateGallery onDeleteTemplateGallery() {
            return this.onDeleteTemplateGallery;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onDeleteTemplateGallery=" + this.onDeleteTemplateGallery + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class DefaultMedia {
        ...
        public static final class Mapper implements ResponseFieldMapper<DefaultMedia> {
            ...
            public DefaultMedia map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[9], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.DefaultMedia.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.DefaultMedia.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultMedia.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[9], DefaultMedia.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.DefaultMedia.1.1
    ...
    public static class DefaultVariableMap {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.DefaultVariableMap.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultVariableMap.$responseFields;
    ...
    public static class OnDeleteTemplateGallery {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<OnDeleteTemplateGallery> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public OnDeleteTemplateGallery map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = OnDeleteTemplateGallery.$responseFields;
                return new OnDeleteTemplateGallery(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), responseReader.readString(responseFieldArr[2]), responseReader.readString(responseFieldArr[3]), responseReader.readList(responseFieldArr[4], new ResponseReader.ListReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.OnDeleteTemplateGallery.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Component read(ResponseReader.ListItemReader listItemReader) {
                        return (Component) listItemReader.readObject(new ResponseReader.ObjectReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.OnDeleteTemplateGallery.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    ...
                    public DefaultVariableMap read(ResponseReader.ListItemReader listItemReader) {
                        return (DefaultVariableMap) listItemReader.readObject(new ResponseReader.ObjectReader<DefaultVariableMap>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.OnDeleteTemplateGallery.Mapper.2.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), responseReader.readString(responseFieldArr[14]), responseReader.readList(responseFieldArr[15], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.OnDeleteTemplateGallery.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                }), responseReader.readString(responseFieldArr[16]), responseReader.readString(responseFieldArr[17]), responseReader.readList(responseFieldArr[18], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.OnDeleteTemplateGallery.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
        ...
        public OnDeleteTemplateGallery(String str, String str2, String str3, String str4, List<Component> list, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, List<DefaultVariableMap> list2, String str13, List<String> list3, String str14, String str15, List<String> list4, Integer num, Integer num2, Integer num3, String str16, String str17, DefaultMedia defaultMedia) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.platform = str3;
            this.name = str4;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnDeleteTemplateGallery)) {
                return false;
            }
            OnDeleteTemplateGallery onDeleteTemplateGallery = (OnDeleteTemplateGallery) obj;
            if (this.__typename.equals(onDeleteTemplateGallery.__typename) && this.id.equals(onDeleteTemplateGallery.id) && ((str = this.platform) != null ? str.equals(onDeleteTemplateGallery.platform) : onDeleteTemplateGallery.platform == null) && ((str2 = this.name) != null ? str2.equals(onDeleteTemplateGallery.name) : onDeleteTemplateGallery.name == null) && ((list = this.components) != null ? list.equals(onDeleteTemplateGallery.components) : onDeleteTemplateGallery.components == null) && ((str3 = this.language) != null ? str3.equals(onDeleteTemplateGallery.language) : onDeleteTemplateGallery.language == null) && ((str4 = this.status) != null ? str4.equals(onDeleteTemplateGallery.status) : onDeleteTemplateGallery.status == null) && ((str5 = this.category) != null ? str5.equals(onDeleteTemplateGallery.category) : onDeleteTemplateGallery.category == null) && ((str6 = this.createdBy) != null ? str6.equals(onDeleteTemplateGallery.createdBy) : onDeleteTemplateGallery.createdBy == null) && ((str7 = this.updatedBy) != null ? str7.equals(onDeleteTemplateGallery.updatedBy) : onDeleteTemplateGallery.updatedBy == null) && ((str8 = this.archivedStatus) != null ? str8.equals(onDeleteTemplateGallery.archivedStatus) : onDeleteTemplateGallery.archivedStatus == null) && ((str9 = this.archivedAt) != null ? str9.equals(onDeleteTemplateGallery.archivedAt) : onDeleteTemplateGallery.archivedAt == null) && ((str10 = this.defaultMediaId) != null ? str10.equals(onDeleteTemplateGallery.defaultMediaId) : onDeleteTemplateGallery.defaultMediaId == null) && ((list2 = this.defaultVariableMap) != null ? list2.equals(onDeleteTemplateGallery.defaultVariableMap) : onDeleteTemplateGallery.defaultVariableMap == null) && ((str11 = this.templateId) != null ? str11.equals(onDeleteTemplateGallery.templateId) : onDeleteTemplateGallery.templateId == null) && ((list3 = this.tags) != null ? list3.equals(onDeleteTemplateGallery.tags) : onDeleteTemplateGallery.tags == null) && ((str12 = this.categoryLevelOne) != null ? str12.equals(onDeleteTemplateGallery.categoryLevelOne) : onDeleteTemplateGallery.categoryLevelOne == null) && ((str13 = this.categoryLevelTwo) != null ? str13.equals(onDeleteTemplateGallery.categoryLevelTwo) : onDeleteTemplateGallery.categoryLevelTwo == null) && ((list4 = this.applicableForIndustry) != null ? list4.equals(onDeleteTemplateGallery.applicableForIndustry) : onDeleteTemplateGallery.applicableForIndustry == null) && ((num = this.viewedTimes) != null ? num.equals(onDeleteTemplateGallery.viewedTimes) : onDeleteTemplateGallery.viewedTimes == null) && ((num2 = this.savedToWorkspaceTimes) != null ? num2.equals(onDeleteTemplateGallery.savedToWorkspaceTimes) : onDeleteTemplateGallery.savedToWorkspaceTimes == null) && ((num3 = this.sentToWhatsappTimes) != null ? num3.equals(onDeleteTemplateGallery.sentToWhatsappTimes) : onDeleteTemplateGallery.sentToWhatsappTimes == null) && ((str14 = this.createdAt) != null ? str14.equals(onDeleteTemplateGallery.createdAt) : onDeleteTemplateGallery.createdAt == null) && ((str15 = this.updatedAt) != null ? str15.equals(onDeleteTemplateGallery.updatedAt) : onDeleteTemplateGallery.updatedAt == null)) {
                DefaultMedia defaultMedia = this.defaultMedia;
                DefaultMedia defaultMedia2 = onDeleteTemplateGallery.defaultMedia;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.OnDeleteTemplateGallery.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = OnDeleteTemplateGallery.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], OnDeleteTemplateGallery.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], OnDeleteTemplateGallery.this.id);
                    responseWriter.writeString(responseFieldArr[2], OnDeleteTemplateGallery.this.platform);
                    responseWriter.writeString(responseFieldArr[3], OnDeleteTemplateGallery.this.name);
                    responseWriter.writeList(responseFieldArr[4], OnDeleteTemplateGallery.this.components, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.OnDeleteTemplateGallery.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Component) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[5], OnDeleteTemplateGallery.this.language);
                    responseWriter.writeString(responseFieldArr[6], OnDeleteTemplateGallery.this.status);
                    responseWriter.writeString(responseFieldArr[7], OnDeleteTemplateGallery.this.category);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], OnDeleteTemplateGallery.this.createdBy);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], OnDeleteTemplateGallery.this.updatedBy);
                    responseWriter.writeString(responseFieldArr[10], OnDeleteTemplateGallery.this.archivedStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], OnDeleteTemplateGallery.this.archivedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], OnDeleteTemplateGallery.this.defaultMediaId);
                    responseWriter.writeList(responseFieldArr[13], OnDeleteTemplateGallery.this.defaultVariableMap, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.OnDeleteTemplateGallery.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((DefaultVariableMap) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[14], OnDeleteTemplateGallery.this.templateId);
                    responseWriter.writeList(responseFieldArr[15], OnDeleteTemplateGallery.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.OnDeleteTemplateGallery.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[16], OnDeleteTemplateGallery.this.categoryLevelOne);
                    responseWriter.writeString(responseFieldArr[17], OnDeleteTemplateGallery.this.categoryLevelTwo);
                    responseWriter.writeList(responseFieldArr[18], OnDeleteTemplateGallery.this.applicableForIndustry, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteTemplateGallerySubscription.OnDeleteTemplateGallery.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeInt(responseFieldArr[19], OnDeleteTemplateGallery.this.viewedTimes);
                    responseWriter.writeInt(responseFieldArr[20], OnDeleteTemplateGallery.this.savedToWorkspaceTimes);
                    responseWriter.writeInt(responseFieldArr[21], OnDeleteTemplateGallery.this.sentToWhatsappTimes);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], OnDeleteTemplateGallery.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], OnDeleteTemplateGallery.this.updatedAt);
                    ResponseField responseField = responseFieldArr[24];
                    DefaultMedia defaultMedia = OnDeleteTemplateGallery.this.defaultMedia;
    ...
    public String operationId() {
        return "4f19c7d0e39a902be993e837826d3963c551826b0a803259a1d464fdab186e07";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "subscription OnDeleteTemplateGallery {\n  onDeleteTemplateGallery {\n    __typename\n    id\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    categoryLevelOne\n    categoryLevelTwo\n    applicableForIndustry\n    viewedTimes\n    savedToWorkspaceTimes\n    sentToWhatsappTimes\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
