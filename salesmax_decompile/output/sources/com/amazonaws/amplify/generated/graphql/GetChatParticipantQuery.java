...
public final class GetChatParticipantQuery implements Query<Data, Data, Variables> {
    ...
    public static class Channel {
        ...
        public static final class Mapper implements ResponseFieldMapper<Channel> {
            ...
            public Channel map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[6], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetChatParticipantQuery.Channel.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChatParticipantQuery.Channel.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[6], Channel.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetChatParticipantQuery.Channel.1.1
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getChatParticipant", "getChatParticipant", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetChatParticipant getChatParticipant;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetChatParticipant.Mapper getChatParticipantFieldMapper = new GetChatParticipant.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetChatParticipant) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetChatParticipant>() { // from class: com.amazonaws.amplify.generated.graphql.GetChatParticipantQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetChatParticipant read(ResponseReader responseReader2) {
                        return Mapper.this.getChatParticipantFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetChatParticipant getChatParticipant) {
            this.getChatParticipant = getChatParticipant;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetChatParticipant getChatParticipant = this.getChatParticipant;
            GetChatParticipant getChatParticipant2 = ((Data) obj).getChatParticipant;
            return getChatParticipant == null ? getChatParticipant2 == null : getChatParticipant.equals(getChatParticipant2);
        }

        public GetChatParticipant getChatParticipant() {
            return this.getChatParticipant;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetChatParticipant getChatParticipant = this.getChatParticipant;
                this.$hashCode = (getChatParticipant == null ? 0 : getChatParticipant.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChatParticipantQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetChatParticipant getChatParticipant = Data.this.getChatParticipant;
                    responseWriter.writeObject(responseField, getChatParticipant != null ? getChatParticipant.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getChatParticipant=" + this.getChatParticipant + "}";
            }
            return this.$toString;
        }
    }

    public static class GetChatParticipant {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public GetChatParticipant(String str, String str2, String str3, String str4, String str5, String str6, String str7, Integer num, String str8, Boolean bool, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, Boolean bool2, String str19, String str20, Boolean bool3, List<String> list, String str21, String str22, String str23, String str24, Channel channel, Participant participant) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetChatParticipant)) {
                return false;
            }
            GetChatParticipant getChatParticipant = (GetChatParticipant) obj;
            if (this.__typename.equals(getChatParticipant.__typename) && this.id.equals(getChatParticipant.id) && this.accountId.equals(getChatParticipant.accountId) && this.channelId.equals(getChatParticipant.channelId) && ((str = this.phoneNumberIdExternal) != null ? str.equals(getChatParticipant.phoneNumberIdExternal) : getChatParticipant.phoneNumberIdExternal == null) && this.participantId.equals(getChatParticipant.participantId) && this.participationStatus.equals(getChatParticipant.participationStatus) && ((num = this.unreadMessageCount) != null ? num.equals(getChatParticipant.unreadMessageCount) : getChatParticipant.unreadMessageCount == null) && ((str2 = this.lastViewed) != null ? str2.equals(getChatParticipant.lastViewed) : getChatParticipant.lastViewed == null) && ((bool = this.isStarred) != null ? bool.equals(getChatParticipant.isStarred) : getChatParticipant.isStarred == null) && ((str3 = this.joinedAt) != null ? str3.equals(getChatParticipant.joinedAt) : getChatParticipant.joinedAt == null) && ((str4 = this.leftAt) != null ? str4.equals(getChatParticipant.leftAt) : getChatParticipant.leftAt == null) && ((str5 = this.channelName) != null ? str5.equals(getChatParticipant.channelName) : getChatParticipant.channelName == null) && ((str6 = this.channelType) != null ? str6.equals(getChatParticipant.channelType) : getChatParticipant.channelType == null) && ((str7 = this.channelSubType) != null ? str7.equals(getChatParticipant.channelSubType) : getChatParticipant.channelSubType == null) && ((str8 = this.channelStatus) != null ? str8.equals(getChatParticipant.channelStatus) : getChatParticipant.channelStatus == null) && ((str9 = this.channelWillBeChargedNext) != null ? str9.equals(getChatParticipant.channelWillBeChargedNext) : getChatParticipant.channelWillBeChargedNext == null) && ((str10 = this.channelOpenUntil) != null ? str10.equals(getChatParticipant.channelOpenUntil) : getChatParticipant.channelOpenUntil == null) && ((str11 = this.lastMessageByLeadTime) != null ? str11.equals(getChatParticipant.lastMessageByLeadTime) : getChatParticipant.lastMessageByLeadTime == null) && ((str12 = this.lastMessageByUserTime) != null ? str12.equals(getChatParticipant.lastMessageByUserTime) : getChatParticipant.lastMessageByUserTime == null) && ((bool2 = this.isLastMessageByLead) != null ? bool2.equals(getChatParticipant.isLastMessageByLead) : getChatParticipant.isLastMessageByLead == null) && ((str13 = this.lastOutboundMessageId) != null ? str13.equals(getChatParticipant.lastOutboundMessageId) : getChatParticipant.lastOutboundMessageId == null) && ((str14 = this.lastOutboundMessageStatus) != null ? str14.equals(getChatParticipant.lastOutboundMessageStatus) : getChatParticipant.lastOutboundMessageStatus == null) && ((bool3 = this.isNewMessageUpdate) != null ? bool3.equals(getChatParticipant.isNewMessageUpdate) : getChatParticipant.isNewMessageUpdate == null) && ((list = this.tags) != null ? list.equals(getChatParticipant.tags) : getChatParticipant.tags == null) && ((str15 = this.participantScopeIfInternal) != null ? str15.equals(getChatParticipant.participantScopeIfInternal) : getChatParticipant.participantScopeIfInternal == null) && ((str16 = this.userIdsForDirectChannel) != null ? str16.equals(getChatParticipant.userIdsForDirectChannel) : getChatParticipant.userIdsForDirectChannel == null) && ((str17 = this.createdAt) != null ? str17.equals(getChatParticipant.createdAt) : getChatParticipant.createdAt == null) && ((str18 = this.updatedAt) != null ? str18.equals(getChatParticipant.updatedAt) : getChatParticipant.updatedAt == null) && ((channel = this.channel) != null ? channel.equals(getChatParticipant.channel) : getChatParticipant.channel == null)) {
                Participant participant = this.participant;
                Participant participant2 = getChatParticipant.participant;
                if (participant == null) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChatParticipantQuery.GetChatParticipant.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetChatParticipant.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetChatParticipant.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetChatParticipant.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetChatParticipant.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], GetChatParticipant.this.channelId);
                    responseWriter.writeString(responseFieldArr[4], GetChatParticipant.this.phoneNumberIdExternal);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], GetChatParticipant.this.participantId);
                    responseWriter.writeString(responseFieldArr[6], GetChatParticipant.this.participationStatus);
                    responseWriter.writeInt(responseFieldArr[7], GetChatParticipant.this.unreadMessageCount);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], GetChatParticipant.this.lastViewed);
                    responseWriter.writeBoolean(responseFieldArr[9], GetChatParticipant.this.isStarred);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[10], GetChatParticipant.this.joinedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], GetChatParticipant.this.leftAt);
                    responseWriter.writeString(responseFieldArr[12], GetChatParticipant.this.channelName);
                    responseWriter.writeString(responseFieldArr[13], GetChatParticipant.this.channelType);
                    responseWriter.writeString(responseFieldArr[14], GetChatParticipant.this.channelSubType);
                    responseWriter.writeString(responseFieldArr[15], GetChatParticipant.this.channelStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], GetChatParticipant.this.channelWillBeChargedNext);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], GetChatParticipant.this.channelOpenUntil);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], GetChatParticipant.this.lastMessageByLeadTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], GetChatParticipant.this.lastMessageByUserTime);
                    responseWriter.writeBoolean(responseFieldArr[20], GetChatParticipant.this.isLastMessageByLead);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], GetChatParticipant.this.lastOutboundMessageId);
                    responseWriter.writeString(responseFieldArr[22], GetChatParticipant.this.lastOutboundMessageStatus);
                    responseWriter.writeBoolean(responseFieldArr[23], GetChatParticipant.this.isNewMessageUpdate);
                    responseWriter.writeList(responseFieldArr[24], GetChatParticipant.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetChatParticipantQuery.GetChatParticipant.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[25], GetChatParticipant.this.participantScopeIfInternal);
                    responseWriter.writeString(responseFieldArr[26], GetChatParticipant.this.userIdsForDirectChannel);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], GetChatParticipant.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[28], GetChatParticipant.this.updatedAt);
                    ResponseField responseField = responseFieldArr[29];
                    Channel channel = GetChatParticipant.this.channel;
                    ...
                    Participant participant = GetChatParticipant.this.participant;
    ...
    public static class Participant {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChatParticipantQuery.Participant.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Participant.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChatParticipantQuery.Variables.1
    ...
    public GetChatParticipantQuery(String str) {
    ...
    public String operationId() {
        return "90f2d30f245f897638635bd427bc1487c345cc33d5bbbdb39c0a8cffa6f2220f";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetChatParticipant($id: ID!) {\n  getChatParticipant(id: $id) {\n    __typename\n    id\n    accountId\n    channelId\n    phoneNumberIdExternal\n    participantId\n    participationStatus\n    unreadMessageCount\n    lastViewed\n    isStarred\n    joinedAt\n    leftAt\n    channelName\n    channelType\n    channelSubType\n    channelStatus\n    channelWillBeChargedNext\n    channelOpenUntil\n    lastMessageByLeadTime\n    lastMessageByUserTime\n    isLastMessageByLead\n    lastOutboundMessageId\n    lastOutboundMessageStatus\n    isNewMessageUpdate\n    tags\n    participantScopeIfInternal\n    userIdsForDirectChannel\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    participant {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
