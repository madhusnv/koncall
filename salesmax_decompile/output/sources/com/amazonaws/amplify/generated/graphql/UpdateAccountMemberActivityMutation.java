...
import type.UpdateAccountMemberActivityInput;

/* loaded from: classes4.dex */
public final class UpdateAccountMemberActivityMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation UpdateAccountMemberActivity($input: UpdateAccountMemberActivityInput!, $condition: ModelAccountMemberActivityConditionInput) {\n  updateAccountMemberActivity(input: $input, condition: $condition) {\n    __typename\n    accountId\n    userId\n    lastActivityId\n    lastViewedNotifications\n    lastViewedCommentMentions\n    lastViewedRecentTasks\n    lastViewedRecentActivities\n    lastViewedMissedActions\n    lastViewedPendingAssignments\n    lastViewedCommentAndMentions\n    lastActivityTime\n    lastActivityType\n    lastActivityBody\n    lastCallLogged\n    lastNoteAdded\n    lastCommentAdded\n    lastTaskCompleted\n    lastTaskCreated\n    lastVisitLogged\n    lastContactAdded\n    lastEmailSent\n    lastWhatsappSent\n    lastSmsSent\n    lastKnownLocation\n    lastKnownLocationTime\n    inCall\n    inCallWithContactId\n    inCallWithContactName\n    inCallWithContactNumber\n    inCallRequestedAt\n    lastInCallUpdatedAt\n    callPlacementId\n    createdAt\n    updatedAt\n    lastActivity {\n      __typename\n      id\n      threadId\n      accountId\n      activityRelatedObjectType\n      activityRelatedObjectId\n      activityCategory\n      activityType\n      body\n      note\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMemberActivityMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "UpdateAccountMemberActivity";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation UpdateAccountMemberActivity($input: UpdateAccountMemberActivityInput!, $condition: ModelAccountMemberActivityConditionInput) {\n  updateAccountMemberActivity(input: $input, condition: $condition) {\n    __typename\n    accountId\n    userId\n    lastActivityId\n    lastViewedNotifications\n    lastViewedCommentMentions\n    lastViewedRecentTasks\n    lastViewedRecentActivities\n    lastViewedMissedActions\n    lastViewedPendingAssignments\n    lastViewedCommentAndMentions\n    lastActivityTime\n    lastActivityType\n    lastActivityBody\n    lastCallLogged\n    lastNoteAdded\n    lastCommentAdded\n    lastTaskCompleted\n    lastTaskCreated\n    lastVisitLogged\n    lastContactAdded\n    lastEmailSent\n    lastWhatsappSent\n    lastSmsSent\n    lastKnownLocation\n    lastKnownLocationTime\n    inCall\n    inCallWithContactId\n    inCallWithContactName\n    inCallWithContactNumber\n    inCallRequestedAt\n    lastInCallUpdatedAt\n    callPlacementId\n    createdAt\n    updatedAt\n    lastActivity {\n      __typename\n      id\n      threadId\n      accountId\n      activityRelatedObjectType\n      activityRelatedObjectId\n      activityCategory\n      activityType\n      body\n      note\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelAccountMemberActivityConditionInput condition;
        private UpdateAccountMemberActivityInput input;

        public UpdateAccountMemberActivityMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new UpdateAccountMemberActivityMutation(this.input, this.condition);
        }
        ...
        public Builder input(UpdateAccountMemberActivityInput updateAccountMemberActivityInput) {
            this.input = updateAccountMemberActivityInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("updateAccountMemberActivity", "updateAccountMemberActivity", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final UpdateAccountMemberActivity updateAccountMemberActivity;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final UpdateAccountMemberActivity.Mapper updateAccountMemberActivityFieldMapper = new UpdateAccountMemberActivity.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((UpdateAccountMemberActivity) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<UpdateAccountMemberActivity>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMemberActivityMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdateAccountMemberActivity read(ResponseReader responseReader2) {
                        return Mapper.this.updateAccountMemberActivityFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(UpdateAccountMemberActivity updateAccountMemberActivity) {
            this.updateAccountMemberActivity = updateAccountMemberActivity;
        }
        ...
        public boolean equals(Object obj) {
            ...
            UpdateAccountMemberActivity updateAccountMemberActivity = this.updateAccountMemberActivity;
            UpdateAccountMemberActivity updateAccountMemberActivity2 = ((Data) obj).updateAccountMemberActivity;
            return updateAccountMemberActivity == null ? updateAccountMemberActivity2 == null : updateAccountMemberActivity.equals(updateAccountMemberActivity2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                UpdateAccountMemberActivity updateAccountMemberActivity = this.updateAccountMemberActivity;
                this.$hashCode = (updateAccountMemberActivity == null ? 0 : updateAccountMemberActivity.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMemberActivityMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    UpdateAccountMemberActivity updateAccountMemberActivity = Data.this.updateAccountMemberActivity;
                    responseWriter.writeObject(responseField, updateAccountMemberActivity != null ? updateAccountMemberActivity.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{updateAccountMemberActivity=" + this.updateAccountMemberActivity + "}";
            }
            return this.$toString;
        }

        public UpdateAccountMemberActivity updateAccountMemberActivity() {
            return this.updateAccountMemberActivity;
        }
    }
    ...
    public static class LastActivity {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMemberActivityMutation.LastActivity.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = LastActivity.$responseFields;
    ...
    public static class UpdateAccountMemberActivity {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<UpdateAccountMemberActivity> {
            final LastActivity.Mapper lastActivityFieldMapper = new LastActivity.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public UpdateAccountMemberActivity map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = UpdateAccountMemberActivity.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
                String str3 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]);
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateAccountMemberActivity)) {
                return false;
            }
            UpdateAccountMemberActivity updateAccountMemberActivity = (UpdateAccountMemberActivity) obj;
            if (this.__typename.equals(updateAccountMemberActivity.__typename) && this.accountId.equals(updateAccountMemberActivity.accountId) && this.userId.equals(updateAccountMemberActivity.userId) && ((str = this.lastActivityId) != null ? str.equals(updateAccountMemberActivity.lastActivityId) : updateAccountMemberActivity.lastActivityId == null) && ((str2 = this.lastViewedNotifications) != null ? str2.equals(updateAccountMemberActivity.lastViewedNotifications) : updateAccountMemberActivity.lastViewedNotifications == null) && ((str3 = this.lastViewedCommentMentions) != null ? str3.equals(updateAccountMemberActivity.lastViewedCommentMentions) : updateAccountMemberActivity.lastViewedCommentMentions == null) && ((str4 = this.lastViewedRecentTasks) != null ? str4.equals(updateAccountMemberActivity.lastViewedRecentTasks) : updateAccountMemberActivity.lastViewedRecentTasks == null) && ((str5 = this.lastViewedRecentActivities) != null ? str5.equals(updateAccountMemberActivity.lastViewedRecentActivities) : updateAccountMemberActivity.lastViewedRecentActivities == null) && ((str6 = this.lastViewedMissedActions) != null ? str6.equals(updateAccountMemberActivity.lastViewedMissedActions) : updateAccountMemberActivity.lastViewedMissedActions == null) && ((str7 = this.lastViewedPendingAssignments) != null ? str7.equals(updateAccountMemberActivity.lastViewedPendingAssignments) : updateAccountMemberActivity.lastViewedPendingAssignments == null) && ((str8 = this.lastViewedCommentAndMentions) != null ? str8.equals(updateAccountMemberActivity.lastViewedCommentAndMentions) : updateAccountMemberActivity.lastViewedCommentAndMentions == null) && ((str9 = this.lastActivityTime) != null ? str9.equals(updateAccountMemberActivity.lastActivityTime) : updateAccountMemberActivity.lastActivityTime == null) && ((activityType = this.lastActivityType) != null ? activityType.equals(updateAccountMemberActivity.lastActivityType) : updateAccountMemberActivity.lastActivityType == null) && ((str10 = this.lastActivityBody) != null ? str10.equals(updateAccountMemberActivity.lastActivityBody) : updateAccountMemberActivity.lastActivityBody == null) && ((str11 = this.lastCallLogged) != null ? str11.equals(updateAccountMemberActivity.lastCallLogged) : updateAccountMemberActivity.lastCallLogged == null) && ((str12 = this.lastNoteAdded) != null ? str12.equals(updateAccountMemberActivity.lastNoteAdded) : updateAccountMemberActivity.lastNoteAdded == null) && ((str13 = this.lastCommentAdded) != null ? str13.equals(updateAccountMemberActivity.lastCommentAdded) : updateAccountMemberActivity.lastCommentAdded == null) && ((str14 = this.lastTaskCompleted) != null ? str14.equals(updateAccountMemberActivity.lastTaskCompleted) : updateAccountMemberActivity.lastTaskCompleted == null) && ((str15 = this.lastTaskCreated) != null ? str15.equals(updateAccountMemberActivity.lastTaskCreated) : updateAccountMemberActivity.lastTaskCreated == null) && ((str16 = this.lastVisitLogged) != null ? str16.equals(updateAccountMemberActivity.lastVisitLogged) : updateAccountMemberActivity.lastVisitLogged == null) && ((str17 = this.lastContactAdded) != null ? str17.equals(updateAccountMemberActivity.lastContactAdded) : updateAccountMemberActivity.lastContactAdded == null) && ((str18 = this.lastEmailSent) != null ? str18.equals(updateAccountMemberActivity.lastEmailSent) : updateAccountMemberActivity.lastEmailSent == null) && ((str19 = this.lastWhatsappSent) != null ? str19.equals(updateAccountMemberActivity.lastWhatsappSent) : updateAccountMemberActivity.lastWhatsappSent == null) && ((str20 = this.lastSmsSent) != null ? str20.equals(updateAccountMemberActivity.lastSmsSent) : updateAccountMemberActivity.lastSmsSent == null) && ((str21 = this.lastKnownLocation) != null ? str21.equals(updateAccountMemberActivity.lastKnownLocation) : updateAccountMemberActivity.lastKnownLocation == null) && ((str22 = this.lastKnownLocationTime) != null ? str22.equals(updateAccountMemberActivity.lastKnownLocationTime) : updateAccountMemberActivity.lastKnownLocationTime == null) && ((str23 = this.inCall) != null ? str23.equals(updateAccountMemberActivity.inCall) : updateAccountMemberActivity.inCall == null) && ((str24 = this.inCallWithContactId) != null ? str24.equals(updateAccountMemberActivity.inCallWithContactId) : updateAccountMemberActivity.inCallWithContactId == null) && ((str25 = this.inCallWithContactName) != null ? str25.equals(updateAccountMemberActivity.inCallWithContactName) : updateAccountMemberActivity.inCallWithContactName == null) && ((str26 = this.inCallWithContactNumber) != null ? str26.equals(updateAccountMemberActivity.inCallWithContactNumber) : updateAccountMemberActivity.inCallWithContactNumber == null) && ((str27 = this.inCallRequestedAt) != null ? str27.equals(updateAccountMemberActivity.inCallRequestedAt) : updateAccountMemberActivity.inCallRequestedAt == null) && ((str28 = this.lastInCallUpdatedAt) != null ? str28.equals(updateAccountMemberActivity.lastInCallUpdatedAt) : updateAccountMemberActivity.lastInCallUpdatedAt == null) && ((str29 = this.callPlacementId) != null ? str29.equals(updateAccountMemberActivity.callPlacementId) : updateAccountMemberActivity.callPlacementId == null) && ((str30 = this.createdAt) != null ? str30.equals(updateAccountMemberActivity.createdAt) : updateAccountMemberActivity.createdAt == null) && ((str31 = this.updatedAt) != null ? str31.equals(updateAccountMemberActivity.updatedAt) : updateAccountMemberActivity.updatedAt == null)) {
                LastActivity lastActivity = this.lastActivity;
                LastActivity lastActivity2 = updateAccountMemberActivity.lastActivity;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMemberActivityMutation.UpdateAccountMemberActivity.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdateAccountMemberActivity.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UpdateAccountMemberActivity.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], UpdateAccountMemberActivity.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], UpdateAccountMemberActivity.this.userId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], UpdateAccountMemberActivity.this.lastActivityId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], UpdateAccountMemberActivity.this.lastViewedNotifications);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], UpdateAccountMemberActivity.this.lastViewedCommentMentions);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], UpdateAccountMemberActivity.this.lastViewedRecentTasks);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], UpdateAccountMemberActivity.this.lastViewedRecentActivities);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], UpdateAccountMemberActivity.this.lastViewedMissedActions);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], UpdateAccountMemberActivity.this.lastViewedPendingAssignments);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[10], UpdateAccountMemberActivity.this.lastViewedCommentAndMentions);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], UpdateAccountMemberActivity.this.lastActivityTime);
                    ResponseField responseField = responseFieldArr[12];
                    ActivityType activityType = UpdateAccountMemberActivity.this.lastActivityType;
                    responseWriter.writeString(responseField, activityType != null ? activityType.name() : null);
                    responseWriter.writeString(responseFieldArr[13], UpdateAccountMemberActivity.this.lastActivityBody);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], UpdateAccountMemberActivity.this.lastCallLogged);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], UpdateAccountMemberActivity.this.lastNoteAdded);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], UpdateAccountMemberActivity.this.lastCommentAdded);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], UpdateAccountMemberActivity.this.lastTaskCompleted);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], UpdateAccountMemberActivity.this.lastTaskCreated);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], UpdateAccountMemberActivity.this.lastVisitLogged);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], UpdateAccountMemberActivity.this.lastContactAdded);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], UpdateAccountMemberActivity.this.lastEmailSent);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], UpdateAccountMemberActivity.this.lastWhatsappSent);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], UpdateAccountMemberActivity.this.lastSmsSent);
                    responseWriter.writeString(responseFieldArr[24], UpdateAccountMemberActivity.this.lastKnownLocation);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], UpdateAccountMemberActivity.this.lastKnownLocationTime);
                    responseWriter.writeString(responseFieldArr[26], UpdateAccountMemberActivity.this.inCall);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], UpdateAccountMemberActivity.this.inCallWithContactId);
                    responseWriter.writeString(responseFieldArr[28], UpdateAccountMemberActivity.this.inCallWithContactName);
                    responseWriter.writeString(responseFieldArr[29], UpdateAccountMemberActivity.this.inCallWithContactNumber);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[30], UpdateAccountMemberActivity.this.inCallRequestedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[31], UpdateAccountMemberActivity.this.lastInCallUpdatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[32], UpdateAccountMemberActivity.this.callPlacementId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[33], UpdateAccountMemberActivity.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[34], UpdateAccountMemberActivity.this.updatedAt);
                    ResponseField responseField2 = responseFieldArr[35];
                    LastActivity lastActivity = UpdateAccountMemberActivity.this.lastActivity;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final UpdateAccountMemberActivityInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(UpdateAccountMemberActivityInput updateAccountMemberActivityInput, ModelAccountMemberActivityConditionInput modelAccountMemberActivityConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = updateAccountMemberActivityInput;
            this.condition = modelAccountMemberActivityConditionInput;
            linkedHashMap.put("input", updateAccountMemberActivityInput);
        ...
        public UpdateAccountMemberActivityInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateAccountMemberActivityMutation.Variables.1
    ...
    public UpdateAccountMemberActivityMutation(UpdateAccountMemberActivityInput updateAccountMemberActivityInput, ModelAccountMemberActivityConditionInput modelAccountMemberActivityConditionInput) {
        Utils.checkNotNull(updateAccountMemberActivityInput, "input == null");
        this.variables = new Variables(updateAccountMemberActivityInput, modelAccountMemberActivityConditionInput);
    }
    ...
    public String operationId() {
        return "19e955423c5e21f22cc0d5d5e7f7c58c0b2e9439a5a77335f9ca6f59a808209c";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation UpdateAccountMemberActivity($input: UpdateAccountMemberActivityInput!, $condition: ModelAccountMemberActivityConditionInput) {\n  updateAccountMemberActivity(input: $input, condition: $condition) {\n    __typename\n    accountId\n    userId\n    lastActivityId\n    lastViewedNotifications\n    lastViewedCommentMentions\n    lastViewedRecentTasks\n    lastViewedRecentActivities\n    lastViewedMissedActions\n    lastViewedPendingAssignments\n    lastViewedCommentAndMentions\n    lastActivityTime\n    lastActivityType\n    lastActivityBody\n    lastCallLogged\n    lastNoteAdded\n    lastCommentAdded\n    lastTaskCompleted\n    lastTaskCreated\n    lastVisitLogged\n    lastContactAdded\n    lastEmailSent\n    lastWhatsappSent\n    lastSmsSent\n    lastKnownLocation\n    lastKnownLocationTime\n    inCall\n    inCallWithContactId\n    inCallWithContactName\n    inCallWithContactNumber\n    inCallRequestedAt\n    lastInCallUpdatedAt\n    callPlacementId\n    createdAt\n    updatedAt\n    lastActivity {\n      __typename\n      id\n      threadId\n      accountId\n      activityRelatedObjectType\n      activityRelatedObjectId\n      activityCategory\n      activityType\n      body\n      note\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
