...
public final class GetAccountMembershipQuery implements Query<Data, Data, Variables> {
    ...
    public static class Account {
        ...
        public static final class Mapper implements ResponseFieldMapper<Account> {
            ...
            public Account map(ResponseReader responseReader) {
                ...
                }), responseReader.readList(responseFieldArr[46], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.Account.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.Account.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[15], Account.this.productOrService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.Account.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[39], Account.this.permissions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.Account.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[45], Account.this.salesmaxSalesContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.Account.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[46], Account.this.salesmaxSupportContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.Account.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[51], Account.this.relatedAccountIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.Account.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class AddedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.AddedBy.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = AddedBy.$responseFields;
    ...
    public static class ApprovedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.ApprovedBy.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ApprovedBy.$responseFields;
    ...
    public static final class Builder {
        ...
        public GetAccountMembershipQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetAccountMembershipQuery(this.id);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getAccountMembership", "getAccountMembership", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetAccountMembership getAccountMembership;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetAccountMembership.Mapper getAccountMembershipFieldMapper = new GetAccountMembership.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetAccountMembership) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetAccountMembership>() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetAccountMembership read(ResponseReader responseReader2) {
                        return Mapper.this.getAccountMembershipFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetAccountMembership getAccountMembership) {
            this.getAccountMembership = getAccountMembership;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetAccountMembership getAccountMembership = this.getAccountMembership;
            GetAccountMembership getAccountMembership2 = ((Data) obj).getAccountMembership;
            return getAccountMembership == null ? getAccountMembership2 == null : getAccountMembership.equals(getAccountMembership2);
        }

        public GetAccountMembership getAccountMembership() {
            return this.getAccountMembership;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetAccountMembership getAccountMembership = this.getAccountMembership;
                this.$hashCode = (getAccountMembership == null ? 0 : getAccountMembership.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetAccountMembership getAccountMembership = Data.this.getAccountMembership;
                    responseWriter.writeObject(responseField, getAccountMembership != null ? getAccountMembership.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getAccountMembership=" + this.getAccountMembership + "}";
            }
            return this.$toString;
        }
    }

    public static class GetAccountMembership {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<GetAccountMembership> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetAccountMembership map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetAccountMembership.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
                String str3 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]);
                List list = responseReader.readList(responseFieldArr[4], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.GetAccountMembership.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetAccountMembership)) {
                return false;
            }
            GetAccountMembership getAccountMembership = (GetAccountMembership) obj;
            if (this.__typename.equals(getAccountMembership.__typename) && this.id.equals(getAccountMembership.id) && this.accountId.equals(getAccountMembership.accountId) && this.userId.equals(getAccountMembership.userId) && ((list = this.allowedDeviceId) != null ? list.equals(getAccountMembership.allowedDeviceId) : getAccountMembership.allowedDeviceId == null) && ((str = this.designation) != null ? str.equals(getAccountMembership.designation) : getAccountMembership.designation == null) && this.authorizationLevel.equals(getAccountMembership.authorizationLevel) && ((str2 = this.signature) != null ? str2.equals(getAccountMembership.signature) : getAccountMembership.signature == null) && ((bool = this.isBillingMember) != null ? bool.equals(getAccountMembership.isBillingMember) : getAccountMembership.isBillingMember == null) && ((str3 = this.addedById) != null ? str3.equals(getAccountMembership.addedById) : getAccountMembership.addedById == null) && ((str4 = this.updatedById) != null ? str4.equals(getAccountMembership.updatedById) : getAccountMembership.updatedById == null) && ((str5 = this.addedOn) != null ? str5.equals(getAccountMembership.addedOn) : getAccountMembership.addedOn == null) && ((str6 = this.approvedById) != null ? str6.equals(getAccountMembership.approvedById) : getAccountMembership.approvedById == null) && ((str7 = this.approvedOn) != null ? str7.equals(getAccountMembership.approvedOn) : getAccountMembership.approvedOn == null) && ((str8 = this.acceptedOn) != null ? str8.equals(getAccountMembership.acceptedOn) : getAccountMembership.acceptedOn == null) && this.userAccountStatus.equals(getAccountMembership.userAccountStatus) && ((str9 = this.whatsappApiAccess) != null ? str9.equals(getAccountMembership.whatsappApiAccess) : getAccountMembership.whatsappApiAccess == null) && ((str10 = this.sharedInboxPermission) != null ? str10.equals(getAccountMembership.sharedInboxPermission) : getAccountMembership.sharedInboxPermission == null) && ((str11 = this.canInitiateNewConversation) != null ? str11.equals(getAccountMembership.canInitiateNewConversation) : getAccountMembership.canInitiateNewConversation == null) && ((str12 = this.canCreateWaCampaigns) != null ? str12.equals(getAccountMembership.canCreateWaCampaigns) : getAccountMembership.canCreateWaCampaigns == null) && this.mapRegisteredMobileNumberToAccount == getAccountMembership.mapRegisteredMobileNumberToAccount && this.mapSecondaryMobileNumberToAccount == getAccountMembership.mapSecondaryMobileNumberToAccount && ((str13 = this.accountEmail) != null ? str13.equals(getAccountMembership.accountEmail) : getAccountMembership.accountEmail == null) && ((bool2 = this.accountEmailVerified) != null ? bool2.equals(getAccountMembership.accountEmailVerified) : getAccountMembership.accountEmailVerified == null) && ((list2 = this.notificationPreferences) != null ? list2.equals(getAccountMembership.notificationPreferences) : getAccountMembership.notificationPreferences == null) && ((str14 = this.migrateToUserIdOnRemoval) != null ? str14.equals(getAccountMembership.migrateToUserIdOnRemoval) : getAccountMembership.migrateToUserIdOnRemoval == null) && ((bool3 = this.prefScreenPop) != null ? bool3.equals(getAccountMembership.prefScreenPop) : getAccountMembership.prefScreenPop == null) && ((bool4 = this.prefSaveBusinessCall) != null ? bool4.equals(getAccountMembership.prefSaveBusinessCall) : getAccountMembership.prefSaveBusinessCall == null) && ((bool5 = this.prefPostCallDisposition) != null ? bool5.equals(getAccountMembership.prefPostCallDisposition) : getAccountMembership.prefPostCallDisposition == null) && ((num = this.prefDefaultSimToCall) != null ? num.equals(getAccountMembership.prefDefaultSimToCall) : getAccountMembership.prefDefaultSimToCall == null) && ((bool6 = this.prefTrackLocationOnActivity) != null ? bool6.equals(getAccountMembership.prefTrackLocationOnActivity) : getAccountMembership.prefTrackLocationOnActivity == null) && ((bool7 = this.prefUseBusinessWhatsapp) != null ? bool7.equals(getAccountMembership.prefUseBusinessWhatsapp) : getAccountMembership.prefUseBusinessWhatsapp == null) && ((bool8 = this.prefTrackAllCalls) != null ? bool8.equals(getAccountMembership.prefTrackAllCalls) : getAccountMembership.prefTrackAllCalls == null) && ((num2 = this.prefTrackAllCallsSpecificSim) != null ? num2.equals(getAccountMembership.prefTrackAllCallsSpecificSim) : getAccountMembership.prefTrackAllCallsSpecificSim == null) && ((bool9 = this.onLeave) != null ? bool9.equals(getAccountMembership.onLeave) : getAccountMembership.onLeave == null) && ((str15 = this.onLeaveTill) != null ? str15.equals(getAccountMembership.onLeaveTill) : getAccountMembership.onLeaveTill == null) && ((str16 = this.lastViewedChatNotification) != null ? str16.equals(getAccountMembership.lastViewedChatNotification) : getAccountMembership.lastViewedChatNotification == null) && ((str17 = this.prefReadOnlyInfo) != null ? str17.equals(getAccountMembership.prefReadOnlyInfo) : getAccountMembership.prefReadOnlyInfo == null) && ((str18 = this.customMemberAttributes) != null ? str18.equals(getAccountMembership.customMemberAttributes) : getAccountMembership.customMemberAttributes == null) && ((str19 = this.createdAt) != null ? str19.equals(getAccountMembership.createdAt) : getAccountMembership.createdAt == null) && ((str20 = this.updatedAt) != null ? str20.equals(getAccountMembership.updatedAt) : getAccountMembership.updatedAt == null) && ((account = this.account) != null ? account.equals(getAccountMembership.account) : getAccountMembership.account == null) && ((user = this.user) != null ? user.equals(getAccountMembership.user) : getAccountMembership.user == null) && ((addedBy = this.addedBy) != null ? addedBy.equals(getAccountMembership.addedBy) : getAccountMembership.addedBy == null) && ((updatedBy = this.updatedBy) != null ? updatedBy.equals(getAccountMembership.updatedBy) : getAccountMembership.updatedBy == null)) {
                ApprovedBy approvedBy = this.approvedBy;
                ApprovedBy approvedBy2 = getAccountMembership.approvedBy;
                if (approvedBy == null) {
                    if (approvedBy2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.GetAccountMembership.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetAccountMembership.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetAccountMembership.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetAccountMembership.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetAccountMembership.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], GetAccountMembership.this.userId);
                    responseWriter.writeList(responseFieldArr[4], GetAccountMembership.this.allowedDeviceId, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.GetAccountMembership.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[5], GetAccountMembership.this.designation);
                    responseWriter.writeString(responseFieldArr[6], GetAccountMembership.this.authorizationLevel.name());
                    responseWriter.writeString(responseFieldArr[7], GetAccountMembership.this.signature);
                    responseWriter.writeBoolean(responseFieldArr[8], GetAccountMembership.this.isBillingMember);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], GetAccountMembership.this.addedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[10], GetAccountMembership.this.updatedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], GetAccountMembership.this.addedOn);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], GetAccountMembership.this.approvedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], GetAccountMembership.this.approvedOn);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], GetAccountMembership.this.acceptedOn);
                    responseWriter.writeString(responseFieldArr[15], GetAccountMembership.this.userAccountStatus.name());
                    responseWriter.writeString(responseFieldArr[16], GetAccountMembership.this.whatsappApiAccess);
                    responseWriter.writeString(responseFieldArr[17], GetAccountMembership.this.sharedInboxPermission);
                    responseWriter.writeString(responseFieldArr[18], GetAccountMembership.this.canInitiateNewConversation);
                    responseWriter.writeString(responseFieldArr[19], GetAccountMembership.this.canCreateWaCampaigns);
                    responseWriter.writeBoolean(responseFieldArr[20], Boolean.valueOf(GetAccountMembership.this.mapRegisteredMobileNumberToAccount));
                    responseWriter.writeBoolean(responseFieldArr[21], Boolean.valueOf(GetAccountMembership.this.mapSecondaryMobileNumberToAccount));
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], GetAccountMembership.this.accountEmail);
                    responseWriter.writeBoolean(responseFieldArr[23], GetAccountMembership.this.accountEmailVerified);
                    responseWriter.writeList(responseFieldArr[24], GetAccountMembership.this.notificationPreferences, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.GetAccountMembership.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((NotificationPreference) obj).marshaller());
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], GetAccountMembership.this.migrateToUserIdOnRemoval);
                    responseWriter.writeBoolean(responseFieldArr[26], GetAccountMembership.this.prefScreenPop);
                    responseWriter.writeBoolean(responseFieldArr[27], GetAccountMembership.this.prefSaveBusinessCall);
                    responseWriter.writeBoolean(responseFieldArr[28], GetAccountMembership.this.prefPostCallDisposition);
                    responseWriter.writeInt(responseFieldArr[29], GetAccountMembership.this.prefDefaultSimToCall);
                    responseWriter.writeBoolean(responseFieldArr[30], GetAccountMembership.this.prefTrackLocationOnActivity);
                    responseWriter.writeBoolean(responseFieldArr[31], GetAccountMembership.this.prefUseBusinessWhatsapp);
                    responseWriter.writeBoolean(responseFieldArr[32], GetAccountMembership.this.prefTrackAllCalls);
                    responseWriter.writeInt(responseFieldArr[33], GetAccountMembership.this.prefTrackAllCallsSpecificSim);
                    responseWriter.writeBoolean(responseFieldArr[34], GetAccountMembership.this.onLeave);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[35], GetAccountMembership.this.onLeaveTill);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[36], GetAccountMembership.this.lastViewedChatNotification);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[37], GetAccountMembership.this.prefReadOnlyInfo);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], GetAccountMembership.this.customMemberAttributes);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[39], GetAccountMembership.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[40], GetAccountMembership.this.updatedAt);
                    ResponseField responseField = responseFieldArr[41];
                    Account account = GetAccountMembership.this.account;
                    ...
                    UpdatedBy updatedBy = GetAccountMembership.this.updatedBy;
                    ...
                    ApprovedBy approvedBy = GetAccountMembership.this.approvedBy;
    ...
    public static class NotificationPreference {
        ...
        public static final class Mapper implements ResponseFieldMapper<NotificationPreference> {
            ...
            public NotificationPreference map(ResponseReader responseReader) {
                ...
                return new NotificationPreference(string, string2 != null ? ActivityType.valueOf(string2) : null, responseReader.readList(responseFieldArr[2], new ResponseReader.ListReader<Channels>() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.NotificationPreference.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.NotificationPreference.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = NotificationPreference.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[2], NotificationPreference.this.channels, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.NotificationPreference.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class UpdatedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.UpdatedBy.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdatedBy.$responseFields;
    ...
    public static class User {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.User.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = User.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountMembershipQuery.Variables.1
    ...
    public GetAccountMembershipQuery(String str) {
    ...
    public String operationId() {
        return "d9e59c08d4401734d8cd1b737f1b05b7180ae437e13f02101741d7fabd69071e";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetAccountMembership($id: ID!) {\n  getAccountMembership(id: $id) {\n    __typename\n    id\n    accountId\n    userId\n    allowedDeviceId\n    designation\n    authorizationLevel\n    signature\n    isBillingMember\n    addedById\n    updatedById\n    addedOn\n    approvedById\n    approvedOn\n    acceptedOn\n    userAccountStatus\n    whatsappApiAccess\n    sharedInboxPermission\n    canInitiateNewConversation\n    canCreateWaCampaigns\n    mapRegisteredMobileNumberToAccount\n    mapSecondaryMobileNumberToAccount\n    accountEmail\n    accountEmailVerified\n    notificationPreferences {\n      __typename\n      notificationType\n      channels\n    }\n    migrateToUserIdOnRemoval\n    prefScreenPop\n    prefSaveBusinessCall\n    prefPostCallDisposition\n    prefDefaultSimToCall\n    prefTrackLocationOnActivity\n    prefUseBusinessWhatsapp\n    prefTrackAllCalls\n    prefTrackAllCallsSpecificSim\n    onLeave\n    onLeaveTill\n    lastViewedChatNotification\n    prefReadOnlyInfo\n    customMemberAttributes\n    createdAt\n    updatedAt\n    account {\n      __typename\n      id\n      accountName\n      accountType\n      deviceKey\n      deviceKeyLastUpdated\n      accountStatus\n      businessLogoUrl\n      createdById\n      dateFormat\n      dateTimeViewStyle\n      defaultCurrency\n      denomination\n      industry\n      nameOfBusiness\n      productOrService\n      timeFormat\n      timeZone\n      plan\n      paidUpTo\n      seats\n      freeSeats\n      currentTotalUsers\n      currentActiveUsers\n      extraActiveUsers\n      pricePerSeat\n      allowAddingSeat\n      allowAddingSeatTill\n      seatReductionMarkedForNextCycle\n      billingCurrency\n      billingEmail\n      taxId\n      taxIdType\n      trialAccountEndDate\n      trialExtensionTimes\n      eligibleForExtension\n      paidForTillDate\n      updatedById\n      website\n      permissions\n      enableCustomCharts\n      createdAt\n      updatedAt\n      dealMode\n      openAiApiKey\n      salesmaxSalesContacts\n      salesmaxSupportContacts\n      chatWidgetConfig\n      onboardingStatus\n      integrationNeeded\n      matchingDealId\n      relatedAccountIds\n      lastChurnDate\n      lastChurnReason\n      possibleReactivationDate\n      locationPeriodicFrequency\n      lastPaymentDataId\n      lastPaymentDataCreatedAt\n      nextRenewalDateIfPaid\n      lastPaymentStatus\n      partPaymentAmountIfAny\n    }\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    addedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    approvedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
