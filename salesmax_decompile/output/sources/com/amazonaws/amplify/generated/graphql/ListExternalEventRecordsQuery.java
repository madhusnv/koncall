...
public final class ListExternalEventRecordsQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListExternalEventRecords($filter: ModelExternalEventRecordFilterInput, $limit: Int, $nextToken: String) {\n  listExternalEventRecords(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      externalSourceId\n      externalSourceType\n      engagementId\n      userId\n      contactId\n      contactName\n      primaryParticipantEmailId\n      primaryParticipantName\n      recordingUrl\n      transcriptUrl\n      rawEvent\n      message\n      status\n      eventSummary\n      eventDescription\n      eventUrl\n      eventStartTime\n      eventEndTime\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListExternalEventRecordsQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListExternalEventRecords";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListExternalEventRecords($filter: ModelExternalEventRecordFilterInput, $limit: Int, $nextToken: String) {\n  listExternalEventRecords(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      externalSourceId\n      externalSourceType\n      engagementId\n      userId\n      contactId\n      contactName\n      primaryParticipantEmailId\n      primaryParticipantName\n      recordingUrl\n      transcriptUrl\n      rawEvent\n      message\n      status\n      eventSummary\n      eventDescription\n      eventUrl\n      eventStartTime\n      eventEndTime\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public ListExternalEventRecordsQuery build() {
            return new ListExternalEventRecordsQuery(this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listExternalEventRecords", "listExternalEventRecords", new UnmodifiableMapBuilder(3).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListExternalEventRecords listExternalEventRecords;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListExternalEventRecords.Mapper listExternalEventRecordsFieldMapper = new ListExternalEventRecords.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListExternalEventRecords) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListExternalEventRecords>() { // from class: com.amazonaws.amplify.generated.graphql.ListExternalEventRecordsQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListExternalEventRecords read(ResponseReader responseReader2) {
                        return Mapper.this.listExternalEventRecordsFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListExternalEventRecords listExternalEventRecords) {
            this.listExternalEventRecords = listExternalEventRecords;
        }
        ...
        public boolean equals(Object obj) {
            ...
            ListExternalEventRecords listExternalEventRecords = this.listExternalEventRecords;
            ListExternalEventRecords listExternalEventRecords2 = ((Data) obj).listExternalEventRecords;
            return listExternalEventRecords == null ? listExternalEventRecords2 == null : listExternalEventRecords.equals(listExternalEventRecords2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListExternalEventRecords listExternalEventRecords = this.listExternalEventRecords;
                this.$hashCode = (listExternalEventRecords == null ? 0 : listExternalEventRecords.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListExternalEventRecords listExternalEventRecords() {
            return this.listExternalEventRecords;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListExternalEventRecordsQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListExternalEventRecords listExternalEventRecords = Data.this.listExternalEventRecords;
                    responseWriter.writeObject(responseField, listExternalEventRecords != null ? listExternalEventRecords.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listExternalEventRecords=" + this.listExternalEventRecords + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListExternalEventRecordsQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static class ListExternalEventRecords {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListExternalEventRecords> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListExternalEventRecords map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListExternalEventRecords.$responseFields;
                return new ListExternalEventRecords(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListExternalEventRecordsQuery.ListExternalEventRecords.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListExternalEventRecordsQuery.ListExternalEventRecords.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListExternalEventRecords(String str, List<Item> list, String str2) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListExternalEventRecords)) {
                return false;
            }
            ListExternalEventRecords listExternalEventRecords = (ListExternalEventRecords) obj;
            if (this.__typename.equals(listExternalEventRecords.__typename) && this.items.equals(listExternalEventRecords.items)) {
                String str = this.nextToken;
                String str2 = listExternalEventRecords.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListExternalEventRecordsQuery.ListExternalEventRecords.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListExternalEventRecords.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListExternalEventRecords.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListExternalEventRecords.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListExternalEventRecordsQuery.ListExternalEventRecords.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListExternalEventRecords.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListExternalEventRecords{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(ModelExternalEventRecordFilterInput modelExternalEventRecordFilterInput, Integer num, String str) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListExternalEventRecordsQuery.Variables.1
    ...
    public ListExternalEventRecordsQuery(ModelExternalEventRecordFilterInput modelExternalEventRecordFilterInput, Integer num, String str) {
        this.variables = new Variables(modelExternalEventRecordFilterInput, num, str);
    }
    ...
    public String operationId() {
        return "3f02b1510fcf5b99d58b180682ea9dd108bdd607ac2ae79e0d356e17c1d96bd4";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListExternalEventRecords($filter: ModelExternalEventRecordFilterInput, $limit: Int, $nextToken: String) {\n  listExternalEventRecords(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      externalSourceId\n      externalSourceType\n      engagementId\n      userId\n      contactId\n      contactName\n      primaryParticipantEmailId\n      primaryParticipantName\n      recordingUrl\n      transcriptUrl\n      rawEvent\n      message\n      status\n      eventSummary\n      eventDescription\n      eventUrl\n      eventStartTime\n      eventEndTime\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
