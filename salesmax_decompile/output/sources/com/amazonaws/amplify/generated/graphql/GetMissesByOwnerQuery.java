...
public final class GetMissesByOwnerQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetMissesByOwner($accountId: ID, $ownerIdUpdatedAt: ModelMissedOpportunitiesByOwnerCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelMissedOpportunitiesFilterInput, $limit: Int, $nextToken: String) {\n  getMissesByOwner(accountId: $accountId, ownerIdUpdatedAt: $ownerIdUpdatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      accountId\n      ownerId\n      primaryTeamId\n      contactId\n      messageBody\n      missedOpportunityType\n      callLaterDateTime\n      relatedEngagementId\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByOwnerQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetMissesByOwner";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetMissesByOwner($accountId: ID, $ownerIdUpdatedAt: ModelMissedOpportunitiesByOwnerCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelMissedOpportunitiesFilterInput, $limit: Int, $nextToken: String) {\n  getMissesByOwner(accountId: $accountId, ownerIdUpdatedAt: $ownerIdUpdatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      accountId\n      ownerId\n      primaryTeamId\n      contactId\n      messageBody\n      missedOpportunityType\n      callLaterDateTime\n      relatedEngagementId\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        private ModelMissedOpportunitiesByOwnerCompositeKeyConditionInput ownerIdUpdatedAt;
        ...
        public GetMissesByOwnerQuery build() {
            return new GetMissesByOwnerQuery(this.accountId, this.ownerIdUpdatedAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
        ...
        public Builder ownerIdUpdatedAt(ModelMissedOpportunitiesByOwnerCompositeKeyConditionInput modelMissedOpportunitiesByOwnerCompositeKeyConditionInput) {
            this.ownerIdUpdatedAt = modelMissedOpportunitiesByOwnerCompositeKeyConditionInput;
            return this;
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getMissesByOwner", "getMissesByOwner", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("ownerIdUpdatedAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "ownerIdUpdatedAt").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetMissesByOwner getMissesByOwner;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetMissesByOwner.Mapper getMissesByOwnerFieldMapper = new GetMissesByOwner.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetMissesByOwner) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetMissesByOwner>() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByOwnerQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetMissesByOwner read(ResponseReader responseReader2) {
                        return Mapper.this.getMissesByOwnerFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetMissesByOwner getMissesByOwner) {
            this.getMissesByOwner = getMissesByOwner;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetMissesByOwner getMissesByOwner = this.getMissesByOwner;
            GetMissesByOwner getMissesByOwner2 = ((Data) obj).getMissesByOwner;
            return getMissesByOwner == null ? getMissesByOwner2 == null : getMissesByOwner.equals(getMissesByOwner2);
        }

        public GetMissesByOwner getMissesByOwner() {
            return this.getMissesByOwner;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetMissesByOwner getMissesByOwner = this.getMissesByOwner;
                this.$hashCode = (getMissesByOwner == null ? 0 : getMissesByOwner.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByOwnerQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetMissesByOwner getMissesByOwner = Data.this.getMissesByOwner;
                    responseWriter.writeObject(responseField, getMissesByOwner != null ? getMissesByOwner.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getMissesByOwner=" + this.getMissesByOwner + "}";
            }
            return this.$toString;
        }
    }

    public static class GetMissesByOwner {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetMissesByOwner> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetMissesByOwner map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetMissesByOwner.$responseFields;
                return new GetMissesByOwner(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByOwnerQuery.GetMissesByOwner.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByOwnerQuery.GetMissesByOwner.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetMissesByOwner(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetMissesByOwner)) {
                return false;
            }
            GetMissesByOwner getMissesByOwner = (GetMissesByOwner) obj;
            if (this.__typename.equals(getMissesByOwner.__typename) && ((list = this.items) != null ? list.equals(getMissesByOwner.items) : getMissesByOwner.items == null)) {
                String str = this.nextToken;
                String str2 = getMissesByOwner.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByOwnerQuery.GetMissesByOwner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetMissesByOwner.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetMissesByOwner.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetMissesByOwner.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByOwnerQuery.GetMissesByOwner.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetMissesByOwner.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetMissesByOwner{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByOwnerQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final ModelMissedOpportunitiesByOwnerCompositeKeyConditionInput ownerIdUpdatedAt;
        private final ModelSortDirection sortDirection;
        private final transient Map<String, Object> valueMap;

        public Variables(String str, ModelMissedOpportunitiesByOwnerCompositeKeyConditionInput modelMissedOpportunitiesByOwnerCompositeKeyConditionInput, ModelSortDirection modelSortDirection, ModelMissedOpportunitiesFilterInput modelMissedOpportunitiesFilterInput, Integer num, String str2) {
            ...
            linkedHashMap.put("ownerIdUpdatedAt", modelMissedOpportunitiesByOwnerCompositeKeyConditionInput);
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByOwnerQuery.Variables.1
        ...
        public ModelMissedOpportunitiesByOwnerCompositeKeyConditionInput ownerIdUpdatedAt() {
    ...
    public GetMissesByOwnerQuery(String str, ModelMissedOpportunitiesByOwnerCompositeKeyConditionInput modelMissedOpportunitiesByOwnerCompositeKeyConditionInput, ModelSortDirection modelSortDirection, ModelMissedOpportunitiesFilterInput modelMissedOpportunitiesFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelMissedOpportunitiesByOwnerCompositeKeyConditionInput, modelSortDirection, modelMissedOpportunitiesFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "7e6ea46d48f61b4f80c28a904cc83ac02eed36e5bb5528b802144e930ece3ffa";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetMissesByOwner($accountId: ID, $ownerIdUpdatedAt: ModelMissedOpportunitiesByOwnerCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelMissedOpportunitiesFilterInput, $limit: Int, $nextToken: String) {\n  getMissesByOwner(accountId: $accountId, ownerIdUpdatedAt: $ownerIdUpdatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      accountId\n      ownerId\n      primaryTeamId\n      contactId\n      messageBody\n      missedOpportunityType\n      callLaterDateTime\n      relatedEngagementId\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
