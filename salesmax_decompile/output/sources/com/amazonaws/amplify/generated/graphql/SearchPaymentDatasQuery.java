...
import type.SearchablePaymentDataFilterInput;
import type.SearchablePaymentDataSortInput;

/* loaded from: classes4.dex */
public final class SearchPaymentDatasQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query SearchPaymentDatas($filter: SearchablePaymentDataFilterInput, $sort: SearchablePaymentDataSortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchPaymentDatas(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      paymentRequestType\n      engagementId\n      paymentProvider\n      orderIdInPaymentProvider\n      orderId\n      paymentLinkId\n      paymentLinkUrl\n      amount\n      amountPaid\n      currency\n      status\n      lastPaymentStatus\n      finalPaymentDate\n      paidByContactIds\n      transactionId\n      note\n      createdAt\n      updatedAt\n      customPaymentData\n      createdById\n      updatedById\n    }\n    nextToken\n    total\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.SearchPaymentDatasQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "SearchPaymentDatas";
        }
    };
    public static final String QUERY_DOCUMENT = "query SearchPaymentDatas($filter: SearchablePaymentDataFilterInput, $sort: SearchablePaymentDataSortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchPaymentDatas(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      paymentRequestType\n      engagementId\n      paymentProvider\n      orderIdInPaymentProvider\n      orderId\n      paymentLinkId\n      paymentLinkUrl\n      amount\n      amountPaid\n      currency\n      status\n      lastPaymentStatus\n      finalPaymentDate\n      paidByContactIds\n      transactionId\n      note\n      createdAt\n      updatedAt\n      customPaymentData\n      createdById\n      updatedById\n    }\n    nextToken\n    total\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private SearchablePaymentDataFilterInput filter;
        private Integer from;
        private Integer limit;
        private String nextToken;
        private SearchablePaymentDataSortInput sort;

        public SearchPaymentDatasQuery build() {
            return new SearchPaymentDatasQuery(this.filter, this.sort, this.limit, this.nextToken, this.from);
        }

        public Builder filter(SearchablePaymentDataFilterInput searchablePaymentDataFilterInput) {
            this.filter = searchablePaymentDataFilterInput;
            return this;
        }
        ...
        public Builder sort(SearchablePaymentDataSortInput searchablePaymentDataSortInput) {
            this.sort = searchablePaymentDataSortInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("searchPaymentDatas", "searchPaymentDatas", new UnmodifiableMapBuilder(5).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put(Constants.MessagePayloadKeys.FROM, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, Constants.MessagePayloadKeys.FROM).build()).put("sort", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sort").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final SearchPaymentDatas searchPaymentDatas;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final SearchPaymentDatas.Mapper searchPaymentDatasFieldMapper = new SearchPaymentDatas.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((SearchPaymentDatas) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<SearchPaymentDatas>() { // from class: com.amazonaws.amplify.generated.graphql.SearchPaymentDatasQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public SearchPaymentDatas read(ResponseReader responseReader2) {
                        return Mapper.this.searchPaymentDatasFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(SearchPaymentDatas searchPaymentDatas) {
            this.searchPaymentDatas = searchPaymentDatas;
        }
        ...
        public boolean equals(Object obj) {
            ...
            SearchPaymentDatas searchPaymentDatas = this.searchPaymentDatas;
            SearchPaymentDatas searchPaymentDatas2 = ((Data) obj).searchPaymentDatas;
            return searchPaymentDatas == null ? searchPaymentDatas2 == null : searchPaymentDatas.equals(searchPaymentDatas2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                SearchPaymentDatas searchPaymentDatas = this.searchPaymentDatas;
                this.$hashCode = (searchPaymentDatas == null ? 0 : searchPaymentDatas.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchPaymentDatasQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    SearchPaymentDatas searchPaymentDatas = Data.this.searchPaymentDatas;
                    responseWriter.writeObject(responseField, searchPaymentDatas != null ? searchPaymentDatas.marshaller() : null);
                }
            };
        }

        public SearchPaymentDatas searchPaymentDatas() {
            return this.searchPaymentDatas;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{searchPaymentDatas=" + this.searchPaymentDatas + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchPaymentDatasQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[17], Item.this.paidByContactIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.SearchPaymentDatasQuery.Item.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], Item.this.transactionId, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.SearchPaymentDatasQuery.Item.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class SearchPaymentDatas {
        ...
        public static final class Mapper implements ResponseFieldMapper<SearchPaymentDatas> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public SearchPaymentDatas map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = SearchPaymentDatas.$responseFields;
                return new SearchPaymentDatas(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.SearchPaymentDatasQuery.SearchPaymentDatas.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.SearchPaymentDatasQuery.SearchPaymentDatas.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public SearchPaymentDatas(String str, List<Item> list, String str2, Integer num) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof SearchPaymentDatas)) {
                return false;
            }
            SearchPaymentDatas searchPaymentDatas = (SearchPaymentDatas) obj;
            if (this.__typename.equals(searchPaymentDatas.__typename) && this.items.equals(searchPaymentDatas.items) && ((str = this.nextToken) != null ? str.equals(searchPaymentDatas.nextToken) : searchPaymentDatas.nextToken == null)) {
                Integer num = this.total;
                Integer num2 = searchPaymentDatas.total;
                if (num == null) {
                    if (num2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchPaymentDatasQuery.SearchPaymentDatas.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = SearchPaymentDatas.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], SearchPaymentDatas.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], SearchPaymentDatas.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.SearchPaymentDatasQuery.SearchPaymentDatas.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], SearchPaymentDatas.this.nextToken);
                    responseWriter.writeInt(responseFieldArr[3], SearchPaymentDatas.this.total);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "SearchPaymentDatas{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + ", total=" + this.total + "}";
            }
            return this.$toString;
        }
    ...
    public static final class Variables extends Operation.Variables {
        private final SearchablePaymentDataFilterInput filter;
        private final Integer from;
        private final Integer limit;
        private final String nextToken;
        private final SearchablePaymentDataSortInput sort;
        private final transient Map<String, Object> valueMap;

        public Variables(SearchablePaymentDataFilterInput searchablePaymentDataFilterInput, SearchablePaymentDataSortInput searchablePaymentDataSortInput, Integer num, String str, Integer num2) {
            ...
            this.nextToken = str;
            this.from = num2;
            linkedHashMap.put("filter", searchablePaymentDataFilterInput);
            linkedHashMap.put("sort", searchablePaymentDataSortInput);
        ...
        public SearchablePaymentDataFilterInput filter() {
            return this.filter;
        }
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchPaymentDatasQuery.Variables.1
        ...
        public SearchablePaymentDataSortInput sort() {
            return this.sort;
        }
    ...
    public SearchPaymentDatasQuery(SearchablePaymentDataFilterInput searchablePaymentDataFilterInput, SearchablePaymentDataSortInput searchablePaymentDataSortInput, Integer num, String str, Integer num2) {
        this.variables = new Variables(searchablePaymentDataFilterInput, searchablePaymentDataSortInput, num, str, num2);
    }
    ...
    public String operationId() {
        return "f4aa0d42ff2a516c2eee459892d0cd92450463c596ce4d35c35b4b0b8148c095";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query SearchPaymentDatas($filter: SearchablePaymentDataFilterInput, $sort: SearchablePaymentDataSortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchPaymentDatas(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      paymentRequestType\n      engagementId\n      paymentProvider\n      orderIdInPaymentProvider\n      orderId\n      paymentLinkId\n      paymentLinkUrl\n      amount\n      amountPaid\n      currency\n      status\n      lastPaymentStatus\n      finalPaymentDate\n      paidByContactIds\n      transactionId\n      note\n      createdAt\n      updatedAt\n      customPaymentData\n      createdById\n      updatedById\n    }\n    nextToken\n    total\n  }\n}";
    }
