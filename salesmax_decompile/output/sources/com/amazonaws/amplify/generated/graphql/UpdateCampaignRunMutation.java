...
import type.ModelCampaignRunConditionInput;
import type.UpdateCampaignRunInput;
import type.UserRegistrationStatus;

/* loaded from: classes4.dex */
public final class UpdateCampaignRunMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation UpdateCampaignRun($input: UpdateCampaignRunInput!, $condition: ModelCampaignRunConditionInput) {\n  updateCampaignRun(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.UpdateCampaignRunMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "UpdateCampaignRun";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation UpdateCampaignRun($input: UpdateCampaignRunInput!, $condition: ModelCampaignRunConditionInput) {\n  updateCampaignRun(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelCampaignRunConditionInput condition;
        private UpdateCampaignRunInput input;

        public UpdateCampaignRunMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new UpdateCampaignRunMutation(this.input, this.condition);
        }

        public Builder condition(ModelCampaignRunConditionInput modelCampaignRunConditionInput) {
            this.condition = modelCampaignRunConditionInput;
            return this;
        }

        public Builder input(UpdateCampaignRunInput updateCampaignRunInput) {
            this.input = updateCampaignRunInput;
            return this;
        }
    }
    ...
    public static class Campaign {
        ...
        public static final class Mapper implements ResponseFieldMapper<Campaign> {
            ...
            public Campaign map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[15], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateCampaignRunMutation.Campaign.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateCampaignRunMutation.Campaign.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[15], Campaign.this.daysToSend, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateCampaignRunMutation.Campaign.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[29], Campaign.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateCampaignRunMutation.Campaign.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("updateCampaignRun", "updateCampaignRun", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final UpdateCampaignRun updateCampaignRun;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final UpdateCampaignRun.Mapper updateCampaignRunFieldMapper = new UpdateCampaignRun.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((UpdateCampaignRun) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<UpdateCampaignRun>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateCampaignRunMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdateCampaignRun read(ResponseReader responseReader2) {
                        return Mapper.this.updateCampaignRunFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(UpdateCampaignRun updateCampaignRun) {
            this.updateCampaignRun = updateCampaignRun;
        }
        ...
        public boolean equals(Object obj) {
            ...
            UpdateCampaignRun updateCampaignRun = this.updateCampaignRun;
            UpdateCampaignRun updateCampaignRun2 = ((Data) obj).updateCampaignRun;
            return updateCampaignRun == null ? updateCampaignRun2 == null : updateCampaignRun.equals(updateCampaignRun2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                UpdateCampaignRun updateCampaignRun = this.updateCampaignRun;
                this.$hashCode = (updateCampaignRun == null ? 0 : updateCampaignRun.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateCampaignRunMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    UpdateCampaignRun updateCampaignRun = Data.this.updateCampaignRun;
                    responseWriter.writeObject(responseField, updateCampaignRun != null ? updateCampaignRun.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{updateCampaignRun=" + this.updateCampaignRun + "}";
            }
            return this.$toString;
        }

        public UpdateCampaignRun updateCampaignRun() {
            return this.updateCampaignRun;
        }
    }
    ...
    public static class Owner {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateCampaignRunMutation.Owner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Owner.$responseFields;
    ...
    public static class PrimaryTeam {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateCampaignRunMutation.PrimaryTeam.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = PrimaryTeam.$responseFields;
    ...
    public static class UpdateCampaignRun {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<UpdateCampaignRun> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public UpdateCampaignRun map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = UpdateCampaignRun.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
        ...
        public UpdateCampaignRun(String str, String str2, String str3, String str4, String str5, CampaignType campaignType, String str6, String str7, String str8, String str9, CampaignStatus campaignStatus, String str10, Integer num, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, Integer num7, String str11, String str12, PrimaryTeam primaryTeam, String str13, String str14, Campaign campaign, Owner owner) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateCampaignRun)) {
                return false;
            }
            UpdateCampaignRun updateCampaignRun = (UpdateCampaignRun) obj;
            if (this.__typename.equals(updateCampaignRun.__typename) && this.id.equals(updateCampaignRun.id) && this.accountId.equals(updateCampaignRun.accountId) && this.campaignId.equals(updateCampaignRun.campaignId) && ((str = this.campaignName) != null ? str.equals(updateCampaignRun.campaignName) : updateCampaignRun.campaignName == null) && ((campaignType = this.campaignType) != null ? campaignType.equals(updateCampaignRun.campaignType) : updateCampaignRun.campaignType == null) && ((str2 = this.campaignChannelIdentifier) != null ? str2.equals(updateCampaignRun.campaignChannelIdentifier) : updateCampaignRun.campaignChannelIdentifier == null) && this.name.equals(updateCampaignRun.name) && ((str3 = this.startDate) != null ? str3.equals(updateCampaignRun.startDate) : updateCampaignRun.startDate == null) && ((str4 = this.endDate) != null ? str4.equals(updateCampaignRun.endDate) : updateCampaignRun.endDate == null) && this.status.equals(updateCampaignRun.status) && ((str5 = this.systemPauseReason) != null ? str5.equals(updateCampaignRun.systemPauseReason) : updateCampaignRun.systemPauseReason == null) && ((num = this.leadCount) != null ? num.equals(updateCampaignRun.leadCount) : updateCampaignRun.leadCount == null) && ((num2 = this.messageCreated) != null ? num2.equals(updateCampaignRun.messageCreated) : updateCampaignRun.messageCreated == null) && ((num3 = this.sentCount) != null ? num3.equals(updateCampaignRun.sentCount) : updateCampaignRun.sentCount == null) && ((num4 = this.deliveredCount) != null ? num4.equals(updateCampaignRun.deliveredCount) : updateCampaignRun.deliveredCount == null) && ((num5 = this.readCount) != null ? num5.equals(updateCampaignRun.readCount) : updateCampaignRun.readCount == null) && ((num6 = this.repliedCount) != null ? num6.equals(updateCampaignRun.repliedCount) : updateCampaignRun.repliedCount == null) && ((num7 = this.failedCount) != null ? num7.equals(updateCampaignRun.failedCount) : updateCampaignRun.failedCount == null) && this.ownerId.equals(updateCampaignRun.ownerId) && ((str6 = this.primaryTeamId) != null ? str6.equals(updateCampaignRun.primaryTeamId) : updateCampaignRun.primaryTeamId == null) && ((primaryTeam = this.primaryTeam) != null ? primaryTeam.equals(updateCampaignRun.primaryTeam) : updateCampaignRun.primaryTeam == null) && ((str7 = this.createdAt) != null ? str7.equals(updateCampaignRun.createdAt) : updateCampaignRun.createdAt == null) && ((str8 = this.updatedAt) != null ? str8.equals(updateCampaignRun.updatedAt) : updateCampaignRun.updatedAt == null) && ((campaign = this.campaign) != null ? campaign.equals(updateCampaignRun.campaign) : updateCampaignRun.campaign == null)) {
                Owner owner = this.owner;
                Owner owner2 = updateCampaignRun.owner;
                if (owner == null) {
                    if (owner2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateCampaignRunMutation.UpdateCampaignRun.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdateCampaignRun.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UpdateCampaignRun.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], UpdateCampaignRun.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], UpdateCampaignRun.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], UpdateCampaignRun.this.campaignId);
                    responseWriter.writeString(responseFieldArr[4], UpdateCampaignRun.this.campaignName);
                    ResponseField responseField = responseFieldArr[5];
                    CampaignType campaignType = UpdateCampaignRun.this.campaignType;
                    responseWriter.writeString(responseField, campaignType != null ? campaignType.name() : null);
                    responseWriter.writeString(responseFieldArr[6], UpdateCampaignRun.this.campaignChannelIdentifier);
                    responseWriter.writeString(responseFieldArr[7], UpdateCampaignRun.this.name);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], UpdateCampaignRun.this.startDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], UpdateCampaignRun.this.endDate);
                    responseWriter.writeString(responseFieldArr[10], UpdateCampaignRun.this.status.name());
                    responseWriter.writeString(responseFieldArr[11], UpdateCampaignRun.this.systemPauseReason);
                    responseWriter.writeInt(responseFieldArr[12], UpdateCampaignRun.this.leadCount);
                    responseWriter.writeInt(responseFieldArr[13], UpdateCampaignRun.this.messageCreated);
                    responseWriter.writeInt(responseFieldArr[14], UpdateCampaignRun.this.sentCount);
                    responseWriter.writeInt(responseFieldArr[15], UpdateCampaignRun.this.deliveredCount);
                    responseWriter.writeInt(responseFieldArr[16], UpdateCampaignRun.this.readCount);
                    responseWriter.writeInt(responseFieldArr[17], UpdateCampaignRun.this.repliedCount);
                    responseWriter.writeInt(responseFieldArr[18], UpdateCampaignRun.this.failedCount);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], UpdateCampaignRun.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], UpdateCampaignRun.this.primaryTeamId);
                    ResponseField responseField2 = responseFieldArr[21];
                    PrimaryTeam primaryTeam = UpdateCampaignRun.this.primaryTeam;
                    responseWriter.writeObject(responseField2, primaryTeam != null ? primaryTeam.marshaller() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], UpdateCampaignRun.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], UpdateCampaignRun.this.updatedAt);
                    ResponseField responseField3 = responseFieldArr[24];
                    Campaign campaign = UpdateCampaignRun.this.campaign;
                    ...
                    Owner owner = UpdateCampaignRun.this.owner;
    ...
    public static final class Variables extends Operation.Variables {
        private final ModelCampaignRunConditionInput condition;
        private final UpdateCampaignRunInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(UpdateCampaignRunInput updateCampaignRunInput, ModelCampaignRunConditionInput modelCampaignRunConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = updateCampaignRunInput;
            this.condition = modelCampaignRunConditionInput;
            linkedHashMap.put("input", updateCampaignRunInput);
            linkedHashMap.put("condition", modelCampaignRunConditionInput);
        }

        public ModelCampaignRunConditionInput condition() {
            return this.condition;
        }

        public UpdateCampaignRunInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateCampaignRunMutation.Variables.1
    ...
    public UpdateCampaignRunMutation(UpdateCampaignRunInput updateCampaignRunInput, ModelCampaignRunConditionInput modelCampaignRunConditionInput) {
        Utils.checkNotNull(updateCampaignRunInput, "input == null");
        this.variables = new Variables(updateCampaignRunInput, modelCampaignRunConditionInput);
    }
    ...
    public String operationId() {
        return "a7737aaeabf14e2542498c1f3480ac498da9b1ddb55c2ef4920ec32242544a8b";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation UpdateCampaignRun($input: UpdateCampaignRunInput!, $condition: ModelCampaignRunConditionInput) {\n  updateCampaignRun(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
