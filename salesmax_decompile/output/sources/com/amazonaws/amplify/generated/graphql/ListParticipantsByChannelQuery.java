...
public final class ListParticipantsByChannelQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListParticipantsByChannel($channelId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelChatParticipantFilterInput, $limit: Int, $nextToken: String) {\n  listParticipantsByChannel(channelId: $channelId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      channelId\n      phoneNumberIdExternal\n      participantId\n      participationStatus\n      unreadMessageCount\n      lastViewed\n      isStarred\n      joinedAt\n      leftAt\n      channelName\n      channelType\n      channelSubType\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      isNewMessageUpdate\n      tags\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListParticipantsByChannelQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListParticipantsByChannel";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListParticipantsByChannel($channelId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelChatParticipantFilterInput, $limit: Int, $nextToken: String) {\n  listParticipantsByChannel(channelId: $channelId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      channelId\n      phoneNumberIdExternal\n      participantId\n      participationStatus\n      unreadMessageCount\n      lastViewed\n      isStarred\n      joinedAt\n      leftAt\n      channelName\n      channelType\n      channelSubType\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      isNewMessageUpdate\n      tags\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public ListParticipantsByChannelQuery build() {
            return new ListParticipantsByChannelQuery(this.channelId, this.updatedAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listParticipantsByChannel", "listParticipantsByChannel", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("channelId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "channelId").build()).put("updatedAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "updatedAt").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListParticipantsByChannel listParticipantsByChannel;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListParticipantsByChannel.Mapper listParticipantsByChannelFieldMapper = new ListParticipantsByChannel.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListParticipantsByChannel) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListParticipantsByChannel>() { // from class: com.amazonaws.amplify.generated.graphql.ListParticipantsByChannelQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListParticipantsByChannel read(ResponseReader responseReader2) {
                        return Mapper.this.listParticipantsByChannelFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListParticipantsByChannel listParticipantsByChannel) {
            this.listParticipantsByChannel = listParticipantsByChannel;
        }
        ...
        public boolean equals(Object obj) {
            ...
            ListParticipantsByChannel listParticipantsByChannel = this.listParticipantsByChannel;
            ListParticipantsByChannel listParticipantsByChannel2 = ((Data) obj).listParticipantsByChannel;
            return listParticipantsByChannel == null ? listParticipantsByChannel2 == null : listParticipantsByChannel.equals(listParticipantsByChannel2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListParticipantsByChannel listParticipantsByChannel = this.listParticipantsByChannel;
                this.$hashCode = (listParticipantsByChannel == null ? 0 : listParticipantsByChannel.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListParticipantsByChannel listParticipantsByChannel() {
            return this.listParticipantsByChannel;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListParticipantsByChannelQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListParticipantsByChannel listParticipantsByChannel = Data.this.listParticipantsByChannel;
                    responseWriter.writeObject(responseField, listParticipantsByChannel != null ? listParticipantsByChannel.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listParticipantsByChannel=" + this.listParticipantsByChannel + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListParticipantsByChannelQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[24], Item.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListParticipantsByChannelQuery.Item.1.1
    ...
    public static class ListParticipantsByChannel {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListParticipantsByChannel> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListParticipantsByChannel map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListParticipantsByChannel.$responseFields;
                return new ListParticipantsByChannel(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListParticipantsByChannelQuery.ListParticipantsByChannel.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListParticipantsByChannelQuery.ListParticipantsByChannel.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListParticipantsByChannel(String str, List<Item> list, String str2) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListParticipantsByChannel)) {
                return false;
            }
            ListParticipantsByChannel listParticipantsByChannel = (ListParticipantsByChannel) obj;
            if (this.__typename.equals(listParticipantsByChannel.__typename) && this.items.equals(listParticipantsByChannel.items)) {
                String str = this.nextToken;
                String str2 = listParticipantsByChannel.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListParticipantsByChannelQuery.ListParticipantsByChannel.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListParticipantsByChannel.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListParticipantsByChannel.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListParticipantsByChannel.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListParticipantsByChannelQuery.ListParticipantsByChannel.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListParticipantsByChannel.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListParticipantsByChannel{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelChatParticipantFilterInput modelChatParticipantFilterInput, Integer num, String str2) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListParticipantsByChannelQuery.Variables.1
    ...
    public ListParticipantsByChannelQuery(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelChatParticipantFilterInput modelChatParticipantFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelStringKeyConditionInput, modelSortDirection, modelChatParticipantFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "bb99711824f54fafc4ed4a067a94027f696402d0b61ba281fb0b9f72dd280954";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListParticipantsByChannel($channelId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelChatParticipantFilterInput, $limit: Int, $nextToken: String) {\n  listParticipantsByChannel(channelId: $channelId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      channelId\n      phoneNumberIdExternal\n      participantId\n      participationStatus\n      unreadMessageCount\n      lastViewed\n      isStarred\n      joinedAt\n      leftAt\n      channelName\n      channelType\n      channelSubType\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      isNewMessageUpdate\n      tags\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
