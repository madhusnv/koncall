...
import type.CreateWabaAccountInput;
import type.CustomType;
import type.ModelWabaAccountConditionInput;

/* loaded from: classes6.dex */
public final class CreateWabaAccountMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation CreateWabaAccount($input: CreateWabaAccountInput!, $condition: ModelWabaAccountConditionInput) {\n  createWabaAccount(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    wabaAccountName\n    accessToken\n    accountId\n    remainingFreeTierConversationsOverall\n    remainingBalanceOverall\n    remainingBalanceBroadcast\n    blockedBalanceOverall\n    blockedBalanceBroadcast\n    promptForPaymentThreshold\n    createdAt\n    updatedAt\n    currentLimitCategory\n    maxDailyConversationPerPhone\n    maxPhoneNumbersPerBusiness\n    maxPhoneNumbersPerWaba\n    restrictionInfo {\n      __typename\n      restrictionType\n      restrictionExpiry\n    }\n    wabaBanState\n    wabaBanDate\n    wabaDecision\n    wabaDecisionTime\n    rejectionReason\n    createdById\n    updatedById\n    wabaPhoneNumbers {\n      __typename\n      nextToken\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.CreateWabaAccountMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "CreateWabaAccount";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation CreateWabaAccount($input: CreateWabaAccountInput!, $condition: ModelWabaAccountConditionInput) {\n  createWabaAccount(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    wabaAccountName\n    accessToken\n    accountId\n    remainingFreeTierConversationsOverall\n    remainingBalanceOverall\n    remainingBalanceBroadcast\n    blockedBalanceOverall\n    blockedBalanceBroadcast\n    promptForPaymentThreshold\n    createdAt\n    updatedAt\n    currentLimitCategory\n    maxDailyConversationPerPhone\n    maxPhoneNumbersPerBusiness\n    maxPhoneNumbersPerWaba\n    restrictionInfo {\n      __typename\n      restrictionType\n      restrictionExpiry\n    }\n    wabaBanState\n    wabaBanDate\n    wabaDecision\n    wabaDecisionTime\n    rejectionReason\n    createdById\n    updatedById\n    wabaPhoneNumbers {\n      __typename\n      nextToken\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelWabaAccountConditionInput condition;
        private CreateWabaAccountInput input;

        public CreateWabaAccountMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new CreateWabaAccountMutation(this.input, this.condition);
        }

        public Builder condition(ModelWabaAccountConditionInput modelWabaAccountConditionInput) {
            this.condition = modelWabaAccountConditionInput;
            return this;
        }

        public Builder input(CreateWabaAccountInput createWabaAccountInput) {
            this.input = createWabaAccountInput;
            return this;
        }
    }

    public static class CreateWabaAccount {
        ...
        public static final class Mapper implements ResponseFieldMapper<CreateWabaAccount> {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateWabaAccount)) {
                return false;
            }
            CreateWabaAccount createWabaAccount = (CreateWabaAccount) obj;
            if (this.__typename.equals(createWabaAccount.__typename) && this.id.equals(createWabaAccount.id) && this.wabaAccountId.equals(createWabaAccount.wabaAccountId) && ((str = this.wabaAccountName) != null ? str.equals(createWabaAccount.wabaAccountName) : createWabaAccount.wabaAccountName == null) && ((str2 = this.accessToken) != null ? str2.equals(createWabaAccount.accessToken) : createWabaAccount.accessToken == null) && this.accountId.equals(createWabaAccount.accountId) && ((num = this.remainingFreeTierConversationsOverall) != null ? num.equals(createWabaAccount.remainingFreeTierConversationsOverall) : createWabaAccount.remainingFreeTierConversationsOverall == null) && ((d = this.remainingBalanceOverall) != null ? d.equals(createWabaAccount.remainingBalanceOverall) : createWabaAccount.remainingBalanceOverall == null) && ((d2 = this.remainingBalanceBroadcast) != null ? d2.equals(createWabaAccount.remainingBalanceBroadcast) : createWabaAccount.remainingBalanceBroadcast == null) && ((d3 = this.blockedBalanceOverall) != null ? d3.equals(createWabaAccount.blockedBalanceOverall) : createWabaAccount.blockedBalanceOverall == null) && ((d4 = this.blockedBalanceBroadcast) != null ? d4.equals(createWabaAccount.blockedBalanceBroadcast) : createWabaAccount.blockedBalanceBroadcast == null) && ((d5 = this.promptForPaymentThreshold) != null ? d5.equals(createWabaAccount.promptForPaymentThreshold) : createWabaAccount.promptForPaymentThreshold == null) && ((str3 = this.createdAt) != null ? str3.equals(createWabaAccount.createdAt) : createWabaAccount.createdAt == null) && ((str4 = this.updatedAt) != null ? str4.equals(createWabaAccount.updatedAt) : createWabaAccount.updatedAt == null) && ((str5 = this.currentLimitCategory) != null ? str5.equals(createWabaAccount.currentLimitCategory) : createWabaAccount.currentLimitCategory == null) && ((num2 = this.maxDailyConversationPerPhone) != null ? num2.equals(createWabaAccount.maxDailyConversationPerPhone) : createWabaAccount.maxDailyConversationPerPhone == null) && ((num3 = this.maxPhoneNumbersPerBusiness) != null ? num3.equals(createWabaAccount.maxPhoneNumbersPerBusiness) : createWabaAccount.maxPhoneNumbersPerBusiness == null) && ((num4 = this.maxPhoneNumbersPerWaba) != null ? num4.equals(createWabaAccount.maxPhoneNumbersPerWaba) : createWabaAccount.maxPhoneNumbersPerWaba == null) && ((list = this.restrictionInfo) != null ? list.equals(createWabaAccount.restrictionInfo) : createWabaAccount.restrictionInfo == null) && ((str6 = this.wabaBanState) != null ? str6.equals(createWabaAccount.wabaBanState) : createWabaAccount.wabaBanState == null) && ((str7 = this.wabaBanDate) != null ? str7.equals(createWabaAccount.wabaBanDate) : createWabaAccount.wabaBanDate == null) && ((str8 = this.wabaDecision) != null ? str8.equals(createWabaAccount.wabaDecision) : createWabaAccount.wabaDecision == null) && ((str9 = this.wabaDecisionTime) != null ? str9.equals(createWabaAccount.wabaDecisionTime) : createWabaAccount.wabaDecisionTime == null) && ((str10 = this.rejectionReason) != null ? str10.equals(createWabaAccount.rejectionReason) : createWabaAccount.rejectionReason == null) && ((str11 = this.createdById) != null ? str11.equals(createWabaAccount.createdById) : createWabaAccount.createdById == null) && ((str12 = this.updatedById) != null ? str12.equals(createWabaAccount.updatedById) : createWabaAccount.updatedById == null)) {
                WabaPhoneNumbers wabaPhoneNumbers = this.wabaPhoneNumbers;
                WabaPhoneNumbers wabaPhoneNumbers2 = createWabaAccount.wabaPhoneNumbers;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWabaAccountMutation.CreateWabaAccount.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateWabaAccount.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateWabaAccount.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateWabaAccount.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], CreateWabaAccount.this.wabaAccountId);
                    responseWriter.writeString(responseFieldArr[3], CreateWabaAccount.this.wabaAccountName);
                    responseWriter.writeString(responseFieldArr[4], CreateWabaAccount.this.accessToken);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], CreateWabaAccount.this.accountId);
                    responseWriter.writeInt(responseFieldArr[6], CreateWabaAccount.this.remainingFreeTierConversationsOverall);
                    responseWriter.writeDouble(responseFieldArr[7], CreateWabaAccount.this.remainingBalanceOverall);
                    responseWriter.writeDouble(responseFieldArr[8], CreateWabaAccount.this.remainingBalanceBroadcast);
                    responseWriter.writeDouble(responseFieldArr[9], CreateWabaAccount.this.blockedBalanceOverall);
                    responseWriter.writeDouble(responseFieldArr[10], CreateWabaAccount.this.blockedBalanceBroadcast);
                    responseWriter.writeDouble(responseFieldArr[11], CreateWabaAccount.this.promptForPaymentThreshold);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], CreateWabaAccount.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], CreateWabaAccount.this.updatedAt);
                    responseWriter.writeString(responseFieldArr[14], CreateWabaAccount.this.currentLimitCategory);
                    responseWriter.writeInt(responseFieldArr[15], CreateWabaAccount.this.maxDailyConversationPerPhone);
                    responseWriter.writeInt(responseFieldArr[16], CreateWabaAccount.this.maxPhoneNumbersPerBusiness);
                    responseWriter.writeInt(responseFieldArr[17], CreateWabaAccount.this.maxPhoneNumbersPerWaba);
                    responseWriter.writeList(responseFieldArr[18], CreateWabaAccount.this.restrictionInfo, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateWabaAccountMutation.CreateWabaAccount.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((RestrictionInfo) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[19], CreateWabaAccount.this.wabaBanState);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], CreateWabaAccount.this.wabaBanDate);
                    responseWriter.writeString(responseFieldArr[21], CreateWabaAccount.this.wabaDecision);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], CreateWabaAccount.this.wabaDecisionTime);
                    responseWriter.writeString(responseFieldArr[23], CreateWabaAccount.this.rejectionReason);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[24], CreateWabaAccount.this.createdById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], CreateWabaAccount.this.updatedById);
                    ResponseField responseField = responseFieldArr[26];
                    WabaPhoneNumbers wabaPhoneNumbers = CreateWabaAccount.this.wabaPhoneNumbers;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createWabaAccount", "createWabaAccount", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final CreateWabaAccount createWabaAccount;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateWabaAccount.Mapper createWabaAccountFieldMapper = new CreateWabaAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateWabaAccount) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateWabaAccount>() { // from class: com.amazonaws.amplify.generated.graphql.CreateWabaAccountMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateWabaAccount read(ResponseReader responseReader2) {
                        return Mapper.this.createWabaAccountFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateWabaAccount createWabaAccount) {
            this.createWabaAccount = createWabaAccount;
        }

        public CreateWabaAccount createWabaAccount() {
            return this.createWabaAccount;
        }
        ...
        public boolean equals(Object obj) {
            ...
            CreateWabaAccount createWabaAccount = this.createWabaAccount;
            CreateWabaAccount createWabaAccount2 = ((Data) obj).createWabaAccount;
            return createWabaAccount == null ? createWabaAccount2 == null : createWabaAccount.equals(createWabaAccount2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateWabaAccount createWabaAccount = this.createWabaAccount;
                this.$hashCode = (createWabaAccount == null ? 0 : createWabaAccount.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWabaAccountMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateWabaAccount createWabaAccount = Data.this.createWabaAccount;
                    responseWriter.writeObject(responseField, createWabaAccount != null ? createWabaAccount.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createWabaAccount=" + this.createWabaAccount + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class RestrictionInfo {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWabaAccountMutation.RestrictionInfo.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = RestrictionInfo.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        private final ModelWabaAccountConditionInput condition;
        private final CreateWabaAccountInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateWabaAccountInput createWabaAccountInput, ModelWabaAccountConditionInput modelWabaAccountConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createWabaAccountInput;
            this.condition = modelWabaAccountConditionInput;
            linkedHashMap.put("input", createWabaAccountInput);
            linkedHashMap.put("condition", modelWabaAccountConditionInput);
        }

        public ModelWabaAccountConditionInput condition() {
            return this.condition;
        }

        public CreateWabaAccountInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWabaAccountMutation.Variables.1
    ...
    public static class WabaPhoneNumbers {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWabaAccountMutation.WabaPhoneNumbers.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = WabaPhoneNumbers.$responseFields;
    ...
    public CreateWabaAccountMutation(CreateWabaAccountInput createWabaAccountInput, ModelWabaAccountConditionInput modelWabaAccountConditionInput) {
        Utils.checkNotNull(createWabaAccountInput, "input == null");
        this.variables = new Variables(createWabaAccountInput, modelWabaAccountConditionInput);
    }
    ...
    public String operationId() {
        return "8e5baabb8f65b52bee04bfc82d0d9ffdd1f487609bd89f489cefb0012c27e30f";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateWabaAccount($input: CreateWabaAccountInput!, $condition: ModelWabaAccountConditionInput) {\n  createWabaAccount(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    wabaAccountName\n    accessToken\n    accountId\n    remainingFreeTierConversationsOverall\n    remainingBalanceOverall\n    remainingBalanceBroadcast\n    blockedBalanceOverall\n    blockedBalanceBroadcast\n    promptForPaymentThreshold\n    createdAt\n    updatedAt\n    currentLimitCategory\n    maxDailyConversationPerPhone\n    maxPhoneNumbersPerBusiness\n    maxPhoneNumbersPerWaba\n    restrictionInfo {\n      __typename\n      restrictionType\n      restrictionExpiry\n    }\n    wabaBanState\n    wabaBanDate\n    wabaDecision\n    wabaDecisionTime\n    rejectionReason\n    createdById\n    updatedById\n    wabaPhoneNumbers {\n      __typename\n      nextToken\n    }\n  }\n}";
    }
