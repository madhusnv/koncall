...
public final class GetFilesByFileIdQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetFilesByFileId($fileId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelfileObjectRelationshipFilterInput, $limit: Int, $nextToken: String) {\n  getFilesByFileId(fileId: $fileId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      fileId\n      fileUrl\n      contactId\n      engagementId\n      businessId\n      dealId\n      productId\n      createdAt\n      updatedAt\n      parentObjectId\n      parentObjectType\n      fieldName\n      inputContext\n      transcription\n      translatedTranscription\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByFileIdQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetFilesByFileId";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetFilesByFileId($fileId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelfileObjectRelationshipFilterInput, $limit: Int, $nextToken: String) {\n  getFilesByFileId(fileId: $fileId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      fileId\n      fileUrl\n      contactId\n      engagementId\n      businessId\n      dealId\n      productId\n      createdAt\n      updatedAt\n      parentObjectId\n      parentObjectType\n      fieldName\n      inputContext\n      transcription\n      translatedTranscription\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetFilesByFileIdQuery build() {
            return new GetFilesByFileIdQuery(this.fileId, this.updatedAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getFilesByFileId", "getFilesByFileId", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("fileId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "fileId").build()).put("updatedAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "updatedAt").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetFilesByFileId getFilesByFileId;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetFilesByFileId.Mapper getFilesByFileIdFieldMapper = new GetFilesByFileId.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetFilesByFileId) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetFilesByFileId>() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByFileIdQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetFilesByFileId read(ResponseReader responseReader2) {
                        return Mapper.this.getFilesByFileIdFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetFilesByFileId getFilesByFileId) {
            this.getFilesByFileId = getFilesByFileId;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetFilesByFileId getFilesByFileId = this.getFilesByFileId;
            GetFilesByFileId getFilesByFileId2 = ((Data) obj).getFilesByFileId;
            return getFilesByFileId == null ? getFilesByFileId2 == null : getFilesByFileId.equals(getFilesByFileId2);
        }

        public GetFilesByFileId getFilesByFileId() {
            return this.getFilesByFileId;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetFilesByFileId getFilesByFileId = this.getFilesByFileId;
                this.$hashCode = (getFilesByFileId == null ? 0 : getFilesByFileId.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByFileIdQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetFilesByFileId getFilesByFileId = Data.this.getFilesByFileId;
                    responseWriter.writeObject(responseField, getFilesByFileId != null ? getFilesByFileId.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getFilesByFileId=" + this.getFilesByFileId + "}";
            }
            return this.$toString;
        }
    }

    public static class GetFilesByFileId {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetFilesByFileId> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetFilesByFileId map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetFilesByFileId.$responseFields;
                return new GetFilesByFileId(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByFileIdQuery.GetFilesByFileId.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByFileIdQuery.GetFilesByFileId.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetFilesByFileId(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetFilesByFileId)) {
                return false;
            }
            GetFilesByFileId getFilesByFileId = (GetFilesByFileId) obj;
            if (this.__typename.equals(getFilesByFileId.__typename) && this.items.equals(getFilesByFileId.items)) {
                String str = this.nextToken;
                String str2 = getFilesByFileId.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByFileIdQuery.GetFilesByFileId.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetFilesByFileId.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetFilesByFileId.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetFilesByFileId.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByFileIdQuery.GetFilesByFileId.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetFilesByFileId.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetFilesByFileId{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByFileIdQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByFileIdQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("fileId", Variables.this.fileId);
    ...
    public GetFilesByFileIdQuery(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelfileObjectRelationshipFilterInput modelfileObjectRelationshipFilterInput, Integer num, String str2) {
    ...
    public String operationId() {
        return "6969c61c6b37c6d16a2a712927ff7238859c6b345720064c1d6be655fca3d948";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetFilesByFileId($fileId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelfileObjectRelationshipFilterInput, $limit: Int, $nextToken: String) {\n  getFilesByFileId(fileId: $fileId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      fileId\n      fileUrl\n      contactId\n      engagementId\n      businessId\n      dealId\n      productId\n      createdAt\n      updatedAt\n      parentObjectId\n      parentObjectType\n      fieldName\n      inputContext\n      transcription\n      translatedTranscription\n    }\n    nextToken\n  }\n}";
    }
