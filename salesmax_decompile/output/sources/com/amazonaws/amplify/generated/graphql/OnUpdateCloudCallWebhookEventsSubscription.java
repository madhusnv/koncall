...
public final class OnUpdateCloudCallWebhookEventsSubscription implements Subscription<Data, Data, Operation.Variables> {
    ...
    public static class Contact {
        ...
        public static final class Mapper implements ResponseFieldMapper<Contact> {
            ...
            public Contact map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[5], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.Contact.Mapper.1
                ...
                List list2 = responseReader.readList(responseFieldArr[7], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.Contact.Mapper.2
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                ...
                List list3 = responseReader.readList(responseFieldArr[34], new ResponseReader.ListReader<Day>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.Contact.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                ...
                List list4 = responseReader.readList(responseFieldArr[92], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.Contact.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                });
                List list5 = responseReader.readList(responseFieldArr[93], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.Contact.Mapper.5
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                ...
                List list6 = responseReader.readList(responseFieldArr[97], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.Contact.Mapper.6
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.Contact.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], Contact.this.sharedOwners, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.Contact.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[7], Contact.this.sharedTeams, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.Contact.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[34], Contact.this.preferredContactDays, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.Contact.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[92], Contact.this.userDefinedTags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.Contact.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[93], Contact.this.productService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.Contact.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[97], Contact.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.Contact.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("onUpdateCloudCallWebhookEvents", "onUpdateCloudCallWebhookEvents", null, true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnUpdateCloudCallWebhookEvents onUpdateCloudCallWebhookEvents;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final OnUpdateCloudCallWebhookEvents.Mapper onUpdateCloudCallWebhookEventsFieldMapper = new OnUpdateCloudCallWebhookEvents.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((OnUpdateCloudCallWebhookEvents) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<OnUpdateCloudCallWebhookEvents>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public OnUpdateCloudCallWebhookEvents read(ResponseReader responseReader2) {
                        return Mapper.this.onUpdateCloudCallWebhookEventsFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(OnUpdateCloudCallWebhookEvents onUpdateCloudCallWebhookEvents) {
            this.onUpdateCloudCallWebhookEvents = onUpdateCloudCallWebhookEvents;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnUpdateCloudCallWebhookEvents onUpdateCloudCallWebhookEvents = this.onUpdateCloudCallWebhookEvents;
            OnUpdateCloudCallWebhookEvents onUpdateCloudCallWebhookEvents2 = ((Data) obj).onUpdateCloudCallWebhookEvents;
            return onUpdateCloudCallWebhookEvents == null ? onUpdateCloudCallWebhookEvents2 == null : onUpdateCloudCallWebhookEvents.equals(onUpdateCloudCallWebhookEvents2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnUpdateCloudCallWebhookEvents onUpdateCloudCallWebhookEvents = this.onUpdateCloudCallWebhookEvents;
                this.$hashCode = (onUpdateCloudCallWebhookEvents == null ? 0 : onUpdateCloudCallWebhookEvents.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    OnUpdateCloudCallWebhookEvents onUpdateCloudCallWebhookEvents = Data.this.onUpdateCloudCallWebhookEvents;
                    responseWriter.writeObject(responseField, onUpdateCloudCallWebhookEvents != null ? onUpdateCloudCallWebhookEvents.marshaller() : null);
                }
            };
        }

        public OnUpdateCloudCallWebhookEvents onUpdateCloudCallWebhookEvents() {
            return this.onUpdateCloudCallWebhookEvents;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onUpdateCloudCallWebhookEvents=" + this.onUpdateCloudCallWebhookEvents + "}";
            }
            return this.$toString;
        }
    }

    public static class OnUpdateCloudCallWebhookEvents {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public OnUpdateCloudCallWebhookEvents(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, String str19, Integer num, Integer num2, String str20, String str21, String str22, Long l, String str23, String str24, Contact contact) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = str3;
            this.contactId = str4;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnUpdateCloudCallWebhookEvents)) {
                return false;
            }
            OnUpdateCloudCallWebhookEvents onUpdateCloudCallWebhookEvents = (OnUpdateCloudCallWebhookEvents) obj;
            if (this.__typename.equals(onUpdateCloudCallWebhookEvents.__typename) && this.id.equals(onUpdateCloudCallWebhookEvents.id) && ((str = this.accountId) != null ? str.equals(onUpdateCloudCallWebhookEvents.accountId) : onUpdateCloudCallWebhookEvents.accountId == null) && ((str2 = this.contactId) != null ? str2.equals(onUpdateCloudCallWebhookEvents.contactId) : onUpdateCloudCallWebhookEvents.contactId == null) && ((str3 = this.callSessionId) != null ? str3.equals(onUpdateCloudCallWebhookEvents.callSessionId) : onUpdateCloudCallWebhookEvents.callSessionId == null) && ((str4 = this.callId) != null ? str4.equals(onUpdateCloudCallWebhookEvents.callId) : onUpdateCloudCallWebhookEvents.callId == null) && ((str5 = this.customIdentifier) != null ? str5.equals(onUpdateCloudCallWebhookEvents.customIdentifier) : onUpdateCloudCallWebhookEvents.customIdentifier == null) && ((str6 = this.providerName) != null ? str6.equals(onUpdateCloudCallWebhookEvents.providerName) : onUpdateCloudCallWebhookEvents.providerName == null) && ((str7 = this.connectionId) != null ? str7.equals(onUpdateCloudCallWebhookEvents.connectionId) : onUpdateCloudCallWebhookEvents.connectionId == null) && ((str8 = this.rawPayload) != null ? str8.equals(onUpdateCloudCallWebhookEvents.rawPayload) : onUpdateCloudCallWebhookEvents.rawPayload == null) && ((str9 = this.eventType) != null ? str9.equals(onUpdateCloudCallWebhookEvents.eventType) : onUpdateCloudCallWebhookEvents.eventType == null) && ((str10 = this.sourceNumber) != null ? str10.equals(onUpdateCloudCallWebhookEvents.sourceNumber) : onUpdateCloudCallWebhookEvents.sourceNumber == null) && ((str11 = this.callerSource) != null ? str11.equals(onUpdateCloudCallWebhookEvents.callerSource) : onUpdateCloudCallWebhookEvents.callerSource == null) && ((str12 = this.destinationNumber) != null ? str12.equals(onUpdateCloudCallWebhookEvents.destinationNumber) : onUpdateCloudCallWebhookEvents.destinationNumber == null) && ((str13 = this.displayNumber) != null ? str13.equals(onUpdateCloudCallWebhookEvents.displayNumber) : onUpdateCloudCallWebhookEvents.displayNumber == null) && ((str14 = this.agentNumber) != null ? str14.equals(onUpdateCloudCallWebhookEvents.agentNumber) : onUpdateCloudCallWebhookEvents.agentNumber == null) && ((str15 = this.customerNumber) != null ? str15.equals(onUpdateCloudCallWebhookEvents.customerNumber) : onUpdateCloudCallWebhookEvents.customerNumber == null) && ((str16 = this.callStartTime) != null ? str16.equals(onUpdateCloudCallWebhookEvents.callStartTime) : onUpdateCloudCallWebhookEvents.callStartTime == null) && ((str17 = this.callEndTime) != null ? str17.equals(onUpdateCloudCallWebhookEvents.callEndTime) : onUpdateCloudCallWebhookEvents.callEndTime == null) && ((num = this.callDuration) != null ? num.equals(onUpdateCloudCallWebhookEvents.callDuration) : onUpdateCloudCallWebhookEvents.callDuration == null) && ((num2 = this.actualCallDuration) != null ? num2.equals(onUpdateCloudCallWebhookEvents.actualCallDuration) : onUpdateCloudCallWebhookEvents.actualCallDuration == null) && ((str18 = this.resourceURL) != null ? str18.equals(onUpdateCloudCallWebhookEvents.resourceURL) : onUpdateCloudCallWebhookEvents.resourceURL == null) && ((str19 = this.callDirection) != null ? str19.equals(onUpdateCloudCallWebhookEvents.callDirection) : onUpdateCloudCallWebhookEvents.callDirection == null) && ((str20 = this.status) != null ? str20.equals(onUpdateCloudCallWebhookEvents.status) : onUpdateCloudCallWebhookEvents.status == null) && ((l = this.expirationUnixTime) != null ? l.equals(onUpdateCloudCallWebhookEvents.expirationUnixTime) : onUpdateCloudCallWebhookEvents.expirationUnixTime == null) && ((str21 = this.createdAt) != null ? str21.equals(onUpdateCloudCallWebhookEvents.createdAt) : onUpdateCloudCallWebhookEvents.createdAt == null) && ((str22 = this.updatedAt) != null ? str22.equals(onUpdateCloudCallWebhookEvents.updatedAt) : onUpdateCloudCallWebhookEvents.updatedAt == null)) {
                Contact contact = this.contact;
                Contact contact2 = onUpdateCloudCallWebhookEvents.contact;
                if (contact == null) {
                    if (contact2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCloudCallWebhookEventsSubscription.OnUpdateCloudCallWebhookEvents.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = OnUpdateCloudCallWebhookEvents.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], OnUpdateCloudCallWebhookEvents.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], OnUpdateCloudCallWebhookEvents.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], OnUpdateCloudCallWebhookEvents.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], OnUpdateCloudCallWebhookEvents.this.contactId);
                    responseWriter.writeString(responseFieldArr[4], OnUpdateCloudCallWebhookEvents.this.callSessionId);
                    responseWriter.writeString(responseFieldArr[5], OnUpdateCloudCallWebhookEvents.this.callId);
                    responseWriter.writeString(responseFieldArr[6], OnUpdateCloudCallWebhookEvents.this.customIdentifier);
                    responseWriter.writeString(responseFieldArr[7], OnUpdateCloudCallWebhookEvents.this.providerName);
                    responseWriter.writeString(responseFieldArr[8], OnUpdateCloudCallWebhookEvents.this.connectionId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], OnUpdateCloudCallWebhookEvents.this.rawPayload);
                    responseWriter.writeString(responseFieldArr[10], OnUpdateCloudCallWebhookEvents.this.eventType);
                    responseWriter.writeString(responseFieldArr[11], OnUpdateCloudCallWebhookEvents.this.sourceNumber);
                    responseWriter.writeString(responseFieldArr[12], OnUpdateCloudCallWebhookEvents.this.callerSource);
                    responseWriter.writeString(responseFieldArr[13], OnUpdateCloudCallWebhookEvents.this.destinationNumber);
                    responseWriter.writeString(responseFieldArr[14], OnUpdateCloudCallWebhookEvents.this.displayNumber);
                    responseWriter.writeString(responseFieldArr[15], OnUpdateCloudCallWebhookEvents.this.agentNumber);
                    responseWriter.writeString(responseFieldArr[16], OnUpdateCloudCallWebhookEvents.this.customerNumber);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], OnUpdateCloudCallWebhookEvents.this.callStartTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], OnUpdateCloudCallWebhookEvents.this.callEndTime);
                    responseWriter.writeInt(responseFieldArr[19], OnUpdateCloudCallWebhookEvents.this.callDuration);
                    responseWriter.writeInt(responseFieldArr[20], OnUpdateCloudCallWebhookEvents.this.actualCallDuration);
                    responseWriter.writeString(responseFieldArr[21], OnUpdateCloudCallWebhookEvents.this.resourceURL);
                    responseWriter.writeString(responseFieldArr[22], OnUpdateCloudCallWebhookEvents.this.callDirection);
                    responseWriter.writeString(responseFieldArr[23], OnUpdateCloudCallWebhookEvents.this.status);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[24], OnUpdateCloudCallWebhookEvents.this.expirationUnixTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], OnUpdateCloudCallWebhookEvents.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[26], OnUpdateCloudCallWebhookEvents.this.updatedAt);
                    ResponseField responseField = responseFieldArr[27];
                    Contact contact = OnUpdateCloudCallWebhookEvents.this.contact;
    ...
    public String operationId() {
        return "312c08f80b80430db9aa8df707b860a37a1d749ccd94b4d3d5515c1e885a1cbb";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "subscription OnUpdateCloudCallWebhookEvents {\n  onUpdateCloudCallWebhookEvents {\n    __typename\n    id\n    accountId\n    contactId\n    callSessionId\n    callId\n    customIdentifier\n    providerName\n    connectionId\n    rawPayload\n    eventType\n    sourceNumber\n    callerSource\n    destinationNumber\n    displayNumber\n    agentNumber\n    customerNumber\n    callStartTime\n    callEndTime\n    callDuration\n    actualCallDuration\n    resourceURL\n    callDirection\n    status\n    expirationUnixTime\n    createdAt\n    updatedAt\n    contact {\n      __typename\n      id\n      accountId\n      ownerId\n      toBeAssigned\n      sharedOwners\n      primaryTeamId\n      sharedTeams\n      accountPriority\n      addedById\n      assignedToId\n      blockedForCallById\n      blockedForCallReason\n      blockedForCallUntil\n      callPriority\n      waChatChannelId\n      contactSource\n      contactSourceDrillDownOne\n      contactSourceDrillDownTwo\n      contactSourceDrillDownThree\n      contactSourceDrillDownOneId\n      contactSourceDrillDownTwoId\n      contactSourceDrillDownThreeId\n      contactStatus\n      contactType\n      department\n      designation\n      lastRepeatEnquiryDate\n      lastRepeatEnquirySource\n      gender\n      isDecisionMaker\n      isPrivate\n      lockPeriod\n      name\n      preferredContactDays\n      profilePhotoUrl\n      referredBy\n      salutation\n      seniority\n      updatedById\n      hasTask\n      openTaskActivityType\n      lastCalledTime\n      lastCallDirection\n      lastCallOutcome\n      lastCallOutcomeNature\n      lastCallUserId\n      lastCallDuration\n      lastCallEngagementId\n      lastVisitTime\n      lastVisitOutcome\n      lastVisitOutcomeNature\n      lastVisitUserId\n      lastVisitEngagementId\n      lastEmailTime\n      lastEmailUserId\n      lastEmailEngagementId\n      lastWhatsappTime\n      lastWhatsappUserId\n      lastWhatsappEngagementId\n      lastWabaBroadcastTime\n      lastWabaBroadcastStatus\n      lastWabaBroadcastTemplate\n      lastWabaBroadcastReplyBody\n      lastWabaBroadcastReplyTime\n      lastWabaBroadcastReplyType\n      lastSmsTime\n      lastSmsUserId\n      lastSmsEngagementId\n      lastNoteAddedTime\n      lastNoteUserId\n      lastNoteEngagementId\n      lastTaskDoneTime\n      lastTaskDoneUserId\n      lastTaskDoneEngagementId\n      openTaskCount\n      lastKnownDisposition\n      lastKnownDispositionTime\n      lastLeadAssignmentDateTime\n      lastEngagementFromAccount\n      lastEngagementFromContact\n      freshLeadTag\n      noWorkAfterAssignment\n      needFollowUpTag\n      needFollowUpTagUpdatedAt\n      activeDealStage\n      activeDealStageUpdatedAt\n      dealDescription\n      isCustomer\n      becameCustomerOn\n      unsuccessfulCallAttempts\n      leadCallsNotAnswered\n      userDefinedTags\n      productService\n      bulkUploadReference\n      assignmentMethod\n      whatsappOptInStatus\n      recentEngagements\n      recentEngagementsUpdatedAt\n      openTaskDetail\n      openVideoCallDetail\n      lastClosedTaskDetail\n      lastClosedTaskDetailUpdatedAt\n      latestRemark\n      customAttributes\n      paymentRequestDetail\n      lastPaymentStatus\n      customDataAddedFromAddContactForm\n      leadLifecycleStage\n      leadLifecycleStageSubCategory\n      manualClosedReason\n      lastDealStageType\n      prospectingAttempts\n      totalProspectingAttemptsAcrossRechurn\n      numberOfTimesRechurned\n      lastProspectingDoneOn\n      firstProspectingDoneOn\n      nextProspectingDueOn\n      nextProspectingSetBy\n      nextProspectingNote\n      movedToOpportunityOn\n      movedToClosedOn\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
