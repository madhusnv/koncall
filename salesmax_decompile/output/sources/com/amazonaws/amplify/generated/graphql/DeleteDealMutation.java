...
import type.DeleteDealInput;
import type.ModelDealConditionInput;

/* loaded from: classes6.dex */
public final class DeleteDealMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation DeleteDeal($input: DeleteDealInput!, $condition: ModelDealConditionInput) {\n  deleteDeal(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    name\n    description\n    dealStage\n    dealStageUpdatedAt\n    dealState\n    dealOutcome\n    dealLostReason\n    amount\n    currency\n    units {\n      __typename\n      productId\n      units\n      negotiatedPricePerUnit\n    }\n    createdByUser\n    lastUpdatedByUser\n    ownerId\n    primaryTeamId\n    openTaskDetail\n    transitionSummary\n    recentEngagements\n    recentEngagementsUpdatedAt\n    lastActivity\n    tags\n    dealStageCustomValues {\n      __typename\n      dealStage\n      customValue\n    }\n    customDealData\n    createdAt\n    updatedAt\n    associations {\n      __typename\n      nextToken\n    }\n    transitions {\n      __typename\n      nextToken\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "DeleteDeal";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation DeleteDeal($input: DeleteDealInput!, $condition: ModelDealConditionInput) {\n  deleteDeal(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    name\n    description\n    dealStage\n    dealStageUpdatedAt\n    dealState\n    dealOutcome\n    dealLostReason\n    amount\n    currency\n    units {\n      __typename\n      productId\n      units\n      negotiatedPricePerUnit\n    }\n    createdByUser\n    lastUpdatedByUser\n    ownerId\n    primaryTeamId\n    openTaskDetail\n    transitionSummary\n    recentEngagements\n    recentEngagementsUpdatedAt\n    lastActivity\n    tags\n    dealStageCustomValues {\n      __typename\n      dealStage\n      customValue\n    }\n    customDealData\n    createdAt\n    updatedAt\n    associations {\n      __typename\n      nextToken\n    }\n    transitions {\n      __typename\n      nextToken\n    }\n  }\n}";
    ...
    public static class Associations {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.Associations.1
    ...
    public static final class Builder {
        ...
        private DeleteDealInput input;

        public DeleteDealMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteDealMutation(this.input, this.condition);
        }
        ...
        public Builder input(DeleteDealInput deleteDealInput) {
            this.input = deleteDealInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteDeal", "deleteDeal", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteDeal.Mapper deleteDealFieldMapper = new DeleteDeal.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteDeal) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteDeal>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteDeal read(ResponseReader responseReader2) {
                        return Mapper.this.deleteDealFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteDeal deleteDeal) {
            this.deleteDeal = deleteDeal;
        }

        public DeleteDeal deleteDeal() {
        ...
        public boolean equals(Object obj) {
            ...
            DeleteDeal deleteDeal = this.deleteDeal;
            DeleteDeal deleteDeal2 = ((Data) obj).deleteDeal;
            return deleteDeal == null ? deleteDeal2 == null : deleteDeal.equals(deleteDeal2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteDeal deleteDeal = this.deleteDeal;
                this.$hashCode = (deleteDeal == null ? 0 : deleteDeal.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteDeal deleteDeal = Data.this.deleteDeal;
                    responseWriter.writeObject(responseField, deleteDeal != null ? deleteDeal.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteDeal=" + this.deleteDeal + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class DealStageCustomValue {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.DealStageCustomValue.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DealStageCustomValue.$responseFields;
    ...
    public static class DeleteDeal {
        ...
        public static final class Mapper implements ResponseFieldMapper<DeleteDeal> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public DeleteDeal map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = DeleteDeal.$responseFields;
                ...
                }), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[13]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[14]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[15]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[16]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[17]), responseReader.readList(responseFieldArr[18], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.DeleteDeal.Mapper.2
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.AWSJSON);
                    }
                }), responseReader.readList(responseFieldArr[19], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.DeleteDeal.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.AWSJSON);
                    }
                }), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[20]), responseReader.readString(responseFieldArr[21]), responseReader.readList(responseFieldArr[22], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.DeleteDeal.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                }), responseReader.readList(responseFieldArr[23], new ResponseReader.ListReader<DealStageCustomValue>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.DeleteDeal.Mapper.5
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public DealStageCustomValue read(ResponseReader.ListItemReader listItemReader) {
                        return (DealStageCustomValue) listItemReader.readObject(new ResponseReader.ObjectReader<DealStageCustomValue>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.DeleteDeal.Mapper.5.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public DeleteDeal(String str, String str2, String str3, String str4, String str5, String str6, String str7, DealState dealState, DealOutcome dealOutcome, String str8, Double d, String str9, List<Unit> list, String str10, String str11, String str12, String str13, String str14, List<String> list2, List<String> list3, String str15, String str16, List<String> list4, List<DealStageCustomValue> list5, String str17, String str18, String str19, Associations associations, Transitions transitions) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteDeal)) {
                return false;
            }
            DeleteDeal deleteDeal = (DeleteDeal) obj;
            if (this.__typename.equals(deleteDeal.__typename) && this.id.equals(deleteDeal.id) && this.accountId.equals(deleteDeal.accountId) && ((str = this.name) != null ? str.equals(deleteDeal.name) : deleteDeal.name == null) && ((str2 = this.description) != null ? str2.equals(deleteDeal.description) : deleteDeal.description == null) && ((str3 = this.dealStage) != null ? str3.equals(deleteDeal.dealStage) : deleteDeal.dealStage == null) && ((str4 = this.dealStageUpdatedAt) != null ? str4.equals(deleteDeal.dealStageUpdatedAt) : deleteDeal.dealStageUpdatedAt == null) && ((dealState = this.dealState) != null ? dealState.equals(deleteDeal.dealState) : deleteDeal.dealState == null) && ((dealOutcome = this.dealOutcome) != null ? dealOutcome.equals(deleteDeal.dealOutcome) : deleteDeal.dealOutcome == null) && ((str5 = this.dealLostReason) != null ? str5.equals(deleteDeal.dealLostReason) : deleteDeal.dealLostReason == null) && ((d = this.amount) != null ? d.equals(deleteDeal.amount) : deleteDeal.amount == null) && ((str6 = this.currency) != null ? str6.equals(deleteDeal.currency) : deleteDeal.currency == null) && ((list = this.units) != null ? list.equals(deleteDeal.units) : deleteDeal.units == null) && ((str7 = this.createdByUser) != null ? str7.equals(deleteDeal.createdByUser) : deleteDeal.createdByUser == null) && ((str8 = this.lastUpdatedByUser) != null ? str8.equals(deleteDeal.lastUpdatedByUser) : deleteDeal.lastUpdatedByUser == null) && ((str9 = this.ownerId) != null ? str9.equals(deleteDeal.ownerId) : deleteDeal.ownerId == null) && ((str10 = this.primaryTeamId) != null ? str10.equals(deleteDeal.primaryTeamId) : deleteDeal.primaryTeamId == null) && ((str11 = this.openTaskDetail) != null ? str11.equals(deleteDeal.openTaskDetail) : deleteDeal.openTaskDetail == null) && ((list2 = this.transitionSummary) != null ? list2.equals(deleteDeal.transitionSummary) : deleteDeal.transitionSummary == null) && ((list3 = this.recentEngagements) != null ? list3.equals(deleteDeal.recentEngagements) : deleteDeal.recentEngagements == null) && ((str12 = this.recentEngagementsUpdatedAt) != null ? str12.equals(deleteDeal.recentEngagementsUpdatedAt) : deleteDeal.recentEngagementsUpdatedAt == null) && ((str13 = this.lastActivity) != null ? str13.equals(deleteDeal.lastActivity) : deleteDeal.lastActivity == null) && ((list4 = this.tags) != null ? list4.equals(deleteDeal.tags) : deleteDeal.tags == null) && ((list5 = this.dealStageCustomValues) != null ? list5.equals(deleteDeal.dealStageCustomValues) : deleteDeal.dealStageCustomValues == null) && ((str14 = this.customDealData) != null ? str14.equals(deleteDeal.customDealData) : deleteDeal.customDealData == null) && ((str15 = this.createdAt) != null ? str15.equals(deleteDeal.createdAt) : deleteDeal.createdAt == null) && ((str16 = this.updatedAt) != null ? str16.equals(deleteDeal.updatedAt) : deleteDeal.updatedAt == null) && ((associations = this.associations) != null ? associations.equals(deleteDeal.associations) : deleteDeal.associations == null)) {
                Transitions transitions = this.transitions;
                Transitions transitions2 = deleteDeal.transitions;
                if (transitions == null) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.DeleteDeal.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteDeal.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteDeal.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteDeal.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteDeal.this.accountId);
                    responseWriter.writeString(responseFieldArr[3], DeleteDeal.this.name);
                    responseWriter.writeString(responseFieldArr[4], DeleteDeal.this.description);
                    responseWriter.writeString(responseFieldArr[5], DeleteDeal.this.dealStage);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], DeleteDeal.this.dealStageUpdatedAt);
                    ResponseField responseField = responseFieldArr[7];
                    DealState dealState = DeleteDeal.this.dealState;
                    ...
                    DealOutcome dealOutcome = DeleteDeal.this.dealOutcome;
                    responseWriter.writeString(responseField2, dealOutcome != null ? dealOutcome.name() : null);
                    responseWriter.writeString(responseFieldArr[9], DeleteDeal.this.dealLostReason);
                    responseWriter.writeDouble(responseFieldArr[10], DeleteDeal.this.amount);
                    responseWriter.writeString(responseFieldArr[11], DeleteDeal.this.currency);
                    responseWriter.writeList(responseFieldArr[12], DeleteDeal.this.units, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.DeleteDeal.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Unit) obj).marshaller());
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], DeleteDeal.this.createdByUser);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], DeleteDeal.this.lastUpdatedByUser);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], DeleteDeal.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], DeleteDeal.this.primaryTeamId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], DeleteDeal.this.openTaskDetail);
                    responseWriter.writeList(responseFieldArr[18], DeleteDeal.this.transitionSummary, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.DeleteDeal.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[19], DeleteDeal.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.DeleteDeal.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], DeleteDeal.this.recentEngagementsUpdatedAt);
                    responseWriter.writeString(responseFieldArr[21], DeleteDeal.this.lastActivity);
                    responseWriter.writeList(responseFieldArr[22], DeleteDeal.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.DeleteDeal.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[23], DeleteDeal.this.dealStageCustomValues, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.DeleteDeal.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((DealStageCustomValue) obj).marshaller());
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[24], DeleteDeal.this.customDealData);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], DeleteDeal.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[26], DeleteDeal.this.updatedAt);
                    ResponseField responseField3 = responseFieldArr[27];
                    Associations associations = DeleteDeal.this.associations;
                    ...
                    Transitions transitions = DeleteDeal.this.transitions;
    ...
    public static class Transitions {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.Transitions.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Transitions.$responseFields;
    ...
    public static class Unit {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.Unit.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Unit.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final DeleteDealInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteDealInput deleteDealInput, ModelDealConditionInput modelDealConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteDealInput;
            this.condition = modelDealConditionInput;
            linkedHashMap.put("input", deleteDealInput);
        ...
        public DeleteDealInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteDealMutation.Variables.1
    ...
    public DeleteDealMutation(DeleteDealInput deleteDealInput, ModelDealConditionInput modelDealConditionInput) {
        Utils.checkNotNull(deleteDealInput, "input == null");
        this.variables = new Variables(deleteDealInput, modelDealConditionInput);
    }
    ...
    public String operationId() {
        return "709bafa1f96e3baa0d0ea40c1d022ef7e1993c02b6151a43a6afd29c6fe26c8c";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteDeal($input: DeleteDealInput!, $condition: ModelDealConditionInput) {\n  deleteDeal(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    name\n    description\n    dealStage\n    dealStageUpdatedAt\n    dealState\n    dealOutcome\n    dealLostReason\n    amount\n    currency\n    units {\n      __typename\n      productId\n      units\n      negotiatedPricePerUnit\n    }\n    createdByUser\n    lastUpdatedByUser\n    ownerId\n    primaryTeamId\n    openTaskDetail\n    transitionSummary\n    recentEngagements\n    recentEngagementsUpdatedAt\n    lastActivity\n    tags\n    dealStageCustomValues {\n      __typename\n      dealStage\n      customValue\n    }\n    customDealData\n    createdAt\n    updatedAt\n    associations {\n      __typename\n      nextToken\n    }\n    transitions {\n      __typename\n      nextToken\n    }\n  }\n}";
    }
