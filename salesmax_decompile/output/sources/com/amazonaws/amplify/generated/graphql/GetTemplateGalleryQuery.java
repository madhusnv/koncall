...
public final class GetTemplateGalleryQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetTemplateGallery($id: ID!) {\n  getTemplateGallery(id: $id) {\n    __typename\n    id\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    categoryLevelOne\n    categoryLevelTwo\n    applicableForIndustry\n    viewedTimes\n    savedToWorkspaceTimes\n    sentToWhatsappTimes\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetTemplateGallery";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetTemplateGallery($id: ID!) {\n  getTemplateGallery(id: $id) {\n    __typename\n    id\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    categoryLevelOne\n    categoryLevelTwo\n    applicableForIndustry\n    viewedTimes\n    savedToWorkspaceTimes\n    sentToWhatsappTimes\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private String id;

        public GetTemplateGalleryQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetTemplateGalleryQuery(this.id);
        }
    ...
    public static class Component {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.Component.1
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getTemplateGallery", "getTemplateGallery", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetTemplateGallery getTemplateGallery;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetTemplateGallery.Mapper getTemplateGalleryFieldMapper = new GetTemplateGallery.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetTemplateGallery) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetTemplateGallery>() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetTemplateGallery read(ResponseReader responseReader2) {
                        return Mapper.this.getTemplateGalleryFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetTemplateGallery getTemplateGallery) {
            this.getTemplateGallery = getTemplateGallery;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetTemplateGallery getTemplateGallery = this.getTemplateGallery;
            GetTemplateGallery getTemplateGallery2 = ((Data) obj).getTemplateGallery;
            return getTemplateGallery == null ? getTemplateGallery2 == null : getTemplateGallery.equals(getTemplateGallery2);
        }

        public GetTemplateGallery getTemplateGallery() {
            return this.getTemplateGallery;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetTemplateGallery getTemplateGallery = this.getTemplateGallery;
                this.$hashCode = (getTemplateGallery == null ? 0 : getTemplateGallery.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetTemplateGallery getTemplateGallery = Data.this.getTemplateGallery;
                    responseWriter.writeObject(responseField, getTemplateGallery != null ? getTemplateGallery.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getTemplateGallery=" + this.getTemplateGallery + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class DefaultMedia {
        ...
        public static final class Mapper implements ResponseFieldMapper<DefaultMedia> {
            ...
            public DefaultMedia map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[9], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.DefaultMedia.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.DefaultMedia.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultMedia.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[9], DefaultMedia.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.DefaultMedia.1.1
    ...
    public static class DefaultVariableMap {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.DefaultVariableMap.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultVariableMap.$responseFields;
    ...
    public static class GetTemplateGallery {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<GetTemplateGallery> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetTemplateGallery map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetTemplateGallery.$responseFields;
                return new GetTemplateGallery(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), responseReader.readString(responseFieldArr[2]), responseReader.readString(responseFieldArr[3]), responseReader.readList(responseFieldArr[4], new ResponseReader.ListReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.GetTemplateGallery.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Component read(ResponseReader.ListItemReader listItemReader) {
                        return (Component) listItemReader.readObject(new ResponseReader.ObjectReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.GetTemplateGallery.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    ...
                    public DefaultVariableMap read(ResponseReader.ListItemReader listItemReader) {
                        return (DefaultVariableMap) listItemReader.readObject(new ResponseReader.ObjectReader<DefaultVariableMap>() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.GetTemplateGallery.Mapper.2.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), responseReader.readString(responseFieldArr[14]), responseReader.readList(responseFieldArr[15], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.GetTemplateGallery.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                }), responseReader.readString(responseFieldArr[16]), responseReader.readString(responseFieldArr[17]), responseReader.readList(responseFieldArr[18], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.GetTemplateGallery.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
        ...
        public GetTemplateGallery(String str, String str2, String str3, String str4, List<Component> list, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, List<DefaultVariableMap> list2, String str13, List<String> list3, String str14, String str15, List<String> list4, Integer num, Integer num2, Integer num3, String str16, String str17, DefaultMedia defaultMedia) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.platform = str3;
            this.name = str4;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetTemplateGallery)) {
                return false;
            }
            GetTemplateGallery getTemplateGallery = (GetTemplateGallery) obj;
            if (this.__typename.equals(getTemplateGallery.__typename) && this.id.equals(getTemplateGallery.id) && ((str = this.platform) != null ? str.equals(getTemplateGallery.platform) : getTemplateGallery.platform == null) && ((str2 = this.name) != null ? str2.equals(getTemplateGallery.name) : getTemplateGallery.name == null) && ((list = this.components) != null ? list.equals(getTemplateGallery.components) : getTemplateGallery.components == null) && ((str3 = this.language) != null ? str3.equals(getTemplateGallery.language) : getTemplateGallery.language == null) && ((str4 = this.status) != null ? str4.equals(getTemplateGallery.status) : getTemplateGallery.status == null) && ((str5 = this.category) != null ? str5.equals(getTemplateGallery.category) : getTemplateGallery.category == null) && ((str6 = this.createdBy) != null ? str6.equals(getTemplateGallery.createdBy) : getTemplateGallery.createdBy == null) && ((str7 = this.updatedBy) != null ? str7.equals(getTemplateGallery.updatedBy) : getTemplateGallery.updatedBy == null) && ((str8 = this.archivedStatus) != null ? str8.equals(getTemplateGallery.archivedStatus) : getTemplateGallery.archivedStatus == null) && ((str9 = this.archivedAt) != null ? str9.equals(getTemplateGallery.archivedAt) : getTemplateGallery.archivedAt == null) && ((str10 = this.defaultMediaId) != null ? str10.equals(getTemplateGallery.defaultMediaId) : getTemplateGallery.defaultMediaId == null) && ((list2 = this.defaultVariableMap) != null ? list2.equals(getTemplateGallery.defaultVariableMap) : getTemplateGallery.defaultVariableMap == null) && ((str11 = this.templateId) != null ? str11.equals(getTemplateGallery.templateId) : getTemplateGallery.templateId == null) && ((list3 = this.tags) != null ? list3.equals(getTemplateGallery.tags) : getTemplateGallery.tags == null) && ((str12 = this.categoryLevelOne) != null ? str12.equals(getTemplateGallery.categoryLevelOne) : getTemplateGallery.categoryLevelOne == null) && ((str13 = this.categoryLevelTwo) != null ? str13.equals(getTemplateGallery.categoryLevelTwo) : getTemplateGallery.categoryLevelTwo == null) && ((list4 = this.applicableForIndustry) != null ? list4.equals(getTemplateGallery.applicableForIndustry) : getTemplateGallery.applicableForIndustry == null) && ((num = this.viewedTimes) != null ? num.equals(getTemplateGallery.viewedTimes) : getTemplateGallery.viewedTimes == null) && ((num2 = this.savedToWorkspaceTimes) != null ? num2.equals(getTemplateGallery.savedToWorkspaceTimes) : getTemplateGallery.savedToWorkspaceTimes == null) && ((num3 = this.sentToWhatsappTimes) != null ? num3.equals(getTemplateGallery.sentToWhatsappTimes) : getTemplateGallery.sentToWhatsappTimes == null) && ((str14 = this.createdAt) != null ? str14.equals(getTemplateGallery.createdAt) : getTemplateGallery.createdAt == null) && ((str15 = this.updatedAt) != null ? str15.equals(getTemplateGallery.updatedAt) : getTemplateGallery.updatedAt == null)) {
                DefaultMedia defaultMedia = this.defaultMedia;
                DefaultMedia defaultMedia2 = getTemplateGallery.defaultMedia;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.GetTemplateGallery.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetTemplateGallery.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetTemplateGallery.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetTemplateGallery.this.id);
                    responseWriter.writeString(responseFieldArr[2], GetTemplateGallery.this.platform);
                    responseWriter.writeString(responseFieldArr[3], GetTemplateGallery.this.name);
                    responseWriter.writeList(responseFieldArr[4], GetTemplateGallery.this.components, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.GetTemplateGallery.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Component) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[5], GetTemplateGallery.this.language);
                    responseWriter.writeString(responseFieldArr[6], GetTemplateGallery.this.status);
                    responseWriter.writeString(responseFieldArr[7], GetTemplateGallery.this.category);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], GetTemplateGallery.this.createdBy);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], GetTemplateGallery.this.updatedBy);
                    responseWriter.writeString(responseFieldArr[10], GetTemplateGallery.this.archivedStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], GetTemplateGallery.this.archivedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], GetTemplateGallery.this.defaultMediaId);
                    responseWriter.writeList(responseFieldArr[13], GetTemplateGallery.this.defaultVariableMap, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.GetTemplateGallery.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((DefaultVariableMap) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[14], GetTemplateGallery.this.templateId);
                    responseWriter.writeList(responseFieldArr[15], GetTemplateGallery.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.GetTemplateGallery.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[16], GetTemplateGallery.this.categoryLevelOne);
                    responseWriter.writeString(responseFieldArr[17], GetTemplateGallery.this.categoryLevelTwo);
                    responseWriter.writeList(responseFieldArr[18], GetTemplateGallery.this.applicableForIndustry, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.GetTemplateGallery.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeInt(responseFieldArr[19], GetTemplateGallery.this.viewedTimes);
                    responseWriter.writeInt(responseFieldArr[20], GetTemplateGallery.this.savedToWorkspaceTimes);
                    responseWriter.writeInt(responseFieldArr[21], GetTemplateGallery.this.sentToWhatsappTimes);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], GetTemplateGallery.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], GetTemplateGallery.this.updatedAt);
                    ResponseField responseField = responseFieldArr[24];
                    DefaultMedia defaultMedia = GetTemplateGallery.this.defaultMedia;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetTemplateGalleryQuery.Variables.1
    ...
    public GetTemplateGalleryQuery(String str) {
    ...
    public String operationId() {
        return "6e4004561287ebcd4f145d44bf366425ab2362b2f1b092c9ece88add4bdd3c83";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetTemplateGallery($id: ID!) {\n  getTemplateGallery(id: $id) {\n    __typename\n    id\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    categoryLevelOne\n    categoryLevelTwo\n    applicableForIndustry\n    viewedTimes\n    savedToWorkspaceTimes\n    sentToWhatsappTimes\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
