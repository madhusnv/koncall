...
public final class GetMentionUserMembershipQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetMentionUserMembership($id: ID!) {\n  getMentionUserMembership(id: $id) {\n    __typename\n    id\n    accountId\n    commentId\n    mentionedUserId\n    isAnnouncement\n    commentedById\n    createdAt\n    updatedAt\n    comment {\n      __typename\n      id\n      accountId\n      ownerId\n      body\n      engagementId\n      activityId\n      parentEngagementId\n      createdAt\n      updatedAt\n    }\n    commentedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetMentionUserMembershipQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetMentionUserMembership";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetMentionUserMembership($id: ID!) {\n  getMentionUserMembership(id: $id) {\n    __typename\n    id\n    accountId\n    commentId\n    mentionedUserId\n    isAnnouncement\n    commentedById\n    createdAt\n    updatedAt\n    comment {\n      __typename\n      id\n      accountId\n      ownerId\n      body\n      engagementId\n      activityId\n      parentEngagementId\n      createdAt\n      updatedAt\n    }\n    commentedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private String id;

        public GetMentionUserMembershipQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetMentionUserMembershipQuery(this.id);
        }
    ...
    public static class Comment {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMentionUserMembershipQuery.Comment.1
    ...
    public static class CommentedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMentionUserMembershipQuery.CommentedBy.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CommentedBy.$responseFields;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getMentionUserMembership", "getMentionUserMembership", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetMentionUserMembership getMentionUserMembership;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetMentionUserMembership.Mapper getMentionUserMembershipFieldMapper = new GetMentionUserMembership.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetMentionUserMembership) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetMentionUserMembership>() { // from class: com.amazonaws.amplify.generated.graphql.GetMentionUserMembershipQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetMentionUserMembership read(ResponseReader responseReader2) {
                        return Mapper.this.getMentionUserMembershipFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetMentionUserMembership getMentionUserMembership) {
            this.getMentionUserMembership = getMentionUserMembership;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetMentionUserMembership getMentionUserMembership = this.getMentionUserMembership;
            GetMentionUserMembership getMentionUserMembership2 = ((Data) obj).getMentionUserMembership;
            return getMentionUserMembership == null ? getMentionUserMembership2 == null : getMentionUserMembership.equals(getMentionUserMembership2);
        }

        public GetMentionUserMembership getMentionUserMembership() {
            return this.getMentionUserMembership;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetMentionUserMembership getMentionUserMembership = this.getMentionUserMembership;
                this.$hashCode = (getMentionUserMembership == null ? 0 : getMentionUserMembership.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMentionUserMembershipQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetMentionUserMembership getMentionUserMembership = Data.this.getMentionUserMembership;
                    responseWriter.writeObject(responseField, getMentionUserMembership != null ? getMentionUserMembership.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getMentionUserMembership=" + this.getMentionUserMembership + "}";
            }
            return this.$toString;
        }
    }

    public static class GetMentionUserMembership {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<GetMentionUserMembership> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetMentionUserMembership map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetMentionUserMembership.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                ...
                return new GetMentionUserMembership(string, str, str2, str3, str4, string2 != null ? Announcement.valueOf(string2) : null, (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[8]), (Comment) responseReader.readObject(responseFieldArr[9], new ResponseReader.ObjectReader<Comment>() { // from class: com.amazonaws.amplify.generated.graphql.GetMentionUserMembershipQuery.GetMentionUserMembership.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public Comment read(ResponseReader responseReader2) {
                        return Mapper.this.commentFieldMapper.map(responseReader2);
                    }
                }), (CommentedBy) responseReader.readObject(responseFieldArr[10], new ResponseReader.ObjectReader<CommentedBy>() { // from class: com.amazonaws.amplify.generated.graphql.GetMentionUserMembershipQuery.GetMentionUserMembership.Mapper.2
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetMentionUserMembership(String str, String str2, String str3, String str4, String str5, Announcement announcement, String str6, String str7, String str8, Comment comment, CommentedBy commentedBy) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetMentionUserMembership)) {
                return false;
            }
            GetMentionUserMembership getMentionUserMembership = (GetMentionUserMembership) obj;
            if (this.__typename.equals(getMentionUserMembership.__typename) && this.id.equals(getMentionUserMembership.id) && this.accountId.equals(getMentionUserMembership.accountId) && this.commentId.equals(getMentionUserMembership.commentId) && ((str = this.mentionedUserId) != null ? str.equals(getMentionUserMembership.mentionedUserId) : getMentionUserMembership.mentionedUserId == null) && ((announcement = this.isAnnouncement) != null ? announcement.equals(getMentionUserMembership.isAnnouncement) : getMentionUserMembership.isAnnouncement == null) && this.commentedById.equals(getMentionUserMembership.commentedById) && ((str2 = this.createdAt) != null ? str2.equals(getMentionUserMembership.createdAt) : getMentionUserMembership.createdAt == null) && ((str3 = this.updatedAt) != null ? str3.equals(getMentionUserMembership.updatedAt) : getMentionUserMembership.updatedAt == null) && ((comment = this.comment) != null ? comment.equals(getMentionUserMembership.comment) : getMentionUserMembership.comment == null)) {
                CommentedBy commentedBy = this.commentedBy;
                CommentedBy commentedBy2 = getMentionUserMembership.commentedBy;
                if (commentedBy == null) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMentionUserMembershipQuery.GetMentionUserMembership.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetMentionUserMembership.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetMentionUserMembership.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetMentionUserMembership.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetMentionUserMembership.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], GetMentionUserMembership.this.commentId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], GetMentionUserMembership.this.mentionedUserId);
                    ResponseField responseField = responseFieldArr[5];
                    Announcement announcement = GetMentionUserMembership.this.isAnnouncement;
                    responseWriter.writeString(responseField, announcement != null ? announcement.name() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], GetMentionUserMembership.this.commentedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], GetMentionUserMembership.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], GetMentionUserMembership.this.updatedAt);
                    ResponseField responseField2 = responseFieldArr[9];
                    Comment comment = GetMentionUserMembership.this.comment;
                    ...
                    CommentedBy commentedBy = GetMentionUserMembership.this.commentedBy;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetMentionUserMembership{__typename=" + this.__typename + ", id=" + this.id + ", accountId=" + this.accountId + ", commentId=" + this.commentId + ", mentionedUserId=" + this.mentionedUserId + ", isAnnouncement=" + this.isAnnouncement + ", commentedById=" + this.commentedById + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", comment=" + this.comment + ", commentedBy=" + this.commentedBy + "}";
            }
            return this.$toString;
        }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMentionUserMembershipQuery.Variables.1
    ...
    public GetMentionUserMembershipQuery(String str) {
    ...
    public String operationId() {
        return "b7dacc5fc235006eb914d214574e9ce9ad7f28360460969c106f9e677f54e6b7";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetMentionUserMembership($id: ID!) {\n  getMentionUserMembership(id: $id) {\n    __typename\n    id\n    accountId\n    commentId\n    mentionedUserId\n    isAnnouncement\n    commentedById\n    createdAt\n    updatedAt\n    comment {\n      __typename\n      id\n      accountId\n      ownerId\n      body\n      engagementId\n      activityId\n      parentEngagementId\n      createdAt\n      updatedAt\n    }\n    commentedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
