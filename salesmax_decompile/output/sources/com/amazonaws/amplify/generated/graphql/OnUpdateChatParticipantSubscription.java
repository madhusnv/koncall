...
public final class OnUpdateChatParticipantSubscription implements Subscription<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "subscription OnUpdateChatParticipant($accountId: ID!, $participantId: ID!) {\n  onUpdateChatParticipant(accountId: $accountId, participantId: $participantId) {\n    __typename\n    id\n    accountId\n    channelId\n    phoneNumberIdExternal\n    participantId\n    participationStatus\n    unreadMessageCount\n    lastViewed\n    isStarred\n    joinedAt\n    leftAt\n    channelName\n    channelType\n    channelSubType\n    channelStatus\n    channelWillBeChargedNext\n    channelOpenUntil\n    lastMessageByLeadTime\n    lastMessageByUserTime\n    isLastMessageByLead\n    lastOutboundMessageId\n    lastOutboundMessageStatus\n    isNewMessageUpdate\n    tags\n    participantScopeIfInternal\n    userIdsForDirectChannel\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    participant {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatParticipantSubscription.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "OnUpdateChatParticipant";
        }
    };
    public static final String QUERY_DOCUMENT = "subscription OnUpdateChatParticipant($accountId: ID!, $participantId: ID!) {\n  onUpdateChatParticipant(accountId: $accountId, participantId: $participantId) {\n    __typename\n    id\n    accountId\n    channelId\n    phoneNumberIdExternal\n    participantId\n    participationStatus\n    unreadMessageCount\n    lastViewed\n    isStarred\n    joinedAt\n    leftAt\n    channelName\n    channelType\n    channelSubType\n    channelStatus\n    channelWillBeChargedNext\n    channelOpenUntil\n    lastMessageByLeadTime\n    lastMessageByUserTime\n    isLastMessageByLead\n    lastOutboundMessageId\n    lastOutboundMessageStatus\n    isNewMessageUpdate\n    tags\n    participantScopeIfInternal\n    userIdsForDirectChannel\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    participant {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    ...
    public static final class Builder {
        ...
        public OnUpdateChatParticipantSubscription build() {
            Utils.checkNotNull(this.accountId, "accountId == null");
            Utils.checkNotNull(this.participantId, "participantId == null");
            return new OnUpdateChatParticipantSubscription(this.accountId, this.participantId);
        }
    ...
    public static class Channel {
        ...
        public static final class Mapper implements ResponseFieldMapper<Channel> {
            ...
            public Channel map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[6], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatParticipantSubscription.Channel.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatParticipantSubscription.Channel.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[6], Channel.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatParticipantSubscription.Channel.1.1
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("onUpdateChatParticipant", "onUpdateChatParticipant", new UnmodifiableMapBuilder(2).put("participantId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "participantId").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnUpdateChatParticipant onUpdateChatParticipant;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final OnUpdateChatParticipant.Mapper onUpdateChatParticipantFieldMapper = new OnUpdateChatParticipant.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((OnUpdateChatParticipant) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<OnUpdateChatParticipant>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatParticipantSubscription.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public OnUpdateChatParticipant read(ResponseReader responseReader2) {
                        return Mapper.this.onUpdateChatParticipantFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(OnUpdateChatParticipant onUpdateChatParticipant) {
            this.onUpdateChatParticipant = onUpdateChatParticipant;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnUpdateChatParticipant onUpdateChatParticipant = this.onUpdateChatParticipant;
            OnUpdateChatParticipant onUpdateChatParticipant2 = ((Data) obj).onUpdateChatParticipant;
            return onUpdateChatParticipant == null ? onUpdateChatParticipant2 == null : onUpdateChatParticipant.equals(onUpdateChatParticipant2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnUpdateChatParticipant onUpdateChatParticipant = this.onUpdateChatParticipant;
                this.$hashCode = (onUpdateChatParticipant == null ? 0 : onUpdateChatParticipant.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatParticipantSubscription.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    OnUpdateChatParticipant onUpdateChatParticipant = Data.this.onUpdateChatParticipant;
                    responseWriter.writeObject(responseField, onUpdateChatParticipant != null ? onUpdateChatParticipant.marshaller() : null);
                }
            };
        }

        public OnUpdateChatParticipant onUpdateChatParticipant() {
            return this.onUpdateChatParticipant;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onUpdateChatParticipant=" + this.onUpdateChatParticipant + "}";
            }
            return this.$toString;
        }
    }

    public static class OnUpdateChatParticipant {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public OnUpdateChatParticipant(String str, String str2, String str3, String str4, String str5, String str6, String str7, Integer num, String str8, Boolean bool, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, Boolean bool2, String str19, String str20, Boolean bool3, List<String> list, String str21, String str22, String str23, String str24, Channel channel, Participant participant) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnUpdateChatParticipant)) {
                return false;
            }
            OnUpdateChatParticipant onUpdateChatParticipant = (OnUpdateChatParticipant) obj;
            if (this.__typename.equals(onUpdateChatParticipant.__typename) && this.id.equals(onUpdateChatParticipant.id) && this.accountId.equals(onUpdateChatParticipant.accountId) && this.channelId.equals(onUpdateChatParticipant.channelId) && ((str = this.phoneNumberIdExternal) != null ? str.equals(onUpdateChatParticipant.phoneNumberIdExternal) : onUpdateChatParticipant.phoneNumberIdExternal == null) && this.participantId.equals(onUpdateChatParticipant.participantId) && this.participationStatus.equals(onUpdateChatParticipant.participationStatus) && ((num = this.unreadMessageCount) != null ? num.equals(onUpdateChatParticipant.unreadMessageCount) : onUpdateChatParticipant.unreadMessageCount == null) && ((str2 = this.lastViewed) != null ? str2.equals(onUpdateChatParticipant.lastViewed) : onUpdateChatParticipant.lastViewed == null) && ((bool = this.isStarred) != null ? bool.equals(onUpdateChatParticipant.isStarred) : onUpdateChatParticipant.isStarred == null) && ((str3 = this.joinedAt) != null ? str3.equals(onUpdateChatParticipant.joinedAt) : onUpdateChatParticipant.joinedAt == null) && ((str4 = this.leftAt) != null ? str4.equals(onUpdateChatParticipant.leftAt) : onUpdateChatParticipant.leftAt == null) && ((str5 = this.channelName) != null ? str5.equals(onUpdateChatParticipant.channelName) : onUpdateChatParticipant.channelName == null) && ((str6 = this.channelType) != null ? str6.equals(onUpdateChatParticipant.channelType) : onUpdateChatParticipant.channelType == null) && ((str7 = this.channelSubType) != null ? str7.equals(onUpdateChatParticipant.channelSubType) : onUpdateChatParticipant.channelSubType == null) && ((str8 = this.channelStatus) != null ? str8.equals(onUpdateChatParticipant.channelStatus) : onUpdateChatParticipant.channelStatus == null) && ((str9 = this.channelWillBeChargedNext) != null ? str9.equals(onUpdateChatParticipant.channelWillBeChargedNext) : onUpdateChatParticipant.channelWillBeChargedNext == null) && ((str10 = this.channelOpenUntil) != null ? str10.equals(onUpdateChatParticipant.channelOpenUntil) : onUpdateChatParticipant.channelOpenUntil == null) && ((str11 = this.lastMessageByLeadTime) != null ? str11.equals(onUpdateChatParticipant.lastMessageByLeadTime) : onUpdateChatParticipant.lastMessageByLeadTime == null) && ((str12 = this.lastMessageByUserTime) != null ? str12.equals(onUpdateChatParticipant.lastMessageByUserTime) : onUpdateChatParticipant.lastMessageByUserTime == null) && ((bool2 = this.isLastMessageByLead) != null ? bool2.equals(onUpdateChatParticipant.isLastMessageByLead) : onUpdateChatParticipant.isLastMessageByLead == null) && ((str13 = this.lastOutboundMessageId) != null ? str13.equals(onUpdateChatParticipant.lastOutboundMessageId) : onUpdateChatParticipant.lastOutboundMessageId == null) && ((str14 = this.lastOutboundMessageStatus) != null ? str14.equals(onUpdateChatParticipant.lastOutboundMessageStatus) : onUpdateChatParticipant.lastOutboundMessageStatus == null) && ((bool3 = this.isNewMessageUpdate) != null ? bool3.equals(onUpdateChatParticipant.isNewMessageUpdate) : onUpdateChatParticipant.isNewMessageUpdate == null) && ((list = this.tags) != null ? list.equals(onUpdateChatParticipant.tags) : onUpdateChatParticipant.tags == null) && ((str15 = this.participantScopeIfInternal) != null ? str15.equals(onUpdateChatParticipant.participantScopeIfInternal) : onUpdateChatParticipant.participantScopeIfInternal == null) && ((str16 = this.userIdsForDirectChannel) != null ? str16.equals(onUpdateChatParticipant.userIdsForDirectChannel) : onUpdateChatParticipant.userIdsForDirectChannel == null) && ((str17 = this.createdAt) != null ? str17.equals(onUpdateChatParticipant.createdAt) : onUpdateChatParticipant.createdAt == null) && ((str18 = this.updatedAt) != null ? str18.equals(onUpdateChatParticipant.updatedAt) : onUpdateChatParticipant.updatedAt == null) && ((channel = this.channel) != null ? channel.equals(onUpdateChatParticipant.channel) : onUpdateChatParticipant.channel == null)) {
                Participant participant = this.participant;
                Participant participant2 = onUpdateChatParticipant.participant;
                if (participant == null) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatParticipantSubscription.OnUpdateChatParticipant.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = OnUpdateChatParticipant.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], OnUpdateChatParticipant.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], OnUpdateChatParticipant.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], OnUpdateChatParticipant.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], OnUpdateChatParticipant.this.channelId);
                    responseWriter.writeString(responseFieldArr[4], OnUpdateChatParticipant.this.phoneNumberIdExternal);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], OnUpdateChatParticipant.this.participantId);
                    responseWriter.writeString(responseFieldArr[6], OnUpdateChatParticipant.this.participationStatus);
                    responseWriter.writeInt(responseFieldArr[7], OnUpdateChatParticipant.this.unreadMessageCount);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], OnUpdateChatParticipant.this.lastViewed);
                    responseWriter.writeBoolean(responseFieldArr[9], OnUpdateChatParticipant.this.isStarred);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[10], OnUpdateChatParticipant.this.joinedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], OnUpdateChatParticipant.this.leftAt);
                    responseWriter.writeString(responseFieldArr[12], OnUpdateChatParticipant.this.channelName);
                    responseWriter.writeString(responseFieldArr[13], OnUpdateChatParticipant.this.channelType);
                    responseWriter.writeString(responseFieldArr[14], OnUpdateChatParticipant.this.channelSubType);
                    responseWriter.writeString(responseFieldArr[15], OnUpdateChatParticipant.this.channelStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], OnUpdateChatParticipant.this.channelWillBeChargedNext);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], OnUpdateChatParticipant.this.channelOpenUntil);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], OnUpdateChatParticipant.this.lastMessageByLeadTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], OnUpdateChatParticipant.this.lastMessageByUserTime);
                    responseWriter.writeBoolean(responseFieldArr[20], OnUpdateChatParticipant.this.isLastMessageByLead);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], OnUpdateChatParticipant.this.lastOutboundMessageId);
                    responseWriter.writeString(responseFieldArr[22], OnUpdateChatParticipant.this.lastOutboundMessageStatus);
                    responseWriter.writeBoolean(responseFieldArr[23], OnUpdateChatParticipant.this.isNewMessageUpdate);
                    responseWriter.writeList(responseFieldArr[24], OnUpdateChatParticipant.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatParticipantSubscription.OnUpdateChatParticipant.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[25], OnUpdateChatParticipant.this.participantScopeIfInternal);
                    responseWriter.writeString(responseFieldArr[26], OnUpdateChatParticipant.this.userIdsForDirectChannel);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], OnUpdateChatParticipant.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[28], OnUpdateChatParticipant.this.updatedAt);
                    ResponseField responseField = responseFieldArr[29];
                    Channel channel = OnUpdateChatParticipant.this.channel;
                    ...
                    Participant participant = OnUpdateChatParticipant.this.participant;
    ...
    public static class Participant {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatParticipantSubscription.Participant.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Participant.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatParticipantSubscription.Variables.1
    ...
    public OnUpdateChatParticipantSubscription(String str, String str2) {
    ...
    public String operationId() {
        return "ae9e861b7084c6867a1a462f5265ec26479bd32c7a1cc5fec3fb84046bf54b2f";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "subscription OnUpdateChatParticipant($accountId: ID!, $participantId: ID!) {\n  onUpdateChatParticipant(accountId: $accountId, participantId: $participantId) {\n    __typename\n    id\n    accountId\n    channelId\n    phoneNumberIdExternal\n    participantId\n    participationStatus\n    unreadMessageCount\n    lastViewed\n    isStarred\n    joinedAt\n    leftAt\n    channelName\n    channelType\n    channelSubType\n    channelStatus\n    channelWillBeChargedNext\n    channelOpenUntil\n    lastMessageByLeadTime\n    lastMessageByUserTime\n    isLastMessageByLead\n    lastOutboundMessageId\n    lastOutboundMessageStatus\n    isNewMessageUpdate\n    tags\n    participantScopeIfInternal\n    userIdsForDirectChannel\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    participant {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
