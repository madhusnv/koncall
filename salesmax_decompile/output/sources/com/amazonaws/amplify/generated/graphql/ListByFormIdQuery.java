...
public final class ListByFormIdQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListByFormId($formId: ID, $sortDirection: ModelSortDirection, $filter: ModelcustomFormAttachConditionFilterInput, $limit: Int, $nextToken: String) {\n  listByFormId(formId: $formId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      formId\n      formType\n      callOutcome\n      visitOutcome\n      taskInputType\n      taskType\n      taskOutcomeType\n      dealStage\n      paymentStatus\n      documentCategory\n      documentSubCategory\n      isDefaultFormForType\n      hideDefaultNote\n      createdById\n      updatedById\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListByFormIdQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListByFormId";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListByFormId($formId: ID, $sortDirection: ModelSortDirection, $filter: ModelcustomFormAttachConditionFilterInput, $limit: Int, $nextToken: String) {\n  listByFormId(formId: $formId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      formId\n      formType\n      callOutcome\n      visitOutcome\n      taskInputType\n      taskType\n      taskOutcomeType\n      dealStage\n      paymentStatus\n      documentCategory\n      documentSubCategory\n      isDefaultFormForType\n      hideDefaultNote\n      createdById\n      updatedById\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public ListByFormIdQuery build() {
            return new ListByFormIdQuery(this.formId, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listByFormId", "listByFormId", new UnmodifiableMapBuilder(5).put("formId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "formId").build()).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListByFormId listByFormId;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListByFormId.Mapper listByFormIdFieldMapper = new ListByFormId.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListByFormId) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListByFormId>() { // from class: com.amazonaws.amplify.generated.graphql.ListByFormIdQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListByFormId read(ResponseReader responseReader2) {
                        return Mapper.this.listByFormIdFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListByFormId listByFormId) {
            this.listByFormId = listByFormId;
        }
        ...
        public boolean equals(Object obj) {
            ...
            ListByFormId listByFormId = this.listByFormId;
            ListByFormId listByFormId2 = ((Data) obj).listByFormId;
            return listByFormId == null ? listByFormId2 == null : listByFormId.equals(listByFormId2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListByFormId listByFormId = this.listByFormId;
                this.$hashCode = (listByFormId == null ? 0 : listByFormId.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListByFormId listByFormId() {
            return this.listByFormId;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListByFormIdQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListByFormId listByFormId = Data.this.listByFormId;
                    responseWriter.writeObject(responseField, listByFormId != null ? listByFormId.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listByFormId=" + this.listByFormId + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListByFormIdQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static class ListByFormId {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListByFormId> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListByFormId map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListByFormId.$responseFields;
                return new ListByFormId(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListByFormIdQuery.ListByFormId.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListByFormIdQuery.ListByFormId.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListByFormId(String str, List<Item> list, String str2) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListByFormId)) {
                return false;
            }
            ListByFormId listByFormId = (ListByFormId) obj;
            if (this.__typename.equals(listByFormId.__typename) && this.items.equals(listByFormId.items)) {
                String str = this.nextToken;
                String str2 = listByFormId.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListByFormIdQuery.ListByFormId.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListByFormId.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListByFormId.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListByFormId.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListByFormIdQuery.ListByFormId.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListByFormId.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListByFormId{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(String str, ModelSortDirection modelSortDirection, ModelcustomFormAttachConditionFilterInput modelcustomFormAttachConditionFilterInput, Integer num, String str2) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListByFormIdQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("formId", Variables.this.formId);
    ...
    public ListByFormIdQuery(String str, ModelSortDirection modelSortDirection, ModelcustomFormAttachConditionFilterInput modelcustomFormAttachConditionFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelSortDirection, modelcustomFormAttachConditionFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "8f12b137617cd500314522b00a1460af76fd10def8e6aee073a32bfc76b5c98f";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListByFormId($formId: ID, $sortDirection: ModelSortDirection, $filter: ModelcustomFormAttachConditionFilterInput, $limit: Int, $nextToken: String) {\n  listByFormId(formId: $formId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      formId\n      formType\n      callOutcome\n      visitOutcome\n      taskInputType\n      taskType\n      taskOutcomeType\n      dealStage\n      paymentStatus\n      documentCategory\n      documentSubCategory\n      isDefaultFormForType\n      hideDefaultNote\n      createdById\n      updatedById\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
