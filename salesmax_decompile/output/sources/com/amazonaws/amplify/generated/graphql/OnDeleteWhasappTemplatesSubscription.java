...
public final class OnDeleteWhasappTemplatesSubscription implements Subscription<Data, Data, Operation.Variables> {
    public static final String OPERATION_DEFINITION = "subscription OnDeleteWhasappTemplates {\n  onDeleteWhasappTemplates {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "OnDeleteWhasappTemplates";
        }
    };
    public static final String QUERY_DOCUMENT = "subscription OnDeleteWhasappTemplates {\n  onDeleteWhasappTemplates {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    ...
    public static class ActionInteractive {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.ActionInteractive.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], ActionInteractive.this.savedAddresses, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.ActionInteractive.1.1
    ...
    public static final class Builder {
        public OnDeleteWhasappTemplatesSubscription build() {
            return new OnDeleteWhasappTemplatesSubscription();
        }
    }
    ...
    public static class Component {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.Component.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("onDeleteWhasappTemplates", "onDeleteWhasappTemplates", null, true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnDeleteWhasappTemplates onDeleteWhasappTemplates;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final OnDeleteWhasappTemplates.Mapper onDeleteWhasappTemplatesFieldMapper = new OnDeleteWhasappTemplates.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((OnDeleteWhasappTemplates) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<OnDeleteWhasappTemplates>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public OnDeleteWhasappTemplates read(ResponseReader responseReader2) {
                        return Mapper.this.onDeleteWhasappTemplatesFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(OnDeleteWhasappTemplates onDeleteWhasappTemplates) {
            this.onDeleteWhasappTemplates = onDeleteWhasappTemplates;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnDeleteWhasappTemplates onDeleteWhasappTemplates = this.onDeleteWhasappTemplates;
            OnDeleteWhasappTemplates onDeleteWhasappTemplates2 = ((Data) obj).onDeleteWhasappTemplates;
            return onDeleteWhasappTemplates == null ? onDeleteWhasappTemplates2 == null : onDeleteWhasappTemplates.equals(onDeleteWhasappTemplates2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnDeleteWhasappTemplates onDeleteWhasappTemplates = this.onDeleteWhasappTemplates;
                this.$hashCode = (onDeleteWhasappTemplates == null ? 0 : onDeleteWhasappTemplates.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    OnDeleteWhasappTemplates onDeleteWhasappTemplates = Data.this.onDeleteWhasappTemplates;
                    responseWriter.writeObject(responseField, onDeleteWhasappTemplates != null ? onDeleteWhasappTemplates.marshaller() : null);
                }
            };
        }

        public OnDeleteWhasappTemplates onDeleteWhasappTemplates() {
            return this.onDeleteWhasappTemplates;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onDeleteWhasappTemplates=" + this.onDeleteWhasappTemplates + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class DefaultMedia {
        ...
        public static final class Mapper implements ResponseFieldMapper<DefaultMedia> {
            ...
            public DefaultMedia map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[9], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.DefaultMedia.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.DefaultMedia.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultMedia.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[9], DefaultMedia.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.DefaultMedia.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class DefaultVariableMap {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.DefaultVariableMap.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultVariableMap.$responseFields;
    ...
    public static class OnDeleteWhasappTemplates {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<OnDeleteWhasappTemplates> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public OnDeleteWhasappTemplates map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = OnDeleteWhasappTemplates.$responseFields;
                return new OnDeleteWhasappTemplates(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), responseReader.readString(responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), responseReader.readString(responseFieldArr[6]), responseReader.readString(responseFieldArr[7]), responseReader.readList(responseFieldArr[8], new ResponseReader.ListReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.OnDeleteWhasappTemplates.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Component read(ResponseReader.ListItemReader listItemReader) {
                        return (Component) listItemReader.readObject(new ResponseReader.ObjectReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.OnDeleteWhasappTemplates.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnDeleteWhasappTemplates)) {
                return false;
            }
            OnDeleteWhasappTemplates onDeleteWhasappTemplates = (OnDeleteWhasappTemplates) obj;
            if (this.__typename.equals(onDeleteWhasappTemplates.__typename) && this.id.equals(onDeleteWhasappTemplates.id) && this.accountId.equals(onDeleteWhasappTemplates.accountId) && ((str = this.whatsappBusinessAccount) != null ? str.equals(onDeleteWhasappTemplates.whatsappBusinessAccount) : onDeleteWhasappTemplates.whatsappBusinessAccount == null) && ((str2 = this.templateType) != null ? str2.equals(onDeleteWhasappTemplates.templateType) : onDeleteWhasappTemplates.templateType == null) && ((str3 = this.snippetType) != null ? str3.equals(onDeleteWhasappTemplates.snippetType) : onDeleteWhasappTemplates.snippetType == null) && ((str4 = this.platform) != null ? str4.equals(onDeleteWhasappTemplates.platform) : onDeleteWhasappTemplates.platform == null) && ((str5 = this.name) != null ? str5.equals(onDeleteWhasappTemplates.name) : onDeleteWhasappTemplates.name == null) && ((list = this.components) != null ? list.equals(onDeleteWhasappTemplates.components) : onDeleteWhasappTemplates.components == null) && ((str6 = this.language) != null ? str6.equals(onDeleteWhasappTemplates.language) : onDeleteWhasappTemplates.language == null) && ((str7 = this.status) != null ? str7.equals(onDeleteWhasappTemplates.status) : onDeleteWhasappTemplates.status == null) && ((str8 = this.category) != null ? str8.equals(onDeleteWhasappTemplates.category) : onDeleteWhasappTemplates.category == null) && ((str9 = this.subCategory) != null ? str9.equals(onDeleteWhasappTemplates.subCategory) : onDeleteWhasappTemplates.subCategory == null) && ((str10 = this.snippetCategory) != null ? str10.equals(onDeleteWhasappTemplates.snippetCategory) : onDeleteWhasappTemplates.snippetCategory == null) && ((str11 = this.snippetSubCategory) != null ? str11.equals(onDeleteWhasappTemplates.snippetSubCategory) : onDeleteWhasappTemplates.snippetSubCategory == null) && ((str12 = this.createdBy) != null ? str12.equals(onDeleteWhasappTemplates.createdBy) : onDeleteWhasappTemplates.createdBy == null) && ((str13 = this.updatedBy) != null ? str13.equals(onDeleteWhasappTemplates.updatedBy) : onDeleteWhasappTemplates.updatedBy == null) && ((str14 = this.archivedStatus) != null ? str14.equals(onDeleteWhasappTemplates.archivedStatus) : onDeleteWhasappTemplates.archivedStatus == null) && ((str15 = this.archivedAt) != null ? str15.equals(onDeleteWhasappTemplates.archivedAt) : onDeleteWhasappTemplates.archivedAt == null) && ((str16 = this.defaultMediaId) != null ? str16.equals(onDeleteWhasappTemplates.defaultMediaId) : onDeleteWhasappTemplates.defaultMediaId == null) && ((list2 = this.defaultVariableMap) != null ? list2.equals(onDeleteWhasappTemplates.defaultVariableMap) : onDeleteWhasappTemplates.defaultVariableMap == null) && ((str17 = this.templateId) != null ? str17.equals(onDeleteWhasappTemplates.templateId) : onDeleteWhasappTemplates.templateId == null) && ((list3 = this.tags) != null ? list3.equals(onDeleteWhasappTemplates.tags) : onDeleteWhasappTemplates.tags == null) && ((bool = this.isSample) != null ? bool.equals(onDeleteWhasappTemplates.isSample) : onDeleteWhasappTemplates.isSample == null) && ((str18 = this.messageType) != null ? str18.equals(onDeleteWhasappTemplates.messageType) : onDeleteWhasappTemplates.messageType == null) && ((str19 = this.messageSubType) != null ? str19.equals(onDeleteWhasappTemplates.messageSubType) : onDeleteWhasappTemplates.messageSubType == null) && ((str20 = this.text) != null ? str20.equals(onDeleteWhasappTemplates.text) : onDeleteWhasappTemplates.text == null) && ((str21 = this.locationObjectToSend) != null ? str21.equals(onDeleteWhasappTemplates.locationObjectToSend) : onDeleteWhasappTemplates.locationObjectToSend == null) && ((str22 = this.headerText) != null ? str22.equals(onDeleteWhasappTemplates.headerText) : onDeleteWhasappTemplates.headerText == null) && ((str23 = this.footerText) != null ? str23.equals(onDeleteWhasappTemplates.footerText) : onDeleteWhasappTemplates.footerText == null) && ((str24 = this.headerType) != null ? str24.equals(onDeleteWhasappTemplates.headerType) : onDeleteWhasappTemplates.headerType == null) && ((actionInteractive = this.actionInteractive) != null ? actionInteractive.equals(onDeleteWhasappTemplates.actionInteractive) : onDeleteWhasappTemplates.actionInteractive == null) && ((str25 = this.messageTemplateQualityNew) != null ? str25.equals(onDeleteWhasappTemplates.messageTemplateQualityNew) : onDeleteWhasappTemplates.messageTemplateQualityNew == null) && ((str26 = this.messageTemplateQualityPrevious) != null ? str26.equals(onDeleteWhasappTemplates.messageTemplateQualityPrevious) : onDeleteWhasappTemplates.messageTemplateQualityPrevious == null) && ((str27 = this.messageTemplateQualityUpdatedAt) != null ? str27.equals(onDeleteWhasappTemplates.messageTemplateQualityUpdatedAt) : onDeleteWhasappTemplates.messageTemplateQualityUpdatedAt == null) && ((str28 = this.messageTemplateStatusUpdatedAt) != null ? str28.equals(onDeleteWhasappTemplates.messageTemplateStatusUpdatedAt) : onDeleteWhasappTemplates.messageTemplateStatusUpdatedAt == null) && ((str29 = this.stausUpdateReason) != null ? str29.equals(onDeleteWhasappTemplates.stausUpdateReason) : onDeleteWhasappTemplates.stausUpdateReason == null) && ((str30 = this.otherDetail) != null ? str30.equals(onDeleteWhasappTemplates.otherDetail) : onDeleteWhasappTemplates.otherDetail == null) && ((str31 = this.lastUsed) != null ? str31.equals(onDeleteWhasappTemplates.lastUsed) : onDeleteWhasappTemplates.lastUsed == null) && ((str32 = this.createdAt) != null ? str32.equals(onDeleteWhasappTemplates.createdAt) : onDeleteWhasappTemplates.createdAt == null) && ((str33 = this.updatedAt) != null ? str33.equals(onDeleteWhasappTemplates.updatedAt) : onDeleteWhasappTemplates.updatedAt == null)) {
                DefaultMedia defaultMedia = this.defaultMedia;
                DefaultMedia defaultMedia2 = onDeleteWhasappTemplates.defaultMedia;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.OnDeleteWhasappTemplates.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = OnDeleteWhasappTemplates.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], OnDeleteWhasappTemplates.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], OnDeleteWhasappTemplates.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], OnDeleteWhasappTemplates.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], OnDeleteWhasappTemplates.this.whatsappBusinessAccount);
                    responseWriter.writeString(responseFieldArr[4], OnDeleteWhasappTemplates.this.templateType);
                    responseWriter.writeString(responseFieldArr[5], OnDeleteWhasappTemplates.this.snippetType);
                    responseWriter.writeString(responseFieldArr[6], OnDeleteWhasappTemplates.this.platform);
                    responseWriter.writeString(responseFieldArr[7], OnDeleteWhasappTemplates.this.name);
                    responseWriter.writeList(responseFieldArr[8], OnDeleteWhasappTemplates.this.components, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.OnDeleteWhasappTemplates.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Component) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[9], OnDeleteWhasappTemplates.this.language);
                    responseWriter.writeString(responseFieldArr[10], OnDeleteWhasappTemplates.this.status);
                    responseWriter.writeString(responseFieldArr[11], OnDeleteWhasappTemplates.this.category);
                    responseWriter.writeString(responseFieldArr[12], OnDeleteWhasappTemplates.this.subCategory);
                    responseWriter.writeString(responseFieldArr[13], OnDeleteWhasappTemplates.this.snippetCategory);
                    responseWriter.writeString(responseFieldArr[14], OnDeleteWhasappTemplates.this.snippetSubCategory);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], OnDeleteWhasappTemplates.this.createdBy);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], OnDeleteWhasappTemplates.this.updatedBy);
                    responseWriter.writeString(responseFieldArr[17], OnDeleteWhasappTemplates.this.archivedStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], OnDeleteWhasappTemplates.this.archivedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], OnDeleteWhasappTemplates.this.defaultMediaId);
                    responseWriter.writeList(responseFieldArr[20], OnDeleteWhasappTemplates.this.defaultVariableMap, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.OnDeleteWhasappTemplates.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((DefaultVariableMap) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[21], OnDeleteWhasappTemplates.this.templateId);
                    responseWriter.writeList(responseFieldArr[22], OnDeleteWhasappTemplates.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteWhasappTemplatesSubscription.OnDeleteWhasappTemplates.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeBoolean(responseFieldArr[23], OnDeleteWhasappTemplates.this.isSample);
                    responseWriter.writeString(responseFieldArr[24], OnDeleteWhasappTemplates.this.messageType);
                    responseWriter.writeString(responseFieldArr[25], OnDeleteWhasappTemplates.this.messageSubType);
                    responseWriter.writeString(responseFieldArr[26], OnDeleteWhasappTemplates.this.text);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], OnDeleteWhasappTemplates.this.locationObjectToSend);
                    responseWriter.writeString(responseFieldArr[28], OnDeleteWhasappTemplates.this.headerText);
                    responseWriter.writeString(responseFieldArr[29], OnDeleteWhasappTemplates.this.footerText);
                    responseWriter.writeString(responseFieldArr[30], OnDeleteWhasappTemplates.this.headerType);
                    ResponseField responseField = responseFieldArr[31];
                    ActionInteractive actionInteractive = OnDeleteWhasappTemplates.this.actionInteractive;
                    responseWriter.writeObject(responseField, actionInteractive != null ? actionInteractive.marshaller() : null);
                    responseWriter.writeString(responseFieldArr[32], OnDeleteWhasappTemplates.this.messageTemplateQualityNew);
                    responseWriter.writeString(responseFieldArr[33], OnDeleteWhasappTemplates.this.messageTemplateQualityPrevious);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[34], OnDeleteWhasappTemplates.this.messageTemplateQualityUpdatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[35], OnDeleteWhasappTemplates.this.messageTemplateStatusUpdatedAt);
                    responseWriter.writeString(responseFieldArr[36], OnDeleteWhasappTemplates.this.stausUpdateReason);
                    responseWriter.writeString(responseFieldArr[37], OnDeleteWhasappTemplates.this.otherDetail);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], OnDeleteWhasappTemplates.this.lastUsed);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[39], OnDeleteWhasappTemplates.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[40], OnDeleteWhasappTemplates.this.updatedAt);
                    ResponseField responseField2 = responseFieldArr[41];
                    DefaultMedia defaultMedia = OnDeleteWhasappTemplates.this.defaultMedia;
    ...
    public String operationId() {
        return "7b7b3dbac3cf080b99e3b8762f467d70f921af3bfd9bba2f0a63fcec8baf32f4";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "subscription OnDeleteWhasappTemplates {\n  onDeleteWhasappTemplates {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
