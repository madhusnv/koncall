...
public final class GetCloudCallWebhookEventsQuery implements Query<Data, Data, Variables> {
    ...
    public static class Contact {
        ...
        public static final class Mapper implements ResponseFieldMapper<Contact> {
            ...
            public Contact map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[5], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Contact.Mapper.1
                ...
                List list2 = responseReader.readList(responseFieldArr[7], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Contact.Mapper.2
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                ...
                List list3 = responseReader.readList(responseFieldArr[34], new ResponseReader.ListReader<Day>() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Contact.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                ...
                List list4 = responseReader.readList(responseFieldArr[92], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Contact.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                });
                List list5 = responseReader.readList(responseFieldArr[93], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Contact.Mapper.5
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                ...
                List list6 = responseReader.readList(responseFieldArr[97], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Contact.Mapper.6
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Contact.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], Contact.this.sharedOwners, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Contact.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[7], Contact.this.sharedTeams, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Contact.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[34], Contact.this.preferredContactDays, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Contact.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[92], Contact.this.userDefinedTags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Contact.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[93], Contact.this.productService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Contact.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[97], Contact.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Contact.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getCloudCallWebhookEvents", "getCloudCallWebhookEvents", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetCloudCallWebhookEvents getCloudCallWebhookEvents;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetCloudCallWebhookEvents.Mapper getCloudCallWebhookEventsFieldMapper = new GetCloudCallWebhookEvents.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetCloudCallWebhookEvents) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetCloudCallWebhookEvents>() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetCloudCallWebhookEvents read(ResponseReader responseReader2) {
                        return Mapper.this.getCloudCallWebhookEventsFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetCloudCallWebhookEvents getCloudCallWebhookEvents) {
            this.getCloudCallWebhookEvents = getCloudCallWebhookEvents;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetCloudCallWebhookEvents getCloudCallWebhookEvents = this.getCloudCallWebhookEvents;
            GetCloudCallWebhookEvents getCloudCallWebhookEvents2 = ((Data) obj).getCloudCallWebhookEvents;
            return getCloudCallWebhookEvents == null ? getCloudCallWebhookEvents2 == null : getCloudCallWebhookEvents.equals(getCloudCallWebhookEvents2);
        }

        public GetCloudCallWebhookEvents getCloudCallWebhookEvents() {
            return this.getCloudCallWebhookEvents;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetCloudCallWebhookEvents getCloudCallWebhookEvents = this.getCloudCallWebhookEvents;
                this.$hashCode = (getCloudCallWebhookEvents == null ? 0 : getCloudCallWebhookEvents.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetCloudCallWebhookEvents getCloudCallWebhookEvents = Data.this.getCloudCallWebhookEvents;
                    responseWriter.writeObject(responseField, getCloudCallWebhookEvents != null ? getCloudCallWebhookEvents.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getCloudCallWebhookEvents=" + this.getCloudCallWebhookEvents + "}";
            }
            return this.$toString;
        }
    }

    public static class GetCloudCallWebhookEvents {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetCloudCallWebhookEvents)) {
                return false;
            }
            GetCloudCallWebhookEvents getCloudCallWebhookEvents = (GetCloudCallWebhookEvents) obj;
            if (this.__typename.equals(getCloudCallWebhookEvents.__typename) && this.id.equals(getCloudCallWebhookEvents.id) && ((str = this.accountId) != null ? str.equals(getCloudCallWebhookEvents.accountId) : getCloudCallWebhookEvents.accountId == null) && ((str2 = this.contactId) != null ? str2.equals(getCloudCallWebhookEvents.contactId) : getCloudCallWebhookEvents.contactId == null) && ((str3 = this.callSessionId) != null ? str3.equals(getCloudCallWebhookEvents.callSessionId) : getCloudCallWebhookEvents.callSessionId == null) && ((str4 = this.callId) != null ? str4.equals(getCloudCallWebhookEvents.callId) : getCloudCallWebhookEvents.callId == null) && ((str5 = this.customIdentifier) != null ? str5.equals(getCloudCallWebhookEvents.customIdentifier) : getCloudCallWebhookEvents.customIdentifier == null) && ((str6 = this.providerName) != null ? str6.equals(getCloudCallWebhookEvents.providerName) : getCloudCallWebhookEvents.providerName == null) && ((str7 = this.connectionId) != null ? str7.equals(getCloudCallWebhookEvents.connectionId) : getCloudCallWebhookEvents.connectionId == null) && ((str8 = this.rawPayload) != null ? str8.equals(getCloudCallWebhookEvents.rawPayload) : getCloudCallWebhookEvents.rawPayload == null) && ((str9 = this.eventType) != null ? str9.equals(getCloudCallWebhookEvents.eventType) : getCloudCallWebhookEvents.eventType == null) && ((str10 = this.sourceNumber) != null ? str10.equals(getCloudCallWebhookEvents.sourceNumber) : getCloudCallWebhookEvents.sourceNumber == null) && ((str11 = this.callerSource) != null ? str11.equals(getCloudCallWebhookEvents.callerSource) : getCloudCallWebhookEvents.callerSource == null) && ((str12 = this.destinationNumber) != null ? str12.equals(getCloudCallWebhookEvents.destinationNumber) : getCloudCallWebhookEvents.destinationNumber == null) && ((str13 = this.displayNumber) != null ? str13.equals(getCloudCallWebhookEvents.displayNumber) : getCloudCallWebhookEvents.displayNumber == null) && ((str14 = this.agentNumber) != null ? str14.equals(getCloudCallWebhookEvents.agentNumber) : getCloudCallWebhookEvents.agentNumber == null) && ((str15 = this.customerNumber) != null ? str15.equals(getCloudCallWebhookEvents.customerNumber) : getCloudCallWebhookEvents.customerNumber == null) && ((str16 = this.callStartTime) != null ? str16.equals(getCloudCallWebhookEvents.callStartTime) : getCloudCallWebhookEvents.callStartTime == null) && ((str17 = this.callEndTime) != null ? str17.equals(getCloudCallWebhookEvents.callEndTime) : getCloudCallWebhookEvents.callEndTime == null) && ((num = this.callDuration) != null ? num.equals(getCloudCallWebhookEvents.callDuration) : getCloudCallWebhookEvents.callDuration == null) && ((num2 = this.actualCallDuration) != null ? num2.equals(getCloudCallWebhookEvents.actualCallDuration) : getCloudCallWebhookEvents.actualCallDuration == null) && ((str18 = this.resourceURL) != null ? str18.equals(getCloudCallWebhookEvents.resourceURL) : getCloudCallWebhookEvents.resourceURL == null) && ((str19 = this.callDirection) != null ? str19.equals(getCloudCallWebhookEvents.callDirection) : getCloudCallWebhookEvents.callDirection == null) && ((str20 = this.status) != null ? str20.equals(getCloudCallWebhookEvents.status) : getCloudCallWebhookEvents.status == null) && ((l = this.expirationUnixTime) != null ? l.equals(getCloudCallWebhookEvents.expirationUnixTime) : getCloudCallWebhookEvents.expirationUnixTime == null) && ((str21 = this.createdAt) != null ? str21.equals(getCloudCallWebhookEvents.createdAt) : getCloudCallWebhookEvents.createdAt == null) && ((str22 = this.updatedAt) != null ? str22.equals(getCloudCallWebhookEvents.updatedAt) : getCloudCallWebhookEvents.updatedAt == null)) {
                Contact contact = this.contact;
                Contact contact2 = getCloudCallWebhookEvents.contact;
                if (contact == null) {
                    if (contact2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.GetCloudCallWebhookEvents.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetCloudCallWebhookEvents.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetCloudCallWebhookEvents.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetCloudCallWebhookEvents.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetCloudCallWebhookEvents.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], GetCloudCallWebhookEvents.this.contactId);
                    responseWriter.writeString(responseFieldArr[4], GetCloudCallWebhookEvents.this.callSessionId);
                    responseWriter.writeString(responseFieldArr[5], GetCloudCallWebhookEvents.this.callId);
                    responseWriter.writeString(responseFieldArr[6], GetCloudCallWebhookEvents.this.customIdentifier);
                    responseWriter.writeString(responseFieldArr[7], GetCloudCallWebhookEvents.this.providerName);
                    responseWriter.writeString(responseFieldArr[8], GetCloudCallWebhookEvents.this.connectionId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], GetCloudCallWebhookEvents.this.rawPayload);
                    responseWriter.writeString(responseFieldArr[10], GetCloudCallWebhookEvents.this.eventType);
                    responseWriter.writeString(responseFieldArr[11], GetCloudCallWebhookEvents.this.sourceNumber);
                    responseWriter.writeString(responseFieldArr[12], GetCloudCallWebhookEvents.this.callerSource);
                    responseWriter.writeString(responseFieldArr[13], GetCloudCallWebhookEvents.this.destinationNumber);
                    responseWriter.writeString(responseFieldArr[14], GetCloudCallWebhookEvents.this.displayNumber);
                    responseWriter.writeString(responseFieldArr[15], GetCloudCallWebhookEvents.this.agentNumber);
                    responseWriter.writeString(responseFieldArr[16], GetCloudCallWebhookEvents.this.customerNumber);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], GetCloudCallWebhookEvents.this.callStartTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], GetCloudCallWebhookEvents.this.callEndTime);
                    responseWriter.writeInt(responseFieldArr[19], GetCloudCallWebhookEvents.this.callDuration);
                    responseWriter.writeInt(responseFieldArr[20], GetCloudCallWebhookEvents.this.actualCallDuration);
                    responseWriter.writeString(responseFieldArr[21], GetCloudCallWebhookEvents.this.resourceURL);
                    responseWriter.writeString(responseFieldArr[22], GetCloudCallWebhookEvents.this.callDirection);
                    responseWriter.writeString(responseFieldArr[23], GetCloudCallWebhookEvents.this.status);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[24], GetCloudCallWebhookEvents.this.expirationUnixTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], GetCloudCallWebhookEvents.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[26], GetCloudCallWebhookEvents.this.updatedAt);
                    ResponseField responseField = responseFieldArr[27];
                    Contact contact = GetCloudCallWebhookEvents.this.contact;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCloudCallWebhookEventsQuery.Variables.1
    ...
    public GetCloudCallWebhookEventsQuery(String str) {
    ...
    public String operationId() {
        return "b67dc5b76885a8e0af42524d86a02a207ae5f1381e81fe476a1a912f270d513c";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetCloudCallWebhookEvents($id: ID!) {\n  getCloudCallWebhookEvents(id: $id) {\n    __typename\n    id\n    accountId\n    contactId\n    callSessionId\n    callId\n    customIdentifier\n    providerName\n    connectionId\n    rawPayload\n    eventType\n    sourceNumber\n    callerSource\n    destinationNumber\n    displayNumber\n    agentNumber\n    customerNumber\n    callStartTime\n    callEndTime\n    callDuration\n    actualCallDuration\n    resourceURL\n    callDirection\n    status\n    expirationUnixTime\n    createdAt\n    updatedAt\n    contact {\n      __typename\n      id\n      accountId\n      ownerId\n      toBeAssigned\n      sharedOwners\n      primaryTeamId\n      sharedTeams\n      accountPriority\n      addedById\n      assignedToId\n      blockedForCallById\n      blockedForCallReason\n      blockedForCallUntil\n      callPriority\n      waChatChannelId\n      contactSource\n      contactSourceDrillDownOne\n      contactSourceDrillDownTwo\n      contactSourceDrillDownThree\n      contactSourceDrillDownOneId\n      contactSourceDrillDownTwoId\n      contactSourceDrillDownThreeId\n      contactStatus\n      contactType\n      department\n      designation\n      lastRepeatEnquiryDate\n      lastRepeatEnquirySource\n      gender\n      isDecisionMaker\n      isPrivate\n      lockPeriod\n      name\n      preferredContactDays\n      profilePhotoUrl\n      referredBy\n      salutation\n      seniority\n      updatedById\n      hasTask\n      openTaskActivityType\n      lastCalledTime\n      lastCallDirection\n      lastCallOutcome\n      lastCallOutcomeNature\n      lastCallUserId\n      lastCallDuration\n      lastCallEngagementId\n      lastVisitTime\n      lastVisitOutcome\n      lastVisitOutcomeNature\n      lastVisitUserId\n      lastVisitEngagementId\n      lastEmailTime\n      lastEmailUserId\n      lastEmailEngagementId\n      lastWhatsappTime\n      lastWhatsappUserId\n      lastWhatsappEngagementId\n      lastWabaBroadcastTime\n      lastWabaBroadcastStatus\n      lastWabaBroadcastTemplate\n      lastWabaBroadcastReplyBody\n      lastWabaBroadcastReplyTime\n      lastWabaBroadcastReplyType\n      lastSmsTime\n      lastSmsUserId\n      lastSmsEngagementId\n      lastNoteAddedTime\n      lastNoteUserId\n      lastNoteEngagementId\n      lastTaskDoneTime\n      lastTaskDoneUserId\n      lastTaskDoneEngagementId\n      openTaskCount\n      lastKnownDisposition\n      lastKnownDispositionTime\n      lastLeadAssignmentDateTime\n      lastEngagementFromAccount\n      lastEngagementFromContact\n      freshLeadTag\n      noWorkAfterAssignment\n      needFollowUpTag\n      needFollowUpTagUpdatedAt\n      activeDealStage\n      activeDealStageUpdatedAt\n      dealDescription\n      isCustomer\n      becameCustomerOn\n      unsuccessfulCallAttempts\n      leadCallsNotAnswered\n      userDefinedTags\n      productService\n      bulkUploadReference\n      assignmentMethod\n      whatsappOptInStatus\n      recentEngagements\n      recentEngagementsUpdatedAt\n      openTaskDetail\n      openVideoCallDetail\n      lastClosedTaskDetail\n      lastClosedTaskDetailUpdatedAt\n      latestRemark\n      customAttributes\n      paymentRequestDetail\n      lastPaymentStatus\n      customDataAddedFromAddContactForm\n      leadLifecycleStage\n      leadLifecycleStageSubCategory\n      manualClosedReason\n      lastDealStageType\n      prospectingAttempts\n      totalProspectingAttemptsAcrossRechurn\n      numberOfTimesRechurned\n      lastProspectingDoneOn\n      firstProspectingDoneOn\n      nextProspectingDueOn\n      nextProspectingSetBy\n      nextProspectingNote\n      movedToOpportunityOn\n      movedToClosedOn\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
