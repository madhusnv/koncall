...
public final class GetWhasappTemplatesQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetWhasappTemplates($id: ID!) {\n  getWhasappTemplates(id: $id) {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetWhasappTemplates";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetWhasappTemplates($id: ID!) {\n  getWhasappTemplates(id: $id) {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    ...
    public static class ActionInteractive {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.ActionInteractive.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], ActionInteractive.this.savedAddresses, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.ActionInteractive.1.1
    ...
    public static final class Builder {
        ...
        public GetWhasappTemplatesQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetWhasappTemplatesQuery(this.id);
        }
    ...
    public static class Component {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.Component.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getWhasappTemplates", "getWhasappTemplates", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetWhasappTemplates getWhasappTemplates;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetWhasappTemplates.Mapper getWhasappTemplatesFieldMapper = new GetWhasappTemplates.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetWhasappTemplates) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetWhasappTemplates>() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetWhasappTemplates read(ResponseReader responseReader2) {
                        return Mapper.this.getWhasappTemplatesFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetWhasappTemplates getWhasappTemplates) {
            this.getWhasappTemplates = getWhasappTemplates;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetWhasappTemplates getWhasappTemplates = this.getWhasappTemplates;
            GetWhasappTemplates getWhasappTemplates2 = ((Data) obj).getWhasappTemplates;
            return getWhasappTemplates == null ? getWhasappTemplates2 == null : getWhasappTemplates.equals(getWhasappTemplates2);
        }

        public GetWhasappTemplates getWhasappTemplates() {
            return this.getWhasappTemplates;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetWhasappTemplates getWhasappTemplates = this.getWhasappTemplates;
                this.$hashCode = (getWhasappTemplates == null ? 0 : getWhasappTemplates.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetWhasappTemplates getWhasappTemplates = Data.this.getWhasappTemplates;
                    responseWriter.writeObject(responseField, getWhasappTemplates != null ? getWhasappTemplates.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getWhasappTemplates=" + this.getWhasappTemplates + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class DefaultMedia {
        ...
        public static final class Mapper implements ResponseFieldMapper<DefaultMedia> {
            ...
            public DefaultMedia map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[9], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.DefaultMedia.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.DefaultMedia.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultMedia.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[9], DefaultMedia.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.DefaultMedia.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class DefaultVariableMap {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.DefaultVariableMap.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultVariableMap.$responseFields;
    ...
    public static class GetWhasappTemplates {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<GetWhasappTemplates> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetWhasappTemplates map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetWhasappTemplates.$responseFields;
                return new GetWhasappTemplates(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), responseReader.readString(responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), responseReader.readString(responseFieldArr[6]), responseReader.readString(responseFieldArr[7]), responseReader.readList(responseFieldArr[8], new ResponseReader.ListReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.GetWhasappTemplates.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Component read(ResponseReader.ListItemReader listItemReader) {
                        return (Component) listItemReader.readObject(new ResponseReader.ObjectReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.GetWhasappTemplates.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetWhasappTemplates)) {
                return false;
            }
            GetWhasappTemplates getWhasappTemplates = (GetWhasappTemplates) obj;
            if (this.__typename.equals(getWhasappTemplates.__typename) && this.id.equals(getWhasappTemplates.id) && this.accountId.equals(getWhasappTemplates.accountId) && ((str = this.whatsappBusinessAccount) != null ? str.equals(getWhasappTemplates.whatsappBusinessAccount) : getWhasappTemplates.whatsappBusinessAccount == null) && ((str2 = this.templateType) != null ? str2.equals(getWhasappTemplates.templateType) : getWhasappTemplates.templateType == null) && ((str3 = this.snippetType) != null ? str3.equals(getWhasappTemplates.snippetType) : getWhasappTemplates.snippetType == null) && ((str4 = this.platform) != null ? str4.equals(getWhasappTemplates.platform) : getWhasappTemplates.platform == null) && ((str5 = this.name) != null ? str5.equals(getWhasappTemplates.name) : getWhasappTemplates.name == null) && ((list = this.components) != null ? list.equals(getWhasappTemplates.components) : getWhasappTemplates.components == null) && ((str6 = this.language) != null ? str6.equals(getWhasappTemplates.language) : getWhasappTemplates.language == null) && ((str7 = this.status) != null ? str7.equals(getWhasappTemplates.status) : getWhasappTemplates.status == null) && ((str8 = this.category) != null ? str8.equals(getWhasappTemplates.category) : getWhasappTemplates.category == null) && ((str9 = this.subCategory) != null ? str9.equals(getWhasappTemplates.subCategory) : getWhasappTemplates.subCategory == null) && ((str10 = this.snippetCategory) != null ? str10.equals(getWhasappTemplates.snippetCategory) : getWhasappTemplates.snippetCategory == null) && ((str11 = this.snippetSubCategory) != null ? str11.equals(getWhasappTemplates.snippetSubCategory) : getWhasappTemplates.snippetSubCategory == null) && ((str12 = this.createdBy) != null ? str12.equals(getWhasappTemplates.createdBy) : getWhasappTemplates.createdBy == null) && ((str13 = this.updatedBy) != null ? str13.equals(getWhasappTemplates.updatedBy) : getWhasappTemplates.updatedBy == null) && ((str14 = this.archivedStatus) != null ? str14.equals(getWhasappTemplates.archivedStatus) : getWhasappTemplates.archivedStatus == null) && ((str15 = this.archivedAt) != null ? str15.equals(getWhasappTemplates.archivedAt) : getWhasappTemplates.archivedAt == null) && ((str16 = this.defaultMediaId) != null ? str16.equals(getWhasappTemplates.defaultMediaId) : getWhasappTemplates.defaultMediaId == null) && ((list2 = this.defaultVariableMap) != null ? list2.equals(getWhasappTemplates.defaultVariableMap) : getWhasappTemplates.defaultVariableMap == null) && ((str17 = this.templateId) != null ? str17.equals(getWhasappTemplates.templateId) : getWhasappTemplates.templateId == null) && ((list3 = this.tags) != null ? list3.equals(getWhasappTemplates.tags) : getWhasappTemplates.tags == null) && ((bool = this.isSample) != null ? bool.equals(getWhasappTemplates.isSample) : getWhasappTemplates.isSample == null) && ((str18 = this.messageType) != null ? str18.equals(getWhasappTemplates.messageType) : getWhasappTemplates.messageType == null) && ((str19 = this.messageSubType) != null ? str19.equals(getWhasappTemplates.messageSubType) : getWhasappTemplates.messageSubType == null) && ((str20 = this.text) != null ? str20.equals(getWhasappTemplates.text) : getWhasappTemplates.text == null) && ((str21 = this.locationObjectToSend) != null ? str21.equals(getWhasappTemplates.locationObjectToSend) : getWhasappTemplates.locationObjectToSend == null) && ((str22 = this.headerText) != null ? str22.equals(getWhasappTemplates.headerText) : getWhasappTemplates.headerText == null) && ((str23 = this.footerText) != null ? str23.equals(getWhasappTemplates.footerText) : getWhasappTemplates.footerText == null) && ((str24 = this.headerType) != null ? str24.equals(getWhasappTemplates.headerType) : getWhasappTemplates.headerType == null) && ((actionInteractive = this.actionInteractive) != null ? actionInteractive.equals(getWhasappTemplates.actionInteractive) : getWhasappTemplates.actionInteractive == null) && ((str25 = this.messageTemplateQualityNew) != null ? str25.equals(getWhasappTemplates.messageTemplateQualityNew) : getWhasappTemplates.messageTemplateQualityNew == null) && ((str26 = this.messageTemplateQualityPrevious) != null ? str26.equals(getWhasappTemplates.messageTemplateQualityPrevious) : getWhasappTemplates.messageTemplateQualityPrevious == null) && ((str27 = this.messageTemplateQualityUpdatedAt) != null ? str27.equals(getWhasappTemplates.messageTemplateQualityUpdatedAt) : getWhasappTemplates.messageTemplateQualityUpdatedAt == null) && ((str28 = this.messageTemplateStatusUpdatedAt) != null ? str28.equals(getWhasappTemplates.messageTemplateStatusUpdatedAt) : getWhasappTemplates.messageTemplateStatusUpdatedAt == null) && ((str29 = this.stausUpdateReason) != null ? str29.equals(getWhasappTemplates.stausUpdateReason) : getWhasappTemplates.stausUpdateReason == null) && ((str30 = this.otherDetail) != null ? str30.equals(getWhasappTemplates.otherDetail) : getWhasappTemplates.otherDetail == null) && ((str31 = this.lastUsed) != null ? str31.equals(getWhasappTemplates.lastUsed) : getWhasappTemplates.lastUsed == null) && ((str32 = this.createdAt) != null ? str32.equals(getWhasappTemplates.createdAt) : getWhasappTemplates.createdAt == null) && ((str33 = this.updatedAt) != null ? str33.equals(getWhasappTemplates.updatedAt) : getWhasappTemplates.updatedAt == null)) {
                DefaultMedia defaultMedia = this.defaultMedia;
                DefaultMedia defaultMedia2 = getWhasappTemplates.defaultMedia;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.GetWhasappTemplates.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetWhasappTemplates.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetWhasappTemplates.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetWhasappTemplates.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetWhasappTemplates.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], GetWhasappTemplates.this.whatsappBusinessAccount);
                    responseWriter.writeString(responseFieldArr[4], GetWhasappTemplates.this.templateType);
                    responseWriter.writeString(responseFieldArr[5], GetWhasappTemplates.this.snippetType);
                    responseWriter.writeString(responseFieldArr[6], GetWhasappTemplates.this.platform);
                    responseWriter.writeString(responseFieldArr[7], GetWhasappTemplates.this.name);
                    responseWriter.writeList(responseFieldArr[8], GetWhasappTemplates.this.components, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.GetWhasappTemplates.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Component) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[9], GetWhasappTemplates.this.language);
                    responseWriter.writeString(responseFieldArr[10], GetWhasappTemplates.this.status);
                    responseWriter.writeString(responseFieldArr[11], GetWhasappTemplates.this.category);
                    responseWriter.writeString(responseFieldArr[12], GetWhasappTemplates.this.subCategory);
                    responseWriter.writeString(responseFieldArr[13], GetWhasappTemplates.this.snippetCategory);
                    responseWriter.writeString(responseFieldArr[14], GetWhasappTemplates.this.snippetSubCategory);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], GetWhasappTemplates.this.createdBy);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], GetWhasappTemplates.this.updatedBy);
                    responseWriter.writeString(responseFieldArr[17], GetWhasappTemplates.this.archivedStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], GetWhasappTemplates.this.archivedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], GetWhasappTemplates.this.defaultMediaId);
                    responseWriter.writeList(responseFieldArr[20], GetWhasappTemplates.this.defaultVariableMap, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.GetWhasappTemplates.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((DefaultVariableMap) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[21], GetWhasappTemplates.this.templateId);
                    responseWriter.writeList(responseFieldArr[22], GetWhasappTemplates.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.GetWhasappTemplates.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeBoolean(responseFieldArr[23], GetWhasappTemplates.this.isSample);
                    responseWriter.writeString(responseFieldArr[24], GetWhasappTemplates.this.messageType);
                    responseWriter.writeString(responseFieldArr[25], GetWhasappTemplates.this.messageSubType);
                    responseWriter.writeString(responseFieldArr[26], GetWhasappTemplates.this.text);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], GetWhasappTemplates.this.locationObjectToSend);
                    responseWriter.writeString(responseFieldArr[28], GetWhasappTemplates.this.headerText);
                    responseWriter.writeString(responseFieldArr[29], GetWhasappTemplates.this.footerText);
                    responseWriter.writeString(responseFieldArr[30], GetWhasappTemplates.this.headerType);
                    ResponseField responseField = responseFieldArr[31];
                    ActionInteractive actionInteractive = GetWhasappTemplates.this.actionInteractive;
                    responseWriter.writeObject(responseField, actionInteractive != null ? actionInteractive.marshaller() : null);
                    responseWriter.writeString(responseFieldArr[32], GetWhasappTemplates.this.messageTemplateQualityNew);
                    responseWriter.writeString(responseFieldArr[33], GetWhasappTemplates.this.messageTemplateQualityPrevious);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[34], GetWhasappTemplates.this.messageTemplateQualityUpdatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[35], GetWhasappTemplates.this.messageTemplateStatusUpdatedAt);
                    responseWriter.writeString(responseFieldArr[36], GetWhasappTemplates.this.stausUpdateReason);
                    responseWriter.writeString(responseFieldArr[37], GetWhasappTemplates.this.otherDetail);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], GetWhasappTemplates.this.lastUsed);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[39], GetWhasappTemplates.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[40], GetWhasappTemplates.this.updatedAt);
                    ResponseField responseField2 = responseFieldArr[41];
                    DefaultMedia defaultMedia = GetWhasappTemplates.this.defaultMedia;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWhasappTemplatesQuery.Variables.1
    ...
    public GetWhasappTemplatesQuery(String str) {
    ...
    public String operationId() {
        return "563286a4844a7ecb6d6f1b1f74a444f0554923a767b4191cb19cdcebebf0a6e7";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetWhasappTemplates($id: ID!) {\n  getWhasappTemplates(id: $id) {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
