...
public final class DeleteCommentMutation implements Mutation<Data, Data, Variables> {
    ...
    public static class Account {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.Account.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[15], Account.this.productOrService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.Account.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[39], Account.this.permissions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.Account.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[45], Account.this.salesmaxSalesContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.Account.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[46], Account.this.salesmaxSupportContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.Account.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[51], Account.this.relatedAccountIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.Account.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class Activity {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.Activity.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Activity.$responseFields;
    ...
    public static final class Builder {
        ...
        private DeleteCommentInput input;

        public DeleteCommentMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteCommentMutation(this.input, this.condition);
        }

        public Builder condition(ModelCommentConditionInput modelCommentConditionInput) {
            this.condition = modelCommentConditionInput;
            return this;
        }

        public Builder input(DeleteCommentInput deleteCommentInput) {
    ...
    public static class ChildEngagements {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.ChildEngagements.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ChildEngagements.$responseFields;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteComment", "deleteComment", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteComment.Mapper deleteCommentFieldMapper = new DeleteComment.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteComment) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteComment>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteComment read(ResponseReader responseReader2) {
                        return Mapper.this.deleteCommentFieldMapper.map(responseReader2);
                    }
                }));
            }
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteComment deleteComment2 = ((Data) obj).deleteComment;
            return deleteComment == null ? deleteComment2 == null : deleteComment.equals(deleteComment2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteComment deleteComment = this.deleteComment;
                this.$hashCode = (deleteComment == null ? 0 : deleteComment.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteComment deleteComment = Data.this.deleteComment;
                    responseWriter.writeObject(responseField, deleteComment != null ? deleteComment.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteComment=" + this.deleteComment + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class DeleteComment {
        ...
        public static final class Mapper implements ResponseFieldMapper<DeleteComment> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public DeleteComment map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = DeleteComment.$responseFields;
                return new DeleteComment(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), responseReader.readList(responseFieldArr[4], new ResponseReader.ListReader<Mentioned>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.DeleteComment.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Mentioned read(ResponseReader.ListItemReader listItemReader) {
                        return (Mentioned) listItemReader.readObject(new ResponseReader.ObjectReader<Mentioned>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.DeleteComment.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), responseReader.readString(responseFieldArr[5]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[8]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[9]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[10]), (Account) responseReader.readObject(responseFieldArr[11], new ResponseReader.ObjectReader<Account>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.DeleteComment.Mapper.2
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public Account read(ResponseReader responseReader2) {
                        return Mapper.this.accountFieldMapper.map(responseReader2);
                    }
                }), (Engagement) responseReader.readObject(responseFieldArr[12], new ResponseReader.ObjectReader<Engagement>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.DeleteComment.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public Engagement read(ResponseReader responseReader2) {
                        return Mapper.this.engagementFieldMapper.map(responseReader2);
                    }
                }), (Activity) responseReader.readObject(responseFieldArr[13], new ResponseReader.ObjectReader<Activity>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.DeleteComment.Mapper.4
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public Activity read(ResponseReader responseReader2) {
                        return Mapper.this.activityFieldMapper.map(responseReader2);
                    }
                }), (ChildEngagements) responseReader.readObject(responseFieldArr[14], new ResponseReader.ObjectReader<ChildEngagements>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.DeleteComment.Mapper.5
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), (UserCommenting) responseReader.readObject(responseFieldArr[15], new ResponseReader.ObjectReader<UserCommenting>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.DeleteComment.Mapper.6
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public DeleteComment(String str, String str2, String str3, String str4, List<Mentioned> list, String str5, String str6, String str7, String str8, String str9, String str10, Account account, Engagement engagement, Activity activity, ChildEngagements childEngagements, UserCommenting userCommenting) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (this.__typename.equals(deleteComment.__typename) && this.id.equals(deleteComment.id) && this.accountId.equals(deleteComment.accountId) && this.ownerId.equals(deleteComment.ownerId) && ((list = this.mentioned) != null ? list.equals(deleteComment.mentioned) : deleteComment.mentioned == null) && this.body.equals(deleteComment.body) && ((str = this.engagementId) != null ? str.equals(deleteComment.engagementId) : deleteComment.engagementId == null) && ((str2 = this.activityId) != null ? str2.equals(deleteComment.activityId) : deleteComment.activityId == null) && ((str3 = this.parentEngagementId) != null ? str3.equals(deleteComment.parentEngagementId) : deleteComment.parentEngagementId == null) && ((str4 = this.createdAt) != null ? str4.equals(deleteComment.createdAt) : deleteComment.createdAt == null) && ((str5 = this.updatedAt) != null ? str5.equals(deleteComment.updatedAt) : deleteComment.updatedAt == null) && ((account = this.account) != null ? account.equals(deleteComment.account) : deleteComment.account == null) && ((engagement = this.engagement) != null ? engagement.equals(deleteComment.engagement) : deleteComment.engagement == null) && ((activity = this.activity) != null ? activity.equals(deleteComment.activity) : deleteComment.activity == null) && ((childEngagements = this.childEngagements) != null ? childEngagements.equals(deleteComment.childEngagements) : deleteComment.childEngagements == null)) {
                UserCommenting userCommenting = this.userCommenting;
                UserCommenting userCommenting2 = deleteComment.userCommenting;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.DeleteComment.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteComment.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteComment.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteComment.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteComment.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], DeleteComment.this.ownerId);
                    responseWriter.writeList(responseFieldArr[4], DeleteComment.this.mentioned, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.DeleteComment.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Mentioned) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[5], DeleteComment.this.body);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], DeleteComment.this.engagementId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], DeleteComment.this.activityId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], DeleteComment.this.parentEngagementId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], DeleteComment.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[10], DeleteComment.this.updatedAt);
                    ResponseField responseField = responseFieldArr[11];
                    Account account = DeleteComment.this.account;
                    ...
                    Engagement engagement = DeleteComment.this.engagement;
                    ...
                    Activity activity = DeleteComment.this.activity;
                    ...
                    ChildEngagements childEngagements = DeleteComment.this.childEngagements;
                    ...
                    UserCommenting userCommenting = DeleteComment.this.userCommenting;
    ...
    public static class Engagement {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.Engagement.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Engagement.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[67], Engagement.this.taskEngagementActions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.Engagement.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
    ...
    public static class Mentioned {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.Mentioned.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Mentioned.$responseFields;
    ...
    public static class UserCommenting {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.UserCommenting.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UserCommenting.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        private final ModelCommentConditionInput condition;
        private final DeleteCommentInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteCommentInput deleteCommentInput, ModelCommentConditionInput modelCommentConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteCommentInput;
            this.condition = modelCommentConditionInput;
            linkedHashMap.put("input", deleteCommentInput);
            linkedHashMap.put("condition", modelCommentConditionInput);
        }

        public ModelCommentConditionInput condition() {
            return this.condition;
        }

        public DeleteCommentInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCommentMutation.Variables.1
    ...
    public DeleteCommentMutation(DeleteCommentInput deleteCommentInput, ModelCommentConditionInput modelCommentConditionInput) {
        Utils.checkNotNull(deleteCommentInput, "input == null");
        this.variables = new Variables(deleteCommentInput, modelCommentConditionInput);
    }
    ...
    public String operationId() {
        return "071331c12f15231544b111f7fa27a06f6846be88a66a7275e48c634343758136";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteComment($input: DeleteCommentInput!, $condition: ModelCommentConditionInput) {\n  deleteComment(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    ownerId\n    mentioned {\n      __typename\n      entityType\n      entityId\n    }\n    body\n    engagementId\n    activityId\n    parentEngagementId\n    createdAt\n    updatedAt\n    account {\n      __typename\n      id\n      accountName\n      accountType\n      deviceKey\n      deviceKeyLastUpdated\n      accountStatus\n      businessLogoUrl\n      createdById\n      dateFormat\n      dateTimeViewStyle\n      defaultCurrency\n      denomination\n      industry\n      nameOfBusiness\n      productOrService\n      timeFormat\n      timeZone\n      plan\n      paidUpTo\n      seats\n      freeSeats\n      currentTotalUsers\n      currentActiveUsers\n      extraActiveUsers\n      pricePerSeat\n      allowAddingSeat\n      allowAddingSeatTill\n      seatReductionMarkedForNextCycle\n      billingCurrency\n      billingEmail\n      taxId\n      taxIdType\n      trialAccountEndDate\n      trialExtensionTimes\n      eligibleForExtension\n      paidForTillDate\n      updatedById\n      website\n      permissions\n      enableCustomCharts\n      createdAt\n      updatedAt\n      dealMode\n      openAiApiKey\n      salesmaxSalesContacts\n      salesmaxSupportContacts\n      chatWidgetConfig\n      onboardingStatus\n      integrationNeeded\n      matchingDealId\n      relatedAccountIds\n      lastChurnDate\n      lastChurnReason\n      possibleReactivationDate\n      locationPeriodicFrequency\n      lastPaymentDataId\n      lastPaymentDataCreatedAt\n      nextRenewalDateIfPaid\n      lastPaymentStatus\n      partPaymentAmountIfAny\n    }\n    engagement {\n      __typename\n      id\n      accountId\n      engagementType\n      contactId\n      primaryTeamId\n      toBeAssigned\n      ownerId\n      contactPrimaryTeamId\n      contactOwnerId\n      addedById\n      updatedById\n      callStatus\n      engagementStatus\n      parentEngagementId\n      nextStepTaskId\n      syncStatus\n      externalNumber\n      userNumber\n      callDirection\n      callConnectStatus\n      callStartTime\n      callEndTime\n      durationInMillis\n      callOutcome\n      callOutcomeNature\n      callRecordingExternalResource\n      noteHeading\n      noteAdditionMethod\n      voiceNoteUrl\n      body\n      isManualTask\n      taskHeading\n      taskType\n      taskActivityType\n      taskInputNote\n      taskPriority\n      taskCompletionNote\n      taskCompletionTime\n      taskCompletionType\n      dueDateTime\n      nextFollowUpOn\n      nextFollowUpSetBy\n      reminderDateTime\n      callRecordingUrl\n      callTranscriptUrl\n      callTranscriptSummary\n      uploadedFiledUrl\n      visitTime\n      visitNote\n      visitOutcome\n      visitOutcomeNature\n      videoCallPlatform\n      videoCallLink\n      meetingName\n      meetingCode\n      videoCallMetadata\n      videoCallOutcome\n      paymentDataId\n      calendarEventId\n      calendarName\n      campaignId\n      campaignRun\n      engagementSourceType\n      engagementSource\n      engagementSourceLevelTwo\n      systemAction\n      taskEngagementActions\n      taskEngagementActionsUpdatedAt\n      firstTaskEngagementActionOn\n      taskEngagementActionCount\n      customCallOutcomeData\n      customVisitOutcomeData\n      customTaskCompletionData\n      customTaskInputData\n      customVideoCallInputData\n      deviceId\n      totalCallDuration\n      cloudProviderNumber\n      hangupReason\n      cloudProvider\n      callType\n      phoneCallLogId\n      externalEventRecordId\n      createdAt\n      updatedAt\n    }\n    activity {\n      __typename\n      id\n      threadId\n      accountId\n      activityRelatedObjectType\n      activityRelatedObjectId\n      activityCategory\n      activityType\n      body\n      note\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      createdAt\n      updatedAt\n    }\n    childEngagements {\n      __typename\n      nextToken\n    }\n    userCommenting {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
