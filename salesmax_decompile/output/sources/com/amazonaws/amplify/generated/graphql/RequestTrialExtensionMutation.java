...
public final class RequestTrialExtensionMutation implements Mutation<Data, Data, Variables> {
    ...
    public static class AccountStats {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.AccountStats.1
    ...
    public static final class Builder {
        ...
        public RequestTrialExtensionMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new RequestTrialExtensionMutation(this.input);
        }
    ...
    public static class CreatedByUser {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.CreatedByUser.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreatedByUser.$responseFields;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("requestTrialExtension", "requestTrialExtension", new UnmodifiableMapBuilder(1).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final RequestTrialExtension requestTrialExtension;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final RequestTrialExtension.Mapper requestTrialExtensionFieldMapper = new RequestTrialExtension.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((RequestTrialExtension) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<RequestTrialExtension>() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public RequestTrialExtension read(ResponseReader responseReader2) {
                        return Mapper.this.requestTrialExtensionFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(RequestTrialExtension requestTrialExtension) {
            this.requestTrialExtension = requestTrialExtension;
        }
        ...
        public boolean equals(Object obj) {
            ...
            RequestTrialExtension requestTrialExtension = this.requestTrialExtension;
            RequestTrialExtension requestTrialExtension2 = ((Data) obj).requestTrialExtension;
            return requestTrialExtension == null ? requestTrialExtension2 == null : requestTrialExtension.equals(requestTrialExtension2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                RequestTrialExtension requestTrialExtension = this.requestTrialExtension;
                this.$hashCode = (requestTrialExtension == null ? 0 : requestTrialExtension.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    RequestTrialExtension requestTrialExtension = Data.this.requestTrialExtension;
                    responseWriter.writeObject(responseField, requestTrialExtension != null ? requestTrialExtension.marshaller() : null);
                }
            };
        }

        public RequestTrialExtension requestTrialExtension() {
            return this.requestTrialExtension;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{requestTrialExtension=" + this.requestTrialExtension + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class LastPaymentData {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.LastPaymentData.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = LastPaymentData.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[17], LastPaymentData.this.paidByContactIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.LastPaymentData.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], LastPaymentData.this.transactionId, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.LastPaymentData.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class MatchingDeal {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.MatchingDeal.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = MatchingDeal.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[17], MatchingDeal.this.transitionSummary, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.MatchingDeal.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], MatchingDeal.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.MatchingDeal.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[21], MatchingDeal.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.MatchingDeal.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class RequestTrialExtension {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<RequestTrialExtension> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public RequestTrialExtension map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = RequestTrialExtension.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String string2 = responseReader.readString(responseFieldArr[2]);
                String string3 = responseReader.readString(responseFieldArr[3]);
                ...
                return new RequestTrialExtension(string, str, string2, accountTypeValueOf, string4, str2, string5 != null ? AccountStatus.valueOf(string5) : null, responseReader.readString(responseFieldArr[7]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[8]), responseReader.readString(responseFieldArr[9]), responseReader.readString(responseFieldArr[10]), responseReader.readString(responseFieldArr[11]), responseReader.readString(responseFieldArr[12]), responseReader.readString(responseFieldArr[13]), responseReader.readString(responseFieldArr[14]), responseReader.readList(responseFieldArr[15], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.Mapper.1
                    ...
                    public WorkingHour read(ResponseReader.ListItemReader listItemReader) {
                        return (WorkingHour) listItemReader.readObject(new ResponseReader.ObjectReader<WorkingHour>() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.Mapper.2.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), responseReader.readList(responseFieldArr[40], new ResponseReader.ListReader<WebPreference>() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public WebPreference read(ResponseReader.ListItemReader listItemReader) {
                        return (WebPreference) listItemReader.readObject(new ResponseReader.ObjectReader<WebPreference>() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.Mapper.3.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), responseReader.readList(responseFieldArr[41], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.AWSJSON);
                    }
                ...
                }), responseReader.readList(responseFieldArr[48], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.Mapper.6
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                ...
                }), (AccountStats) responseReader.readObject(responseFieldArr[54], new ResponseReader.ObjectReader<AccountStats>() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.Mapper.8
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), (LastPaymentData) responseReader.readObject(responseFieldArr[65], new ResponseReader.ObjectReader<LastPaymentData>() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.Mapper.10
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), (MatchingDeal) responseReader.readObject(responseFieldArr[66], new ResponseReader.ObjectReader<MatchingDeal>() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.Mapper.11
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public MatchingDeal read(ResponseReader responseReader2) {
                        return Mapper.this.matchingDealFieldMapper.map(responseReader2);
                    }
                }), (CreatedByUser) responseReader.readObject(responseFieldArr[67], new ResponseReader.ObjectReader<CreatedByUser>() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.Mapper.12
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreatedByUser read(ResponseReader responseReader2) {
                        return Mapper.this.createdByUserFieldMapper.map(responseReader2);
                    }
                }), (UpdatedByUser) responseReader.readObject(responseFieldArr[68], new ResponseReader.ObjectReader<UpdatedByUser>() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.Mapper.13
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof RequestTrialExtension)) {
                return false;
            }
            RequestTrialExtension requestTrialExtension = (RequestTrialExtension) obj;
            if (this.__typename.equals(requestTrialExtension.__typename) && this.id.equals(requestTrialExtension.id) && this.accountName.equals(requestTrialExtension.accountName) && this.accountType.equals(requestTrialExtension.accountType) && ((str = this.deviceKey) != null ? str.equals(requestTrialExtension.deviceKey) : requestTrialExtension.deviceKey == null) && ((str2 = this.deviceKeyLastUpdated) != null ? str2.equals(requestTrialExtension.deviceKeyLastUpdated) : requestTrialExtension.deviceKeyLastUpdated == null) && ((accountStatus = this.accountStatus) != null ? accountStatus.equals(requestTrialExtension.accountStatus) : requestTrialExtension.accountStatus == null) && ((str3 = this.businessLogoUrl) != null ? str3.equals(requestTrialExtension.businessLogoUrl) : requestTrialExtension.businessLogoUrl == null) && ((str4 = this.createdById) != null ? str4.equals(requestTrialExtension.createdById) : requestTrialExtension.createdById == null) && ((str5 = this.dateFormat) != null ? str5.equals(requestTrialExtension.dateFormat) : requestTrialExtension.dateFormat == null) && ((str6 = this.dateTimeViewStyle) != null ? str6.equals(requestTrialExtension.dateTimeViewStyle) : requestTrialExtension.dateTimeViewStyle == null) && ((str7 = this.defaultCurrency) != null ? str7.equals(requestTrialExtension.defaultCurrency) : requestTrialExtension.defaultCurrency == null) && ((str8 = this.denomination) != null ? str8.equals(requestTrialExtension.denomination) : requestTrialExtension.denomination == null) && ((str9 = this.industry) != null ? str9.equals(requestTrialExtension.industry) : requestTrialExtension.industry == null) && ((str10 = this.nameOfBusiness) != null ? str10.equals(requestTrialExtension.nameOfBusiness) : requestTrialExtension.nameOfBusiness == null) && ((list = this.productOrService) != null ? list.equals(requestTrialExtension.productOrService) : requestTrialExtension.productOrService == null) && ((str11 = this.timeFormat) != null ? str11.equals(requestTrialExtension.timeFormat) : requestTrialExtension.timeFormat == null) && ((str12 = this.timeZone) != null ? str12.equals(requestTrialExtension.timeZone) : requestTrialExtension.timeZone == null) && ((str13 = this.plan) != null ? str13.equals(requestTrialExtension.plan) : requestTrialExtension.plan == null) && ((str14 = this.paidUpTo) != null ? str14.equals(requestTrialExtension.paidUpTo) : requestTrialExtension.paidUpTo == null) && ((num = this.seats) != null ? num.equals(requestTrialExtension.seats) : requestTrialExtension.seats == null) && ((num2 = this.freeSeats) != null ? num2.equals(requestTrialExtension.freeSeats) : requestTrialExtension.freeSeats == null) && ((num3 = this.currentTotalUsers) != null ? num3.equals(requestTrialExtension.currentTotalUsers) : requestTrialExtension.currentTotalUsers == null) && ((num4 = this.currentActiveUsers) != null ? num4.equals(requestTrialExtension.currentActiveUsers) : requestTrialExtension.currentActiveUsers == null) && ((num5 = this.extraActiveUsers) != null ? num5.equals(requestTrialExtension.extraActiveUsers) : requestTrialExtension.extraActiveUsers == null) && ((num6 = this.pricePerSeat) != null ? num6.equals(requestTrialExtension.pricePerSeat) : requestTrialExtension.pricePerSeat == null) && ((bool = this.allowAddingSeat) != null ? bool.equals(requestTrialExtension.allowAddingSeat) : requestTrialExtension.allowAddingSeat == null) && ((str15 = this.allowAddingSeatTill) != null ? str15.equals(requestTrialExtension.allowAddingSeatTill) : requestTrialExtension.allowAddingSeatTill == null) && ((num7 = this.seatReductionMarkedForNextCycle) != null ? num7.equals(requestTrialExtension.seatReductionMarkedForNextCycle) : requestTrialExtension.seatReductionMarkedForNextCycle == null) && ((str16 = this.billingCurrency) != null ? str16.equals(requestTrialExtension.billingCurrency) : requestTrialExtension.billingCurrency == null) && ((str17 = this.billingEmail) != null ? str17.equals(requestTrialExtension.billingEmail) : requestTrialExtension.billingEmail == null) && ((str18 = this.taxId) != null ? str18.equals(requestTrialExtension.taxId) : requestTrialExtension.taxId == null) && ((str19 = this.taxIdType) != null ? str19.equals(requestTrialExtension.taxIdType) : requestTrialExtension.taxIdType == null) && ((str20 = this.trialAccountEndDate) != null ? str20.equals(requestTrialExtension.trialAccountEndDate) : requestTrialExtension.trialAccountEndDate == null) && ((num8 = this.trialExtensionTimes) != null ? num8.equals(requestTrialExtension.trialExtensionTimes) : requestTrialExtension.trialExtensionTimes == null) && ((bool2 = this.eligibleForExtension) != null ? bool2.equals(requestTrialExtension.eligibleForExtension) : requestTrialExtension.eligibleForExtension == null) && ((str21 = this.paidForTillDate) != null ? str21.equals(requestTrialExtension.paidForTillDate) : requestTrialExtension.paidForTillDate == null) && ((str22 = this.updatedById) != null ? str22.equals(requestTrialExtension.updatedById) : requestTrialExtension.updatedById == null) && ((str23 = this.website) != null ? str23.equals(requestTrialExtension.website) : requestTrialExtension.website == null) && ((list2 = this.workingHours) != null ? list2.equals(requestTrialExtension.workingHours) : requestTrialExtension.workingHours == null) && ((list3 = this.webPreferences) != null ? list3.equals(requestTrialExtension.webPreferences) : requestTrialExtension.webPreferences == null) && ((list4 = this.permissions) != null ? list4.equals(requestTrialExtension.permissions) : requestTrialExtension.permissions == null) && ((bool3 = this.enableCustomCharts) != null ? bool3.equals(requestTrialExtension.enableCustomCharts) : requestTrialExtension.enableCustomCharts == null) && ((str24 = this.createdAt) != null ? str24.equals(requestTrialExtension.createdAt) : requestTrialExtension.createdAt == null) && ((str25 = this.updatedAt) != null ? str25.equals(requestTrialExtension.updatedAt) : requestTrialExtension.updatedAt == null) && ((str26 = this.dealMode) != null ? str26.equals(requestTrialExtension.dealMode) : requestTrialExtension.dealMode == null) && ((str27 = this.openAiApiKey) != null ? str27.equals(requestTrialExtension.openAiApiKey) : requestTrialExtension.openAiApiKey == null) && ((list5 = this.salesmaxSalesContacts) != null ? list5.equals(requestTrialExtension.salesmaxSalesContacts) : requestTrialExtension.salesmaxSalesContacts == null) && ((list6 = this.salesmaxSupportContacts) != null ? list6.equals(requestTrialExtension.salesmaxSupportContacts) : requestTrialExtension.salesmaxSupportContacts == null) && ((str28 = this.chatWidgetConfig) != null ? str28.equals(requestTrialExtension.chatWidgetConfig) : requestTrialExtension.chatWidgetConfig == null) && ((str29 = this.onboardingStatus) != null ? str29.equals(requestTrialExtension.onboardingStatus) : requestTrialExtension.onboardingStatus == null) && ((str30 = this.integrationNeeded) != null ? str30.equals(requestTrialExtension.integrationNeeded) : requestTrialExtension.integrationNeeded == null) && ((str31 = this.matchingDealId) != null ? str31.equals(requestTrialExtension.matchingDealId) : requestTrialExtension.matchingDealId == null) && ((list7 = this.relatedAccountIds) != null ? list7.equals(requestTrialExtension.relatedAccountIds) : requestTrialExtension.relatedAccountIds == null) && ((accountStats = this.accountStats) != null ? accountStats.equals(requestTrialExtension.accountStats) : requestTrialExtension.accountStats == null) && ((str32 = this.lastChurnDate) != null ? str32.equals(requestTrialExtension.lastChurnDate) : requestTrialExtension.lastChurnDate == null) && ((str33 = this.lastChurnReason) != null ? str33.equals(requestTrialExtension.lastChurnReason) : requestTrialExtension.lastChurnReason == null) && ((str34 = this.possibleReactivationDate) != null ? str34.equals(requestTrialExtension.possibleReactivationDate) : requestTrialExtension.possibleReactivationDate == null) && ((d = this.locationPeriodicFrequency) != null ? d.equals(requestTrialExtension.locationPeriodicFrequency) : requestTrialExtension.locationPeriodicFrequency == null) && ((str35 = this.lastPaymentDataId) != null ? str35.equals(requestTrialExtension.lastPaymentDataId) : requestTrialExtension.lastPaymentDataId == null) && ((str36 = this.lastPaymentDataCreatedAt) != null ? str36.equals(requestTrialExtension.lastPaymentDataCreatedAt) : requestTrialExtension.lastPaymentDataCreatedAt == null) && ((str37 = this.nextRenewalDateIfPaid) != null ? str37.equals(requestTrialExtension.nextRenewalDateIfPaid) : requestTrialExtension.nextRenewalDateIfPaid == null) && ((str38 = this.lastPaymentStatus) != null ? str38.equals(requestTrialExtension.lastPaymentStatus) : requestTrialExtension.lastPaymentStatus == null) && ((num9 = this.partPaymentAmountIfAny) != null ? num9.equals(requestTrialExtension.partPaymentAmountIfAny) : requestTrialExtension.partPaymentAmountIfAny == null) && ((subscriptions = this.subscriptions) != null ? subscriptions.equals(requestTrialExtension.subscriptions) : requestTrialExtension.subscriptions == null) && ((lastPaymentData = this.lastPaymentData) != null ? lastPaymentData.equals(requestTrialExtension.lastPaymentData) : requestTrialExtension.lastPaymentData == null) && ((matchingDeal = this.matchingDeal) != null ? matchingDeal.equals(requestTrialExtension.matchingDeal) : requestTrialExtension.matchingDeal == null) && ((createdByUser = this.createdByUser) != null ? createdByUser.equals(requestTrialExtension.createdByUser) : requestTrialExtension.createdByUser == null)) {
                UpdatedByUser updatedByUser = this.updatedByUser;
                UpdatedByUser updatedByUser2 = requestTrialExtension.updatedByUser;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = RequestTrialExtension.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], RequestTrialExtension.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], RequestTrialExtension.this.id);
                    responseWriter.writeString(responseFieldArr[2], RequestTrialExtension.this.accountName);
                    responseWriter.writeString(responseFieldArr[3], RequestTrialExtension.this.accountType.name());
                    responseWriter.writeString(responseFieldArr[4], RequestTrialExtension.this.deviceKey);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], RequestTrialExtension.this.deviceKeyLastUpdated);
                    ResponseField responseField = responseFieldArr[6];
                    AccountStatus accountStatus = RequestTrialExtension.this.accountStatus;
                    responseWriter.writeString(responseField, accountStatus != null ? accountStatus.name() : null);
                    responseWriter.writeString(responseFieldArr[7], RequestTrialExtension.this.businessLogoUrl);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], RequestTrialExtension.this.createdById);
                    responseWriter.writeString(responseFieldArr[9], RequestTrialExtension.this.dateFormat);
                    responseWriter.writeString(responseFieldArr[10], RequestTrialExtension.this.dateTimeViewStyle);
                    responseWriter.writeString(responseFieldArr[11], RequestTrialExtension.this.defaultCurrency);
                    responseWriter.writeString(responseFieldArr[12], RequestTrialExtension.this.denomination);
                    responseWriter.writeString(responseFieldArr[13], RequestTrialExtension.this.industry);
                    responseWriter.writeString(responseFieldArr[14], RequestTrialExtension.this.nameOfBusiness);
                    responseWriter.writeList(responseFieldArr[15], RequestTrialExtension.this.productOrService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[16], RequestTrialExtension.this.timeFormat);
                    responseWriter.writeString(responseFieldArr[17], RequestTrialExtension.this.timeZone);
                    responseWriter.writeString(responseFieldArr[18], RequestTrialExtension.this.plan);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], RequestTrialExtension.this.paidUpTo);
                    responseWriter.writeInt(responseFieldArr[20], RequestTrialExtension.this.seats);
                    responseWriter.writeInt(responseFieldArr[21], RequestTrialExtension.this.freeSeats);
                    responseWriter.writeInt(responseFieldArr[22], RequestTrialExtension.this.currentTotalUsers);
                    responseWriter.writeInt(responseFieldArr[23], RequestTrialExtension.this.currentActiveUsers);
                    responseWriter.writeInt(responseFieldArr[24], RequestTrialExtension.this.extraActiveUsers);
                    responseWriter.writeInt(responseFieldArr[25], RequestTrialExtension.this.pricePerSeat);
                    responseWriter.writeBoolean(responseFieldArr[26], RequestTrialExtension.this.allowAddingSeat);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], RequestTrialExtension.this.allowAddingSeatTill);
                    responseWriter.writeInt(responseFieldArr[28], RequestTrialExtension.this.seatReductionMarkedForNextCycle);
                    responseWriter.writeString(responseFieldArr[29], RequestTrialExtension.this.billingCurrency);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[30], RequestTrialExtension.this.billingEmail);
                    responseWriter.writeString(responseFieldArr[31], RequestTrialExtension.this.taxId);
                    responseWriter.writeString(responseFieldArr[32], RequestTrialExtension.this.taxIdType);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[33], RequestTrialExtension.this.trialAccountEndDate);
                    responseWriter.writeInt(responseFieldArr[34], RequestTrialExtension.this.trialExtensionTimes);
                    responseWriter.writeBoolean(responseFieldArr[35], RequestTrialExtension.this.eligibleForExtension);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[36], RequestTrialExtension.this.paidForTillDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[37], RequestTrialExtension.this.updatedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], RequestTrialExtension.this.website);
                    responseWriter.writeList(responseFieldArr[39], RequestTrialExtension.this.workingHours, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((WorkingHour) obj).marshaller());
                        }
                    });
                    responseWriter.writeList(responseFieldArr[40], RequestTrialExtension.this.webPreferences, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((WebPreference) obj).marshaller());
                        }
                    });
                    responseWriter.writeList(responseFieldArr[41], RequestTrialExtension.this.permissions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    });
                    responseWriter.writeBoolean(responseFieldArr[42], RequestTrialExtension.this.enableCustomCharts);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[43], RequestTrialExtension.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[44], RequestTrialExtension.this.updatedAt);
                    responseWriter.writeString(responseFieldArr[45], RequestTrialExtension.this.dealMode);
                    responseWriter.writeString(responseFieldArr[46], RequestTrialExtension.this.openAiApiKey);
                    responseWriter.writeList(responseFieldArr[47], RequestTrialExtension.this.salesmaxSalesContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[48], RequestTrialExtension.this.salesmaxSupportContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[49], RequestTrialExtension.this.chatWidgetConfig);
                    responseWriter.writeString(responseFieldArr[50], RequestTrialExtension.this.onboardingStatus);
                    responseWriter.writeString(responseFieldArr[51], RequestTrialExtension.this.integrationNeeded);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[52], RequestTrialExtension.this.matchingDealId);
                    responseWriter.writeList(responseFieldArr[53], RequestTrialExtension.this.relatedAccountIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.RequestTrialExtension.1.7
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    ...
                    AccountStats accountStats = RequestTrialExtension.this.accountStats;
                    responseWriter.writeObject(responseField2, accountStats != null ? accountStats.marshaller() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[55], RequestTrialExtension.this.lastChurnDate);
                    responseWriter.writeString(responseFieldArr[56], RequestTrialExtension.this.lastChurnReason);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[57], RequestTrialExtension.this.possibleReactivationDate);
                    responseWriter.writeDouble(responseFieldArr[58], RequestTrialExtension.this.locationPeriodicFrequency);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[59], RequestTrialExtension.this.lastPaymentDataId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[60], RequestTrialExtension.this.lastPaymentDataCreatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[61], RequestTrialExtension.this.nextRenewalDateIfPaid);
                    responseWriter.writeString(responseFieldArr[62], RequestTrialExtension.this.lastPaymentStatus);
                    responseWriter.writeInt(responseFieldArr[63], RequestTrialExtension.this.partPaymentAmountIfAny);
                    ResponseField responseField3 = responseFieldArr[64];
                    Subscriptions subscriptions = RequestTrialExtension.this.subscriptions;
                    ...
                    LastPaymentData lastPaymentData = RequestTrialExtension.this.lastPaymentData;
                    ...
                    MatchingDeal matchingDeal = RequestTrialExtension.this.matchingDeal;
                    ...
                    CreatedByUser createdByUser = RequestTrialExtension.this.createdByUser;
                    ...
                    UpdatedByUser updatedByUser = RequestTrialExtension.this.updatedByUser;
    ...
    public static class Subscriptions {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.Subscriptions.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Subscriptions.$responseFields;
    ...
    public static class UpdatedByUser {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.UpdatedByUser.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdatedByUser.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.Variables.1
    ...
    public static class WebPreference {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.WebPreference.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = WebPreference.$responseFields;
    ...
    public static class WorkingHour {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.RequestTrialExtensionMutation.WorkingHour.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = WorkingHour.$responseFields;
    ...
    public RequestTrialExtensionMutation(String str) {
    ...
    public String operationId() {
        return "213289a77982508fc4f90c643437a7d68db0200e2e3b5f280bbed346c4a9a023";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation RequestTrialExtension($input: ID!) {\n  requestTrialExtension(input: $input) {\n    __typename\n    id\n    accountName\n    accountType\n    deviceKey\n    deviceKeyLastUpdated\n    accountStatus\n    businessLogoUrl\n    createdById\n    dateFormat\n    dateTimeViewStyle\n    defaultCurrency\n    denomination\n    industry\n    nameOfBusiness\n    productOrService\n    timeFormat\n    timeZone\n    plan\n    paidUpTo\n    seats\n    freeSeats\n    currentTotalUsers\n    currentActiveUsers\n    extraActiveUsers\n    pricePerSeat\n    allowAddingSeat\n    allowAddingSeatTill\n    seatReductionMarkedForNextCycle\n    billingCurrency\n    billingEmail\n    taxId\n    taxIdType\n    trialAccountEndDate\n    trialExtensionTimes\n    eligibleForExtension\n    paidForTillDate\n    updatedById\n    website\n    workingHours {\n      __typename\n      day\n      startTime\n      endTime\n    }\n    webPreferences {\n      __typename\n      key\n      value\n    }\n    permissions\n    enableCustomCharts\n    createdAt\n    updatedAt\n    dealMode\n    openAiApiKey\n    salesmaxSalesContacts\n    salesmaxSupportContacts\n    chatWidgetConfig\n    onboardingStatus\n    integrationNeeded\n    matchingDealId\n    relatedAccountIds\n    accountStats {\n      __typename\n      callSevenDays\n      wabaConversationSevenDays\n      wabaBroadcastSevenDays\n      paymentSevenDays\n      taskSevenDays\n      callPreviousSevenDays\n      wabaConversationPreviousSevenDays\n      contactCreatedPreviousSevenDays\n      bulkActionsSeventDays\n      bulkActionsSeventDays_BULK_UPLOAD\n      bulkActionsSeventDays_CREATE_TAG\n      bulkActionsSeventDays_CAMPAIGN_WITH_RULE\n      bulkActionsSeventDays_BULK_UPDATE\n      bulkActionsSeventDays_GENERATE_REPORT\n      bulkActionsSeventDays_REMOVE_USER\n      bulkActionsPreviousSeventDays\n      onboardingStepsDone\n    }\n    lastChurnDate\n    lastChurnReason\n    possibleReactivationDate\n    locationPeriodicFrequency\n    lastPaymentDataId\n    lastPaymentDataCreatedAt\n    nextRenewalDateIfPaid\n    lastPaymentStatus\n    partPaymentAmountIfAny\n    subscriptions {\n      __typename\n      nextToken\n    }\n    lastPaymentData {\n      __typename\n      id\n      accountId\n      contactId\n      paymentRequestType\n      engagementId\n      paymentProvider\n      orderIdInPaymentProvider\n      orderId\n      paymentLinkId\n      paymentLinkUrl\n      amount\n      amountPaid\n      currency\n      status\n      lastPaymentStatus\n      finalPaymentDate\n      paidByContactIds\n      transactionId\n      note\n      createdAt\n      updatedAt\n      customPaymentData\n      createdById\n      updatedById\n    }\n    matchingDeal {\n      __typename\n      id\n      accountId\n      name\n      description\n      dealStage\n      dealStageUpdatedAt\n      dealState\n      dealOutcome\n      dealLostReason\n      amount\n      currency\n      createdByUser\n      lastUpdatedByUser\n      ownerId\n      primaryTeamId\n      openTaskDetail\n      transitionSummary\n      recentEngagements\n      recentEngagementsUpdatedAt\n      lastActivity\n      tags\n      customDealData\n      createdAt\n      updatedAt\n    }\n    createdByUser {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedByUser {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
