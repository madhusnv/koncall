...
public final class GetPaymentByOrderIdQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetPaymentByOrderId($orderId: ID, $sortDirection: ModelSortDirection, $filter: ModelPaymentEventFilterInput, $limit: Int, $nextToken: String) {\n  getPaymentByOrderId(orderId: $orderId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      orderId\n      externalOrderId\n      paymentProvider\n      idInPaymentProvider\n      currency\n      amount\n      status\n      note\n      description\n      method\n      international\n      refundStatus\n      amountRefunded\n      error\n      acquirerData\n      createdAt\n      updatedAt\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentByOrderIdQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetPaymentByOrderId";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetPaymentByOrderId($orderId: ID, $sortDirection: ModelSortDirection, $filter: ModelPaymentEventFilterInput, $limit: Int, $nextToken: String) {\n  getPaymentByOrderId(orderId: $orderId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      orderId\n      externalOrderId\n      paymentProvider\n      idInPaymentProvider\n      currency\n      amount\n      status\n      note\n      description\n      method\n      international\n      refundStatus\n      amountRefunded\n      error\n      acquirerData\n      createdAt\n      updatedAt\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetPaymentByOrderIdQuery build() {
            return new GetPaymentByOrderIdQuery(this.orderId, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getPaymentByOrderId", "getPaymentByOrderId", new UnmodifiableMapBuilder(5).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put("orderId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "orderId").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetPaymentByOrderId getPaymentByOrderId;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetPaymentByOrderId.Mapper getPaymentByOrderIdFieldMapper = new GetPaymentByOrderId.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetPaymentByOrderId) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetPaymentByOrderId>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentByOrderIdQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetPaymentByOrderId read(ResponseReader responseReader2) {
                        return Mapper.this.getPaymentByOrderIdFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetPaymentByOrderId getPaymentByOrderId) {
            this.getPaymentByOrderId = getPaymentByOrderId;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetPaymentByOrderId getPaymentByOrderId = this.getPaymentByOrderId;
            GetPaymentByOrderId getPaymentByOrderId2 = ((Data) obj).getPaymentByOrderId;
            return getPaymentByOrderId == null ? getPaymentByOrderId2 == null : getPaymentByOrderId.equals(getPaymentByOrderId2);
        }

        public GetPaymentByOrderId getPaymentByOrderId() {
            return this.getPaymentByOrderId;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetPaymentByOrderId getPaymentByOrderId = this.getPaymentByOrderId;
                this.$hashCode = (getPaymentByOrderId == null ? 0 : getPaymentByOrderId.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentByOrderIdQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetPaymentByOrderId getPaymentByOrderId = Data.this.getPaymentByOrderId;
                    responseWriter.writeObject(responseField, getPaymentByOrderId != null ? getPaymentByOrderId.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getPaymentByOrderId=" + this.getPaymentByOrderId + "}";
            }
    ...
    public static class GetPaymentByOrderId {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetPaymentByOrderId> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetPaymentByOrderId map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetPaymentByOrderId.$responseFields;
                return new GetPaymentByOrderId(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentByOrderIdQuery.GetPaymentByOrderId.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentByOrderIdQuery.GetPaymentByOrderId.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetPaymentByOrderId(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetPaymentByOrderId)) {
                return false;
            }
            GetPaymentByOrderId getPaymentByOrderId = (GetPaymentByOrderId) obj;
            if (this.__typename.equals(getPaymentByOrderId.__typename) && this.items.equals(getPaymentByOrderId.items)) {
                String str = this.nextToken;
                String str2 = getPaymentByOrderId.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentByOrderIdQuery.GetPaymentByOrderId.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetPaymentByOrderId.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetPaymentByOrderId.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetPaymentByOrderId.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentByOrderIdQuery.GetPaymentByOrderId.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetPaymentByOrderId.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetPaymentByOrderId{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentByOrderIdQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(String str, ModelSortDirection modelSortDirection, ModelPaymentEventFilterInput modelPaymentEventFilterInput, Integer num, String str2) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentByOrderIdQuery.Variables.1
    ...
    public GetPaymentByOrderIdQuery(String str, ModelSortDirection modelSortDirection, ModelPaymentEventFilterInput modelPaymentEventFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelSortDirection, modelPaymentEventFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "13649a02b12dce49b09af4dac3f40f41baaa85e5a8b4ef06c9c4d4b221e86cac";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetPaymentByOrderId($orderId: ID, $sortDirection: ModelSortDirection, $filter: ModelPaymentEventFilterInput, $limit: Int, $nextToken: String) {\n  getPaymentByOrderId(orderId: $orderId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      orderId\n      externalOrderId\n      paymentProvider\n      idInPaymentProvider\n      currency\n      amount\n      status\n      note\n      description\n      method\n      international\n      refundStatus\n      amountRefunded\n      error\n      acquirerData\n      createdAt\n      updatedAt\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    }
