...
public final class SearchWhasappTemplatessQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query SearchWhasappTemplatess($filter: SearchableWhasappTemplatesFilterInput, $sort: SearchableWhasappTemplatesSortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchWhasappTemplatess(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      whatsappBusinessAccount\n      templateType\n      snippetType\n      platform\n      name\n      language\n      status\n      category\n      subCategory\n      snippetCategory\n      snippetSubCategory\n      createdBy\n      updatedBy\n      archivedStatus\n      archivedAt\n      defaultMediaId\n      templateId\n      tags\n      isSample\n      messageType\n      messageSubType\n      text\n      locationObjectToSend\n      headerText\n      footerText\n      headerType\n      messageTemplateQualityNew\n      messageTemplateQualityPrevious\n      messageTemplateQualityUpdatedAt\n      messageTemplateStatusUpdatedAt\n      stausUpdateReason\n      otherDetail\n      lastUsed\n      createdAt\n      updatedAt\n    }\n    nextToken\n    total\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.SearchWhasappTemplatessQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "SearchWhasappTemplatess";
        }
    };
    public static final String QUERY_DOCUMENT = "query SearchWhasappTemplatess($filter: SearchableWhasappTemplatesFilterInput, $sort: SearchableWhasappTemplatesSortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchWhasappTemplatess(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      whatsappBusinessAccount\n      templateType\n      snippetType\n      platform\n      name\n      language\n      status\n      category\n      subCategory\n      snippetCategory\n      snippetSubCategory\n      createdBy\n      updatedBy\n      archivedStatus\n      archivedAt\n      defaultMediaId\n      templateId\n      tags\n      isSample\n      messageType\n      messageSubType\n      text\n      locationObjectToSend\n      headerText\n      footerText\n      headerType\n      messageTemplateQualityNew\n      messageTemplateQualityPrevious\n      messageTemplateQualityUpdatedAt\n      messageTemplateStatusUpdatedAt\n      stausUpdateReason\n      otherDetail\n      lastUsed\n      createdAt\n      updatedAt\n    }\n    nextToken\n    total\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private SearchableWhasappTemplatesFilterInput filter;
        private Integer from;
        private Integer limit;
        private String nextToken;
        private SearchableWhasappTemplatesSortInput sort;

        public SearchWhasappTemplatessQuery build() {
            return new SearchWhasappTemplatessQuery(this.filter, this.sort, this.limit, this.nextToken, this.from);
        }

        public Builder filter(SearchableWhasappTemplatesFilterInput searchableWhasappTemplatesFilterInput) {
            this.filter = searchableWhasappTemplatesFilterInput;
            return this;
        }
        ...
        public Builder sort(SearchableWhasappTemplatesSortInput searchableWhasappTemplatesSortInput) {
            this.sort = searchableWhasappTemplatesSortInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("searchWhasappTemplatess", "searchWhasappTemplatess", new UnmodifiableMapBuilder(5).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put(Constants.MessagePayloadKeys.FROM, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, Constants.MessagePayloadKeys.FROM).build()).put("sort", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sort").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final SearchWhasappTemplatess searchWhasappTemplatess;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final SearchWhasappTemplatess.Mapper searchWhasappTemplatessFieldMapper = new SearchWhasappTemplatess.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((SearchWhasappTemplatess) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<SearchWhasappTemplatess>() { // from class: com.amazonaws.amplify.generated.graphql.SearchWhasappTemplatessQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public SearchWhasappTemplatess read(ResponseReader responseReader2) {
                        return Mapper.this.searchWhasappTemplatessFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(SearchWhasappTemplatess searchWhasappTemplatess) {
            this.searchWhasappTemplatess = searchWhasappTemplatess;
        }
        ...
        public boolean equals(Object obj) {
            ...
            SearchWhasappTemplatess searchWhasappTemplatess = this.searchWhasappTemplatess;
            SearchWhasappTemplatess searchWhasappTemplatess2 = ((Data) obj).searchWhasappTemplatess;
            return searchWhasappTemplatess == null ? searchWhasappTemplatess2 == null : searchWhasappTemplatess.equals(searchWhasappTemplatess2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                SearchWhasappTemplatess searchWhasappTemplatess = this.searchWhasappTemplatess;
                this.$hashCode = (searchWhasappTemplatess == null ? 0 : searchWhasappTemplatess.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchWhasappTemplatessQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    SearchWhasappTemplatess searchWhasappTemplatess = Data.this.searchWhasappTemplatess;
                    responseWriter.writeObject(responseField, searchWhasappTemplatess != null ? searchWhasappTemplatess.marshaller() : null);
                }
            };
        }

        public SearchWhasappTemplatess searchWhasappTemplatess() {
            return this.searchWhasappTemplatess;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{searchWhasappTemplatess=" + this.searchWhasappTemplatess + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchWhasappTemplatessQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[20], Item.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.SearchWhasappTemplatessQuery.Item.1.1
    ...
    public static class SearchWhasappTemplatess {
        ...
        public static final class Mapper implements ResponseFieldMapper<SearchWhasappTemplatess> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public SearchWhasappTemplatess map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = SearchWhasappTemplatess.$responseFields;
                return new SearchWhasappTemplatess(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.SearchWhasappTemplatessQuery.SearchWhasappTemplatess.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.SearchWhasappTemplatessQuery.SearchWhasappTemplatess.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public SearchWhasappTemplatess(String str, List<Item> list, String str2, Integer num) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof SearchWhasappTemplatess)) {
                return false;
            }
            SearchWhasappTemplatess searchWhasappTemplatess = (SearchWhasappTemplatess) obj;
            if (this.__typename.equals(searchWhasappTemplatess.__typename) && this.items.equals(searchWhasappTemplatess.items) && ((str = this.nextToken) != null ? str.equals(searchWhasappTemplatess.nextToken) : searchWhasappTemplatess.nextToken == null)) {
                Integer num = this.total;
                Integer num2 = searchWhasappTemplatess.total;
                if (num == null) {
                    if (num2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchWhasappTemplatessQuery.SearchWhasappTemplatess.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = SearchWhasappTemplatess.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], SearchWhasappTemplatess.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], SearchWhasappTemplatess.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.SearchWhasappTemplatessQuery.SearchWhasappTemplatess.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], SearchWhasappTemplatess.this.nextToken);
                    responseWriter.writeInt(responseFieldArr[3], SearchWhasappTemplatess.this.total);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "SearchWhasappTemplatess{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + ", total=" + this.total + "}";
            }
            return this.$toString;
        }
    ...
    public static final class Variables extends Operation.Variables {
        private final SearchableWhasappTemplatesFilterInput filter;
        private final Integer from;
        private final Integer limit;
        private final String nextToken;
        private final SearchableWhasappTemplatesSortInput sort;
        private final transient Map<String, Object> valueMap;

        public Variables(SearchableWhasappTemplatesFilterInput searchableWhasappTemplatesFilterInput, SearchableWhasappTemplatesSortInput searchableWhasappTemplatesSortInput, Integer num, String str, Integer num2) {
            ...
            this.nextToken = str;
            this.from = num2;
            linkedHashMap.put("filter", searchableWhasappTemplatesFilterInput);
            linkedHashMap.put("sort", searchableWhasappTemplatesSortInput);
        ...
        public SearchableWhasappTemplatesFilterInput filter() {
            return this.filter;
        }
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchWhasappTemplatessQuery.Variables.1
        ...
        public SearchableWhasappTemplatesSortInput sort() {
            return this.sort;
        }
    ...
    public SearchWhasappTemplatessQuery(SearchableWhasappTemplatesFilterInput searchableWhasappTemplatesFilterInput, SearchableWhasappTemplatesSortInput searchableWhasappTemplatesSortInput, Integer num, String str, Integer num2) {
        this.variables = new Variables(searchableWhasappTemplatesFilterInput, searchableWhasappTemplatesSortInput, num, str, num2);
    }
    ...
    public String operationId() {
        return "d856fd211db00126f6f427c7ac285dfed4289e6c3c9559aeb190f63bb1806f5c";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query SearchWhasappTemplatess($filter: SearchableWhasappTemplatesFilterInput, $sort: SearchableWhasappTemplatesSortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchWhasappTemplatess(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      whatsappBusinessAccount\n      templateType\n      snippetType\n      platform\n      name\n      language\n      status\n      category\n      subCategory\n      snippetCategory\n      snippetSubCategory\n      createdBy\n      updatedBy\n      archivedStatus\n      archivedAt\n      defaultMediaId\n      templateId\n      tags\n      isSample\n      messageType\n      messageSubType\n      text\n      locationObjectToSend\n      headerText\n      footerText\n      headerType\n      messageTemplateQualityNew\n      messageTemplateQualityPrevious\n      messageTemplateQualityUpdatedAt\n      messageTemplateStatusUpdatedAt\n      stausUpdateReason\n      otherDetail\n      lastUsed\n      createdAt\n      updatedAt\n    }\n    nextToken\n    total\n  }\n}";
    }
