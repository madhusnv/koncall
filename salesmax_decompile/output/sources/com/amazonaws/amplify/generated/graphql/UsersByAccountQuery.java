...
public final class UsersByAccountQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query UsersByAccount($accountId: ID, $userId: ModelIDKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelAccountMembershipFilterInput, $limit: Int, $nextToken: String) {\n  usersByAccount(accountId: $accountId, userId: $userId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      userId\n      allowedDeviceId\n      designation\n      authorizationLevel\n      signature\n      isBillingMember\n      addedById\n      updatedById\n      addedOn\n      approvedById\n      approvedOn\n      acceptedOn\n      userAccountStatus\n      whatsappApiAccess\n      sharedInboxPermission\n      canInitiateNewConversation\n      canCreateWaCampaigns\n      mapRegisteredMobileNumberToAccount\n      mapSecondaryMobileNumberToAccount\n      accountEmail\n      accountEmailVerified\n      migrateToUserIdOnRemoval\n      prefScreenPop\n      prefSaveBusinessCall\n      prefPostCallDisposition\n      prefDefaultSimToCall\n      prefTrackLocationOnActivity\n      prefUseBusinessWhatsapp\n      prefTrackAllCalls\n      prefTrackAllCallsSpecificSim\n      onLeave\n      onLeaveTill\n      lastViewedChatNotification\n      prefReadOnlyInfo\n      customMemberAttributes\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.UsersByAccountQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "UsersByAccount";
        }
    };
    public static final String QUERY_DOCUMENT = "query UsersByAccount($accountId: ID, $userId: ModelIDKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelAccountMembershipFilterInput, $limit: Int, $nextToken: String) {\n  usersByAccount(accountId: $accountId, userId: $userId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      userId\n      allowedDeviceId\n      designation\n      authorizationLevel\n      signature\n      isBillingMember\n      addedById\n      updatedById\n      addedOn\n      approvedById\n      approvedOn\n      acceptedOn\n      userAccountStatus\n      whatsappApiAccess\n      sharedInboxPermission\n      canInitiateNewConversation\n      canCreateWaCampaigns\n      mapRegisteredMobileNumberToAccount\n      mapSecondaryMobileNumberToAccount\n      accountEmail\n      accountEmailVerified\n      migrateToUserIdOnRemoval\n      prefScreenPop\n      prefSaveBusinessCall\n      prefPostCallDisposition\n      prefDefaultSimToCall\n      prefTrackLocationOnActivity\n      prefUseBusinessWhatsapp\n      prefTrackAllCalls\n      prefTrackAllCallsSpecificSim\n      onLeave\n      onLeaveTill\n      lastViewedChatNotification\n      prefReadOnlyInfo\n      customMemberAttributes\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public UsersByAccountQuery build() {
            return new UsersByAccountQuery(this.accountId, this.userId, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("usersByAccount", "usersByAccount", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("userId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "userId").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final UsersByAccount usersByAccount;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final UsersByAccount.Mapper usersByAccountFieldMapper = new UsersByAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((UsersByAccount) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<UsersByAccount>() { // from class: com.amazonaws.amplify.generated.graphql.UsersByAccountQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UsersByAccount read(ResponseReader responseReader2) {
                        return Mapper.this.usersByAccountFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(UsersByAccount usersByAccount) {
        ...
        public boolean equals(Object obj) {
            ...
            UsersByAccount usersByAccount = this.usersByAccount;
            UsersByAccount usersByAccount2 = ((Data) obj).usersByAccount;
            return usersByAccount == null ? usersByAccount2 == null : usersByAccount.equals(usersByAccount2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                UsersByAccount usersByAccount = this.usersByAccount;
                this.$hashCode = (usersByAccount == null ? 0 : usersByAccount.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UsersByAccountQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    UsersByAccount usersByAccount = Data.this.usersByAccount;
                    responseWriter.writeObject(responseField, usersByAccount != null ? usersByAccount.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{usersByAccount=" + this.usersByAccount + "}";
            }
            return this.$toString;
        }

        public UsersByAccount usersByAccount() {
            return this.usersByAccount;
        }
    }
    ...
    public static class Item {
        ...
        public static final class Mapper implements ResponseFieldMapper<Item> {
            ...
            public Item map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[4], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.UsersByAccountQuery.Item.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UsersByAccountQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[4], Item.this.allowedDeviceId, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UsersByAccountQuery.Item.1.1
    ...
    public static class UsersByAccount {
        ...
        public static final class Mapper implements ResponseFieldMapper<UsersByAccount> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public UsersByAccount map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = UsersByAccount.$responseFields;
                return new UsersByAccount(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.UsersByAccountQuery.UsersByAccount.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.UsersByAccountQuery.UsersByAccount.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public UsersByAccount(String str, List<Item> list, String str2) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof UsersByAccount)) {
                return false;
            }
            UsersByAccount usersByAccount = (UsersByAccount) obj;
            if (this.__typename.equals(usersByAccount.__typename) && this.items.equals(usersByAccount.items)) {
                String str = this.nextToken;
                String str2 = usersByAccount.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UsersByAccountQuery.UsersByAccount.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UsersByAccount.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UsersByAccount.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], UsersByAccount.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UsersByAccountQuery.UsersByAccount.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], UsersByAccount.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "UsersByAccount{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(String str, ModelIDKeyConditionInput modelIDKeyConditionInput, ModelSortDirection modelSortDirection, ModelAccountMembershipFilterInput modelAccountMembershipFilterInput, Integer num, String str2) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UsersByAccountQuery.Variables.1
    ...
    public UsersByAccountQuery(String str, ModelIDKeyConditionInput modelIDKeyConditionInput, ModelSortDirection modelSortDirection, ModelAccountMembershipFilterInput modelAccountMembershipFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelIDKeyConditionInput, modelSortDirection, modelAccountMembershipFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "dcf00a84cf091218539a44c4c1747df8ba189e1dbdd3333fae63c8abe379af70";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query UsersByAccount($accountId: ID, $userId: ModelIDKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelAccountMembershipFilterInput, $limit: Int, $nextToken: String) {\n  usersByAccount(accountId: $accountId, userId: $userId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      userId\n      allowedDeviceId\n      designation\n      authorizationLevel\n      signature\n      isBillingMember\n      addedById\n      updatedById\n      addedOn\n      approvedById\n      approvedOn\n      acceptedOn\n      userAccountStatus\n      whatsappApiAccess\n      sharedInboxPermission\n      canInitiateNewConversation\n      canCreateWaCampaigns\n      mapRegisteredMobileNumberToAccount\n      mapSecondaryMobileNumberToAccount\n      accountEmail\n      accountEmailVerified\n      migrateToUserIdOnRemoval\n      prefScreenPop\n      prefSaveBusinessCall\n      prefPostCallDisposition\n      prefDefaultSimToCall\n      prefTrackLocationOnActivity\n      prefUseBusinessWhatsapp\n      prefTrackAllCalls\n      prefTrackAllCallsSpecificSim\n      onLeave\n      onLeaveTill\n      lastViewedChatNotification\n      prefReadOnlyInfo\n      customMemberAttributes\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
