...
import type.CreateBusinessInput;
import type.CustomType;
import type.ModelBusinessConditionInput;
import type.UserRegistrationStatus;

/* loaded from: classes3.dex */
public final class CreateBusinessMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation CreateBusiness($input: CreateBusinessInput!, $condition: ModelBusinessConditionInput) {\n  createBusiness(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    name\n    addresses {\n      __typename\n      addressType\n      establishmentName\n      area\n      city\n      country\n      googlePlaceId\n      isPrimaryAddress\n      landmark\n      lat\n      lng\n      rawAddressText\n      region\n      state\n      streetAddress\n      zipcode\n    }\n    industry\n    priority\n    website\n    domain\n    logo\n    userDefinedTags\n    addedById\n    updatedById\n    createdAt\n    updatedAt\n    deals {\n      __typename\n      nextToken\n    }\n    contacts {\n      __typename\n      nextToken\n    }\n    addedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.CreateBusinessMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "CreateBusiness";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation CreateBusiness($input: CreateBusinessInput!, $condition: ModelBusinessConditionInput) {\n  createBusiness(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    name\n    addresses {\n      __typename\n      addressType\n      establishmentName\n      area\n      city\n      country\n      googlePlaceId\n      isPrimaryAddress\n      landmark\n      lat\n      lng\n      rawAddressText\n      region\n      state\n      streetAddress\n      zipcode\n    }\n    industry\n    priority\n    website\n    domain\n    logo\n    userDefinedTags\n    addedById\n    updatedById\n    createdAt\n    updatedAt\n    deals {\n      __typename\n      nextToken\n    }\n    contacts {\n      __typename\n      nextToken\n    }\n    addedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    ...
    public static class AddedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateBusinessMutation.AddedBy.1
    ...
    public static class Address {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateBusinessMutation.Address.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Address.$responseFields;
    ...
    public static final class Builder {
        ...
        private CreateBusinessInput input;

        public CreateBusinessMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new CreateBusinessMutation(this.input, this.condition);
        }
        ...
        public Builder input(CreateBusinessInput createBusinessInput) {
            this.input = createBusinessInput;
            return this;
        }
    }
    ...
    public static class Contacts {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateBusinessMutation.Contacts.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Contacts.$responseFields;
    ...
    public static class CreateBusiness {
        ...
        public static final class Mapper implements ResponseFieldMapper<CreateBusiness> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public CreateBusiness map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = CreateBusiness.$responseFields;
                return new CreateBusiness(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), responseReader.readString(responseFieldArr[3]), responseReader.readList(responseFieldArr[4], new ResponseReader.ListReader<Address>() { // from class: com.amazonaws.amplify.generated.graphql.CreateBusinessMutation.CreateBusiness.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Address read(ResponseReader.ListItemReader listItemReader) {
                        return (Address) listItemReader.readObject(new ResponseReader.ObjectReader<Address>() { // from class: com.amazonaws.amplify.generated.graphql.CreateBusinessMutation.CreateBusiness.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
        ...
        public CreateBusiness(String str, String str2, String str3, String str4, List<Address> list, String str5, String str6, String str7, String str8, String str9, List<String> list2, String str10, String str11, String str12, String str13, Deals deals, Contacts contacts, AddedBy addedBy, UpdatedBy updatedBy) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateBusiness)) {
                return false;
            }
            CreateBusiness createBusiness = (CreateBusiness) obj;
            if (this.__typename.equals(createBusiness.__typename) && this.id.equals(createBusiness.id) && this.accountId.equals(createBusiness.accountId) && this.name.equals(createBusiness.name) && ((list = this.addresses) != null ? list.equals(createBusiness.addresses) : createBusiness.addresses == null) && ((str = this.industry) != null ? str.equals(createBusiness.industry) : createBusiness.industry == null) && ((str2 = this.priority) != null ? str2.equals(createBusiness.priority) : createBusiness.priority == null) && ((str3 = this.website) != null ? str3.equals(createBusiness.website) : createBusiness.website == null) && ((str4 = this.domain) != null ? str4.equals(createBusiness.domain) : createBusiness.domain == null) && ((str5 = this.logo) != null ? str5.equals(createBusiness.logo) : createBusiness.logo == null) && ((list2 = this.userDefinedTags) != null ? list2.equals(createBusiness.userDefinedTags) : createBusiness.userDefinedTags == null) && ((str6 = this.addedById) != null ? str6.equals(createBusiness.addedById) : createBusiness.addedById == null) && ((str7 = this.updatedById) != null ? str7.equals(createBusiness.updatedById) : createBusiness.updatedById == null) && ((str8 = this.createdAt) != null ? str8.equals(createBusiness.createdAt) : createBusiness.createdAt == null) && ((str9 = this.updatedAt) != null ? str9.equals(createBusiness.updatedAt) : createBusiness.updatedAt == null) && ((deals = this.deals) != null ? deals.equals(createBusiness.deals) : createBusiness.deals == null) && ((contacts = this.contacts) != null ? contacts.equals(createBusiness.contacts) : createBusiness.contacts == null) && ((addedBy = this.addedBy) != null ? addedBy.equals(createBusiness.addedBy) : createBusiness.addedBy == null)) {
                UpdatedBy updatedBy = this.updatedBy;
                UpdatedBy updatedBy2 = createBusiness.updatedBy;
                if (updatedBy == null) {
                    if (updatedBy2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateBusinessMutation.CreateBusiness.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateBusiness.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateBusiness.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateBusiness.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], CreateBusiness.this.accountId);
                    responseWriter.writeString(responseFieldArr[3], CreateBusiness.this.name);
                    responseWriter.writeList(responseFieldArr[4], CreateBusiness.this.addresses, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateBusinessMutation.CreateBusiness.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Address) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[5], CreateBusiness.this.industry);
                    responseWriter.writeString(responseFieldArr[6], CreateBusiness.this.priority);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], CreateBusiness.this.website);
                    responseWriter.writeString(responseFieldArr[8], CreateBusiness.this.domain);
                    responseWriter.writeString(responseFieldArr[9], CreateBusiness.this.logo);
                    responseWriter.writeList(responseFieldArr[10], CreateBusiness.this.userDefinedTags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateBusinessMutation.CreateBusiness.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], CreateBusiness.this.addedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], CreateBusiness.this.updatedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], CreateBusiness.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], CreateBusiness.this.updatedAt);
                    ResponseField responseField = responseFieldArr[15];
                    Deals deals = CreateBusiness.this.deals;
                    ...
                    Contacts contacts = CreateBusiness.this.contacts;
                    ...
                    AddedBy addedBy = CreateBusiness.this.addedBy;
                    ...
                    UpdatedBy updatedBy = CreateBusiness.this.updatedBy;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createBusiness", "createBusiness", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateBusiness.Mapper createBusinessFieldMapper = new CreateBusiness.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateBusiness) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateBusiness>() { // from class: com.amazonaws.amplify.generated.graphql.CreateBusinessMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateBusiness read(ResponseReader responseReader2) {
                        return Mapper.this.createBusinessFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateBusiness createBusiness) {
            this.createBusiness = createBusiness;
        }

        public CreateBusiness createBusiness() {
        ...
        public boolean equals(Object obj) {
            ...
            CreateBusiness createBusiness = this.createBusiness;
            CreateBusiness createBusiness2 = ((Data) obj).createBusiness;
            return createBusiness == null ? createBusiness2 == null : createBusiness.equals(createBusiness2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateBusiness createBusiness = this.createBusiness;
                this.$hashCode = (createBusiness == null ? 0 : createBusiness.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateBusinessMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateBusiness createBusiness = Data.this.createBusiness;
                    responseWriter.writeObject(responseField, createBusiness != null ? createBusiness.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createBusiness=" + this.createBusiness + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Deals {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateBusinessMutation.Deals.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Deals.$responseFields;
    ...
    public static class UpdatedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateBusinessMutation.UpdatedBy.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdatedBy.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final CreateBusinessInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateBusinessInput createBusinessInput, ModelBusinessConditionInput modelBusinessConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createBusinessInput;
            this.condition = modelBusinessConditionInput;
            linkedHashMap.put("input", createBusinessInput);
        ...
        public CreateBusinessInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateBusinessMutation.Variables.1
    ...
    public CreateBusinessMutation(CreateBusinessInput createBusinessInput, ModelBusinessConditionInput modelBusinessConditionInput) {
        Utils.checkNotNull(createBusinessInput, "input == null");
        this.variables = new Variables(createBusinessInput, modelBusinessConditionInput);
    }
    ...
    public String operationId() {
        return "0bd8ba09f9f7b2403fc1d4cc6cc9dc7711fa73b21a432ab9a32ac30d7b582bb6";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateBusiness($input: CreateBusinessInput!, $condition: ModelBusinessConditionInput) {\n  createBusiness(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    name\n    addresses {\n      __typename\n      addressType\n      establishmentName\n      area\n      city\n      country\n      googlePlaceId\n      isPrimaryAddress\n      landmark\n      lat\n      lng\n      rawAddressText\n      region\n      state\n      streetAddress\n      zipcode\n    }\n    industry\n    priority\n    website\n    domain\n    logo\n    userDefinedTags\n    addedById\n    updatedById\n    createdAt\n    updatedAt\n    deals {\n      __typename\n      nextToken\n    }\n    contacts {\n      __typename\n      nextToken\n    }\n    addedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
