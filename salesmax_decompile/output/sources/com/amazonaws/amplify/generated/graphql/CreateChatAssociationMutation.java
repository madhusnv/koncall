...
import type.CreateChatAssociationInput;
import type.CustomType;
import type.ModelChatAssociationConditionInput;

/* loaded from: classes5.dex */
public final class CreateChatAssociationMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation CreateChatAssociation($input: CreateChatAssociationInput!, $condition: ModelChatAssociationConditionInput) {\n  createChatAssociation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    channelId\n    relatedObjectId\n    relatedObjectType\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatAssociationMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "CreateChatAssociation";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation CreateChatAssociation($input: CreateChatAssociationInput!, $condition: ModelChatAssociationConditionInput) {\n  createChatAssociation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    channelId\n    relatedObjectId\n    relatedObjectType\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelChatAssociationConditionInput condition;
        private CreateChatAssociationInput input;

        public CreateChatAssociationMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new CreateChatAssociationMutation(this.input, this.condition);
        }
        ...
        public Builder input(CreateChatAssociationInput createChatAssociationInput) {
            this.input = createChatAssociationInput;
            return this;
        }
    }
    ...
    public static class Channel {
        ...
        public static final class Mapper implements ResponseFieldMapper<Channel> {
            ...
            public Channel map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[6], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatAssociationMutation.Channel.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatAssociationMutation.Channel.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[6], Channel.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatAssociationMutation.Channel.1.1
    ...
    /* loaded from: classes6.dex */
    public static class CreateChatAssociation {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<CreateChatAssociation> {
            final Channel.Mapper channelFieldMapper = new Channel.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public CreateChatAssociation map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = CreateChatAssociation.$responseFields;
                return new CreateChatAssociation(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (Channel) responseReader.readObject(responseFieldArr[8], new ResponseReader.ObjectReader<Channel>() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatAssociationMutation.CreateChatAssociation.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
        ...
        public CreateChatAssociation(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, Channel channel) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateChatAssociation)) {
                return false;
            }
            CreateChatAssociation createChatAssociation = (CreateChatAssociation) obj;
            if (this.__typename.equals(createChatAssociation.__typename) && this.id.equals(createChatAssociation.id) && this.accountId.equals(createChatAssociation.accountId) && this.channelId.equals(createChatAssociation.channelId) && this.relatedObjectId.equals(createChatAssociation.relatedObjectId) && this.relatedObjectType.equals(createChatAssociation.relatedObjectType) && ((str = this.createdAt) != null ? str.equals(createChatAssociation.createdAt) : createChatAssociation.createdAt == null) && ((str2 = this.updatedAt) != null ? str2.equals(createChatAssociation.updatedAt) : createChatAssociation.updatedAt == null)) {
                Channel channel = this.channel;
                Channel channel2 = createChatAssociation.channel;
                if (channel == null) {
                    if (channel2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatAssociationMutation.CreateChatAssociation.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateChatAssociation.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateChatAssociation.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateChatAssociation.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], CreateChatAssociation.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], CreateChatAssociation.this.channelId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], CreateChatAssociation.this.relatedObjectId);
                    responseWriter.writeString(responseFieldArr[5], CreateChatAssociation.this.relatedObjectType);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], CreateChatAssociation.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], CreateChatAssociation.this.updatedAt);
                    ResponseField responseField = responseFieldArr[8];
                    Channel channel = CreateChatAssociation.this.channel;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "CreateChatAssociation{__typename=" + this.__typename + ", id=" + this.id + ", accountId=" + this.accountId + ", channelId=" + this.channelId + ", relatedObjectId=" + this.relatedObjectId + ", relatedObjectType=" + this.relatedObjectType + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", channel=" + this.channel + "}";
            }
            return this.$toString;
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createChatAssociation", "createChatAssociation", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final CreateChatAssociation createChatAssociation;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateChatAssociation.Mapper createChatAssociationFieldMapper = new CreateChatAssociation.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateChatAssociation) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateChatAssociation>() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatAssociationMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateChatAssociation read(ResponseReader responseReader2) {
                        return Mapper.this.createChatAssociationFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateChatAssociation createChatAssociation) {
            this.createChatAssociation = createChatAssociation;
        }

        public CreateChatAssociation createChatAssociation() {
            return this.createChatAssociation;
        }
        ...
        public boolean equals(Object obj) {
            ...
            CreateChatAssociation createChatAssociation = this.createChatAssociation;
            CreateChatAssociation createChatAssociation2 = ((Data) obj).createChatAssociation;
            return createChatAssociation == null ? createChatAssociation2 == null : createChatAssociation.equals(createChatAssociation2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateChatAssociation createChatAssociation = this.createChatAssociation;
                this.$hashCode = (createChatAssociation == null ? 0 : createChatAssociation.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatAssociationMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateChatAssociation createChatAssociation = Data.this.createChatAssociation;
                    responseWriter.writeObject(responseField, createChatAssociation != null ? createChatAssociation.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createChatAssociation=" + this.createChatAssociation + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final CreateChatAssociationInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateChatAssociationInput createChatAssociationInput, ModelChatAssociationConditionInput modelChatAssociationConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createChatAssociationInput;
            this.condition = modelChatAssociationConditionInput;
            linkedHashMap.put("input", createChatAssociationInput);
        ...
        public CreateChatAssociationInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatAssociationMutation.Variables.1
    ...
    public CreateChatAssociationMutation(CreateChatAssociationInput createChatAssociationInput, ModelChatAssociationConditionInput modelChatAssociationConditionInput) {
        Utils.checkNotNull(createChatAssociationInput, "input == null");
        this.variables = new Variables(createChatAssociationInput, modelChatAssociationConditionInput);
    }
    ...
    public String operationId() {
        return "a81168726dd48fb67dcc5283092a388b3bdd0b5bdcacf521a1459a4a078dc7e9";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateChatAssociation($input: CreateChatAssociationInput!, $condition: ModelChatAssociationConditionInput) {\n  createChatAssociation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    channelId\n    relatedObjectId\n    relatedObjectType\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
