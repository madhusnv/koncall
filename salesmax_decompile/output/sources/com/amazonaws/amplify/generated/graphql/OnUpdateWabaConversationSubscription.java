...
public final class OnUpdateWabaConversationSubscription implements Subscription<Data, Data, Operation.Variables> {
    ...
    public static class Channel {
        ...
        public static final class Mapper implements ResponseFieldMapper<Channel> {
            ...
            public Channel map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[6], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Channel.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Channel.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[6], Channel.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Channel.1.1
    ...
    public static class Contact {
        ...
        public static final class Mapper implements ResponseFieldMapper<Contact> {
            ...
            public Contact map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[5], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Contact.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                ...
                List list2 = responseReader.readList(responseFieldArr[7], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Contact.Mapper.2
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                ...
                List list3 = responseReader.readList(responseFieldArr[34], new ResponseReader.ListReader<Day>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Contact.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                ...
                List list4 = responseReader.readList(responseFieldArr[92], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Contact.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                });
                List list5 = responseReader.readList(responseFieldArr[93], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Contact.Mapper.5
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                ...
                List list6 = responseReader.readList(responseFieldArr[97], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Contact.Mapper.6
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Contact.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Contact.$responseFields;
                    ...
                    responseWriter.writeString(responseField, contactAssignmentStatus != null ? contactAssignmentStatus.name() : null);
                    responseWriter.writeList(responseFieldArr[5], Contact.this.sharedOwners, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Contact.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[7], Contact.this.sharedTeams, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Contact.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[34], Contact.this.preferredContactDays, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Contact.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[92], Contact.this.userDefinedTags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Contact.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[93], Contact.this.productService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Contact.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[97], Contact.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Contact.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("onUpdateWabaConversation", "onUpdateWabaConversation", null, true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnUpdateWabaConversation onUpdateWabaConversation;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final OnUpdateWabaConversation.Mapper onUpdateWabaConversationFieldMapper = new OnUpdateWabaConversation.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((OnUpdateWabaConversation) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<OnUpdateWabaConversation>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public OnUpdateWabaConversation read(ResponseReader responseReader2) {
                        return Mapper.this.onUpdateWabaConversationFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(OnUpdateWabaConversation onUpdateWabaConversation) {
            this.onUpdateWabaConversation = onUpdateWabaConversation;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnUpdateWabaConversation onUpdateWabaConversation = this.onUpdateWabaConversation;
            OnUpdateWabaConversation onUpdateWabaConversation2 = ((Data) obj).onUpdateWabaConversation;
            return onUpdateWabaConversation == null ? onUpdateWabaConversation2 == null : onUpdateWabaConversation.equals(onUpdateWabaConversation2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnUpdateWabaConversation onUpdateWabaConversation = this.onUpdateWabaConversation;
                this.$hashCode = (onUpdateWabaConversation == null ? 0 : onUpdateWabaConversation.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    OnUpdateWabaConversation onUpdateWabaConversation = Data.this.onUpdateWabaConversation;
                    responseWriter.writeObject(responseField, onUpdateWabaConversation != null ? onUpdateWabaConversation.marshaller() : null);
                }
            };
        }

        public OnUpdateWabaConversation onUpdateWabaConversation() {
            return this.onUpdateWabaConversation;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onUpdateWabaConversation=" + this.onUpdateWabaConversation + "}";
            }
            return this.$toString;
        }
    }

    public static class OnUpdateWabaConversation {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<OnUpdateWabaConversation> {
            final Channel.Mapper channelFieldMapper = new Channel.Mapper();
            final Contact.Mapper contactFieldMapper = new Contact.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public OnUpdateWabaConversation map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = OnUpdateWabaConversation.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                ...
                return new OnUpdateWabaConversation(string, str, string2, string3, bool, string4, str2, str3, str4, str5, str6, str7, str8, string5 != null ? MessageSendCategory.valueOf(string5) : null, (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[14]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[15]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[16]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[17]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[18]), (Channel) responseReader.readObject(responseFieldArr[19], new ResponseReader.ObjectReader<Channel>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.OnUpdateWabaConversation.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public Channel read(ResponseReader responseReader2) {
                        return Mapper.this.channelFieldMapper.map(responseReader2);
                    }
                }), (Contact) responseReader.readObject(responseFieldArr[20], new ResponseReader.ObjectReader<Contact>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.OnUpdateWabaConversation.Mapper.2
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnUpdateWabaConversation)) {
                return false;
            }
            OnUpdateWabaConversation onUpdateWabaConversation = (OnUpdateWabaConversation) obj;
            if (this.__typename.equals(onUpdateWabaConversation.__typename) && this.conversationId.equals(onUpdateWabaConversation.conversationId) && ((str = this.originType) != null ? str.equals(onUpdateWabaConversation.originType) : onUpdateWabaConversation.originType == null) && ((str2 = this.category) != null ? str2.equals(onUpdateWabaConversation.category) : onUpdateWabaConversation.category == null) && ((bool = this.isBillable) != null ? bool.equals(onUpdateWabaConversation.isBillable) : onUpdateWabaConversation.isBillable == null) && ((str3 = this.pricingModel) != null ? str3.equals(onUpdateWabaConversation.pricingModel) : onUpdateWabaConversation.pricingModel == null) && ((str4 = this.expirationTimestamp) != null ? str4.equals(onUpdateWabaConversation.expirationTimestamp) : onUpdateWabaConversation.expirationTimestamp == null) && ((str5 = this.recipientId) != null ? str5.equals(onUpdateWabaConversation.recipientId) : onUpdateWabaConversation.recipientId == null) && ((str6 = this.channelId) != null ? str6.equals(onUpdateWabaConversation.channelId) : onUpdateWabaConversation.channelId == null) && ((str7 = this.accountId) != null ? str7.equals(onUpdateWabaConversation.accountId) : onUpdateWabaConversation.accountId == null) && ((str8 = this.wabaAccountId) != null ? str8.equals(onUpdateWabaConversation.wabaAccountId) : onUpdateWabaConversation.wabaAccountId == null) && ((str9 = this.displayPhoneNumber) != null ? str9.equals(onUpdateWabaConversation.displayPhoneNumber) : onUpdateWabaConversation.displayPhoneNumber == null) && ((str10 = this.phoneNumberId) != null ? str10.equals(onUpdateWabaConversation.phoneNumberId) : onUpdateWabaConversation.phoneNumberId == null) && ((messageSendCategory = this.messageSendCategory) != null ? messageSendCategory.equals(onUpdateWabaConversation.messageSendCategory) : onUpdateWabaConversation.messageSendCategory == null) && ((str11 = this.initiatingMessageExternalId) != null ? str11.equals(onUpdateWabaConversation.initiatingMessageExternalId) : onUpdateWabaConversation.initiatingMessageExternalId == null) && ((str12 = this.initiatingMessageId) != null ? str12.equals(onUpdateWabaConversation.initiatingMessageId) : onUpdateWabaConversation.initiatingMessageId == null) && ((str13 = this.conversationInitiatedByUserId) != null ? str13.equals(onUpdateWabaConversation.conversationInitiatedByUserId) : onUpdateWabaConversation.conversationInitiatedByUserId == null) && ((str14 = this.createdAt) != null ? str14.equals(onUpdateWabaConversation.createdAt) : onUpdateWabaConversation.createdAt == null) && ((str15 = this.updatedAt) != null ? str15.equals(onUpdateWabaConversation.updatedAt) : onUpdateWabaConversation.updatedAt == null) && ((channel = this.channel) != null ? channel.equals(onUpdateWabaConversation.channel) : onUpdateWabaConversation.channel == null)) {
                Contact contact = this.contact;
                Contact contact2 = onUpdateWabaConversation.contact;
                if (contact == null) {
                    if (contact2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateWabaConversationSubscription.OnUpdateWabaConversation.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = OnUpdateWabaConversation.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], OnUpdateWabaConversation.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], OnUpdateWabaConversation.this.conversationId);
                    responseWriter.writeString(responseFieldArr[2], OnUpdateWabaConversation.this.originType);
                    responseWriter.writeString(responseFieldArr[3], OnUpdateWabaConversation.this.category);
                    responseWriter.writeBoolean(responseFieldArr[4], OnUpdateWabaConversation.this.isBillable);
                    responseWriter.writeString(responseFieldArr[5], OnUpdateWabaConversation.this.pricingModel);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], OnUpdateWabaConversation.this.expirationTimestamp);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], OnUpdateWabaConversation.this.recipientId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], OnUpdateWabaConversation.this.channelId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], OnUpdateWabaConversation.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[10], OnUpdateWabaConversation.this.wabaAccountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], OnUpdateWabaConversation.this.displayPhoneNumber);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], OnUpdateWabaConversation.this.phoneNumberId);
                    ResponseField responseField = responseFieldArr[13];
                    MessageSendCategory messageSendCategory = OnUpdateWabaConversation.this.messageSendCategory;
                    responseWriter.writeString(responseField, messageSendCategory != null ? messageSendCategory.name() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], OnUpdateWabaConversation.this.initiatingMessageExternalId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], OnUpdateWabaConversation.this.initiatingMessageId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], OnUpdateWabaConversation.this.conversationInitiatedByUserId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], OnUpdateWabaConversation.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], OnUpdateWabaConversation.this.updatedAt);
                    ResponseField responseField2 = responseFieldArr[19];
                    Channel channel = OnUpdateWabaConversation.this.channel;
                    ...
                    Contact contact = OnUpdateWabaConversation.this.contact;
    ...
    public String operationId() {
        return "9fdf990cbd41e760acd47f403e0086f8576cc5b52d416c7447c05e5024ff896f";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "subscription OnUpdateWabaConversation {\n  onUpdateWabaConversation {\n    __typename\n    conversationId\n    originType\n    category\n    isBillable\n    pricingModel\n    expirationTimestamp\n    recipientId\n    channelId\n    accountId\n    wabaAccountId\n    displayPhoneNumber\n    phoneNumberId\n    messageSendCategory\n    initiatingMessageExternalId\n    initiatingMessageId\n    conversationInitiatedByUserId\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    contact {\n      __typename\n      id\n      accountId\n      ownerId\n      toBeAssigned\n      sharedOwners\n      primaryTeamId\n      sharedTeams\n      accountPriority\n      addedById\n      assignedToId\n      blockedForCallById\n      blockedForCallReason\n      blockedForCallUntil\n      callPriority\n      waChatChannelId\n      contactSource\n      contactSourceDrillDownOne\n      contactSourceDrillDownTwo\n      contactSourceDrillDownThree\n      contactSourceDrillDownOneId\n      contactSourceDrillDownTwoId\n      contactSourceDrillDownThreeId\n      contactStatus\n      contactType\n      department\n      designation\n      lastRepeatEnquiryDate\n      lastRepeatEnquirySource\n      gender\n      isDecisionMaker\n      isPrivate\n      lockPeriod\n      name\n      preferredContactDays\n      profilePhotoUrl\n      referredBy\n      salutation\n      seniority\n      updatedById\n      hasTask\n      openTaskActivityType\n      lastCalledTime\n      lastCallDirection\n      lastCallOutcome\n      lastCallOutcomeNature\n      lastCallUserId\n      lastCallDuration\n      lastCallEngagementId\n      lastVisitTime\n      lastVisitOutcome\n      lastVisitOutcomeNature\n      lastVisitUserId\n      lastVisitEngagementId\n      lastEmailTime\n      lastEmailUserId\n      lastEmailEngagementId\n      lastWhatsappTime\n      lastWhatsappUserId\n      lastWhatsappEngagementId\n      lastWabaBroadcastTime\n      lastWabaBroadcastStatus\n      lastWabaBroadcastTemplate\n      lastWabaBroadcastReplyBody\n      lastWabaBroadcastReplyTime\n      lastWabaBroadcastReplyType\n      lastSmsTime\n      lastSmsUserId\n      lastSmsEngagementId\n      lastNoteAddedTime\n      lastNoteUserId\n      lastNoteEngagementId\n      lastTaskDoneTime\n      lastTaskDoneUserId\n      lastTaskDoneEngagementId\n      openTaskCount\n      lastKnownDisposition\n      lastKnownDispositionTime\n      lastLeadAssignmentDateTime\n      lastEngagementFromAccount\n      lastEngagementFromContact\n      freshLeadTag\n      noWorkAfterAssignment\n      needFollowUpTag\n      needFollowUpTagUpdatedAt\n      activeDealStage\n      activeDealStageUpdatedAt\n      dealDescription\n      isCustomer\n      becameCustomerOn\n      unsuccessfulCallAttempts\n      leadCallsNotAnswered\n      userDefinedTags\n      productService\n      bulkUploadReference\n      assignmentMethod\n      whatsappOptInStatus\n      recentEngagements\n      recentEngagementsUpdatedAt\n      openTaskDetail\n      openVideoCallDetail\n      lastClosedTaskDetail\n      lastClosedTaskDetailUpdatedAt\n      latestRemark\n      customAttributes\n      paymentRequestDetail\n      lastPaymentStatus\n      customDataAddedFromAddContactForm\n      leadLifecycleStage\n      leadLifecycleStageSubCategory\n      manualClosedReason\n      lastDealStageType\n      prospectingAttempts\n      totalProspectingAttemptsAcrossRechurn\n      numberOfTimesRechurned\n      lastProspectingDoneOn\n      firstProspectingDoneOn\n      nextProspectingDueOn\n      nextProspectingSetBy\n      nextProspectingNote\n      movedToOpportunityOn\n      movedToClosedOn\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
