...
import type.DeleteWabaAccountInput;
import type.ModelWabaAccountConditionInput;

/* loaded from: classes7.dex */
public final class DeleteWabaAccountMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation DeleteWabaAccount($input: DeleteWabaAccountInput!, $condition: ModelWabaAccountConditionInput) {\n  deleteWabaAccount(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    wabaAccountName\n    accessToken\n    accountId\n    remainingFreeTierConversationsOverall\n    remainingBalanceOverall\n    remainingBalanceBroadcast\n    blockedBalanceOverall\n    blockedBalanceBroadcast\n    promptForPaymentThreshold\n    createdAt\n    updatedAt\n    currentLimitCategory\n    maxDailyConversationPerPhone\n    maxPhoneNumbersPerBusiness\n    maxPhoneNumbersPerWaba\n    restrictionInfo {\n      __typename\n      restrictionType\n      restrictionExpiry\n    }\n    wabaBanState\n    wabaBanDate\n    wabaDecision\n    wabaDecisionTime\n    rejectionReason\n    createdById\n    updatedById\n    wabaPhoneNumbers {\n      __typename\n      nextToken\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWabaAccountMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "DeleteWabaAccount";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation DeleteWabaAccount($input: DeleteWabaAccountInput!, $condition: ModelWabaAccountConditionInput) {\n  deleteWabaAccount(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    wabaAccountName\n    accessToken\n    accountId\n    remainingFreeTierConversationsOverall\n    remainingBalanceOverall\n    remainingBalanceBroadcast\n    blockedBalanceOverall\n    blockedBalanceBroadcast\n    promptForPaymentThreshold\n    createdAt\n    updatedAt\n    currentLimitCategory\n    maxDailyConversationPerPhone\n    maxPhoneNumbersPerBusiness\n    maxPhoneNumbersPerWaba\n    restrictionInfo {\n      __typename\n      restrictionType\n      restrictionExpiry\n    }\n    wabaBanState\n    wabaBanDate\n    wabaDecision\n    wabaDecisionTime\n    rejectionReason\n    createdById\n    updatedById\n    wabaPhoneNumbers {\n      __typename\n      nextToken\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelWabaAccountConditionInput condition;
        private DeleteWabaAccountInput input;

        public DeleteWabaAccountMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new DeleteWabaAccountMutation(this.input, this.condition);
        }
        ...
        public Builder input(DeleteWabaAccountInput deleteWabaAccountInput) {
            this.input = deleteWabaAccountInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteWabaAccount", "deleteWabaAccount", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final DeleteWabaAccount deleteWabaAccount;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteWabaAccount.Mapper deleteWabaAccountFieldMapper = new DeleteWabaAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteWabaAccount) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteWabaAccount>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWabaAccountMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteWabaAccount read(ResponseReader responseReader2) {
                        return Mapper.this.deleteWabaAccountFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteWabaAccount deleteWabaAccount) {
            this.deleteWabaAccount = deleteWabaAccount;
        }

        public DeleteWabaAccount deleteWabaAccount() {
            return this.deleteWabaAccount;
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteWabaAccount deleteWabaAccount = this.deleteWabaAccount;
            DeleteWabaAccount deleteWabaAccount2 = ((Data) obj).deleteWabaAccount;
            return deleteWabaAccount == null ? deleteWabaAccount2 == null : deleteWabaAccount.equals(deleteWabaAccount2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteWabaAccount deleteWabaAccount = this.deleteWabaAccount;
                this.$hashCode = (deleteWabaAccount == null ? 0 : deleteWabaAccount.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWabaAccountMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteWabaAccount deleteWabaAccount = Data.this.deleteWabaAccount;
                    responseWriter.writeObject(responseField, deleteWabaAccount != null ? deleteWabaAccount.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteWabaAccount=" + this.deleteWabaAccount + "}";
            }
            return this.$toString;
        }
    }

    public static class DeleteWabaAccount {
        ...
        public static final class Mapper implements ResponseFieldMapper<DeleteWabaAccount> {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteWabaAccount)) {
                return false;
            }
            DeleteWabaAccount deleteWabaAccount = (DeleteWabaAccount) obj;
            if (this.__typename.equals(deleteWabaAccount.__typename) && this.id.equals(deleteWabaAccount.id) && this.wabaAccountId.equals(deleteWabaAccount.wabaAccountId) && ((str = this.wabaAccountName) != null ? str.equals(deleteWabaAccount.wabaAccountName) : deleteWabaAccount.wabaAccountName == null) && ((str2 = this.accessToken) != null ? str2.equals(deleteWabaAccount.accessToken) : deleteWabaAccount.accessToken == null) && this.accountId.equals(deleteWabaAccount.accountId) && ((num = this.remainingFreeTierConversationsOverall) != null ? num.equals(deleteWabaAccount.remainingFreeTierConversationsOverall) : deleteWabaAccount.remainingFreeTierConversationsOverall == null) && ((d = this.remainingBalanceOverall) != null ? d.equals(deleteWabaAccount.remainingBalanceOverall) : deleteWabaAccount.remainingBalanceOverall == null) && ((d2 = this.remainingBalanceBroadcast) != null ? d2.equals(deleteWabaAccount.remainingBalanceBroadcast) : deleteWabaAccount.remainingBalanceBroadcast == null) && ((d3 = this.blockedBalanceOverall) != null ? d3.equals(deleteWabaAccount.blockedBalanceOverall) : deleteWabaAccount.blockedBalanceOverall == null) && ((d4 = this.blockedBalanceBroadcast) != null ? d4.equals(deleteWabaAccount.blockedBalanceBroadcast) : deleteWabaAccount.blockedBalanceBroadcast == null) && ((d5 = this.promptForPaymentThreshold) != null ? d5.equals(deleteWabaAccount.promptForPaymentThreshold) : deleteWabaAccount.promptForPaymentThreshold == null) && ((str3 = this.createdAt) != null ? str3.equals(deleteWabaAccount.createdAt) : deleteWabaAccount.createdAt == null) && ((str4 = this.updatedAt) != null ? str4.equals(deleteWabaAccount.updatedAt) : deleteWabaAccount.updatedAt == null) && ((str5 = this.currentLimitCategory) != null ? str5.equals(deleteWabaAccount.currentLimitCategory) : deleteWabaAccount.currentLimitCategory == null) && ((num2 = this.maxDailyConversationPerPhone) != null ? num2.equals(deleteWabaAccount.maxDailyConversationPerPhone) : deleteWabaAccount.maxDailyConversationPerPhone == null) && ((num3 = this.maxPhoneNumbersPerBusiness) != null ? num3.equals(deleteWabaAccount.maxPhoneNumbersPerBusiness) : deleteWabaAccount.maxPhoneNumbersPerBusiness == null) && ((num4 = this.maxPhoneNumbersPerWaba) != null ? num4.equals(deleteWabaAccount.maxPhoneNumbersPerWaba) : deleteWabaAccount.maxPhoneNumbersPerWaba == null) && ((list = this.restrictionInfo) != null ? list.equals(deleteWabaAccount.restrictionInfo) : deleteWabaAccount.restrictionInfo == null) && ((str6 = this.wabaBanState) != null ? str6.equals(deleteWabaAccount.wabaBanState) : deleteWabaAccount.wabaBanState == null) && ((str7 = this.wabaBanDate) != null ? str7.equals(deleteWabaAccount.wabaBanDate) : deleteWabaAccount.wabaBanDate == null) && ((str8 = this.wabaDecision) != null ? str8.equals(deleteWabaAccount.wabaDecision) : deleteWabaAccount.wabaDecision == null) && ((str9 = this.wabaDecisionTime) != null ? str9.equals(deleteWabaAccount.wabaDecisionTime) : deleteWabaAccount.wabaDecisionTime == null) && ((str10 = this.rejectionReason) != null ? str10.equals(deleteWabaAccount.rejectionReason) : deleteWabaAccount.rejectionReason == null) && ((str11 = this.createdById) != null ? str11.equals(deleteWabaAccount.createdById) : deleteWabaAccount.createdById == null) && ((str12 = this.updatedById) != null ? str12.equals(deleteWabaAccount.updatedById) : deleteWabaAccount.updatedById == null)) {
                WabaPhoneNumbers wabaPhoneNumbers = this.wabaPhoneNumbers;
                WabaPhoneNumbers wabaPhoneNumbers2 = deleteWabaAccount.wabaPhoneNumbers;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWabaAccountMutation.DeleteWabaAccount.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteWabaAccount.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteWabaAccount.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteWabaAccount.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteWabaAccount.this.wabaAccountId);
                    responseWriter.writeString(responseFieldArr[3], DeleteWabaAccount.this.wabaAccountName);
                    responseWriter.writeString(responseFieldArr[4], DeleteWabaAccount.this.accessToken);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], DeleteWabaAccount.this.accountId);
                    responseWriter.writeInt(responseFieldArr[6], DeleteWabaAccount.this.remainingFreeTierConversationsOverall);
                    responseWriter.writeDouble(responseFieldArr[7], DeleteWabaAccount.this.remainingBalanceOverall);
                    responseWriter.writeDouble(responseFieldArr[8], DeleteWabaAccount.this.remainingBalanceBroadcast);
                    responseWriter.writeDouble(responseFieldArr[9], DeleteWabaAccount.this.blockedBalanceOverall);
                    responseWriter.writeDouble(responseFieldArr[10], DeleteWabaAccount.this.blockedBalanceBroadcast);
                    responseWriter.writeDouble(responseFieldArr[11], DeleteWabaAccount.this.promptForPaymentThreshold);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], DeleteWabaAccount.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], DeleteWabaAccount.this.updatedAt);
                    responseWriter.writeString(responseFieldArr[14], DeleteWabaAccount.this.currentLimitCategory);
                    responseWriter.writeInt(responseFieldArr[15], DeleteWabaAccount.this.maxDailyConversationPerPhone);
                    responseWriter.writeInt(responseFieldArr[16], DeleteWabaAccount.this.maxPhoneNumbersPerBusiness);
                    responseWriter.writeInt(responseFieldArr[17], DeleteWabaAccount.this.maxPhoneNumbersPerWaba);
                    responseWriter.writeList(responseFieldArr[18], DeleteWabaAccount.this.restrictionInfo, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWabaAccountMutation.DeleteWabaAccount.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((RestrictionInfo) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[19], DeleteWabaAccount.this.wabaBanState);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], DeleteWabaAccount.this.wabaBanDate);
                    responseWriter.writeString(responseFieldArr[21], DeleteWabaAccount.this.wabaDecision);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], DeleteWabaAccount.this.wabaDecisionTime);
                    responseWriter.writeString(responseFieldArr[23], DeleteWabaAccount.this.rejectionReason);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[24], DeleteWabaAccount.this.createdById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], DeleteWabaAccount.this.updatedById);
                    ResponseField responseField = responseFieldArr[26];
                    WabaPhoneNumbers wabaPhoneNumbers = DeleteWabaAccount.this.wabaPhoneNumbers;
    ...
    public static class RestrictionInfo {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWabaAccountMutation.RestrictionInfo.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = RestrictionInfo.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final DeleteWabaAccountInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteWabaAccountInput deleteWabaAccountInput, ModelWabaAccountConditionInput modelWabaAccountConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteWabaAccountInput;
            this.condition = modelWabaAccountConditionInput;
            linkedHashMap.put("input", deleteWabaAccountInput);
        ...
        public DeleteWabaAccountInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWabaAccountMutation.Variables.1
    ...
    public static class WabaPhoneNumbers {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteWabaAccountMutation.WabaPhoneNumbers.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = WabaPhoneNumbers.$responseFields;
    ...
    public DeleteWabaAccountMutation(DeleteWabaAccountInput deleteWabaAccountInput, ModelWabaAccountConditionInput modelWabaAccountConditionInput) {
        Utils.checkNotNull(deleteWabaAccountInput, "input == null");
        this.variables = new Variables(deleteWabaAccountInput, modelWabaAccountConditionInput);
    }
    ...
    public String operationId() {
        return "3fcbd18d4ee70d976bca2fbf79d3fb89321c36f37e87618e1abe9db22eba4b09";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteWabaAccount($input: DeleteWabaAccountInput!, $condition: ModelWabaAccountConditionInput) {\n  deleteWabaAccount(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    wabaAccountName\n    accessToken\n    accountId\n    remainingFreeTierConversationsOverall\n    remainingBalanceOverall\n    remainingBalanceBroadcast\n    blockedBalanceOverall\n    blockedBalanceBroadcast\n    promptForPaymentThreshold\n    createdAt\n    updatedAt\n    currentLimitCategory\n    maxDailyConversationPerPhone\n    maxPhoneNumbersPerBusiness\n    maxPhoneNumbersPerWaba\n    restrictionInfo {\n      __typename\n      restrictionType\n      restrictionExpiry\n    }\n    wabaBanState\n    wabaBanDate\n    wabaDecision\n    wabaDecisionTime\n    rejectionReason\n    createdById\n    updatedById\n    wabaPhoneNumbers {\n      __typename\n      nextToken\n    }\n  }\n}";
    }
