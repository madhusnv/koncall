...
import type.CreateCampaignRunInput;
import type.CustomType;
import type.ModelCampaignRunConditionInput;
import type.UserRegistrationStatus;

/* loaded from: classes4.dex */
public final class CreateCampaignRunMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation CreateCampaignRun($input: CreateCampaignRunInput!, $condition: ModelCampaignRunConditionInput) {\n  createCampaignRun(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.CreateCampaignRunMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "CreateCampaignRun";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation CreateCampaignRun($input: CreateCampaignRunInput!, $condition: ModelCampaignRunConditionInput) {\n  createCampaignRun(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelCampaignRunConditionInput condition;
        private CreateCampaignRunInput input;

        public CreateCampaignRunMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new CreateCampaignRunMutation(this.input, this.condition);
        }
        ...
        public Builder input(CreateCampaignRunInput createCampaignRunInput) {
            this.input = createCampaignRunInput;
            return this;
        }
    }
    ...
    public static class Campaign {
        ...
        public static final class Mapper implements ResponseFieldMapper<Campaign> {
            ...
            public Campaign map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[15], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateCampaignRunMutation.Campaign.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateCampaignRunMutation.Campaign.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[15], Campaign.this.daysToSend, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateCampaignRunMutation.Campaign.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[29], Campaign.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateCampaignRunMutation.Campaign.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class CreateCampaignRun {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<CreateCampaignRun> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public CreateCampaignRun map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = CreateCampaignRun.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
        ...
        public CreateCampaignRun(String str, String str2, String str3, String str4, String str5, CampaignType campaignType, String str6, String str7, String str8, String str9, CampaignStatus campaignStatus, String str10, Integer num, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, Integer num7, String str11, String str12, PrimaryTeam primaryTeam, String str13, String str14, Campaign campaign, Owner owner) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateCampaignRun)) {
                return false;
            }
            CreateCampaignRun createCampaignRun = (CreateCampaignRun) obj;
            if (this.__typename.equals(createCampaignRun.__typename) && this.id.equals(createCampaignRun.id) && this.accountId.equals(createCampaignRun.accountId) && this.campaignId.equals(createCampaignRun.campaignId) && ((str = this.campaignName) != null ? str.equals(createCampaignRun.campaignName) : createCampaignRun.campaignName == null) && ((campaignType = this.campaignType) != null ? campaignType.equals(createCampaignRun.campaignType) : createCampaignRun.campaignType == null) && ((str2 = this.campaignChannelIdentifier) != null ? str2.equals(createCampaignRun.campaignChannelIdentifier) : createCampaignRun.campaignChannelIdentifier == null) && this.name.equals(createCampaignRun.name) && ((str3 = this.startDate) != null ? str3.equals(createCampaignRun.startDate) : createCampaignRun.startDate == null) && ((str4 = this.endDate) != null ? str4.equals(createCampaignRun.endDate) : createCampaignRun.endDate == null) && this.status.equals(createCampaignRun.status) && ((str5 = this.systemPauseReason) != null ? str5.equals(createCampaignRun.systemPauseReason) : createCampaignRun.systemPauseReason == null) && ((num = this.leadCount) != null ? num.equals(createCampaignRun.leadCount) : createCampaignRun.leadCount == null) && ((num2 = this.messageCreated) != null ? num2.equals(createCampaignRun.messageCreated) : createCampaignRun.messageCreated == null) && ((num3 = this.sentCount) != null ? num3.equals(createCampaignRun.sentCount) : createCampaignRun.sentCount == null) && ((num4 = this.deliveredCount) != null ? num4.equals(createCampaignRun.deliveredCount) : createCampaignRun.deliveredCount == null) && ((num5 = this.readCount) != null ? num5.equals(createCampaignRun.readCount) : createCampaignRun.readCount == null) && ((num6 = this.repliedCount) != null ? num6.equals(createCampaignRun.repliedCount) : createCampaignRun.repliedCount == null) && ((num7 = this.failedCount) != null ? num7.equals(createCampaignRun.failedCount) : createCampaignRun.failedCount == null) && this.ownerId.equals(createCampaignRun.ownerId) && ((str6 = this.primaryTeamId) != null ? str6.equals(createCampaignRun.primaryTeamId) : createCampaignRun.primaryTeamId == null) && ((primaryTeam = this.primaryTeam) != null ? primaryTeam.equals(createCampaignRun.primaryTeam) : createCampaignRun.primaryTeam == null) && ((str7 = this.createdAt) != null ? str7.equals(createCampaignRun.createdAt) : createCampaignRun.createdAt == null) && ((str8 = this.updatedAt) != null ? str8.equals(createCampaignRun.updatedAt) : createCampaignRun.updatedAt == null) && ((campaign = this.campaign) != null ? campaign.equals(createCampaignRun.campaign) : createCampaignRun.campaign == null)) {
                Owner owner = this.owner;
                Owner owner2 = createCampaignRun.owner;
                if (owner == null) {
                    if (owner2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateCampaignRunMutation.CreateCampaignRun.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateCampaignRun.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateCampaignRun.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateCampaignRun.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], CreateCampaignRun.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], CreateCampaignRun.this.campaignId);
                    responseWriter.writeString(responseFieldArr[4], CreateCampaignRun.this.campaignName);
                    ResponseField responseField = responseFieldArr[5];
                    CampaignType campaignType = CreateCampaignRun.this.campaignType;
                    responseWriter.writeString(responseField, campaignType != null ? campaignType.name() : null);
                    responseWriter.writeString(responseFieldArr[6], CreateCampaignRun.this.campaignChannelIdentifier);
                    responseWriter.writeString(responseFieldArr[7], CreateCampaignRun.this.name);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], CreateCampaignRun.this.startDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], CreateCampaignRun.this.endDate);
                    responseWriter.writeString(responseFieldArr[10], CreateCampaignRun.this.status.name());
                    responseWriter.writeString(responseFieldArr[11], CreateCampaignRun.this.systemPauseReason);
                    responseWriter.writeInt(responseFieldArr[12], CreateCampaignRun.this.leadCount);
                    responseWriter.writeInt(responseFieldArr[13], CreateCampaignRun.this.messageCreated);
                    responseWriter.writeInt(responseFieldArr[14], CreateCampaignRun.this.sentCount);
                    responseWriter.writeInt(responseFieldArr[15], CreateCampaignRun.this.deliveredCount);
                    responseWriter.writeInt(responseFieldArr[16], CreateCampaignRun.this.readCount);
                    responseWriter.writeInt(responseFieldArr[17], CreateCampaignRun.this.repliedCount);
                    responseWriter.writeInt(responseFieldArr[18], CreateCampaignRun.this.failedCount);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], CreateCampaignRun.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], CreateCampaignRun.this.primaryTeamId);
                    ResponseField responseField2 = responseFieldArr[21];
                    PrimaryTeam primaryTeam = CreateCampaignRun.this.primaryTeam;
                    responseWriter.writeObject(responseField2, primaryTeam != null ? primaryTeam.marshaller() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], CreateCampaignRun.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], CreateCampaignRun.this.updatedAt);
                    ResponseField responseField3 = responseFieldArr[24];
                    Campaign campaign = CreateCampaignRun.this.campaign;
                    ...
                    Owner owner = CreateCampaignRun.this.owner;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createCampaignRun", "createCampaignRun", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final CreateCampaignRun createCampaignRun;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateCampaignRun.Mapper createCampaignRunFieldMapper = new CreateCampaignRun.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateCampaignRun) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateCampaignRun>() { // from class: com.amazonaws.amplify.generated.graphql.CreateCampaignRunMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateCampaignRun read(ResponseReader responseReader2) {
                        return Mapper.this.createCampaignRunFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateCampaignRun createCampaignRun) {
            this.createCampaignRun = createCampaignRun;
        }

        public CreateCampaignRun createCampaignRun() {
            return this.createCampaignRun;
        }
        ...
        public boolean equals(Object obj) {
            ...
            CreateCampaignRun createCampaignRun = this.createCampaignRun;
            CreateCampaignRun createCampaignRun2 = ((Data) obj).createCampaignRun;
            return createCampaignRun == null ? createCampaignRun2 == null : createCampaignRun.equals(createCampaignRun2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateCampaignRun createCampaignRun = this.createCampaignRun;
                this.$hashCode = (createCampaignRun == null ? 0 : createCampaignRun.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateCampaignRunMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateCampaignRun createCampaignRun = Data.this.createCampaignRun;
                    responseWriter.writeObject(responseField, createCampaignRun != null ? createCampaignRun.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createCampaignRun=" + this.createCampaignRun + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Owner {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateCampaignRunMutation.Owner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Owner.$responseFields;
    ...
    public static class PrimaryTeam {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateCampaignRunMutation.PrimaryTeam.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = PrimaryTeam.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final CreateCampaignRunInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateCampaignRunInput createCampaignRunInput, ModelCampaignRunConditionInput modelCampaignRunConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createCampaignRunInput;
            this.condition = modelCampaignRunConditionInput;
            linkedHashMap.put("input", createCampaignRunInput);
        ...
        public CreateCampaignRunInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateCampaignRunMutation.Variables.1
    ...
    public CreateCampaignRunMutation(CreateCampaignRunInput createCampaignRunInput, ModelCampaignRunConditionInput modelCampaignRunConditionInput) {
        Utils.checkNotNull(createCampaignRunInput, "input == null");
        this.variables = new Variables(createCampaignRunInput, modelCampaignRunConditionInput);
    }
    ...
    public String operationId() {
        return "ad4e917af9f3c0f4d7a9cb30df14a088a2241eb2b2f0cba4073c4a3b4d10a7b0";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateCampaignRun($input: CreateCampaignRunInput!, $condition: ModelCampaignRunConditionInput) {\n  createCampaignRun(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
