...
public final class GetWabaPhoneNumberNewQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetWabaPhoneNumberNew($id: ID!) {\n  getWabaPhoneNumberNew(id: $id) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaPhoneNumberNewQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetWabaPhoneNumberNew";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetWabaPhoneNumberNew($id: ID!) {\n  getWabaPhoneNumberNew(id: $id) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private String id;

        public GetWabaPhoneNumberNewQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetWabaPhoneNumberNewQuery(this.id);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getWabaPhoneNumberNew", "getWabaPhoneNumberNew", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetWabaPhoneNumberNew getWabaPhoneNumberNew;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetWabaPhoneNumberNew.Mapper getWabaPhoneNumberNewFieldMapper = new GetWabaPhoneNumberNew.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetWabaPhoneNumberNew) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetWabaPhoneNumberNew>() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaPhoneNumberNewQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetWabaPhoneNumberNew read(ResponseReader responseReader2) {
                        return Mapper.this.getWabaPhoneNumberNewFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetWabaPhoneNumberNew getWabaPhoneNumberNew) {
            this.getWabaPhoneNumberNew = getWabaPhoneNumberNew;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetWabaPhoneNumberNew getWabaPhoneNumberNew = this.getWabaPhoneNumberNew;
            GetWabaPhoneNumberNew getWabaPhoneNumberNew2 = ((Data) obj).getWabaPhoneNumberNew;
            return getWabaPhoneNumberNew == null ? getWabaPhoneNumberNew2 == null : getWabaPhoneNumberNew.equals(getWabaPhoneNumberNew2);
        }

        public GetWabaPhoneNumberNew getWabaPhoneNumberNew() {
            return this.getWabaPhoneNumberNew;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetWabaPhoneNumberNew getWabaPhoneNumberNew = this.getWabaPhoneNumberNew;
                this.$hashCode = (getWabaPhoneNumberNew == null ? 0 : getWabaPhoneNumberNew.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaPhoneNumberNewQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetWabaPhoneNumberNew getWabaPhoneNumberNew = Data.this.getWabaPhoneNumberNew;
                    responseWriter.writeObject(responseField, getWabaPhoneNumberNew != null ? getWabaPhoneNumberNew.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getWabaPhoneNumberNew=" + this.getWabaPhoneNumberNew + "}";
            }
    ...
    public static class EntityList {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaPhoneNumberNewQuery.EntityList.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = EntityList.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[34], EntityList.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaPhoneNumberNewQuery.EntityList.1.1
    ...
    public static class GetWabaPhoneNumberNew {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public GetWabaPhoneNumberNew(String str, String str2, String str3, String str4, String str5, String str6, Boolean bool, String str7, String str8, String str9, Integer num, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, String str19, String str20, String str21, String str22, String str23, String str24, String str25, String str26, EntityList entityList) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetWabaPhoneNumberNew)) {
                return false;
            }
            GetWabaPhoneNumberNew getWabaPhoneNumberNew = (GetWabaPhoneNumberNew) obj;
            if (this.__typename.equals(getWabaPhoneNumberNew.__typename) && this.id.equals(getWabaPhoneNumberNew.id) && this.wabaAccountId.equals(getWabaPhoneNumberNew.wabaAccountId) && this.accountId.equals(getWabaPhoneNumberNew.accountId) && this.phoneNumberId.equals(getWabaPhoneNumberNew.phoneNumberId) && this.phoneNumber.equals(getWabaPhoneNumberNew.phoneNumber) && ((bool = this.isDefault) != null ? bool.equals(getWabaPhoneNumberNew.isDefault) : getWabaPhoneNumberNew.isDefault == null) && ((str = this.accessToken) != null ? str.equals(getWabaPhoneNumberNew.accessToken) : getWabaPhoneNumberNew.accessToken == null) && ((str2 = this.name) != null ? str2.equals(getWabaPhoneNumberNew.name) : getWabaPhoneNumberNew.name == null) && ((str3 = this.internalName) != null ? str3.equals(getWabaPhoneNumberNew.internalName) : getWabaPhoneNumberNew.internalName == null) && ((num = this.quota) != null ? num.equals(getWabaPhoneNumberNew.quota) : getWabaPhoneNumberNew.quota == null) && ((str4 = this.currentLimitCategory) != null ? str4.equals(getWabaPhoneNumberNew.currentLimitCategory) : getWabaPhoneNumberNew.currentLimitCategory == null) && ((str5 = this.status) != null ? str5.equals(getWabaPhoneNumberNew.status) : getWabaPhoneNumberNew.status == null) && ((str6 = this.qualityRating) != null ? str6.equals(getWabaPhoneNumberNew.qualityRating) : getWabaPhoneNumberNew.qualityRating == null) && ((str7 = this.entityListId) != null ? str7.equals(getWabaPhoneNumberNew.entityListId) : getWabaPhoneNumberNew.entityListId == null) && ((str8 = this.createdAt) != null ? str8.equals(getWabaPhoneNumberNew.createdAt) : getWabaPhoneNumberNew.createdAt == null) && ((str9 = this.updatedAt) != null ? str9.equals(getWabaPhoneNumberNew.updatedAt) : getWabaPhoneNumberNew.updatedAt == null) && ((str10 = this.welcomeMessage) != null ? str10.equals(getWabaPhoneNumberNew.welcomeMessage) : getWabaPhoneNumberNew.welcomeMessage == null) && ((str11 = this.requestedDisplayName) != null ? str11.equals(getWabaPhoneNumberNew.requestedDisplayName) : getWabaPhoneNumberNew.requestedDisplayName == null) && ((str12 = this.displayNameUpdate) != null ? str12.equals(getWabaPhoneNumberNew.displayNameUpdate) : getWabaPhoneNumberNew.displayNameUpdate == null) && ((str13 = this.displayNameUpdateDateTime) != null ? str13.equals(getWabaPhoneNumberNew.displayNameUpdateDateTime) : getWabaPhoneNumberNew.displayNameUpdateDateTime == null) && ((str14 = this.wabaNumberDecision) != null ? str14.equals(getWabaPhoneNumberNew.wabaNumberDecision) : getWabaPhoneNumberNew.wabaNumberDecision == null) && ((str15 = this.wabaNumberDecisionTime) != null ? str15.equals(getWabaPhoneNumberNew.wabaNumberDecisionTime) : getWabaPhoneNumberNew.wabaNumberDecisionTime == null) && ((str16 = this.rejectionReason) != null ? str16.equals(getWabaPhoneNumberNew.rejectionReason) : getWabaPhoneNumberNew.rejectionReason == null) && ((str17 = this.phoneNumberQualityUpdate) != null ? str17.equals(getWabaPhoneNumberNew.phoneNumberQualityUpdate) : getWabaPhoneNumberNew.phoneNumberQualityUpdate == null) && ((str18 = this.phoneNumberQualityUpdateTime) != null ? str18.equals(getWabaPhoneNumberNew.phoneNumberQualityUpdateTime) : getWabaPhoneNumberNew.phoneNumberQualityUpdateTime == null) && ((str19 = this.createdById) != null ? str19.equals(getWabaPhoneNumberNew.createdById) : getWabaPhoneNumberNew.createdById == null) && ((str20 = this.updatedById) != null ? str20.equals(getWabaPhoneNumberNew.updatedById) : getWabaPhoneNumberNew.updatedById == null)) {
                EntityList entityList = this.entityList;
                EntityList entityList2 = getWabaPhoneNumberNew.entityList;
                if (entityList == null) {
                    if (entityList2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaPhoneNumberNewQuery.GetWabaPhoneNumberNew.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetWabaPhoneNumberNew.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetWabaPhoneNumberNew.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetWabaPhoneNumberNew.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetWabaPhoneNumberNew.this.wabaAccountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], GetWabaPhoneNumberNew.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], GetWabaPhoneNumberNew.this.phoneNumberId);
                    responseWriter.writeString(responseFieldArr[5], GetWabaPhoneNumberNew.this.phoneNumber);
                    responseWriter.writeBoolean(responseFieldArr[6], GetWabaPhoneNumberNew.this.isDefault);
                    responseWriter.writeString(responseFieldArr[7], GetWabaPhoneNumberNew.this.accessToken);
                    responseWriter.writeString(responseFieldArr[8], GetWabaPhoneNumberNew.this.name);
                    responseWriter.writeString(responseFieldArr[9], GetWabaPhoneNumberNew.this.internalName);
                    responseWriter.writeInt(responseFieldArr[10], GetWabaPhoneNumberNew.this.quota);
                    responseWriter.writeString(responseFieldArr[11], GetWabaPhoneNumberNew.this.currentLimitCategory);
                    responseWriter.writeString(responseFieldArr[12], GetWabaPhoneNumberNew.this.status);
                    responseWriter.writeString(responseFieldArr[13], GetWabaPhoneNumberNew.this.qualityRating);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], GetWabaPhoneNumberNew.this.entityListId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], GetWabaPhoneNumberNew.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], GetWabaPhoneNumberNew.this.updatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], GetWabaPhoneNumberNew.this.welcomeMessage);
                    responseWriter.writeString(responseFieldArr[18], GetWabaPhoneNumberNew.this.requestedDisplayName);
                    responseWriter.writeString(responseFieldArr[19], GetWabaPhoneNumberNew.this.displayNameUpdate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], GetWabaPhoneNumberNew.this.displayNameUpdateDateTime);
                    responseWriter.writeString(responseFieldArr[21], GetWabaPhoneNumberNew.this.wabaNumberDecision);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], GetWabaPhoneNumberNew.this.wabaNumberDecisionTime);
                    responseWriter.writeString(responseFieldArr[23], GetWabaPhoneNumberNew.this.rejectionReason);
                    responseWriter.writeString(responseFieldArr[24], GetWabaPhoneNumberNew.this.phoneNumberQualityUpdate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], GetWabaPhoneNumberNew.this.phoneNumberQualityUpdateTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[26], GetWabaPhoneNumberNew.this.createdById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], GetWabaPhoneNumberNew.this.updatedById);
                    ResponseField responseField = responseFieldArr[28];
                    EntityList entityList = GetWabaPhoneNumberNew.this.entityList;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaPhoneNumberNewQuery.Variables.1
    ...
    public GetWabaPhoneNumberNewQuery(String str) {
    ...
    public String operationId() {
        return "2504a57d57f91f715d3d7a2a7ab5bbf3463dcd5c1be3962ecd0b4a679ba9ff69";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetWabaPhoneNumberNew($id: ID!) {\n  getWabaPhoneNumberNew(id: $id) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
