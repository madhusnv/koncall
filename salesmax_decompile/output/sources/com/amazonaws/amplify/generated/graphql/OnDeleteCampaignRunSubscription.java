...
public final class OnDeleteCampaignRunSubscription implements Subscription<Data, Data, Operation.Variables> {
    public static final String OPERATION_DEFINITION = "subscription OnDeleteCampaignRun {\n  onDeleteCampaignRun {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteCampaignRunSubscription.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "OnDeleteCampaignRun";
        }
    };
    public static final String QUERY_DOCUMENT = "subscription OnDeleteCampaignRun {\n  onDeleteCampaignRun {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Operation.Variables variables = Operation.EMPTY_VARIABLES;

    public static final class Builder {
        public OnDeleteCampaignRunSubscription build() {
            return new OnDeleteCampaignRunSubscription();
        }
    }
    ...
    public static class Campaign {
        ...
        public static final class Mapper implements ResponseFieldMapper<Campaign> {
            ...
            public Campaign map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[15], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteCampaignRunSubscription.Campaign.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteCampaignRunSubscription.Campaign.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[15], Campaign.this.daysToSend, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteCampaignRunSubscription.Campaign.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[29], Campaign.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteCampaignRunSubscription.Campaign.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("onDeleteCampaignRun", "onDeleteCampaignRun", null, true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnDeleteCampaignRun onDeleteCampaignRun;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final OnDeleteCampaignRun.Mapper onDeleteCampaignRunFieldMapper = new OnDeleteCampaignRun.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((OnDeleteCampaignRun) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<OnDeleteCampaignRun>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteCampaignRunSubscription.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public OnDeleteCampaignRun read(ResponseReader responseReader2) {
                        return Mapper.this.onDeleteCampaignRunFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(OnDeleteCampaignRun onDeleteCampaignRun) {
            this.onDeleteCampaignRun = onDeleteCampaignRun;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnDeleteCampaignRun onDeleteCampaignRun = this.onDeleteCampaignRun;
            OnDeleteCampaignRun onDeleteCampaignRun2 = ((Data) obj).onDeleteCampaignRun;
            return onDeleteCampaignRun == null ? onDeleteCampaignRun2 == null : onDeleteCampaignRun.equals(onDeleteCampaignRun2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnDeleteCampaignRun onDeleteCampaignRun = this.onDeleteCampaignRun;
                this.$hashCode = (onDeleteCampaignRun == null ? 0 : onDeleteCampaignRun.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteCampaignRunSubscription.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    OnDeleteCampaignRun onDeleteCampaignRun = Data.this.onDeleteCampaignRun;
                    responseWriter.writeObject(responseField, onDeleteCampaignRun != null ? onDeleteCampaignRun.marshaller() : null);
                }
            };
        }

        public OnDeleteCampaignRun onDeleteCampaignRun() {
            return this.onDeleteCampaignRun;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onDeleteCampaignRun=" + this.onDeleteCampaignRun + "}";
            }
            return this.$toString;
        }
    }

    public static class OnDeleteCampaignRun {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<OnDeleteCampaignRun> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public OnDeleteCampaignRun map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = OnDeleteCampaignRun.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
                ...
                }), (Owner) responseReader.readObject(responseFieldArr[25], new ResponseReader.ObjectReader<Owner>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteCampaignRunSubscription.OnDeleteCampaignRun.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public OnDeleteCampaignRun(String str, String str2, String str3, String str4, String str5, CampaignType campaignType, String str6, String str7, String str8, String str9, CampaignStatus campaignStatus, String str10, Integer num, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, Integer num7, String str11, String str12, PrimaryTeam primaryTeam, String str13, String str14, Campaign campaign, Owner owner) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnDeleteCampaignRun)) {
                return false;
            }
            OnDeleteCampaignRun onDeleteCampaignRun = (OnDeleteCampaignRun) obj;
            if (this.__typename.equals(onDeleteCampaignRun.__typename) && this.id.equals(onDeleteCampaignRun.id) && this.accountId.equals(onDeleteCampaignRun.accountId) && this.campaignId.equals(onDeleteCampaignRun.campaignId) && ((str = this.campaignName) != null ? str.equals(onDeleteCampaignRun.campaignName) : onDeleteCampaignRun.campaignName == null) && ((campaignType = this.campaignType) != null ? campaignType.equals(onDeleteCampaignRun.campaignType) : onDeleteCampaignRun.campaignType == null) && ((str2 = this.campaignChannelIdentifier) != null ? str2.equals(onDeleteCampaignRun.campaignChannelIdentifier) : onDeleteCampaignRun.campaignChannelIdentifier == null) && this.name.equals(onDeleteCampaignRun.name) && ((str3 = this.startDate) != null ? str3.equals(onDeleteCampaignRun.startDate) : onDeleteCampaignRun.startDate == null) && ((str4 = this.endDate) != null ? str4.equals(onDeleteCampaignRun.endDate) : onDeleteCampaignRun.endDate == null) && this.status.equals(onDeleteCampaignRun.status) && ((str5 = this.systemPauseReason) != null ? str5.equals(onDeleteCampaignRun.systemPauseReason) : onDeleteCampaignRun.systemPauseReason == null) && ((num = this.leadCount) != null ? num.equals(onDeleteCampaignRun.leadCount) : onDeleteCampaignRun.leadCount == null) && ((num2 = this.messageCreated) != null ? num2.equals(onDeleteCampaignRun.messageCreated) : onDeleteCampaignRun.messageCreated == null) && ((num3 = this.sentCount) != null ? num3.equals(onDeleteCampaignRun.sentCount) : onDeleteCampaignRun.sentCount == null) && ((num4 = this.deliveredCount) != null ? num4.equals(onDeleteCampaignRun.deliveredCount) : onDeleteCampaignRun.deliveredCount == null) && ((num5 = this.readCount) != null ? num5.equals(onDeleteCampaignRun.readCount) : onDeleteCampaignRun.readCount == null) && ((num6 = this.repliedCount) != null ? num6.equals(onDeleteCampaignRun.repliedCount) : onDeleteCampaignRun.repliedCount == null) && ((num7 = this.failedCount) != null ? num7.equals(onDeleteCampaignRun.failedCount) : onDeleteCampaignRun.failedCount == null) && this.ownerId.equals(onDeleteCampaignRun.ownerId) && ((str6 = this.primaryTeamId) != null ? str6.equals(onDeleteCampaignRun.primaryTeamId) : onDeleteCampaignRun.primaryTeamId == null) && ((primaryTeam = this.primaryTeam) != null ? primaryTeam.equals(onDeleteCampaignRun.primaryTeam) : onDeleteCampaignRun.primaryTeam == null) && ((str7 = this.createdAt) != null ? str7.equals(onDeleteCampaignRun.createdAt) : onDeleteCampaignRun.createdAt == null) && ((str8 = this.updatedAt) != null ? str8.equals(onDeleteCampaignRun.updatedAt) : onDeleteCampaignRun.updatedAt == null) && ((campaign = this.campaign) != null ? campaign.equals(onDeleteCampaignRun.campaign) : onDeleteCampaignRun.campaign == null)) {
                Owner owner = this.owner;
                Owner owner2 = onDeleteCampaignRun.owner;
                if (owner == null) {
                    if (owner2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteCampaignRunSubscription.OnDeleteCampaignRun.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = OnDeleteCampaignRun.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], OnDeleteCampaignRun.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], OnDeleteCampaignRun.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], OnDeleteCampaignRun.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], OnDeleteCampaignRun.this.campaignId);
                    responseWriter.writeString(responseFieldArr[4], OnDeleteCampaignRun.this.campaignName);
                    ResponseField responseField = responseFieldArr[5];
                    CampaignType campaignType = OnDeleteCampaignRun.this.campaignType;
                    responseWriter.writeString(responseField, campaignType != null ? campaignType.name() : null);
                    responseWriter.writeString(responseFieldArr[6], OnDeleteCampaignRun.this.campaignChannelIdentifier);
                    responseWriter.writeString(responseFieldArr[7], OnDeleteCampaignRun.this.name);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], OnDeleteCampaignRun.this.startDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], OnDeleteCampaignRun.this.endDate);
                    responseWriter.writeString(responseFieldArr[10], OnDeleteCampaignRun.this.status.name());
                    responseWriter.writeString(responseFieldArr[11], OnDeleteCampaignRun.this.systemPauseReason);
                    responseWriter.writeInt(responseFieldArr[12], OnDeleteCampaignRun.this.leadCount);
                    responseWriter.writeInt(responseFieldArr[13], OnDeleteCampaignRun.this.messageCreated);
                    responseWriter.writeInt(responseFieldArr[14], OnDeleteCampaignRun.this.sentCount);
                    responseWriter.writeInt(responseFieldArr[15], OnDeleteCampaignRun.this.deliveredCount);
                    responseWriter.writeInt(responseFieldArr[16], OnDeleteCampaignRun.this.readCount);
                    responseWriter.writeInt(responseFieldArr[17], OnDeleteCampaignRun.this.repliedCount);
                    responseWriter.writeInt(responseFieldArr[18], OnDeleteCampaignRun.this.failedCount);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], OnDeleteCampaignRun.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], OnDeleteCampaignRun.this.primaryTeamId);
                    ResponseField responseField2 = responseFieldArr[21];
                    PrimaryTeam primaryTeam = OnDeleteCampaignRun.this.primaryTeam;
                    responseWriter.writeObject(responseField2, primaryTeam != null ? primaryTeam.marshaller() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], OnDeleteCampaignRun.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], OnDeleteCampaignRun.this.updatedAt);
                    ResponseField responseField3 = responseFieldArr[24];
                    Campaign campaign = OnDeleteCampaignRun.this.campaign;
                    ...
                    Owner owner = OnDeleteCampaignRun.this.owner;
    ...
    public static class Owner {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteCampaignRunSubscription.Owner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Owner.$responseFields;
    ...
    public static class PrimaryTeam {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteCampaignRunSubscription.PrimaryTeam.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = PrimaryTeam.$responseFields;
    ...
    public String operationId() {
        return "9c4a34a00a5ae7c0bbc3055123e36fdd224b3648da098f1c495505c1bf52d6c3";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "subscription OnDeleteCampaignRun {\n  onDeleteCampaignRun {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
