...
public final class GetWabaPhoneNumberQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetWabaPhoneNumber($id: ID!) {\n  getWabaPhoneNumber(id: $id) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaPhoneNumberQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetWabaPhoneNumber";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetWabaPhoneNumber($id: ID!) {\n  getWabaPhoneNumber(id: $id) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private String id;

        public GetWabaPhoneNumberQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetWabaPhoneNumberQuery(this.id);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getWabaPhoneNumber", "getWabaPhoneNumber", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetWabaPhoneNumber getWabaPhoneNumber;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetWabaPhoneNumber.Mapper getWabaPhoneNumberFieldMapper = new GetWabaPhoneNumber.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetWabaPhoneNumber) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetWabaPhoneNumber>() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaPhoneNumberQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetWabaPhoneNumber read(ResponseReader responseReader2) {
                        return Mapper.this.getWabaPhoneNumberFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetWabaPhoneNumber getWabaPhoneNumber) {
            this.getWabaPhoneNumber = getWabaPhoneNumber;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetWabaPhoneNumber getWabaPhoneNumber = this.getWabaPhoneNumber;
            GetWabaPhoneNumber getWabaPhoneNumber2 = ((Data) obj).getWabaPhoneNumber;
            return getWabaPhoneNumber == null ? getWabaPhoneNumber2 == null : getWabaPhoneNumber.equals(getWabaPhoneNumber2);
        }

        public GetWabaPhoneNumber getWabaPhoneNumber() {
            return this.getWabaPhoneNumber;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetWabaPhoneNumber getWabaPhoneNumber = this.getWabaPhoneNumber;
                this.$hashCode = (getWabaPhoneNumber == null ? 0 : getWabaPhoneNumber.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaPhoneNumberQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetWabaPhoneNumber getWabaPhoneNumber = Data.this.getWabaPhoneNumber;
                    responseWriter.writeObject(responseField, getWabaPhoneNumber != null ? getWabaPhoneNumber.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getWabaPhoneNumber=" + this.getWabaPhoneNumber + "}";
            }
    ...
    public static class EntityList {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaPhoneNumberQuery.EntityList.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = EntityList.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[34], EntityList.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaPhoneNumberQuery.EntityList.1.1
    ...
    public static class GetWabaPhoneNumber {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public GetWabaPhoneNumber(String str, String str2, String str3, String str4, String str5, String str6, Boolean bool, String str7, String str8, String str9, Integer num, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, String str19, String str20, String str21, String str22, String str23, String str24, String str25, String str26, EntityList entityList) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetWabaPhoneNumber)) {
                return false;
            }
            GetWabaPhoneNumber getWabaPhoneNumber = (GetWabaPhoneNumber) obj;
            if (this.__typename.equals(getWabaPhoneNumber.__typename) && this.id.equals(getWabaPhoneNumber.id) && this.wabaAccountId.equals(getWabaPhoneNumber.wabaAccountId) && this.accountId.equals(getWabaPhoneNumber.accountId) && this.phoneNumberId.equals(getWabaPhoneNumber.phoneNumberId) && this.phoneNumber.equals(getWabaPhoneNumber.phoneNumber) && ((bool = this.isDefault) != null ? bool.equals(getWabaPhoneNumber.isDefault) : getWabaPhoneNumber.isDefault == null) && ((str = this.accessToken) != null ? str.equals(getWabaPhoneNumber.accessToken) : getWabaPhoneNumber.accessToken == null) && ((str2 = this.name) != null ? str2.equals(getWabaPhoneNumber.name) : getWabaPhoneNumber.name == null) && ((str3 = this.internalName) != null ? str3.equals(getWabaPhoneNumber.internalName) : getWabaPhoneNumber.internalName == null) && ((num = this.quota) != null ? num.equals(getWabaPhoneNumber.quota) : getWabaPhoneNumber.quota == null) && ((str4 = this.currentLimitCategory) != null ? str4.equals(getWabaPhoneNumber.currentLimitCategory) : getWabaPhoneNumber.currentLimitCategory == null) && ((str5 = this.status) != null ? str5.equals(getWabaPhoneNumber.status) : getWabaPhoneNumber.status == null) && ((str6 = this.qualityRating) != null ? str6.equals(getWabaPhoneNumber.qualityRating) : getWabaPhoneNumber.qualityRating == null) && ((str7 = this.entityListId) != null ? str7.equals(getWabaPhoneNumber.entityListId) : getWabaPhoneNumber.entityListId == null) && ((str8 = this.createdAt) != null ? str8.equals(getWabaPhoneNumber.createdAt) : getWabaPhoneNumber.createdAt == null) && ((str9 = this.updatedAt) != null ? str9.equals(getWabaPhoneNumber.updatedAt) : getWabaPhoneNumber.updatedAt == null) && ((str10 = this.welcomeMessage) != null ? str10.equals(getWabaPhoneNumber.welcomeMessage) : getWabaPhoneNumber.welcomeMessage == null) && ((str11 = this.requestedDisplayName) != null ? str11.equals(getWabaPhoneNumber.requestedDisplayName) : getWabaPhoneNumber.requestedDisplayName == null) && ((str12 = this.displayNameUpdate) != null ? str12.equals(getWabaPhoneNumber.displayNameUpdate) : getWabaPhoneNumber.displayNameUpdate == null) && ((str13 = this.displayNameUpdateDateTime) != null ? str13.equals(getWabaPhoneNumber.displayNameUpdateDateTime) : getWabaPhoneNumber.displayNameUpdateDateTime == null) && ((str14 = this.wabaNumberDecision) != null ? str14.equals(getWabaPhoneNumber.wabaNumberDecision) : getWabaPhoneNumber.wabaNumberDecision == null) && ((str15 = this.wabaNumberDecisionTime) != null ? str15.equals(getWabaPhoneNumber.wabaNumberDecisionTime) : getWabaPhoneNumber.wabaNumberDecisionTime == null) && ((str16 = this.rejectionReason) != null ? str16.equals(getWabaPhoneNumber.rejectionReason) : getWabaPhoneNumber.rejectionReason == null) && ((str17 = this.phoneNumberQualityUpdate) != null ? str17.equals(getWabaPhoneNumber.phoneNumberQualityUpdate) : getWabaPhoneNumber.phoneNumberQualityUpdate == null) && ((str18 = this.phoneNumberQualityUpdateTime) != null ? str18.equals(getWabaPhoneNumber.phoneNumberQualityUpdateTime) : getWabaPhoneNumber.phoneNumberQualityUpdateTime == null) && ((str19 = this.createdById) != null ? str19.equals(getWabaPhoneNumber.createdById) : getWabaPhoneNumber.createdById == null) && ((str20 = this.updatedById) != null ? str20.equals(getWabaPhoneNumber.updatedById) : getWabaPhoneNumber.updatedById == null)) {
                EntityList entityList = this.entityList;
                EntityList entityList2 = getWabaPhoneNumber.entityList;
                if (entityList == null) {
                    if (entityList2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaPhoneNumberQuery.GetWabaPhoneNumber.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetWabaPhoneNumber.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetWabaPhoneNumber.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetWabaPhoneNumber.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetWabaPhoneNumber.this.wabaAccountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], GetWabaPhoneNumber.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], GetWabaPhoneNumber.this.phoneNumberId);
                    responseWriter.writeString(responseFieldArr[5], GetWabaPhoneNumber.this.phoneNumber);
                    responseWriter.writeBoolean(responseFieldArr[6], GetWabaPhoneNumber.this.isDefault);
                    responseWriter.writeString(responseFieldArr[7], GetWabaPhoneNumber.this.accessToken);
                    responseWriter.writeString(responseFieldArr[8], GetWabaPhoneNumber.this.name);
                    responseWriter.writeString(responseFieldArr[9], GetWabaPhoneNumber.this.internalName);
                    responseWriter.writeInt(responseFieldArr[10], GetWabaPhoneNumber.this.quota);
                    responseWriter.writeString(responseFieldArr[11], GetWabaPhoneNumber.this.currentLimitCategory);
                    responseWriter.writeString(responseFieldArr[12], GetWabaPhoneNumber.this.status);
                    responseWriter.writeString(responseFieldArr[13], GetWabaPhoneNumber.this.qualityRating);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], GetWabaPhoneNumber.this.entityListId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], GetWabaPhoneNumber.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], GetWabaPhoneNumber.this.updatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], GetWabaPhoneNumber.this.welcomeMessage);
                    responseWriter.writeString(responseFieldArr[18], GetWabaPhoneNumber.this.requestedDisplayName);
                    responseWriter.writeString(responseFieldArr[19], GetWabaPhoneNumber.this.displayNameUpdate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], GetWabaPhoneNumber.this.displayNameUpdateDateTime);
                    responseWriter.writeString(responseFieldArr[21], GetWabaPhoneNumber.this.wabaNumberDecision);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], GetWabaPhoneNumber.this.wabaNumberDecisionTime);
                    responseWriter.writeString(responseFieldArr[23], GetWabaPhoneNumber.this.rejectionReason);
                    responseWriter.writeString(responseFieldArr[24], GetWabaPhoneNumber.this.phoneNumberQualityUpdate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], GetWabaPhoneNumber.this.phoneNumberQualityUpdateTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[26], GetWabaPhoneNumber.this.createdById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], GetWabaPhoneNumber.this.updatedById);
                    ResponseField responseField = responseFieldArr[28];
                    EntityList entityList = GetWabaPhoneNumber.this.entityList;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetWabaPhoneNumberQuery.Variables.1
    ...
    public GetWabaPhoneNumberQuery(String str) {
    ...
    public String operationId() {
        return "744648565a3e7f47a56d143aaebc4570319da4e01f9b0f4e52ce1534213841ea";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetWabaPhoneNumber($id: ID!) {\n  getWabaPhoneNumber(id: $id) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
