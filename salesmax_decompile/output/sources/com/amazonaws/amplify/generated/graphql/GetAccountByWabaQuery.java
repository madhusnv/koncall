...
public final class GetAccountByWabaQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetAccountByWaba($wabaAccountId: ID, $sortDirection: ModelSortDirection, $filter: ModelWabaAccountFilterInput, $limit: Int, $nextToken: String) {\n  getAccountByWaba(wabaAccountId: $wabaAccountId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      wabaAccountId\n      wabaAccountName\n      accessToken\n      accountId\n      remainingFreeTierConversationsOverall\n      remainingBalanceOverall\n      remainingBalanceBroadcast\n      blockedBalanceOverall\n      blockedBalanceBroadcast\n      promptForPaymentThreshold\n      createdAt\n      updatedAt\n      currentLimitCategory\n      maxDailyConversationPerPhone\n      maxPhoneNumbersPerBusiness\n      maxPhoneNumbersPerWaba\n      wabaBanState\n      wabaBanDate\n      wabaDecision\n      wabaDecisionTime\n      rejectionReason\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountByWabaQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetAccountByWaba";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetAccountByWaba($wabaAccountId: ID, $sortDirection: ModelSortDirection, $filter: ModelWabaAccountFilterInput, $limit: Int, $nextToken: String) {\n  getAccountByWaba(wabaAccountId: $wabaAccountId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      wabaAccountId\n      wabaAccountName\n      accessToken\n      accountId\n      remainingFreeTierConversationsOverall\n      remainingBalanceOverall\n      remainingBalanceBroadcast\n      blockedBalanceOverall\n      blockedBalanceBroadcast\n      promptForPaymentThreshold\n      createdAt\n      updatedAt\n      currentLimitCategory\n      maxDailyConversationPerPhone\n      maxPhoneNumbersPerBusiness\n      maxPhoneNumbersPerWaba\n      wabaBanState\n      wabaBanDate\n      wabaDecision\n      wabaDecisionTime\n      rejectionReason\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetAccountByWabaQuery build() {
            return new GetAccountByWabaQuery(this.wabaAccountId, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getAccountByWaba", "getAccountByWaba", new UnmodifiableMapBuilder(5).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("wabaAccountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "wabaAccountId").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetAccountByWaba getAccountByWaba;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetAccountByWaba.Mapper getAccountByWabaFieldMapper = new GetAccountByWaba.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetAccountByWaba) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetAccountByWaba>() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountByWabaQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetAccountByWaba read(ResponseReader responseReader2) {
                        return Mapper.this.getAccountByWabaFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetAccountByWaba getAccountByWaba) {
            this.getAccountByWaba = getAccountByWaba;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetAccountByWaba getAccountByWaba = this.getAccountByWaba;
            GetAccountByWaba getAccountByWaba2 = ((Data) obj).getAccountByWaba;
            return getAccountByWaba == null ? getAccountByWaba2 == null : getAccountByWaba.equals(getAccountByWaba2);
        }

        public GetAccountByWaba getAccountByWaba() {
            return this.getAccountByWaba;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetAccountByWaba getAccountByWaba = this.getAccountByWaba;
                this.$hashCode = (getAccountByWaba == null ? 0 : getAccountByWaba.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountByWabaQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetAccountByWaba getAccountByWaba = Data.this.getAccountByWaba;
                    responseWriter.writeObject(responseField, getAccountByWaba != null ? getAccountByWaba.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getAccountByWaba=" + this.getAccountByWaba + "}";
            }
            return this.$toString;
        }
    }

    public static class GetAccountByWaba {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetAccountByWaba> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetAccountByWaba map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetAccountByWaba.$responseFields;
                return new GetAccountByWaba(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountByWabaQuery.GetAccountByWaba.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountByWabaQuery.GetAccountByWaba.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetAccountByWaba(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetAccountByWaba)) {
                return false;
            }
            GetAccountByWaba getAccountByWaba = (GetAccountByWaba) obj;
            if (this.__typename.equals(getAccountByWaba.__typename) && this.items.equals(getAccountByWaba.items)) {
                String str = this.nextToken;
                String str2 = getAccountByWaba.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountByWabaQuery.GetAccountByWaba.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetAccountByWaba.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetAccountByWaba.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetAccountByWaba.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountByWabaQuery.GetAccountByWaba.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetAccountByWaba.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetAccountByWaba{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountByWabaQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(String str, ModelSortDirection modelSortDirection, ModelWabaAccountFilterInput modelWabaAccountFilterInput, Integer num, String str2) {
            ...
            this.limit = num;
            this.nextToken = str2;
            linkedHashMap.put("wabaAccountId", str);
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetAccountByWabaQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("wabaAccountId", Variables.this.wabaAccountId);
    ...
    public GetAccountByWabaQuery(String str, ModelSortDirection modelSortDirection, ModelWabaAccountFilterInput modelWabaAccountFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelSortDirection, modelWabaAccountFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "afb7274e9c8747ff03c5a9dbf36959c5cac882b003e3a184197dc6e19cc777c3";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetAccountByWaba($wabaAccountId: ID, $sortDirection: ModelSortDirection, $filter: ModelWabaAccountFilterInput, $limit: Int, $nextToken: String) {\n  getAccountByWaba(wabaAccountId: $wabaAccountId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      wabaAccountId\n      wabaAccountName\n      accessToken\n      accountId\n      remainingFreeTierConversationsOverall\n      remainingBalanceOverall\n      remainingBalanceBroadcast\n      blockedBalanceOverall\n      blockedBalanceBroadcast\n      promptForPaymentThreshold\n      createdAt\n      updatedAt\n      currentLimitCategory\n      maxDailyConversationPerPhone\n      maxPhoneNumbersPerBusiness\n      maxPhoneNumbersPerWaba\n      wabaBanState\n      wabaBanDate\n      wabaDecision\n      wabaDecisionTime\n      rejectionReason\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    }
