...
public final class GetUserAuthorizationQuery implements Query<Data, Data, Variables> {
    ...
    public static class Account {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.Account.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[15], Account.this.productOrService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.Account.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[39], Account.this.permissions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.Account.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[45], Account.this.salesmaxSalesContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.Account.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[46], Account.this.salesmaxSupportContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.Account.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[51], Account.this.relatedAccountIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.Account.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static final class Builder {
        ...
        public GetUserAuthorizationQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetUserAuthorizationQuery(this.id);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getUserAuthorization", "getUserAuthorization", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetUserAuthorization getUserAuthorization;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetUserAuthorization.Mapper getUserAuthorizationFieldMapper = new GetUserAuthorization.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetUserAuthorization) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetUserAuthorization>() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetUserAuthorization read(ResponseReader responseReader2) {
                        return Mapper.this.getUserAuthorizationFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetUserAuthorization getUserAuthorization) {
        ...
        public boolean equals(Object obj) {
            ...
            GetUserAuthorization getUserAuthorization = this.getUserAuthorization;
            GetUserAuthorization getUserAuthorization2 = ((Data) obj).getUserAuthorization;
            return getUserAuthorization == null ? getUserAuthorization2 == null : getUserAuthorization.equals(getUserAuthorization2);
        }

        public GetUserAuthorization getUserAuthorization() {
        ...
        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetUserAuthorization getUserAuthorization = this.getUserAuthorization;
                this.$hashCode = (getUserAuthorization == null ? 0 : getUserAuthorization.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetUserAuthorization getUserAuthorization = Data.this.getUserAuthorization;
                    responseWriter.writeObject(responseField, getUserAuthorization != null ? getUserAuthorization.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getUserAuthorization=" + this.getUserAuthorization + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class DefaultTeam {
        ...
        public static final class Mapper implements ResponseFieldMapper<DefaultTeam> {
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public DefaultTeam map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = DefaultTeam.$responseFields;
        ...
        public DefaultTeam(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DefaultTeam)) {
                return false;
            }
            DefaultTeam defaultTeam = (DefaultTeam) obj;
            if (this.__typename.equals(defaultTeam.__typename) && this.id.equals(defaultTeam.id) && this.accountId.equals(defaultTeam.accountId) && this.createdById.equals(defaultTeam.createdById) && this.description.equals(defaultTeam.description) && this.teamName.equals(defaultTeam.teamName) && this.updatedById.equals(defaultTeam.updatedById) && ((str = this.createdAt) != null ? str.equals(defaultTeam.createdAt) : defaultTeam.createdAt == null)) {
                String str2 = this.updatedAt;
                String str3 = defaultTeam.updatedAt;
                if (str2 == null) {
                    if (str3 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.DefaultTeam.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultTeam.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DefaultTeam.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DefaultTeam.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DefaultTeam.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], DefaultTeam.this.createdById);
                    responseWriter.writeString(responseFieldArr[4], DefaultTeam.this.description);
                    responseWriter.writeString(responseFieldArr[5], DefaultTeam.this.teamName);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], DefaultTeam.this.updatedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], DefaultTeam.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], DefaultTeam.this.updatedAt);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "DefaultTeam{__typename=" + this.__typename + ", id=" + this.id + ", accountId=" + this.accountId + ", createdById=" + this.createdById + ", description=" + this.description + ", teamName=" + this.teamName + ", updatedById=" + this.updatedById + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + "}";
            }
            return this.$toString;
        }
    ...
    public static class GetUserAuthorization {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        final String createdAt;
        final DefaultTeam defaultTeam;
        final String defaultTeamId;
        final String id;
        final List<TeamWiseReportee> teamWiseReportees;
        final List<String> teamsAsLead;
        final List<String> teamsAsReportees;
        final String updatedAt;
        final User user;
        final UserAccountEmail userAccountEmail;
        ...
        public static final class Mapper implements ResponseFieldMapper<GetUserAuthorization> {
            final UserAccountEmail.Mapper userAccountEmailFieldMapper = new UserAccountEmail.Mapper();
            final DefaultTeam.Mapper defaultTeamFieldMapper = new DefaultTeam.Mapper();
            final TeamWiseReportee.Mapper teamWiseReporteeFieldMapper = new TeamWiseReportee.Mapper();
            final Account.Mapper accountFieldMapper = new Account.Mapper();
            final User.Mapper userFieldMapper = new User.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetUserAuthorization map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetUserAuthorization.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                ...
                return new GetUserAuthorization(string, str, str2, userRegistrationStatusValueOf, str3, accountTypeValueOf, accountStatusValueOf, userStatusValueOf, string6 != null ? AuthorizationLevel.valueOf(string6) : null, (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[9]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[10]), (UserAccountEmail) responseReader.readObject(responseFieldArr[11], new ResponseReader.ObjectReader<UserAccountEmail>() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UserAccountEmail read(ResponseReader responseReader2) {
                        return Mapper.this.userAccountEmailFieldMapper.map(responseReader2);
                    }
                }), responseReader.readBoolean(responseFieldArr[12]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[13]), (DefaultTeam) responseReader.readObject(responseFieldArr[14], new ResponseReader.ObjectReader<DefaultTeam>() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.Mapper.2
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DefaultTeam read(ResponseReader responseReader2) {
                        return Mapper.this.defaultTeamFieldMapper.map(responseReader2);
                    }
                }), responseReader.readList(responseFieldArr[15], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                }), responseReader.readList(responseFieldArr[16], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                }), responseReader.readList(responseFieldArr[17], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.Mapper.5
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                }), responseReader.readList(responseFieldArr[18], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.Mapper.6
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                }), responseReader.readList(responseFieldArr[19], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.Mapper.7
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                }), responseReader.readList(responseFieldArr[20], new ResponseReader.ListReader<TeamWiseReportee>() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.Mapper.8
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public TeamWiseReportee read(ResponseReader.ListItemReader listItemReader) {
                        return (TeamWiseReportee) listItemReader.readObject(new ResponseReader.ObjectReader<TeamWiseReportee>() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.Mapper.8.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                            public TeamWiseReportee read(ResponseReader responseReader2) {
                                return Mapper.this.teamWiseReporteeFieldMapper.map(responseReader2);
                            }
                        });
                    }
                }), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[21]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[22]), (Account) responseReader.readObject(responseFieldArr[23], new ResponseReader.ObjectReader<Account>() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.Mapper.9
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public Account read(ResponseReader responseReader2) {
                        return Mapper.this.accountFieldMapper.map(responseReader2);
                    }
                }), (User) responseReader.readObject(responseFieldArr[24], new ResponseReader.ObjectReader<User>() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.Mapper.10
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        static {
            ...
            $responseFields = new ResponseField[]{ResponseField.forString(ModelWithMetadataAdapter.TYPE_NAME, ModelWithMetadataAdapter.TYPE_NAME, null, false, Collections.emptyList()), ResponseField.forCustomType(OutcomeConstants.OUTCOME_ID, OutcomeConstants.OUTCOME_ID, null, false, customType, Collections.emptyList()), ResponseField.forCustomType("userId", "userId", null, false, customType, Collections.emptyList()), ResponseField.forString("userRegistrationStatus", "userRegistrationStatus", null, false, Collections.emptyList()), ResponseField.forCustomType("accountId", "accountId", null, false, customType, Collections.emptyList()), ResponseField.forString("accountType", "accountType", null, false, Collections.emptyList()), ResponseField.forString("accountStatus", "accountStatus", null, false, Collections.emptyList()), ResponseField.forString("userAccountStatus", "userAccountStatus", null, false, Collections.emptyList()), ResponseField.forString("authorizationLevel", "authorizationLevel", null, false, Collections.emptyList()), ResponseField.forCustomType("userAccountPrimaryNumber", "userAccountPrimaryNumber", null, true, customType2, Collections.emptyList()), ResponseField.forCustomType("userAccountSecondaryNumber", "userAccountSecondaryNumber", null, true, customType2, Collections.emptyList()), ResponseField.forObject("userAccountEmail", "userAccountEmail", null, true, Collections.emptyList()), ResponseField.forBoolean("userAccountEmailVerification", "userAccountEmailVerification", null, true, Collections.emptyList()), ResponseField.forCustomType("defaultTeamId", "defaultTeamId", null, true, customType, Collections.emptyList()), ResponseField.forObject("defaultTeam", "defaultTeam", null, true, Collections.emptyList()), ResponseField.forList("allAllowedTeams", "allAllowedTeams", null, true, Collections.emptyList()), ResponseField.forList("teamsAsLead", "teamsAsLead", null, true, Collections.emptyList()), ResponseField.forList("teamsAsReportees", "teamsAsReportees", null, true, Collections.emptyList()), ResponseField.forList("allDirectReportees", "allDirectReportees", null, true, Collections.emptyList()), ResponseField.forList("allIndirectReportees", "allIndirectReportees", null, true, Collections.emptyList()), ResponseField.forList("teamWiseReportees", "teamWiseReportees", null, true, Collections.emptyList()), ResponseField.forCustomType("createdAt", "createdAt", null, true, customType3, Collections.emptyList()), ResponseField.forCustomType("updatedAt", "updatedAt", null, true, customType3, Collections.emptyList()), ResponseField.forObject("account", "account", null, true, Collections.emptyList()), ResponseField.forObject("user", "user", null, true, Collections.emptyList())};
        }

        public GetUserAuthorization(String str, String str2, String str3, UserRegistrationStatus userRegistrationStatus, String str4, AccountType accountType, AccountStatus accountStatus, UserStatus userStatus, AuthorizationLevel authorizationLevel, String str5, String str6, UserAccountEmail userAccountEmail, Boolean bool, String str7, DefaultTeam defaultTeam, List<String> list, List<String> list2, List<String> list3, List<String> list4, List<String> list5, List<TeamWiseReportee> list6, String str8, String str9, Account account, User user) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
        ...
        public DefaultTeam defaultTeam() {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetUserAuthorization)) {
                return false;
            }
            GetUserAuthorization getUserAuthorization = (GetUserAuthorization) obj;
            if (this.__typename.equals(getUserAuthorization.__typename) && this.id.equals(getUserAuthorization.id) && this.userId.equals(getUserAuthorization.userId) && this.userRegistrationStatus.equals(getUserAuthorization.userRegistrationStatus) && this.accountId.equals(getUserAuthorization.accountId) && this.accountType.equals(getUserAuthorization.accountType) && this.accountStatus.equals(getUserAuthorization.accountStatus) && this.userAccountStatus.equals(getUserAuthorization.userAccountStatus) && this.authorizationLevel.equals(getUserAuthorization.authorizationLevel) && ((str = this.userAccountPrimaryNumber) != null ? str.equals(getUserAuthorization.userAccountPrimaryNumber) : getUserAuthorization.userAccountPrimaryNumber == null) && ((str2 = this.userAccountSecondaryNumber) != null ? str2.equals(getUserAuthorization.userAccountSecondaryNumber) : getUserAuthorization.userAccountSecondaryNumber == null) && ((userAccountEmail = this.userAccountEmail) != null ? userAccountEmail.equals(getUserAuthorization.userAccountEmail) : getUserAuthorization.userAccountEmail == null) && ((bool = this.userAccountEmailVerification) != null ? bool.equals(getUserAuthorization.userAccountEmailVerification) : getUserAuthorization.userAccountEmailVerification == null) && ((str3 = this.defaultTeamId) != null ? str3.equals(getUserAuthorization.defaultTeamId) : getUserAuthorization.defaultTeamId == null) && ((defaultTeam = this.defaultTeam) != null ? defaultTeam.equals(getUserAuthorization.defaultTeam) : getUserAuthorization.defaultTeam == null) && ((list = this.allAllowedTeams) != null ? list.equals(getUserAuthorization.allAllowedTeams) : getUserAuthorization.allAllowedTeams == null) && ((list2 = this.teamsAsLead) != null ? list2.equals(getUserAuthorization.teamsAsLead) : getUserAuthorization.teamsAsLead == null) && ((list3 = this.teamsAsReportees) != null ? list3.equals(getUserAuthorization.teamsAsReportees) : getUserAuthorization.teamsAsReportees == null) && ((list4 = this.allDirectReportees) != null ? list4.equals(getUserAuthorization.allDirectReportees) : getUserAuthorization.allDirectReportees == null) && ((list5 = this.allIndirectReportees) != null ? list5.equals(getUserAuthorization.allIndirectReportees) : getUserAuthorization.allIndirectReportees == null) && ((list6 = this.teamWiseReportees) != null ? list6.equals(getUserAuthorization.teamWiseReportees) : getUserAuthorization.teamWiseReportees == null) && ((str4 = this.createdAt) != null ? str4.equals(getUserAuthorization.createdAt) : getUserAuthorization.createdAt == null) && ((str5 = this.updatedAt) != null ? str5.equals(getUserAuthorization.updatedAt) : getUserAuthorization.updatedAt == null) && ((account = this.account) != null ? account.equals(getUserAuthorization.account) : getUserAuthorization.account == null)) {
                User user = this.user;
                User user2 = getUserAuthorization.user;
                if (user == null) {
                    if (user2 == null) {
                        return true;
                    }
        ...
        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ...
                int iHashCode4 = (iHashCode3 ^ (userAccountEmail == null ? 0 : userAccountEmail.hashCode())) * 1000003;
                ...
                DefaultTeam defaultTeam = this.defaultTeam;
                int iHashCode7 = (iHashCode6 ^ (defaultTeam == null ? 0 : defaultTeam.hashCode())) * 1000003;
                ...
                int iHashCode12 = (iHashCode11 ^ (list5 == null ? 0 : list5.hashCode())) * 1000003;
                List<TeamWiseReportee> list6 = this.teamWiseReportees;
                int iHashCode13 = (iHashCode12 ^ (list6 == null ? 0 : list6.hashCode())) * 1000003;
                String str4 = this.createdAt;
                int iHashCode14 = (iHashCode13 ^ (str4 == null ? 0 : str4.hashCode())) * 1000003;
                String str5 = this.updatedAt;
                int iHashCode15 = (iHashCode14 ^ (str5 == null ? 0 : str5.hashCode())) * 1000003;
                Account account = this.account;
                int iHashCode16 = (iHashCode15 ^ (account == null ? 0 : account.hashCode())) * 1000003;
                User user = this.user;
                this.$hashCode = iHashCode16 ^ (user != null ? user.hashCode() : 0);
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetUserAuthorization.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetUserAuthorization.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetUserAuthorization.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetUserAuthorization.this.userId);
                    responseWriter.writeString(responseFieldArr[3], GetUserAuthorization.this.userRegistrationStatus.name());
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], GetUserAuthorization.this.accountId);
                    responseWriter.writeString(responseFieldArr[5], GetUserAuthorization.this.accountType.name());
                    responseWriter.writeString(responseFieldArr[6], GetUserAuthorization.this.accountStatus.name());
                    responseWriter.writeString(responseFieldArr[7], GetUserAuthorization.this.userAccountStatus.name());
                    responseWriter.writeString(responseFieldArr[8], GetUserAuthorization.this.authorizationLevel.name());
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], GetUserAuthorization.this.userAccountPrimaryNumber);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[10], GetUserAuthorization.this.userAccountSecondaryNumber);
                    ResponseField responseField = responseFieldArr[11];
                    UserAccountEmail userAccountEmail = GetUserAuthorization.this.userAccountEmail;
                    responseWriter.writeObject(responseField, userAccountEmail != null ? userAccountEmail.marshaller() : null);
                    responseWriter.writeBoolean(responseFieldArr[12], GetUserAuthorization.this.userAccountEmailVerification);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], GetUserAuthorization.this.defaultTeamId);
                    ResponseField responseField2 = responseFieldArr[14];
                    DefaultTeam defaultTeam = GetUserAuthorization.this.defaultTeam;
                    responseWriter.writeObject(responseField2, defaultTeam != null ? defaultTeam.marshaller() : null);
                    responseWriter.writeList(responseFieldArr[15], GetUserAuthorization.this.allAllowedTeams, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[16], GetUserAuthorization.this.teamsAsLead, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[17], GetUserAuthorization.this.teamsAsReportees, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], GetUserAuthorization.this.allDirectReportees, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[19], GetUserAuthorization.this.allIndirectReportees, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[20], GetUserAuthorization.this.teamWiseReportees, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.GetUserAuthorization.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((TeamWiseReportee) obj).marshaller());
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], GetUserAuthorization.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], GetUserAuthorization.this.updatedAt);
                    ResponseField responseField3 = responseFieldArr[23];
                    Account account = GetUserAuthorization.this.account;
                    ...
                    User user = GetUserAuthorization.this.user;
                    responseWriter.writeObject(responseField4, user != null ? user.marshaller() : null);
                }
            };
        }

        public List<TeamWiseReportee> teamWiseReportees() {
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetUserAuthorization{__typename=" + this.__typename + ", id=" + this.id + ", userId=" + this.userId + ", userRegistrationStatus=" + this.userRegistrationStatus + ", accountId=" + this.accountId + ", accountType=" + this.accountType + ", accountStatus=" + this.accountStatus + ", userAccountStatus=" + this.userAccountStatus + ", authorizationLevel=" + this.authorizationLevel + ", userAccountPrimaryNumber=" + this.userAccountPrimaryNumber + ", userAccountSecondaryNumber=" + this.userAccountSecondaryNumber + ", userAccountEmail=" + this.userAccountEmail + ", userAccountEmailVerification=" + this.userAccountEmailVerification + ", defaultTeamId=" + this.defaultTeamId + ", defaultTeam=" + this.defaultTeam + ", allAllowedTeams=" + this.allAllowedTeams + ", teamsAsLead=" + this.teamsAsLead + ", teamsAsReportees=" + this.teamsAsReportees + ", allDirectReportees=" + this.allDirectReportees + ", allIndirectReportees=" + this.allIndirectReportees + ", teamWiseReportees=" + this.teamWiseReportees + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", account=" + this.account + ", user=" + this.user + "}";
            }
            return this.$toString;
        }
        ...
        public UserAccountEmail userAccountEmail() {
    ...
    public static class TeamWiseReportee {
        static final ResponseField[] $responseFields = {ResponseField.forString(ModelWithMetadataAdapter.TYPE_NAME, ModelWithMetadataAdapter.TYPE_NAME, null, false, Collections.emptyList()), ResponseField.forCustomType("teamId", "teamId", null, true, CustomType.ID, Collections.emptyList()), ResponseField.forList("users", "users", null, true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final String __typename;
        ...
        public static final class Mapper implements ResponseFieldMapper<TeamWiseReportee> {
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public TeamWiseReportee map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = TeamWiseReportee.$responseFields;
                return new TeamWiseReportee(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), responseReader.readList(responseFieldArr[2], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.TeamWiseReportee.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
        ...
        public TeamWiseReportee(String str, String str2, List<String> list) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.teamId = str2;
            this.users = list;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof TeamWiseReportee)) {
                return false;
            }
            TeamWiseReportee teamWiseReportee = (TeamWiseReportee) obj;
            if (this.__typename.equals(teamWiseReportee.__typename) && ((str = this.teamId) != null ? str.equals(teamWiseReportee.teamId) : teamWiseReportee.teamId == null)) {
                List<String> list = this.users;
                List<String> list2 = teamWiseReportee.users;
                if (list == null) {
                    if (list2 == null) {
                        return true;
                    }
        ...
        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ...
                int iHashCode2 = (iHashCode ^ (str == null ? 0 : str.hashCode())) * 1000003;
                List<String> list = this.users;
                this.$hashCode = iHashCode2 ^ (list != null ? list.hashCode() : 0);
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.TeamWiseReportee.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = TeamWiseReportee.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], TeamWiseReportee.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], TeamWiseReportee.this.teamId);
                    responseWriter.writeList(responseFieldArr[2], TeamWiseReportee.this.users, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.TeamWiseReportee.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "TeamWiseReportee{__typename=" + this.__typename + ", teamId=" + this.teamId + ", users=" + this.users + "}";
            }
            return this.$toString;
        }
    ...
    public static class User {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.User.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = User.$responseFields;
    ...
    public static class UserAccountEmail {
        ...
        public static final class Mapper implements ResponseFieldMapper<UserAccountEmail> {
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public UserAccountEmail map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = UserAccountEmail.$responseFields;
                return new UserAccountEmail(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), responseReader.readString(responseFieldArr[2]), responseReader.readBoolean(responseFieldArr[3]), responseReader.readBoolean(responseFieldArr[4]), responseReader.readBoolean(responseFieldArr[5]), responseReader.readBoolean(responseFieldArr[6]), responseReader.readBoolean(responseFieldArr[7]), responseReader.readBoolean(responseFieldArr[8]));
            }
        }

        public UserAccountEmail(String str, String str2, String str3, Boolean bool, Boolean bool2, Boolean bool3, Boolean bool4, Boolean bool5, Boolean bool6) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.email = str2;
            this.fullName = str3;
        ...
        public boolean equals(Object obj) {
            ...
            if (this.__typename.equals(userAccountEmail.__typename) && ((str = this.email) != null ? str.equals(userAccountEmail.email) : userAccountEmail.email == null) && ((str2 = this.fullName) != null ? str2.equals(userAccountEmail.fullName) : userAccountEmail.fullName == null) && ((bool = this.isDisposableEmail) != null ? bool.equals(userAccountEmail.isDisposableEmail) : userAccountEmail.isDisposableEmail == null) && ((bool2 = this.isPrimary) != null ? bool2.equals(userAccountEmail.isPrimary) : userAccountEmail.isPrimary == null) && ((bool3 = this.isPublicEmail) != null ? bool3.equals(userAccountEmail.isPublicEmail) : userAccountEmail.isPublicEmail == null) && ((bool4 = this.isValid) != null ? bool4.equals(userAccountEmail.isValid) : userAccountEmail.isValid == null) && ((bool5 = this.isVerified) != null ? bool5.equals(userAccountEmail.isVerified) : userAccountEmail.isVerified == null)) {
                Boolean bool6 = this.isGenericEmail;
                Boolean bool7 = userAccountEmail.isGenericEmail;
                if (bool6 == null) {
                    if (bool7 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.UserAccountEmail.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UserAccountEmail.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UserAccountEmail.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], UserAccountEmail.this.email);
                    responseWriter.writeString(responseFieldArr[2], UserAccountEmail.this.fullName);
                    responseWriter.writeBoolean(responseFieldArr[3], UserAccountEmail.this.isDisposableEmail);
                    responseWriter.writeBoolean(responseFieldArr[4], UserAccountEmail.this.isPrimary);
                    responseWriter.writeBoolean(responseFieldArr[5], UserAccountEmail.this.isPublicEmail);
                    responseWriter.writeBoolean(responseFieldArr[6], UserAccountEmail.this.isValid);
                    responseWriter.writeBoolean(responseFieldArr[7], UserAccountEmail.this.isVerified);
                    responseWriter.writeBoolean(responseFieldArr[8], UserAccountEmail.this.isGenericEmail);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "UserAccountEmail{__typename=" + this.__typename + ", email=" + this.email + ", fullName=" + this.fullName + ", isDisposableEmail=" + this.isDisposableEmail + ", isPrimary=" + this.isPrimary + ", isPublicEmail=" + this.isPublicEmail + ", isValid=" + this.isValid + ", isVerified=" + this.isVerified + ", isGenericEmail=" + this.isGenericEmail + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetUserAuthorizationQuery.Variables.1
    ...
    public GetUserAuthorizationQuery(String str) {
    ...
    public String operationId() {
        return "c98f429c0b8b8ff5182dab33a4a910dce45e3d1abd0d305611ffd444cda4cba8";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetUserAuthorization($id: ID!) {\n  getUserAuthorization(id: $id) {\n    __typename\n    id\n    userId\n    userRegistrationStatus\n    accountId\n    accountType\n    accountStatus\n    userAccountStatus\n    authorizationLevel\n    userAccountPrimaryNumber\n    userAccountSecondaryNumber\n    userAccountEmail {\n      __typename\n      email\n      fullName\n      isDisposableEmail\n      isPrimary\n      isPublicEmail\n      isValid\n      isVerified\n      isGenericEmail\n    }\n    userAccountEmailVerification\n    defaultTeamId\n    defaultTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    allAllowedTeams\n    teamsAsLead\n    teamsAsReportees\n    allDirectReportees\n    allIndirectReportees\n    teamWiseReportees {\n      __typename\n      teamId\n      users\n    }\n    createdAt\n    updatedAt\n    account {\n      __typename\n      id\n      accountName\n      accountType\n      deviceKey\n      deviceKeyLastUpdated\n      accountStatus\n      businessLogoUrl\n      createdById\n      dateFormat\n      dateTimeViewStyle\n      defaultCurrency\n      denomination\n      industry\n      nameOfBusiness\n      productOrService\n      timeFormat\n      timeZone\n      plan\n      paidUpTo\n      seats\n      freeSeats\n      currentTotalUsers\n      currentActiveUsers\n      extraActiveUsers\n      pricePerSeat\n      allowAddingSeat\n      allowAddingSeatTill\n      seatReductionMarkedForNextCycle\n      billingCurrency\n      billingEmail\n      taxId\n      taxIdType\n      trialAccountEndDate\n      trialExtensionTimes\n      eligibleForExtension\n      paidForTillDate\n      updatedById\n      website\n      permissions\n      enableCustomCharts\n      createdAt\n      updatedAt\n      dealMode\n      openAiApiKey\n      salesmaxSalesContacts\n      salesmaxSupportContacts\n      chatWidgetConfig\n      onboardingStatus\n      integrationNeeded\n      matchingDealId\n      relatedAccountIds\n      lastChurnDate\n      lastChurnReason\n      possibleReactivationDate\n      locationPeriodicFrequency\n      lastPaymentDataId\n      lastPaymentDataCreatedAt\n      nextRenewalDateIfPaid\n      lastPaymentStatus\n      partPaymentAmountIfAny\n    }\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
