...
public final class OnCreateWhasappTemplatesSubscription implements Subscription<Data, Data, Operation.Variables> {
    public static final String OPERATION_DEFINITION = "subscription OnCreateWhasappTemplates {\n  onCreateWhasappTemplates {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "OnCreateWhasappTemplates";
        }
    };
    public static final String QUERY_DOCUMENT = "subscription OnCreateWhasappTemplates {\n  onCreateWhasappTemplates {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    ...
    public static class ActionInteractive {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.ActionInteractive.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], ActionInteractive.this.savedAddresses, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.ActionInteractive.1.1
    ...
    public static final class Builder {
        public OnCreateWhasappTemplatesSubscription build() {
            return new OnCreateWhasappTemplatesSubscription();
        }
    }
    ...
    public static class Component {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.Component.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("onCreateWhasappTemplates", "onCreateWhasappTemplates", null, true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnCreateWhasappTemplates onCreateWhasappTemplates;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final OnCreateWhasappTemplates.Mapper onCreateWhasappTemplatesFieldMapper = new OnCreateWhasappTemplates.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((OnCreateWhasappTemplates) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<OnCreateWhasappTemplates>() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public OnCreateWhasappTemplates read(ResponseReader responseReader2) {
                        return Mapper.this.onCreateWhasappTemplatesFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(OnCreateWhasappTemplates onCreateWhasappTemplates) {
            this.onCreateWhasappTemplates = onCreateWhasappTemplates;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnCreateWhasappTemplates onCreateWhasappTemplates = this.onCreateWhasappTemplates;
            OnCreateWhasappTemplates onCreateWhasappTemplates2 = ((Data) obj).onCreateWhasappTemplates;
            return onCreateWhasappTemplates == null ? onCreateWhasappTemplates2 == null : onCreateWhasappTemplates.equals(onCreateWhasappTemplates2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnCreateWhasappTemplates onCreateWhasappTemplates = this.onCreateWhasappTemplates;
                this.$hashCode = (onCreateWhasappTemplates == null ? 0 : onCreateWhasappTemplates.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    OnCreateWhasappTemplates onCreateWhasappTemplates = Data.this.onCreateWhasappTemplates;
                    responseWriter.writeObject(responseField, onCreateWhasappTemplates != null ? onCreateWhasappTemplates.marshaller() : null);
                }
            };
        }

        public OnCreateWhasappTemplates onCreateWhasappTemplates() {
            return this.onCreateWhasappTemplates;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onCreateWhasappTemplates=" + this.onCreateWhasappTemplates + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class DefaultMedia {
        ...
        public static final class Mapper implements ResponseFieldMapper<DefaultMedia> {
            ...
            public DefaultMedia map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[9], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.DefaultMedia.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.DefaultMedia.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultMedia.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[9], DefaultMedia.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.DefaultMedia.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class DefaultVariableMap {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.DefaultVariableMap.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultVariableMap.$responseFields;
    ...
    public static class OnCreateWhasappTemplates {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<OnCreateWhasappTemplates> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public OnCreateWhasappTemplates map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = OnCreateWhasappTemplates.$responseFields;
                return new OnCreateWhasappTemplates(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), responseReader.readString(responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), responseReader.readString(responseFieldArr[6]), responseReader.readString(responseFieldArr[7]), responseReader.readList(responseFieldArr[8], new ResponseReader.ListReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.OnCreateWhasappTemplates.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Component read(ResponseReader.ListItemReader listItemReader) {
                        return (Component) listItemReader.readObject(new ResponseReader.ObjectReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.OnCreateWhasappTemplates.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnCreateWhasappTemplates)) {
                return false;
            }
            OnCreateWhasappTemplates onCreateWhasappTemplates = (OnCreateWhasappTemplates) obj;
            if (this.__typename.equals(onCreateWhasappTemplates.__typename) && this.id.equals(onCreateWhasappTemplates.id) && this.accountId.equals(onCreateWhasappTemplates.accountId) && ((str = this.whatsappBusinessAccount) != null ? str.equals(onCreateWhasappTemplates.whatsappBusinessAccount) : onCreateWhasappTemplates.whatsappBusinessAccount == null) && ((str2 = this.templateType) != null ? str2.equals(onCreateWhasappTemplates.templateType) : onCreateWhasappTemplates.templateType == null) && ((str3 = this.snippetType) != null ? str3.equals(onCreateWhasappTemplates.snippetType) : onCreateWhasappTemplates.snippetType == null) && ((str4 = this.platform) != null ? str4.equals(onCreateWhasappTemplates.platform) : onCreateWhasappTemplates.platform == null) && ((str5 = this.name) != null ? str5.equals(onCreateWhasappTemplates.name) : onCreateWhasappTemplates.name == null) && ((list = this.components) != null ? list.equals(onCreateWhasappTemplates.components) : onCreateWhasappTemplates.components == null) && ((str6 = this.language) != null ? str6.equals(onCreateWhasappTemplates.language) : onCreateWhasappTemplates.language == null) && ((str7 = this.status) != null ? str7.equals(onCreateWhasappTemplates.status) : onCreateWhasappTemplates.status == null) && ((str8 = this.category) != null ? str8.equals(onCreateWhasappTemplates.category) : onCreateWhasappTemplates.category == null) && ((str9 = this.subCategory) != null ? str9.equals(onCreateWhasappTemplates.subCategory) : onCreateWhasappTemplates.subCategory == null) && ((str10 = this.snippetCategory) != null ? str10.equals(onCreateWhasappTemplates.snippetCategory) : onCreateWhasappTemplates.snippetCategory == null) && ((str11 = this.snippetSubCategory) != null ? str11.equals(onCreateWhasappTemplates.snippetSubCategory) : onCreateWhasappTemplates.snippetSubCategory == null) && ((str12 = this.createdBy) != null ? str12.equals(onCreateWhasappTemplates.createdBy) : onCreateWhasappTemplates.createdBy == null) && ((str13 = this.updatedBy) != null ? str13.equals(onCreateWhasappTemplates.updatedBy) : onCreateWhasappTemplates.updatedBy == null) && ((str14 = this.archivedStatus) != null ? str14.equals(onCreateWhasappTemplates.archivedStatus) : onCreateWhasappTemplates.archivedStatus == null) && ((str15 = this.archivedAt) != null ? str15.equals(onCreateWhasappTemplates.archivedAt) : onCreateWhasappTemplates.archivedAt == null) && ((str16 = this.defaultMediaId) != null ? str16.equals(onCreateWhasappTemplates.defaultMediaId) : onCreateWhasappTemplates.defaultMediaId == null) && ((list2 = this.defaultVariableMap) != null ? list2.equals(onCreateWhasappTemplates.defaultVariableMap) : onCreateWhasappTemplates.defaultVariableMap == null) && ((str17 = this.templateId) != null ? str17.equals(onCreateWhasappTemplates.templateId) : onCreateWhasappTemplates.templateId == null) && ((list3 = this.tags) != null ? list3.equals(onCreateWhasappTemplates.tags) : onCreateWhasappTemplates.tags == null) && ((bool = this.isSample) != null ? bool.equals(onCreateWhasappTemplates.isSample) : onCreateWhasappTemplates.isSample == null) && ((str18 = this.messageType) != null ? str18.equals(onCreateWhasappTemplates.messageType) : onCreateWhasappTemplates.messageType == null) && ((str19 = this.messageSubType) != null ? str19.equals(onCreateWhasappTemplates.messageSubType) : onCreateWhasappTemplates.messageSubType == null) && ((str20 = this.text) != null ? str20.equals(onCreateWhasappTemplates.text) : onCreateWhasappTemplates.text == null) && ((str21 = this.locationObjectToSend) != null ? str21.equals(onCreateWhasappTemplates.locationObjectToSend) : onCreateWhasappTemplates.locationObjectToSend == null) && ((str22 = this.headerText) != null ? str22.equals(onCreateWhasappTemplates.headerText) : onCreateWhasappTemplates.headerText == null) && ((str23 = this.footerText) != null ? str23.equals(onCreateWhasappTemplates.footerText) : onCreateWhasappTemplates.footerText == null) && ((str24 = this.headerType) != null ? str24.equals(onCreateWhasappTemplates.headerType) : onCreateWhasappTemplates.headerType == null) && ((actionInteractive = this.actionInteractive) != null ? actionInteractive.equals(onCreateWhasappTemplates.actionInteractive) : onCreateWhasappTemplates.actionInteractive == null) && ((str25 = this.messageTemplateQualityNew) != null ? str25.equals(onCreateWhasappTemplates.messageTemplateQualityNew) : onCreateWhasappTemplates.messageTemplateQualityNew == null) && ((str26 = this.messageTemplateQualityPrevious) != null ? str26.equals(onCreateWhasappTemplates.messageTemplateQualityPrevious) : onCreateWhasappTemplates.messageTemplateQualityPrevious == null) && ((str27 = this.messageTemplateQualityUpdatedAt) != null ? str27.equals(onCreateWhasappTemplates.messageTemplateQualityUpdatedAt) : onCreateWhasappTemplates.messageTemplateQualityUpdatedAt == null) && ((str28 = this.messageTemplateStatusUpdatedAt) != null ? str28.equals(onCreateWhasappTemplates.messageTemplateStatusUpdatedAt) : onCreateWhasappTemplates.messageTemplateStatusUpdatedAt == null) && ((str29 = this.stausUpdateReason) != null ? str29.equals(onCreateWhasappTemplates.stausUpdateReason) : onCreateWhasappTemplates.stausUpdateReason == null) && ((str30 = this.otherDetail) != null ? str30.equals(onCreateWhasappTemplates.otherDetail) : onCreateWhasappTemplates.otherDetail == null) && ((str31 = this.lastUsed) != null ? str31.equals(onCreateWhasappTemplates.lastUsed) : onCreateWhasappTemplates.lastUsed == null) && ((str32 = this.createdAt) != null ? str32.equals(onCreateWhasappTemplates.createdAt) : onCreateWhasappTemplates.createdAt == null) && ((str33 = this.updatedAt) != null ? str33.equals(onCreateWhasappTemplates.updatedAt) : onCreateWhasappTemplates.updatedAt == null)) {
                DefaultMedia defaultMedia = this.defaultMedia;
                DefaultMedia defaultMedia2 = onCreateWhasappTemplates.defaultMedia;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.OnCreateWhasappTemplates.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = OnCreateWhasappTemplates.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], OnCreateWhasappTemplates.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], OnCreateWhasappTemplates.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], OnCreateWhasappTemplates.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], OnCreateWhasappTemplates.this.whatsappBusinessAccount);
                    responseWriter.writeString(responseFieldArr[4], OnCreateWhasappTemplates.this.templateType);
                    responseWriter.writeString(responseFieldArr[5], OnCreateWhasappTemplates.this.snippetType);
                    responseWriter.writeString(responseFieldArr[6], OnCreateWhasappTemplates.this.platform);
                    responseWriter.writeString(responseFieldArr[7], OnCreateWhasappTemplates.this.name);
                    responseWriter.writeList(responseFieldArr[8], OnCreateWhasappTemplates.this.components, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.OnCreateWhasappTemplates.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Component) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[9], OnCreateWhasappTemplates.this.language);
                    responseWriter.writeString(responseFieldArr[10], OnCreateWhasappTemplates.this.status);
                    responseWriter.writeString(responseFieldArr[11], OnCreateWhasappTemplates.this.category);
                    responseWriter.writeString(responseFieldArr[12], OnCreateWhasappTemplates.this.subCategory);
                    responseWriter.writeString(responseFieldArr[13], OnCreateWhasappTemplates.this.snippetCategory);
                    responseWriter.writeString(responseFieldArr[14], OnCreateWhasappTemplates.this.snippetSubCategory);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], OnCreateWhasappTemplates.this.createdBy);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], OnCreateWhasappTemplates.this.updatedBy);
                    responseWriter.writeString(responseFieldArr[17], OnCreateWhasappTemplates.this.archivedStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], OnCreateWhasappTemplates.this.archivedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], OnCreateWhasappTemplates.this.defaultMediaId);
                    responseWriter.writeList(responseFieldArr[20], OnCreateWhasappTemplates.this.defaultVariableMap, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.OnCreateWhasappTemplates.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((DefaultVariableMap) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[21], OnCreateWhasappTemplates.this.templateId);
                    responseWriter.writeList(responseFieldArr[22], OnCreateWhasappTemplates.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateWhasappTemplatesSubscription.OnCreateWhasappTemplates.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeBoolean(responseFieldArr[23], OnCreateWhasappTemplates.this.isSample);
                    responseWriter.writeString(responseFieldArr[24], OnCreateWhasappTemplates.this.messageType);
                    responseWriter.writeString(responseFieldArr[25], OnCreateWhasappTemplates.this.messageSubType);
                    responseWriter.writeString(responseFieldArr[26], OnCreateWhasappTemplates.this.text);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], OnCreateWhasappTemplates.this.locationObjectToSend);
                    responseWriter.writeString(responseFieldArr[28], OnCreateWhasappTemplates.this.headerText);
                    responseWriter.writeString(responseFieldArr[29], OnCreateWhasappTemplates.this.footerText);
                    responseWriter.writeString(responseFieldArr[30], OnCreateWhasappTemplates.this.headerType);
                    ResponseField responseField = responseFieldArr[31];
                    ActionInteractive actionInteractive = OnCreateWhasappTemplates.this.actionInteractive;
                    responseWriter.writeObject(responseField, actionInteractive != null ? actionInteractive.marshaller() : null);
                    responseWriter.writeString(responseFieldArr[32], OnCreateWhasappTemplates.this.messageTemplateQualityNew);
                    responseWriter.writeString(responseFieldArr[33], OnCreateWhasappTemplates.this.messageTemplateQualityPrevious);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[34], OnCreateWhasappTemplates.this.messageTemplateQualityUpdatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[35], OnCreateWhasappTemplates.this.messageTemplateStatusUpdatedAt);
                    responseWriter.writeString(responseFieldArr[36], OnCreateWhasappTemplates.this.stausUpdateReason);
                    responseWriter.writeString(responseFieldArr[37], OnCreateWhasappTemplates.this.otherDetail);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], OnCreateWhasappTemplates.this.lastUsed);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[39], OnCreateWhasappTemplates.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[40], OnCreateWhasappTemplates.this.updatedAt);
                    ResponseField responseField2 = responseFieldArr[41];
                    DefaultMedia defaultMedia = OnCreateWhasappTemplates.this.defaultMedia;
    ...
    public String operationId() {
        return "3a413d75d5145bed6b4ab9f918c3b6b032aea5269ae0840d42614aa9d48fe792";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "subscription OnCreateWhasappTemplates {\n  onCreateWhasappTemplates {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
