...
public final class CreateTeamAccountMutation implements Mutation<Data, Data, Variables> {
    ...
    public static class AccountStats {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.AccountStats.1
    ...
    public static final class Builder {
        private CreateTeamAccountInput input;

        public CreateTeamAccountMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new CreateTeamAccountMutation(this.input);
        }

        public Builder input(CreateTeamAccountInput createTeamAccountInput) {
            this.input = createTeamAccountInput;
            return this;
        }
    }

    public static class CreateTeamAccount {
        ...
        public static final class Mapper implements ResponseFieldMapper<CreateTeamAccount> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public CreateTeamAccount map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = CreateTeamAccount.$responseFields;
                ...
                }), responseReader.readList(responseFieldArr[40], new ResponseReader.ListReader<WebPreference>() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.CreateTeamAccount.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public WebPreference read(ResponseReader.ListItemReader listItemReader) {
                        return (WebPreference) listItemReader.readObject(new ResponseReader.ObjectReader<WebPreference>() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.CreateTeamAccount.Mapper.3.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                ...
                }), (MatchingDeal) responseReader.readObject(responseFieldArr[66], new ResponseReader.ObjectReader<MatchingDeal>() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.CreateTeamAccount.Mapper.11
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public MatchingDeal read(ResponseReader responseReader2) {
                        return Mapper.this.matchingDealFieldMapper.map(responseReader2);
                    }
                }), (CreatedByUser) responseReader.readObject(responseFieldArr[67], new ResponseReader.ObjectReader<CreatedByUser>() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.CreateTeamAccount.Mapper.12
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreatedByUser read(ResponseReader responseReader2) {
                        return Mapper.this.createdByUserFieldMapper.map(responseReader2);
                    }
                }), (UpdatedByUser) responseReader.readObject(responseFieldArr[68], new ResponseReader.ObjectReader<UpdatedByUser>() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.CreateTeamAccount.Mapper.13
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateTeamAccount)) {
                return false;
            }
            CreateTeamAccount createTeamAccount = (CreateTeamAccount) obj;
            if (this.__typename.equals(createTeamAccount.__typename) && this.id.equals(createTeamAccount.id) && this.accountName.equals(createTeamAccount.accountName) && this.accountType.equals(createTeamAccount.accountType) && ((str = this.deviceKey) != null ? str.equals(createTeamAccount.deviceKey) : createTeamAccount.deviceKey == null) && ((str2 = this.deviceKeyLastUpdated) != null ? str2.equals(createTeamAccount.deviceKeyLastUpdated) : createTeamAccount.deviceKeyLastUpdated == null) && ((accountStatus = this.accountStatus) != null ? accountStatus.equals(createTeamAccount.accountStatus) : createTeamAccount.accountStatus == null) && ((str3 = this.businessLogoUrl) != null ? str3.equals(createTeamAccount.businessLogoUrl) : createTeamAccount.businessLogoUrl == null) && ((str4 = this.createdById) != null ? str4.equals(createTeamAccount.createdById) : createTeamAccount.createdById == null) && ((str5 = this.dateFormat) != null ? str5.equals(createTeamAccount.dateFormat) : createTeamAccount.dateFormat == null) && ((str6 = this.dateTimeViewStyle) != null ? str6.equals(createTeamAccount.dateTimeViewStyle) : createTeamAccount.dateTimeViewStyle == null) && ((str7 = this.defaultCurrency) != null ? str7.equals(createTeamAccount.defaultCurrency) : createTeamAccount.defaultCurrency == null) && ((str8 = this.denomination) != null ? str8.equals(createTeamAccount.denomination) : createTeamAccount.denomination == null) && ((str9 = this.industry) != null ? str9.equals(createTeamAccount.industry) : createTeamAccount.industry == null) && ((str10 = this.nameOfBusiness) != null ? str10.equals(createTeamAccount.nameOfBusiness) : createTeamAccount.nameOfBusiness == null) && ((list = this.productOrService) != null ? list.equals(createTeamAccount.productOrService) : createTeamAccount.productOrService == null) && ((str11 = this.timeFormat) != null ? str11.equals(createTeamAccount.timeFormat) : createTeamAccount.timeFormat == null) && ((str12 = this.timeZone) != null ? str12.equals(createTeamAccount.timeZone) : createTeamAccount.timeZone == null) && ((str13 = this.plan) != null ? str13.equals(createTeamAccount.plan) : createTeamAccount.plan == null) && ((str14 = this.paidUpTo) != null ? str14.equals(createTeamAccount.paidUpTo) : createTeamAccount.paidUpTo == null) && ((num = this.seats) != null ? num.equals(createTeamAccount.seats) : createTeamAccount.seats == null) && ((num2 = this.freeSeats) != null ? num2.equals(createTeamAccount.freeSeats) : createTeamAccount.freeSeats == null) && ((num3 = this.currentTotalUsers) != null ? num3.equals(createTeamAccount.currentTotalUsers) : createTeamAccount.currentTotalUsers == null) && ((num4 = this.currentActiveUsers) != null ? num4.equals(createTeamAccount.currentActiveUsers) : createTeamAccount.currentActiveUsers == null) && ((num5 = this.extraActiveUsers) != null ? num5.equals(createTeamAccount.extraActiveUsers) : createTeamAccount.extraActiveUsers == null) && ((num6 = this.pricePerSeat) != null ? num6.equals(createTeamAccount.pricePerSeat) : createTeamAccount.pricePerSeat == null) && ((bool = this.allowAddingSeat) != null ? bool.equals(createTeamAccount.allowAddingSeat) : createTeamAccount.allowAddingSeat == null) && ((str15 = this.allowAddingSeatTill) != null ? str15.equals(createTeamAccount.allowAddingSeatTill) : createTeamAccount.allowAddingSeatTill == null) && ((num7 = this.seatReductionMarkedForNextCycle) != null ? num7.equals(createTeamAccount.seatReductionMarkedForNextCycle) : createTeamAccount.seatReductionMarkedForNextCycle == null) && ((str16 = this.billingCurrency) != null ? str16.equals(createTeamAccount.billingCurrency) : createTeamAccount.billingCurrency == null) && ((str17 = this.billingEmail) != null ? str17.equals(createTeamAccount.billingEmail) : createTeamAccount.billingEmail == null) && ((str18 = this.taxId) != null ? str18.equals(createTeamAccount.taxId) : createTeamAccount.taxId == null) && ((str19 = this.taxIdType) != null ? str19.equals(createTeamAccount.taxIdType) : createTeamAccount.taxIdType == null) && ((str20 = this.trialAccountEndDate) != null ? str20.equals(createTeamAccount.trialAccountEndDate) : createTeamAccount.trialAccountEndDate == null) && ((num8 = this.trialExtensionTimes) != null ? num8.equals(createTeamAccount.trialExtensionTimes) : createTeamAccount.trialExtensionTimes == null) && ((bool2 = this.eligibleForExtension) != null ? bool2.equals(createTeamAccount.eligibleForExtension) : createTeamAccount.eligibleForExtension == null) && ((str21 = this.paidForTillDate) != null ? str21.equals(createTeamAccount.paidForTillDate) : createTeamAccount.paidForTillDate == null) && ((str22 = this.updatedById) != null ? str22.equals(createTeamAccount.updatedById) : createTeamAccount.updatedById == null) && ((str23 = this.website) != null ? str23.equals(createTeamAccount.website) : createTeamAccount.website == null) && ((list2 = this.workingHours) != null ? list2.equals(createTeamAccount.workingHours) : createTeamAccount.workingHours == null) && ((list3 = this.webPreferences) != null ? list3.equals(createTeamAccount.webPreferences) : createTeamAccount.webPreferences == null) && ((list4 = this.permissions) != null ? list4.equals(createTeamAccount.permissions) : createTeamAccount.permissions == null) && ((bool3 = this.enableCustomCharts) != null ? bool3.equals(createTeamAccount.enableCustomCharts) : createTeamAccount.enableCustomCharts == null) && ((str24 = this.createdAt) != null ? str24.equals(createTeamAccount.createdAt) : createTeamAccount.createdAt == null) && ((str25 = this.updatedAt) != null ? str25.equals(createTeamAccount.updatedAt) : createTeamAccount.updatedAt == null) && ((str26 = this.dealMode) != null ? str26.equals(createTeamAccount.dealMode) : createTeamAccount.dealMode == null) && ((str27 = this.openAiApiKey) != null ? str27.equals(createTeamAccount.openAiApiKey) : createTeamAccount.openAiApiKey == null) && ((list5 = this.salesmaxSalesContacts) != null ? list5.equals(createTeamAccount.salesmaxSalesContacts) : createTeamAccount.salesmaxSalesContacts == null) && ((list6 = this.salesmaxSupportContacts) != null ? list6.equals(createTeamAccount.salesmaxSupportContacts) : createTeamAccount.salesmaxSupportContacts == null) && ((str28 = this.chatWidgetConfig) != null ? str28.equals(createTeamAccount.chatWidgetConfig) : createTeamAccount.chatWidgetConfig == null) && ((str29 = this.onboardingStatus) != null ? str29.equals(createTeamAccount.onboardingStatus) : createTeamAccount.onboardingStatus == null) && ((str30 = this.integrationNeeded) != null ? str30.equals(createTeamAccount.integrationNeeded) : createTeamAccount.integrationNeeded == null) && ((str31 = this.matchingDealId) != null ? str31.equals(createTeamAccount.matchingDealId) : createTeamAccount.matchingDealId == null) && ((list7 = this.relatedAccountIds) != null ? list7.equals(createTeamAccount.relatedAccountIds) : createTeamAccount.relatedAccountIds == null) && ((accountStats = this.accountStats) != null ? accountStats.equals(createTeamAccount.accountStats) : createTeamAccount.accountStats == null) && ((str32 = this.lastChurnDate) != null ? str32.equals(createTeamAccount.lastChurnDate) : createTeamAccount.lastChurnDate == null) && ((str33 = this.lastChurnReason) != null ? str33.equals(createTeamAccount.lastChurnReason) : createTeamAccount.lastChurnReason == null) && ((str34 = this.possibleReactivationDate) != null ? str34.equals(createTeamAccount.possibleReactivationDate) : createTeamAccount.possibleReactivationDate == null) && ((d = this.locationPeriodicFrequency) != null ? d.equals(createTeamAccount.locationPeriodicFrequency) : createTeamAccount.locationPeriodicFrequency == null) && ((str35 = this.lastPaymentDataId) != null ? str35.equals(createTeamAccount.lastPaymentDataId) : createTeamAccount.lastPaymentDataId == null) && ((str36 = this.lastPaymentDataCreatedAt) != null ? str36.equals(createTeamAccount.lastPaymentDataCreatedAt) : createTeamAccount.lastPaymentDataCreatedAt == null) && ((str37 = this.nextRenewalDateIfPaid) != null ? str37.equals(createTeamAccount.nextRenewalDateIfPaid) : createTeamAccount.nextRenewalDateIfPaid == null) && ((str38 = this.lastPaymentStatus) != null ? str38.equals(createTeamAccount.lastPaymentStatus) : createTeamAccount.lastPaymentStatus == null) && ((num9 = this.partPaymentAmountIfAny) != null ? num9.equals(createTeamAccount.partPaymentAmountIfAny) : createTeamAccount.partPaymentAmountIfAny == null) && ((subscriptions = this.subscriptions) != null ? subscriptions.equals(createTeamAccount.subscriptions) : createTeamAccount.subscriptions == null) && ((lastPaymentData = this.lastPaymentData) != null ? lastPaymentData.equals(createTeamAccount.lastPaymentData) : createTeamAccount.lastPaymentData == null) && ((matchingDeal = this.matchingDeal) != null ? matchingDeal.equals(createTeamAccount.matchingDeal) : createTeamAccount.matchingDeal == null) && ((createdByUser = this.createdByUser) != null ? createdByUser.equals(createTeamAccount.createdByUser) : createTeamAccount.createdByUser == null)) {
                UpdatedByUser updatedByUser = this.updatedByUser;
                UpdatedByUser updatedByUser2 = createTeamAccount.updatedByUser;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.CreateTeamAccount.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateTeamAccount.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateTeamAccount.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateTeamAccount.this.id);
                    responseWriter.writeString(responseFieldArr[2], CreateTeamAccount.this.accountName);
                    responseWriter.writeString(responseFieldArr[3], CreateTeamAccount.this.accountType.name());
                    responseWriter.writeString(responseFieldArr[4], CreateTeamAccount.this.deviceKey);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], CreateTeamAccount.this.deviceKeyLastUpdated);
                    ResponseField responseField = responseFieldArr[6];
                    AccountStatus accountStatus = CreateTeamAccount.this.accountStatus;
                    responseWriter.writeString(responseField, accountStatus != null ? accountStatus.name() : null);
                    responseWriter.writeString(responseFieldArr[7], CreateTeamAccount.this.businessLogoUrl);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], CreateTeamAccount.this.createdById);
                    responseWriter.writeString(responseFieldArr[9], CreateTeamAccount.this.dateFormat);
                    responseWriter.writeString(responseFieldArr[10], CreateTeamAccount.this.dateTimeViewStyle);
                    responseWriter.writeString(responseFieldArr[11], CreateTeamAccount.this.defaultCurrency);
                    responseWriter.writeString(responseFieldArr[12], CreateTeamAccount.this.denomination);
                    responseWriter.writeString(responseFieldArr[13], CreateTeamAccount.this.industry);
                    responseWriter.writeString(responseFieldArr[14], CreateTeamAccount.this.nameOfBusiness);
                    responseWriter.writeList(responseFieldArr[15], CreateTeamAccount.this.productOrService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.CreateTeamAccount.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[16], CreateTeamAccount.this.timeFormat);
                    responseWriter.writeString(responseFieldArr[17], CreateTeamAccount.this.timeZone);
                    responseWriter.writeString(responseFieldArr[18], CreateTeamAccount.this.plan);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], CreateTeamAccount.this.paidUpTo);
                    responseWriter.writeInt(responseFieldArr[20], CreateTeamAccount.this.seats);
                    responseWriter.writeInt(responseFieldArr[21], CreateTeamAccount.this.freeSeats);
                    responseWriter.writeInt(responseFieldArr[22], CreateTeamAccount.this.currentTotalUsers);
                    responseWriter.writeInt(responseFieldArr[23], CreateTeamAccount.this.currentActiveUsers);
                    responseWriter.writeInt(responseFieldArr[24], CreateTeamAccount.this.extraActiveUsers);
                    responseWriter.writeInt(responseFieldArr[25], CreateTeamAccount.this.pricePerSeat);
                    responseWriter.writeBoolean(responseFieldArr[26], CreateTeamAccount.this.allowAddingSeat);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], CreateTeamAccount.this.allowAddingSeatTill);
                    responseWriter.writeInt(responseFieldArr[28], CreateTeamAccount.this.seatReductionMarkedForNextCycle);
                    responseWriter.writeString(responseFieldArr[29], CreateTeamAccount.this.billingCurrency);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[30], CreateTeamAccount.this.billingEmail);
                    responseWriter.writeString(responseFieldArr[31], CreateTeamAccount.this.taxId);
                    responseWriter.writeString(responseFieldArr[32], CreateTeamAccount.this.taxIdType);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[33], CreateTeamAccount.this.trialAccountEndDate);
                    responseWriter.writeInt(responseFieldArr[34], CreateTeamAccount.this.trialExtensionTimes);
                    responseWriter.writeBoolean(responseFieldArr[35], CreateTeamAccount.this.eligibleForExtension);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[36], CreateTeamAccount.this.paidForTillDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[37], CreateTeamAccount.this.updatedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], CreateTeamAccount.this.website);
                    responseWriter.writeList(responseFieldArr[39], CreateTeamAccount.this.workingHours, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.CreateTeamAccount.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((WorkingHour) obj).marshaller());
                        }
                    });
                    responseWriter.writeList(responseFieldArr[40], CreateTeamAccount.this.webPreferences, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.CreateTeamAccount.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((WebPreference) obj).marshaller());
                        }
                    });
                    responseWriter.writeList(responseFieldArr[41], CreateTeamAccount.this.permissions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.CreateTeamAccount.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    });
                    responseWriter.writeBoolean(responseFieldArr[42], CreateTeamAccount.this.enableCustomCharts);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[43], CreateTeamAccount.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[44], CreateTeamAccount.this.updatedAt);
                    responseWriter.writeString(responseFieldArr[45], CreateTeamAccount.this.dealMode);
                    responseWriter.writeString(responseFieldArr[46], CreateTeamAccount.this.openAiApiKey);
                    responseWriter.writeList(responseFieldArr[47], CreateTeamAccount.this.salesmaxSalesContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.CreateTeamAccount.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[48], CreateTeamAccount.this.salesmaxSupportContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.CreateTeamAccount.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[49], CreateTeamAccount.this.chatWidgetConfig);
                    responseWriter.writeString(responseFieldArr[50], CreateTeamAccount.this.onboardingStatus);
                    responseWriter.writeString(responseFieldArr[51], CreateTeamAccount.this.integrationNeeded);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[52], CreateTeamAccount.this.matchingDealId);
                    responseWriter.writeList(responseFieldArr[53], CreateTeamAccount.this.relatedAccountIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.CreateTeamAccount.1.7
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    AccountStats accountStats = CreateTeamAccount.this.accountStats;
                    responseWriter.writeObject(responseField2, accountStats != null ? accountStats.marshaller() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[55], CreateTeamAccount.this.lastChurnDate);
                    responseWriter.writeString(responseFieldArr[56], CreateTeamAccount.this.lastChurnReason);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[57], CreateTeamAccount.this.possibleReactivationDate);
                    responseWriter.writeDouble(responseFieldArr[58], CreateTeamAccount.this.locationPeriodicFrequency);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[59], CreateTeamAccount.this.lastPaymentDataId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[60], CreateTeamAccount.this.lastPaymentDataCreatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[61], CreateTeamAccount.this.nextRenewalDateIfPaid);
                    responseWriter.writeString(responseFieldArr[62], CreateTeamAccount.this.lastPaymentStatus);
                    responseWriter.writeInt(responseFieldArr[63], CreateTeamAccount.this.partPaymentAmountIfAny);
                    ResponseField responseField3 = responseFieldArr[64];
                    Subscriptions subscriptions = CreateTeamAccount.this.subscriptions;
                    ...
                    LastPaymentData lastPaymentData = CreateTeamAccount.this.lastPaymentData;
                    ...
                    MatchingDeal matchingDeal = CreateTeamAccount.this.matchingDeal;
                    ...
                    CreatedByUser createdByUser = CreateTeamAccount.this.createdByUser;
                    ...
                    UpdatedByUser updatedByUser = CreateTeamAccount.this.updatedByUser;
    ...
    public static class CreatedByUser {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.CreatedByUser.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreatedByUser.$responseFields;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createTeamAccount", "createTeamAccount", new UnmodifiableMapBuilder(1).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final CreateTeamAccount createTeamAccount;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateTeamAccount.Mapper createTeamAccountFieldMapper = new CreateTeamAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateTeamAccount) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateTeamAccount>() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateTeamAccount read(ResponseReader responseReader2) {
                        return Mapper.this.createTeamAccountFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateTeamAccount createTeamAccount) {
            this.createTeamAccount = createTeamAccount;
        }

        public CreateTeamAccount createTeamAccount() {
            return this.createTeamAccount;
        }
        ...
        public boolean equals(Object obj) {
            ...
            CreateTeamAccount createTeamAccount = this.createTeamAccount;
            CreateTeamAccount createTeamAccount2 = ((Data) obj).createTeamAccount;
            return createTeamAccount == null ? createTeamAccount2 == null : createTeamAccount.equals(createTeamAccount2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateTeamAccount createTeamAccount = this.createTeamAccount;
                this.$hashCode = (createTeamAccount == null ? 0 : createTeamAccount.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateTeamAccount createTeamAccount = Data.this.createTeamAccount;
                    responseWriter.writeObject(responseField, createTeamAccount != null ? createTeamAccount.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createTeamAccount=" + this.createTeamAccount + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class LastPaymentData {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.LastPaymentData.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = LastPaymentData.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[17], LastPaymentData.this.paidByContactIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.LastPaymentData.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], LastPaymentData.this.transactionId, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.LastPaymentData.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class MatchingDeal {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.MatchingDeal.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = MatchingDeal.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[17], MatchingDeal.this.transitionSummary, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.MatchingDeal.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], MatchingDeal.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.MatchingDeal.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[21], MatchingDeal.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.MatchingDeal.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class Subscriptions {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.Subscriptions.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Subscriptions.$responseFields;
    ...
    public static class UpdatedByUser {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.UpdatedByUser.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdatedByUser.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        private final CreateTeamAccountInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateTeamAccountInput createTeamAccountInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createTeamAccountInput;
            linkedHashMap.put("input", createTeamAccountInput);
        }

        public CreateTeamAccountInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.Variables.1
    ...
    public static class WebPreference {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.WebPreference.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = WebPreference.$responseFields;
    ...
    public static class WorkingHour {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateTeamAccountMutation.WorkingHour.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = WorkingHour.$responseFields;
    ...
    public CreateTeamAccountMutation(CreateTeamAccountInput createTeamAccountInput) {
        Utils.checkNotNull(createTeamAccountInput, "input == null");
        this.variables = new Variables(createTeamAccountInput);
    }
    ...
    public String operationId() {
        return "74b24fd2ae34bab18c5cdba306949e3e0226785924601f091f27bb4480d6ddb0";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateTeamAccount($input: CreateTeamAccountInput!) {\n  createTeamAccount(input: $input) {\n    __typename\n    id\n    accountName\n    accountType\n    deviceKey\n    deviceKeyLastUpdated\n    accountStatus\n    businessLogoUrl\n    createdById\n    dateFormat\n    dateTimeViewStyle\n    defaultCurrency\n    denomination\n    industry\n    nameOfBusiness\n    productOrService\n    timeFormat\n    timeZone\n    plan\n    paidUpTo\n    seats\n    freeSeats\n    currentTotalUsers\n    currentActiveUsers\n    extraActiveUsers\n    pricePerSeat\n    allowAddingSeat\n    allowAddingSeatTill\n    seatReductionMarkedForNextCycle\n    billingCurrency\n    billingEmail\n    taxId\n    taxIdType\n    trialAccountEndDate\n    trialExtensionTimes\n    eligibleForExtension\n    paidForTillDate\n    updatedById\n    website\n    workingHours {\n      __typename\n      day\n      startTime\n      endTime\n    }\n    webPreferences {\n      __typename\n      key\n      value\n    }\n    permissions\n    enableCustomCharts\n    createdAt\n    updatedAt\n    dealMode\n    openAiApiKey\n    salesmaxSalesContacts\n    salesmaxSupportContacts\n    chatWidgetConfig\n    onboardingStatus\n    integrationNeeded\n    matchingDealId\n    relatedAccountIds\n    accountStats {\n      __typename\n      callSevenDays\n      wabaConversationSevenDays\n      wabaBroadcastSevenDays\n      paymentSevenDays\n      taskSevenDays\n      callPreviousSevenDays\n      wabaConversationPreviousSevenDays\n      contactCreatedPreviousSevenDays\n      bulkActionsSeventDays\n      bulkActionsSeventDays_BULK_UPLOAD\n      bulkActionsSeventDays_CREATE_TAG\n      bulkActionsSeventDays_CAMPAIGN_WITH_RULE\n      bulkActionsSeventDays_BULK_UPDATE\n      bulkActionsSeventDays_GENERATE_REPORT\n      bulkActionsSeventDays_REMOVE_USER\n      bulkActionsPreviousSeventDays\n      onboardingStepsDone\n    }\n    lastChurnDate\n    lastChurnReason\n    possibleReactivationDate\n    locationPeriodicFrequency\n    lastPaymentDataId\n    lastPaymentDataCreatedAt\n    nextRenewalDateIfPaid\n    lastPaymentStatus\n    partPaymentAmountIfAny\n    subscriptions {\n      __typename\n      nextToken\n    }\n    lastPaymentData {\n      __typename\n      id\n      accountId\n      contactId\n      paymentRequestType\n      engagementId\n      paymentProvider\n      orderIdInPaymentProvider\n      orderId\n      paymentLinkId\n      paymentLinkUrl\n      amount\n      amountPaid\n      currency\n      status\n      lastPaymentStatus\n      finalPaymentDate\n      paidByContactIds\n      transactionId\n      note\n      createdAt\n      updatedAt\n      customPaymentData\n      createdById\n      updatedById\n    }\n    matchingDeal {\n      __typename\n      id\n      accountId\n      name\n      description\n      dealStage\n      dealStageUpdatedAt\n      dealState\n      dealOutcome\n      dealLostReason\n      amount\n      currency\n      createdByUser\n      lastUpdatedByUser\n      ownerId\n      primaryTeamId\n      openTaskDetail\n      transitionSummary\n      recentEngagements\n      recentEngagementsUpdatedAt\n      lastActivity\n      tags\n      customDealData\n      createdAt\n      updatedAt\n    }\n    createdByUser {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedByUser {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
