...
public final class ListEngagementTypeByContactQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListEngagementTypeByContact($contactId: ID, $engagementTypeUpdatedAt: ModelEngagementListEngagementTypeByContactCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelEngagementFilterInput, $limit: Int, $nextToken: String) {\n  listEngagementTypeByContact(contactId: $contactId, engagementTypeUpdatedAt: $engagementTypeUpdatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      engagementType\n      contactId\n      primaryTeamId\n      toBeAssigned\n      ownerId\n      contactPrimaryTeamId\n      contactOwnerId\n      addedById\n      updatedById\n      callStatus\n      engagementStatus\n      parentEngagementId\n      nextStepTaskId\n      syncStatus\n      externalNumber\n      userNumber\n      callDirection\n      callConnectStatus\n      callStartTime\n      callEndTime\n      durationInMillis\n      callOutcome\n      callOutcomeNature\n      callRecordingExternalResource\n      noteHeading\n      noteAdditionMethod\n      voiceNoteUrl\n      body\n      isManualTask\n      taskHeading\n      taskType\n      taskActivityType\n      taskInputNote\n      taskPriority\n      taskCompletionNote\n      taskCompletionTime\n      taskCompletionType\n      dueDateTime\n      nextFollowUpOn\n      nextFollowUpSetBy\n      reminderDateTime\n      callRecordingUrl\n      callTranscriptUrl\n      callTranscriptSummary\n      uploadedFiledUrl\n      visitTime\n      visitNote\n      visitOutcome\n      visitOutcomeNature\n      videoCallPlatform\n      videoCallLink\n      meetingName\n      meetingCode\n      videoCallMetadata\n      videoCallOutcome\n      paymentDataId\n      calendarEventId\n      calendarName\n      campaignId\n      campaignRun\n      engagementSourceType\n      engagementSource\n      engagementSourceLevelTwo\n      systemAction\n      taskEngagementActions\n      taskEngagementActionsUpdatedAt\n      firstTaskEngagementActionOn\n      taskEngagementActionCount\n      customCallOutcomeData\n      customVisitOutcomeData\n      customTaskCompletionData\n      customTaskInputData\n      customVideoCallInputData\n      deviceId\n      totalCallDuration\n      cloudProviderNumber\n      hangupReason\n      cloudProvider\n      callType\n      phoneCallLogId\n      externalEventRecordId\n      createdAt\n      updatedAt\n    }\n    nextToken\n    startedAt\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListEngagementTypeByContactQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListEngagementTypeByContact";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListEngagementTypeByContact($contactId: ID, $engagementTypeUpdatedAt: ModelEngagementListEngagementTypeByContactCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelEngagementFilterInput, $limit: Int, $nextToken: String) {\n  listEngagementTypeByContact(contactId: $contactId, engagementTypeUpdatedAt: $engagementTypeUpdatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      engagementType\n      contactId\n      primaryTeamId\n      toBeAssigned\n      ownerId\n      contactPrimaryTeamId\n      contactOwnerId\n      addedById\n      updatedById\n      callStatus\n      engagementStatus\n      parentEngagementId\n      nextStepTaskId\n      syncStatus\n      externalNumber\n      userNumber\n      callDirection\n      callConnectStatus\n      callStartTime\n      callEndTime\n      durationInMillis\n      callOutcome\n      callOutcomeNature\n      callRecordingExternalResource\n      noteHeading\n      noteAdditionMethod\n      voiceNoteUrl\n      body\n      isManualTask\n      taskHeading\n      taskType\n      taskActivityType\n      taskInputNote\n      taskPriority\n      taskCompletionNote\n      taskCompletionTime\n      taskCompletionType\n      dueDateTime\n      nextFollowUpOn\n      nextFollowUpSetBy\n      reminderDateTime\n      callRecordingUrl\n      callTranscriptUrl\n      callTranscriptSummary\n      uploadedFiledUrl\n      visitTime\n      visitNote\n      visitOutcome\n      visitOutcomeNature\n      videoCallPlatform\n      videoCallLink\n      meetingName\n      meetingCode\n      videoCallMetadata\n      videoCallOutcome\n      paymentDataId\n      calendarEventId\n      calendarName\n      campaignId\n      campaignRun\n      engagementSourceType\n      engagementSource\n      engagementSourceLevelTwo\n      systemAction\n      taskEngagementActions\n      taskEngagementActionsUpdatedAt\n      firstTaskEngagementActionOn\n      taskEngagementActionCount\n      customCallOutcomeData\n      customVisitOutcomeData\n      customTaskCompletionData\n      customTaskInputData\n      customVideoCallInputData\n      deviceId\n      totalCallDuration\n      cloudProviderNumber\n      hangupReason\n      cloudProvider\n      callType\n      phoneCallLogId\n      externalEventRecordId\n      createdAt\n      updatedAt\n    }\n    nextToken\n    startedAt\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private String contactId;
        private C19135x216a5771 engagementTypeUpdatedAt;
        private ModelEngagementFilterInput filter;
        private Integer limit;
        private String nextToken;
        private ModelSortDirection sortDirection;

        public ListEngagementTypeByContactQuery build() {
            return new ListEngagementTypeByContactQuery(this.contactId, this.engagementTypeUpdatedAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
        ...
        public Builder engagementTypeUpdatedAt(C19135x216a5771 c19135x216a5771) {
            this.engagementTypeUpdatedAt = c19135x216a5771;
            return this;
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listEngagementTypeByContact", "listEngagementTypeByContact", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put("contactId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "contactId").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("engagementTypeUpdatedAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "engagementTypeUpdatedAt").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListEngagementTypeByContact listEngagementTypeByContact;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListEngagementTypeByContact.Mapper listEngagementTypeByContactFieldMapper = new ListEngagementTypeByContact.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListEngagementTypeByContact) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListEngagementTypeByContact>() { // from class: com.amazonaws.amplify.generated.graphql.ListEngagementTypeByContactQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListEngagementTypeByContact read(ResponseReader responseReader2) {
                        return Mapper.this.listEngagementTypeByContactFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListEngagementTypeByContact listEngagementTypeByContact) {
            this.listEngagementTypeByContact = listEngagementTypeByContact;
        }
        ...
        public boolean equals(Object obj) {
            ...
            ListEngagementTypeByContact listEngagementTypeByContact = this.listEngagementTypeByContact;
            ListEngagementTypeByContact listEngagementTypeByContact2 = ((Data) obj).listEngagementTypeByContact;
            return listEngagementTypeByContact == null ? listEngagementTypeByContact2 == null : listEngagementTypeByContact.equals(listEngagementTypeByContact2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListEngagementTypeByContact listEngagementTypeByContact = this.listEngagementTypeByContact;
                this.$hashCode = (listEngagementTypeByContact == null ? 0 : listEngagementTypeByContact.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListEngagementTypeByContact listEngagementTypeByContact() {
            return this.listEngagementTypeByContact;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListEngagementTypeByContactQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListEngagementTypeByContact listEngagementTypeByContact = Data.this.listEngagementTypeByContact;
                    responseWriter.writeObject(responseField, listEngagementTypeByContact != null ? listEngagementTypeByContact.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listEngagementTypeByContact=" + this.listEngagementTypeByContact + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListEngagementTypeByContactQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[67], Item.this.taskEngagementActions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListEngagementTypeByContactQuery.Item.1.1
    ...
    public static class ListEngagementTypeByContact {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListEngagementTypeByContact> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListEngagementTypeByContact map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListEngagementTypeByContact.$responseFields;
                return new ListEngagementTypeByContact(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListEngagementTypeByContactQuery.ListEngagementTypeByContact.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListEngagementTypeByContactQuery.ListEngagementTypeByContact.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListEngagementTypeByContact(String str, List<Item> list, String str2, Long l) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.items = list;
            this.nextToken = str2;
            this.startedAt = l;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListEngagementTypeByContact)) {
                return false;
            }
            ListEngagementTypeByContact listEngagementTypeByContact = (ListEngagementTypeByContact) obj;
            if (this.__typename.equals(listEngagementTypeByContact.__typename) && ((list = this.items) != null ? list.equals(listEngagementTypeByContact.items) : listEngagementTypeByContact.items == null) && ((str = this.nextToken) != null ? str.equals(listEngagementTypeByContact.nextToken) : listEngagementTypeByContact.nextToken == null)) {
                Long l = this.startedAt;
                Long l2 = listEngagementTypeByContact.startedAt;
                if (l == null) {
                    if (l2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListEngagementTypeByContactQuery.ListEngagementTypeByContact.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListEngagementTypeByContact.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListEngagementTypeByContact.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListEngagementTypeByContact.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListEngagementTypeByContactQuery.ListEngagementTypeByContact.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListEngagementTypeByContact.this.nextToken);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], ListEngagementTypeByContact.this.startedAt);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListEngagementTypeByContact{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + ", startedAt=" + this.startedAt + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final C19135x216a5771 engagementTypeUpdatedAt;
        ...
        public Variables(String str, C19135x216a5771 c19135x216a5771, ModelSortDirection modelSortDirection, ModelEngagementFilterInput modelEngagementFilterInput, Integer num, String str2) {
            ...
            linkedHashMap.put("engagementTypeUpdatedAt", c19135x216a5771);
        ...
        public C19135x216a5771 engagementTypeUpdatedAt() {
            return this.engagementTypeUpdatedAt;
        }
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListEngagementTypeByContactQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("contactId", Variables.this.contactId);
                    inputFieldWriter.writeObject("engagementTypeUpdatedAt", Variables.this.engagementTypeUpdatedAt != null ? Variables.this.engagementTypeUpdatedAt.marshaller() : null);
    ...
    public ListEngagementTypeByContactQuery(String str, C19135x216a5771 c19135x216a5771, ModelSortDirection modelSortDirection, ModelEngagementFilterInput modelEngagementFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, c19135x216a5771, modelSortDirection, modelEngagementFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "9c06132b022ca6fb8e0d0ff12355c1e208e557d6c396290d213e94c07bdc2817";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListEngagementTypeByContact($contactId: ID, $engagementTypeUpdatedAt: ModelEngagementListEngagementTypeByContactCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelEngagementFilterInput, $limit: Int, $nextToken: String) {\n  listEngagementTypeByContact(contactId: $contactId, engagementTypeUpdatedAt: $engagementTypeUpdatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      engagementType\n      contactId\n      primaryTeamId\n      toBeAssigned\n      ownerId\n      contactPrimaryTeamId\n      contactOwnerId\n      addedById\n      updatedById\n      callStatus\n      engagementStatus\n      parentEngagementId\n      nextStepTaskId\n      syncStatus\n      externalNumber\n      userNumber\n      callDirection\n      callConnectStatus\n      callStartTime\n      callEndTime\n      durationInMillis\n      callOutcome\n      callOutcomeNature\n      callRecordingExternalResource\n      noteHeading\n      noteAdditionMethod\n      voiceNoteUrl\n      body\n      isManualTask\n      taskHeading\n      taskType\n      taskActivityType\n      taskInputNote\n      taskPriority\n      taskCompletionNote\n      taskCompletionTime\n      taskCompletionType\n      dueDateTime\n      nextFollowUpOn\n      nextFollowUpSetBy\n      reminderDateTime\n      callRecordingUrl\n      callTranscriptUrl\n      callTranscriptSummary\n      uploadedFiledUrl\n      visitTime\n      visitNote\n      visitOutcome\n      visitOutcomeNature\n      videoCallPlatform\n      videoCallLink\n      meetingName\n      meetingCode\n      videoCallMetadata\n      videoCallOutcome\n      paymentDataId\n      calendarEventId\n      calendarName\n      campaignId\n      campaignRun\n      engagementSourceType\n      engagementSource\n      engagementSourceLevelTwo\n      systemAction\n      taskEngagementActions\n      taskEngagementActionsUpdatedAt\n      firstTaskEngagementActionOn\n      taskEngagementActionCount\n      customCallOutcomeData\n      customVisitOutcomeData\n      customTaskCompletionData\n      customTaskInputData\n      customVideoCallInputData\n      deviceId\n      totalCallDuration\n      cloudProviderNumber\n      hangupReason\n      cloudProvider\n      callType\n      phoneCallLogId\n      externalEventRecordId\n      createdAt\n      updatedAt\n    }\n    nextToken\n    startedAt\n  }\n}";
    }
