...
public final class OnUpdateChatChannelSubscription implements Subscription<Data, Data, Variables> {
    ...
    public static final class Builder {
        ...
        public OnUpdateChatChannelSubscription build() {
            Utils.checkNotNull(this.accountId, "accountId == null");
            Utils.checkNotNull(this.id, "id == null");
            return new OnUpdateChatChannelSubscription(this.accountId, this.id);
        }
    ...
    public static class Contact {
        ...
        public static final class Mapper implements ResponseFieldMapper<Contact> {
            ...
            public Contact map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[5], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Contact.Mapper.1
                ...
                List list2 = responseReader.readList(responseFieldArr[7], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Contact.Mapper.2
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                ...
                List list3 = responseReader.readList(responseFieldArr[34], new ResponseReader.ListReader<Day>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Contact.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                ...
                List list4 = responseReader.readList(responseFieldArr[92], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Contact.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                });
                List list5 = responseReader.readList(responseFieldArr[93], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Contact.Mapper.5
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                ...
                List list6 = responseReader.readList(responseFieldArr[97], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Contact.Mapper.6
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Contact.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], Contact.this.sharedOwners, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Contact.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[7], Contact.this.sharedTeams, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Contact.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[34], Contact.this.preferredContactDays, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Contact.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[92], Contact.this.userDefinedTags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Contact.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[93], Contact.this.productService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Contact.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[97], Contact.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Contact.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("onUpdateChatChannel", "onUpdateChatChannel", new UnmodifiableMapBuilder(2).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnUpdateChatChannel onUpdateChatChannel;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final OnUpdateChatChannel.Mapper onUpdateChatChannelFieldMapper = new OnUpdateChatChannel.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((OnUpdateChatChannel) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<OnUpdateChatChannel>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public OnUpdateChatChannel read(ResponseReader responseReader2) {
                        return Mapper.this.onUpdateChatChannelFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(OnUpdateChatChannel onUpdateChatChannel) {
            this.onUpdateChatChannel = onUpdateChatChannel;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnUpdateChatChannel onUpdateChatChannel = this.onUpdateChatChannel;
            OnUpdateChatChannel onUpdateChatChannel2 = ((Data) obj).onUpdateChatChannel;
            return onUpdateChatChannel == null ? onUpdateChatChannel2 == null : onUpdateChatChannel.equals(onUpdateChatChannel2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnUpdateChatChannel onUpdateChatChannel = this.onUpdateChatChannel;
                this.$hashCode = (onUpdateChatChannel == null ? 0 : onUpdateChatChannel.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    OnUpdateChatChannel onUpdateChatChannel = Data.this.onUpdateChatChannel;
                    responseWriter.writeObject(responseField, onUpdateChatChannel != null ? onUpdateChatChannel.marshaller() : null);
                }
            };
        }

        public OnUpdateChatChannel onUpdateChatChannel() {
            return this.onUpdateChatChannel;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onUpdateChatChannel=" + this.onUpdateChatChannel + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Messages {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Messages.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Messages.$responseFields;
    ...
    public static class OnUpdateChatChannel {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<OnUpdateChatChannel> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public OnUpdateChatChannel map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = OnUpdateChatChannel.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
                ...
                List list = responseReader.readList(responseFieldArr[6], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.OnUpdateChatChannel.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnUpdateChatChannel)) {
                return false;
            }
            OnUpdateChatChannel onUpdateChatChannel = (OnUpdateChatChannel) obj;
            if (this.__typename.equals(onUpdateChatChannel.__typename) && this.id.equals(onUpdateChatChannel.id) && this.accountId.equals(onUpdateChatChannel.accountId) && ((str = this.phoneNumberIdExternal) != null ? str.equals(onUpdateChatChannel.phoneNumberIdExternal) : onUpdateChatChannel.phoneNumberIdExternal == null) && ((str2 = this.channelName) != null ? str2.equals(onUpdateChatChannel.channelName) : onUpdateChatChannel.channelName == null) && ((str3 = this.messagePlatform) != null ? str3.equals(onUpdateChatChannel.messagePlatform) : onUpdateChatChannel.messagePlatform == null) && ((list = this.tags) != null ? list.equals(onUpdateChatChannel.tags) : onUpdateChatChannel.tags == null) && ((str4 = this.recipientType) != null ? str4.equals(onUpdateChatChannel.recipientType) : onUpdateChatChannel.recipientType == null) && ((str5 = this.channelType) != null ? str5.equals(onUpdateChatChannel.channelType) : onUpdateChatChannel.channelType == null) && ((str6 = this.channelSubType) != null ? str6.equals(onUpdateChatChannel.channelSubType) : onUpdateChatChannel.channelSubType == null) && ((bool = this.externalParticipantsAllowed) != null ? bool.equals(onUpdateChatChannel.externalParticipantsAllowed) : onUpdateChatChannel.externalParticipantsAllowed == null) && ((str7 = this.participantScopeIfInternal) != null ? str7.equals(onUpdateChatChannel.participantScopeIfInternal) : onUpdateChatChannel.participantScopeIfInternal == null) && ((str8 = this.userIdsForDirectChannel) != null ? str8.equals(onUpdateChatChannel.userIdsForDirectChannel) : onUpdateChatChannel.userIdsForDirectChannel == null) && ((str9 = this.channelStatus) != null ? str9.equals(onUpdateChatChannel.channelStatus) : onUpdateChatChannel.channelStatus == null) && ((str10 = this.channelWillBeChargedNext) != null ? str10.equals(onUpdateChatChannel.channelWillBeChargedNext) : onUpdateChatChannel.channelWillBeChargedNext == null) && ((str11 = this.channelOpenUntil) != null ? str11.equals(onUpdateChatChannel.channelOpenUntil) : onUpdateChatChannel.channelOpenUntil == null) && ((str12 = this.contactId) != null ? str12.equals(onUpdateChatChannel.contactId) : onUpdateChatChannel.contactId == null) && ((str13 = this.visitorId) != null ? str13.equals(onUpdateChatChannel.visitorId) : onUpdateChatChannel.visitorId == null) && ((str14 = this.recipientExternalId) != null ? str14.equals(onUpdateChatChannel.recipientExternalId) : onUpdateChatChannel.recipientExternalId == null) && ((str15 = this.recipientExternalIdType) != null ? str15.equals(onUpdateChatChannel.recipientExternalIdType) : onUpdateChatChannel.recipientExternalIdType == null) && ((str16 = this.ownerId) != null ? str16.equals(onUpdateChatChannel.ownerId) : onUpdateChatChannel.ownerId == null) && ((str17 = this.primaryTeamId) != null ? str17.equals(onUpdateChatChannel.primaryTeamId) : onUpdateChatChannel.primaryTeamId == null) && ((contactAssignmentStatus = this.toBeAssigned) != null ? contactAssignmentStatus.equals(onUpdateChatChannel.toBeAssigned) : onUpdateChatChannel.toBeAssigned == null) && ((str18 = this.createdById) != null ? str18.equals(onUpdateChatChannel.createdById) : onUpdateChatChannel.createdById == null) && ((str19 = this.readNotifiedAt) != null ? str19.equals(onUpdateChatChannel.readNotifiedAt) : onUpdateChatChannel.readNotifiedAt == null) && ((str20 = this.lastMessageByLeadTime) != null ? str20.equals(onUpdateChatChannel.lastMessageByLeadTime) : onUpdateChatChannel.lastMessageByLeadTime == null) && ((str21 = this.lastMessageByUserTime) != null ? str21.equals(onUpdateChatChannel.lastMessageByUserTime) : onUpdateChatChannel.lastMessageByUserTime == null) && ((bool2 = this.isLastMessageByLead) != null ? bool2.equals(onUpdateChatChannel.isLastMessageByLead) : onUpdateChatChannel.isLastMessageByLead == null) && ((str22 = this.lastOutboundMessageId) != null ? str22.equals(onUpdateChatChannel.lastOutboundMessageId) : onUpdateChatChannel.lastOutboundMessageId == null) && ((str23 = this.lastOutboundMessageStatus) != null ? str23.equals(onUpdateChatChannel.lastOutboundMessageStatus) : onUpdateChatChannel.lastOutboundMessageStatus == null) && ((bool3 = this.lastOutboundMessageWasBroadcast) != null ? bool3.equals(onUpdateChatChannel.lastOutboundMessageWasBroadcast) : onUpdateChatChannel.lastOutboundMessageWasBroadcast == null) && ((bool4 = this.chanelHasOnlyBroadcast) != null ? bool4.equals(onUpdateChatChannel.chanelHasOnlyBroadcast) : onUpdateChatChannel.chanelHasOnlyBroadcast == null) && ((str24 = this.salesmaxAccountId) != null ? str24.equals(onUpdateChatChannel.salesmaxAccountId) : onUpdateChatChannel.salesmaxAccountId == null) && ((str25 = this.channelProfilePic) != null ? str25.equals(onUpdateChatChannel.channelProfilePic) : onUpdateChatChannel.channelProfilePic == null) && ((str26 = this.createdAt) != null ? str26.equals(onUpdateChatChannel.createdAt) : onUpdateChatChannel.createdAt == null) && ((str27 = this.updatedAt) != null ? str27.equals(onUpdateChatChannel.updatedAt) : onUpdateChatChannel.updatedAt == null) && ((messages = this.messages) != null ? messages.equals(onUpdateChatChannel.messages) : onUpdateChatChannel.messages == null) && ((participants = this.participants) != null ? participants.equals(onUpdateChatChannel.participants) : onUpdateChatChannel.participants == null) && ((contact = this.contact) != null ? contact.equals(onUpdateChatChannel.contact) : onUpdateChatChannel.contact == null)) {
                Owner owner = this.owner;
                Owner owner2 = onUpdateChatChannel.owner;
                if (owner == null) {
                    if (owner2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.OnUpdateChatChannel.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = OnUpdateChatChannel.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], OnUpdateChatChannel.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], OnUpdateChatChannel.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], OnUpdateChatChannel.this.accountId);
                    responseWriter.writeString(responseFieldArr[3], OnUpdateChatChannel.this.phoneNumberIdExternal);
                    responseWriter.writeString(responseFieldArr[4], OnUpdateChatChannel.this.channelName);
                    responseWriter.writeString(responseFieldArr[5], OnUpdateChatChannel.this.messagePlatform);
                    responseWriter.writeList(responseFieldArr[6], OnUpdateChatChannel.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.OnUpdateChatChannel.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[7], OnUpdateChatChannel.this.recipientType);
                    responseWriter.writeString(responseFieldArr[8], OnUpdateChatChannel.this.channelType);
                    responseWriter.writeString(responseFieldArr[9], OnUpdateChatChannel.this.channelSubType);
                    responseWriter.writeBoolean(responseFieldArr[10], OnUpdateChatChannel.this.externalParticipantsAllowed);
                    responseWriter.writeString(responseFieldArr[11], OnUpdateChatChannel.this.participantScopeIfInternal);
                    responseWriter.writeString(responseFieldArr[12], OnUpdateChatChannel.this.userIdsForDirectChannel);
                    responseWriter.writeString(responseFieldArr[13], OnUpdateChatChannel.this.channelStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], OnUpdateChatChannel.this.channelWillBeChargedNext);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], OnUpdateChatChannel.this.channelOpenUntil);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], OnUpdateChatChannel.this.contactId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], OnUpdateChatChannel.this.visitorId);
                    responseWriter.writeString(responseFieldArr[18], OnUpdateChatChannel.this.recipientExternalId);
                    responseWriter.writeString(responseFieldArr[19], OnUpdateChatChannel.this.recipientExternalIdType);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], OnUpdateChatChannel.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], OnUpdateChatChannel.this.primaryTeamId);
                    ResponseField responseField = responseFieldArr[22];
                    ContactAssignmentStatus contactAssignmentStatus = OnUpdateChatChannel.this.toBeAssigned;
                    responseWriter.writeString(responseField, contactAssignmentStatus != null ? contactAssignmentStatus.name() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], OnUpdateChatChannel.this.createdById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[24], OnUpdateChatChannel.this.readNotifiedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], OnUpdateChatChannel.this.lastMessageByLeadTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[26], OnUpdateChatChannel.this.lastMessageByUserTime);
                    responseWriter.writeBoolean(responseFieldArr[27], OnUpdateChatChannel.this.isLastMessageByLead);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[28], OnUpdateChatChannel.this.lastOutboundMessageId);
                    responseWriter.writeString(responseFieldArr[29], OnUpdateChatChannel.this.lastOutboundMessageStatus);
                    responseWriter.writeBoolean(responseFieldArr[30], OnUpdateChatChannel.this.lastOutboundMessageWasBroadcast);
                    responseWriter.writeBoolean(responseFieldArr[31], OnUpdateChatChannel.this.chanelHasOnlyBroadcast);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[32], OnUpdateChatChannel.this.salesmaxAccountId);
                    responseWriter.writeString(responseFieldArr[33], OnUpdateChatChannel.this.channelProfilePic);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[34], OnUpdateChatChannel.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[35], OnUpdateChatChannel.this.updatedAt);
                    ResponseField responseField2 = responseFieldArr[36];
                    Messages messages = OnUpdateChatChannel.this.messages;
                    ...
                    Participants participants = OnUpdateChatChannel.this.participants;
                    ...
                    Contact contact = OnUpdateChatChannel.this.contact;
                    ...
                    Owner owner = OnUpdateChatChannel.this.owner;
    ...
    public static class Owner {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Owner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Owner.$responseFields;
    ...
    public static class Participants {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Participants.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Participants.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateChatChannelSubscription.Variables.1
    ...
    public OnUpdateChatChannelSubscription(String str, String str2) {
    ...
    public String operationId() {
        return "5ca6afcefdf1068fc8e33ffef92a3b6a3b1f77216f9661b5d34b88209396a464";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "subscription OnUpdateChatChannel($accountId: ID!, $id: ID!) {\n  onUpdateChatChannel(accountId: $accountId, id: $id) {\n    __typename\n    id\n    accountId\n    phoneNumberIdExternal\n    channelName\n    messagePlatform\n    tags\n    recipientType\n    channelType\n    channelSubType\n    externalParticipantsAllowed\n    participantScopeIfInternal\n    userIdsForDirectChannel\n    channelStatus\n    channelWillBeChargedNext\n    channelOpenUntil\n    contactId\n    visitorId\n    recipientExternalId\n    recipientExternalIdType\n    ownerId\n    primaryTeamId\n    toBeAssigned\n    createdById\n    readNotifiedAt\n    lastMessageByLeadTime\n    lastMessageByUserTime\n    isLastMessageByLead\n    lastOutboundMessageId\n    lastOutboundMessageStatus\n    lastOutboundMessageWasBroadcast\n    chanelHasOnlyBroadcast\n    salesmaxAccountId\n    channelProfilePic\n    createdAt\n    updatedAt\n    messages {\n      __typename\n      nextToken\n    }\n    participants {\n      __typename\n      nextToken\n    }\n    contact {\n      __typename\n      id\n      accountId\n      ownerId\n      toBeAssigned\n      sharedOwners\n      primaryTeamId\n      sharedTeams\n      accountPriority\n      addedById\n      assignedToId\n      blockedForCallById\n      blockedForCallReason\n      blockedForCallUntil\n      callPriority\n      waChatChannelId\n      contactSource\n      contactSourceDrillDownOne\n      contactSourceDrillDownTwo\n      contactSourceDrillDownThree\n      contactSourceDrillDownOneId\n      contactSourceDrillDownTwoId\n      contactSourceDrillDownThreeId\n      contactStatus\n      contactType\n      department\n      designation\n      lastRepeatEnquiryDate\n      lastRepeatEnquirySource\n      gender\n      isDecisionMaker\n      isPrivate\n      lockPeriod\n      name\n      preferredContactDays\n      profilePhotoUrl\n      referredBy\n      salutation\n      seniority\n      updatedById\n      hasTask\n      openTaskActivityType\n      lastCalledTime\n      lastCallDirection\n      lastCallOutcome\n      lastCallOutcomeNature\n      lastCallUserId\n      lastCallDuration\n      lastCallEngagementId\n      lastVisitTime\n      lastVisitOutcome\n      lastVisitOutcomeNature\n      lastVisitUserId\n      lastVisitEngagementId\n      lastEmailTime\n      lastEmailUserId\n      lastEmailEngagementId\n      lastWhatsappTime\n      lastWhatsappUserId\n      lastWhatsappEngagementId\n      lastWabaBroadcastTime\n      lastWabaBroadcastStatus\n      lastWabaBroadcastTemplate\n      lastWabaBroadcastReplyBody\n      lastWabaBroadcastReplyTime\n      lastWabaBroadcastReplyType\n      lastSmsTime\n      lastSmsUserId\n      lastSmsEngagementId\n      lastNoteAddedTime\n      lastNoteUserId\n      lastNoteEngagementId\n      lastTaskDoneTime\n      lastTaskDoneUserId\n      lastTaskDoneEngagementId\n      openTaskCount\n      lastKnownDisposition\n      lastKnownDispositionTime\n      lastLeadAssignmentDateTime\n      lastEngagementFromAccount\n      lastEngagementFromContact\n      freshLeadTag\n      noWorkAfterAssignment\n      needFollowUpTag\n      needFollowUpTagUpdatedAt\n      activeDealStage\n      activeDealStageUpdatedAt\n      dealDescription\n      isCustomer\n      becameCustomerOn\n      unsuccessfulCallAttempts\n      leadCallsNotAnswered\n      userDefinedTags\n      productService\n      bulkUploadReference\n      assignmentMethod\n      whatsappOptInStatus\n      recentEngagements\n      recentEngagementsUpdatedAt\n      openTaskDetail\n      openVideoCallDetail\n      lastClosedTaskDetail\n      lastClosedTaskDetailUpdatedAt\n      latestRemark\n      customAttributes\n      paymentRequestDetail\n      lastPaymentStatus\n      customDataAddedFromAddContactForm\n      leadLifecycleStage\n      leadLifecycleStageSubCategory\n      manualClosedReason\n      lastDealStageType\n      prospectingAttempts\n      totalProspectingAttemptsAcrossRechurn\n      numberOfTimesRechurned\n      lastProspectingDoneOn\n      firstProspectingDoneOn\n      nextProspectingDueOn\n      nextProspectingSetBy\n      nextProspectingNote\n      movedToOpportunityOn\n      movedToClosedOn\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
