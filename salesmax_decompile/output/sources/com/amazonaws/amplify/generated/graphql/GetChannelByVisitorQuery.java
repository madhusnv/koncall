...
public final class GetChannelByVisitorQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetChannelByVisitor($visitorId: ID, $sortDirection: ModelSortDirection, $filter: ModelChatChannelFilterInput, $limit: Int, $nextToken: String) {\n  getChannelByVisitor(visitorId: $visitorId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetChannelByVisitorQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetChannelByVisitor";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetChannelByVisitor($visitorId: ID, $sortDirection: ModelSortDirection, $filter: ModelChatChannelFilterInput, $limit: Int, $nextToken: String) {\n  getChannelByVisitor(visitorId: $visitorId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetChannelByVisitorQuery build() {
            return new GetChannelByVisitorQuery(this.visitorId, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getChannelByVisitor", "getChannelByVisitor", new UnmodifiableMapBuilder(5).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("visitorId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "visitorId").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetChannelByVisitor getChannelByVisitor;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetChannelByVisitor.Mapper getChannelByVisitorFieldMapper = new GetChannelByVisitor.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetChannelByVisitor) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetChannelByVisitor>() { // from class: com.amazonaws.amplify.generated.graphql.GetChannelByVisitorQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetChannelByVisitor read(ResponseReader responseReader2) {
                        return Mapper.this.getChannelByVisitorFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetChannelByVisitor getChannelByVisitor) {
            this.getChannelByVisitor = getChannelByVisitor;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetChannelByVisitor getChannelByVisitor = this.getChannelByVisitor;
            GetChannelByVisitor getChannelByVisitor2 = ((Data) obj).getChannelByVisitor;
            return getChannelByVisitor == null ? getChannelByVisitor2 == null : getChannelByVisitor.equals(getChannelByVisitor2);
        }

        public GetChannelByVisitor getChannelByVisitor() {
            return this.getChannelByVisitor;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetChannelByVisitor getChannelByVisitor = this.getChannelByVisitor;
                this.$hashCode = (getChannelByVisitor == null ? 0 : getChannelByVisitor.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChannelByVisitorQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetChannelByVisitor getChannelByVisitor = Data.this.getChannelByVisitor;
                    responseWriter.writeObject(responseField, getChannelByVisitor != null ? getChannelByVisitor.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getChannelByVisitor=" + this.getChannelByVisitor + "}";
            }
            return this.$toString;
        }
    }

    public static class GetChannelByVisitor {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetChannelByVisitor> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetChannelByVisitor map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetChannelByVisitor.$responseFields;
                return new GetChannelByVisitor(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetChannelByVisitorQuery.GetChannelByVisitor.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetChannelByVisitorQuery.GetChannelByVisitor.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetChannelByVisitor(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetChannelByVisitor)) {
                return false;
            }
            GetChannelByVisitor getChannelByVisitor = (GetChannelByVisitor) obj;
            if (this.__typename.equals(getChannelByVisitor.__typename) && this.items.equals(getChannelByVisitor.items)) {
                String str = this.nextToken;
                String str2 = getChannelByVisitor.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChannelByVisitorQuery.GetChannelByVisitor.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetChannelByVisitor.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetChannelByVisitor.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetChannelByVisitor.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetChannelByVisitorQuery.GetChannelByVisitor.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetChannelByVisitor.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetChannelByVisitor{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public static final class Mapper implements ResponseFieldMapper<Item> {
            ...
            public Item map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[6], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.GetChannelByVisitorQuery.Item.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChannelByVisitorQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[6], Item.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetChannelByVisitorQuery.Item.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(String str, ModelSortDirection modelSortDirection, ModelChatChannelFilterInput modelChatChannelFilterInput, Integer num, String str2) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetChannelByVisitorQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("visitorId", Variables.this.visitorId);
    ...
    public GetChannelByVisitorQuery(String str, ModelSortDirection modelSortDirection, ModelChatChannelFilterInput modelChatChannelFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelSortDirection, modelChatChannelFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "543dfa4547c3161a3d4fc9ee7ce97e2372d125be020ace1165f3d05b90fa4f08";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetChannelByVisitor($visitorId: ID, $sortDirection: ModelSortDirection, $filter: ModelChatChannelFilterInput, $limit: Int, $nextToken: String) {\n  getChannelByVisitor(visitorId: $visitorId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
