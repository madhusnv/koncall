...
public final class GetBusinessQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetBusiness($id: ID!) {\n  getBusiness(id: $id) {\n    __typename\n    id\n    accountId\n    name\n    addresses {\n      __typename\n      addressType\n      establishmentName\n      area\n      city\n      country\n      googlePlaceId\n      isPrimaryAddress\n      landmark\n      lat\n      lng\n      rawAddressText\n      region\n      state\n      streetAddress\n      zipcode\n    }\n    industry\n    priority\n    website\n    domain\n    logo\n    userDefinedTags\n    addedById\n    updatedById\n    createdAt\n    updatedAt\n    deals {\n      __typename\n      nextToken\n    }\n    contacts {\n      __typename\n      nextToken\n    }\n    addedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetBusinessQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetBusiness";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetBusiness($id: ID!) {\n  getBusiness(id: $id) {\n    __typename\n    id\n    accountId\n    name\n    addresses {\n      __typename\n      addressType\n      establishmentName\n      area\n      city\n      country\n      googlePlaceId\n      isPrimaryAddress\n      landmark\n      lat\n      lng\n      rawAddressText\n      region\n      state\n      streetAddress\n      zipcode\n    }\n    industry\n    priority\n    website\n    domain\n    logo\n    userDefinedTags\n    addedById\n    updatedById\n    createdAt\n    updatedAt\n    deals {\n      __typename\n      nextToken\n    }\n    contacts {\n      __typename\n      nextToken\n    }\n    addedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    ...
    public static class AddedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBusinessQuery.AddedBy.1
    ...
    public static class Address {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBusinessQuery.Address.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Address.$responseFields;
    ...
    public static final class Builder {
        ...
        public GetBusinessQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetBusinessQuery(this.id);
        }
    ...
    public static class Contacts {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBusinessQuery.Contacts.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Contacts.$responseFields;
    ...
    public static class Data implements Operation.Data {
        ...
        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetBusiness.Mapper getBusinessFieldMapper = new GetBusiness.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetBusiness) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetBusiness>() { // from class: com.amazonaws.amplify.generated.graphql.GetBusinessQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetBusiness read(ResponseReader responseReader2) {
                        return Mapper.this.getBusinessFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetBusiness getBusiness) {
        ...
        public boolean equals(Object obj) {
            ...
            GetBusiness getBusiness2 = ((Data) obj).getBusiness;
            return getBusiness == null ? getBusiness2 == null : getBusiness.equals(getBusiness2);
        }

        public GetBusiness getBusiness() {
        ...
        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetBusiness getBusiness = this.getBusiness;
                this.$hashCode = (getBusiness == null ? 0 : getBusiness.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBusinessQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetBusiness getBusiness = Data.this.getBusiness;
                    responseWriter.writeObject(responseField, getBusiness != null ? getBusiness.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getBusiness=" + this.getBusiness + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Deals {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBusinessQuery.Deals.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Deals.$responseFields;
    ...
    public static class GetBusiness {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetBusiness> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetBusiness map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetBusiness.$responseFields;
                return new GetBusiness(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), responseReader.readString(responseFieldArr[3]), responseReader.readList(responseFieldArr[4], new ResponseReader.ListReader<Address>() { // from class: com.amazonaws.amplify.generated.graphql.GetBusinessQuery.GetBusiness.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Address read(ResponseReader.ListItemReader listItemReader) {
                        return (Address) listItemReader.readObject(new ResponseReader.ObjectReader<Address>() { // from class: com.amazonaws.amplify.generated.graphql.GetBusinessQuery.GetBusiness.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetBusiness(String str, String str2, String str3, String str4, List<Address> list, String str5, String str6, String str7, String str8, String str9, List<String> list2, String str10, String str11, String str12, String str13, Deals deals, Contacts contacts, AddedBy addedBy, UpdatedBy updatedBy) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetBusiness)) {
                return false;
            }
            GetBusiness getBusiness = (GetBusiness) obj;
            if (this.__typename.equals(getBusiness.__typename) && this.id.equals(getBusiness.id) && this.accountId.equals(getBusiness.accountId) && this.name.equals(getBusiness.name) && ((list = this.addresses) != null ? list.equals(getBusiness.addresses) : getBusiness.addresses == null) && ((str = this.industry) != null ? str.equals(getBusiness.industry) : getBusiness.industry == null) && ((str2 = this.priority) != null ? str2.equals(getBusiness.priority) : getBusiness.priority == null) && ((str3 = this.website) != null ? str3.equals(getBusiness.website) : getBusiness.website == null) && ((str4 = this.domain) != null ? str4.equals(getBusiness.domain) : getBusiness.domain == null) && ((str5 = this.logo) != null ? str5.equals(getBusiness.logo) : getBusiness.logo == null) && ((list2 = this.userDefinedTags) != null ? list2.equals(getBusiness.userDefinedTags) : getBusiness.userDefinedTags == null) && ((str6 = this.addedById) != null ? str6.equals(getBusiness.addedById) : getBusiness.addedById == null) && ((str7 = this.updatedById) != null ? str7.equals(getBusiness.updatedById) : getBusiness.updatedById == null) && ((str8 = this.createdAt) != null ? str8.equals(getBusiness.createdAt) : getBusiness.createdAt == null) && ((str9 = this.updatedAt) != null ? str9.equals(getBusiness.updatedAt) : getBusiness.updatedAt == null) && ((deals = this.deals) != null ? deals.equals(getBusiness.deals) : getBusiness.deals == null) && ((contacts = this.contacts) != null ? contacts.equals(getBusiness.contacts) : getBusiness.contacts == null) && ((addedBy = this.addedBy) != null ? addedBy.equals(getBusiness.addedBy) : getBusiness.addedBy == null)) {
                UpdatedBy updatedBy = this.updatedBy;
                UpdatedBy updatedBy2 = getBusiness.updatedBy;
                if (updatedBy == null) {
                    if (updatedBy2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBusinessQuery.GetBusiness.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetBusiness.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetBusiness.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetBusiness.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetBusiness.this.accountId);
                    responseWriter.writeString(responseFieldArr[3], GetBusiness.this.name);
                    responseWriter.writeList(responseFieldArr[4], GetBusiness.this.addresses, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetBusinessQuery.GetBusiness.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Address) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[5], GetBusiness.this.industry);
                    responseWriter.writeString(responseFieldArr[6], GetBusiness.this.priority);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], GetBusiness.this.website);
                    responseWriter.writeString(responseFieldArr[8], GetBusiness.this.domain);
                    responseWriter.writeString(responseFieldArr[9], GetBusiness.this.logo);
                    responseWriter.writeList(responseFieldArr[10], GetBusiness.this.userDefinedTags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetBusinessQuery.GetBusiness.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], GetBusiness.this.addedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], GetBusiness.this.updatedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], GetBusiness.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], GetBusiness.this.updatedAt);
                    ResponseField responseField = responseFieldArr[15];
                    Deals deals = GetBusiness.this.deals;
                    ...
                    Contacts contacts = GetBusiness.this.contacts;
                    ...
                    AddedBy addedBy = GetBusiness.this.addedBy;
                    ...
                    UpdatedBy updatedBy = GetBusiness.this.updatedBy;
    ...
    public static class UpdatedBy {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBusinessQuery.UpdatedBy.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdatedBy.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetBusinessQuery.Variables.1
    ...
    public GetBusinessQuery(String str) {
    ...
    public String operationId() {
        return "f22c49302647bed50a562c1a04071a050d739326f8abe86ae9e163f38d402f58";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetBusiness($id: ID!) {\n  getBusiness(id: $id) {\n    __typename\n    id\n    accountId\n    name\n    addresses {\n      __typename\n      addressType\n      establishmentName\n      area\n      city\n      country\n      googlePlaceId\n      isPrimaryAddress\n      landmark\n      lat\n      lng\n      rawAddressText\n      region\n      state\n      streetAddress\n      zipcode\n    }\n    industry\n    priority\n    website\n    domain\n    logo\n    userDefinedTags\n    addedById\n    updatedById\n    createdAt\n    updatedAt\n    deals {\n      __typename\n      nextToken\n    }\n    contacts {\n      __typename\n      nextToken\n    }\n    addedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n    updatedBy {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
