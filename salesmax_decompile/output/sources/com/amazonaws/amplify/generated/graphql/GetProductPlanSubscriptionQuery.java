...
public final class GetProductPlanSubscriptionQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetProductPlanSubscription($id: ID!) {\n  getProductPlanSubscription(id: $id) {\n    __typename\n    id\n    accountId\n    addedById\n    productAccountId\n    productPlanId\n    planDescription\n    planStatus\n    planFeePerUnit\n    planFeeProRataPerUnit\n    period\n    amount\n    currency\n    status\n    numberOfUnits\n    numberOfFreeUnits\n    unitType\n    subscriptionPaymentStatus\n    subscriptionStartDate\n    subscriptionEndDate\n    createdAt\n    updatedAt\n    productPlan {\n      __typename\n      id\n      accountId\n      productId\n      planDescription\n      planStatus\n      period\n      fee\n      proRataFee\n      currency\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetProductPlanSubscriptionQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetProductPlanSubscription";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetProductPlanSubscription($id: ID!) {\n  getProductPlanSubscription(id: $id) {\n    __typename\n    id\n    accountId\n    addedById\n    productAccountId\n    productPlanId\n    planDescription\n    planStatus\n    planFeePerUnit\n    planFeeProRataPerUnit\n    period\n    amount\n    currency\n    status\n    numberOfUnits\n    numberOfFreeUnits\n    unitType\n    subscriptionPaymentStatus\n    subscriptionStartDate\n    subscriptionEndDate\n    createdAt\n    updatedAt\n    productPlan {\n      __typename\n      id\n      accountId\n      productId\n      planDescription\n      planStatus\n      period\n      fee\n      proRataFee\n      currency\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private String id;

        public GetProductPlanSubscriptionQuery build() {
            Utils.checkNotNull(this.id, "id == null");
            return new GetProductPlanSubscriptionQuery(this.id);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getProductPlanSubscription", "getProductPlanSubscription", new UnmodifiableMapBuilder(1).put(OutcomeConstants.OUTCOME_ID, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, OutcomeConstants.OUTCOME_ID).build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetProductPlanSubscription getProductPlanSubscription;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetProductPlanSubscription.Mapper getProductPlanSubscriptionFieldMapper = new GetProductPlanSubscription.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetProductPlanSubscription) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetProductPlanSubscription>() { // from class: com.amazonaws.amplify.generated.graphql.GetProductPlanSubscriptionQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetProductPlanSubscription read(ResponseReader responseReader2) {
                        return Mapper.this.getProductPlanSubscriptionFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetProductPlanSubscription getProductPlanSubscription) {
            this.getProductPlanSubscription = getProductPlanSubscription;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetProductPlanSubscription getProductPlanSubscription = this.getProductPlanSubscription;
            GetProductPlanSubscription getProductPlanSubscription2 = ((Data) obj).getProductPlanSubscription;
            return getProductPlanSubscription == null ? getProductPlanSubscription2 == null : getProductPlanSubscription.equals(getProductPlanSubscription2);
        }

        public GetProductPlanSubscription getProductPlanSubscription() {
            return this.getProductPlanSubscription;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetProductPlanSubscription getProductPlanSubscription = this.getProductPlanSubscription;
                this.$hashCode = (getProductPlanSubscription == null ? 0 : getProductPlanSubscription.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetProductPlanSubscriptionQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetProductPlanSubscription getProductPlanSubscription = Data.this.getProductPlanSubscription;
                    responseWriter.writeObject(responseField, getProductPlanSubscription != null ? getProductPlanSubscription.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getProductPlanSubscription=" + this.getProductPlanSubscription + "}";
            }
            return this.$toString;
        }
    }

    public static class GetProductPlanSubscription {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetProductPlanSubscription)) {
                return false;
            }
            GetProductPlanSubscription getProductPlanSubscription = (GetProductPlanSubscription) obj;
            if (this.__typename.equals(getProductPlanSubscription.__typename) && this.id.equals(getProductPlanSubscription.id) && this.accountId.equals(getProductPlanSubscription.accountId) && this.addedById.equals(getProductPlanSubscription.addedById) && ((str = this.productAccountId) != null ? str.equals(getProductPlanSubscription.productAccountId) : getProductPlanSubscription.productAccountId == null) && this.productPlanId.equals(getProductPlanSubscription.productPlanId) && ((str2 = this.planDescription) != null ? str2.equals(getProductPlanSubscription.planDescription) : getProductPlanSubscription.planDescription == null) && ((str3 = this.planStatus) != null ? str3.equals(getProductPlanSubscription.planStatus) : getProductPlanSubscription.planStatus == null) && ((num = this.planFeePerUnit) != null ? num.equals(getProductPlanSubscription.planFeePerUnit) : getProductPlanSubscription.planFeePerUnit == null) && ((num2 = this.planFeeProRataPerUnit) != null ? num2.equals(getProductPlanSubscription.planFeeProRataPerUnit) : getProductPlanSubscription.planFeeProRataPerUnit == null) && ((str4 = this.period) != null ? str4.equals(getProductPlanSubscription.period) : getProductPlanSubscription.period == null) && ((num3 = this.amount) != null ? num3.equals(getProductPlanSubscription.amount) : getProductPlanSubscription.amount == null) && ((str5 = this.currency) != null ? str5.equals(getProductPlanSubscription.currency) : getProductPlanSubscription.currency == null) && ((str6 = this.status) != null ? str6.equals(getProductPlanSubscription.status) : getProductPlanSubscription.status == null) && ((num4 = this.numberOfUnits) != null ? num4.equals(getProductPlanSubscription.numberOfUnits) : getProductPlanSubscription.numberOfUnits == null) && ((num5 = this.numberOfFreeUnits) != null ? num5.equals(getProductPlanSubscription.numberOfFreeUnits) : getProductPlanSubscription.numberOfFreeUnits == null) && ((str7 = this.unitType) != null ? str7.equals(getProductPlanSubscription.unitType) : getProductPlanSubscription.unitType == null) && ((str8 = this.subscriptionPaymentStatus) != null ? str8.equals(getProductPlanSubscription.subscriptionPaymentStatus) : getProductPlanSubscription.subscriptionPaymentStatus == null) && this.subscriptionStartDate.equals(getProductPlanSubscription.subscriptionStartDate) && ((str9 = this.subscriptionEndDate) != null ? str9.equals(getProductPlanSubscription.subscriptionEndDate) : getProductPlanSubscription.subscriptionEndDate == null) && this.createdAt.equals(getProductPlanSubscription.createdAt) && this.updatedAt.equals(getProductPlanSubscription.updatedAt)) {
                ProductPlan productPlan = this.productPlan;
                ProductPlan productPlan2 = getProductPlanSubscription.productPlan;
                if (productPlan == null) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetProductPlanSubscriptionQuery.GetProductPlanSubscription.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetProductPlanSubscription.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetProductPlanSubscription.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetProductPlanSubscription.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetProductPlanSubscription.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], GetProductPlanSubscription.this.addedById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], GetProductPlanSubscription.this.productAccountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], GetProductPlanSubscription.this.productPlanId);
                    responseWriter.writeString(responseFieldArr[6], GetProductPlanSubscription.this.planDescription);
                    responseWriter.writeString(responseFieldArr[7], GetProductPlanSubscription.this.planStatus);
                    responseWriter.writeInt(responseFieldArr[8], GetProductPlanSubscription.this.planFeePerUnit);
                    responseWriter.writeInt(responseFieldArr[9], GetProductPlanSubscription.this.planFeeProRataPerUnit);
                    responseWriter.writeString(responseFieldArr[10], GetProductPlanSubscription.this.period);
                    responseWriter.writeInt(responseFieldArr[11], GetProductPlanSubscription.this.amount);
                    responseWriter.writeString(responseFieldArr[12], GetProductPlanSubscription.this.currency);
                    responseWriter.writeString(responseFieldArr[13], GetProductPlanSubscription.this.status);
                    responseWriter.writeInt(responseFieldArr[14], GetProductPlanSubscription.this.numberOfUnits);
                    responseWriter.writeInt(responseFieldArr[15], GetProductPlanSubscription.this.numberOfFreeUnits);
                    responseWriter.writeString(responseFieldArr[16], GetProductPlanSubscription.this.unitType);
                    responseWriter.writeString(responseFieldArr[17], GetProductPlanSubscription.this.subscriptionPaymentStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], GetProductPlanSubscription.this.subscriptionStartDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], GetProductPlanSubscription.this.subscriptionEndDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], GetProductPlanSubscription.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], GetProductPlanSubscription.this.updatedAt);
                    ResponseField responseField = responseFieldArr[22];
                    ProductPlan productPlan = GetProductPlanSubscription.this.productPlan;
    ...
    public static class ProductPlan {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetProductPlanSubscriptionQuery.ProductPlan.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ProductPlan.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetProductPlanSubscriptionQuery.Variables.1
    ...
    public GetProductPlanSubscriptionQuery(String str) {
    ...
    public String operationId() {
        return "89741c3993ecd271a2bdf33bc4e7660cdb2d6e334688a9fb6a1c1ac5f17b9770";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetProductPlanSubscription($id: ID!) {\n  getProductPlanSubscription(id: $id) {\n    __typename\n    id\n    accountId\n    addedById\n    productAccountId\n    productPlanId\n    planDescription\n    planStatus\n    planFeePerUnit\n    planFeeProRataPerUnit\n    period\n    amount\n    currency\n    status\n    numberOfUnits\n    numberOfFreeUnits\n    unitType\n    subscriptionPaymentStatus\n    subscriptionStartDate\n    subscriptionEndDate\n    createdAt\n    updatedAt\n    productPlan {\n      __typename\n      id\n      accountId\n      productId\n      planDescription\n      planStatus\n      period\n      fee\n      proRataFee\n      currency\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
