...
public final class GetPaymentDataByOrderIdQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetPaymentDataByOrderId($orderId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelPaymentDataFilterInput, $limit: Int, $nextToken: String) {\n  getPaymentDataByOrderId(orderId: $orderId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      paymentRequestType\n      engagementId\n      paymentProvider\n      orderIdInPaymentProvider\n      orderId\n      paymentLinkId\n      paymentLinkUrl\n      amount\n      amountPaid\n      currency\n      status\n      lastPaymentStatus\n      finalPaymentDate\n      paidByContactIds\n      transactionId\n      note\n      createdAt\n      updatedAt\n      customPaymentData\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataByOrderIdQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetPaymentDataByOrderId";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetPaymentDataByOrderId($orderId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelPaymentDataFilterInput, $limit: Int, $nextToken: String) {\n  getPaymentDataByOrderId(orderId: $orderId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      paymentRequestType\n      engagementId\n      paymentProvider\n      orderIdInPaymentProvider\n      orderId\n      paymentLinkId\n      paymentLinkUrl\n      amount\n      amountPaid\n      currency\n      status\n      lastPaymentStatus\n      finalPaymentDate\n      paidByContactIds\n      transactionId\n      note\n      createdAt\n      updatedAt\n      customPaymentData\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetPaymentDataByOrderIdQuery build() {
            return new GetPaymentDataByOrderIdQuery(this.orderId, this.updatedAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getPaymentDataByOrderId", "getPaymentDataByOrderId", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put("orderId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "orderId").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("updatedAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "updatedAt").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetPaymentDataByOrderId getPaymentDataByOrderId;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetPaymentDataByOrderId.Mapper getPaymentDataByOrderIdFieldMapper = new GetPaymentDataByOrderId.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetPaymentDataByOrderId) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetPaymentDataByOrderId>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataByOrderIdQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetPaymentDataByOrderId read(ResponseReader responseReader2) {
                        return Mapper.this.getPaymentDataByOrderIdFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetPaymentDataByOrderId getPaymentDataByOrderId) {
            this.getPaymentDataByOrderId = getPaymentDataByOrderId;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetPaymentDataByOrderId getPaymentDataByOrderId = this.getPaymentDataByOrderId;
            GetPaymentDataByOrderId getPaymentDataByOrderId2 = ((Data) obj).getPaymentDataByOrderId;
            return getPaymentDataByOrderId == null ? getPaymentDataByOrderId2 == null : getPaymentDataByOrderId.equals(getPaymentDataByOrderId2);
        }

        public GetPaymentDataByOrderId getPaymentDataByOrderId() {
            return this.getPaymentDataByOrderId;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetPaymentDataByOrderId getPaymentDataByOrderId = this.getPaymentDataByOrderId;
                this.$hashCode = (getPaymentDataByOrderId == null ? 0 : getPaymentDataByOrderId.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataByOrderIdQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetPaymentDataByOrderId getPaymentDataByOrderId = Data.this.getPaymentDataByOrderId;
                    responseWriter.writeObject(responseField, getPaymentDataByOrderId != null ? getPaymentDataByOrderId.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getPaymentDataByOrderId=" + this.getPaymentDataByOrderId + "}";
            }
            return this.$toString;
        }
    }

    public static class GetPaymentDataByOrderId {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetPaymentDataByOrderId> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetPaymentDataByOrderId map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetPaymentDataByOrderId.$responseFields;
                return new GetPaymentDataByOrderId(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataByOrderIdQuery.GetPaymentDataByOrderId.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataByOrderIdQuery.GetPaymentDataByOrderId.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetPaymentDataByOrderId(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetPaymentDataByOrderId)) {
                return false;
            }
            GetPaymentDataByOrderId getPaymentDataByOrderId = (GetPaymentDataByOrderId) obj;
            if (this.__typename.equals(getPaymentDataByOrderId.__typename) && this.items.equals(getPaymentDataByOrderId.items)) {
                String str = this.nextToken;
                String str2 = getPaymentDataByOrderId.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataByOrderIdQuery.GetPaymentDataByOrderId.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetPaymentDataByOrderId.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetPaymentDataByOrderId.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetPaymentDataByOrderId.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataByOrderIdQuery.GetPaymentDataByOrderId.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetPaymentDataByOrderId.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetPaymentDataByOrderId{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataByOrderIdQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[17], Item.this.paidByContactIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataByOrderIdQuery.Item.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], Item.this.transactionId, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataByOrderIdQuery.Item.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelPaymentDataFilterInput modelPaymentDataFilterInput, Integer num, String str2) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentDataByOrderIdQuery.Variables.1
    ...
    public GetPaymentDataByOrderIdQuery(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelPaymentDataFilterInput modelPaymentDataFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelStringKeyConditionInput, modelSortDirection, modelPaymentDataFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "863b75e7c8bbb57029de8fe250a08d5f3b14703e2832bc0a05275c7abcc0b848";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetPaymentDataByOrderId($orderId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelPaymentDataFilterInput, $limit: Int, $nextToken: String) {\n  getPaymentDataByOrderId(orderId: $orderId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      paymentRequestType\n      engagementId\n      paymentProvider\n      orderIdInPaymentProvider\n      orderId\n      paymentLinkId\n      paymentLinkUrl\n      amount\n      amountPaid\n      currency\n      status\n      lastPaymentStatus\n      finalPaymentDate\n      paidByContactIds\n      transactionId\n      note\n      createdAt\n      updatedAt\n      customPaymentData\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    }
