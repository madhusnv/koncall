...
import type.UpdateWabaAccountInput;

/* loaded from: classes4.dex */
public final class UpdateWabaAccountMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation UpdateWabaAccount($input: UpdateWabaAccountInput!, $condition: ModelWabaAccountConditionInput) {\n  updateWabaAccount(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    wabaAccountName\n    accessToken\n    accountId\n    remainingFreeTierConversationsOverall\n    remainingBalanceOverall\n    remainingBalanceBroadcast\n    blockedBalanceOverall\n    blockedBalanceBroadcast\n    promptForPaymentThreshold\n    createdAt\n    updatedAt\n    currentLimitCategory\n    maxDailyConversationPerPhone\n    maxPhoneNumbersPerBusiness\n    maxPhoneNumbersPerWaba\n    restrictionInfo {\n      __typename\n      restrictionType\n      restrictionExpiry\n    }\n    wabaBanState\n    wabaBanDate\n    wabaDecision\n    wabaDecisionTime\n    rejectionReason\n    createdById\n    updatedById\n    wabaPhoneNumbers {\n      __typename\n      nextToken\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaAccountMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "UpdateWabaAccount";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation UpdateWabaAccount($input: UpdateWabaAccountInput!, $condition: ModelWabaAccountConditionInput) {\n  updateWabaAccount(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    wabaAccountName\n    accessToken\n    accountId\n    remainingFreeTierConversationsOverall\n    remainingBalanceOverall\n    remainingBalanceBroadcast\n    blockedBalanceOverall\n    blockedBalanceBroadcast\n    promptForPaymentThreshold\n    createdAt\n    updatedAt\n    currentLimitCategory\n    maxDailyConversationPerPhone\n    maxPhoneNumbersPerBusiness\n    maxPhoneNumbersPerWaba\n    restrictionInfo {\n      __typename\n      restrictionType\n      restrictionExpiry\n    }\n    wabaBanState\n    wabaBanDate\n    wabaDecision\n    wabaDecisionTime\n    rejectionReason\n    createdById\n    updatedById\n    wabaPhoneNumbers {\n      __typename\n      nextToken\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelWabaAccountConditionInput condition;
        private UpdateWabaAccountInput input;

        public UpdateWabaAccountMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new UpdateWabaAccountMutation(this.input, this.condition);
        }
        ...
        public Builder input(UpdateWabaAccountInput updateWabaAccountInput) {
            this.input = updateWabaAccountInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("updateWabaAccount", "updateWabaAccount", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final UpdateWabaAccount updateWabaAccount;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final UpdateWabaAccount.Mapper updateWabaAccountFieldMapper = new UpdateWabaAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((UpdateWabaAccount) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<UpdateWabaAccount>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaAccountMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdateWabaAccount read(ResponseReader responseReader2) {
                        return Mapper.this.updateWabaAccountFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(UpdateWabaAccount updateWabaAccount) {
            this.updateWabaAccount = updateWabaAccount;
        }
        ...
        public boolean equals(Object obj) {
            ...
            UpdateWabaAccount updateWabaAccount = this.updateWabaAccount;
            UpdateWabaAccount updateWabaAccount2 = ((Data) obj).updateWabaAccount;
            return updateWabaAccount == null ? updateWabaAccount2 == null : updateWabaAccount.equals(updateWabaAccount2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                UpdateWabaAccount updateWabaAccount = this.updateWabaAccount;
                this.$hashCode = (updateWabaAccount == null ? 0 : updateWabaAccount.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaAccountMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    UpdateWabaAccount updateWabaAccount = Data.this.updateWabaAccount;
                    responseWriter.writeObject(responseField, updateWabaAccount != null ? updateWabaAccount.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{updateWabaAccount=" + this.updateWabaAccount + "}";
            }
            return this.$toString;
        }

        public UpdateWabaAccount updateWabaAccount() {
            return this.updateWabaAccount;
        }
    }
    ...
    public static class RestrictionInfo {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaAccountMutation.RestrictionInfo.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = RestrictionInfo.$responseFields;
    ...
    public static class UpdateWabaAccount {
        ...
        public static final class Mapper implements ResponseFieldMapper<UpdateWabaAccount> {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateWabaAccount)) {
                return false;
            }
            UpdateWabaAccount updateWabaAccount = (UpdateWabaAccount) obj;
            if (this.__typename.equals(updateWabaAccount.__typename) && this.id.equals(updateWabaAccount.id) && this.wabaAccountId.equals(updateWabaAccount.wabaAccountId) && ((str = this.wabaAccountName) != null ? str.equals(updateWabaAccount.wabaAccountName) : updateWabaAccount.wabaAccountName == null) && ((str2 = this.accessToken) != null ? str2.equals(updateWabaAccount.accessToken) : updateWabaAccount.accessToken == null) && this.accountId.equals(updateWabaAccount.accountId) && ((num = this.remainingFreeTierConversationsOverall) != null ? num.equals(updateWabaAccount.remainingFreeTierConversationsOverall) : updateWabaAccount.remainingFreeTierConversationsOverall == null) && ((d = this.remainingBalanceOverall) != null ? d.equals(updateWabaAccount.remainingBalanceOverall) : updateWabaAccount.remainingBalanceOverall == null) && ((d2 = this.remainingBalanceBroadcast) != null ? d2.equals(updateWabaAccount.remainingBalanceBroadcast) : updateWabaAccount.remainingBalanceBroadcast == null) && ((d3 = this.blockedBalanceOverall) != null ? d3.equals(updateWabaAccount.blockedBalanceOverall) : updateWabaAccount.blockedBalanceOverall == null) && ((d4 = this.blockedBalanceBroadcast) != null ? d4.equals(updateWabaAccount.blockedBalanceBroadcast) : updateWabaAccount.blockedBalanceBroadcast == null) && ((d5 = this.promptForPaymentThreshold) != null ? d5.equals(updateWabaAccount.promptForPaymentThreshold) : updateWabaAccount.promptForPaymentThreshold == null) && ((str3 = this.createdAt) != null ? str3.equals(updateWabaAccount.createdAt) : updateWabaAccount.createdAt == null) && ((str4 = this.updatedAt) != null ? str4.equals(updateWabaAccount.updatedAt) : updateWabaAccount.updatedAt == null) && ((str5 = this.currentLimitCategory) != null ? str5.equals(updateWabaAccount.currentLimitCategory) : updateWabaAccount.currentLimitCategory == null) && ((num2 = this.maxDailyConversationPerPhone) != null ? num2.equals(updateWabaAccount.maxDailyConversationPerPhone) : updateWabaAccount.maxDailyConversationPerPhone == null) && ((num3 = this.maxPhoneNumbersPerBusiness) != null ? num3.equals(updateWabaAccount.maxPhoneNumbersPerBusiness) : updateWabaAccount.maxPhoneNumbersPerBusiness == null) && ((num4 = this.maxPhoneNumbersPerWaba) != null ? num4.equals(updateWabaAccount.maxPhoneNumbersPerWaba) : updateWabaAccount.maxPhoneNumbersPerWaba == null) && ((list = this.restrictionInfo) != null ? list.equals(updateWabaAccount.restrictionInfo) : updateWabaAccount.restrictionInfo == null) && ((str6 = this.wabaBanState) != null ? str6.equals(updateWabaAccount.wabaBanState) : updateWabaAccount.wabaBanState == null) && ((str7 = this.wabaBanDate) != null ? str7.equals(updateWabaAccount.wabaBanDate) : updateWabaAccount.wabaBanDate == null) && ((str8 = this.wabaDecision) != null ? str8.equals(updateWabaAccount.wabaDecision) : updateWabaAccount.wabaDecision == null) && ((str9 = this.wabaDecisionTime) != null ? str9.equals(updateWabaAccount.wabaDecisionTime) : updateWabaAccount.wabaDecisionTime == null) && ((str10 = this.rejectionReason) != null ? str10.equals(updateWabaAccount.rejectionReason) : updateWabaAccount.rejectionReason == null) && ((str11 = this.createdById) != null ? str11.equals(updateWabaAccount.createdById) : updateWabaAccount.createdById == null) && ((str12 = this.updatedById) != null ? str12.equals(updateWabaAccount.updatedById) : updateWabaAccount.updatedById == null)) {
                WabaPhoneNumbers wabaPhoneNumbers = this.wabaPhoneNumbers;
                WabaPhoneNumbers wabaPhoneNumbers2 = updateWabaAccount.wabaPhoneNumbers;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaAccountMutation.UpdateWabaAccount.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdateWabaAccount.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UpdateWabaAccount.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], UpdateWabaAccount.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], UpdateWabaAccount.this.wabaAccountId);
                    responseWriter.writeString(responseFieldArr[3], UpdateWabaAccount.this.wabaAccountName);
                    responseWriter.writeString(responseFieldArr[4], UpdateWabaAccount.this.accessToken);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], UpdateWabaAccount.this.accountId);
                    responseWriter.writeInt(responseFieldArr[6], UpdateWabaAccount.this.remainingFreeTierConversationsOverall);
                    responseWriter.writeDouble(responseFieldArr[7], UpdateWabaAccount.this.remainingBalanceOverall);
                    responseWriter.writeDouble(responseFieldArr[8], UpdateWabaAccount.this.remainingBalanceBroadcast);
                    responseWriter.writeDouble(responseFieldArr[9], UpdateWabaAccount.this.blockedBalanceOverall);
                    responseWriter.writeDouble(responseFieldArr[10], UpdateWabaAccount.this.blockedBalanceBroadcast);
                    responseWriter.writeDouble(responseFieldArr[11], UpdateWabaAccount.this.promptForPaymentThreshold);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], UpdateWabaAccount.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[13], UpdateWabaAccount.this.updatedAt);
                    responseWriter.writeString(responseFieldArr[14], UpdateWabaAccount.this.currentLimitCategory);
                    responseWriter.writeInt(responseFieldArr[15], UpdateWabaAccount.this.maxDailyConversationPerPhone);
                    responseWriter.writeInt(responseFieldArr[16], UpdateWabaAccount.this.maxPhoneNumbersPerBusiness);
                    responseWriter.writeInt(responseFieldArr[17], UpdateWabaAccount.this.maxPhoneNumbersPerWaba);
                    responseWriter.writeList(responseFieldArr[18], UpdateWabaAccount.this.restrictionInfo, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaAccountMutation.UpdateWabaAccount.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((RestrictionInfo) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[19], UpdateWabaAccount.this.wabaBanState);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], UpdateWabaAccount.this.wabaBanDate);
                    responseWriter.writeString(responseFieldArr[21], UpdateWabaAccount.this.wabaDecision);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], UpdateWabaAccount.this.wabaDecisionTime);
                    responseWriter.writeString(responseFieldArr[23], UpdateWabaAccount.this.rejectionReason);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[24], UpdateWabaAccount.this.createdById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], UpdateWabaAccount.this.updatedById);
                    ResponseField responseField = responseFieldArr[26];
                    WabaPhoneNumbers wabaPhoneNumbers = UpdateWabaAccount.this.wabaPhoneNumbers;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final UpdateWabaAccountInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(UpdateWabaAccountInput updateWabaAccountInput, ModelWabaAccountConditionInput modelWabaAccountConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = updateWabaAccountInput;
            this.condition = modelWabaAccountConditionInput;
            linkedHashMap.put("input", updateWabaAccountInput);
        ...
        public UpdateWabaAccountInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaAccountMutation.Variables.1
    ...
    public static class WabaPhoneNumbers {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaAccountMutation.WabaPhoneNumbers.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = WabaPhoneNumbers.$responseFields;
    ...
    public UpdateWabaAccountMutation(UpdateWabaAccountInput updateWabaAccountInput, ModelWabaAccountConditionInput modelWabaAccountConditionInput) {
        Utils.checkNotNull(updateWabaAccountInput, "input == null");
        this.variables = new Variables(updateWabaAccountInput, modelWabaAccountConditionInput);
    }
    ...
    public String operationId() {
        return "d8881b773f939a1062e0fdaf37e2c113ce80eb0991b1cc09628f2fb477f5670a";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation UpdateWabaAccount($input: UpdateWabaAccountInput!, $condition: ModelWabaAccountConditionInput) {\n  updateWabaAccount(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    wabaAccountName\n    accessToken\n    accountId\n    remainingFreeTierConversationsOverall\n    remainingBalanceOverall\n    remainingBalanceBroadcast\n    blockedBalanceOverall\n    blockedBalanceBroadcast\n    promptForPaymentThreshold\n    createdAt\n    updatedAt\n    currentLimitCategory\n    maxDailyConversationPerPhone\n    maxPhoneNumbersPerBusiness\n    maxPhoneNumbersPerWaba\n    restrictionInfo {\n      __typename\n      restrictionType\n      restrictionExpiry\n    }\n    wabaBanState\n    wabaBanDate\n    wabaDecision\n    wabaDecisionTime\n    rejectionReason\n    createdById\n    updatedById\n    wabaPhoneNumbers {\n      __typename\n      nextToken\n    }\n  }\n}";
    }
