...
public final class CreateAccountSubscriptionBillCycleMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation CreateAccountSubscriptionBillCycle($input: CreateAccountSubscriptionBillCycleInput!, $condition: ModelAccountSubscriptionBillCycleConditionInput) {\n  createAccountSubscriptionBillCycle(input: $input, condition: $condition) {\n    __typename\n    id\n    productAccountId\n    accountId\n    addedById\n    period\n    lastBillDate\n    nextBillDate\n    createdAt\n    updatedAt\n    productAccount {\n      __typename\n      id\n      accountName\n      accountType\n      deviceKey\n      deviceKeyLastUpdated\n      accountStatus\n      businessLogoUrl\n      createdById\n      dateFormat\n      dateTimeViewStyle\n      defaultCurrency\n      denomination\n      industry\n      nameOfBusiness\n      productOrService\n      timeFormat\n      timeZone\n      plan\n      paidUpTo\n      seats\n      freeSeats\n      currentTotalUsers\n      currentActiveUsers\n      extraActiveUsers\n      pricePerSeat\n      allowAddingSeat\n      allowAddingSeatTill\n      seatReductionMarkedForNextCycle\n      billingCurrency\n      billingEmail\n      taxId\n      taxIdType\n      trialAccountEndDate\n      trialExtensionTimes\n      eligibleForExtension\n      paidForTillDate\n      updatedById\n      website\n      permissions\n      enableCustomCharts\n      createdAt\n      updatedAt\n      dealMode\n      openAiApiKey\n      salesmaxSalesContacts\n      salesmaxSupportContacts\n      chatWidgetConfig\n      onboardingStatus\n      integrationNeeded\n      matchingDealId\n      relatedAccountIds\n      lastChurnDate\n      lastChurnReason\n      possibleReactivationDate\n      locationPeriodicFrequency\n      lastPaymentDataId\n      lastPaymentDataCreatedAt\n      nextRenewalDateIfPaid\n      lastPaymentStatus\n      partPaymentAmountIfAny\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.CreateAccountSubscriptionBillCycleMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "CreateAccountSubscriptionBillCycle";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation CreateAccountSubscriptionBillCycle($input: CreateAccountSubscriptionBillCycleInput!, $condition: ModelAccountSubscriptionBillCycleConditionInput) {\n  createAccountSubscriptionBillCycle(input: $input, condition: $condition) {\n    __typename\n    id\n    productAccountId\n    accountId\n    addedById\n    period\n    lastBillDate\n    nextBillDate\n    createdAt\n    updatedAt\n    productAccount {\n      __typename\n      id\n      accountName\n      accountType\n      deviceKey\n      deviceKeyLastUpdated\n      accountStatus\n      businessLogoUrl\n      createdById\n      dateFormat\n      dateTimeViewStyle\n      defaultCurrency\n      denomination\n      industry\n      nameOfBusiness\n      productOrService\n      timeFormat\n      timeZone\n      plan\n      paidUpTo\n      seats\n      freeSeats\n      currentTotalUsers\n      currentActiveUsers\n      extraActiveUsers\n      pricePerSeat\n      allowAddingSeat\n      allowAddingSeatTill\n      seatReductionMarkedForNextCycle\n      billingCurrency\n      billingEmail\n      taxId\n      taxIdType\n      trialAccountEndDate\n      trialExtensionTimes\n      eligibleForExtension\n      paidForTillDate\n      updatedById\n      website\n      permissions\n      enableCustomCharts\n      createdAt\n      updatedAt\n      dealMode\n      openAiApiKey\n      salesmaxSalesContacts\n      salesmaxSupportContacts\n      chatWidgetConfig\n      onboardingStatus\n      integrationNeeded\n      matchingDealId\n      relatedAccountIds\n      lastChurnDate\n      lastChurnReason\n      possibleReactivationDate\n      locationPeriodicFrequency\n      lastPaymentDataId\n      lastPaymentDataCreatedAt\n      nextRenewalDateIfPaid\n      lastPaymentStatus\n      partPaymentAmountIfAny\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelAccountSubscriptionBillCycleConditionInput condition;
        private CreateAccountSubscriptionBillCycleInput input;

        public CreateAccountSubscriptionBillCycleMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new CreateAccountSubscriptionBillCycleMutation(this.input, this.condition);
        }
        ...
        public Builder input(CreateAccountSubscriptionBillCycleInput createAccountSubscriptionBillCycleInput) {
            this.input = createAccountSubscriptionBillCycleInput;
            return this;
        }
    }

    public static class CreateAccountSubscriptionBillCycle {
        ...
        public static final class Mapper implements ResponseFieldMapper<CreateAccountSubscriptionBillCycle> {
            final ProductAccount.Mapper productAccountFieldMapper = new ProductAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public CreateAccountSubscriptionBillCycle map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = CreateAccountSubscriptionBillCycle.$responseFields;
                return new CreateAccountSubscriptionBillCycle(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[8]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[9]), (ProductAccount) responseReader.readObject(responseFieldArr[10], new ResponseReader.ObjectReader<ProductAccount>() { // from class: com.amazonaws.amplify.generated.graphql.CreateAccountSubscriptionBillCycleMutation.CreateAccountSubscriptionBillCycle.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
        ...
        public CreateAccountSubscriptionBillCycle(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, ProductAccount productAccount) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateAccountSubscriptionBillCycle)) {
                return false;
            }
            CreateAccountSubscriptionBillCycle createAccountSubscriptionBillCycle = (CreateAccountSubscriptionBillCycle) obj;
            if (this.__typename.equals(createAccountSubscriptionBillCycle.__typename) && this.id.equals(createAccountSubscriptionBillCycle.id) && this.productAccountId.equals(createAccountSubscriptionBillCycle.productAccountId) && this.accountId.equals(createAccountSubscriptionBillCycle.accountId) && this.addedById.equals(createAccountSubscriptionBillCycle.addedById) && ((str = this.period) != null ? str.equals(createAccountSubscriptionBillCycle.period) : createAccountSubscriptionBillCycle.period == null) && this.lastBillDate.equals(createAccountSubscriptionBillCycle.lastBillDate) && this.nextBillDate.equals(createAccountSubscriptionBillCycle.nextBillDate) && this.createdAt.equals(createAccountSubscriptionBillCycle.createdAt) && this.updatedAt.equals(createAccountSubscriptionBillCycle.updatedAt)) {
                ProductAccount productAccount = this.productAccount;
                ProductAccount productAccount2 = createAccountSubscriptionBillCycle.productAccount;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateAccountSubscriptionBillCycleMutation.CreateAccountSubscriptionBillCycle.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateAccountSubscriptionBillCycle.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateAccountSubscriptionBillCycle.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateAccountSubscriptionBillCycle.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], CreateAccountSubscriptionBillCycle.this.productAccountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], CreateAccountSubscriptionBillCycle.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], CreateAccountSubscriptionBillCycle.this.addedById);
                    responseWriter.writeString(responseFieldArr[5], CreateAccountSubscriptionBillCycle.this.period);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], CreateAccountSubscriptionBillCycle.this.lastBillDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], CreateAccountSubscriptionBillCycle.this.nextBillDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], CreateAccountSubscriptionBillCycle.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], CreateAccountSubscriptionBillCycle.this.updatedAt);
                    ResponseField responseField = responseFieldArr[10];
                    ProductAccount productAccount = CreateAccountSubscriptionBillCycle.this.productAccount;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "CreateAccountSubscriptionBillCycle{__typename=" + this.__typename + ", id=" + this.id + ", productAccountId=" + this.productAccountId + ", accountId=" + this.accountId + ", addedById=" + this.addedById + ", period=" + this.period + ", lastBillDate=" + this.lastBillDate + ", nextBillDate=" + this.nextBillDate + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", productAccount=" + this.productAccount + "}";
            }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createAccountSubscriptionBillCycle", "createAccountSubscriptionBillCycle", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final CreateAccountSubscriptionBillCycle createAccountSubscriptionBillCycle;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateAccountSubscriptionBillCycle.Mapper createAccountSubscriptionBillCycleFieldMapper = new CreateAccountSubscriptionBillCycle.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateAccountSubscriptionBillCycle) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateAccountSubscriptionBillCycle>() { // from class: com.amazonaws.amplify.generated.graphql.CreateAccountSubscriptionBillCycleMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateAccountSubscriptionBillCycle read(ResponseReader responseReader2) {
                        return Mapper.this.createAccountSubscriptionBillCycleFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateAccountSubscriptionBillCycle createAccountSubscriptionBillCycle) {
            this.createAccountSubscriptionBillCycle = createAccountSubscriptionBillCycle;
        }

        public CreateAccountSubscriptionBillCycle createAccountSubscriptionBillCycle() {
            return this.createAccountSubscriptionBillCycle;
        }
        ...
        public boolean equals(Object obj) {
            ...
            CreateAccountSubscriptionBillCycle createAccountSubscriptionBillCycle = this.createAccountSubscriptionBillCycle;
            CreateAccountSubscriptionBillCycle createAccountSubscriptionBillCycle2 = ((Data) obj).createAccountSubscriptionBillCycle;
            return createAccountSubscriptionBillCycle == null ? createAccountSubscriptionBillCycle2 == null : createAccountSubscriptionBillCycle.equals(createAccountSubscriptionBillCycle2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateAccountSubscriptionBillCycle createAccountSubscriptionBillCycle = this.createAccountSubscriptionBillCycle;
                this.$hashCode = (createAccountSubscriptionBillCycle == null ? 0 : createAccountSubscriptionBillCycle.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateAccountSubscriptionBillCycleMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateAccountSubscriptionBillCycle createAccountSubscriptionBillCycle = Data.this.createAccountSubscriptionBillCycle;
                    responseWriter.writeObject(responseField, createAccountSubscriptionBillCycle != null ? createAccountSubscriptionBillCycle.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createAccountSubscriptionBillCycle=" + this.createAccountSubscriptionBillCycle + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class ProductAccount {
        ...
        public static final class Mapper implements ResponseFieldMapper<ProductAccount> {
            ...
            public ProductAccount map(ResponseReader responseReader) {
                ...
                }), responseReader.readList(responseFieldArr[46], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateAccountSubscriptionBillCycleMutation.ProductAccount.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateAccountSubscriptionBillCycleMutation.ProductAccount.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ProductAccount.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[15], ProductAccount.this.productOrService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateAccountSubscriptionBillCycleMutation.ProductAccount.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[39], ProductAccount.this.permissions, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateAccountSubscriptionBillCycleMutation.ProductAccount.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[45], ProductAccount.this.salesmaxSalesContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateAccountSubscriptionBillCycleMutation.ProductAccount.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[46], ProductAccount.this.salesmaxSupportContacts, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateAccountSubscriptionBillCycleMutation.ProductAccount.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[51], ProductAccount.this.relatedAccountIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateAccountSubscriptionBillCycleMutation.ProductAccount.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final CreateAccountSubscriptionBillCycleInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateAccountSubscriptionBillCycleInput createAccountSubscriptionBillCycleInput, ModelAccountSubscriptionBillCycleConditionInput modelAccountSubscriptionBillCycleConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createAccountSubscriptionBillCycleInput;
            this.condition = modelAccountSubscriptionBillCycleConditionInput;
            linkedHashMap.put("input", createAccountSubscriptionBillCycleInput);
        ...
        public CreateAccountSubscriptionBillCycleInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateAccountSubscriptionBillCycleMutation.Variables.1
    ...
    public CreateAccountSubscriptionBillCycleMutation(CreateAccountSubscriptionBillCycleInput createAccountSubscriptionBillCycleInput, ModelAccountSubscriptionBillCycleConditionInput modelAccountSubscriptionBillCycleConditionInput) {
        Utils.checkNotNull(createAccountSubscriptionBillCycleInput, "input == null");
        this.variables = new Variables(createAccountSubscriptionBillCycleInput, modelAccountSubscriptionBillCycleConditionInput);
    }
    ...
    public String operationId() {
        return "37ac920a5e658b1b69e3c09d98ae5cc54388e45099806f776ec8d65a4488314c";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateAccountSubscriptionBillCycle($input: CreateAccountSubscriptionBillCycleInput!, $condition: ModelAccountSubscriptionBillCycleConditionInput) {\n  createAccountSubscriptionBillCycle(input: $input, condition: $condition) {\n    __typename\n    id\n    productAccountId\n    accountId\n    addedById\n    period\n    lastBillDate\n    nextBillDate\n    createdAt\n    updatedAt\n    productAccount {\n      __typename\n      id\n      accountName\n      accountType\n      deviceKey\n      deviceKeyLastUpdated\n      accountStatus\n      businessLogoUrl\n      createdById\n      dateFormat\n      dateTimeViewStyle\n      defaultCurrency\n      denomination\n      industry\n      nameOfBusiness\n      productOrService\n      timeFormat\n      timeZone\n      plan\n      paidUpTo\n      seats\n      freeSeats\n      currentTotalUsers\n      currentActiveUsers\n      extraActiveUsers\n      pricePerSeat\n      allowAddingSeat\n      allowAddingSeatTill\n      seatReductionMarkedForNextCycle\n      billingCurrency\n      billingEmail\n      taxId\n      taxIdType\n      trialAccountEndDate\n      trialExtensionTimes\n      eligibleForExtension\n      paidForTillDate\n      updatedById\n      website\n      permissions\n      enableCustomCharts\n      createdAt\n      updatedAt\n      dealMode\n      openAiApiKey\n      salesmaxSalesContacts\n      salesmaxSupportContacts\n      chatWidgetConfig\n      onboardingStatus\n      integrationNeeded\n      matchingDealId\n      relatedAccountIds\n      lastChurnDate\n      lastChurnReason\n      possibleReactivationDate\n      locationPeriodicFrequency\n      lastPaymentDataId\n      lastPaymentDataCreatedAt\n      nextRenewalDateIfPaid\n      lastPaymentStatus\n      partPaymentAmountIfAny\n    }\n  }\n}";
    }
