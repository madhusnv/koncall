...
public final class GetFilesByProductQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetFilesByProduct($productId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelfileObjectRelationshipFilterInput, $limit: Int, $nextToken: String) {\n  getFilesByProduct(productId: $productId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      fileId\n      fileUrl\n      contactId\n      engagementId\n      businessId\n      dealId\n      productId\n      createdAt\n      updatedAt\n      parentObjectId\n      parentObjectType\n      fieldName\n      inputContext\n      transcription\n      translatedTranscription\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByProductQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetFilesByProduct";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetFilesByProduct($productId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelfileObjectRelationshipFilterInput, $limit: Int, $nextToken: String) {\n  getFilesByProduct(productId: $productId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      fileId\n      fileUrl\n      contactId\n      engagementId\n      businessId\n      dealId\n      productId\n      createdAt\n      updatedAt\n      parentObjectId\n      parentObjectType\n      fieldName\n      inputContext\n      transcription\n      translatedTranscription\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetFilesByProductQuery build() {
            return new GetFilesByProductQuery(this.productId, this.updatedAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getFilesByProduct", "getFilesByProduct", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put("productId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "productId").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("updatedAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "updatedAt").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetFilesByProduct getFilesByProduct;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetFilesByProduct.Mapper getFilesByProductFieldMapper = new GetFilesByProduct.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetFilesByProduct) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetFilesByProduct>() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByProductQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetFilesByProduct read(ResponseReader responseReader2) {
                        return Mapper.this.getFilesByProductFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetFilesByProduct getFilesByProduct) {
            this.getFilesByProduct = getFilesByProduct;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetFilesByProduct getFilesByProduct = this.getFilesByProduct;
            GetFilesByProduct getFilesByProduct2 = ((Data) obj).getFilesByProduct;
            return getFilesByProduct == null ? getFilesByProduct2 == null : getFilesByProduct.equals(getFilesByProduct2);
        }

        public GetFilesByProduct getFilesByProduct() {
            return this.getFilesByProduct;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetFilesByProduct getFilesByProduct = this.getFilesByProduct;
                this.$hashCode = (getFilesByProduct == null ? 0 : getFilesByProduct.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByProductQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetFilesByProduct getFilesByProduct = Data.this.getFilesByProduct;
                    responseWriter.writeObject(responseField, getFilesByProduct != null ? getFilesByProduct.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getFilesByProduct=" + this.getFilesByProduct + "}";
            }
            return this.$toString;
        }
    }

    public static class GetFilesByProduct {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetFilesByProduct> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetFilesByProduct map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetFilesByProduct.$responseFields;
                return new GetFilesByProduct(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByProductQuery.GetFilesByProduct.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByProductQuery.GetFilesByProduct.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetFilesByProduct(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetFilesByProduct)) {
                return false;
            }
            GetFilesByProduct getFilesByProduct = (GetFilesByProduct) obj;
            if (this.__typename.equals(getFilesByProduct.__typename) && this.items.equals(getFilesByProduct.items)) {
                String str = this.nextToken;
                String str2 = getFilesByProduct.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByProductQuery.GetFilesByProduct.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetFilesByProduct.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetFilesByProduct.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetFilesByProduct.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByProductQuery.GetFilesByProduct.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetFilesByProduct.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetFilesByProduct{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByProductQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetFilesByProductQuery.Variables.1
    ...
    public GetFilesByProductQuery(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelfileObjectRelationshipFilterInput modelfileObjectRelationshipFilterInput, Integer num, String str2) {
    ...
    public String operationId() {
        return "46fefe74c7802db862e64410e20efcf8ec8b809d5bf5612fb1363765aa5e1553";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetFilesByProduct($productId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelfileObjectRelationshipFilterInput, $limit: Int, $nextToken: String) {\n  getFilesByProduct(productId: $productId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      fileId\n      fileUrl\n      contactId\n      engagementId\n      businessId\n      dealId\n      productId\n      createdAt\n      updatedAt\n      parentObjectId\n      parentObjectType\n      fieldName\n      inputContext\n      transcription\n      translatedTranscription\n    }\n    nextToken\n  }\n}";
    }
