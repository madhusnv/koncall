...
public final class ListAllNotificationsByOwnerQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListAllNotificationsByOwner($accountId: ID, $ownerIdScheduledAt: ModelNotificationStagingAllNotificationsByOwnerCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelNotificationStagingFilterInput, $limit: Int, $nextToken: String) {\n  listAllNotificationsByOwner(accountId: $accountId, ownerIdScheduledAt: $ownerIdScheduledAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      notificationId\n      notificationChannel\n      notificationStatus\n      notificationType\n      notificationRelatedObjectType\n      notificationRelatedObjectId\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      content\n      createdAt\n      updatedAt\n      scheduledAt\n      expirationUnixTime\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListAllNotificationsByOwnerQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListAllNotificationsByOwner";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListAllNotificationsByOwner($accountId: ID, $ownerIdScheduledAt: ModelNotificationStagingAllNotificationsByOwnerCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelNotificationStagingFilterInput, $limit: Int, $nextToken: String) {\n  listAllNotificationsByOwner(accountId: $accountId, ownerIdScheduledAt: $ownerIdScheduledAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      notificationId\n      notificationChannel\n      notificationStatus\n      notificationType\n      notificationRelatedObjectType\n      notificationRelatedObjectId\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      content\n      createdAt\n      updatedAt\n      scheduledAt\n      expirationUnixTime\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        private C19192x9c702555 ownerIdScheduledAt;
        ...
        public ListAllNotificationsByOwnerQuery build() {
            return new ListAllNotificationsByOwnerQuery(this.accountId, this.ownerIdScheduledAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
        ...
        public Builder ownerIdScheduledAt(C19192x9c702555 c19192x9c702555) {
            this.ownerIdScheduledAt = c19192x9c702555;
            return this;
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listAllNotificationsByOwner", "listAllNotificationsByOwner", new UnmodifiableMapBuilder(6).put("ownerIdScheduledAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "ownerIdScheduledAt").build()).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListAllNotificationsByOwner listAllNotificationsByOwner;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListAllNotificationsByOwner.Mapper listAllNotificationsByOwnerFieldMapper = new ListAllNotificationsByOwner.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListAllNotificationsByOwner) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListAllNotificationsByOwner>() { // from class: com.amazonaws.amplify.generated.graphql.ListAllNotificationsByOwnerQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListAllNotificationsByOwner read(ResponseReader responseReader2) {
                        return Mapper.this.listAllNotificationsByOwnerFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListAllNotificationsByOwner listAllNotificationsByOwner) {
            this.listAllNotificationsByOwner = listAllNotificationsByOwner;
        }
        ...
        public boolean equals(Object obj) {
            ...
            ListAllNotificationsByOwner listAllNotificationsByOwner = this.listAllNotificationsByOwner;
            ListAllNotificationsByOwner listAllNotificationsByOwner2 = ((Data) obj).listAllNotificationsByOwner;
            return listAllNotificationsByOwner == null ? listAllNotificationsByOwner2 == null : listAllNotificationsByOwner.equals(listAllNotificationsByOwner2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListAllNotificationsByOwner listAllNotificationsByOwner = this.listAllNotificationsByOwner;
                this.$hashCode = (listAllNotificationsByOwner == null ? 0 : listAllNotificationsByOwner.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListAllNotificationsByOwner listAllNotificationsByOwner() {
            return this.listAllNotificationsByOwner;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListAllNotificationsByOwnerQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListAllNotificationsByOwner listAllNotificationsByOwner = Data.this.listAllNotificationsByOwner;
                    responseWriter.writeObject(responseField, listAllNotificationsByOwner != null ? listAllNotificationsByOwner.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listAllNotificationsByOwner=" + this.listAllNotificationsByOwner + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListAllNotificationsByOwnerQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static class ListAllNotificationsByOwner {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListAllNotificationsByOwner> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListAllNotificationsByOwner map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListAllNotificationsByOwner.$responseFields;
                return new ListAllNotificationsByOwner(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListAllNotificationsByOwnerQuery.ListAllNotificationsByOwner.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListAllNotificationsByOwnerQuery.ListAllNotificationsByOwner.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListAllNotificationsByOwner(String str, List<Item> list, String str2) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListAllNotificationsByOwner)) {
                return false;
            }
            ListAllNotificationsByOwner listAllNotificationsByOwner = (ListAllNotificationsByOwner) obj;
            if (this.__typename.equals(listAllNotificationsByOwner.__typename) && this.items.equals(listAllNotificationsByOwner.items)) {
                String str = this.nextToken;
                String str2 = listAllNotificationsByOwner.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListAllNotificationsByOwnerQuery.ListAllNotificationsByOwner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListAllNotificationsByOwner.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListAllNotificationsByOwner.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListAllNotificationsByOwner.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListAllNotificationsByOwnerQuery.ListAllNotificationsByOwner.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListAllNotificationsByOwner.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListAllNotificationsByOwner{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final C19192x9c702555 ownerIdScheduledAt;
        private final ModelSortDirection sortDirection;
        private final transient Map<String, Object> valueMap;

        public Variables(String str, C19192x9c702555 c19192x9c702555, ModelSortDirection modelSortDirection, ModelNotificationStagingFilterInput modelNotificationStagingFilterInput, Integer num, String str2) {
            ...
            linkedHashMap.put("ownerIdScheduledAt", c19192x9c702555);
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListAllNotificationsByOwnerQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("accountId", Variables.this.accountId);
                    inputFieldWriter.writeObject("ownerIdScheduledAt", Variables.this.ownerIdScheduledAt != null ? Variables.this.ownerIdScheduledAt.marshaller() : null);
        ...
        public C19192x9c702555 ownerIdScheduledAt() {
            return this.ownerIdScheduledAt;
        }
    ...
    public ListAllNotificationsByOwnerQuery(String str, C19192x9c702555 c19192x9c702555, ModelSortDirection modelSortDirection, ModelNotificationStagingFilterInput modelNotificationStagingFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, c19192x9c702555, modelSortDirection, modelNotificationStagingFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "891007556409c21d5c1db88111b517e5ba389868fbeb30eb9329b4884fc83dfa";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListAllNotificationsByOwner($accountId: ID, $ownerIdScheduledAt: ModelNotificationStagingAllNotificationsByOwnerCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelNotificationStagingFilterInput, $limit: Int, $nextToken: String) {\n  listAllNotificationsByOwner(accountId: $accountId, ownerIdScheduledAt: $ownerIdScheduledAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      notificationId\n      notificationChannel\n      notificationStatus\n      notificationType\n      notificationRelatedObjectType\n      notificationRelatedObjectId\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      content\n      createdAt\n      updatedAt\n      scheduledAt\n      expirationUnixTime\n    }\n    nextToken\n  }\n}";
    }
