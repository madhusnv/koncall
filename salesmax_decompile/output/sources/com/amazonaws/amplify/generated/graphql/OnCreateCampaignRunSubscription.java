...
public final class OnCreateCampaignRunSubscription implements Subscription<Data, Data, Operation.Variables> {
    public static final String OPERATION_DEFINITION = "subscription OnCreateCampaignRun {\n  onCreateCampaignRun {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateCampaignRunSubscription.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "OnCreateCampaignRun";
        }
    };
    public static final String QUERY_DOCUMENT = "subscription OnCreateCampaignRun {\n  onCreateCampaignRun {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Operation.Variables variables = Operation.EMPTY_VARIABLES;

    public static final class Builder {
        public OnCreateCampaignRunSubscription build() {
            return new OnCreateCampaignRunSubscription();
        }
    }
    ...
    public static class Campaign {
        ...
        public static final class Mapper implements ResponseFieldMapper<Campaign> {
            ...
            public Campaign map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[15], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateCampaignRunSubscription.Campaign.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateCampaignRunSubscription.Campaign.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[15], Campaign.this.daysToSend, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateCampaignRunSubscription.Campaign.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[29], Campaign.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateCampaignRunSubscription.Campaign.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("onCreateCampaignRun", "onCreateCampaignRun", null, true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnCreateCampaignRun onCreateCampaignRun;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final OnCreateCampaignRun.Mapper onCreateCampaignRunFieldMapper = new OnCreateCampaignRun.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((OnCreateCampaignRun) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<OnCreateCampaignRun>() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateCampaignRunSubscription.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public OnCreateCampaignRun read(ResponseReader responseReader2) {
                        return Mapper.this.onCreateCampaignRunFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(OnCreateCampaignRun onCreateCampaignRun) {
            this.onCreateCampaignRun = onCreateCampaignRun;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnCreateCampaignRun onCreateCampaignRun = this.onCreateCampaignRun;
            OnCreateCampaignRun onCreateCampaignRun2 = ((Data) obj).onCreateCampaignRun;
            return onCreateCampaignRun == null ? onCreateCampaignRun2 == null : onCreateCampaignRun.equals(onCreateCampaignRun2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnCreateCampaignRun onCreateCampaignRun = this.onCreateCampaignRun;
                this.$hashCode = (onCreateCampaignRun == null ? 0 : onCreateCampaignRun.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateCampaignRunSubscription.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    OnCreateCampaignRun onCreateCampaignRun = Data.this.onCreateCampaignRun;
                    responseWriter.writeObject(responseField, onCreateCampaignRun != null ? onCreateCampaignRun.marshaller() : null);
                }
            };
        }

        public OnCreateCampaignRun onCreateCampaignRun() {
            return this.onCreateCampaignRun;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onCreateCampaignRun=" + this.onCreateCampaignRun + "}";
            }
            return this.$toString;
        }
    }

    public static class OnCreateCampaignRun {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<OnCreateCampaignRun> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public OnCreateCampaignRun map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = OnCreateCampaignRun.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
        ...
        public OnCreateCampaignRun(String str, String str2, String str3, String str4, String str5, CampaignType campaignType, String str6, String str7, String str8, String str9, CampaignStatus campaignStatus, String str10, Integer num, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, Integer num7, String str11, String str12, PrimaryTeam primaryTeam, String str13, String str14, Campaign campaign, Owner owner) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnCreateCampaignRun)) {
                return false;
            }
            OnCreateCampaignRun onCreateCampaignRun = (OnCreateCampaignRun) obj;
            if (this.__typename.equals(onCreateCampaignRun.__typename) && this.id.equals(onCreateCampaignRun.id) && this.accountId.equals(onCreateCampaignRun.accountId) && this.campaignId.equals(onCreateCampaignRun.campaignId) && ((str = this.campaignName) != null ? str.equals(onCreateCampaignRun.campaignName) : onCreateCampaignRun.campaignName == null) && ((campaignType = this.campaignType) != null ? campaignType.equals(onCreateCampaignRun.campaignType) : onCreateCampaignRun.campaignType == null) && ((str2 = this.campaignChannelIdentifier) != null ? str2.equals(onCreateCampaignRun.campaignChannelIdentifier) : onCreateCampaignRun.campaignChannelIdentifier == null) && this.name.equals(onCreateCampaignRun.name) && ((str3 = this.startDate) != null ? str3.equals(onCreateCampaignRun.startDate) : onCreateCampaignRun.startDate == null) && ((str4 = this.endDate) != null ? str4.equals(onCreateCampaignRun.endDate) : onCreateCampaignRun.endDate == null) && this.status.equals(onCreateCampaignRun.status) && ((str5 = this.systemPauseReason) != null ? str5.equals(onCreateCampaignRun.systemPauseReason) : onCreateCampaignRun.systemPauseReason == null) && ((num = this.leadCount) != null ? num.equals(onCreateCampaignRun.leadCount) : onCreateCampaignRun.leadCount == null) && ((num2 = this.messageCreated) != null ? num2.equals(onCreateCampaignRun.messageCreated) : onCreateCampaignRun.messageCreated == null) && ((num3 = this.sentCount) != null ? num3.equals(onCreateCampaignRun.sentCount) : onCreateCampaignRun.sentCount == null) && ((num4 = this.deliveredCount) != null ? num4.equals(onCreateCampaignRun.deliveredCount) : onCreateCampaignRun.deliveredCount == null) && ((num5 = this.readCount) != null ? num5.equals(onCreateCampaignRun.readCount) : onCreateCampaignRun.readCount == null) && ((num6 = this.repliedCount) != null ? num6.equals(onCreateCampaignRun.repliedCount) : onCreateCampaignRun.repliedCount == null) && ((num7 = this.failedCount) != null ? num7.equals(onCreateCampaignRun.failedCount) : onCreateCampaignRun.failedCount == null) && this.ownerId.equals(onCreateCampaignRun.ownerId) && ((str6 = this.primaryTeamId) != null ? str6.equals(onCreateCampaignRun.primaryTeamId) : onCreateCampaignRun.primaryTeamId == null) && ((primaryTeam = this.primaryTeam) != null ? primaryTeam.equals(onCreateCampaignRun.primaryTeam) : onCreateCampaignRun.primaryTeam == null) && ((str7 = this.createdAt) != null ? str7.equals(onCreateCampaignRun.createdAt) : onCreateCampaignRun.createdAt == null) && ((str8 = this.updatedAt) != null ? str8.equals(onCreateCampaignRun.updatedAt) : onCreateCampaignRun.updatedAt == null) && ((campaign = this.campaign) != null ? campaign.equals(onCreateCampaignRun.campaign) : onCreateCampaignRun.campaign == null)) {
                Owner owner = this.owner;
                Owner owner2 = onCreateCampaignRun.owner;
                if (owner == null) {
                    if (owner2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateCampaignRunSubscription.OnCreateCampaignRun.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = OnCreateCampaignRun.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], OnCreateCampaignRun.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], OnCreateCampaignRun.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], OnCreateCampaignRun.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], OnCreateCampaignRun.this.campaignId);
                    responseWriter.writeString(responseFieldArr[4], OnCreateCampaignRun.this.campaignName);
                    ResponseField responseField = responseFieldArr[5];
                    CampaignType campaignType = OnCreateCampaignRun.this.campaignType;
                    responseWriter.writeString(responseField, campaignType != null ? campaignType.name() : null);
                    responseWriter.writeString(responseFieldArr[6], OnCreateCampaignRun.this.campaignChannelIdentifier);
                    responseWriter.writeString(responseFieldArr[7], OnCreateCampaignRun.this.name);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], OnCreateCampaignRun.this.startDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], OnCreateCampaignRun.this.endDate);
                    responseWriter.writeString(responseFieldArr[10], OnCreateCampaignRun.this.status.name());
                    responseWriter.writeString(responseFieldArr[11], OnCreateCampaignRun.this.systemPauseReason);
                    responseWriter.writeInt(responseFieldArr[12], OnCreateCampaignRun.this.leadCount);
                    responseWriter.writeInt(responseFieldArr[13], OnCreateCampaignRun.this.messageCreated);
                    responseWriter.writeInt(responseFieldArr[14], OnCreateCampaignRun.this.sentCount);
                    responseWriter.writeInt(responseFieldArr[15], OnCreateCampaignRun.this.deliveredCount);
                    responseWriter.writeInt(responseFieldArr[16], OnCreateCampaignRun.this.readCount);
                    responseWriter.writeInt(responseFieldArr[17], OnCreateCampaignRun.this.repliedCount);
                    responseWriter.writeInt(responseFieldArr[18], OnCreateCampaignRun.this.failedCount);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], OnCreateCampaignRun.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], OnCreateCampaignRun.this.primaryTeamId);
                    ResponseField responseField2 = responseFieldArr[21];
                    PrimaryTeam primaryTeam = OnCreateCampaignRun.this.primaryTeam;
                    responseWriter.writeObject(responseField2, primaryTeam != null ? primaryTeam.marshaller() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], OnCreateCampaignRun.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], OnCreateCampaignRun.this.updatedAt);
                    ResponseField responseField3 = responseFieldArr[24];
                    Campaign campaign = OnCreateCampaignRun.this.campaign;
                    ...
                    Owner owner = OnCreateCampaignRun.this.owner;
    ...
    public static class Owner {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateCampaignRunSubscription.Owner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Owner.$responseFields;
    ...
    public static class PrimaryTeam {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnCreateCampaignRunSubscription.PrimaryTeam.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = PrimaryTeam.$responseFields;
    ...
    public String operationId() {
        return "b34564fd782e325bba7fc92be192ef3ba674af39d2605700a5b3f1f89f0eda75";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "subscription OnCreateCampaignRun {\n  onCreateCampaignRun {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
