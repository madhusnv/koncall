...
import type.CreateDealAssociationInput;
...
public final class CreateDealAssociationMutation implements Mutation<Data, Data, Variables> {
    ...
    public static class Business {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Business.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[9], Business.this.userDefinedTags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Business.1.1
    ...
    public static class Contact {
        ...
        public static final class Mapper implements ResponseFieldMapper<Contact> {
            ...
            public Contact map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[5], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Contact.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                ...
                List list2 = responseReader.readList(responseFieldArr[7], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Contact.Mapper.2
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                ...
                List list3 = responseReader.readList(responseFieldArr[34], new ResponseReader.ListReader<Day>() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Contact.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                ...
                List list4 = responseReader.readList(responseFieldArr[92], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Contact.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                });
                List list5 = responseReader.readList(responseFieldArr[93], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Contact.Mapper.5
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                ...
                List list6 = responseReader.readList(responseFieldArr[97], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Contact.Mapper.6
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Contact.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Contact.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[5], Contact.this.sharedOwners, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Contact.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[7], Contact.this.sharedTeams, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Contact.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[34], Contact.this.preferredContactDays, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Contact.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[92], Contact.this.userDefinedTags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Contact.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[93], Contact.this.productService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Contact.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[97], Contact.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Contact.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class CreateDealAssociation {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<CreateDealAssociation> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public CreateDealAssociation map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = CreateDealAssociation.$responseFields;
                return new CreateDealAssociation(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[4]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[5]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[8]), (Product) responseReader.readObject(responseFieldArr[9], new ResponseReader.ObjectReader<Product>() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.CreateDealAssociation.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public Product read(ResponseReader responseReader2) {
                        return Mapper.this.productFieldMapper.map(responseReader2);
                    }
                }), (Deal) responseReader.readObject(responseFieldArr[10], new ResponseReader.ObjectReader<Deal>() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.CreateDealAssociation.Mapper.2
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public Deal read(ResponseReader responseReader2) {
                        return Mapper.this.dealFieldMapper.map(responseReader2);
                    }
                }), (Business) responseReader.readObject(responseFieldArr[11], new ResponseReader.ObjectReader<Business>() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.CreateDealAssociation.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public Business read(ResponseReader responseReader2) {
                        return Mapper.this.businessFieldMapper.map(responseReader2);
                    }
                }), (Contact) responseReader.readObject(responseFieldArr[12], new ResponseReader.ObjectReader<Contact>() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.CreateDealAssociation.Mapper.4
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        static {
            CustomType customType = CustomType.ID;
            CustomType customType2 = CustomType.AWSDATETIME;
            $responseFields = new ResponseField[]{ResponseField.forString(ModelWithMetadataAdapter.TYPE_NAME, ModelWithMetadataAdapter.TYPE_NAME, null, false, Collections.emptyList()), ResponseField.forCustomType(OutcomeConstants.OUTCOME_ID, OutcomeConstants.OUTCOME_ID, null, false, customType, Collections.emptyList()), ResponseField.forCustomType("accountId", "accountId", null, false, customType, Collections.emptyList()), ResponseField.forCustomType("dealId", "dealId", null, false, customType, Collections.emptyList()), ResponseField.forCustomType("contactId", "contactId", null, true, customType, Collections.emptyList()), ResponseField.forCustomType("businessId", "businessId", null, true, customType, Collections.emptyList()), ResponseField.forCustomType("productId", "productId", null, true, customType, Collections.emptyList()), ResponseField.forCustomType("createdAt", "createdAt", null, true, customType2, Collections.emptyList()), ResponseField.forCustomType("updatedAt", "updatedAt", null, true, customType2, Collections.emptyList()), ResponseField.forObject("product", "product", null, true, Collections.emptyList()), ResponseField.forObject("deal", "deal", null, true, Collections.emptyList()), ResponseField.forObject("business", "business", null, true, Collections.emptyList()), ResponseField.forObject("contact", "contact", null, true, Collections.emptyList())};
        }

        public CreateDealAssociation(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, Product product, Deal deal, Business business, Contact contact) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateDealAssociation)) {
                return false;
            }
            CreateDealAssociation createDealAssociation = (CreateDealAssociation) obj;
            if (this.__typename.equals(createDealAssociation.__typename) && this.id.equals(createDealAssociation.id) && this.accountId.equals(createDealAssociation.accountId) && this.dealId.equals(createDealAssociation.dealId) && ((str = this.contactId) != null ? str.equals(createDealAssociation.contactId) : createDealAssociation.contactId == null) && ((str2 = this.businessId) != null ? str2.equals(createDealAssociation.businessId) : createDealAssociation.businessId == null) && ((str3 = this.productId) != null ? str3.equals(createDealAssociation.productId) : createDealAssociation.productId == null) && ((str4 = this.createdAt) != null ? str4.equals(createDealAssociation.createdAt) : createDealAssociation.createdAt == null) && ((str5 = this.updatedAt) != null ? str5.equals(createDealAssociation.updatedAt) : createDealAssociation.updatedAt == null) && ((product = this.product) != null ? product.equals(createDealAssociation.product) : createDealAssociation.product == null) && ((deal = this.deal) != null ? deal.equals(createDealAssociation.deal) : createDealAssociation.deal == null) && ((business = this.business) != null ? business.equals(createDealAssociation.business) : createDealAssociation.business == null)) {
                Contact contact = this.contact;
                Contact contact2 = createDealAssociation.contact;
                if (contact == null) {
                    if (contact2 == null) {
                        return true;
                    }
        ...
        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ...
                int iHashCode7 = (iHashCode6 ^ (product == null ? 0 : product.hashCode())) * 1000003;
                Deal deal = this.deal;
                int iHashCode8 = (iHashCode7 ^ (deal == null ? 0 : deal.hashCode())) * 1000003;
                Business business = this.business;
                int iHashCode9 = (iHashCode8 ^ (business == null ? 0 : business.hashCode())) * 1000003;
                Contact contact = this.contact;
                this.$hashCode = iHashCode9 ^ (contact != null ? contact.hashCode() : 0);
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.CreateDealAssociation.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateDealAssociation.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateDealAssociation.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateDealAssociation.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], CreateDealAssociation.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], CreateDealAssociation.this.dealId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], CreateDealAssociation.this.contactId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], CreateDealAssociation.this.businessId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], CreateDealAssociation.this.productId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], CreateDealAssociation.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], CreateDealAssociation.this.updatedAt);
                    ResponseField responseField = responseFieldArr[9];
                    Product product = CreateDealAssociation.this.product;
                    ...
                    Deal deal = CreateDealAssociation.this.deal;
                    responseWriter.writeObject(responseField2, deal != null ? deal.marshaller() : null);
                    ResponseField responseField3 = responseFieldArr[11];
                    Business business = CreateDealAssociation.this.business;
                    responseWriter.writeObject(responseField3, business != null ? business.marshaller() : null);
                    ResponseField responseField4 = responseFieldArr[12];
                    Contact contact = CreateDealAssociation.this.contact;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "CreateDealAssociation{__typename=" + this.__typename + ", id=" + this.id + ", accountId=" + this.accountId + ", dealId=" + this.dealId + ", contactId=" + this.contactId + ", businessId=" + this.businessId + ", productId=" + this.productId + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", product=" + this.product + ", deal=" + this.deal + ", business=" + this.business + ", contact=" + this.contact + "}";
            }
            return this.$toString;
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createDealAssociation", "createDealAssociation", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final CreateDealAssociation createDealAssociation;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateDealAssociation.Mapper createDealAssociationFieldMapper = new CreateDealAssociation.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateDealAssociation) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateDealAssociation>() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateDealAssociation read(ResponseReader responseReader2) {
                        return Mapper.this.createDealAssociationFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateDealAssociation createDealAssociation) {
            this.createDealAssociation = createDealAssociation;
        }

        public CreateDealAssociation createDealAssociation() {
            return this.createDealAssociation;
        }
        ...
        public boolean equals(Object obj) {
            ...
            CreateDealAssociation createDealAssociation = this.createDealAssociation;
            CreateDealAssociation createDealAssociation2 = ((Data) obj).createDealAssociation;
            return createDealAssociation == null ? createDealAssociation2 == null : createDealAssociation.equals(createDealAssociation2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateDealAssociation createDealAssociation = this.createDealAssociation;
                this.$hashCode = (createDealAssociation == null ? 0 : createDealAssociation.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateDealAssociation createDealAssociation = Data.this.createDealAssociation;
                    responseWriter.writeObject(responseField, createDealAssociation != null ? createDealAssociation.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createDealAssociation=" + this.createDealAssociation + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Deal {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Deal.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Deal.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[17], Deal.this.transitionSummary, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Deal.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], Deal.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Deal.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.AWSJSON, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[21], Deal.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Deal.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class Product {
        ...
        final ProductServiceType f58059type;
        final String updatedAt;
        ...
        public boolean equals(Object obj) {
            ...
            if (this.__typename.equals(product.__typename) && this.id.equals(product.id) && this.accountId.equals(product.accountId) && ((str = this.name) != null ? str.equals(product.name) : product.name == null) && ((str2 = this.description) != null ? str2.equals(product.description) : product.description == null) && ((productServiceType = this.f58059type) != null ? productServiceType.equals(product.f58059type) : product.f58059type == null) && ((str3 = this.measurementUnit) != null ? str3.equals(product.measurementUnit) : product.measurementUnit == null) && ((num = this.incrementBy) != null ? num.equals(product.incrementBy) : product.incrementBy == null) && ((str4 = this.hsCode) != null ? str4.equals(product.hsCode) : product.hsCode == null) && ((str5 = this.skuCode) != null ? str5.equals(product.skuCode) : product.skuCode == null) && ((str6 = this.standardPricePerUnit) != null ? str6.equals(product.standardPricePerUnit) : product.standardPricePerUnit == null) && ((str7 = this.currency) != null ? str7.equals(product.currency) : product.currency == null) && ((str8 = this.parentProductId) != null ? str8.equals(product.parentProductId) : product.parentProductId == null) && ((str9 = this.productPicture) != null ? str9.equals(product.productPicture) : product.productPicture == null) && ((str10 = this.startDate) != null ? str10.equals(product.startDate) : product.startDate == null) && ((str11 = this.endDate) != null ? str11.equals(product.endDate) : product.endDate == null) && ((bool = this.isArchived) != null ? bool.equals(product.isArchived) : product.isArchived == null) && ((str12 = this.createdBy) != null ? str12.equals(product.createdBy) : product.createdBy == null) && ((str13 = this.updatedBy) != null ? str13.equals(product.updatedBy) : product.updatedBy == null) && ((str14 = this.createdAt) != null ? str14.equals(product.createdAt) : product.createdAt == null)) {
                String str15 = this.updatedAt;
                String str16 = product.updatedAt;
                if (str15 == null) {
                    if (str16 == null) {
                        return true;
                    }
        ...
        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ...
                String str2 = this.description;
                int iHashCode3 = (iHashCode2 ^ (str2 == null ? 0 : str2.hashCode())) * 1000003;
                ProductServiceType productServiceType = this.f58059type;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Product.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Product.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], Product.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], Product.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], Product.this.accountId);
                    responseWriter.writeString(responseFieldArr[3], Product.this.name);
                    responseWriter.writeString(responseFieldArr[4], Product.this.description);
                    ResponseField responseField = responseFieldArr[5];
                    ProductServiceType productServiceType = Product.this.f58059type;
                    responseWriter.writeString(responseField, productServiceType != null ? productServiceType.name() : null);
                    responseWriter.writeString(responseFieldArr[6], Product.this.measurementUnit);
                    responseWriter.writeInt(responseFieldArr[7], Product.this.incrementBy);
                    responseWriter.writeString(responseFieldArr[8], Product.this.hsCode);
                    responseWriter.writeString(responseFieldArr[9], Product.this.skuCode);
                    responseWriter.writeString(responseFieldArr[10], Product.this.standardPricePerUnit);
                    responseWriter.writeString(responseFieldArr[11], Product.this.currency);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[12], Product.this.parentProductId);
                    responseWriter.writeString(responseFieldArr[13], Product.this.productPicture);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], Product.this.startDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], Product.this.endDate);
                    responseWriter.writeBoolean(responseFieldArr[16], Product.this.isArchived);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], Product.this.createdBy);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], Product.this.updatedBy);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], Product.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], Product.this.updatedAt);
                }
            };
        }
    ...
    public static final class Variables extends Operation.Variables {
        private final ModelDealAssociationConditionInput condition;
        private final CreateDealAssociationInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateDealAssociationInput createDealAssociationInput, ModelDealAssociationConditionInput modelDealAssociationConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createDealAssociationInput;
            this.condition = modelDealAssociationConditionInput;
            linkedHashMap.put("input", createDealAssociationInput);
            linkedHashMap.put("condition", modelDealAssociationConditionInput);
        }

        public ModelDealAssociationConditionInput condition() {
            return this.condition;
        }

        public CreateDealAssociationInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateDealAssociationMutation.Variables.1
    ...
    public CreateDealAssociationMutation(CreateDealAssociationInput createDealAssociationInput, ModelDealAssociationConditionInput modelDealAssociationConditionInput) {
        Utils.checkNotNull(createDealAssociationInput, "input == null");
        this.variables = new Variables(createDealAssociationInput, modelDealAssociationConditionInput);
    }
    ...
    public String operationId() {
        return "7ae61ebb9f934ae2a5b507b7dd2ee568f40851f83f50df7e7211141db340956a";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateDealAssociation($input: CreateDealAssociationInput!, $condition: ModelDealAssociationConditionInput) {\n  createDealAssociation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    dealId\n    contactId\n    businessId\n    productId\n    createdAt\n    updatedAt\n    product {\n      __typename\n      id\n      accountId\n      name\n      description\n      type\n      measurementUnit\n      incrementBy\n      hsCode\n      skuCode\n      standardPricePerUnit\n      currency\n      parentProductId\n      productPicture\n      startDate\n      endDate\n      isArchived\n      createdBy\n      updatedBy\n      createdAt\n      updatedAt\n    }\n    deal {\n      __typename\n      id\n      accountId\n      name\n      description\n      dealStage\n      dealStageUpdatedAt\n      dealState\n      dealOutcome\n      dealLostReason\n      amount\n      currency\n      createdByUser\n      lastUpdatedByUser\n      ownerId\n      primaryTeamId\n      openTaskDetail\n      transitionSummary\n      recentEngagements\n      recentEngagementsUpdatedAt\n      lastActivity\n      tags\n      customDealData\n      createdAt\n      updatedAt\n    }\n    business {\n      __typename\n      id\n      accountId\n      name\n      industry\n      priority\n      website\n      domain\n      logo\n      userDefinedTags\n      addedById\n      updatedById\n      createdAt\n      updatedAt\n    }\n    contact {\n      __typename\n      id\n      accountId\n      ownerId\n      toBeAssigned\n      sharedOwners\n      primaryTeamId\n      sharedTeams\n      accountPriority\n      addedById\n      assignedToId\n      blockedForCallById\n      blockedForCallReason\n      blockedForCallUntil\n      callPriority\n      waChatChannelId\n      contactSource\n      contactSourceDrillDownOne\n      contactSourceDrillDownTwo\n      contactSourceDrillDownThree\n      contactSourceDrillDownOneId\n      contactSourceDrillDownTwoId\n      contactSourceDrillDownThreeId\n      contactStatus\n      contactType\n      department\n      designation\n      lastRepeatEnquiryDate\n      lastRepeatEnquirySource\n      gender\n      isDecisionMaker\n      isPrivate\n      lockPeriod\n      name\n      preferredContactDays\n      profilePhotoUrl\n      referredBy\n      salutation\n      seniority\n      updatedById\n      hasTask\n      openTaskActivityType\n      lastCalledTime\n      lastCallDirection\n      lastCallOutcome\n      lastCallOutcomeNature\n      lastCallUserId\n      lastCallDuration\n      lastCallEngagementId\n      lastVisitTime\n      lastVisitOutcome\n      lastVisitOutcomeNature\n      lastVisitUserId\n      lastVisitEngagementId\n      lastEmailTime\n      lastEmailUserId\n      lastEmailEngagementId\n      lastWhatsappTime\n      lastWhatsappUserId\n      lastWhatsappEngagementId\n      lastWabaBroadcastTime\n      lastWabaBroadcastStatus\n      lastWabaBroadcastTemplate\n      lastWabaBroadcastReplyBody\n      lastWabaBroadcastReplyTime\n      lastWabaBroadcastReplyType\n      lastSmsTime\n      lastSmsUserId\n      lastSmsEngagementId\n      lastNoteAddedTime\n      lastNoteUserId\n      lastNoteEngagementId\n      lastTaskDoneTime\n      lastTaskDoneUserId\n      lastTaskDoneEngagementId\n      openTaskCount\n      lastKnownDisposition\n      lastKnownDispositionTime\n      lastLeadAssignmentDateTime\n      lastEngagementFromAccount\n      lastEngagementFromContact\n      freshLeadTag\n      noWorkAfterAssignment\n      needFollowUpTag\n      needFollowUpTagUpdatedAt\n      activeDealStage\n      activeDealStageUpdatedAt\n      dealDescription\n      isCustomer\n      becameCustomerOn\n      unsuccessfulCallAttempts\n      leadCallsNotAnswered\n      userDefinedTags\n      productService\n      bulkUploadReference\n      assignmentMethod\n      whatsappOptInStatus\n      recentEngagements\n      recentEngagementsUpdatedAt\n      openTaskDetail\n      openVideoCallDetail\n      lastClosedTaskDetail\n      lastClosedTaskDetailUpdatedAt\n      latestRemark\n      customAttributes\n      paymentRequestDetail\n      lastPaymentStatus\n      customDataAddedFromAddContactForm\n      leadLifecycleStage\n      leadLifecycleStageSubCategory\n      manualClosedReason\n      lastDealStageType\n      prospectingAttempts\n      totalProspectingAttemptsAcrossRechurn\n      numberOfTimesRechurned\n      lastProspectingDoneOn\n      firstProspectingDoneOn\n      nextProspectingDueOn\n      nextProspectingSetBy\n      nextProspectingNote\n      movedToOpportunityOn\n      movedToClosedOn\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
