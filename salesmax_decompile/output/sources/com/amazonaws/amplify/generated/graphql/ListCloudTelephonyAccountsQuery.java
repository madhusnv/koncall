...
public final class ListCloudTelephonyAccountsQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListCloudTelephonyAccounts($filter: ModelCloudTelephonyAccountFilterInput, $limit: Int, $nextToken: String) {\n  listCloudTelephonyAccounts(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      providerName\n      telephonyNumber\n      providerAccountId\n      displayNumber\n      hasOutbound\n      createNewLead\n      accessToken\n      cloudTelephonySubdomain\n      cloudTelephonyAccountSid\n      createdAt\n      updatedAt\n      entityListId\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListCloudTelephonyAccountsQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListCloudTelephonyAccounts";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListCloudTelephonyAccounts($filter: ModelCloudTelephonyAccountFilterInput, $limit: Int, $nextToken: String) {\n  listCloudTelephonyAccounts(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      providerName\n      telephonyNumber\n      providerAccountId\n      displayNumber\n      hasOutbound\n      createNewLead\n      accessToken\n      cloudTelephonySubdomain\n      cloudTelephonyAccountSid\n      createdAt\n      updatedAt\n      entityListId\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public ListCloudTelephonyAccountsQuery build() {
            return new ListCloudTelephonyAccountsQuery(this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listCloudTelephonyAccounts", "listCloudTelephonyAccounts", new UnmodifiableMapBuilder(3).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListCloudTelephonyAccounts listCloudTelephonyAccounts;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListCloudTelephonyAccounts.Mapper listCloudTelephonyAccountsFieldMapper = new ListCloudTelephonyAccounts.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListCloudTelephonyAccounts) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListCloudTelephonyAccounts>() { // from class: com.amazonaws.amplify.generated.graphql.ListCloudTelephonyAccountsQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListCloudTelephonyAccounts read(ResponseReader responseReader2) {
                        return Mapper.this.listCloudTelephonyAccountsFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListCloudTelephonyAccounts listCloudTelephonyAccounts) {
            this.listCloudTelephonyAccounts = listCloudTelephonyAccounts;
        }
        ...
        public boolean equals(Object obj) {
            ...
            ListCloudTelephonyAccounts listCloudTelephonyAccounts = this.listCloudTelephonyAccounts;
            ListCloudTelephonyAccounts listCloudTelephonyAccounts2 = ((Data) obj).listCloudTelephonyAccounts;
            return listCloudTelephonyAccounts == null ? listCloudTelephonyAccounts2 == null : listCloudTelephonyAccounts.equals(listCloudTelephonyAccounts2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListCloudTelephonyAccounts listCloudTelephonyAccounts = this.listCloudTelephonyAccounts;
                this.$hashCode = (listCloudTelephonyAccounts == null ? 0 : listCloudTelephonyAccounts.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListCloudTelephonyAccounts listCloudTelephonyAccounts() {
            return this.listCloudTelephonyAccounts;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListCloudTelephonyAccountsQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListCloudTelephonyAccounts listCloudTelephonyAccounts = Data.this.listCloudTelephonyAccounts;
                    responseWriter.writeObject(responseField, listCloudTelephonyAccounts != null ? listCloudTelephonyAccounts.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listCloudTelephonyAccounts=" + this.listCloudTelephonyAccounts + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListCloudTelephonyAccountsQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static class ListCloudTelephonyAccounts {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListCloudTelephonyAccounts> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListCloudTelephonyAccounts map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListCloudTelephonyAccounts.$responseFields;
                return new ListCloudTelephonyAccounts(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListCloudTelephonyAccountsQuery.ListCloudTelephonyAccounts.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListCloudTelephonyAccountsQuery.ListCloudTelephonyAccounts.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListCloudTelephonyAccounts(String str, List<Item> list, String str2) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListCloudTelephonyAccounts)) {
                return false;
            }
            ListCloudTelephonyAccounts listCloudTelephonyAccounts = (ListCloudTelephonyAccounts) obj;
            if (this.__typename.equals(listCloudTelephonyAccounts.__typename) && this.items.equals(listCloudTelephonyAccounts.items)) {
                String str = this.nextToken;
                String str2 = listCloudTelephonyAccounts.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListCloudTelephonyAccountsQuery.ListCloudTelephonyAccounts.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListCloudTelephonyAccounts.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListCloudTelephonyAccounts.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListCloudTelephonyAccounts.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListCloudTelephonyAccountsQuery.ListCloudTelephonyAccounts.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListCloudTelephonyAccounts.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListCloudTelephonyAccounts{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(ModelCloudTelephonyAccountFilterInput modelCloudTelephonyAccountFilterInput, Integer num, String str) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListCloudTelephonyAccountsQuery.Variables.1
    ...
    public ListCloudTelephonyAccountsQuery(ModelCloudTelephonyAccountFilterInput modelCloudTelephonyAccountFilterInput, Integer num, String str) {
        this.variables = new Variables(modelCloudTelephonyAccountFilterInput, num, str);
    }
    ...
    public String operationId() {
        return "12323d2b618f7db3d0d8aeb5babeec8ef85c3403164a251c10e71fe7b30e8776";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListCloudTelephonyAccounts($filter: ModelCloudTelephonyAccountFilterInput, $limit: Int, $nextToken: String) {\n  listCloudTelephonyAccounts(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      providerName\n      telephonyNumber\n      providerAccountId\n      displayNumber\n      hasOutbound\n      createNewLead\n      accessToken\n      cloudTelephonySubdomain\n      cloudTelephonyAccountSid\n      createdAt\n      updatedAt\n      entityListId\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    }
