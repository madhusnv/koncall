...
import type.C19198x7e5166ad;
import type.CustomType;
import type.ModelPaymentDataFilterInput;
import type.ModelSortDirection;

/* loaded from: classes7.dex */
public final class GetPaymentRequestsByContactQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetPaymentRequestsByContact($accountId: ID, $statusContactId: ModelPaymentDataPaymentRequestsByContactCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelPaymentDataFilterInput, $limit: Int, $nextToken: String) {\n  getPaymentRequestsByContact(accountId: $accountId, statusContactId: $statusContactId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      paymentRequestType\n      engagementId\n      paymentProvider\n      orderIdInPaymentProvider\n      orderId\n      paymentLinkId\n      paymentLinkUrl\n      amount\n      amountPaid\n      currency\n      status\n      lastPaymentStatus\n      finalPaymentDate\n      paidByContactIds\n      transactionId\n      note\n      createdAt\n      updatedAt\n      customPaymentData\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentRequestsByContactQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetPaymentRequestsByContact";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetPaymentRequestsByContact($accountId: ID, $statusContactId: ModelPaymentDataPaymentRequestsByContactCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelPaymentDataFilterInput, $limit: Int, $nextToken: String) {\n  getPaymentRequestsByContact(accountId: $accountId, statusContactId: $statusContactId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      paymentRequestType\n      engagementId\n      paymentProvider\n      orderIdInPaymentProvider\n      orderId\n      paymentLinkId\n      paymentLinkUrl\n      amount\n      amountPaid\n      currency\n      status\n      lastPaymentStatus\n      finalPaymentDate\n      paidByContactIds\n      transactionId\n      note\n      createdAt\n      updatedAt\n      customPaymentData\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        private C19198x7e5166ad statusContactId;
        ...
        public GetPaymentRequestsByContactQuery build() {
            return new GetPaymentRequestsByContactQuery(this.accountId, this.statusContactId, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
        ...
        public Builder statusContactId(C19198x7e5166ad c19198x7e5166ad) {
            this.statusContactId = c19198x7e5166ad;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getPaymentRequestsByContact", "getPaymentRequestsByContact", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("statusContactId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "statusContactId").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetPaymentRequestsByContact getPaymentRequestsByContact;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetPaymentRequestsByContact.Mapper getPaymentRequestsByContactFieldMapper = new GetPaymentRequestsByContact.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetPaymentRequestsByContact) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetPaymentRequestsByContact>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentRequestsByContactQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetPaymentRequestsByContact read(ResponseReader responseReader2) {
                        return Mapper.this.getPaymentRequestsByContactFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetPaymentRequestsByContact getPaymentRequestsByContact) {
            this.getPaymentRequestsByContact = getPaymentRequestsByContact;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetPaymentRequestsByContact getPaymentRequestsByContact = this.getPaymentRequestsByContact;
            GetPaymentRequestsByContact getPaymentRequestsByContact2 = ((Data) obj).getPaymentRequestsByContact;
            return getPaymentRequestsByContact == null ? getPaymentRequestsByContact2 == null : getPaymentRequestsByContact.equals(getPaymentRequestsByContact2);
        }

        public GetPaymentRequestsByContact getPaymentRequestsByContact() {
            return this.getPaymentRequestsByContact;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetPaymentRequestsByContact getPaymentRequestsByContact = this.getPaymentRequestsByContact;
                this.$hashCode = (getPaymentRequestsByContact == null ? 0 : getPaymentRequestsByContact.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentRequestsByContactQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetPaymentRequestsByContact getPaymentRequestsByContact = Data.this.getPaymentRequestsByContact;
                    responseWriter.writeObject(responseField, getPaymentRequestsByContact != null ? getPaymentRequestsByContact.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getPaymentRequestsByContact=" + this.getPaymentRequestsByContact + "}";
            }
            return this.$toString;
        }
    }

    public static class GetPaymentRequestsByContact {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetPaymentRequestsByContact> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetPaymentRequestsByContact map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetPaymentRequestsByContact.$responseFields;
                return new GetPaymentRequestsByContact(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentRequestsByContactQuery.GetPaymentRequestsByContact.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentRequestsByContactQuery.GetPaymentRequestsByContact.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetPaymentRequestsByContact(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetPaymentRequestsByContact)) {
                return false;
            }
            GetPaymentRequestsByContact getPaymentRequestsByContact = (GetPaymentRequestsByContact) obj;
            if (this.__typename.equals(getPaymentRequestsByContact.__typename) && this.items.equals(getPaymentRequestsByContact.items)) {
                String str = this.nextToken;
                String str2 = getPaymentRequestsByContact.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentRequestsByContactQuery.GetPaymentRequestsByContact.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetPaymentRequestsByContact.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetPaymentRequestsByContact.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetPaymentRequestsByContact.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentRequestsByContactQuery.GetPaymentRequestsByContact.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetPaymentRequestsByContact.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetPaymentRequestsByContact{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentRequestsByContactQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[17], Item.this.paidByContactIds, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentRequestsByContactQuery.Item.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[18], Item.this.transactionId, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentRequestsByContactQuery.Item.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final C19198x7e5166ad statusContactId;
        private final transient Map<String, Object> valueMap;

        public Variables(String str, C19198x7e5166ad c19198x7e5166ad, ModelSortDirection modelSortDirection, ModelPaymentDataFilterInput modelPaymentDataFilterInput, Integer num, String str2) {
            ...
            linkedHashMap.put("statusContactId", c19198x7e5166ad);
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetPaymentRequestsByContactQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("accountId", Variables.this.accountId);
                    inputFieldWriter.writeObject("statusContactId", Variables.this.statusContactId != null ? Variables.this.statusContactId.marshaller() : null);
        ...
        public C19198x7e5166ad statusContactId() {
            return this.statusContactId;
        }
    ...
    public GetPaymentRequestsByContactQuery(String str, C19198x7e5166ad c19198x7e5166ad, ModelSortDirection modelSortDirection, ModelPaymentDataFilterInput modelPaymentDataFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, c19198x7e5166ad, modelSortDirection, modelPaymentDataFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "5f7eb9f2f1337c42e8626fb9196d0ecfc86a3dc42db304d2b7db5c2f911a59ce";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetPaymentRequestsByContact($accountId: ID, $statusContactId: ModelPaymentDataPaymentRequestsByContactCompositeKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelPaymentDataFilterInput, $limit: Int, $nextToken: String) {\n  getPaymentRequestsByContact(accountId: $accountId, statusContactId: $statusContactId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      paymentRequestType\n      engagementId\n      paymentProvider\n      orderIdInPaymentProvider\n      orderId\n      paymentLinkId\n      paymentLinkUrl\n      amount\n      amountPaid\n      currency\n      status\n      lastPaymentStatus\n      finalPaymentDate\n      paidByContactIds\n      transactionId\n      note\n      createdAt\n      updatedAt\n      customPaymentData\n      createdById\n      updatedById\n    }\n    nextToken\n  }\n}";
    }
