...
public final class GetMissesByAccountQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetMissesByAccount($accountId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelMissedOpportunitiesFilterInput, $limit: Int, $nextToken: String) {\n  getMissesByAccount(accountId: $accountId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      accountId\n      ownerId\n      primaryTeamId\n      contactId\n      messageBody\n      missedOpportunityType\n      callLaterDateTime\n      relatedEngagementId\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByAccountQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetMissesByAccount";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetMissesByAccount($accountId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelMissedOpportunitiesFilterInput, $limit: Int, $nextToken: String) {\n  getMissesByAccount(accountId: $accountId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      accountId\n      ownerId\n      primaryTeamId\n      contactId\n      messageBody\n      missedOpportunityType\n      callLaterDateTime\n      relatedEngagementId\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetMissesByAccountQuery build() {
            return new GetMissesByAccountQuery(this.accountId, this.updatedAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getMissesByAccount", "getMissesByAccount", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("updatedAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "updatedAt").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetMissesByAccount getMissesByAccount;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetMissesByAccount.Mapper getMissesByAccountFieldMapper = new GetMissesByAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetMissesByAccount) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetMissesByAccount>() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByAccountQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetMissesByAccount read(ResponseReader responseReader2) {
                        return Mapper.this.getMissesByAccountFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetMissesByAccount getMissesByAccount) {
            this.getMissesByAccount = getMissesByAccount;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetMissesByAccount getMissesByAccount = this.getMissesByAccount;
            GetMissesByAccount getMissesByAccount2 = ((Data) obj).getMissesByAccount;
            return getMissesByAccount == null ? getMissesByAccount2 == null : getMissesByAccount.equals(getMissesByAccount2);
        }

        public GetMissesByAccount getMissesByAccount() {
            return this.getMissesByAccount;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetMissesByAccount getMissesByAccount = this.getMissesByAccount;
                this.$hashCode = (getMissesByAccount == null ? 0 : getMissesByAccount.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByAccountQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetMissesByAccount getMissesByAccount = Data.this.getMissesByAccount;
                    responseWriter.writeObject(responseField, getMissesByAccount != null ? getMissesByAccount.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getMissesByAccount=" + this.getMissesByAccount + "}";
            }
            return this.$toString;
        }
    }

    public static class GetMissesByAccount {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetMissesByAccount> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetMissesByAccount map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetMissesByAccount.$responseFields;
                return new GetMissesByAccount(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByAccountQuery.GetMissesByAccount.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByAccountQuery.GetMissesByAccount.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetMissesByAccount(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetMissesByAccount)) {
                return false;
            }
            GetMissesByAccount getMissesByAccount = (GetMissesByAccount) obj;
            if (this.__typename.equals(getMissesByAccount.__typename) && ((list = this.items) != null ? list.equals(getMissesByAccount.items) : getMissesByAccount.items == null)) {
                String str = this.nextToken;
                String str2 = getMissesByAccount.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByAccountQuery.GetMissesByAccount.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetMissesByAccount.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetMissesByAccount.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetMissesByAccount.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByAccountQuery.GetMissesByAccount.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetMissesByAccount.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetMissesByAccount{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByAccountQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMissesByAccountQuery.Variables.1
    ...
    public GetMissesByAccountQuery(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelMissedOpportunitiesFilterInput modelMissedOpportunitiesFilterInput, Integer num, String str2) {
    ...
    public String operationId() {
        return "b5cfcf9bb6dbada0050656259e34ba72aea626039ea83ac0316593672fab953a";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetMissesByAccount($accountId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelMissedOpportunitiesFilterInput, $limit: Int, $nextToken: String) {\n  getMissesByAccount(accountId: $accountId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      accountId\n      ownerId\n      primaryTeamId\n      contactId\n      messageBody\n      missedOpportunityType\n      callLaterDateTime\n      relatedEngagementId\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
