...
import type.UpdateChatAssociationInput;

/* loaded from: classes4.dex */
public final class UpdateChatAssociationMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation UpdateChatAssociation($input: UpdateChatAssociationInput!, $condition: ModelChatAssociationConditionInput) {\n  updateChatAssociation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    channelId\n    relatedObjectId\n    relatedObjectType\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.UpdateChatAssociationMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "UpdateChatAssociation";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation UpdateChatAssociation($input: UpdateChatAssociationInput!, $condition: ModelChatAssociationConditionInput) {\n  updateChatAssociation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    channelId\n    relatedObjectId\n    relatedObjectType\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelChatAssociationConditionInput condition;
        private UpdateChatAssociationInput input;

        public UpdateChatAssociationMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new UpdateChatAssociationMutation(this.input, this.condition);
        }
        ...
        public Builder input(UpdateChatAssociationInput updateChatAssociationInput) {
            this.input = updateChatAssociationInput;
            return this;
        }
    }
    ...
    public static class Channel {
        ...
        public static final class Mapper implements ResponseFieldMapper<Channel> {
            ...
            public Channel map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[6], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateChatAssociationMutation.Channel.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateChatAssociationMutation.Channel.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[6], Channel.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateChatAssociationMutation.Channel.1.1
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("updateChatAssociation", "updateChatAssociation", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final UpdateChatAssociation updateChatAssociation;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final UpdateChatAssociation.Mapper updateChatAssociationFieldMapper = new UpdateChatAssociation.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((UpdateChatAssociation) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<UpdateChatAssociation>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateChatAssociationMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdateChatAssociation read(ResponseReader responseReader2) {
                        return Mapper.this.updateChatAssociationFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(UpdateChatAssociation updateChatAssociation) {
            this.updateChatAssociation = updateChatAssociation;
        }
        ...
        public boolean equals(Object obj) {
            ...
            UpdateChatAssociation updateChatAssociation = this.updateChatAssociation;
            UpdateChatAssociation updateChatAssociation2 = ((Data) obj).updateChatAssociation;
            return updateChatAssociation == null ? updateChatAssociation2 == null : updateChatAssociation.equals(updateChatAssociation2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                UpdateChatAssociation updateChatAssociation = this.updateChatAssociation;
                this.$hashCode = (updateChatAssociation == null ? 0 : updateChatAssociation.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateChatAssociationMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    UpdateChatAssociation updateChatAssociation = Data.this.updateChatAssociation;
                    responseWriter.writeObject(responseField, updateChatAssociation != null ? updateChatAssociation.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{updateChatAssociation=" + this.updateChatAssociation + "}";
            }
            return this.$toString;
        }

        public UpdateChatAssociation updateChatAssociation() {
            return this.updateChatAssociation;
        }
    }

    public static class UpdateChatAssociation {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<UpdateChatAssociation> {
            final Channel.Mapper channelFieldMapper = new Channel.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public UpdateChatAssociation map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = UpdateChatAssociation.$responseFields;
                return new UpdateChatAssociation(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (Channel) responseReader.readObject(responseFieldArr[8], new ResponseReader.ObjectReader<Channel>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateChatAssociationMutation.UpdateChatAssociation.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public UpdateChatAssociation(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, Channel channel) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateChatAssociation)) {
                return false;
            }
            UpdateChatAssociation updateChatAssociation = (UpdateChatAssociation) obj;
            if (this.__typename.equals(updateChatAssociation.__typename) && this.id.equals(updateChatAssociation.id) && this.accountId.equals(updateChatAssociation.accountId) && this.channelId.equals(updateChatAssociation.channelId) && this.relatedObjectId.equals(updateChatAssociation.relatedObjectId) && this.relatedObjectType.equals(updateChatAssociation.relatedObjectType) && ((str = this.createdAt) != null ? str.equals(updateChatAssociation.createdAt) : updateChatAssociation.createdAt == null) && ((str2 = this.updatedAt) != null ? str2.equals(updateChatAssociation.updatedAt) : updateChatAssociation.updatedAt == null)) {
                Channel channel = this.channel;
                Channel channel2 = updateChatAssociation.channel;
                if (channel == null) {
                    if (channel2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateChatAssociationMutation.UpdateChatAssociation.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdateChatAssociation.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UpdateChatAssociation.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], UpdateChatAssociation.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], UpdateChatAssociation.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], UpdateChatAssociation.this.channelId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], UpdateChatAssociation.this.relatedObjectId);
                    responseWriter.writeString(responseFieldArr[5], UpdateChatAssociation.this.relatedObjectType);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], UpdateChatAssociation.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], UpdateChatAssociation.this.updatedAt);
                    ResponseField responseField = responseFieldArr[8];
                    Channel channel = UpdateChatAssociation.this.channel;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "UpdateChatAssociation{__typename=" + this.__typename + ", id=" + this.id + ", accountId=" + this.accountId + ", channelId=" + this.channelId + ", relatedObjectId=" + this.relatedObjectId + ", relatedObjectType=" + this.relatedObjectType + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", channel=" + this.channel + "}";
            }
            return this.$toString;
        }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final UpdateChatAssociationInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(UpdateChatAssociationInput updateChatAssociationInput, ModelChatAssociationConditionInput modelChatAssociationConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = updateChatAssociationInput;
            this.condition = modelChatAssociationConditionInput;
            linkedHashMap.put("input", updateChatAssociationInput);
        ...
        public UpdateChatAssociationInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateChatAssociationMutation.Variables.1
    ...
    public UpdateChatAssociationMutation(UpdateChatAssociationInput updateChatAssociationInput, ModelChatAssociationConditionInput modelChatAssociationConditionInput) {
        Utils.checkNotNull(updateChatAssociationInput, "input == null");
        this.variables = new Variables(updateChatAssociationInput, modelChatAssociationConditionInput);
    }
    ...
    public String operationId() {
        return "42d7ac12fd875bdc6ec17cc0f83800d5a4929d0b4430e86221ee966902181de2";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation UpdateChatAssociation($input: UpdateChatAssociationInput!, $condition: ModelChatAssociationConditionInput) {\n  updateChatAssociation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    channelId\n    relatedObjectId\n    relatedObjectType\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
