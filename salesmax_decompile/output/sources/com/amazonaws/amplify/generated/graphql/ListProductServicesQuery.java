...
public final class ListProductServicesQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListProductServices($filter: ModelProductServiceFilterInput, $limit: Int, $nextToken: String) {\n  listProductServices(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      name\n      description\n      type\n      measurementUnit\n      incrementBy\n      hsCode\n      skuCode\n      standardPricePerUnit\n      currency\n      parentProductId\n      productPicture\n      startDate\n      endDate\n      isArchived\n      createdBy\n      updatedBy\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListProductServicesQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListProductServices";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListProductServices($filter: ModelProductServiceFilterInput, $limit: Int, $nextToken: String) {\n  listProductServices(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      name\n      description\n      type\n      measurementUnit\n      incrementBy\n      hsCode\n      skuCode\n      standardPricePerUnit\n      currency\n      parentProductId\n      productPicture\n      startDate\n      endDate\n      isArchived\n      createdBy\n      updatedBy\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public ListProductServicesQuery build() {
            return new ListProductServicesQuery(this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listProductServices", "listProductServices", new UnmodifiableMapBuilder(3).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListProductServices listProductServices;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListProductServices.Mapper listProductServicesFieldMapper = new ListProductServices.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListProductServices) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListProductServices>() { // from class: com.amazonaws.amplify.generated.graphql.ListProductServicesQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListProductServices read(ResponseReader responseReader2) {
                        return Mapper.this.listProductServicesFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListProductServices listProductServices) {
            this.listProductServices = listProductServices;
        }
        ...
        public boolean equals(Object obj) {
            ...
            ListProductServices listProductServices = this.listProductServices;
            ListProductServices listProductServices2 = ((Data) obj).listProductServices;
            return listProductServices == null ? listProductServices2 == null : listProductServices.equals(listProductServices2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListProductServices listProductServices = this.listProductServices;
                this.$hashCode = (listProductServices == null ? 0 : listProductServices.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListProductServices listProductServices() {
            return this.listProductServices;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListProductServicesQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListProductServices listProductServices = Data.this.listProductServices;
                    responseWriter.writeObject(responseField, listProductServices != null ? listProductServices.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listProductServices=" + this.listProductServices + "}";
            }
    ...
    public static class Item {
        ...
        final ProductServiceType f58074type;
        ...
        public Item(String str, String str2, String str3, String str4, String str5, ProductServiceType productServiceType, String str6, Integer num, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, Boolean bool, String str15, String str16, String str17, String str18) {
            ...
            this.f58074type = productServiceType;
        ...
        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ...
                ProductServiceType productServiceType = this.f58074type;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListProductServicesQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    ProductServiceType productServiceType = Item.this.f58074type;
    ...
    public static class ListProductServices {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListProductServices> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListProductServices map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListProductServices.$responseFields;
                return new ListProductServices(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListProductServicesQuery.ListProductServices.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListProductServicesQuery.ListProductServices.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListProductServices(String str, List<Item> list, String str2) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListProductServices)) {
                return false;
            }
            ListProductServices listProductServices = (ListProductServices) obj;
            if (this.__typename.equals(listProductServices.__typename) && this.items.equals(listProductServices.items)) {
                String str = this.nextToken;
                String str2 = listProductServices.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListProductServicesQuery.ListProductServices.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListProductServices.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListProductServices.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListProductServices.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListProductServicesQuery.ListProductServices.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListProductServices.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListProductServices{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(ModelProductServiceFilterInput modelProductServiceFilterInput, Integer num, String str) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListProductServicesQuery.Variables.1
    ...
    public ListProductServicesQuery(ModelProductServiceFilterInput modelProductServiceFilterInput, Integer num, String str) {
        this.variables = new Variables(modelProductServiceFilterInput, num, str);
    }
    ...
    public String operationId() {
        return "bd22c47049f3f2f82dcc66b7fcc0993388736f2fbb6c2236392e905e52a40cfa";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListProductServices($filter: ModelProductServiceFilterInput, $limit: Int, $nextToken: String) {\n  listProductServices(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      name\n      description\n      type\n      measurementUnit\n      incrementBy\n      hsCode\n      skuCode\n      standardPricePerUnit\n      currency\n      parentProductId\n      productPicture\n      startDate\n      endDate\n      isArchived\n      createdBy\n      updatedBy\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
