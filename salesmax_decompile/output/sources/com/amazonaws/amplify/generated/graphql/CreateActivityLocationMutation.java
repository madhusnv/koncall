...
public final class CreateActivityLocationMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation CreateActivityLocation($input: CreateActivityLocationInput!, $condition: ModelActivityLocationConditionInput) {\n  createActivityLocation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityLocationMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "CreateActivityLocation";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation CreateActivityLocation($input: CreateActivityLocationInput!, $condition: ModelActivityLocationConditionInput) {\n  createActivityLocation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelActivityLocationConditionInput condition;
        private CreateActivityLocationInput input;

        public CreateActivityLocationMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new CreateActivityLocationMutation(this.input, this.condition);
        }
        ...
        public Builder input(CreateActivityLocationInput createActivityLocationInput) {
            this.input = createActivityLocationInput;
            return this;
        }
    }

    public static class CreateActivityLocation {
        ...
        public static final class Mapper implements ResponseFieldMapper<CreateActivityLocation> {
            final User.Mapper userFieldMapper = new User.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public CreateActivityLocation map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = CreateActivityLocation.$responseFields;
                return new CreateActivityLocation(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), responseReader.readString(responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[8]), (User) responseReader.readObject(responseFieldArr[9], new ResponseReader.ObjectReader<User>() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityLocationMutation.CreateActivityLocation.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
        ...
        public CreateActivityLocation(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, User user) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateActivityLocation)) {
                return false;
            }
            CreateActivityLocation createActivityLocation = (CreateActivityLocation) obj;
            if (this.__typename.equals(createActivityLocation.__typename) && this.id.equals(createActivityLocation.id) && this.accountId.equals(createActivityLocation.accountId) && ((str = this.engagementId) != null ? str.equals(createActivityLocation.engagementId) : createActivityLocation.engagementId == null) && ((str2 = this.lat) != null ? str2.equals(createActivityLocation.lat) : createActivityLocation.lat == null) && ((str3 = this.lng) != null ? str3.equals(createActivityLocation.lng) : createActivityLocation.lng == null) && this.ownerId.equals(createActivityLocation.ownerId) && ((str4 = this.createdAt) != null ? str4.equals(createActivityLocation.createdAt) : createActivityLocation.createdAt == null) && ((str5 = this.updatedAt) != null ? str5.equals(createActivityLocation.updatedAt) : createActivityLocation.updatedAt == null)) {
                User user = this.user;
                User user2 = createActivityLocation.user;
                if (user == null) {
                    if (user2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityLocationMutation.CreateActivityLocation.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateActivityLocation.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateActivityLocation.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateActivityLocation.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], CreateActivityLocation.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], CreateActivityLocation.this.engagementId);
                    responseWriter.writeString(responseFieldArr[4], CreateActivityLocation.this.lat);
                    responseWriter.writeString(responseFieldArr[5], CreateActivityLocation.this.lng);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], CreateActivityLocation.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], CreateActivityLocation.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], CreateActivityLocation.this.updatedAt);
                    ResponseField responseField = responseFieldArr[9];
                    User user = CreateActivityLocation.this.user;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "CreateActivityLocation{__typename=" + this.__typename + ", id=" + this.id + ", accountId=" + this.accountId + ", engagementId=" + this.engagementId + ", lat=" + this.lat + ", lng=" + this.lng + ", ownerId=" + this.ownerId + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", user=" + this.user + "}";
            }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createActivityLocation", "createActivityLocation", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final CreateActivityLocation createActivityLocation;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateActivityLocation.Mapper createActivityLocationFieldMapper = new CreateActivityLocation.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateActivityLocation) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateActivityLocation>() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityLocationMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateActivityLocation read(ResponseReader responseReader2) {
                        return Mapper.this.createActivityLocationFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateActivityLocation createActivityLocation) {
            this.createActivityLocation = createActivityLocation;
        }

        public CreateActivityLocation createActivityLocation() {
            return this.createActivityLocation;
        }
        ...
        public boolean equals(Object obj) {
            ...
            CreateActivityLocation createActivityLocation = this.createActivityLocation;
            CreateActivityLocation createActivityLocation2 = ((Data) obj).createActivityLocation;
            return createActivityLocation == null ? createActivityLocation2 == null : createActivityLocation.equals(createActivityLocation2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateActivityLocation createActivityLocation = this.createActivityLocation;
                this.$hashCode = (createActivityLocation == null ? 0 : createActivityLocation.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityLocationMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateActivityLocation createActivityLocation = Data.this.createActivityLocation;
                    responseWriter.writeObject(responseField, createActivityLocation != null ? createActivityLocation.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createActivityLocation=" + this.createActivityLocation + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class User {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityLocationMutation.User.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = User.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final CreateActivityLocationInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateActivityLocationInput createActivityLocationInput, ModelActivityLocationConditionInput modelActivityLocationConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createActivityLocationInput;
            this.condition = modelActivityLocationConditionInput;
            linkedHashMap.put("input", createActivityLocationInput);
        ...
        public CreateActivityLocationInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateActivityLocationMutation.Variables.1
    ...
    public CreateActivityLocationMutation(CreateActivityLocationInput createActivityLocationInput, ModelActivityLocationConditionInput modelActivityLocationConditionInput) {
        Utils.checkNotNull(createActivityLocationInput, "input == null");
        this.variables = new Variables(createActivityLocationInput, modelActivityLocationConditionInput);
    }
    ...
    public String operationId() {
        return "cb39b345fbeff27c75a0b5704494c992d4aa1d9d9584ea1a2e5ffcb99844cce1";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateActivityLocation($input: CreateActivityLocationInput!, $condition: ModelActivityLocationConditionInput) {\n  createActivityLocation(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
