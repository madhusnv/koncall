...
public final class SearchChatChannelsQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query SearchChatChannels($filter: SearchableChatChannelFilterInput, $sort: SearchableChatChannelSortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchChatChannels(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    nextToken\n    total\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.SearchChatChannelsQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "SearchChatChannels";
        }
    };
    public static final String QUERY_DOCUMENT = "query SearchChatChannels($filter: SearchableChatChannelFilterInput, $sort: SearchableChatChannelSortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchChatChannels(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    nextToken\n    total\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private SearchableChatChannelFilterInput filter;
        private Integer from;
        private Integer limit;
        private String nextToken;
        private SearchableChatChannelSortInput sort;

        public SearchChatChannelsQuery build() {
            return new SearchChatChannelsQuery(this.filter, this.sort, this.limit, this.nextToken, this.from);
        }

        public Builder filter(SearchableChatChannelFilterInput searchableChatChannelFilterInput) {
            this.filter = searchableChatChannelFilterInput;
            return this;
        }
        ...
        public Builder sort(SearchableChatChannelSortInput searchableChatChannelSortInput) {
            this.sort = searchableChatChannelSortInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("searchChatChannels", "searchChatChannels", new UnmodifiableMapBuilder(5).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put(Constants.MessagePayloadKeys.FROM, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, Constants.MessagePayloadKeys.FROM).build()).put("sort", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sort").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final SearchChatChannels searchChatChannels;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final SearchChatChannels.Mapper searchChatChannelsFieldMapper = new SearchChatChannels.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((SearchChatChannels) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<SearchChatChannels>() { // from class: com.amazonaws.amplify.generated.graphql.SearchChatChannelsQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public SearchChatChannels read(ResponseReader responseReader2) {
                        return Mapper.this.searchChatChannelsFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(SearchChatChannels searchChatChannels) {
            this.searchChatChannels = searchChatChannels;
        }
        ...
        public boolean equals(Object obj) {
            ...
            SearchChatChannels searchChatChannels = this.searchChatChannels;
            SearchChatChannels searchChatChannels2 = ((Data) obj).searchChatChannels;
            return searchChatChannels == null ? searchChatChannels2 == null : searchChatChannels.equals(searchChatChannels2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                SearchChatChannels searchChatChannels = this.searchChatChannels;
                this.$hashCode = (searchChatChannels == null ? 0 : searchChatChannels.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchChatChannelsQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    SearchChatChannels searchChatChannels = Data.this.searchChatChannels;
                    responseWriter.writeObject(responseField, searchChatChannels != null ? searchChatChannels.marshaller() : null);
                }
            };
        }

        public SearchChatChannels searchChatChannels() {
            return this.searchChatChannels;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{searchChatChannels=" + this.searchChatChannels + "}";
            }
    ...
    public static class Item {
        ...
        public static final class Mapper implements ResponseFieldMapper<Item> {
            ...
            public Item map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[6], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.SearchChatChannelsQuery.Item.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchChatChannelsQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[6], Item.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.SearchChatChannelsQuery.Item.1.1
    ...
    public static class SearchChatChannels {
        ...
        public static final class Mapper implements ResponseFieldMapper<SearchChatChannels> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public SearchChatChannels map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = SearchChatChannels.$responseFields;
                return new SearchChatChannels(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.SearchChatChannelsQuery.SearchChatChannels.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.SearchChatChannelsQuery.SearchChatChannels.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public SearchChatChannels(String str, List<Item> list, String str2, Integer num) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof SearchChatChannels)) {
                return false;
            }
            SearchChatChannels searchChatChannels = (SearchChatChannels) obj;
            if (this.__typename.equals(searchChatChannels.__typename) && this.items.equals(searchChatChannels.items) && ((str = this.nextToken) != null ? str.equals(searchChatChannels.nextToken) : searchChatChannels.nextToken == null)) {
                Integer num = this.total;
                Integer num2 = searchChatChannels.total;
                if (num == null) {
                    if (num2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchChatChannelsQuery.SearchChatChannels.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = SearchChatChannels.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], SearchChatChannels.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], SearchChatChannels.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.SearchChatChannelsQuery.SearchChatChannels.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], SearchChatChannels.this.nextToken);
                    responseWriter.writeInt(responseFieldArr[3], SearchChatChannels.this.total);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "SearchChatChannels{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + ", total=" + this.total + "}";
            }
            return this.$toString;
        }
    ...
    public static final class Variables extends Operation.Variables {
        private final SearchableChatChannelFilterInput filter;
        private final Integer from;
        private final Integer limit;
        private final String nextToken;
        private final SearchableChatChannelSortInput sort;
        private final transient Map<String, Object> valueMap;

        public Variables(SearchableChatChannelFilterInput searchableChatChannelFilterInput, SearchableChatChannelSortInput searchableChatChannelSortInput, Integer num, String str, Integer num2) {
            ...
            this.nextToken = str;
            this.from = num2;
            linkedHashMap.put("filter", searchableChatChannelFilterInput);
            linkedHashMap.put("sort", searchableChatChannelSortInput);
        ...
        public SearchableChatChannelFilterInput filter() {
            return this.filter;
        }
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.SearchChatChannelsQuery.Variables.1
        ...
        public SearchableChatChannelSortInput sort() {
            return this.sort;
        }
    ...
    public SearchChatChannelsQuery(SearchableChatChannelFilterInput searchableChatChannelFilterInput, SearchableChatChannelSortInput searchableChatChannelSortInput, Integer num, String str, Integer num2) {
        this.variables = new Variables(searchableChatChannelFilterInput, searchableChatChannelSortInput, num, str, num2);
    }
    ...
    public String operationId() {
        return "8a430f93c31c8db2ad391fb2adba6f53138b34af9e6d8aeddc8a97789be7f53a";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query SearchChatChannels($filter: SearchableChatChannelFilterInput, $sort: SearchableChatChannelSortInput, $limit: Int, $nextToken: String, $from: Int) {\n  searchChatChannels(filter: $filter, sort: $sort, limit: $limit, nextToken: $nextToken, from: $from) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    nextToken\n    total\n  }\n}";
    }
