...
import type.ModelWabaPhoneNumberNewConditionInput;
import type.UpdateWabaPhoneNumberNewInput;

/* loaded from: classes4.dex */
public final class UpdateWabaPhoneNumberNewMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation UpdateWabaPhoneNumberNew($input: UpdateWabaPhoneNumberNewInput!, $condition: ModelWabaPhoneNumberNewConditionInput) {\n  updateWabaPhoneNumberNew(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaPhoneNumberNewMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "UpdateWabaPhoneNumberNew";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation UpdateWabaPhoneNumberNew($input: UpdateWabaPhoneNumberNewInput!, $condition: ModelWabaPhoneNumberNewConditionInput) {\n  updateWabaPhoneNumberNew(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelWabaPhoneNumberNewConditionInput condition;
        private UpdateWabaPhoneNumberNewInput input;

        public UpdateWabaPhoneNumberNewMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new UpdateWabaPhoneNumberNewMutation(this.input, this.condition);
        }

        public Builder condition(ModelWabaPhoneNumberNewConditionInput modelWabaPhoneNumberNewConditionInput) {
            this.condition = modelWabaPhoneNumberNewConditionInput;
            return this;
        }

        public Builder input(UpdateWabaPhoneNumberNewInput updateWabaPhoneNumberNewInput) {
            this.input = updateWabaPhoneNumberNewInput;
            return this;
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("updateWabaPhoneNumberNew", "updateWabaPhoneNumberNew", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final UpdateWabaPhoneNumberNew updateWabaPhoneNumberNew;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final UpdateWabaPhoneNumberNew.Mapper updateWabaPhoneNumberNewFieldMapper = new UpdateWabaPhoneNumberNew.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((UpdateWabaPhoneNumberNew) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<UpdateWabaPhoneNumberNew>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaPhoneNumberNewMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdateWabaPhoneNumberNew read(ResponseReader responseReader2) {
                        return Mapper.this.updateWabaPhoneNumberNewFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(UpdateWabaPhoneNumberNew updateWabaPhoneNumberNew) {
            this.updateWabaPhoneNumberNew = updateWabaPhoneNumberNew;
        }
        ...
        public boolean equals(Object obj) {
            ...
            UpdateWabaPhoneNumberNew updateWabaPhoneNumberNew = this.updateWabaPhoneNumberNew;
            UpdateWabaPhoneNumberNew updateWabaPhoneNumberNew2 = ((Data) obj).updateWabaPhoneNumberNew;
            return updateWabaPhoneNumberNew == null ? updateWabaPhoneNumberNew2 == null : updateWabaPhoneNumberNew.equals(updateWabaPhoneNumberNew2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                UpdateWabaPhoneNumberNew updateWabaPhoneNumberNew = this.updateWabaPhoneNumberNew;
                this.$hashCode = (updateWabaPhoneNumberNew == null ? 0 : updateWabaPhoneNumberNew.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaPhoneNumberNewMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    UpdateWabaPhoneNumberNew updateWabaPhoneNumberNew = Data.this.updateWabaPhoneNumberNew;
                    responseWriter.writeObject(responseField, updateWabaPhoneNumberNew != null ? updateWabaPhoneNumberNew.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{updateWabaPhoneNumberNew=" + this.updateWabaPhoneNumberNew + "}";
            }
            return this.$toString;
        }

        public UpdateWabaPhoneNumberNew updateWabaPhoneNumberNew() {
            return this.updateWabaPhoneNumberNew;
        }
    }
    ...
    public static class EntityList {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaPhoneNumberNewMutation.EntityList.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = EntityList.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[34], EntityList.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaPhoneNumberNewMutation.EntityList.1.1
    ...
    public static class UpdateWabaPhoneNumberNew {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public UpdateWabaPhoneNumberNew(String str, String str2, String str3, String str4, String str5, String str6, Boolean bool, String str7, String str8, String str9, Integer num, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, String str19, String str20, String str21, String str22, String str23, String str24, String str25, String str26, EntityList entityList) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateWabaPhoneNumberNew)) {
                return false;
            }
            UpdateWabaPhoneNumberNew updateWabaPhoneNumberNew = (UpdateWabaPhoneNumberNew) obj;
            if (this.__typename.equals(updateWabaPhoneNumberNew.__typename) && this.id.equals(updateWabaPhoneNumberNew.id) && this.wabaAccountId.equals(updateWabaPhoneNumberNew.wabaAccountId) && this.accountId.equals(updateWabaPhoneNumberNew.accountId) && this.phoneNumberId.equals(updateWabaPhoneNumberNew.phoneNumberId) && this.phoneNumber.equals(updateWabaPhoneNumberNew.phoneNumber) && ((bool = this.isDefault) != null ? bool.equals(updateWabaPhoneNumberNew.isDefault) : updateWabaPhoneNumberNew.isDefault == null) && ((str = this.accessToken) != null ? str.equals(updateWabaPhoneNumberNew.accessToken) : updateWabaPhoneNumberNew.accessToken == null) && ((str2 = this.name) != null ? str2.equals(updateWabaPhoneNumberNew.name) : updateWabaPhoneNumberNew.name == null) && ((str3 = this.internalName) != null ? str3.equals(updateWabaPhoneNumberNew.internalName) : updateWabaPhoneNumberNew.internalName == null) && ((num = this.quota) != null ? num.equals(updateWabaPhoneNumberNew.quota) : updateWabaPhoneNumberNew.quota == null) && ((str4 = this.currentLimitCategory) != null ? str4.equals(updateWabaPhoneNumberNew.currentLimitCategory) : updateWabaPhoneNumberNew.currentLimitCategory == null) && ((str5 = this.status) != null ? str5.equals(updateWabaPhoneNumberNew.status) : updateWabaPhoneNumberNew.status == null) && ((str6 = this.qualityRating) != null ? str6.equals(updateWabaPhoneNumberNew.qualityRating) : updateWabaPhoneNumberNew.qualityRating == null) && ((str7 = this.entityListId) != null ? str7.equals(updateWabaPhoneNumberNew.entityListId) : updateWabaPhoneNumberNew.entityListId == null) && ((str8 = this.createdAt) != null ? str8.equals(updateWabaPhoneNumberNew.createdAt) : updateWabaPhoneNumberNew.createdAt == null) && ((str9 = this.updatedAt) != null ? str9.equals(updateWabaPhoneNumberNew.updatedAt) : updateWabaPhoneNumberNew.updatedAt == null) && ((str10 = this.welcomeMessage) != null ? str10.equals(updateWabaPhoneNumberNew.welcomeMessage) : updateWabaPhoneNumberNew.welcomeMessage == null) && ((str11 = this.requestedDisplayName) != null ? str11.equals(updateWabaPhoneNumberNew.requestedDisplayName) : updateWabaPhoneNumberNew.requestedDisplayName == null) && ((str12 = this.displayNameUpdate) != null ? str12.equals(updateWabaPhoneNumberNew.displayNameUpdate) : updateWabaPhoneNumberNew.displayNameUpdate == null) && ((str13 = this.displayNameUpdateDateTime) != null ? str13.equals(updateWabaPhoneNumberNew.displayNameUpdateDateTime) : updateWabaPhoneNumberNew.displayNameUpdateDateTime == null) && ((str14 = this.wabaNumberDecision) != null ? str14.equals(updateWabaPhoneNumberNew.wabaNumberDecision) : updateWabaPhoneNumberNew.wabaNumberDecision == null) && ((str15 = this.wabaNumberDecisionTime) != null ? str15.equals(updateWabaPhoneNumberNew.wabaNumberDecisionTime) : updateWabaPhoneNumberNew.wabaNumberDecisionTime == null) && ((str16 = this.rejectionReason) != null ? str16.equals(updateWabaPhoneNumberNew.rejectionReason) : updateWabaPhoneNumberNew.rejectionReason == null) && ((str17 = this.phoneNumberQualityUpdate) != null ? str17.equals(updateWabaPhoneNumberNew.phoneNumberQualityUpdate) : updateWabaPhoneNumberNew.phoneNumberQualityUpdate == null) && ((str18 = this.phoneNumberQualityUpdateTime) != null ? str18.equals(updateWabaPhoneNumberNew.phoneNumberQualityUpdateTime) : updateWabaPhoneNumberNew.phoneNumberQualityUpdateTime == null) && ((str19 = this.createdById) != null ? str19.equals(updateWabaPhoneNumberNew.createdById) : updateWabaPhoneNumberNew.createdById == null) && ((str20 = this.updatedById) != null ? str20.equals(updateWabaPhoneNumberNew.updatedById) : updateWabaPhoneNumberNew.updatedById == null)) {
                EntityList entityList = this.entityList;
                EntityList entityList2 = updateWabaPhoneNumberNew.entityList;
                if (entityList == null) {
                    if (entityList2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaPhoneNumberNewMutation.UpdateWabaPhoneNumberNew.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdateWabaPhoneNumberNew.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UpdateWabaPhoneNumberNew.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], UpdateWabaPhoneNumberNew.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], UpdateWabaPhoneNumberNew.this.wabaAccountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], UpdateWabaPhoneNumberNew.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[4], UpdateWabaPhoneNumberNew.this.phoneNumberId);
                    responseWriter.writeString(responseFieldArr[5], UpdateWabaPhoneNumberNew.this.phoneNumber);
                    responseWriter.writeBoolean(responseFieldArr[6], UpdateWabaPhoneNumberNew.this.isDefault);
                    responseWriter.writeString(responseFieldArr[7], UpdateWabaPhoneNumberNew.this.accessToken);
                    responseWriter.writeString(responseFieldArr[8], UpdateWabaPhoneNumberNew.this.name);
                    responseWriter.writeString(responseFieldArr[9], UpdateWabaPhoneNumberNew.this.internalName);
                    responseWriter.writeInt(responseFieldArr[10], UpdateWabaPhoneNumberNew.this.quota);
                    responseWriter.writeString(responseFieldArr[11], UpdateWabaPhoneNumberNew.this.currentLimitCategory);
                    responseWriter.writeString(responseFieldArr[12], UpdateWabaPhoneNumberNew.this.status);
                    responseWriter.writeString(responseFieldArr[13], UpdateWabaPhoneNumberNew.this.qualityRating);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[14], UpdateWabaPhoneNumberNew.this.entityListId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], UpdateWabaPhoneNumberNew.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], UpdateWabaPhoneNumberNew.this.updatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], UpdateWabaPhoneNumberNew.this.welcomeMessage);
                    responseWriter.writeString(responseFieldArr[18], UpdateWabaPhoneNumberNew.this.requestedDisplayName);
                    responseWriter.writeString(responseFieldArr[19], UpdateWabaPhoneNumberNew.this.displayNameUpdate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], UpdateWabaPhoneNumberNew.this.displayNameUpdateDateTime);
                    responseWriter.writeString(responseFieldArr[21], UpdateWabaPhoneNumberNew.this.wabaNumberDecision);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], UpdateWabaPhoneNumberNew.this.wabaNumberDecisionTime);
                    responseWriter.writeString(responseFieldArr[23], UpdateWabaPhoneNumberNew.this.rejectionReason);
                    responseWriter.writeString(responseFieldArr[24], UpdateWabaPhoneNumberNew.this.phoneNumberQualityUpdate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], UpdateWabaPhoneNumberNew.this.phoneNumberQualityUpdateTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[26], UpdateWabaPhoneNumberNew.this.createdById);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], UpdateWabaPhoneNumberNew.this.updatedById);
                    ResponseField responseField = responseFieldArr[28];
                    EntityList entityList = UpdateWabaPhoneNumberNew.this.entityList;
    ...
    public static final class Variables extends Operation.Variables {
        private final ModelWabaPhoneNumberNewConditionInput condition;
        private final UpdateWabaPhoneNumberNewInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(UpdateWabaPhoneNumberNewInput updateWabaPhoneNumberNewInput, ModelWabaPhoneNumberNewConditionInput modelWabaPhoneNumberNewConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = updateWabaPhoneNumberNewInput;
            this.condition = modelWabaPhoneNumberNewConditionInput;
            linkedHashMap.put("input", updateWabaPhoneNumberNewInput);
            linkedHashMap.put("condition", modelWabaPhoneNumberNewConditionInput);
        }

        public ModelWabaPhoneNumberNewConditionInput condition() {
            return this.condition;
        }

        public UpdateWabaPhoneNumberNewInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWabaPhoneNumberNewMutation.Variables.1
    ...
    public UpdateWabaPhoneNumberNewMutation(UpdateWabaPhoneNumberNewInput updateWabaPhoneNumberNewInput, ModelWabaPhoneNumberNewConditionInput modelWabaPhoneNumberNewConditionInput) {
        Utils.checkNotNull(updateWabaPhoneNumberNewInput, "input == null");
        this.variables = new Variables(updateWabaPhoneNumberNewInput, modelWabaPhoneNumberNewConditionInput);
    }
    ...
    public String operationId() {
        return "8b99ebf3f986363b4d05a0bc2d89483848adc7d0f8749ab1b5c3c81f01cae12f";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation UpdateWabaPhoneNumberNew($input: UpdateWabaPhoneNumberNewInput!, $condition: ModelWabaPhoneNumberNewConditionInput) {\n  updateWabaPhoneNumberNew(input: $input, condition: $condition) {\n    __typename\n    id\n    wabaAccountId\n    accountId\n    phoneNumberId\n    phoneNumber\n    isDefault\n    accessToken\n    name\n    internalName\n    quota\n    currentLimitCategory\n    status\n    qualityRating\n    entityListId\n    createdAt\n    updatedAt\n    welcomeMessage\n    requestedDisplayName\n    displayNameUpdate\n    displayNameUpdateDateTime\n    wabaNumberDecision\n    wabaNumberDecisionTime\n    rejectionReason\n    phoneNumberQualityUpdate\n    phoneNumberQualityUpdateTime\n    createdById\n    updatedById\n    entityList {\n      __typename\n      id\n      accountId\n      entityTypeInList\n      entityListType\n      listName\n      description\n      status\n      successfulCount\n      duplicateCount\n      invalidNumbersCount\n      invalidEmailCount\n      doNotTrackCount\n      otherFailedCount\n      ownerId\n      listCreationType\n      listCategory\n      rawBulkUploadFileRef\n      rawBulkUploadFileHash\n      modifiedBulkUploadFileRef\n      finalBulkUploadFileRef\n      leadSourceForBulkUpload\n      defaultCountryCode\n      defaultCountryIso\n      notificationBody\n      rule\n      toBeAssigned\n      assignedUserId\n      assignedTeamId\n      associatedDistributionId\n      entityActionDefinitionReference\n      redistributeEntities\n      redistributionRequestedAt\n      dupliacteLeadList\n      tags\n      chatMessagePlatform\n      allowMultiple\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
