...
public final class OnUpdateCampaignRunSubscription implements Subscription<Data, Data, Operation.Variables> {
    public static final String OPERATION_DEFINITION = "subscription OnUpdateCampaignRun {\n  onUpdateCampaignRun {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCampaignRunSubscription.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "OnUpdateCampaignRun";
        }
    };
    public static final String QUERY_DOCUMENT = "subscription OnUpdateCampaignRun {\n  onUpdateCampaignRun {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Operation.Variables variables = Operation.EMPTY_VARIABLES;

    public static final class Builder {
        public OnUpdateCampaignRunSubscription build() {
            return new OnUpdateCampaignRunSubscription();
        }
    }
    ...
    public static class Campaign {
        ...
        public static final class Mapper implements ResponseFieldMapper<Campaign> {
            ...
            public Campaign map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[15], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCampaignRunSubscription.Campaign.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCampaignRunSubscription.Campaign.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[15], Campaign.this.daysToSend, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCampaignRunSubscription.Campaign.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[29], Campaign.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCampaignRunSubscription.Campaign.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("onUpdateCampaignRun", "onUpdateCampaignRun", null, true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnUpdateCampaignRun onUpdateCampaignRun;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final OnUpdateCampaignRun.Mapper onUpdateCampaignRunFieldMapper = new OnUpdateCampaignRun.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((OnUpdateCampaignRun) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<OnUpdateCampaignRun>() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCampaignRunSubscription.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public OnUpdateCampaignRun read(ResponseReader responseReader2) {
                        return Mapper.this.onUpdateCampaignRunFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(OnUpdateCampaignRun onUpdateCampaignRun) {
            this.onUpdateCampaignRun = onUpdateCampaignRun;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnUpdateCampaignRun onUpdateCampaignRun = this.onUpdateCampaignRun;
            OnUpdateCampaignRun onUpdateCampaignRun2 = ((Data) obj).onUpdateCampaignRun;
            return onUpdateCampaignRun == null ? onUpdateCampaignRun2 == null : onUpdateCampaignRun.equals(onUpdateCampaignRun2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnUpdateCampaignRun onUpdateCampaignRun = this.onUpdateCampaignRun;
                this.$hashCode = (onUpdateCampaignRun == null ? 0 : onUpdateCampaignRun.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCampaignRunSubscription.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    OnUpdateCampaignRun onUpdateCampaignRun = Data.this.onUpdateCampaignRun;
                    responseWriter.writeObject(responseField, onUpdateCampaignRun != null ? onUpdateCampaignRun.marshaller() : null);
                }
            };
        }

        public OnUpdateCampaignRun onUpdateCampaignRun() {
            return this.onUpdateCampaignRun;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onUpdateCampaignRun=" + this.onUpdateCampaignRun + "}";
            }
            return this.$toString;
        }
    }

    public static class OnUpdateCampaignRun {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<OnUpdateCampaignRun> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public OnUpdateCampaignRun map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = OnUpdateCampaignRun.$responseFields;
                String string = responseReader.readString(responseFieldArr[0]);
                String str = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]);
                String str2 = (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]);
        ...
        public OnUpdateCampaignRun(String str, String str2, String str3, String str4, String str5, CampaignType campaignType, String str6, String str7, String str8, String str9, CampaignStatus campaignStatus, String str10, Integer num, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, Integer num7, String str11, String str12, PrimaryTeam primaryTeam, String str13, String str14, Campaign campaign, Owner owner) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnUpdateCampaignRun)) {
                return false;
            }
            OnUpdateCampaignRun onUpdateCampaignRun = (OnUpdateCampaignRun) obj;
            if (this.__typename.equals(onUpdateCampaignRun.__typename) && this.id.equals(onUpdateCampaignRun.id) && this.accountId.equals(onUpdateCampaignRun.accountId) && this.campaignId.equals(onUpdateCampaignRun.campaignId) && ((str = this.campaignName) != null ? str.equals(onUpdateCampaignRun.campaignName) : onUpdateCampaignRun.campaignName == null) && ((campaignType = this.campaignType) != null ? campaignType.equals(onUpdateCampaignRun.campaignType) : onUpdateCampaignRun.campaignType == null) && ((str2 = this.campaignChannelIdentifier) != null ? str2.equals(onUpdateCampaignRun.campaignChannelIdentifier) : onUpdateCampaignRun.campaignChannelIdentifier == null) && this.name.equals(onUpdateCampaignRun.name) && ((str3 = this.startDate) != null ? str3.equals(onUpdateCampaignRun.startDate) : onUpdateCampaignRun.startDate == null) && ((str4 = this.endDate) != null ? str4.equals(onUpdateCampaignRun.endDate) : onUpdateCampaignRun.endDate == null) && this.status.equals(onUpdateCampaignRun.status) && ((str5 = this.systemPauseReason) != null ? str5.equals(onUpdateCampaignRun.systemPauseReason) : onUpdateCampaignRun.systemPauseReason == null) && ((num = this.leadCount) != null ? num.equals(onUpdateCampaignRun.leadCount) : onUpdateCampaignRun.leadCount == null) && ((num2 = this.messageCreated) != null ? num2.equals(onUpdateCampaignRun.messageCreated) : onUpdateCampaignRun.messageCreated == null) && ((num3 = this.sentCount) != null ? num3.equals(onUpdateCampaignRun.sentCount) : onUpdateCampaignRun.sentCount == null) && ((num4 = this.deliveredCount) != null ? num4.equals(onUpdateCampaignRun.deliveredCount) : onUpdateCampaignRun.deliveredCount == null) && ((num5 = this.readCount) != null ? num5.equals(onUpdateCampaignRun.readCount) : onUpdateCampaignRun.readCount == null) && ((num6 = this.repliedCount) != null ? num6.equals(onUpdateCampaignRun.repliedCount) : onUpdateCampaignRun.repliedCount == null) && ((num7 = this.failedCount) != null ? num7.equals(onUpdateCampaignRun.failedCount) : onUpdateCampaignRun.failedCount == null) && this.ownerId.equals(onUpdateCampaignRun.ownerId) && ((str6 = this.primaryTeamId) != null ? str6.equals(onUpdateCampaignRun.primaryTeamId) : onUpdateCampaignRun.primaryTeamId == null) && ((primaryTeam = this.primaryTeam) != null ? primaryTeam.equals(onUpdateCampaignRun.primaryTeam) : onUpdateCampaignRun.primaryTeam == null) && ((str7 = this.createdAt) != null ? str7.equals(onUpdateCampaignRun.createdAt) : onUpdateCampaignRun.createdAt == null) && ((str8 = this.updatedAt) != null ? str8.equals(onUpdateCampaignRun.updatedAt) : onUpdateCampaignRun.updatedAt == null) && ((campaign = this.campaign) != null ? campaign.equals(onUpdateCampaignRun.campaign) : onUpdateCampaignRun.campaign == null)) {
                Owner owner = this.owner;
                Owner owner2 = onUpdateCampaignRun.owner;
                if (owner == null) {
                    if (owner2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCampaignRunSubscription.OnUpdateCampaignRun.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = OnUpdateCampaignRun.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], OnUpdateCampaignRun.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], OnUpdateCampaignRun.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], OnUpdateCampaignRun.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], OnUpdateCampaignRun.this.campaignId);
                    responseWriter.writeString(responseFieldArr[4], OnUpdateCampaignRun.this.campaignName);
                    ResponseField responseField = responseFieldArr[5];
                    CampaignType campaignType = OnUpdateCampaignRun.this.campaignType;
                    responseWriter.writeString(responseField, campaignType != null ? campaignType.name() : null);
                    responseWriter.writeString(responseFieldArr[6], OnUpdateCampaignRun.this.campaignChannelIdentifier);
                    responseWriter.writeString(responseFieldArr[7], OnUpdateCampaignRun.this.name);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], OnUpdateCampaignRun.this.startDate);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], OnUpdateCampaignRun.this.endDate);
                    responseWriter.writeString(responseFieldArr[10], OnUpdateCampaignRun.this.status.name());
                    responseWriter.writeString(responseFieldArr[11], OnUpdateCampaignRun.this.systemPauseReason);
                    responseWriter.writeInt(responseFieldArr[12], OnUpdateCampaignRun.this.leadCount);
                    responseWriter.writeInt(responseFieldArr[13], OnUpdateCampaignRun.this.messageCreated);
                    responseWriter.writeInt(responseFieldArr[14], OnUpdateCampaignRun.this.sentCount);
                    responseWriter.writeInt(responseFieldArr[15], OnUpdateCampaignRun.this.deliveredCount);
                    responseWriter.writeInt(responseFieldArr[16], OnUpdateCampaignRun.this.readCount);
                    responseWriter.writeInt(responseFieldArr[17], OnUpdateCampaignRun.this.repliedCount);
                    responseWriter.writeInt(responseFieldArr[18], OnUpdateCampaignRun.this.failedCount);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], OnUpdateCampaignRun.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[20], OnUpdateCampaignRun.this.primaryTeamId);
                    ResponseField responseField2 = responseFieldArr[21];
                    PrimaryTeam primaryTeam = OnUpdateCampaignRun.this.primaryTeam;
                    responseWriter.writeObject(responseField2, primaryTeam != null ? primaryTeam.marshaller() : null);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[22], OnUpdateCampaignRun.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[23], OnUpdateCampaignRun.this.updatedAt);
                    ResponseField responseField3 = responseFieldArr[24];
                    Campaign campaign = OnUpdateCampaignRun.this.campaign;
                    ...
                    Owner owner = OnUpdateCampaignRun.this.owner;
    ...
    public static class Owner {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCampaignRunSubscription.Owner.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Owner.$responseFields;
    ...
    public static class PrimaryTeam {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnUpdateCampaignRunSubscription.PrimaryTeam.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = PrimaryTeam.$responseFields;
    ...
    public String operationId() {
        return "491077bfb0dd024e9abfd0d2bccdef7d2cf4c34dc54e419133e585e04a9edadb";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "subscription OnUpdateCampaignRun {\n  onUpdateCampaignRun {\n    __typename\n    id\n    accountId\n    campaignId\n    campaignName\n    campaignType\n    campaignChannelIdentifier\n    name\n    startDate\n    endDate\n    status\n    systemPauseReason\n    leadCount\n    messageCreated\n    sentCount\n    deliveredCount\n    readCount\n    repliedCount\n    failedCount\n    ownerId\n    primaryTeamId\n    primaryTeam {\n      __typename\n      id\n      accountId\n      createdById\n      description\n      teamName\n      updatedById\n      createdAt\n      updatedAt\n    }\n    createdAt\n    updatedAt\n    campaign {\n      __typename\n      id\n      accountId\n      name\n      description\n      campaignCategory\n      campaignSubCategory\n      campaignType\n      campaignChannelIdentifier\n      campaignData\n      campaignRunFrequencyUnit\n      campaignRunFrequencyValue\n      startDateOfRun\n      endDateOfRun\n      durationOfRunInDays\n      daysToSend\n      ownerId\n      primaryTeamId\n      status\n      systemPauseReason\n      associatedEntityListId\n      includeHistoricalMemberships\n      allowMultiple\n      messageCreated\n      sentCount\n      deliveredCount\n      readCount\n      repliedCount\n      failedCount\n      tags\n      leadLimit\n      createdAt\n      updatedAt\n    }\n    owner {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
