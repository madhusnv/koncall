...
import type.UpdateWhasappTemplatesInput;

/* loaded from: classes4.dex */
public final class UpdateWhasappTemplatesMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation UpdateWhasappTemplates($input: UpdateWhasappTemplatesInput!, $condition: ModelWhasappTemplatesConditionInput) {\n  updateWhasappTemplates(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "UpdateWhasappTemplates";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation UpdateWhasappTemplates($input: UpdateWhasappTemplatesInput!, $condition: ModelWhasappTemplatesConditionInput) {\n  updateWhasappTemplates(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    ...
    public static class ActionInteractive {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.ActionInteractive.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], ActionInteractive.this.savedAddresses, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.ActionInteractive.1.1
    ...
    public static final class Builder {
        ...
        private UpdateWhasappTemplatesInput input;

        public UpdateWhasappTemplatesMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new UpdateWhasappTemplatesMutation(this.input, this.condition);
        }
        ...
        public Builder input(UpdateWhasappTemplatesInput updateWhasappTemplatesInput) {
            this.input = updateWhasappTemplatesInput;
            return this;
        }
    }
    ...
    public static class Component {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.Component.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("updateWhasappTemplates", "updateWhasappTemplates", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final UpdateWhasappTemplates updateWhasappTemplates;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final UpdateWhasappTemplates.Mapper updateWhasappTemplatesFieldMapper = new UpdateWhasappTemplates.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((UpdateWhasappTemplates) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<UpdateWhasappTemplates>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public UpdateWhasappTemplates read(ResponseReader responseReader2) {
                        return Mapper.this.updateWhasappTemplatesFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(UpdateWhasappTemplates updateWhasappTemplates) {
            this.updateWhasappTemplates = updateWhasappTemplates;
        }
        ...
        public boolean equals(Object obj) {
            ...
            UpdateWhasappTemplates updateWhasappTemplates = this.updateWhasappTemplates;
            UpdateWhasappTemplates updateWhasappTemplates2 = ((Data) obj).updateWhasappTemplates;
            return updateWhasappTemplates == null ? updateWhasappTemplates2 == null : updateWhasappTemplates.equals(updateWhasappTemplates2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                UpdateWhasappTemplates updateWhasappTemplates = this.updateWhasappTemplates;
                this.$hashCode = (updateWhasappTemplates == null ? 0 : updateWhasappTemplates.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    UpdateWhasappTemplates updateWhasappTemplates = Data.this.updateWhasappTemplates;
                    responseWriter.writeObject(responseField, updateWhasappTemplates != null ? updateWhasappTemplates.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{updateWhasappTemplates=" + this.updateWhasappTemplates + "}";
            }
            return this.$toString;
        }

        public UpdateWhasappTemplates updateWhasappTemplates() {
            return this.updateWhasappTemplates;
        }
    }
    ...
    public static class DefaultMedia {
        ...
        public static final class Mapper implements ResponseFieldMapper<DefaultMedia> {
            ...
            public DefaultMedia map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[9], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.DefaultMedia.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.DefaultMedia.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultMedia.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[9], DefaultMedia.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.DefaultMedia.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class DefaultVariableMap {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.DefaultVariableMap.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultVariableMap.$responseFields;
    ...
    public static class UpdateWhasappTemplates {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<UpdateWhasappTemplates> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public UpdateWhasappTemplates map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = UpdateWhasappTemplates.$responseFields;
                return new UpdateWhasappTemplates(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), responseReader.readString(responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), responseReader.readString(responseFieldArr[6]), responseReader.readString(responseFieldArr[7]), responseReader.readList(responseFieldArr[8], new ResponseReader.ListReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.UpdateWhasappTemplates.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Component read(ResponseReader.ListItemReader listItemReader) {
                        return (Component) listItemReader.readObject(new ResponseReader.ObjectReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.UpdateWhasappTemplates.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateWhasappTemplates)) {
                return false;
            }
            UpdateWhasappTemplates updateWhasappTemplates = (UpdateWhasappTemplates) obj;
            if (this.__typename.equals(updateWhasappTemplates.__typename) && this.id.equals(updateWhasappTemplates.id) && this.accountId.equals(updateWhasappTemplates.accountId) && ((str = this.whatsappBusinessAccount) != null ? str.equals(updateWhasappTemplates.whatsappBusinessAccount) : updateWhasappTemplates.whatsappBusinessAccount == null) && ((str2 = this.templateType) != null ? str2.equals(updateWhasappTemplates.templateType) : updateWhasappTemplates.templateType == null) && ((str3 = this.snippetType) != null ? str3.equals(updateWhasappTemplates.snippetType) : updateWhasappTemplates.snippetType == null) && ((str4 = this.platform) != null ? str4.equals(updateWhasappTemplates.platform) : updateWhasappTemplates.platform == null) && ((str5 = this.name) != null ? str5.equals(updateWhasappTemplates.name) : updateWhasappTemplates.name == null) && ((list = this.components) != null ? list.equals(updateWhasappTemplates.components) : updateWhasappTemplates.components == null) && ((str6 = this.language) != null ? str6.equals(updateWhasappTemplates.language) : updateWhasappTemplates.language == null) && ((str7 = this.status) != null ? str7.equals(updateWhasappTemplates.status) : updateWhasappTemplates.status == null) && ((str8 = this.category) != null ? str8.equals(updateWhasappTemplates.category) : updateWhasappTemplates.category == null) && ((str9 = this.subCategory) != null ? str9.equals(updateWhasappTemplates.subCategory) : updateWhasappTemplates.subCategory == null) && ((str10 = this.snippetCategory) != null ? str10.equals(updateWhasappTemplates.snippetCategory) : updateWhasappTemplates.snippetCategory == null) && ((str11 = this.snippetSubCategory) != null ? str11.equals(updateWhasappTemplates.snippetSubCategory) : updateWhasappTemplates.snippetSubCategory == null) && ((str12 = this.createdBy) != null ? str12.equals(updateWhasappTemplates.createdBy) : updateWhasappTemplates.createdBy == null) && ((str13 = this.updatedBy) != null ? str13.equals(updateWhasappTemplates.updatedBy) : updateWhasappTemplates.updatedBy == null) && ((str14 = this.archivedStatus) != null ? str14.equals(updateWhasappTemplates.archivedStatus) : updateWhasappTemplates.archivedStatus == null) && ((str15 = this.archivedAt) != null ? str15.equals(updateWhasappTemplates.archivedAt) : updateWhasappTemplates.archivedAt == null) && ((str16 = this.defaultMediaId) != null ? str16.equals(updateWhasappTemplates.defaultMediaId) : updateWhasappTemplates.defaultMediaId == null) && ((list2 = this.defaultVariableMap) != null ? list2.equals(updateWhasappTemplates.defaultVariableMap) : updateWhasappTemplates.defaultVariableMap == null) && ((str17 = this.templateId) != null ? str17.equals(updateWhasappTemplates.templateId) : updateWhasappTemplates.templateId == null) && ((list3 = this.tags) != null ? list3.equals(updateWhasappTemplates.tags) : updateWhasappTemplates.tags == null) && ((bool = this.isSample) != null ? bool.equals(updateWhasappTemplates.isSample) : updateWhasappTemplates.isSample == null) && ((str18 = this.messageType) != null ? str18.equals(updateWhasappTemplates.messageType) : updateWhasappTemplates.messageType == null) && ((str19 = this.messageSubType) != null ? str19.equals(updateWhasappTemplates.messageSubType) : updateWhasappTemplates.messageSubType == null) && ((str20 = this.text) != null ? str20.equals(updateWhasappTemplates.text) : updateWhasappTemplates.text == null) && ((str21 = this.locationObjectToSend) != null ? str21.equals(updateWhasappTemplates.locationObjectToSend) : updateWhasappTemplates.locationObjectToSend == null) && ((str22 = this.headerText) != null ? str22.equals(updateWhasappTemplates.headerText) : updateWhasappTemplates.headerText == null) && ((str23 = this.footerText) != null ? str23.equals(updateWhasappTemplates.footerText) : updateWhasappTemplates.footerText == null) && ((str24 = this.headerType) != null ? str24.equals(updateWhasappTemplates.headerType) : updateWhasappTemplates.headerType == null) && ((actionInteractive = this.actionInteractive) != null ? actionInteractive.equals(updateWhasappTemplates.actionInteractive) : updateWhasappTemplates.actionInteractive == null) && ((str25 = this.messageTemplateQualityNew) != null ? str25.equals(updateWhasappTemplates.messageTemplateQualityNew) : updateWhasappTemplates.messageTemplateQualityNew == null) && ((str26 = this.messageTemplateQualityPrevious) != null ? str26.equals(updateWhasappTemplates.messageTemplateQualityPrevious) : updateWhasappTemplates.messageTemplateQualityPrevious == null) && ((str27 = this.messageTemplateQualityUpdatedAt) != null ? str27.equals(updateWhasappTemplates.messageTemplateQualityUpdatedAt) : updateWhasappTemplates.messageTemplateQualityUpdatedAt == null) && ((str28 = this.messageTemplateStatusUpdatedAt) != null ? str28.equals(updateWhasappTemplates.messageTemplateStatusUpdatedAt) : updateWhasappTemplates.messageTemplateStatusUpdatedAt == null) && ((str29 = this.stausUpdateReason) != null ? str29.equals(updateWhasappTemplates.stausUpdateReason) : updateWhasappTemplates.stausUpdateReason == null) && ((str30 = this.otherDetail) != null ? str30.equals(updateWhasappTemplates.otherDetail) : updateWhasappTemplates.otherDetail == null) && ((str31 = this.lastUsed) != null ? str31.equals(updateWhasappTemplates.lastUsed) : updateWhasappTemplates.lastUsed == null) && ((str32 = this.createdAt) != null ? str32.equals(updateWhasappTemplates.createdAt) : updateWhasappTemplates.createdAt == null) && ((str33 = this.updatedAt) != null ? str33.equals(updateWhasappTemplates.updatedAt) : updateWhasappTemplates.updatedAt == null)) {
                DefaultMedia defaultMedia = this.defaultMedia;
                DefaultMedia defaultMedia2 = updateWhasappTemplates.defaultMedia;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.UpdateWhasappTemplates.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = UpdateWhasappTemplates.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], UpdateWhasappTemplates.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], UpdateWhasappTemplates.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], UpdateWhasappTemplates.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], UpdateWhasappTemplates.this.whatsappBusinessAccount);
                    responseWriter.writeString(responseFieldArr[4], UpdateWhasappTemplates.this.templateType);
                    responseWriter.writeString(responseFieldArr[5], UpdateWhasappTemplates.this.snippetType);
                    responseWriter.writeString(responseFieldArr[6], UpdateWhasappTemplates.this.platform);
                    responseWriter.writeString(responseFieldArr[7], UpdateWhasappTemplates.this.name);
                    responseWriter.writeList(responseFieldArr[8], UpdateWhasappTemplates.this.components, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.UpdateWhasappTemplates.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Component) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[9], UpdateWhasappTemplates.this.language);
                    responseWriter.writeString(responseFieldArr[10], UpdateWhasappTemplates.this.status);
                    responseWriter.writeString(responseFieldArr[11], UpdateWhasappTemplates.this.category);
                    responseWriter.writeString(responseFieldArr[12], UpdateWhasappTemplates.this.subCategory);
                    responseWriter.writeString(responseFieldArr[13], UpdateWhasappTemplates.this.snippetCategory);
                    responseWriter.writeString(responseFieldArr[14], UpdateWhasappTemplates.this.snippetSubCategory);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], UpdateWhasappTemplates.this.createdBy);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], UpdateWhasappTemplates.this.updatedBy);
                    responseWriter.writeString(responseFieldArr[17], UpdateWhasappTemplates.this.archivedStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], UpdateWhasappTemplates.this.archivedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], UpdateWhasappTemplates.this.defaultMediaId);
                    responseWriter.writeList(responseFieldArr[20], UpdateWhasappTemplates.this.defaultVariableMap, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.UpdateWhasappTemplates.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((DefaultVariableMap) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[21], UpdateWhasappTemplates.this.templateId);
                    responseWriter.writeList(responseFieldArr[22], UpdateWhasappTemplates.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.UpdateWhasappTemplates.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeBoolean(responseFieldArr[23], UpdateWhasappTemplates.this.isSample);
                    responseWriter.writeString(responseFieldArr[24], UpdateWhasappTemplates.this.messageType);
                    responseWriter.writeString(responseFieldArr[25], UpdateWhasappTemplates.this.messageSubType);
                    responseWriter.writeString(responseFieldArr[26], UpdateWhasappTemplates.this.text);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], UpdateWhasappTemplates.this.locationObjectToSend);
                    responseWriter.writeString(responseFieldArr[28], UpdateWhasappTemplates.this.headerText);
                    responseWriter.writeString(responseFieldArr[29], UpdateWhasappTemplates.this.footerText);
                    responseWriter.writeString(responseFieldArr[30], UpdateWhasappTemplates.this.headerType);
                    ResponseField responseField = responseFieldArr[31];
                    ActionInteractive actionInteractive = UpdateWhasappTemplates.this.actionInteractive;
                    responseWriter.writeObject(responseField, actionInteractive != null ? actionInteractive.marshaller() : null);
                    responseWriter.writeString(responseFieldArr[32], UpdateWhasappTemplates.this.messageTemplateQualityNew);
                    responseWriter.writeString(responseFieldArr[33], UpdateWhasappTemplates.this.messageTemplateQualityPrevious);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[34], UpdateWhasappTemplates.this.messageTemplateQualityUpdatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[35], UpdateWhasappTemplates.this.messageTemplateStatusUpdatedAt);
                    responseWriter.writeString(responseFieldArr[36], UpdateWhasappTemplates.this.stausUpdateReason);
                    responseWriter.writeString(responseFieldArr[37], UpdateWhasappTemplates.this.otherDetail);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], UpdateWhasappTemplates.this.lastUsed);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[39], UpdateWhasappTemplates.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[40], UpdateWhasappTemplates.this.updatedAt);
                    ResponseField responseField2 = responseFieldArr[41];
                    DefaultMedia defaultMedia = UpdateWhasappTemplates.this.defaultMedia;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final UpdateWhasappTemplatesInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(UpdateWhasappTemplatesInput updateWhasappTemplatesInput, ModelWhasappTemplatesConditionInput modelWhasappTemplatesConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = updateWhasappTemplatesInput;
            this.condition = modelWhasappTemplatesConditionInput;
            linkedHashMap.put("input", updateWhasappTemplatesInput);
        ...
        public UpdateWhasappTemplatesInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.UpdateWhasappTemplatesMutation.Variables.1
    ...
    public UpdateWhasappTemplatesMutation(UpdateWhasappTemplatesInput updateWhasappTemplatesInput, ModelWhasappTemplatesConditionInput modelWhasappTemplatesConditionInput) {
        Utils.checkNotNull(updateWhasappTemplatesInput, "input == null");
        this.variables = new Variables(updateWhasappTemplatesInput, modelWhasappTemplatesConditionInput);
    }
    ...
    public String operationId() {
        return "6313b236fe22a341f768b0d859c29be75518eba436dbcec4c560d9e425bf576b";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation UpdateWhasappTemplates($input: UpdateWhasappTemplatesInput!, $condition: ModelWhasappTemplatesConditionInput) {\n  updateWhasappTemplates(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
