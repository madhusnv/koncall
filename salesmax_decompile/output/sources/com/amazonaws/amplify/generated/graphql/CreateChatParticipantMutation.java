...
import type.CreateChatParticipantInput;
import type.CustomType;
import type.ModelChatParticipantConditionInput;
import type.UserRegistrationStatus;

/* loaded from: classes6.dex */
public final class CreateChatParticipantMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation CreateChatParticipant($input: CreateChatParticipantInput!, $condition: ModelChatParticipantConditionInput) {\n  createChatParticipant(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    channelId\n    phoneNumberIdExternal\n    participantId\n    participationStatus\n    unreadMessageCount\n    lastViewed\n    isStarred\n    joinedAt\n    leftAt\n    channelName\n    channelType\n    channelSubType\n    channelStatus\n    channelWillBeChargedNext\n    channelOpenUntil\n    lastMessageByLeadTime\n    lastMessageByUserTime\n    isLastMessageByLead\n    lastOutboundMessageId\n    lastOutboundMessageStatus\n    isNewMessageUpdate\n    tags\n    participantScopeIfInternal\n    userIdsForDirectChannel\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    participant {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatParticipantMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "CreateChatParticipant";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation CreateChatParticipant($input: CreateChatParticipantInput!, $condition: ModelChatParticipantConditionInput) {\n  createChatParticipant(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    channelId\n    phoneNumberIdExternal\n    participantId\n    participationStatus\n    unreadMessageCount\n    lastViewed\n    isStarred\n    joinedAt\n    leftAt\n    channelName\n    channelType\n    channelSubType\n    channelStatus\n    channelWillBeChargedNext\n    channelOpenUntil\n    lastMessageByLeadTime\n    lastMessageByUserTime\n    isLastMessageByLead\n    lastOutboundMessageId\n    lastOutboundMessageStatus\n    isNewMessageUpdate\n    tags\n    participantScopeIfInternal\n    userIdsForDirectChannel\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    participant {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private ModelChatParticipantConditionInput condition;
        private CreateChatParticipantInput input;

        public CreateChatParticipantMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new CreateChatParticipantMutation(this.input, this.condition);
        }
        ...
        public Builder input(CreateChatParticipantInput createChatParticipantInput) {
            this.input = createChatParticipantInput;
            return this;
        }
    }
    ...
    public static class Channel {
        ...
        public static final class Mapper implements ResponseFieldMapper<Channel> {
            ...
            public Channel map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[6], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatParticipantMutation.Channel.Mapper.1
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatParticipantMutation.Channel.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[6], Channel.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatParticipantMutation.Channel.1.1
    ...
    public static class CreateChatParticipant {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements ResponseFieldMapper<CreateChatParticipant> {
            ...
            public CreateChatParticipant map(ResponseReader responseReader) {
                ...
                }), (Participant) responseReader.readObject(responseFieldArr[30], new ResponseReader.ObjectReader<Participant>() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatParticipantMutation.CreateChatParticipant.Mapper.3
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public CreateChatParticipant(String str, String str2, String str3, String str4, String str5, String str6, String str7, Integer num, String str8, Boolean bool, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, Boolean bool2, String str19, String str20, Boolean bool3, List<String> list, String str21, String str22, String str23, String str24, Channel channel, Participant participant) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.id = (String) Utils.checkNotNull(str2, "id == null");
            this.accountId = (String) Utils.checkNotNull(str3, "accountId == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateChatParticipant)) {
                return false;
            }
            CreateChatParticipant createChatParticipant = (CreateChatParticipant) obj;
            if (this.__typename.equals(createChatParticipant.__typename) && this.id.equals(createChatParticipant.id) && this.accountId.equals(createChatParticipant.accountId) && this.channelId.equals(createChatParticipant.channelId) && ((str = this.phoneNumberIdExternal) != null ? str.equals(createChatParticipant.phoneNumberIdExternal) : createChatParticipant.phoneNumberIdExternal == null) && this.participantId.equals(createChatParticipant.participantId) && this.participationStatus.equals(createChatParticipant.participationStatus) && ((num = this.unreadMessageCount) != null ? num.equals(createChatParticipant.unreadMessageCount) : createChatParticipant.unreadMessageCount == null) && ((str2 = this.lastViewed) != null ? str2.equals(createChatParticipant.lastViewed) : createChatParticipant.lastViewed == null) && ((bool = this.isStarred) != null ? bool.equals(createChatParticipant.isStarred) : createChatParticipant.isStarred == null) && ((str3 = this.joinedAt) != null ? str3.equals(createChatParticipant.joinedAt) : createChatParticipant.joinedAt == null) && ((str4 = this.leftAt) != null ? str4.equals(createChatParticipant.leftAt) : createChatParticipant.leftAt == null) && ((str5 = this.channelName) != null ? str5.equals(createChatParticipant.channelName) : createChatParticipant.channelName == null) && ((str6 = this.channelType) != null ? str6.equals(createChatParticipant.channelType) : createChatParticipant.channelType == null) && ((str7 = this.channelSubType) != null ? str7.equals(createChatParticipant.channelSubType) : createChatParticipant.channelSubType == null) && ((str8 = this.channelStatus) != null ? str8.equals(createChatParticipant.channelStatus) : createChatParticipant.channelStatus == null) && ((str9 = this.channelWillBeChargedNext) != null ? str9.equals(createChatParticipant.channelWillBeChargedNext) : createChatParticipant.channelWillBeChargedNext == null) && ((str10 = this.channelOpenUntil) != null ? str10.equals(createChatParticipant.channelOpenUntil) : createChatParticipant.channelOpenUntil == null) && ((str11 = this.lastMessageByLeadTime) != null ? str11.equals(createChatParticipant.lastMessageByLeadTime) : createChatParticipant.lastMessageByLeadTime == null) && ((str12 = this.lastMessageByUserTime) != null ? str12.equals(createChatParticipant.lastMessageByUserTime) : createChatParticipant.lastMessageByUserTime == null) && ((bool2 = this.isLastMessageByLead) != null ? bool2.equals(createChatParticipant.isLastMessageByLead) : createChatParticipant.isLastMessageByLead == null) && ((str13 = this.lastOutboundMessageId) != null ? str13.equals(createChatParticipant.lastOutboundMessageId) : createChatParticipant.lastOutboundMessageId == null) && ((str14 = this.lastOutboundMessageStatus) != null ? str14.equals(createChatParticipant.lastOutboundMessageStatus) : createChatParticipant.lastOutboundMessageStatus == null) && ((bool3 = this.isNewMessageUpdate) != null ? bool3.equals(createChatParticipant.isNewMessageUpdate) : createChatParticipant.isNewMessageUpdate == null) && ((list = this.tags) != null ? list.equals(createChatParticipant.tags) : createChatParticipant.tags == null) && ((str15 = this.participantScopeIfInternal) != null ? str15.equals(createChatParticipant.participantScopeIfInternal) : createChatParticipant.participantScopeIfInternal == null) && ((str16 = this.userIdsForDirectChannel) != null ? str16.equals(createChatParticipant.userIdsForDirectChannel) : createChatParticipant.userIdsForDirectChannel == null) && ((str17 = this.createdAt) != null ? str17.equals(createChatParticipant.createdAt) : createChatParticipant.createdAt == null) && ((str18 = this.updatedAt) != null ? str18.equals(createChatParticipant.updatedAt) : createChatParticipant.updatedAt == null) && ((channel = this.channel) != null ? channel.equals(createChatParticipant.channel) : createChatParticipant.channel == null)) {
                Participant participant = this.participant;
                Participant participant2 = createChatParticipant.participant;
                if (participant == null) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatParticipantMutation.CreateChatParticipant.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateChatParticipant.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateChatParticipant.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateChatParticipant.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], CreateChatParticipant.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], CreateChatParticipant.this.channelId);
                    responseWriter.writeString(responseFieldArr[4], CreateChatParticipant.this.phoneNumberIdExternal);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[5], CreateChatParticipant.this.participantId);
                    responseWriter.writeString(responseFieldArr[6], CreateChatParticipant.this.participationStatus);
                    responseWriter.writeInt(responseFieldArr[7], CreateChatParticipant.this.unreadMessageCount);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], CreateChatParticipant.this.lastViewed);
                    responseWriter.writeBoolean(responseFieldArr[9], CreateChatParticipant.this.isStarred);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[10], CreateChatParticipant.this.joinedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[11], CreateChatParticipant.this.leftAt);
                    responseWriter.writeString(responseFieldArr[12], CreateChatParticipant.this.channelName);
                    responseWriter.writeString(responseFieldArr[13], CreateChatParticipant.this.channelType);
                    responseWriter.writeString(responseFieldArr[14], CreateChatParticipant.this.channelSubType);
                    responseWriter.writeString(responseFieldArr[15], CreateChatParticipant.this.channelStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], CreateChatParticipant.this.channelWillBeChargedNext);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], CreateChatParticipant.this.channelOpenUntil);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], CreateChatParticipant.this.lastMessageByLeadTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], CreateChatParticipant.this.lastMessageByUserTime);
                    responseWriter.writeBoolean(responseFieldArr[20], CreateChatParticipant.this.isLastMessageByLead);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[21], CreateChatParticipant.this.lastOutboundMessageId);
                    responseWriter.writeString(responseFieldArr[22], CreateChatParticipant.this.lastOutboundMessageStatus);
                    responseWriter.writeBoolean(responseFieldArr[23], CreateChatParticipant.this.isNewMessageUpdate);
                    responseWriter.writeList(responseFieldArr[24], CreateChatParticipant.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatParticipantMutation.CreateChatParticipant.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeString(responseFieldArr[25], CreateChatParticipant.this.participantScopeIfInternal);
                    responseWriter.writeString(responseFieldArr[26], CreateChatParticipant.this.userIdsForDirectChannel);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], CreateChatParticipant.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[28], CreateChatParticipant.this.updatedAt);
                    ResponseField responseField = responseFieldArr[29];
                    Channel channel = CreateChatParticipant.this.channel;
                    ...
                    Participant participant = CreateChatParticipant.this.participant;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createChatParticipant", "createChatParticipant", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final CreateChatParticipant createChatParticipant;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateChatParticipant.Mapper createChatParticipantFieldMapper = new CreateChatParticipant.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateChatParticipant) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateChatParticipant>() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatParticipantMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateChatParticipant read(ResponseReader responseReader2) {
                        return Mapper.this.createChatParticipantFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateChatParticipant createChatParticipant) {
            this.createChatParticipant = createChatParticipant;
        }

        public CreateChatParticipant createChatParticipant() {
        ...
        public boolean equals(Object obj) {
            ...
            CreateChatParticipant createChatParticipant = this.createChatParticipant;
            CreateChatParticipant createChatParticipant2 = ((Data) obj).createChatParticipant;
            return createChatParticipant == null ? createChatParticipant2 == null : createChatParticipant.equals(createChatParticipant2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateChatParticipant createChatParticipant = this.createChatParticipant;
                this.$hashCode = (createChatParticipant == null ? 0 : createChatParticipant.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatParticipantMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateChatParticipant createChatParticipant = Data.this.createChatParticipant;
                    responseWriter.writeObject(responseField, createChatParticipant != null ? createChatParticipant.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createChatParticipant=" + this.createChatParticipant + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Participant {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatParticipantMutation.Participant.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Participant.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final CreateChatParticipantInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateChatParticipantInput createChatParticipantInput, ModelChatParticipantConditionInput modelChatParticipantConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createChatParticipantInput;
            this.condition = modelChatParticipantConditionInput;
            linkedHashMap.put("input", createChatParticipantInput);
        ...
        public CreateChatParticipantInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateChatParticipantMutation.Variables.1
    ...
    public CreateChatParticipantMutation(CreateChatParticipantInput createChatParticipantInput, ModelChatParticipantConditionInput modelChatParticipantConditionInput) {
        Utils.checkNotNull(createChatParticipantInput, "input == null");
        this.variables = new Variables(createChatParticipantInput, modelChatParticipantConditionInput);
    }
    ...
    public String operationId() {
        return "daf80e80ebad6ed9695f103f175e98bfbe483c9ec55f6aec6f805ee34355c99c";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateChatParticipant($input: CreateChatParticipantInput!, $condition: ModelChatParticipantConditionInput) {\n  createChatParticipant(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    channelId\n    phoneNumberIdExternal\n    participantId\n    participationStatus\n    unreadMessageCount\n    lastViewed\n    isStarred\n    joinedAt\n    leftAt\n    channelName\n    channelType\n    channelSubType\n    channelStatus\n    channelWillBeChargedNext\n    channelOpenUntil\n    lastMessageByLeadTime\n    lastMessageByUserTime\n    isLastMessageByLead\n    lastOutboundMessageId\n    lastOutboundMessageStatus\n    isNewMessageUpdate\n    tags\n    participantScopeIfInternal\n    userIdsForDirectChannel\n    createdAt\n    updatedAt\n    channel {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      channelName\n      messagePlatform\n      tags\n      recipientType\n      channelType\n      channelSubType\n      externalParticipantsAllowed\n      participantScopeIfInternal\n      userIdsForDirectChannel\n      channelStatus\n      channelWillBeChargedNext\n      channelOpenUntil\n      contactId\n      visitorId\n      recipientExternalId\n      recipientExternalIdType\n      ownerId\n      primaryTeamId\n      toBeAssigned\n      createdById\n      readNotifiedAt\n      lastMessageByLeadTime\n      lastMessageByUserTime\n      isLastMessageByLead\n      lastOutboundMessageId\n      lastOutboundMessageStatus\n      lastOutboundMessageWasBroadcast\n      chanelHasOnlyBroadcast\n      salesmaxAccountId\n      channelProfilePic\n      createdAt\n      updatedAt\n    }\n    participant {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
