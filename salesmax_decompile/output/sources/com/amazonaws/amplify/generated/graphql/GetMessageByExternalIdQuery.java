...
public final class GetMessageByExternalIdQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetMessageByExternalId($externalMessageReferenceId: String, $sortDirection: ModelSortDirection, $filter: ModelChatMessageFilterInput, $limit: Int, $nextToken: String) {\n  getMessageByExternalId(externalMessageReferenceId: $externalMessageReferenceId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      messagePlatform\n      externalMessageReferenceId\n      externalConversationId\n      recipientExternalId\n      recipientExternalIdType\n      channelId\n      contactId\n      visitorId\n      referredContactId\n      messageType\n      messageSubType\n      messageCategory\n      messageSendCategory\n      replyingToMessageId\n      replyingToMessageIdExternal\n      responseMessageId\n      followUpType\n      replyType\n      replyTypeId\n      referredProductCatalogId\n      referredProductRetailerId\n      referral\n      isStarred\n      status\n      errorMessages\n      sentAt\n      deliveredAt\n      readAt\n      internalTemplateId\n      externalTemplateId\n      externalTemplateCategory\n      text\n      contactObjectToSend\n      locationObjectToSend\n      adddressMessageParameters\n      headerText\n      footerText\n      headerType\n      mediaObjectId\n      mediaMetadata\n      hasImage\n      thumbnailUrl\n      isInbound\n      chatUserId\n      chatUserName\n      chatBotId\n      chatUserAccountIdIfExternal\n      chatUserAccountNameIfExternal\n      directChatUserId\n      primaryTeamId\n      linkedEngagementIdIfBroadcast\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetMessageByExternalIdQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetMessageByExternalId";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetMessageByExternalId($externalMessageReferenceId: String, $sortDirection: ModelSortDirection, $filter: ModelChatMessageFilterInput, $limit: Int, $nextToken: String) {\n  getMessageByExternalId(externalMessageReferenceId: $externalMessageReferenceId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      messagePlatform\n      externalMessageReferenceId\n      externalConversationId\n      recipientExternalId\n      recipientExternalIdType\n      channelId\n      contactId\n      visitorId\n      referredContactId\n      messageType\n      messageSubType\n      messageCategory\n      messageSendCategory\n      replyingToMessageId\n      replyingToMessageIdExternal\n      responseMessageId\n      followUpType\n      replyType\n      replyTypeId\n      referredProductCatalogId\n      referredProductRetailerId\n      referral\n      isStarred\n      status\n      errorMessages\n      sentAt\n      deliveredAt\n      readAt\n      internalTemplateId\n      externalTemplateId\n      externalTemplateCategory\n      text\n      contactObjectToSend\n      locationObjectToSend\n      adddressMessageParameters\n      headerText\n      footerText\n      headerType\n      mediaObjectId\n      mediaMetadata\n      hasImage\n      thumbnailUrl\n      isInbound\n      chatUserId\n      chatUserName\n      chatBotId\n      chatUserAccountIdIfExternal\n      chatUserAccountNameIfExternal\n      directChatUserId\n      primaryTeamId\n      linkedEngagementIdIfBroadcast\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private final Variables variables;

    public static final class Builder {
        private String externalMessageReferenceId;
        private ModelChatMessageFilterInput filter;
        private Integer limit;
        private String nextToken;
        private ModelSortDirection sortDirection;

        public GetMessageByExternalIdQuery build() {
            return new GetMessageByExternalIdQuery(this.externalMessageReferenceId, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
        ...
        public Builder filter(ModelChatMessageFilterInput modelChatMessageFilterInput) {
            this.filter = modelChatMessageFilterInput;
            return this;
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getMessageByExternalId", "getMessageByExternalId", new UnmodifiableMapBuilder(5).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("externalMessageReferenceId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "externalMessageReferenceId").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetMessageByExternalId getMessageByExternalId;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetMessageByExternalId.Mapper getMessageByExternalIdFieldMapper = new GetMessageByExternalId.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetMessageByExternalId) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetMessageByExternalId>() { // from class: com.amazonaws.amplify.generated.graphql.GetMessageByExternalIdQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetMessageByExternalId read(ResponseReader responseReader2) {
                        return Mapper.this.getMessageByExternalIdFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetMessageByExternalId getMessageByExternalId) {
            this.getMessageByExternalId = getMessageByExternalId;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetMessageByExternalId getMessageByExternalId = this.getMessageByExternalId;
            GetMessageByExternalId getMessageByExternalId2 = ((Data) obj).getMessageByExternalId;
            return getMessageByExternalId == null ? getMessageByExternalId2 == null : getMessageByExternalId.equals(getMessageByExternalId2);
        }

        public GetMessageByExternalId getMessageByExternalId() {
            return this.getMessageByExternalId;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetMessageByExternalId getMessageByExternalId = this.getMessageByExternalId;
                this.$hashCode = (getMessageByExternalId == null ? 0 : getMessageByExternalId.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMessageByExternalIdQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetMessageByExternalId getMessageByExternalId = Data.this.getMessageByExternalId;
                    responseWriter.writeObject(responseField, getMessageByExternalId != null ? getMessageByExternalId.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getMessageByExternalId=" + this.getMessageByExternalId + "}";
            }
            return this.$toString;
        }
    }

    public static class GetMessageByExternalId {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetMessageByExternalId> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetMessageByExternalId map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetMessageByExternalId.$responseFields;
                return new GetMessageByExternalId(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetMessageByExternalIdQuery.GetMessageByExternalId.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetMessageByExternalIdQuery.GetMessageByExternalId.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetMessageByExternalId(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetMessageByExternalId)) {
                return false;
            }
            GetMessageByExternalId getMessageByExternalId = (GetMessageByExternalId) obj;
            if (this.__typename.equals(getMessageByExternalId.__typename) && this.items.equals(getMessageByExternalId.items)) {
                String str = this.nextToken;
                String str2 = getMessageByExternalId.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMessageByExternalIdQuery.GetMessageByExternalId.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetMessageByExternalId.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetMessageByExternalId.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetMessageByExternalId.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetMessageByExternalIdQuery.GetMessageByExternalId.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetMessageByExternalId.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetMessageByExternalId{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMessageByExternalIdQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[36], Item.this.contactObjectToSend, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetMessageByExternalIdQuery.Item.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final ModelChatMessageFilterInput filter;
        private final Integer limit;
        private final String nextToken;
        private final ModelSortDirection sortDirection;
        private final transient Map<String, Object> valueMap;

        public Variables(String str, ModelSortDirection modelSortDirection, ModelChatMessageFilterInput modelChatMessageFilterInput, Integer num, String str2) {
            ...
            this.limit = num;
            this.nextToken = str2;
            linkedHashMap.put("externalMessageReferenceId", str);
            linkedHashMap.put("sortDirection", modelSortDirection);
            linkedHashMap.put("filter", modelChatMessageFilterInput);
        ...
        public ModelChatMessageFilterInput filter() {
            return this.filter;
        }
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetMessageByExternalIdQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("externalMessageReferenceId", Variables.this.externalMessageReferenceId);
    ...
    public GetMessageByExternalIdQuery(String str, ModelSortDirection modelSortDirection, ModelChatMessageFilterInput modelChatMessageFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelSortDirection, modelChatMessageFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "57620660dbdda64ab5b68119f10128b99e2af55b0327d4d36d5dab7edca8d104";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetMessageByExternalId($externalMessageReferenceId: String, $sortDirection: ModelSortDirection, $filter: ModelChatMessageFilterInput, $limit: Int, $nextToken: String) {\n  getMessageByExternalId(externalMessageReferenceId: $externalMessageReferenceId, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      phoneNumberIdExternal\n      messagePlatform\n      externalMessageReferenceId\n      externalConversationId\n      recipientExternalId\n      recipientExternalIdType\n      channelId\n      contactId\n      visitorId\n      referredContactId\n      messageType\n      messageSubType\n      messageCategory\n      messageSendCategory\n      replyingToMessageId\n      replyingToMessageIdExternal\n      responseMessageId\n      followUpType\n      replyType\n      replyTypeId\n      referredProductCatalogId\n      referredProductRetailerId\n      referral\n      isStarred\n      status\n      errorMessages\n      sentAt\n      deliveredAt\n      readAt\n      internalTemplateId\n      externalTemplateId\n      externalTemplateCategory\n      text\n      contactObjectToSend\n      locationObjectToSend\n      adddressMessageParameters\n      headerText\n      footerText\n      headerType\n      mediaObjectId\n      mediaMetadata\n      hasImage\n      thumbnailUrl\n      isInbound\n      chatUserId\n      chatUserName\n      chatBotId\n      chatUserAccountIdIfExternal\n      chatUserAccountNameIfExternal\n      directChatUserId\n      primaryTeamId\n      linkedEngagementIdIfBroadcast\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
