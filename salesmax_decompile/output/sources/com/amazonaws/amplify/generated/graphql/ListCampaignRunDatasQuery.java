...
public final class ListCampaignRunDatasQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListCampaignRunDatas($filter: ModelCampaignRunDataFilterInput, $limit: Int, $nextToken: String) {\n  listCampaignRunDatas(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      contactSource\n      campaignId\n      campaignRunId\n      engagementId\n      campaignOutputType\n      campaignOutputId\n      campaignResponseType\n      campaignResponseId\n      responseCategory\n      responseBody\n      status\n      messageCreatedAt\n      sentAt\n      deliveredAt\n      readAt\n      repliedAt\n      sourceId\n      sourceType\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListCampaignRunDatasQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListCampaignRunDatas";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListCampaignRunDatas($filter: ModelCampaignRunDataFilterInput, $limit: Int, $nextToken: String) {\n  listCampaignRunDatas(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      contactSource\n      campaignId\n      campaignRunId\n      engagementId\n      campaignOutputType\n      campaignOutputId\n      campaignResponseType\n      campaignResponseId\n      responseCategory\n      responseBody\n      status\n      messageCreatedAt\n      sentAt\n      deliveredAt\n      readAt\n      repliedAt\n      sourceId\n      sourceType\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public ListCampaignRunDatasQuery build() {
            return new ListCampaignRunDatasQuery(this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listCampaignRunDatas", "listCampaignRunDatas", new UnmodifiableMapBuilder(3).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListCampaignRunDatas listCampaignRunDatas;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListCampaignRunDatas.Mapper listCampaignRunDatasFieldMapper = new ListCampaignRunDatas.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListCampaignRunDatas) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListCampaignRunDatas>() { // from class: com.amazonaws.amplify.generated.graphql.ListCampaignRunDatasQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListCampaignRunDatas read(ResponseReader responseReader2) {
                        return Mapper.this.listCampaignRunDatasFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListCampaignRunDatas listCampaignRunDatas) {
            this.listCampaignRunDatas = listCampaignRunDatas;
        }
        ...
        public boolean equals(Object obj) {
            ...
            ListCampaignRunDatas listCampaignRunDatas = this.listCampaignRunDatas;
            ListCampaignRunDatas listCampaignRunDatas2 = ((Data) obj).listCampaignRunDatas;
            return listCampaignRunDatas == null ? listCampaignRunDatas2 == null : listCampaignRunDatas.equals(listCampaignRunDatas2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListCampaignRunDatas listCampaignRunDatas = this.listCampaignRunDatas;
                this.$hashCode = (listCampaignRunDatas == null ? 0 : listCampaignRunDatas.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListCampaignRunDatas listCampaignRunDatas() {
            return this.listCampaignRunDatas;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListCampaignRunDatasQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListCampaignRunDatas listCampaignRunDatas = Data.this.listCampaignRunDatas;
                    responseWriter.writeObject(responseField, listCampaignRunDatas != null ? listCampaignRunDatas.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listCampaignRunDatas=" + this.listCampaignRunDatas + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListCampaignRunDatasQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static class ListCampaignRunDatas {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListCampaignRunDatas> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListCampaignRunDatas map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListCampaignRunDatas.$responseFields;
                return new ListCampaignRunDatas(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListCampaignRunDatasQuery.ListCampaignRunDatas.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListCampaignRunDatasQuery.ListCampaignRunDatas.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListCampaignRunDatas(String str, List<Item> list, String str2) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListCampaignRunDatas)) {
                return false;
            }
            ListCampaignRunDatas listCampaignRunDatas = (ListCampaignRunDatas) obj;
            if (this.__typename.equals(listCampaignRunDatas.__typename) && this.items.equals(listCampaignRunDatas.items)) {
                String str = this.nextToken;
                String str2 = listCampaignRunDatas.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListCampaignRunDatasQuery.ListCampaignRunDatas.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListCampaignRunDatas.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListCampaignRunDatas.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListCampaignRunDatas.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListCampaignRunDatasQuery.ListCampaignRunDatas.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListCampaignRunDatas.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListCampaignRunDatas{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(ModelCampaignRunDataFilterInput modelCampaignRunDataFilterInput, Integer num, String str) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListCampaignRunDatasQuery.Variables.1
    ...
    public ListCampaignRunDatasQuery(ModelCampaignRunDataFilterInput modelCampaignRunDataFilterInput, Integer num, String str) {
        this.variables = new Variables(modelCampaignRunDataFilterInput, num, str);
    }
    ...
    public String operationId() {
        return "85bb011d4ff3bbfc39ded14a3e04638c690c6eb2d2acd47241eb6d0177dc0580";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListCampaignRunDatas($filter: ModelCampaignRunDataFilterInput, $limit: Int, $nextToken: String) {\n  listCampaignRunDatas(filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      contactId\n      contactSource\n      campaignId\n      campaignRunId\n      engagementId\n      campaignOutputType\n      campaignOutputId\n      campaignResponseType\n      campaignResponseId\n      responseCategory\n      responseBody\n      status\n      messageCreatedAt\n      sentAt\n      deliveredAt\n      readAt\n      repliedAt\n      sourceId\n      sourceType\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
