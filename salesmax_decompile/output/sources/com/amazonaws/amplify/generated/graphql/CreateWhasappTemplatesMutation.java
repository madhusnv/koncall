...
import type.CreateWhasappTemplatesInput;
import type.CustomType;
import type.HasParent;
import type.ModelWhasappTemplatesConditionInput;
import type.ScopeLevel;

/* loaded from: classes6.dex */
public final class CreateWhasappTemplatesMutation implements Mutation<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "mutation CreateWhasappTemplates($input: CreateWhasappTemplatesInput!, $condition: ModelWhasappTemplatesConditionInput) {\n  createWhasappTemplates(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "CreateWhasappTemplates";
        }
    };
    public static final String QUERY_DOCUMENT = "mutation CreateWhasappTemplates($input: CreateWhasappTemplatesInput!, $condition: ModelWhasappTemplatesConditionInput) {\n  createWhasappTemplates(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    ...
    public static class ActionInteractive {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.ActionInteractive.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], ActionInteractive.this.savedAddresses, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.ActionInteractive.1.1
    ...
    public static final class Builder {
        private ModelWhasappTemplatesConditionInput condition;
        private CreateWhasappTemplatesInput input;

        public CreateWhasappTemplatesMutation build() {
            Utils.checkNotNull(this.input, "input == null");
            return new CreateWhasappTemplatesMutation(this.input, this.condition);
        }

        public Builder condition(ModelWhasappTemplatesConditionInput modelWhasappTemplatesConditionInput) {
            this.condition = modelWhasappTemplatesConditionInput;
            return this;
        }

        public Builder input(CreateWhasappTemplatesInput createWhasappTemplatesInput) {
            this.input = createWhasappTemplatesInput;
            return this;
        }
    }
    ...
    public static class Component {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.Component.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
    ...
    public static class CreateWhasappTemplates {
        ...
        public static final class Mapper implements ResponseFieldMapper<CreateWhasappTemplates> {
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public CreateWhasappTemplates map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = CreateWhasappTemplates.$responseFields;
                return new CreateWhasappTemplates(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), responseReader.readString(responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), responseReader.readString(responseFieldArr[6]), responseReader.readString(responseFieldArr[7]), responseReader.readList(responseFieldArr[8], new ResponseReader.ListReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.CreateWhasappTemplates.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Component read(ResponseReader.ListItemReader listItemReader) {
                        return (Component) listItemReader.readObject(new ResponseReader.ObjectReader<Component>() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.CreateWhasappTemplates.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof CreateWhasappTemplates)) {
                return false;
            }
            CreateWhasappTemplates createWhasappTemplates = (CreateWhasappTemplates) obj;
            if (this.__typename.equals(createWhasappTemplates.__typename) && this.id.equals(createWhasappTemplates.id) && this.accountId.equals(createWhasappTemplates.accountId) && ((str = this.whatsappBusinessAccount) != null ? str.equals(createWhasappTemplates.whatsappBusinessAccount) : createWhasappTemplates.whatsappBusinessAccount == null) && ((str2 = this.templateType) != null ? str2.equals(createWhasappTemplates.templateType) : createWhasappTemplates.templateType == null) && ((str3 = this.snippetType) != null ? str3.equals(createWhasappTemplates.snippetType) : createWhasappTemplates.snippetType == null) && ((str4 = this.platform) != null ? str4.equals(createWhasappTemplates.platform) : createWhasappTemplates.platform == null) && ((str5 = this.name) != null ? str5.equals(createWhasappTemplates.name) : createWhasappTemplates.name == null) && ((list = this.components) != null ? list.equals(createWhasappTemplates.components) : createWhasappTemplates.components == null) && ((str6 = this.language) != null ? str6.equals(createWhasappTemplates.language) : createWhasappTemplates.language == null) && ((str7 = this.status) != null ? str7.equals(createWhasappTemplates.status) : createWhasappTemplates.status == null) && ((str8 = this.category) != null ? str8.equals(createWhasappTemplates.category) : createWhasappTemplates.category == null) && ((str9 = this.subCategory) != null ? str9.equals(createWhasappTemplates.subCategory) : createWhasappTemplates.subCategory == null) && ((str10 = this.snippetCategory) != null ? str10.equals(createWhasappTemplates.snippetCategory) : createWhasappTemplates.snippetCategory == null) && ((str11 = this.snippetSubCategory) != null ? str11.equals(createWhasappTemplates.snippetSubCategory) : createWhasappTemplates.snippetSubCategory == null) && ((str12 = this.createdBy) != null ? str12.equals(createWhasappTemplates.createdBy) : createWhasappTemplates.createdBy == null) && ((str13 = this.updatedBy) != null ? str13.equals(createWhasappTemplates.updatedBy) : createWhasappTemplates.updatedBy == null) && ((str14 = this.archivedStatus) != null ? str14.equals(createWhasappTemplates.archivedStatus) : createWhasappTemplates.archivedStatus == null) && ((str15 = this.archivedAt) != null ? str15.equals(createWhasappTemplates.archivedAt) : createWhasappTemplates.archivedAt == null) && ((str16 = this.defaultMediaId) != null ? str16.equals(createWhasappTemplates.defaultMediaId) : createWhasappTemplates.defaultMediaId == null) && ((list2 = this.defaultVariableMap) != null ? list2.equals(createWhasappTemplates.defaultVariableMap) : createWhasappTemplates.defaultVariableMap == null) && ((str17 = this.templateId) != null ? str17.equals(createWhasappTemplates.templateId) : createWhasappTemplates.templateId == null) && ((list3 = this.tags) != null ? list3.equals(createWhasappTemplates.tags) : createWhasappTemplates.tags == null) && ((bool = this.isSample) != null ? bool.equals(createWhasappTemplates.isSample) : createWhasappTemplates.isSample == null) && ((str18 = this.messageType) != null ? str18.equals(createWhasappTemplates.messageType) : createWhasappTemplates.messageType == null) && ((str19 = this.messageSubType) != null ? str19.equals(createWhasappTemplates.messageSubType) : createWhasappTemplates.messageSubType == null) && ((str20 = this.text) != null ? str20.equals(createWhasappTemplates.text) : createWhasappTemplates.text == null) && ((str21 = this.locationObjectToSend) != null ? str21.equals(createWhasappTemplates.locationObjectToSend) : createWhasappTemplates.locationObjectToSend == null) && ((str22 = this.headerText) != null ? str22.equals(createWhasappTemplates.headerText) : createWhasappTemplates.headerText == null) && ((str23 = this.footerText) != null ? str23.equals(createWhasappTemplates.footerText) : createWhasappTemplates.footerText == null) && ((str24 = this.headerType) != null ? str24.equals(createWhasappTemplates.headerType) : createWhasappTemplates.headerType == null) && ((actionInteractive = this.actionInteractive) != null ? actionInteractive.equals(createWhasappTemplates.actionInteractive) : createWhasappTemplates.actionInteractive == null) && ((str25 = this.messageTemplateQualityNew) != null ? str25.equals(createWhasappTemplates.messageTemplateQualityNew) : createWhasappTemplates.messageTemplateQualityNew == null) && ((str26 = this.messageTemplateQualityPrevious) != null ? str26.equals(createWhasappTemplates.messageTemplateQualityPrevious) : createWhasappTemplates.messageTemplateQualityPrevious == null) && ((str27 = this.messageTemplateQualityUpdatedAt) != null ? str27.equals(createWhasappTemplates.messageTemplateQualityUpdatedAt) : createWhasappTemplates.messageTemplateQualityUpdatedAt == null) && ((str28 = this.messageTemplateStatusUpdatedAt) != null ? str28.equals(createWhasappTemplates.messageTemplateStatusUpdatedAt) : createWhasappTemplates.messageTemplateStatusUpdatedAt == null) && ((str29 = this.stausUpdateReason) != null ? str29.equals(createWhasappTemplates.stausUpdateReason) : createWhasappTemplates.stausUpdateReason == null) && ((str30 = this.otherDetail) != null ? str30.equals(createWhasappTemplates.otherDetail) : createWhasappTemplates.otherDetail == null) && ((str31 = this.lastUsed) != null ? str31.equals(createWhasappTemplates.lastUsed) : createWhasappTemplates.lastUsed == null) && ((str32 = this.createdAt) != null ? str32.equals(createWhasappTemplates.createdAt) : createWhasappTemplates.createdAt == null) && ((str33 = this.updatedAt) != null ? str33.equals(createWhasappTemplates.updatedAt) : createWhasappTemplates.updatedAt == null)) {
                DefaultMedia defaultMedia = this.defaultMedia;
                DefaultMedia defaultMedia2 = createWhasappTemplates.defaultMedia;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.CreateWhasappTemplates.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = CreateWhasappTemplates.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], CreateWhasappTemplates.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], CreateWhasappTemplates.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], CreateWhasappTemplates.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], CreateWhasappTemplates.this.whatsappBusinessAccount);
                    responseWriter.writeString(responseFieldArr[4], CreateWhasappTemplates.this.templateType);
                    responseWriter.writeString(responseFieldArr[5], CreateWhasappTemplates.this.snippetType);
                    responseWriter.writeString(responseFieldArr[6], CreateWhasappTemplates.this.platform);
                    responseWriter.writeString(responseFieldArr[7], CreateWhasappTemplates.this.name);
                    responseWriter.writeList(responseFieldArr[8], CreateWhasappTemplates.this.components, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.CreateWhasappTemplates.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Component) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[9], CreateWhasappTemplates.this.language);
                    responseWriter.writeString(responseFieldArr[10], CreateWhasappTemplates.this.status);
                    responseWriter.writeString(responseFieldArr[11], CreateWhasappTemplates.this.category);
                    responseWriter.writeString(responseFieldArr[12], CreateWhasappTemplates.this.subCategory);
                    responseWriter.writeString(responseFieldArr[13], CreateWhasappTemplates.this.snippetCategory);
                    responseWriter.writeString(responseFieldArr[14], CreateWhasappTemplates.this.snippetSubCategory);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[15], CreateWhasappTemplates.this.createdBy);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[16], CreateWhasappTemplates.this.updatedBy);
                    responseWriter.writeString(responseFieldArr[17], CreateWhasappTemplates.this.archivedStatus);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], CreateWhasappTemplates.this.archivedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[19], CreateWhasappTemplates.this.defaultMediaId);
                    responseWriter.writeList(responseFieldArr[20], CreateWhasappTemplates.this.defaultVariableMap, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.CreateWhasappTemplates.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((DefaultVariableMap) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[21], CreateWhasappTemplates.this.templateId);
                    responseWriter.writeList(responseFieldArr[22], CreateWhasappTemplates.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.CreateWhasappTemplates.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeBoolean(responseFieldArr[23], CreateWhasappTemplates.this.isSample);
                    responseWriter.writeString(responseFieldArr[24], CreateWhasappTemplates.this.messageType);
                    responseWriter.writeString(responseFieldArr[25], CreateWhasappTemplates.this.messageSubType);
                    responseWriter.writeString(responseFieldArr[26], CreateWhasappTemplates.this.text);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[27], CreateWhasappTemplates.this.locationObjectToSend);
                    responseWriter.writeString(responseFieldArr[28], CreateWhasappTemplates.this.headerText);
                    responseWriter.writeString(responseFieldArr[29], CreateWhasappTemplates.this.footerText);
                    responseWriter.writeString(responseFieldArr[30], CreateWhasappTemplates.this.headerType);
                    ResponseField responseField = responseFieldArr[31];
                    ActionInteractive actionInteractive = CreateWhasappTemplates.this.actionInteractive;
                    responseWriter.writeObject(responseField, actionInteractive != null ? actionInteractive.marshaller() : null);
                    responseWriter.writeString(responseFieldArr[32], CreateWhasappTemplates.this.messageTemplateQualityNew);
                    responseWriter.writeString(responseFieldArr[33], CreateWhasappTemplates.this.messageTemplateQualityPrevious);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[34], CreateWhasappTemplates.this.messageTemplateQualityUpdatedAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[35], CreateWhasappTemplates.this.messageTemplateStatusUpdatedAt);
                    responseWriter.writeString(responseFieldArr[36], CreateWhasappTemplates.this.stausUpdateReason);
                    responseWriter.writeString(responseFieldArr[37], CreateWhasappTemplates.this.otherDetail);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[38], CreateWhasappTemplates.this.lastUsed);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[39], CreateWhasappTemplates.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[40], CreateWhasappTemplates.this.updatedAt);
                    ResponseField responseField2 = responseFieldArr[41];
                    DefaultMedia defaultMedia = CreateWhasappTemplates.this.defaultMedia;
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("createWhasappTemplates", "createWhasappTemplates", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final CreateWhasappTemplates createWhasappTemplates;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final CreateWhasappTemplates.Mapper createWhasappTemplatesFieldMapper = new CreateWhasappTemplates.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((CreateWhasappTemplates) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<CreateWhasappTemplates>() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public CreateWhasappTemplates read(ResponseReader responseReader2) {
                        return Mapper.this.createWhasappTemplatesFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(CreateWhasappTemplates createWhasappTemplates) {
            this.createWhasappTemplates = createWhasappTemplates;
        }

        public CreateWhasappTemplates createWhasappTemplates() {
            return this.createWhasappTemplates;
        }
        ...
        public boolean equals(Object obj) {
            ...
            CreateWhasappTemplates createWhasappTemplates = this.createWhasappTemplates;
            CreateWhasappTemplates createWhasappTemplates2 = ((Data) obj).createWhasappTemplates;
            return createWhasappTemplates == null ? createWhasappTemplates2 == null : createWhasappTemplates.equals(createWhasappTemplates2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                CreateWhasappTemplates createWhasappTemplates = this.createWhasappTemplates;
                this.$hashCode = (createWhasappTemplates == null ? 0 : createWhasappTemplates.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    CreateWhasappTemplates createWhasappTemplates = Data.this.createWhasappTemplates;
                    responseWriter.writeObject(responseField, createWhasappTemplates != null ? createWhasappTemplates.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{createWhasappTemplates=" + this.createWhasappTemplates + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class DefaultMedia {
        ...
        public static final class Mapper implements ResponseFieldMapper<DefaultMedia> {
            ...
            public DefaultMedia map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[9], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.DefaultMedia.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.DefaultMedia.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultMedia.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[9], DefaultMedia.this.tags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.DefaultMedia.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
    ...
    public static class DefaultVariableMap {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.DefaultVariableMap.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DefaultVariableMap.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        private final ModelWhasappTemplatesConditionInput condition;
        private final CreateWhasappTemplatesInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(CreateWhasappTemplatesInput createWhasappTemplatesInput, ModelWhasappTemplatesConditionInput modelWhasappTemplatesConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = createWhasappTemplatesInput;
            this.condition = modelWhasappTemplatesConditionInput;
            linkedHashMap.put("input", createWhasappTemplatesInput);
            linkedHashMap.put("condition", modelWhasappTemplatesConditionInput);
        }

        public ModelWhasappTemplatesConditionInput condition() {
            return this.condition;
        }

        public CreateWhasappTemplatesInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.CreateWhasappTemplatesMutation.Variables.1
    ...
    public CreateWhasappTemplatesMutation(CreateWhasappTemplatesInput createWhasappTemplatesInput, ModelWhasappTemplatesConditionInput modelWhasappTemplatesConditionInput) {
        Utils.checkNotNull(createWhasappTemplatesInput, "input == null");
        this.variables = new Variables(createWhasappTemplatesInput, modelWhasappTemplatesConditionInput);
    }
    ...
    public String operationId() {
        return "76de548255993fd17bb7e27946d619e761b1a07cf687a69bd2551663d5babf4b";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation CreateWhasappTemplates($input: CreateWhasappTemplatesInput!, $condition: ModelWhasappTemplatesConditionInput) {\n  createWhasappTemplates(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    whatsappBusinessAccount\n    templateType\n    snippetType\n    platform\n    name\n    components {\n      __typename\n    }\n    language\n    status\n    category\n    subCategory\n    snippetCategory\n    snippetSubCategory\n    createdBy\n    updatedBy\n    archivedStatus\n    archivedAt\n    defaultMediaId\n    defaultVariableMap {\n      __typename\n      taType\n      variableId\n      mappedObject\n      mappedProperty\n      fallBackValue\n      sampleValue\n      index\n      sub_type\n    }\n    templateId\n    tags\n    isSample\n    messageType\n    messageSubType\n    text\n    locationObjectToSend\n    headerText\n    footerText\n    headerType\n    actionInteractive {\n      __typename\n      actionName\n      display_text\n      ctaUrl\n      addressCountry\n      savedAddresses\n      button\n      catalog_id\n      product_retailer_id\n      flow_mode\n      flow_message_version\n      flow_token\n      flow_id\n      flow_cta\n      flow_action\n    }\n    messageTemplateQualityNew\n    messageTemplateQualityPrevious\n    messageTemplateQualityUpdatedAt\n    messageTemplateStatusUpdatedAt\n    stausUpdateReason\n    otherDetail\n    lastUsed\n    createdAt\n    updatedAt\n    defaultMedia {\n      __typename\n      id\n      accountId\n      fileUrl\n      fileStorageDestination\n      fileName\n      description\n      documentCategory\n      documentSubCategory\n      tags\n      templateType\n      templateTitle\n      templateBody\n      templateLastUsed\n      templateExternalLink\n      uploadSource\n      fileMetaData\n      fileMimeType\n      fileThumbnailUrl\n      hasParent\n      parentFileId\n      scopeLevel\n      scopeId\n      uploadedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
