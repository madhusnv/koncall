...
public final class ListAllActivitiesByContactQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query ListAllActivitiesByContact($contactId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelActivityFilterInput, $limit: Int, $nextToken: String) {\n  listAllActivitiesByContact(contactId: $contactId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      threadId\n      accountId\n      activityRelatedObjectType\n      activityRelatedObjectId\n      activityCategory\n      activityType\n      body\n      note\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      createdAt\n      updatedAt\n    }\n    nextToken\n    startedAt\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.ListAllActivitiesByContactQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "ListAllActivitiesByContact";
        }
    };
    public static final String QUERY_DOCUMENT = "query ListAllActivitiesByContact($contactId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelActivityFilterInput, $limit: Int, $nextToken: String) {\n  listAllActivitiesByContact(contactId: $contactId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      threadId\n      accountId\n      activityRelatedObjectType\n      activityRelatedObjectId\n      activityCategory\n      activityType\n      body\n      note\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      createdAt\n      updatedAt\n    }\n    nextToken\n    startedAt\n  }\n}";
    ...
    public static final class Builder {
        ...
        public ListAllActivitiesByContactQuery build() {
            return new ListAllActivitiesByContactQuery(this.contactId, this.updatedAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("listAllActivitiesByContact", "listAllActivitiesByContact", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put("contactId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "contactId").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("updatedAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "updatedAt").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final ListAllActivitiesByContact listAllActivitiesByContact;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final ListAllActivitiesByContact.Mapper listAllActivitiesByContactFieldMapper = new ListAllActivitiesByContact.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((ListAllActivitiesByContact) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<ListAllActivitiesByContact>() { // from class: com.amazonaws.amplify.generated.graphql.ListAllActivitiesByContactQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public ListAllActivitiesByContact read(ResponseReader responseReader2) {
                        return Mapper.this.listAllActivitiesByContactFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(ListAllActivitiesByContact listAllActivitiesByContact) {
            this.listAllActivitiesByContact = listAllActivitiesByContact;
        }
        ...
        public boolean equals(Object obj) {
            ...
            ListAllActivitiesByContact listAllActivitiesByContact = this.listAllActivitiesByContact;
            ListAllActivitiesByContact listAllActivitiesByContact2 = ((Data) obj).listAllActivitiesByContact;
            return listAllActivitiesByContact == null ? listAllActivitiesByContact2 == null : listAllActivitiesByContact.equals(listAllActivitiesByContact2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                ListAllActivitiesByContact listAllActivitiesByContact = this.listAllActivitiesByContact;
                this.$hashCode = (listAllActivitiesByContact == null ? 0 : listAllActivitiesByContact.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }

        public ListAllActivitiesByContact listAllActivitiesByContact() {
            return this.listAllActivitiesByContact;
        }

        @Override // com.apollographql.apollo.api.Operation.Data
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListAllActivitiesByContactQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    ListAllActivitiesByContact listAllActivitiesByContact = Data.this.listAllActivitiesByContact;
                    responseWriter.writeObject(responseField, listAllActivitiesByContact != null ? listAllActivitiesByContact.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{listAllActivitiesByContact=" + this.listAllActivitiesByContact + "}";
            }
    ...
    public static class Item {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListAllActivitiesByContactQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
    ...
    public static class ListAllActivitiesByContact {
        ...
        public static final class Mapper implements ResponseFieldMapper<ListAllActivitiesByContact> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public ListAllActivitiesByContact map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = ListAllActivitiesByContact.$responseFields;
                return new ListAllActivitiesByContact(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListAllActivitiesByContactQuery.ListAllActivitiesByContact.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.ListAllActivitiesByContactQuery.ListAllActivitiesByContact.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public ListAllActivitiesByContact(String str, List<Item> list, String str2, Long l) {
            this.__typename = (String) Utils.checkNotNull(str, "__typename == null");
            this.items = list;
            this.nextToken = str2;
            this.startedAt = l;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ListAllActivitiesByContact)) {
                return false;
            }
            ListAllActivitiesByContact listAllActivitiesByContact = (ListAllActivitiesByContact) obj;
            if (this.__typename.equals(listAllActivitiesByContact.__typename) && ((list = this.items) != null ? list.equals(listAllActivitiesByContact.items) : listAllActivitiesByContact.items == null) && ((str = this.nextToken) != null ? str.equals(listAllActivitiesByContact.nextToken) : listAllActivitiesByContact.nextToken == null)) {
                Long l = this.startedAt;
                Long l2 = listAllActivitiesByContact.startedAt;
                if (l == null) {
                    if (l2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListAllActivitiesByContactQuery.ListAllActivitiesByContact.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = ListAllActivitiesByContact.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], ListAllActivitiesByContact.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], ListAllActivitiesByContact.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.ListAllActivitiesByContactQuery.ListAllActivitiesByContact.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], ListAllActivitiesByContact.this.nextToken);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], ListAllActivitiesByContact.this.startedAt);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "ListAllActivitiesByContact{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + ", startedAt=" + this.startedAt + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelActivityFilterInput modelActivityFilterInput, Integer num, String str2) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.ListAllActivitiesByContactQuery.Variables.1
    ...
    public ListAllActivitiesByContactQuery(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelActivityFilterInput modelActivityFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelStringKeyConditionInput, modelSortDirection, modelActivityFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "da476c9f37d72f3d5a5aa41b332618271d691f0164ab0ba75d08083a66e18d98";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query ListAllActivitiesByContact($contactId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelActivityFilterInput, $limit: Int, $nextToken: String) {\n  listAllActivitiesByContact(contactId: $contactId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      threadId\n      accountId\n      activityRelatedObjectType\n      activityRelatedObjectId\n      activityCategory\n      activityType\n      body\n      note\n      ownerId\n      primaryTeamId\n      contactId\n      activityDoneByUserId\n      createdAt\n      updatedAt\n    }\n    nextToken\n    startedAt\n  }\n}";
    }
