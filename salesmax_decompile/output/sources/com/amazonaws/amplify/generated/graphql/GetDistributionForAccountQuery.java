...
public final class GetDistributionForAccountQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetDistributionForAccount($accountId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelDistributionDefinitionFilterInput, $limit: Int, $nextToken: String) {\n  getDistributionForAccount(accountId: $accountId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      name\n      description\n      distributedEntityType\n      ifOwnerExists\n      assignLeadOwnerToTask\n      remeberAssigneeInDistributionScope\n      remeberAssigneeInGlobalScope\n      ownerId\n      distributionCreationType\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetDistributionForAccountQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetDistributionForAccount";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetDistributionForAccount($accountId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelDistributionDefinitionFilterInput, $limit: Int, $nextToken: String) {\n  getDistributionForAccount(accountId: $accountId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      name\n      description\n      distributedEntityType\n      ifOwnerExists\n      assignLeadOwnerToTask\n      remeberAssigneeInDistributionScope\n      remeberAssigneeInGlobalScope\n      ownerId\n      distributionCreationType\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetDistributionForAccountQuery build() {
            return new GetDistributionForAccountQuery(this.accountId, this.updatedAt, this.sortDirection, this.filter, this.limit, this.nextToken);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getDistributionForAccount", "getDistributionForAccount", new UnmodifiableMapBuilder(6).put("filter", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "filter").build()).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("sortDirection", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "sortDirection").build()).put(LazyTypeDeserializersKt.NEXT_TOKEN_KEY, new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, LazyTypeDeserializersKt.NEXT_TOKEN_KEY).build()).put("limit", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "limit").build()).put("updatedAt", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "updatedAt").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetDistributionForAccount getDistributionForAccount;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetDistributionForAccount.Mapper getDistributionForAccountFieldMapper = new GetDistributionForAccount.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetDistributionForAccount) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetDistributionForAccount>() { // from class: com.amazonaws.amplify.generated.graphql.GetDistributionForAccountQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetDistributionForAccount read(ResponseReader responseReader2) {
                        return Mapper.this.getDistributionForAccountFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetDistributionForAccount getDistributionForAccount) {
            this.getDistributionForAccount = getDistributionForAccount;
        }
        ...
        public boolean equals(Object obj) {
            ...
            GetDistributionForAccount getDistributionForAccount = this.getDistributionForAccount;
            GetDistributionForAccount getDistributionForAccount2 = ((Data) obj).getDistributionForAccount;
            return getDistributionForAccount == null ? getDistributionForAccount2 == null : getDistributionForAccount.equals(getDistributionForAccount2);
        }

        public GetDistributionForAccount getDistributionForAccount() {
            return this.getDistributionForAccount;
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetDistributionForAccount getDistributionForAccount = this.getDistributionForAccount;
                this.$hashCode = (getDistributionForAccount == null ? 0 : getDistributionForAccount.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetDistributionForAccountQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetDistributionForAccount getDistributionForAccount = Data.this.getDistributionForAccount;
                    responseWriter.writeObject(responseField, getDistributionForAccount != null ? getDistributionForAccount.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getDistributionForAccount=" + this.getDistributionForAccount + "}";
            }
            return this.$toString;
        }
    }

    public static class GetDistributionForAccount {
        ...
        public static final class Mapper implements ResponseFieldMapper<GetDistributionForAccount> {
            final Item.Mapper itemFieldMapper = new Item.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public GetDistributionForAccount map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = GetDistributionForAccount.$responseFields;
                return new GetDistributionForAccount(responseReader.readString(responseFieldArr[0]), responseReader.readList(responseFieldArr[1], new ResponseReader.ListReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetDistributionForAccountQuery.GetDistributionForAccount.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public Item read(ResponseReader.ListItemReader listItemReader) {
                        return (Item) listItemReader.readObject(new ResponseReader.ObjectReader<Item>() { // from class: com.amazonaws.amplify.generated.graphql.GetDistributionForAccountQuery.GetDistributionForAccount.Mapper.1.1
                            /* JADX WARN: Can't rename method to resolve collision */
                            @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public GetDistributionForAccount(String str, List<Item> list, String str2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetDistributionForAccount)) {
                return false;
            }
            GetDistributionForAccount getDistributionForAccount = (GetDistributionForAccount) obj;
            if (this.__typename.equals(getDistributionForAccount.__typename) && this.items.equals(getDistributionForAccount.items)) {
                String str = this.nextToken;
                String str2 = getDistributionForAccount.nextToken;
                if (str == null) {
                    if (str2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetDistributionForAccountQuery.GetDistributionForAccount.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetDistributionForAccount.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetDistributionForAccount.this.__typename);
                    responseWriter.writeList(responseFieldArr[1], GetDistributionForAccount.this.items, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetDistributionForAccountQuery.GetDistributionForAccount.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeObject(((Item) obj).marshaller());
                        }
                    });
                    responseWriter.writeString(responseFieldArr[2], GetDistributionForAccount.this.nextToken);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetDistributionForAccount{__typename=" + this.__typename + ", items=" + this.items + ", nextToken=" + this.nextToken + "}";
            }
            return this.$toString;
        }
    }
    ...
    public static class Item {
        ...
        public static final class Mapper implements ResponseFieldMapper<Item> {
            ...
            public Item map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[5], new ResponseReader.ListReader<DistributedEntityType>() { // from class: com.amazonaws.amplify.generated.graphql.GetDistributionForAccountQuery.Item.Mapper.1
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetDistributionForAccountQuery.Item.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = Item.$responseFields;
                    ...
                    responseWriter.writeList(responseFieldArr[5], Item.this.distributedEntityType, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.GetDistributionForAccountQuery.Item.1.1
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelDistributionDefinitionFilterInput modelDistributionDefinitionFilterInput, Integer num, String str2) {
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetDistributionForAccountQuery.Variables.1
    ...
    public GetDistributionForAccountQuery(String str, ModelStringKeyConditionInput modelStringKeyConditionInput, ModelSortDirection modelSortDirection, ModelDistributionDefinitionFilterInput modelDistributionDefinitionFilterInput, Integer num, String str2) {
        this.variables = new Variables(str, modelStringKeyConditionInput, modelSortDirection, modelDistributionDefinitionFilterInput, num, str2);
    }
    ...
    public String operationId() {
        return "88c867b68989fdbe1e7ce252b8381ac6dd6367d0448562b8b04ede5cd1f6a385";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetDistributionForAccount($accountId: ID, $updatedAt: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelDistributionDefinitionFilterInput, $limit: Int, $nextToken: String) {\n  getDistributionForAccount(accountId: $accountId, updatedAt: $updatedAt, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      accountId\n      name\n      description\n      distributedEntityType\n      ifOwnerExists\n      assignLeadOwnerToTask\n      remeberAssigneeInDistributionScope\n      remeberAssigneeInGlobalScope\n      ownerId\n      distributionCreationType\n      createdAt\n      updatedAt\n    }\n    nextToken\n  }\n}";
    }
