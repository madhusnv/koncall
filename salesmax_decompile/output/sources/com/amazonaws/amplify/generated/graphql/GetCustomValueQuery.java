...
public final class GetCustomValueQuery implements Query<Data, Data, Variables> {
    public static final String OPERATION_DEFINITION = "query GetCustomValue($accountId: ID!, $parentObjectId: ID!, $propertyDefinitionId: ID!) {\n  getCustomValue(accountId: $accountId, parentObjectId: $parentObjectId, propertyDefinitionId: $propertyDefinitionId) {\n    __typename\n    propertyDefinitionId\n    accountId\n    parentObjectId\n    parentObjectType\n    value\n    createSourceId\n    createSourceType\n    createdAt\n    updatedAt\n    propertyDefinition {\n      __typename\n      id\n      accountId\n      propertyName\n      displayName\n      description\n      scalarType\n      dataType\n      isMultiple\n      parentObjectType\n      isSystemProperty\n      isArchived\n      displayOrder\n      createdById\n      updaedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.GetCustomValueQuery.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "GetCustomValue";
        }
    };
    public static final String QUERY_DOCUMENT = "query GetCustomValue($accountId: ID!, $parentObjectId: ID!, $propertyDefinitionId: ID!) {\n  getCustomValue(accountId: $accountId, parentObjectId: $parentObjectId, propertyDefinitionId: $propertyDefinitionId) {\n    __typename\n    propertyDefinitionId\n    accountId\n    parentObjectId\n    parentObjectType\n    value\n    createSourceId\n    createSourceType\n    createdAt\n    updatedAt\n    propertyDefinition {\n      __typename\n      id\n      accountId\n      propertyName\n      displayName\n      description\n      scalarType\n      dataType\n      isMultiple\n      parentObjectType\n      isSystemProperty\n      isArchived\n      displayOrder\n      createdById\n      updaedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    ...
    public static final class Builder {
        ...
        public GetCustomValueQuery build() {
            ...
            return new GetCustomValueQuery(this.accountId, this.parentObjectId, this.propertyDefinitionId);
        }
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("getCustomValue", "getCustomValue", new UnmodifiableMapBuilder(3).put("accountId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "accountId").build()).put("parentObjectId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "parentObjectId").build()).put("propertyDefinitionId", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "propertyDefinitionId").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final GetCustomValue getCustomValue;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final GetCustomValue.Mapper getCustomValueFieldMapper = new GetCustomValue.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((GetCustomValue) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<GetCustomValue>() { // from class: com.amazonaws.amplify.generated.graphql.GetCustomValueQuery.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public GetCustomValue read(ResponseReader responseReader2) {
                        return Mapper.this.getCustomValueFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(GetCustomValue getCustomValue) {
        ...
        public boolean equals(Object obj) {
            ...
            GetCustomValue getCustomValue = this.getCustomValue;
            GetCustomValue getCustomValue2 = ((Data) obj).getCustomValue;
            return getCustomValue == null ? getCustomValue2 == null : getCustomValue.equals(getCustomValue2);
        }

        public GetCustomValue getCustomValue() {
        ...
        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                GetCustomValue getCustomValue = this.getCustomValue;
                this.$hashCode = (getCustomValue == null ? 0 : getCustomValue.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCustomValueQuery.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    GetCustomValue getCustomValue = Data.this.getCustomValue;
                    responseWriter.writeObject(responseField, getCustomValue != null ? getCustomValue.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{getCustomValue=" + this.getCustomValue + "}";
            }
            return this.$toString;
        }
    }

    public static class GetCustomValue {
        ...
        public GetCustomValue(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, PropertyDefinition propertyDefinition) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof GetCustomValue)) {
                return false;
            }
            GetCustomValue getCustomValue = (GetCustomValue) obj;
            if (this.__typename.equals(getCustomValue.__typename) && this.propertyDefinitionId.equals(getCustomValue.propertyDefinitionId) && this.accountId.equals(getCustomValue.accountId) && this.parentObjectId.equals(getCustomValue.parentObjectId) && ((str = this.parentObjectType) != null ? str.equals(getCustomValue.parentObjectType) : getCustomValue.parentObjectType == null) && this.value.equals(getCustomValue.value) && ((str2 = this.createSourceId) != null ? str2.equals(getCustomValue.createSourceId) : getCustomValue.createSourceId == null) && ((str3 = this.createSourceType) != null ? str3.equals(getCustomValue.createSourceType) : getCustomValue.createSourceType == null) && ((str4 = this.createdAt) != null ? str4.equals(getCustomValue.createdAt) : getCustomValue.createdAt == null) && ((str5 = this.updatedAt) != null ? str5.equals(getCustomValue.updatedAt) : getCustomValue.updatedAt == null)) {
                PropertyDefinition propertyDefinition = this.propertyDefinition;
                PropertyDefinition propertyDefinition2 = getCustomValue.propertyDefinition;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCustomValueQuery.GetCustomValue.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = GetCustomValue.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], GetCustomValue.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], GetCustomValue.this.propertyDefinitionId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], GetCustomValue.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], GetCustomValue.this.parentObjectId);
                    responseWriter.writeString(responseFieldArr[4], GetCustomValue.this.parentObjectType);
                    responseWriter.writeString(responseFieldArr[5], GetCustomValue.this.value);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], GetCustomValue.this.createSourceId);
                    responseWriter.writeString(responseFieldArr[7], GetCustomValue.this.createSourceType);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], GetCustomValue.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], GetCustomValue.this.updatedAt);
                    ResponseField responseField = responseFieldArr[10];
                    PropertyDefinition propertyDefinition = GetCustomValue.this.propertyDefinition;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "GetCustomValue{__typename=" + this.__typename + ", propertyDefinitionId=" + this.propertyDefinitionId + ", accountId=" + this.accountId + ", parentObjectId=" + this.parentObjectId + ", parentObjectType=" + this.parentObjectType + ", value=" + this.value + ", createSourceId=" + this.createSourceId + ", createSourceType=" + this.createSourceType + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", propertyDefinition=" + this.propertyDefinition + "}";
            }
            return this.$toString;
        }
    ...
    public static class PropertyDefinition {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCustomValueQuery.PropertyDefinition.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = PropertyDefinition.$responseFields;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        public Variables(String str, String str2, String str3) {
            ...
            linkedHashMap.put("parentObjectId", str2);
            linkedHashMap.put("propertyDefinitionId", str3);
        }
        ...
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.GetCustomValueQuery.Variables.1
                @Override // com.apollographql.apollo.api.InputFieldMarshaller
                public void marshal(InputFieldWriter inputFieldWriter) {
                    inputFieldWriter.writeString("accountId", Variables.this.accountId);
                    inputFieldWriter.writeString("parentObjectId", Variables.this.parentObjectId);
                    inputFieldWriter.writeString("propertyDefinitionId", Variables.this.propertyDefinitionId);
                }
            };
        }
    ...
    public GetCustomValueQuery(String str, String str2, String str3) {
        Utils.checkNotNull(str, "accountId == null");
        Utils.checkNotNull(str2, "parentObjectId == null");
        Utils.checkNotNull(str3, "propertyDefinitionId == null");
    ...
    public String operationId() {
        return "a99a0d2e61dac880c6a38b2c45373f2453f836db8db2dba50ceb5afc70544a32";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "query GetCustomValue($accountId: ID!, $parentObjectId: ID!, $propertyDefinitionId: ID!) {\n  getCustomValue(accountId: $accountId, parentObjectId: $parentObjectId, propertyDefinitionId: $propertyDefinitionId) {\n    __typename\n    propertyDefinitionId\n    accountId\n    parentObjectId\n    parentObjectType\n    value\n    createSourceId\n    createSourceType\n    createdAt\n    updatedAt\n    propertyDefinition {\n      __typename\n      id\n      accountId\n      propertyName\n      displayName\n      description\n      scalarType\n      dataType\n      isMultiple\n      parentObjectType\n      isSystemProperty\n      isArchived\n      displayOrder\n      createdById\n      updaedById\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
