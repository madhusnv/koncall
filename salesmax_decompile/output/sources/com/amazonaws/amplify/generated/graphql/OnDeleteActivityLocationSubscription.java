...
public final class OnDeleteActivityLocationSubscription implements Subscription<Data, Data, Operation.Variables> {
    public static final String OPERATION_DEFINITION = "subscription OnDeleteActivityLocation {\n  onDeleteActivityLocation {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private static final OperationName OPERATION_NAME = new OperationName() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteActivityLocationSubscription.1
        @Override // com.apollographql.apollo.api.OperationName
        public String name() {
            return "OnDeleteActivityLocation";
        }
    };
    public static final String QUERY_DOCUMENT = "subscription OnDeleteActivityLocation {\n  onDeleteActivityLocation {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    private final Operation.Variables variables = Operation.EMPTY_VARIABLES;

    public static final class Builder {
        public OnDeleteActivityLocationSubscription build() {
            return new OnDeleteActivityLocationSubscription();
        }
    }

    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("onDeleteActivityLocation", "onDeleteActivityLocation", null, true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final OnDeleteActivityLocation onDeleteActivityLocation;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final OnDeleteActivityLocation.Mapper onDeleteActivityLocationFieldMapper = new OnDeleteActivityLocation.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((OnDeleteActivityLocation) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<OnDeleteActivityLocation>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteActivityLocationSubscription.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public OnDeleteActivityLocation read(ResponseReader responseReader2) {
                        return Mapper.this.onDeleteActivityLocationFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(OnDeleteActivityLocation onDeleteActivityLocation) {
            this.onDeleteActivityLocation = onDeleteActivityLocation;
        }
        ...
        public boolean equals(Object obj) {
            ...
            OnDeleteActivityLocation onDeleteActivityLocation = this.onDeleteActivityLocation;
            OnDeleteActivityLocation onDeleteActivityLocation2 = ((Data) obj).onDeleteActivityLocation;
            return onDeleteActivityLocation == null ? onDeleteActivityLocation2 == null : onDeleteActivityLocation.equals(onDeleteActivityLocation2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                OnDeleteActivityLocation onDeleteActivityLocation = this.onDeleteActivityLocation;
                this.$hashCode = (onDeleteActivityLocation == null ? 0 : onDeleteActivityLocation.hashCode()) ^ 1000003;
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteActivityLocationSubscription.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    OnDeleteActivityLocation onDeleteActivityLocation = Data.this.onDeleteActivityLocation;
                    responseWriter.writeObject(responseField, onDeleteActivityLocation != null ? onDeleteActivityLocation.marshaller() : null);
                }
            };
        }

        public OnDeleteActivityLocation onDeleteActivityLocation() {
            return this.onDeleteActivityLocation;
        }

        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{onDeleteActivityLocation=" + this.onDeleteActivityLocation + "}";
            }
            return this.$toString;
        }
    }

    public static class OnDeleteActivityLocation {
        ...
        public static final class Mapper implements ResponseFieldMapper<OnDeleteActivityLocation> {
            final User.Mapper userFieldMapper = new User.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public OnDeleteActivityLocation map(ResponseReader responseReader) {
                ResponseField[] responseFieldArr = OnDeleteActivityLocation.$responseFields;
                return new OnDeleteActivityLocation(responseReader.readString(responseFieldArr[0]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[1]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[2]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[3]), responseReader.readString(responseFieldArr[4]), responseReader.readString(responseFieldArr[5]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[6]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[7]), (String) responseReader.readCustomType((ResponseField.CustomTypeField) responseFieldArr[8]), (User) responseReader.readObject(responseFieldArr[9], new ResponseReader.ObjectReader<User>() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteActivityLocationSubscription.OnDeleteActivityLocation.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
        ...
        public OnDeleteActivityLocation(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, User user) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof OnDeleteActivityLocation)) {
                return false;
            }
            OnDeleteActivityLocation onDeleteActivityLocation = (OnDeleteActivityLocation) obj;
            if (this.__typename.equals(onDeleteActivityLocation.__typename) && this.id.equals(onDeleteActivityLocation.id) && this.accountId.equals(onDeleteActivityLocation.accountId) && ((str = this.engagementId) != null ? str.equals(onDeleteActivityLocation.engagementId) : onDeleteActivityLocation.engagementId == null) && ((str2 = this.lat) != null ? str2.equals(onDeleteActivityLocation.lat) : onDeleteActivityLocation.lat == null) && ((str3 = this.lng) != null ? str3.equals(onDeleteActivityLocation.lng) : onDeleteActivityLocation.lng == null) && this.ownerId.equals(onDeleteActivityLocation.ownerId) && ((str4 = this.createdAt) != null ? str4.equals(onDeleteActivityLocation.createdAt) : onDeleteActivityLocation.createdAt == null) && ((str5 = this.updatedAt) != null ? str5.equals(onDeleteActivityLocation.updatedAt) : onDeleteActivityLocation.updatedAt == null)) {
                User user = this.user;
                User user2 = onDeleteActivityLocation.user;
                if (user == null) {
                    if (user2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteActivityLocationSubscription.OnDeleteActivityLocation.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = OnDeleteActivityLocation.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], OnDeleteActivityLocation.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], OnDeleteActivityLocation.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], OnDeleteActivityLocation.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], OnDeleteActivityLocation.this.engagementId);
                    responseWriter.writeString(responseFieldArr[4], OnDeleteActivityLocation.this.lat);
                    responseWriter.writeString(responseFieldArr[5], OnDeleteActivityLocation.this.lng);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[6], OnDeleteActivityLocation.this.ownerId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[7], OnDeleteActivityLocation.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[8], OnDeleteActivityLocation.this.updatedAt);
                    ResponseField responseField = responseFieldArr[9];
                    User user = OnDeleteActivityLocation.this.user;
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "OnDeleteActivityLocation{__typename=" + this.__typename + ", id=" + this.id + ", accountId=" + this.accountId + ", engagementId=" + this.engagementId + ", lat=" + this.lat + ", lng=" + this.lng + ", ownerId=" + this.ownerId + ", createdAt=" + this.createdAt + ", updatedAt=" + this.updatedAt + ", user=" + this.user + "}";
            }
            return this.$toString;
        }
    ...
    public static class User {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.OnDeleteActivityLocationSubscription.User.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = User.$responseFields;
    ...
    public String operationId() {
        return "a74138a219ea394041962e35f71797c0c0ff693daf4cea991fc0b8bed0015f4e";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "subscription OnDeleteActivityLocation {\n  onDeleteActivityLocation {\n    __typename\n    id\n    accountId\n    engagementId\n    lat\n    lng\n    ownerId\n    createdAt\n    updatedAt\n    user {\n      __typename\n      id\n      addedSourceType\n      name\n      profilePictureUrl\n      registeredEmail\n      registeredEmailVerified\n      registeredNumber\n      registeredNumberVerified\n      secondaryNumber\n      secondaryNumberVerified\n      userRegistrationStatus\n      lastSelectedAccountWeb\n      lastSelectedAccountApp\n      appVersion\n      deviceModel\n      deviceManufacturer\n      androidVersionRelease\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
