...
import type.Day;
import type.DeleteCloudCallWebhookEventsInput;
...
public final class DeleteCloudCallWebhookEventsMutation implements Mutation<Data, Data, Variables> {
    ...
    public static final class Builder {
        ...
        public Builder input(DeleteCloudCallWebhookEventsInput deleteCloudCallWebhookEventsInput) {
            this.input = deleteCloudCallWebhookEventsInput;
            return this;
        }
    }
    ...
    public static class Contact {
        ...
        public static final class Mapper implements ResponseFieldMapper<Contact> {
            ...
            public Contact map(ResponseReader responseReader) {
                ...
                List list = responseReader.readList(responseFieldArr[5], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Contact.Mapper.1
                ...
                List list2 = responseReader.readList(responseFieldArr[7], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Contact.Mapper.2
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return (String) listItemReader.readCustomType(CustomType.ID);
                    }
                ...
                List list3 = responseReader.readList(responseFieldArr[34], new ResponseReader.ListReader<Day>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Contact.Mapper.3
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                ...
                List list4 = responseReader.readList(responseFieldArr[92], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Contact.Mapper.4
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                });
                List list5 = responseReader.readList(responseFieldArr[93], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Contact.Mapper.5
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
                        return listItemReader.readString();
                    }
                ...
                List list6 = responseReader.readList(responseFieldArr[97], new ResponseReader.ListReader<String>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Contact.Mapper.6
                    @Override // com.apollographql.apollo.api.ResponseReader.ListReader
                    public String read(ResponseReader.ListItemReader listItemReader) {
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Contact.1
                ...
                public void marshal(ResponseWriter responseWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[5], Contact.this.sharedOwners, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Contact.1.1
                    ...
                    responseWriter.writeList(responseFieldArr[7], Contact.this.sharedTeams, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Contact.1.2
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeCustom(CustomType.ID, obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[34], Contact.this.preferredContactDays, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Contact.1.3
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                    ...
                    responseWriter.writeList(responseFieldArr[92], Contact.this.userDefinedTags, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Contact.1.4
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    });
                    responseWriter.writeList(responseFieldArr[93], Contact.this.productService, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Contact.1.5
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
                            listItemWriter.writeString(obj);
                        }
                    ...
                    responseWriter.writeList(responseFieldArr[97], Contact.this.recentEngagements, new ResponseWriter.ListWriter() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Contact.1.6
                        @Override // com.apollographql.apollo.api.ResponseWriter.ListWriter
                        public void write(Object obj, ResponseWriter.ListItemWriter listItemWriter) {
    ...
    public static class Data implements Operation.Data {
        static final ResponseField[] $responseFields = {ResponseField.forObject("deleteCloudCallWebhookEvents", "deleteCloudCallWebhookEvents", new UnmodifiableMapBuilder(2).put("input", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "input").build()).put("condition", new UnmodifiableMapBuilder(2).put(ResponseField.VARIABLE_IDENTIFIER_KEY, ResponseField.VARIABLE_IDENTIFIER_VALUE).put(ResponseField.VARIABLE_NAME_KEY, "condition").build()).build(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        final DeleteCloudCallWebhookEvents deleteCloudCallWebhookEvents;

        public static final class Mapper implements ResponseFieldMapper<Data> {
            final DeleteCloudCallWebhookEvents.Mapper deleteCloudCallWebhookEventsFieldMapper = new DeleteCloudCallWebhookEvents.Mapper();

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.apollographql.apollo.api.ResponseFieldMapper
            public Data map(ResponseReader responseReader) {
                return new Data((DeleteCloudCallWebhookEvents) responseReader.readObject(Data.$responseFields[0], new ResponseReader.ObjectReader<DeleteCloudCallWebhookEvents>() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Data.Mapper.1
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // com.apollographql.apollo.api.ResponseReader.ObjectReader
                    public DeleteCloudCallWebhookEvents read(ResponseReader responseReader2) {
                        return Mapper.this.deleteCloudCallWebhookEventsFieldMapper.map(responseReader2);
                    }
                }));
            }
        }

        public Data(DeleteCloudCallWebhookEvents deleteCloudCallWebhookEvents) {
            this.deleteCloudCallWebhookEvents = deleteCloudCallWebhookEvents;
        }

        public DeleteCloudCallWebhookEvents deleteCloudCallWebhookEvents() {
            return this.deleteCloudCallWebhookEvents;
        }
        ...
        public boolean equals(Object obj) {
            ...
            DeleteCloudCallWebhookEvents deleteCloudCallWebhookEvents = this.deleteCloudCallWebhookEvents;
            DeleteCloudCallWebhookEvents deleteCloudCallWebhookEvents2 = ((Data) obj).deleteCloudCallWebhookEvents;
            return deleteCloudCallWebhookEvents == null ? deleteCloudCallWebhookEvents2 == null : deleteCloudCallWebhookEvents.equals(deleteCloudCallWebhookEvents2);
        }

        public int hashCode() {
            if (!this.$hashCodeMemoized) {
                DeleteCloudCallWebhookEvents deleteCloudCallWebhookEvents = this.deleteCloudCallWebhookEvents;
                this.$hashCode = (deleteCloudCallWebhookEvents == null ? 0 : deleteCloudCallWebhookEvents.hashCode()) ^ 1000003;
                this.$hashCodeMemoized = true;
            }
            return this.$hashCode;
        }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Data.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField responseField = Data.$responseFields[0];
                    DeleteCloudCallWebhookEvents deleteCloudCallWebhookEvents = Data.this.deleteCloudCallWebhookEvents;
                    responseWriter.writeObject(responseField, deleteCloudCallWebhookEvents != null ? deleteCloudCallWebhookEvents.marshaller() : null);
                }
            };
        }
        ...
        public String toString() {
            if (this.$toString == null) {
                this.$toString = "Data{deleteCloudCallWebhookEvents=" + this.deleteCloudCallWebhookEvents + "}";
            }
            return this.$toString;
        }
    }

    public static class DeleteCloudCallWebhookEvents {
        static final ResponseField[] $responseFields;
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof DeleteCloudCallWebhookEvents)) {
                return false;
            }
            DeleteCloudCallWebhookEvents deleteCloudCallWebhookEvents = (DeleteCloudCallWebhookEvents) obj;
            if (this.__typename.equals(deleteCloudCallWebhookEvents.__typename) && this.id.equals(deleteCloudCallWebhookEvents.id) && ((str = this.accountId) != null ? str.equals(deleteCloudCallWebhookEvents.accountId) : deleteCloudCallWebhookEvents.accountId == null) && ((str2 = this.contactId) != null ? str2.equals(deleteCloudCallWebhookEvents.contactId) : deleteCloudCallWebhookEvents.contactId == null) && ((str3 = this.callSessionId) != null ? str3.equals(deleteCloudCallWebhookEvents.callSessionId) : deleteCloudCallWebhookEvents.callSessionId == null) && ((str4 = this.callId) != null ? str4.equals(deleteCloudCallWebhookEvents.callId) : deleteCloudCallWebhookEvents.callId == null) && ((str5 = this.customIdentifier) != null ? str5.equals(deleteCloudCallWebhookEvents.customIdentifier) : deleteCloudCallWebhookEvents.customIdentifier == null) && ((str6 = this.providerName) != null ? str6.equals(deleteCloudCallWebhookEvents.providerName) : deleteCloudCallWebhookEvents.providerName == null) && ((str7 = this.connectionId) != null ? str7.equals(deleteCloudCallWebhookEvents.connectionId) : deleteCloudCallWebhookEvents.connectionId == null) && ((str8 = this.rawPayload) != null ? str8.equals(deleteCloudCallWebhookEvents.rawPayload) : deleteCloudCallWebhookEvents.rawPayload == null) && ((str9 = this.eventType) != null ? str9.equals(deleteCloudCallWebhookEvents.eventType) : deleteCloudCallWebhookEvents.eventType == null) && ((str10 = this.sourceNumber) != null ? str10.equals(deleteCloudCallWebhookEvents.sourceNumber) : deleteCloudCallWebhookEvents.sourceNumber == null) && ((str11 = this.callerSource) != null ? str11.equals(deleteCloudCallWebhookEvents.callerSource) : deleteCloudCallWebhookEvents.callerSource == null) && ((str12 = this.destinationNumber) != null ? str12.equals(deleteCloudCallWebhookEvents.destinationNumber) : deleteCloudCallWebhookEvents.destinationNumber == null) && ((str13 = this.displayNumber) != null ? str13.equals(deleteCloudCallWebhookEvents.displayNumber) : deleteCloudCallWebhookEvents.displayNumber == null) && ((str14 = this.agentNumber) != null ? str14.equals(deleteCloudCallWebhookEvents.agentNumber) : deleteCloudCallWebhookEvents.agentNumber == null) && ((str15 = this.customerNumber) != null ? str15.equals(deleteCloudCallWebhookEvents.customerNumber) : deleteCloudCallWebhookEvents.customerNumber == null) && ((str16 = this.callStartTime) != null ? str16.equals(deleteCloudCallWebhookEvents.callStartTime) : deleteCloudCallWebhookEvents.callStartTime == null) && ((str17 = this.callEndTime) != null ? str17.equals(deleteCloudCallWebhookEvents.callEndTime) : deleteCloudCallWebhookEvents.callEndTime == null) && ((num = this.callDuration) != null ? num.equals(deleteCloudCallWebhookEvents.callDuration) : deleteCloudCallWebhookEvents.callDuration == null) && ((num2 = this.actualCallDuration) != null ? num2.equals(deleteCloudCallWebhookEvents.actualCallDuration) : deleteCloudCallWebhookEvents.actualCallDuration == null) && ((str18 = this.resourceURL) != null ? str18.equals(deleteCloudCallWebhookEvents.resourceURL) : deleteCloudCallWebhookEvents.resourceURL == null) && ((str19 = this.callDirection) != null ? str19.equals(deleteCloudCallWebhookEvents.callDirection) : deleteCloudCallWebhookEvents.callDirection == null) && ((str20 = this.status) != null ? str20.equals(deleteCloudCallWebhookEvents.status) : deleteCloudCallWebhookEvents.status == null) && ((l = this.expirationUnixTime) != null ? l.equals(deleteCloudCallWebhookEvents.expirationUnixTime) : deleteCloudCallWebhookEvents.expirationUnixTime == null) && ((str21 = this.createdAt) != null ? str21.equals(deleteCloudCallWebhookEvents.createdAt) : deleteCloudCallWebhookEvents.createdAt == null) && ((str22 = this.updatedAt) != null ? str22.equals(deleteCloudCallWebhookEvents.updatedAt) : deleteCloudCallWebhookEvents.updatedAt == null)) {
                Contact contact = this.contact;
                Contact contact2 = deleteCloudCallWebhookEvents.contact;
                if (contact == null) {
                    if (contact2 == null) {
                        return true;
                    }
        ...
        public ResponseFieldMarshaller marshaller() {
            return new ResponseFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.DeleteCloudCallWebhookEvents.1
                @Override // com.apollographql.apollo.api.ResponseFieldMarshaller
                public void marshal(ResponseWriter responseWriter) {
                    ResponseField[] responseFieldArr = DeleteCloudCallWebhookEvents.$responseFields;
                    responseWriter.writeString(responseFieldArr[0], DeleteCloudCallWebhookEvents.this.__typename);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[1], DeleteCloudCallWebhookEvents.this.id);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[2], DeleteCloudCallWebhookEvents.this.accountId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[3], DeleteCloudCallWebhookEvents.this.contactId);
                    responseWriter.writeString(responseFieldArr[4], DeleteCloudCallWebhookEvents.this.callSessionId);
                    responseWriter.writeString(responseFieldArr[5], DeleteCloudCallWebhookEvents.this.callId);
                    responseWriter.writeString(responseFieldArr[6], DeleteCloudCallWebhookEvents.this.customIdentifier);
                    responseWriter.writeString(responseFieldArr[7], DeleteCloudCallWebhookEvents.this.providerName);
                    responseWriter.writeString(responseFieldArr[8], DeleteCloudCallWebhookEvents.this.connectionId);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[9], DeleteCloudCallWebhookEvents.this.rawPayload);
                    responseWriter.writeString(responseFieldArr[10], DeleteCloudCallWebhookEvents.this.eventType);
                    responseWriter.writeString(responseFieldArr[11], DeleteCloudCallWebhookEvents.this.sourceNumber);
                    responseWriter.writeString(responseFieldArr[12], DeleteCloudCallWebhookEvents.this.callerSource);
                    responseWriter.writeString(responseFieldArr[13], DeleteCloudCallWebhookEvents.this.destinationNumber);
                    responseWriter.writeString(responseFieldArr[14], DeleteCloudCallWebhookEvents.this.displayNumber);
                    responseWriter.writeString(responseFieldArr[15], DeleteCloudCallWebhookEvents.this.agentNumber);
                    responseWriter.writeString(responseFieldArr[16], DeleteCloudCallWebhookEvents.this.customerNumber);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[17], DeleteCloudCallWebhookEvents.this.callStartTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[18], DeleteCloudCallWebhookEvents.this.callEndTime);
                    responseWriter.writeInt(responseFieldArr[19], DeleteCloudCallWebhookEvents.this.callDuration);
                    responseWriter.writeInt(responseFieldArr[20], DeleteCloudCallWebhookEvents.this.actualCallDuration);
                    responseWriter.writeString(responseFieldArr[21], DeleteCloudCallWebhookEvents.this.resourceURL);
                    responseWriter.writeString(responseFieldArr[22], DeleteCloudCallWebhookEvents.this.callDirection);
                    responseWriter.writeString(responseFieldArr[23], DeleteCloudCallWebhookEvents.this.status);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[24], DeleteCloudCallWebhookEvents.this.expirationUnixTime);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[25], DeleteCloudCallWebhookEvents.this.createdAt);
                    responseWriter.writeCustom((ResponseField.CustomTypeField) responseFieldArr[26], DeleteCloudCallWebhookEvents.this.updatedAt);
                    ResponseField responseField = responseFieldArr[27];
                    Contact contact = DeleteCloudCallWebhookEvents.this.contact;
    ...
    public static final class Variables extends Operation.Variables {
        ...
        private final DeleteCloudCallWebhookEventsInput input;
        private final transient Map<String, Object> valueMap;

        public Variables(DeleteCloudCallWebhookEventsInput deleteCloudCallWebhookEventsInput, ModelCloudCallWebhookEventsConditionInput modelCloudCallWebhookEventsConditionInput) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            this.valueMap = linkedHashMap;
            this.input = deleteCloudCallWebhookEventsInput;
            this.condition = modelCloudCallWebhookEventsConditionInput;
            linkedHashMap.put("input", deleteCloudCallWebhookEventsInput);
        ...
        public DeleteCloudCallWebhookEventsInput input() {
            return this.input;
        }

        @Override // com.apollographql.apollo.api.Operation.Variables
        public InputFieldMarshaller marshaller() {
            return new InputFieldMarshaller() { // from class: com.amazonaws.amplify.generated.graphql.DeleteCloudCallWebhookEventsMutation.Variables.1
    ...
    public DeleteCloudCallWebhookEventsMutation(DeleteCloudCallWebhookEventsInput deleteCloudCallWebhookEventsInput, ModelCloudCallWebhookEventsConditionInput modelCloudCallWebhookEventsConditionInput) {
        Utils.checkNotNull(deleteCloudCallWebhookEventsInput, "input == null");
        this.variables = new Variables(deleteCloudCallWebhookEventsInput, modelCloudCallWebhookEventsConditionInput);
    }
    ...
    public String operationId() {
        return "c988bdce331c9ae547c62073c568dd8985551e32e1de6e2ff4ee772a890b01b3";
    }

    @Override // com.apollographql.apollo.api.Operation
    public String queryDocument() {
        return "mutation DeleteCloudCallWebhookEvents($input: DeleteCloudCallWebhookEventsInput!, $condition: ModelCloudCallWebhookEventsConditionInput) {\n  deleteCloudCallWebhookEvents(input: $input, condition: $condition) {\n    __typename\n    id\n    accountId\n    contactId\n    callSessionId\n    callId\n    customIdentifier\n    providerName\n    connectionId\n    rawPayload\n    eventType\n    sourceNumber\n    callerSource\n    destinationNumber\n    displayNumber\n    agentNumber\n    customerNumber\n    callStartTime\n    callEndTime\n    callDuration\n    actualCallDuration\n    resourceURL\n    callDirection\n    status\n    expirationUnixTime\n    createdAt\n    updatedAt\n    contact {\n      __typename\n      id\n      accountId\n      ownerId\n      toBeAssigned\n      sharedOwners\n      primaryTeamId\n      sharedTeams\n      accountPriority\n      addedById\n      assignedToId\n      blockedForCallById\n      blockedForCallReason\n      blockedForCallUntil\n      callPriority\n      waChatChannelId\n      contactSource\n      contactSourceDrillDownOne\n      contactSourceDrillDownTwo\n      contactSourceDrillDownThree\n      contactSourceDrillDownOneId\n      contactSourceDrillDownTwoId\n      contactSourceDrillDownThreeId\n      contactStatus\n      contactType\n      department\n      designation\n      lastRepeatEnquiryDate\n      lastRepeatEnquirySource\n      gender\n      isDecisionMaker\n      isPrivate\n      lockPeriod\n      name\n      preferredContactDays\n      profilePhotoUrl\n      referredBy\n      salutation\n      seniority\n      updatedById\n      hasTask\n      openTaskActivityType\n      lastCalledTime\n      lastCallDirection\n      lastCallOutcome\n      lastCallOutcomeNature\n      lastCallUserId\n      lastCallDuration\n      lastCallEngagementId\n      lastVisitTime\n      lastVisitOutcome\n      lastVisitOutcomeNature\n      lastVisitUserId\n      lastVisitEngagementId\n      lastEmailTime\n      lastEmailUserId\n      lastEmailEngagementId\n      lastWhatsappTime\n      lastWhatsappUserId\n      lastWhatsappEngagementId\n      lastWabaBroadcastTime\n      lastWabaBroadcastStatus\n      lastWabaBroadcastTemplate\n      lastWabaBroadcastReplyBody\n      lastWabaBroadcastReplyTime\n      lastWabaBroadcastReplyType\n      lastSmsTime\n      lastSmsUserId\n      lastSmsEngagementId\n      lastNoteAddedTime\n      lastNoteUserId\n      lastNoteEngagementId\n      lastTaskDoneTime\n      lastTaskDoneUserId\n      lastTaskDoneEngagementId\n      openTaskCount\n      lastKnownDisposition\n      lastKnownDispositionTime\n      lastLeadAssignmentDateTime\n      lastEngagementFromAccount\n      lastEngagementFromContact\n      freshLeadTag\n      noWorkAfterAssignment\n      needFollowUpTag\n      needFollowUpTagUpdatedAt\n      activeDealStage\n      activeDealStageUpdatedAt\n      dealDescription\n      isCustomer\n      becameCustomerOn\n      unsuccessfulCallAttempts\n      leadCallsNotAnswered\n      userDefinedTags\n      productService\n      bulkUploadReference\n      assignmentMethod\n      whatsappOptInStatus\n      recentEngagements\n      recentEngagementsUpdatedAt\n      openTaskDetail\n      openVideoCallDetail\n      lastClosedTaskDetail\n      lastClosedTaskDetailUpdatedAt\n      latestRemark\n      customAttributes\n      paymentRequestDetail\n      lastPaymentStatus\n      customDataAddedFromAddContactForm\n      leadLifecycleStage\n      leadLifecycleStageSubCategory\n      manualClosedReason\n      lastDealStageType\n      prospectingAttempts\n      totalProspectingAttemptsAcrossRechurn\n      numberOfTimesRechurned\n      lastProspectingDoneOn\n      firstProspectingDoneOn\n      nextProspectingDueOn\n      nextProspectingSetBy\n      nextProspectingNote\n      movedToOpportunityOn\n      movedToClosedOn\n      createdAt\n      updatedAt\n    }\n  }\n}";
    }
