...
public abstract class ModelStoreListener<TModel extends Model> implements IModelStoreChangeHandler<TModel>, IBootstrapService, Closeable {
    ...
    public void onModelAdded(TModel tmodel, String str) {
        ...
        sq8.m48649h(str, "tag");
        if (sq8.m48644c(str, ModelChangeTags.NORMAL) && (addOperation = getAddOperation(tmodel)) != null) {
    ...
    public void onModelRemoved(TModel tmodel, String str) {
        ...
        sq8.m48649h(tmodel, "model");
        sq8.m48649h(str, "tag");
        if (sq8.m48644c(str, ModelChangeTags.NORMAL) && (removeOperation = getRemoveOperation(tmodel)) != null) {
    ...
    public void onModelUpdated(ModelChangedArgs modelChangedArgs, String str) {
        ...
        if (sq8.m48644c(str, ModelChangeTags.NORMAL)) {
            ...
            sq8.m48647f(model, "null cannot be cast to non-null type TModel of com.onesignal.core.internal.operations.listeners.ModelStoreListener");
