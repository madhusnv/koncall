...
public final class DynamicTriggerController$dynamicTriggerShouldFire$1$2$run$1 extends kf9 implements xk7 {
    ...
    public final void invoke(ITriggerHandler iTriggerHandler) {
        ...
        iTriggerHandler.onTriggerConditionChanged(this.$triggerId);
    }
}
