    ...
    */
    ...
    public double nextDouble() throws IOException, NumberFormatException {
        ...
        if (iDoPeek == 16) {
            ...
            this.peekedString = nextQuotedValue(iDoPeek == 8 ? '\'' : TokenParser.DQUOTE);
        } else if (iDoPeek == 10) {
    ...
    public String nextName() throws IOException {
        ...
        if (iDoPeek == 14) {
            ...
            strNextQuotedValue = nextQuotedValue(TokenParser.DQUOTE);
        }
        this.peeked = 0;
    ...
    public String nextString() throws IOException {
        ...
        if (iDoPeek == 10) {
            ...
            str = nextQuotedValue(TokenParser.DQUOTE);
        } else if (iDoPeek == 11) {
