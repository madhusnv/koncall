...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder excluderM68740clone = m68740clone();
        excluderM68740clone.serializeInnerClasses = false;
        return excluderM68740clone;
    }
    ...
    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM68740clone = m68740clone();
        excluderM68740clone.requireExpose = true;
        return excluderM68740clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            excluderM68740clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z2) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM68740clone.deserializationStrategies = arrayList2;
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder excluderM68740clone = m68740clone();
        excluderM68740clone.modifiers = 0;
        for (int i : iArr) {
            excluderM68740clone.modifiers = i | excluderM68740clone.modifiers;
        }
        return excluderM68740clone;
    }
    ...
    public Excluder withVersion(double d) {
        Excluder excluderM68740clone = m68740clone();
        excluderM68740clone.version = d;
        return excluderM68740clone;
    }

    /* renamed from: clone, reason: merged with bridge method [inline-methods] */
    public Excluder m68740clone() {
        try {
