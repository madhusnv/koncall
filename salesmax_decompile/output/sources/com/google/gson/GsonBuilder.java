...
public final class GsonBuilder {
    ...
    public GsonBuilder registerTypeAdapter(Type type2, Object obj) {
        ...
        if (z || (obj instanceof JsonDeserializer)) {
            this.factories.add(TreeTypeAdapter.newFactoryWithMatchRawType(TypeToken.get(type2), obj));
        }
        if (obj instanceof TypeAdapter) {
            this.factories.add(TypeAdapters.newFactory(TypeToken.get(type2), (TypeAdapter) obj));
        }
        return this;
    }
