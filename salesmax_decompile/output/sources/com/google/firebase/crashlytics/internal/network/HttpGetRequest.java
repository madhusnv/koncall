...
public class HttpGetRequest {
    ...
    private String createParamsString(Map<String, String> map) {
        ...
        sb.append("=");
        sb.append(next.getValue() != null ? URLEncoder.encode(next.getValue(), HTTP.UTF_8) : "");
        while (it.hasNext()) {
            Map.Entry<String, String> next2 = it.next();
            sb.append("&");
            sb.append(next2.getKey());
            sb.append("=");
            sb.append(next2.getValue() != null ? URLEncoder.encode(next2.getValue(), HTTP.UTF_8) : "");
        }
        return sb.toString();
    }
    ...
    public HttpResponse execute() throws Throwable {
        ...
        try {
            ...
            Logger.getLogger().m15668v("GET Request URL: " + strCreateUrlWithParams);
