...
final class C11366x7e3e3ebd extends CrashlyticsReport.Session.Event.Application.Execution.Thread {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Thread build() {
            ...
            if (str.isEmpty()) {
                return new C11366x7e3e3ebd(this.name, this.importance.intValue(), this.frames);
            }
    ...
    private C11366x7e3e3ebd(String str, int i, ImmutableList<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> immutableList) {
        this.name = str;
        this.importance = i;
        this.frames = immutableList;
    }
