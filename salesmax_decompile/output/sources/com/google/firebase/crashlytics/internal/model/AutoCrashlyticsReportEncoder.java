...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    public static final class CrashlyticsReportCustomAttributeEncoder implements ObjectEncoder<CrashlyticsReport.CustomAttribute> {
        ...
        private static final FieldDescriptor KEY_DESCRIPTOR = FieldDescriptor.of(TransferTable.COLUMN_KEY);
    ...
    public static final class CrashlyticsReportEncoder implements ObjectEncoder<CrashlyticsReport> {
        ...
        private static final FieldDescriptor SESSION_DESCRIPTOR = FieldDescriptor.of(OutcomeEventsTable.COLUMN_NAME_SESSION);
    ...
    public static final class CrashlyticsReportSessionApplicationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Application> {
        ...
        private static final FieldDescriptor VERSION_DESCRIPTOR = FieldDescriptor.of(ClientCookie.VERSION_ATTR);
        private static final FieldDescriptor DISPLAYVERSION_DESCRIPTOR = FieldDescriptor.of("displayVersion");
    ...
    public static final class C11348x99c932db implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.BinaryImage> {
        static final C11348x99c932db INSTANCE = new C11348x99c932db();
    ...
    public static final class C11349x55689506 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Exception> {
        static final C11349x55689506 INSTANCE = new C11349x55689506();
    ...
    public static final class C11350xc3999712 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> {
        static final C11350xc3999712 INSTANCE = new C11350xc3999712();
        ...
        private static final FieldDescriptor FILE_DESCRIPTOR = FieldDescriptor.of(TransferTable.COLUMN_FILE);
        private static final FieldDescriptor OFFSET_DESCRIPTOR = FieldDescriptor.of("offset");
        private static final FieldDescriptor IMPORTANCE_DESCRIPTOR = FieldDescriptor.of("importance");

        private C11350xc3999712() {
        }
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        ...
        encoderConfig.registerEncoder(C11366x7e3e3ebd.class, crashlyticsReportSessionEventApplicationExecutionThreadEncoder);
        C11350xc3999712 c11350xc3999712 = C11350xc3999712.INSTANCE;
        encoderConfig.registerEncoder(CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.class, c11350xc3999712);
        encoderConfig.registerEncoder(C11367xce3d994b.class, c11350xc3999712);
        C11349x55689506 c11349x55689506 = C11349x55689506.INSTANCE;
        encoderConfig.registerEncoder(CrashlyticsReport.Session.Event.Application.Execution.Exception.class, c11349x55689506);
        encoderConfig.registerEncoder(C11364xc2f5febc.class, c11349x55689506);
        ...
        encoderConfig.registerEncoder(C11365x7c929f5b.class, crashlyticsReportSessionEventApplicationExecutionSignalEncoder);
        C11348x99c932db c11348x99c932db = C11348x99c932db.INSTANCE;
        encoderConfig.registerEncoder(CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.class, c11348x99c932db);
        encoderConfig.registerEncoder(C11363xfe724d07.class, c11348x99c932db);
