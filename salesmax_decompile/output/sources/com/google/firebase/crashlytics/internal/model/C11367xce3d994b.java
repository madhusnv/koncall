...
final class C11367xce3d994b extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame build() {
            ...
            if (str.isEmpty()) {
                return new C11367xce3d994b(this.pc.longValue(), this.symbol, this.file, this.offset.longValue(), this.importance.intValue());
            }
    ...
    private C11367xce3d994b(long j, String str, String str2, long j2, int i) {
        this.pc = j;
        this.symbol = str;
        this.file = str2;
        this.offset = j2;
