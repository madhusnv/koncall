...
final class C11364xc2f5febc extends CrashlyticsReport.Session.Event.Application.Execution.Exception {
    ...
    private final String f58157type;
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Exception.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Exception build() {
            ...
            if (str.isEmpty()) {
                return new C11364xc2f5febc(this.f58158type, this.reason, this.frames, this.causedBy, this.overflowCount.intValue());
            }
    ...
    public String getType() {
        return this.f58157type;
    }

    public int hashCode() {
        int iHashCode = (this.f58157type.hashCode() ^ 1000003) * 1000003;
    ...
    public String toString() {
        return "Exception{type=" + this.f58157type + ", reason=" + this.reason + ", frames=" + this.frames + ", causedBy=" + this.causedBy + ", overflowCount=" + this.overflowCount + "}";
    }

    private C11364xc2f5febc(String str, String str2, ImmutableList<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> immutableList, CrashlyticsReport.Session.Event.Application.Execution.Exception exception, int i) {
        this.f58157type = str;
        this.reason = str2;
        this.frames = immutableList;
        this.causedBy = exception;
