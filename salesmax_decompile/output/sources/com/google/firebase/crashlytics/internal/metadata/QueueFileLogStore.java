...
class QueueFileLogStore implements FileLogStore {
    ...
    private void doWriteToLog(long j, String str) {
        ...
        try {
            ...
            Logger.getLogger().m15665e("There was a problem writing to the Crashlytics log.", e);
        }
    }
    ...
    private LogBytes getLogBytes() {
        ...
        try {
            ...
            Logger.getLogger().m15665e("A problem occurred while reading the Crashlytics log file.", e);
        }
    ...
    private void openLogFile() {
        if (this.logFile == null) {
            try {
                ...
                Logger.getLogger().m15665e("Could not open log file: " + this.workingFile, e);
            }
        }
    }
