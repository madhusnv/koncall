...
public class IdManager implements InstallIdProvider {
    ...
    private synchronized String createAndCacheCrashlyticsInstallId(String str, SharedPreferences sharedPreferences) {
        ...
        Logger.getLogger().m15668v("Created new Crashlytics installation ID: " + id + " for FID: " + str);
    ...
    private String fetchTrueFid() {
        try {
            ...
            Logger.getLogger().m15671w("Failed to retrieve Firebase Installations ID.", e);
            return null;
        }
    }
    ...
    public synchronized String getCrashlyticsInstallId() {
        ...
        Logger.getLogger().m15668v("Determining Crashlytics installation ID...");
        SharedPreferences sharedPrefs = CommonUtils.getSharedPrefs(this.appContext);
        String string = sharedPrefs.getString(PREFKEY_FIREBASE_IID, null);
        Logger.getLogger().m15668v("Cached Firebase Installation ID: " + string);
        if (this.dataCollectionArbiter.isAutomaticDataCollectionEnabled()) {
            String strFetchTrueFid = fetchTrueFid();
            Logger.getLogger().m15668v("Fetched Firebase Installation ID: " + strFetchTrueFid);
        ...
        if (this.crashlyticsInstallId == null) {
            Logger.getLogger().m15670w("Unable to determine Crashlytics Install Id, creating a new one.");
            this.crashlyticsInstallId = createAndCacheCrashlyticsInstallId(createSyntheticFid(), sharedPrefs);
        }
        Logger.getLogger().m15668v("Crashlytics installation ID: " + this.crashlyticsInstallId);
