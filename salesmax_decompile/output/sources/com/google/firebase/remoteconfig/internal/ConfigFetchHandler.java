...
public class ConfigFetchHandler {
    ...
    private Task<FetchResponse> fetchFromBackendAndCacheResponse(String str, String str2, Date date) {
        try {
            ...
            return fetchResponseFetchFromBackend.getStatus() != 0 ? Tasks.forResult(fetchResponseFetchFromBackend) : this.fetchedConfigsCache.put(fetchResponseFetchFromBackend.getFetchedConfigs()).onSuccessTask(this.executor, new SuccessContinuation() { // from class: o.tq3
    ...
    public Task<FetchResponse> lambda$fetch$0(Task<ConfigContainer> task, long j) {
        ...
        if (backoffEndTimeInMillis != null) {
            ...
            taskContinueWithTask = Tasks.whenAllComplete((Task<?>[]) new Task[]{id, token}).continueWithTask(this.executor, new Continuation() { // from class: o.rq3
                @Override // com.google.android.gms.tasks.Continuation
                public final Object then(Task task2) {
                    return this.f43942a.lambda$fetchIfCacheExpiredAndNotThrottled$1(id, token, date, task2);
                }
            });
        }
        return taskContinueWithTask.continueWithTask(this.executor, new Continuation() { // from class: o.sq3
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task2) {
                return this.f45759a.lambda$fetchIfCacheExpiredAndNotThrottled$2(date, task2);
            }
        });
    }
    ...
    public Task<FetchResponse> fetch(final long j) {
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new Continuation() { // from class: o.qq3
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task) {
                return this.f42285a.lambda$fetch$0(j, task);
            }
        });
    }
}
