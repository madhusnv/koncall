...
public class ConfigFetchHttpClient {
    ...
    private JSONObject createFetchRequestBody(String str, String str2, Map<String, String> map, Long l) throws PackageManager.NameNotFoundException, FirebaseRemoteConfigClientException {
        ...
        try {
            ...
            if (packageInfo != null) {
                ...
                map2.put(RemoteConfigConstants.RequestFieldKey.APP_BUILD, Long.toString(fic.m26778a(packageInfo)));
            }
    ...
    @Keep
    public ConfigFetchHandler.FetchResponse fetch(HttpURLConnection httpURLConnection, String str, String str2, Map<String, String> map, String str3, Map<String, String> map2, Long l, Date date) {
