...
public class MessagingAnalytics {
    ...
    private static void logToFirelog(MessagingClientEvent.Event event, Intent intent, rwh rwhVar) {
        MessagingClientEvent messagingClientEventEventToProto;
        if (rwhVar == null || (messagingClientEventEventToProto = eventToProto(event, intent)) == null) {
            return;
        }
        try {
            rwhVar.mo47214a(Constants.FirelogAnalytics.FCM_LOG_SOURCE, MessagingClientEventExtension.class, n76.m40202b("proto"), new dvh() { // from class: o.ddb
                @Override // p001o.dvh
                public final Object apply(Object obj) {
                    return ((MessagingClientEventExtension) obj).toByteArray();
                }
            }).mo42730a(xj6.m56377e(MessagingClientEventExtension.newBuilder().setMessagingClientEvent(messagingClientEventEventToProto).build()));
