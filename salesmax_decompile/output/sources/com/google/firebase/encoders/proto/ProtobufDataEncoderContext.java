...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor MAP_KEY_DESC = FieldDescriptor.builder(TransferTable.COLUMN_KEY).withProperty(AtProtobuf.builder().tag(1).build()).build();
    ...
    public static /* synthetic */ class C113871 {

        /* renamed from: $SwitchMap$com$google$firebase$encoders$proto$Protobuf$IntEncoding */
        static final /* synthetic */ int[] f13397x531607dd;

        static {
            int[] iArr = new int[Protobuf.IntEncoding.values().length];
            f13397x531607dd = iArr;
            try {
                iArr[Protobuf.IntEncoding.DEFAULT.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f13397x531607dd[Protobuf.IntEncoding.SIGNED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f13397x531607dd[Protobuf.IntEncoding.FIXED.ordinal()] = 3;
    ...
    private void writeVarInt32(int i) throws IOException {
        while ((i & (-128)) != 0) {
            this.output.write((i & Opcodes.LAND) | 128);
            i >>>= 7;
        }
        this.output.write(i & Opcodes.LAND);
    }

    private void writeVarInt64(long j) throws IOException {
        while (((-128) & j) != 0) {
            this.output.write((((int) j) & Opcodes.LAND) | 128);
            j >>>= 7;
        }
        this.output.write(((int) j) & Opcodes.LAND);
    }
    ...
    public ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, int i, boolean z) {
        ...
        int i2 = C113871.f13397x531607dd[protobuf.intEncoding().ordinal()];
        if (i2 == 1) {
    ...
    public ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, long j, boolean z) {
        ...
        Protobuf protobuf = getProtobuf(fieldDescriptor);
        int i = C113871.f13397x531607dd[protobuf.intEncoding().ordinal()];
        if (i == 1) {
            writeVarInt32(protobuf.tag() << 3);
            writeVarInt64(j);
        } else if (i == 2) {
