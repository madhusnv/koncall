...
public class FirebaseApp {
    ...
    static final Map<String, FirebaseApp> INSTANCES = new vo0();
        ...
        public static void ensureBackgroundStateListenerRegistered(Context context) {
            if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
                ...
                if (INSTANCE.get() == null) {
                    ...
                    if (ec3.m24748a(INSTANCE, null, globalBackgroundStateListener)) {
    ...
    public static class UserUnlockReceiver extends BroadcastReceiver {
        ...
        public static void ensureReceiverRegistered(Context context) {
            if (INSTANCE.get() == null) {
                ...
                if (ec3.m24748a(INSTANCE, null, userUnlockReceiver)) {
    ...
    public FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        if (shi.m48357a(context) && FirebaseInitProvider.isCurrentlyInitializing()) {
        ...
        FirebaseTrace.popTrace();
        this.dataCollectionConfigStorage = new Lazy<>(new Provider() { // from class: o.m07
            @Override // com.google.firebase.inject.Provider
            public final Object get() {
                return this.f34586a.lambda$new$0(context);
            }
        });
        this.defaultHeartBeatController = componentRuntimeBuild.getProvider(DefaultHeartBeatController.class);
        addBackgroundStateChangeListener(new BackgroundStateChangeListener() { // from class: o.n07
            @Override // com.google.firebase.FirebaseApp.BackgroundStateChangeListener
            public final void onBackgroundStateChanged(boolean z) {
                this.f36161a.lambda$new$1(z);
            }
        });
        FirebaseTrace.popTrace();
    }
    ...
    public void initializeAllApis() {
        if (!shi.m48357a(this.applicationContext)) {
