...
public final class zzs extends zzbz {
    ...
    static {
        vo0 vo0Var = new vo0();
        zzb = vo0Var;
        vo0Var.put("registered", FastJsonResponse.Field.forStrings("registered", 2));
        vo0Var.put("in_progress", FastJsonResponse.Field.forStrings("in_progress", 3));
        vo0Var.put(FirebaseAnalytics.Param.SUCCESS, FastJsonResponse.Field.forStrings(FirebaseAnalytics.Param.SUCCESS, 4));
        vo0Var.put("failed", FastJsonResponse.Field.forStrings("failed", 5));
        vo0Var.put("escrowed", FastJsonResponse.Field.forStrings("escrowed", 6));
    }
