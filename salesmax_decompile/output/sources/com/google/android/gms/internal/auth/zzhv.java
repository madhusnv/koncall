...
public final class zzhv implements zzht {
    ...
    static {
        ...
        zza = zzczVarZza.zzc("getTokenRefactor__account_data_service_sample_percentage", FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
        ...
        try {
            ...
            zzn = zzczVarZza.zzc("getTokenRefactor__gms_account_authenticator_sample_percentage", FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
        } catch (Exception e) {
