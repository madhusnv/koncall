...
class zzun extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i = 0;
        if (size >= 0) {
            int iCompareTo = comparable.compareTo(((zzuh) this.zzb.get(size)).zza());
            if (iCompareTo > 0) {
                return -(size + 2);
            }
            if (iCompareTo == 0) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int iCompareTo2 = comparable.compareTo(((zzuh) this.zzb.get(i2)).zza());
            if (iCompareTo2 < 0) {
                size = i2 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final boolean equals(Object obj) {
        ...
        int iZzb = zzb();
        if (iZzb != zzunVar.zzb()) {
            return entrySet().equals(zzunVar.entrySet());
        }
        ...
        if (iZzb != size) {
            return this.zzc.equals(zzunVar.zzc);
        }
        return true;
    }
    ...
    public final Object get(Object obj) {
        ...
        return iZzk >= 0 ? ((zzuh) this.zzb.get(iZzk)).getValue() : this.zzc.get(comparable);
    }
    ...
    public final int hashCode() {
        ...
        int iHashCode = 0;
        for (int i = 0; i < iZzb; i++) {
            iHashCode += ((zzuh) this.zzb.get(i)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int iZzk = zzk(comparable);
        if (iZzk >= 0) {
            return ((zzuh) this.zzb.get(iZzk)).setValue(obj);
        }
        zzn();
