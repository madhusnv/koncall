...
public final class zzkq {
    ...
    static {
        ...
        zzd = zzkqVar4;
        zzkq zzkqVar5 = new zzkq("DOUBLE", 4, Double.TYPE, Double.class, Double.valueOf(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE));
        zze = zzkqVar5;
    ...
    private zzkq(String str, int i, Class cls, Class cls2, Object obj) {
        this.zzl = cls;
        this.zzm = cls2;
        this.zzn = obj;
    }
