...
public abstract class zzfh extends zzfd implements List, RandomAccess {
    ...
    public static zzfh zzi(Object[] objArr, int i) {
        return i == 0 ? zzfo.zza : new zzfo(objArr, i);
    }
    ...
    public zzfh subList(int i, int i2) {
        zzeu.zzd(i, i2, size());
        int i3 = i2 - i;
        return i3 == size() ? this : i3 == 0 ? zzfo.zza : new zzfg(this, i, i3);
    }
    ...
    public final zzfy listIterator(int i) {
        ...
        return isEmpty() ? zza : new zzff(this, i);
    }
}
