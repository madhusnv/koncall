...
public abstract class zzad extends zzz implements List, RandomAccess {
    private static final zzap zza = new zzab(zzah.zza, 0);
    public static final /* synthetic */ int zzd = 0;

    public static zzad zzg(Object[] objArr, int i) {
        return i == 0 ? zzah.zza : new zzah(objArr, i);
    }
    ...
    public zzad subList(int i, int i2) {
        zzt.zze(i, i2, size());
        int i3 = i2 - i;
        return i3 == size() ? this : i3 == 0 ? zzah.zza : new zzac(this, i, i3);
    }
    ...
    public final zzap listIterator(int i) {
        ...
        return isEmpty() ? zza : new zzab(this, i);
    }
}
