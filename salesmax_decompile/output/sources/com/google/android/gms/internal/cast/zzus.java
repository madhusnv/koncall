...
public final class zzus {
    ...
    public static zzus zze(zzus zzusVar, zzus zzusVar2) {
        int i = zzusVar.zzb;
        int i2 = zzusVar2.zzb;
        int[] iArrCopyOf = Arrays.copyOf(zzusVar.zzc, 0);
        System.arraycopy(zzusVar2.zzc, 0, iArrCopyOf, 0, 0);
        Object[] objArrCopyOf = Arrays.copyOf(zzusVar.zzd, 0);
        System.arraycopy(zzusVar2.zzd, 0, objArrCopyOf, 0, 0);
        return new zzus(0, iArrCopyOf, objArrCopyOf, true);
    }
