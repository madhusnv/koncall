...
public enum zznf implements zzbl {
    NO_ERROR(0),
    ...
    MODEL_INFO_DOWNLOAD_NO_HASH(Opcodes.FMUL),
    MODEL_INFO_DOWNLOAD_CONNECTION_FAILED(Opcodes.DMUL),
    NO_VALID_MODEL(108),
    LOCAL_MODEL_INVALID(Opcodes.LDIV),
    REMOTE_MODEL_INVALID(110),
    REMOTE_MODEL_LOADER_ERROR(Opcodes.DDIV),
    REMOTE_MODEL_LOADER_LOADS_NO_MODEL(112),
    SMART_REPLY_LANG_ID_DETECTAION_FAILURE(Opcodes.LREM),
    MODEL_NOT_REGISTERED(Opcodes.FREM),
    MODEL_TYPE_MISUSE(Opcodes.DREM),
    ...
    PERMISSION_DENIED(MediaError.DetailedErrorCode.TEXT_UNKNOWN),
    CANCELLED(601),
