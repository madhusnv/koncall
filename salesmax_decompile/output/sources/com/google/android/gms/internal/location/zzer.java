...
public final class zzer {
    ...
    public static int zzc(int i, int i2, String str) {
        ...
        if (i < 0) {
            strZza = zzes.zza("%s (%s) must not be negative", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i));
        } else {
            if (i2 < 0) {
            ...
            strZza = zzes.zza("%s (%s) must be less than size (%s)", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i), Integer.valueOf(i2));
        }
