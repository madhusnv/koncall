...
final class zzrv implements zzvi {
    ...
    private zzrv(zzru zzruVar) {
        byte[] bArr = zzsq.zzd;
        this.zza = zzruVar;
        zzruVar.zza = this;
    }

    public static zzrv zza(zzru zzruVar) {
        zzrv zzrvVar = zzruVar.zza;
        return zzrvVar != null ? zzrvVar : new zzrv(zzruVar);
    }
    ...
    public final void zzA(int i, List list, boolean z) {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzruVar.zzp(i, (iIntValue >> 31) ^ (iIntValue + iIntValue));
                i2++;
            }
            return;
        }
        ...
        for (int i3 = 0; i3 < list.size(); i3++) {
            ...
            iZzx += zzru.zzx((iIntValue2 >> 31) ^ (iIntValue2 + iIntValue2));
        }
        this.zza.zzq(iZzx);
        while (i2 < list.size()) {
            zzru zzruVar2 = this.zza;
            int iIntValue3 = ((Integer) list.get(i2)).intValue();
            zzruVar2.zzq((iIntValue3 >> 31) ^ (iIntValue3 + iIntValue3));
            i2++;
        }
    }
    ...
    public final void zzC(int i, List list, boolean z) {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzruVar.zzr(i, (jLongValue >> 63) ^ (jLongValue + jLongValue));
                i2++;
            }
            return;
        }
        ...
        for (int i3 = 0; i3 < list.size(); i3++) {
            ...
            iZzy += zzru.zzy((jLongValue2 >> 63) ^ (jLongValue2 + jLongValue2));
        }
        this.zza.zzq(iZzy);
        while (i2 < list.size()) {
            zzru zzruVar2 = this.zza;
            long jLongValue3 = ((Long) list.get(i2)).longValue();
            zzruVar2.zzs((jLongValue3 >> 63) ^ (jLongValue3 + jLongValue3));
            i2++;
        }
    }
    ...
    public final void zzG(int i, List list, boolean z) {
        ...
        int iZzx = 0;
        for (int i3 = 0; i3 < list.size(); i3++) {
            iZzx += zzru.zzx(((Integer) list.get(i3)).intValue());
        }
        this.zza.zzq(iZzx);
        while (i2 < list.size()) {
    ...
    public final void zzI(int i, List list, boolean z) {
        ...
        int iZzy = 0;
        for (int i3 = 0; i3 < list.size(); i3++) {
            iZzy += zzru.zzy(((Long) list.get(i3)).longValue());
        }
        this.zza.zzq(iZzy);
        while (i2 < list.size()) {
    ...
    @Override // com.google.android.gms.internal.cast.zzvi
    public final void zzd(int i, zzrm zzrmVar) {
        this.zza.zze(i, zzrmVar);
    }
    ...
    public final void zzi(int i, List list, boolean z) {
        ...
        int iZzu = 0;
        for (int i3 = 0; i3 < list.size(); i3++) {
            iZzu += zzru.zzu(((Integer) list.get(i3)).intValue());
        }
        this.zza.zzq(iZzu);
        while (i2 < list.size()) {
    ...
    @Override // com.google.android.gms.internal.cast.zzvi
    public final void zzp(int i, Object obj, zzua zzuaVar) {
        zzru zzruVar = this.zza;
        zzruVar.zzo(i, 3);
        zzuaVar.zzf((zztp) obj, zzruVar.zza);
        zzruVar.zzo(i, 4);
    }
    ...
    @Override // com.google.android.gms.internal.cast.zzvi
    public final void zzu(int i, Object obj, zzua zzuaVar) throws zzrs {
        zztp zztpVar = (zztp) obj;
        zzrr zzrrVar = (zzrr) this.zza;
        zzrrVar.zzq((i << 3) | 2);
        zzrrVar.zzq(((zzqz) zztpVar).zzp(zzuaVar));
        zzuaVar.zzf(zztpVar, zzrrVar.zza);
    }
