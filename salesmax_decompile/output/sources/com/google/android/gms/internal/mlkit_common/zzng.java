...
public enum zzng implements zzbl {
    UNKNOWN_EVENT(0),
    ...
    ON_DEVICE_OBJECT_LOAD(Opcodes.CHECKCAST),
    ON_DEVICE_OBJECT_INFERENCE(Opcodes.INSTANCEOF),
    ON_DEVICE_OBJECT_CLOSE(Opcodes.MONITORENTER),
    ON_DEVICE_DI_CREATE(MediaError.DetailedErrorCode.HLS_NETWORK_MASTER_PLAYLIST),
    ON_DEVICE_DI_LOAD(MediaError.DetailedErrorCode.HLS_NETWORK_PLAYLIST),
    ON_DEVICE_DI_DOWNLOAD(MediaError.DetailedErrorCode.HLS_NETWORK_NO_KEY_RESPONSE),
    ON_DEVICE_DI_RECOGNIZE(MediaError.DetailedErrorCode.HLS_NETWORK_KEY_LOAD),
    ON_DEVICE_DI_CLOSE(MediaError.DetailedErrorCode.HLS_NETWORK_INVALID_SEGMENT),
    ON_DEVICE_POSE_CREATE(MediaError.DetailedErrorCode.DASH_NETWORK),
    ON_DEVICE_POSE_LOAD(MediaError.DetailedErrorCode.DASH_NO_INIT),
    ON_DEVICE_POSE_INFERENCE(323),
    ON_DEVICE_POSE_CLOSE(324),
    ON_DEVICE_POSE_PRELOAD(325),
    ON_DEVICE_SEGMENTATION_CREATE(MediaError.DetailedErrorCode.SMOOTH_NETWORK),
    ON_DEVICE_SEGMENTATION_LOAD(MediaError.DetailedErrorCode.SMOOTH_NO_MEDIA_DATA),
    ...
    CLOUD_LOGO_CLOSE(93),
    CLOUD_SAFE_SEARCH_CREATE(Opcodes.DDIV),
    CLOUD_SAFE_SEARCH_DETECT(112),
    CLOUD_SAFE_SEARCH_CLOSE(Opcodes.LREM),
    CLOUD_TEXT_CREATE(Opcodes.LSHL),
    CLOUD_TEXT_DETECT(122),
    CLOUD_TEXT_CLOSE(Opcodes.LSHR),
    ...
    AGGREGATED_ON_DEVICE_OBJECT_INFERENCE(HttpStatus.SC_RESET_CONTENT),
    AGGREGATED_ON_DEVICE_TEXT_DETECTION(HttpStatus.SC_PARTIAL_CONTENT),
    AGGREGATED_ON_DEVICE_POSE_DETECTION(HttpStatus.SC_MULTI_STATUS),
    ...
    NLCLASSIFIER_CLIENT_LIBRARY(MediaError.DetailedErrorCode.DASH_MANIFEST_NO_PERIODS),
    NLCLASSIFIER_CLIENT_LIBRARY_CREATE(422),
    NLCLASSIFIER_CLIENT_LIBRARY_CLASSIFY(423),
    NLCLASSIFIER_CLIENT_LIBRARY_CLOSE(HttpStatus.SC_FAILED_DEPENDENCY),
    ...
    ACCELERATION_ALLOWLIST_GET(MediaError.DetailedErrorCode.SMOOTH_MANIFEST),
    ...
    ON_DEVICE_EXPLICIT_CONTENT_CREATE(HttpStatus.SC_NOT_IMPLEMENTED),
    ON_DEVICE_EXPLICIT_CONTENT_LOAD(502),
    ON_DEVICE_EXPLICIT_CONTENT_DETECT(503),
    ON_DEVICE_EXPLICIT_CONTENT_CLOSE(HttpStatus.SC_GATEWAY_TIMEOUT),
