...
public class MediaMetadata extends AbstractSafeParcelable {
    ...
    private static final String[] zzb = {DevicePublicKeyStringDef.NONE, "String", "int", "double", "ISO-8601 date String", "Time in milliseconds as long"};
    ...
    static {
        ...
        zzcdVar.zzb(KEY_TITLE, OneSignalDbContract.NotificationTable.COLUMN_NAME_TITLE, 1);
        ...
        zzcdVar.zzb(KEY_LOCATION_NAME, "location", 1);
