...
public class HelpTextView extends LinearLayout {
    ...
    public void onFinishInflate() {
        ...
        TextView textView = (TextView) findViewById(C10905R.id.cast_featurehighlight_help_text_header_view);
        textView.getClass();
        this.headerTextView = textView;
        TextView textView2 = (TextView) findViewById(C10905R.id.cast_featurehighlight_help_text_body_view);
        textView2.getClass();
