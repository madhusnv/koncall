...
public final class zzb {
    ...
    public final boolean zzd(Uri uri) {
        ...
        if (this.zzb.getWidthInPixels() == 0 || this.zzb.getHeightInPixels() == 0) {
            this.zzd = new zzf(this.zza, 0, 0, false, 2097152L, 5, 333, TransferRecord.MAXIMUM_UPLOAD_PARTS, this);
        } else {
            this.zzd = new zzf(this.zza, this.zzb.getWidthInPixels(), this.zzb.getHeightInPixels(), false, 2097152L, 5, 333, TransferRecord.MAXIMUM_UPLOAD_PARTS, this);
        }
