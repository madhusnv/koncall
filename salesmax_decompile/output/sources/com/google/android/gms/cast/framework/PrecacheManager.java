...
public class PrecacheManager {
    ...
    public void precache(final String str) {
        ...
        if (currentSession == null) {
            ...
            zznVar.doWrite(TaskApiCall.builder().setMethodKey(8423).run(new RemoteCall(strArr, str, list) { // from class: com.google.android.gms.cast.internal.zze
                ...
                public final void accept(Object obj, Object obj2) {
                    ...
                    ((zzaj) ((zzo) obj).getService()).zze(new zzj(zznVar2, (TaskCompletionSource) obj2), strArr2, str2, null);
                }
            }).build());
        } else {
            if (!(currentSession instanceof CastSession)) {
                this.zza.m13797e("Current session is not a CastSession. Precache is not supported.", new Object[0]);
                return;
            }
            ...
            if (remoteMediaClient != null) {
                ...
                this.zza.m13797e("Failed to get RemoteMediaClient from current cast session.", new Object[0]);
            }
        }
    }
}
