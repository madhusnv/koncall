...
final class zzs extends MediaSessionCompat.AbstractC1719b {
    ...
    @Override // android.support.v4.media.session.MediaSessionCompat.AbstractC1719b
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void onCustomAction(String str, Bundle bundle) {
        char c;
        zzv.zzb.m13795d("onCustomAction with action = %s", str);
        switch (str.hashCode()) {
            case -1699820260:
    ...
    public final boolean onMediaButtonEvent(Intent intent) {
        zzv.zzb.m13795d("onMediaButtonEvent", new Object[0]);
    ...
    public final void onPause() {
        zzv.zzb.m13795d("onPause", new Object[0]);
        zzv zzvVar = this.zza;
        if (zzvVar.zzp != null) {
            zzvVar.zzp.togglePlayback();
        }
    ...
    public final void onPlay() {
        zzv.zzb.m13795d("onPlay", new Object[0]);
        zzv zzvVar = this.zza;
        if (zzvVar.zzp != null) {
            zzvVar.zzp.togglePlayback();
        }
    ...
    public final void onSeekTo(long j) {
        zzv.zzb.m13795d("onSeekTo %d", Long.valueOf(j));
        zzb(j);
    }

    @Override // android.support.v4.media.session.MediaSessionCompat.AbstractC1719b
    public final void onSkipToNext() {
        zzv.zzb.m13795d("onSkipToNext", new Object[0]);
        zzv zzvVar = this.zza;
        if (zzvVar.zzp != null) {
    ...
    public final void onSkipToPrevious() {
        zzv.zzb.m13795d("onSkipToPrevious", new Object[0]);
        zzv zzvVar = this.zza;
        if (zzvVar.zzp != null) {
