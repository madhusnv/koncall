...
public class MediaLiveSeekableRange extends AbstractSafeParcelable {
    ...
    public static MediaLiveSeekableRange zza(JSONObject jSONObject) {
        if (jSONObject != null && jSONObject.has("start") && jSONObject.has("end")) {
            try {
                ...
                zza.m13797e("Ignoring Malformed MediaLiveSeekableRange: ".concat(jSONObject.toString()), new Object[0]);
            }
        }
        return null;
    }
    ...
    public final JSONObject zzb() throws JSONException {
        try {
            ...
            zza.m13797e("Error transforming MediaLiveSeekableRange into JSONObject", new Object[0]);
