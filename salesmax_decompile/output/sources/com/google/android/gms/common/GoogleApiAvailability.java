...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public final void zae(Context context, int i, String str, PendingIntent pendingIntent) throws Resources.NotFoundException {
        ...
        o2c.C15694f c15694fM41401E = new o2c.C15694f(context).m41427v(true).m41412g(true).m41418m(strZae).m41401E(new o2c.C15692d().m41377h(strZad));
        if (DeviceProperties.isWearable(context)) {
            Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
            c15694fM41401E.m41399C(context.getApplicationInfo().icon).m41431z(2);
            if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                c15694fM41401E.m41407a(C10903R.drawable.common_full_open_on_phone, resources.getString(C10903R.string.common_open_on_phone), pendingIntent);
            } else {
                c15694fM41401E.m41416k(pendingIntent);
            }
        } else {
            c15694fM41401E.m41399C(android.R.drawable.stat_sys_warning).m41402F(resources.getString(C10903R.string.common_google_play_services_notification_ticker)).m41406J(System.currentTimeMillis()).m41416k(pendingIntent).m41417l(strZad);
        }
        if (PlatformVersion.isAtLeastO()) {
            ...
            if (str2 == null) {
                ...
                String string = context.getResources().getString(C10903R.string.common_google_play_services_notification_channel_name);
                if (notificationChannel == null) {
                    notificationManager.createNotificationChannel(pc7.m43335a("com.google.android.gms.availability", string, 4));
                } else if (!string.contentEquals(notificationChannel.getName())) {
                    notificationChannel.setName(string);
                    notificationManager.createNotificationChannel(notificationChannel);
                }
            }
            c15694fM41401E.m41413h(str2);
        }
        Notification notificationM41409c = c15694fM41401E.m41409c();
        if (i == 1 || i == 2 || i == 3) {
        ...
        notificationManager.notify(i2, notificationM41409c);
    }
    ...
    public boolean showErrorDialogFragment(Activity activity, int i, ws wsVar, DialogInterface.OnCancelListener onCancelListener) {
        Dialog dialogZaa = zaa(activity, i, null, onCancelListener, new zac(this, activity, i, wsVar));
        if (dialogZaa == null) {
            return false;
        }
        zad(activity, dialogZaa, GooglePlayServicesUtil.GMS_ERROR_DIALOG, onCancelListener);
