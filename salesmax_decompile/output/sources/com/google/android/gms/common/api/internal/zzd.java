...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    private final Map zzb = Collections.synchronizedMap(new vo0());
    private int zzc = 0;
    private Bundle zzd;
    ...
    public static zzd zzc(FragmentActivity fragmentActivity) {
        ...
        try {
            zzd zzdVar2 = (zzd) fragmentActivity.getSupportFragmentManager().m0("SupportLifecycleFragmentImpl");
            if (zzdVar2 == null || zzdVar2.isRemoving()) {
                zzdVar2 = new zzd();
                fragmentActivity.getSupportFragmentManager().m6205q().m6421e(zzdVar2, "SupportLifecycleFragmentImpl").mo6261i();
            }
