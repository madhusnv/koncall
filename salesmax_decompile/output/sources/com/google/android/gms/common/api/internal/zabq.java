...
public final class zabq implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    private final Feature zaC(Feature[] featureArr) {
        if (featureArr != null && featureArr.length != 0) {
            ...
            vo0 vo0Var = new vo0(availableFeatures.length);
            for (Feature feature : availableFeatures) {
                vo0Var.put(feature.getName(), Long.valueOf(feature.getVersion()));
            }
            for (Feature feature2 : featureArr) {
                Long l = (Long) vo0Var.get(feature2.getName());
    ...
    public final void zaI(int i) {
        ...
        googleApiManager.zar.sendMessageDelayed(Message.obtain(googleApiManager.zar, 9, apiKey), DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
    ...
    private final boolean zaM(zai zaiVar) throws Resources.NotFoundException {
        ...
        String name2 = featureZaC.getName();
        long version = featureZaC.getVersion();
        ...
        if (iIndexOf >= 0) {
            ...
            GoogleApiManager googleApiManager = this.zaa;
            googleApiManager.zar.sendMessageDelayed(Message.obtain(googleApiManager.zar, 15, zabsVar2), DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
            return false;
        }
        this.zak.add(zabsVar);
        GoogleApiManager googleApiManager2 = this.zaa;
        googleApiManager2.zar.sendMessageDelayed(Message.obtain(googleApiManager2.zar, 15, zabsVar), DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
    ...
    public final void zar(ConnectionResult connectionResult, Exception exc) {
        ...
        GoogleApiManager googleApiManager2 = this.zaa;
        googleApiManager2.zar.sendMessageDelayed(Message.obtain(googleApiManager2.zar, 9, this.zad), DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
    }
