    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                vo0Var.put(api2, Boolean.valueOf(z2));
                ...
                vo0Var2.put(api2.zab(), clientBuildClient);
            ...
            zabe zabeVar = new zabe(this.zai, new ReentrantLock(), this.zan, clientSettingsZaa, this.zao, this.zap, vo0Var, this.zaq, this.zar, vo0Var2, this.zal, zabe.zad(vo0Var2.values(), true), arrayList);
