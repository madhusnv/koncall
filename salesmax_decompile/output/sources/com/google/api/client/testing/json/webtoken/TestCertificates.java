...
public class TestCertificates {
    ...
    public static class CertData {
        ...
        public X509TrustManager getTrustManager() throws NoSuchAlgorithmException, IOException, KeyStoreException, CertificateException {
    ...
    public static JsonWebSignature getJsonWebSignature() {
        if (jsonWebSignature == null) {
            ...
            arrayListNewArrayList.add(FOO_BAR_COM_CERT.getBase64Der());
            arrayListNewArrayList.add(CA_CERT.getBase64Der());
            header.setX509Certificates(arrayListNewArrayList);
            JsonWebToken.Payload payload = new JsonWebToken.Payload();
            payload.set("foo", (Object) "bar");
            int iIndexOf = JWS_SIGNATURE.indexOf(46, 2723);
            jsonWebSignature = new JsonWebSignature(header, payload, Base64.decodeBase64(JWS_SIGNATURE.substring(iIndexOf + 1)), StringUtils.getBytesUtf8(JWS_SIGNATURE.substring(0, iIndexOf)));
        }
