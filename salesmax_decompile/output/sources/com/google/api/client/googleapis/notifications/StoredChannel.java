...
public final class StoredChannel implements Serializable {
    ...
    public String toString() {
        return Objects.toStringHelper(StoredChannel.class).add("notificationCallback", getNotificationCallback()).add("clientToken", getClientToken()).add("expiration", getExpiration()).add(OutcomeConstants.OUTCOME_ID, getId()).add("topicId", getTopicId()).toString();
    }
