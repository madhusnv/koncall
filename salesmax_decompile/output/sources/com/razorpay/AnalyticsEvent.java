...
enum AnalyticsEvent {
    ...
    CHECKOUT_PLUGIN_INTERNAL_CALLBACK_SUCCESS("ch:amz_pay:and", "internal:callback", FirebaseAnalytics.Param.SUCCESS),
    ...
    CUSTOM_UI_PLUGIN_INTERNAL_CALLBACK_SUCCESS("cu:and", "internal:callback", FirebaseAnalytics.Param.SUCCESS),
    ...
    CUSTOMUI_INTERNAL_CALLBACK_SUCCESS("cu:and", "internal:callback", FirebaseAnalytics.Param.SUCCESS),
    ...
    AMAZON_INTERNAL_CALLBACK_SUCCESS("amz_pay:and", "internal:callback", FirebaseAnalytics.Param.SUCCESS),
    AMAZON_INTERNAL_CALLBACK_ERROR("amz_pay:and", "internal:callback", "S1"),
    AMAZON_PWAIN_CALLBACK_SUCCESS("amz_pay:and", "pwain:callback", FirebaseAnalytics.Param.SUCCESS),
    ...
    GOOGLEPAY_PAYMENT_CALLBACK_SUCCESS("google_pay:and", "googlepay:callback", FirebaseAnalytics.Param.SUCCESS),
    ...
    GOOGLEPAY_VERIFY_PAYMENT_SUCCESS_CALLED("google_pay:and", "cb:sign_encrypt_response", FirebaseAnalytics.Param.SUCCESS),
