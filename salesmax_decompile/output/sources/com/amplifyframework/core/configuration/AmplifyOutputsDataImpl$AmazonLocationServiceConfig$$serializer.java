...
public final class AmplifyOutputsDataImpl$AmazonLocationServiceConfig$$serializer implements yn7 {
    ...
    static {
        ...
        ubd ubdVar = new ubd("com.amplifyframework.core.configuration.AmplifyOutputsDataImpl.AmazonLocationServiceConfig", amplifyOutputsDataImpl$AmazonLocationServiceConfig$$serializer, 1);
        ubdVar.m51338k("style", false);
        descriptor = ubdVar;
    }
    ...
    @Override // p001o.bn5
    public AmplifyOutputsDataImpl.AmazonLocationServiceConfig deserialize(w75 w75Var) {
        String strMo17247p;
        ...
        return new AmplifyOutputsDataImpl.AmazonLocationServiceConfig(i, strMo17247p, null);
    }
    ...
    @Override // p001o.iff
    public void serialize(h76 h76Var, AmplifyOutputsDataImpl.AmazonLocationServiceConfig amazonLocationServiceConfig) {
        sq8.m48649h(h76Var, "encoder");
        sq8.m48649h(amazonLocationServiceConfig, "value");
        uef descriptor2 = getDescriptor();
        lo3 lo3VarMo29876b = h76Var.mo29876b(descriptor2);
        lo3VarMo29876b.mo37568p(descriptor2, 0, amazonLocationServiceConfig.getStyle());
