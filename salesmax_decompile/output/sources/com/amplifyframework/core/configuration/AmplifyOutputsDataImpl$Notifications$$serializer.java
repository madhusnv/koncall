...
public final class AmplifyOutputsDataImpl$Notifications$$serializer implements yn7 {
    ...
    static {
        ...
        ubd ubdVar = new ubd("com.amplifyframework.core.configuration.AmplifyOutputsDataImpl.Notifications", amplifyOutputsDataImpl$Notifications$$serializer, 3);
        ubdVar.m51338k("awsRegion", false);
        ubdVar.m51338k("amazonPinpointAppId", false);
        ubdVar.m51338k("channels", false);
        descriptor = ubdVar;
    }
    ...
    public dc9[] childSerializers() {
        dc9[] dc9VarArr = AmplifyOutputsDataImpl.Notifications.$childSerializers;
        p8g p8gVar = p8g.f39602a;
        return new dc9[]{p8gVar, p8gVar, dc9VarArr[2]};
    }

    @Override // p001o.bn5
    public AmplifyOutputsDataImpl.Notifications deserialize(w75 w75Var) {
        int i;
        String str;
        String str2;
        List list;
        ...
        return new AmplifyOutputsDataImpl.Notifications(i, str, str2, list, null);
    }
    ...
    @Override // p001o.iff
    public void serialize(h76 h76Var, AmplifyOutputsDataImpl.Notifications notifications) {
        sq8.m48649h(h76Var, "encoder");
        sq8.m48649h(notifications, "value");
        uef descriptor2 = getDescriptor();
        lo3 lo3VarMo29876b = h76Var.mo29876b(descriptor2);
        AmplifyOutputsDataImpl.Notifications.write$Self(notifications, lo3VarMo29876b, descriptor2);
