...
public final class AmplifyOutputsDataImpl$Geo$GeofenceCollections$$serializer implements yn7 {
    ...
    static {
        ...
        ubd ubdVar = new ubd("com.amplifyframework.core.configuration.AmplifyOutputsDataImpl.Geo.GeofenceCollections", amplifyOutputsDataImpl$Geo$GeofenceCollections$$serializer, 2);
    ...
    public dc9[] childSerializers() {
        return new dc9[]{AmplifyOutputsDataImpl.Geo.GeofenceCollections.$childSerializers[0], p8g.f39602a};
    }

    @Override // p001o.bn5
    public AmplifyOutputsDataImpl.Geo.GeofenceCollections deserialize(w75 w75Var) {
        Set set;
        String strMo17247p;
        int i;
        ...
        dc9[] dc9VarArr = AmplifyOutputsDataImpl.Geo.GeofenceCollections.$childSerializers;
        ...
        return new AmplifyOutputsDataImpl.Geo.GeofenceCollections(i, set, strMo17247p, null);
    }
    ...
    @Override // p001o.iff
    public void serialize(h76 h76Var, AmplifyOutputsDataImpl.Geo.GeofenceCollections geofenceCollections) {
        sq8.m48649h(h76Var, "encoder");
        sq8.m48649h(geofenceCollections, "value");
        uef descriptor2 = getDescriptor();
        lo3 lo3VarMo29876b = h76Var.mo29876b(descriptor2);
        AmplifyOutputsDataImpl.Geo.GeofenceCollections.write$Self(geofenceCollections, lo3VarMo29876b, descriptor2);
