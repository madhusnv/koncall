...
public final class AmplifyOutputsDataImpl$StorageBucket$$serializer implements yn7 {
    ...
    static {
        ...
        ubd ubdVar = new ubd("com.amplifyframework.core.configuration.AmplifyOutputsDataImpl.StorageBucket", amplifyOutputsDataImpl$StorageBucket$$serializer, 3);
        ubdVar.m51338k("name", false);
    ...
    public dc9[] childSerializers() {
        ...
        return new dc9[]{p8gVar, p8gVar, p8gVar};
    }

    @Override // p001o.bn5
    public AmplifyOutputsDataImpl.StorageBucket deserialize(w75 w75Var) {
        String str;
        String strMo17247p;
        String str2;
        int i;
        ...
        if (jo3VarMo20420b.mo17245n()) {
            ...
            str = strMo17247p2;
            strMo17247p = jo3VarMo20420b.mo17247p(descriptor2, 2);
            str2 = strMo17247p3;
            i = 7;
        } else {
            ...
            while (z) {
                ...
                if (iMo16814k == -1) {
                    ...
                    strMo17247p6 = jo3VarMo20420b.mo17247p(descriptor2, 1);
                    i2 |= 2;
                } else {
                    if (iMo16814k != 2) {
                        throw new i4i(iMo16814k);
                    }
                    strMo17247p5 = jo3VarMo20420b.mo17247p(descriptor2, 2);
                    i2 |= 4;
                }
            }
            str = strMo17247p4;
            strMo17247p = strMo17247p5;
            str2 = strMo17247p6;
            i = i2;
        }
        jo3VarMo20420b.mo18548c(descriptor2);
        return new AmplifyOutputsDataImpl.StorageBucket(i, str, str2, strMo17247p, null);
    }
    ...
    @Override // p001o.iff
    public void serialize(h76 h76Var, AmplifyOutputsDataImpl.StorageBucket storageBucket) {
        sq8.m48649h(h76Var, "encoder");
        sq8.m48649h(storageBucket, "value");
        uef descriptor2 = getDescriptor();
        lo3 lo3VarMo29876b = h76Var.mo29876b(descriptor2);
        AmplifyOutputsDataImpl.StorageBucket.write$Self(storageBucket, lo3VarMo29876b, descriptor2);
