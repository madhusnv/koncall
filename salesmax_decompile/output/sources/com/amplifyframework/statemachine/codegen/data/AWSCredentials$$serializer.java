...
public final class AWSCredentials$$serializer implements yn7 {
    ...
    static {
        ...
        ubd ubdVar = new ubd("com.amplifyframework.statemachine.codegen.data.AWSCredentials", aWSCredentials$$serializer, 4);
    ...
    @Override // p001o.bn5
    public AWSCredentials deserialize(w75 w75Var) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new AWSCredentials(i, str, str2, str3, l, null);
    }
    ...
    @Override // p001o.iff
    public void serialize(h76 h76Var, AWSCredentials aWSCredentials) {
        sq8.m48649h(h76Var, "encoder");
        sq8.m48649h(aWSCredentials, "value");
        uef descriptor2 = getDescriptor();
        lo3 lo3VarMo29876b = h76Var.mo29876b(descriptor2);
        AWSCredentials.write$Self(aWSCredentials, lo3VarMo29876b, descriptor2);
