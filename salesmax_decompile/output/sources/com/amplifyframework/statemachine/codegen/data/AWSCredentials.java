...
public final class AWSCredentials {
    ...
    public /* synthetic */ AWSCredentials(int i, String str, String str2, String str3, Long l, fff fffVar) {
        if (15 != (i & 15)) {
            tbd.m49692a(i, 15, AWSCredentials$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final /* synthetic */ void write$Self(AWSCredentials aWSCredentials, lo3 lo3Var, uef uefVar) {
        p8g p8gVar = p8g.f39602a;
        lo3Var.mo37571z(uefVar, 0, p8gVar, aWSCredentials.accessKeyId);
        lo3Var.mo37571z(uefVar, 1, p8gVar, aWSCredentials.secretAccessKey);
        lo3Var.mo37571z(uefVar, 2, p8gVar, aWSCredentials.sessionToken);
        lo3Var.mo37571z(uefVar, 3, qla.f42120a, aWSCredentials.expiration);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return sq8.m48644c(this.accessKeyId, aWSCredentials.accessKeyId) && sq8.m48644c(this.secretAccessKey, aWSCredentials.secretAccessKey) && sq8.m48644c(this.sessionToken, aWSCredentials.sessionToken) && sq8.m48644c(this.expiration, aWSCredentials.expiration);
    }
