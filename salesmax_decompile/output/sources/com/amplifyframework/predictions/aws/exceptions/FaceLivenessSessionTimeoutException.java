...
public final class FaceLivenessSessionTimeoutException extends PredictionsException {
    ...
    public /* synthetic */ FaceLivenessSessionTimeoutException(String str, Throwable th, String str2, int i, id5 id5Var) {
    ...
    public FaceLivenessSessionTimeoutException(String str, Throwable th, String str2) {
        super(str, th, str2);
