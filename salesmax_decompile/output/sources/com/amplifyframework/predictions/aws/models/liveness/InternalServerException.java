...
public final class InternalServerException extends Exception {
    ...
    public /* synthetic */ InternalServerException(int i, String str, fff fffVar) {
        if (1 != (i & 1)) {
            tbd.m49692a(i, 1, InternalServerException$$serializer.INSTANCE.getDescriptor());
        }
        this.message = str;
    }
    ...
    public final InternalServerException copy(String str) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof InternalServerException) && sq8.m48644c(this.message, ((InternalServerException) obj).message);
    }
