...
public final class TargetFace$$serializer implements yn7 {
    ...
    static {
        ...
        ubd ubdVar = new ubd("com.amplifyframework.predictions.aws.models.liveness.TargetFace", targetFace$$serializer, 3);
        ubdVar.m51338k("BoundingBox", false);
        ubdVar.m51338k("FaceDetectedInTargetPositionStartTimestamp", false);
        ubdVar.m51338k("FaceDetectedInTargetPositionEndTimestamp", false);
        descriptor = ubdVar;
    }
    ...
    public dc9[] childSerializers() {
        ...
        return new dc9[]{BoundingBox$$serializer.INSTANCE, qlaVar, qlaVar};
    }

    @Override // p001o.bn5
    public TargetFace deserialize(w75 w75Var) {
        int i;
        ...
        if (jo3VarMo20420b.mo17245n()) {
            ...
            jMo17220H2 = jo3VarMo20420b.mo17220H(descriptor2, 2);
        } else {
            long jMo17220H3 = 0;
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (iMo16814k == -1) {
                    ...
                    jMo17220H3 = jo3VarMo20420b.mo17220H(descriptor2, 1);
                    i2 |= 2;
                } else {
                    if (iMo16814k != 2) {
                        throw new i4i(iMo16814k);
                    }
                    jMo17220H4 = jo3VarMo20420b.mo17220H(descriptor2, 2);
                    i2 |= 4;
                }
            }
            i = i2;
            boundingBox = boundingBox2;
            jMo17220H = jMo17220H3;
            jMo17220H2 = jMo17220H4;
        }
        jo3VarMo20420b.mo18548c(descriptor2);
        return new TargetFace(i, boundingBox, jMo17220H, jMo17220H2, null);
    }
    ...
    @Override // p001o.iff
    public void serialize(h76 h76Var, TargetFace targetFace) {
        sq8.m48649h(h76Var, "encoder");
        sq8.m48649h(targetFace, "value");
        uef descriptor2 = getDescriptor();
        lo3 lo3VarMo29876b = h76Var.mo29876b(descriptor2);
        TargetFace.write$Self(targetFace, lo3VarMo29876b, descriptor2);
