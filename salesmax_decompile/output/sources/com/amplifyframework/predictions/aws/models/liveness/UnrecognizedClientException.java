...
public final class UnrecognizedClientException extends Exception {
    ...
    public /* synthetic */ UnrecognizedClientException(int i, String str, fff fffVar) {
        if (1 != (i & 1)) {
            tbd.m49692a(i, 1, UnrecognizedClientException$$serializer.INSTANCE.getDescriptor());
        }
        this.message = str;
    }
    ...
    public final UnrecognizedClientException copy(String str) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof UnrecognizedClientException) && sq8.m48644c(this.message, ((UnrecognizedClientException) obj).message);
    }
    ...
    public UnrecognizedClientException(String str) {
        super(str);
        sq8.m48649h(str, OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE);
        this.message = str;
    }
