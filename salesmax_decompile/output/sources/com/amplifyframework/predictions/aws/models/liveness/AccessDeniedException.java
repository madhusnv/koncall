...
public final class AccessDeniedException extends Exception {
    ...
    public /* synthetic */ AccessDeniedException(int i, String str, fff fffVar) {
        if (1 != (i & 1)) {
            tbd.m49692a(i, 1, AccessDeniedException$$serializer.INSTANCE.getDescriptor());
        }
        this.message = str;
    }
    ...
    public final AccessDeniedException copy(String str) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof AccessDeniedException) && sq8.m48644c(this.message, ((AccessDeniedException) obj).message);
    }
