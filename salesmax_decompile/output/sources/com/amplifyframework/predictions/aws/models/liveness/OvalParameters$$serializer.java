...
public final class OvalParameters$$serializer implements yn7 {
    public static final OvalParameters$$serializer INSTANCE;
    private static final /* synthetic */ ubd descriptor;

    static {
        OvalParameters$$serializer ovalParameters$$serializer = new OvalParameters$$serializer();
        INSTANCE = ovalParameters$$serializer;
        ubd ubdVar = new ubd("com.amplifyframework.predictions.aws.models.liveness.OvalParameters", ovalParameters$$serializer, 4);
        ubdVar.m51338k("Width", false);
        ubdVar.m51338k("Height", false);
        ubdVar.m51338k("CenterX", false);
        ubdVar.m51338k("CenterY", false);
        descriptor = ubdVar;
    }

    private OvalParameters$$serializer() {
    }
    ...
    @Override // p001o.bn5
    public OvalParameters deserialize(w75 w75Var) {
        float f;
        float fMo17217E;
        float f2;
        float f3;
        ...
        return new OvalParameters(i, f, f3, f2, fMo17217E, null);
    }
    ...
    @Override // p001o.iff
    public void serialize(h76 h76Var, OvalParameters ovalParameters) {
        sq8.m48649h(h76Var, "encoder");
        sq8.m48649h(ovalParameters, "value");
        uef descriptor2 = getDescriptor();
        lo3 lo3VarMo29876b = h76Var.mo29876b(descriptor2);
        OvalParameters.write$Self(ovalParameters, lo3VarMo29876b, descriptor2);
