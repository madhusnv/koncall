...
public final class VideoEvent$$serializer implements yn7 {
    ...
    static {
        ...
        ubd ubdVar = new ubd("com.amplifyframework.predictions.aws.models.liveness.VideoEvent", videoEvent$$serializer, 2);
        ubdVar.m51338k("VideoChunk", false);
    ...
    public dc9[] childSerializers() {
        return new dc9[]{ByteBufferSerializer.INSTANCE, qla.f42120a};
    }

    @Override // p001o.bn5
    public VideoEvent deserialize(w75 w75Var) {
        ...
        if (jo3VarMo20420b.mo17245n()) {
            byteBuffer = (ByteBuffer) jo3VarMo20420b.mo17252u(descriptor2, 0, ByteBufferSerializer.INSTANCE, null);
            ...
            while (z) {
                ...
                if (iMo16814k == -1) {
                    ...
                    byteBuffer2 = (ByteBuffer) jo3VarMo20420b.mo17252u(descriptor2, 0, ByteBufferSerializer.INSTANCE, byteBuffer2);
                    i2 |= 1;
                } else {
                    if (iMo16814k != 1) {
        ...
        return new VideoEvent(i, byteBuffer, jMo17220H, null);
    }
    ...
    @Override // p001o.iff
    public void serialize(h76 h76Var, VideoEvent videoEvent) {
        sq8.m48649h(h76Var, "encoder");
        sq8.m48649h(videoEvent, "value");
        uef descriptor2 = getDescriptor();
        lo3 lo3VarMo29876b = h76Var.mo29876b(descriptor2);
        VideoEvent.write$Self(videoEvent, lo3VarMo29876b, descriptor2);
