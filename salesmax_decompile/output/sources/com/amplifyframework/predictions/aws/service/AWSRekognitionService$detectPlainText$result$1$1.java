...
public final class AWSRekognitionService$detectPlainText$result$1$1 extends kf9 implements xk7 {
    final /* synthetic */ ByteBuffer $imageData;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AWSRekognitionService$detectPlainText$result$1$1(ByteBuffer byteBuffer) {
        super(1);
