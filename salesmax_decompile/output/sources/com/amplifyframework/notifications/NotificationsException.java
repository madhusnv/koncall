...
public class NotificationsException extends AmplifyException {
    public /* synthetic */ NotificationsException(String str, String str2, Throwable th, int i, id5 id5Var) {
        this(str, str2, (i & 4) != 0 ? null : th);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NotificationsException(String str, String str2, Throwable th) {
        super(str, th, str2);
