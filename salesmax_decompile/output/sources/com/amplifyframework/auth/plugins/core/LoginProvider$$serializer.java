...
public final class LoginProvider$$serializer implements yn7 {
    ...
    static {
        ...
        ubd ubdVar = new ubd("com.amplifyframework.auth.plugins.core.LoginProvider", loginProvider$$serializer, 2);
        ubdVar.m51338k("name", false);
        ubdVar.m51338k("userIdentifier", false);
        descriptor = ubdVar;
    }
    ...
    @Override // p001o.bn5
    public LoginProvider deserialize(w75 w75Var) {
        String strMo17247p;
        String strMo17247p2;
        int i;
        ...
        return new LoginProvider(i, strMo17247p, strMo17247p2, null);
    }
    ...
    @Override // p001o.iff
    public void serialize(h76 h76Var, LoginProvider loginProvider) {
        sq8.m48649h(h76Var, "encoder");
        sq8.m48649h(loginProvider, "value");
        uef descriptor2 = getDescriptor();
        lo3 lo3VarMo29876b = h76Var.mo29876b(descriptor2);
        LoginProvider.write$Self(loginProvider, lo3VarMo29876b, descriptor2);
