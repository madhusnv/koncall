...
public final class AWSCredentialsInternal$$serializer implements yn7 {
    ...
    static {
        ...
        ubd ubdVar = new ubd("com.amplifyframework.auth.plugins.core.data.AWSCredentialsInternal", aWSCredentialsInternal$$serializer, 4);
        ubdVar.m51338k("accessKeyId", false);
        ubdVar.m51338k("secretAccessKey", false);
        ubdVar.m51338k("sessionToken", false);
    ...
    @Override // p001o.bn5
    public AWSCredentialsInternal deserialize(w75 w75Var) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        return new AWSCredentialsInternal(i, str, str2, str3, l, null);
    }
    ...
    @Override // p001o.iff
    public void serialize(h76 h76Var, AWSCredentialsInternal aWSCredentialsInternal) {
        sq8.m48649h(h76Var, "encoder");
        sq8.m48649h(aWSCredentialsInternal, "value");
        uef descriptor2 = getDescriptor();
        lo3 lo3VarMo29876b = h76Var.mo29876b(descriptor2);
        AWSCredentialsInternal.write$Self(aWSCredentialsInternal, lo3VarMo29876b, descriptor2);
