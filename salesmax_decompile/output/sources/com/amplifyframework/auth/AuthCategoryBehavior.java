...
public interface AuthCategoryBehavior {
    void associateWebAuthnCredential(Activity activity, AuthAssociateWebAuthnCredentialsOptions authAssociateWebAuthnCredentialsOptions, Action action, Consumer<AuthException> consumer);

    void associateWebAuthnCredential(Activity activity, Action action, Consumer<AuthException> consumer);

    void autoSignIn(Consumer<AuthSignInResult> consumer, Consumer<AuthException> consumer2);
    ...
    void deleteWebAuthnCredential(String str, AuthDeleteWebAuthnCredentialOptions authDeleteWebAuthnCredentialOptions, Action action, Consumer<AuthException> consumer);

    void deleteWebAuthnCredential(String str, Action action, Consumer<AuthException> consumer);
    ...
    void listWebAuthnCredentials(AuthListWebAuthnCredentialsOptions authListWebAuthnCredentialsOptions, Consumer<AuthListWebAuthnCredentialsResult> consumer, Consumer<AuthException> consumer2);

    void listWebAuthnCredentials(Consumer<AuthListWebAuthnCredentialsResult> consumer, Consumer<AuthException> consumer2);
    ...
    void setUpTOTP(Consumer<TOTPSetupDetails> consumer, Consumer<AuthException> consumer2);
    ...
    void verifyTOTPSetup(String str, AuthVerifyTOTPSetupOptions authVerifyTOTPSetupOptions, Action action, Consumer<AuthException> consumer);

    void verifyTOTPSetup(String str, Action action, Consumer<AuthException> consumer);
}
