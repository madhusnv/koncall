...
public final class SignUpCognitoActions$initiateSignUpAction$1$evt$response$1$1$1 extends kf9 implements xk7 {
    final /* synthetic */ AuthUserAttribute $it;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SignUpCognitoActions$initiateSignUpAction$1$evt$response$1$1$1(AuthUserAttribute authUserAttribute) {
        super(1);
