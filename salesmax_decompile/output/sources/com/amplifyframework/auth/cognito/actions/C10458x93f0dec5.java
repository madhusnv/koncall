...
/* renamed from: com.amplifyframework.auth.cognito.actions.DeviceSRPCognitoSignInActions$respondDevicePasswordVerifier$1$evt$2$respondToAuthChallenge$1 */
/* loaded from: classes5.dex */
public final class C10458x93f0dec5 extends kf9 implements xk7 {
    ...
    public C10458x93f0dec5(AuthEnvironment authEnvironment, Map<String, String> map, DeviceSRPSignInEvent.EventType.RespondDevicePasswordVerifier respondDevicePasswordVerifier, String str, String str2) {
        super(1);
    ...
    public final void invoke(wqe.C17950a c17950a) {
        ...
        c17950a.m54876j(cg2.C12659d.f18058c);
        ...
        if (str != null) {
            c17950a.m54867a(new C10459x5f3b0e1f(str));
        }
        String str2 = this.$encodedContextData;
        if (str2 != null) {
            c17950a.m54881o(new C10460x5f3b11e0(str2));
        }
    }
}
