...
public class UserCancelledException extends ServiceException {
    public /* synthetic */ UserCancelledException(String str, String str2, Throwable th, int i, id5 id5Var) {
        this(str, str2, (i & 4) != 0 ? null : th);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UserCancelledException(String str, String str2, Throwable th) {
        super(str, str2, th);
