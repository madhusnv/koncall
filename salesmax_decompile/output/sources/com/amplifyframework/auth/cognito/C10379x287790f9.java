...
/* renamed from: com.amplifyframework.auth.cognito.AWSCognitoAuthService$Companion$fromConfiguration$cognitoIdentityClient$1$1 */
/* loaded from: classes5.dex */
public final class C10379x287790f9 extends kf9 implements xk7 {
    final /* synthetic */ Map<String, String> $customPairs;
    final /* synthetic */ IdentityPoolConfiguration $it;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C10379x287790f9(IdentityPoolConfiguration identityPoolConfiguration, Map<String, String> map) {
        super(1);
    ...
    public final void invoke(cg3.C12676c.a aVar) {
        ...
        listM21168w.add(new sn8() { // from class: com.amplifyframework.auth.cognito.AWSCognitoAuthService$Companion$fromConfiguration$cognitoIdentityClient$1$1.1
            @Override // p001o.sn8
