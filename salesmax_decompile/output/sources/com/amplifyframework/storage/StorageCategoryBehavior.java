...
public interface StorageCategoryBehavior {
    StorageDownloadFileOperation<?> downloadFile(StoragePath storagePath, File file, Consumer<StorageDownloadFileResult> consumer, Consumer<StorageException> consumer2);

    StorageDownloadFileOperation<?> downloadFile(StoragePath storagePath, File file, StorageDownloadFileOptions storageDownloadFileOptions, Consumer<StorageDownloadFileResult> consumer, Consumer<StorageException> consumer2);

    StorageDownloadFileOperation<?> downloadFile(StoragePath storagePath, File file, StorageDownloadFileOptions storageDownloadFileOptions, Consumer<StorageTransferProgress> consumer, Consumer<StorageDownloadFileResult> consumer2, Consumer<StorageException> consumer3);
    ...
    StorageGetUrlOperation<?> getUrl(StoragePath storagePath, Consumer<StorageGetUrlResult> consumer, Consumer<StorageException> consumer2);

    StorageGetUrlOperation<?> getUrl(StoragePath storagePath, StorageGetUrlOptions storageGetUrlOptions, Consumer<StorageGetUrlResult> consumer, Consumer<StorageException> consumer2);
    ...
    StorageListOperation<?> list(StoragePath storagePath, StoragePagedListOptions storagePagedListOptions, Consumer<StorageListResult> consumer, Consumer<StorageException> consumer2);
    ...
    @Deprecated
    StorageListOperation<?> list(String str, StoragePagedListOptions storagePagedListOptions, Consumer<StorageListResult> consumer, Consumer<StorageException> consumer2);

    StorageRemoveOperation<?> remove(StoragePath storagePath, Consumer<StorageRemoveResult> consumer, Consumer<StorageException> consumer2);

    StorageRemoveOperation<?> remove(StoragePath storagePath, StorageRemoveOptions storageRemoveOptions, Consumer<StorageRemoveResult> consumer, Consumer<StorageException> consumer2);
    ...
    StorageUploadFileOperation<?> uploadFile(StoragePath storagePath, File file, Consumer<StorageUploadFileResult> consumer, Consumer<StorageException> consumer2);

    StorageUploadFileOperation<?> uploadFile(StoragePath storagePath, File file, StorageUploadFileOptions storageUploadFileOptions, Consumer<StorageUploadFileResult> consumer, Consumer<StorageException> consumer2);

    StorageUploadFileOperation<?> uploadFile(StoragePath storagePath, File file, StorageUploadFileOptions storageUploadFileOptions, Consumer<StorageTransferProgress> consumer, Consumer<StorageUploadFileResult> consumer2, Consumer<StorageException> consumer3);
    ...
    StorageUploadInputStreamOperation<?> uploadInputStream(StoragePath storagePath, InputStream inputStream, Consumer<StorageUploadInputStreamResult> consumer, Consumer<StorageException> consumer2);

    StorageUploadInputStreamOperation<?> uploadInputStream(StoragePath storagePath, InputStream inputStream, StorageUploadInputStreamOptions storageUploadInputStreamOptions, Consumer<StorageUploadInputStreamResult> consumer, Consumer<StorageException> consumer2);

    StorageUploadInputStreamOperation<?> uploadInputStream(StoragePath storagePath, InputStream inputStream, StorageUploadInputStreamOptions storageUploadInputStreamOptions, Consumer<StorageTransferProgress> consumer, Consumer<StorageUploadInputStreamResult> consumer2, Consumer<StorageException> consumer3);
