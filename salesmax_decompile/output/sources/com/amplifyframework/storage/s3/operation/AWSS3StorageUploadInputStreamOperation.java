...
public final class AWSS3StorageUploadInputStreamOperation extends StorageUploadInputStreamOperation<AWSS3StorageUploadRequest<InputStream>> {
    ...
    public final class UploadTransferListener implements TransferListener {
        ...
        public void onError(int i, Exception exc) {
            ...
            if (onError != null) {
                onError.accept(new StorageException("Something went wrong with your AWS S3 Storage upload input stream operation", exc, "See attached exception for more information and suggestions"));
            }
        }
        ...
        public void onStateChanged(int i, TransferState transferState, String str) {
            ...
            if (WhenMappings.$EnumSwitchMapping$0[transferState.ordinal()] != 1 || (onSuccess = AWSS3StorageUploadInputStreamOperation.this.getOnSuccess()) == null) {
                return;
            }
            onSuccess.accept(StorageUploadInputStreamResult.fromKey(str));
        }
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public AWSS3StorageUploadInputStreamOperation(String str, StorageService storageService, ExecutorService executorService, AuthCredentialsProvider authCredentialsProvider, AWSS3StoragePluginConfiguration aWSS3StoragePluginConfiguration) {
    ...
    public static final void cancel$lambda$7(AWSS3StorageUploadInputStreamOperation aWSS3StorageUploadInputStreamOperation) {
        sq8.m48649h(aWSS3StorageUploadInputStreamOperation, "this$0");
        ...
        if (transferObserver != null) {
            try {
                ...
                if (onError != null) {
                    onError.accept(new StorageException("Something went wrong while attempting to cancel your AWS S3 Storage upload input stream operation", e, "See attached exception for more information and suggestions"));
                }
            }
        }
    }
    ...
    public static final void pause$lambda$3(AWSS3StorageUploadInputStreamOperation aWSS3StorageUploadInputStreamOperation) {
        ...
        if (transferObserver != null) {
            try {
                ...
                Consumer<StorageException> onError = aWSS3StorageUploadInputStreamOperation.getOnError();
                if (onError != null) {
                    onError.accept(new StorageException("Something went wrong while attempting to pause your AWS S3 Storage upload input stream operation", e, "See attached exception for more information and suggestions"));
                }
            }
        }
    }
    ...
    public static final void resume$lambda$5(AWSS3StorageUploadInputStreamOperation aWSS3StorageUploadInputStreamOperation) {
        ...
        if (transferObserver != null) {
            try {
                ...
                Consumer<StorageException> onError = aWSS3StorageUploadInputStreamOperation.getOnError();
                if (onError != null) {
                    onError.accept(new StorageException("Something went wrong while attempting to resume your AWS S3 Storage upload input stream operation", e, "See attached exception for more information and suggestions"));
                }
            }
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void start$lambda$1(final AWSS3StorageUploadInputStreamOperation aWSS3StorageUploadInputStreamOperation, final AWSS3StorageUploadRequest aWSS3StorageUploadRequest) {
        sq8.m48649h(aWSS3StorageUploadInputStreamOperation, "this$0");
        ...
        aWSS3PluginPrefixResolver.resolvePrefix(accessLevel, aWSS3StorageUploadRequest.getTargetIdentityId(), new Consumer() { // from class: o.m5
            @Override // com.amplifyframework.core.Consumer
            public final void accept(Object obj) {
                AWSS3StorageUploadInputStreamOperation.start$lambda$1$lambda$0(aWSS3StorageUploadRequest, aWSS3StorageUploadInputStreamOperation, (String) obj);
            }
        }, aWSS3StorageUploadInputStreamOperation.getOnError());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void start$lambda$1$lambda$0(AWSS3StorageUploadRequest aWSS3StorageUploadRequest, AWSS3StorageUploadInputStreamOperation aWSS3StorageUploadInputStreamOperation, String str) {
        sq8.m48649h(aWSS3StorageUploadRequest, "$uploadRequest");
        sq8.m48649h(aWSS3StorageUploadInputStreamOperation, "this$0");
        ...
        try {
            ...
            TransferObserver transferObserverUploadInputStream = aWSS3StorageUploadInputStreamOperation.storageService.uploadInputStream(aWSS3StorageUploadInputStreamOperation.getTransferId(), str2, inputStream, objectMetadata, aWSS3StorageUploadRequest.useAccelerateEndpoint());
    ...
    public void cancel() {
        this.executorService.submit(new Runnable() { // from class: o.n5
            @Override // java.lang.Runnable
            public final void run() {
                AWSS3StorageUploadInputStreamOperation.cancel$lambda$7(this.f36384a);
            }
        });
    }
    ...
    public void pause() {
        this.executorService.submit(new Runnable() { // from class: o.o5
            @Override // java.lang.Runnable
            public final void run() {
                AWSS3StorageUploadInputStreamOperation.pause$lambda$3(this.f37775a);
            }
        });
    }
    ...
    @Override // com.amplifyframework.core.async.Resumable
    public void resume() {
        this.executorService.submit(new Runnable() { // from class: o.l5
            @Override // java.lang.Runnable
            public final void run() {
                AWSS3StorageUploadInputStreamOperation.resume$lambda$5(this.f33263a);
            }
        });
    }
    ...
    public void start() {
        ...
        if (this.transferObserver == null && (request = getRequest()) != null) {
            this.executorService.submit(new Runnable() { // from class: o.p5
                @Override // java.lang.Runnable
                public final void run() {
                    AWSS3StorageUploadInputStreamOperation.start$lambda$1(this.f39329a, request);
                }
            });
        }
    }
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public AWSS3StorageUploadInputStreamOperation(String str, StorageService storageService, ExecutorService executorService, AuthCredentialsProvider authCredentialsProvider, AWSS3StoragePluginConfiguration aWSS3StoragePluginConfiguration, AWSS3StorageUploadRequest<InputStream> aWSS3StorageUploadRequest) {
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public AWSS3StorageUploadInputStreamOperation(String str, StorageService storageService, ExecutorService executorService, AuthCredentialsProvider authCredentialsProvider, AWSS3StoragePluginConfiguration aWSS3StoragePluginConfiguration, AWSS3StorageUploadRequest<InputStream> aWSS3StorageUploadRequest, TransferObserver transferObserver) {
