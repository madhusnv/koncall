...
/* loaded from: salesmax.apk:org/objectweb/asm/Frame.SCL.lombok */
class Frame {
    ...
    static int getAbstractTypeFromApiFormat(SymbolTable symbolTable, Object type2) {
        if (type2 instanceof Integer) {
            return 4194304 | ((Integer) type2).intValue();
        }
        if (type2 instanceof String) {
            String descriptor = Type.getObjectType((String) type2).getDescriptor();
            return getAbstractTypeFromDescriptor(symbolTable, descriptor, 0);
        }
        return UNINITIALIZED_KIND | symbolTable.addUninitializedType("", ((Label) type2).bytecodeOffset);
    }
                ...
                if (arg > 0) {
                    ...
                    if (previousLocalType2 == LONG || previousLocalType2 == DOUBLE) {
                        ...
                        if ((previousLocalType2 & KIND_MASK) == 16777216 || (previousLocalType2 & KIND_MASK) == STACK_KIND) {
                            setLocal(arg - 1, previousLocalType2 | TOP_IF_LONG_OR_DOUBLE_FLAG);
                            return;
                        }
                        return;
                    }
    ...
    private int getConcreteOutputType(int abstractOutputType, int numStack) {
        ...
        if (kind == STACK_KIND) {
            ...
            if ((abstractOutputType & TOP_IF_LONG_OR_DOUBLE_FLAG) != 0 && (concreteOutputType2 == LONG || concreteOutputType2 == DOUBLE)) {
