...
/* loaded from: salesmax.apk:org/objectweb/asm/AnnotationWriter.SCL.lombok */
final class AnnotationWriter extends AnnotationVisitor {
    ...
    public void visit(String name, Object value) {
        ...
        if (value instanceof String) {
            this.annotation.put12(Opcodes.DREM, this.symbolTable.addConstantUtf8((String) value));
            return;
        }
