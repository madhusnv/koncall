...
/* loaded from: salesmax.apk:org/objectweb/asm/ConstantDynamic.SCL.lombok */
public final class ConstantDynamic {
    ...
    public String toString() {
        return this.name + " : " + this.descriptor + TokenParser.SP + this.bootstrapMethod + TokenParser.SP + Arrays.toString(this.bootstrapMethodArguments);
    }
}
