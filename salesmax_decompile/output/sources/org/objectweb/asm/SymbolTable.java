...
/* loaded from: salesmax.apk:org/objectweb/asm/SymbolTable.SCL.lombok */
final class SymbolTable {
    ...
    private void copyBootstrapMethods(ClassReader classReader, char[] charBuffer) {
        ...
        if (this.bootstrapMethodCount > 0) {
            ...
            for (int i2 = 0; i2 < this.bootstrapMethodCount; i2++) {
                ...
                add(new Entry(i2, 64, offset, hashCode & Api.BaseClientBuilder.API_PRIORITY_OTHER));
            }
        }
    }
    ...
    Symbol addConstant(Object value) {
        ...
        if (value instanceof Type) {
            ...
            int typeSort = type2.getSort();
            if (typeSort == 10) {
                return addConstantClass(type2.getInternalName());
            }
            if (typeSort == 11) {
                return addConstantMethodType(type2.getDescriptor());
            }
            return addConstantClass(type2.getDescriptor());
        }
    ...
    Symbol addBootstrapMethod(Handle bootstrapMethodHandle, Object... bootstrapMethodArguments) {
        ...
        return addBootstrapMethod(bootstrapMethodOffset, bootstrapMethodlength, hashCode & Api.BaseClientBuilder.API_PRIORITY_OTHER);
    }
    ...
    /* loaded from: salesmax.apk:org/objectweb/asm/SymbolTable$Entry.SCL.lombok */
