...
/* loaded from: salesmax.apk:org/objectweb/asm/commons/Remapper.SCL.lombok */
    ...
    private Type mapType(Type type2) {
        switch (type2.getSort()) {
            case 9:
                ...
                remappedDescriptor.append(mapType(type2.getElementType()).getDescriptor());
                return Type.getType(remappedDescriptor.toString());
            case 10:
                String remappedInternalName = map(type2.getInternalName());
