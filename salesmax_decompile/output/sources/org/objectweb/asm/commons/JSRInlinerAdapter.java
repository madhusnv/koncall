...
/* loaded from: salesmax.apk:org/objectweb/asm/commons/JSRInlinerAdapter.SCL.lombok */
public class JSRInlinerAdapter extends MethodNode implements Opcodes {
    ...
    private void emitInstantiation(Instantiation instantiation, List<Instantiation> worklist, InsnList newInstructions, List<TryCatchBlockNode> newTryCatchBlocks, List<LocalVariableNode> newLocalVariables) {
        ...
        for (TryCatchBlockNode tryCatchBlockNode : this.tryCatchBlocks) {
            ...
            if (start != end) {
                ...
                newTryCatchBlocks.add(new TryCatchBlockNode(start, end, handler, tryCatchBlockNode.f58185type));
            }
        }
    ...
    /* loaded from: salesmax.apk:org/objectweb/asm/commons/JSRInlinerAdapter$Instantiation.SCL.lombok */
