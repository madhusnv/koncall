...
/* loaded from: salesmax.apk:org/objectweb/asm/commons/LocalVariablesSorter.SCL.lombok */
public class LocalVariablesSorter extends MethodVisitor {
    ...
    public void visitFrame(int type2, int numLocal, Object[] local, int numStack, Object[] stack) {
        ...
        super.visitFrame(type2, remappedNumLocal, this.remappedLocalTypes, numStack, stack);
    ...
    public int newLocal(Type type2) {
        ...
        switch (type2.getSort()) {
            ...
            case 8:
                ...
                break;
            case 9:
                localType = type2.getDescriptor();
                break;
            case 10:
                localType = type2.getInternalName();
                break;
            default:
                throw new AssertionError();
        }
        int local = newLocalMapping(type2);
    ...
    private void setFrameLocal(int local, Object type2) {
        ...
        this.remappedLocalTypes[local] = type2;
    }
    ...
    private int remap(int var, Type type2) {
        ...
        if (value2 == 0) {
            value = newLocalMapping(type2);
            setLocalType(value, type2);
