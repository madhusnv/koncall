...
/* loaded from: salesmax.apk:org/objectweb/asm/commons/MethodRemapper.SCL.lombok */
public class MethodRemapper extends MethodVisitor {
    ...
    public void visitFrame(int type2, int numLocal, Object[] local, int numStack, Object[] stack) {
        super.visitFrame(type2, numLocal, remapFrameTypes(numLocal, local), numStack, remapFrameTypes(numStack, stack));
    }
