...
/* loaded from: salesmax.apk:org/objectweb/asm/tree/FrameNode.SCL.lombok */
public class FrameNode extends AbstractInsnNode {

    /* renamed from: type, reason: collision with root package name */
    public int f58184type;
    ...
    public FrameNode(int type2, int numLocal, Object[] local, int numStack, Object[] stack) {
        super(-1);
        this.f58184type = type2;
        switch (type2) {
            case -1:
            case 0:
    ...
    public void accept(MethodVisitor methodVisitor) {
        switch (this.f58184type) {
            case -1:
            case 0:
                methodVisitor.visitFrame(this.f58184type, this.local.size(), asArray(this.local), this.stack.size(), asArray(this.stack));
                return;
            case 1:
                methodVisitor.visitFrame(this.f58184type, this.local.size(), asArray(this.local), 0, null);
                return;
            case 2:
                methodVisitor.visitFrame(this.f58184type, this.local.size(), null, 0, null);
                return;
            case 3:
                methodVisitor.visitFrame(this.f58184type, 0, null, 0, null);
                return;
            case 4:
                methodVisitor.visitFrame(this.f58184type, 0, null, 1, asArray(this.stack));
                return;
            default:
                throw new IllegalArgumentException();
        }
    ...
    public AbstractInsnNode clone(Map<LabelNode, LabelNode> clonedLabels) {
        ...
        clone.f58184type = this.f58184type;
        if (this.local != null) {
