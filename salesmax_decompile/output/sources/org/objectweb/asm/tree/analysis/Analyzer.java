...
/* loaded from: salesmax.apk:org/objectweb/asm/tree/analysis/Analyzer.SCL.lombok */
            ...
            try {
                ...
                if (insnHandlers2 != null) {
                    for (TryCatchBlockNode tryCatchBlock2 : insnHandlers2) {
                        if (tryCatchBlock2.f58185type == null) {
                            catchType = Type.getObjectType("java/lang/Throwable");
                        } else {
                            catchType = Type.getObjectType(tryCatchBlock2.f58185type);
                        }
