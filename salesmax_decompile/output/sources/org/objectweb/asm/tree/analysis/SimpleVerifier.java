...
/* loaded from: salesmax.apk:org/objectweb/asm/tree/analysis/SimpleVerifier.SCL.lombok */
public class SimpleVerifier extends BasicVerifier {
    ...
    public BasicValue newValue(Type type2) {
        ...
        boolean isArray = type2.getSort() == 9;
        if (isArray) {
        ...
        BasicValue value = super.newValue(type2);
        if (BasicValue.REFERENCE_VALUE.equals(value)) {
            if (isArray) {
                BasicValue value2 = newValue(type2.getElementType());
    ...
    protected boolean isArrayValue(BasicValue value) {
        ...
        return type2 != null && (type2.getSort() == 9 || type2.equals(NULL_TYPE));
    }
        ...
        switch (expectedType.getSort()) {
            ...
            case 10:
                ...
                if (type2.getSort() == 10 || type2.getSort() == 9) {
                    if (isAssignableFrom(expectedType, type2)) {
                        return true;
                    }
    ...
    private BasicValue newArrayValue(Type type2, int dimensions) {
        if (dimensions == 0) {
        ...
        descriptor.append(type2.getDescriptor());
    ...
    protected boolean isInterface(Type type2) {
        ...
        return getClass(type2).isInterface();
    }
