...
/* loaded from: salesmax.apk:org/objectweb/asm/tree/MethodNode.SCL.lombok */
public class MethodNode extends MethodVisitor {
    ...
    public void visitFrame(int type2, int numLocal, Object[] local, int numStack, Object[] stack) {
        this.instructions.add(new FrameNode(type2, numLocal, local == null ? null : getLabelNodes(local), numStack, stack == null ? null : getLabelNodes(stack)));
    }
    ...
    public void visitTypeInsn(int opcode, String type2) {
        this.instructions.add(new TypeInsnNode(opcode, type2));
    }
    ...
    public void visitTryCatchBlock(Label start, Label end, Label handler, String type2) {
        TryCatchBlockNode tryCatchBlock = new TryCatchBlockNode(getLabelNode(start), getLabelNode(end), getLabelNode(handler), type2);
