...
public class SSLContextBuilder {
    ...
    public SSLContext build() throws KeyManagementException {
    ...
    public SSLContextBuilder loadKeyMaterial(File file, char[] cArr, char[] cArr2, PrivateKeyStrategy privateKeyStrategy) throws IOException, KeyStoreException {
    ...
    public SSLContextBuilder loadTrustMaterial(File file, char[] cArr, TrustStrategy trustStrategy) throws IOException, KeyStoreException {
    ...
    public SSLContextBuilder loadKeyMaterial(URL url, char[] cArr, char[] cArr2, PrivateKeyStrategy privateKeyStrategy) throws IOException, KeyStoreException {
    ...
    public SSLContextBuilder loadTrustMaterial(URL url, char[] cArr, TrustStrategy trustStrategy) throws IOException, KeyStoreException {
