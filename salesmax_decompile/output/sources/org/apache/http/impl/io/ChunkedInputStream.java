...
public class ChunkedInputStream extends InputStream {
    ...
    private long getChunkSize() throws MalformedChunkCodingException, ConnectionClosedException {
        int i = this.state;
        if (i != 1) {
            if (i != 3) {
    ...
    private void nextChunk() throws MalformedChunkCodingException, ConnectionClosedException {
