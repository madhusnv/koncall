...
public class HttpServer {
    ...
    public HttpServer(int i, InetAddress inetAddress, SocketConfig socketConfig, ServerSocketFactory serverSocketFactory, HttpService httpService, HttpConnectionFactory<? extends DefaultBHttpServerConnection> httpConnectionFactory, SSLServerSetupHandler sSLServerSetupHandler, ExceptionLogger exceptionLogger) {
        ...
        this.workerExecutorService = new WorkerPoolExecutor(0, Api.BaseClientBuilder.API_PRIORITY_OTHER, 1L, TimeUnit.SECONDS, new SynchronousQueue(), new ThreadFactoryImpl("HTTP-worker", threadGroup));
    ...
    public void start() throws SocketException {
        if (ec3.m24748a(this.status, Status.READY, Status.ACTIVE)) {
    ...
    public void stop() {
        if (ec3.m24748a(this.status, Status.ACTIVE, Status.STOPPING)) {
