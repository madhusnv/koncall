...
public class HttpProcessorBuilder {
    ...
    public HttpProcessor build() {
        ...
        LinkedList<HttpRequestInterceptor> linkedListBuild = chainBuilder != null ? chainBuilder.build() : null;
        ChainBuilder<HttpResponseInterceptor> chainBuilder2 = this.responseChainBuilder;
        return new ImmutableHttpProcessor(linkedListBuild, chainBuilder2 != null ? chainBuilder2.build() : null);
    }
