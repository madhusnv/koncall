...
/* loaded from: salesmax.apk:lombok/core/AgentLauncher.SCL.lombok */
public class AgentLauncher {
    private static final List<AgentInfo> AGENTS = Collections.unmodifiableList(Arrays.asList(new EclipsePatcherInfo(null)));

    /* loaded from: salesmax.apk:lombok/core/AgentLauncher$AgentLaunchable.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/core/AgentLauncher$AgentInfo.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/core/AgentLauncher$EclipsePatcherInfo.SCL.lombok */
