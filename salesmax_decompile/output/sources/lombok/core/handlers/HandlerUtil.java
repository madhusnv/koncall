...
/* loaded from: salesmax.apk:lombok/core/handlers/HandlerUtil.SCL.lombok */
public class HandlerUtil {
    ...
    /* loaded from: salesmax.apk:lombok/core/handlers/HandlerUtil$FieldAccess.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/core/handlers/HandlerUtil$JavadocTag.SCL.lombok */
    ...
    public static String stripLinesWithTagFromJavadoc(String javadoc, JavadocTag tag) {
        return (javadoc == null || javadoc.isEmpty()) ? javadoc : tag.pattern.matcher(javadoc).replaceAll("");
    }
    ...
    public static String addJavadocLine(String in, String line) {
        return in == null ? line : in.endsWith("\n") ? String.valueOf(in) + line + "\n" : String.valueOf(in) + "\n" + line;
    }
