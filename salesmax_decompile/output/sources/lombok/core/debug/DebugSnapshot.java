...
/* loaded from: salesmax.apk:lombok/core/debug/DebugSnapshot.SCL.lombok */
public class DebugSnapshot implements Comparable<DebugSnapshot> {
    ...
    public int compareTo(DebugSnapshot o2) {
        return Long.valueOf(this.id).compareTo(Long.valueOf(o2.id));
    }
}
