...
/* loaded from: salesmax.apk:lombok/core/configuration/ConfigurationSource.SCL.lombok */
public interface ConfigurationSource {
    Result resolve(ConfigurationKey<?> configurationKey);

    List<ConfigurationFile> imports();

    /* loaded from: salesmax.apk:lombok/core/configuration/ConfigurationSource$Result.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/core/configuration/ConfigurationSource$ListModification.SCL.lombok */
