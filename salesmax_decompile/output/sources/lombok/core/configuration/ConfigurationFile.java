...
/* loaded from: salesmax.apk:lombok/core/configuration/ConfigurationFile.SCL.lombok */
public abstract class ConfigurationFile {
    ...
    public static String read(InputStream is) throws IOException {
        ...
        while (true) {
            ...
            if (r != -1) {
                ...
                return new String(out.toByteArray(), HTTP.UTF_8);
            }
        }
    }

    /* loaded from: salesmax.apk:lombok/core/configuration/ConfigurationFile$RegularConfigurationFile.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/core/configuration/ConfigurationFile$ArchivedConfigurationFile.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/core/configuration/ConfigurationFile$CharSequenceConfigurationFile.SCL.lombok */
