...
/* loaded from: salesmax.apk:lombok/core/configuration/ConfigurationKey.SCL.lombok */
public abstract class ConfigurationKey<T> {
    ...
    private final ConfigurationDataType f58167type;
    ...
    public ConfigurationKey(String keyName, String description, boolean hidden) {
        ...
        ConfigurationDataType type2 = ConfigurationDataType.toDataType(getClass());
        this.f58167type = type2;
    ...
    public String toString() {
        return String.valueOf(this.keyName) + " (" + this.f58167type + "): " + this.description;
    }
