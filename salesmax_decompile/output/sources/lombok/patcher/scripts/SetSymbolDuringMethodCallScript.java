...
/* loaded from: salesmax.apk:lombok/patcher/scripts/SetSymbolDuringMethodCallScript.SCL.lombok */
public class SetSymbolDuringMethodCallScript extends MethodLevelPatchScript {
    ...
    public void makeWrapperMethod(ClassVisitor cv, WrapperMethodDescriptor wmd) {
        ...
        mv.visitMethodInsn(Opcodes.INVOKESTATIC, "lombok/patcher/Symbols", InAppMessagePromptTypes.PUSH_PROMPT_KEY, "(Ljava/lang/String;)V", false);
    ...
    /* loaded from: salesmax.apk:lombok/patcher/scripts/SetSymbolDuringMethodCallScript$WrapWithSymbol.SCL.lombok */
