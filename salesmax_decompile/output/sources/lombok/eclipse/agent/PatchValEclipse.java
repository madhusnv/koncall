...
/* loaded from: salesmax.apk:lombok/eclipse/agent/PatchValEclipse.SCL.lombok */
public class PatchValEclipse {
    ...
    private static boolean couldBeVal(ImportReference[] imports, TypeReference type2) {
        return PatchVal.couldBe(imports, "lombok.val", type2);
    }

    private static boolean couldBeVar(ImportReference[] imports, TypeReference type2) {
        return PatchVal.couldBe(imports, "lombok.experimental.var", type2) || PatchVal.couldBe(imports, "lombok.var", type2);
    }
    ...
    static {
        Field f = null;
        try {
            f = Permit.getField(Name.class, FirebaseAnalytics.Param.INDEX);
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchValEclipse$Reflection.SCL.lombok */
