...
/* loaded from: salesmax.apk:lombok/eclipse/agent/PatchExtensionMethod.SCL.lombok */
public class PatchExtensionMethod {
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchExtensionMethod$PostponedError.SCL.lombok */
    private interface PostponedError {
        void fire();
    }

    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchExtensionMethod$Extension.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchExtensionMethod$PostponedNoMethodError.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchExtensionMethod$PostponedInvalidMethodError.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchExtensionMethod$PostponedNonStaticAccessToStaticMethodError.SCL.lombok */
    ...
    public static TypeBinding resolveType(TypeBinding resolvedType, MessageSend methodCall, BlockScope scope) throws IllegalAccessException, IllegalArgumentException {
        TypeBinding param;
        List<Extension> extensions = new ArrayList<>();
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchExtensionMethod$Reflection.SCL.lombok */
