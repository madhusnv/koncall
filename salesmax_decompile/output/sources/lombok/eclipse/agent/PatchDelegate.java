...
/* loaded from: salesmax.apk:lombok/eclipse/agent/PatchDelegate.SCL.lombok */
public class PatchDelegate {
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchDelegate$CantMakeDelegates.SCL.lombok */
    public static class CantMakeDelegates extends Exception {
        public Set<String> conflicted;
    }

    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchDelegate$ClassScopeEntry.SCL.lombok */
    ...
    private static void fillMethodBindingsForFields(CompilationUnitDeclaration cud, ClassScope scope, List<BindingTuple> methodsToDelegate) throws IllegalAccessException, IllegalArgumentException {
        TypeDeclaration decl = scope.referenceContext;
                    ...
                    while (true) {
                        ...
                        if (isDelegate(ann, decl) && !EcjAugments.Annotation_applied.getAndSet(ann, true).booleanValue()) {
                            ...
                            try {
                                ...
                                eclipseAst3.get(ann).addError(String.format(RECURSION_NOT_ALLOWED, new String(e.member), new String(e.f58168type)));
                            }
                        }
                        i++;
                    }
    ...
    private static void fillMethodBindingsForMethods(CompilationUnitDeclaration cud, ClassScope scope, List<BindingTuple> methodsToDelegate) throws IllegalAccessException, IllegalArgumentException {
        TypeDeclaration decl = scope.referenceContext;
                    ...
                    while (true) {
                        ...
                        if (isDelegate(ann, decl) && !EcjAugments.Annotation_applied.getAndSet(ann, true).booleanValue()) {
                            ...
                            try {
                                ...
                                eclipseAst5.get(ann).addError(String.format(RECURSION_NOT_ALLOWED, new String(e.member), new String(e.f58168type)));
                            }
                        }
                        i++;
                    }
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchDelegate$TypeVarFinder.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchDelegate$EclipseTypeBindingScanner.SCL.lombok */
    ...
    private static MethodDeclaration createDelegateMethod(char[] name, EclipseNode typeNode, BindingTuple pair, CompilationResult compilationResult, EclipseNode annNode, DelegateReceiver delegateReceiver) {
        ...
        try {
            ...
            if (binding.parameters != null && binding.parameters.length > 0) {
                ...
                if (isVarargs) {
                    method.arguments[method.arguments.length - 1].type.bits |= Opcodes.ACC_ENUM;
                }
            }
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchDelegate$EclipseOnlyMethods.SCL.lombok */
    public static class EclipseOnlyMethods {
        ...
        /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchDelegate$EclipseOnlyMethods$DelegateSourceMethod.SCL.lombok */
        private static final class DelegateSourceMethod extends SourceMethod {
            ...
            /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchDelegate$EclipseOnlyMethods$DelegateSourceMethod$DelegateSourceMethodInfo.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchDelegate$Reflection.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchDelegate$DelegateRecursion.SCL.lombok */
    private static class DelegateRecursion extends Throwable {

        /* renamed from: type, reason: collision with root package name */
        final char[] f58168type;
        final char[] member;

        public DelegateRecursion(char[] type2, char[] member) {
            this.f58168type = type2;
            this.member = member;
        }
    }
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchDelegate$BindingTuple.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/agent/PatchDelegate$DelegateReceiver.SCL.lombok */
