...
/* loaded from: salesmax.apk:lombok/eclipse/agent/ExtensionMethodCompletionProposal.SCL.lombok */
public class ExtensionMethodCompletionProposal extends InternalCompletionProposal {
    ...
    public void setMethodBinding(MethodBinding method, ASTNode node) {
        ...
        for (int i = 0; i < length; i++) {
            TypeBinding type2 = method.original().parameters[i];
            r0[i] = type2.qualifiedPackageName();
            r02[i] = type2.qualifiedSourceName();
        }
