...
/* loaded from: salesmax.apk:lombok/eclipse/EclipseASTVisitor.SCL.lombok */
public interface EclipseASTVisitor {
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/EclipseASTVisitor$Printer.SCL.lombok */
    public static class Printer implements EclipseASTVisitor {
        ...
        private String str(TypeReference type2) {
            if (type2 == null) {
                return "(NULL)";
            }
            char[][] c = type2.getTypeName();
            StringBuilder sb = new StringBuilder();
            boolean first = true;
            for (char[] d : c) {
        ...
        @Override // lombok.eclipse.EclipseASTVisitor
        public void visitType(EclipseNode node, TypeDeclaration type2) {
            Object[] objArr = new Object[4];
            objArr[0] = str(type2.name);
            objArr[1] = EclipseHandlerUtil.isGenerated(type2) ? " (GENERATED)" : "";
            objArr[2] = position(node);
            objArr[3] = printFlags(type2.modifiers, type2);
        ...
        @Override // lombok.eclipse.EclipseASTVisitor
        public void visitAnnotationOnType(TypeDeclaration type2, EclipseNode node, Annotation annotation) {
            Object[] objArr = new Object[3];
        ...
        @Override // lombok.eclipse.EclipseASTVisitor
        public void endVisitType(EclipseNode node, TypeDeclaration type2) {
            if (this.printContent) {
                this.disablePrinting--;
            }
            this.indent--;
            print("</TYPE %s>", str(type2.name));
        }
        ...
        public void visitMethod(EclipseNode node, AbstractMethodDeclaration method) {
            String type2 = method instanceof ConstructorDeclaration ? "CONSTRUCTOR" : "METHOD";
            Object[] objArr = new Object[6];
            objArr[0] = type2;
        ...
        public void endVisitMethod(EclipseNode node, AbstractMethodDeclaration method) {
            ...
            String type2 = method instanceof ConstructorDeclaration ? "CONSTRUCTOR" : "METHOD";
            this.indent--;
            print("</%s %s>", type2, str(method.selector));
        }
