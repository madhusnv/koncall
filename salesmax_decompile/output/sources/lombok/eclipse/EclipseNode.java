...
/* loaded from: salesmax.apk:lombok/eclipse/EclipseNode.SCL.lombok */
public class EclipseNode extends LombokNode<EclipseAST, EclipseNode, ASTNode> {
    ...
    @Override // lombok.core.LombokNode
    public boolean hasAnnotation(Class<? extends java.lang.annotation.Annotation> type2) {
        return EclipseHandlerUtil.hasAnnotation(type2, this);
    }

    @Override // lombok.core.LombokNode
    public <Z extends java.lang.annotation.Annotation> AnnotationValues<Z> findAnnotation(Class<Z> type2) {
        EclipseNode annotation = EclipseHandlerUtil.findAnnotation(type2, this);
        if (annotation == null) {
            return null;
        }
        return EclipseHandlerUtil.createAnnotation(type2, annotation);
    }
