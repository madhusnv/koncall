...
/* loaded from: salesmax.apk:lombok/eclipse/TransformEclipseAST.SCL.lombok */
public class TransformEclipseAST {
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/TransformEclipseAST$State.SCL.lombok */
    private enum State {
        DIET,
        FULL;
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/TransformEclipseAST$AnnotationVisitor.SCL.lombok */
    private static class AnnotationVisitor extends EclipseASTAdapter {
        ...
        @Override // lombok.eclipse.EclipseASTAdapter, lombok.eclipse.EclipseASTVisitor
        public void visitAnnotationOnType(TypeDeclaration type2, EclipseNode annotationNode, Annotation annotation) {
            CompilationUnitDeclaration top = annotationNode.top().get();
            this.nextPriority = Math.min(this.nextPriority, TransformEclipseAST.handlers.handleAnnotation(top, annotationNode, annotation, this.priority));
        }
