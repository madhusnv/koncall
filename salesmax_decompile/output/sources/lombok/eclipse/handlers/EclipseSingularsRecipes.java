...
/* loaded from: salesmax.apk:lombok/eclipse/handlers/EclipseSingularsRecipes.SCL.lombok */
public class EclipseSingularsRecipes {
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/handlers/EclipseSingularsRecipes$StatementMaker.SCL.lombok */
    public interface StatementMaker {
        /* renamed from: make */
        Statement mo68859make();
    }

    /* loaded from: salesmax.apk:lombok/eclipse/handlers/EclipseSingularsRecipes$TypeReferenceMaker.SCL.lombok */
    ...
    private static void loadAll(TypeLibrary library, Map<String, EclipseSingularizer> map) throws IOException {
        for (EclipseSingularizer handler : SpiLoadUtil.findServices(EclipseSingularizer.class, EclipseSingularizer.class.getClassLoader())) {
            ...
            while (it.hasNext()) {
                ...
                EclipseSingularizer existingSingularizer = map.get(type2);
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/handlers/EclipseSingularsRecipes$SingularData.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/handlers/EclipseSingularsRecipes$EclipseSingularizer.SCL.lombok */
    public static abstract class EclipseSingularizer {
        ...
        /* JADX WARN: Type inference failed for: r0v7, types: [char[], java.lang.Object[]] */
        ...
        protected Annotation[] generateSelfReturnAnnotations(boolean deprecate, CheckerFrameworkVersion cfv, ASTNode source) {
            ...
            MarkerAnnotation markerAnnotationGenerateNamedAnnotation = cfv.generateReturnsReceiver() ? EclipseHandlerUtil.generateNamedAnnotation(source, CheckerFrameworkVersion.NAME__RETURNS_RECEIVER) : null;
            if (markerAnnotationGenerateDeprecatedAnnotation == null && markerAnnotationGenerateNamedAnnotation == null) {
                return null;
            }
            return markerAnnotationGenerateDeprecatedAnnotation == null ? new Annotation[]{markerAnnotationGenerateNamedAnnotation} : markerAnnotationGenerateNamedAnnotation == null ? new Annotation[]{markerAnnotationGenerateDeprecatedAnnotation} : new Annotation[]{markerAnnotationGenerateDeprecatedAnnotation, markerAnnotationGenerateNamedAnnotation};
        }
        ...
        protected TypeReference addTypeArgs(int count, boolean addExtends, EclipseNode node, TypeReference type2, List<TypeReference> typeArgs) {
            TypeReference[] clonedAndFixedArgs = createTypeArgs(count, addExtends, node, typeArgs);
            if (type2 instanceof SingleTypeReference) {
                type2 = new ParameterizedSingleTypeReference(((SingleTypeReference) type2).token, clonedAndFixedArgs, 0, 0L);
            } else if (type2 instanceof QualifiedTypeReference) {
                QualifiedTypeReference qtr = (QualifiedTypeReference) type2;
                ?? r0 = new TypeReference[qtr.tokens.length];
                r0[qtr.tokens.length - 1] = clonedAndFixedArgs;
                type2 = new ParameterizedQualifiedTypeReference(((QualifiedTypeReference) type2).tokens, (TypeReference[][]) r0, 0, NULL_POSS);
            } else {
                node.addError("Don't know how to clone-and-parameterize type: " + type2);
            }
            return type2;
        }
