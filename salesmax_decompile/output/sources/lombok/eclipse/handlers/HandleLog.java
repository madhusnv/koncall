...
/* loaded from: salesmax.apk:lombok/eclipse/handlers/HandleLog.SCL.lombok */
public class HandleLog {
    ...
    private static /* synthetic */ int[] f13959xeb5c83f5;
    ...
    /* renamed from: $SWITCH_TABLE$lombok$core$configuration$LogDeclaration$LogFactoryParameter */
    static /* synthetic */ int[] m16258xeb5c83f5() {
        int[] iArr = f13959xeb5c83f5;
        if (iArr != null) {
            return iArr;
        }
    ...
    public static ClassLiteralAccess selfType(EclipseNode type2, org.eclipse.jdt.internal.compiler.ast.Annotation source) {
    ...
    private static final Expression[] createFactoryParameters(ClassLiteralAccess loggingType, org.eclipse.jdt.internal.compiler.ast.Annotation source, List<LogDeclaration.LogFactoryParameter> parameters, Expression loggerTopic) {
        ...
        for (int i = 0; i < parameters.size(); i++) {
            ...
            switch (m16258xeb5c83f5()[parameter.ordinal()]) {
                case 1:
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/handlers/HandleLog$HandleCommonsLog.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/handlers/HandleLog$HandleJulLog.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/handlers/HandleLog$HandleLog4jLog.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/handlers/HandleLog$HandleLog4j2Log.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/handlers/HandleLog$HandleSlf4jLog.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/handlers/HandleLog$HandleXSlf4jLog.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/handlers/HandleLog$HandleJBossLog.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/handlers/HandleLog$HandleFloggerLog.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/eclipse/handlers/HandleLog$HandleCustomLog.SCL.lombok */
