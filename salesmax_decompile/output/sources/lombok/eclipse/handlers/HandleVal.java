...
/* loaded from: salesmax.apk:lombok/eclipse/handlers/HandleVal.SCL.lombok */
public class HandleVal extends EclipseASTAdapter {
    ...
    public void visitLocal(EclipseNode localNode, LocalDeclaration local) {
        TypeReference type2 = local.type;
        boolean isVal = EclipseHandlerUtil.typeMatches((Class<?>) val.class, localNode, type2);
        boolean isVar = EclipseHandlerUtil.typeMatches((Class<?>) var.class, localNode, type2);
        if (isVal || isVar) {
            if (isVal) {
