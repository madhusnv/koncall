...
/* loaded from: salesmax.apk:lombok/eclipse/handlers/HandleWithBy.SCL.lombok */
public class HandleWithBy extends EclipseAnnotationHandler<WithBy> {
    ...
    private static /* synthetic */ int[] f13964xb87c1847;
    ...
    /* renamed from: $SWITCH_TABLE$lombok$eclipse$handlers$EclipseHandlerUtil$MemberExistsResult */
    static /* synthetic */ int[] m16263xb87c1847() {
        int[] iArr = f13964xb87c1847;
        if (iArr != null) {
            return iArr;
        }
    ...
    public void createWithByForField(AccessLevel level, EclipseNode fieldNode, EclipseNode sourceNode, boolean whineIfExists, List<org.eclipse.jdt.internal.compiler.ast.Annotation> onMethod) throws IllegalAccessException, IllegalArgumentException {
        ...
        for (String altName : EclipseHandlerUtil.toAllWithByNames(fieldNode, isBoolean)) {
            switch (m16263xb87c1847()[EclipseHandlerUtil.methodExists(altName, fieldNode, false, 1).ordinal()]) {
                case 2:
                    return;
                case 3:
                    if (whineIfExists) {
    ...
    public MethodDeclaration createWithBy(TypeDeclaration parent, EclipseNode fieldNode, String name, int modifier, EclipseNode sourceNode, List<org.eclipse.jdt.internal.compiler.ast.Annotation> onMethod, boolean makeAbstract) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (qualifiedTypeReferenceCopyType != null && superExtendsStyle) {
            ...
            r0[functionalInterfaceName.length - 1] = new TypeReference[]{wildcard, wildcard2};
            long[] ps = new long[functionalInterfaceName.length];
            qualifiedTypeReference = new ParameterizedQualifiedTypeReference(functionalInterfaceName, (TypeReference[][]) r0, 0, ps);
        }
        if (qualifiedTypeReferenceCopyType != null && !superExtendsStyle) {
            ?? r02 = new TypeReference[functionalInterfaceName.length];
            r02[functionalInterfaceName.length - 1] = new TypeReference[]{qualifiedTypeReferenceCopyType};
            long[] ps2 = new long[functionalInterfaceName.length];
            qualifiedTypeReference = new ParameterizedQualifiedTypeReference(functionalInterfaceName, (TypeReference[][]) r02, 0, ps2);
        }
