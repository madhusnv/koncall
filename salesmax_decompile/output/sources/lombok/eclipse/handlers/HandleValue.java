...
@HandlerPriority(-512)
/* loaded from: salesmax.apk:lombok/eclipse/handlers/HandleValue.SCL.lombok */
public class HandleValue extends EclipseAnnotationHandler<Value> {
    ...
    public void handle(AnnotationValues<Value> annotation, Annotation ast, EclipseNode annotationNode) throws IllegalAccessException, InstantiationException, SecurityException, IllegalArgumentException, InvocationTargetException {
