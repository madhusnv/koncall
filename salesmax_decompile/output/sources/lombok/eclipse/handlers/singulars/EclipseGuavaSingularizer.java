...
/* loaded from: salesmax.apk:lombok/eclipse/handlers/singulars/EclipseGuavaSingularizer.SCL.lombok */
abstract class EclipseGuavaSingularizer extends EclipseSingularsRecipes.EclipseSingularizer {
    ...
    public List<EclipseNode> generateFields(EclipseSingularsRecipes.SingularData data, EclipseNode builderType) {
        ...
        TypeReference type2 = addTypeArgs(getTypeArgumentsCount(), false, builderType, new QualifiedTypeReference(tokenizedName, NULL_POSS), data.getTypeArgs());
