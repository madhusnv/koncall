...
/* loaded from: salesmax.apk:lombok/delombok/DelombokApp.SCL.lombok */
public class DelombokApp extends LombokApp {
    ...
    public int runApp(List<String> args) throws Exception {
        try {
            ...
            try {
                Permit.invoke(Permit.getMethod(loadDelombok(args), MediaTrack.ROLE_MAIN, String[].class), null, args.toArray(new String[0]));
                return 0;
    ...
    public static Class<?> loadDelombok(List<String> args) throws Exception {
        ...
        if (toolsJar == null) {
            ...
            for (String arg : args) {
                ...
                if (arg.contains(" ")) {
                    sb.append(TokenParser.DQUOTE).append(arg).append(TokenParser.DQUOTE);
                } else {
                    sb.append(arg);
                }
            }
