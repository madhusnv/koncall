...
/* loaded from: salesmax.apk:lombok/bytecode/ClassFileMetaData.SCL.lombok */
public class ClassFileMetaData {
    ...
    public ClassFileMetaData(byte[] byteCode) {
        ...
        while (i < this.maxPoolSize) {
            ...
            switch (type2) {
                ...
                case 14:
                default:
                    throw new AssertionError("Unknown constant pool type " + ((int) type2));
                case 3:
                case 4:
                case 9:
                case 10:
        ...
        for (int i = 1; i < this.maxPoolSize; i++) {
            ...
            switch (this.types[i]) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    result.append("String \"").append(this.utf8s[readValue(pos)]).append(ModelIdentifier.Helper.PRIMARY_KEY_ENCAPSULATE_CHAR);
                    break;
                case 9:
    ...
    private boolean isMethod(int i) {
        byte type2 = this.types[i];
        return type2 == 10 || type2 == 11;
    }
