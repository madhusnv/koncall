...
/* loaded from: salesmax.apk:lombok/javac/handlers/HandleHelper.SCL.lombok */
public class HandleHelper extends JavacAnnotationHandler<Helper> {
    ...
    public void handle(AnnotationValues<Helper> annotation, JCTree.JCAnnotation ast, final JavacNode annotationNode) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        String n;
        ...
        TreeScanner<Void, Void> treeScanner = new TreeScanner<Void, Void>() { // from class: lombok.javac.handlers.HandleHelper.1
            public Void visitMethodInvocation(MethodInvocationTree node, Void p) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
                JCTree.JCMethodInvocation jcmi = (JCTree.JCMethodInvocation) node;
                apply(jcmi);
                return (Void) super.visitMethodInvocation(node, p);
            }

            private void apply(JCTree.JCMethodInvocation jcmi) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
