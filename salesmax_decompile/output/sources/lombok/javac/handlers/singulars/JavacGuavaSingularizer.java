...
/* loaded from: salesmax.apk:lombok/javac/handlers/singulars/JavacGuavaSingularizer.SCL.lombok */
abstract class JavacGuavaSingularizer extends JavacSingularsRecipes.JavacSingularizer {
    ...
    public List<JavacNode> generateFields(JavacSingularsRecipes.SingularData data, JavacNode builderType, JavacNode source) {
        ...
        String simpleTypeName = getSimpleTargetTypeName(data);
        JCTree.JCExpression type2 = JavacHandlerUtil.chainDots(builderType, "com", "google", "common", "collect", simpleTypeName, "Builder");
        JCTree.JCVariableDecl buildField = maker.VarDef(maker.Modifiers(2L), data.getPluralName(), addTypeArgs(getTypeArgumentsCount(), false, builderType, type2, data.getTypeArgs(), source), null);
