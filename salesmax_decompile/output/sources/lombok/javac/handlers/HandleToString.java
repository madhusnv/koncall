...
/* loaded from: salesmax.apk:lombok/javac/handlers/HandleToString.SCL.lombok */
public class HandleToString extends JavacAnnotationHandler<ToString> {
    ...
    private static /* synthetic */ int[] f13971x2486df07;
    ...
    /* renamed from: $SWITCH_TABLE$lombok$javac$handlers$JavacHandlerUtil$MemberExistsResult */
    static /* synthetic */ int[] m16270x2486df07() {
        int[] iArr = f13971x2486df07;
        if (iArr != null) {
            return iArr;
        }
    ...
    public void generateToString(JavacNode typeNode, JavacNode source, List<InclusionExclusionUtils.Included<JavacNode, ToString.Include>> members, boolean includeFieldNames, Boolean callSuper, boolean whineIfExists, HandlerUtil.FieldAccess fieldAccess) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        switch (m16270x2486df07()[JavacHandlerUtil.methodExists("toString", typeNode, 0).ordinal()]) {
            case 1:
                if (callSuper == null) {
    ...
    static JCTree.JCMethodDecl createToString(JavacNode typeNode, Collection<InclusionExclusionUtils.Included<JavacNode, ToString.Include>> members, boolean includeNames, boolean callSuper, HandlerUtil.FieldAccess fieldAccess, JavacNode source) {
        ...
        if (!isEnum) {
            ...
            current = maker.Binary(Javac.CTC_PLUS, maker.Literal(String.valueOf(typeName) + "."), maker.Apply(com.sun.tools.javac.util.List.nil(), maker.Select(maker.Ident(typeNode.toName("this")), typeNode.toName("name")), com.sun.tools.javac.util.List.nil()));
            if (!prefix.isEmpty()) {
