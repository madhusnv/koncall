...
/* loaded from: salesmax.apk:lombok/javac/handlers/HandleBuilder.SCL.lombok */
public class HandleBuilder extends JavacAnnotationHandler<Builder> {
    ...
    private static /* synthetic */ int[] f13965x2486df07;

    /* renamed from: $SWITCH_TABLE$lombok$javac$handlers$JavacHandlerUtil$MemberExistsResult */
    static /* synthetic */ int[] m16264x2486df07() {
        int[] iArr = f13965x2486df07;
        if (iArr != null) {
            return iArr;
        }
    ...
    /* loaded from: salesmax.apk:lombok/javac/handlers/HandleBuilder$BuilderJob.SCL.lombok */
    static class BuilderJob {
        ...
        String replaceBuilderClassName(String name, String template) {
            return template.indexOf(42) == -1 ? template : template.replace("*", name);
        }
    ...
    /* loaded from: salesmax.apk:lombok/javac/handlers/HandleBuilder$BuilderFieldData.SCL.lombok */
    static class BuilderFieldData {
        List<JCTree.JCAnnotation> annotations;

        /* renamed from: type, reason: collision with root package name */
        JCTree.JCExpression f58171type;
        Name rawName;
        Name name;
    ...
    public void handle(AnnotationValues<Builder> annotation, JCTree.JCAnnotation ast, JavacNode annotationNode) throws IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        ...
        if (HandlerUtil.checkName("buildMethodName", job.buildMethodName, annotationNode)) {
            ...
            if (job.toBuilder) {
                switch (m16264x2486df07()[JavacHandlerUtil.methodExists(TO_BUILDER_METHOD_NAME, job.parentType, 0).ordinal()]) {
                    case 1:
    ...
    private JCTree.JCMethodDecl generateToBuilderMethod(BuilderJob job, List<JCTree.JCTypeParameter> typeParameters, String prefix) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        for (BuilderFieldData bfd : job.builderFields) {
            ...
            if (bfd.obtainVia == null || !bfd.obtainVia.field().isEmpty()) {
                ...
                JCTree.JCExpression varType = JavacHandlerUtil.cloneType(maker, bfd.f58171type, job.sourceNode);
    ...
    private JCTree.JCMethodDecl generateCleanMethod(BuilderJob job) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        JavacTreeMaker maker = job.getTreeMaker();
        ListBuffer<JCTree.JCStatement> statements = new ListBuffer<>();
        for (BuilderFieldData bfd : job.builderFields) {
    ...
    private JCTree.JCMethodDecl generateBuildMethod(BuilderJob job, Name staticName, JCTree.JCExpression returnType, List<JCTree.JCExpression> thrownExceptions, boolean addCleaning) throws IllegalAccessException, IllegalArgumentException {
        ...
        for (BuilderFieldData bfd2 : job.builderFields) {
            if (bfd2.nameOfSetFlag != null) {
                statements.append(maker.VarDef(maker.Modifiers(0L), bfd2.builderFieldName, JavacHandlerUtil.cloneType(maker, bfd2.f58171type, job.sourceNode), maker.Select(maker.Ident(thisName), bfd2.builderFieldName)));
    ...
    public static JCTree.JCMethodDecl generateDefaultProvider(Name methodName, JavacNode fieldNode, List<JCTree.JCTypeParameter> params) {
        ...
        return maker.MethodDef(maker.Modifiers(10), methodName, JavacHandlerUtil.cloneType(maker, field.vartype, fieldNode), JavacHandlerUtil.copyTypeParams(fieldNode, params), List.nil(), List.nil(), body, null);
    }
    ...
    public void generateBuilderFields(BuilderJob job) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        for (int i = len - 1; i >= 0; i--) {
            ...
            if (bfd.singularData != null && bfd.singularData.getSingularizer() != null) {
                ...
                if (field2 == null) {
                    ...
                    JCTree.JCVariableDecl newField = maker.VarDef(mods, bfd.builderFieldName, JavacHandlerUtil.cloneType(maker, bfd.f58171type, job.sourceNode), null);
    ...
    public JavacNode makeBuilderClass(BuilderJob job) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        JavacTreeMaker maker = job.getTreeMaker();
        int modifiers = JavacHandlerUtil.toJavacModifier(job.accessOuters);
        if (job.isStatic) {
            modifiers |= 8;
