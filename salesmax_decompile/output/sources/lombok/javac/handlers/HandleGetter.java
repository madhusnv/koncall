...
/* loaded from: salesmax.apk:lombok/javac/handlers/HandleGetter.SCL.lombok */
public class HandleGetter extends JavacAnnotationHandler<Getter> {
    ...
    private static /* synthetic */ int[] f13967x2486df07;
    ...
    /* renamed from: $SWITCH_TABLE$lombok$javac$handlers$JavacHandlerUtil$MemberExistsResult */
    static /* synthetic */ int[] m16266x2486df07() {
        int[] iArr = f13967x2486df07;
        if (iArr != null) {
            return iArr;
        }
    ...
    public void createGetterForField(AccessLevel level, JavacNode fieldNode, JavacNode source, boolean whineIfExists, boolean lazy, List<JCTree.JCAnnotation> onMethod) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        for (String altName : JavacHandlerUtil.toAllGetterNames(fieldNode)) {
            switch (m16266x2486df07()[JavacHandlerUtil.methodExists(altName, fieldNode, false, 0).ordinal()]) {
                case 2:
                    return;
                case 3:
                    if (whineIfExists) {
    ...
    public JCTree.JCMethodDecl createGetter(long access, JavacNode field, JavacTreeMaker treeMaker, JavacNode source, boolean lazy, List<JCTree.JCAnnotation> onMethod) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
