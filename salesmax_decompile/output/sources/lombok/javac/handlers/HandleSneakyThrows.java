...
/* loaded from: salesmax.apk:lombok/javac/handlers/HandleSneakyThrows.SCL.lombok */
public class HandleSneakyThrows extends JavacAnnotationHandler<SneakyThrows> {
    ...
    public void handleMethod(JavacNode annotation, JCTree.JCMethodDecl method, Collection<String> exceptions) {
        ...
        if ((method.mods.flags & MediaStatus.COMMAND_QUEUE_REPEAT_ALL) != 0) {
    ...
    public JCTree.JCStatement buildTryCatchBlock(JavacNode node, com.sun.tools.javac.util.List<JCTree.JCStatement> contents, String exception, JavacNode source) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
