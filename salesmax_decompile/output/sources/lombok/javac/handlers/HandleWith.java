...
/* loaded from: salesmax.apk:lombok/javac/handlers/HandleWith.SCL.lombok */
public class HandleWith extends JavacAnnotationHandler<With> {
    ...
    private static /* synthetic */ int[] f13972x2486df07;
    ...
    /* renamed from: $SWITCH_TABLE$lombok$javac$handlers$JavacHandlerUtil$MemberExistsResult */
    static /* synthetic */ int[] m16271x2486df07() {
        int[] iArr = f13972x2486df07;
        if (iArr != null) {
            return iArr;
        }
    ...
    public void createWithForField(AccessLevel level, JavacNode fieldNode, JavacNode source, boolean strictMode, List<JCTree.JCAnnotation> onMethod, List<JCTree.JCAnnotation> onParam) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        for (String altName : JavacHandlerUtil.toAllWithNames(fieldNode)) {
            switch (m16271x2486df07()[JavacHandlerUtil.methodExists(altName, fieldNode, false, 1).ordinal()]) {
                case 2:
                    return;
                case 3:
                    if (strictMode) {
    ...
    public JCTree.JCMethodDecl createWith(long access, JavacNode field, JavacTreeMaker maker, JavacNode source, List<JCTree.JCAnnotation> onMethod, List<JCTree.JCAnnotation> onParam, boolean makeAbstract) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
