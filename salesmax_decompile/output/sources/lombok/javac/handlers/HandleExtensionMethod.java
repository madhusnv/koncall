...
/* loaded from: salesmax.apk:lombok/javac/handlers/HandleExtensionMethod.SCL.lombok */
public class HandleExtensionMethod extends JavacAnnotationHandler<ExtensionMethod> {
    ...
    /* loaded from: salesmax.apk:lombok/javac/handlers/HandleExtensionMethod$Extension.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/javac/handlers/HandleExtensionMethod$ExtensionMethodReplaceVisitor.SCL.lombok */
    private static class ExtensionMethodReplaceVisitor extends TreeScanner<Void, Void> {
        ...
        public Void visitMethodInvocation(MethodInvocationTree tree, Void p) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            super.visitMethodInvocation(tree, p);
            handleMethodCall((JCTree.JCMethodInvocation) tree);
            return null;
        }

        private void handleMethodCall(JCTree.JCMethodInvocation methodCall) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
