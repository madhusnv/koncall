...
/* loaded from: salesmax.apk:lombok/javac/apt/LombokProcessor.SCL.lombok */
public class LombokProcessor extends AbstractProcessor {
    ...
    public void init(ProcessingEnvironment procEnv) throws IllegalAccessException, IllegalArgumentException {
        super.init(procEnv);
    ...
    private void placePostCompileAndDontMakeForceRoundDummiesHook() throws IllegalAccessException, IllegalArgumentException {
        ...
        try {
            Method keyMethod = Permit.getMethod(Context.class, TransferTable.COLUMN_KEY, Class.class);
    ...
    public JavacProcessingEnvironment getJavacProcessingEnvironment(Object procEnv) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
        addOpensForLombok();
    ...
    private static Object getJdkCompilerModule() throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
        try {
    ...
    public static void addOpensForLombok() throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
        try {
