...
/* loaded from: salesmax.apk:lombok/javac/JavacTreeMaker.SCL.lombok */
public class JavacTreeMaker {
    ...
    /* loaded from: salesmax.apk:lombok/javac/JavacTreeMaker$Case12.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/javac/JavacTreeMaker$FieldId.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/javac/JavacTreeMaker$MethodId.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/javac/JavacTreeMaker$SchroedingerType.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/javac/JavacTreeMaker$TypeTag.SCL.lombok */
    public static class TypeTag extends SchroedingerType {
        ...
        public static TypeTag typeTag(JCTree o2) {
            try {
                return new TypeTag(getFieldCached(FIELD_CACHE, o2, "typetag"));
            } catch (NoSuchFieldException e) {
                throw Javac.sneakyThrow(e);
            }
        }
    ...
    /* loaded from: salesmax.apk:lombok/javac/JavacTreeMaker$TreeTag.SCL.lombok */
    public static class TreeTag extends SchroedingerType {
        ...
        public static TreeTag treeTag(JCTree o2) {
            try {
                return TAG_METHOD != null ? new TreeTag(TAG_METHOD.invoke(o2, new Object[0])) : new TreeTag(TAG_FIELD.get(o2));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static <J> J invokeAny(Object obj, MethodId<J> methodId, Object... objArr) throws SecurityException {
    ...
    public JCTree.JCTypeCast TypeCast(JCTree expr, JCTree.JCExpression type2) {
        return (JCTree.JCTypeCast) invoke(TypeCast, expr, type2);
    }
    ...
    public JCTree.JCWildcard Wildcard(JCTree.TypeBoundKind kind, JCTree type2) {
        return (JCTree.JCWildcard) invoke(Wildcard, kind, type2);
    }
    ...
    public JCTree.JCExpression Type(Type type2) {
        return (JCTree.JCExpression) invoke(Type, type2);
    }
