...
/* loaded from: salesmax.apk:lombok/javac/JavacAST.SCL.lombok */
public class JavacAST extends AST<JavacAST, JavacNode, JCTree> {
    ...
    private static URI tryGetSbtFile_(JavaFileObject sourcefile) throws Exception {
        ...
        if (sbtMappedVirtualFileClass == null) {
            String cn2 = c3.getName();
            if (!cn2.startsWith("sbt.") || !cn2.endsWith("MappedVirtualFile")) {
                return null;
            }
        ...
        int idx = encodedPath.indexOf(Opcodes.LUSHR);
        if (idx == -1) {
            return null;
        }
    ...
    private JavacNode buildType(JCTree.JCClassDecl type2) {
        ...
        return putInMap(new JavacNode(this, type2, childNodes, AST.Kind.TYPE));
    }
    ...
    /* loaded from: salesmax.apk:lombok/javac/JavacAST$ErrorLog.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/javac/JavacAST$JdkBefore9.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/javac/JavacAST$Jdk9Plus.SCL.lombok */
    static class Jdk9Plus extends ErrorLog {
        ...
        private Jdk9Plus(Log log, Messager messager, Field errorCount, Field warningCount) {
            ...
            try {
                ...
                this.errorMethod = Permit.getMethod(lc, Constants.IPC_BUNDLE_KEY_SEND_ERROR, df, JCDiagnostic.DiagnosticPosition.class, errorCls);
