...
/* loaded from: salesmax.apk:lombok/installer/Installer.SCL.lombok */
public class Installer {
    ...
    /* loaded from: salesmax.apk:lombok/installer/Installer$GraphicalInstallerApp.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/installer/Installer$CommandLineInstallerApp.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/installer/Installer$CommandLineUninstallerApp.SCL.lombok */
    ...
    /* loaded from: salesmax.apk:lombok/installer/Installer$CmdArgs.SCL.lombok */
    ...
    public static int cliInstaller(boolean uninstall, List<String> rawArgs) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException {
        ...
        try {
            ...
            for (IdeLocation loc2 : locations) {
                ...
                objArr[1] = uninstall ? Constants.MessagePayloadKeys.FROM : "to";
